...
case 0:
if(func_70()==0){
if(!func_65(&uLocal_114)){
func_64(&uLocal_114);
}
if(func_65(&uLocal_117)){
func_87(&uLocal_117);
}
if(func_61(&uLocal_114) > 20f){
...
if(func_61(&uLocal_114) > 15f){
if(!func_84(Global_113648.f_19099, 32)){
func_57("TC_MISSEDJOB", -1);
func_82(&(Global_113648.f_19099), 32);
}
fLocal_107=(MISC::GET_RANDOM_FLOAT_IN_RANGE(10f, 40f) + func_61(&uLocal_114));
iLocal_102=3;
}
elseif(iLocal_108){
if(func_61(&uLocal_114) > 6f){
...
if(func_61(&uLocal_114) > fLocal_107){
func_87(&uLocal_114);
iLocal_102=0;
}
break;
}
if(((PAD::IS_CONTROL_PRESSED(0, 86) && !ENTITY::IS_ENTITY_UPSIDEDOWN(PLAYER::PLAYER_PED_ID())) && !Global_32316) && (MISC::GET_GAME_TIMER() - iLocal_105) > 3000){
iVar4=func_70();
if(iVar4==0){
...
if(func_61(&uLocal_117) < 10f){
if((MISC::GET_GAME_TIMER() % 1000) < 50){
}
}
if(func_61(&uLocal_117) > 10f && iLocal_102 !=0){
iLocal_102=0;
}}
...
iLocal_96=start_new_script(&Local_97, 54000);
