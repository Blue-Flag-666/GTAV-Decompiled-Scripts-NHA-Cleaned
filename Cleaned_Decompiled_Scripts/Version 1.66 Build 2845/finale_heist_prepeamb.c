...
func_146();
func_111();
if(func_78(PLAYER::PLAYER_PED_ID(), Local_50, 150f, 1) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, 0, 1, 0)){
MISC::CLEAR_AREA_OF_VEHICLES(Local_50, 6f, 0, 1, 0, 0, 0, 0, 0);
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-169.4253f, -622.0479f, 31.42444f, -162.2762f, -620.509f, 35.42448f, 0, 1);
}
if(!MISC::IS_BIT_SET(uLocal_49, 18)){
...
switch (iLocal_38){
case 0:
if(((!HUD::DOES_BLIP_EXIST(uLocal_245) && MISC::IS_BIT_SET(uLocal_49, 0)) && !MISC::IS_BIT_SET(uLocal_49, 1)) && MISC::IS_BIT_SET(uLocal_49, 18)){
uLocal_245=func_147(Local_50, 1);
...
var func__147(struct<3> Param0, int iParam1){
var uVar0;
...
if(!MISC::IS_BIT_SET(uLocal_49, 1)){
if(func_87(iLocal_51)){
ENTITY::IS_ENTITY_AT_COORD(iLocal_51, Local_50, 4f, 4f, 2f, 1, 1, 0);
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_51, -168.8162f, -619.9002f, 31.42446f, -162.6423f, -622.0781f, 33.42446f, 4.14f, 0, 1, 0)){
func_152(24, 46);
...
if(!MISC::IS_BIT_SET(uLocal_49, 19)){
func_71(9);
...
int iVar0;
bool bVar1;
if(((((((Global_43257==15 && iLocal_37 !=3) && MISC::IS_BIT_SET(uLocal_49, 5)) && !func_171()) && Global_78555==-1) && !func_221()) && !func_86(9)) || func_105(35)){
func_220();
func_219();
switch (iLocal_39){
case 0:
...
struct<8> func_248(char* sParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<8> Var0;
Var0.f_0=sParam0;
Var0.f_1={
Param1 
