...
case 9:
if(!PED::IS_PED_INJURED(iLocal_71)){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_71, Local_77, 200f, 200f, 200f, 0, 1, 0)){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_71, Local_77, 1f, -1, 0.25f, 0, 1193033728);
}else{
...
if(!PED::IS_PED_INJURED(iLocal_71)){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_71, Local_79, 5f, 5f, 5f, 0, 1, 0)){
func_56(0);
wait(0);
func_54();
iLocal_57=10;
...
func_59();
}elseif(!PED::IS_PED_RAGDOLL(iLocal_71)){
...
TASK::CLEAR_PED_TASKS(iLocal_72);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_72, Local_77, 1f, -1, 0.25f, 0, 1193033728);
func_24();
}}
if(!PED::IS_PED_INJURED(iLocal_72)){
...
if(PED::IS_PED_INJURED(iLocal_72) && ENTITY::IS_ENTITY_AT_COORD(iLocal_71, ENTITY::GET_ENTITY_COORDS(iLocal_72, 0), 1f, 1f, 5f, 0, 1, 0)){
iLocal_127=5;
}}elseif(!PED::IS_PED_INJURED(iLocal_72)){
...
iLocal_127=2;
}}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_71, 0)){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_71, uLocal_75);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_72, 0), 1f, -1, 3f, 0, 1193033728);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_72, -1);
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_71) || timerb() > 15000){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_71, -1046.832f, -2518.146f, 12.9447f, 20f, 20f, 5f, 0, 1, 0) || timerb() > 15000){
PED::DELETE_PED(&iLocal_71);
func_24();
}}}elseif(iLocal_58==2){
if(!iLocal_102){
...
if(!HUD::DOES_BLIP_EXIST(uLocal_100)){
uLocal_100=func_69(iLocal_72, 1, 145);
}
TASK::OPEN_SEQUENCE_TASK(&uLocal_75);
TASK::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 17f, 1f, 1073741824, 0);
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_75);
TASK::TASK_PERFORM_SEQUENCE(iLocal_72, uLocal_75);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_75);
PED::SET_PED_KEEP_TASK(iLocal_72, 1);
...
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_71, joaat("script_task_go_to_entity"))==1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_71, joaat("script_task_go_to_entity"))==0){
TASK::CLEAR_PED_TASKS(iLocal_71);
}}}elseif(!PED::IS_PED_IN_GROUP(iLocal_71)){
...
iLocal_105=0;
}}}elseif((!iLocal_105 && AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()) && !func_124()){
Local_107={
func_123() 
};
Local_106={
...
if(!HUD::DOES_BLIP_EXIST(uLocal_99)){
uLocal_99=func_69(iLocal_71, 0, 145);
}
if(HUD::DOES_BLIP_EXIST(uLocal_69)){
HUD::REMOVE_BLIP(&uLocal_69);
}}else{
if(!HUD::DOES_BLIP_EXIST(uLocal_69)){
uLocal_69=func_131(Local_77, 1);
}
if(HUD::DOES_BLIP_EXIST(uLocal_99)){
HUD::REMOVE_BLIP(&uLocal_99);
}}}elseif(!HUD::DOES_BLIP_EXIST(uLocal_99)){
uLocal_99=func_69(iLocal_71, 0, 145);
}
if(((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_71, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_77, 50f, 50f, 50f, 0, 1, 0)) || PED::IS_PED_IN_ANY_TAXI(PLAYER::PLAYER_PED_ID())){
if(!HUD::DOES_BLIP_EXIST(uLocal_69)){
uLocal_69=func_131(Local_77, 1);
}}elseif(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_77, 50f, 50f, 50f, 0, 1, 0)){
if(HUD::DOES_BLIP_EXIST(uLocal_69)){
HUD::REMOVE_BLIP(&uLocal_69);
}}}}


var func__131(struct<3> Param0, int iParam1){
var uVar0;
...
func_56(0);
iLocal_103=0;
}}elseif(!PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_71)){
...
settimera(0);
if(!PED::IS_PED_INJURED(iLocal_71)){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_77, 3f, 3f, 2f, 1, 1, 0) && ENTITY::IS_ENTITY_AT_COORD(iLocal_71, Local_77, Global_19, 0, 1, 0)){
if(func_142(1, 0, 1)){
func_141();
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
if(!PED::IS_PED_INJURED(iLocal_71)){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 805.501f, 1269.926f, 361.4025f, 25f, 30f, 2f, 0, 1, 0) || (ENTITY::IS_ENTITY_AT_COORD(iLocal_71, 824.8886f, 1275.671f, 359.4312f, Global_19, 1, 1, 0) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_71, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0))){
func_54();
wait(0);
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_77, 50f, 50f, 50f, 0, 1, 0) && !PED::IS_PED_INJURED(iLocal_71)){
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_71, 0)){
return 1;
}}
return 0;
...
if((((PED::IS_PED_INJURED(iLocal_72) || !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_72, PLAYER::PLAYER_PED_ID(), 150f, 150f, 150f, 0, 1, 0)) || vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_77) < 250f) || vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_79) < 250f) || iLocal_94){
if(HUD::DOES_BLIP_EXIST(uLocal_100)){
HUD::REMOVE_BLIP(&uLocal_100);
}
...
if(!PED::IS_PED_INJURED(iLocal_72)){
func_152(&iLocal_72, &uLocal_100, &iLocal_139, &uLocal_101);
func_151(&iLocal_72, &uLocal_100, &iLocal_139, &uLocal_101);
func_145(iLocal_139, PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_153, &uLocal_156, &Local_158, &uLocal_157, &uLocal_159, 0f, 0f, 0f, 1500, 0f);
...
void func_145(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, struct<3> Param7, int iParam8, float fParam9){
struct<3> Var0;
...
if(func_147(iParam0, iParam1, 1) > fParam9 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam1, 1), *uParam2, 1) > 20f){
if(!func_146(*uParam2)){
...
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_158, uLocal_157, Param7) 
};
if(!func_146(Var0)){
...
ENTITY::SET_ENTITY_HEADING(iParam0, uLocal_157);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iParam0, 1084227584);
VEHICLE::SET_VEHICLE_FORWARD_SPEED(iParam0, 10f);
VEHICLE::SET_VEHICLE_ENGINE_ON(iParam0, 1, 1, 0);
*uParam6=MISC::GET_GAME_TIMER();
...
var func__149(struct<2> Param0, Vector3 vParam1, struct<2> Param2, Vector3 vParam3){
...
void func_153(){
if(!PED::IS_PED_INJURED(iLocal_72)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 655.7768f, 1282.45f, 359.048f, 802.4241f, 1278.077f, 382.4866f, 77f, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_72, 655.7768f, 1282.45f, 359.048f, 802.4241f, 1278.077f, 382.4866f, 77f, 0, 1, 0)){
...
if(!bLocal_90){
if(iLocal_58==3){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_84, 200f, 200f, 200f, 0, 1, 0)){
...
iLocal_72=PED::CREATE_PED(26, iLocal_81, Local_84, fLocal_85, 1, 1);
...
PED::SET_PED_CONFIG_FLAG(iLocal_72, 42, 1);
...
if(!PED::IS_PED_INJURED(iLocal_71)){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_67, 1) > 320f && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_71, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)){
if(PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), MISC::GET_RANDOM_INT_IN_RANGE(2, 5), &Local_62, 1, 1077936128, 0)){
if(!CAM::IS_SPHERE_VISIBLE(Local_62, 7f) && vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_62) < 110f){
STREAMING::REQUEST_MODEL(iLocal_81);
...
iLocal_139=VEHICLE::CREATE_VEHICLE(iLocal_82, Local_62, func_155(Local_62, func_156(PLAYER::PLAYER_ID()), 1), 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOURS(iLocal_139, 134, 134);
VEHICLE::SET_VEHICLE_DIRT_LEVEL(iLocal_139, 0f);
iLocal_72=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_139, 26, iLocal_81, -1, 1, 1);
...
float func_155(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, int iParam4){
float fVar0;
float fVar1;
float fVar2;
...
}}elseif((iLocal_142 >=24 && iLocal_123 < 150000) || (iLocal_142 >=24 && iLocal_123 < 150000)){
...
if(!iLocal_133){
uLocal_145=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FRONTEND(uLocal_145, "VARIABLE_COUNTDOWN_CLOCK_wp", 0, 1);
...
AUDIO::PLAY_SOUND_FRONTEND(iLocal_145, "VARIABLE_COUNTDOWN_CLOCK_wp", 0, 1);
AUDIO::SET_VARIABLE_ON_SOUND(iLocal_145, "countdown_fadein", 35f);
AUDIO::START_AUDIO_SCENE("TIMER_SCENE");
iLocal_133=1;
}}}
...
bLocal_143=true;
}}elseif(iLocal_142==func_164(func_166()) && iLocal_141==func_165(func_166())){
bLocal_143=true;
}
if(bLocal_143){
func_54();
...
if(!HUD::DOES_BLIP_EXIST(uLocal_70)){
uLocal_70=func_131(Local_79, 0);
HUD::SET_BLIP_SPRITE(uLocal_70, 269);
func_178();
}}
if(iLocal_58==1){
if(!func_60()){
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_75);
iLocal_108++;
}}elseif(func_182(iLocal_71, PLAYER::PLAYER_PED_ID()) < 12f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_182(PLAYER::PLAYER_PED_ID(), iLocal_71) < 30f)){
fLocal_152=func_147(iLocal_71, PLAYER::PLAYER_PED_ID(), 1);
...
case 1:
if(HUD::DOES_BLIP_EXIST(uLocal_99)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_99, 1);
}
if(!PED::IS_PED_INJURED(iLocal_71)){
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_71, 5000, 2052, 2);
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
case 4:
if(!PED::IS_PED_INJURED(iLocal_71)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_182(iLocal_71, PLAYER::PLAYER_PED_ID()) < 25f){
if(func_127()){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)){
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_75);
iLocal_108++;
}}elseif(func_182(iLocal_71, PLAYER::PLAYER_PED_ID()) < 8f || (PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()) && func_182(PLAYER::PLAYER_PED_ID(), iLocal_71) < 30f)){
fLocal_152=func_147(iLocal_71, PLAYER::PLAYER_PED_ID(), 1);
fLocal_152=(fLocal_152 - 0.25f);
TASK::OPEN_SEQUENCE_TASK(&uLocal_75);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
...
case 4:
if(!PED::IS_PED_INJURED(iLocal_71)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_182(iLocal_71, PLAYER::PLAYER_PED_ID()) < 15f){
if(func_127()){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)){
if(VEHICLE::IS_VEHICLE_SEAT_FREE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0, 0)){
PED::SET_PED_AS_GROUP_MEMBER(iLocal_71, func_121());
...
iLocal_140=VEHICLE::GET_CLOSEST_VEHICLE(ENTITY::GET_ENTITY_COORDS(iLocal_71, 0), 18f, 0, 4);
}
if(iLocal_140 !=0){
iLocal_124++;
...
if(iLocal_124 > iVar0){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_140, 1, 0);
...
if((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -3024.265f, 660.8264f, 1.1982f, -3140.823f, 803.707f, 35.131f, 93f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_71)) || func_182(PLAYER::PLAYER_PED_ID(), iLocal_71) < 12f){
func_189();
iLocal_57=2;
}}}}elseif(iLocal_58==2){
if(!iLocal_135){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_76, 100f, 100f, 100f, 0, 1, 0) && !PED::IS_PED_INJURED(iLocal_71)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_75);
...
if(!iLocal_135){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_76, 200f, 200f, 200f, 0, 1, 0) && !PED::IS_PED_INJURED(iLocal_71)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_75);
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_71)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_71, 0)){
if((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_71, 95f, 95f, 50f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_71)) || func_182(PLAYER::PLAYER_PED_ID(), iLocal_71) < 12f){
func_189();
iLocal_57=2;
}}}}}
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_71, 0)){
uLocal_99=func_69(iLocal_71, 0, 145);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_99, 0);
}}
if(!func_222()){
func_197(1);
}
...
func_192(43, 1);
func_192(44, 1);
iLocal_71=PED::CREATE_PED(26, iLocal_80, Local_76, fLocal_78, 1, 1);
...
iLocal_139=VEHICLE::CREATE_VEHICLE(iLocal_82, -3088.068f, 730.4819f, 20.3028f, 332.2996f, 1, 1, 0);
...
TASK::TASK_PLAY_ANIM(iLocal_71, "random@hitch_lift", "idle_f", 2f, -2f, -1, 49, 0, 0, 0, 0);
PED::ADD_SCENARIO_BLOCKING_AREA(Local_77 - Vector(20f, 50f, 50f), Local_77 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
func_191(1);
}elseif(iLocal_58==3){
...
if(!bLocal_92){
if(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_71, 1), 10f, 1) || MISC::IS_PROJECTILE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_71, 1) - Vector(10f, 10f, 10f), ENTITY::GET_ENTITY_COORDS(iLocal_71, 1) + Vector(10f, 10f, 10f), 0)){
return 1;
}}elseif(PED::IS_PED_INJURED(iLocal_72) && ENTITY::DOES_ENTITY_EXIST(iLocal_72)){
...
int func_226(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4){
bool bVar0;
struct<3> Var1;
int iVar2;
struct<3> Var3;
...
PED::SET_PED_CAN_BE_TARGETTED(iLocal_71, 1);
if(PED::IS_PED_IN_GROUP(iLocal_71)){
PED::REMOVE_PED_FROM_GROUP(iLocal_71);
}}}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_72)){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_67, 1) < fVar0){
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_67, 1);
iLocal_63=5;
}
if(iLocal_63==1){
bLocal_68=true;
