...
if(func_14(iLocal_58, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f, 1)){
...
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_58, 0, 0);
...
if(func_17(iLocal_58)){
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_58, 0) 
};
if(!func_246(0)){
...
func_35(13, floor(Global_113648.f_10196.f_3853));
}
...
func_188(&uVar1, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
int func_242(struct<3> Param0, struct<3> Param1, int iParam2, float fParam3){
...
int func_250(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
...
if(iParam2==1){
if(func_325(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
...
void func_281(int iParam0, struct<3> Param1, var uParam2, int iParam3, bool bParam4){
struct<60> Var0;
...
func_315(iParam3, &Var0, Param1, uParam2, func_318(iParam0));
...
void func_315(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_312(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
int func_325(struct<3> Param0, int iParam1, var uParam2, var uParam3){
int iVar0;
...
int func_326(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
void func_329(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
func_330(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}


void func_330(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
int func_332(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
bool func_335(struct<3> Param0, int iParam1){
return func_336(Global_104212.f_2890.f_12.f_66, Param0, iParam1);
}

int func_336(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
struct<3> Var1;
if(iParam0==0){
return 0;
...
void func_338(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
int iVar0;
iVar0=PLAYER::GET_PLAYER_INDEX();
...
int func_367(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_368(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
int func_368(int iParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_179(iParam1)){
...
void func_370(var uParam0, var uParam1, struct<3> Param2, float fParam3){
func_4(uParam0);
...
void func_378(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11){
int iVar0;
iVar0=1;
...
int func_379(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5){
var uVar0;
var uVar1;
struct<97> Var2;
int iVar3;
...
void func_430(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_439(iParam0, uVar1[iVar3], 1) && func_438(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_319(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
