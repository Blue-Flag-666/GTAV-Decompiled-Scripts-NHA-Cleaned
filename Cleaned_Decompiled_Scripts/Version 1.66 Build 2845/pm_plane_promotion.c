...
uLocal_46=func_141(iLocal_237, 0, 0);
}
if(func_140(PLAYER::PLAYER_PED_ID(), iLocal_237, 1) > 300f){
func_143();
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_46)){
HUD::CLEAR_PRINTS();
HUD::REMOVE_BLIP(&uLocal_46);
}}}
if((((ENTITY::DOES_ENTITY_EXIST(iLocal_237) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_237, 0)) && ENTITY::IS_ENTITY_IN_AIR(iLocal_237)) && iLocal_241) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PLANES", 0, -1)){
if(!bLocal_242){
if(PAD::IS_CONTROL_JUST_PRESSED(0, 114)){
if(iLocal_240==-1 || (MISC::GET_GAME_TIMER() - iLocal_240) > 2000){
if(!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_248)){
uLocal_248=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_property_leaflet_drop", iLocal_237, 0f, -2f, -0.65f, 0f, 0f, 0f, 1f, 0, 0, 0);
fLocal_246=0f;
}
if(func_139("LEAFLET")){
HUD::CLEAR_HELP(1);
...
bLocal_242=true;
}}}elseif((MISC::GET_GAME_TIMER() - iLocal_240) > 3000){
bLocal_242=false;
}}elseif(GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_248)){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(uLocal_248, 0);
fLocal_246=0f;
}
if(GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_248)){
if(bLocal_242){
...
GRAPHICS::SET_PARTICLE_FX_LOOPED_EVOLUTION(uLocal_248, "spawn", fLocal_246, 0);
}
switch (iLocal_43){
case 0:
STREAMING::REQUEST_MODEL(joaat("stunt"));
if(STREAMING::HAS_MODEL_LOADED(joaat("stunt"))){
iLocal_237=Global_112358.f_222[0];
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_237)){
iLocal_237=VEHICLE::CREATE_VEHICLE(joaat("stunt"), Var0, 121.2244f, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_237, 1084227584);
}else{
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_237, 1, 1);
}
...
break;
case 3:
if(func_30(&uLocal_47, Local_36, -1067.083f, -2922.601f, 12.82418f, -1091.854f, -2965.403f, 23.94564f, 31.5625f, 1, iLocal_237, "LAND", "", "BK_PLANE", 1, 0, 1, -1) && !ENTITY::IS_ENTITY_IN_AIR(iLocal_237)){
func_135(&uLocal_47, 1, 0);
iLocal_43++;
}
break;
...
if((10 - iLocal_239) <=0){
iLocal_44++;
}elseif((func_26() && (MISC::GET_GAME_TIMER() - iLocal_45) > 5000) && iLocal_245){
...
if(iParam2==1){
if(func_131(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
}}
func_81(Global_104212.f_4, Param0, fParam1, 24, 0);
}}}}
...
func_117(iParam3, &Var0, Param1, uParam2, func_123(iParam0));
...
void func_117(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_114(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
bool func_124(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_131(struct<3> Param0, int iParam1, var uParam2, var uParam3){
int iVar0;
...
int func_132(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
