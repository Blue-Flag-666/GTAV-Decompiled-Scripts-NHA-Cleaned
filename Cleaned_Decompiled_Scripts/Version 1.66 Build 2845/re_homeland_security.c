...
case 1:
if(!func_143()){
if((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_59, 75f, 75f, 75f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_58)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_58, 15f, 15f, 15f, 0, 1, 0)){
if(!func_166()){
...
if(!PED::IS_PED_INJURED(iLocal_58) && VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_53, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_58, uLocal_53, 0)){
iLocal_103=1;
}
}
if(bLocal_104){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_53, 0)){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_58, uLocal_102);
...
elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_53, 0)){
...
elseif(!PED::IS_PED_INJURED(iLocal_50[1])){
...
}elseif(PED::CAN_PED_SEE_HATED_PED(iLocal_50[0], PLAYER::PLAYER_PED_ID()) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_50[0], PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0)){
}elseif(HUD::DOES_BLIP_EXIST(uLocal_89[0])){
HUD::REMOVE_BLIP(&(uLocal_89[0]));
}
if(PED::IS_PED_INJURED(iLocal_50[1])){
if(HUD::DOES_BLIP_EXIST(uLocal_89[1])){
HUD::REMOVE_BLIP(&(uLocal_89[1]));
}
func_113(&uLocal_120, 4);
}elseif(PED::CAN_PED_SEE_HATED_PED(iLocal_50[1], PLAYER::PLAYER_PED_ID()) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_50[1], PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0)){
}elseif(HUD::DOES_BLIP_EXIST(uLocal_89[1])){
HUD::REMOVE_BLIP(&(uLocal_89[1]));
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_50[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_50[1])){
if(((WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_50[0], joaat("weapon_stungun"), 0) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_50[1], joaat("weapon_stungun"), 0)) || (PED::IS_PED_DEAD_OR_DYING(iLocal_50[0], 1) && PED::IS_PED_DEAD_OR_DYING(iLocal_50[1], 1))) || func_112()){
if(HUD::DOES_BLIP_EXIST(uLocal_89[0])){
HUD::REMOVE_BLIP(&(uLocal_89[0]));
}
if(HUD::DOES_BLIP_EXIST(uLocal_89[1])){
...
if(!PED::IS_PED_INJURED(iLocal_58)){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_67, Global_22, 1, 1, 0) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_58, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0)){
if(PED::IS_PED_IN_GROUP(iLocal_58)){
if(HUD::DOES_BLIP_EXIST(uLocal_88)){
HUD::REMOVE_BLIP(&uLocal_88);
}
...
if(iLocal_47 !=6){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_115)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_115) > 0.85f){
...
iLocal_61=0;
}}}elseif(!iLocal_61 && AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()){
Local_63={
func_70() 
};
Local_62={
...
HUD::SET_BLIP_SPRITE(uLocal_91, 269);
func_99();
}}}}else{
if(!HUD::DOES_BLIP_EXIST(uLocal_88)){
uLocal_88=func_107(iLocal_58, 0, 145);
...
var func__102(struct<3> Param0, int iParam1){
var uVar0;
...
int func_106(){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
uLocal_86=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_86, 0)){
if(!PED::IS_PED_INJURED(iLocal_58)){
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_102);
TASK::TASK_PERFORM_SEQUENCE(iLocal_50[0], uLocal_102);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_102);
PED::SET_PED_KEEP_TASK(iLocal_50[0], 1);
if(HUD::DOES_BLIP_EXIST(uLocal_89[0])){
...
if((ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_50[1], "random@homelandsecurity", "idle_cop_ground", 3) || PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_115)) && !PED::IS_PED_RAGDOLL(iLocal_50[1])){
...
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_102);
TASK::TASK_PERFORM_SEQUENCE(iLocal_50[1], uLocal_102);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_102);
PED::SET_PED_KEEP_TASK(iLocal_50[1], 1);
iLocal_78=1;
}else{
...
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_115)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_115) > 0.98f){
if(!func_116()){
...
uLocal_115=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_115, iLocal_53, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_58, uLocal_115, "random@homelandsecurity", "exit_girl", 2f, -4f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_50[0], uLocal_115, "random@homelandsecurity", "exit_cop_gun", 2f, -4f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_50[1], uLocal_115, "random@homelandsecurity", "exit_cop_ground", 2f, -4f, 1, 0, 1148846080, 0);
...
func_128();
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_115)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_115) > 0.45f){
if((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_53, 0) && !PED::IS_PED_INJURED(iLocal_58)) && !PED::IS_PED_INJURED(iLocal_50[0])){
}}}
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_115)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_115) > 0.9f){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_53, 0)){
if(!PED::IS_PED_INJURED(iLocal_50[0])){
...
func_128();
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_115)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_115) > 0.95f){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_53, 0)){
if(!PED::IS_PED_INJURED(iLocal_50[1])){
...
elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_50[1], joaat("script_task_synchronized_scene")) !=1){
TASK::OPEN_SEQUENCE_TASK(&uLocal_102);
TASK::TASK_CLEAR_LOOK_AT(0);
...
return 1;
}}elseif((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_50[0], 0.5f, 0.5f, 5f, 0, 1, 1) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_50[1], 0.5f, 0.5f, 5f, 0, 1, 1)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_58, 0.5f, 0.5f, 5f, 0, 1, 1)){
return 1;
}}
return 0;
}
...
iLocal_92=0;
while (iLocal_92 <=1){
if(!HUD::DOES_BLIP_EXIST(uLocal_89[iLocal_92])){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_50[iLocal_92], 0)){
uLocal_89[iLocal_92]=func_107(iLocal_50[iLocal_92], 0, 145);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_89[iLocal_92], 0);
}}else{
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_89[iLocal_92], 1);
}
iLocal_92++;
}}
...
var uVar1;
if(!bLocal_99){
if(MISC::IS_PROJECTILE_IN_AREA(Local_54 - Vector(30f, 30f, 30f), Local_54 + Vector(30f, 30f, 30f), 1) || MISC::IS_BULLET_IN_BOX(Local_54 - Vector(30f, 30f, 30f), Local_54 + Vector(30f, 30f, 30f), 1)){
iLocal_48=2;
return 1;
}
if(!PED::IS_PED_INJURED(iLocal_50[0]) && !PED::IS_PED_INJURED(iLocal_50[1])){
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_53, 0)){
if(VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uVar1, iLocal_53)){
iLocal_48=2;
return 1;
}}}}
...
iLocal_48=4;
return 1;
}}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_58, PLAYER::PLAYER_PED_ID(), 1)){
iLocal_48=4;
return 1;
}}
return 0;
...
PED::ADD_SCENARIO_BLOCKING_AREA(Local_68 - Vector(20f, 20f, 20f), Local_68 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
...
iLocal_58=PED::CREATE_PED(26, iLocal_60, Local_59, 0, 1, 1);
...
iLocal_92=0;
while (iLocal_92 <=1){
iLocal_50[iLocal_92]=PED::CREATE_PED(6, iLocal_56, Local_51[iLocal_92 /*3*/], fLocal_52[iLocal_92], 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_50[iLocal_92], 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_56);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_50[iLocal_92], iLocal_119);
PED::SET_PED_CONFIG_FLAG(iLocal_50[iLocal_92], 42, 1);
iLocal_92++;
}
WEAPON::GIVE_WEAPON_TO_PED(iLocal_50[0], joaat("weapon_pistol"), -1, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_50[1], joaat("weapon_pistol"), -1, 0, 1);
...
iLocal_53=VEHICLE::CREATE_VEHICLE(iLocal_57, Local_54, fLocal_55, 1, 1, 0);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_57, 1);
...
uLocal_115=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_115, iLocal_53, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_58, uLocal_115, "random@homelandsecurity", "idle_girl", 4f, -2f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_50[0], uLocal_115, "random@homelandsecurity", "idle_cop_gun", 4f, -2f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_50[1], uLocal_115, "random@homelandsecurity", "idle_cop_ground", 4f, -2f, 1, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_115, 1);
}
...
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_57, 0);
}
iVar0=0;
while (iVar0 < iLocal_50){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_50[iVar0])){
...
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
TASK::TASK_AIM_GUN_AT_COORD(iLocal_50[iVar0], func_224(PLAYER::PLAYER_ID()), -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_50[iVar0], 1);
if(!PED::IS_PED_INJURED(iLocal_58)){
TASK::TASK_COWER(iLocal_58, -1);
PED::SET_PED_KEEP_TASK(iLocal_58, 1);
}}
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_50[iVar0], 0);
}
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_50[iVar0]));
}
iVar0++;
