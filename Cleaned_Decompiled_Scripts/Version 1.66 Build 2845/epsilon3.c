...
iLocal_263++;
}}elseif(func_2(&uLocal_86, "EPS3AUD", "EP3_FOLLOW", 8, 0, 0, 0)){
iLocal_260=MISC::GET_GAME_TIMER();
iLocal_263++;
}}}elseif((!HUD::IS_MESSAGE_BEING_DISPLAYED() && !func_240()) && (MISC::GET_GAME_TIMER() - iLocal_260) > iLocal_262){
...
elseif(func_2(&uLocal_86, "EPS3AUD", "EP3_AMB", 8, 0, 0, 0)){
iLocal_260=MISC::GET_GAME_TIMER();
iLocal_262=1000;
}}}}
if(func_239(Local_81.f_28[0])){
...
}}}elseif(PED::IS_PED_HEADTRACKING_PED(Local_81.f_28[0], PLAYER::PLAYER_PED_ID())){
TASK::TASK_CLEAR_LOOK_AT(Local_81.f_28[0]);
}
if(func_241(PLAYER::PLAYER_PED_ID(), Local_81.f_28[0], 1) >=100f && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 1), 3f)){
iLocal_84=3;
}
if((((((GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), 5f) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), 5f, 0)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), joaat("weapon_grenadelauncher"), 5f, 0)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), joaat("weapon_rpg"), 5f, 0)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), joaat("weapon_grenade"), 5f, 0)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), joaat("weapon_molotov"), 5f, 0)) || MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 0), joaat("weapon_flare"), 5f, 0)){
...
func_227(13, floor(Global_113648.f_10196.f_3853));
}
...
uVar0=Global_2805029[iParam0 /*3*/][func_96(iParam1)];
...
func_182(&uVar1, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
MemCopy(&Var3,{
func_234(Global_44465[iVar4 /*12*/].f_1)
}
, 4);
}else{
Var3={
...
iVar2=iVar5;
Var3={
func_234(Global_44465[iVar5 /*12*/].f_1) 
};
...
Var3={
func_234(Global_44465[iVar11 /*12*/].f_1) 
};
}}
if(!bParam4){
...
int func_257(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_239(iParam0)){
...
void func_258(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
int iVar0;
iVar0=PLAYER::GET_PLAYER_INDEX();
...
void func_261(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
...
int func_266(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
if(func_249(PLAYER::PLAYER_PED_ID())){
uLocal_258=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
}
if(func_249(Local_81.f_28[0])){
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_81.f_28[0], uLocal_258);
...
Var4={
func_295(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
if(func_320(&(uParam0->f_28[0]), 60, Var2, uVar3, "EPSILON LAUNCHER RC - MARNIE", 1)){
...
int func_320(var uParam0, int iParam1, struct<3> Param2, var uParam3, char* sParam4, int iParam5){
if(func_321(uParam0, iParam1, Param2, uParam3, 1)){
...
int func_321(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_16(iParam1)){
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_257, 0);
if(func_344()){}
