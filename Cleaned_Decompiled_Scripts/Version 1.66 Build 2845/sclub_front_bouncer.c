...
uLocal_242=PED::ADD_SCENARIO_BLOCKING_AREA(Vector(28.23271f, -1299.691f, 128.1264f) - Vector(2f, 1f, 1f), Vector(28.23271f, -1299.691f, 128.1264f) + Vector(2f, 1f, 1f), 0, 1, 1, 1);
func_118(0);
while (true){
func_115(&uLocal_244);
if(bLocal_240){
...
func_18(32);
if(!HUD::DOES_BLIP_EXIST(uLocal_243)){
uLocal_243=HUD::ADD_BLIP_FOR_ENTITY(iLocal_69);
HUD::SET_BLIP_COLOUR(uLocal_243, 1);
HUD::SET_BLIP_SCALE(uLocal_243, 0.7f);
}
return 1;
}
...
}}}elseif(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_69, 1)) < (10f * 10f)){
...
fVar2=func_42();
if(vdist(ENTITY::GET_ENTITY_COORDS(iLocal_69, 1), Var1) > 2f && TASK::GET_SCRIPT_TASK_STATUS(iLocal_69, joaat("script_task_follow_nav_mesh_to_coord")) !=1){
func_41(0);
}
switch (func_40()){
case 0:
if(vdist(ENTITY::GET_ENTITY_COORDS(iLocal_69, 1), Var1) > 0.3f){
...
if(CAM::IS_SPHERE_VISIBLE(func_34(), 1f) && vdist2(func_34(), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < (30f * 30f)){
return 0;
}}}
...
Local_239[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2=vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_69, 1));
}else{
