...
func_152(Global_113648.f_19975.f_3, &Var1, &uVar3, &uVar0, &uVar2);
if(Global_113648.f_19975.f_3 >=5 || uLocal_257){
func_151(iParam1, Var1, uVar3, iParam0);
...
if(HUD::DOES_BLIP_EXIST(uLocal_267)){
HUD::REMOVE_BLIP(&uLocal_267);
}
...
elseif(iLocal_265==joaat("towtruck2")){
...
Var3={
func_85(Var3, -Var0.f_3.f_2) 
};
Var3={
func_85(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__85(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
return (shift_right(iParam0, 26) & 31 * func_104(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
Local_51.f_2=1;
iLocal_245=start_new_script_with_args("Towing", &Local_51, 9, 54000);
SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("Towing");
...
case 1:
if(!func_145()){
if(!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_144(&uLocal_58)){
AUDIO::SET_FRONTEND_RADIO_ACTIVE(0);
func_142(&uLocal_58);
}elseif(!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_144(&uLocal_58)){
if(func_139(&uLocal_58) >=2f){
iLocal_70=0;
}}}
break;
case 0:
...
void func_151(int iParam0, struct<3> Param1, float fParam2, var uParam3){
float fVar0;
var uVar1;
int iVar2;
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_269)){
iLocal_269=VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Param1, uParam2, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("towtruck"));
iLocal_71=3;
}}}
break;
