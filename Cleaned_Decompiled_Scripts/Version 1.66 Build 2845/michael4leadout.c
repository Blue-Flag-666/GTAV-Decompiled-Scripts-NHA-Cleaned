...
return (shift_right(iParam0, 26) & 31 * func_37(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
if(!func_107() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_121(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
uVar0=Global_2805029[iParam0 /*3*/][func_157(iParam1)];
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_121(iParam0));
if(iVar11 > iVar10){
...
void func_229(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4){
int iVar0;
if(bParam4){
