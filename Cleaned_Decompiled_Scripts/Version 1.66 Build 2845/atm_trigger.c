...
if(func_98(ENTITY::GET_ENTITY_COORDS(iScriptParam_540, 1))){
func_99();
SCRIPT::TERMINATE_THIS_THREAD();
}
...
bVar2=true;
Local_505={
ENTITY::GET_ENTITY_COORDS(iScriptParam_540, 1) 
};
Local_505.f_2=(Local_505.f_2 + 1f);
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() !=4){
Local_510={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iScriptParam_540, Local_508) 
};
}else{
Local_510={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iScriptParam_540, Local_509) 
};
}
if(MISC::GET_GROUND_Z_FOR_3D_COORD(Local_510, &fVar3, 0, 0)){
...
if(!bVar6){
if(iLocal_529==-1){
func_70(&iLocal_529, 4, "FINH_ATMNEAR", 0, 0, 0, 0);
}
bVar4=true;
if(func_69(iLocal_529, 1)){
Global_44193=1;
while (!AUDIO::REQUEST_SCRIPT_AUDIO_BANK("ATM", 0, -1) && !func_64(iScriptParam_540, 1)){
wait(0);
}
wait(100);
StringCopy(&Var7, "", 64);
...
iLocal_507=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_510, ENTITY::GET_ENTITY_ROTATION(iScriptParam_540, 2), 2, 0, 0, 1065353216, 0, 1065353216);
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_507, &Var7, "exit", 8f, -4f, 5, 0, 1148846080, 0);
...
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_530) && !func_64(uParam2, 1)){
wait(0);
func_56();
func_55(uParam2);
}
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_531) && !func_64(uParam2, 1)){
wait(0);
func_56();
func_55(uParam2);
}
...
iLocal_527=0;
while (bVar4){
iLocal_527=(iLocal_527 + round((0f + (1000f * timestep()))));
func_40();
...
while (iLocal_537){
iLocal_537=0;
func_26(uParam2, iLocal_530, iParam1);
}}}
if(Global_78558){
func_25(iLocal_530);
}
...
fVar2=(1f + (Global_75829 * timestep()));
...
iLocal_536=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uVar0);
switch (*uParam1){
case 0:
switch (iLocal_536){
case 2:
...
uVar0=Global_2805029[iParam0 /*3*/][func_16(uParam1)];
...
}elseif(fLocal_519 !=PAD::GET_CONTROL_NORMAL(2, 239) || fLocal_520 !=PAD::GET_CONTROL_NORMAL(2, 240)){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SHOW_CURSOR");
...
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(iLocal_532, 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam1, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(3);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(to_float(Global_60536[iVar0]));
func_31("W_BA_BAL");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
iVar1=4;
iVar2=0;
...
iLocal_507=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_510, ENTITY::GET_ENTITY_ROTATION(uParam0, 2), 2, 0, 0, 1065353216, 0, 1065353216);
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_507, &sVar0, "enter", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_507);
...
iLocal_507=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_510, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, 0, 1, 1065353216, 0, 1065353216);
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_507, &sVar1, "base", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_507);
iLocal_506=2;
}
break;
...
switch (iVar6){
case 0:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_507, &sVar2, "idle_a", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_507);
StringCopy(&cLocal_511, "idle_a", 16);
iLocal_506=3;
break;
case 1:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_507, &sVar2, "idle_b", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_507);
StringCopy(&cLocal_511, "idle_b", 16);
iLocal_506=3;
break;
case 2:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_507, &sVar2, "idle_c", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_507);
StringCopy(&cLocal_511, "idle_c", 16);
iLocal_506=3;
break;
case 3:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_507, &sVar2, "idle_d", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_507);
...
iVar1=0;
iVar5=SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_526, &iVar1, &uVar2, &uVar3, &uVar4);
if(iVar5==2){
iLocal_525=0;
if(iVar1 !=0){
iLocal_526=0;
