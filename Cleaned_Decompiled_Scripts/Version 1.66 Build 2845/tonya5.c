...
if(!iLocal_998){
if(func_648()){
iLocal_1002=func_647();
if(!Global_94858){
if(iLocal_1002==0){
func_646(Local_1011, fLocal_1012, 1, 0);
}elseif(iLocal_1002==1){
func_646(404.1494f, -1630.793f, 28.2928f, 231.5304f, 1, 0);
}elseif(iLocal_1002==2){
func_646(Local_610, fLocal_611, 1, 0);
}}elseif(iLocal_1002==0){
func_646(404.1494f, -1630.793f, 28.2928f, 231.5304f, 1, 0);
}elseif(iLocal_1002==1){
func_646(404.1494f, -1630.793f, 28.2928f, 231.5304f, 1, 0);
}
...
iLocal_987=VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Local_991, fLocal_992, 1, 1, 0);
iLocal_674=iLocal_987;
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_674, 1, 0);
AUDIO::SET_VEH_RADIO_STATION(iLocal_674, "RADIO_03_HIPHOP_NEW");
MISC::CLEAR_AREA(Local_991, 25f, 1, 1, 0, 0);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_987)){
HUD::REMOVE_BLIP(&uLocal_557);
...
if(!iLocal_201){
if(!func_533()){
if(func_529(&uLocal_228, "TOWAUD", "TOW_HERE", 8, 0, 0, 0)){
if(!func_216(&uLocal_1005)){
func_542(&uLocal_1005);
}
iLocal_201=1;
}
...
if(!bLocal_993){
if(func_216(&uLocal_1005)){
if(func_213(&uLocal_1005) > 20f){
if(!func_533()){
if(func_529(&uLocal_228, "TOWAUD", "TOW_WAITING", 8, 0, 0, 0)){
func_392(&uLocal_1005);
}}}
}
}}}
}}else{
...
if(!iLocal_202){
if(!func_533()){
if(func_529(&uLocal_228, "TOWAUD", "TOW_CAR", 8, 0, 0, 0)){
iLocal_202=1;
}
}
}}else{
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)){
if(!func_533()){
if(func_529(&uLocal_228, "TOWAUD", "TOW_CARWAIT", 8, 0, 0, 0)){
iLocal_995=1;
}
}}}
}}}}
...
if(func_529(&uLocal_228, "TOWAUD", "TOW_JACK", 8, 0, 0, 0)){
iLocal_996=1;
}}}}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_556, 0)){
...
case 1:
if(!func_533()){
if(func_529(&uLocal_228, "TOWAUD", "TOW_CHAT", 8, 0, 0, 0)){
iLocal_1003=2;
}}
break;
case 2:
...
if(!func_216(&uLocal_1008)){
func_542(&uLocal_1008);
}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
...
case 2:
if(func_216(&uLocal_1008)){
if((func_213(&uLocal_1008) > 3f || (iLocal_1001 && !func_533())) || (func_312(PLAYER::PLAYER_PED_ID(), iLocal_556, 1) < 3.5f && !func_533())){
iLocal_982=1;
}}
break;
case 1:
...
uLocal_1004=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Local_990, 5f, 5f, 5f, 0f, 0, 7);
func_571();
...
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
func_572(23, 0);
PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(uLocal_1004);
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
iLocal_981=2;
iLocal_982=0;
break;
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_674)){
iLocal_674=VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Local_991, fLocal_992, 1, 1, 0);
