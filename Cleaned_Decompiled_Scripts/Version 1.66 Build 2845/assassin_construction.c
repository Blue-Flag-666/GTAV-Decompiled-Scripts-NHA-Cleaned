...
iLocal_140=100;
iLocal_141=3;
uLocal_744=HUD::GET_STANDARD_BLIP_ENUM_ID();
uLocal_745=HUD::GET_WAYPOINT_BLIP_ENUM_ID();
iLocal_920=-1;
fLocal_922=1f;
iLocal_938=1;
Local_946={
...
}elseif(iLocal_1174==2){
if(TASK::DOES_SCRIPTED_COVER_POINT_EXIST_AT_COORDS(-182.0891f, -1004.055f, 113.1355f)){
TASK::REMOVE_COVER_POINT(uLocal_1110);
}
uLocal_1110=TASK::ADD_COVER_POINT(-182.0891f, -1004.055f, 113.1355f, 341.2941f, 1, 2, 0, 0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(90f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
func_416(-182.1094f, -1004.058f, 113.1362f, 250.235f, 1, 0);
}elseif(iLocal_1174==3){
if(TASK::DOES_SCRIPTED_COVER_POINT_EXIST_AT_COORDS(-150.5964f, -945.8911f, 268.1318f)){
TASK::REMOVE_COVER_POINT(uLocal_1111);
}
uLocal_1111=TASK::ADD_COVER_POINT(-150.5964f, -945.8911f, 268.1318f, 231.5456f, 2, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_1187, 1, 0);
TASK::TASK_PUT_PED_DIRECTLY_INTO_COVER(iLocal_1187, Local_1217, -1, 0, 0, 0, 0, 0, 0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(90f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
func_416(Local_1217, fLocal_1218, 1, 0);
}elseif(iLocal_1174==4){
if(TASK::DOES_SCRIPTED_COVER_POINT_EXIST_AT_COORDS(-150.5964f, -945.8911f, 268.1318f)){
TASK::REMOVE_COVER_POINT(uLocal_1111);
}
...
if(func_415()){
func_414();
}}elseif(!PED::IS_PED_INJURED(iLocal_1187)){
func_1();
}
wait(0);
}}
...
case 5:
if(func_393()){
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_1177[0], 1);
iLocal_938=6;
}
break;
case 6:
...
return 1;
}elseif(iLocal_938 >=11){
if(iLocal_938==13){
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_1187, 1) 
};
if(!bLocal_1141){
if(Var0.f_2 < (Local_1200.f_2 - 50f) && ((ENTITY::DOES_ENTITY_EXIST(iLocal_1188) && !PED::IS_PED_INJURED(iLocal_1188)) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_1188, 0))){
return 1;
...
*uParam0=1;
return 1;
}}elseif(func_26(&uLocal_1112, Local_1197, "ASS_CS_RTNR", 250f)){
*uParam0=1;
return 1;
}}
return 0;
...
if(!HUD::IS_MESSAGE_BEING_DISPLAYED()){
if(func_30(&uLocal_142)){
if(func_27(&uLocal_142) > 15f){
return 1;
}}}}
return 0;
}
...
PED::SET_PED_COMBAT_ATTRIBUTES(Local_1102[3 /*19*/], 30, 1);
ENTITY::SET_ENTITY_COORDS(Local_1102[3 /*19*/], -119.0637f, -973.7914f, 292.04f, 1, 0, 0, 1);
...
iLocal_1162=10;
}elseif(iLocal_938 >=11 && iLocal_1162 < 4){
iLocal_1162=4;
}
switch (iLocal_1162){
case 0:
if(bLocal_1113){
if(!func_30(&uLocal_1233)){
func_67(&uLocal_1233);
}
elseif(func_27(&uLocal_1233) > 2f){
...
break;
case 7:
if(func_27(&uLocal_1233) > 12f){
if(PED::IS_PED_IN_COVER(iLocal_1187, 0) || func_45(&Local_1100, 6) < 4){
iLocal_1190=func_66(75f);
if(iLocal_1190 !=0){
if(PED::IS_PED_IN_COVER(iLocal_1187, 0)){
func_394(&uLocal_1259, 7, iLocal_1190, "OJAcsGUARD4", 0, 1);
...
if(WEAPON::IS_PED_ARMED(iLocal_1187, 6) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_1187, 0)){
...
fVar4=vdist2(Var1, ENTITY::GET_ENTITY_COORDS(Local_1102[iVar2 /*19*/], 1));
if(fVar4 < fVar3){
fVar3=fVar4;
...
case 1:
if(iLocal_1161 >=2){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_1188) || (!ENTITY::IS_ENTITY_DEAD(iLocal_1188, 0) && iLocal_938 < 13)){
...
if(iLocal_1161 >=5){
if(iLocal_938 < 13){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_1188) || !ENTITY::IS_ENTITY_DEAD(iLocal_1188, 0)){
...
if((fVar0 <=33f && PED::CAN_PED_SEE_HATED_PED(iParam0, iLocal_1187)) || (PED::IS_PED_IN_ANY_VEHICLE(iLocal_1187, 0) && fVar0 <=5f)){
return 1;
}}}}
return 0;
}
...
int func_76(){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_1187, -140.6299f, -1029.231f, 26.29815f, -109.2613f, -943.295f, 29.2294f, 107f, 0, 0, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_1187, -169.2749f, -1096.598f, 18.68888f, -142.4606f, -1029.005f, 27.31028f, 99.5f, 0, 0, 0)){
return 1;
}
return 0;
}
...
Global_113648.f_19965.f_9=func_27(&uLocal_1230);
...
uParam0->f_563=func_141((uParam0->f_563 + (((1f / 0.3f) * uParam0->f_577) * timestep())), 0f, 1f);
uParam0->f_577=func_141((uParam0->f_577 + 0.07f), 0.75f, 1.15f);
}}else{
uParam0->f_563=func_141((uParam0->f_563 - ((((1f / 0.3f) * uParam0->f_577) * 0.01f) * timestep())), 0f, 1f);
uParam0->f_577=func_141((uParam0->f_577 + 0.07f), 0.75f, 1.15f);
}
...
func_163();
GRAPHICS::DRAW_RECT(0.5f, (fVar1 - (func_166((2f - 0.5f)) - 0.001388889f)), fVar6, func_157(1f), uVar13, uVar14, uVar15, round((fVar12 * IntToFloat(iVar16))), 0);
}else{
return;
}
...
func_154(uParam0, iVar17, (fVar1 + func_166(2f)), fVar9, fVar10, round((IntToFloat(iVar0) * fVar12)));
}else{
return;
}
...
fVar12=func_141((fVar11 / (0.6f * func_166(25f))), 0f, 1f);
func_163();
GRAPHICS::DRAW_RECT(0.5f, (fVar1 + func_166((2f * 0.5f))), fVar6, func_157(1f), uVar13, uVar14, uVar15, round((fVar12 * IntToFloat(iVar16))), 0);
fVar1=(fVar1 + func_166((2f * 0.3f)));
if(uParam0->f_56 > 0){
fVar1=(fVar1 + func_166((25f * 0.2f)));
}}}}
...
if(Global_94858){
func_184(&uLocal_145, 6, &(Local_726.f_12), "MTPHPERSKI", floor(fLocal_129), 0, 3, 0);
func_184(&uLocal_145, 6, &(Local_726.f_24), "MTPHPERSKI", 0, 0, 3, 0);
func_184(&uLocal_145, 6, &(Local_726.f_30), "MTPHPERSKI", round((fLocal_131 + fLocal_130)), 0, 3, 0);
func_183();
}else{
if(bLocal_133){
func_184(&uLocal_145, 6, &(Local_726.f_12), "MTPHPERRET", floor(fLocal_129), 0, 3, 0);
}else{
func_184(&uLocal_145, 9, &(Local_726.f_12), "", floor(fLocal_129), 0, 0, 0);
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_726.f_18))){
if(bLocal_132){
func_184(&uLocal_145, 6, &(Local_726.f_24), "", 0, 0, 2, 0);
func_184(&uLocal_145, 3, &(Local_726.f_30), "", round((fLocal_131 + fLocal_130)), 0, 2, 0);
}else{
func_184(&uLocal_145, 6, &(Local_726.f_24), "", 0, 0, 1, 0);
func_184(&uLocal_145, 3, &(Local_726.f_30), "", round(fLocal_130), 0, 0, 0);
}}else{
func_184(&uLocal_145, 3, &(Local_726.f_30), "", round(fLocal_130), 0, 0, 0);
}}
iVar0=0;
...
func_181(38, floor(fLocal_129), 1);
if(bLocal_132){
func_181(39, 1, 1);
}else{
func_181(39, 0, 1);
...
if(bLocal_132){
func_181(40, round((fLocal_131 + fLocal_130)), 1);
}else{
func_181(40, round(fLocal_130), 1);
}
...
func_181(52, floor(fLocal_129), 1);
if(bLocal_132){
func_181(53, 1, 1);
}else{
func_181(53, 0, 1);
...
if(bLocal_132){
func_181(56, round((fLocal_131 + fLocal_130)), 1);
}else{
func_181(56, round(fLocal_130), 1);
}
...
func_181(66, floor(fLocal_129), 1);
if(bLocal_132){
func_181(67, 1, 1);
}else{
func_181(67, 0, 1);
...
if(bLocal_132){
func_181(68, round((fLocal_131 + fLocal_130)), 1);
}else{
func_181(68, round(fLocal_130), 1);
}
...
func_181(81, floor(fLocal_129), 1);
if(bLocal_132){
func_181(82, 1, 1);
}else{
func_181(82, 0, 1);
...
if(bLocal_132){
func_181(83, round((fLocal_131 + fLocal_130)), 1);
}else{
func_181(83, round(fLocal_130), 1);
}
...
func_181(97, floor(fLocal_129), 1);
if(bLocal_132){
func_181(98, 1, 1);
}else{
func_181(98, 0, 1);
...
if(bLocal_132){
func_181(99, round((fLocal_131 + fLocal_130)), 1);
}else{
func_181(99, round(fLocal_130), 1);
}
...
func_31(&uLocal_1254);
iLocal_1152=1;
}}}elseif(!iLocal_1153 && iLocal_1159==0){
if((func_27(&uLocal_1254) > 7f && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
...
iLocal_1159++;
}elseif(PED::GET_PED_PARACHUTE_STATE(iLocal_1187)==0){
...
EVENT::REMOVE_ALL_SHOCKING_EVENTS(0);
iLocal_1159++;
}elseif(!WEAPON::HAS_PED_GOT_WEAPON(iLocal_1187, joaat("gadget_parachute"), 0)){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1225, 0)){
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_1225, 1084227584);
}}
iLocal_1159++;
}else{
func_195();
...
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1188, 3, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_1188, 2, 0);
PED::SET_PED_KEEP_TASK(iLocal_1188, 1);
}}
...
MISC::CLEAR_AREA(Local_1200, 10f, 1, 0, 0, 0);
HUD::CLEAR_HELP(1);
settimera(0);
iLocal_1168++;
break;
case 1:
if(func_214(uLocal_1184[1], uLocal_1185[1], 152.2146f)){
iLocal_1168++;
}
break;
case 2:
if(timera() >=0){
func_219(&iLocal_1164);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_1187, 0);
HUD::DISPLAY_RADAR(0);
HUD::DISPLAY_HUD(0);
iLocal_1168++;
}
break;
case 3:
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1184[1])){
Var0={
ENTITY::GET_ENTITY_COORDS(uLocal_1184[1], 1) 
};
if(Var0.f_2 <=32f){
...
func_210(uLocal_1184[1], 0, 0, 0.25f, 1, 0, 1);
}}
break;
case 4:
func_219(&iLocal_1164);
...
if(bParam4){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_1187, 0)){
iVar2=PED::GET_VEHICLE_PED_IS_IN(iLocal_1187, 0);
}
if(iVar2==0){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_1187, 0)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_1187, iParam0, 0, Local_1212, 0f, 0f, fVar1, 0, 0, 1, 0, 2, 1, 0);
...
int iVar0;
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_1187, 0)){
iVar0=PED::GET_VEHICLE_PED_IS_IN(iLocal_1187, 0);
ENTITY::DETACH_ENTITY(iVar0, 1, 1);
}else{
ENTITY::DETACH_ENTITY(iLocal_1187, 1, 1);
}
func_219(&iLocal_1164);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1184[1])){
ENTITY::SET_ENTITY_COORDS(uLocal_1184[1], -158.84f, -942.24f, 31.44f, 1, 0, 0, 1);
}else{
uLocal_1184[1]=OBJECT::CREATE_OBJECT(iLocal_1181, -158.84f, -942.24f, 31.44f, 1, 1, 0);
ENTITY::SET_ENTITY_COORDS(uLocal_1184[1], -158.84f, -942.24f, 31.44f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_1184[1], Local_1202[1 /*3*/], 2, 1);
}
if(iVar0==0){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_1187, uLocal_1184[1], 0, Local_1212, 0f, 0f, 74.1208f, 0, 0, 1, 0, 2, 1, 0);
}else{
ENTITY::ATTACH_ENTITY_TO_ENTITY(iVar0, uLocal_1184[1], 0, 0.4f, -2.2f, -1.2f, 0f, 0f, 74.1208f, 0, 0, 0, 0, 2, 1, 0);
}
if(bParam0){}
if(iVar0 !=0){
ENTITY::DETACH_ENTITY(iVar0, 0, 0);
}else{
ENTITY::DETACH_ENTITY(iLocal_1187, 0, 0);
}
...
switch (iLocal_1160){
case 0:
TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, Local_1207), 1f, -1, fParam2, 1056964608);
iLocal_1160++;
break;
case 1:
if(TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), joaat("script_task_go_straight_to_coord")) !=1){
WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iLocal_1428, 1);
...
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_1176, "oddjobs@assassinate@construction@", "ig_1_button", 4f, -4f, 1, 0, 1148846080, 0);
iLocal_1160++;
}
break;
case 3:
...
if((((((func_35(iLocal_1187, Param0, 1) <=1.65f && !ENTITY::IS_ENTITY_IN_AIR(iLocal_1187)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && func_66(3f)==0) && !func_223()) && !PED::IS_PED_JUMPING(iLocal_1187)) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_1187, 0)){
return 1;
}
return 0;
}
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1226, 0) && !ENTITY::IS_ENTITY_DEAD(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1226, -1, 0), 0)){
TASK::TASK_HELI_MISSION(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1226, -1, 0), iLocal_1226, 0, iLocal_1187, 0f, 0f, 180f, 8, 20f, 30f, -1f, 325, 40, -1082130432, 0);
}else{
...
if(HUD::DOES_BLIP_EXIST(uLocal_1108)){
HUD::REMOVE_BLIP(&uLocal_1108);
}}
...
func_241(5);
func_240(0);
if((!ENTITY::IS_ENTITY_DEAD(iLocal_1188, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_1226, 0)) && !PED::IS_PED_IN_VEHICLE(iLocal_1188, iLocal_1226, 0)){
TASK::TASK_ENTER_VEHICLE(iLocal_1188, iLocal_1226, 20000, 0, 1073741824, 1, 0);
}
if(bLocal_1135){
...
if(!ENTITY::IS_ENTITY_DEAD(Local_1103[1 /*19*/], 0)){
TASK::TASK_COMBAT_PED(Local_1103[1 /*19*/], iLocal_1187, 0, 16);
}
if(!ENTITY::IS_ENTITY_DEAD(Local_1103[2 /*19*/], 0)){
...
void func_230(){
if(!iLocal_1132){
if(!ENTITY::IS_ENTITY_DEAD(Local_1102[3 /*19*/], 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_1102[3 /*19*/], PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_INJURED(Local_1102[3 /*19*/])){
ENTITY::APPLY_FORCE_TO_ENTITY(Local_1102[3 /*19*/], 1, 0f, -4f, 2f, 0f, 0.2f, 0f, 0, 1, 1, 1, 0, 1);
ENTITY::SET_ENTITY_COLLISION(Local_1102[3 /*19*/], 0, 0);
ENTITY::SET_ENTITY_HAS_GRAVITY(Local_1102[3 /*19*/], 1);
...
if(!ENTITY::IS_ENTITY_AT_COORD(Local_1102[3 /*19*/], Local_1195, 5f, 5f, 5f, 0, 1, 0)){
ENTITY::SET_ENTITY_COORDS(Local_1102[3 /*19*/], Local_1195, 1, 0, 0, 1);
iLocal_1133=1;
}}}}
switch (iLocal_1166){
case 0:
...
ENTITY::FREEZE_ENTITY_POSITION(Local_1102[3 /*19*/], 0);
...
uLocal_1163=MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000);
uLocal_1163=uLocal_1163;
iLocal_1166++;
}
break;
case 1:
if(!PED::IS_PED_INJURED(Local_1102[3 /*19*/])){
Local_1205={
ENTITY::GET_ENTITY_COORDS(Local_1102[3 /*19*/], 1) 
};
if(Local_1205.f_2 > 294f){
if(!ENTITY::IS_ENTITY_AT_COORD(Local_1102[3 /*19*/], Local_1195, 2f, 2f, 2f, 0, 1, 0)){
...
TASK::TASK_GO_STRAIGHT_TO_COORD(Local_1102[3 /*19*/], Local_1195, 2f, 20000, 1193033728, 1056964608);
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(Local_1102[3 /*19*/], joaat("script_task_shoot_at_entity")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(Local_1102[3 /*19*/], joaat("script_task_shoot_at_entity")) !=0){
TASK::TASK_SHOOT_AT_ENTITY(Local_1102[3 /*19*/], iLocal_1187, -1, joaat("FIRING_PATTERN_FULL_AUTO"));
}}}
break;
}}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1226)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1188)){
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1226, 0) || PED::IS_PED_INJURED(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1226, -1, 0))){
if(!iLocal_1136){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1226, 0)){
...
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_1226, 1, 1);
VEHICLE::SET_VEHICLE_OUT_OF_CONTROL(iLocal_1226, 1, 1);
...
iLocal_1136=1;
}}}elseif(iLocal_1130==0){
if(!PED::IS_PED_INJURED(iLocal_1188)){
if(PED::IS_PED_IN_VEHICLE(iLocal_1188, iLocal_1226, 0)){
iLocal_1130=1;
}}}else{
func_232();
}}}}
...
switch (iLocal_940){
case 0:
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1188, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_1226, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_1188, iLocal_1226, 0)){
VEHICLE::SET_HELI_BLADES_SPEED(iLocal_1226, 1f);
TASK::TASK_HELI_MISSION(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1226, -1, 0), iLocal_1226, 0, iLocal_1187, 0f, 0f, 10f, 9, 20f, 30f, -1f, 325, 40, -1082130432, 0);
}}
func_31(&uLocal_1242);
iLocal_940=1;
break;
...
if(!func_30(&uLocal_1245)){
func_31(&uLocal_1245);
}elseif(func_27(&uLocal_1245) > 45f){
TASK::TASK_HELI_MISSION(Local_1103[0 /*19*/], iLocal_1226, 0, iLocal_1187, 0f, 0f, 0f, 8, 30f, 300f, -1f, 325, 40, -1082130432, 0);
iLocal_940=2;
}
}
elseif(!func_30(&uLocal_1242)){
func_31(&uLocal_1242);
}
elseif(func_27(&uLocal_1242) > 180f){
TASK::TASK_HELI_MISSION(Local_1103[0 /*19*/], iLocal_1226, 0, iLocal_1187, 0f, 0f, 0f, 8, 30f, 300f, -1f, 325, 40, -1082130432, 0);
iLocal_940=2;
}}}}
break;
...
var uVar0;
if(!PED::IS_PED_INJURED(iLocal_1188)){
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1188, 3, 1);
TASK::OPEN_SEQUENCE_TASK(&uVar0);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
TASK::TASK_COWER(0, -1);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(iLocal_1188, uVar0);
...
PED::SET_PED_COMBAT_ATTRIBUTES(Local_1103[iVar0 /*19*/], 3, 1);
...
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1226, 1, 0) !=0){
iLocal_1192=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1226, 1, 0);
iLocal_1192=iLocal_1192;
}
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1226, 2, 0) !=0){
iLocal_1193=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1226, 2, 0);
}
if(VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_1226, 1, 0)){
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
TASK::OPEN_SEQUENCE_TASK(&uVar0);
TASK::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(0, iLocal_1226, 0);
TASK::TASK_COMBAT_PED(0, iLocal_1187, 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1193, 0)){
TASK::TASK_PERFORM_SEQUENCE(iLocal_1193, uVar0);
}
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
iLocal_1146=1;
}}}}
...
void func_237(){
if(func_30(&uLocal_1251)){
if(!iLocal_1258){
if(func_27(&uLocal_1251) >=12f){
func_238(5, 15);
func_238(6, 15);
iLocal_1258=1;
}}}else{
...
if(CAM::IS_SCREEN_FADED_IN()){
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_1102[iVar1 /*19*/], Local_1102[iVar1 /*19*/].f_10, 15f, 0, 0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
TASK::OPEN_SEQUENCE_TASK(&uVar0);
TASK::TASK_AIM_GUN_AT_ENTITY(0, iLocal_1187, 250, 0);
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, -141.3603f, -946.2284f, 268.135f, iLocal_1187, 2f, 1, 0.5f, 4f, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
TASK::TASK_COMBAT_PED(0, iLocal_1187, 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(Local_1102[iVar1 /*19*/], uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
PED::SET_PED_COMBAT_MOVEMENT(Local_1102[iVar1 /*19*/], 2);
PED::SET_PED_KEEP_TASK(Local_1102[iVar1 /*19*/], 1);
}}}elseif(iVar1==1){
if(!PED::IS_PED_INJURED(Local_1102[iVar1 /*19*/])){
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
TASK::OPEN_SEQUENCE_TASK(&uVar0);
...
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_1102[iVar1 /*19*/], Local_1102[iVar1 /*19*/].f_10, 10f, 0, 0);
PED::SET_PED_COMBAT_MOVEMENT(Local_1102[iVar1 /*19*/], 2);
PED::SET_PED_KEEP_TASK(Local_1102[iVar1 /*19*/], 1);
}}
iVar1++;
...
if(!bLocal_1128){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_1226)){
iLocal_1226=VEHICLE::CREATE_VEHICLE(iLocal_1182, Local_1213, fLocal_1214, 1, 1, 0);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1226, 1, 1, 0);
AUDIO::SET_VEHICLE_RADIO_ENABLED(iLocal_1226, 0);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_1226, 1, 1);
if(bParam0){
iLocal_1188=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1226, 26, iLocal_1177[0], 0, 1, 1);
}else{
iLocal_1188=PED::CREATE_PED(26, iLocal_1177[0], Local_1215, fLocal_1216, 1, 1);
}
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_1188);
func_394(&uLocal_1259, 3, iLocal_1188, "MAFIABOSS", 0, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_1188, 3, 0);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_1188, joaat("weapon_pistol"), -1, 1, 1);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_1188, 2);
PED::SET_PED_ACCURACY(iLocal_1188, 10);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_1188, 1, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_1188, iLocal_1229);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_1188, 1);
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_1226, "ASSASSINATION_CONSTRUCT_HELI_GROUP", 0);
func_241(6);
bLocal_1128=true;
}}}}
...
if((iVar0 % 2)==0){
Local_1098[iVar0 /*19*/]=PED::CREATE_PED(26, iLocal_1177[0], Local_1098[iVar0 /*19*/].f_10, Local_1098[iVar0 /*19*/].f_13, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(Local_1098[iVar0 /*19*/], 3, 0, MISC::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
}else{
Local_1098[iVar0 /*19*/]=PED::CREATE_PED(26, iLocal_1177[1], Local_1098[iVar0 /*19*/].f_10, Local_1098[iVar0 /*19*/].f_13, 1, 1);
}
if(iVar0==0){
TASK::TASK_PATROL(Local_1098[iVar0 /*19*/], "miss_Ass0", 1, 0, 1);
}elseif(iVar0==1){
TASK::TASK_PATROL(Local_1098[iVar0 /*19*/], "miss_Ass4", 1, 0, 1);
}elseif(iVar0==2){
TASK::TASK_GUARD_CURRENT_POSITION(Local_1098[iVar0 /*19*/], 10f, 10f, 1);
}elseif(iVar0==3){
TASK::TASK_PATROL(Local_1098[iVar0 /*19*/], "miss_Ass6", 1, 0, 1);
}elseif(iVar0==4){
TASK::TASK_PATROL(Local_1098[iVar0 /*19*/], "miss_Ass3", 1, 0, 1);
}
...
if(iVar0==0){
Local_1099[iVar0 /*19*/]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1224, 26, iLocal_1177[0], -1, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(Local_1099[iVar0 /*19*/], 3, 0, MISC::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
}
elseif(iVar0==1){
Local_1099[iVar0 /*19*/]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1224, 26, iLocal_1177[0], 0, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(Local_1099[iVar0 /*19*/], 3, 0, MISC::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
}
elseif(iVar0==2){
Local_1099[iVar0 /*19*/]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1224, 26, iLocal_1177[1], 1, 1, 1);
}
...
if(!ENTITY::DOES_ENTITY_EXIST(Local_1100[iVar0 /*19*/])){
if((iVar0 % 2)==0){
Local_1100[iVar0 /*19*/]=PED::CREATE_PED(26, iLocal_1177[0], Local_1100[iVar0 /*19*/].f_10, Local_1100[iVar0 /*19*/].f_13, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(Local_1100[iVar0 /*19*/], 3, 0, MISC::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
}else{
Local_1100[iVar0 /*19*/]=PED::CREATE_PED(26, iLocal_1177[1], Local_1100[iVar0 /*19*/].f_10, Local_1100[iVar0 /*19*/].f_13, 1, 1);
}
func_242(&Local_1100, iVar0, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_1100[iVar0 /*19*/], 50, 1);
AUDIO::STOP_PED_SPEAKING(Local_1100[iVar0 /*19*/], 1);
if(iVar0==0){
if(!PED::IS_PED_INJURED(Local_1100[iVar0 /*19*/])){
TASK::TASK_PLAY_ANIM(Local_1100[iVar0 /*19*/], "oddjobs@assassinate@construction@", "unarmed_fold_arms", 8f, -8f, -1, 1, 0, 0, 0, 0);
}}}
iVar0++;
}}elseif(iParam0==4){
iVar0=0;
...
if(!ENTITY::DOES_ENTITY_EXIST(Local_1101[iVar0 /*19*/])){
if((iVar0 % 2)==0){
Local_1101[iVar0 /*19*/]=PED::CREATE_PED(26, iLocal_1177[0], Local_1101[iVar0 /*19*/].f_10, Local_1101[iVar0 /*19*/].f_13, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(Local_1101[iVar0 /*19*/], 3, 0, MISC::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
TASK::TASK_AIM_GUN_AT_ENTITY(Local_1101[iVar0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0);
...
Local_1101[iVar0 /*19*/]=PED::CREATE_PED(26, iLocal_1177[1], Local_1101[iVar0 /*19*/].f_10, Local_1101[iVar0 /*19*/].f_13, 1, 1);
TASK::TASK_AIM_GUN_AT_ENTITY(Local_1101[iVar0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0);
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1184[1])){
if(iVar0==0){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_1101[iVar0 /*19*/], uLocal_1184[1], 0, Local_1212, 0f, 0f, 84.24f, 0, 0, 0, 0, 2, 1, 0);
func_394(&uLocal_1259, 4, Local_1101[iVar0 /*19*/], "OJAcsGUARD", 0, 1);
}elseif(iVar0==1){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_1101[iVar0 /*19*/], uLocal_1184[1], 0, -1.34f, -2.36f, -1.34f, 0f, 0f, 84.24f, 0, 0, 0, 0, 2, 1, 0);
...
if(!ENTITY::DOES_ENTITY_EXIST(Local_1102[iVar0 /*19*/])){
if((iVar0 % 2)==0){
Local_1102[iVar0 /*19*/]=PED::CREATE_PED(26, iLocal_1177[0], Local_1102[iVar0 /*19*/].f_10, Local_1102[iVar0 /*19*/].f_13, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(Local_1102[iVar0 /*19*/], 3, 0, MISC::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
}else{
Local_1102[iVar0 /*19*/]=PED::CREATE_PED(26, iLocal_1177[1], Local_1102[iVar0 /*19*/].f_10, Local_1102[iVar0 /*19*/].f_13, 1, 1);
}
if(iVar0==3){
TASK::TASK_AIM_GUN_AT_ENTITY(Local_1102[iVar0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 1);
ENTITY::FREEZE_ENTITY_POSITION(Local_1102[iVar0 /*19*/], 1);
}
func_242(&Local_1102, iVar0, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_1102[iVar0 /*19*/], 50, 1);
}
iVar0++;
}
bLocal_1127=true;
...
while (iVar0 <=2){
if(!ENTITY::DOES_ENTITY_EXIST(Local_1103[iVar0 /*19*/])){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1226, 0)){
if(iVar0==0){
Local_1103[iVar0 /*19*/]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1226, 26, iLocal_1177[0], -1, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(Local_1103[iVar0 /*19*/], 3, 0, MISC::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
WEAPON::GIVE_WEAPON_TO_PED(Local_1103[0 /*19*/], joaat("weapon_assaultrifle"), -1, 1, 1);
}elseif(iVar0==1){
Local_1103[1 /*19*/]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1226, 26, iLocal_1177[1], 2, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(Local_1103[1 /*19*/], joaat("weapon_carbinerifle"), -1, 1, 1);
}elseif(iVar0==2){
Local_1103[2 /*19*/]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1226, 26, iLocal_1177[0], 1, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(Local_1103[iVar0 /*19*/], 3, 0, MISC::GET_RANDOM_INT_IN_RANGE(1, 4), 0);
WEAPON::GIVE_WEAPON_TO_PED(Local_1103[2 /*19*/], joaat("weapon_carbinerifle"), -1, 1, 1);
}
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1103[iVar0 /*19*/], 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_1103[iVar0 /*19*/], 3, 0);
...
PED::SET_PED_COMBAT_ATTRIBUTES(Local_1103[iVar0 /*19*/], 50, 1);
PED::SET_PED_CONFIG_FLAG(Local_1103[iVar0 /*19*/], 115, 1);
}}
iVar0++;
}}}
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH((*uParam0)[iParam1 /*19*/], iLocal_1229);
...
int func_279(struct<3> Param0, char* sParam1, struct<3> Param2){
int iVar0;
int iVar1;
...
int func_287(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
Var3={
func_294(Var3, -Var0.f_3.f_2) 
};
Var3={
func_294(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__294(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
return (shift_right(iParam0, 26) & 31 * func_312(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
HUD::CLEAR_HELP(1);
PLAYER::SET_PLAYER_INVINCIBLE(PLAYER::PLAYER_ID(), 1);
MISC::CLEAR_AREA(Local_1199, 10f, 1, 0, 0, 0);
HUD::CLEAR_HELP(1);
settimera(0);
iLocal_1159++;
break;
...
func_210(uLocal_1184[1], 0, 0, fVar1, 1, 1, 1);
func_330();
}}
break;
case 4:
...
if(bParam0){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1184[1])){
ENTITY::SET_ENTITY_COORDS(uLocal_1184[1], -158.84f, -942.24f, 270.46f, 1, 0, 0, 1);
}else{
uLocal_1184[1]=OBJECT::CREATE_OBJECT(iLocal_1181, -158.84f, -942.24f, 270.46f, 1, 1, 0);
ENTITY::SET_ENTITY_COORDS(uLocal_1184[1], -158.84f, -942.24f, 270.46f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_1184[1], Local_1202[1 /*3*/], 2, 1);
}}
if(bParam1){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_1187, uLocal_1184[1], 0, Local_1212, 0f, 0f, 269f, 0, 0, 1, 0, 2, 1, 0);
ENTITY::DETACH_ENTITY(iLocal_1187, 0, 0);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
}
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_1185[1])){
uLocal_1185[1]=OBJECT::CREATE_OBJECT(iLocal_1183, Local_1203[1 /*3*/], 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_1185[1], uLocal_1184[1], 0, Local_1206, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}
...
WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_1428, 1);
WEAPON::GET_AMMO_IN_CLIP(PLAYER::PLAYER_PED_ID(), iLocal_1428, &iVar1);
iVar2=WEAPON::GET_MAX_AMMO_IN_CLIP(PLAYER::PLAYER_PED_ID(), iLocal_1428, 1);
...
if(PED::IS_PED_INJURED(Local_1101[iVar0 /*19*/])){
Var1={
ENTITY::GET_ENTITY_COORDS(Local_1101[iVar0 /*19*/], 0) 
};
if(MISC::GET_DISTANCE_BETWEEN_COORDS(Var1, Local_1199, 1) < 3.25f){
...
int iVar1;
if(!iLocal_1257){
if(func_30(&uLocal_1248)){
if(func_27(&uLocal_1248) >=12f){
func_238(3, 20);
func_238(4, 20);
iLocal_1257=1;
}}}
...
if(!HUD::DOES_BLIP_EXIST(uLocal_1109)){
uLocal_1109=HUD::ADD_BLIP_FOR_COORD(-154.799f, -941.62f, 269.1f);
HUD::SET_BLIP_ROUTE(uLocal_1109, 0);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_1109, "ASS_CS_TARGET");
}else{
HUD::SET_BLIP_COORDS(uLocal_1109, -154.799f, -941.62f, 269.1f);
}
if(iLocal_1162 < 4){
iLocal_1162=4;
}
...
ENTITY::CREATE_MODEL_HIDE(Local_1199, 5f, joaat("prop_conslift_lift"), 1);
func_337(0);
iLocal_1159++;
}
break;
...
TASK::TASK_COMBAT_PED((*uParam0)[iVar0 /*19*/], iLocal_1187, 0, 16);
}
iVar0++;
}}
...
if(Var0.f_2 >=115.5f){
func_210(uLocal_1184[1], 0, 0, 0.2f, 0, 0, 0);
if(Var0.f_2 >=117.8f){
}}else{
func_336();
func_219(&iLocal_1164);
...
while (iVar0 <=1){
if(!PED::IS_PED_INJURED(Local_1101[iVar0 /*19*/])){
ENTITY::DETACH_ENTITY(Local_1101[iVar0 /*19*/], 0, 0);
if(iVar0==0){
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_1101[iVar0 /*19*/], -145.5655f, -941.1028f, 113.2452f, 10f, 0, 0);
}elseif(iVar0==1){
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_1101[iVar0 /*19*/], -152.5679f, -947.0895f, 113.1339f, 10f, 0, 0);
}
PED::SET_PED_KEEP_TASK(Local_1101[iVar0 /*19*/], 1);
...
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Var2, iLocal_1187, 2f, 0, 0.5f, 0f, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
TASK::TASK_COMBAT_PED(0, iLocal_1187, 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uVar1);
TASK::TASK_PERFORM_SEQUENCE(Local_1101[iVar0 /*19*/], uVar1);
TASK::CLEAR_SEQUENCE_TASK(&uVar1);
}
iVar0++;
}}
...
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_1184[1])){
if(bParam0){
uLocal_1184[1]=OBJECT::CREATE_OBJECT(iLocal_1181, Local_1203[1 /*3*/], 1, 1, 0);
}else{
uLocal_1184[1]=OBJECT::CREATE_OBJECT(iLocal_1181, Local_1203[1 /*3*/], 1, 1, 0);
ENTITY::SET_ENTITY_COORDS(uLocal_1184[1], -158.84f, -942.24f, 125.8f, 1, 0, 0, 1);
}
ENTITY::SET_ENTITY_ROTATION(uLocal_1184[1], Local_1202[1 /*3*/], 2, 1);
}else{
ENTITY::SET_ENTITY_COORDS(uLocal_1184[1], -158.84f, -942.24f, 125.8f, 1, 0, 0, 1);
...
float fVar2;
uVar0=uVar0;
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1184[0])){
Var1={
ENTITY::GET_ENTITY_COORDS(uLocal_1184[0], 1) 
};
}
switch (iLocal_1159){
case 0:
...
break;
case 1:
if(func_214(uLocal_1184[0], uLocal_1185[0], 264.1952f)){
iLocal_1159++;
}
break;
case 2:
...
ENTITY::DETACH_ENTITY(PED::GET_VEHICLE_PED_IS_IN(iLocal_1187, 0), 0, 0);
}
settimera(0);
func_219(&iLocal_1164);
iLocal_1159++;
...
func_210(uLocal_1184[0], 0, 0, fVar2, 1, 1, 1);
if(Var1.f_2 >=113.8f){
if(!bLocal_1113){
...
func_219(&iLocal_1164);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1184[0])){
ENTITY::SET_ENTITY_COORDS(uLocal_1184[0], -182.17f, -1016.09f, 115.46f, 1, 0, 0, 1);
}else{
uLocal_1184[0]=OBJECT::CREATE_OBJECT(iLocal_1181, -182.17f, -1016.09f, 115.46f, 1, 1, 0);
ENTITY::SET_ENTITY_COORDS(uLocal_1184[0], -182.17f, -1016.09f, 115.46f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_1184[0], Local_1202[0 /*3*/], 2, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_1184[0], 1, 1);
}
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_1185[0]) && ENTITY::DOES_ENTITY_EXIST(uLocal_1184[0])){
uLocal_1185[0]=OBJECT::CREATE_OBJECT(iLocal_1183, Local_1203[0 /*3*/], 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_1185[0], uLocal_1184[0], 0, Local_1206, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}
if(bParam0){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_1187, uLocal_1184[0], 0, Local_1212, 0f, 0f, 340f, 0, 0, 1, 0, 2, 1, 0);
ENTITY::DETACH_ENTITY(iLocal_1187, 0, 0);
...
if(iVar0==0){
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_1100[iVar0 /*19*/], Local_1100[iVar0 /*19*/].f_10, 10f, 0, 0);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_1100[iVar0 /*19*/], 1, 1);
}elseif(iVar0==1){
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_1100[iVar0 /*19*/], Local_1100[iVar0 /*19*/].f_10, 10f, 0, 0);
}elseif(iVar0==2){
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_1100[iVar0 /*19*/], -151.3457f, -948.0886f, 113.1339f, 10f, 0, 0);
}elseif(iVar0==3){
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_1100[iVar0 /*19*/], -145.5338f, -986.0398f, 113.1282f, 10f, 0, 0);
}elseif(iVar0==4){
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_1100[iVar0 /*19*/], -139.7715f, -968.064f, 113.1339f, 10f, 0, 0);
}elseif(iVar0==5){
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_1100[iVar0 /*19*/], -154.0288f, -960.1566f, 113.1317f, 10f, 0, 0);
}
TASK::OPEN_SEQUENCE_TASK(&uVar1);
if(iVar0==0){
...
TASK::TASK_COMBAT_PED(0, iLocal_1187, 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uVar1);
TASK::TASK_PERFORM_SEQUENCE(Local_1100[iVar0 /*19*/], uVar1);
TASK::CLEAR_SEQUENCE_TASK(&uVar1);
PED::SET_PED_COMBAT_MOVEMENT(Local_1100[iVar0 /*19*/], 2);
PED::SET_COMBAT_FLOAT(Local_1100[iVar0 /*19*/], 13, 3f);
PED::SET_PED_KEEP_TASK(Local_1100[iVar0 /*19*/], 1);
}}
iVar0++;
}}
...
if(!HUD::DOES_BLIP_EXIST(uLocal_1109)){
uLocal_1109=HUD::ADD_BLIP_FOR_COORD(-184.599f, -1015.819f, 254.2567f);
HUD::SET_BLIP_ROUTE(uLocal_1109, 0);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_1109, "ASS_CS_TARGET");
}
iLocal_1159++;
...
if(iLocal_1225 !=0){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1225, 0)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_1225, 1, 0);
}
}
...
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_1098[iVar0 /*19*/], -176.2501f, -1026.913f, 26.2752f, 25f, 0, 0);
...
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_1224, 1) 
};
...
if(!iLocal_1119){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1224)){
if(((bLocal_1113 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_1187, -125.446f, -999.097f, 27.228f, -173.264f, -1095.935f, 27.228f, 98f, 0, 0, 0)) || (bLocal_1113 && func_38(iLocal_1224, 1) < 50f)) || (bLocal_1113 && func_34(Local_1198, 0) < 50f)){
func_345();
iLocal_1119=1;
}}}else{
func_344();
...
if(!bLocal_1118){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1224, 0)){
if(((((!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1224) || PED::IS_PED_INJURED(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1224, -1, 0))) || func_35(iLocal_1224, -177.2643f, -1036.083f, 26.2322f, 0) <=8f) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_1224, 0, 3000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_1224, 2, 3000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_1224, 3, 3000)){
...
while (iVar0 <=2){
if(!PED::IS_PED_INJURED(Local_1099[iVar0 /*19*/])){
if(Local_1099[iVar0 /*19*/]==VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1224, -1, 0)){
if(!AUDIO::IS_AUDIO_SCENE_ACTIVE("ASSASSINATION_CONSTRUCT_CAR_ARRIVES")){
AUDIO::START_AUDIO_SCENE("ASSASSINATION_CONSTRUCT_CAR_ARRIVES");
}
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_1099[iVar0 /*19*/], iLocal_1224, "OJAScs_101", 52, 0, 0, -1, -1082130432, 0, 1073741824);
...
PED::SET_PED_COMBAT_ATTRIBUTES(Local_1099[iVar1 /*19*/], 3, 1);
if(iVar1 !=2){
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_1099[iVar1 /*19*/], Local_1098[3 /*19*/].f_10, 10f, 0, 0);
...
TASK::TASK_COMBAT_PED(0, iLocal_1187, 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(Local_1099[iVar1 /*19*/], uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
}
iVar1++;
}
...
void func_348(){
uLocal_1184[0]=OBJECT::CREATE_OBJECT(iLocal_1181, Local_1203[0 /*3*/], 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(uLocal_1184[0], Local_1202[0 /*3*/], 2, 1);
uLocal_1185[0]=OBJECT::CREATE_OBJECT(iLocal_1183, Local_1203[0 /*3*/], 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_1185[0], uLocal_1184[0], 0, Local_1206, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}
...
switch (iLocal_1159){
case 0:
if((func_353(5f, 0) && STREAMING::IS_SRL_LOADED()) || ((func_353(1084227584, 1) && func_30(&uLocal_1254)) && func_27(&uLocal_1254) > 15f)){
if(!iLocal_1143){
uLocal_1167=VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(-69.7777f, -923.6335f, 28.2933f, 10f, 0f, 0);
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
iLocal_1227=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1227)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1227, 0)){
AUDIO::SET_VEH_RADIO_STATION(iLocal_1227, "OFF");
}}
}}
func_352(1);
if(!PED::IS_PED_INJURED(iLocal_1188)){
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_1188, 1, 0);
TASK::TASK_PLAY_ANIM(iLocal_1188, "oddjobs@assassinate@construction@", "CS_GetInLift", 1000f, -4f, 9500, 0, 0, 0, 0, 0);
}
if(!PED::IS_PED_INJURED(iLocal_1189)){
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_1189, 1, 0);
TASK::TASK_PLAY_ANIM(iLocal_1189, "oddjobs@assassinate@construction@", "idle_a", 1000f, -4f, -1, 1, 0, 0, 0, 0);
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1184[1])){
if(!PED::IS_PED_INJURED(iLocal_1188)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_1188, uLocal_1184[1], 0, -1.75f, -1.88f, -1.3f, 0f, 0f, 84.2f, 0, 0, 0, 0, 2, 1, 0);
}}
uLocal_1155=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -147.5668f, -958.6139f, 114.8839f, -1.648425f, -0.29868f, 24.55094f, 31.35205f, 0, 2);
uLocal_1156=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -147.2354f, -957.6655f, 114.8667f, -1.648426f, -0.29868f, 25.52002f, 31.35205f, 0, 2);
CAM::SHAKE_CAM(uLocal_1155, "HAND_SHAKE", 0.2f);
CAM::SHAKE_CAM(uLocal_1156, "HAND_SHAKE", 0.2f);
iLocal_1143=1;
}else{
...
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_1156, uLocal_1155, 4800, 0, 1);
...
if(timera() >=4800){
CAM::SET_CAM_PARAMS(uLocal_1155, -152.6485f, -944.8f, 114.2028f, 2.386309f, -0.295268f, 43.69577f, 31.34258f, 0, 1, 1, 2);
CAM::SET_CAM_PARAMS(uLocal_1156, -152.7505f, -944.6934f, 114.2089f, 2.386309f, -0.295268f, 43.69577f, 31.34258f, 0, 1, 1, 2);
CAM::SHAKE_CAM(uLocal_1155, "HAND_SHAKE", 0.2f);
CAM::SHAKE_CAM(uLocal_1156, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_1156, uLocal_1155, 6000, 0, 1);
iLocal_1159++;
}
STREAMING::OVERRIDE_LODSCALE_THIS_FRAME(1f);
break;
...
STREAMING::SET_SRL_TIME(to_float(timera()));
if(timera() >=7500){
CAM::SET_CAM_PARAMS(uLocal_1155, -165.2002f, -938.0276f, 113.4667f, 4.389886f, 0.213688f, -112.1127f, 32.21227f, 0, 1, 1, 2);
CAM::SET_CAM_PARAMS(uLocal_1156, -164.6229f, -937.1241f, 113.4675f, 77.82435f, 0.213692f, -131.0643f, 32.21227f, 0, 1, 1, 2);
CAM::SHAKE_CAM(uLocal_1155, "HAND_SHAKE", 0.2f);
CAM::SHAKE_CAM(uLocal_1156, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_1156, uLocal_1155, 4250, 1, 1);
func_219(&iLocal_1164);
iLocal_1159++;
}
STREAMING::OVERRIDE_LODSCALE_THIS_FRAME(1f);
...
func_210(uLocal_1184[1], 0, 0, fVar1, 0, 1, 1);
break;
case 4:
if(!iLocal_967){
if(func_350()){
...
fVar1=func_351(Var0.f_2, (Local_1203[1 /*3*/].f_2 + 7.5f), (Local_1203[1 /*3*/].f_2 + 2.763f), 0.1f, 0.25f);
func_210(uLocal_1184[1], 0, 0, 0.25f, 0, 1, 1);
break;
}
if(iLocal_1159 >=2){
if(!iLocal_1120){
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_1188)){
if(bParam0){
iLocal_1188=PED::CREATE_PED(26, iLocal_1177[0], -153.2591f, -941.5044f, 113.1339f, 263f, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_1188);
func_394(&uLocal_1259, 3, iLocal_1188, "MAFIABOSS", 0, 1);
iLocal_1189=PED::CREATE_PED(26, iLocal_1177[1], -153.6352f, -942.8479f, 113.1339f, 66f, 1, 1);
PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_1189, 0);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_1189, joaat("weapon_smg"), -1, 1, 1);
}
if(!PED::IS_PED_INJURED(iLocal_1189)){
...
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 0);
}elseif(func_27(&uLocal_124) > 1f || iParam1==0){
return 1;
}}
return 0;
}
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_1211, 5f, 5f, 2f, 1, 1, 0)){
}
...
iLocal_1142=1;
}}elseif(func_34(Local_1211, 1) > 120f){
...
Local_1104[0 /*19*/]=PED::CREATE_PED(26, iLocal_1177[1], -111.9202f, -943.5192f, 28.2288f, 344.7112f, 1, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_1104[0 /*19*/], 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_1104[0 /*19*/], 50, 1);
PED::STOP_PED_WEAPON_FIRING_WHEN_DROPPED(Local_1104[0 /*19*/]);
func_361(0);
}
if(!ENTITY::DOES_ENTITY_EXIST(Local_1104[1 /*19*/])){
Local_1104[1 /*19*/]=PED::CREATE_PED(26, iLocal_1177[1], -197.8959f, -1078.97f, 20.6882f, 166.4473f, 1, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_1104[1 /*19*/], 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_1104[1 /*19*/], 50, 1);
PED::STOP_PED_WEAPON_FIRING_WHEN_DROPPED(Local_1104[1 /*19*/]);
func_361(1);
}
if(!ENTITY::DOES_ENTITY_EXIST(Local_1104[2 /*19*/])){
Local_1104[2 /*19*/]=PED::CREATE_PED(26, iLocal_1177[1], -82.0262f, -1023.124f, 27.3748f, 269.8311f, 1, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_1104[2 /*19*/], 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_1104[2 /*19*/], 50, 1);
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1104[iParam0 /*19*/], 1);
WEAPON::GIVE_WEAPON_TO_PED(Local_1104[iParam0 /*19*/], joaat("weapon_microsmg"), -1, 0, 1);
PED::SET_PED_COMBAT_MOVEMENT(Local_1104[iParam0 /*19*/], 2);
PED::SET_PED_COMBAT_RANGE(Local_1104[iParam0 /*19*/], 2);
TASK::TASK_PLAY_ANIM(Local_1104[iParam0 /*19*/], "oddjobs@assassinate@construction@", "unarmed_fold_arms", 8f, -4f, -1, 1, 0, 0, 0, 0);
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
iLocal_1228=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1228) && !ENTITY::IS_ENTITY_DEAD(iLocal_1228, 0)){
...
if(vdist2(Var0, Local_946) > 10000f){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_944)){
...
ENTITY::SET_ENTITY_VISIBLE(iLocal_943, 1, 0);
ENTITY::SET_ENTITY_COLLISION(iLocal_943, 1, 0);
}}}
...
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_1194, 0)){
if(func_39(iLocal_1194, iLocal_1187, 1) > 5f){
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_1194, iLocal_1187, iLocal_1187, 2f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
}
else{
TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_1194, iLocal_1187, -1, 0);
}}}}elseif(func_27(&uLocal_1239) > 0.25f){
bLocal_1113=true;
iLocal_941=2;
}
break;
...
int func_367(){
int iVar0;
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1187, 0)){
if(((ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_1187, -113.319f, -941.315f, -100f, -171.373f, -1095.764f, 100f, 100f, 0, 0, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_1187, Local_1209[0 /*3*/], Local_1208[0 /*3*/], fLocal_1210[0], 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_1187, Local_1209[1 /*3*/], Local_1208[1 /*3*/], fLocal_1210[1], 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_1187, Local_1209[2 /*3*/], Local_1208[2 /*3*/], fLocal_1210[2], 0, 1, 0)){
bLocal_1139=true;
}else{
bLocal_1139=false;
}}
...
TASK::TASK_PLAY_ANIM(Local_1104[iVar0 /*19*/], "oddjobs@assassinate@construction@", "unarmed_fold_arms", 4f, -4f, -1, 1, 0, 0, 0, 0);
iLocal_1105[iVar0]=0;
}
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_1187, Local_1209[0 /*3*/], Local_1208[0 /*3*/], fLocal_1210[0], 0, 1, 0)){
iLocal_1170=0;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_1187, Local_1209[1 /*3*/], Local_1208[1 /*3*/], fLocal_1210[1], 0, 1, 0)){
iLocal_1170=1;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_1187, Local_1209[2 /*3*/], Local_1208[2 /*3*/], fLocal_1210[2], 0, 1, 0)){
iLocal_1170=2;
}else{
iLocal_1170=-1;
}
if(iLocal_1170 !=-1){
if(!func_30(&uLocal_1236)){
func_67(&uLocal_1236);
}
else{
func_31(&uLocal_1236);
...
case 2:
if(func_30(&uLocal_1236)){
if(func_27(&uLocal_1236) > IntToFloat(iLocal_1171)){
...
if(!PED::IS_PED_INJURED(Local_1104[iLocal_1170 /*19*/])){
TASK::TASK_AIM_GUN_AT_ENTITY(Local_1104[iLocal_1170 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 1);
...
case 4:
if(func_30(&uLocal_1236)){
if(func_27(&uLocal_1236) > IntToFloat(iLocal_1172)){
if(bLocal_1139){
func_394(&uLocal_1259, 8, Local_1104[iLocal_1170 /*19*/], "OJAScsWARN1", 0, 1);
...
iVar0=0;
while (iVar0 < 3){
if(!ENTITY::IS_ENTITY_DEAD(Local_1104[iVar0 /*19*/], 0)){
...
func_32(&uLocal_1230, Global_113648.f_19965.f_9);
}
if(iLocal_1174==0){
func_386();
}elseif(iLocal_1174==1){
...
if(!HUD::DOES_BLIP_EXIST(uLocal_1108)){
uLocal_1108=func_373(Local_1211, 1);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_1108, "ASS_CS_STATION");
func_372(&uLocal_1108, -79.8767f, -917.7642f, 28.1898f, 269.6892f);
if(bParam0){
...
void func_372(var uParam0, struct<3> Param1, float fParam2){
if(HUD::DOES_BLIP_EXIST(*uParam0)){
...
var func__373(struct<3> Param0, int iParam1){
var uVar0;
...
ENTITY::SET_ENTITY_COORDS(Local_1100[0 /*19*/], -152.2697f, -1003.765f, 113.1382f, 1, 0, 0, 1);
}
func_340();
func_339(0);
...
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_1187, 1, 0);
TASK::TASK_PUT_PED_DIRECTLY_INTO_COVER(iLocal_1187, -182.1094f, -1004.058f, 113.1362f, -1, 0, 0, 0, 0, 0, 0);
func_376(0, -1, 1);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(90f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
...
if(iLocal_1427 !=0){
WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), iLocal_1427, 0, 0, 0);
}else{
iLocal_1427=WEAPON::GET_BEST_PED_WEAPON(PLAYER::PLAYER_PED_ID(), 0);
WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), iLocal_1427, 0, 0, 0);
}}
...
void func_387(){
if(!OBJECT::DOES_PICKUP_EXIST(uLocal_1425)){
iLocal_1175=0;
MISC::SET_BIT(&iLocal_1175, 3);
MISC::SET_BIT(&iLocal_1175, 4);
uLocal_1425=OBJECT::CREATE_PICKUP(joaat("pickup_parachute"), -140.6149f, -945.9811f, 268.1331f, iLocal_1175, 1, 1, 0);
if(!OBJECT::DOES_PICKUP_EXIST(uLocal_1426)){
uLocal_1426=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_parachute"), -149.709f, -966.41f, 269.23f, 87f, 22f, 90f, 0, -1, 2, 1, 0);
}}}


void func_388(){
if(!OBJECT::DOES_PICKUP_EXIST(uLocal_1424)){
uLocal_1424=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_health_standard"), -170.47f, -1016.089f, 114.537f, 0f, 0f, 65f, 0, -1, 2, 1, 0);
}}
...
while (iVar0 < 5){
if(bParam0){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1186[iVar0])){
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(uLocal_1186[iVar0]));
}}elseif(!ENTITY::DOES_ENTITY_EXIST(uLocal_1186[iVar0])){
uLocal_1186[iVar0]=OBJECT::CREATE_OBJECT(joaat("prop_conc_blocks01a"), Var1[iVar0 /*3*/], 1, 1, 0);
ENTITY::SET_ENTITY_HEADING(uLocal_1186[iVar0], fVar2[iVar0]);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_1186[iVar0], 1);
}
iVar0++;
}}
...
iLocal_1223=VEHICLE::CREATE_VEHICLE(iLocal_1178, Local_1196, fLocal_1157, 1, 1, 0);
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_1224)){
iLocal_1224=VEHICLE::CREATE_VEHICLE(iLocal_1179, -130.3431f, -1096.441f, 21.3323f, 337f, 1, 1, 0);
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_1224, "ASSASSINATION_CONSTRUCT_CAR_GROUP", 0);
}}


void func_392(){
uLocal_1155=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -150.9599f, -944.2627f, 114.3693f, 3.6074f, -0.2888f, 15.6398f, 50f, 0, 2);
uLocal_1156=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -150.6499f, -945.0825f, 114.3487f, 1.2634f, -0.2776f, 28.5068f, 50f, 0, 2);
}
...
if(!func_30(&uLocal_957)){
func_67(&uLocal_957);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_943)){
ENTITY::SET_ENTITY_VISIBLE(iLocal_943, 0, 0);
ENTITY::SET_ENTITY_COLLISION(iLocal_943, 0, 0);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(iLocal_943, 0);
iLocal_944=OBJECT::CREATE_OBJECT(joaat("p_phonebox_01b_s"), 809.3085f, -1074.928f, 27.6018f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_944, 0f, 0f, 0.091681f, 2, 1);
ENTITY::SET_ENTITY_COLLISION(iLocal_944, 0, 0);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(iLocal_944, 0);
ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 1, 0);
}
uLocal_1097=STREAMING::STREAMVOL_CREATE_SPHERE(809.3085f, -1074.928f, 27.6018f, 350f, 12, 127);
func_202(1, 1, 1, 0, 0, 0, 0);
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_947, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), fLocal_948);
WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), 1);
PED::REMOVE_PED_HELMET(PLAYER::PLAYER_PED_ID(), 1);
}
uLocal_970=PED::CREATE_SYNCHRONIZED_SCENE(Local_968, Local_969, 2);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_944)){
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_970, iLocal_944, -1);
}
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_970, "oddjobs@assassinate@construction@call", "ass_construction_call_p1", 1000f, -2f, 2, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_944, iLocal_970, "ass_construction_call_phone", "oddjobs@assassinate@construction@call", 1000f, -2f, 0, 1148846080);
GRAPHICS::REMOVE_PARTICLE_FX_IN_RANGE(Local_947, 5f);
if(!CAM::DOES_CAM_EXIST(uLocal_945)){
uLocal_945=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Local_952, Local_953, 34.0542f, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
CAM::SHAKE_CAM(uLocal_945, "HAND_SHAKE", 0.2f);
}
func_394(&uLocal_1259, 3, 0, "LESTER", 0, 1);
...
STREAMING::REQUEST_MODEL(joaat("p_phonebox_01b_s"));
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_943)){
iLocal_943=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_946, 5f, joaat("prop_phonebox_01b"), 1, 0, 1);
}}}
break;
case 1:
func_403();
if(func_30(&uLocal_954)){
if(func_27(&uLocal_954) > 1f){
if(func_199()){
bLocal_960=true;
if(!CAM::IS_SCREEN_FADED_OUT()){
func_402(800);
...
if(func_30(&uLocal_954)){
if((func_27(&uLocal_954) > fLocal_949 || (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_970) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_970) >=0.961f)) || bLocal_960){
iLocal_942=3;
}}
break;
case 2:
...
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_944, -1000f, 1);
wait(0);
...
if(STREAMING::STREAMVOL_IS_VALID(uLocal_1097)){
STREAMING::STREAMVOL_DELETE(uLocal_1097);
}
ENTITY::SET_ENTITY_COLLISION(iLocal_944, 1, 0);
HUD::DISPLAY_RADAR(1);
HUD::DISPLAY_HUD(1);
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
...
switch (iLocal_972){
case 0:
if(func_404(&uLocal_945, 4f, 799.7321f, -1083.417f, 30.3753f, -1.3455f, 0f, -42.1124f, 42.5517f, 1, 0.3f)){
iLocal_972=1;
}
break;
case 1:
if(func_404(&uLocal_945, 11f, 814.8909f, -1078.272f, 29.0784f, 0f, -0.0387f, 70.1654f, 30.1956f, 1, 0.3f)){
iLocal_972=2;
}
break;
case 2:
if(func_404(&uLocal_945, 20f, 808.044f, -1074.647f, 29.2119f, -4.8627f, 0f, -129.3806f, 36.3462f, 1, 0.3f)){
iLocal_972=3;
}
break;
case 3:
if(func_404(&uLocal_945, 25f, 814.8909f, -1078.272f, 29.0784f, 0f, -0.0387f, 70.1654f, 30.1956f, 1, 0.2f)){
iLocal_972=4;
}
break;
case 4:
if(func_404(&uLocal_945, 30f, 808.044f, -1074.647f, 29.2119f, -4.8627f, 0f, -129.3806f, 36.3462f, 1, 0.2f)){
iLocal_972=5;
}
break;
case 5:
if(func_404(&uLocal_945, 37f, 812.5805f, -1076.648f, 28.9375f, 2.1171f, 0.0247f, 79.0055f, 29.2734f, 1, 0.2f)){
iLocal_972=6;
}
break;
case 6:
...
if(func_30(&uLocal_957)){
if(func_27(&uLocal_957) >=fParam1){
CAM::SET_CAM_COORD(uLocal_945, Param2);
CAM::SET_CAM_ROT(uLocal_945, Param3, 2);
CAM::SET_CAM_FOV(uLocal_945, fParam4);
if(bParam5){
CAM::SHAKE_CAM(uLocal_945, "HAND_SHAKE", fParam6);
}
return 1;
}}}
return 0;
...
void func_405(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
...
int func_407(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
int func_408(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1223, 0)){
ENTITY::SET_ENTITY_PROOFS(iLocal_1223, 0, 0, 0, 0, 0, 0, 0, 0);
VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(iLocal_1223, 1);
VEHICLE::SET_DISABLE_VEHICLE_PETROL_TANK_FIRES(iLocal_1223, 0);
}
...
if(((PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID())) || iVar2) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_1187, -117.225f, -977.2565f, 200.1625f, -135.9228f, -971.2293f, 268.8807f, 11f, 0, 1, 0)){
fVar1=vdist2(Var0, Local_1201);
...
void func_416(struct<3> Param0, float fParam1, int iParam2, int iParam3){
if(func_490()){
...
int func_446(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_448(iParam0, uVar1[iVar3], 1) && func_447(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
...
if(!func_464() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
void func_478(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
func_496();
STREAMING::END_SRL();
VEHICLE::REMOVE_ROAD_NODE_SPEED_ZONE(uLocal_1167);
func_216(&Local_1098, 5);
func_216(&Local_1099, 3);
func_216(&Local_1100, 6);
func_216(&Local_1101, 2);
...
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_1177[0], 0);
ENTITY::REMOVE_MODEL_HIDE(Local_1198, 5f, joaat("prop_conslift_lift"), 0);
ENTITY::REMOVE_MODEL_HIDE(Local_1199, 5f, joaat("prop_conslift_lift"), 0);
STREAMING::REQUEST_IPL("DT1_21_prop_lift_on");
STREAMING::REMOVE_IPL("DT1_21_ConSiteAssass");
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1184[1])){
if(ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_1187, uLocal_1184[1])){
ENTITY::DETACH_ENTITY(iLocal_1187, 1, 1);
}}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1184[0])){
if(ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_1187, uLocal_1184[0])){
ENTITY::DETACH_ENTITY(iLocal_1187, 1, 1);
}}
...
ENTITY::SET_ENTITY_VISIBLE(iLocal_943, 1, 0);
ENTITY::SET_ENTITY_COLLISION(iLocal_943, 1, 0);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(iLocal_943, 1);
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1226)){
AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_1226, 0);
}
if(AUDIO::IS_AUDIO_SCENE_ACTIVE("ASSASSINATION_CONSTRUCT_CUTSCENE")){
AUDIO::STOP_AUDIO_SCENE("ASSASSINATION_CONSTRUCT_CUTSCENE");
}
...
void func_496(){
if(OBJECT::DOES_PICKUP_EXIST(uLocal_1425)){
OBJECT::REMOVE_PICKUP(uLocal_1425);
}
if(OBJECT::DOES_PICKUP_EXIST(uLocal_1426)){
OBJECT::REMOVE_PICKUP(uLocal_1426);
}}
