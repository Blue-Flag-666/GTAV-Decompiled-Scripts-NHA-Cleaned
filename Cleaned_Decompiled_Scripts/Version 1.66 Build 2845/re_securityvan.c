...
Local_67={
ScriptParam_302.f_1[0 /*3*/] 
};
if(vdist(Local_67, -337.3338f, -1460.373f, 29.5668f) < 5f){
bLocal_45=true;
}elseif(vdist(Local_67, -588.4711f, -866.9462f, 25.3292f) < 5f){
bLocal_45=2;
}elseif(vdist(Local_67, -389f, 6061f, 31f) < 5f){
bLocal_45=3;
}elseif(vdist(Local_67, -600f, -1094f, 22.76f) < 5f){
bLocal_45=4;
}elseif(vdist(Local_67, -1025f, -1086f, 2f) < 5f){
bLocal_45=5;
}elseif(vdist(Local_67, -595.5618f, -667.7235f, 31.0544f) < 5f){
bLocal_45=6;
}elseif(vdist(Local_67, 3018.384f, 3634.017f, 70.4076f) < 5f){
bLocal_45=7;
}elseif(vdist(Local_67, -2815.661f, 2208.171f, 27.8382f) < 5f){
bLocal_45=8;
}elseif(vdist(Local_67, 856.7742f, -2067.845f, 29.0704f) < 5f){
bLocal_45=9;
}elseif(vdist(Local_67, 805.1932f, -703.1327f, 28.1632f) < 5f){
bLocal_45=10;
}else{
...
TASK::TASK_ENTER_VEHICLE(iLocal_49[iVar0], iLocal_50, -1, func_248(iLocal_50), 1073741824, 1, 0);
}}else{
...
func_187();
uLocal_59=PED::ADD_SCENARIO_BLOCKING_AREA(Local_63 + Vector(30f, 30f, 30f), Local_63 - Vector(30f, 30f, 30f), 0, 1, 1, 1);
while (true){
wait(0);
func_184(&uLocal_123);
if(!func_183()){
...
MISC::CLEAR_AREA(Local_63, 4f, 1, 0, 0, 0);
}
iLocal_46=4;
bLocal_79=true;
}else{
...
if(((vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_50, 1)) < 10000f || !ENTITY::IS_ENTITY_OCCLUDED(iLocal_50)) || (!PED::IS_PED_INJURED(iLocal_49[0]) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_49[0]))) || (!PED::IS_PED_INJURED(iLocal_49[1]) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_49[1]))){
iLocal_298++;
}}
if(func_158()){
iLocal_298++;
...
if(iLocal_44==3){
func_148();
if(!ENTITY::IS_ENTITY_OCCLUDED(iLocal_50) && (vdist(ENTITY::GET_ENTITY_COORDS(iLocal_50, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 100f || func_158())){
func_139(1);
}
}
elseif(((!ENTITY::IS_ENTITY_OCCLUDED(iLocal_50) && iLocal_46==4) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_70, Local_71, fLocal_72, 0, 1, 0)) || func_158()){
func_139(1);
}
if((iLocal_46==4 && ENTITY::IS_ENTITY_OCCLUDED(iLocal_50)) && iLocal_44 !=3){
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_50, 1)) > 100f){
func_231();
}else{
func_139(1);
}
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_50, 1)) > 62500f){
func_231();
}
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_50, 1)) > 10000f && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_231();
}}}}else{
...
if(iLocal_299 !=0){
if(vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_52, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < pow(50f, 2f)){
iLocal_299=0;
func_135(&uLocal_111, 0, 0);
}}}elseif(((bLocal_79 && !OBJECT::DOES_PICKUP_EXIST(uLocal_103)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0)) && !bLocal_89){
if(iLocal_299 !=1){
if(vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_50, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < pow(50f, 2f)){
iLocal_299=1;
func_135(&uLocal_111, 0, 0);
}}}elseif(OBJECT::DOES_PICKUP_EXIST(uLocal_103)){
if(iLocal_299 !=2){
if(vdist2(OBJECT::GET_PICKUP_COORDS(uLocal_103), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < pow(50f, 2f)){
iLocal_299=2;
func_135(&uLocal_111, 0, 0);
}}}
if(iLocal_299==0){
...
if(OBJECT::DOES_PICKUP_EXIST(uLocal_103)){
func_105(&uLocal_111, OBJECT::GET_PICKUP_COORDS(uLocal_103), 0, 0, 1, 1, 1);
if(vdist2(OBJECT::GET_PICKUP_COORDS(uLocal_103), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > pow(50f, 2f)){
iLocal_299=-1;
func_135(&uLocal_111, 0, 0);
}}}
...
switch (iLocal_100){
case 0:
if(!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_50, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 225f){
...
if(bLocal_81){
if((OBJECT::DOES_PICKUP_EXIST(uLocal_103) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), OBJECT::GET_PICKUP_COORDS(uLocal_103)) > 250f){
func_68(9);
}}
if(!bLocal_89){
if(func_67()){
...
if((!ENTITY::IS_ENTITY_DEAD(iLocal_49[iVar2], 0) && !PED::IS_PED_INJURED(iLocal_49[iVar2])) && vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_49[0], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 10000f){
iVar1=0;
}}
...
if((vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_50, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 10000f && ENTITY::IS_ENTITY_OCCLUDED(iLocal_50)) || vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_50, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 62500f){
iVar3=1;
}}
if(iVar3 && iVar1){
func_43();
...
WEAPON::HIDE_PED_WEAPON_FOR_SCRIPTED_CUTSCENE(iLocal_49[iVar5], 1);
iLocal_85=1;
}}else{
if(iLocal_300[iVar5]){
PED::CLEAR_PED_ALTERNATE_MOVEMENT_ANIM(iLocal_49[iVar5], 0, -1056964608);
PED::CLEAR_PED_ALTERNATE_MOVEMENT_ANIM(iLocal_49[iVar5], 1, -1056964608);
iLocal_300[iVar5]=0;
}
if(iLocal_301[iVar5]){
PED::CLEAR_PED_ALTERNATE_MOVEMENT_ANIM(iLocal_49[iVar5], 0, -1056964608);
...
int iVar2;
fVar0=50f;
if(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && (((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0) && bLocal_84) && OBJECT::DOES_PICKUP_EXIST(uLocal_103)) || (!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0) && OBJECT::DOES_PICKUP_EXIST(uLocal_103)))) && vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_50, 1)) < 20f) && vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), OBJECT::GET_PICKUP_COORDS(uLocal_103)) < 20f){
...
if(!PED::IS_PED_INJURED(iLocal_49[0])){
fVar0=vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_49[0], 1));
iVar1=0;
}
if(!PED::IS_PED_INJURED(iLocal_49[1])){
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_49[1], 1)) < fVar0){
fVar0=vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_49[1], 1));
iVar1=1;
}}}
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(!PED::IS_PED_INJURED(iLocal_49[0])){
fVar0=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_49[0], 1));
}
if(!PED::IS_PED_INJURED(iLocal_49[1])){
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_49[1], 1)) < fVar0){
fVar0=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_49[1], 1));
}}}
return sqrt(fVar0);
}
...
if(!OBJECT::DOES_PICKUP_EXIST(uLocal_103) && !bLocal_81){
func_30(0f, 0f, 0f, 0);
}}elseif((MISC::GET_GAME_TIMER() - iLocal_102) > 3000){
if(PED::IS_PED_INJURED(iLocal_49[iLocal_96]) || PED::IS_PED_RAGDOLL(iLocal_49[iLocal_96])){
ENTITY::DETACH_ENTITY(iLocal_52, 1, 1);
...
if(OBJECT::DOES_PICKUP_EXIST(uLocal_103)){
OBJECT::REMOVE_PICKUP(uLocal_103);
}}}
...
if(bLocal_79){
Param0={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, -3.3f, 0f), 1067030938, 1069547520) 
};
}else{
Param0={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_49[iLocal_96], 0), 1067030938, 1069547520) 
};
}}
MISC::SET_BIT(&uLocal_104, 3);
MISC::SET_BIT(&uLocal_104, 4);
MISC::SET_BIT(&uLocal_104, true);
if(bParam1){
uLocal_103=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_money_security_case"), Param0, ENTITY::GET_ENTITY_ROTATION(iLocal_52, 2), 0, uLocal_94, 2, 1, 0);
}else{
uLocal_103=OBJECT::CREATE_PICKUP(joaat("pickup_money_security_case"), Param0, uLocal_104, uLocal_94, 1, 0);
}
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_52, iLocal_50, 0, Local_65, Local_66, 0, 0, 0, 0, 2, 1, 0);
iLocal_47=2;
}}
break;
case 2:
...
ENTITY::DETACH_ENTITY(iLocal_52, 1, 0);
ENTITY::SET_ENTITY_COLLISION(iLocal_52, 1, 0);
PHYSICS::ACTIVATE_PHYSICS(iLocal_52);
OBJECT::SET_ACTIVATE_OBJECT_PHYSICS_AS_SOON_AS_IT_IS_UNFROZEN(iLocal_52, 1);
Local_279={
ENTITY::GET_ENTITY_COORDS(iLocal_52, 1) - ENTITY::GET_ENTITY_COORDS(iLocal_50, 1) * Vector(1.5f, 1.5f, 1.5f) 
};
...
}elseif(MISC::GET_RATIO_OF_CLOSEST_POINT_ON_LINE(ENTITY::GET_ENTITY_COORDS(iLocal_52, 1), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, Local_276), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, Local_277), 0) >=1f){
iLocal_47=3;
iLocal_91[0]=0;
iLocal_91[1]=0;
}elseif((MISC::GET_GAME_TIMER() - iLocal_278) > 5000){
func_30(0f, 0f, 0f, 0);
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_52) && !OBJECT::DOES_PICKUP_EXIST(uLocal_103)){
if(ENTITY::GET_ENTITY_SPEED(iLocal_52)==0f && (MISC::GET_GAME_TIMER() - iLocal_278) > 1000){
func_30(ENTITY::GET_ENTITY_COORDS(iLocal_52, 1), 1);
OBJECT::DELETE_OBJECT(&iLocal_52);
}elseif((MISC::GET_GAME_TIMER() - iLocal_278) > 5000){
func_30(0f, 0f, 0f, 0);
}}
...
if(!iLocal_272){
if(MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(iLocal_53, 1), joaat("weapon_stickybomb"), 0.25f, 0) || OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_53, 1), 0.3f, WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_stickybomb")), 0)){
iLocal_272=1;
}}
iVar0=0;
GRAPHICS::DRAW_DEBUG_SPHERE(ENTITY::GET_ENTITY_COORDS(iLocal_53, 1), 0.1f, 255, 0, 0, 255);
if(func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_53, 1), 1f, 1) || (FIRE::IS_EXPLOSION_IN_SPHERE(2, ENTITY::GET_ENTITY_COORDS(iLocal_53, 1), 0.3f) && iLocal_272)){
iLocal_87=1;
iVar0=1;
}
...
if(HUD::DOES_BLIP_EXIST(uLocal_55) && HUD::GET_BLIP_HUD_COLOUR(uLocal_55) !=119){
HUD::REMOVE_BLIP(&uLocal_55);
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0)){
iVar0=0;
...
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_55)){
HUD::REMOVE_BLIP(&uLocal_55);
}
if((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0) && HUD::DOES_BLIP_EXIST(uLocal_55)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_50, 0)){
if(HUD::GET_BLIP_ALPHA(uLocal_55) !=0){
HUD::SET_BLIP_ALPHA(uLocal_55, 0);
}}elseif(HUD::GET_BLIP_ALPHA(uLocal_55) !=255){
HUD::SET_BLIP_ALPHA(uLocal_55, 255);
}}
iVar0=0;
while (iVar0 < iLocal_49){
if(!PED::IS_PED_INJURED(iLocal_49[iVar0]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(!OBJECT::DOES_PICKUP_EXIST(uLocal_103) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_49[iVar0], 0)){
if(!PED::IS_PED_FLEEING(iLocal_49[iVar0]) || vdist(ENTITY::GET_ENTITY_COORDS(iLocal_49[iVar0], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 30f){
iVar2[iVar0]=1;
}}
...
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_56[iVar0])){
HUD::REMOVE_BLIP(&(uLocal_56[iVar0]));
}
iVar0++;
}
if(OBJECT::DOES_PICKUP_EXIST(uLocal_103) && !bLocal_89){
if(!HUD::DOES_BLIP_EXIST(uLocal_58)){
uLocal_58=func_32(uLocal_103);
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_58)){
HUD::REMOVE_BLIP(&uLocal_58);
}}}elseif((ENTITY::DOES_ENTITY_EXIST(iLocal_50) && ENTITY::DOES_ENTITY_EXIST(iLocal_49[0])) && ENTITY::DOES_ENTITY_EXIST(iLocal_49[1])){
...
if(HUD::DOES_BLIP_EXIST(uLocal_56[1])){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_56[1], iLocal_90);
}
if(HUD::DOES_BLIP_EXIST(uLocal_55)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_55, iLocal_90);
}
if(HUD::DOES_BLIP_EXIST(uLocal_58)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_58, iLocal_90);
}
if(!iLocal_90){
...
int func_67(){
if(bLocal_81){
if(OBJECT::HAS_PICKUP_BEEN_COLLECTED(uLocal_103)){
return 1;
}}
return 0;
}
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && vdist(OBJECT::GET_PICKUP_COORDS(uLocal_103), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 300f){
return 1;
}}
return 0;
}
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_49[iVar0], uLocal_54);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_54);
}
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[iVar0], 6, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[iVar0], 0, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[iVar0], 1, 0);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_49[iVar0], 1);
PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_49[iVar0], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_49[iVar0], 1);
}
iVar0++;
}
...
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_54);
TASK::TASK_PERFORM_SEQUENCE(iLocal_49[iLocal_96], uLocal_54);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_54);
}
iLocal_48++;
}
...
if(((OBJECT::DOES_PICKUP_EXIST(uLocal_103) && !iLocal_91[iVar0]) && iLocal_47==3) && !bLocal_89){
PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_VEHICLE(iLocal_49[iVar0], iLocal_50, OBJECT::GET_PICKUP_COORDS(uLocal_103), 5f, 0);
iLocal_91[iVar0]=1;
}
if(bLocal_89){
if(iLocal_91[iVar0]){
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_49[iParam0], 1);
...
if(bVar0){
if(!PED::IS_PED_INJURED(iLocal_49[iParam0])){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_49[iParam0], 0);
}}
return bVar0;
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
Var0={
func_35(ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_50, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))) 
};
...
Var3[0 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_50, 1), fVar1, 0f, 4.5f, 0f) 
};
Var3[1 /*3*/]={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_50, 1), fVar2, 0f, 4.5f, 0f) 
};
func_78(&fVar1);
func_78(&fVar2);
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_293) > 2f){
bVar5=true;
}
iVar4=0;
while (iVar4 < iLocal_49){
if(!PED::IS_PED_INJURED(iLocal_49[iVar4])){
if(vdist(ENTITY::GET_ENTITY_COORDS(iLocal_49[iVar4], 1), Var3[iVar4 /*3*/]) > 2f){
bVar5=true;
}}
iVar4++;
}
...
iVar4=0;
while (iVar4 < iLocal_49){
if((((((!PED::IS_PED_INJURED(iLocal_49[iVar4]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && vdist(ENTITY::GET_ENTITY_COORDS(iLocal_49[iVar4], 1), Var3[iVar4 /*3*/]) > 2f) && (MISC::GET_GAME_TIMER() - iLocal_294[iVar4]) > 1000) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_49[iVar4], 0)) && !iLocal_281[iVar4]) && (iParam0==-1 || iParam0==iVar4)){
if(bParam1){
if(func_72()){
Local_293={
...
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_COORD(0, Var3[iVar4 /*3*/], Local_293, 2f, 0, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
TASK::TASK_AIM_GUN_AT_COORD(0, Local_293, -1, 1, 0);
}
TASK::CLOSE_SEQUENCE_TASK(uVar6);
TASK::TASK_PERFORM_SEQUENCE(iLocal_49[iVar4], uVar6);
...
Local_283={
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_50, 0) 
};
Local_284={
ENTITY::GET_ENTITY_ROTATION(iLocal_50, 2) 
};
Local_285={
PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@security_van", "sec_case_into_van_panic", Local_283, Local_284, 0, 2) 
};
...
if(OBJECT::DOES_PICKUP_EXIST(uLocal_103)){
if(bLocal_80){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, OBJECT::GET_PICKUP_COORDS(uLocal_103), 2f, -1, 0.25f, 0, 1193033728);
}else{
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, OBJECT::GET_PICKUP_COORDS(uLocal_103), 1f, -1, 0.25f, 0, 1193033728);
}
iLocal_48++;
}
else{
...
break;
case 1:
if(!PED::IS_PED_INJURED(iParam0) && OBJECT::DOES_PICKUP_EXIST(uLocal_103)){
if((MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), OBJECT::GET_PICKUP_COORDS(uLocal_103), 1) < 2f && !PED::IS_PED_RAGDOLL(iParam0)) && (MISC::GET_GAME_TIMER() - iLocal_102) > 3000){
...
if(vdist(Local_285, ENTITY::GET_ENTITY_COORDS(iParam0, 1)) < 0.3f){
...
elseif(ENTITY::IS_ENTITY_OCCLUDED(iParam0) && !CAM::IS_SPHERE_VISIBLE(Local_283, 2f)){
ENTITY::SET_ENTITY_COORDS(iParam0, Local_283, 1, 0, 0, 1);
}}}
break;
case 4:
...
ENTITY::DETACH_ENTITY(iLocal_52, 1, 1);
ENTITY::SET_ENTITY_COLLISION(iLocal_52, 0, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_52, iLocal_50, 0, ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_50, ENTITY::GET_ENTITY_COORDS(iLocal_52, 1)), 90f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}
bLocal_79=true;
}}elseif(PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_286) > fLocal_297){
...
fVar9=1.35f;
Var4[0 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, (-fVar9 - 0.25f), fVar8, 0f) 
};
Var4[1 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, (fVar9 + 0.25f), fVar8, 0f) 
};
Var4[2 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, (fVar9 - 0.25f), (fVar8 - 1.55f), 0f) 
};
Var4[3 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, (-fVar9 + 0.25f), (fVar8 - 1.55f), 0f) 
};
Var5[0 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, -fVar9, 0.5f, 0f) 
};
Var5[1 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, (-fVar9 - 0.75f), 0.5f, 0f) 
};
Var5[2 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, (-fVar9 - 0.75f), 1.5f, 0f) 
};
Var5[3 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, -fVar9, 1.5f, 0f) 
};
Var6[0 /*3*/]={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, fVar9, 0.5f, 0f) 
};
...
if(!PED::IS_PED_INJURED(iParam0)){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_52)){
iLocal_52=OBJECT::CREATE_OBJECT(iLocal_75, Local_63, 1, 1, 0);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(iLocal_52, 0);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_52)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_52, iParam0, PED::GET_PED_BONE_INDEX(iParam0, 28422), Local_68, Local_69, 1, 0, 0, 0, 2, 1, 0);
}}}
...
TASK::TASK_ENTER_VEHICLE(iLocal_49[1], iLocal_50, -1, 0, 1073741824, 1, 0);
}}
iLocal_48++;
}else{
func_68(8);
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_50, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 100f){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_49[iVar1], uVar2);
TASK::CLEAR_SEQUENCE_TASK(&uVar2);
}}else{
func_68(8);
}}
if(((((((!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0) || OBJECT::DOES_PICKUP_EXIST(uLocal_103)) || iLocal_47==3) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_50, 0, 7000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_50, 3, 30000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_50, 2, 30000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_50, 1, 40000)) || (iLocal_48 > 1 && !func_88())){
if(!func_88()){
}
func_68(8);
}}
...
while (iVar0 < iLocal_49){
if(!PED::IS_PED_INJURED(iLocal_49[iVar0])){
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[iVar0], 17, 1);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_49[iVar0], uVar1);
...
if(vdist(ENTITY::GET_ENTITY_COORDS(iLocal_51, 1), ENTITY::GET_ENTITY_COORDS(iLocal_50, 1)) > 10f){
func_68(7);
}}
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_54);
TASK::TASK_PERFORM_SEQUENCE(iLocal_49[iParam0], uLocal_54);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_54);
if(iLocal_97==0){
iLocal_97=EVENT::ADD_SHOCKING_EVENT_AT_POSITION(118, ENTITY::GET_ENTITY_COORDS(iLocal_49[iParam0], 1), -1082130432);
}}}
...
case 0:
if(!PED::IS_PED_INJURED(iLocal_49[0])){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_49[0], 1);
}
if(!PED::IS_PED_INJURED(iLocal_49[1])){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_49[1], 1);
}
if(func_103()){
if(func_4(&Local_106, cLocal_105, "RESEC_ATT1", 8, 0, 0, 0)){
settimera(0);
func_68(8);
}}elseif((!PED::IS_PED_INJURED(iLocal_49[0]) && !PED::IS_PED_INJURED(iLocal_49[1])) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
...
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1)) > fLocal_290){
iVar0=1;
}
if((MISC::GET_GAME_TIMER() - iLocal_291) > iParam1){
fLocal_290=vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1));
...
int iVar0;
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, 1.7532f, 0.5984f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, 3.3477f, 3.5984f), 2.8f, 0, 1, 0)){
return 1;
}
iVar0=0;
while (iVar0 < iLocal_49){
if(!PED::IS_PED_INJURED(iLocal_49[iVar0])){
if((!PED::IS_PED_IN_VEHICLE(iLocal_49[iVar0], iLocal_50, 0) && PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_50)) && vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_49[iVar0], 1)) < 400f){
return 1;
}}
iVar0++;
}}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0)){
if(!PED::IS_PED_INJURED(iLocal_49[0]) && !PED::IS_PED_INJURED(iLocal_49[1])){
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[0], 6, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[1], 6, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_49[0], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_49[1], 1);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_49[0], uVar0);
...
TASK::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_50, 10f, 786603);
TASK::CLOSE_SEQUENCE_TASK(uVar1);
TASK::TASK_PERFORM_SEQUENCE(iLocal_49[0], uVar1);
TASK::CLEAR_SEQUENCE_TASK(&uVar1);
iLocal_48++;
}
elseif(bLocal_45==7){
...
TASK::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_50, 10f, 786603);
TASK::CLOSE_SEQUENCE_TASK(uVar2);
TASK::TASK_PERFORM_SEQUENCE(iLocal_49[0], uVar2);
TASK::CLEAR_SEQUENCE_TASK(&uVar2);
iLocal_48++;
}
else{
...
if(!PED::IS_PED_IN_VEHICLE(iLocal_49[0], iLocal_50, 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_49[0], joaat("script_task_enter_vehicle")) !=1){
TASK::TASK_ENTER_VEHICLE(iLocal_49[0], iLocal_50, -1, -1, 1f, 8388608, 0);
}
if(!PED::IS_PED_IN_VEHICLE(iLocal_49[1], iLocal_50, 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_49[1], joaat("script_task_enter_vehicle")) !=1){
...
if((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, -3.44f, -3f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, -13.44f, 3f), 2.3f, 0, 1, 0)) && vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_50, 1)) < 225f){
func_68(6);
}
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, -3.44f, -3f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_50, 0f, -13.44f, 3f), 2.3f, 0, 1, 0)){
GRAPHICS::DRAW_DEBUG_TEXT_2D("PLAYER IS BEHIND VAN", 0.1f, 0.8f, 0f, 0, 0, 255, 255);
}
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_50, 1)) < 225f){
GRAPHICS::DRAW_DEBUG_TEXT_2D("PLAYER IS CLOSE TO VAN", 0.1f, 0.82f, 0f, 0, 0, 255, 255);
}
if(PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())){
}}}
if(((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_50, 1), 25f, 0)) || (!PED::IS_PED_INJURED(iLocal_49[0]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_49[0], 1), 20f, 0))) || (!PED::IS_PED_INJURED(iLocal_49[1]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_49[1], 1), 20f, 0))){
func_68(6);
}
if(iLocal_46 !=4){
if(!PED::IS_PED_INJURED(iLocal_49[0])){
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[0], 6, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_49[0], 0);
}
if(!PED::IS_PED_INJURED(iLocal_49[1])){
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[1], 6, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_49[1], 0);
}}}}
...
Var0={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - ENTITY::GET_ENTITY_COORDS(iLocal_50, 1) 
};
Var1={
ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_50) 
};
Var2={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_50, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) 
};
...
Local_285={
PED::GET_ANIM_INITIAL_OFFSET_POSITION("random@security_van", "sec_case_into_van_calm", Local_283, Local_284, 0, 2) 
};
bLocal_288=false;
iLocal_289=0;
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_63) < 22500f && ENTITY::HAS_COLLISION_LOADED_AROUND_ENTITY(iLocal_50)){
...
PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_287, 1);
}}
...
if(MISC::ABSF((fVar0 - Local_284.f_2)) < 15f && vdist(Local_285, ENTITY::GET_ENTITY_COORDS(iLocal_49[1], 1)) < 0.2f){
...
bLocal_79=true;
}}elseif(PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_286) > 0.546243f){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_50, -4f, 1);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_52)){
iLocal_76=0;
VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_50, 2, 1);
...
iLocal_289=1;
}}elseif((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_287) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_287) >=0.92f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_287)){
if(!PED::IS_PED_IN_VEHICLE(iLocal_49[0], iLocal_50, 0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_49[0], joaat("script_task_enter_vehicle")) !=1){
TASK::CLEAR_PED_TASKS(iLocal_49[0]);
TASK::TASK_ENTER_VEHICLE(iLocal_49[0], iLocal_50, -1, -1, 1f, 1, 0);
}}
...
if(bLocal_79 && !OBJECT::DOES_PICKUP_EXIST(uLocal_103)){
VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_50, 2, 1);
VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_50, 3, 1);
}}}
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_63, 25f, 25f, 20f, 0, 1, 0)){
return 1;
}}
if(((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_50, 0) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_50, 1), 25f, 0)) || (!PED::IS_PED_INJURED(iLocal_49[0]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_49[0], 1), 20f, 0))) || (!PED::IS_PED_INJURED(iLocal_49[1]) && func_37(0f, 0f, 0f, 0f, 0f, 0f, ENTITY::GET_ENTITY_COORDS(iLocal_49[1], 1), 20f, 0))){
return 1;
...
if((MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_49[iVar0], 1), 5f, 1) || func_37(ENTITY::GET_ENTITY_COORDS(iLocal_49[iVar0], 1) + Vector(5f, 10f, 10f), ENTITY::GET_ENTITY_COORDS(iLocal_49[iVar0], 1) - Vector(5f, 5f, 5f), 0f, 0f, 0f, 0, 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49[iVar0], PLAYER::PLAYER_PED_ID(), 1)){
bLocal_80=true;
return 1;
}}else{
bLocal_80=true;
...
void func_159(){
int iVar0;
iLocal_50=VEHICLE::CREATE_VEHICLE(iLocal_74, Local_63, fLocal_64, 1, 1, 0);
iLocal_53=OBJECT::CREATE_OBJECT(joaat("prop_security_case_01"), Local_63, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_53, iLocal_50, 0, 0f, -2.4589f, 1.2195f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::SET_ENTITY_VISIBLE(iLocal_53, 0, 0);
ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(iLocal_53, iLocal_50, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_50, 1084227584);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_50, 3);
ENTITY::SET_ENTITY_PROOFS(iLocal_53, 0, 1, 1, 1, 1, 1, 0, 0);
ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_50, 1, 0);
ENTITY::SET_ENTITY_HEALTH(iLocal_50, 700, 0);
VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_50, 0, 0);
...
iLocal_49[1]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_50, 26, iLocal_73, 0, 1, 1);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_50, 1, 1, 0);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_50, 1, 1);
}else{
iLocal_49[1]=PED::CREATE_PED(26, iLocal_73, Local_61[1 /*3*/], fLocal_62[1], 1, 1);
iLocal_49[0]=PED::CREATE_PED(26, iLocal_73, Local_61[0 /*3*/], fLocal_62[0], 1, 1);
...
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[iVar0], 1, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[iVar0], 13, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[iVar0], 6, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[iVar0], 8, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49[iVar0], 10, 1);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_49[iVar0], 512, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_49[iVar0], 118, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_49[iVar0], 128, 1);
...
WEAPON::GIVE_WEAPON_TO_PED(iLocal_49[iVar0], joaat("weapon_pistol"), -1, 0, 1);
...
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_49[1], 1, 1);
...
if(iLocal_44==1){
PED::SET_PED_PROP_INDEX(iLocal_49[0], 0, 1, 0, 0, 1);
PED::SET_PED_SUFFERS_CRITICAL_HITS(iLocal_49[0], 0);
PED::SET_PED_PROP_INDEX(iLocal_49[1], 0, 1, 0, 0, 1);
...
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_74, 1);
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_73, 1);
if(iLocal_44 !=3){}}
...
uLocal_94=MISC::GET_RANDOM_INT_IN_RANGE(3000, 8000);
switch (bLocal_45){
case 1:
Local_70={
...
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_73, 0);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_74, 0);
}
if(iLocal_97 !=0){
EVENT::REMOVE_SHOCKING_EVENT(iLocal_97);
}
