...
func_8(13, floor(Global_113648.f_10196.f_3853));
}
...
Global_78341[1 /*14*/]={
func_83(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_83(iVar10, 14, uVar12[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_83(iVar10, 14, uVar15[iVar1], -1) 
};
func_50(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_66(14);
if(Global_78339==1){
...
func_161(&uVar1, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
if(func_353(uLocal_47[0]) && func_353(uLocal_47[1])){
if((func_220(uLocal_47[0], Local_237, 30f, 1) || func_217(uLocal_47[0], PLAYER::PLAYER_PED_ID(), 1126825984, 0)) || func_217(uLocal_47[1], PLAYER::PLAYER_PED_ID(), 1126825984, 0)){
func_216(&(uLocal_47[0]), 1, 0, 1);
func_216(&(uLocal_47[1]), 1, 0, 1);
func_215(&iLocal_46);
}}
break;
case 2:
...
bool func_220(int iParam0, struct<3> Param1, float fParam2, int iParam3){
...
TASK::TASK_PLAY_ANIM(0, sLocal_43, "barry_get_up", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_39.f_41[0], iLocal_45, PED::GET_PED_BONE_INDEX(iLocal_45, 60309), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}elseif(ENTITY::IS_ENTITY_ATTACHED(Local_39.f_41[0])){
...
iLocal_46=VEHICLE::CREATE_VEHICLE(iLocal_49, Var0, fVar1, 1, 1, 0);
uLocal_47[0]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_46, 6, iLocal_50, -1, 1, 1);
WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uLocal_47[0], joaat("weapon_pistol"), -1, 1);
WEAPON::SET_PED_INFINITE_AMMO(uLocal_47[0], 1, joaat("weapon_pistol"));
uLocal_47[1]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_46, 6, iLocal_50, 0, 1, 1);
WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uLocal_47[1], joaat("weapon_pistol"), -1, 1);
WEAPON::SET_PED_INFINITE_AMMO(uLocal_47[1], 1, joaat("weapon_pistol"));
VEHICLE::SET_VEHICLE_SIREN(iLocal_46, 1);
VEHICLE::SET_VEHICLE_FORWARD_SPEED(iLocal_46, 20f);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(uLocal_47[0], iLocal_46, Local_237, 20f, 1, iLocal_49, 786603, 5f, 5f);
return 1;
}
return 0;
}
...
float func_241(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
...
uLocal_243=PED::CREATE_SYNCHRONIZED_SCENE(Local_247, Local_248, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_243, 1);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_45, uLocal_243, sLocal_43, "barry_3_sit_loop", 1000f, -8f, 1, 16, 1148846080, 0);
}
...
func_243();
}}}elseif(func_237(PLAYER::PLAYER_PED_ID(), iLocal_45, 15f, 1)){
if(!bLocal_61){
...
iLocal_53=1;
iLocal_42=2;
}elseif(!func_237(PLAYER::PLAYER_PED_ID(), iLocal_45, 100f, 1)){
iLocal_42=2;
}}
break;
case 2:
...
}}elseif(AUDIO::IS_PED_IN_CURRENT_CONVERSATION(iLocal_45)){
if(!PED::IS_PED_HEADTRACKING_PED(iLocal_45, PLAYER::PLAYER_PED_ID())){
TASK::TASK_LOOK_AT_ENTITY(iLocal_45, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
}}elseif(PED::IS_PED_HEADTRACKING_PED(iLocal_45, PLAYER::PLAYER_PED_ID())){
TASK::TASK_CLEAR_LOOK_AT(iLocal_45);
}
if(func_237(iLocal_45, PLAYER::PLAYER_PED_ID(), 6f, 1)){
if(!PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), iLocal_45)){
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_45, -1, 0, 2);
}}elseif(PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), iLocal_45)){
TASK::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
}}
...
if(func_237(iLocal_45, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 15f, 1)){
bLocal_55=true;
AUDIO::STOP_SCRIPTED_CONVERSATION(0);
func_221(0);
TASK::TASK_PERFORM_SEQUENCE(iLocal_45, uLocal_44);
...
switch (iLocal_42){
case 0:
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_242)){
if(func_353(iLocal_45)){
uLocal_242=PED::CREATE_SYNCHRONIZED_SCENE(417.533f, -765.23f, 28.41f, 0f, 0f, 12.96f, 2);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_45, uLocal_242, sLocal_43, "lead_out", 1000f, -8f, 1, 16, 1148846080, 0);
}}
func_239(1);
iLocal_64=0;
iLocal_42=1;
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_242) > 0.99f){
iLocal_42=2;
}}else{
iLocal_42=2;
}
...
void func_269(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, var uParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
Var3={
func_83(iVar4, 2, uParam1->f_59, -1) 
};
...
Var3={
func_83(iVar4, 1, uParam1->f_62, -1) 
};
...
var uVar0;
var uVar1;
uVar0=Global_2848282[iParam0 /*3*/][func_69(uParam1)];
...
if(!bLocal_57 && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 415.4781f, -771.7041f, 27.85562f, 415.5606f, -759.9372f, 31.36162f, 7.25f, 0, 1, 0) || func_291())){
bLocal_57=true;
...
iLocal_232[1]=20000;
iLocal_232[2]=7000;
uLocal_246=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_45, uLocal_246);
...
uLocal_243=PED::CREATE_SYNCHRONIZED_SCENE(Local_247, Local_248, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_243, 1);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_45, uLocal_243, sLocal_43, "barry_3_sit_loop", 1000f, -8f, 0, 0, 1148846080, 0);
}
func_264();
...
int func_306(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_353(iParam0)){
...
if(!func_353(PLAYER::PLAYER_PED_ID())){
return 1;
}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_45)){
if(ENTITY::IS_ENTITY_DEAD(iLocal_45, 0)){
func_239(0);
func_328("B3BARRYDEAD");
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_45, PLAYER::PLAYER_PED_ID(), 1) || func_327(PLAYER::PLAYER_PED_ID(), iLocal_45, 1)){
TASK::TASK_SMART_FLEE_PED(iLocal_45, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
func_239(0);
func_328("B3BARRYHURT");
return 1;
}elseif(func_311(iLocal_45, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_327(PLAYER::PLAYER_PED_ID(), iLocal_45, 1)){
if(!iLocal_53){
if((iLocal_41==-2 && PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_242)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_242) < 0.82f){
}else{
func_221(0);
TASK::TASK_PERFORM_SEQUENCE(iLocal_45, uLocal_44);
}
...
int func_315(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5){
var uVar0;
struct<3> Var1;
var uVar2;
int iVar3;
...
int func_325(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
...
if(func_332()){
func_479();
}elseif(!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_40)){
if(func_255(iLocal_45)){
...
void func_335(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_337(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
void func_354(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11){
int iVar0;
iVar0=1;
...
int func_355(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5){
var uVar0;
var uVar1;
struct<97> Var2;
int iVar3;
...
if(((!func_372(PLAYER::PLAYER_ID()) && iParam0 !=joaat("thruster")) && iParam0 !=joaat("avenger")) && !bVar0){
return 0;
}
return 1;
}
...
if(!func_423() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
void func_428(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
bool func_434(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_435(struct<3> Param0, float fParam1){
return func_436(&(Global_107196.f_2890), Param0, fParam1, 0);
}

int func_436(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
int func_438(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_440(iParam0, uVar1[iVar3], 1) && func_439(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_434(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
...
int func_439(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
...
if(func_471(&(uParam0->f_28[0]), 49, Var1, fVar2, "RC LAUNCHER:
BARRY 3", 1)){
...
void func_469(var uParam0, int iParam1, struct<3> Param2, float fParam3){
func_470(uParam0);
...
int func_471(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_472(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
int func_472(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_152(iParam1)){
...
func_489(&(uLocal_47[0]));
func_489(&(uLocal_47[1]));
func_485(&iLocal_46);
}}
