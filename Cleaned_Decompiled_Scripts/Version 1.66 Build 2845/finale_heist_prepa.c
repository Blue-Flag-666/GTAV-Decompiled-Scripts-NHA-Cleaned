...
func_398();
func_384();
uLocal_264=PED::ADD_SCENARIO_BLOCKING_AREA(402.9022f, -1633.604f, 25.0472f, 315.6288f, -1558.814f, 38.7931f, 0, 1, 1, 1);
func_383(27, 0);
if(func_382()){
...
if(func_13()){
func_413();
}elseif(func_12(&uLocal_150, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
...
if(iLocal_45==2){
if(func_12(&uLocal_150, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
...
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_290.f_0, 0)){
...
void func_64(int iParam0, struct<3> Param1, int iParam2){
if(!HUD::DOES_BLIP_EXIST(*iParam0)){
*iParam0=func_65(Param1, 5, iParam2);
}}

int func_65(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
iVar0=0;
...
bLocal_28=false;
func_36(1, 1, 1);
}elseif(func_82(1, Local_265, 0)){
if(((func_82(2, Local_290.f_1, Local_290.f_4) && func_82(4, Local_265, 0)) && func_82(3, Local_265, 0)) && func_82(5, Local_265, 0)){
uLocal_271=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), 0, 7);
...
bVar0=false;
while (bVar0 <=(15 - 1)){
MISC::CLEAR_BIT(&(Local_289[iVar1 /*22*/].f_15), bVar0);
bVar0++;
}
...
WEAPON::GIVE_WEAPON_TO_PED(Local_289[iVar0 /*22*/], joaat("weapon_pistol"), -1, 0, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_289[iVar0 /*22*/], uLocal_292);
...
VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Local_290.f_0, 2, 0);
VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Local_290.f_0, 3, 0);
func_89(Local_290.f_0, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_290.f_0, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_290.f_0, 1);
return 1;
}}elseif(func_88(&Local_290, Local_290.f_5, Local_290.f_1, Local_290.f_4, 1)){
if(!VEHICLE::DOES_VEHICLE_HAVE_STUCK_VEHICLE_CHECK(Local_290.f_0)){
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_290.f_0);
}
func_89(Local_290.f_0, 0);
...
iVar1++;
}}elseif(func_86(&(Local_289[iVar0 /*22*/]), Local_289[iVar0 /*22*/].f_5, Local_289[iVar0 /*22*/].f_1, Local_289[iVar0 /*22*/].f_4, 0, 0, 0, 1)){
func_87(iVar0);
AUDIO::STOP_PED_SPEAKING(Local_289[iVar0 /*22*/], 1);
PED::SET_PED_TARGET_LOSS_RESPONSE(Local_289[iVar0 /*22*/], 2);
...
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97178[iVar3], 1, 1);
Local_291[iVar4 /*6*/]=Global_97178[iVar3];
if(func_7(Local_291[iVar4 /*6*/])){
iVar5++;
}}elseif(func_88(&(Local_291[iVar4 /*6*/]), Local_291[iVar4 /*6*/].f_5, Local_291[iVar4 /*6*/].f_1, Local_291[iVar4 /*6*/].f_4, 1)){
iVar5++;
}
iVar4++;
iVar3++;
...
break;
case 5:
if(func_83(&uLocal_262, joaat("prop_box_guncase_03a"), 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1)){
if(func_7(Local_290.f_0)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_262, Local_290.f_0, 0, 0f, -1.85f, 0.05f, ENTITY::GET_ENTITY_ROTATION(Local_290.f_0, 2), 0, 0, 0, 0, 2, 1, 0);
if(ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_290.f_0, uLocal_262)){
return 1;
}}}
break;
}
...
int func_83(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
if(!ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
int func_86(var uParam0, var uParam1, struct<3> Param2, var uParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7){
if(!ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
int func_88(int iParam0, var uParam1, struct<3> Param2, float fParam3, bool bParam4){
if(!ENTITY::DOES_ENTITY_EXIST(*iParam0)){
if(func_85(uParam1, "Loading", 0)){
...
void func_91(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, struct<3> Param5, int iParam6, bool bParam7, int iParam8){
if(func_7(*iParam0)){
switch (*iParam2){
case 0:
...
case 0:
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, 0), Local_266, 4, 20f, 786469, 3.5f, 5f, 1);
iLocal_43[iParam0]=3;
break;
case 3:
...
if(!func_112()){
if((ENTITY::DOES_ENTITY_EXIST(Local_290.f_0) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_290.f_0, 0)) && !ENTITY::IS_ENTITY_AT_COORD(Local_290.f_0, Local_266, 2f, 2f, 2f, 0, 1, 0)){
if((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_290.f_0, 0)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if(PED::IS_PED_IN_VEHICLE(iParam1, Local_290.f_0, 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_290.f_0, -1, 0)==iParam1){
iLocal_44[iParam0]=2;
return 1;
}}}}
return 0;
...
func_125();
return;
}elseif(MISC::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 9) && !bLocal_272){
func_127(iParam0);
func_125();
return;
}else{
...
while (bVar0 <=14){
if(bVar0 !=iParam1){
if(MISC::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, bVar0)){
return 0;
}}
bVar0++;
}
...
}elseif(func_78(Local_289[iParam0 /*22*/], joaat("script_task_start_scenario_at_position")) || func_78(Local_289[iParam0 /*22*/], joaat("script_task_start_scenario_in_place"))){
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(Local_289[iParam0 /*22*/]);
}
PED::SET_PED_AS_COP(Local_289[iParam0 /*22*/], 1);
TASK::TASK_ARREST_PED(Local_289[iParam0 /*22*/], PLAYER::PLAYER_PED_ID());
WEAPON::GIVE_WEAPON_TO_PED(Local_289[iParam0 /*22*/], joaat("weapon_pistol"), -1, 0, 1);
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_289[iParam0 /*22*/], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", 0);
}
iLocal_464=1;
}}}}
...
TASK::CLEAR_PED_TASKS(Local_289[iParam0 /*22*/]);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_289[iParam0 /*22*/], uLocal_292);
if(iParam0==2){
...
void func_135(){
if(func_12(&uLocal_46, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
if(!func_103()){
...
func_174(iParam0);
if(!func_173(iParam0)){
if(func_154(Local_289[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_289[iParam0 /*22*/], 1), 100f)){
...
PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, 0);
PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), 0);
}}}elseif(func_153(Local_289[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 5f, 1)){
if(!bLocal_274){
PLAYER::SUPPRESS_CRIME_THIS_FRAME(PLAYER::PLAYER_ID(), 41);
PLAYER::SUPPRESS_CRIME_THIS_FRAME(PLAYER::PLAYER_ID(), 33);
}}}
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_289[iParam0 /*22*/], 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)){
return 1;
}
return 0;
}
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_289[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", 0);
}elseif(iParam0==1){
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_289[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", 0);
func_183(iParam0, iParam1, 0);
}}elseif(iParam1==7){
...
return;
}elseif(!MISC::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 11)){
...
if(((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_289[iParam0 /*22*/], Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, 1, 0)) && !MISC::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 10)) && !MISC::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 11)){
if((fVar0 > 12f && !Local_289[iParam0 /*22*/].f_16) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0)){
func_186(iParam0, 11);
}}}elseif((MISC::GET_GAME_TIMER() - iLocal_281) > 4000){
iLocal_282=0;
}}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_255[5 /*7*/], Local_255[5 /*7*/].f_3, Local_255[5 /*7*/].f_6, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_289[iParam0 /*22*/], Local_255[5 /*7*/], Local_255[5 /*7*/].f_3, Local_255[5 /*7*/].f_6, 0, 1, 0)){
...
if(MISC::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, bParam1)){
...
func_186(iParam0, 3);
}}}}elseif(!func_153(Local_289[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 5.5f, 1)){
func_185(iParam0, 5);
func_185(iParam0, 3);
}}
...
if(Local_289[iParam0 /*22*/].f_20 !=7){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_289[iParam0 /*22*/], 1f, -1f, 0f), 1f, 1f, 2f, 0, 1, 0)){
return 1;
}}
return 0;
}
...
if(Local_289[iParam0 /*22*/].f_16){
if(!MISC::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 12)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_255[iVar0 /*7*/], Local_255[iVar0 /*7*/].f_3, Local_255[iVar0 /*7*/].f_6, 0, 1, 0)){
iLocal_282=1;
iLocal_281=MISC::GET_GAME_TIMER();
if(iVar0==4){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
}}}elseif(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_255[iVar0 /*7*/], Local_255[iVar0 /*7*/].f_3, Local_255[iVar0 /*7*/].f_6, 0, 1, 0) || MISC::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 12)){
func_191(iParam0, iVar0);
}
iVar0++;
}}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_255[3 /*7*/], Local_255[3 /*7*/].f_3, Local_255[3 /*7*/].f_6, 0, 1, 0)){
func_193(iParam0, 3);
}else{
func_191(iParam0, 3);
}}
...
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, Local_255[4 /*7*/], Local_255[4 /*7*/].f_3, Local_255[4 /*7*/].f_6, 0, 1, 0)){
func_185(iParam0, 8);
func_185(iParam0, 7);
}elseif(!MISC::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 7)){
func_186(iParam0, 7);
}}else{
func_185(iParam0, 8);
func_185(iParam0, 7);
...
if(((fVar1 < 12f && !Local_289[iParam0 /*22*/].f_16) && !MISC::IS_BIT_SET(Local_289[iParam0 /*22*/].f_15, 10)) && !func_78(Local_289[iParam0 /*22*/], joaat("script_task_turn_ped_to_face_entity"))){
...
if(bLocal_274){
func_125();
}elseif(func_154(Local_289[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_289[iParam0 /*22*/], 1), 100f)){
func_125();
...
if((((func_380(Local_289[0 /*22*/]) && func_380(Local_289[1 /*22*/])) && func_12(&uLocal_46, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))) && func_63(Local_289[0 /*22*/], Local_289[0 /*22*/].f_1, 3f, 1)) && func_63(Local_289[1 /*22*/], Local_289[1 /*22*/].f_1, 3f, 1)){
...
iLocal_461=1;
}}}elseif((func_380(Local_289[2 /*22*/]) && func_12(&uLocal_98, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))) && func_63(Local_289[2 /*22*/], Local_289[2 /*22*/].f_1, 3f, 1)){
...
void func_211(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5){
var uVar0;
int iVar1;
...
void func_225(int iParam0, struct<3> Param1, var uParam2, int iParam3, bool bParam4){
struct<60> Var0;
...
func_262(iParam3, &Var0, Param1, uParam2, func_268(iParam0));
...
return (shift_right(iParam0, 26) & 31 * func_254(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_276(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_276(iParam0));
if(iVar11 > iVar10){
...
}}elseif(PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID()) || iLocal_42==1){
...
PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(uLocal_271);
*fParam1=0f;
}}}}
...
}elseif(!func_63(PLAYER::PLAYER_PED_ID(), 372.0053f, -1604.076f, 36.7536f, 170f, 1) && bLocal_287){
func_375(3);
}}}
...
}elseif(!func_153(PLAYER::PLAYER_PED_ID(), Local_290.f_0, 100f, 1) && bLocal_288){
func_375(4);
}}}}
...
struct<7> func_386(struct<3> Param0, struct<3> Param1, float fParam2){
struct<7> Var0;
Var0={
Param0 
};
...
bVar2=false;
while (bVar2 <=(15 - 1)){
MISC::CLEAR_BIT(&(Local_289[iVar1 /*22*/].f_15), bVar2);
bVar2++;
}
iVar1++;
}
...
struct<22> func_395(struct<3> Param0, float fParam1, int iParam2){
struct<22> Var0;
Var0.f_14=-1;
Var0.f_1={
Param0 
...
struct<6> func_397(struct<3> Param0, float fParam1, int iParam2){
struct<6> Var0;
Var0.f_1={
Param0 
};
...
void func_398(){
PED::ADD_RELATIONSHIP_GROUP("COPS", &uLocal_292);
}


void func_399(){
PED::REMOVE_RELATIONSHIP_GROUP(uLocal_292);
func_410(1);
if(OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Global_41953[13 /*31*/])){
...
if(CAM::DOES_CAM_EXIST(uLocal_263)){
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
CAM::DESTROY_CAM(uLocal_263, 0);
}}
