...
TASK::OPEN_SEQUENCE_TASK(&uLocal_227);
TASK::TASK_PLAY_ANIM(0, "rcmepsilonism3", "outro", 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_227);
TASK::TASK_PERFORM_SEQUENCE(Var0.f_28[0], uLocal_227);
}else{
...
var func__171(struct<3> Param0, int iParam1){
var uVar0;
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_259(iVar10, 14, uVar12[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_259(iVar10, 14, uVar15[iVar1], -1) 
};
func_231(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_254(14);
if(Global_78339==1){
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_221(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_221(iParam0));
if(iVar11 > iVar10){
...
float func_346(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
Var0={
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0->f_28[0], Local_234[iLocal_233 /*3*/], 1f, 20000, 0.25f, 0, 1193033728);
func_498("Eps 6:
Nav tasking Tom...");
iLocal_232=2;
}
...
int func_368(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6){
var uVar0;
if(func_332(2)){
if(!func_367()){
...
void func_374(){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_228, "SET_COLOUR");
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_228, "SET_DISTANCE");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(10f);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
HUD::SET_TEXT_RENDER_ID(uLocal_229);
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_228, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
if((MISC::GET_GAME_TIMER() - iLocal_230) > 1250){
AUDIO::PLAY_SOUND_FROM_COORD(uLocal_231, "IDLE_BEEP_NPC", 1827.06f, 4700.52f, 39.16f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
...
int func_392(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
...
int func_394(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7){
var uVar0;
...
void func_413(){
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_54, joaat("player"));
...
void func_435(){
uLocal_228=GRAPHICS::REQUEST_SCALEFORM_MOVIE("digiscanner");
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_228)){
wait(0);
}
...
if(HUD::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner")){
uLocal_229=HUD::GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");
}
...
PED::ADD_RELATIONSHIP_GROUP("gang", &uLocal_54);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uParam0->f_28[0], uLocal_54);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uParam0->f_28[1], uLocal_54);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uParam0->f_28[2], uLocal_54);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uParam0->f_28[3], uLocal_54);
...
void func_442(var uParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4){
func_443(uParam0);
...
void func_444(var uParam0, var uParam1, struct<3> Param2, float fParam3){
func_445(uParam0);
...
int func_451(var uParam0, bool bParam1, struct<3> Param2, float fParam3, bool bParam4){
int iVar0;
if(!func_36(bParam1)){
...
int func_456(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_395(uParam0)){
...
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0])){
if(func_450(&(uParam0->f_28[0]), 60, Var2, uVar3, "EPSILON LAUNCHER RC - MARNIE", 1)){
...
int func_479(int iParam0, int iParam1, struct<3> Param2, float fParam3){
int iVar0;
if(*iParam0==1){
...
int func_480(int iParam0, struct<3> Param1, float fParam2, var uParam3){
int iVar0;
struct<7> Var1;
iVar0=0;
...
int func_481(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
