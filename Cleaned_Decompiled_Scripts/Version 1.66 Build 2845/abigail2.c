...
func_237(3);
}}elseif(func_235(PLAYER::PLAYER_PED_ID(), iLocal_61) > 250f){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX())==0){
iLocal_60=2;
}else{
func_237(3);
...
iLocal_230=1;
}}elseif(((((iLocal_238 < 15 && !func_232()) && (MISC::GET_GAME_TIMER() - iLocal_235) > 10000) && func_231(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_61)) && func_214(&uLocal_65, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0)){
...
void func_240(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7){
...
void func_257(var uParam0, int iParam1, struct<3> Param2, int iParam3){
int iVar0;
int iVar1;
int iVar2;
int iVar3;
...
TASK::TASK_VEHICLE_PARK(0, iLocal_56, Local_239, 49.567f, 3, 1092616192, 0);
...
func_275();
func_237(4);
}elseif(ENTITY::IS_ENTITY_AT_COORD(iLocal_61, Local_239, 5f, 5f, 5f, 0, 1, 0)){
func_237(3);
}else{
func_273(&iLocal_62, "", "", &iLocal_63, iLocal_64, 0);
if(iLocal_231==0){
if(((func_472(iLocal_56) && PED::IS_PED_IN_VEHICLE(iLocal_61, iLocal_56, 1)) && func_231(iLocal_61, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_214(&uLocal_65, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0)){
iLocal_231=1;
}
...
int func_282(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5){
var uVar0;
struct<3> Var1;
var uVar2;
int iVar3;
...
int func_295(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
...
void func_300(){
if(!func_472(iLocal_56)){
iLocal_56=VEHICLE::CREATE_VEHICLE(iLocal_55, Local_57, fLocal_58, 1, 1, 0);
...
int func_340(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_472(uParam0)){
...
void func_342(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
var uVar0;
uVar0=PLAYER::GET_PLAYER_INDEX();
...
void func_345(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
func_346(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}


void func_346(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
Var4={
func_371(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
void func_391(struct<3> Param0, float fParam1, struct<3> Param2, float fParam3, struct<3> Param4, float fParam5, struct<3> Param6, float fParam7){
int iVar0;
if(func_347(Param0)){
...
iLocal_56=VEHICLE::CREATE_VEHICLE(iLocal_55, Param6, fParam7, 1, 1, 0);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_55, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_55);
func_300();
if(func_347(Param4)){
...
int func_392(var uParam0, int iParam1, struct<3> Param2, var uParam3, char* sParam4, int iParam5){
if(func_393(uParam0, iParam1, Param2, uParam3, 1)){
...
int func_393(int iParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_161(iParam1)){
...
int func_396(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5){
var uVar0;
var uVar1;
struct<97> Var2;
int iVar3;
