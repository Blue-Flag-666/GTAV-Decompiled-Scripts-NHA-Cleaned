...
if(Local_66.f_8 !=-1){
if(func_13()){
if(((ENTITY::DOES_ENTITY_EXIST(Local_66.f_12[Local_66.f_8]) && (!ENTITY::IS_ENTITY_DEAD(Local_66.f_12[Local_66.f_8], 0) || ENTITY::IS_ENTITY_IN_WATER(Local_66.f_12[Local_66.f_8]))) && func_9(Local_66.f_12[Local_66.f_8], 1, 0, 0, 0, 0, 1, 0, 1)) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_66.f_12[Local_66.f_8], 0)){
...
int iVar1;
int iVar2;
if(MISC::IS_BIT_SET(Local_66.f_0, 1)){
...
return 0;
}}elseif(!func_183(iParam0, "PACKED_MP_VEH_MOD_VAR_0_v", "VEM_CMOD_TYR", 1, 32, iVar12, -1, 0, 23)){
return 0;
}
...
return 0;
}}elseif(!func_183(iParam0, "PACKED_MP_VEH_MOD_VAR_1_v", "VEM_CMOD_TYR", 1, 32, iVar12, -1, 0, 23)){
return 0;
}}
...
return func_203(78225582, -1224924353, MISC::GET_HASH_KEY(&cVar1), 478352891, 1, 0, 1, 4, MISC::GET_HASH_KEY(&cVar0), 3);
}
...
return func_203(78225582, -1224924353, MISC::GET_HASH_KEY(&cVar2), 478352891, 1, 0, 1, 4, MISC::GET_HASH_KEY(&cVar0), 3);
}
...
return func_203(78225582, -1224924353, iVar1, 478352891, 1, 0, 1, 4, MISC::GET_HASH_KEY(&cVar0), 3);
}
...
}elseif(iParam4==func_211()){
StringCopy(sParam0, "VE_KOSATKA_t0_v0", 64);
}elseif(iParam4==func_210()){
if(iParam6==40){
...
}elseif((!HUD::IS_PAUSE_MENU_ACTIVE() && !func_239(8, -1)) && !Global_2683864.f_785.f_5){
if(PAD::IS_USING_KEYBOARD_AND_MOUSE(2)){
if(func_238()){
if(uParam0->f_420==0){
...
GRAPHICS::DRAW_SPRITE(func_270(Global_23270.f_5165), func_267(Global_23270.f_5165, 1), ((Global_23267 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
...
GRAPHICS::DRAW_SPRITE(func_270(Global_4540953.f_67), func_267(Global_4540953.f_67, 1), ((Global_23267 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
fVar49=(fVar49 + (((HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
...
if(iVar5==1){
GRAPHICS::DRAW_SPRITE(func_270(26), func_267(26, 1), ((fVar34 + fVar40) + fVar43), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}}
}
...
if(iVar5==1){
GRAPHICS::DRAW_SPRITE(func_270(27), func_267(27, 1), (((fVar34 + fVar40) + fVar43) + (fVar41 + fVar42)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}}
}
}
iVar25=0;
...
if(iVar5==1){
if(Global_23270.f_5526[iVar8]==2){
GRAPHICS::DRAW_SPRITE(func_270(Global_23270.f_4824[(iVar22 + iVar28)]), func_267(Global_23270.f_4824[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
else{
GRAPHICS::DRAW_SPRITE(func_270(Global_23270.f_4824[(iVar22 + iVar28)]), func_267(Global_23270.f_4824[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
}
...
GRAPHICS::DRAW_SPRITE(func_270(Global_23270.f_4824[(iVar22 + iVar14)]), func_267(Global_23270.f_4824[(iVar22 + iVar14)], bVar32), (Global_23267 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
elseif(Global_23270.f_5526[iVar8]==2){
GRAPHICS::DRAW_SPRITE(func_270(Global_23270.f_4824[(iVar22 + iVar14)]), func_267(Global_23270.f_4824[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
else{
GRAPHICS::DRAW_SPRITE(func_270(Global_23270.f_4824[(iVar22 + iVar14)]), func_267(Global_23270.f_4824[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
}
}
...
GRAPHICS::DRAW_SPRITE(func_270(Global_23270.f_4824[iVar22]), func_267(Global_23270.f_4824[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_249(Global_23270.f_4824[iVar22])), (fVar37 * func_249(Global_23270.f_4824[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
}
}}
bVar39=true;
...
uParam0->f_1[iVar0]=iVar8;
iVar0++;
}}elseif(!func_201(Global_1586468[iVar9 /*142*/].f_66)){
if(MISC::IS_BIT_SET(Global_1586468[iVar9 /*142*/].f_103, 6)){
StringCopy(&Var12, "MP_MAN_VEH_S1", 24);
StringIntConCat(&Var12, iVar11, 24);
func_271(iVar0, &Var12, iVar11, 1, 0, 0, 0);
...
switch (iParam0){
case 0:
func_384("CAS_VEH_REW", VEHICLE::GET_DISPLAY_NAME_FROM_VEHICLE_MODEL(func_385(Local_66.f_10)), -1);
break;
case 1:
...
uVar3=NETWORK::NET_TO_VEH(Local_65[iVar0 /*2*/].f_1);
ENTITY::SET_ENTITY_HEADING(uVar3, uVar2);
ENTITY::SET_ENTITY_INVINCIBLE(uVar3, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iVar3, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED_FOR_ALL_PLAYERS(iVar3, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED_FOR_PLAYER(iVar3, PLAYER::PLAYER_ID(), 0);
VEHICLE::SET_DONT_ALLOW_PLAYER_TO_ENTER_VEHICLE_IF_LOCKED_FOR_PLAYER(iVar3, 1);
VEHICLE::SET_VEHICLE_RESPECTS_LOCKS_WHEN_HAS_DRIVER(iVar3, 1);
...
if(ENTITY::IS_ENTITY_DEAD(uVar5, 0) || ENTITY::IS_ENTITY_IN_WATER(iVar5)){
uVar6=iVar5;
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uVar6)){
if(func_8(iVar6, &(Local_66.f_9))){
NETWORK::NETWORK_FADE_OUT_ENTITY(iVar6, 0, 1);
...
if(!func_200() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
return 1;
}}elseif(func_470(func_479(iVar1), Param0, fParam1, iParam2, 1036831949)){
return 1;
...
if(!func_524(Var1)){
Var1={
func_519(Var1, &fVar2, iVar7, uParam2->f_9, *uParam2, iVar8, uParam2->f_11, uParam2->f_34, &bVar9, bVar10, 1, uParam2->f_51, uParam2->f_60) 
};
if(vmag(Var1) > 0f){
if(!func_518(Var1, 5f)){
...
elseif(func_550(Var1, 6f, 1f, 1f, 5f, iVar17, bVar18, iVar19, fVar20, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_469(Var1, fVar2, uParam2->f_34, 1, 1, 0, 0, 0, 0)){
iVar21=1;
}
}
...
return 1;
}}elseif(vdist(func_479(iVar1), Param0) < 1f){
return 1;
}}elseif(Global_2648605.f_261[iVar0]){
if(vdist(Global_2648605.f_131[iVar0 /*3*/], Param0) < fParam1){
return 1;
...
if(vmag(*uParam3) > 0f){
*uParam3={
func_519(*uParam3, fParam4, iParam7, uParam5->f_9, *uParam5, iParam6, uParam5->f_11, uParam5->f_34, &bParam11, 0, 0, uParam5->f_51, uParam5->f_60) 
};
if(!func_524(*uParam3)){
iVar0=999;
return;
...
Vector3 func__519(struct<3> Param0, var uParam1, int iParam2, bool bParam3, struct<3> Param4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10, bool bParam11, var uParam12){
struct<3> Var0;
var uVar1;
var uVar2;
var uVar3;
...
Vector3 func__535(struct<3> Param0, struct<3> Param1, struct<3> Param2, float fParam3, int iParam4, float fParam5, bool bParam6){
int iVar0;
struct<3> Var1;
switch (iParam4){
case 0:
...
Vector3 func__537(struct<3> Param0, struct<3> Param1){
...
bVar10=true;
}}elseif(func_550(Var3, 6f, 1f, 1f, 5f, iVar6, bVar7, iVar8, fVar9, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_469(Var3, fVar4, uParam2->f_34, 1, 1, 0, 0, uParam2->f_58, 0)){
bVar10=true;
}
}
if(bVar10){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_552(PLAYER::PLAYER_ID()), Param0, 1) <=(fVar2 + fParam1)){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_552(iVar1), Param0, 1) <=(fVar2 + fParam1)){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_479(iVar1), Param0, 1) < fParam1){
return 1;
}}
}}}}}
iVar0++;
...
break;
}}elseif(func_579(Param0, &iVar2, &iVar3) || (func_557(Param0, &(iVar2[0])) && (VEHICLE::IS_THIS_MODEL_A_PLANE(iParam1) || VEHICLE::IS_THIS_MODEL_A_HELI(iParam1)))){
func_598();
iVar0=0;
while (iVar0 < iVar2){
if(iVar2[iVar0] > 1000){
