...
fLocal_31=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_32);
}
func_176(&iVar1);
func_31(&iVar2);
if(iLocal_39 > 3){
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_45, 4f, 0, 0, 0, 0, 0, 0, 0);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_44)){
VEHICLE::DELETE_VEHICLE(&iLocal_44);
}
iLocal_44=VEHICLE::CREATE_VEHICLE(func_167(), Local_45, fLocal_46, 1, 1, 0);
...
VEHICLE::SET_VEHICLE_EXTRA(iLocal_44, 1, 1);
}
if(VEHICLE::DOES_EXTRA_EXIST(iLocal_44, 2)){
VEHICLE::SET_VEHICLE_EXTRA(iLocal_44, 2, 0);
}
if(VEHICLE::DOES_EXTRA_EXIST(iLocal_44, 3)){
VEHICLE::SET_VEHICLE_EXTRA(iLocal_44, 3, 0);
}
...
if(iVar2==iLocal_44){
if(vdist2(Local_45, ENTITY::GET_ENTITY_COORDS(iLocal_28, 1)) < 100f){
...
Var4.f_85=4;
Var4.f_90=6;
iLocal_30=start_new_script_with_args("Traffick_Ground", &Var4, 97, 54000);
func_81(16);
...
var uVar0;
var uVar1;
uVar0=Global_2848282[iParam0 /*3*/][func_91(iParam1)];
...
int func_106(struct<3> Param0, char* sParam1, struct<3> Param2){
int iVar0;
int iVar1;
...
int func_115(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
Var3={
func_123(Var3, -Var0.f_3.f_2) 
};
Var3={
func_123(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__123(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
void func_158(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_157(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_32) < 2500f){
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_42, 8f, 0, 0, 0, 0, 0, 0, 0);
iLocal_40=VEHICLE::CREATE_VEHICLE(joaat("cuban800"), Local_42, 25.29f, 1, 1, 0);
...
iLocal_30=start_new_script("Traffick_Air", 54000);
func_81(15);
