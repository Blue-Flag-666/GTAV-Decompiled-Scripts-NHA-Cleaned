...
if(MISC::IS_BIT_SET(Global_2793046.f_2320.f_18, 1)){
func_137(41, 1);
}}
...
return (shift_right(iParam0, 26) & 31 * func_36(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
var func__39(struct<7> Param0, int iParam1){
var uVar0;
var uVar1;
var uVar2;
if(func_48(Param0)==0){
...
var func__49(struct<6> Param0, var uParam1){
var uVar0;
if(Param0.f_0 > 0){
...
}elseif(iParam4==func_65()){
StringCopy(sParam0, "VE_KOSATKA_t0_v0", 64);
}elseif(iParam4==func_64()){
if(iParam6==40){
