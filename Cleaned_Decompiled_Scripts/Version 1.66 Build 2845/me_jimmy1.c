...
iVar0=0;
while (iVar0 < 3){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_301[iVar0])){
if(PED::IS_PED_INJURED(uLocal_301[iVar0])){
func_2(5);
}}
iVar0++;
}}
...
func_2(2);
}elseif(func_42(iLocal_299) && func_42(PLAYER::PLAYER_PED_ID())){
if(FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_299, 1), 2f) && !FIRE::IS_EXPLOSION_IN_SPHERE(13, ENTITY::GET_ENTITY_COORDS(iLocal_299, 1), 2f)){
...
ENTITY::SET_ENTITY_COLLISION(iLocal_299, 1, 0);
func_2(2);
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_299, PLAYER::PLAYER_PED_ID(), 1)){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_299, uVar0);
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_299, joaat("script_task_hands_up"))==1){
...
}elseif(func_42(iLocal_299) && ENTITY::IS_ENTITY_AT_COORD(iLocal_299, Local_291, 50f, 50f, 50f, 0, 1, 0)){
func_50(iLocal_299);
}else{
func_53(&iLocal_299, 1, 0, 1);
}}
...
iVar0=0;
while (iVar0 < 3){
func_54(&(uLocal_301[iVar0]));
iVar0++;
}}else{
iVar0=0;
while (iVar0 < 3){
func_53(&(uLocal_301[iVar0]), 1, 0, 1);
iVar0++;
}}
func_67(&iLocal_298);
...
fVar3=0f;
if(!func_62(Global_113648.f_18535[iVar0], &Var2, &fVar3)){
...
PED::SET_PED_RESET_FLAG(iLocal_299, 60, 1);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_250, 1f, 20000, 1048576000, 0, 1193033728);
TASK::CLOSE_SEQUENCE_TASK(uVar1);
TASK::TASK_PERFORM_SEQUENCE(iLocal_299, uVar1);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_299, uVar2);
...
iLocal_296=2;
}}elseif(func_45(&uLocal_67, "MEJ1AUD", "MEJ1_HOME", 7, 0, 0, 0) || func_44(&iLocal_334, 5000)){
iLocal_296=2;
}}
if(func_83(1000)){
bLocal_252=true;
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_299, uVar3);
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_142(iVar10, 14, uVar12[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_142(iVar10, 14, uVar15[iVar1], -1) 
};
func_111(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_134(14);
if(Global_78339==1){
...
func_145(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_145(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_145(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
...
if(func_42(iLocal_299)){
TASK::CLEAR_PED_TASKS(iLocal_299);
ENTITY::SET_ENTITY_COORDS(iLocal_299, Local_249, 1, 0, 0, 1);
...
void func_214(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
int func_218(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
int func_219(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
func_223();
if(func_42(iLocal_299)){
PED::SET_PED_RESET_FLAG(iLocal_299, 124, 1);
}}
...
break;
case 2:
uLocal_233=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_233, 0f);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_233, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_233, 1);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_299, uLocal_233, sLocal_232, "enter_back", 8f, -8f, 4, iLocal_236, 1148846080, 0);
iLocal_266=0;
iLocal_267=-1;
iLocal_234=12;
break;
case 3:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_233)){
if(iLocal_237 || !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_304, 7)){
iLocal_234=14;
}else{
switch (func_225()){
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_233, 1);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_299, uLocal_233, sLocal_232, "enter_left", 8f, -8f, 4, iLocal_236, 1148846080, 0);
iLocal_234=5;
break;
case 5:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_233)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_233) >=0.9f){
uLocal_233=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_233, 1);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_233, 0);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_299, uLocal_233, sLocal_232, "left", 8f, -8f, 4, iLocal_236, 1148846080, 0);
iLocal_234=6;
}}
break;
case 6:
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_233, 1);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_299, uLocal_233, sLocal_232, "exit_left", 8f, -8f, 4, iLocal_236, 1148846080, 0);
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_233, 1);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_299, uLocal_233, sLocal_232, "enter_right", 8f, -8f, 4, iLocal_236, 1148846080, 0);
iLocal_234=9;
break;
case 9:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_233)){
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_233, 0);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_299, uLocal_233, sLocal_232, "right", 8f, -8f, 4, iLocal_236, 1148846080, 0);
iLocal_234=10;
}}
break;
case 10:
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_233, 1);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_299, uLocal_233, sLocal_232, "exit_right", 8f, -8f, 4, iLocal_236, 1148846080, 0);
if(iLocal_237 || !VEHICLE::IS_VEHICLE_WINDOW_INTACT(iLocal_304, 7)){
iLocal_234=13;
}else{
iLocal_234=12;
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_233, 0);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_299, uLocal_233, sLocal_232, "back", 8f, -8f, 4, iLocal_236, 1148846080, 0);
iLocal_234=3;
}}
break;
case 13:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_233)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_233) >=0.7f){
iLocal_234=14;
}}
break;
case 14:
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_233, 1);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_299, uLocal_233, sLocal_232, "exit_back", 4f, -8f, 4, iLocal_236, 1148846080, 0);
iLocal_234=15;
break;
case 15:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_233)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_233) >=0.95f){
uLocal_233=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_233, 0f);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_233, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_233, 1);
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_299, uLocal_233, sLocal_232, "enter_backseat", 8f, -8f, 4, iLocal_236, 1148846080, 0);
iLocal_234=16;
}}else{
uLocal_233=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_233, 0);
...
case 16:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_233)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_233) >=0.85f){
...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_304, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) 
};
if(Var0.f_1 < -1f){
return 1;
}elseif(Var0.f_0 < -1f){
...
func_67(&iLocal_298);
if(func_339()==1){
iLocal_298=func_338(Local_292, 5, 1);
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_292 - Vector(10f, 10f, 10f), Local_292 + Vector(10f, 10f, 10f), 0, 1);
MISC::CLEAR_AREA_OF_VEHICLES(Local_292, 10f, 0, 0, 0, 0, 0, 0, 0);
}else{
iLocal_298=func_338(Local_291, 5, 1);
}
...
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_299, 1);
PED::SET_PED_DIES_INSTANTLY_IN_WATER(iLocal_299, 0);
ENTITY::SET_ENTITY_PROOFS(iLocal_299, 1, 0, 0, 0, 1, 0, 0, 0);
PED::SET_PED_CAN_RAGDOLL(iLocal_299, 1);
}
...
void func_250(){
if((iLocal_285 < 12 && MISC::GET_GAME_TIMER() > iLocal_283) && func_42(uLocal_301[0])){
if(func_226(PLAYER::PLAYER_PED_ID(), uLocal_301[0]) < 30f){
if(!func_27() && func_230()){
...
}elseif(MISC::GET_GAME_TIMER() > iLocal_263){
...
void func_253(){
if(((((iLocal_288 && ENTITY::DOES_ENTITY_EXIST(uLocal_301[0])) && ENTITY::DOES_ENTITY_EXIST(uLocal_301[1])) && ENTITY::DOES_ENTITY_EXIST(uLocal_301[2])) && func_42(iLocal_299)) && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
...
iVar4=func_328(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
if(iVar4 !=-1){
...
int func_296(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
Var3={
func_303(Var3, -Var0.f_3.f_2) 
};
Var3={
func_303(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__303(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
return (shift_right(iParam0, 26) & 31 * func_321(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_330(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21){
uParam0->f_4=iParam4;
*uParam0=sParam1;
uParam0->f_1={
Param2 
...
int func_338(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
iVar0=0;
...
func_28();
func_67(&iLocal_298);
if((((func_49(iLocal_304) && func_42(uLocal_301[0])) && func_42(uLocal_301[1])) && func_42(uLocal_301[2])) && func_42(iLocal_299)){
ENTITY::SET_ENTITY_VISIBLE(iLocal_304, 1, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iLocal_304, 1);
iVar0=0;
iVar0=0;
while (iVar0 < 3){
ENTITY::SET_ENTITY_VISIBLE(uLocal_301[iVar0], 1, 0);
iVar0++;
}
ENTITY::SET_ENTITY_VISIBLE(iLocal_299, 1, 0);
PED::SET_PED_DIES_INSTANTLY_IN_WATER(iLocal_299, 1);
VEHICLE::SET_VEHICLE_FORWARD_SPEED(iLocal_304, 12f);
TASK::TASK_VEHICLE_DRIVE_WANDER(uLocal_301[0], iLocal_304, 12f, 786468);
VEHICLE::REQUEST_VEHICLE_ASSET(iLocal_305, 3);
iLocal_298=func_394(iLocal_304, 0, 5);
...
iLocal_237=0;
iLocal_261=1;
func_392(&uLocal_331, &uLocal_333, &uLocal_330, &fLocal_332);
fLocal_293=800f;
fLocal_294=100f;
PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
...
func_386();
func_384();
func_383(iLocal_298, iLocal_299, fLocal_293, 1061158912, 0);
if(func_49(iLocal_304) && ENTITY::DOES_ENTITY_EXIST(uLocal_301[0])){
if(iLocal_266 && MISC::GET_GAME_TIMER() > iLocal_267){
VEHICLE::SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(iLocal_304, 1);
iLocal_266=0;
}
func_356(&uLocal_40, iLocal_304, 0, 0, 1, 1, 1);
if((((((((((ENTITY::GET_ENTITY_HEALTH(iLocal_304) < 850 || func_355()) || func_353()) || func_352(iLocal_304, &uLocal_331, &uLocal_333, &uLocal_330, &fLocal_332, 6, 1082130432)) || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_304) < 50f) || VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(iLocal_304) < 50f) || (func_42(uLocal_301[0]) && !PED::IS_PED_IN_VEHICLE(uLocal_301[0], iLocal_304, 0))) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_304, 2, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_304, 3, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_304, 0, 5000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_304, 1, 5000)){
if(AUDIO::IS_MOBILE_PHONE_CALL_ONGOING()){
func_208();
}
if(func_42(uLocal_301[0])){
TASK::TASK_VEHICLE_TEMP_ACTION(uLocal_301[0], iLocal_304, 20, 1000);
}
...
ENTITY::SET_ENTITY_HEALTH(iLocal_299, 99, 0);
func_2(2);
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_304)){
STREAMING::REMOVE_ANIM_DICT("missfam3");
if(FIRE::IS_ENTITY_ON_FIRE(iLocal_304)){
PED::SET_PED_CAN_RAGDOLL(iLocal_299, 1);
PED::SET_PED_TO_RAGDOLL(iLocal_299, 500, 1000, 0, 0, 0, 0);
...
iVar2=0;
while (iVar2 < 3){
if(func_42(uLocal_301[iVar2])){
TASK::OPEN_SEQUENCE_TASK(&uVar3);
TASK::TASK_PAUSE(0, iVar2 * 1000);
if(PED::IS_PED_IN_VEHICLE(uLocal_301[iVar2], iLocal_304, 0)){
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 257);
}
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar3);
TASK::TASK_PERFORM_SEQUENCE(uLocal_301[iVar2], uVar3);
TASK::CLEAR_SEQUENCE_TASK(&uVar3);
if(iVar2==0 && !func_353()){
func_28();
func_4(&uLocal_67, "MEJ1AUD", "MEJ1_NERD", "MEJ1_NERD_1", 7, 1, 0);
}elseif(((iVar2==1 && !func_42(uLocal_301[0])) || ((iVar2==2 && !func_42(uLocal_301[0])) && !func_42(uLocal_301[1]))) && !func_353()){
func_351(&uLocal_67, 6, uLocal_301[iVar2], "MEJimmyKidnapper2", 1, 1);
func_28();
func_4(&uLocal_67, "MEJ1AUD", "MEJ1_NERD", "MEJ1_NERD_2", 7, 0, 0);
}elseif((iVar2==1 && func_42(uLocal_301[0])) || (iVar2==2 && (func_42(uLocal_301[0]) || func_42(uLocal_301[1])))){
func_348(uLocal_301[iVar2], 1);
}
}
iVar2++;
}
func_67(&iLocal_298);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_304, 0);
...
func_344();
}}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_304, 0)){
iLocal_237=1;
if(AUDIO::IS_AUDIO_SCENE_ACTIVE("M_E_JIMMY_STOP_KIDNAPPERS")){
AUDIO::STOP_AUDIO_SCENE("M_E_JIMMY_STOP_KIDNAPPERS");
}
...
iLocal_298=func_394(iLocal_304, 1, 5);
...
func_344();
}}elseif(func_227(PLAYER::PLAYER_PED_ID(), iLocal_304, 1) < (5f - 1f)){
iLocal_237=1;
func_344();
}}
break;
...
if(func_42(iLocal_299)){
PED::SET_PED_RESET_FLAG(iLocal_299, 249, 1);
PED::SET_PED_RESET_FLAG(iLocal_299, 248, 1);
PED::SET_PED_RESET_FLAG(iLocal_299, 124, 1);
}
func_223();
func_244();
...
if(func_42(PLAYER::PLAYER_PED_ID()) && func_42(iLocal_299)){
if((func_226(PLAYER::PLAYER_PED_ID(), iLocal_299) < 50f && !func_27()) && !func_385("MEJ1_02", 0, 0)){
if(iLocal_259){
if(func_45(&uLocal_67, "MEJ1AUD", "MEJ1_DONT", 7, 0, 0, 0)){
iLocal_256=MISC::GET_GAME_TIMER() + 10000;
iLocal_259=0;
}}elseif(func_45(&uLocal_67, "MEJ1AUD", "MEJ1_CALL", 7, 0, 0, 0)){
iLocal_256=MISC::GET_GAME_TIMER() + 10000;
}}}}}
...
void func_386(){
bool bVar0;
if((func_42(PLAYER::PLAYER_PED_ID()) && func_42(uLocal_301[0])) && func_49(iLocal_304)){
...
TASK::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_301[0], iLocal_304, PLAYER::PLAYER_PED_ID(), 8, 25f, 786468, 100f, 1f, 1);
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 0f, 3);
iLocal_234=2;
fLocal_293=200f;
fLocal_294=500f;
}}elseif(func_226(PLAYER::PLAYER_PED_ID(), uLocal_301[0]) < 50f && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_304)){
...
if(!func_27()){
if(func_387(&uLocal_67, 14, "MEJ1AUD", "MEJ1_DAD", 7, 0, 0, 1)){
iLocal_260=0;
}}}elseif(((iLocal_254 < 8 && func_226(PLAYER::PLAYER_PED_ID(), uLocal_301[0]) < 50f) && !func_27()) && !func_385("MEJ1_02", 0, 0)){
if(!iLocal_258 && func_45(&uLocal_67, "MEJ1AUD", "MEJ1_DSPOT", 7, 0, 0, 0)){
iLocal_263=MISC::GET_GAME_TIMER() + 5000;
iLocal_258=1;
iLocal_256=MISC::GET_GAME_TIMER() + 10000;
}elseif(iLocal_255==iLocal_254){
iLocal_254++;
iLocal_263=MISC::GET_GAME_TIMER() + 5000;
}elseif(MISC::GET_GAME_TIMER() > iLocal_263){
...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_304, 0f, -20f, 0f) 
};
if(func_391(PLAYER::PLAYER_PED_ID(), Var0, 20f, 1)){
iVar1=MISC::GET_RANDOM_INT_IN_RANGE(1, uLocal_301);
iVar2=MISC::GET_RANDOM_INT_IN_RANGE(1, 6);
iVar2 *=1000;
func_389(iLocal_301[iVar1], iVar2, 0);
...
bool func_391(int iParam0, struct<3> Param1, float fParam2, int iParam3){
...
case 0:
func_67(&iLocal_298);
iLocal_298=func_338(Local_290, 5, 0);
HUD::SET_BLIP_COLOUR(iLocal_298, 3);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_298, "MEJ1_JIM");
HUD::SET_BLIP_ROUTE(iLocal_298, 1);
func_402(&iLocal_298, -2086.913f, 951.6347f, 183.7526f, 75.8f);
...
break;
case 1:
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_290, 1) < 1400f){
iLocal_296=2;
}
break;
case 2:
...
if(func_391(PLAYER::PLAYER_PED_ID(), Local_290, 150f, 1) || func_387(&uLocal_67, 14, "MEJ1AUD", "MEJ1_CLOSE", 7, 0, 0, 1)){
iLocal_296=3;
}}
break;
case 3:
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_308, Local_309, fLocal_316, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_310, Local_311, fLocal_317, 0, 1, 0)){
ENTITY::SET_ENTITY_COORDS(iLocal_304, Local_306, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_304, fLocal_307);
return 1;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_312, Local_313, fLocal_316, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_314, Local_315, fLocal_317, 0, 1, 0)){
ENTITY::SET_ENTITY_COORDS(iLocal_304, Local_306, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_304, fLocal_307);
return 1;
}}
...
iLocal_301[iVar0]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_304, 4, iLocal_303, iLocal_302[iVar0], 1, 1);
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_301[iVar0], 1);
ENTITY::SET_ENTITY_VISIBLE(iLocal_301[iVar0], 0, 0);
...
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_301[iVar0], 17, 1);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_301[iVar0], 1);
if(iVar0==0){
func_351(&uLocal_67, 5, iLocal_301[iVar0], "MEJimmyKidnapper", 1, 1);
}}}
iVar0++;
}
if(!func_42(iLocal_299)){
if(STREAMING::HAS_MODEL_LOADED(func_52(14)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_232)){
func_398(&iLocal_299, Local_306, fLocal_307, 1);
ENTITY::SET_ENTITY_VISIBLE(iLocal_299, 0, 0);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_299, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_299, 29, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_299, 116, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_299, 104, 1);
...
ENTITY::SET_ENTITY_PROOFS(iLocal_299, 1, 0, 0, 1, 1, 0, 0, 0);
PED::SET_PED_CAN_RAGDOLL(iLocal_299, 0);
PED::SET_PED_RESET_FLAG(iLocal_299, 249, 1);
PED::SET_PED_RESET_FLAG(iLocal_299, 248, 1);
PED::SET_PED_RESET_FLAG(iLocal_299, 124, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_299, 1);
PED::SET_PED_DIES_IN_WATER(iLocal_299, 1);
PED::SET_PED_DIES_IN_SINKING_VEHICLE(iLocal_299, 1);
func_351(&uLocal_67, 3, iLocal_299, "JIMMY", 1, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID(), uLocal_300);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_299, uLocal_300);
ENTITY::SET_ENTITY_COLLISION(iLocal_299, 0, 0);
uLocal_233=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_233, 1);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_233, 0);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_233, iLocal_304, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_304, sLocal_235));
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_299, uLocal_233, sLocal_232, "base", 8f, -8f, 4, iLocal_236, 1148846080, 0);
iLocal_234=0;
}}}elseif(STREAMING::HAS_MODEL_LOADED(iLocal_305)){
iLocal_304=VEHICLE::CREATE_VEHICLE(iLocal_305, Local_306, fLocal_307, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOURS(iLocal_304, 22, 22);
VEHICLE::SET_VEHICLE_EXTRA_COLOURS(iLocal_304, 0, 8);
ENTITY::SET_ENTITY_VISIBLE(iLocal_304, 0, 0);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_304, 1);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_305, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_305);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_304, 1, 1);
VEHICLE::SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(iLocal_304, 0);
iLocal_266=0;
iLocal_267=-1;
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_304, "M_E_JIMMY_ENEMY_VEHICLE_GROUP", 0);
}}

int func_398(int iParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
iVar0=func_52(14);
...
void func_402(int iParam0, struct<3> Param1, float fParam2){
if(HUD::DOES_BLIP_EXIST(*iParam0)){
...
if(func_42(PLAYER::PLAYER_PED_ID())){
func_351(&uLocal_67, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 1, 1);
}
func_351(&uLocal_67, 4, 0, "JIMMY", 0, 1);
if(func_42(PLAYER::PLAYER_PED_ID())){
uLocal_300=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
}
func_534(1);
...
func_441(&iVar0, Var1, fVar2, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
}
if(func_399()){
iVar3=func_440();
if(Global_94858==1){
...
switch (iVar3){
case 0:
func_422(&iVar4, 1, 1, 1, 1, iLocal_335, 0, 145);
if(func_391(iVar4, -811.3438f, 187.4367f, 71.47861f, 6f, 1)){
...
void func_404(struct<3> Param0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5){
var uVar0;
int iVar1;
...
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_304, 1, 1, 0);
}}else{
Var2={
func_414() 
};
func_413(&Var2, &fVar3);
func_441(&iVar1, Var2, fVar3, 1, 0, 1, 1, 1, joaat("asterope"), 0, 145, 1);
...
func_46(1, 0);
func_400();
func_441(&iVar0, -2086.913f, 951.6347f, 183.7526f, 75.8f, 1, 1, 0, 1, 1, iLocal_335, 0, 145, 1);
if(func_49(iVar0)){
...
fVar1=0f;
func_441(iParam0, Var0, fVar1, 1, iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1);
...
int func_427(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
...
if(!func_495() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
void func_498(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
return func_508(&(Global_107196.f_2890), Param0, fParam1, 0);
}
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_511(iParam0, uVar1[iVar3], 1) && func_427(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_289(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
VEHICLE::DELETE_VEHICLE(&iParam0);
return 1;
}else{
return 0;
...
CAM::SET_WIDESCREEN_BORDERS(0, 0);
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_292 - Vector(10f, 10f, 10f), Local_292 + Vector(10f, 10f, 10f), 1, 1);
func_534(0);
