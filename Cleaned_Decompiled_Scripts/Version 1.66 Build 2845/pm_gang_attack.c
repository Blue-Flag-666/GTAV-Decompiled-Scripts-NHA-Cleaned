...
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_221[iVar1], 1, 1);
if(iLocal_226==0){
...
}elseif(func_6(uLocal_221[iVar1], func_7(func_8()), 1) > 100f && func_5(PLAYER::PLAYER_PED_ID(), uLocal_221[iVar1], 1) > 300f){
func_4();
}elseif(iLocal_219 && func_6(uLocal_221[iVar1], func_7(func_8()), 1) > 50f){
if(func_2()){
if(!iLocal_218){
...
WEAPON::SET_CURRENT_PED_WEAPON(uLocal_221[iVar0], joaat("weapon_microsmg"), 1);
}else{
WEAPON::GIVE_WEAPON_TO_PED(uLocal_221[iVar0], joaat("weapon_microsmg"), -1, 1, 1);
}}}
switch (uLocal_222[iVar0]){
case 0:
...
if(((((((((((func_44(Global_112358.f_35, 134217728) || PED::CAN_PED_SEE_HATED_PED(uLocal_221[iParam0], PLAYER::PLAYER_PED_ID())) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), uLocal_221[iParam0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uLocal_221[iParam0])) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], 1), 15f, 1)) || MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], 1), 15f, 1, 1)) || FIRE::IS_EXPLOSION_IN_SPHERE(21, ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], 1), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(10, ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], 1), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(7, ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], 1), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(0, ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], 1), 15f)) || FIRE::IS_EXPLOSION_IN_SPHERE(1, ENTITY::GET_ENTITY_COORDS(uLocal_221[iParam0], 1), 15f)) || iLocal_219){
return 1;
}
return 0;
}
...
PED::SET_PED_CONFIG_FLAG(uLocal_221[iVar0], 286, 1);
}}else{
bVar5=false;
...
uVar7=PED::GET_VEHICLE_PED_IS_IN(uLocal_221[iLocal_215], 0);
}
}}
if((((((((iLocal_215==-1 || !ENTITY::DOES_ENTITY_EXIST(uLocal_221[iLocal_215])) || PED::IS_PED_INJURED(uLocal_221[iLocal_215])) || !ENTITY::DOES_ENTITY_EXIST(uVar7)) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iVar7, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iVar7, 0, 1)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iVar7, 1, 1)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iVar7, 4, 1)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iVar7, 5, 1)){
iVar8=-1;
bVar9=false;
iVar4=0;
while (iVar4 <=5){
...
if(!func_38(uLocal_221[iVar0], joaat("script_task_combat"), 1)){
TASK::TASK_COMBAT_PED(uLocal_221[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
}}elseif(uLocal_220[Local_37[iVar0 /*10*/].f_8]==0 || Local_37[iVar0 /*10*/].f_9==-2){
}elseif(!PED::IS_PED_IN_VEHICLE(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], 0)){
...
elseif(!func_38(uLocal_221[iVar0], joaat("script_task_enter_vehicle"), 1)){
TASK::TASK_ENTER_VEHICLE(uLocal_221[iVar0], uLocal_220[Local_37[iVar0 /*10*/].f_8], -1, Local_37[iVar0 /*10*/].f_9, 2f, 1, 0);
}
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_220[Local_37[iVar0 /*10*/].f_8], 0)){
if(!func_38(uLocal_221[iVar0], joaat("script_task_combat"), 1)){
TASK::TASK_COMBAT_PED(uLocal_221[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
}
}}elseif(!func_38(uLocal_221[iVar0], joaat("script_task_vehicle_shoot_at_entity"), 1)){
...
}}elseif(!func_38(uLocal_221[iVar0], joaat("script_task_vehicle_mission"), 1) || iLocal_215 !=iLocal_216){
...
}elseif(TASK::GET_SCRIPT_TASK_STATUS(uLocal_221[iVar0], joaat("script_task_vehicle_mission"))==1){
...
elseif(func_46(uLocal_221[iVar0], 0)==-1){
if(!func_38(uLocal_221[iVar0], joaat("script_task_vehicle_mission"), 1) || iLocal_215 !=iLocal_216){
TASK::TASK_VEHICLE_ESCORT(uLocal_221[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_221[iVar0], 0), PED::GET_VEHICLE_PED_IS_IN(uLocal_221[iLocal_215], 0), -1, 40f, 786468, -1082130432, 20, 1101004800);
}elseif(TASK::GET_SCRIPT_TASK_STATUS(uLocal_221[iVar0], joaat("script_task_vehicle_mission"))==1){
if(!TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(uLocal_221[iVar0])){
TASK::TASK_DRIVE_BY(uLocal_221[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 1000f, 100, 1, -753768974);
}}
...
if(!func_38(uLocal_221[iVar0], joaat("script_task_shuffle_to_next_vehicle_seat"), 1)){
TASK::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(uLocal_221[iVar0], PED::GET_VEHICLE_PED_IS_IN(uLocal_221[iVar0], 0), 0);
}}elseif(!func_38(uLocal_221[iVar0], joaat("script_task_drive_by"), 1) || iLocal_215 !=iLocal_216){
TASK::TASK_DRIVE_BY(uLocal_221[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 1000f, 100, 1, -753768974);
}
}}
break;
...
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_225, 0);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_226, 0);
