...
if((((((iLocal_64==0 && !MISC::IS_BIT_SET(Global_1890444[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*129*/].f_38.f_27, 3)) && !func_16()) && !HUD::IS_PAUSE_MENU_ACTIVE()) && !func_15(0)) && !func_14()) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 225)){
func_12(&Local_47);
}}else{
MISC::CLEAR_BIT(&Global_1836154, 1);
}}else{
...
if(func_81(PLAYER::PLAYER_ID()) || MISC::IS_BIT_SET(iLocal_64, 0)){
return 0;
}
Var0={
uParam0->f_1 
