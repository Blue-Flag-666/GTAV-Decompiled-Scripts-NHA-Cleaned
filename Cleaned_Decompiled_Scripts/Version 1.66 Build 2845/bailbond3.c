...
StringCopy(&cLocal_327, "MAUDE_MCS_4", 24);
Local_63={
ScriptParam_342 
};
...
if(func_116(Local_75.f_0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f, 1)){
...
func_105(&(Global_107196.f_2890), Param0, fParam1);
}
...
bool func_116(int iParam0, struct<3> Param1, float fParam2, int iParam3){
...
func_130(13, floor(Global_113648.f_10196.f_3853));
}
...
if(iParam2==1){
if(func_185(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
}}
func_136(Global_104212.f_4, Param0, fParam1, 24, 0);
}}}}
...
return func_197(Global_104212.f_2890.f_12.f_66, Param0, iParam1);
}
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_254(iVar10, 14, uVar12[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_254(iVar10, 14, uVar15[iVar1], -1) 
};
func_223(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_246(14);
if(Global_78339==1){
...
func_257(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_257(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_257(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
...
elseif(func_124(iLocal_134, 8000)){
bVar0=true;
}
...
iLocal_123=MISC::GET_GAME_TIMER();
}}elseif(func_75(&uLocal_157, cLocal_150, "BB3_FLEE", 4, 0, 0, 0)){
iLocal_123=MISC::GET_GAME_TIMER();
}
}
}}}else{
...
void func_328(int iParam0, struct<3> Param1, int iParam2, float fParam3){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
int func_332(int iParam0, struct<3> Param1, bool bParam2, bool bParam3, bool bParam4, int iParam5){
int iVar0;
if(func_23(iParam0)){
...
int func_333(int iParam0, struct<3> Param1, float fParam2, float fParam3){
...
void func_353(var uParam0, int iParam1, struct<3> Param2, int iParam3){
int iVar0;
int iVar1;
int iVar2;
int iVar3;
...
if(bLocal_115){
PED::SET_PED_MOVEMENT_CLIPSET(Local_68.f_9, func_376(), 1048576000);
iLocal_70=2;
}else{
...
elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_68.f_9, "oddjobs@bailbond_mountain", "base_jump_idle", 3)){
...
PED::SET_PED_RESET_FLAG(Local_68.f_9, 222, 1);
Local_335={
ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_68.f_9) 
};
TASK::OPEN_SEQUENCE_TASK(&uLocal_145);
...
ENTITY::APPLY_FORCE_TO_ENTITY(Local_68.f_9, 1, Vector(fVar5, fVar5, fVar5) * Local_335, Var4, 0, 0, 1, 1, 0, 1);
Local_68.f_18=MISC::GET_GAME_TIMER();
Local_68.f_10=19;
}
}}else{
...
break;
case 19:
PED::FORCE_PED_MOTION_STATE(Local_68.f_9, joaat("MotionState_Parachuting"), 0, 0, 0);
...
Local_68.f_10=21;
}elseif(PED::GET_PED_PARACHUTE_STATE(Local_68.f_9)==2){
if(!iLocal_106){
...
if((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], 0) && func_116(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f, 1)) && func_374(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f)){
if(PED::IS_PED_IN_VEHICLE(Local_68.f_9, Local_71[0 /*6*/], 0) && !PED::IS_PED_BEING_JACKED(Local_68.f_9)){
Local_68.f_10=25;
}elseif(func_124(Local_68.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 350))){
if(PED::IS_PED_USING_ANY_SCENARIO(Local_68.f_9)){
PED::SET_PED_PANIC_EXIT_SCENARIO(Local_68.f_9, Local_332);
}else{
TASK::CLEAR_PED_TASKS(Local_68.f_9);
...
if(!func_102(Local_71[0 /*6*/])){
Local_68.f_10=22;
}elseif(((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], 0) || PED::IS_PED_BEING_JACKED(Local_68.f_9)) || !func_116(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f, 1)) || !func_374(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f)){
Local_68.f_10=22;
...
if(PED::IS_PED_IN_ANY_VEHICLE(Local_68.f_9, 0)){
TASK::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
}elseif(((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && !PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_68.f_9)) && !func_371()) || ENTITY::IS_ENTITY_IN_WATER(Local_68.f_9)){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1);
...
Local_68.f_10=32;
}}elseif(!func_368(Local_68.f_19, 10) && func_116(Local_68.f_9, Local_332, 50f, 1)){
...
int func_381(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5){
var uVar0;
struct<3> Var1;
var uVar2;
int iVar3;
...
float func_385(struct<3> Param0, struct<3> Param1){
return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
void func_388(){
if(func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_331, 100f)){
if(!func_389()){
CUTSCENE::REQUEST_CUTSCENE(&cLocal_327, 8);
func_67();
iLocal_113=1;
}}elseif(iLocal_113){
if(!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_331, 120f)){
if(CUTSCENE::HAS_CUTSCENE_LOADED()){
CUTSCENE::REMOVE_CUTSCENE();
iLocal_113=0;
}}else{
...
}}elseif(func_116(Local_68.f_9, Local_332, 8f, 1)){
...
iLocal_123=MISC::GET_GAME_TIMER();
}}elseif(func_75(&uLocal_157, cLocal_150, "BB3_J5", 4, 0, 0, 0)){
iLocal_123=MISC::GET_GAME_TIMER();
}
}}
iLocal_110=0;
...
int func_391(int iParam0, struct<3> Param1, int iParam2, int iParam3, float fParam4){
struct<3> Var0;
var uVar1;
char[] cVar2[8];
char* sVar3;
...
elseif(func_75(&uLocal_157, cLocal_150, "BB3_WTF", 4, iVar1, 0, 0)){
iLocal_89=1;
}}}elseif(!iLocal_93){
if(func_394(&iVar0)){
...
iLocal_90=1;
}}elseif(func_75(&uLocal_157, cLocal_150, "BB3_OUT", 4, iVar1, 0, 0)){
iLocal_90=1;
}
}}}elseif(Local_68.f_10==33 && func_64(Local_68.f_9, joaat("script_task_hands_up"))){
if(func_116(Local_68.f_9, Local_332, 25f, 1)){
...
if(iLocal_97){
uLocal_116=func_400(Local_331, 5, 1);
}
}
if(!iLocal_83){
if(!func_326(sLocal_148, 1)){
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_331, 4f, 4f, 2f, 1, 1, 0)){
}
...
elseif(func_116(PLAYER::PLAYER_PED_ID(), Local_331, 2.5f, 1)){
iLocal_60=2;
}}}else{
func_121(&uLocal_116);
...
int func_400(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
iVar0=0;
...
Local_68.f_10=22;
}elseif(Local_68.f_10==22 || Local_68.f_10==23){
if(iLocal_135==-1){
iLocal_135=MISC::GET_GAME_TIMER();
}
if(iLocal_134==-1){
...
elseif(func_124(iLocal_134, 5000)){
bVar0=true;
}
...
}elseif(ENTITY::DOES_ENTITY_EXIST(Local_73[0 /*9*/])){
if(!ENTITY::IS_ENTITY_ATTACHED(Local_73[0 /*9*/])){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_73[0 /*9*/], Local_69[0 /*20*/], PED::GET_PED_BONE_INDEX(Local_69[0 /*20*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}else{
...
}}elseif(func_409(Local_68.f_9, iLocal_133, 0, 1103626240, 1086324736)){
iLocal_61=0;
}elseif(func_116(Local_68.f_9, Local_332, 5f, 1)){
iLocal_61=0;
}elseif(func_410(&(Local_68.f_19))){
...
elseif(func_124(Local_68.f_17, 500)){
if(Local_68.f_10 !=3 && Local_68.f_10 !=4){
Local_68.f_18=MISC::GET_GAME_TIMER();
Local_68.f_10=3;
}
...
int func_411(int iParam0, struct<3> Param1, float fParam2){
struct<3> Var0;
float fVar1;
Var0={
...
int func_426(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
...
void func_431(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4){
...
void func_446(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11){
int iVar0;
iVar0=1;
...
int func_447(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5){
var uVar0;
var uVar1;
struct<97> Var2;
int iVar3;
...
func_487(iParam0, &(Var2.f_31), &(Var2.f_81));
VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
if(iParam1==1){
...
if(((!func_461(PLAYER::PLAYER_ID()) && iParam0 !=joaat("thruster")) && iParam0 !=joaat("avenger")) && !bVar0){
return 0;
}
return 1;
}
...
if(!func_493() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
void func_496(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
int func_500(struct<3> Param0, float fParam1){
return func_501(&(Global_107196.f_2890), Param0, fParam1, 0);
}

int func_501(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
func_537(Local_69[0 /*20*/], "BACKUP_", 0);
...
if(!ENTITY::IS_ENTITY_ATTACHED(Local_73[0 /*9*/])){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_73[0 /*9*/], Local_69[0 /*20*/], PED::GET_PED_BONE_INDEX(Local_69[0 /*20*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::FREEZE_ENTITY_POSITION(Local_73[0 /*9*/], 0);
TASK::TASK_LOOK_AT_ENTITY(Local_69[0 /*20*/], Local_68.f_9, -1, 2060, 3);
TASK::TASK_PLAY_ANIM(Local_69[0 /*20*/], "oddjobs@bailbond_mountain", "Idle_Camman", 8f, -8f, -1, 49, 0, 0, 0, 0);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_69[0 /*20*/], Local_68.f_9, -1);
}}}}}
...
int func_539(var uParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4, bool bParam5){
if(!OBJECT::DOES_PICKUP_EXIST(*uParam0)){
if(func_56(iParam4)){
...
int func_540(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
if(!ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(func_56(iParam1)){
...
Vector3 func__541(struct<5> Param0, var uParam1, var uParam2, var uParam3){
switch (Param0.f_4){
case 0:
...
MISC::SET_BIT(&(Local_74[0 /*7*/].f_6), true);
iLocal_131=1;
Local_336={
...
void func_572(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21){
uParam0->f_4=iParam4;
*uParam0=sParam1;
uParam0->f_1={
Param2 
