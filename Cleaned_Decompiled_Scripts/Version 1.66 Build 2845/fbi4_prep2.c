...
void func_96(){
func_131(&iLocal_198, &uLocal_199, &iLocal_55, &iLocal_173, &iLocal_172, Local_176, Local_202.f_0, 0, 11f);
switch (iLocal_53){
case 0:
...
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_202.f_0, 0)){
...
void func_105(int iParam0, struct<3> Param1, int iParam2){
if(!HUD::DOES_BLIP_EXIST(*iParam0)){
*iParam0=func_106(Param1, 5, iParam2);
}}

int func_106(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
iVar0=0;
...
iLocal_52=2;
return 1;
}elseif((((func_124(2, Local_202.f_1, Local_202.f_4) && func_124(5, Local_200.f_1, Local_200.f_4)) && func_124(6, Local_201.f_1, Local_201.f_4)) && func_124(3, Local_197.f_1, Local_197.f_4)) && func_124(4, Local_175, 0)){
uLocal_206=PED::ADD_SCENARIO_BLOCKING_AREA(-417.198f, -2155.886f, 8.36266f, -383.4908f, -2188.511f, 12.9213f, 0, 1, 1, 1);
func_122(34);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("trash"), 1);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("towtruck"), 1);
if(func_449(Local_197.f_0)){
if(!func_121(Local_197.f_0, joaat("script_task_play_anim"))){
TASK::TASK_PLAY_ANIM_ADVANCED(Local_197.f_0, "mini@repair", "fixing_a_ped", ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_200.f_0, Local_196), 0f, 0f, -ENTITY::GET_ENTITY_HEADING(Local_200.f_0), 1000f, -1.5f, -1, 1, 0, 2, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_197.f_0, 0, 0);
}
func_120();
func_118();
PED::SET_PED_CONFIG_FLAG(Local_197.f_0, 154, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_197.f_0, uLocal_203);
}
...
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Tow_truck_damage", Local_200.f_0, "FBI_04_HEAT_SOUNDS", 0, 0);
return 1;
}}else{
return 1;
}}
...
MISC::CLEAR_AREA(Local_197.f_1, 100f, 1, 0, 0, 0);
func_115();
if(func_449(Local_197.f_0)){
...
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_202.f_0, 1);
return 1;
}}elseif(func_128(&Local_202, Local_202.f_5, Local_202.f_1, Local_202.f_4, 1)){
func_129(Local_202.f_0, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_202.f_0, 1);
return 1;
}
...
PED::SET_PED_CAPSULE(Local_197.f_0, 0.1f);
AUDIO::STOP_PED_SPEAKING(Local_197.f_0, 1);
TASK::SET_PED_PATH_MAY_ENTER_WATER(Local_197.f_0, 0);
return 1;
}}else{
return 1;
}}elseif(func_125(&Local_197, Local_197.f_5, Local_197.f_1, Local_197.f_4, 1, 0, 1, 1)){
PED::SET_PED_CAPSULE(Local_197.f_0, 0.1f);
AUDIO::STOP_PED_SPEAKING(Local_197.f_0, 1);
...
return 1;
}}elseif(func_128(&Local_200, Local_200.f_5, Local_200.f_1, Local_200.f_4, 1)){
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_200.f_0, 0);
VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_200.f_0, 4, 0, 0);
VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_200.f_0, 0, 1, 0);
...
return 1;
}}elseif(func_128(&Local_201, Local_201.f_5, Local_201.f_1, Local_201.f_4, 1)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_201.f_0, 3);
return 1;
}
break;
...
int func_125(var uParam0, var uParam1, struct<3> Param2, var uParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7){
...
int func_128(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
if(!ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
void func_131(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, struct<3> Param5, int iParam6, bool bParam7, int iParam8){
if(func_6(*iParam0)){
switch (*iParam2){
case 0:
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, 0)){
...
if(!func_142()){
if(func_449(Local_197.f_0)){
if(func_137(PED::GET_VEHICLE_PED_IS_IN(Local_197.f_0, 0))){
...
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, 0), Local_176, 4, 20f, 786469, 2f, 10f, 1);
iLocal_57[iParam0]=5;
}
break;
case 5:
...
case 0:
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_197.f_0, Var1) 
};
if(!MISC::IS_POSITION_OCCUPIED(Var0, 1.5f, 0, 0, 1, 0, 0, Local_197.f_0, 0)){
if(!bLocal_195){
if(iParam0==0){
sVar2="FP2_MTAKEDOW";
}
...
if(!func_151()){
if((ENTITY::DOES_ENTITY_EXIST(iLocal_198) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_198, 0)) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_198, Local_176, 2f, 2f, 2f, 0, 1, 0)){
...
if(!func_151()){
if(func_449(Local_197.f_0)){
if(((ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam1, -408.0286f, -2175.476f, 5.31836f, -394.644f, -2175.297f, 15.31835f, 21.52f, 0, 1, 0) && !func_153(iParam0)) && !PED::IS_PED_IN_MELEE_COMBAT(Local_197.f_0)) && !PED::IS_PED_IN_ANY_VEHICLE(iParam1, 0)){
iLocal_58[iParam0]=1;
return 1;
}}}
return 0;
...
break;
case 9:
if(func_209(Local_197.f_0, PLAYER::PLAYER_PED_ID(), 20f, 1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_210(10);
return;
}
if(func_208()){
...
if(!func_209(Local_197.f_0, PLAYER::PLAYER_PED_ID(), 10f, 1)){
func_210(14);
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_197.f_0, PLAYER::PLAYER_PED_ID(), 1)){
func_210(14);
}else{
func_210(13);
}}elseif(func_202(Local_197.f_0, 1, 0, 0, 0)){
func_210(14);
}
break;
case 15:
...
case 16:
if(func_6(Local_202.f_0)){
if(PED::IS_PED_IN_VEHICLE(Local_197.f_0, Local_202.f_0, 0)){
...
TASK::TASK_PERFORM_SEQUENCE(Local_197.f_0, uVar0);
...
}}elseif(!func_121(Local_197.f_0, joaat("script_task_achieve_heading"))){
...
func_210(13);
}}elseif(((((iLocal_56 !=15 && iLocal_56 !=9) && iLocal_56 !=10) && iLocal_56 !=6) && iLocal_56 !=8) && iLocal_56 !=7){
func_210(15);
}}
...
}elseif((MISC::GET_GAME_TIMER() - iLocal_185) > 6000){
return 1;
}}}elseif(func_209(Local_197.f_0, PLAYER::PLAYER_PED_ID(), 10f, 1)){
if(ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 10f){
if(iLocal_185==-1){
iLocal_185=MISC::GET_GAME_TIMER();
}elseif((MISC::GET_GAME_TIMER() - iLocal_185) > 5500){
return 1;
}}}else{
iLocal_185=-1;
}
...
if(!func_121(Local_197.f_0, joaat("script_task_play_anim"))){
if(func_6(Local_200.f_0)){
TASK::TASK_PLAY_ANIM(Local_197.f_0, "mini@repair", "fixing_a_ped", 1.5f, -1.5f, -1, 1, 0, 0, 0, 0);
}}
break;
case 3:
...
if(!func_121(Local_197.f_0, joaat("script_task_enter_vehicle"))){
if(func_6(Local_200.f_0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(Local_197.f_0, 0)){
...
TASK::TASK_VEHICLE_MISSION(Local_197.f_0, Local_201.f_0, Local_200.f_0, 11, 30f, 34341156, 1f, -1f, 1);
}else{
func_213();
iParam0=10;
}
...
elseif(iLocal_55==1){
if(!ENTITY::IS_ENTITY_UPSIDEDOWN(Local_201.f_0)){
TASK::TASK_VEHICLE_MISSION(Local_197.f_0, Local_201.f_0, Local_202.f_0, 11, 30f, 34341156, 1f, -1f, 1);
}else{
func_213();
iParam0=10;
}
}}}elseif(func_6(Local_200.f_0) && func_6(Local_202.f_0)){
if(bLocal_177){
if(!ENTITY::IS_ENTITY_UPSIDEDOWN(Local_202.f_0)){
TASK::TASK_VEHICLE_MISSION(Local_197.f_0, Local_202.f_0, Local_200.f_0, 11, 30f, 34341156, 1f, -1f, 1);
}
else{
func_213();
iParam0=10;
...
TASK::TASK_VEHICLE_MISSION(Local_197.f_0, Local_200.f_0, Local_202.f_0, 11, 30f, 34341156, 1f, -1f, 1);
}
else{
func_213();
iParam0=10;
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_203, joaat("player"));
...
TASK::TASK_SMART_FLEE_PED(Local_197.f_0, PLAYER::PLAYER_PED_ID(), 120f, -1, 0, 0);
}
break;
case 15:
if(!func_121(Local_197.f_0, joaat("script_task_combat"))){
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_197.f_0, sParam0, "S_M_M_TRUCKER_01_BLACK_FULL_02", "SPEECH_PARAMS_FORCE", 0);
}
...
if(!func_235() || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_197.f_0, PLAYER::PLAYER_PED_ID(), 1)){
...
void func_229(){
if(!PED::IS_PED_IN_ANY_VEHICLE(Local_197.f_0, 1)){
func_194();
}else{
if(func_6(Local_202.f_0)){
if(PED::IS_PED_IN_VEHICLE(Local_197.f_0, Local_202.f_0, 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_197.f_0, Local_202.f_0, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
iLocal_56=14;
return;
}}
if(func_6(Local_200.f_0)){
if(PED::IS_PED_IN_VEHICLE(Local_197.f_0, Local_200.f_0, 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_197.f_0, Local_200.f_0, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
iLocal_56=14;
return;
}}
if(func_6(Local_201.f_0)){
if(PED::IS_PED_IN_VEHICLE(Local_197.f_0, Local_201.f_0, 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_197.f_0, Local_201.f_0, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
iLocal_56=14;
}}}
...
int func_235(){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_197.f_0, 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)){
return 1;
}
return 0;
}
...
func_210(15);
}}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_202.f_0, PLAYER::PLAYER_PED_ID(), 1)){
...
}}elseif(PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_200.f_0)){
func_210(15);
...
if(func_95(Local_200.f_0, Local_200.f_1, 2f, 1)){
func_210(5);
}}}elseif((((((func_241() && iLocal_56 !=7) && iLocal_56 !=6) && iLocal_56 !=8) && iLocal_56 !=11) && iLocal_56 !=16) && iLocal_56 !=7){
func_210(16);
}}
...
if(func_209(Local_197.f_0, PLAYER::PLAYER_PED_ID(), 2f, 1) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
}}elseif(func_95(PLAYER::PLAYER_PED_ID(), Local_176, 240f, 1)){
if(iLocal_205){
func_133(&iLocal_204);
iLocal_205=0;
}}}
...
return;
}}elseif(!func_209(Local_197.f_0, PLAYER::PLAYER_PED_ID(), 200f, 1)){
if(ENTITY::IS_ENTITY_ON_SCREEN(Local_197.f_0)){
func_207(&Local_197, 0, 1, 1);
func_133(&Local_200);
}else{
...
void func_251(){
func_252();
func_131(&iLocal_198, &uLocal_199, &iLocal_55, &iLocal_173, &iLocal_172, Local_176, Local_202.f_0, 0, 1090519040);
func_156();
func_145();
switch (iLocal_53){
case 0:
...
bLocal_177=true;
}}elseif(!PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_200.f_0)){
bLocal_177=false;
}}}
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_323(iVar10, 14, uVar12[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_323(iVar10, 14, uVar15[iVar1], -1) 
};
func_292(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_315(14);
if(Global_78339==1){
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_282(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
uVar0=Global_2805029[iParam0 /*3*/][func_318(iParam1)];
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_282(iParam0));
if(iVar11 > iVar10){
...
void func_392(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4){
struct<60> Var0;
...
void func_429(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4){
if(func_426(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
iVar0=0;
if(!func_6(iLocal_198)){
if(!func_6(uLocal_199) && !func_6(Local_202.f_0)){
func_448(1);
return;
}
if(func_6(Local_202.f_0)){
...
if(func_6(uLocal_199)){
if(!func_209(PLAYER::PLAYER_PED_ID(), uLocal_199, 500f, 1)){
iVar0++;
}}else{
iVar0++;
}
...
void func_464(){
PED::ADD_RELATIONSHIP_GROUP("ENEMY", &uLocal_203);
}
...
bool func_468(var uParam0, struct<2> Param1, Vector3 vParam2){
bool bVar0;
int iVar1;
int iVar2;
if(uParam0->f_46 < 3){}
...
struct<16> func_473(struct<3> Param0, float fParam1, int iParam2){
struct<16> Var0;
Var0.f_14=-1;
Var0.f_1={
Param0 
...
struct<6> func_475(struct<3> Param0, float fParam1, int iParam2){
struct<6> Var0;
Var0.f_1={
Param0 
};
...
func_478();
func_477();
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_206, 0);
func_262(0);
