...
StringCopy(&cLocal_331, "MAUDE_MCS_3", 24);
...
}}elseif(func_75(&uLocal_157, cLocal_151, &Local_323, 4, 0, 0, 0)){
iLocal_95=1;
}}
if(iLocal_62==4){
if(!iLocal_105){
...
elseif(func_120(iLocal_136, 8000)){
bVar0=true;
}
...
iLocal_124=MISC::GET_GAME_TIMER();
}}elseif(func_75(&uLocal_157, cLocal_150, "BB2_FLEE", 4, 0, 0, 0)){
iLocal_124=MISC::GET_GAME_TIMER();
}
}
}}}else{
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uParam0, iLocal_322);
...
Local_68.f_10=23;
}}elseif(!func_366(Local_68.f_19, 10) && func_112(Local_68.f_9, Local_337, 50f, 1)){
...
void func_386(){
if(func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_336, 100f)){
if(!func_387()){
CUTSCENE::REQUEST_CUTSCENE(&cLocal_331, 8);
func_67();
iLocal_114=1;
}}elseif(iLocal_114){
if(!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_336, 120f)){
if(CUTSCENE::HAS_CUTSCENE_LOADED()){
CUTSCENE::REMOVE_CUTSCENE();
iLocal_114=0;
}}else{
...
func_389();
}}elseif(func_112(Local_68.f_9, Local_337, 8f, 1)){
...
iLocal_124=MISC::GET_GAME_TIMER();
}}elseif(func_75(&uLocal_157, cLocal_150, "BB2_J5", 4, 0, 0, 0)){
iLocal_124=MISC::GET_GAME_TIMER();
}
}}
iLocal_110=0;
...
elseif(func_75(&uLocal_157, cLocal_150, "BB2_WTF", 4, iVar1, 0, 0)){
iLocal_89=1;
}}}elseif(!iLocal_93){
if(func_390(&iVar0)){
...
iLocal_90=1;
}}elseif(func_75(&uLocal_157, cLocal_150, "BB2_OUT", 4, iVar1, 0, 0)){
iLocal_90=1;
}
...
if(iLocal_97){
uLocal_117=func_398(Local_336, 5, 1);
}
}
if(!iLocal_83){
if(!func_324(sLocal_148, 1)){
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_336, 4f, 4f, 2f, 1, 1, 0)){
}
...
elseif(func_112(PLAYER::PLAYER_PED_ID(), Local_336, 2.5f, 1)){
iLocal_60=2;
}}}else{
func_117(&uLocal_117);
...
int func_394(struct<3> Param0, struct<3> Param1, float fParam2){
int iVar0;
...
bool func_395(struct<3> Param0, struct<3> Param1, float fParam2){
struct<3> Var0;
Var0={
Param1 - Param0 
};
...
int func_396(int iParam0, struct<3> Param1, int iParam2, int iParam3, float fParam4){
struct<3> Var0;
var uVar1;
char[] cVar2[8];
char* sVar3;
...
elseif(func_120(iLocal_136, 5000)){
bVar0=true;
}
...
func_326(Local_68.f_9, Local_337, iLocal_137, 925353388);
}}elseif((iLocal_129 > 0 && func_112(Local_68.f_9, Local_337, 85f, 1)) || ENTITY::GET_ENTITY_HEALTH(Local_68.f_9) < 200){
Local_68.f_10=13;
Local_68.f_18=(MISC::GET_GAME_TIMER() - 5000);
iLocal_136=MISC::GET_GAME_TIMER();
...
iLocal_124=MISC::GET_GAME_TIMER();
}}elseif(func_75(&uLocal_157, cLocal_150, "BB2_SHOOT", 4, 0, 0, 0)){
iLocal_124=MISC::GET_GAME_TIMER();
}}
}}else{
iLocal_124=MISC::GET_GAME_TIMER();
...
break;
case 2:
func_403(Local_69[iVar0 /*20*/], &(Local_69[iVar0 /*20*/].f_6), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
break;
case 3:
...
}}elseif(func_413(Local_68.f_9, iLocal_135, 0, 1102053376, 1086324736)){
iLocal_61=0;
}elseif(func_112(Local_68.f_9, Local_337, 5f, 1)){
iLocal_61=0;
}elseif(func_414(&(Local_68.f_19))){
...
iLocal_92=1;
}}elseif(func_411(&uLocal_157, cLocal_150, "BB2_AMB", &Local_335, 1, iLocal_118, 0)){
iLocal_92=1;
StringCopy(&Local_335, "", 24);
...
int func_415(int iParam0, struct<3> Param1, float fParam2){
struct<3> Var0;
float fVar1;
Var0={
...
int func_430(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
...
void func_435(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4){
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_143, 0);
PED::CLEAR_PED_NON_CREATION_AREA();
...
void func_449(struct<3> Param0, float fParam1, int iParam2, int iParam3){
if(func_538()){
...
void func_450(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11){
int iVar0;
iVar0=1;
...
if(iVar0==1){
if(!func_533(iParam4, iParam5, iParam6, iParam11)){
iVar0=0;
}}
if(iVar0==1){
func_531();
...
*iParam0=func_504(Param1, fParam2);
}elseif(iParam7==1){
if(func_176(Param1, 0f, 0f, 0f, 0)){
Param1={
...
int func_451(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5){
var uVar0;
var uVar1;
struct<97> Var2;
int iVar3;
...
if(((!func_465(PLAYER::PLAYER_ID()) && iParam0 !=joaat("thruster")) && iParam0 !=joaat("avenger")) && !bVar0){
return 0;
}
return 1;
}
...
return func_505(&(Global_107196.f_2890), Param0, fParam1, 0);
}
...
int func_507(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_509(iParam0, uVar1[iVar3], 1) && func_508(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
...
int func_508(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
...
PED::SET_PED_NON_CREATION_AREA(Var0, Var1);
uLocal_143=PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var1, 0, 1, 1, 1);
MISC::CLEAR_AREA(Local_63, 15f, 0, 0, 0, 0);
...
func_363(Local_68.f_9);
func_541(Local_68.f_9, "TARGET_", 0);
Local_68.f_10=0;
...
func_541(Local_69[iVar0 /*20*/], "BACKUP_", iVar0);
if(func_102(Local_71[0 /*6*/])){
if(iVar0==1){
...
if(func_544(&(Local_71[iVar2 /*6*/]), Local_71[iVar2 /*6*/].f_5, Local_71[iVar2 /*6*/].f_1, Local_71[iVar2 /*6*/].f_4, 1)){
iVar0++;
}
iVar2++;
}}
...
if(func_543(&(Local_74[iVar2 /*7*/]), Local_74[iVar2 /*7*/].f_5, Local_74[iVar2 /*7*/].f_2, Local_74[iVar2 /*7*/].f_6, Local_74[iVar2 /*7*/].f_1, 1)){
iVar0++;
}
iVar2++;
}}
...
int func_543(var uParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4, bool bParam5){
if(!OBJECT::DOES_PICKUP_EXIST(*uParam0)){
if(func_56(iParam4)){
...
int func_544(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
if(!ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(func_56(iParam1)){
...
StringCopy(&Local_323, "", 24);
StringCopy(&Local_335, "", 24);
Local_75.f_6=func_558(62);
Local_75.f_1={
func_557() 
};
Local_75.f_4=func_556();
Local_77.f_5=func_555();
Local_77.f_1={
func_554() 
};
Local_77.f_4=func_553();
Local_78.f_5=func_552();
Local_78.f_1={
func_551() 
};
Local_78.f_4=func_550();
...
iVar2=func_574(SCRIPT::GET_THIS_SCRIPT_NAME());
if(iVar2 > -1){
...
void func_576(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21){
uParam0->f_4=iParam4;
*uParam0=sParam1;
uParam0->f_1={
Param2 
