...
func_6(&uLocal_115);
uLocal_115=func_5(Local_106, 5, 1);
iLocal_114=MISC::GET_GAME_TIMER() + 10000;
func_3(0);
iLocal_113=0;
}}elseif(func_8(PLAYER::PLAYER_PED_ID(), Local_106, 1) > fLocal_107){
...
func_541();
}elseif(MISC::ARE_STRINGS_EQUAL(sLocal_97, "B1_FAIL")){
if(func_13(0) && func_508(0)){
func_541();
}}elseif(MISC::ARE_STRINGS_EQUAL(sLocal_97, "B1_FAIL2")){
func_11();
}
break;
}}
...
bVar1=true;
}}elseif(func_17(&uLocal_308, "BARY1AU", "BARY1_PREOUT", "BARY1_PREOUT_2", 8, 0, 0) || MISC::GET_GAME_TIMER() > iLocal_96){
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_108, 200f, 0, 0, 0, 0, 0, 0, 0);
...
func_56(&(Global_107196.f_2890), Param0, fParam1);
}
...
func_80(PLAYER::PLAYER_PED_ID(), floor(fLocal_126), &iLocal_118);
break;
case 3:
if(func_71()){
func_2("B1_FAIL3");
...
switch (iLocal_569){
case 0:
uLocal_545=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", Local_571, Local_572, 50f, 0, 2);
Local_546.f_11=uLocal_545;
...
case 3:
if(MISC::GET_GAME_TIMER() > iLocal_570){
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_571, 1, 0, 0, 1);
ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), 0);
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 1, 0);
if(CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(0) !=4){
if(CAM::DOES_CAM_EXIST(uLocal_545)){
CAM::SET_CAM_ROT(uLocal_545, Local_572, 2);
CAM::SET_CAM_ACTIVE(uLocal_545, 1);
CAM::ATTACH_CAM_TO_ENTITY(uLocal_545, PLAYER::PLAYER_PED_ID(), 0f, 0f, 4f, 0);
}}else{
...
if(CAM::DOES_CAM_EXIST(uLocal_545)){
CAM::SET_CAM_ACTIVE(uLocal_545, 0);
...
func_335();
MISC::CLEAR_AREA_OF_VEHICLES(Local_108, 250f, 0, 0, 0, 0, 0, 0, 0);
...
iVar0=Global_2805029[iParam0 /*3*/][func_148(iParam1)];
...
fVar1=23.45f;
func_282(uParam0, iParam1, Var0, fVar1);
}
...
void func_283(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
int iVar0;
iVar0=PLAYER::GET_PLAYER_INDEX();
...
MISC::CLEAR_AREA(Local_542, 3f, 1, 0, 0, 0);
if(func_578(func_334())){
ENTITY::SET_ENTITY_COORDS(func_334(), Local_542, 1, 0, 0, 1);
...
void func_287(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4){
struct<60> Var0;
...
return (shift_right(iParam0, 26) & 31 * func_314(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
bool func_331(struct<3> Param0, int iParam1){
return func_332(Global_104212.f_2890.f_12.f_66, Param0, iParam1);
}

int func_332(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
struct<3> Var1;
if(iParam0==0){
return 0;
...
void func_344(struct<3> Param0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5){
var uVar0;
int iVar1;
...
if(AUDIO::IS_AUDIO_SCENE_ACTIVE(sLocal_258)){
AUDIO::SET_AUDIO_SCENE_VARIABLE(sLocal_258, "DrugsEffect", ((sin((((to_float(MISC::GET_GAME_TIMER()) / 1000f) * 45f) % 360f)) * 0.25f) + 0.25f));
}
...
if(bLocal_493){
*uParam0={
func_359(Local_494, fLocal_495, 6f) 
};
}else{
*uParam0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(fLocal_496, fLocal_497), 6f) 
};
}
...
if(bParam1){
fVar1=2.5f;
}elseif(iLocal_525 > 27){
fVar1=10f;
}
if(func_358(PLAYER::PLAYER_PED_ID(), Var0, fVar1, 1)){
return 0;
}
if(MISC::GET_DISTANCE_BETWEEN_COORDS(Var0, Local_106, 1) > fLocal_107){
return 0;
}
if(!OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Local_125[0 /*3*/], Local_125[1 /*3*/], Local_125.f_7, 0, 1)){
return 0;
}
if(bLocal_117){
...
bool func_357(struct<3> Param0, float fParam1, int iParam2, int iParam3){
...
Vector3 func__359(struct<3> Param0, float fParam1, float fParam2){
struct<3> Var0;
float fVar1;
Var0={
...
fVar1=(fParam2 / 2f);
Var0={
func_360(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) 
};
...
Vector3 func__360(struct<3> Param0, float fParam1){
float fVar0;
if(fParam1==0f){
return 0f, 0f, 0f;
}
...
int func_362(var uParam0, struct<3> Param1, int iParam2, bool bParam3){
if(bParam3){
if(!func_356(&Param1, 0)){
return 0;
}}
uParam0->f_2=PED::CREATE_PED(26, iLocal_275, Param1, 0, 1, 1);
...
float func_365(struct<2> Param0, Vector3 vParam1, struct<2> Param2, Vector3 vParam3, int iParam4){
float fVar0;
float fVar1;
float fVar2;
...
iVar0=30;
}elseif(iParam0==iLocal_122){
iVar0=10;
}elseif(iParam0==iLocal_123){
iVar0=-1;
}else{
iVar0=-1;
}
...
void func_387(struct<3> Param0, float fParam1, int iParam2, bool bParam3){
int iVar0;
struct<3> Var1;
if(iLocal_527 < iParam2){
if(func_376(&uLocal_534, fLocal_537)){
if(func_370(&iVar0)){
...
int func_388(struct<3> Param0, float fParam1, var uParam2){
if(iLocal_113==0){
return 0;
}
*uParam2={
func_359(Param0, fParam1, 6f) 
};
...
void func_422(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
func_423(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}


void func_423(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
int func_425(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
int func_426(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
uVar7=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_435(iVar2, bVar6));
}}}
bVar6++;
}
...
WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_435(iVar2, bVar8));
func_432(uVar1, func_435(iVar2, bVar8));
}}
bVar8++;
}
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
...
Var0={
PED::GET_PED_BONE_COORDS(uParam0->f_2, 31086, Local_516) 
};
...
uParam0->f_23=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_beam", uParam0->f_4, 0f, 0f, 0f, Local_517, fLocal_510, 0, 0, 0);
...
int func_451(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
...
uParam0->f_8=(MISC::GET_GAME_TIMER() + round((IntToFloat(iLocal_506) * 1.25f)));
...
void func_453(struct<3> Param0, struct<3> Param1, int iParam2){
...
if(func_459(&Var3, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, 1), ENTITY::GET_ENTITY_COORDS(uParam0->f_5, 1), Var1, Var2)){
if(CAM::IS_SPHERE_VISIBLE(Var3, 0.5f)){
iVar6=func_457(Var1, Var0, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, 1));
iVar7=func_457(Var1, Var0, ENTITY::GET_ENTITY_COORDS(uParam0->f_5, 1));
if(iVar6 > 0 && iVar7 < 0){
Var3={
Var3 - ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * Vector(fLocal_518, fLocal_518, fLocal_518) 
};
}elseif(iVar6 < 0 && iVar7 > 0){
Var3={
Var3 + ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * FtoV((fLocal_518 * 4.5f)) 
};
}
...
int func_457(struct<3> Param0, struct<3> Param1, struct<3> Param2){
float fVar0;
...
float func_458(struct<3> Param0, struct<3> Param1){
return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

int func_459(var uParam0, struct<3> Param1, struct<3> Param2, struct<3> Param3, struct<3> Param4){
struct<3> Var0;
struct<3> Var1;
float fVar2;
float fVar3;
...
void func_462(struct<3> Param0, struct<3> Param1, var uParam2, var uParam3, int iParam4){
struct<3> Var0;
Var0={
Param1 - Param0 
};
...
void func_463(struct<3> Param0, var uParam1, var uParam2, int iParam3){
float fVar0;
if(Param0.f_1 !=0f){
...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_260, 3)){
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_264, 8f, -4f, -1, 0, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
}else{
...
void func_483(char* sParam0, char* sParam1, struct<3> Param2, int iParam3){
...
void func_492(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_494(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
void func_510(struct<3> Param0, float fParam1, var uParam2, var uParam3){
struct<3> Var0;
Var0={
...
if(func_578(PLAYER::PLAYER_PED_ID())){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_262, 3)){
TASK::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_262, -1056964608);
}
if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_260, 3)){
TASK::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), sLocal_256, sLocal_260, -1056964608);
}
ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 1, 0);
func_438(PLAYER::PLAYER_PED_ID());
WEAPON::REMOVE_ALL_PED_WEAPONS(PLAYER::PLAYER_PED_ID(), 1);
...
if(func_517(&(uParam0->f_28[0]), 49, Var1, uVar2, "RC LAUNCHER:
BARRY 1", 1)){
...
int func_517(var uParam0, int iParam1, struct<3> Param2, var uParam3, char* sParam4, int iParam5){
if(func_518(uParam0, iParam1, Param2, uParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
int func_518(var uParam0, int iParam1, struct<3> Param2, int iParam3, bool bParam4){
int iVar0;
if(!func_31(iParam1)){
...
void func_531(var uParam0, struct<3> Param1, struct<3> Param2, float fParam3){
*(uParam0[0 /*3*/])={
Param1 
};
*(uParam0[1 /*3*/])={
