...
func_470(Local_53, fLocal_54, 1, 0);
func_505("*** Replay setup started");
Global_78804=1;
iLocal_37=0;
while (!func_459(&Local_386)){
wait(0);
}
func_505("*** Josh 4 scene set up");
func_458(&Local_386, 0, 1);
Global_78804=0;
}
if(func_457(Local_386.f_28[1])){
AUDIO::STOP_PED_SPEAKING(Local_386.f_28[1], 1);
}
if(func_457(Local_386.f_28[2])){
...
case 0:
func_458(&Local_386, 0, 1);
if(func_457(iLocal_390)){
ENTITY::SET_ENTITY_PROOFS(iLocal_390, 0, 0, 0, 0, 0, 0, 0, 0);
}
if(func_457(iLocal_391)){
ENTITY::SET_ENTITY_PROOFS(iLocal_391, 0, 0, 0, 0, 0, 0, 0, 0);
}
...
if(func_457(Local_386.f_28[iVar0])){
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_55, 2f, 20000, 1f, 1, 1193033728);
...
PED::SET_PED_KEEP_TASK(Local_386.f_28[0], 1);
TASK::TASK_PERFORM_SEQUENCE(Local_386.f_28[0], uLocal_389);
}
else{
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_55, 2f, 20000, 1f, 1, 1193033728);
if(func_207(iLocal_391)){
TASK::TASK_ENTER_VEHICLE(0, iLocal_391, 20000, -1, 1073741824, 1, 0);
TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_391, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 500f, 0.1f, 1);
}
else{
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
...
PED::SET_PED_CONFIG_FLAG(Local_386.f_28[0], 177, 1);
iLocal_49=1;
}
break;
case 1:
...
if(func_457(PLAYER::PLAYER_PED_ID()) && func_457(Local_386.f_28[0])){
if(iLocal_410 < 3){
...
iLocal_393=0;
while (iLocal_393 <=4){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_415[iLocal_393 /*7*/], Local_415[iLocal_393 /*7*/].f_3, Local_415[iLocal_393 /*7*/].f_6, 0, 1, 2)){
func_241("Player detected inside flee direction trigger:
", iLocal_393);
STREAMING::REQUEST_MODEL(iLocal_43);
STREAMING::REQUEST_MODEL(iLocal_42);
Local_47={
Local_416[iLocal_393 /*3*/] 
};
...
Local_47.f_7=VEHICLE::CREATE_VEHICLE(iLocal_43, Local_47, 0f, 1, 1, 0);
...
Local_47.f_8=PED::CREATE_PED_INSIDE_VEHICLE(Local_47.f_7, 6, iLocal_42, -1, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(Local_47.f_8, joaat("weapon_pistol"), -1, 0, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47.f_8, 1);
...
VEHICLE::FORCE_PLAYBACK_RECORDED_VEHICLE_UPDATE(Local_47.f_7, 1);
...
if(func_207(Local_47.f_7)){
if(func_457(Local_47.f_8)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_47.f_8, 0);
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_386.f_28[1], 0);
...
iLocal_48=3;
iLocal_394=MISC::GET_GAME_TIMER();
}elseif(func_243(Local_386.f_28[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0)){
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_386.f_28[iVar0], 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_389);
TASK::TASK_SHOOT_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, joaat("FIRING_PATTERN_BURST_FIRE"));
TASK::CLOSE_SEQUENCE_TASK(uLocal_389);
TASK::TASK_PERFORM_SEQUENCE(Local_386.f_28[iVar0], uLocal_389);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_389);
}
iVar0++;
}
...
if(func_457(Local_386.f_28[iVar1])){
...
int func_247(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5){
var uVar0;
struct<3> Var1;
var uVar2;
int iVar3;
...
float func_251(struct<3> Param0, struct<3> Param1){
...
int func_260(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
...
if(func_207(iLocal_390)){
ENTITY::SET_ENTITY_COORDS(iLocal_390, -1107.5f, 280.33f, 64.01f, 1, 0, 0, 1);
...
TASK::TASK_PERFORM_SEQUENCE(Local_386.f_28[0], uLocal_389);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_389);
PED::FORCE_PED_MOTION_STATE(Local_386.f_28[0], joaat("MotionState_DoNothing"), 0, 1, 0);
}}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Security_guard_pistol", 0)){
if(func_457(iLocal_387) && func_457(Local_386.f_28[1])){
...
if(func_457(iLocal_388) && func_457(Local_386.f_28[2])){
...
if(func_457(Local_386.f_28[1])){
PED::FORCE_PED_MOTION_STATE(Local_386.f_28[1], joaat("MotionState_Aiming"), 0, 1, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_389);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_389);
TASK::TASK_PERFORM_SEQUENCE(Local_386.f_28[1], uLocal_389);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_389);
func_505("*** Idle cop anim");
}}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_with_notepad", 0)){
if(func_457(Local_386.f_28[2])){
PED::FORCE_PED_MOTION_STATE(Local_386.f_28[2], joaat("MotionState_Aiming"), 0, 1, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_389);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1026, 2);
...
TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_389);
TASK::TASK_PERFORM_SEQUENCE(Local_386.f_28[2], uLocal_389);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_389);
...
void func_278(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
int iVar0;
...
void func_283(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
func_284(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}


void func_284(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
if(func_457(Local_386.f_28[0])){
if(iParam0==1){
ENTITY::SET_ENTITY_COORDS(Local_386.f_28[0], -1103.962f, 291.3401f, 63.367f, 1, 0, 0, 1);
...
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_386.f_28[0], 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_386.f_28[0], 1);
}
if(iParam0==1){
if(func_457(Local_386.f_28[2])){
WEAPON::GIVE_WEAPON_TO_PED(Local_386.f_28[2], joaat("weapon_pistol"), -1, 1, 1);
ENTITY::SET_ENTITY_COORDS(Local_386.f_28[2], -1106.08f, 288.55f, 63.31f, 1, 0, 0, 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_389);
TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_389);
TASK::TASK_PERFORM_SEQUENCE(Local_386.f_28[2], uLocal_389);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_389);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_386.f_28[2], 1);
}}
if(iParam0==1){
if(func_457(Local_386.f_28[1])){
WEAPON::GIVE_WEAPON_TO_PED(Local_386.f_28[1], joaat("weapon_pistol"), -1, 1, 1);
ENTITY::SET_ENTITY_COORDS(Local_386.f_28[1], -1102.41f, 289.73f, 63.18f, 1, 0, 0, 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_389);
TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_389);
TASK::TASK_PERFORM_SEQUENCE(Local_386.f_28[1], uLocal_389);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_389);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_386.f_28[1], 1);
}}
if(func_457(Local_386.f_28[1])){
PED::SET_PED_COMBAT_ATTRIBUTES(Local_386.f_28[1], 23, 1);
}
if(func_457(Local_386.f_28[2])){
PED::SET_PED_COMBAT_ATTRIBUTES(Local_386.f_28[2], 23, 1);
}
...
case 1:
if(!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0)){
if(func_457(PLAYER::PLAYER_PED_ID()) && func_267(Local_386.f_28[0])){
...
if((func_457(PLAYER::PLAYER_PED_ID()) && func_267(Local_386.f_28[0])) && !func_303()){
if(!func_296(PLAYER::PLAYER_PED_ID(), joaat("script_task_turn_ped_to_face_entity"))){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_386.f_28[0], 0);
}}
if(func_267(Local_386.f_28[0])){
...
Var4={
func_314(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
Local_386.f_28[1]=PED::CREATE_PED(6, iLocal_42, -1102.92f, 290.12f, -200f, 40.46f, 0, 0);
}
if(func_457(Local_386.f_28[2])){
...
Local_386.f_28[2]=PED::CREATE_PED(6, iLocal_42, -1102.73f, 290.91f, -200f, 92.06f, 0, 0);
}
if(!func_334()){
...
int func_333(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_457(iParam0)){
...
void func_335(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11){
int iVar0;
iVar0=1;
...
*iParam0=func_416(Param1, fParam2);
}elseif(iParam7==1){
...
int func_336(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5){
var uVar0;
var uVar1;
struct<97> Var2;
int iVar3;
...
if(!func_404() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
void func_409(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
bool func_415(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_416(struct<3> Param0, float fParam1){
return func_417(&(Global_107196.f_2890), Param0, fParam1, 0);
}

int func_417(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
int func_419(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_421(iParam0, uVar1[iVar3], 1) && func_420(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_415(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
VEHICLE::DELETE_VEHICLE(&iParam0);
return 1;
}else{
return 0;
...
int func_420(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
...
func_461(uParam0, iLocal_39, Var0, fVar1);
...
void func_462(var uParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4){
func_236(uParam0);
*uParam0=PED::CREATE_PED(iParam4, uParam1, Param2, fParam3, 0, 0);
}

int func_463(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_464(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
int func_464(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
int iVar0;
if(!func_153(iParam1)){
...
void func_470(struct<3> Param0, float fParam1, int iParam2, int iParam3){
if(func_471()){
