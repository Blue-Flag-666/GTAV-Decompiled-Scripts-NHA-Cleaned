...
fVar0=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_70);
if(fVar0 > (100f * 100f)){
return 1;
}
return 0;
...
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_68[iVar0], 0, 0);
...
iLocal_83[3]=1110;
Local_84[0 /*3*/]={
Vector(0.37364f, -1445.534f, 2803.76f) - Local_70 + Vector(0.1f, 0f, 0f) 
};
Local_84[1 /*3*/]={
Vector(0.28778f, -1444.863f, 2800.022f) - Local_70 + Vector(0.1f, 0f, 0f) 
};
Local_84[2 /*3*/]={
Vector(0.6045f, -1452.404f, 2795.934f) - Local_70 + Vector(0.1f, 0f, 0f) 
};
Local_84[3 /*3*/]={
Vector(0.28483f, -1448.033f, 2794.301f) - Local_70 + Vector(0.1f, 0f, 0f) 
};
iLocal_83[4]=1015;
iLocal_83[5]=1015;
Local_84[4 /*3*/]={
Local_84[0 /*3*/] + Local_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) 
};
Local_84[5 /*3*/]={
Local_84[1 /*3*/] + Local_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) 
};
break;
default:
