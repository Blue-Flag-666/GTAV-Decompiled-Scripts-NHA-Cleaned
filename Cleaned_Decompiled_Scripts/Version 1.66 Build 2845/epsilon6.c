...
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_54.f_0, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_54.f_0, 1);
}
if(func_484(PLAYER::PLAYER_PED_ID())){
uLocal_624=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
}
if(func_483(Local_53.f_28[0])){
Local_62.f_0=Local_53.f_28[0];
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_62.f_0, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_62.f_0, uLocal_624);
PED::SET_PED_CONFIG_FLAG(Local_62.f_0, 132, 1);
}
func_475();
...
TASK::TASK_PLANE_MISSION(0, Local_54.f_0, 0, 0, 3891.478f, 2298.554f, 301.6707f, 4, 40f, 10f, -1f, 300, 30, 1);
TASK::TASK_PLANE_MISSION(0, Local_54.f_0, 0, 0, 1562.099f, 2167.677f, 329.9366f, 4, 40f, 10f, -1f, 300, 100, 1);
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_125, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_125);
TASK::TASK_PERFORM_SEQUENCE(Local_61.f_0, uLocal_125);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_125);
iLocal_70=2;
}
if(((((!func_22() && !PED::IS_PED_FLEEING(Local_61.f_0)) && !PED::IS_PED_RAGDOLL(Local_61.f_0)) && !PED::IS_PED_PRONE(Local_61.f_0)) && !PED::IS_PED_INJURED(Local_61.f_0)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_61.f_0, 0)){
...
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_54.f_0, 501, "Eps6_Takeoff", 1);
VEHICLE::FORCE_PLAYBACK_RECORDED_VEHICLE_UPDATE(Local_54.f_0, 1);
...
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_54.f_0, 1, 1, 0);
}
TASK::CLEAR_SEQUENCE_TASK(&uLocal_125);
iLocal_111++;
}
...
iLocal_70=0;
iLocal_69=6;
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_54.f_0, 0)){
bLocal_101=true;
}
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
}}
...
func_25(13, floor(Global_113648.f_10196.f_3853));
}
...
Global_78341[1 /*14*/]={
func_106(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_106(iVar10, 14, uVar12[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_106(iVar10, 14, uVar15[iVar1], -1) 
};
func_73(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_89(14);
if(Global_78339==1){
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_98(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_98(iParam0));
if(iVar11 > iVar10){
...
func_184(&uVar1, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
return 0;
}elseif(VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(Local_54.f_0)){
func_526("Detected plane is stuck on roof");
return 0;
}elseif(VEHICLE::GET_VEHICLE_ENGINE_HEALTH(Local_54.f_0) <=0f){
func_526("Detected plane engine health is <=0");
return 0;
}elseif(VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Local_54.f_0, 3, 30000)){
...
if(func_247(Local_61.f_0, 0, 1116471296, 1126825984, 1, 0, 0, 0) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_61.f_0, 1), 3f, 1)){
...
func_245();
}elseif((func_244(PLAYER::PLAYER_PED_ID(), Local_61.f_0, 1) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_61.f_0, 1), 3f, 0)) || PED::IS_PED_BEING_JACKED(Local_61.f_0)){
if(iLocal_69 !=5 && iLocal_69 !=3){
bLocal_101=true;
}
iLocal_128=5;
...
func_245();
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_61.f_0, PLAYER::PLAYER_PED_ID(), 1)){
...
PED::SET_PED_KEEP_TASK(Local_61.f_0, 1);
TASK::TASK_SMART_FLEE_PED(Local_61.f_0, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
}}
...
int func_251(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5){
var uVar0;
struct<3> Var1;
var uVar2;
int iVar3;
...
int func_264(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
...
int func_269(){
if(func_242()){
if(MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_54.f_0, 0), joaat("weapon_stickybomb"), 10f, 0)){
...
if(func_242()){
if(!func_271()){
func_276(ENTITY::GET_ENTITY_COORDS(Local_54.f_0, 1), 200f, 12, 5000, 0, 0);
}
if(func_242()){
ENTITY::FREEZE_ENTITY_POSITION(Local_54.f_0, 0);
if(VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(500, "Eps6_LandingSkip")){
if(!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_54.f_0)){
if(!func_271()){
func_526("Doing plane boost");
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_54.f_0, 500, "Eps6_LandingSkip", 1);
}
}}}}
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_625);
break;
...
case 5:
if(!func_486(Local_59.f_0)){
Local_59.f_0=VEHICLE::CREATE_VEHICLE(Local_59.f_1, Local_59.f_3, Local_59.f_6, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_59.f_0, 1084227584);
VEHICLE::SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Local_59.f_0, 1);
...
void func_276(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5){
var uVar0;
int iVar1;
...
ENTITY::SET_ENTITY_COORDS(Local_62.f_0, -2881.755f, 3188.125f, 10.1136f, 1, 0, 0, 1);
TASK::CLEAR_PED_TASKS(Local_62.f_0);
func_285();
}else{
func_4(&Local_62);
Local_62.f_0=PED::CREATE_PED(26, iLocal_626, -2881.755f, 3188.125f, 10.1136f, 254.1723f, 1, 1);
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_62.f_0, 1);
PED::SET_PED_CONFIG_FLAG(Local_62.f_0, 167, 1);
AUDIO::STOP_PED_SPEAKING(Local_62.f_0, 1);
PED::SET_PED_DIES_WHEN_INJURED(Local_62.f_0, 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_62.f_0, 0);
PED::SET_PED_CONFIG_FLAG(Local_62.f_0, 185, 1);
PED::SET_PED_CONFIG_FLAG(Local_62.f_0, 188, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_62.f_0, uLocal_624);
PED::SET_PED_CONFIG_FLAG(Local_62.f_0, 132, 1);
...
if(func_483(Local_62.f_0)){
ENTITY::SET_ENTITY_HEADING(Local_62.f_0, 254.1723f);
ENTITY::SET_ENTITY_COORDS(Local_62.f_0, -2889.89f, 3198.69f, 10.11f, 1, 0, 0, 1);
TASK::CLEAR_PED_TASKS(Local_62.f_0);
}else{
func_4(&Local_62);
Local_62.f_0=PED::CREATE_PED(26, iLocal_626, -2889.89f, 3198.69f, 10.11f, 254.1723f, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_62.f_0);
}
if(func_483(Local_62.f_0)){
PED::SET_PED_MAX_MOVE_BLEND_RATIO(Local_62.f_0, 0f);
...
void func_285(){
WEAPON::GIVE_WEAPON_TO_PED(Local_62.f_0, joaat("weapon_digiscanner"), 0, 1, 1);
PED::SET_PED_CAN_SWITCH_WEAPON(Local_62.f_0, 0);
AUDIO::STOP_PED_SPEAKING(Local_62.f_0, 1);
PED::SET_PED_DIES_WHEN_INJURED(Local_62.f_0, 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_62.f_0, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_125);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_125, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_125);
TASK::TASK_PERFORM_SEQUENCE(Local_62.f_0, uLocal_125);
}
...
Local_54.f_0=VEHICLE::CREATE_VEHICLE(iLocal_625, -2892.93f, 3192.37f, 11.66f, -132.35f, 0, 0, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_54.f_0, 1084227584);
...
VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(Local_54.f_0, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_54.f_0, 1);
func_485(Local_54.f_0, 0);
...
ENTITY::FREEZE_ENTITY_POSITION(Local_54.f_0, 1);
}else{
Local_54.f_0=VEHICLE::CREATE_VEHICLE(iLocal_625, 595.7562f, 2926.42f, 173.2301f, 283.3833f, 0, 0, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_54.f_0, 1084227584);
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_54.f_0);
VEHICLE::SET_VEHICLE_COLOURS(Local_54.f_0, 157, 157);
VEHICLE::SET_VEHICLE_EXTRA_COLOURS(Local_54.f_0, 157, 5);
...
Local_54.f_0=VEHICLE::CREATE_VEHICLE(Local_54.f_1, 1684.78f, 3255.58f, 41.78f, 284.26f, 1, 1, 0);
if(func_486(Local_54.f_0)){
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_54.f_0, 1084227584);
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_54.f_0);
...
Local_54.f_0=VEHICLE::CREATE_VEHICLE(Local_54.f_1, 1674.91f, 3252.47f, 41.69f, 284.26f, 1, 1, 0);
if(func_486(Local_54.f_0)){
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_54.f_0, 1084227584);
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_54.f_0);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_54.f_0, 3);
...
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_54.f_1, 1);
}

int func_287(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_483(iParam0)){
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_61.f_0, 1);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_61.f_0, 0);
PED::SET_PED_CAN_BE_TARGETTED(Local_61.f_0, 0);
PED::SET_PED_CONFIG_FLAG(Local_61.f_0, 185, 1);
PED::SET_PED_PROP_INDEX(Local_61.f_0, 1, 0, 0, false, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_61.f_0, uLocal_624);
PED::SET_PED_CONFIG_FLAG(Local_61.f_0, 132, 1);
TASK::TASK_PLAY_ANIM(Local_61.f_0, Local_61.f_6, Local_61.f_7, 8f, -8f, -1, 49, 0, 0, 0, 0);
}else{
...
iLocal_126=OBJECT::CREATE_OBJECT(joaat("p_amb_phone_01"), ENTITY::GET_ENTITY_COORDS(Local_61.f_0, 1), 1, 1, 0);
}
if(!ENTITY::IS_ENTITY_ATTACHED(iLocal_126)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_126, Local_61.f_0, PED::GET_PED_BONE_INDEX(Local_61.f_0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1, 0);
}
func_291(55);
break;
case 5:
...
TASK::TASK_ENTER_VEHICLE(0, Local_54.f_0, 20000, -1, 1073741824, 1, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_125);
TASK::TASK_PERFORM_SEQUENCE(Local_61.f_0, uLocal_125);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_125);
}
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_61.f_0, 0, 0);
}else{
...
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_61.f_0, 1, 0);
}
func_289(&iLocal_126);
}else{
func_16(&(Local_61.f_1));
...
int func_292(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_293(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
int func_293(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
int iVar0;
if(!func_175(iParam1)){
...
int func_330(struct<3> Param0, char* sParam1, struct<3> Param2){
int iVar0;
int iVar1;
...
Var3={
func_345(Var3, -Var0.f_3.f_2) 
};
Var3={
func_345(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__345(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
return (shift_right(iParam0, 26) & 31 * func_363(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
func_16(&(Local_54.f_2));
if(func_242()){
ENTITY::SET_ENTITY_COORDS(Local_54.f_0, 1674.91f, 3252.47f, 41.69f, 1, 0, 0, 1);
...
STREAMING::STREAMVOL_DELETE(uLocal_124);
}
...
if(func_242()){
ENTITY::SET_ENTITY_COORDS(Local_54.f_0, 1684.78f, 3255.58f, 41.78f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(Local_54.f_0, 284.26f);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_54.f_0, 1084227584);
}else{
func_5(&Local_54);
...
PED::FORCE_PED_MOTION_STATE(Local_61.f_0, joaat("MotionState_Run"), 0, 1, 0);
}}}
...
void func_389(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
var uVar0;
uVar0=PLAYER::GET_PLAYER_INDEX();
...
void func_392(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
func_393(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}


void func_393(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
int func_394(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
if(func_242()){
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_54.f_0, 0, 0, 0);
}
if(!HUD::DOES_BLIP_EXIST(Local_61.f_1)){
Local_61.f_1=func_290(Local_61.f_0, 1, 1, 9);
}
...
CUTSCENE::REQUEST_CUTSCENE("ep_6_rcm", 8);
func_526("Requesting cutscene now");
}}elseif(func_241(PLAYER::PLAYER_PED_ID(), Local_61.f_0, 1) > 120f){
if(CUTSCENE::HAS_CUTSCENE_LOADED()){
...
iLocal_70=2;
}}}elseif(func_406(PLAYER::PLAYER_PED_ID(), Local_61.f_0, 5f, 1)){
...
if(!STREAMING::IS_STREAMVOL_ACTIVE()){
if(!STREAMING::STREAMVOL_HAS_LOADED(uLocal_124)){
func_526("Loading streamvol");
uLocal_124=STREAMING::STREAMVOL_CREATE_FRUSTUM(1684.85f, 3276.16f, 39.93f, func_408(-2.1719f, 0f, -78.5672f), 50f, 12, 127);
...
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_61.f_0, 1), 1);
}
if(fVar0 < 50f){
fLocal_118=100f;
fLocal_119=150f;
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_61.f_0, 1), 1) > fLocal_118){
if(!iLocal_84){
func_410("EPS6_GOBACK", 7500, 1);
iLocal_84=1;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_61.f_0, 1), 1) > fLocal_119){
iLocal_128=2;
iLocal_70=0;
iLocal_69=6;
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
...
}}elseif(func_241(PLAYER::PLAYER_PED_ID(), Local_61.f_0, 1) <=25f && func_22()){
if(!PED::IS_PED_HEADTRACKING_PED(Local_61.f_0, PLAYER::PLAYER_PED_ID())){
func_526("Jimmy headlooking (during conv)");
TASK::TASK_LOOK_AT_ENTITY(Local_61.f_0, PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
}}elseif(PED::IS_PED_HEADTRACKING_PED(Local_61.f_0, PLAYER::PLAYER_PED_ID()) && !func_22()){
...
Var3={
func_106(iVar4, 2, uParam1->f_59, -1) 
};
...
Var3={
func_106(iVar4, 1, uParam1->f_62, -1) 
};
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_54.f_0, Local_121, Local_122, 33.25f, 0, 1, 2)){
...
func_16(&(Local_60.f_3));
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_54.f_0, 1), 1) > 80f){
if(func_426(Local_54.f_0, 1654.72f, 3239.21f, 39.55f, 1) >=50f){
if(!iLocal_84){
func_410("EPS6_BACKPL", 7500, 1);
iLocal_84=1;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_54.f_0, 1), 1) > 150f){
if(func_419()){
bLocal_101=true;
}
iLocal_128=1;
...
elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_54.f_0, 1), 1) > 250f){
if(func_419()){
bLocal_101=true;
}
iLocal_128=1;
...
if(func_418() && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_54.f_0, 0)){
func_526("*** Finishing Landing cleanup");
func_417("*** Plane 'entity' health:
", ENTITY::GET_ENTITY_HEALTH(Local_54.f_0));
func_416("*** Plane engine health:
", VEHICLE::GET_VEHICLE_ENGINE_HEALTH(Local_54.f_0));
func_416("*** Plane petrol tank health:
", VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(Local_54.f_0));
...
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_54.f_0, 1, 0, 0);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_54.f_0, 1);
iLocal_70=1;
}}else{
...
bLocal_92=false;
}}}elseif(!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_61.f_0, Local_61.f_6, Local_61.f_7, 3)){
...
float func_426(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
Var0={
ENTITY::GET_ENTITY_COORDS(iParam0, 1) 
...
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 10f, 1);
iLocal_74=1;
}elseif(func_225(&uLocal_129, "EPS6AUD", "EPS6_SPOT", 8, 0, 0, 0)){
iLocal_116=0;
func_526("EPSILONIST:
...
iLocal_103=0;
}}}elseif((MISC::GET_GAME_TIMER() - iLocal_116) > 1000 || iLocal_116==0){
if(!func_22()){
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_54.f_0, 1)){
if(func_22()){
func_20();
...
}elseif((MISC::GET_GAME_TIMER() - iLocal_107) > 1200){
TASK::CLEAR_PED_TASKS(Local_62.f_0);
TASK::TASK_LOOK_AT_ENTITY(Local_62.f_0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_62.f_0, PLAYER::PLAYER_PED_ID(), 0);
if(iLocal_102==0){
...
if(iLocal_81==0){
if((!HUD::IS_MESSAGE_BEING_DISPLAYED() && !func_22()) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_54.f_0, 1)){
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 10f, 1);
...
if(iLocal_74==0){
if(func_484(Local_62.f_0)){
if(func_426(Local_62.f_0, -2884.934f, 3200.156f, 10.7036f, 1) > 2f){
TASK::CLEAR_PED_TASKS(Local_62.f_0);
...
if(iLocal_69==0){
if(iLocal_81==0){
if((!func_420("EPS6_SPOT") && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_54.f_0, 1)) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())){
func_431("EPS6_GETIN", 7500, 1);
...
TASK::TASK_SMART_FLEE_PED(Local_62.f_0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
func_16(&(Local_62.f_1));
}}
...
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_54.f_0, 1)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_54.f_0, PLAYER::PLAYER_PED_ID(), 1)){
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_125);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_628, 1f, 20000, 0.25f, 0, 1193033728);
TASK::CLOSE_SEQUENCE_TASK(uLocal_125);
TASK::TASK_PERFORM_SEQUENCE(Local_62.f_0, uLocal_125);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_125);
iLocal_75=2;
...
TASK::TASK_PLAY_ANIM(Local_62.f_0, "rcmepsilonism6", "cultist_upperstatic", 8f, -8f, -1, 49, 0, 0, 0, 0);
iLocal_76=1;
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_62.f_0, Local_78[iLocal_77 /*3*/], 1f, 20000, 0.25f, 0, 1193033728);
func_526("Eps 6:
Nav tasking Tom...");
iLocal_76=2;
}
...
case 3:
TASK::CLEAR_PED_TASKS(Local_62.f_0);
TASK::TASK_PLAY_ANIM(Local_62.f_0, "rcmepsilonism6", "cultist_idle_a", 16f, -2f, -1, 131072, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_62.f_0, 0, 0);
iLocal_76=4;
func_526("Eps 6:
Done Tom idle anim");
break;
...
TASK::TASK_PLAY_ANIM(Local_62.f_0, "rcmepsilonism6", "cultist_upperstatic", 16f, -8f, -1, 49, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_62.f_0, 0, 0);
iLocal_76=1;
func_526("Eps 6:
Tom idle anim >0.98");
...
return 1;
}}elseif(ENTITY::DOES_ENTITY_EXIST(Local_62.f_0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_62.f_0, PLAYER::PLAYER_PED_ID(), 1)){
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_62.f_0, PLAYER::PLAYER_PED_ID(), 1)){
if(ENTITY::IS_ENTITY_DEAD(Local_62.f_0, 0)){
...
elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_54.f_0, 1), 1) > 120f){
if(func_419()){
bLocal_101=true;
}
iLocal_128=1;
...
if(func_242()){
Var0={
ENTITY::GET_ENTITY_COORDS(Local_54.f_0, 1) 
};
if(Var0.f_2 > 15f){
...
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_104, "DEVICE", WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_62.f_0, 1), "EPSILONISM_04_SOUNDSET", 0, 0);
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_105, "IDLE_BEEP_NPC", WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_62.f_0, 1), "EPSILONISM_04_SOUNDSET", 0, 0);
}
...
iLocal_69=6;
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_54.f_0, 1), 1) > 50f){
if(!iLocal_84){
if(AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_54.f_0, 1), 1) > 100f){
iLocal_128=1;
iLocal_70=0;
iLocal_69=6;
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
...
void func_454(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_456(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
