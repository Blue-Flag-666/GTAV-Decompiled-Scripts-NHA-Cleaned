...
if(bVar3){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_53, ScriptParam_97.f_1[0 /*3*/], fLocal_77, fLocal_77, 2f, 0, 1, iLocal_67)){
bVar3=false;
}
...
}}elseif(func_120(uLocal_58, 1024)){
...
elseif(!func_120(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_78(&iLocal_60);
...
if(func_120(uLocal_58, 2097152)){
if(!func_102(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_50)){
func_113(10);
}}
if(!SCRIPT::IS_THREAD_ACTIVE(uLocal_50)){
STATS::PLAYSTATS_ODDJOB_DONE(round((func_34(&uLocal_71) * 1000f)), iLocal_63, 0);
func_33(&uLocal_71);
...
uLocal_86=PED::ADD_SCENARIO_BLOCKING_AREA((Local_79.f_0 - 3f), (Local_79.f_1 - 3f), (Local_79.f_2 - 3f), (Local_79.f_0 + 3f), (Local_79.f_1 + 3f), (Local_79.f_2 + 3f), 0, 1, 1, 1);
func_7();
func_5();
}
...
func_75(iLocal_69);
}elseif((PED::IS_PED_INJURED(iLocal_85) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(91, ENTITY::GET_ENTITY_COORDS(iLocal_85, 1), 40f)) || EVENT::IS_SHOCKING_EVENT_IN_SPHERE(118, ENTITY::GET_ENTITY_COORDS(iLocal_85, 1), 40f)){
func_81("TRI_DEATH", -1);
iVar0=iLocal_69;
func_75(iLocal_69);
iLocal_69=iVar0;
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_85, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) <=144f){
...
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_85, joaat("script_task_look_at_entity"))==1){
...
Var1={
func_109(iLocal_91==1, 2434.162f, 4282.774f, 35.5112f, func_109(iLocal_91==0, -1231.203f, -2051.531f, 12.9317f, func_109(iLocal_91==2, 1591.099f, 3814.026f, 33.2697f, 0f, 0f, 0f))) 
};
fVar0=func_108(iLocal_91==1, 264.0724f, func_108(iLocal_91==0, 256.2876f, func_108(iLocal_91==2, 222.6197f, 0f)));
iLocal_81=OBJECT::CREATE_OBJECT(joaat("prop_tri_table_01"), Var1, 1, 1, 0);
...
Local_79={
func_109(iLocal_91==1, 2434.955f, 4282.711f, 35.5333f, func_109(iLocal_91==0, -1230.361f, -2051.761f, 12.918f, func_109(iLocal_91==2, 1591.686f, 3813.401f, 33.3371f, 0f, 0f, 0f))) 
};
fVar0=func_108(iLocal_91==1, 264.3256f, func_108(iLocal_91==0, 253.044f, func_108(iLocal_91==2, 220.7912f, 0f)));
iLocal_82=OBJECT::CREATE_OBJECT(joaat("prop_chair_08"), Local_79, 1, 1, 0);
...
iLocal_85=PED::CREATE_PED(4, joaat("a_m_y_roadcyc_01"), Local_79, fVar0, 1, 1);
...
iLocal_84=OBJECT::CREATE_OBJECT(joaat("prop_pencil_01"), Var2, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_pencil_01"));
}
if(!PED::IS_PED_INJURED(iLocal_85)){
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_79, 3f, 1)){
...
TASK::TASK_START_SCENARIO_AT_POSITION(iLocal_85, "PROP_HUMAN_SEAT_CHAIR", Var3, fVar4, -1, 0, 1);
}}
iVar8=0;
while (iVar8 < iLocal_92){
func_107(iLocal_91, iVar8, &Var5, &Var6, &uVar7);
if(!func_106(Var5)){
iLocal_92[iVar8]=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Var5, Var6, uVar7, 0, 7);
}
iVar8++;
}}}
