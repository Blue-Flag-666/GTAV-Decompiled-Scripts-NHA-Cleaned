...
if(!MISC::IS_BIT_SET(Local_85.f_1, 0)){
if(MISC::IS_BIT_SET(Local_87[iLocal_94 /*4*/].f_1, 0)){
iLocal_95=1;
...
if((MISC::IS_BIT_SET(Local_87[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 0) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) >=(Local_85.f_16 - 1)) && Local_87[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2 < 10){
Local_87[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2++;
}
if(Local_87[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2 > 0){
iVar0=(Local_87[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_2 * Global_262145.f_8566);
Global_2696875=iVar0;
func_113(&iVar0, 1);
if(iVar0 > 0){
func_110(iVar0, 1, 1, 0);
if(func_109()){
func_97(-2043695058, iVar0, &uVar2, 0, 0, 0);
}else{
...
if(MISC::IS_BIT_SET(uLocal_88, 4)){
if(!MISC::IS_BIT_SET(uLocal_88, 5)){
func_15(66, 1, -1);
}}}
MISC::SET_BIT(&uLocal_88, true);
}}
...
var uVar0;
var uVar1;
uVar0=Global_2850194[iParam0 /*3*/][func_18(iParam1)];
...
if(((func_77(PLAYER::PLAYER_ID()) || (func_76() && func_75())) && !MISC::IS_BIT_SET(Global_2793046.f_4690, 31)) && !bParam4){
uVar1=func_74();
...
void func_106(struct<67> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19){
struct<3> Var0;
int iVar1;
if(iParam19 < 0){
return;
...
HUD::SET_BLIP_DISPLAY(uLocal_89, 0);
}else{
HUD::SET_BLIP_DISPLAY(uLocal_89, 4);
}}
...
func_228();
MISC::SET_BIT(&(Local_87[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), false);
MISC::SET_BIT(&(Global_2793046.f_4692), false);
...
void func_152(struct<3> Param0, int iParam1, int iParam2, char* sParam3, var uParam4){
int iVar0;
int iVar1;
if(iParam1 !=0){
iVar1=-1;
...
float func_155(struct<3> Param0, var uParam1, var uParam2){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
if(bVar3){
iVar6=round((func_179(*iParam0, 100) * (10f * Global_262145.f_4228)));
}
if(iVar2 > 4){
iVar2=4;
}
if(iVar2 >=2){
iVar7=round((func_179(*iParam0, 100) * (20f * Global_262145.f_4221)));
}
...
if(bVar2){
iVar5=round((func_179(*iParam1, 100) * (10f * Global_262145.f_4228)));
}
if(iVar1 > 4){
iVar1=4;
}
if(iVar1 >=1){
iVar6=round((func_179(*iParam1, 100) * (20f * Global_262145.f_4221)));
}
...
return vdist(func_183(iParam0), func_183(iParam1));
return 0f;
}
...
iVar0=round((func_179(*iParam0, 100) * 25f));
*iParam0=(*iParam0 + iVar0);
return *iParam0;
}
...
uVar0=Global_2805029[iParam0 /*3*/][func_18(uParam1)];
if(STATS::STAT_GET_INT(uVar0, &uVar1, -1)){
return uVar1;
}}
return 0;
...
if(!MISC::IS_BIT_SET(uLocal_88, 0) && MISC::IS_BIT_SET(uLocal_88, 3)){
...
if(!MISC::IS_BIT_SET(uLocal_88, 3)){
MISC::SET_BIT(&uLocal_88, 3);
}
if(MISC::IS_BIT_SET(uLocal_88, 0)){
MISC::CLEAR_BIT(&uLocal_88, false);
}}}
...
func_5(&uLocal_92);
func_206();
MISC::CLEAR_BIT(&(Local_87[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), false);
...
void func_206(){
if(MISC::IS_BIT_SET(uLocal_88, 2)){
func_207(1, 1, 0);
...
if(MISC::IS_BIT_SET(Global_2657589[Global_2672505.f_1685.f_703.f_16 /*466*/].f_427, 0) && func_215()){
iParam0=23;
}}
...
void func_229(struct<3> Param0, int iParam1, int iParam2){
Global_2635559.f_45.f_49={
Param0 
};
...
void func_230(struct<3> Param0, var uParam1, int iParam2, int iParam3){
func_231(Param0, 0f, 0f, 0f, uParam1, 0, iParam2, iParam3);
}


void func_231(struct<3> Param0, struct<3> Param1, var uParam2, int iParam3, int iParam4, var uParam5){
struct<12> Var0;
...
void func_232(struct<12> Param0, int iParam1){
...
int func_235(struct<3> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10){
int iVar0;
iVar0=0;
...
bool func_236(struct<3> Param0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
...
int func_237(struct<3> Param0, struct<3> Param1, struct<3> Param2, struct<3> Param3){
...
int func_238(struct<3> Param0, float fParam1, struct<3> Param2, float fParam3){
struct<3> Var0;
Var0={
Param2 - Param0 
};
...
void func_248(struct<3> Param0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5){
func_249(Param0, 0f, 0f, 0f, fParam1, 0, iParam2, iParam4, iParam3, iParam5);
}


void func_249(struct<3> Param0, struct<3> Param1, var uParam2, int iParam3, int iParam4, var uParam5, var uParam6, var uParam7){
struct<12> Var0;
if(func_240(PLAYER::PLAYER_ID()) || uParam5){
...
void func_250(struct<12> Param0, int iParam1){
...
void func_253(){
if(!MISC::IS_BIT_SET(uLocal_88, 6)){
...
uLocal_89=HUD::ADD_BLIP_FOR_RADIUS(Local_85.f_2, Local_85.f_5);
HUD::SET_BLIP_COLOUR(uLocal_89, 50);
HUD::SET_BLIP_ALPHA(uLocal_89, 220);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_89, 0);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_89, "DCP_BLIPN");
if(func_252()){
HUD::SET_BLIP_DISPLAY(uLocal_89, 0);
}}}
...
void func_279(var uParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
func_271();
}
