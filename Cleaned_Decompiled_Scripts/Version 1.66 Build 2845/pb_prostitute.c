...
bVar0=false;
}elseif(!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_90)){
bVar0=false;
...
break;
case 8:
if(vdist2(Local_88, ENTITY::GET_ENTITY_COORDS(iLocal_90, 1)) < 25f && TASK::GET_SCRIPT_TASK_STATUS(iLocal_91, joaat("script_task_vehicle_drive_to_coord")) !=1){
...
break;
case 1:
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(iLocal_90, 0)) < 22500f){
func_38();
}
func_35(iLocal_92);
...
struct<3> Var1;
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_90, 1) 
};
Var1={
Local_88 
};
...
Local_88={
func_60(ENTITY::GET_ENTITY_COORDS(iLocal_90, 1)) 
};
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_95);
TASK::TASK_PERFORM_SEQUENCE(iLocal_90, uLocal_95);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_90, uVar0);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_90, uVar1);
...
Var4={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_92, 0.2f, 0.2f, 0f) 
};
Var5={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_92, 0.2f, 0.2f, 0f) 
};
...
if(func_90(ENTITY::GET_ENTITY_COORDS(iLocal_91, 1), 1106247680)){
return;
}
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_90, 1) 
...
TASK::TASK_VEHICLE_PARK(iLocal_91, iLocal_92, Var0, 0f, 3, 360f, 1);
...
if(func_471(&uLocal_107, 25f)){
func_5(&iLocal_49, 16384);
func_5(&iLocal_49, 8388608);
}}elseif(iLocal_287 !=0 && !func_470("PROS_NO_MONEY")){
func_64(0);
switch (func_23()){
case 0:
...
switch (iLocal_294){
case 0:
if(!AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_90) || func_121(&uLocal_101) > 4f){
func_116(iLocal_90);
...
if(!func_10(&uLocal_101)){
func_40(&uLocal_101);
}
if(func_121(&uLocal_101) > 15f || iLocal_297 !=0){
HUD::CLEAR_HELP(1);
func_111();
iLocal_294=2;
}}
...
}elseif(((iVar0 > 333 && iVar0 <=666) && iLocal_297==0) || iLocal_297==1){
...
}elseif(iLocal_297==0 || iLocal_297==2){
...
if(bParam0){
Var0={
ENTITY::GET_ENTITY_ROTATION(iLocal_93, 2) 
};
...
func_154(13, floor(Global_113648.f_10196.f_3853));
}
...
void func_162(var uParam0, struct<3> Param1, struct<3> Param2, int iParam3){
if(!func_551()){
...
var func__164(struct<3> Param0, struct<3> Param1, bool bParam2, int iParam3, int iParam4){
var uVar0;
if(func_551()){
if(bParam2){
iParam3=0;
...
}elseif(!PED::IS_PED_IN_VEHICLE(iParam0, iLocal_93, 0)){
...
var func__185(struct<2> Param0, var uParam1, struct<2> Param2, Vector3 vParam3){
...
Var3={
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_93, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_93, "windscreen")) 
};
Var4={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_93, Var3) 
};
switch (iParam0){
case 0:
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_93, 0f, (Var2.f_1 + 1.4f), Var4.f_2) 
};
break;
case 1:
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_93, 1.5f, (Var2.f_1 + 1.2f), (Var4.f_2 - 0.1f)) 
};
break;
case 2:
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_93, -3.7f, 0.7f, Var4.f_2) 
};
break;
case 3:
Var0={
...
Var1={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_93, Var0) 
};
...
func_528(512);
}}}elseif(ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_90, 876132797)){
PAD::SET_CONTROL_SHAKE(0, 200, 252);
ENTITY::APPLY_FORCE_TO_ENTITY(iLocal_93, 1, 0f, 0f, -0.1f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
func_197();
}
...
if(!func_10(&uLocal_101)){
func_472(&uLocal_101);
}elseif(func_7(&uLocal_101) > MISC::GET_RANDOM_FLOAT_IN_RANGE(2f, 5f)){
...
if(func_524(4)){
if(!func_10(&uLocal_104)){
func_472(&uLocal_104);
}elseif(func_7(&uLocal_104) > 2f){
...
void func_223(){
int iVar0;
if(func_225(&uLocal_98, 3f) && !CAM::IS_CAM_ACTIVE(uLocal_97)){
iVar0=floor(((func_224() - 2f) * 1000f));
CAM::SET_CAM_ACTIVE(uLocal_96, 0);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_97, uLocal_96, iVar0, 1, 1);
}
if(func_225(&uLocal_98, func_224())){
...
VEHICLE::SET_VEHICLE_HANDBRAKE(iLocal_93, 1);
VEHICLE::SET_VEHICLE_LIGHTS(iLocal_93, 4);
VEHICLE::SET_VEHICLE_INTERIORLIGHT(iLocal_93, 1);
VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_93, 0, 0);
}}else{
VEHICLE::SET_VEHICLE_HANDBRAKE(iLocal_93, 1);
VEHICLE::SET_VEHICLE_LIGHTS(iLocal_93, 4);
VEHICLE::SET_VEHICLE_INTERIORLIGHT(iLocal_93, 1);
...
}elseif(((PAD::IS_CONTROL_JUST_PRESSED(2, 188) || (PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_CONTROL_JUST_PRESSED(2, 241))) || (PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 32))) || (((MISC::IS_PC_VERSION() && !PAD::IS_USING_KEYBOARD_AND_MOUSE(2)) && iVar4 < -100) && (MISC::GET_GAME_TIMER() - iLocal_87) > 300)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
func_492("UP pressed!");
if(iLocal_68 > 0){
...
func_315();
func_313((((Global_23267 + fParam5) - 0.00390625f) - func_314("CM_ITEM_COUNT", Global_23270.f_6179, Global_23270.f_6180)), ((Global_23268 + fVar55) + 0.00416664f), "CM_ITEM_COUNT", Global_23270.f_6179, Global_23270.f_6180);
}elseif(Global_23270.f_6174 > Global_23270.f_5668){
if(Global_23270.f_6177 !=0){
func_315();
func_313((((Global_23267 + fParam5) - 0.00390625f) - func_314("CM_ITEM_COUNT", Global_23270.f_6177, Global_23270.f_6176)), ((Global_23268 + fVar55) + 0.00416664f), "CM_ITEM_COUNT", Global_23270.f_6177, Global_23270.f_6176);
}}}
...
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_5165), func_316(Global_23270.f_5165, 1), ((Global_23267 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
...
GRAPHICS::DRAW_SPRITE(func_319(Global_4540953.f_67), func_316(Global_4540953.f_67, 1), ((Global_23267 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
fVar49=(fVar49 + (((HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
...
if(iVar5==1){
if(Global_23270.f_5526[iVar8]==2){
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_4824[(iVar22 + iVar28)]), func_316(Global_23270.f_4824[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
else{
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_4824[(iVar22 + iVar28)]), func_316(Global_23270.f_4824[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
}
...
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_4824[(iVar22 + iVar14)]), func_316(Global_23270.f_4824[(iVar22 + iVar14)], bVar32), (Global_23267 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
elseif(Global_23270.f_5526[iVar8]==2){
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_4824[(iVar22 + iVar14)]), func_316(Global_23270.f_4824[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
else{
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_4824[(iVar22 + iVar14)]), func_316(Global_23270.f_4824[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
}
}
...
GRAPHICS::DRAW_SPRITE(func_319(Global_23270.f_4824[iVar22]), func_316(Global_23270.f_4824[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_297(Global_23270.f_4824[iVar22])), (fVar37 * func_297(Global_23270.f_4824[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
}
}}
bVar39=true;
...
}elseif(!func_491(iLocal_73, 2)){
if(func_332(iLocal_295)){
iLocal_295=func_349();
func_340(&iLocal_295, 0, 0, MISC::GET_RANDOM_INT_IN_RANGE(1, 2), 0, 0, 0);
func_482(&iLocal_73, 2);
}}elseif(func_332(iLocal_295)){
func_282();
func_473(0);
}}
...
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_93, 1) 
};
...
}elseif(((ENTITY::GET_ENTITY_MODEL(iLocal_93)==joaat("casco") || ENTITY::GET_ENTITY_MODEL(iLocal_93)==joaat("feltzer3")) || ENTITY::GET_ENTITY_MODEL(iLocal_93)==joaat("fagaloa")) || ENTITY::GET_ENTITY_MODEL(iLocal_93)==joaat("warrener2")){
...
struct<7> Var0;
struct<7> Var1;
if(!CAM::DOES_CAM_EXIST(uLocal_96)){
uLocal_96=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
}
if(!CAM::DOES_CAM_EXIST(uLocal_97)){
uLocal_97=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
}
func_383(&Var0, &Var1);
CAM::SET_CAM_COORD(uLocal_96, Var0);
CAM::SET_CAM_ROT(uLocal_96, Var0.f_3, 2);
CAM::SET_CAM_FOV(uLocal_96, Var0.f_6);
CAM::SET_CAM_COORD(uLocal_97, Var1);
CAM::SET_CAM_ROT(uLocal_97, Var1.f_3, 2);
CAM::SET_CAM_FOV(uLocal_97, Var1.f_6);
...
func_394();
if(func_7(&uLocal_110) > 2.5f){
uLocal_83=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(ENTITY::GET_ENTITY_COORDS(iLocal_93, 0), 40f, 40f, 40f, ENTITY::GET_ENTITY_HEADING(iLocal_93), 0, 7);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 896);
func_482(&iLocal_49, 2048);
iLocal_94=0;
PED::ADD_RELATIONSHIP_GROUP("ProstituteInPlay", &uLocal_298);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_298, joaat("player"));
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_90, uLocal_298);
...
if((!AUDIO::IS_ANY_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID()) && func_7(&uLocal_101) > 15f) && func_392()){
...
void func_393(){
if(func_551()){
PED::SET_PED_CONFIG_FLAG(iLocal_90, 229, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_90, 26, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_90, 115, 1);
...
Var1={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_93, 0f, 0f, -2f) 
};
iLocal_94=SHAPETEST::START_SHAPE_TEST_CAPSULE(Var0, Var1, 2f, 511, iLocal_93, 7);
}elseif(SHAPETEST::GET_SHAPE_TEST_RESULT_INCLUDING_MATERIAL(iLocal_94, &iVar4, &uVar5, &uVar6, &iVar3, &uVar7)==2){
if(iVar4 !=0){
...
if(!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_90, iLocal_93, 0, 0, 0)){
return 0;
}
...
void func_411(){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_90, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_90, PLAYER::PLAYER_PED_ID(), 5f, 5f, 5f, 0, 1, 0) || func_491(iLocal_49, 8192)){
...
if(func_551()){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_90, 0, 0);
}
else{
...
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_93, 0)){
iLocal_93=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
}elseif(!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_90, iLocal_93, 0, 0, 0)){
if(!func_112()){
if(!func_491(iLocal_73, 1)){
func_40(&uLocal_113);
func_482(&iLocal_73, 1);
}elseif(func_7(&uLocal_113) > 20f){
func_126();
func_492("prostitute couldn't get into the car");
iLocal_286=6;
}
}}}}}elseif(!func_491(iLocal_73, 1)){
...
return func_121(&uLocal_107) > fParam0;
}
...
if(func_121(&uLocal_107) >=20f || !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_90, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0)){
if(func_491(iLocal_73, 524288)){
func_115(&uLocal_107);
iLocal_286=6;
}elseif(func_437()){
...
func_69(iLocal_90);
if(((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_90, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0) || func_491(iLocal_73, 1)) && !func_217(0)) && !func_402()){
if(!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_90, iLocal_93, 0, 0, 0)){
if(!func_112()){
if(!func_491(iLocal_73, 1)){
func_40(&uLocal_113);
func_482(&iLocal_73, 1);
}elseif(func_7(&uLocal_113) > 10f){
func_68();
TASK::CLEAR_PED_TASKS(iLocal_90);
func_492("prostitute couldn't get into the car");
iLocal_286=6;
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_90, joaat("script_task_enter_vehicle")) !=1 && !PED::IS_PED_IN_VEHICLE(iLocal_90, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 1)){
...
if(func_90(ENTITY::GET_ENTITY_COORDS(iLocal_90, 1), 1106247680)){
...
Var3={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_93, -(Var0.f_0 + 0.2f), 0f, 0f) 
};
Var4={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_93, (Var0.f_0 + 0.2f), 0f, 0f) 
};
...
if((TASK::GET_SCRIPT_TASK_STATUS(iLocal_90, joaat("script_task_enter_vehicle")) !=1 || !func_491(iLocal_49, 8192)) && vdist2(Local_89, Var3) > 0f){
if(func_551()){
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_90)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_90, 0, 1);
}
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_90, uVar6);
...
Global_32316=1;
func_430();
if(func_471(&uLocal_107, 2f) || func_491(iLocal_49, 8192)){
...
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_91, 1, 0);
}
...
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_92, 0, 1);
return 1;
}}}}}}
iLocal_92=0;
iLocal_91=0;
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_90, 0);
...
TASK::TASK_CLEAR_LOOK_AT(iLocal_90);
TASK::TASK_LOOK_AT_ENTITY(iLocal_90, iParam0, -1, 2048, 4);
}}}elseif(PED::IS_PED_HEADTRACKING_PED(iLocal_90, iParam0)){
if(func_551()){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_90)){
TASK::TASK_CLEAR_LOOK_AT(iLocal_90);
}}else{
...
if((vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_90, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < Global_32318 || Global_32318==0f) && iLocal_287 !=4){
Global_32318=vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_90, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
...
if(func_551()){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_90)){
PED::SET_PED_RESET_FLAG(iLocal_90, 323, 1);
}}else{
PED::SET_PED_RESET_FLAG(iLocal_90, 323, 1);
}}
...
func_96(12);
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_90, PLAYER::PLAYER_PED_ID(), 1)){
iLocal_65++;
if(iLocal_65 >=2){
...
if(func_551()){
if(PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(uLocal_83)){
PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(uLocal_83);
}}
iLocal_92=0;
func_540();
func_537();
...
VEHICLE::SET_VEHICLE_HANDBRAKE(iLocal_93, 0);
VEHICLE::SET_VEHICLE_LIGHTS(iLocal_93, 3);
VEHICLE::SET_VEHICLE_INTERIORLIGHT(iLocal_93, 0);
}
VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_93, 1, 0);
}}else{
VEHICLE::SET_VEHICLE_HANDBRAKE(iLocal_93, 0);
VEHICLE::SET_VEHICLE_LIGHTS(iLocal_93, 3);
VEHICLE::SET_VEHICLE_INTERIORLIGHT(iLocal_93, 0);
...
}}}elseif(NETWORK::NETWORK_GET_ENTITY_IS_NETWORKED(iLocal_93)){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_93)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_93, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED_FOR_ALL_PLAYERS(iLocal_93, 0);
VEHICLE::SET_VEHICLE_RESPECTS_LOCKS_WHEN_HAS_DRIVER(iLocal_93, 0);
}else{
