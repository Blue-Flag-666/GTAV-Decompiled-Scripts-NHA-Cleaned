...
Local_79.f_0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_79.f_1, 10f, func_48(), 1, 0, 1);
if(func_437(Local_79.f_0)){
ENTITY::SET_ENTITY_COORDS(Local_79.f_0, func_47(), 1, 0, 0, 1);
...
Local_80.f_0=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_80.f_1, 10f, func_45(), 1, 0, 1);
...
TASK::TASK_SYNCHRONIZED_SCENE(Local_75.f_0, uVar0, func_41(), func_51(), 1000f, -8f, 4688, 0, 1148846080, 0);
iVar1=0;
iVar1 +=16;
iVar1 +=64;
iVar1 +=512;
iVar1 +=4096;
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_77.f_0, uVar0, func_50(), func_41(), 1000f, -8f, iVar1, 1148846080);
...
}}}elseif(func_75(&uLocal_155, cLocal_149, &Local_321, 4, 0, 0, 0)){
iLocal_100=1;
}
if(iLocal_62==4){
if(!iLocal_113){
...
func_127(13, floor(Global_113648.f_10196.f_3853));
}
...
if(iParam2==1){
if(func_183(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
}}
func_133(Global_104212.f_4, Param0, fParam1, 24, 0);
}}}}
...
return (shift_right(iParam0, 26) & 31 * func_161(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_169(int iParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4){
if(func_166(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
bool func_176(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
return func_195(Global_104212.f_2890.f_12.f_66, Param0, iParam1);
}
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_252(iVar10, 14, uVar12[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_252(iVar10, 14, uVar15[iVar1], -1) 
};
func_221(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_244(14);
if(Global_78339==1){
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_211(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
func_255(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_255(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_255(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
iVar10=(iParam1 - iParam2);
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_211(iParam0));
if(iVar11 > iVar10){
...
elseif(func_120(iLocal_134, 8000)){
bVar0=true;
}
...
iLocal_122=MISC::GET_GAME_TIMER();
}}elseif(func_75(&uLocal_155, cLocal_148, "BB4_FLEE", 4, 0, 0, 0)){
iLocal_122=MISC::GET_GAME_TIMER();
}
}
}}}else{
...
void func_326(int iParam0, struct<3> Param1, int iParam2, float fParam3){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
int func_330(int iParam0, struct<3> Param1, bool bParam2, bool bParam3, bool bParam4, int iParam5){
int iVar0;
if(func_23(iParam0)){
...
int func_331(int iParam0, struct<3> Param1, float fParam2, float fParam3){
...
}}elseif(!func_64(Local_68.f_9, joaat("script_task_turn_ped_to_face_entity"))){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1);
}
break;
case 7:
...
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_332, PLAYER::PLAYER_PED_ID(), 1f, 1, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
...
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_332, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.5f, 4f, 1, 0, 0, joaat("FIRING_PATTERN_BURST_FIRE"), 20000);
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_143);
TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 750, 0);
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_332, PLAYER::PLAYER_PED_ID(), 2f, 1, 0.75f, 4f, 1, 0, 0, joaat("FIRING_PATTERN_BURST_FIRE"), 20000);
TASK::CLOSE_SEQUENCE_TASK(uLocal_143);
TASK::TASK_PERFORM_SEQUENCE(Local_68.f_9, uLocal_143);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_143);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68.f_9, 1);
...
if((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], 0) && func_112(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f, 1)) && func_372(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f)){
...
if(!func_102(Local_71[0 /*6*/])){
Local_68.f_10=13;
}elseif(((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_71[0 /*6*/], 0) || PED::IS_PED_BEING_JACKED(Local_68.f_9)) || !func_112(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f, 1)) || !func_372(ENTITY::GET_ENTITY_HEADING(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f)){
Local_68.f_10=13;
}elseif(PED::IS_PED_SITTING_IN_VEHICLE(Local_68.f_9, Local_71[0 /*6*/])){
Local_68.f_10=39;
}elseif(!func_64(Local_68.f_9, joaat("script_task_enter_vehicle"))){
Local_68.f_10=15;
}
...
TASK::TASK_LEAVE_ANY_VEHICLE(Local_68.f_9, 0, 0);
}elseif(((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && !PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_68.f_9)) && !func_369()) || ENTITY::IS_ENTITY_IN_WATER(Local_68.f_9)){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_68.f_9, PLAYER::PLAYER_PED_ID(), -1);
...
Local_68.f_10=23;
}}elseif(!func_366(Local_68.f_19, 10) && func_112(Local_68.f_9, Local_331, 50f, 1)){
...
int func_379(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5){
var uVar0;
struct<3> Var1;
var uVar2;
int iVar3;
...
float func_383(struct<3> Param0, struct<3> Param1){
return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
void func_386(){
if(func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_330, 100f)){
if(!func_387()){
CUTSCENE::REQUEST_CUTSCENE(&cLocal_325, 8);
func_67();
iLocal_111=1;
}}elseif(iLocal_111){
if(!func_59(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_330, 120f)){
if(CUTSCENE::HAS_CUTSCENE_LOADED()){
CUTSCENE::REMOVE_CUTSCENE();
iLocal_111=0;
}}else{
...
}}elseif(func_112(Local_68.f_9, Local_331, 8f, 1)){
...
iLocal_122=MISC::GET_GAME_TIMER();
}}elseif(func_75(&uLocal_155, cLocal_148, "BB4_J5", 4, 0, 0, 0)){
iLocal_122=MISC::GET_GAME_TIMER();
}
}}
iLocal_108=0;
...
int func_389(int iParam0, struct<3> Param1, int iParam2, int iParam3, float fParam4){
struct<3> Var0;
var uVar1;
char[] cVar2[8];
char* sVar3;
...
elseif(func_75(&uLocal_155, cLocal_148, "BB4_VEH", 4, iVar1, 0, 0)){
iLocal_89=1;
}}}elseif(!iLocal_93){
if(func_392(&iVar0)){
...
iLocal_90=1;
}}elseif(func_75(&uLocal_155, cLocal_148, "BB4_GETOUT", 4, iVar1, 0, 0)){
iLocal_90=1;
}
}}}elseif(Local_68.f_10==24 && func_64(Local_68.f_9, joaat("script_task_hands_up"))){
if(func_112(Local_68.f_9, Local_331, 25f, 1)){
...
if(iLocal_94){
uLocal_115=func_398(Local_330, 5, 1);
}
}
if(!iLocal_83){
if(!func_324(sLocal_146, 1)){
...
elseif(func_112(PLAYER::PLAYER_PED_ID(), Local_330, 2.5f, 1)){
iLocal_60=2;
}}}else{
func_117(&uLocal_115);
...
int func_396(struct<3> Param0, struct<3> Param1, float fParam2){
int iVar0;
...
bool func_397(struct<3> Param0, struct<3> Param1, float fParam2){
struct<3> Var0;
Var0={
Param1 - Param0 
};
...
elseif(func_120(iLocal_134, 5000)){
bVar0=true;
}
...
Local_69[iVar0 /*19*/].f_14=4;
func_116(&(Local_69[iVar0 /*19*/].f_6));
}}elseif(!func_64(Local_69[iVar0 /*19*/], joaat("script_task_combat"))){
func_116(&(Local_69[iVar0 /*19*/].f_6));
...
func_403(Local_69[iVar0 /*19*/], &(Local_69[iVar0 /*19*/].f_6), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
}
break;
case 3:
...
}}elseif(func_414(Local_68.f_9, iLocal_133, 0, 1103626240, 1086324736)){
iLocal_61=0;
}elseif(func_112(Local_68.f_9, Local_331, 5f, 1)){
iLocal_61=0;
}elseif(func_415(&(Local_68.f_19))){
iLocal_61=1;
iLocal_91=0;
if(Local_68.f_10 !=3 && Local_68.f_10 !=4){
Local_68.f_18=(MISC::GET_GAME_TIMER() - 50000);
...
elseif(func_120(Local_68.f_17, 500)){
if(Local_68.f_10 !=3 && Local_68.f_10 !=4){
Local_68.f_18=MISC::GET_GAME_TIMER();
Local_68.f_10=3;
}
...
iLocal_92=1;
}}elseif(func_412(&uLocal_155, cLocal_148, "BB4_AMB", &Local_329, 1, iLocal_116, 0)){
iLocal_92=1;
StringCopy(&Local_329, "", 24);
...
int func_416(int iParam0, struct<3> Param1, float fParam2){
struct<3> Var0;
float fVar1;
Var0={
...
int func_431(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
...
void func_436(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4){
...
void func_450(struct<3> Param0, float fParam1, int iParam2, int iParam3){
if(func_539()){
...
void func_451(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11){
int iVar0;
iVar0=1;
...
if(iVar0==1){
if(!func_534(iParam4, iParam5, iParam6, iParam11)){
iVar0=0;
}}
if(iVar0==1){
func_532();
...
*iParam0=func_505(Param1, fParam2);
}elseif(iParam7==1){
if(func_176(Param1, 0f, 0f, 0f, 0)){
Param1={
...
int func_452(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5){
var uVar0;
var uVar1;
struct<97> Var2;
int iVar3;
...
func_492(iParam0, &(Var2.f_31), &(Var2.f_81));
VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
if(iParam1==1){
...
if(((!func_466(PLAYER::PLAYER_ID()) && iParam0 !=joaat("thruster")) && iParam0 !=joaat("avenger")) && !bVar0){
return 0;
}
return 1;
}
...
if(!func_498() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
void func_501(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
int func_505(struct<3> Param0, float fParam1){
return func_506(&(Global_107196.f_2890), Param0, fParam1, 0);
}

int func_506(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
int func_508(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_510(iParam0, uVar1[iVar3], 1) && func_509(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_176(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
...
int func_509(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
...
func_363(Local_68.f_9);
func_542(Local_68.f_9, "TARGET_", 0);
Local_68.f_10=0;
...
func_542(Local_69[iVar0 /*19*/], "BACKUP_", iVar0);
switch (iVar0){
case 0:
TASK::OPEN_SEQUENCE_TASK(&uLocal_143);
...
if(func_545(&(Local_71[iVar2 /*6*/]), Local_71[iVar2 /*6*/].f_5, Local_71[iVar2 /*6*/].f_1, Local_71[iVar2 /*6*/].f_4, 1)){
iVar0++;
}
iVar2++;
}}
...
if(func_544(&(Local_74[iVar2 /*7*/]), Local_74[iVar2 /*7*/].f_5, Local_74[iVar2 /*7*/].f_2, Local_74[iVar2 /*7*/].f_6, Local_74[iVar2 /*7*/].f_1, 1)){
iVar0++;
}
iVar2++;
}}
...
int func_544(var uParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4, bool bParam5){
if(!OBJECT::DOES_PICKUP_EXIST(*uParam0)){
if(func_56(iParam4)){
...
int func_545(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
if(!ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(func_56(iParam1)){
...
Vector3 func__546(struct<5> Param0, var uParam1, var uParam2, var uParam3){
switch (Param0.f_4){
case 0:
...
Vector3 func__547(struct<5> Param0, var uParam1, var uParam2, var uParam3){
switch (Param0.f_4){
case 0:
...
StringCopy(&Local_321, "", 24);
StringCopy(&Local_329, "", 24);
Local_75.f_6=func_559(62);
Local_75.f_1={
func_558() 
};
Local_75.f_4=func_557();
Local_77.f_5=func_556();
Local_77.f_1={
func_555() 
};
Local_77.f_4=func_554();
Local_78.f_5=func_553();
Local_78.f_1={
func_552() 
};
...
iVar2=func_575(SCRIPT::GET_THIS_SCRIPT_NAME());
if(iVar2 > -1){
...
void func_577(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21){
uParam0->f_4=iParam4;
*uParam0=sParam1;
uParam0->f_1={
Param2 
