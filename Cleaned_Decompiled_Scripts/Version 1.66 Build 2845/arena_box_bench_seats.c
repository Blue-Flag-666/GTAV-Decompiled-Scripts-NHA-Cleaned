...
if(MISC::IS_BIT_SET(Local_125[bVar2 /*2*/], 0)){
if(!MISC::IS_BIT_SET(Local_114.f_13, bVar2)){
if(Local_125[bVar2 /*2*/].f_1 !=0){
if(MISC::IS_BIT_SET(Local_125[bVar2 /*2*/].f_1, 0)){
iVar3=0;
while (iVar3 < 10){
...
iVar4=0;
while (iVar4 < 10){
if(MISC::IS_BIT_SET(Local_125[bVar2 /*2*/].f_1, iVar4 + 1)){
...
if(MISC::IS_BIT_SET(Local_114.f_13, bVar0)){
iVar5=0;
while (iVar5 < 10){
...
Jump @393;
//curOff=369 Local_114.f_2[iVar5]=-1;
MISC::CLEAR_BIT(&(Local_114.f_13), bVar0);
iVar5++;
}
bVar0++;
...
ENTITY::SET_ENTITY_ROTATION(uVar1, Var3, 2, 1);
...
if(!MISC::IS_BIT_SET(Local_125[PLAYER::PLAYER_ID() /*2*/], 0)){
MISC::SET_BIT(&(Local_125[PLAYER::PLAYER_ID() /*2*/]), false);
if(func_50()){
MISC::SET_BIT(&(Local_125[PLAYER::PLAYER_ID() /*2*/].f_1), false);
}elseif(Local_95.f_281.f_9==1){
MISC::SET_BIT(&(Local_125[PLAYER::PLAYER_ID() /*2*/].f_1), Local_95.f_281.f_2 + 1);
}}elseif(MISC::IS_BIT_SET(Local_114.f_13, PLAYER::PLAYER_ID())){
if(func_49() < 0){
iVar2=0;
while (iVar2 < 10){
...
MISC::CLEAR_BIT(&(Local_125[PLAYER::PLAYER_ID() /*2*/]), false);
...
uVar3=PLAYER::GET_PLAYER_PED(iParam1->f_2[uParam0->f_281.f_2]);
if(ENTITY::DOES_ENTITY_EXIST(uVar3) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar3, 2797.988f, -3954.898f, 181.0005f, 2797.949f, -3930.85f, 187.4114f, 30f, 0, 1, 0)){
...
Var4={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_116(uParam0), func_115(uParam0), 0, 2) 
};
Var5={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_116(uParam0), func_115(uParam0), 0, 2) 
};
...
uParam0->f_281.f_1=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Var12, func_115(uParam0), 2, 1, 0, 1065353216, fVar11, fVar10);
...
if(uParam0->f_281.f_2 >=0 && uParam0->f_281.f_2 < 10){
AUDIO::PLAY_SOUND_FROM_ENTITY(uVar13, "Exit_Menu", NETWORK::NET_TO_OBJ(iParam1->f_14[uParam0->f_281.f_2]), "DLC_AW_Spectator_Tablet_Sounds", 1, 0);
}
func_100(uParam0);
}
func_62(uParam0, iParam1);
uVar2=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_281.f_1);
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uVar2)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uVar2) >=1f){
if(!Global_2764620){
...
if(uParam0->f_281.f_9==1){
if(uParam0->f_281.f_2 >=0 && uParam0->f_281.f_2 < 10){
AUDIO::PLAY_SOUND_FROM_ENTITY(uVar14, "Enter_Menu", NETWORK::NET_TO_OBJ(iParam1->f_14[uParam0->f_281.f_2]), "DLC_AW_Spectator_Tablet_Sounds", 1, 0);
}
...
if(uParam0->f_281.f_9==1 && (ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), 1374875855) || PED::GET_SYNCHRONIZED_SCENE_PHASE(uVar2) > 0.25f)){
...
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(NETWORK::NET_TO_OBJ(iParam1->f_14[uParam0->f_281.f_2]), Var15, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(NETWORK::NET_TO_OBJ(iParam1->f_14[uParam0->f_281.f_2]), Var16, 2, 1);
...
uVar17=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_281.f_1);
iVar18=TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), joaat("script_task_synchronized_scene"));
if(iVar18==0 || iVar18==1){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uVar17)){
if((PED::GET_SYNCHRONIZED_SCENE_PHASE(uVar17) >=0.7f || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), 364629851)) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), 2116425869)){
NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_281.f_1);
if((!MISC::IS_BIT_SET(Global_1969892, 7) && !MISC::IS_BIT_SET(Global_1969892, 3)) && !func_22(PLAYER::PLAYER_ID())){
func_21(-1);
func_20(-1);
...
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(NETWORK::NET_TO_OBJ(iParam1->f_14[uParam0->f_281.f_2]), Var19, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(NETWORK::NET_TO_OBJ(iParam1->f_14[uParam0->f_281.f_2]), Var20, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(NETWORK::NET_TO_OBJ(iParam1->f_14[uParam0->f_281.f_2]), true);
}
}
if(!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE()){
...
if(!MISC::IS_BIT_SET(Global_2764622, 7)){
...
if(MISC::IS_BIT_SET(Global_2764622, 4) && uParam0->f_281.f_6==-1){
func_84("ARENA_VIP_CASH2", Global_262145.f_26646, 2000);
}
if(MISC::IS_BIT_SET(Global_2764622, 5) && uParam0->f_281.f_6==-1){
func_84("ARENA_VIP_CASH1", Global_262145.f_26645, 2000);
}
if(MISC::IS_BIT_SET(Global_2764622, 7) && uParam0->f_281.f_6==-1){
func_83("ARENA_VIP_ABIL", 2000);
}
if((MISC::IS_BIT_SET(Global_2764622, 4) || MISC::IS_BIT_SET(Global_2764622, 5)) || MISC::IS_BIT_SET(Global_2764622, 7)){
func_25(uParam0, 1);
}
...
if((((((!func_26() && !MISC::IS_BIT_SET(Global_2764622, 4)) && !MISC::IS_BIT_SET(Global_2764622, 5)) && !MISC::IS_BIT_SET(Global_2764622, 7)) && !func_27("ARENA_VIP_CASH1", Global_262145.f_26645)) && !func_27("ARENA_VIP_CASH2", Global_262145.f_26646)) && !func_29("ARENA_VIP_ABIL")){
...
if(!MISC::IS_BIT_SET(Global_2764622, 2) && !MISC::IS_BIT_SET(Global_2764622, 3)){
func_78("ARENA_SEAT_PC1", Global_262145.f_26645, Global_262145.f_26646);
}elseif(MISC::IS_BIT_SET(Global_2764622, 2) && !MISC::IS_BIT_SET(Global_2764622, 3)){
...
if(((PAD::IS_DISABLED_CONTROL_JUST_PRESSED(2, 235) && !PAD::IS_CONTROL_JUST_PRESSED(2, 224)) && !Global_2766483) && !Global_2766480){
if(uParam0->f_281.f_2 >=0 && uParam0->f_281.f_2 < 10){
...
if(MONEY::NETWORK_CAN_SPEND_MONEY(Global_262145.f_26645, 0, 0, 1, -1, 0) || MISC::IS_BIT_SET(Global_2764622, 3)){
func_25(uParam0, 1);
Global_2766483=1;
Global_2766480=1;
if(uParam0->f_281.f_2 >=0 && uParam0->f_281.f_2 < 10){
...
func_68();
func_63();
}elseif(!MISC::IS_BIT_SET(Global_2764622, 5)){
...
func_164(func_165(), (fVar1 - 180f)) + Var0 
};
(uParam1[iParam2 /*14*/])->f_1.f_3={
func_164(func_163(), (fVar1 - 180f)) + Var0 
};
...
Vector3 func__164(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
