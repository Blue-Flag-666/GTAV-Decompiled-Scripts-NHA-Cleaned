...
Var0.f_1=5;
Var0.f_17=5;
if(ENTITY::DOES_ENTITY_EXIST(uScriptParam_104)){
Local_56={
ENTITY::GET_ENTITY_COORDS(iScriptParam_104, 1) 
};
uLocal_94=iScriptParam_104;
Var0.f_1[0 /*3*/]={
Local_56 
};
uLocal_78=ENTITY::GET_ENTITY_MODEL(uLocal_94);
}else{
uLocal_94=iScriptParam_104;
Var0.f_1[0 /*3*/]={
Local_56 
...
if(bVar4){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_53, Var0.f_1[0 /*3*/], fLocal_77, fLocal_77, 2f, 0, 1, iLocal_67)){
bVar4=false;
}
if(ENTITY::IS_ENTITY_DEAD(uLocal_94, 0)){
iLocal_94=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_56, 2f, uLocal_78, 1, 0, 1);
func_87(&uLocal_58, 128);
bVar4=false;
}else{
Local_83={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_94, Local_82) 
};
if(func_80(&Local_79, Local_55, Local_83, iLocal_94)){
bLocal_80=false;
}elseif(Local_79.f_12==1){
bLocal_80=true;
}
if(bLocal_80){
bVar4=false;
...
elseif(!func_117(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_77(&iLocal_60);
...
if(func_117(uLocal_58, 2097152)){
if(!func_101(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_50)){
func_110(10);
}}
...
iLocal_91=1;
if(!func_103(6) && !func_103(7)){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_87, 0)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_87, 0);
TASK::TASK_LOOK_AT_ENTITY(iLocal_87, uLocal_88, -1, 2049, 3);
TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_87, "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
}
if(!ENTITY::IS_ENTITY_DEAD(uLocal_88, 0)){
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_87, 0)){
ENTITY::SET_ENTITY_COORDS(iLocal_87, 1991.677f, 3044.957f, 46.21505f, 1, 0, 0, 1);
TASK::TASK_STAND_STILL(iLocal_87, -1);
if(!ENTITY::IS_ENTITY_ATTACHED(iLocal_87)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_87, 1);
}}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0)){
ENTITY::SET_ENTITY_COORDS(iLocal_88, 1990.37f, 3045.121f, 46.21502f, 1, 0, 0, 1);
TASK::TASK_STAND_STILL(iLocal_88, -1);
if(!ENTITY::IS_ENTITY_ATTACHED(iLocal_88)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_88, 1);
}}}}}}
...
}elseif(iLocal_95==INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())){
func_40(140, 3);
func_40(139, 3);
if(!PED::IS_PED_INJURED(iLocal_87) && !PED::IS_PED_INJURED(iLocal_88)){
if(iLocal_98){
...
iLocal_98=0;
}}}elseif(!PED::IS_PED_INJURED(iLocal_87) && !PED::IS_PED_INJURED(iLocal_88)){
if(!iLocal_98){
...
}elseif(iLocal_96==INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())){
if(!PED::IS_PED_INJURED(iLocal_87) && !PED::IS_PED_INJURED(iLocal_88)){
if(iLocal_98){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_87, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_88, 0);
...
fVar9=142.6717f;
fVar10=44.8785f;
uVar11=INTERIOR::GET_INTERIOR_AT_COORDS(func_73(iLocal_92));
...
iLocal_87=PED::CREATE_PED(26, iLocal_85, func_106(iLocal_92==1, Var3, Var5), func_105(iLocal_92==1, fVar7, fVar9), 1, 1);
iLocal_88=PED::CREATE_PED(26, iLocal_86, func_106(iLocal_92==1, Var4, Var6), func_105(iLocal_92==1, fVar8, fVar10), 1, 1);
...
if(fVar2 <=45f){
}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_87)){
}
iLocal_89=0;
}}else{
iLocal_89=0;
