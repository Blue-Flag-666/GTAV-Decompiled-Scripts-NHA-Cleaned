...
func_267(uParam0[iParam3 /*94*/], PED::CREATE_PED(1, uParam0->f_1669, Var13, MISC::GET_HEADING_FROM_VECTOR_2D(uParam0->f_1658, uParam0->f_1658.f_1), 0, 0));
...
func_267(uParam0[iParam4 /*94*/], PED::CREATE_PED(1, uParam0->f_1668, Var1, MISC::GET_HEADING_FROM_VECTOR_2D(-uParam0->f_1658, -uParam0->f_1658.f_1), 0, 0));
...
Var2={
func_88((uParam0[iVar4 /*94*/])->f_37, &(uParam0->f_189), func_284(&(uParam0->f_247)), uParam0->f_247.f_10, uParam0->f_1658, func_93(&(uParam0->f_247)), func_92(&(uParam0->f_247)), func_91(&(uParam0->f_247)), &fVar5) 
};
...
func_270(uParam1, 14);
}elseif(Var6.f_2 < (uParam0->f_189.f_3[0 /*3*/].f_2 - 1f) && vdist2(uParam0->f_189.f_29, func_284(&(uParam0->f_247))) < (26.75f * 26.75f)){
func_104(uParam1, (1 - func_178(uParam1)));
func_270(uParam1, 14);
if(func_64(uParam1) !=iParam3 && uParam0->f_1657 !=1){
Global_113648.f_20023.f_10++;
...
if(uParam0->f_31 !=4){
Var16={
func_88(uParam0->f_37, &(uParam1->f_189), func_284(&(uParam1->f_247)), uParam1->f_247.f_10, uParam1->f_1658, func_93(&(uParam1->f_247)), func_92(&(uParam1->f_247)), func_91(&(uParam1->f_247)), &fVar15) 
};
...
func_166(uParam0);
func_174(uParam0, (to_float(iVar0) * MISC::GET_FRAME_TIME()));
}}
if(!func_173(*uParam2)){
uParam1->f_1583[iVar0 /*3*/]={
*uParam2 
...
Var5={
func_123(Var6, Var5, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 1f)) 
};
...
fVar0=*uParam1;
Var1={
func_185(to_float(*uParam2), to_float(uParam2->f_1), fVar0, &(uParam1->f_40), &(uParam1->f_43)) 
};
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_247)){
if(uParam0->f_1657 !=1 && !func_276(&(uParam0->f_247))){
func_275(&(uParam0->f_247));
...
if(((func_76(uParam0)==75 && ENTITY::DOES_ENTITY_EXIST(uParam1->f_247)) && ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(uParam1->f_247)) && vdist2(uParam0->f_37, func_284(&(uParam1->f_247))) < (0.88f * 0.88f)){
func_59(uParam0, 256);
...
TASK::TASK_GO_STRAIGHT_TO_COORD(func_266(uParam0), Var1, 2f, -1, 1193033728, 1056964608);
...
}elseif((ENTITY::IS_ENTITY_AT_COORD(uParam0->f_32, func_71(&(uParam0->f_4)), Var2, 0, 1, 0) || TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0), joaat("script_task_go_straight_to_coord"))==7) && !func_229(&(uParam0->f_4), 256)){
func_236(&(uParam0->f_4), 0);
func_218(&(uParam0->f_4), 4);
...
Var7={
func_284(uParam4) - func_284(uParam4) + uParam4->f_10 * Vector(fVar3, fVar3, fVar3) 
};
Var6={
func_284(uParam4) + Var7 
};
Var4={
Var1 - uParam0->f_37 
};
...
if(((!PED::IS_PED_INJURED(func_266(uParam0)) && !vdist2(uParam0->f_37, Var1) <=(0f * 0f)) && !func_229(&(uParam0->f_4), 4)) && !func_105(uParam0, 1024)){
...
*iParam1=round((Var0.f_0 * 128f));
*iParam2=round((Var0.f_1 * 128f));
}elseif(vdist2(uParam0->f_37, Var1) <=(0f * 0f) || TASK::GET_SCRIPT_TASK_STATUS(func_266(uParam0), joaat("script_task_go_straight_to_coord"))==7){
...
if(!bParam4){
ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_266(uParam0[iParam1 /*94*/]), PED::GET_PED_BONE_INDEX(func_266(uParam0[iParam1 /*94*/]), 28422), Local_164, Local_165, 0, 0, 0, 0, 2, 1, 0);
}
ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_266(uParam0[iParam2 /*94*/]), PED::GET_PED_BONE_INDEX(func_266(uParam0[iParam2 /*94*/]), 28422), Local_164, Local_165, 0, 0, 0, 0, 2, 1, 0);
}}}
...
Vector3 func__271(var uParam0, int iParam1, struct<3> Param2, struct<3> Param3, bool bParam4, int iParam5){
struct<3> Var0;
struct<3> Var1;
float fVar2;
float fVar3;
...
*uParam2={
*uParam2 + func_281(*uParam2, fVar1) 
};
...
Vector3 func__281(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
struct<3> Var2;
Var0={
