...
VEHICLE::SET_VEHICLE_GENERATES_ENGINE_SHOCKING_EVENTS(uLocal_50, 0);
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_50) && !ENTITY::IS_ENTITY_DEAD(uLocal_50, 0)){
if(!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_50)){
if((ENTITY::IS_ENTITY_OCCLUDED(uLocal_50) && !CAM::IS_SPHERE_VISIBLE(-1602.086f, -2674.039f, 12.9444f, 50f)) && vdist2(Var0, ENTITY::GET_ENTITY_COORDS(uLocal_50, 1)) > 62500f){
iLocal_61=1;
}}}
break;
}}
...
}elseif(!ENTITY::IS_ENTITY_DEAD(uLocal_67, 0) && !PED::IS_PED_INJURED(uLocal_68)){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_67);
PED::SET_PED_KEEP_TASK(uLocal_68, 1);
Var0={
ENTITY::GET_ENTITY_COORDS(uLocal_67, 1) 
};
