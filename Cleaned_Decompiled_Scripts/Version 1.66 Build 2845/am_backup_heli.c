...
func_58(5);
}}elseif(func_11(Local_227.f_1.f_3[0 /*2*/])){
if(func_11(Local_227.f_1.f_3[1 /*2*/]) && func_11(Local_227.f_1.f_3[2 /*2*/])){
func_58(5);
}}elseif(func_11(Local_227.f_1.f_3[1 /*2*/]) && func_11(Local_227.f_1.f_3[2 /*2*/])){
func_58(3);
}else{
...
if(func_12(Local_227.f_1)){
iLocal_56++;
}elseif(ENTITY::DOES_ENTITY_EXIST(NETWORK::NET_TO_VEH(Local_227.f_1))){
...
Global_2672505.f_3797=NETWORK::NET_TO_VEH(Local_227.f_1);
...
Global_2672505.f_3798[0]=NETWORK::NET_TO_PED(Local_227.f_1.f_3[0 /*2*/]);
...
Global_2672505.f_3798[1]=NETWORK::NET_TO_PED(Local_227.f_1.f_3[1 /*2*/]);
...
Global_2672505.f_3798[2]=NETWORK::NET_TO_PED(Local_227.f_1.f_3[2 /*2*/]);
return 1;
}
}}}}}}
return 0;
...
Var0={
func_55(func_56(PLAYER::PLAYER_ID()), 0f, (-200f * sin((to_float(Local_227.f_1.f_15) * 30f))), (200f * cos((to_float(Local_227.f_1.f_15) * 30f))), 0f) 
};
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_45(PLAYER::PLAYER_ID()), Param0, 1) <=(fVar2 + fParam1)){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_45(iVar1), Param0, 1) <=(fVar2 + fParam1)){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_56(iVar1), Param0, 1) < fParam1){
return 1;
}}
}}}}}
iVar0++;
...
Vector3 func__55(struct<3> Param0, float fParam1, struct<2> Param2, float fParam3){
struct<3> Var0;
float fVar1;
float fVar2;
float fVar3;
...
case 2:
if(func_12(Local_227.f_1)){
uVar1=NETWORK::NET_TO_VEH(Local_227.f_1);
...
uVar0=NETWORK::NET_TO_PED(Local_227.f_1.f_3[0 /*2*/]);
...
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_HELI_MISSION(uVar0, uVar1, 0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 23, 20f, 40f, -1f, ceil(fLocal_61[0]), 10, -1082130432, 0);
}
}}}
}
if(!iLocal_50){
if(vdist(func_56(PLAYER::PLAYER_ID()), ENTITY::GET_ENTITY_COORDS(NETWORK::NET_TO_VEH(Local_227.f_1), 1)) <=50f){
func_62(&uLocal_62, "CT_AUD", "MPCT_HBarr", 12, 0, 0, 0);
iLocal_50=1;
}
}}}
if(NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_227.f_1.f_3[1 /*2*/])){
uVar0=NETWORK::NET_TO_PED(Local_227.f_1.f_3[1 /*2*/]);
if(!PED::IS_PED_INJURED(uVar0)){
...
uVar0=NETWORK::NET_TO_PED(Local_227.f_1.f_3[2 /*2*/]);
if(!PED::IS_PED_INJURED(uVar0)){
