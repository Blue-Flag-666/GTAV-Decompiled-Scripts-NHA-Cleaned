...
fVar4=MISC::GET_DISTANCE_BETWEEN_COORDS(Var0, HUD::GET_BLIP_COORDS(Global_32543[iLocal_51[iVar3] /*23*/].f_19), 1);
if(fVar4 < fVar2){
fVar2=fVar4;
iVar1=iVar3;
}}}
...
}}elseif(HUD::DOES_BLIP_EXIST(Global_32543[iLocal_51[iVar3] /*23*/].f_19)){
...
if(iLocal_57 && MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 13)){
MISC::SET_BIT(&(Global_32543[iParam0 /*23*/].f_11), 18);
return 1;
}
if(iLocal_58 && ((MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 7) || MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 11)) || MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 16))){
MISC::SET_BIT(&(Global_32543[iParam0 /*23*/].f_11), 18);
return 1;
}
if(iLocal_59 && MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 14)){
MISC::SET_BIT(&(Global_32543[iParam0 /*23*/].f_11), 18);
return 1;
}
if(iLocal_54 && ((MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 10) || MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 8)) || MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 19))){
MISC::SET_BIT(&(Global_32543[iParam0 /*23*/].f_11), 18);
return 1;
}
if(bLocal_55){
...
if(iLocal_61 && MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 27)){
MISC::SET_BIT(&(Global_32543[iParam0 /*23*/].f_11), 18);
return 1;
}
if((iLocal_62 && (MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 1) || MISC::IS_BIT_SET(Global_32543[iParam0 /*23*/].f_11, 2))) || Global_32543[iParam0 /*23*/].f_16==1){
MISC::SET_BIT(&(Global_32543[iParam0 /*23*/].f_11), 18);
return 1;
}
return 0;
