...
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_268, &cLocal_286, 2)){
TASK::CLEAR_PED_TASKS(*uParam0);
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(*uParam0, -16f, 1);
PED::SET_PED_MOVE_ANIMS_BLEND_OUT(*uParam0);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_264 + Local_266, 1f, -1, (fLocal_267 * 0.1f), 0, 1193033728);
...
TASK::TASK_START_SCENARIO_AT_POSITION(*uParam0, &cLocal_295, Local_264 + Local_304, (fLocal_265 + fLocal_305), 0, 0, 1);
...
Local_266={
Var3 - Local_264 * Vector(4f, 4f, 4f) 
};
}
TASK::CLEAR_PED_TASKS(*uParam0);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_264 + Local_266, 1f, -1, (fLocal_267 * 0.1f), 0, 1193033728);
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_264 + Local_266) < (fLocal_267 * fLocal_267)){
if(fLocal_267==0f){
fLocal_267=(vmag(Local_266) * 0.75f);
}
TASK::TASK_WANDER_IN_AREA(*uParam0, Local_264 + Local_266, fLocal_267, 1077936128, 1086324736);
func_134(4, 0);
return 1;
}}
break;
...
func_7(*uParam0);
if(vdist2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_264 + Local_266) < (fLocal_267 * fLocal_267)){
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_264 + Local_266, fLocal_267, 1)){
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*uParam0, Local_264 + Local_266, fLocal_267, 0);
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_307, 0);
func_134(5, 0);
return 1;
}}
break;
...
Var4={
func_4(Local_264 + Local_266, (fLocal_267 * 0.9f), 0f) 
};
...
uLocal_307=PED::ADD_SCENARIO_BLOCKING_AREA(Var6, Var7, 0, 0, 1, 1);
...
func_7(*uParam0);
if(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_268, &cLocal_277, 2)){
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_268, &cLocal_286, 2)){
}
break;
case 8:
if(func_130(uParam0)){
...
float fVar4;
if(PED::IS_PED_INJURED(uParam0)){
if(!iLocal_310 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0, PLAYER::PLAYER_PED_ID(), 1)){
...
func_10(uParam0, 138, &uLocal_68, "FMMAUD", &uLocal_233, &uLocal_254, 3);
...
iLocal_308=-1;
iLocal_309++;
}}elseif(iLocal_308 + 10000 < MISC::GET_GAME_TIMER()){
...
if(Global_2694521){
if(iVar1==14){
func_93(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(Global_22788), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}}
Global_8822[iVar0]=1;
}}}
iVar1++;
...
func_93(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(Global_22793), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}elseif(iVar1==7){
if(Global_78558){
iVar4=0;
...
func_93(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}else{
switch (Global_20383){
case 0:
iVar6=Global_44457;
...
func_93(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}}elseif(iVar1==14){
func_93(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(Global_22788), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}elseif(iVar1==20){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_20364, "SET_DATA_SLOT");
...
func_93(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}else{
func_93(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}
Global_8822[iVar0]=1;
}}}
iVar1++;
...
int func_100(struct<6> Param0, struct<6> Param1){
struct<4> Var0;
struct<4> Var1;
int iVar2;
int iVar3;
...
iParam2=1;
}elseif(func_103(&(Var1[1 /*4*/]), iVar2)){
iParam2=0;
}else{
...
iParam2=1;
}elseif(func_103(&(Var0[1 /*4*/]), iVar1)){
iParam2=0;
}else{
iParam2=MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
}}else{
...
void func_113(int iParam0, struct<3> Param1, float fParam2, int iParam3){
if(iParam0==iParam3){
return;
}
if(iParam0==76){
...
int func_124(struct<3> Param0, bool bParam1){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
uLocal_260=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_264 + Local_262, 1f, iLocal_261, 1, 0, 1);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_260)){
ENTITY::SET_ENTITY_COORDS(uLocal_260, Local_264 + Local_262, 1, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_260, Vector(fLocal_265, 0f, 0f) + Local_263, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_260, 1);
}}}
return 0;
}
...
case 99:
Local_266={
Vector(24.3224f, -700.7733f, -1306.836f) - Local_264 
};
fLocal_267=40f;
iLocal_258=2;
break;
case 100:
Local_266={
Vector((82.0206f + 1f), 272.6104f, -566.2225f) - Local_264 
};
fLocal_267=30f;
iLocal_258=2;
break;
case 101:
Local_266={
Vector((53.6418f + 1f), -217.321f, 77.2686f) - Local_264 
};
fLocal_267=25f;
iLocal_258=2;
break;
case 102:
Local_266={
Vector((102.0191f + 1f), 313.2252f, 412.1519f) - Local_264 
};
fLocal_267=15f;
iLocal_258=2;
break;
case 170:
Local_266={
Vector((37.8417f + 1f), -275.1926f, -616.7041f) - Local_264 
};
fLocal_267=30f;
break;
case 171:
Local_266={
Vector((56.8469f + 1f), -125.1416f, -106.3491f) - Local_264 
};
fLocal_267=25f;
break;
case 172:
...
case 94:
Local_266={
Vector((112.1615f + 1f), 328.301f, -16.8925f) - Local_264 
};
fLocal_267=25f;
break;
case 152:
