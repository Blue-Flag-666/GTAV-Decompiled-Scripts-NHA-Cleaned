...
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_283) > 100f){
return 1;
}
return 0;
}
...
TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_98010, &cLocal_338, &(Local_347[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
(*iParam1)[iVar0]=101;
...
case 101:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98011)){
TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_98011, &cLocal_338, &(Local_348[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
...
if(iLocal_109==108){
Local_285[iVar0 /*3*/]={
Vector(224.5948f, 1213.466f, 199.6328f) - Local_283 
};
}elseif(iLocal_109==109){
Local_285[iVar0 /*3*/]={
Vector(5.9049f, -717.1404f, -1908.287f) - Local_283 
};
}
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], Local_283 + Local_285[iVar0 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
...
Var9={
Local_283 + Local_285[iVar0 /*3*/] + Vector(1f, 0f, 0f) 
};
...
break;
case 11:
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_283) > 50f && vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], 1)) > 50f){
...
TASK::CLEAR_PED_TASKS((*iParam0)[iVar0]);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], Local_283 + Local_285[iVar0 /*3*/], 0.5f, -1, 1048576000, 0, 1193033728);
(*iParam1)[iVar0]=1;
}
...
OBJECT::DELETE_OBJECT(&(uLocal_280[iVar0]));
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(uLocal_280[iVar0]));
}
TASK::CLEAR_PED_TASKS((*iParam0)[iVar0]);
...
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_283 + Local_285[iVar0 /*3*/], 20f, 1)){
...
iLocal_350[iVar0]=MISC::GET_GAME_TIMER();
}}elseif(ENTITY::DOES_ENTITY_EXIST(uLocal_280[iVar0])){
...
while (iVar0 < iLocal_276){
if(iLocal_278[iVar0] !=0){
iLocal_276[iVar0]=PED::CREATE_PED(26, iLocal_278[iVar0], Local_283 + Local_285[iVar0 /*3*/], 0, 1, 1);
...
}}elseif(PED::GET_PED_DRAWABLE_VARIATION(iLocal_276[iVar0], 10)==1){
...
if(iLocal_281[iVar0] !=0){
uLocal_280[iVar0]=OBJECT::CREATE_OBJECT(iLocal_281[iVar0], Local_283 + Local_285[iVar0 /*3*/], 1, 1, 0);
ENTITY::SET_ENTITY_HEADING(uLocal_280[iVar0], (fLocal_284 + fLocal_286[iVar0]));
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_280[iVar0], iLocal_276[iVar0], PED::GET_PED_BONE_INDEX(iLocal_276[iVar0], iLocal_282[iVar0]), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}
iVar0++;
}
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_279, joaat("player"));
...
case 166:
Local_285[0 /*3*/]={
Vector(36.037f, -476.663f, -1050.724f) - Local_283 
};
...
case 246:
Local_285[0 /*3*/]={
Vector(4.6f, -1570.924f, -1194.77f) - Local_283 + Vector(-1f, 0f, 0f) 
};
...
case 257:
Local_285[0 /*3*/]={
Vector(7.1578f, -978.6192f, -1666.374f) - Local_283 
};
...
case 239:
Local_285[0 /*3*/]={
Vector(113.05f, 354.39f, -52.2f) - Local_283 + Vector(-1f, 0f, 0f) 
};
Local_285[1 /*3*/]={
Vector(113.05f, 354.08f, -53.18f) - Local_283 + Vector(-1f, 0f, 0f) 
};
fLocal_286[0]=-100f;
fLocal_286[1]=-100f;
iLocal_278[0]=joaat("a_m_m_business_01");
