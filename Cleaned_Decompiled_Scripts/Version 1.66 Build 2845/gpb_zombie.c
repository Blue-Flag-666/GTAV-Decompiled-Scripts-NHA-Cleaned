...
iLocal_209=1;
if(ENTITY::DOES_ENTITY_EXIST(uLocal_208) && func_103(uLocal_208)){
...
fVar12=func_97(PLAYER::PLAYER_PED_ID(), uLocal_208);
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_208) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_208)) && fVar12 < 25f) && func_89(PLAYER::PLAYER_PED_ID()) !=joaat("weapon_unarmed")) && func_86(uLocal_208, PLAYER::PLAYER_PED_ID(), 1126825984, 0)){
if(!func_90()){
func_92();
TASK::TASK_PLAY_ANIM(uLocal_208, &cLocal_234, &Local_203, 2f, -2f, -1, 0, 0, 0, 0, 0);
iLocal_216=24;
...
if(func_85(uLocal_208, PLAYER::PLAYER_PED_ID(), 1) < 25f){
if(!HUD::DOES_BLIP_EXIST(uLocal_214)){
func_81(&uLocal_214, &uLocal_208, 0);
...
if(func_85(uLocal_208, PLAYER::PLAYER_PED_ID(), 1) < fVar9){
if(func_59()==1){
iLocal_216=8;
iLocal_269=0;
}}
...
func_53(Global_113593[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_208, &Local_253, &Local_252));
}}
break;
case 9:
...
func_50(&uLocal_37, 3, uLocal_208, &Local_205, 0, 1);
func_49(&cVar2);
...
if(bLocal_266){
iVar35=1;
}elseif(func_34(&uLocal_37, &cLocal_227, &cVar3, 3, 0, 0, 0)){
iVar35=1;
}
if(iVar35==1){
iLocal_216=11;
...
if(((((((((((((iLocal_216==0 || iLocal_216==1) || iLocal_216==3) || iLocal_216==8) || iLocal_216==9) || iLocal_216==7) && func_85(uLocal_208, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_265==1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar6==0) && bLocal_268==1) && !Global_3) && func_7()) && bVar18){
if(iLocal_224==-1){
...
if((ENTITY::IS_ENTITY_OCCLUDED(uLocal_208) && func_85(uLocal_208, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_114(1);
}
wait(0);
}}
...
void func_9(){
func_10();
if(func_103(uLocal_208) && func_103(PLAYER::PLAYER_PED_ID())){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_208, 0);
...
uLocal_277=OBJECT::CREATE_OBJECT(joaat("prop_npc_phone"), ENTITY::GET_ENTITY_COORDS(uLocal_208, 1), 1, 1, 0);
...
void func_105(){
PED::SET_PED_CAN_EVASIVE_DIVE(uLocal_208, 0);
PED::SET_PED_CONFIG_FLAG(uLocal_208, 185, 1);
PED::SET_PED_CONFIG_FLAG(uLocal_208, 318, 1);
}
