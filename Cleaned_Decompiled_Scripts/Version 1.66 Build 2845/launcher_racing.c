...
GRAPHICS::DRAW_SPRITE(func_109(Global_23270.f_4824[iVar22]), func_106(Global_23270.f_4824[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_88(Global_23270.f_4824[iVar22])), (fVar37 * func_88(Global_23270.f_4824[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
}
}}
bVar39=true;
...
if(bLocal_55){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_56[iVar0], cLocal_73, sLocal_74[iVar0], 3)){
TASK::STOP_ANIM_TASK(uLocal_56[iVar0], cLocal_73, sLocal_74[iVar0], -1056964608);
}
func_135(iVar0);
}}
...
var uVar0;
if(!ENTITY::IS_ENTITY_DEAD(uLocal_56[iParam0], 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
switch (iLocal_77){
case 0:
if(vdist2(ENTITY::GET_ENTITY_COORDS(uLocal_56[iParam0], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 64f){
iLocal_78=0;
iLocal_79=0;
iLocal_77=1;
}
...
TASK::TASK_PERFORM_SEQUENCE(uLocal_56[iParam0], uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
iLocal_77=2;
break;
case 2:
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_56[iParam0], joaat("script_task_perform_sequence")) !=1 || PED::IS_PED_FACING_PED(uLocal_56[iParam0], PLAYER::PLAYER_PED_ID(), 20f)){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(uLocal_56[iParam0], PLAYER::PLAYER_PED_ID(), -1);
if(!iLocal_79){
...
break;
case 3:
if(!AUDIO::IS_AMBIENT_SPEECH_PLAYING(uLocal_56[iParam0])){
func_140(&uLocal_80);
TASK::TASK_PLAY_ANIM(uLocal_56[iParam0], "random@street_race", "_streetracer_wait_loop", 4f, -4f, -1, 9, 0, 0, 0, 0);
iLocal_77=4;
}
break;
case 4:
if(vdist2(ENTITY::GET_ENTITY_COORDS(uLocal_56[iParam0], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 225f){
iLocal_77=0;
}
if(func_136(&uLocal_80) >=5f && !iLocal_78){
iLocal_78=1;
iLocal_77=1;
}elseif(func_136(&uLocal_80) >=10f && !iLocal_79){
iLocal_79=1;
iLocal_77=1;
}
break;
...
CAM::SET_GAMEPLAY_ENTITY_HINT(uLocal_56[iParam0], 0f, 0f, 0f, 1, 2000, 2000, 2000, 0);
iLocal_46=0;
}}}}
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_44, 1) < IntToFloat(iVar0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==0){
return 1;
}}
return 0;
}
...
iLocal_57=VEHICLE::CREATE_VEHICLE(iLocal_71, Local_59, fLocal_60, 1, 1, 0);
...
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_57, 1, 1, 0);
AUDIO::SET_VEHICLE_RADIO_ENABLED(iLocal_57, 1);
...
VEHICLE::SET_VEHICLE_NOT_STEALABLE_AMBIENTLY(iLocal_57, 0);
...
iLocal_61=VEHICLE::CREATE_VEHICLE(iLocal_72, Local_62, fLocal_63, 1, 1, 0);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_61, 0, 1, 0);
AUDIO::SET_VEHICLE_RADIO_ENABLED(iLocal_61, 1);
...
VEHICLE::SET_VEHICLE_NOT_STEALABLE_AMBIENTLY(iLocal_61, 0);
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_56[iVar0])){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_56[iVar0], 0) && !func_165(uLocal_56[iVar0], joaat("script_task_play_anim"))){
TASK::TASK_PLAY_ANIM(uLocal_56[iVar0], cLocal_73, sLocal_74[iVar0], 1000f, -1000f, -1, 1, 0, 0, 0, 0);
PED::SET_PED_KEEP_TASK(uLocal_56[iVar0], 1);
}}elseif(STREAMING::HAS_MODEL_LOADED(iLocal_70[iVar0])){
uLocal_56[iVar0]=PED::CREATE_PED(25, iLocal_70[iVar0], Local_66[iVar0 /*3*/], fLocal_67[iVar0], 1, 1);
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uLocal_56[iVar0], Local_66[iVar0 /*3*/], 0, 0, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_56[iVar0], 1);
TASK::TASK_PLAY_ANIM(uLocal_56[iVar0], cLocal_73, sLocal_74[iVar0], 1000f, -1000f, -1, 1, 0, 0, 0, 0);
PED::SET_PED_KEEP_TASK(uLocal_56[iVar0], 1);
}
iVar0++;
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_56[iVar1])){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_56[iVar1], 0) && !func_165(uLocal_56[iVar1], joaat("script_task_play_anim"))){
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uLocal_56[iVar1], Local_66[iVar1 /*3*/], 0, 0, 1);
if(iVar1 !=2 && iVar1 !=3){
TASK::TASK_PLAY_ANIM(uLocal_56[iVar1], cLocal_73, sLocal_74[iVar1], 1000f, -1000f, -1, 1, 0, 0, 0, 0);
}
else{
TASK::TASK_PLAY_ANIM(uLocal_56[iVar1], cLocal_73, sLocal_74[iVar1], 1000f, -1000f, -1, 1, 0.5f, 0, 0, 0);
}
PED::SET_PED_KEEP_TASK(uLocal_56[iVar1], 1);
}}elseif(STREAMING::HAS_MODEL_LOADED(iLocal_70[iVar1])){
uLocal_56[iVar1]=PED::CREATE_PED(25, iLocal_70[iVar1], Local_66[iVar1 /*3*/], fLocal_67[iVar1], 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_56[iVar1], 1);
}
iVar1++;
}
if((((func_65(uLocal_56[0]) && func_65(uLocal_56[1])) && func_65(uLocal_56[2])) && func_65(uLocal_56[3])) && func_65(uLocal_56[4])){
TASK::TASK_LOOK_AT_ENTITY(uLocal_56[4], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
iVar1=0;
...
VEHICLE::SET_BOAT_REMAINS_ANCHORED_WHILE_PLAYER_IS_DRIVER(iLocal_57, 0);
VEHICLE::SET_FORCE_LOW_LOD_ANCHOR_MODE(iLocal_57, 0);
if(VEHICLE::CAN_ANCHOR_BOAT_HERE(iLocal_57)){
VEHICLE::SET_BOAT_ANCHOR(iLocal_57, 1);
}
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_57, 0, 1, 0);
}}
iVar2=0;
iVar2=0;
while (iVar2 < 3){
...
elseif(func_16(iLocal_68[iVar2]) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_jetski_01"))){
iLocal_69[iVar2]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_68[iVar2], 25, joaat("a_m_y_jetski_01"), -1, 1, 1);
PED::SET_PED_DIES_IN_WATER(iLocal_69[iVar2], 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_69[iVar2], 1);
}}elseif(STREAMING::HAS_MODEL_LOADED(iLocal_71)){
iLocal_68[iVar2]=VEHICLE::CREATE_VEHICLE(iLocal_71, Local_64[iVar2 /*3*/], fLocal_65[iVar2], 1, 1, 0);
...
VEHICLE::SET_BOAT_REMAINS_ANCHORED_WHILE_PLAYER_IS_DRIVER(iLocal_68[iVar2], 1);
VEHICLE::SET_FORCE_LOW_LOD_ANCHOR_MODE(iLocal_68[iVar2], 1);
if(VEHICLE::CAN_ANCHOR_BOAT_HERE(iLocal_68[iVar2])){
VEHICLE::SET_BOAT_ANCHOR(iLocal_68[iVar2], 1);
}
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_68[iVar2], 0, 1, 0);
}
iVar2++;
}
...
if(Local_43.f_1==3){
return 1;
}elseif(Local_43.f_1==1 || Local_43.f_1==2){
...
PATHFIND::SET_PED_PATHS_IN_AREA(Local_83, Local_84, 0, 0);
PATHFIND::SET_ROADS_IN_ANGLED_AREA(Local_85, Local_86, fLocal_87, 0, 0, 1);
iLocal_47=1;
}elseif(Local_43.f_1==3){
switch (Local_43.f_0){
case 5:
...
TASK::TASK_PERFORM_SEQUENCE(uLocal_56[iVar1], uVar2);
}
iVar1++;
}
iVar1=0;
...
if(func_16(iLocal_68[iVar1]) && PED::IS_PED_IN_VEHICLE(iLocal_69[iVar1], iLocal_68[iVar1], 0)){
TASK::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_68[iVar1], 30f, 786597);
}else{
TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
}
TASK::CLOSE_SEQUENCE_TASK(uVar2);
TASK::TASK_PERFORM_SEQUENCE(iLocal_69[iVar1], uVar2);
}
iVar1++;
}
if(func_65(iLocal_58)){
if(func_16(iLocal_57) && PED::IS_PED_IN_VEHICLE(iLocal_58, iLocal_57, 0)){
...
TASK::TASK_PERFORM_SEQUENCE(uLocal_56[iVar4], uVar3);
}
iVar4++;
}
iVar4=0;
...
VEHICLE::SET_BOAT_ANCHOR(iLocal_68[iVar4], 0);
}
if(func_65(iLocal_69[iVar4])){
TASK::OPEN_SEQUENCE_TASK(&uVar3);
TASK::TASK_PAUSE(0, iVar4 * 60);
if(func_16(iLocal_68[iVar4]) && PED::IS_PED_IN_VEHICLE(iLocal_69[iVar4], iLocal_68[iVar4], 0)){
TASK::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_68[iVar4], 50f, 786468);
}else{
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
}
TASK::CLOSE_SEQUENCE_TASK(uVar3);
TASK::TASK_PERFORM_SEQUENCE(iLocal_69[iVar4], uVar3);
if((iVar4 % 2)==0){
...
VEHICLE::SET_BOAT_ANCHOR(iLocal_57, 0);
}
if(func_65(iLocal_58)){
if(func_16(iLocal_57) && PED::IS_PED_IN_VEHICLE(iLocal_58, iLocal_57, 0)){
...
return 1;
}elseif(func_185(iLocal_69[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0) || PED::IS_PED_BEING_JACKED(iLocal_69[iVar0])){
return 1;
}}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_68[iVar0])){
if(ENTITY::IS_ENTITY_DEAD(iLocal_68[iVar0], 0)){
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_68[iVar0], PLAYER::PLAYER_PED_ID(), 1) && ENTITY::GET_ENTITY_HEALTH(iLocal_68[iVar0]) < 900){
return 1;
}}
iVar0++;
}
...
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_57, PLAYER::PLAYER_PED_ID(), 1) && ENTITY::GET_ENTITY_HEALTH(iLocal_57) < 900){
return 1;
}}
return 0;
}
...
return 1;
}elseif(func_185(iLocal_58, 1, 1116471296, 1126825984, 0, 0, 0, 0)){
return 1;
}elseif(PED::IS_PED_BEING_JACKED(iLocal_58)){
...
if(ENTITY::IS_ENTITY_DEAD(iLocal_57, 0)){
return 1;
}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_57, 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_57, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_61)){
if(ENTITY::IS_ENTITY_DEAD(iLocal_61, 0)){
return 1;
}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_61, 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_61, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}}
iVar0=0;
while (iVar0 <=(iLocal_70 - 1)){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_56[iVar0])){
if(PED::IS_PED_INJURED(uLocal_56[iVar0])){
return 1;
}elseif(func_185(uLocal_56[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0)){
return 1;
}}
iVar0++;
}
...
var func__207(struct<3> Param0, float fParam1){
struct<3> Var0;
Var0={
...
Local_43.f_3=100;
Local_43.f_4=20;
}elseif(func_215(func_216(87, 0), Local_44, 1f, 0)){
Local_43.f_0=1;
Local_43.f_1=2;
Local_43.f_3=500;
Local_43.f_4=18;
}elseif(func_215(func_216(88, 0), Local_44, 1f, 0)){
Local_43.f_0=2;
Local_43.f_1=2;
Local_43.f_3=1000;
Local_43.f_4=2;
}elseif(func_215(func_216(89, 0), Local_44, 1f, 0)){
Local_43.f_0=3;
Local_43.f_1=2;
Local_43.f_3=1250;
Local_43.f_4=4;
}elseif(func_215(func_216(90, 0), Local_44, 1f, 0)){
Local_43.f_0=4;
Local_43.f_1=1;
Local_43.f_3=1500;
Local_43.f_4=5;
}elseif(func_215(func_216(82, 0), Local_44, 1f, 0)){
Local_43.f_0=5;
Local_43.f_1=3;
Local_43.f_3=0;
Local_43.f_4=16;
}elseif(func_215(func_216(83, 0), Local_44, 1f, 0)){
Local_43.f_0=6;
Local_43.f_1=3;
Local_43.f_3=0;
Local_43.f_4=13;
}elseif(func_215(func_216(84, 0), Local_44, 1f, 0)){
Local_43.f_0=7;
Local_43.f_1=3;
Local_43.f_3=0;
Local_43.f_4=15;
Local_43.f_5=1;
}elseif(func_215(func_216(85, 0), Local_44, 1f, 0)){
Local_43.f_0=8;
Local_43.f_1=3;
Local_43.f_4=24;
Local_43.f_3=0;
...
TASK::CLEAR_PED_TASKS(uLocal_56[iVar0]);
TASK::TASK_WANDER_STANDARD(uLocal_56[iVar0], 1193033728, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_56[iVar0], 0);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_56[iVar0]));
}
iVar0++;
}
iVar0=0;
...
VEHICLE::SET_BOAT_ANCHOR(iLocal_68[iVar0], 0);
}
...
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_58, 1, 1);
...
if(Local_43.f_0==1){
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_89, 0);
}
if(Local_43.f_1==1 || Local_43.f_1==2){
