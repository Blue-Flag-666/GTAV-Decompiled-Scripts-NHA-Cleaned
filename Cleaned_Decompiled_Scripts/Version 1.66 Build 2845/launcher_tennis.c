...
uLocal_62=PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
iLocal_68=0;
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_62) && !ENTITY::IS_ENTITY_DEAD(iLocal_62, 0)){
Local_64={
ENTITY::GET_ENTITY_COORDS(iLocal_62, 1) 
};
...
if(bVar2){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_86, Local_87, fLocal_88, 1, 0, iLocal_76) || (fLocal_90 > 0f && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_142(Local_86, Local_87, 0.5f), 0) > fLocal_90)){
bVar2=false;
}elseif(fLocal_89 > 0f){
...
elseif(!func_183(uLocal_67, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_139(&iLocal_69);
...
STATS::PLAYSTATS_ODDJOB_DONE(round((func_13(&uLocal_80) * 1000f)), iLocal_72, 0);
func_12(&uLocal_80);
...
Vector3 func__142(struct<3> Param0, struct<3> Param1, float fParam2){
...
iVar3=0;
while (iVar3 < 10){
fVar1=vdist2(Param0, func_151(iVar3));
if(fVar0 > fVar1){
fVar0=fVar1;
iVar2=iVar3;
}
...
uVar2[iVar3]=func_173(&uVar2, 3, 2, 7);
iVar3++;
}
iVar3=0;
while (iVar3 < iVar1 && iVar3 < 3){
