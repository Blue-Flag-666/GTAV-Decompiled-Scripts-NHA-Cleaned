...
func_17(13, floor(Global_113648.f_10196.f_3853));
}
...
func_170(&uVar1, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
func_298(4);
}elseif(func_296(PLAYER::PLAYER_PED_ID(), iLocal_89) > 250f){
...
}}}}}}elseif((bParam6 && !iLocal_304==0) && !func_245()){
if(*iParam1 < (iParam2 - 1)){
*iParam1++;
}else{
*iParam0=1;
...
func_246();
iLocal_304=2;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_89, PLAYER::PLAYER_PED_ID(), iParam0) && iLocal_288 < 4){
func_246();
iLocal_304=1;
}}
if(iLocal_304==1){
...
float func_258(struct<3> Param0, struct<3> Param1){
...
while (iVar0 < 3){
Local_295[iVar0 /*3*/]={
ENTITY::GET_ENTITY_COORDS(Local_82.f_35[0], 1) 
};
iVar0++;
}}
...
if(((!iLocal_265 && !iLocal_266) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_89)) && !ENTITY::IS_ENTITY_AT_COORD(Local_82.f_35[0], -1474.445f, 519.4703f, 117.0069f, 15f, 15f, 15f, 0, 1, 0)){
...
iLocal_265=1;
func_298(3);
}elseif(PED::IS_PED_BEING_JACKED(iLocal_89) || !func_3(Local_82.f_35[0])){
iLocal_265=1;
func_298(3);
}}else{
iLocal_265=1;
...
int iVar0;
iVar0=VEHICLE::GET_CLOSEST_VEHICLE(ENTITY::GET_ENTITY_COORDS(Local_82.f_35[0], 1), 20f, iParam0, 6);
if(ENTITY::DOES_ENTITY_EXIST(iVar0)){
...
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_82.f_35[0], 1, 1, 0);
...
uLocal_263=VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(ENTITY::GET_ENTITY_COORDS(Local_82.f_35[0], 1), 100f, 10f, 0);
}else{
...
if(!ENTITY::IS_ENTITY_AT_COORD(Local_82.f_35[0], Local_80, 20f, 20f, 100f, 0, 1, 0)){
sLocal_274="DREY1_CGONE";
iLocal_265=1;
func_298(3);
return 1;
}elseif(!ENTITY::IS_ENTITY_AT_COORD(Local_82.f_35[0], Local_80, 5f, 5f, 100f, 0, 1, 0)){
...
ENTITY::FREEZE_ENTITY_POSITION(iLocal_321, 1);
}
iLocal_88=1;
iLocal_320=0;
break;
...
void func_329(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
var uVar0;
uVar0=PLAYER::GET_PLAYER_INDEX();
...
void func_332(struct<3> Param0, float fParam1, int iParam2, int iParam3){
struct<3> Var0;
var uVar1;
...
if(iParam2==1){
if(func_376(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
...
void func_333(int iParam0, struct<3> Param1, var uParam2, int iParam3, bool bParam4){
struct<60> Var0;
...
func_367(iParam3, &Var0, Param1, uParam2, func_370(iParam0));
...
return (shift_right(iParam0, 26) & 31 * func_359(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_376(struct<3> Param0, int iParam1, var uParam2, var uParam3){
int iVar0;
...
int func_377(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
void func_380(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
func_381(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}


void func_381(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, var uParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
bool func_386(struct<3> Param0, int iParam1){
return func_387(Global_104212.f_2890.f_12.f_66, Param0, iParam1);
}

int func_387(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
struct<3> Var1;
if(iParam0==0){
return 0;
...
void func_406(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_408(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
void func_425(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5){
var uVar0;
int iVar1;
...
Local_82.f_35[0]=VEHICLE::CREATE_VEHICLE(iLocal_96, Local_80, fLocal_81, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_96);
}
if(func_440(Local_82.f_35[0])){
VEHICLE::SET_VEHICLE_INFLUENCES_WANTED_LEVEL(Local_82.f_35[0], 0);
...
PED::SET_PED_CONFIG_FLAG(iLocal_89, 177, 1);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_89, 1);
...
PED::SET_PED_CONFIG_FLAG(iLocal_89, 281, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_89, 42, 1);
}}
...
int func_430(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
int iVar0;
if(!func_161(iParam1)){
...
int func_432(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_440(uParam0)){
...
void func_444(var uParam0, int iParam1, struct<3> Param2, float fParam3){
func_2(uParam0);
...
int func_445(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_430(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
PED::SET_PED_KEEP_TASK(iLocal_89, 1);
...
func_463();
PATHFIND::SET_ROADS_IN_AREA(Local_83, Local_83.f_3, 1, 1);
VEHICLE::REMOVE_ROAD_NODE_SPEED_ZONE(uLocal_263);
}
