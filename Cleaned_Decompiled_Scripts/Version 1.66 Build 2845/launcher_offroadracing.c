...
if(bVar3){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_53, ScriptParam_274.f_1[0 /*3*/], fLocal_77, fLocal_77, 2f, 0, 1, iLocal_67)){
bVar3=false;
}
...
}}}elseif(iVar4 < iLocal_79 || iVar4 >=iLocal_80){
func_103(&uLocal_58, 128);
bVar3=false;
if(fLocal_57 < ((fLocal_77 * fLocal_77) + 4f)){
if(!func_144(uLocal_58, 134217728)){
...
elseif(!func_144(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_92(&iLocal_60);
...
if(func_144(uLocal_58, 2097152)){
if(!func_116(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_50)){
func_137(10);
}}
if(!SCRIPT::IS_THREAD_ACTIVE(uLocal_50)){
STATS::PLAYSTATS_ODDJOB_DONE(round((func_25(&uLocal_71) * 1000f)), iLocal_63, 0);
func_24(&uLocal_71);
...
void func_52(){
float fVar0;
fVar0=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_81);
if(fVar0 < 62500f){
func_82();
func_79();
if(iLocal_97){
...
switch (iLocal_266){
case 0:
if(vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_95, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 64f && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
iLocal_99=0;
iLocal_100=0;
iLocal_266=1;
}
...
break;
case 4:
if(vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_95, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 225f){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_95, uVar2);
...
iLocal_99=1;
iLocal_266=1;
}elseif(func_25(&uLocal_87) >=10f && !iLocal_100){
iLocal_100=1;
iLocal_266=1;
}}
break;
...
if(func_87(Local_267[iVar2 /*14*/], 1, 0, 0, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_267[iVar2 /*14*/].f_1, 1)){
func_85();
func_84(iLocal_69);
...
if(!PED::IS_PED_INJURED(Local_267[iVar2 /*14*/])){
TASK::TASK_PERFORM_SEQUENCE(Local_267[iVar2 /*14*/], uVar3);
}
TASK::CLEAR_SEQUENCE_TASK(&uVar3);
}
func_35(&(Local_83[iVar2 /*3*/]));
uLocal_93[iVar2]=MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 3f);
}}else{
...
}elseif(Local_267[iVar2 /*14*/].f_11){
TASK::OPEN_SEQUENCE_TASK(&uVar3);
...
}elseif(Local_267[iVar2 /*14*/].f_10){
TASK::OPEN_SEQUENCE_TASK(&uVar3);
...
TASK::CLOSE_SEQUENCE_TASK(uVar3);
if(!PED::IS_PED_INJURED(Local_267.f_83)){
TASK::TASK_PERFORM_SEQUENCE(Local_267.f_83, uVar3);
}
TASK::CLEAR_SEQUENCE_TASK(&uVar3);
}
func_35(&uLocal_84);
...
Local_267[iVar5 /*14*/].f_1=VEHICLE::CREATE_VEHICLE(func_124(0), Local_267[iVar5 /*14*/].f_2, Local_267[iVar5 /*14*/].f_5, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_267[iVar5 /*14*/].f_1, 1084227584);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_267[iVar5 /*14*/].f_1, 1);
if(func_125(Local_267[iVar5 /*14*/].f_6)){
Local_267[iVar5 /*14*/]=PED::CREATE_PED_INSIDE_VEHICLE(Local_267[iVar5 /*14*/].f_1, 4, func_123(), -1, 1, 1);
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_267[iVar5 /*14*/].f_1, 1, 0, 0);
}else{
Local_267[iVar5 /*14*/]=PED::CREATE_PED(4, func_123(), Local_267[iVar5 /*14*/].f_6, Local_267[iVar5 /*14*/].f_9, 1, 1);
iVar1=iVar5;
switch (iVar1){
case 0:
case 3:
...
TASK::TASK_PERFORM_SEQUENCE(Local_267[iVar5 /*14*/], uVar0);
...
Local_267.f_83.f_1=VEHICLE::CREATE_VEHICLE(func_124(1), Local_267.f_83.f_2, Local_267.f_83.f_5, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_267.f_83.f_1, 1084227584);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_267.f_83.f_1, 1);
if(func_125(Local_267.f_83.f_6)){
Local_267.f_83=PED::CREATE_PED_INSIDE_VEHICLE(Local_267.f_83.f_1, 4, func_123(), -1, 1, 1);
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_267.f_83.f_1, 1, 0, 0);
}else{
Local_267.f_83=PED::CREATE_PED(4, func_123(), Local_267.f_83.f_6, Local_267.f_83.f_9, 1, 1);
...
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(Local_267.f_83, uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
}}elseif(fLocal_74 < 225f){}
...
Local_267[iVar0 /*14*/].f_2={
Param0 
};
Local_267[iVar0 /*14*/].f_5=fParam1;
Local_267[iVar0 /*14*/].f_6={
Param2 
};
