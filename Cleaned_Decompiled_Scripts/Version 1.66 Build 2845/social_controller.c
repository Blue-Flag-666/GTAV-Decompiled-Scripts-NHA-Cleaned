...
}elseif(func_7(&uLocal_294, 7200000, 0)){
if(func_6(0)){
...
if(((!Global_110345 && NETWORK::NETWORK_IS_GAME_IN_PROGRESS()) && func_21(3763, -1)) && (!iLocal_301 || MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), uLocal_302)) > 25000)){
...
}elseif(!SOCIALCLUB::SC_LICENSEPLATE_GET_ISVALID_IS_PENDING(iLocal_300)){
...
}elseif(!SOCIALCLUB::SC_LICENSEPLATE_GET_ADD_IS_PENDING(iLocal_300)){
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
iLocal_301=1;
uLocal_302=NETWORK::GET_NETWORK_TIME();
}
break;
}
iLocal_300=0;
...
iLocal_110=0;
iLocal_112=1;
}}}elseif(func_192(&uLocal_106, &uLocal_111)){
...
bVar21=MISC::IS_BIT_SET(iVar24[(iLocal_116 / 32)], (iLocal_116 % 32)) !=MISC::IS_BIT_SET(uLocal_120[(iLocal_116 / 32)], (iLocal_116 % 32));
iLocal_116++;
settimerb(4900);
}}
if(bVar21){
...
}elseif(!SOCIALCLUB::SC_LICENSEPLATE_GET_ISVALID_IS_PENDING(iLocal_97)){
...
if(func_292(96, "SOCIAL_CARAPP1", VEHICLE::GET_DISPLAY_NAME_FROM_VEHICLE_MODEL(Var12.f_0), 0, -99, 0, 0, 0, 0)){
...
if(func_292(96, "SOCIAL_CARAPP3", VEHICLE::GET_DISPLAY_NAME_FROM_VEHICLE_MODEL(Var12.f_0), 0, -99, 0, 0, 0, 0)){
Var12.f_33=0;
Var12.f_36=1;
Var12.f_35=0;
Var12.f_34=0;
}}elseif(func_292(96, "SOCIAL_CARAPP", VEHICLE::GET_DISPLAY_NAME_FROM_VEHICLE_MODEL(Var12.f_0), 0, -99, 0, 0, 0, 0)){
Var12.f_33=0;
Var12.f_36=1;
Var12.f_35=0;
}
...
return (shift_right(iParam0, 26) & 31 * func_231(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
var func__234(struct<7> Param0, int iParam1){
var uVar0;
var uVar1;
var uVar2;
...
var func__244(struct<6> Param0, var uParam1){
var uVar0;
if(Param0.f_0 > 0){
...
if(iLocal_123){
if(MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), uLocal_122)) < 1500){
return 0;
}}
iLocal_123=0;
...
iLocal_123=1;
uLocal_122=NETWORK::GET_NETWORK_TIME();
settimera(0);
return 1;
}
