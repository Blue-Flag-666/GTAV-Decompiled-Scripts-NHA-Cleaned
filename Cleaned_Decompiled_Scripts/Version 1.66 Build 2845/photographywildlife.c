...
func_30();
func_21();
if(MISC::IS_BIT_SET(Global_113648.f_10051.f_99, 1) && !bLocal_214){
iLocal_221++;
}
break;
case 1:
...
MemCopy(&Var3,{
func_12(Global_44465[iVar4 /*12*/].f_1)
}
, 4);
}else{
Var3={
...
iVar2=iVar5;
Var3={
func_12(Global_44465[iVar5 /*12*/].f_1) 
};
...
Var3={
func_12(Global_44465[iVar11 /*12*/].f_1) 
};
}}
if(!bParam4){
...
if(bLocal_214){
if(!func_29()){
uLocal_211=GRAPHICS::REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_211)){
wait(0);
}
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_211, "SHOW_BRIDGES_KNIVES_PROGRESS");
func_28("PW_TITLE");
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_211, "SHARD_ANIM_OUT");
...
void func_22(){
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_211)){
GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_211);
}}
...
if(!func_29()){
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_211)){
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_211, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
}}}
...
if((func_17(&uLocal_205) <=3f && func_34(0)) && func_33(PLAYER::PLAYER_PED_ID())){
...
void func_42(){
if(iLocal_217){
if((func_17(&uLocal_208) > 5f && func_45() >=1) && !MISC::IS_BIT_SET(Global_113648.f_10051.f_99, 1)){
switch (iLocal_224){
case 0:
