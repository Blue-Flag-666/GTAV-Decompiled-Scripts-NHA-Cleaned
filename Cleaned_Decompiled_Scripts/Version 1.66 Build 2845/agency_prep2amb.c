...
void func_177(){
if((MISC::IS_BIT_SET(uLocal_49, 0) && Global_43257==15) && !func_210()){
if(iLocal_38==0){
if(!MISC::IS_BIT_SET(uLocal_49, 1) && MISC::IS_BIT_SET(uLocal_49, 0)){
if(!func_78(PLAYER::PLAYER_PED_ID(), Local_50, 5f, 1)){
if(MISC::IS_BIT_SET(uLocal_49, 20) || func_135()){
if((func_252(PLAYER::PLAYER_PED_ID()) && !MISC::IS_BIT_SET(uLocal_47[0], 17)) && !MISC::IS_BIT_SET(uLocal_47[1], 18)){
...
int iVar0;
bool bVar1;
if(((((((Global_43257==15 && iLocal_37 !=3) && MISC::IS_BIT_SET(uLocal_49, 5)) && !func_210()) && Global_78555==-1) && !func_236()) && !func_86(9)) || func_105(35)){
func_235();
func_233();
switch (iLocal_39){
case 0:
...
struct<8> func_264(char* sParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<8> Var0;
Var0.f_0=sParam0;
Var0.f_1={
Param1 
