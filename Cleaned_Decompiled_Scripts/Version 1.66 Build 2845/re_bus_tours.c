...
}}elseif(CAM::DOES_CAM_EXIST(uLocal_81)){
CAM::DESTROY_CAM(uLocal_81, 0);
CAM::RENDER_SCRIPT_CAMS(0, 0, 0, 1, 0, 0);
ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 1, 0);
}}
...
CAM::ATTACH_CAM_TO_ENTITY(uLocal_81, PLAYER::PLAYER_PED_ID(), Var7.f_0, (Var7.f_1 - 1f), (Var7.f_2 + 1f), 1);
}else{
...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_59[2], MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f), 0.5f) 
};
...
ENTITY::SET_ENTITY_COORDS(iLocal_63, Param0.f_0, Param0.f_1, Param0.f_2, 1, 0, 0, 1);
...
elseif(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_50[iVar0 /*15*/].f_1, 40f, 40f, 12f, 0, 1, 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_63, 0)){
...
if((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 5f, 5f, 5f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_124("TX_H02")){
if(func_155()){
if(!iLocal_266){
...
HUD::SET_BLIP_SCALE(uLocal_67, Global_32210);
if(!PED::IS_PED_INJURED(iLocal_58)){
...
if(!PED::IS_PED_INJURED(iLocal_57)){
if(((func_171(iLocal_57) || !PED::IS_PED_IN_ANY_VEHICLE(iLocal_57, 0)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_57)) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_57)){
func_167(iLocal_58);
return 1;
}}else{
func_167(iLocal_58);
...
if(func_172(uParam0, &uLocal_90, &uLocal_87, uLocal_85, bLocal_91, 1077936128, 0) || PED::IS_PED_RAGDOLL(uParam0)){
func_167(uParam0);
return 1;
}
return 0;
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_66, joaat("player"));
}
...
return (shift_right(iParam0, 26) & 31 * func_209(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
