...
Var3={
func_87(Var3, -Var0.f_3.f_2) 
};
Var3={
func_87(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
return (shift_right(iParam0, 26) & 31 * func_106(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
while (iVar0 < 5){
Var1={
Global_32543[(iLocal_239 + iVar0) /*23*/][0 /*3*/] 
};
...
break;
case 2:
uLocal_71[0]=PED::CREATE_SYNCHRONIZED_SCENE(Local_66, Local_67, 2);
if(func_133(uParam0->f_28[0])){
func_235(&uLocal_72, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_1", 7, 0, 0);
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_71[0], sVar0, "hipster_post_post_irony", 8f, -8f, 513, 0, 1148846080, 0);
}
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_71[0], 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_71[0], 1);
iLocal_70++;
break;
case 3:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_71[0])){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_71[0]) >=0.95f){
iLocal_70++;
}}
break;
case 4:
uLocal_71[1]=PED::CREATE_SYNCHRONIZED_SCENE(Local_66, Local_67, 2);
if(func_133(uParam0->f_28[0])){
func_235(&uLocal_72, "RAMP2AU", "RAMP2_LEADIN", "RAMP2_LEADIN_2", 7, 0, 0);
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_71[1], sVar0, "hipster_self_hating_hipster", 8f, -8f, 513, 0, 1148846080, 0);
}
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_71[1], 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_71[1], 1);
iLocal_70++;
break;
case 5:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_71[1])){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_71[1]) >=0.95f){
iLocal_70++;
}}
break;
case 6:
uLocal_71[2]=PED::CREATE_SYNCHRONIZED_SCENE(Local_66, Local_67, 2);
if(func_133(uParam0->f_28[0])){
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_71[2], sVar0, "hipster_idle", 8f, -8f, 513, 0, 1148846080, 0);
}
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_71[2], 1);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_71[2], 0);
iLocal_70++;
break;
case 7:
break;
...
}elseif(MISC::GET_GAME_TIMER() > iLocal_69){
iLocal_69=-1;
return 1;
}
return 0;
...
uLocal_238=PED::CREATE_SYNCHRONIZED_SCENE(Local_66, Local_67, 2);
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_238, "misstrvram_2", "hipster_cunts_in_america", 8f, -8f, 513, 0, 1148846080, 0);
...
var func__298(struct<7> Param0, int iParam1){
var uVar0;
var uVar1;
var uVar2;
...
var func__302(struct<6> Param0, var uParam1){
var uVar0;
if(Param0.f_0 > 0){
...
}elseif(iParam4==func_315()){
StringCopy(sParam0, "VE_KOSATKA_t0_v0", 64);
}elseif(iParam4==func_314()){
if(iParam6==40){
...
var func__359(struct<3> Param0, float fParam1){
struct<3> Var0;
Var0={
