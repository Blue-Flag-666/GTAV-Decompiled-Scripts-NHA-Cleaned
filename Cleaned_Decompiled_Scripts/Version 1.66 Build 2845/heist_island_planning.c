...
if((MISC::IS_BIT_SET(Local_176.f_3[(0 / 32)], (0 % 32)) && !func_10()) && !iLocal_144){
...
break;
case 2:
TASK::OPEN_SEQUENCE_TASK(&uLocal_153);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_153);
TASK::TASK_PERFORM_SEQUENCE(iLocal_159, uLocal_153);
iLocal_150=3;
if(!func_42()){
...
break;
case 5:
TASK::TASK_PLAY_ANIM(iLocal_159, func_48(), func_25(), 8f, 1.5f, -1, 262152, 0, 0, 0, 0);
if(func_42()){
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_153);
func_38(&uLocal_155);
iLocal_150=0;
iLocal_136=0;
break;
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_30(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
fVar2=50f;
}elseif(func_171(Global_4718592.f_113724) || MISC::IS_BIT_SET(uParam12, 2)){
...
fVar2=42.6052f;
}}elseif(func_169(Global_4718592.f_113724) || MISC::IS_BIT_SET(uParam12, 1)){
Var0={
...
fVar2=50f;
}elseif(MISC::IS_BIT_SET(uParam12, 4) || func_168(Global_4718592.f_113724)){
Var0={
...
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_166(iVar6), func_165(iVar6), 3.5688f, 7.9792f, 4.1641f) 
};
Var1={
-21.6791f, 0f, (func_165(iVar6) + 40.237f) 
};
fVar2=70f;
}elseif(MISC::IS_BIT_SET(uParam12, 6) || func_164()){
...
fVar2=50f;
}elseif(MISC::IS_BIT_SET(uParam12, 8) || func_160(Global_4718592.f_113724)){}elseif(MISC::IS_BIT_SET(uParam12, 9) || (func_158() && func_157(249))){
Var0={
...
if(!func_116()){
iVar5=0;
}}elseif(MISC::IS_BIT_SET(uParam12, 10)){}elseif(func_156(Global_4718592.f_113724)){
Var0={
...
func_128(func_195(), ((MISC::IS_BIT_SET(uParam12, 0) || MISC::IS_BIT_SET(uParam12, 1)) || MISC::IS_BIT_SET(uParam12, 2)));
}
...
Var1={
func_145(Var1, -Var0[0 /*6*/].f_3.f_2) 
};
Var1={
func_145(Var1, Var0[1 /*6*/].f_3.f_2) 
};
*uParam2={
...
Vector3 func__145(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
return MISC::IS_BIT_SET(Local_176.f_3[(iParam1 / 32)], (iParam1 % 32));
}


var func__328(var uParam0, int iParam1){
return MISC::IS_BIT_SET(Local_176[(iParam1 / 32)], (iParam1 % 32));
}
...
uLocal_131=GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
iLocal_133=1;
}
...
MONEY::NETWORK_SPEND_ISLAND_HEIST(Global_262145.f_29929, 0, 1, &Var4);
}
func_605(1);
...
if(!MISC::IS_BIT_SET(Local_176[(iParam1 / 32)], (iParam1 % 32))){}
...
if(GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_131)){
*iParam0=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_131);
return 1;
}
*iParam0=-1;
return 0;
...
bVar0=false;
while (bVar0 < 6){
if(MISC::IS_BIT_SET(Global_1979596[uParam0->f_1084 /*53*/].f_5.f_45, bVar0) && !MISC::IS_BIT_SET(iLocal_152, bVar0)){
...
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_159, 1561.149f, 386.0429f, -49.68533f, 1f, 0.65f, 1f, 0, 1, 0) && func_968(ENTITY::GET_ENTITY_HEADING(iLocal_159), 180f, 60f)){
return 1;
}
return 0;
}
