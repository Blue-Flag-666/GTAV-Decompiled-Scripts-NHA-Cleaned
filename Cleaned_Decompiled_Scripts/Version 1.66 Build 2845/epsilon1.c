...
func_6(13, floor(Global_113648.f_10196.f_3853));
}
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_88(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_88(iParam0));
if(iVar11 > iVar10){
...
func_174(&uVar1, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_88, 1, 1, 0);
}}
if(func_217(PLAYER::PLAYER_PED_ID())){
...
uLocal_264=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 1966.059f, 2861.493f, 50.10657f, 5.965983f, 0f, -30.2506f, 50f, 0, 2);
CAM::SET_CAM_ACTIVE(uLocal_264, 1);
uLocal_265=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 1970.629f, 2872.505f, 49.44081f, 5.712656f, 0f, -160.9523f, 50f, 0, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
}}elseif(func_217(iLocal_85)){
if(func_217(iLocal_88)){
...
CAM::SET_CAM_ACTIVE(uLocal_265, 0);
func_247(0);
iLocal_83=2;
}elseif(timera() > 10000){
if(!CAM::IS_CAM_ACTIVE(uLocal_265)){
CAM::SET_CAM_ACTIVE(uLocal_265, 1);
CAM::SET_CAM_ACTIVE(uLocal_264, 0);
CAM::SET_CAM_PARAMS(uLocal_265, 1970.766f, 2872.221f, 49.47233f, 5.712656f, 0f, -160.9523f, 50f, 5000, 3, 3, 2);
}}
}
...
settimera(0);
func_220(2000, 0);
CAM::SET_CAM_PARAMS(uLocal_264, 1966.352f, 2861.772f, 50.31656f, 4.433831f, 0f, -30.38087f, 50f, 10000, 0, 0, 2);
}
}}else{
TASK::TASK_WARP_PED_INTO_VEHICLE(iLocal_85, iLocal_88, -1);
}}}
...
void func_246(){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_85)){
iLocal_85=PED::CREATE_PED(26, iLocal_86, Local_257, 0, 1, 1);
}
if(func_217(iLocal_85)){
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_85, 1);
...
void func_274(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
func_275(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}


void func_275(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
int func_279(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
void func_303(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_305(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
void func_321(var uParam0, int iParam1, struct<3> Param2, float fParam3){
func_322(uParam0);
