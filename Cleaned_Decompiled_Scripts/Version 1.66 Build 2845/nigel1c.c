...
fLocal_30=180f;
iLocal_33=3;
uLocal_41=func_546(64);
uLocal_42=func_546(63);
...
iLocal_638=1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_422, PLAYER::PLAYER_PED_ID(), 1)){
if(PED::IS_PED_USING_ANY_SCENARIO(iLocal_422)){
PED::SET_PED_PANIC_EXIT_SCENARIO(iLocal_422, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
}
...
iLocal_420=0;
iLocal_419=10;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_423, PLAYER::PLAYER_PED_ID(), 1) || func_47()){
PED::SET_PED_TO_RAGDOLL(iLocal_423, 500, 1000, 0, 1, 1, 0);
iLocal_414=4;
iLocal_420=0;
iLocal_419=10;
}elseif(FIRE::GET_NUMBER_OF_FIRES_IN_RANGE(ENTITY::GET_ENTITY_COORDS(iLocal_423, 1), 2f) > 0){
PED::SET_PED_TO_RAGDOLL(iLocal_423, 500, 1000, 0, 1, 1, 0);
iLocal_414=3;
iLocal_420=0;
iLocal_419=10;
...
iLocal_420=0;
iLocal_419=10;
}elseif(func_34(iLocal_422, 1, 8f, 15f) || func_29(iLocal_422, 5f, 0, 0)){
...
HUD::CLEAR_PRINTS();
HUD::CLEAR_HELP(1);
if(HUD::DOES_BLIP_EXIST(uLocal_451)){
HUD::REMOVE_BLIP(&uLocal_451);
}
AUDIO::TRIGGER_MUSIC_EVENT("NIGEL1C_FAIL");
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_617);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_617);
TASK::TASK_PERFORM_SEQUENCE(iLocal_423, uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
}
if(AUDIO::IS_AUDIO_SCENE_ACTIVE("NIGEL_1C_SCENE")){
...
}elseif(MISC::GET_GAME_TIMER() > iLocal_673){
TASK::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
...
func_220();
func_68(&uLocal_452, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_665, Local_666, fLocal_667, 0, 1, 0)){
func_219(500, 1);
...
uLocal_430=PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2), 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_430, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_430, 0);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_430, sLocal_655, "take_collar_trevor", 8f, -4f, 1, 16, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_423, uLocal_430, sLocal_655, "take_collar_dog", 8f, -4f, 1, 16, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
uLocal_622=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_622, uLocal_430, "take_collar_cam", sLocal_655);
...
break;
case 1:
if(((iLocal_633==0 && PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_430)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_430) >=0.75f) && func_284(iLocal_423)){
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "COLLAR", iLocal_423, "NIGEL_1C_SOUNDSET", 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_423, 3, 1, 0, 0);
iLocal_633=1;
}elseif(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_430) && !func_26()){
if(func_86(&uLocal_452, "NIG1CAU", "NIG1C_COLLAR", "NIG1C_COLLAR_3", 7, 0, 0)){
CAM::STOP_RENDERING_SCRIPT_CAMS_USING_CATCH_UP(0, 0, 3, 0);
if(CAM::DOES_CAM_EXIST(uLocal_622)){
CAM::SET_CAM_ACTIVE(uLocal_622, 0);
CAM::DESTROY_CAM(uLocal_622, 0);
}
TASK::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
func_76(1, 1, 1, 1);
iLocal_420=0;
...
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_430)){
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_430, 1f);
}
wait(3000);
if(func_26()){
AUDIO::STOP_SCRIPTED_CONVERSATION(0);
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_656, 50f, 0, 0, 0, 0, 0, 0, 0);
...
PED::ADD_SCENARIO_BLOCKING_AREA(Local_657, Local_658, 0, 1, 1, 1);
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_103(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
func_147(&(Global_78341[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_147(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_147(&(Global_78341[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
iVar10=(iParam1 - iParam2);
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_103(iParam0));
if(iVar11 > iVar10){
...
void func_211(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
int func_215(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
int func_216(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
int func_222(struct<2> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_423, uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_423, 1, 0);
}
func_87(1);
...
break;
case 1:
func_241(uLocal_451, iLocal_423, 100f, 0.7f, 0);
func_240();
func_235();
func_234();
func_232();
...
if((ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_423, Local_662, Local_663, fLocal_664, 0, 1, 0) && func_226(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_423, 0f, 1f, 0f), 1.5f)) && !ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_423)){
...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_423, 1)) 
};
...
bool func_226(int iParam0, struct<3> Param1, float fParam2){
struct<3> Var0;
struct<3> Var1;
Var0={
ENTITY::GET_ENTITY_COORDS(iParam0, 1) 
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_617);
TASK::TASK_PERFORM_SEQUENCE(Local_421[0 /*16*/], uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
iLocal_630=1;
...
iLocal_632=0;
}}elseif(func_88(&uLocal_452, "NIG1CAU", "NIG1C_DOG", "NIG1C_DOG_3", 7, 1, 0)){
iLocal_632=0;
}}}
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_617);
TASK::TASK_PERFORM_SEQUENCE(Local_421[1 /*16*/], uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
...
int func_228(){
var uVar0;
TASK::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_426, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), &uVar0);
return uVar0;
}
...
VEHICLE::START_VEHICLE_HORN(Local_445.f_0, 4000, 0, 0);
iLocal_626=1;
}}}elseif(TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_423)){
if(func_233()==19){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_445.f_0, 2, "NIG1C_COMET2", 1);
...
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_445.f_0, 1);
}}}}}

int func_233(){
var uVar0;
TASK::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(sLocal_426, ENTITY::GET_ENTITY_COORDS(iLocal_423, 1), &uVar0);
return uVar0;
}
...
VEHICLE::START_VEHICLE_HORN(Local_443.f_0, 3000, 0, 0);
iLocal_625=1;
}}}elseif(TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_423)){
if(func_233() > 25){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_443.f_0, 1, "NIG1C_COMET", 1);
...
if(iLocal_624==0){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_423, -662.7688f, -208.3171f, 35.49321f, -674.6289f, -214.6519f, 38.80591f, 6.5f, 0, 1, 0)){
VEHICLE::START_VEHICLE_HORN(Local_441.f_0, 1500, 0, 0);
...
PED::SET_PED_PANIC_EXIT_SCENARIO(Local_421[2 /*16*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
}
TASK::OPEN_SEQUENCE_TASK(&uLocal_617);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_617);
TASK::TASK_PERFORM_SEQUENCE(Local_421[2 /*16*/], uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
}
iLocal_624=1;
}}
...
break;
case 1:
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_441.f_0, iLocal_643, sLocal_642, 1);
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_442.f_0, iLocal_645, sLocal_644, 1);
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_446.f_0, iLocal_646, sLocal_644, 1);
...
TASK::TASK_VEHICLE_MISSION(Local_446.f_1, Local_446.f_0, Local_442.f_0, 2, 20f, 262144, 0.5f, 2f, 1);
TASK::TASK_VEHICLE_MISSION(Local_442.f_1, Local_442.f_0, Local_446.f_0, 2, 20f, 262144, 0.5f, 2f, 1);
VEHICLE::START_VEHICLE_HORN(Local_442.f_0, 800, 0, 0);
iLocal_412=4;
break;
case 4:
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_617);
TASK::TASK_PERFORM_SEQUENCE(Local_446.f_1, uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
...
TASK::TASK_PLAY_ANIM(0, sLocal_652, "exit_to_generic", 8f, -8f, -1, 8192, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_617);
TASK::TASK_PERFORM_SEQUENCE(Local_441.f_1, uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
...
case 6:
break;
}}elseif(func_222(Local_449)){
if(TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(iLocal_423)){
if(func_233() > 19){
TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_449.f_1, Local_449.f_0, -567.85f, -288.8f, 34.08f, 12f, 0, iLocal_437, 24, 5f, 5f);
iLocal_412=6;
}}}}elseif((func_56(Local_442.f_0) && func_56(Local_441.f_0)) && func_56(Local_446.f_0)){
...
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_446.f_0, 1);
func_236();
}}
...
switch (iLocal_417){
case 0:
if((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_442.f_0, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_441.f_0, 0)) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_446.f_0, 0)){
TASK::CLEAR_PED_TASKS(Local_446.f_1);
if(func_239()==joaat("weapon_unarmed")){
PED::SET_PED_COMBAT_ATTRIBUTES(Local_446.f_1, 5, 1);
}
...
break;
case 1:
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_446.f_0, 0)){
...
PED::SET_PED_COMBAT_ATTRIBUTES(Local_446.f_1, 5, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_446.f_1, 17, 1);
TASK::CLEAR_PED_TASKS(Local_446.f_1);
...
break;
case 1:
ENTITY::SET_ENTITY_COORDS(Local_444.f_0, -616.56f, -176.6f, 37.26f, 1, 0, 0, 1);
...
TASK::TASK_VEHICLE_MISSION(Local_444.f_1, Local_444.f_0, Local_442.f_0, 12, 15f, 262144, 20f, 5f, 1);
}
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_617);
TASK::TASK_PERFORM_SEQUENCE(Local_444.f_1, uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
VEHICLE::START_VEHICLE_HORN(Local_444.f_0, 1000, 0, 0);
iLocal_413=4;
break;
case 4:
if((TASK::GET_SCRIPT_TASK_STATUS(Local_444.f_1, joaat("script_task_perform_sequence")) !=1 && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_444.f_0, -1, 0)) && !PED::IS_PED_FLEEING(Local_444.f_1)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_617);
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_444.f_0, 0) && !PED::IS_PED_FLEEING(Local_444.f_1)){
...
TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, Local_444.f_0, PLAYER::PLAYER_PED_ID(), 8, 20f, 20, 100f, 5f, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_617);
TASK::TASK_PERFORM_SEQUENCE(Local_444.f_1, uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
iLocal_413=7;
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_617);
TASK::TASK_PERFORM_SEQUENCE(Local_448.f_1, uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
}
if(func_222(Local_447)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_617);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_617);
TASK::TASK_PERFORM_SEQUENCE(Local_447.f_1, uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
}
...
ENTITY::SET_ENTITY_COORDS(Local_448.f_0, -678.85f, -95.08f, 36.86f, 1, 0, 0, 1);
...
func_234();
func_232();
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_423, Local_620, 3f, 3f, 2f, 0, 1, 0)){
iLocal_420=0;
iLocal_419=6;
}
if(func_225(0)){
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_617);
TASK::TASK_PERFORM_SEQUENCE(Local_421[4 /*16*/], uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_617);
TASK::TASK_PERFORM_SEQUENCE(Local_421[iParam0 /*16*/], uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
Local_421[iParam0 /*16*/].f_13=1;
}}}elseif(func_27(Local_421[iParam0 /*16*/], iLocal_423, 3f, 1)){
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_421[iParam0 /*16*/], ENTITY::GET_ENTITY_COORDS(iLocal_423, 1)) 
};
...
TASK::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_423, -1, 0, 2);
}}elseif(MISC::GET_GAME_TIMER() > iLocal_428 && !func_26()){
if(func_2(&uLocal_452, "NIG1CAU", "NIG1C_WAIT", 7, func_25(), 0, 0)){
iLocal_428=MISC::GET_GAME_TIMER() + 5000;
}}}}


float func_247(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
Var0={
ENTITY::GET_ENTITY_COORDS(iParam0, 1) 
...
Local_421[iParam0 /*16*/]=PED::CREATE_PED(5, Local_421[iParam0 /*16*/].f_1, Local_421[iParam0 /*16*/].f_2, Local_421[iParam0 /*16*/].f_5, 1, 1);
Var0={
Local_421[iParam0 /*16*/].f_2 
};
MISC::GET_GROUND_Z_FOR_3D_COORD(Var0, &fVar1, 0, 0);
ENTITY::SET_ENTITY_COORDS(Local_421[iParam0 /*16*/], Var0.f_0, Var0.f_1, fVar1, 1, 0, 0, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_421[iParam0 /*16*/], uLocal_619);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_421[iParam0 /*16*/], 17, 1);
}}
...
Local_441.f_0=VEHICLE::CREATE_VEHICLE(Local_441.f_2, Local_441.f_4, Local_441.f_7, 1, 1, 0);
Local_441.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_441.f_0, 4, Local_441.f_3, -1, 1, 1);
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_441.f_0, 1);
...
PED::SET_PED_CONFIG_FLAG(Local_441.f_1, 115, 1);
}
return 0;
}
if(!ENTITY::DOES_ENTITY_EXIST(Local_442.f_0)){
if(STREAMING::HAS_MODEL_LOADED(iLocal_437) && STREAMING::HAS_MODEL_LOADED(iLocal_432)){
Local_442.f_0=VEHICLE::CREATE_VEHICLE(iLocal_437, -591.7191f, -166.3491f, 37.8459f, 35f, 1, 1, 0);
Local_442.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_442.f_0, 5, iLocal_432, -1, 1, 1);
PED::SET_PED_CONFIG_FLAG(Local_442.f_1, 32, 1);
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_442.f_0, 1);
...
Local_443.f_0=VEHICLE::CREATE_VEHICLE(iLocal_435, -651.4f, -153.68f, 36.95f, 217.44f, 1, 1, 0);
Local_443.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_443.f_0, 4, iLocal_434, -1, 1, 1);
iLocal_429=PED::CREATE_PED_INSIDE_VEHICLE(Local_443.f_0, 4, iLocal_432, 2, 1, 1);
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Local_443.f_0, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_443.f_0, 3);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_443.f_1, 17, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_429, 17, 1);
...
Local_445.f_0=VEHICLE::CREATE_VEHICLE(iLocal_436, -525.33f, -137.35f, 38.04f, 111.2f, 1, 1, 0);
...
if(STREAMING::HAS_MODEL_LOADED(iLocal_435) && STREAMING::HAS_MODEL_LOADED(iLocal_434)){
Local_446.f_0=VEHICLE::CREATE_VEHICLE(iLocal_435, Local_446.f_4, Local_446.f_7, 1, 1, 0);
...
Local_446.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_446.f_0, 4, iLocal_434, -1, 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_446.f_1, 17, 1);
...
Local_444.f_0=VEHICLE::CREATE_VEHICLE(iLocal_438, -584.32f, -156.66f, 36.95f, 117.29f, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_444.f_0, 1084227584);
...
Local_447.f_0=VEHICLE::CREATE_VEHICLE(iLocal_440, -683.3f, -238.03f, 36.63f, 29.79f, 1, 1, 0);
...
Local_447.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_447.f_0, 4, iLocal_434, -1, 1, 1);
...
Local_448.f_0=VEHICLE::CREATE_VEHICLE(Local_448.f_2, Local_448.f_4, Local_448.f_7, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_448.f_0, 1084227584);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_448.f_0, 3);
if(!func_284(Local_448.f_1)){
Local_448.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_448.f_0, 4, Local_448.f_3, -1, 1, 1);
...
Local_449.f_0=VEHICLE::CREATE_VEHICLE(iLocal_437, Local_449.f_4, Local_449.f_7, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_449.f_0, 1084227584);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_449.f_0, 3);
if(!func_284(Local_449.f_1)){
Local_449.f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_449.f_0, 4, iLocal_434, -1, 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_449.f_1, 17, 1);
...
iLocal_450=VEHICLE::CREATE_VEHICLE(joaat("firetruk"), -637.88f, -112.82f, 38.1f, 83.08f, 1, 1, 0);
...
case 0:
if(!HUD::DOES_BLIP_EXIST(uLocal_451)){
uLocal_451=func_253(iLocal_423, 1, 1, 5);
}
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_617);
TASK::TASK_PERFORM_SEQUENCE(iLocal_422, uLocal_617);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_617);
}
iLocal_427=1;
iLocal_428=0;
...
bool func_257(int iParam0, struct<3> Param1, float fParam2, int iParam3){
...
break;
case 1:
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_662, Local_663, fLocal_664, 0, 1, 0)){
iLocal_420=0;
iLocal_419=3;
}
if(PED::IS_PED_FLEEING(iLocal_422)){
...
bool bVar0;
if(func_284(iLocal_422)){
if(MISC::GET_GAME_TIMER() > iLocal_647 && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_648, Local_649, fLocal_650, 0, 1, 0)){
bVar0=false;
if(HUD::IS_MESSAGE_BEING_DISPLAYED()){
...
func_252("N1C_INIT", 7500, 1);
AUDIO::TRIGGER_MUSIC_EVENT("NIGEL1C_FORA");
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_659, Local_660, fLocal_661, 0, 1, 0)){
iLocal_420=0;
iLocal_419=2;
}else{
iLocal_420=1;
...
void func_262(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_265(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
void func_281(struct<3> Param0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5){
var uVar0;
int iVar1;
...
func_292(13, floor(Global_113648.f_10196.f_3853));
}
...
Global_78341[1 /*14*/]={
func_144(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
func_320(&uVar1, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
void func_322(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21){
uParam0->f_4=iParam4;
*uParam0=sParam1;
uParam0->f_1={
Param2 
...
void func_368(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11){
int iVar0;
iVar0=1;
...
*iParam0=func_449(Param1, fParam2);
}elseif(iParam7==1){
...
int func_369(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5){
var uVar0;
var uVar1;
struct<97> Var2;
int iVar3;
...
func_431(iParam0, &(Var2.f_31), &(Var2.f_81));
VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
if(iParam1==1){
...
if(((!func_386(PLAYER::PLAYER_ID()) && iParam0 !=joaat("thruster")) && iParam0 !=joaat("avenger")) && !bVar0){
return 0;
}
return 1;
}
...
if(!func_437() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
bool func_448(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_449(struct<3> Param0, float fParam1){
return func_450(&(Global_107196.f_2890), Param0, fParam1, 0);
}

int func_450(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
if((!bParam2 || func_448(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
VEHICLE::DELETE_VEHICLE(&iParam0);
return 1;
}else{
return 0;
...
iLocal_422=PED::CREATE_PED(5, iLocal_431, Local_424, 27.58f, 1, 1);
...
iLocal_423=PED::CREATE_PED(26, iLocal_433, -633.89f, -250.1f, 37.38f, 50f, 1, 1);
...
iLocal_423=PED::CREATE_PED(26, iLocal_433, -636.42f, -95.84f, 37.48f, -95.46f, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_423, 3, 0, 3, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_423, 4, 0, 1, 0);
...
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_434, 1);
return 1;
}
...
iLocal_423=Local_411.f_28[1];
if(func_284(iLocal_423)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_423, 1);
}
func_68(&uLocal_452, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
func_68(&uLocal_452, 3, iLocal_422, "KERRY", 0, 1);
...
break;
case 1:
if(!func_506(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar2)){
return 0;
}
iLocal_40=2;
break;
...
func_519(&iLocal_422, 1, 0, 1);
func_519(&iLocal_423, 1, 0, 1);
func_519(&iLocal_429, 0, 0, 1);
func_516(&iLocal_450);
func_522(Local_442);
func_522(Local_444);
func_522(Local_441);
...
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_434, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_435);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_436);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_437);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_440);
...
if(ENTITY::DOES_ENTITY_EXIST(Local_421[iParam0 /*16*/])){
func_519(&(Local_421[iParam0 /*16*/]), 0, 0, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_421[iParam0 /*16*/].f_1);
}}


void func_522(struct<2> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6){
...
iVar2=func_527(SCRIPT::GET_THIS_SCRIPT_NAME());
if(iVar2 > -1){
