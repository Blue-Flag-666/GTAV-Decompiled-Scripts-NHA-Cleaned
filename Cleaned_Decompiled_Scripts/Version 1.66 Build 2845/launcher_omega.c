...
float fVar2;
float fVar3;
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_56, "SET_COLOUR");
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_56, "SET_DISTANCE");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(10f);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
HUD::SET_TEXT_RENDER_ID(uLocal_57);
fVar0=0.1f;
fVar1=0.24f;
fVar2=0.21f;
fVar3=0.51f;
...
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_56, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
if((MISC::GET_GAME_TIMER() - iLocal_58) > 1250){
AUDIO::PLAY_SOUND_FROM_COORD(uLocal_59, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
iLocal_58=MISC::GET_GAME_TIMER();
}}

int func_192(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6){
var uVar0;
if(!*uParam6==3){
if(func_180(2)){
if(!func_151()){
...
void func_247(){
uLocal_56=GRAPHICS::REQUEST_SCALEFORM_MOVIE("digiscanner");
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_56)){
wait(0);
}
...
if(HUD::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner")){
uLocal_57=HUD::GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");
}
uLocal_59=AUDIO::GET_SOUND_ID();
iLocal_58=MISC::GET_GAME_TIMER();
}
