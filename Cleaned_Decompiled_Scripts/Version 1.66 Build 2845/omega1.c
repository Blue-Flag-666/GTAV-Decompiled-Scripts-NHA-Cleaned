...
fLocal_48=20f;
sLocal_214="Omega";
uLocal_215=WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_digiscanner"));
...
func_227();
iLocal_45=1;
}elseif((MISC::GET_GAME_TIMER() - iLocal_224) > 7500){
if(!bLocal_43){
...
elseif(!bLocal_46 && func_229(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0]) > 50f){
...
Global_78341[1 /*14*/]={
func_88(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_88(iVar10, 14, uVar12[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_88(iVar10, 14, uVar15[iVar1], -1) 
};
func_55(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_71(14);
if(Global_78339==1){
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_80(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_80(iParam0));
if(iVar11 > iVar10){
...
func_166(&uVar1, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
void func_168(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21){
uParam0->f_4=iParam4;
*uParam0=sParam1;
uParam0->f_1={
Param2 
...
func_254(5);
return 0;
}elseif(PED::IS_PED_INJURED(Local_39.f_28[0])){
iLocal_42=2;
func_254(5);
return 0;
}elseif(func_235(Local_39.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0)){
TASK::TASK_SMART_FLEE_PED(Local_39.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
iLocal_42=3;
func_254(5);
return 0;
}elseif(func_233(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0], 1)){
TASK::TASK_SMART_FLEE_PED(Local_39.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
iLocal_42=3;
func_254(5);
return 0;
}elseif(PED::IS_PED_RAGDOLL(Local_39.f_28[0])){
iLocal_42=3;
func_254(5);
return 0;
}}
...
case 0:
if(func_231(Local_39.f_28[0])){
TASK::TASK_PERFORM_SEQUENCE(Local_39.f_28[0], uLocal_220);
}
...
func_319(&Local_39, 0, 1);
if(!ENTITY::DOES_ENTITY_EXIST(Local_39.f_41[0])){
Local_39.f_41[0]=OBJECT::CREATE_OBJECT(uLocal_215, 2468.51f, 3437.39f, 55f, 1, 1, 0);
}
iLocal_217=OBJECT::CREATE_OBJECT(iLocal_216, 2472.3f, 3437.3f, 49.3f, 1, 1, 0);
if(func_231(Local_39.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(Local_39.f_41[0])){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_39.f_41[0], Local_39.f_28[0], PED::GET_PED_BONE_INDEX(Local_39.f_28[0], 18905), 0.09f, 0.072f, -0.006f, 298f, 194f, 178f, 0, 0, 0, 0, 2, 1, 0);
}
if(func_231(Local_39.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_217)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_217, Local_39.f_28[0], PED::GET_PED_BONE_INDEX(Local_39.f_28[0], 64729), Local_218, Local_219, 0, 0, 0, 0, 2, 1, 0);
}
...
void func_259(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
int iVar0;
...
void func_271(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
iVar0=0;
while (iVar0 < 16){
if(func_231(uVar1[iVar0]) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar1[iVar0], Local_225[0 /*3*/], Local_225[1 /*3*/], fLocal_226, 0, 1, 0)){
...
PED::SET_PED_CONFIG_FLAG(Local_39.f_28[0], 185, 1);
}
if(func_234(PLAYER::PLAYER_PED_ID()) && func_234(Local_39.f_28[0])){
uLocal_223=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_39.f_28[0], uLocal_223);
PED::SET_PED_CONFIG_FLAG(Local_39.f_28[0], 132, 1);
...
int func_321(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_322(uParam0, iParam1, Param2, fParam3, 1)){
...
int func_322(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_157(iParam1)){
...
bVar2=false;
if(func_231(iParam0)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, Local_225[0 /*3*/], Local_225[1 /*3*/], fLocal_226, 0, 1, 0)){
...
void func_331(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11){
int iVar0;
iVar0=1;
...
if(!func_400() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
void func_405(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
bool func_411(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_412(struct<3> Param0, float fParam1){
return func_413(&(Global_107196.f_2890), Param0, fParam1, 0);
}

int func_413(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
int func_415(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_417(iParam0, uVar1[iVar3], 1) && func_416(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_411(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
...
int func_416(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
