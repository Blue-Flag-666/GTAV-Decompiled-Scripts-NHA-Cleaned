...
if(!func_196(0)){
func_78();
}elseif(!MISC::IS_BIT_SET(Local_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1)){
func_8();
}}elseif(func_197()==6){
Local_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/]=5;
}
...
if(NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT()){
if(iLocal_137==0){
MISC::CLEAR_BIT(&uLocal_140, false);
MISC::SET_BIT(&uLocal_140, true);
}
iVar0=iLocal_137;
if(NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar0)){
iVar1=NETWORK::NETWORK_GET_PLAYER_INDEX(iVar0);
if(!MISC::IS_BIT_SET(Local_138[iLocal_137 /*3*/].f_2, 0)){
MISC::CLEAR_BIT(&uLocal_140, true);
}
if(func_4(iVar1, 0, 1)){
if(!MISC::IS_BIT_SET(Global_1853910[iLocal_137 /*862*/].f_143, 4)){
}}}
iLocal_137++;
if(iLocal_137==32){
if(MISC::IS_BIT_SET(uLocal_140, 1)){
MISC::SET_BIT(&(Local_61.f_1), false);
}
MISC::SET_BIT(&uLocal_140, false);
iLocal_137=0;
}}}
...
MISC::SET_BIT(&(Local_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), false);
MISC::SET_BIT(&(Local_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), true);
func_74(10, 0);
func_73(0);
func_30(1);
func_23();
...
case 0:
if(!MISC::IS_BIT_SET(Local_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(!MISC::IS_BIT_SET(uLocal_140, 5)){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if(MISC::IS_BIT_SET(uLocal_140, 3)){
...
if(MISC::IS_BIT_SET(uLocal_140, 7)){
MISC::CLEAR_BIT(&uLocal_140, 7);
}
if(MISC::IS_BIT_SET(uLocal_140, 8)){
MISC::CLEAR_BIT(&uLocal_140, 8);
}
if(MISC::IS_BIT_SET(uLocal_140, 11)){
MISC::CLEAR_BIT(&uLocal_140, 11);
}
if(!MISC::IS_BIT_SET(uLocal_140, 2)){
if(iLocal_139 !=-1){
func_76(iLocal_139, 0);
func_75(iLocal_139, 0);
iLocal_139=-1;
...
elseif(MISC::IS_BIT_SET(uLocal_140, 11)){
...
if(iLocal_139==-1){
iLocal_139=func_128(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 4, -1);
if(iLocal_139 !=-1){
...
if(!MISC::IS_BIT_SET(uLocal_140, 4)){
if(MISC::IS_BIT_SET(uLocal_140, 3)){
...
if(!MISC::IS_BIT_SET(uLocal_140, 10)){
if(!MISC::IS_BIT_SET(uLocal_140, 9)){
...
if(MISC::IS_BIT_SET(uLocal_140, 3) || (func_147() && MISC::IS_BIT_SET(uLocal_140, 10))){
if(func_147()){
...
if(func_121()){
if(!MISC::IS_BIT_SET(Global_2793046.f_1822, 25)){
MISC::SET_BIT(&(Global_2793046.f_1822), 25);
}
...
func_23();
}}elseif(MISC::IS_BIT_SET(uLocal_140, 9)){
...
}}elseif(!MISC::IS_BIT_SET(Local_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0)){
MISC::SET_BIT(&(Local_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), false);
}
}}elseif(MISC::IS_BIT_SET(uLocal_140, 9)){
MISC::CLEAR_BIT(&uLocal_140, 9);
...
}elseif(func_150(&uLocal_143, 7000, 0) || func_147()){
...
if(!MISC::IS_BIT_SET(Local_138[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1)){
if(func_80()){
func_8();
}else{
func_79();
...
}elseif(func_150(&uLocal_149, 1000, 0)){
...
if(!func_81(&uLocal_149)){
func_7(&uLocal_149, 0, 0);
}elseif(func_150(&uLocal_149, 5000, 0)){
...
int func_128(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
Var3={
func_136(Var3, -Var0.f_3.f_2) 
};
Var3={
func_136(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__136(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
bool func_158(){
return MISC::IS_BIT_SET(Global_2793046.f_1825, 4);
}
...
void func_223(var uParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
func_200();
}
