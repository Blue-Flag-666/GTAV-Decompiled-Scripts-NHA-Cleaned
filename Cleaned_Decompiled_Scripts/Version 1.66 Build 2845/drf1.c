...
StringCopy(&cLocal_387, "Michael", 24);
StringCopy(&cLocal_391, "Therapist", 24);
Local_395={
...
uLocal_405=func_272(func_273(), 0, 1);
uLocal_406=func_272(func_273(), 0, 1);
...
func_253(&iLocal_379, &iLocal_382, uLocal_384, iLocal_60);
}
iLocal_62=func_252();
...
func_233(&iLocal_379, iLocal_55, Local_395, fLocal_397, iLocal_404, uLocal_405, uLocal_406);
...
func_137(&cLocal_387, PLAYER::PLAYER_PED_ID(), 0, 2);
}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_379, 0)){
func_137(&cLocal_391, iLocal_379, 0, 2);
}
bVar5=true;
}}}
if(func_135(&uVar6) > 6f && func_134()){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_379, 0)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), &cLocal_387, 0, 0, 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_379, &cLocal_391, 0, 0, 0);
}
...
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&cLocal_387, 0)){
func_132(iLocal_379, 1, 0);
}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&cLocal_391, 0)){
func_132(iLocal_379, 0, 1);
}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(0)){
func_131(iLocal_379, &iLocal_381, &iLocal_382, &uLocal_384, &uLocal_63, Local_396, fLocal_399, iLocal_57);
func_129(func_252());
func_243(&uLocal_231);
func_128(&uLocal_255, 0, 0, 0, 1);
func_127(&uLocal_255, "SHRINK_ACCEPT", 2, 201, 1, 1, 0);
func_127(&uLocal_255, "SHRINK_REJECT", 2, 202, 1, 1, 0);
bVar5=false;
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 0);
iLocal_60=3;
...
func_119(&uLocal_231);
while (func_135(&uLocal_231) < 0.4f){
wait(0);
func_120();
}
...
if(func_97(&uLocal_231, &uLocal_255, &bVar1)){
if(bVar1){
Local_61.f_20=0;
}
else{
...
HUD::CLEAR_HELP(1);
bVar2=true;
}elseif(func_135(&uLocal_231) >=14f){
Local_61.f_20=2;
bVar2=true;
HUD::CLEAR_HELP(1);
}elseif(!bVar3 && func_135(&uLocal_231) >=7f){
StringCopy(&cVar11, "DRF_PROMPT", 16);
func_96(&uLocal_63, &cVar10, &cVar11, 9, 0, 0, 0);
bVar3=true;
}}elseif((func_135(&uLocal_231) > 5f && func_134()) || (CUTSCENE::HAS_CUTSCENE_LOADED() && ((Local_61.f_20 !=1 || func_135(&uLocal_231) > fVar12) || func_93(iLocal_62, iLocal_379, &uLocal_384)))){
func_90();
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), &cLocal_387, 0, 0, 0);
}
...
ENTITY::SET_ENTITY_COORDS(iLocal_382, func_77(iLocal_382), 1, 0, 0, 1);
...
if(!func_75(&uVar7)){
func_243(&uVar7);
}elseif(func_135(&uVar7) > func_74(func_252())){
if(func_252()==4){
iLocal_380=PED::CREATE_PED(26, iLocal_56, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_380, 3, iLocal_404, uLocal_405, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_380, 4, 0, uLocal_406, 0);
...
if(HUD::DOES_BLIP_EXIST(uLocal_383)){
HUD::SET_BLIP_COLOUR(uLocal_383, 1);
}
iLocal_60=17;
}elseif(!ENTITY::DOES_ENTITY_EXIST(iLocal_380) || func_72(iLocal_380, PLAYER::PLAYER_PED_ID(), 1) > 300f){
func_96(&uLocal_63, "DrfAud", "DRF_AWAY", 9, 0, 0, 0);
if(HUD::DOES_BLIP_EXIST(uLocal_383)){
HUD::SET_BLIP_COLOUR(uLocal_383, 3);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_380)){
MISC::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_380, 1), 10f, 0);
}
iLocal_60=17;
}else{
func_55();
PED::SET_PED_CONFIG_FLAG(iLocal_380, 26, 1);
if(func_75(&uLocal_246)){
if(func_135(&uLocal_246) > 2.5f){
...
uLocal_384=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var16, Var17, 50f, 0, 2);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_384, uLocal_385, 2660, 1, 1);
...
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
}}elseif(CAM::DOES_CAM_EXIST(uLocal_385)){
if(func_135(&uLocal_243) >=2.66f){
...
if(func_52(&uLocal_237, 0.5f)){
if(STREAMING::IS_NEW_LOAD_SCENE_ACTIVE()){
STREAMING::NEW_LOAD_SCENE_STOP();
}
if(!HUD::DOES_BLIP_EXIST(uLocal_383)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_380, 0)){
uLocal_383=HUD::ADD_BLIP_FOR_ENTITY(iLocal_380);
HUD::SET_BLIP_COLOUR(uLocal_383, 1);
func_119(&uLocal_237);
}}elseif(HUD::GET_BLIP_COLOUR(uLocal_383) !=3){
HUD::SET_BLIP_COLOUR(uLocal_383, 3);
if(func_75(&uLocal_240)){
if(func_135(&uLocal_240) < (7500f / 1000f)){
...
elseif(!PED::IS_PED_FLEEING(iLocal_380)){
TASK::TASK_SMART_FLEE_PED(iLocal_380, PLAYER::PLAYER_PED_ID(), 3000f, -1, 0, 0);
}
if(!bVar15 && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_380, -1892.139f, -567.194f, 10.5f, -1904.935f, -556.4423f, 13.5f, 4.73f, 0, 1, 0)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_380, 0);
bVar15=true;
}}}
break;
case 16:
if(!func_75(&uLocal_234)){
STREAMING::NEW_LOAD_SCENE_STOP();
func_243(&uLocal_234);
}elseif(func_135(&uLocal_234) > 2f){
...
if(func_135(&uLocal_234) > 4f || CAM::IS_SCREEN_FADED_OUT()){
HUD::REMOVE_BLIP(&uLocal_383);
if(CAM::DOES_CAM_EXIST(uLocal_384)){
CAM::DESTROY_CAM(uLocal_384, 0);
}
func_271();
...
uVar0=Global_2805029[iParam0 /*3*/][func_10(iParam1)];
...
if(!func_75(&uLocal_249)){
func_243(&uLocal_249);
}
if(!func_75(&uLocal_252)){
func_243(&uLocal_252);
}
fVar3=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_380, 1));
if(iLocal_401 < 7){
if(iLocal_401 <=0){
if(func_135(&uLocal_249) > 0.2f){
...
iLocal_401=1;
func_119(&uLocal_249);
}}elseif(func_135(&uLocal_249) > 12f){
...
func_49(&uLocal_249, 6f);
}}}
if(iLocal_403 < 8){
if(iLocal_403 <=0){
if(func_135(&uLocal_252) > 1f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_380)){
...
VEHICLE::DELETE_VEHICLE(&iLocal_381);
iLocal_381=VEHICLE::CREATE_VEHICLE(iLocal_57, Local_396, fLocal_399, 1, 1, 0);
...
ENTITY::SET_ENTITY_COORDS(iLocal_381, Local_396, 1, 0, 0, 1);
...
PED::FORCE_PED_MOTION_STATE(iLocal_380, joaat("MotionState_Run"), 1, 1, 1);
}
uLocal_383=HUD::ADD_BLIP_FOR_ENTITY(iLocal_380);
HUD::SET_BLIP_COLOUR(uLocal_383, 1);
func_119(&uLocal_237);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
uLocal_385=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1904.615f, -558.892f, 12.8339f, -9.0794f, 0f, -127.4455f, 50f, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
HUD::DISPLAY_RADAR(0);
HUD::DISPLAY_HUD(0);
}
...
void func_131(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, struct<3> Param5, float fParam6, int iParam7){
int iVar0;
int iVar1;
...
Var3={
func_150(iVar4, 2, uParam1->f_59, -1) 
};
...
Var3={
func_150(iVar4, 1, uParam1->f_62, -1) 
};
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_144(iParam0));
if(iVar11 > iVar10){
...
var uVar0;
var uVar1;
uVar0=Global_2848282[iParam0 /*3*/][func_10(uParam1)];
...
iVar1=(iVar1 || shift_left(func_224(iParam1), iVar0));
...
void func_233(var uParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4, var uParam5, var uParam6){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
