...
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_39[bLocal_31 /*3*/]) < fLocal_40){
...
if(func_15()){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_41, Local_42, fLocal_45, 0, 1, 0)){
bLocal_33=true;
iLocal_27=1;
}
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_43, Local_44, fLocal_45, 0, 1, 0)){
bLocal_34=true;
iLocal_27=1;
}
}
...
if(iLocal_37){
if(iLocal_36){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_41, Local_42, fLocal_45, 0, 1, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_43, Local_44, fLocal_45, 0, 1, 0)){
func_14();
func_1();
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 1073741824, 3);
}
}
elseif(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_41, Local_42, fLocal_45, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_43, Local_44, fLocal_45, 0, 1, 0)){
iLocal_36=1;
}
elseif(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_41, Local_42, fLocal_45, 0, 1, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_43, Local_44, fLocal_45, 0, 1, 0)){
func_14();
...
break;
case 1:
if((((((timerb() > 3750 || CAM::IS_SCREEN_FADED_OUT()) || !PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || func_23()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || func_21()) || func_20()){
...
break;
case 2:
if((((((timerb() > 500 || CAM::IS_SCREEN_FADED_OUT()) || !PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || func_23()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || func_21()) || func_20()){
iLocal_28=3;
}else{
func_19();
if(Global_32399 > iLocal_32){
...
func_48(13, floor(Global_113648.f_10196.f_3853));
}
