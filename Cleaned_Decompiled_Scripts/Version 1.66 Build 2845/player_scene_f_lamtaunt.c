...
if(!iLocal_337 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0, PLAYER::PLAYER_PED_ID(), 1)){
...
iLocal_335=-1;
iLocal_336++;
}}elseif(iLocal_335 + 10000 < MISC::GET_GAME_TIMER()){
...
case 0:
if(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_317, &(Local_327[iParam1 /*16*/]), 2)){
fVar1=fLocal_334;
fVar2=-1f;
fVar3=-1f;
...
Local_266[iParam1 /*3*/]={
Var4 - Local_263 * Vector(4f, 4f, 4f) 
};
...
TASK::TASK_GO_STRAIGHT_TO_COORD(*uParam0, Local_263 + Local_266[iParam1 /*3*/] * Vector(0.1f, 0.1f, 0.1f), 1f, -1, 1193033728, 1056964608);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_263 + Local_266[iParam1 /*3*/], 1f, -1, 0.25f, iVar0, 1193033728);
iLocal_260[iParam1]=2;
return 1;
}
fVar5=vmag(Local_266[iParam1 /*3*/] * Vector(0.05f, 0.05f, 0.05f));
if(vdist2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_263) >=fVar5){
...
TASK::TASK_WANDER_IN_AREA(*uParam0, Local_263 + Local_266[iParam1 /*3*/], fLocal_268[iParam1], 1077936128, 1086324736);
...
TASK::SET_SCENARIO_TYPE_ENABLED(sLocal_333, 0);
}
if(vdist2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_263 + Local_266[iParam1 /*3*/]) < (fLocal_268[iParam1] * fLocal_268[iParam1])){
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_263 + Local_266[iParam1 /*3*/], fLocal_268[iParam1], 1)){
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*uParam0, Local_263 + Local_266[iParam1 /*3*/], fLocal_268[iParam1], 0);
...
Var6={
func_126(Local_263 + Local_266[iParam1 /*3*/], func_129((fLocal_268[iParam1] * 0.9f), 10f, 100f), 0f) 
};
...
Vector3 func__126(struct<3> Param0, float fParam1, float fParam2){
struct<3> Var0;
float fVar1;
float fVar2;
int iVar3;
...
fVar1=(fParam2 / 2f);
Var0={
func_128(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) 
};
...
Vector3 func__128(struct<3> Param0, float fParam1){
float fVar0;
if(fParam1==0f){
return 0f, 0f, 0f;
}
...
if(!iLocal_332){
if(fVar0 < fLocal_331){
}elseif(func_12(&uLocal_68, "PRSAUD", &Local_328, 3, 0, 0, 0)){
iLocal_332=1;
}}}else{
return 1;
}}
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_258[iVar0], Global_98011, &cLocal_317, &(Local_327[iVar0 /*16*/]), 8f, -4f, 3, 0, 1148846080, 0);
iLocal_260[iVar0]=0;
}else{
iLocal_260[iVar0]=-1;
}
...
while (iVar0 < iLocal_258){
if(!PED::IS_PED_INJURED(iLocal_258[iVar0])){
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_258[iVar0], Global_98010, &cLocal_317, &(Local_326[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
}
iVar0++;
}
...
while (iVar0 < iLocal_258){
if(iLocal_259[iVar0] !=0){
iLocal_258[iVar0]=PED::CREATE_PED(iLocal_262, iLocal_259[iVar0], Local_263 + Local_265[iVar0 /*3*/], 0, 1, 1);
...
TASK::TASK_PLAY_ANIM(iLocal_258[iVar0], &cLocal_317, &(Local_326[iVar0 /*16*/]), 8f, -8f, -1, 9, 0, 0, 0, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_258[iVar0], 317, 1);
if(iLocal_262==6){
WEAPON::GIVE_WEAPON_TO_PED(iLocal_258[iVar0], joaat("weapon_stungun"), 1000, 0, 1);
}}
iVar0++;
}}
...
Local_266[0 /*3*/]={
Vector(21.5656f, -1890.595f, 59.4395f) - Local_263 
};
Local_266[1 /*3*/]={
Local_266[0 /*3*/] 
};
...
Local_266[0 /*3*/]={
Vector(27.9565f, -1650.517f, 278.2831f) - Local_263 
};
Local_266[1 /*3*/]={
Local_266[0 /*3*/] 
};
...
if(!TASK::IS_SCENARIO_TYPE_ENABLED(sLocal_333)){
TASK::SET_SCENARIO_TYPE_ENABLED(sLocal_333, 1);
}
