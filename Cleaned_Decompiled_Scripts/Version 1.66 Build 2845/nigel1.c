...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_94.f_28[0], 1);
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_94.f_28[1], 1);
PED::SET_PED_INTO_VEHICLE(Local_94.f_28[1], Local_94.f_35[0], 0);
PED::SET_PED_KEEP_TASK(Local_94.f_28[1], 1);
}
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_94.f_35[0], 1, 1, 0);
...
int func_235(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_312(iParam0)){
...
int func_236(var uParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4){
...
func_237(uParam0, iLocal_81, Param1, fParam2);
if(func_312(*uParam0)){
...
void func_237(var uParam0, int iParam1, struct<3> Param2, float fParam3){
func_238(uParam0);
...
void func_254(struct<3> Param0, float fParam1, int iParam2, int iParam3){
struct<3> Var0;
var uVar1;
...
if(iParam2==1){
if(func_299(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
...
void func_255(int iParam0, struct<3> Param1, var uParam2, int iParam3, bool bParam4){
struct<60> Var0;
...
func_289(iParam3, &Var0, Param1, uParam2, func_292(iParam0));
...
return (shift_right(iParam0, 26) & 31 * func_281(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_289(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_286(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
int func_299(struct<3> Param0, int iParam1, var uParam2, var uParam3){
int iVar0;
...
int func_300(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
void func_303(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
...
int func_306(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
int func_307(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
Var4={
func_323(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
case 38:
if(bParam1){
uLocal_93=PED::ADD_SCENARIO_BLOCKING_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", 0);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", 0);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", 0);
...
case 39:
if(bParam1){
uLocal_93=PED::ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
...
case 41:
if(bParam1){
uLocal_93=PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
...
case 42:
if(bParam1){
uLocal_93=PED::ADD_SCENARIO_BLOCKING_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
...
int func_344(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_345(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
int func_345(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_153(iParam1)){
