...
StringCopy(&cLocal_35, "PMPLANE", 16);
StringCopy(&cLocal_38, "", 16);
iLocal_43=-1;
...
uLocal_44=func_142(iLocal_235, 0, 0);
}
if(func_141(PLAYER::PLAYER_PED_ID(), iLocal_235, 1) > 300f){
func_144();
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_44)){
HUD::CLEAR_PRINTS();
HUD::REMOVE_BLIP(&uLocal_44);
}}}
if((((ENTITY::DOES_ENTITY_EXIST(iLocal_235) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_235, 0)) && ENTITY::IS_ENTITY_IN_AIR(iLocal_235)) && iLocal_239) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("PLANES", 0, -1)){
if(!bLocal_240){
if(PAD::IS_CONTROL_JUST_PRESSED(0, 114)){
if(iLocal_238==-1 || (MISC::GET_GAME_TIMER() - iLocal_238) > 2000){
if(!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_246)){
uLocal_246=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_property_leaflet_drop", iLocal_235, 0f, -2f, -0.65f, 0f, 0f, 0f, 1f, 0, 0, 0);
fLocal_244=0f;
}
if(func_140("LEAFLET")){
HUD::CLEAR_HELP(1);
}
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "PROPERTIES_PLANE_PROMO_MASTER", iLocal_235, 0, 0, 0);
iLocal_238=MISC::GET_GAME_TIMER();
bLocal_240=true;
}}}elseif((MISC::GET_GAME_TIMER() - iLocal_238) > 3000){
bLocal_240=false;
}}elseif(GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_246)){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(uLocal_246, 0);
fLocal_244=0f;
}
if(GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_246)){
if(bLocal_240){
...
fLocal_244=(fLocal_244 + ((fVar2 * timestep()) * 100f));
fLocal_244=func_139(fLocal_244, 0f, 1f);
GRAPHICS::SET_PARTICLE_FX_LOOPED_EVOLUTION(uLocal_246, "spawn", fLocal_244, 0);
}
switch (iLocal_41){
case 0:
STREAMING::REQUEST_MODEL(joaat("stunt"));
if(STREAMING::HAS_MODEL_LOADED(joaat("stunt"))){
iLocal_235=Global_112519.f_222[0];
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_235)){
iLocal_235=VEHICLE::CREATE_VEHICLE(joaat("stunt"), Var0, 121.2244f, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_235, 1084227584);
}else{
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_235, 1, 1);
}
...
func_136(&uLocal_45, 1, 0);
iLocal_41++;
}
break;
case 1:
if(ENTITY::DOES_ENTITY_EXIST(iLocal_235) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_235, 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_235, 0)){
HUD::CLEAR_PRINTS();
...
case 2:
iVar3=0;
while (iVar3 < Local_236.f_0){
if(func_76(&(Local_236[iVar3 /*8*/]))){
iLocal_237++;
}
iVar3++;
}
...
break;
case 3:
if(func_30(&uLocal_45, Local_34, -1067.083f, -2922.601f, 12.82418f, -1091.854f, -2965.403f, 23.94564f, 31.5625f, 1, iLocal_235, "LAND", "", "BK_PLANE", 1, 0, 1, -1) && !ENTITY::IS_ENTITY_IN_AIR(iLocal_235)){
func_136(&uLocal_45, 1, 0);
iLocal_41++;
}
break;
case 4:
if(func_28(iLocal_235, 1093140480, 1, 0f, 0, 1, 0)){
iLocal_41++;
}
break;
case 5:
TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_235, 0);
func_27();
break;
}
switch (iLocal_42){
...
if((10 - iLocal_237) <=0){
iLocal_42++;
}elseif((func_26() && (MISC::GET_GAME_TIMER() - iLocal_43) > 5000) && iLocal_243){
StringCopy(&cVar1, "RAND_", 16);
StringConCat(&cVar1, &cLocal_38, 16);
if(func_25(49) && MISC::GET_RANDOM_INT_IN_RANGE(0, 3)==0){
StringConCat(&cVar1, "M", 16);
}elseif(iLocal_245 > 0){
StringIntConCat(&cVar1, iLocal_245 + 1, 16);
}
if(func_2(&uLocal_70, &cLocal_35, &cVar1, 8, 0, 0, 0)){
iLocal_245++;
if(iLocal_245 >=6){
iLocal_245=0;
}
...
break;
case 1:
if(func_26() && (MISC::GET_GAME_TIMER() - iLocal_43) > 1000){
if(func_2(&uLocal_70, &cLocal_35, "DONE", 8, 0, 0, 0)){
StringCopy(&cVar1, "", 16);
iLocal_42++;
}}
break;
...
int func_30(var uParam0, struct<3> Param1, struct<3> Param2, struct<3> Param3, float fParam4, int iParam5, int iParam6, char* sParam7, char* sParam8, char* sParam9, bool bParam10, int iParam11, bool bParam12, int iParam13){
return func_31(uParam0, Param1, func_75(), Param2, Param3, iParam5, 5, 0, 0, 0, iParam6, sParam7, func_74(), func_74(), func_74(), func_74(), sParam8, 0, bParam10, sParam9, 1, iParam11, bParam12, iParam13, func_74(), func_74(), func_74(), 1, fParam4);
}

int func_31(var uParam0, struct<3> Param1, struct<3> Param2, struct<3> Param3, struct<3> Param4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, char* sParam11, char* sParam12, char* sParam13, char* sParam14, char* sParam15, char* sParam16, bool bParam17, bool bParam18, char* sParam19, bool bParam20, int iParam21, bool bParam22, int iParam23, var uParam24, var uParam25, var uParam26, bool bParam27, var uParam28){
int iVar0;
bool bVar1;
int iVar2;
struct<3> Var3;
...
func_72(uParam0);
func_71();
if(func_54(uParam0, uParam0->f_17[0], uParam0->f_17[1], uParam0->f_17[2], sParam12, sParam13, sParam14, sParam15, uParam0->f_8, bParam17, iParam10, 0, 0, uParam24, uParam25, uParam26, iParam6, bParam18)){
func_53(sParam12);
func_53(sParam13);
func_53(sParam14);
func_53(sParam15);
...
func_44(uParam0->f_17[iVar7], "NEED_A_BIGGER_VEHICLE", 3);
}
...
int func_41(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
...
var func__43(struct<3> Param0, int iParam1){
var uVar0;
...
var func__77(struct<3> Param0, var uParam1, bool bParam2){
var uVar0;
...
var func__79(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
Var0={
...
void func_80(struct<3> Param0, float fParam1, int iParam2, int iParam3){
struct<3> Var0;
var uVar1;
...
if(iParam2==1){
if(func_132(ENTITY::GET_ENTITY_COORDS(Global_104373.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
}}
func_81(Global_104373.f_4, Param0, fParam1, 24, 0);
}}}}


void func_81(int iParam0, struct<3> Param1, var uParam2, int iParam3, bool bParam4){
struct<60> Var0;
...
func_118(iParam3, &Var0, Param1, uParam2, func_124(iParam0));
...
if(!func_115(&(Global_77479.f_555[0 /*21*/]), iParam0)){
return;
}
...
func_126(iParam0, &(Global_113810.f_32752.f_5510));
}

int func_84(int iParam0){
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_102(iParam0, 0, 0)) || func_102(iParam0, 1, 0)) || func_102(iParam0, 2, 0)) || func_124(iParam0) !=145) || func_101(iParam0)) || func_100(iParam0)) || func_99(iParam0)) || func_98(iParam0)) || !func_85(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_100(iParam0)){
}
if(func_100(iParam0)){
}
...
if(!func_125(Global_113810.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
if(!func_125(Global_113810.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
if(!func_125(Global_113810.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
void func_118(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_115(&(Global_77479.f_555[0 /*21*/]), iParam0)){
if(MISC::IS_BIT_SET(Global_77479.f_555[0 /*21*/].f_9, 10)){
func_123(iParam0);
func_122(uParam1, &(Global_113810.f_32752.f_69[Global_77479.f_555[0 /*21*/].f_14 /*78*/]));
...
bool func_125(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_132(struct<3> Param0, int iParam1, var uParam2, var uParam3){
int iVar0;
...
float func_141(int iParam0, int iParam1, int iParam2){
struct<3> Var0;
struct<3> Var1;
...
func_150(2, 1);
func_149(&uLocal_70, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
Local_236[0 /*8*/]={
-1039.556f, -1071.264f, 150f 
};
Local_236[0 /*8*/].f_3=200f;
Local_236[1 /*8*/]={
-1014.976f, 450.128f, 150f 
};
Local_236[1 /*8*/].f_3=200f;
Local_236[2 /*8*/]={
-598.1714f, -310.67f, 150f 
};
Local_236[2 /*8*/].f_3=200f;
Local_236[3 /*8*/]={
-392.5704f, 514.8138f, 150f 
};
Local_236[3 /*8*/].f_3=200f;
Local_236[4 /*8*/]={
127.7632f, -135.7758f, 150f 
};
Local_236[4 /*8*/].f_3=200f;
Local_236[5 /*8*/]={
1033.469f, -570.8278f, 150f 
};
Local_236[5 /*8*/].f_3=200f;
Local_236[6 /*8*/]={
246.5894f, -890.811f, 150f 
};
Local_236[6 /*8*/].f_3=200f;
Local_236[7 /*8*/]={
1231.393f, -1694.348f, 150f 
};
Local_236[7 /*8*/].f_3=200f;
Local_236[8 /*8*/]={
424.9531f, -1904.325f, 150f 
};
Local_236[8 /*8*/].f_3=200f;
Local_236[9 /*8*/]={
-22.4342f, -1414.275f, 160f 
};
Local_236[9 /*8*/].f_3=200f;
iVar0=0;
while (iVar0 <=9){
if(!func_148(Local_236[iVar0 /*8*/])){
fVar1=0f;
MISC::GET_GROUND_Z_FOR_3D_COORD(Local_236[iVar0 /*8*/], &fVar1, 0, 0);
Local_236[iVar0 /*8*/].f_2=fVar1;
}
iVar0++;
}
switch (func_147()){
case 6:
StringCopy(&cLocal_38, "DT", 16);
break;
case 5:
StringCopy(&cLocal_38, "VW", 16);
break;
case 7:
StringCopy(&cLocal_38, "MW", 16);
break;
}
...
if(HUD::DOES_BLIP_EXIST(Local_236[0 /*8*/].f_4)){
HUD::REMOVE_BLIP(&(Local_236[0 /*8*/].f_4));
}
if(HUD::DOES_BLIP_EXIST(Local_236[0 /*8*/].f_5)){
HUD::REMOVE_BLIP(&(Local_236[0 /*8*/].f_5));
}
if(HUD::DOES_BLIP_EXIST(Local_236[1 /*8*/].f_4)){
HUD::REMOVE_BLIP(&(Local_236[1 /*8*/].f_4));
}
if(HUD::DOES_BLIP_EXIST(Local_236[1 /*8*/].f_5)){
HUD::REMOVE_BLIP(&(Local_236[1 /*8*/].f_5));
}
