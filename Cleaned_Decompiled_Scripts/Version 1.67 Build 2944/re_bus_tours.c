...
iLocal_271=7500;
Local_51={
ScriptParam_275.f_1[0 /*3*/] 
};
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_61, 0)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_61, 0)){
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_61, 2.5f, 1.5f, 0f), 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_HEADING(iLocal_61));
...
case 1:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_61, 0)){
if(PED::IS_PED_INJURED(iLocal_55) || PED::IS_PED_INJURED(uLocal_56)){
func_231();
}
else{
iLocal_67=1;
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(!PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_61) && iLocal_50 + 1 < 13){
func_231();
}}
if(!iLocal_72){
if(timera() > 12000){
...
VEHICLE::REQUEST_VEHICLE_HIGH_DETAIL_MODEL(iLocal_61);
}else{
func_3(&uLocal_94, "BUSTOAU", "BUSTO_THANK", "BUSTO_THANK_7", 4, 0, 0);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_61, 3);
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_61, 0);
iLocal_266=1;
}}else{
func_231();
}}
...
}}elseif(CAM::DOES_CAM_EXIST(uLocal_79)){
CAM::DESTROY_CAM(uLocal_79, 0);
CAM::RENDER_SCRIPT_CAMS(0, 0, 0, 1, 0, 0);
ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 1, 0);
}}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_61, 0)){
if(!CAM::DOES_CAM_EXIST(uLocal_79) && !CAM::IS_GAMEPLAY_HINT_ACTIVE()){
if(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_49.f_4, 12f, 12f, 12f, 0, 1, 0)){
CAM::SET_GAMEPLAY_COORD_HINT(Param0, uParam1, 3000, 3000, 0);
func_29(Param0);
iLocal_69=MISC::GET_GAME_TIMER();
}}
if(!PED::IS_PED_INJURED(iLocal_55)){
TASK::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_55, 3f);
}
iLocal_72=1;
}}
...
iVar0=0;
while (iVar0 < 5){
if(!PED::IS_PED_INJURED(uLocal_57[iVar0])){
iVar1=MISC::GET_RANDOM_INT_IN_RANGE(6000, 16000);
iLocal_58[iVar0]=MISC::GET_RANDOM_INT_IN_RANGE(0, 2000);
iLocal_60[iVar0]=0;
}
iVar0++;
}}
...
func_32();
iVar8=floor((PAD::GET_CONTROL_UNBOUND_NORMAL(2, 218) * 127f));
iVar9=floor((PAD::GET_CONTROL_UNBOUND_NORMAL(2, 219) * 127f));
iVar10=floor((PAD::GET_CONTROL_UNBOUND_NORMAL(2, 220) * 127f));
iVar11=floor((PAD::GET_CONTROL_UNBOUND_NORMAL(2, 221) * 127f));
...
func_31(PLAYER::PLAYER_PED_ID(), &uLocal_79, fLocal_93, 0f, fLocal_92);
CAM::SET_CAM_FOV(uLocal_79, fVar1);
CAM::ATTACH_CAM_TO_ENTITY(uLocal_79, PLAYER::PLAYER_PED_ID(), Var7.f_0, (Var7.f_1 - 1f), (Var7.f_2 + 1f), 1);
}else{
uLocal_79=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
CAM::ATTACH_CAM_TO_ENTITY(uLocal_79, PLAYER::PLAYER_PED_ID(), Var7.f_0, (Var7.f_1 - 1f), (Var7.f_2 + 1f), 1);
CAM::SET_CAM_NEAR_CLIP(uLocal_79, 0.01f);
fLocal_92=-70f;
fLocal_93=3f;
func_31(PLAYER::PLAYER_PED_ID(), &uLocal_79, fLocal_93, 0f, fLocal_92);
CAM::SET_CAM_FOV(uLocal_79, fVar1);
...
struct<3> Var0;
int iVar1;
if(!PED::IS_PED_INJURED(uLocal_57[2])){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_57[2], joaat("script_task_look_at_coord"))==7){
if(MISC::GET_GAME_TIMER() > iLocal_87 + 8000){
PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(uLocal_57[2], 0);
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_57[2], MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f), 0.5f) 
};
iVar1=MISC::GET_RANDOM_INT_IN_RANGE(1000, 6000);
TASK::TASK_LOOK_AT_COORD(uLocal_57[2], Var0, iVar1, 2049, 2);
...
int iVar0;
iVar0=iLocal_50 + 1;
if(!iLocal_90 && CAM::IS_SCREEN_FADED_IN()){
HUD::DISPLAY_HELP_TEXT_THIS_FRAME("Tour_help", 0);
}
if(iVar0 < 14){
if(PAD::IS_CONTROL_JUST_PRESSED(2, 223) || iLocal_71==1){
...
TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_61, 120.8878f, 239.3244f, 106.5131f, 3f, 0, joaat("tourbus"), iLocal_262, 5f, 15f);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_61, Local_49.f_1, 3f, 0, joaat("tourbus"), iLocal_262, 3f, 15f);
TASK::CLOSE_SEQUENCE_TASK(uLocal_77);
TASK::TASK_PERFORM_SEQUENCE(iLocal_55, uLocal_77);
...
ENTITY::SET_ENTITY_COORDS(iLocal_61, Param0.f_0, Param0.f_1, Param0.f_2, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_61, fParam1);
VEHICLE::SET_VEHICLE_FORWARD_SPEED(iLocal_61, 0f);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_55, iLocal_61, ENTITY::GET_ENTITY_COORDS(iLocal_61, 1), 0f, 0, joaat("tourbus"), iLocal_262, 5f, 15f);
func_39(Param0, 1112014848, 12, 5000, 0, 0);
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_61, 0)){
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_61, 1084227584);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_61, 1, 1, 0);
if(iVar0 < 13){
if(!PED::IS_PED_INJURED(iLocal_55)){
TASK::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_55, iLocal_61, Local_48[iVar0 /*15*/].f_1, Local_48[iVar0 /*15*/].f_8, 0, joaat("tourbus"), iLocal_262, 5f, 15f);
}}elseif(!PED::IS_PED_INJURED(iLocal_55)){
TASK::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_55, iLocal_61, Local_49.f_1, Local_48[iVar0 /*15*/].f_8, 0, joaat("tourbus"), iLocal_262, 5f, 15f);
}
VEHICLE::SET_VEHICLE_FORWARD_SPEED(iLocal_61, 8f);
}
func_37();
...
if(iVar0==13){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_48[iVar0 /*15*/].f_1, 30f, 30f, 15f, 0, 1, 0)){
...
elseif(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_48[iVar0 /*15*/].f_1, 40f, 40f, 12f, 0, 1, 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_61, 0)){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_61, 0)){
if(iVar1 <=13){
func_86(ENTITY::GET_ENTITY_COORDS(iLocal_61, 1), Local_48[iVar1 /*15*/].f_1, &Local_75, &Local_76, 500);
}
if(PATHFIND::ARE_NODES_LOADED_FOR_AREA(Local_75.f_0, Local_75.f_1, Local_76.f_0, Local_76.f_1)){
if((iLocal_68 - iLocal_69) > 0){
if(func_85(&uLocal_94, "BUSTOAU", Local_48[iLocal_50 /*15*/], 4, 0, 0, 0)){
if(iVar1 <=13){
if(iVar1==11){
TASK::OPEN_SEQUENCE_TASK(&uVar2);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_61, -100.461f, -206.1412f, 44.4215f, Local_48[iVar1 /*15*/].f_8, 0, joaat("tourbus"), iLocal_262, 4f, 15f);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_61, Local_48[iVar1 /*15*/].f_1, Local_48[iVar1 /*15*/].f_8, 0, joaat("tourbus"), iLocal_262, 4f, 15f);
TASK::CLOSE_SEQUENCE_TASK(uVar2);
TASK::TASK_PERFORM_SEQUENCE(iLocal_55, uVar2);
TASK::CLEAR_SEQUENCE_TASK(&uVar2);
}
else{
TASK::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_55, iLocal_61, Local_48[iVar1 /*15*/].f_1, Local_48[iVar1 /*15*/].f_8, 0, joaat("tourbus"), iLocal_262, 4f, 15f);
}}
iLocal_69=MISC::GET_GAME_TIMER();
...
if(!PED::IS_PED_INJURED(iLocal_55)){
TASK::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_55, 15f);
}
iLocal_46=0;
}}}
break;
...
iVar0=0;
while (iVar0 < 5){
if((MISC::GET_GAME_TIMER() - iLocal_59) > iLocal_58[iVar0] && iLocal_60[iVar0]==0){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_57[iVar0], 0)){
TASK::TASK_LOOK_AT_COORD(uLocal_57[iVar0], Param0, 20000, 2050, 4);
}
iLocal_60[iVar0]=1;
}
iVar0++;
...
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 0);
GRAPHICS::SET_EXPOSURETWEAK(1);
uLocal_80=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 93.8459f, 251.8829f, 110.4535f, 23.0883f, 0.101f, -61.7699f, 40f, 1, 2);
uLocal_81=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 97.0995f, 249.7653f, 109.0195f, -3f, 0f, -91.5944f, 50f, 1, 2);
CAM::SET_CAM_ACTIVE(uLocal_80, 1);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_81, uLocal_80, 17000, 1, 1);
func_85(&uLocal_94, "BUSTOAU", "BUSTO_THANK", 4, 0, 0, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_61, Local_49.f_1, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_61, Local_49.f_13);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_61, 1084227584);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_61, 3);
if(!PED::IS_PED_INJURED(iLocal_55)){
TASK::CLEAR_PED_TASKS(iLocal_55);
TASK::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_55, 0f);
TASK::OPEN_SEQUENCE_TASK(&uLocal_77);
TASK::TASK_VEHICLE_TEMP_ACTION(0, iLocal_61, 24, 10000);
TASK::CLOSE_SEQUENCE_TASK(uLocal_77);
TASK::TASK_PERFORM_SEQUENCE(iLocal_55, uLocal_77);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_77);
}
...
iLocal_86=0;
while (iLocal_86 < 5){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_57[iLocal_86])){
if(!PED::IS_PED_INJURED(uLocal_57[iLocal_86])){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_57[iLocal_86]);
ENTITY::SET_ENTITY_HEADING(uLocal_57[iLocal_86], fVar0[iLocal_86]);
ENTITY::SET_ENTITY_COORDS(uLocal_57[iLocal_86], Var1[iLocal_86 /*3*/], 1, 0, 0, 1);
TASK::TASK_WANDER_STANDARD(uLocal_57[iLocal_86], 1193033728, 0);
}}
iLocal_86++;
}
iLocal_69=MISC::GET_GAME_TIMER();
...
*uParam4={
*uParam4 - Vector(IntToFloat(iParam6), IntToFloat(iParam6), IntToFloat(iParam6)) 
};
*uParam5={
*uParam5 + Vector(IntToFloat(iParam6), IntToFloat(iParam6), IntToFloat(iParam6)) 
};
iLocal_73=1;
}}
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uLocal_57[iLocal_269], sVar1, "SPEECH_PARAMS_FORCE", 1);
iLocal_270++;
if(iLocal_270==3){
iLocal_268=0;
}
iLocal_271=MISC::GET_RANDOM_INT_IN_RANGE(9000, 14000);
iLocal_69=MISC::GET_GAME_TIMER();
}
iLocal_269++;
if(iLocal_269==5){
iLocal_269=0;
}}}elseif(iLocal_259 < 14){
iLocal_68=MISC::GET_GAME_TIMER();
...
int func_89(){
if(PAD::IS_CONTROL_JUST_PRESSED(2, 222) && !iLocal_267){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_61)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_61, 0)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_61, 0)){
if(!PED::IS_PED_INJURED(iLocal_55)){
TASK::TASK_VEHICLE_TEMP_ACTION(iLocal_55, iLocal_61, 24, 5000);
fLocal_63=ENTITY::GET_ENTITY_SPEED(iLocal_61);
while (fLocal_63 > 5f){
wait(0);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_61, 0)){
fLocal_63=ENTITY::GET_ENTITY_SPEED(iLocal_61);
...
func_35();
CAM::SET_FOLLOW_VEHICLE_CAM_ZOOM_LEVEL(iLocal_261);
PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(PLAYER::PLAYER_PED_ID(), 1);
AUDIO::STOP_AUDIO_SCENE("RE_BUS_TOUR_SCENE");
AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_61, 0);
if(CAM::DOES_CAM_EXIST(uLocal_79)){
...
TASK::TASK_LEAVE_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_61, 0);
}}}}}
return 1;
}
return 0;
...
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_61, "RE_BUS_TOUR_BUS_VEHICLE", 0);
PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(PLAYER::PLAYER_PED_ID(), 0);
func_74(1, 1, 1, 0, 0, 0, 0);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 256);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
MISC::CLEAR_AREA_OF_PROJECTILES(Local_49.f_1, 30f, 0);
PED::SET_PED_CAN_BE_DRAGGED_OUT(iLocal_55, 0);
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_61, 2);
MISC::SET_MINIGAME_IN_PROGRESS(1);
HUD::DISPLAY_RADAR(0);
uLocal_80=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 94.5693f, 246.0525f, 108.9809f, -11.5369f, 0f, -74.512f, 40f, 1, 2);
uLocal_81=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 95.7144f, 243.8854f, 111.291f, -26.2154f, 0f, -59.2407f, 50f, 1, 2);
CAM::SET_CAM_ACTIVE(uLocal_80, 1);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_81, uLocal_80, 6500, 1, 1);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), iLocal_61, 8f, 8f, 5f, 0, 1, 0)){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_61, 0)){
func_86(ENTITY::GET_ENTITY_COORDS(iLocal_61, 1), Local_48[0 /*15*/].f_1, &Local_75, &Local_76, 500);
...
if((MISC::GET_GAME_TIMER() - iLocal_273) > 5000 && !iLocal_272){
...
if((MISC::GET_GAME_TIMER() - iLocal_273) > 6200){
if(iLocal_74==1){
if(iLocal_274==0){
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if((PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_61) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_56, iLocal_61)) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_55, iLocal_61)){
iLocal_47=2;
}elseif(func_83(1000)){
if(VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_61, 0, 0)){
PED::SET_PED_INTO_VEHICLE(iLocal_56, iLocal_61, 0);
}
iLocal_47=2;
}}
break;
case 2:
TASK::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_55, iLocal_61, Local_48[0 /*15*/].f_1, Local_48[0 /*15*/].f_8, 0, joaat("tourbus"), iLocal_262, 5f, 15f);
CAM::SET_CAM_ACTIVE(uLocal_80, 0);
...
iLocal_261=CAM::GET_FOLLOW_VEHICLE_CAM_ZOOM_LEVEL();
if(!iLocal_74){
CAM::SET_FOLLOW_VEHICLE_CAM_ZOOM_LEVEL(3);
}else{
func_27(1);
...
}}elseif(MISC::IS_BIT_SET(Global_113810.f_20567.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_100() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_100() /*5568*/].f_681.f_10, iParam0);
}
...
TASK::TASK_ENTER_VEHICLE(iLocal_56, iLocal_61, 10000, 0, 2f, 262144, 0);
...
if((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_61, 5f, 5f, 5f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_126("TX_H02")){
if(func_157()){
if(!iLocal_264){
...
TASK::TASK_ENTER_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_61, -1, 2, 1f, 8, 0);
}
if(!HUD::DOES_BLIP_EXIST(uLocal_65)){
if(HUD::DOES_BLIP_EXIST(uLocal_66)){
HUD::REMOVE_BLIP(&uLocal_66);
}
uLocal_65=HUD::ADD_BLIP_FOR_ENTITY(iLocal_61);
HUD::SET_BLIP_AS_FRIENDLY(uLocal_65, 1);
HUD::SET_BLIP_SCALE(uLocal_65, Global_32330);
if(!PED::IS_PED_INJURED(iLocal_56)){
TASK::TASK_LOOK_AT_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
}
if(!func_156()){
if(func_144()){
func_231();
...
if(iLocal_264){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_61, 2);
iLocal_264=0;
}}}}
if(iLocal_86 < 5){
...
char* sVar0;
*uParam0=0;
if(PED::GET_CLOSEST_PED(Local_51, 100f, 1, 0, uParam0, 0, 0, 28)){
if(!PED::IS_PED_INJURED(*uParam0)){
if(func_131(*uParam0)){
...
case 0:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_61, 0)){
PED::SET_PED_INTO_VEHICLE(*uParam0, iLocal_61, 3);
PED::SET_PED_KEEP_TASK(*uParam0, 1);
}
break;
case 1:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_61, 0)){
PED::SET_PED_INTO_VEHICLE(*uParam0, iLocal_61, 7);
PED::SET_PED_KEEP_TASK(*uParam0, 1);
}
break;
case 2:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_61, 0)){
PED::SET_PED_INTO_VEHICLE(*uParam0, iLocal_61, 6);
PED::SET_PED_KEEP_TASK(*uParam0, 1);
}
break;
case 3:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_61, 0)){
PED::SET_PED_INTO_VEHICLE(*uParam0, iLocal_61, 8);
PED::SET_PED_KEEP_TASK(*uParam0, 1);
}
break;
case 4:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_61, 0)){
PED::SET_PED_INTO_VEHICLE(*uParam0, iLocal_61, 1);
PED::SET_PED_KEEP_TASK(*uParam0, 1);
}
break;
}
...
if(PED::GET_VEHICLE_PED_IS_ENTERING(PLAYER::PLAYER_PED_ID())==iLocal_61){
return 1;
}}}}
return 0;
}
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(vmag2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_151()){
return 0;
}}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_167()) || Global_112857) || Global_32286) || func_166()) || func_23(8, -1)) || func_165()) || func_164()) || func_163()) || func_162()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_167()) || Global_32286) || func_166()) || func_23(8, -1)) || func_163()) || func_165()) || func_164()) || func_162()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_167()) || Global_112857) || Global_32286) || func_166()) || func_23(8, -1)) || func_165()) || func_164()) || func_162()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_167()) || Global_32286) || func_166()) || func_23(8, -1)) || func_164()) || func_163()) || func_162()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
}
break;
...
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_167()) || Global_112857) || Global_32286) || func_166()) || func_23(8, -1)) || func_163()) || func_161()) || func_165()) || func_164()) || func_162()){
return 0;
}
break;
}}else{
...
if(!PED::IS_PED_INJURED(iLocal_55)){
if(((func_173(iLocal_55) || !PED::IS_PED_IN_ANY_VEHICLE(iLocal_55, 0)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_55)) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_55)){
func_169(iLocal_56);
return 1;
}}else{
func_169(iLocal_56);
...
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_61, 220f, 220f, 30f, 0, 1, 0)){
return 1;
}
return 0;
}
...
void func_170(){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 40f, 40f, 5f, 0, 1, 0)){
iLocal_68=MISC::GET_GAME_TIMER();
if((iLocal_68 - iLocal_69) > 10000){
if(!func_91()){
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_172(iParam2), 1);
}
...
if(func_174(uParam0, &uLocal_88, &uLocal_85, uLocal_83, bLocal_89, 1077936128, 0) || PED::IS_PED_RAGDOLL(uParam0)){
func_169(uParam0);
return 1;
}
return 0;
...
void func_184(){
if(iLocal_73){
PATHFIND::REQUEST_PATH_NODES_IN_AREA_THIS_FRAME(Local_75.f_0, Local_75.f_1, Local_76.f_0, Local_76.f_1);
}}
...
if((((STREAMING::HAS_MODEL_LOADED(iVar0) && STREAMING::HAS_MODEL_LOADED(iVar1)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_260)) && STREAMING::HAS_MODEL_LOADED(joaat("tourbus"))) && HUD::HAS_ADDITIONAL_TEXT_LOADED(2)){
AUDIO::REGISTER_SCRIPT_WITH_AUDIO(0);
PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(Local_51, &uLocal_52, &uLocal_62, 1, 1077936128, 0);
iLocal_61=VEHICLE::CREATE_VEHICLE(joaat("tourbus"), Local_49.f_1, Local_49.f_13, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_61, 1084227584);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_61, 3);
ENTITY::SET_CAN_CLIMB_ON_ENTITY(iLocal_61, 0);
AUDIO::SET_VEH_RADIO_STATION(iLocal_61, "OFF");
VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_61, 0, 0);
VEHICLE::SET_VEHICLE_EXTRA(iLocal_61, 2, 1);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("tourbus"), 1);
VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(iLocal_61, 100f);
iLocal_55=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_61, 26, iVar1, -1, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_55, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_55, 251, 1);
PED::SET_PED_STAY_IN_VEHICLE_WHEN_JACKED(iLocal_55, 1);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_55)){
if(!PED::IS_PED_INJURED(iLocal_55)){
PED::SET_PED_COMPONENT_VARIATION(iLocal_55, 3, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_55, 4, 0, 2, 0);
}}
iLocal_56=PED::CREATE_PED(26, iVar0, 102.9893f, 248.5367f, 107.1759f, 329f, 1, 1);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_56, "A_F_M_BEVHILLS_02_WHITE_FULL_02");
...
PED::SET_PED_COMPONENT_VARIATION(iLocal_56, 4, 1, 0, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_78);
TASK::TASK_PLAY_ANIM(0, sLocal_260, "IDLE_A", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_260, "IDLE_B", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_260, "IDLE_C", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_78, 1);
...
if(!HUD::DOES_BLIP_EXIST(uLocal_66)){
uLocal_66=HUD::ADD_BLIP_FOR_ENTITY(iLocal_61);
HUD::SET_BLIP_SPRITE(uLocal_66, 85);
}
func_187();
iLocal_44=1;
}}}
...
PED::ADD_RELATIONSHIP_GROUP("re_bus_tours1", &uLocal_64);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_55, uLocal_64);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_56, uLocal_64);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_64, joaat("player"));
}
...
if(!func_224(Global_113810.f_24998.f_43[iParam1])){
return 0;
}
...
return (shift_right(iParam0, 26) & 31 * func_211(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_55)){
if(!PED::IS_PED_INJURED(iLocal_55)){
PED::SET_PED_CONFIG_FLAG(iLocal_55, 251, 0);
PED::SET_PED_CAN_BE_DRAGGED_OUT(iLocal_55, 1);
...
iVar0=0;
while (iVar0 < 5){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_57[iVar0])){
if(func_181(uLocal_57[iVar0])){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_57[iVar0], 0);
}
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_57[iVar0]));
}
iVar0++;
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_61)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_61, 1);
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_61, 1);
