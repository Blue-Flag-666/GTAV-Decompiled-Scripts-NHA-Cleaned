...
Var1={
ENTITY::GET_ENTITY_COORDS(uLocal_40, 1) 
};
...
break;
case 2:
if(!func_4(iLocal_40, joaat("script_task_smart_flee_ped")) && !PED::IS_PED_FLEEING(iLocal_40)){
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_40, func_11(), func_3(), 3)){
func_1();
}}else{
func_56();
}
...
func_2(&iLocal_40);
TASK::TASK_SMART_FLEE_PED(iLocal_40, PLAYER::PLAYER_PED_ID(), 10000f, -1, 0, 0);
...
if(func_51(iLocal_40)){
if(!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_40)){
...
char* func_21(){
if(MISC::IS_BIT_SET(Global_113810.f_24989, 3)){
return "BB4_loiter";
}elseif(MISC::IS_BIT_SET(Global_113810.f_24989, 2)){
return "BB3_loiter";
}elseif(MISC::IS_BIT_SET(Global_113810.f_24989, 1)){
return "BB2_loiter";
}elseif(MISC::IS_BIT_SET(Global_113810.f_24989, 0)){
return "BB1_loiter";
}
return "MAUDE_loiter";
}
...
if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_37)){
return 1;
}}
...
if(MISC::GET_GAME_TIMER() - iLocal_41) > (iParam2 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000)){
uVar0=16;
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_40, 1);
PED::SET_PED_MONEY(iLocal_40, 0);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_40, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_40, joaat("player"));
TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_40, 0);
TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_40, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_40, 118, 0);
Var0={
2728.33f, 4145.6f, 43.89f 
};
if(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Var0, 10f, joaat("prop_table_03b"), 0)){
iLocal_38=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Var0, 10f, joaat("prop_table_03b"), 1, 0, 1);
if(func_8(iLocal_38)){
ENTITY::SET_ENTITY_COORDS(iLocal_38, 2727.4f, 4145.56f, 43.68f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_38, -92.17f);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_38, 1);
}}
if(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Var0, 10f, joaat("prop_laptop_01a"), 0)){
iLocal_39=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Var0, 10f, joaat("prop_laptop_01a"), 0, 0, 1);
if(func_8(iLocal_39)){
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_39)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_39, 1, 0);
}
ENTITY::SET_ENTITY_COORDS(iLocal_39, 2727.686f, 4145.715f, 44.08f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_39, 71f);
...
iLocal_37=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Var0, 10f, joaat("prop_table_03_chr"), 0, 0, 1);
if(func_8(iLocal_37)){
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_37)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_37, 1, 0);
}
ENTITY::SET_ENTITY_COORDS(iLocal_37, 2728.35f, 4145.59f, 43.3f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_37, -91.28f);
}}}}
...
func_58(&iLocal_38, 0);
if(func_8(iLocal_37)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_37, 0);
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_37, "special_ped@maude@base", "base_chair", 3)){
ENTITY::STOP_ENTITY_ANIM(iLocal_37, "base_chair", "special_ped@maude@base", -1000f);
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_37, -1000f, 1);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_37, func_11(), "Female_Flee_Table_Left_Maude_Chair", 3)){
ENTITY::STOP_ENTITY_ANIM(iLocal_37, "Female_Flee_Table_Left_Maude_Chair", func_11(), -1000f);
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_37, -1000f, 1);
}}
func_58(&iLocal_37, 0);
if(func_51(iLocal_40)){
PED::SET_PED_KEEP_TASK(iLocal_40, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_40, 118, 1);
}
