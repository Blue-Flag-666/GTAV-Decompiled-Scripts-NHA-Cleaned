...
Global_78935=1;
iLocal_35=0;
while (!func_273(&Local_37)){
wait(0);
}
func_272(&Local_37, 0, 1);
Global_78935=0;
}
func_271(1, 1, 1, 1);
while (true){
...
func_254(Local_37.f_9, 0, 0, 0, 0, 0);
switch (iLocal_38){
case 0:
func_252();
break;
...
switch (iLocal_39){
case 0:
func_45(&uLocal_58, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
if(func_29(iLocal_57) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_57, 1)){
...
case 0:
func_220(23, 1);
uLocal_224=Global_32534;
Global_32534=0;
func_219("SCRAP_2_RCM", 0);
if(func_210(1, 1093140480, 0)){
if(func_29(Local_37.f_28[0])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_37.f_28[0], sLocal_43, 0, 0, 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Franklin", 0, 0, 0);
}
if(func_29(uLocal_46[2])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_46[2], sLocal_45[2], 1, 0, 0);
}
if(func_29(uLocal_46[0])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_46[0], sLocal_45[0], 0, 0, 0);
}
if(func_29(uLocal_46[1])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_46[1], sLocal_45[1], 0, 0, 0);
}
if(func_29(PLAYER::PLAYER_PED_ID())){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), sLocal_44, 0, 0, 0);
}
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_48, sLocal_47, 2, joaat("p_cs_saucer_01_s"), 0);
func_202();
...
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_45[0], 0)){
ENTITY::FREEZE_ENTITY_POSITION(uLocal_46[0], 1);
}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_45[1], 0)){
ENTITY::FREEZE_ENTITY_POSITION(uLocal_46[1], 1);
}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_44, 0)){
PED::FORCE_PED_MOTION_STATE(PLAYER::PLAYER_PED_ID(), joaat("MotionState_Idle"), 1, 0, 1);
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_48)){
if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_47, 0))){
iLocal_48=ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_47, 0));
}}elseif(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_47, 0)){
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_49) && STREAMING::HAS_MODEL_LOADED(iLocal_52)){
iLocal_49=OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_52, Local_50, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_49, Local_51, 2, 0);
}
func_48(18, 0);
func_220(23, 0);
Global_32534=uLocal_224;
iLocal_39=2;
}
break;
case 2:
...
if(!func_182(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_64, Global_113810.f_2366.f_539[iVar0 /*65*/].f_63)){
...
if(!func_182(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_61, Global_113810.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3==1){
...
var func__111(int iParam0, var uParam1){
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_75(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_75(iParam1))){
return 1;
}
return 0;
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_189(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
Vector3 func__200(struct<3> Param0){
float fVar0;
float fVar1;
fVar0=vmag(Param0);
if(fVar0 !=0f){
...
func_243();
if(func_223()){
if(MISC::GET_GAME_TIMER() < iLocal_42 && !func_222(PLAYER::PLAYER_PED_ID(), Local_37.f_28[0], 5f, 1)){
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_37.f_28[0], 0f, 0f, 0f, 1, 2000, 2500, 2000, 0);
...
func_47(4);
return 0;
}elseif(PED::IS_PED_INJURED(Local_37.f_28[0]) || PED::IS_PED_RAGDOLL(Local_37.f_28[0])){
iLocal_40=2;
func_47(4);
return 0;
}elseif(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(func_225(Local_37.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_224(PLAYER::PLAYER_PED_ID(), Local_37.f_28[0], 1)){
...
if(func_216(iParam0) && PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0)){
if(func_216(uParam1)){
...
if(bParam4){
return 0;
}elseif(func_226(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
uVar0=func_229(&(Local_33[iVar2 /*4*/]), Var1, iParam1, &(Local_33[iVar2 /*4*/].f_3), iParam0, iParam5);
...
float fVar2;
Var0={
func_200(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var1={
func_200(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
float fVar2;
Var0={
func_200(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
if(fParam2 < 0.1f || fParam2 > 360f){
return 1;
}
...
uLocal_56=INTERIOR::GET_INTERIOR_AT_COORDS(ENTITY::GET_ENTITY_COORDS(Local_37.f_35[0], 1));
if(INTERIOR::IS_VALID_INTERIOR(uLocal_56)){
INTERIOR::PIN_INTERIOR_IN_MEMORY(uLocal_56);
iLocal_53=1;
}}}elseif(!iLocal_54){
if(INTERIOR::IS_INTERIOR_READY(uLocal_56)){
iLocal_54=1;
}}elseif(!iLocal_55){
if(func_29(Local_37.f_35[0])){
Var0={
ENTITY::GET_ENTITY_COORDS(Local_37.f_35[0], 1) 
};
uVar1=ENTITY::GET_ENTITY_HEADING(Local_37.f_35[0]);
func_38(&(Local_37.f_35[0]));
Local_37.f_35[0]=VEHICLE::CREATE_VEHICLE(joaat("dune2"), Var0, uVar1, 1, 1, 0);
INTERIOR::UNPIN_INTERIOR(uLocal_56);
iLocal_55=1;
}}}
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_217(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
STREAMING::REQUEST_MODEL(iLocal_52);
if(func_223()){
...
if(func_216(PLAYER::PLAYER_PED_ID()) && func_216(Local_37.f_28[0])){
uLocal_41=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_37.f_28[0], uLocal_41);
}
iLocal_42=MISC::GET_GAME_TIMER() + 3500;
func_253();
func_47(1);
}}}
...
void func_253(){
uLocal_46[0]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2333.23f, 2574.97f, 47.03f, 5f, joaat("prop_ch3_01_trlrdoor_l"), 1, 0, 1);
uLocal_46[1]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2329.65f, 2576.64f, 47.03f, 5f, joaat("prop_ch3_01_trlrdoor_r"), 1, 0, 1);
...
Var4={
func_257(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
void func_274(var uParam0, int iParam1, struct<3> Param2, float fParam3){
func_38(uParam0);
...
int func_276(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_20(iParam1)){
...
func_292(13, floor(Global_113810.f_10197.f_3853));
}
...
func_320(&uVar1, Var0.f_3, Global_100870, iParam1, iParam2);
}}
...
}elseif(MISC::IS_PS3_VERSION() || func_325()){
