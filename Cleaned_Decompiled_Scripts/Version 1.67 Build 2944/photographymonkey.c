...
iLocal_57=MISC::IS_BIT_SET(Global_8371, 28);
if(iLocal_46 !=-1){
if(fVar0 < fLocal_44){
Var1={
Local_53 
...
bVar8=((((GRAPHICS::IS_TRACKED_POINT_VISIBLE(iLocal_47) && GRAPHICS::IS_TRACKED_POINT_VISIBLE(iLocal_48)) && GRAPHICS::IS_TRACKED_POINT_VISIBLE(iLocal_49)) && GRAPHICS::IS_TRACKED_POINT_VISIBLE(iLocal_50)) && GRAPHICS::IS_TRACKED_POINT_VISIBLE(iLocal_51));
iVar9++;
wait(0);
}
if(bVar8){
...
func_13(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_13(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_13(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
iVar10=(iParam1 - iParam2);
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_25(iParam0));
if(iVar11 > iVar10){
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_25(iParam2));
...
return MISC::IS_BIT_SET(Global_113810.f_10052.f_135[iVar0], uVar1);
}
...
func_96(iParam0, &iVar0, &uVar1);
if(bParam1){
MISC::SET_BIT(&(Global_113810.f_10052.f_135[iVar0]), uVar1);
}else{
...
fVar7=(fVar4 / 2f);
Var8={
func_102(func_103(Var2, 0f, 0f, -1f)) 
};
Var9={
func_102(func_103(Var2, Var8)) 
};
*uParam1={
Var1 + Vector(fVar6, fVar6, fVar6) * Var8 + Vector(fVar7, fVar7, fVar7) * Var9 + Var2 * Vector(fVar5, fVar5, fVar5) 
};
*uParam2={
Var1 + Vector(fVar6, fVar6, fVar6) * -Var8 + Vector(fVar7, fVar7, fVar7) * Var9 + Var2 * Vector(fVar5, fVar5, fVar5) 
};
...
Vector3 func__102(struct<3> Param0){
float fVar0;
fVar0=vmag(Param0);
...
Vector3 func__103(struct<3> Param0, struct<3> Param1){
...
while (iVar0 < 50){
if(!func_95(iVar0)){
fVar3=vdist2(Var2, Local_52[iVar0 /*8*/]);
...
return Global_113810.f_10052.f_135[iVar0]==(round(pow(2f, to_float(iVar1 + 1))) - 1);
}


void func_108(){
if(bLocal_56){
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_55)){
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_55, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
}
switch (iLocal_54){
case 0:
iLocal_58=MISC::GET_GAME_TIMER() + 2000;
iLocal_54++;
break;
case 1:
if(iLocal_58 < MISC::GET_GAME_TIMER()){
if(!func_114()){
uLocal_55=GRAPHICS::REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
iLocal_58=MISC::GET_GAME_TIMER() + 5000;
iLocal_54++;
}}
break;
case 2:
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_55) || iLocal_58 < MISC::GET_GAME_TIMER()){
if(iLocal_58 < MISC::GET_GAME_TIMER()){
bLocal_56=false;
iLocal_54=0;
}else{
...
break;
case 3:
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_55, "SHOW_BRIDGES_KNIVES_PROGRESS");
func_113("PM_TITLE");
...
iLocal_58=MISC::GET_GAME_TIMER() + 7500;
AUDIO::PLAY_SOUND_FRONTEND(-1, "UNDER_THE_BRIDGE", "HUD_AWARDS", 1);
iLocal_54++;
break;
case 4:
if((((((iLocal_58 < MISC::GET_GAME_TIMER() || CAM::IS_SCREEN_FADED_OUT()) || !PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || func_114()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || func_112()) || func_111()){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_55, "SHARD_ANIM_OUT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(0.33f);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
iLocal_58=MISC::GET_GAME_TIMER() + 500;
iLocal_54++;
}
break;
case 5:
