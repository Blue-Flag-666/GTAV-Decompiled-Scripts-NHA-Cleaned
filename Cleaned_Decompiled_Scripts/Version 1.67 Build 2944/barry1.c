...
if(MISC::ARE_STRINGS_EQUAL(sLocal_95, "B1_FAIL3")){
func_566("B1_FAIL3", 1);
...
PLAYER::SET_PLAYER_HEALTH_RECHARGE_MULTIPLIER(PLAYER::GET_PLAYER_INDEX(), fLocal_109);
PLAYER::SET_PLAYER_WEAPON_DAMAGE_MODIFIER(PLAYER::GET_PLAYER_INDEX(), fLocal_108);
if(func_9()){
func_1();
}
wait(0);
...
void func_1(){
bool bVar0;
bVar0=func_8(PLAYER::PLAYER_PED_ID(), Local_104, 1) < (fLocal_105 + 10f);
if(iLocal_111){
if(bVar0==0 && bLocal_475==0){
func_7("B1_WARN", 7500, 1);
func_6(&uLocal_113);
uLocal_113=func_5(Local_104, 5, 1);
iLocal_112=MISC::GET_GAME_TIMER() + 10000;
func_3(0);
iLocal_111=0;
}}elseif(func_8(PLAYER::PLAYER_PED_ID(), Local_104, 1) > fLocal_105){
if(MISC::GET_GAME_TIMER() > iLocal_112 && bLocal_475==0){
func_2("B1_FAIL");
}}else{
...
func_544();
}elseif(MISC::ARE_STRINGS_EQUAL(sLocal_95, "B1_FAIL")){
if(func_13(0) && func_511(0)){
func_544();
}}elseif(MISC::ARE_STRINGS_EQUAL(sLocal_95, "B1_FAIL2")){
func_11();
}
break;
}}
...
void func_11(){
if(MISC::GET_GAME_TIMER() > iLocal_94 && iLocal_94 !=-1){
...
TASK::TASK_PLAY_ANIM(0, sLocal_254, sLocal_268, 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_254, sLocal_269, 8f, -8f, -1, 1, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar2);
TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar2);
TASK::CLEAR_SEQUENCE_TASK(&uVar2);
}
uVar3=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", CAM::GET_GAMEPLAY_CAM_COORD(), CAM::GET_GAMEPLAY_CAM_ROT(2), CAM::GET_GAMEPLAY_CAM_FOV(), 1, 2);
Var0={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - CAM::GET_GAMEPLAY_CAM_COORD() 
};
CAM::ATTACH_CAM_TO_ENTITY(uVar3, PLAYER::PLAYER_PED_ID(), -Var0, 1);
if(CAM::DOES_CAM_EXIST(uVar3)){
CAM::SET_CAM_ACTIVE(uVar3, 1);
}
iLocal_94=MISC::GET_GAME_TIMER() + 6000;
func_41(&uLocal_306, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
iLocal_97=2;
break;
case 2:
bVar1=false;
if(iParam0==1){
if(func_40(&uLocal_306, "BARY1AU", "BARY1_PREOUT", 8, 0, 0, 0) || MISC::GET_GAME_TIMER() > iLocal_94){
if(MISC::GET_GAME_TIMER() < iLocal_94){
}
iLocal_94=MISC::GET_GAME_TIMER() + 4500;
bVar1=true;
}}elseif(func_17(&uLocal_306, "BARY1AU", "BARY1_PREOUT", "BARY1_PREOUT_2", 8, 0, 0) || MISC::GET_GAME_TIMER() > iLocal_94){
...
if(MISC::GET_GAME_TIMER() > iLocal_94){
func_16();
GRAPHICS::ANIMPOSTFX_PLAY(sLocal_253, 0, 0);
...
if(func_12(iLocal_99) && ENTITY::IS_ENTITY_ATTACHED(iLocal_99)){
ENTITY::DETACH_ENTITY(iLocal_99, 1, 0);
}}
bVar1=true;
}
...
func_14(&iLocal_99);
if(CAM::DOES_CAM_EXIST(uVar3)){
CAM::SET_CAM_ACTIVE(uVar3, 0);
CAM::DESTROY_CAM(uVar3, 0);
}
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_106, 200f, 0, 0, 0, 0, 0, 0, 0);
GRAPHICS::REMOVE_DECALS_IN_RANGE(Local_106, 500f);
AUDIO::CLEAR_AMBIENT_ZONE_STATE(sLocal_471, 1);
if(func_12(PLAYER::PLAYER_PED_ID())){
...
void func_16(){
if(GRAPHICS::ANIMPOSTFX_IS_RUNNING(sLocal_251)){
GRAPHICS::ANIMPOSTFX_STOP(sLocal_251);
}
if(GRAPHICS::ANIMPOSTFX_IS_RUNNING(sLocal_252)){
GRAPHICS::ANIMPOSTFX_STOP(sLocal_252);
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_50(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
func_57(&(Global_107357.f_2890), Param0, fParam1);
}
...
if(func_59(Global_78930, 0f, 0f, 0f, 0)){
Global_78930={
Param0 
};
...
TASK::TASK_SMART_FLEE_COORD(Local_500[iVar0 /*33*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
}
iVar0++;
}}
...
iLocal_99=func_15(iLocal_125, 0);
if(func_12(iLocal_99) && ENTITY::IS_ENTITY_ATTACHED(iLocal_99)){
ENTITY::DETACH_ENTITY(iLocal_99, 1, 1);
}
TASK::OPEN_SEQUENCE_TASK(&uVar0);
TASK::TASK_PLAY_ANIM(0, sLocal_254, sLocal_264, 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_254, sLocal_267, 8f, -2f, -1, 0, 0, 0, 0, 0);
...
GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_alien_teleport", ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2), fLocal_489, 0, 0, 0);
...
break;
case 4:
fLocal_124=(fLocal_124 - (MISC::GET_FRAME_TIME() * 512f));
if(fLocal_124 <=0f){
fLocal_124=0f;
...
func_81(PLAYER::PLAYER_PED_ID(), floor(fLocal_124), &iLocal_116);
break;
case 3:
if(func_72()){
func_2("B1_FAIL3");
iLocal_94=MISC::GET_GAME_TIMER() + 50;
}
break;
}}
...
switch (iLocal_567){
case 0:
uLocal_543=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", Local_569, Local_570, 50f, 0, 2);
Local_544.f_11=uLocal_543;
iLocal_568=MISC::GET_GAME_TIMER() + 400;
iLocal_567++;
break;
case 1:
...
case 3:
if(MISC::GET_GAME_TIMER() > iLocal_568){
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_569, 1, 0, 0, 1);
ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), 0);
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 1, 0);
if(CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(0) !=4){
if(CAM::DOES_CAM_EXIST(uLocal_543)){
CAM::SET_CAM_ROT(uLocal_543, Local_570, 2);
CAM::SET_CAM_ACTIVE(uLocal_543, 1);
CAM::ATTACH_CAM_TO_ENTITY(uLocal_543, PLAYER::PLAYER_PED_ID(), 0f, 0f, 4f, 0);
}}else{
...
if(CAM::DOES_CAM_EXIST(uLocal_543)){
CAM::SET_CAM_ACTIVE(uLocal_543, 0);
...
fVar2=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iVar7, 1), CAM::GET_CAM_COORD(uParam0->f_11), 1);
}else{
fVar2=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iVar7, 0), CAM::GET_CAM_COORD(uParam0->f_11), 1);
}
...
if(bVar5){
Var4={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar6, CAM::GET_FINAL_RENDERED_CAM_COORD()) 
};
CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar6, Var4, 1);
}else{
Var4={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iVar7, CAM::GET_FINAL_RENDERED_CAM_COORD()) 
};
CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar7, Var4, 1);
}
...
CAM::ATTACH_CAM_TO_ENTITY((*uParam0)[uParam0->f_24], iVar6, Var4 + Vector(15f, 0f, 0f), 1);
}else{
...
if(!Global_23251.f_111){
AUDIO::PLAY_SOUND(-1, "CHARACTER_CHANGE_UP_MASTER", 0, 0, 0, 1);
if(Global_23251.f_109==-1){
Global_23251.f_109=AUDIO::GET_SOUND_ID();
Global_23251.f_110=MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME());
}
AUDIO::PLAY_SOUND(Global_23251.f_109, "CHARACTER_CHANGE_SKY_MASTER", 0, 0, 0, 1);
...
uParam0->f_24=0;
uParam0->f_27=0;
if(Global_23251.f_109 !=-1 && Global_23251.f_110==MISC::GET_HASH_KEY(SCRIPT::GET_THIS_SCRIPT_NAME())){
AUDIO::STOP_SOUND(Global_23251.f_109);
AUDIO::RELEASE_SOUND_ID(Global_23251.f_109);
Global_23251.f_109=-1;
Global_23251.f_110=0;
}
...
break;
case 1:
if(func_339(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2")){
iLocal_272=0;
if(func_12(PLAYER::PLAYER_PED_ID())){
PED::RESET_PED_VISIBLE_DAMAGE(PLAYER::PLAYER_PED_ID());
PED::CLEAR_PED_BLOOD_DAMAGE(PLAYER::PLAYER_PED_ID());
...
func_338();
MISC::CLEAR_AREA_OF_VEHICLES(Local_106, 250f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_PEDS(Local_106, 50f, 0);
MISC::CLEAR_AREA_OF_OBJECTS(Local_106, 30f, 0);
GRAPHICS::REMOVE_DECALS_IN_RANGE(Local_106, 500f);
PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
func_288();
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_244, 2, func_584(49), 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_246, 2, joaat("prop_protest_table_01"), 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_245, 2, joaat("prop_chair_08"), 0);
if(func_581(PLAYER::PLAYER_PED_ID())){
...
if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_244, 0))){
Local_92.f_28[0]=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_244, 0));
...
Local_92.f_41[0]=ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_246, 0));
}}
if(!func_581(Local_92.f_41[1])){
if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_245, 0))){
Local_92.f_41[1]=ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_245, 0));
}}
if(CUTSCENE::CAN_SET_ENTER_STATE_FOR_REGISTERED_ENTITY(sLocal_246, 0)){
...
func_54(1, 1, 1, 1);
func_280(PLAYER::PLAYER_PED_ID(), Local_106);
...
void func_83(){
if(iLocal_125==iLocal_121 && WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_125, 0)){
WEAPON::SET_PED_INFINITE_AMMO(PLAYER::PLAYER_PED_ID(), 0, iLocal_125);
}
if(func_581(PLAYER::PLAYER_PED_ID())){
func_571(PLAYER::PLAYER_PED_ID(), 1);
func_570(PLAYER::PLAYER_PED_ID(), 0);
...
Vector3 func__280(int iParam0, struct<3> Param1){
var uVar0;
...
if(ENTITY::DOES_ENTITY_EXIST(func_337()) && !func_59(Local_540, Local_102, 0)){
MISC::CLEAR_AREA(Local_540, 3f, 1, 0, 0, 0);
if(func_581(func_337())){
ENTITY::SET_ENTITY_COORDS(func_337(), Local_540, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(func_337(), fLocal_541);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(func_337(), 1084227584);
}
if(func_334(func_336(), 1)){
func_289(func_337(), Local_540, fLocal_541, 24, 0);
}}
iLocal_542=1;
}
...
func_325(iParam3, &Var0, Param1, fParam2, func_328(iParam0));
...
if(!func_322(&(Global_77479.f_555[0 /*21*/]), iParam0)){
return;
}
...
if(iParam0==24){
Global_113810.f_32752.f_4801=func_311();
}
...
func_329(iParam0, &(Global_113810.f_32752.f_5510));
}

int func_292(int iParam0){
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_308(iParam0, 0, 0)) || func_308(iParam0, 1, 0)) || func_308(iParam0, 2, 0)) || func_328(iParam0) !=145) || func_307(iParam0)) || func_306(iParam0)) || func_305(iParam0)) || func_304(iParam0)) || !func_293(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_306(iParam0)){
}
if(func_306(iParam0)){
}
...
if(!func_59(Global_113810.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
if(!func_59(Global_113810.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
if(!func_59(Global_113810.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
void func_325(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_322(&(Global_77479.f_555[0 /*21*/]), iParam0)){
if(MISC::IS_BIT_SET(Global_77479.f_555[0 /*21*/].f_9, 10)){
func_327(iParam0);
func_326(uParam1, &(Global_113810.f_32752.f_69[Global_77479.f_555[0 /*21*/].f_14 /*78*/]));
...
bool func_334(struct<3> Param0, int iParam1){
return func_335(Global_104373.f_2890.f_12.f_66, Param0, iParam1);
}

int func_335(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
struct<3> Var1;
if(iParam0==0){
return 0;
...
void func_338(){
if(AUDIO::IS_AUDIO_SCENE_ACTIVE(sLocal_256)){
AUDIO::STOP_AUDIO_SCENE(sLocal_256);
}
AUDIO::CLEAR_AMBIENT_ZONE_STATE(sLocal_471, 1);
...
iVar0=0;
if(!func_344(PLAYER::PLAYER_PED_ID(), joaat("script_task_leave_any_vehicle"))){
...
break;
case 2:
if(iLocal_520 !=0 && MISC::GET_GAME_TIMER() > iLocal_520){
iLocal_520=0;
iLocal_519=0;
}
if(AUDIO::IS_AUDIO_SCENE_ACTIVE(sLocal_256)){
AUDIO::SET_AUDIO_SCENE_VARIABLE(sLocal_256, "DrugsEffect", ((sin((((to_float(MISC::GET_GAME_TIMER()) / 1000f) * 45f) % 360f)) * 0.25f) + 0.25f));
}
...
iLocal_279=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(20000, 40000));
if((iLocal_278 - MISC::GET_GAME_TIMER()) < 2500){
iLocal_278=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(3000, 5000));
}}}
...
if(!iLocal_472){
iLocal_496=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_497, iLocal_498));
return;
}
if(bLocal_475){
iLocal_496=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_497 * 3, iLocal_498 * 2));
return;
}
...
if(MISC::GET_GAME_TIMER() > iLocal_496){
if(func_373(&iVar1)){
...
if(bLocal_491){
*uParam0={
func_362(Local_492, fLocal_493, 6f) 
};
}else{
*uParam0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f), 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(fLocal_494, fLocal_495), 6f) 
};
}
...
if(bParam1){
fVar1=2.5f;
}elseif(iLocal_523 > 27){
fVar1=10f;
}
if(func_361(PLAYER::PLAYER_PED_ID(), Var0, fVar1, 1)){
return 0;
}
if(MISC::GET_DISTANCE_BETWEEN_COORDS(Var0, Local_104, 1) > fLocal_105){
return 0;
}
if(!OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Local_123[0 /*3*/], Local_123[1 /*3*/], Local_123.f_7, 0, 1)){
return 0;
}
if(bLocal_115){
...
Vector3 func__362(struct<3> Param0, float fParam1, float fParam2){
struct<3> Var0;
float fVar1;
Var0={
...
fVar1=(fParam2 / 2f);
Var0={
func_363(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) 
};
...
Vector3 func__363(struct<3> Param0, float fParam1){
float fVar0;
if(fParam1==0f){
return 0f, 0f, 0f;
}
...
ENTITY::SET_ENTITY_HEALTH(uParam0->f_2, (iLocal_483 / 4), 0);
...
uParam0->f_2=PED::CREATE_PED(26, iLocal_273, Param1, 0, 1, 1);
...
ENTITY::SET_ENTITY_MAX_HEALTH(uParam0->f_2, iLocal_483);
ENTITY::SET_ENTITY_HEALTH(uParam0->f_2, iLocal_483, 0);
uParam0->f_4=OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_274, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_2, 0f, -5f, 0f), 1, 1, 0);
...
uParam0->f_5=OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_274, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_2, 0f, -5f, 0f), 1, 1, 0);
...
uParam0->f_6=OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_274, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_2, 0f, 5f, 0f), 1, 1, 0);
...
uParam0->f_16=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_484, iLocal_485));
uParam0->f_10=func_366(uParam0->f_2, PLAYER::PLAYER_PED_ID(), 1);
uParam0->f_11=MISC::GET_RANDOM_FLOAT_IN_RANGE(2f, 3f);
uParam0->f_14=(fLocal_507 + (MISC::GET_RANDOM_FLOAT_IN_RANGE(fLocal_511, fLocal_512) * fLocal_507));
uParam0->f_15=0f;
if(iLocal_114==1){}
TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_254, sLocal_266, 1000f, -8f, -1, 1, 0, 0, 0, 0);
iLocal_522++;
return 1;
}
...
var uVar0;
uVar0=func_368(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
...
while (iVar0 < 9){
if(iVar1 < Var2.f_0){
if(!PED::IS_ANY_PED_NEAR_POINT(Local_539[iVar0 /*3*/], 1.5f)){
...
iVar0=10;
}elseif(iParam0==iLocal_119){
iVar0=30;
}elseif(iParam0==iLocal_120){
iVar0=10;
}elseif(iParam0==iLocal_121){
iVar0=-1;
}else{
iVar0=-1;
}
...
return (func_383(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return uParam0->f_1;
}
...
uParam0->f_1=(func_383(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
switch (*iParam0){
case 0:
MISC::SET_TIME_SCALE(fLocal_110);
AUDIO::DEACTIVATE_AUDIO_SLOWMO_MODE("BARRY_01_SLOWMO");
...
func_395();
func_394(iLocal_125);
AUDIO::SET_AMBIENT_ZONE_STATE(sLocal_471, 1, 0);
break;
case 1:
HUD::CLEAR_PRINTS();
AUDIO::START_AUDIO_SCENE(sLocal_256);
PED::CLEAR_PED_BLOOD_DAMAGE(PLAYER::PLAYER_PED_ID());
iLocal_522=0;
iLocal_523=0;
iLocal_479=0;
...
func_386(&uLocal_532);
fLocal_535=MISC::GET_RANDOM_FLOAT_IN_RANGE(1.5f, 2.5f);
}else{
func_386(&uLocal_532);
fLocal_535=1f;
}}}}}
...
void func_408(){
func_41(&uLocal_306, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
iLocal_277=MISC::GET_GAME_TIMER() + 1500;
iLocal_279=(iLocal_277 + MISC::GET_RANDOM_INT_IN_RANGE(20000, 40000));
iLocal_278=(iLocal_277 + MISC::GET_RANDOM_INT_IN_RANGE(12000, 18000));
...
if(func_581(Local_92.f_28[0])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_28[0], sLocal_244, 0, 0, 0);
}else{
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_28[0], sLocal_244, 2, func_584(49), 0);
}
if(func_581(Local_92.f_41[0])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[0], sLocal_246, 0, 0, 0);
}else{
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[0], sLocal_246, 2, joaat("prop_protest_table_01"), 0);
}
if(func_581(Local_92.f_41[1])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[1], sLocal_245, 0, 0, 0);
}else{
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[1], sLocal_245, 2, joaat("prop_chair_08"), 0);
}
if(func_581(Local_92.f_41[2])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[2], sLocal_248, 0, 0, 0);
}else{
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[2], sLocal_248, 2, joaat("p_a4_sheets_s"), 0);
}
if(func_581(Local_92.f_41[3])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[3], sLocal_249, 0, 0, 0);
}else{
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[3], sLocal_249, 2, joaat("p_cs_lighter_01"), 0);
}
if(func_581(Local_92.f_41[4])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[4], sLocal_250, 0, 0, 0);
}else{
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[4], sLocal_250, 2, joaat("p_cs_joint_01"), 0);
}
if(func_581(PLAYER::PLAYER_PED_ID())){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Michael", 0, 0, 0);
}
WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), iLocal_125, -1, 0, 0);
iLocal_528=func_434(PLAYER::PLAYER_PED_ID(), iLocal_125, 1, 0, 0, 0, 0, 0, 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_528, sLocal_247, 0, 0, 0);
func_433();
CUTSCENE::START_CUTSCENE(0);
RECORDING::REPLAY_START_EVENT(1);
...
wait(0);
if(func_581(Local_92.f_41[4])){
if(ENTITY::IS_ENTITY_ATTACHED(Local_92.f_41[4])){
ENTITY::DETACH_ENTITY(Local_92.f_41[4], 1, 1);
}}
func_432(0, 0, 1, 0);
func_424();
...
WEAPON::REQUEST_WEAPON_HIGH_DETAIL_MODEL(iLocal_528);
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_247, 0)){
WEAPON::GIVE_WEAPON_OBJECT_TO_PED(iLocal_528, PLAYER::PLAYER_PED_ID());
}}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_248, 0)){
if(func_581(Local_92.f_41[2])){
OBJECT::DELETE_OBJECT(&(Local_92.f_41[2]));
}}
if(iLocal_270==0){
if(iVar0 >=58500){
iLocal_270=1;
...
if(!GRAPHICS::ANIMPOSTFX_IS_RUNNING(sLocal_252)){
GRAPHICS::ANIMPOSTFX_PLAY(sLocal_252, 0, 1);
}}else{
...
if(func_581(func_337())){
Local_540={
ENTITY::GET_ENTITY_COORDS(func_337(), 1) 
};
fLocal_541=ENTITY::GET_ENTITY_HEADING(func_337());
}}
if(!func_334(func_336(), 1) || func_8(func_337(), Local_106, 1) < 10f){
Local_540={
Local_102 
};
fLocal_541=fLocal_103;
}
func_425(Local_122[0 /*3*/], Local_122[1 /*3*/], Local_122.f_7, Local_102, fLocal_103, func_336(), 1, 1, 1, 0, 0);
if(func_334(func_336(), 1)){
func_289(func_337(), Local_540, fLocal_541, 24, 0);
}}
...
Vector3 func__430(struct<3> Param0){
float fVar0;
float fVar1;
fVar0=vmag(Param0);
if(fVar0 !=0f){
...
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
if(WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_438(iVar2, bVar6))){
if(func_437(func_438(iVar2, bVar6))){
uVar7=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_438(iVar2, bVar6));
}}}
bVar6++;
}
...
WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_438(iVar2, bVar8));
...
func_442(iParam0, &(Global_113810.f_2366.f_539.f_1764));
iVar1=0;
while (iVar1 <=(8 - 1)){
Global_113810.f_2366.f_539.f_1730[iVar1 /*4*/][iVar0]=HUD::HUD_GET_WEAPON_WHEEL_TOP_SLOT(iVar1);
iVar1++;
}}}
...
iVar5=0;
while (iVar5 < iVar6){
if((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_443(Var7.f_1)) && iVar9 < 51){
...
if(func_581(Local_92.f_28[0])){
if(CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(0)==4){
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_92.f_28[0], 0f, 0f, 0.8f, 1, -1, 3000, 2000, 0);
CAM::SET_GAMEPLAY_HINT_CAMERA_RELATIVE_SIDE_OFFSET(0f);
}else{
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_92.f_28[0], 0.5f, 0f, 0.8f, 1, -1, 3000, 2000, 0);
...
break;
case 1:
if(STREAMING::HAS_ANIM_DICT_LOADED(sLocal_255) && !func_342()){
uVar0=16;
...
TASK::TASK_PLAY_ANIM(Local_92.f_28[0], sLocal_255, "leadin", 8f, -4f, -1, 2, 0, 0, 0, 0);
TASK::TASK_LOOK_AT_ENTITY(Local_92.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
*iParam0=2;
iLocal_93=MISC::GET_GAME_TIMER() + 30000;
}}
break;
case 2:
if(func_581(Local_92.f_28[0])){
if(!func_342() || MISC::GET_GAME_TIMER() > iLocal_93){
*iParam0=4;
}}
break;
case 3:
...
if(MISC::GET_GAME_TIMER() < iLocal_479){
iLocal_477=-1;
}elseif(iLocal_477==-1){
func_451();
}}
...
Var0={
PED::GET_PED_BONE_COORDS(uParam0->f_2, 31086, Local_514) 
};
...
TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_254, sLocal_265, 8f, -8f, -1, 1, 0, 0, 0, 0);
func_65(uParam0);
func_67(&(uParam0->f_17));
uParam0->f_1=13;
uParam0->f_26=0;
...
if(uParam0->f_3 !=0){
func_6(&(uParam0->f_3));
}}elseif(func_480(uParam0) && uParam0->f_3==0){
...
uParam0->f_1=2;
uParam0->f_15=0f;
ENTITY::SET_ENTITY_ALPHA(uParam0->f_2, floor(uParam0->f_15), 0);
}
break;
case 2:
ENTITY::SET_ENTITY_COLLISION(uParam0->f_2, 0, 0);
...
PED::SET_PED_CAN_BE_TARGETTED(uParam0->f_2, 0);
func_367(uParam0->f_2);
TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_254, sLocal_266, 8f, -8f, -1, 1, 0, 0, 0, 0);
GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_alien_teleport", uParam0->f_2, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_489, 0, 0, 0);
...
if(uParam0->f_15 < 255f){
func_81(uParam0->f_2, floor(uParam0->f_15), &iLocal_116);
}else{
...
func_6(&(uParam0->f_3));
func_67(&(uParam0->f_17));
GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD("scr_alien_teleport", ENTITY::GET_ENTITY_COORDS(uParam0->f_2, 1), ENTITY::GET_ENTITY_ROTATION(uParam0->f_2, 2), fLocal_489, 0, 0, 0);
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "SPAWN", uParam0->f_2, "BARRY_01_SOUNDSET", 0, 0);
uParam0->f_7=MISC::GET_GAME_TIMER() + 450;
uParam0->f_1=5;
...
break;
case 5:
uParam0->f_15=(IntToFloat((uParam0->f_7 - MISC::GET_GAME_TIMER()) * 255) / to_float(450));
if(uParam0->f_15 < 0f){
uParam0->f_15=0f;
}
func_81(uParam0->f_2, floor(uParam0->f_15), &iLocal_116);
...
if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_254, sLocal_262, 3)){
...
if(WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_125, 0)){
if(WEAPON::GET_AMMO_IN_PED_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_125) > 0){
if(WEAPON::GET_AMMO_IN_CLIP(PLAYER::PLAYER_PED_ID(), iLocal_125, &iVar2)){
if(iVar2==0){
WEAPON::REFILL_AMMO_INSTANTLY(PLAYER::PLAYER_PED_ID());
}
}}}
...
TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_254, sLocal_265, 4f, -4f, -1, 1, 0, 0, 0, 0);
}
return;
}
uParam0->f_1=14;
uParam0->f_7=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE((iLocal_478 - 1500), (iLocal_478 - 500)));
break;
case 14:
PED::SET_PED_NAME_DEBUG(uParam0->f_2, "WATCH END");
if(MISC::GET_GAME_TIMER() > uParam0->f_7 && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_254, sLocal_262, 3)){
uParam0->f_1=9;
}
break;
case 15:
...
func_468(uParam0->f_2, "ALIEN_HOSTILE", "ALIENS", 10);
uParam0->f_1=16;
uParam0->f_26=0;
}elseif(bLocal_475){
uParam0->f_1=13;
...
uParam0->f_7=(MISC::GET_GAME_TIMER() + iLocal_506);
func_66(&(uParam0->f_21));
func_66(&(uParam0->f_22));
func_66(&(uParam0->f_23));
func_66(&(uParam0->f_24));
uParam0->f_12=0f;
uParam0->f_22=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_impact", uParam0->f_4, 0f, 0f, 0f, 0f, 0f, 0f, (fLocal_487 / 3f), 0, 0, 0);
uParam0->f_23=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_beam", uParam0->f_4, 0f, 0f, 0f, Local_515, fLocal_508, 0, 0, 0);
GRAPHICS::SET_PARTICLE_FX_LOOPED_FAR_CLIP_DIST(uParam0->f_23, uParam0->f_12);
TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_254, "MIND_CONTROL_B_Loop", 4f, -8f, -1, 1, 0, 0, 0, 0);
uParam0->f_1=19;
}
break;
case 19:
...
if(TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_2, joaat("script_task_play_anim")) !=1){
TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_254, "MIND_CONTROL_B_LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
}
if(TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_2, joaat("script_task_play_anim"))==1){
...
uParam0->f_22=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_charging", uParam0->f_4, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_488, 0, 0, 0);
}
if(iLocal_114==1){
}
uParam0->f_1=19;
...
GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_alien_disintegrate", uParam0->f_2, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_490, 0, 0, 0);
...
break;
case 8:
uParam0->f_15=(IntToFloat((uParam0->f_7 - MISC::GET_GAME_TIMER()) * 255) / to_float(1000));
if(uParam0->f_15 < 0f){
uParam0->f_15=0f;
}
...
Var4={
Var3 + ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * FtoV((uParam0->f_12 + 3f)) 
};
if(uParam0->f_26==0){
...
uParam0->f_27={
MISC::GET_CLOSEST_POINT_ON_LINE(Var5, Var3, Var4, 0) 
};
...
MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS(Var3, Var4, 0, 1, joaat("weapon_pistol"), 0, 0, 1, -1082130432);
}
if(iLocal_501==1){
ENTITY::APPLY_FORCE_TO_ENTITY(PLAYER::PLAYER_PED_ID(), 1, Vector(fLocal_513, fLocal_513, fLocal_513) * ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4), 0f, 0f, 0f, 0, 0, 1, 1, 0, 1);
}
if(iLocal_502==0){
...
if((ENTITY::GET_ENTITY_HEALTH(PLAYER::PLAYER_PED_ID()) - iLocal_503) <=100){
func_69();
func_61(1);
func_456(Var3, Var4, 1);
return;
}else{
PED::APPLY_DAMAGE_TO_PED(PLAYER::PLAYER_PED_ID(), iLocal_503, 0, 0);
}
uParam0->f_8=(MISC::GET_GAME_TIMER() + round((IntToFloat(iLocal_504) * 1.25f)));
PAD::SET_CONTROL_SHAKE(0, (iLocal_504 / 2), 255);
PAD::SET_CONTROL_SHAKE(0, (iLocal_504 / 2), 255);
}}}}
uParam0->f_26=0;
}}
...
uParam0->f_24=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_alien_impact", uParam0->f_5, 0f, 0f, 0f, 0f, 0f, 0f, fLocal_487, 0, 0, 0);
}}
...
iLocal_280=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(4000, 7000));
}}
...
Var1={
func_463(CAM::GET_FINAL_RENDERED_CAM_ROT(2)) 
};
Var2={
Var0 + Var1 * FtoV(CAM::GET_FINAL_RENDERED_CAM_NEAR_CLIP()) 
};
fVar5=(fLocal_487 * 1.25f);
if(func_462(&Var3, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, 1), ENTITY::GET_ENTITY_COORDS(uParam0->f_5, 1), Var1, Var2)){
if(CAM::IS_SPHERE_VISIBLE(Var3, 0.5f)){
iVar6=func_460(Var1, Var0, ENTITY::GET_ENTITY_COORDS(uParam0->f_4, 1));
iVar7=func_460(Var1, Var0, ENTITY::GET_ENTITY_COORDS(uParam0->f_5, 1));
if(iVar6 > 0 && iVar7 < 0){
Var3={
Var3 - ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * Vector(fLocal_516, fLocal_516, fLocal_516) 
};
}elseif(iVar6 < 0 && iVar7 > 0){
Var3={
Var3 + ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_4) * FtoV((fLocal_516 * 4.5f)) 
};
}
if(!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uParam0->f_25)){
uParam0->f_25=GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_alien_impact", Var3, 0f, 0f, 0f, fVar5, 0, 0, 0, 0);
}
...
fVar4=(fVar3 / fVar2);
*uParam0={
Param1 + Vector(fVar4, fVar4, fVar4) * Var0 
};
...
Vector3 func__463(struct<3> Param0){
...
float fVar0;
float fVar1;
func_465(ENTITY::GET_ENTITY_COORDS(iParam0, 1), Param1, &fVar0, &fVar1, 1);
...
uParam0->f_7=(MISC::GET_GAME_TIMER() + iLocal_505 * 2);
}
if(!func_9()){
return;
}
...
TASK::TASK_PLAY_ANIM(0, sLocal_254, "MIND_CONTROL_B_Enter", 8f, -8f, -1, 2, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar2);
...
uParam0->f_7=(MISC::GET_GAME_TIMER() + iLocal_505);
func_67(&(uParam0->f_17));
uParam0->f_17=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FROM_ENTITY(uParam0->f_17, "MIND_CONTROL", uParam0->f_2, "BARRY_01_SOUNDSET", 0, 0);
}
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(uParam0, sParam1, sParam2, func_469(iParam3), 0);
}
...
int iVar0;
float fVar1;
iLocal_479=(MISC::GET_GAME_TIMER() + iLocal_480);
bLocal_475=true;
...
GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_alien_teleport", PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, fLocal_489, 0, 0, 0);
uParam0->f_19=MISC::GET_GAME_TIMER() + 2000;
}
if(uParam0->f_18 > iLocal_481 || TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_2, joaat("script_task_perform_sequence")) > 1){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_2, sLocal_254, sLocal_259, 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_2, sLocal_254, sLocal_257, 3)){
TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_254, sLocal_261, 8f, -8f, -1, 0, 0, 0, 0, 0);
}
if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_254, sLocal_260, 3)){
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_254, sLocal_262, 8f, -4f, -1, 0, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_254, sLocal_258, 3)){
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_254, sLocal_262, 8f, -4f, -1, 0, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
}else{
...
if(iLocal_117==0){
fVar1=(to_float(iLocal_482 + 2000) / 1000f);
...
if(MISC::GET_GAME_TIMER() > uParam0->f_7){
TASK::TASK_PLAY_ANIM(uParam0->f_2, sLocal_254, sLocal_263, 8f, -8f, -1, 0, 0, 0, 0, 0);
func_67(&(uParam0->f_17));
func_471();
}}
...
func_367(uParam0->f_2);
TASK::OPEN_SEQUENCE_TASK(&uVar0);
TASK::TASK_PLAY_ANIM(0, sLocal_254, sLocal_257, 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_254, sLocal_259, 8f, -8f, -1, 1, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
...
TASK::OPEN_SEQUENCE_TASK(&uVar0);
TASK::TASK_PLAY_ANIM(0, sLocal_254, sLocal_258, 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_254, sLocal_260, 8f, -8f, -1, 1, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
...
uParam0->f_7=(MISC::GET_GAME_TIMER() + iLocal_482) + 2000;
CAM::SET_GAMEPLAY_PED_HINT(uParam0->f_2, 0f, 0f, 0f, 1, iLocal_482 + 2000, 2000, 2000);
}else{
uParam0->f_7=(MISC::GET_GAME_TIMER() + iLocal_482);
CAM::SET_GAMEPLAY_PED_HINT(uParam0->f_2, 0f, 0f, 0f, 1, iLocal_482, 2000, 2000);
}
iLocal_521++;
uParam0->f_18=0;
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
...
var uVar0;
uVar0=func_368(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(iParam1, 1), 1);
ENTITY::SET_ENTITY_HEADING(iParam0, uVar0);
}
...
float fVar2;
Var0={
func_430(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var1={
func_430(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
return ((iLocal_476==1 && MISC::GET_GAME_TIMER() > iLocal_479) && uParam0->f_30==iLocal_477);
}
...
func_468(uParam0->f_2, "ALIEN_CLICKS", "ALIENS", 10);
uParam0->f_16=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_484, iLocal_485));
}}
...
func_486("ALIEN_DEATH", "ALIENS", ENTITY::GET_ENTITY_COORDS(uParam0->f_2, 1), 10);
func_65(uParam0);
func_67(&(uParam0->f_17));
func_14(&(uParam0->f_4));
func_14(&(uParam0->f_5));
...
iLocal_523++;
if(iLocal_519==0){
iLocal_520=MISC::GET_GAME_TIMER() + 10000;
}
iLocal_519++;
...
iLocal_278=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(10000, 20000));
if((iLocal_279 - MISC::GET_GAME_TIMER()) < 2500){
iLocal_279=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(3000, 5000));
}}}


void func_486(char* sParam0, char* sParam1, struct<3> Param2, int iParam3){
AUDIO::PLAY_AMBIENT_SPEECH_FROM_POSITION_NATIVE(sParam0, sParam1, Param2, func_469(iParam3));
}
...
Var4={
func_497(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
if(((!func_508(0) || Global_78960) || Global_78948==1) || !CAM::IS_SCREEN_FADED_IN()){
return 0;
}
switch (Global_78944){
case 0:
...
return func_510(iParam0, Global_43377);
}
...
if(func_581(PLAYER::PLAYER_PED_ID())){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_254, sLocal_260, 3)){
TASK::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), sLocal_254, sLocal_260, -1056964608);
}
if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_254, sLocal_258, 3)){
TASK::STOP_ANIM_TASK(PLAYER::PLAYER_PED_ID(), sLocal_254, sLocal_258, -1056964608);
}
ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 1, 0);
func_441(PLAYER::PLAYER_PED_ID());
WEAPON::REMOVE_ALL_PED_WEAPONS(PLAYER::PLAYER_PED_ID(), 1);
...
if(func_520(&(uParam0->f_28[0]), 49, Var1, uVar2, "RC LAUNCHER:
BARRY 1", 1)){
...
ENTITY::SET_ENTITY_HEADING(uParam0->f_28[0], uVar2);
...
if(func_88()==0){
return MISC::IS_BIT_SET(func_151(func_541(iParam0), -1), iParam1);
}}else{
...
int iVar0;
int iVar1;
iVar0=func_554(&(Global_100833.f_3), 0);
iVar1=0;
if(iVar0==53){
iVar1=1;
}
...
if(func_552(&(Global_100833.f_3)) > -1){
return 1;
}}
return 0;
}
...
if(func_31(iParam0)){
Global_113810.f_2366.f_539.f_298[iParam0 /*477*/]={
Global_113810.f_2366.f_539.f_1764 
};
}}
...
func_442(iParam0, &(Global_113810.f_2366.f_539.f_298[iVar0 /*477*/]));
iVar2=0;
while (iVar2 <=(8 - 1)){
...
if(!PED::IS_PED_INJURED(iParam0)){
iVar0=func_32(iParam0);
func_572(iParam0, &(Global_113810.f_2366.f_539.f_1764), bParam1);
iVar1=0;
while (iVar1 <=(8 - 1)){
...
if(!func_303() || NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
return 0;
}
break;
case joaat("weapon_hatchet"):
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
if(!func_303() && !Global_262145.f_20404){
return 0;
}}
break;
case joaat("weapon_knuckle"):
