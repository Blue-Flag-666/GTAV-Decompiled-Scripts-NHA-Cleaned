...
if(!iLocal_996){
if(func_654()){
iLocal_1000=func_653();
if(!Global_94990){
if(iLocal_1000==0){
func_652(Local_1009, fLocal_1010, 1, 0);
}elseif(iLocal_1000==1){
func_652(404.1494f, -1630.793f, 28.2928f, 231.5304f, 1, 0);
}elseif(iLocal_1000==2){
func_652(Local_608, fLocal_609, 1, 0);
}}elseif(iLocal_1000==0){
func_652(404.1494f, -1630.793f, 28.2928f, 231.5304f, 1, 0);
}elseif(iLocal_1000==1){
func_652(404.1494f, -1630.793f, 28.2928f, 231.5304f, 1, 0);
}
...
iLocal_985=VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Local_989, fLocal_990, 1, 1, 0);
iLocal_672=iLocal_985;
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_672, 1, 0);
AUDIO::SET_VEH_RADIO_STATION(iLocal_672, "RADIO_03_HIPHOP_NEW");
MISC::CLEAR_AREA(Local_989, 25f, 1, 1, 0, 0);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_985)){
HUD::REMOVE_BLIP(&uLocal_555);
...
if(!iLocal_199){
if(!func_538()){
if(func_534(&uLocal_226, "TOWAUD", "TOW_HERE", 8, 0, 0, 0)){
if(!func_217(&uLocal_1003)){
func_547(&uLocal_1003);
}
iLocal_199=1;
}
...
if(!bLocal_991){
if(func_217(&uLocal_1003)){
if(func_214(&uLocal_1003) > 20f){
if(!func_538()){
if(func_534(&uLocal_226, "TOWAUD", "TOW_WAITING", 8, 0, 0, 0)){
func_394(&uLocal_1003);
}}}
}
}}}
}}else{
...
if(!iLocal_200){
if(!func_538()){
if(func_534(&uLocal_226, "TOWAUD", "TOW_CAR", 8, 0, 0, 0)){
iLocal_200=1;
}
}
}}else{
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)){
if(!func_538()){
if(func_534(&uLocal_226, "TOWAUD", "TOW_CARWAIT", 8, 0, 0, 0)){
iLocal_993=1;
}
}}}
}}}}
...
if(func_534(&uLocal_226, "TOWAUD", "TOW_JACK", 8, 0, 0, 0)){
iLocal_994=1;
}}}}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_554, 0)){
...
case 1:
if(!func_538()){
if(func_534(&uLocal_226, "TOWAUD", "TOW_CHAT", 8, 0, 0, 0)){
iLocal_1001=2;
}}
break;
case 2:
...
if(!func_217(&uLocal_1006)){
func_547(&uLocal_1006);
}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
...
case 2:
if(func_217(&uLocal_1006)){
if((func_214(&uLocal_1006) > 3f || (iLocal_999 && !func_538())) || (func_313(PLAYER::PLAYER_PED_ID(), iLocal_554, 1) < 3.5f && !func_538())){
iLocal_980=1;
}}
break;
case 1:
...
uLocal_1002=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Local_988, 5f, 5f, 5f, 0f, 0, 7);
func_576();
...
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
func_577(23, 0);
PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(uLocal_1002);
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
iLocal_979=2;
iLocal_980=0;
break;
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_672)){
iLocal_672=VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Local_989, fLocal_990, 1, 1, 0);
