...
if(ENTITY::IS_ENTITY_DEAD(uLocal_89, 0) && !iLocal_93==7){
...
if(func_11()){
uLocal_89=PED::CREATE_PED(26, iLocal_86, Local_87, uLocal_88, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_89, 1);
uLocal_90=OBJECT::CREATE_OBJECT(joaat("prop_tapeplayer_01"), 704.7615f, 4179.574f, 39.7093f, 1, 1, 0);
ENTITY::SET_ENTITY_HEADING(uLocal_90, (233.8288f + 180f));
PED::SET_PED_PROP_INDEX(uLocal_89, 0, 0, 0, 0, 1);
iLocal_93=1;
}}else{
func_37(0);
}
break;
case 1:
iLocal_95=PED::CREATE_SYNCHRONIZED_SCENE(Local_87 + Vector(1f, 0f, 0f), 0f, 0f, uLocal_88, 2);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_89, iLocal_95, sLocal_92, "MTN_DNC_if_you_want_to_get_to_heaven", 2f, -2f, 1, 0, 1148846080, 0);
AUDIO::INIT_SYNCH_SCENE_AUDIO_WITH_ENTITY("MNT_DNC", uLocal_89);
iLocal_93=2;
break;
case 2:
if(AUDIO::PREPARE_SYNCHRONIZED_AUDIO_EVENT_FOR_SCENE(iLocal_95, "MNT_DNC")==1){
AUDIO::PLAY_SYNCHRONIZED_AUDIO_EVENT(iLocal_95);
iLocal_93=3;
}
break;
case 3:
...
PED::SET_PED_LOD_MULTIPLIER(uLocal_89, 3f);
if(func_10(PLAYER::PLAYER_PED_ID(), uLocal_89) < 10f){
PED::SET_IK_TARGET(PLAYER::PLAYER_PED_ID(), 1, uLocal_89, 31086, 0f, 0f, 0f, 0, -1, -1);
PED::SET_IK_TARGET(uLocal_89, 1, PLAYER::PLAYER_PED_ID(), 31086, 0f, 0f, 0f, 0, -1, -1);
}
if(func_9(uLocal_89, PLAYER::PLAYER_PED_ID(), 1) < 25f){
if(!HUD::DOES_BLIP_EXIST(uLocal_94)){
func_5(&uLocal_94, &uLocal_89, 0);
HUD::SET_BLIP_COLOUR(uLocal_94, 3);
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_94)){
func_4(&uLocal_94);
}
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_95) > 0.9999999f){
iLocal_93=1;
}
if(PED::IS_PED_RAGDOLL(uLocal_89)){
AUDIO::STOP_SYNCHRONIZED_AUDIO_EVENT(iLocal_95);
iLocal_93=4;
}
if(((((PED::IS_PED_INJURED(uLocal_89) || MISC::IS_BULLET_IN_AREA(Var0, 50f, 1)) || MISC::IS_BULLET_IN_AREA(Var0, 50f, 0)) || MISC::IS_PROJECTILE_IN_AREA(Var0, 20f, 20f, 20f, 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, Var0, 50f)) || (((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_89) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_89)) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Var0, 1) < 25f) && func_1(uLocal_89, PLAYER::PLAYER_PED_ID(), 1126825984, 0))){
AUDIO::STOP_SYNCHRONIZED_AUDIO_EVENT(iLocal_95);
iLocal_93=4;
iLocal_91=1;
}
...
if(!PED::IS_PED_RAGDOLL(uLocal_89)){
if(iLocal_91==1){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_89, 723.1315f, 4171.957f, 39.7091f, 2f, -1, 1f, 1024, 1193033728);
}else{
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_89, 723.1315f, 4171.957f, 39.7091f, 1f, -1, 1f, 1024, 1193033728);
}
...
break;
case 6:
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_89, joaat("script_task_follow_nav_mesh_to_coord")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_89, joaat("script_task_follow_nav_mesh_to_coord")) !=0){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_89, 0);
if(iLocal_91==1){
TASK::TASK_SMART_FLEE_PED(uLocal_89, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
}else{
TASK::TASK_WANDER_STANDARD(uLocal_89, 1193033728, 0);
}
PED::SET_PED_KEEP_TASK(uLocal_89, 1);
iLocal_93=5;
}
break;
case 5:
if((ENTITY::IS_ENTITY_OCCLUDED(uLocal_89) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_89, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_37(1);
}
break;
case 7:
...
STREAMING::REQUEST_ANIM_DICT(sLocal_92);
if(STREAMING::HAS_MODEL_LOADED(iLocal_86) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_92)){
return 1;
}
return 0;
}
...
if(vmag2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_27()){
return 0;
}}
if(func_13(100f, 1) !=-1){
return 1;
...
OBJECT::DELETE_OBJECT(&uLocal_90);
}
if(HUD::DOES_BLIP_EXIST(uLocal_94)){
func_4(&uLocal_94);
}
