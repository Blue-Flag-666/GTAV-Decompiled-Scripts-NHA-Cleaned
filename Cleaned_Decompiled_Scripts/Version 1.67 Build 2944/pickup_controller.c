...
uLocal_27[iParam0]=OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_4(iParam0), Param2, iVar0, -1, 2, 1, 0);
...
uLocal_25[iParam0]=OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_8(iParam0), Param2, iVar0, -1, 2, 1, 0);
OBJECT::SET_PICKUP_REGENERATION_TIME(uLocal_25[iParam0], 600000);
}
...
uLocal_22[iParam0]=OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_12(iParam0), Param2, iVar0, -1, 2, 1, 0);
...
break;
case 1:
if(OBJECT::DOES_PICKUP_EXIST(uLocal_20[Global_32530]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(uLocal_20[Global_32530])){
Global_32531=0;
}else{
Global_32531=1;
}
break;
case 2:
if(OBJECT::DOES_PICKUP_EXIST(uLocal_21[Global_32530]) && OBJECT::DOES_PICKUP_OBJECT_EXIST(uLocal_21[Global_32530])){
Global_32531=0;
}else{
Global_32531=1;
}
...
iVar0=0;
while (iVar0 < 1){
if(OBJECT::DOES_PICKUP_EXIST(uLocal_25[iVar0])){
OBJECT::REMOVE_PICKUP(uLocal_25[iVar0]);
}
iVar0++;
}
iLocal_26=0;
...
iVar0=0;
while (iVar0 < 45){
if(OBJECT::DOES_PICKUP_EXIST(uLocal_18[iVar0])){
OBJECT::REMOVE_PICKUP(uLocal_18[iVar0]);
}
iVar0++;
}}
...
uLocal_21[iParam0]=OBJECT::CREATE_PICKUP_ROTATE(iParam1, func_28(iParam0, 0), Param2, iVar0, -1, 2, 1, 0);
OBJECT::SET_PICKUP_REGENERATION_TIME(uLocal_21[iParam0], 600000);
if(bParam4){
INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(uLocal_21[iParam0], func_27(iParam0));
}}
...
uLocal_20[iParam0]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_health_standard"), func_32(iParam0, 0), Param1, iVar0, -1, 2, 1, 0);
OBJECT::SET_PICKUP_REGENERATION_TIME(uLocal_20[iParam0], 600000);
if(bParam3){
INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(uLocal_20[iParam0], func_31(iParam0));
}}
...
uLocal_19[iParam0]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_weapon_petrolcan"), func_35(iParam0), Param1, iVar0, -1, 2, 1, 0);
...
uLocal_18[iParam0]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_armour_standard"), func_39(iParam0, 0), Param1, iVar0, -1, 2, 1, 0);
