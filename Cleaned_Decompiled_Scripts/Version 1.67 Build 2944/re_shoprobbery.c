...
while (true){
wait(0);
if(BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_97){
if(!func_200()){
if(func_199()){
func_236();
}}
...
if(!iLocal_74){
func_184();
if(INTERIOR::IS_INTERIOR_READY(iLocal_86)){
func_178();
iLocal_74=1;
}}else{
if(iLocal_45==1){
...
func_175();
INTERIOR::UNPIN_INTERIOR(iLocal_86);
if(func_174()){
if(!iLocal_92){
if(iLocal_45==1){
...
if(!PED::IS_PED_INJURED(iLocal_64[iVar0])){
TASK::TASK_COMBAT_PED(iLocal_64[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_KEEP_TASK(iLocal_64[iVar0], 1);
if(!HUD::DOES_BLIP_EXIST(uLocal_114[iVar0])){
...
TASK::TASK_COWER(iLocal_65[iVar0], -1);
...
func_163(1);
settimera(0);
EVENT::ADD_SHOCKING_EVENT_AT_POSITION(90, Local_121, 15000f);
iLocal_42=1;
}}
break;
case 1:
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_65[iVar1])){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_65[iVar1], PLAYER::PLAYER_PED_ID(), 1)){
func_162();
}
}
iVar1++;
...
if(!ENTITY::IS_ENTITY_ATTACHED(iLocal_100)){
func_151();
WEAPON::SET_CURRENT_PED_WEAPON(iLocal_64[0], joaat("weapon_unarmed"), 1);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_100, iLocal_64[0], PED::GET_PED_BONE_INDEX(iLocal_64[0], 57005), 0.3f, 0f, 0f, 80f, -90f, 0f, 1, 1, 0, 0, 2, 1, 0);
}}
}
if(MISC::IS_PROJECTILE_IN_AREA(Local_121 - Vector(20f, 20f, 20f), Local_121 + Vector(20f, 20f, 20f), 0)){
if(!PED::IS_PED_INJURED(iLocal_65[1])){
TASK::TASK_SMART_FLEE_COORD(iLocal_65[1], Local_57, 150f, -1, 0, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_65[1], 0);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_65[1]));
}
if(!PED::IS_PED_INJURED(iLocal_65[2])){
TASK::TASK_SMART_FLEE_COORD(iLocal_65[2], Local_57, 150f, -1, 0, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_65[2], 0);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_65[2]));
}
iVar2=0;
while (iVar2 <=(iLocal_63 - 1)){
if(!PED::IS_PED_INJURED(iLocal_66[iVar2])){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_66[iVar2], 1, 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
if(iLocal_45==1){
...
TASK::TASK_SMART_FLEE_COORD(0, Local_57, 150f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(iLocal_66[iVar2], uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
PED::SET_PED_KEEP_TASK(iLocal_66[iVar2], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_66[iVar2], 0);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_66[iVar2], 1);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_66[iVar2]));
}
iVar2++;
}
}
...
if(!iLocal_97){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_64[0], 0)){
...
if(iLocal_45==1){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_100)){
ENTITY::SET_ENTITY_VISIBLE(iLocal_100, 0, 0);
ENTITY::SET_ENTITY_COLLISION(iLocal_100, 0, 0);
}
}
elseif(iLocal_45==2){
}
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_65[iVar1], 0);
}
iVar1++;
}
iVar1=0;
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_65[0], 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
TASK::TASK_PLAY_ANIM(0, "random@robbery", "f_distressed_loop", 2f, -2f, -1, 9, 0f, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(iLocal_65[0], uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
...
if(!PED::IS_PED_INJURED(iLocal_64[0]) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_104, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_64[0], iLocal_104, 0)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_100)){
OBJECT::DELETE_OBJECT(&iLocal_100);
bLocal_94=true;
}}}
if(func_114() && !iLocal_95){
if(HUD::DOES_BLIP_EXIST(uLocal_114[0])){
HUD::REMOVE_BLIP(&(uLocal_114[0]));
}
if(HUD::DOES_BLIP_EXIST(uLocal_114[1])){
HUD::REMOVE_BLIP(&(uLocal_114[1]));
}
...
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_113, 17, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_113, 6, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_113, 1, 1);
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_113, iLocal_104, PLAYER::PLAYER_PED_ID(), 8, 16f, 786469, -1f, -1f, 1);
PED::SET_PED_KEEP_TASK(iLocal_113, 1);
iLocal_95=1;
}}
if(iLocal_95 && !iLocal_141){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_104, 0) && !PED::IS_PED_INJURED(iLocal_113)){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_104, Local_49[0 /*3*/], 20f, 20f, 10f, 0, 1, 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_113, iLocal_104, PLAYER::PLAYER_PED_ID(), 8, 19f, 786469, -1f, -1f, 1);
iLocal_141=1;
}}}
if(func_111()){
if(!PED::IS_PED_INJURED(iLocal_113)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_104, 0)){
if(!iLocal_96){
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_113, 17, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_113, 6, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_113, 1, 1);
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_113, iLocal_104, PLAYER::PLAYER_PED_ID(), 8, 17f, 786469, -1f, -1f, 1);
iLocal_96=1;
}
...
if(!iLocal_78[iVar3]){
if(!PED::IS_PED_INJURED(iLocal_64[iVar3])){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_64[iVar3], 0) && !PED::IS_PED_INJURED(iLocal_113)){
TASK::TASK_DRIVE_BY(iLocal_64[iVar3], PLAYER::PLAYER_PED_ID(), 0, 0.3f, 0.7f, 1.9f, -1f, 15, 0, -753768974);
iLocal_78[iVar3]=1;
}
elseif(!HUD::DOES_BLIP_EXIST(uLocal_119)){
TASK::TASK_COMBAT_PED(iLocal_64[iVar3], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_KEEP_TASK(iLocal_64[iVar3], 1);
if(HUD::DOES_BLIP_EXIST(uLocal_118)){
HUD::REMOVE_BLIP(&uLocal_118);
}
if(!HUD::DOES_BLIP_EXIST(uLocal_114[iVar3])){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_104, 0)){
if(!PED::IS_PED_INJURED(iLocal_64[iVar3])){
if((PED::IS_PED_INJURED(iLocal_113) || VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_104, -1, 0)) || FIRE::IS_ENTITY_ON_FIRE(iLocal_64[iVar3])){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_64[iVar3], 1, 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(iLocal_64[iVar3], uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
PED::SET_PED_KEEP_TASK(iLocal_64[iVar3], 1);
if(!PED::IS_PED_INJURED(iLocal_113)){
...
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(iLocal_113, uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
PED::SET_PED_KEEP_TASK(iLocal_113, 1);
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_100)){
if(ENTITY::IS_ENTITY_ATTACHED(iLocal_100)){
ENTITY::DETACH_ENTITY(iLocal_100, 1, 1);
}
OBJECT::DELETE_OBJECT(&iLocal_100);
func_109();
func_106();
iLocal_43=9;
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_64[0], PLAYER::PLAYER_PED_ID(), 1)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_100)){
if(ENTITY::IS_ENTITY_ATTACHED(iLocal_100)){
ENTITY::DETACH_ENTITY(iLocal_100, 1, 1);
}
...
STREAMING::REQUEST_ANIM_DICT("random@robbery");
}elseif(!PED::IS_PED_INJURED(iLocal_65[0])){
ENTITY::SET_ENTITY_COORDS(iLocal_65[0], -818.5553f, -185.4815f, 36.5689f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_65[0], 47.0582f);
TASK::TASK_PLAY_ANIM(iLocal_65[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0f, 0, 0, 0);
if(!PED::IS_PED_INJURED(iLocal_65[1])){
TASK::TASK_SMART_FLEE_COORD(iLocal_65[1], Local_57, 150f, -1, 0, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_65[1], 0);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_65[1]));
...
if(!PED::IS_PED_INJURED(iLocal_66[iVar4])){
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
TASK::TASK_PLAY_ANIM(0, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, 0, 1, 0);
TASK::TASK_SMART_FLEE_COORD(0, Local_57, 150f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(iLocal_66[iVar4], uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
PED::SET_PED_KEEP_TASK(iLocal_66[iVar4], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_66[iVar4], 0);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_66[iVar4], 1);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_66[iVar4]));
}
iVar4++;
}
iLocal_93=1;
...
ENTITY::SET_ENTITY_COORDS(iLocal_65[0], -1197.455f, -776.0289f, 16.3254f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_65[0], 205.7753f);
TASK::TASK_PLAY_ANIM(iLocal_65[0], "random@robbery", "stand_worried_female", 8f, -8f, -1, 9, 0f, 0, 0, 0);
if(!PED::IS_PED_INJURED(iLocal_65[1])){
TASK::TASK_SMART_FLEE_COORD(iLocal_65[1], Local_57, 150f, -1, 0, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_65[1], 0);
...
if(!PED::IS_PED_INJURED(iLocal_66[iVar5])){
TASK::TASK_SMART_FLEE_COORD(iLocal_66[iVar5], Local_57, 150f, -1, 0, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_66[iVar5], 0);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_66[iVar5], 1);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_66[iVar5]));
}
iVar5++;
}
iLocal_93=1;
...
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_250()) > (fLocal_122 + 150f)){
iLocal_43=12;
}
if(timera() > 120000){
iLocal_43=14;
...
elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_65[0], PLAYER::PLAYER_PED_ID(), 1)){
func_74(2);
func_54();
}
break;
...
TASK::TASK_USE_MOBILE_PHONE_TIMED(iLocal_65[0], 20000);
PED::SET_PED_KEEP_TASK(iLocal_65[0], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_65[0], 0);
iLocal_142=1;
}
}
if(!func_133()){
...
HUD::CLEAR_HELP(1);
MISC::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_65[0], 1), 20f, 0);
HUD::DISPLAY_HUD(0);
HUD::DISPLAY_RADAR(0);
if(iLocal_45==1){
bLocal_110=true;
...
Local_123={
ENTITY::GET_ENTITY_COORDS(iLocal_65[0], 0) 
};
if(iLocal_45==1){
Local_123={
...
uLocal_133=PED::CREATE_SYNCHRONIZED_SCENE(Local_123, Local_125, 2);
uLocal_127=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_127, uLocal_133, sLocal_132, sLocal_128);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_133, sLocal_128, sLocal_129, 1000f, -2f, 5, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_65[0]);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_65[0], uLocal_133, sLocal_128, sLocal_130, 1000f, -2f, 4, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_65[0], 0, 0);
iLocal_100=OBJECT::CREATE_OBJECT(joaat("prop_cs_duffel_01"), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1, 1, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_100, uLocal_133, sLocal_131, sLocal_128, 1000f, 1090519040, 0, 1148846080);
if(!PED::IS_PED_INJURED(iLocal_65[0])){
func_53();
...
if((timera() > 1500 && iLocal_112) && !iLocal_91){
func_51();
wait(0);
if(iLocal_45==1){
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_133) > fLocal_134 && iLocal_112){
if(!PED::IS_PED_INJURED(iLocal_65[0])){
PED::SET_PED_MONEY(iLocal_65[0], iLocal_116);
TASK::CLEAR_PED_TASKS(iLocal_65[0]);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
...
PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 1f, 650, 0, 1, 0, 0);
func_141(0, 1, 1, 0, 0, 0, 0);
...
}}elseif(func_12(iParam0, iVar0, 0)){
...
var func__5(int iParam0, var uParam1){
...
if(func_10()==0){
return MISC::IS_BIT_SET(func_8(func_9(iParam0), -1), iParam1);
}}else{
...
}}elseif(MISC::IS_BIT_SET(Global_113810.f_20567.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_19() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_66[2])){
if(!PED::IS_PED_INJURED(iLocal_66[2])){
ENTITY::SET_ENTITY_COORDS(iLocal_66[2], -820.424f, -181.9059f, 36.5687f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_66[2], 167.7909f);
...
func_39(13, floor(Global_113810.f_10197.f_3853));
}
...
iVar0=ENTITY::GET_ENTITY_MODEL(func_81(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 1)));
switch (iVar0){
...
return (shift_right(iParam0, 26) & 31 * func_91(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_103(){
if(OBJECT::HAS_PICKUP_BEEN_COLLECTED(uLocal_60)){
func_49(joaat("rc_wallets_recovered"), 1);
if(!PED::IS_PED_INJURED(iLocal_65[0])){
uLocal_120=func_171(iLocal_65[0], 0, 145);
}
func_104(&uLocal_146);
fLocal_122=vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_250());
settimera(0);
iLocal_43=10;
}
if(OBJECT::DOES_PICKUP_EXIST(uLocal_60)){
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), OBJECT::GET_PICKUP_COORDS(uLocal_60)) > 200f){
func_162();
}}}
...
int iVar0;
if(!OBJECT::DOES_PICKUP_EXIST(uLocal_60)){
MISC::SET_BIT(&uLocal_58, 3);
MISC::SET_BIT(&uLocal_58, 4);
MISC::SET_BIT(&uLocal_58, 1);
if(!bLocal_94){
if(ENTITY::IS_ENTITY_DEAD(iLocal_64[0], 0)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_64[0])){
Local_59={
PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_64[0], 1067030938, 1069547520) 
};
}}else{
Local_59={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_64[0], 1), 1067030938, 1069547520) 
};
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_104)){
Local_59={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_104, 0), 1067030938, 1069547520) 
};
}
Local_59={
Local_59.f_0, Local_59.f_1, (Local_59.f_2 + 0.25f) 
};
uLocal_60=OBJECT::CREATE_PICKUP(joaat("pickup_money_med_bag"), Local_59, uLocal_58, iLocal_116, 1, joaat("prop_cs_duffel_01"));
uLocal_119=func_107(uLocal_60);
if(iLocal_45==1){
iVar0=0;
while (iVar0 <=(iLocal_61 - 1)){
if(!PED::IS_PED_INJURED(iLocal_64[iVar0])){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_64[iVar0], 1, 1);
TASK::CLEAR_PED_TASKS(iLocal_64[iVar0]);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(iLocal_64[iVar0], uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
PED::SET_PED_KEEP_TASK(iLocal_64[iVar0], 1);
}
iVar0++;
...
if(!PED::IS_PED_INJURED(iLocal_64[0])){
TASK::CLEAR_PED_SECONDARY_TASK(iLocal_64[0]);
if(!TASK::IS_PED_IN_WRITHE(iLocal_64[0])){
func_51();
wait(0);
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_64[0])){
iLocal_82=1;
}elseif(PED::IS_PED_INJURED(iLocal_64[0])){
iLocal_82=1;
}
if(!bLocal_94){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_64[1])){
iLocal_83=1;
}elseif(PED::IS_PED_INJURED(iLocal_64[1])){
iLocal_83=1;
}}else{
iLocal_83=1;
}
...
iLocal_84=1;
}elseif(PED::IS_PED_INJURED(iLocal_113) || !PED::IS_PED_IN_ANY_VEHICLE(iLocal_113, 0)){
iLocal_84=1;
}
...
if(!PED::IS_PED_INJURED(iLocal_64[iVar0]) || ENTITY::IS_ENTITY_DEAD(iLocal_64[iVar0], 0)){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_64[iVar0])){
if(!PED::IS_PED_INJURED(iLocal_64[iVar0])){
if(PED::IS_PED_BEING_JACKED(iLocal_64[iVar0])){
if(PED::GET_PEDS_JACKER(iLocal_64[iVar0])==PLAYER::PLAYER_PED_ID()){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_64[iVar0], 1, 1);
TASK::TASK_SMART_FLEE_PED(iLocal_64[iVar0], PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_64[iVar0], 1);
wait(0);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_64[iVar0]));
return 1;
}}}}
iVar0++;
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_113)){
if(!PED::IS_PED_INJURED(iLocal_113) || ENTITY::IS_ENTITY_DEAD(iLocal_113, 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_113, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}}
if(!PED::IS_PED_INJURED(iLocal_113)){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_113)){
if(!PED::IS_PED_INJURED(iLocal_113)){
if(PED::IS_PED_BEING_JACKED(iLocal_113)){
if(PED::GET_PEDS_JACKER(iLocal_113)==PLAYER::PLAYER_PED_ID()){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_113, 1, 1);
TASK::TASK_SMART_FLEE_PED(iLocal_113, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_113, 1);
wait(0);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_113);
return 1;
}}}}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_104)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_104, 0) || ENTITY::IS_ENTITY_DEAD(iLocal_104, 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_104, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}}}
return 0;
}
...
if(PED::IS_PED_IN_VEHICLE(iLocal_64[0], iLocal_104, 0)){
if(!PED::IS_PED_INJURED(iLocal_64[1])){
if(PED::IS_PED_IN_VEHICLE(iLocal_64[1], iLocal_104, 0)){
return 1;
}}}}}
return 0;
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_146(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
int func_150(){
if(!PED::IS_PED_INJURED(iLocal_64[0]) && !PED::IS_PED_INJURED(iLocal_64[1])){
if(iLocal_45==1){
if(!iLocal_98){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_64[0], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, 1, 0)){
iLocal_98=1;
}}
if(!iLocal_99){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_64[1], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, 1, 0)){
iLocal_99=1;
}}}elseif(iLocal_45==2){
if(!iLocal_98){
if((!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_64[0], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_64[0], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_64[0], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, 1, 0)){
TASK::TASK_SMART_FLEE_PED(iLocal_64[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
iLocal_98=1;
}}
if(!iLocal_99){
if((!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_64[1], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_64[1], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_64[1], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, 1, 0)){
TASK::TASK_SMART_FLEE_PED(iLocal_64[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
iLocal_99=1;
}}}}
...
Var1={
ENTITY::GET_ENTITY_ROTATION(iLocal_100, 2) 
};
OBJECT::DELETE_OBJECT(&iLocal_100);
iLocal_100=OBJECT::CREATE_OBJECT(joaat("prop_cs_duffel_01"), Var0, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_100, Var1, 2, 1);
}


void func_152(){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_64[0])){
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_64[0], 0)) > 200f && ENTITY::IS_ENTITY_OCCLUDED(iLocal_64[0])){
if(HUD::DOES_BLIP_EXIST(uLocal_114[0])){
HUD::REMOVE_BLIP(&(uLocal_114[0]));
}
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_64[0]));
bLocal_80=true;
}}else{
bLocal_80=true;
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_104)){
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_104, 0)) > 200f && ENTITY::IS_ENTITY_OCCLUDED(iLocal_104)){
if(HUD::DOES_BLIP_EXIST(uLocal_118)){
HUD::REMOVE_BLIP(&uLocal_118);
}
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_104);
bLocal_81=true;
}}else{
bLocal_81=true;
}
...
if(ENTITY::GET_ENTITY_HEALTH(iLocal_104) < 800){
ENTITY::SET_ENTITY_HEALTH(iLocal_104, 0, 0);
VEHICLE::SET_VEHICLE_ENGINE_HEALTH(iLocal_104, 10f);
}}}
...
if(PED::IS_PED_INJURED(iLocal_64[iVar0])){
if(HUD::DOES_BLIP_EXIST(uLocal_114[iVar0])){
HUD::REMOVE_BLIP(&(uLocal_114[iVar0]));
}}}
iVar0++;
}}
...
if(!PED::IS_PED_INJURED(iLocal_64[iVar1])){
TASK::TASK_COMBAT_PED(iLocal_64[iVar1], PLAYER::PLAYER_PED_ID(), 0, 16);
}
iVar1++;
}
bLocal_77=true;
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_100) && !PED::IS_PED_INJURED(iLocal_64[0])){
if(!iLocal_107){
iLocal_107=1;
}}}
if(!iLocal_75){
if(iLocal_45==1){
if(timera() > 14100){
OBJECT::DELETE_OBJECT(&(uLocal_101[0]));
OBJECT::DELETE_OBJECT(&(uLocal_101[1]));
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_104, 0)){
if(!PED::IS_PED_INJURED(iLocal_64[0])){
TASK::CLEAR_PED_TASKS(iLocal_64[0]);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
TASK::TASK_CLEAR_LOOK_AT(0);
TASK::TASK_ENTER_VEHICLE(0, iLocal_104, -1, 0, 2f, 1, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(iLocal_64[0], uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
}
if(!PED::IS_PED_INJURED(iLocal_64[1])){
PED::FORCE_PED_MOTION_STATE(iLocal_64[1], joaat("MotionState_Run"), 1, 0, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
TASK::TASK_CLEAR_LOOK_AT(0);
TASK::TASK_ENTER_VEHICLE(0, iLocal_104, -1, 1, 2f, 1, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(iLocal_64[1], uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
}
iLocal_43=2;
iLocal_75=1;
...
if(!PED::IS_PED_INJURED(iLocal_64[0])){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_64[0], 1, 1);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_64[0]);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
TASK::TASK_CLEAR_LOOK_AT(0);
...
if(!PED::IS_PED_INJURED(iLocal_64[1])){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_64[1], 1, 1);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_64[1]);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
TASK::TASK_CLEAR_LOOK_AT(0);
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_133) > 0.453f){
if(!PED::IS_PED_INJURED(iLocal_65[0])){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_65[0], 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
TASK::TASK_PLAY_ANIM(0, "random@robbery", "f_distressed_loop", 2f, -2f, -1, 9, 0f, 0, 0, 0);
...
if(!PED::IS_PED_INJURED(iLocal_64[0])){
TASK::CLEAR_PED_TASKS(iLocal_64[0]);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_64[0], 128, 1);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_64[0], 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_64[0], 17, 1);
PED::SET_PED_MAX_MOVE_BLEND_RATIO(iLocal_64[0], 1.6f);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_64[0], 1, 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_64[0], uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
PED::SET_PED_KEEP_TASK(iLocal_64[0], 1);
settimerb(0);
}
if(!PED::IS_PED_INJURED(iLocal_64[1])){
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_64[1], 128, 1);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_64[1], 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_64[1], 17, 1);
PED::SET_PED_MAX_MOVE_BLEND_RATIO(iLocal_64[1], 1.6f);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_64[1], 1, 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
TASK::TASK_CLEAR_LOOK_AT(0);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_64[1], uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
PED::SET_PED_KEEP_TASK(iLocal_64[1], 1);
}
iLocal_43=2;
iLocal_75=1;
}}
...
uLocal_143=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
CAM::SET_CAM_ACTIVE(uLocal_143, 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_143, uLocal_133, "robbery_action_cam", "random@shop_robbery");
if(iLocal_45==1){
...
break;
case 1:
if(iLocal_145 < MISC::GET_GAME_TIMER()){
if(iLocal_45==1){
...
CAM::SET_CAM_ACTIVE(uLocal_143, 0);
...
if(iLocal_45==1){
if(!iLocal_106){
uLocal_133=PED::CREATE_SYNCHRONIZED_SCENE(Local_124, Local_126, 2);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_133, "random@shop_robbery", "robbery_action_p", 8f, -8f, 1, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 1, 0);
if(((!PED::IS_PED_INJURED(iLocal_64[0]) && !PED::IS_PED_INJURED(iLocal_64[1])) && !PED::IS_PED_INJURED(iLocal_65[0])) && ENTITY::DOES_ENTITY_EXIST(iLocal_100)){
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_64[0], uLocal_133, "random@shop_robbery", "robbery_action_b", 8f, -8f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_64[1], uLocal_133, "random@shop_robbery", "robbery_action_a", 8f, -8f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_65[0], uLocal_133, "random@shop_robbery", "robbery_action_f", 8f, -4f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_100, uLocal_133, "robbery_action_bag", "random@shop_robbery", 8f, -8f, 0, 1148846080);
}
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_133, 0.06f);
iLocal_106=1;
}}elseif(iLocal_45==2){
if(!PED::IS_PED_INJURED(iLocal_65[0])){
TASK::CLEAR_PED_TASKS(iLocal_65[0]);
TASK::TASK_PLAY_ANIM(iLocal_65[0], "random@robbery", "robbery_main_female", 2f, -2f, -1, 0, 0f, 0, 0, 0);
}
STREAMING::NEW_LOAD_SCENE_START_SPHERE(-1195.062f, -773.2098f, 16.324f, 20f, 4);
uLocal_133=PED::CREATE_SYNCHRONIZED_SCENE(Local_124, Local_126, 2);
if(((!PED::IS_PED_INJURED(iLocal_64[0]) && !PED::IS_PED_INJURED(iLocal_64[1])) && !PED::IS_PED_INJURED(iLocal_65[0])) && ENTITY::DOES_ENTITY_EXIST(iLocal_100)){
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_64[0], uLocal_133, "random@shop_robbery", "robbery_action_b", 2f, -2f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_65[0], uLocal_133, "random@shop_robbery", "robbery_action_f", 2f, -2f, 0, 0, 1148846080, 0);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_101[0]) && ENTITY::DOES_ENTITY_EXIST(uLocal_101[1])){
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_101[0], iLocal_65[0], PED::GET_PED_BONE_INDEX(iLocal_65[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_101[1], iLocal_65[0], PED::GET_PED_BONE_INDEX(iLocal_65[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1, 0);
}}
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_133, 0.05f);
Local_124={
...
uLocal_133=PED::CREATE_SYNCHRONIZED_SCENE(Local_124, Local_126, 2);
if(!PED::IS_PED_INJURED(iLocal_64[1])){
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_64[1], uLocal_133, "random@shop_robbery", "robbery_action_a", 2f, -2f, 1, 0, 1148846080, 0);
}
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_133, 0.06f);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
}
iLocal_73=1;
...
if((iLocal_45==1 && ENTITY::DOES_ENTITY_EXIST(iLocal_104)) || iLocal_45==2){
settimera(0);
iLocal_43=1;
}}
...
if(func_160()){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_102, -828.3692f, -194.4669f, 36.41385f, -824.5801f, -201.1353f, 39.39436f, 4.3125f, 0, 1, 0)){
Local_103={
...
iLocal_104=VEHICLE::CREATE_VEHICLE(iVar0, Local_103, 31.9252f, 1, 1, 0);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_104, 1, 1);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_104, 1084227584);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_104, 1, 1, 0);
iLocal_113=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_104, 26, joaat("g_m_y_korean_01"), -1, 1, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_113, 134, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_113, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_113, iLocal_117);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_113, 8, 0);
PED::SET_PED_COMBAT_ABILITY(iLocal_113, 0);
PED::SET_PED_ACCURACY(iLocal_113, 13);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_113, joaat("weapon_pistol"), -1, 1, 1);
ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_113, 1, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_113, 42, 1);
iLocal_105=1;
}}
...
uLocal_102=iVar0;
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(uLocal_102)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_102, 1, 0);
}
return 1;
}}
return 0;
...
var func__171(var uParam0, bool bParam1, int iParam2){
var uVar0;
...
if(!PED::IS_PED_INJURED(iLocal_64[0]) && !PED::IS_PED_INJURED(iLocal_64[1])){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_64[0], PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_64[1], PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}
if(PED::CAN_PED_SEE_HATED_PED(iLocal_64[0], PLAYER::PLAYER_PED_ID()) || PED::CAN_PED_SEE_HATED_PED(iLocal_64[1], PLAYER::PLAYER_PED_ID())){
if(((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_64[0]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_64[0])) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_64[1])) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_64[1])){
if(iLocal_67==-1){
iLocal_67=MISC::GET_GAME_TIMER();
}}else{
iLocal_67=-1;
}
if(iLocal_67 !=-1 && MISC::GET_GAME_TIMER() > iLocal_67 + 1500){
return 1;
}}}}
if(FIRE::IS_EXPLOSION_IN_AREA(-1, Local_121 - Vector(20f, 20f, 20f), Local_121 + Vector(20f, 20f, 20f))){
return 1;
}
if(ENTITY::IS_ENTITY_DEAD(iLocal_64[0], 0) || ENTITY::IS_ENTITY_DEAD(iLocal_64[1], 0)){
return 1;
}
...
if(!PED::IS_PED_INJURED(iLocal_64[0]) && !PED::IS_PED_INJURED(iLocal_64[1])){
if(((PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_64[1], 1) - Vector(12f, 12f, 12f), ENTITY::GET_ENTITY_COORDS(iLocal_64[1], 1) + Vector(12f, 12f, 12f), 0, 1) && !WEAPON::IS_PED_CURRENT_WEAPON_SILENCED(PLAYER::PLAYER_PED_ID())) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_64[0], 1), 3f, 1)) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_64[1], 1), 3f, 1)){
return 1;
}}
iVar0=0;
while (iVar0 < iLocal_65){
...
void func_175(){
if(!PED::IS_PED_INJURED(iLocal_65[1])){
if(PED::IS_PED_MALE(iLocal_65[1])){
func_176(iLocal_65[1], "WHIMPER", "WAVELOAD_PAIN_MALE", 3);
}else{
func_176(iLocal_65[1], "WHIMPER", "WAVELOAD_PAIN_FEMALE", 3);
}
AUDIO::PLAY_PAIN(iLocal_65[1], 26, 0, 0);
}
if(!PED::IS_PED_INJURED(iLocal_66[1])){
func_176(iLocal_66[1], "SCREAM_PANIC", "WAVELOAD_PAIN_FEMALE", 3);
AUDIO::PLAY_PAIN(iLocal_66[1], 3, 0, 0);
}}


void func_176(var uParam0, char* sParam1, char* sParam2, int iParam3){
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(uParam0, sParam1, sParam2, func_177(iParam3), 0);
}
...
PED::ADD_RELATIONSHIP_GROUP("ROBBERS", &iLocal_117);
iVar0=0;
while (iVar0 <=(iLocal_61 - 1)){
iLocal_64[iVar0]=PED::CREATE_PED(26, iLocal_139, Local_49[iVar0 /*3*/], fLocal_50[iVar0], 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_64[iVar0], 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_64[iVar0], iLocal_117);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_64[iVar0], 8, 0);
PED::SET_PED_COMBAT_ABILITY(iLocal_64[iVar0], 0);
PED::SET_PED_ACCURACY(iLocal_64[iVar0], 13);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_64[iVar0], joaat("weapon_pistol"), -1, 1, 1);
ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_64[iVar0], 1, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_64[iVar0], 42, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_64[iVar0], 269, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_64[iVar0], 188, 1);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_64[iVar0], 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_64[iVar0], 128, 1);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_64[iVar0], 8, 1);
iVar0++;
}
PED::SET_PED_NAME_DEBUG(iLocal_64[0], "pedRobber[0]");
PED::SET_PED_NAME_DEBUG(iLocal_64[1], "pedRobber[1]");
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_117, joaat("player"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_117);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_117, joaat("COP"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("COP"), iLocal_117);
if(func_43()==0){
func_183(&uLocal_149, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
}elseif(func_43()==1){
func_183(&uLocal_149, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}elseif(func_43()==2){
func_183(&uLocal_149, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
}
iLocal_100=OBJECT::CREATE_OBJECT(iLocal_115, Local_55, 1, 1, 0);
if(iLocal_45==1){
PED::ADD_SCENARIO_BLOCKING_AREA(Local_69 - Vector(20f, 20f, 20f), Local_69 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("baller"), 1);
uLocal_101[0]=OBJECT::CREATE_OBJECT(joaat("prop_anim_cash_pile_01"), Local_55, 1, 1, 0);
uLocal_101[1]=OBJECT::CREATE_OBJECT(joaat("prop_anim_cash_pile_01"), Local_55 - Vector(0.1f, 0f, 0f), 1, 1, 0);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_64[0], "G_M_Y_KorLieut_01_Korean_MINI_01");
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_64[1], "G_M_Y_Korean_01_Korean_MINI_02");
Local_124={
...
uLocal_133=PED::CREATE_SYNCHRONIZED_SCENE(Local_124, Local_126, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_133, 1);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_64[1], uLocal_133, "random@shop_robbery", "robbery_intro_loop_a", 8f, -8f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_100, uLocal_133, "robbery_intro_loop_bag", "random@shop_robbery", 1000f, 1090519040, 0, 1148846080);
iVar0=0;
while (iVar0 <=(iLocal_62 - 1)){
iLocal_65[iVar0]=PED::CREATE_PED(26, iLocal_136, Local_51[iVar0 /*3*/], fLocal_52[iVar0], 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_65[iVar0], 17, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_65[iVar0], 1);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_65[iVar0], 0);
PED::SET_PED_CONFIG_FLAG(iLocal_65[iVar0], 269, 1);
iVar0++;
}
PED::SET_PED_NAME_DEBUG(iLocal_65[0], "pedWorker[0]");
PED::SET_PED_NAME_DEBUG(iLocal_65[1], "pedWorker[1]");
PED::SET_PED_NAME_DEBUG(iLocal_65[2], "pedWorker[2]");
iLocal_66[0]=PED::CREATE_PED(26, iLocal_137, Local_53[0 /*3*/], fLocal_54[0], 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_66[0], 17, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_66[0], 1);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_66[0], 0);
PED::SET_PED_CONFIG_FLAG(iLocal_66[0], 269, 1);
iVar0=1;
while (iVar0 <=2){
iLocal_66[iVar0]=PED::CREATE_PED(26, iLocal_138, Local_53[iVar0 /*3*/], fLocal_54[iVar0], 1, 1);
...
PED::SET_PED_NAME_DEBUG(iLocal_66[0], "pedShopper[0]");
PED::SET_PED_NAME_DEBUG(iLocal_66[1], "pedShopper[1]");
PED::SET_PED_NAME_DEBUG(iLocal_66[2], "pedShopper[2]");
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[0], 0, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[0], 2, 1, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[0], 3, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[0], 4, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[0], 5, 0, 0, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_65[0], uLocal_133, "random@shop_robbery", "robbery_intro_loop_f", 8f, -8f, 0, 0, 1148846080, 0);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_65[0], "A_M_Y_BevHills_01_White_Mini_01");
func_183(&uLocal_149, 5, iLocal_65[0], "REROBShopworker", 0, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[1], 0, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[1], 2, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[1], 3, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[1], 4, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[1], 5, 0, 0, 0);
TASK::TASK_COWER(iLocal_65[1], -1);
PED::SET_PED_KEEP_TASK(iLocal_65[1], 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[2], 0, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[2], 2, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[2], 3, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[2], 4, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_65[2], 5, 0, 0, 0);
TASK::TASK_COWER(iLocal_65[2], -1);
PED::SET_PED_KEEP_TASK(iLocal_65[2], 1);
uLocal_133=PED::CREATE_SYNCHRONIZED_SCENE(-812.37f, -185.65f, 37.5804f, 0f, 0f, 30f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_133, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[0], 0, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[0], 2, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[0], 3, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[0], 4, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[0], 8, 0, 0, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_66[0], uLocal_133, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
PED::SET_PED_KEEP_TASK(iLocal_66[0], 1);
uLocal_133=PED::CREATE_SYNCHRONIZED_SCENE(-817.5606f, -190.8273f, 37.6114f, 0f, 0f, 25.8399f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_133, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[1], 0, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[1], 2, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[1], 3, 1, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[1], 4, 1, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[1], 8, 0, 0, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_66[1], uLocal_133, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
PED::SET_PED_KEEP_TASK(iLocal_66[1], 1);
uLocal_133=PED::CREATE_SYNCHRONIZED_SCENE(-816.1862f, -182.897f, 37.68f, 0f, 0f, 30f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_133, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[2], 0, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[2], 2, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[2], 3, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[2], 4, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_66[2], 8, 0, 0, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_66[2], uLocal_133, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
PED::SET_PED_KEEP_TASK(iLocal_66[2], 1);
TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_64[0], iLocal_65[0], -1, 0);
...
ENTITY::SET_ENTITY_ROTATION(iLocal_100, Local_56, 2, 1);
iLocal_65[0]=PED::CREATE_PED(26, iLocal_136, Local_51[0 /*3*/], fLocal_52[0], 1, 1);
PED::SET_PED_NAME_DEBUG(iLocal_65[0], "pedWorker[0]");
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_65[0], "A_M_Y_BeachVesp_01_White_Mini_01");
func_183(&uLocal_149, 6, iLocal_65[0], "REROBShopworker2", 0, 1);
iLocal_65[1]=PED::CREATE_PED(26, iLocal_135, Local_51[1 /*3*/], fLocal_52[1], 1, 1);
PED::SET_PED_NAME_DEBUG(iLocal_65[1], "pedWorker[1]");
iVar0=0;
while (iVar0 <=(iLocal_62 - 1)){
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_65[iVar0], 17, 1);
...
iLocal_66[0]=PED::CREATE_PED(26, iLocal_137, Local_53[0 /*3*/], fLocal_54[0], 1, 1);
PED::SET_PED_NAME_DEBUG(iLocal_66[0], "pedShopper[0]");
iLocal_66[1]=PED::CREATE_PED(26, iLocal_138, Local_53[1 /*3*/], fLocal_54[1], 1, 1);
PED::SET_PED_NAME_DEBUG(iLocal_66[1], "pedShopper[1]");
iVar0=0;
...
TASK::TASK_PLAY_ANIM(iLocal_65[0], "random@shop_robbery", "robbery_intro_loop_f", 4f, -4f, -1, 9, 0f, 0, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_65[0], 1);
TASK::TASK_PLAY_ANIM(iLocal_65[1], "random@robbery", "f_cower_02", 4f, -4f, -1, 9, 0f, 0, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_65[1], 1);
TASK::TASK_COWER(iLocal_66[0], -1);
PED::SET_PED_KEEP_TASK(iLocal_66[0], 1);
TASK::TASK_PLAY_ANIM(iLocal_66[1], "random@robbery", "f_cower_01", 4f, -4f, -1, 9, 0f, 0, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_66[1], 1);
Local_124={
...
uLocal_133=PED::CREATE_SYNCHRONIZED_SCENE(Local_124, Local_126, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_133, 1);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_64[0], uLocal_133, "random@shop_robbery", "robbery_intro_loop_b", 2f, -2f, 0, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_65[0], uLocal_133, "random@shop_robbery", "robbery_intro_loop_f", 2f, -2f, 0, 0, 1148846080, 0);
TASK::TASK_PLAY_ANIM(iLocal_64[1], "random@shop_robbery", "robbery_intro_loop_a", 16f, -4f, -1, 9, 0f, 0, 0, 0);
func_182(14, 1);
func_181(14);
wait(500);
func_179(14, 0, 0);
...
void func_184(){
if(!iLocal_72){
iLocal_86=INTERIOR::GET_INTERIOR_AT_COORDS(Local_49[0 /*3*/]);
INTERIOR::PIN_INTERIOR_IN_MEMORY(iLocal_86);
iLocal_72=1;
}}


void func_185(){
STREAMING::REQUEST_MODEL(iLocal_136);
...
if((((((((((STREAMING::HAS_MODEL_LOADED(iLocal_136) && STREAMING::HAS_MODEL_LOADED(iLocal_137)) && STREAMING::HAS_MODEL_LOADED(iLocal_138)) && STREAMING::HAS_MODEL_LOADED(iLocal_139)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_anim_cash_pile_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_cs_duffel_01"))) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED("re_shoprobbery")) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED("re_shoprobbery2")) && STREAMING::HAS_ANIM_DICT_LOADED("random@robbery")) && STREAMING::HAS_ANIM_DICT_LOADED("random@shop_robbery")) && AUDIO::PREPARE_MUSIC_EVENT("RE51A_SHOP")){
iLocal_47=1;
}else{
STREAMING::REQUEST_MODEL(iLocal_136);
STREAMING::REQUEST_MODEL(iLocal_137);
...
if(vmag2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_198()){
return 0;
}}
if(func_194()){
return 1;
...
if(!func_228(Global_113810.f_24998.f_43[iParam1])){
return 0;
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_226()) || Global_112857) || Global_32286) || func_225()) || func_130(8, -1)) || func_224()) || func_223()) || func_222()) || func_221()) || Global_113810.f_7691.f_919[bVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_226()) || Global_32286) || func_225()) || func_130(8, -1)) || func_222()) || func_224()) || func_223()) || func_221()) || Global_113810.f_7691.f_919[bVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_226()) || Global_112857) || Global_32286) || func_225()) || func_130(8, -1)) || func_224()) || func_223()) || func_221()) || Global_113810.f_7691.f_919[bVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_226()) || Global_32286) || func_225()) || func_130(8, -1)) || func_223()) || func_222()) || func_221()) || Global_113810.f_7691.f_919[bVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_226()) || func_223()) || Global_112857) || Global_32286) || func_225()) || Global_44569) || func_130(8, -1)) || func_222()) || func_220()) || func_221()) || Global_113810.f_7691.f_919[bVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_226()) || Global_112857) || Global_32286) || func_225()) || func_130(8, -1)) || func_222()) || func_220()) || func_224()) || func_223()) || func_221()){
return 0;
}
break;
}}else{
...
while (iVar0 <=(iLocal_61 - 1)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_64[iVar0])){
if(!PED::IS_PED_INJURED(iLocal_64[iVar0]) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_64[iVar0], 0)){
TASK::TASK_SMART_FLEE_COORD(iLocal_64[iVar0], Local_57, 150f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_64[iVar0], 1);
}
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_64[iVar0]));
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_66[iVar0])){
if(!PED::IS_PED_INJURED(iLocal_66[iVar0])){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_66[iVar0], 1, 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
if(iLocal_45==1){
TASK::TASK_PLAY_ANIM(0, "random@robbery", "exit_flee", 4f, -4f, -1, 5632, 0f, 0, 1, 0);
}elseif(iLocal_45==2){
...
TASK::TASK_SMART_FLEE_COORD(0, Local_57, 150f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(iLocal_66[iVar0], uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
PED::SET_PED_KEEP_TASK(iLocal_66[iVar0], 1);
}}
iVar0++;
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_65[iVar0])){
if(!PED::IS_PED_INJURED(iLocal_65[iVar0])){
PED::SET_PED_CONFIG_FLAG(iLocal_65[iVar0], 317, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_65[iVar0], 1, 1);
if(iVar0==0){
if(!iLocal_112){
TASK::CLEAR_PED_TASKS(iLocal_65[iVar0]);
TASK::TASK_SMART_FLEE_COORD(iLocal_65[iVar0], Local_57, 150f, -1, 0, 0);
}
else{
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_65[iVar0], 0);
}}else{
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
if(iLocal_45==2){
TASK::CLEAR_PED_TASKS(iLocal_65[iVar0]);
...
TASK::TASK_SMART_FLEE_COORD(0, Local_57, 150f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(iLocal_65[iVar0], uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
}
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_65[iVar0], 0);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_65[iVar0], 1);
}}
iVar0++;
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_113)){
...
iLocal_68=1;
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_70, 1) < fVar0){
