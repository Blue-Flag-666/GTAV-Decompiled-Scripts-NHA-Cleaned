...
func_26(uParam0);
func_18(uParam0);
uVar7=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_85.f_1);
...
break;
case 8:
uVar8=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_85.f_1);
...
int func_70(){
if(Global_1853830 !=func_60()){
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_reception_seats", Global_1853830, 1, 0)){
return 0;
}
...
func_77(func_78(iVar2), fVar1) + Var0 
};
(uParam1[(*iParam2)[iVar2] /*14*/])->f_8.f_3={
0f, 0f, (fVar1 + 174f) 
};
(uParam1[(*iParam2)[iVar2] /*14*/])->f_1={
func_77(func_76(iVar2), fVar1) + Var0 
};
(uParam1[(*iParam2)[iVar2] /*14*/])->f_1.f_3={
func_77(func_75(iVar2), fVar1) + Var0 
};
