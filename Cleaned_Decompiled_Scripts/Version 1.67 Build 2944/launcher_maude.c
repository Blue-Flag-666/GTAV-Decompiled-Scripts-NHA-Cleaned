...
iVar2[0]=31;
if(!func_260(&iVar2, &Var0, Var1, 1f)){
func_259();
...
func_202(Var0.f_0);
func_194(&iLocal_51, &(Var0.f_9), Var1);
if(func_179(&Var0, 0)){
if(!func_2(&Var0)){
func_263(&Var0, 1);
}
...
func_280("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_183(uParam0->f_27)){
func_182(uParam0->f_27, *uParam0);
func_280("RC5_IN_ACTIVATION_RANGE:
...
if(func_183(1)){
func_182(1, *uParam0);
func_280("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_280("RC_STOP_PLAYER_VEHICLE_CHECK:
...
struct<27> Var0;
if(Global_78689){
func_280("IS_RC_FINE_AND_IN_RANGE():
...
uParam1->f_3=5;
}elseif((func_206(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
uVar0=func_218(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
...
float fVar2;
Var0={
func_223(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
float fVar2;
Var0={
func_223(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
if(fParam2 < 0.1f || fParam2 > 360f){
return 1;
}
...
int func_243(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_244(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
int func_244(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_36(iParam1)){
...
void func_246(var uParam0, var uParam1, struct<3> Param2, float fParam3){
func_209(uParam0);
...
case 31:
if(bParam1){
uLocal_50=PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var1, 0, 1, 1, 1);
...
int func_260(int iParam0, int iParam1, struct<3> Param2, float fParam3){
int iVar0;
if(*iParam0==1){
if(func_261((*iParam0)[0], Param2, fParam3, iParam1)){
return 1;
}}else{
iVar0=0;
while (iVar0 < *iParam0){
if(func_261((*iParam0)[iVar0], Param2, fParam3, iParam1)){
iVar0=*iParam0;
return 1;
}
iVar0++;
...
int func_261(int iParam0, struct<3> Param1, float fParam2, var uParam3){
int iVar0;
struct<7> Var1;
iVar0=0;
func_119(iParam0, &Var1);
if(func_262(Var1.f_6, Param1, fParam2, 0)){
...
int func_262(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
