...
}elseif(bVar14 || ((!func_14(PLAYER::PLAYER_ID(), 0) && !func_13()) && !func_12(PLAYER::PLAYER_ID()))){
...
if((((((((((((func_76(uParam0) || func_72(uParam0)) || func_71(uParam0)) || !func_70(uParam0)) || func_68(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || MISC::IS_BIT_SET(Global_1950844.f_4, 2)) || func_67(uParam0->f_16[uParam0->f_9 /*14*/].f_13)){
...
Var2={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_55(uParam0), func_54(uParam0), 0, 2) 
};
Var3={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_55(uParam0), func_54(uParam0), 0, 2) 
};
uVar4=Var3.f_2;
fVar5=0.05f;
...
fVar8=Var7.f_2;
if((iVar6 !=1 && iVar6 !=0) || func_41(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), fVar8, 5f)){
if(uParam0->f_1.f_1==3){
if(CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(0)==4){
if(!func_57(&(uParam0->f_7), 13)){
CAM::SET_CAM_VIEW_MODE_FOR_CONTEXT(0, 1);
...
PAD::DISABLE_CONTROL_ACTION(0, 0, 1);
uParam0->f_8=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_55(uParam0), func_54(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
...
iVar1=0;
while (iVar1 < 10){
if(((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar1]) && !PED::IS_PED_INJURED(uVar0[iVar1])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar1])) && func_80(uVar0[iVar1], &(uParam0->f_16[uParam0->f_9 /*14*/]))){
return 1;
}
iVar1++;
}
...
return 1;
}}elseif(func_41(ENTITY::GET_ENTITY_HEADING(iParam0), Param1.f_2, 45f)){
return 1;
}}
return 0;
}
...
var func__80(var uParam0, var uParam1){
...
func_87(&(uParam0->f_7), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
func_87(&(uParam0->f_7), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
...
int func_103(){
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("music_studio_seating", func_114(), 1, 0)){
return 0;
}
...
func_107(func_109(), func_108(iParam3, fVar1)) + Var0 
};
uParam1->f_16[iParam2 /*14*/].f_6.f_4={
func_107(func_106(), func_108(iParam3, fVar1)) + Var0 
};
...
Vector3 func__107(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
