...
uLocal_50=func_286(54);
iLocal_51=joaat("dune");
iLocal_52=WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_sniperrifle"));
iLocal_53=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("component_at_scope_large"));
iLocal_54=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("component_at_ar_supp_02"));
Local_55={
...
if(!func_267(&iVar2, &Var0, Var1, 1f)){
func_266();
...
func_206(Var0.f_0);
func_199(&iLocal_57, &(Var0.f_9), Var1);
if(Var0.f_0==25){
func_194(&Var0, Var1, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
}
...
if(func_179(&Var0, 0) && MISC::ABSF((Var1.f_2 - Var3.f_2)) < 2.5f){
if(!func_2(&Var0)){
func_270(&Var0, 1);
}
if(func_1(&Var0)){
...
func_283("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_183(iParam0->f_27)){
func_182(iParam0->f_27, *iParam0);
func_283("RC5_IN_ACTIVATION_RANGE:
...
if(func_183(1)){
func_182(1, *iParam0);
func_283("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_283("RC_STOP_PLAYER_VEHICLE_CHECK:
...
int func_194(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7){
var uVar0;
if((((func_136(PLAYER::PLAYER_PED_ID()) && func_136(iParam0->f_28[0])) && !func_156()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_198(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7){
uVar0=16;
func_197(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
...
void func_195(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5){
...
float func_198(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
Var0={
...
struct<27> Var0;
if(Global_78689){
func_283("IS_RC_FINE_AND_IN_RANGE():
...
uParam1->f_3=5;
}elseif((func_210(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
uVar0=func_222(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
...
float fVar2;
Var0={
func_227(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
float fVar2;
Var0={
func_227(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
if(fParam2 < 0.1f || fParam2 > 360f){
return 1;
}
...
func_247(&(uParam0->f_35[0]), -685.2281f, 5833.982f, 16.331f, 313.2204f, 0);
}
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_56)){
iLocal_56=WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_sniperrifle"), 0, Local_55, 0, 1065353216, 0, 0, 1);
WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iLocal_56, joaat("component_at_scope_large"));
WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iLocal_56, joaat("component_at_ar_supp_02"));
}
if(bVar2){
iLocal_49=3;
}
...
if(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_55, 1f, iLocal_52, 0)){
ENTITY::SET_ENTITY_ROTATION(iLocal_56, 0f, -90f, -162.64f, 2, 1);
}
iVar1=0;
while (iVar1 <=(iVar0 - 1)){
...
void func_247(var uParam0, struct<3> Param1, float fParam2, int iParam3){
func_248(uParam0, iLocal_51, Param1, fParam2);
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
void func_248(var uParam0, int iParam1, struct<3> Param2, var uParam3){
func_249(uParam0);
...
int func_250(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_251(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
int func_251(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_36(iParam1)){
...
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])){
func_247(&(uParam0->f_35[0]), 1806.732f, 3934.353f, 33.3275f, 76.1155f, 0);
