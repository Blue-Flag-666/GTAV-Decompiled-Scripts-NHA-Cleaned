...
break;
case 2:
if(!SCRIPT::IS_THREAD_ACTIVE(iLocal_237)){
func_4(1);
iLocal_52=3;
iLocal_49=0;
}
...
func_2(0);
}elseif(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&Global_112866))==0){
func_2(0);
}}}
...
if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_238, "HAIL_TAXI", 3)){
ENTITY::STOP_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), "HAIL_TAXI", &cLocal_238, -2f);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_238, "FP_HAIL_TAXI", 3)){
ENTITY::STOP_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), "FP_HAIL_TAXI", &cLocal_238, -2f);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_238, "FUCK_U", 3)){
ENTITY::STOP_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), "FUCK_U", &cLocal_238, -2f);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_238, "FORGET_IT", 3)){
ENTITY::STOP_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), "FORGET_IT", &cLocal_238, -2f);
}
if(iLocal_63 !=-1){
...
STREAMING::REMOVE_ANIM_DICT(&cLocal_238);
if(iLocal_63 !=-1){
func_8(&iLocal_63);
}
if(func_7("TXM_H01")){
...
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112842, &cLocal_238, "Aknowledge_R", 3)){
ENTITY::STOP_ENTITY_ANIM(Global_112842, "Aknowledge_R", &cLocal_238, -4f);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112842, &cLocal_238, "Aknowledge_L", 3)){
ENTITY::STOP_ENTITY_ANIM(Global_112842, "Aknowledge_L", &cLocal_238, -4f);
}}}
if(iLocal_52==0){
func_6();
}
...
if(ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Local_54.f_1, 0)){
if(Local_54.f_1 !=Global_112842){
if(!PED::IS_PED_INJURED(Local_54.f_1)){
PED::SET_PED_CONFIG_FLAG(Local_54.f_1, 251, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_54.f_1, 0);
if(!PED::IS_PED_FLEEING(Local_54.f_1) && !PED::IS_PED_IN_COMBAT(Local_54.f_1, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(Local_54.f_1, 0)){
if(ENTITY::DOES_ENTITY_EXIST(Local_54.f_0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Local_54.f_0, 0)){
if(PED::IS_PED_SITTING_IN_VEHICLE(Local_54.f_1, Local_54.f_0)){
TASK::OPEN_SEQUENCE_TASK(&uVar0);
if((!VEHICLE::IS_VEHICLE_SEAT_FREE(Local_54.f_0, 1, 0) || !VEHICLE::IS_VEHICLE_SEAT_FREE(Local_54.f_0, 2, 0)) || !VEHICLE::IS_VEHICLE_SEAT_FREE(Local_54.f_0, 0, 0)){
TASK::TASK_PAUSE(0, 2000);
}
else{
TASK::TASK_PAUSE(0, 500);
...
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(Local_54.f_1, uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
}
else{
TASK::TASK_SMART_FLEE_PED(Local_54.f_1, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
}}else{
TASK::TASK_SMART_FLEE_PED(Local_54.f_1, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
}}
}
else{
TASK::TASK_WANDER_STANDARD(Local_54.f_1, 1193033728, 0);
}}}
...
if(ENTITY::DOES_ENTITY_EXIST(Local_54.f_0)){
if(ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Local_54.f_0, 0)){
...
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_67);
}
Local_54.f_0=0;
Local_54.f_1=0;
Local_54.f_2=0;
...
void func_16(){
if(func_22(&Global_112841, iLocal_68, iLocal_67)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_112841, 0)){
...
func_20(&Global_112841, iLocal_244);
...
if(SCRIPT::HAS_SCRIPT_LOADED("taxiService")){
iLocal_237=start_new_script("taxiService", 1828);
SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("taxiService");
iLocal_49=2;
}}}else{
func_4(1);
...
if(PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_242)){
iVar0=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_242, -1, 0);
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_242, 1, 0)){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_242, 1, 0)==PLAYER::PLAYER_PED_ID()){
iLocal_244=1;
}}
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_242, 2, 0)){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_242, 2, 0)==PLAYER::PLAYER_PED_ID()){
iLocal_244=2;
}}
if(iLocal_53==4 || iLocal_53==2){
if(iLocal_242 !=Global_112841){
func_5();
}}
func_21();
...
if(!iLocal_57){
if(iLocal_242==Global_112841 && iLocal_53==4){
...
if(ENTITY::DOES_ENTITY_EXIST(iVar0)){
if(iVar0==iLocal_242){
iVar1=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_242, -1, 0);
if(iLocal_53==4 || iLocal_53==2){
if(iLocal_242 !=Global_112841){
func_5();
}}
...
void func_32(){
if(func_42(&Global_112841, &Global_112842, iLocal_68, iLocal_67)){
if(!func_36()){
if(!func_19(Global_112842, joaat("script_task_vehicle_temp_action"))){
TASK::TASK_VEHICLE_TEMP_ACTION(Global_112842, Global_112841, 1, 1000000);
}
...
func_33();
if(HUD::DOES_BLIP_EXIST(uLocal_61)){
HUD::SET_BLIP_FLASH_TIMER(uLocal_61, 10000);
}}else{
func_5();
}}else{
func_5();
...
}elseif(func_41(Global_112878, 30000)){
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Global_112841, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Global_112842, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}}else{
return 1;
}
...
void func_43(){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_238, "HAIL_TAXI", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_238, "FP_HAIL_TAXI", 3)){
return;
}elseif(func_41(iLocal_65, 3000)){
STREAMING::REQUEST_ANIM_DICT(&cLocal_238);
if(STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_238)){
if(func_44()){
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 113, 1);
if(MISC::GET_RANDOM_INT_IN_RANGE(0, 3) < 2){
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_238, "FORGET_IT", 4f, -2f, -1, 48, 0, 0, 0, 0);
}else{
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_238, "FUCK_U", 4f, -2f, -1, 48, 0, 0, 0, 0);
}}
...
if(((!ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_238, "HAIL_TAXI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_238, "FP_HAIL_TAXI", 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_238, "FUCK_U", 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_238, "FORGET_IT", 3)){
...
TASK::TASK_PLAY_ANIM(0, &cLocal_238, "Aknowledge_R", 8f, -4f, -1, 16785456, 0, 0, 0, 0);
}else{
TASK::TASK_PLAY_ANIM(0, &cLocal_238, "Aknowledge_L", 8f, -4f, -1, 16785456, 0, 0, 0, 0);
}
TASK::TASK_VEHICLE_MISSION(0, Global_112841, Global_112841, 22, 12f, 262275, 3f, 3f, 1);
TASK::TASK_VEHICLE_MISSION(0, Global_112841, Global_112841, 5, 12f, 262275, 3f, 3f, 1);
TASK::CLOSE_SEQUENCE_TASK(uVar2);
TASK::TASK_PERFORM_SEQUENCE(Global_112842, uVar2);
...
if(func_39(Global_112841)){
if(!HUD::DOES_BLIP_EXIST(uLocal_61)){
uLocal_61=HUD::ADD_BLIP_FOR_ENTITY(Global_112841);
HUD::SET_BLIP_SPRITE(uLocal_61, 198);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_61, "TXM_BLIP");
HUD::SET_BLIP_FLASHES(uLocal_61, 1);
HUD::SET_BLIP_FLASH_TIMER(uLocal_61, 10000);
}}}
...
if(!VEHICLE::IS_TAXI_LIGHT_ON(iLocal_243)){
VEHICLE::SET_TAXI_LIGHTS(iLocal_243, 1);
}
}
if(iLocal_63==-1){
...
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_243, 5000, 0, 2);
func_60();
func_59();
iLocal_65=MISC::GET_GAME_TIMER();
func_8(&iLocal_63);
if(func_63(&iLocal_243)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_243, 0)){
VEHICLE::SET_TAXI_LIGHTS(iLocal_243, 0);
}
iLocal_56=0;
iLocal_53=3;
}else{
iVar0=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_243, -1, 0);
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
if(!CAM::IS_GAMEPLAY_HINT_ACTIVE()){
CAM::SET_GAMEPLAY_VEHICLE_HINT(Global_112841, 0f, 0f, 0f, 1, 4000, 2000, 2000);
iLocal_56=1;
}
}
Global_113810.f_10052.f_120=1;
...
if(iLocal_51==0){}elseif(iLocal_51==1){
func_99();
}elseif(iLocal_51==2){
func_74();
}elseif(iLocal_51==3){
...
Global_112878=0;
if(func_39(Global_112841)){
VEHICLE::START_VEHICLE_HORN(Global_112841, 2500, MISC::GET_HASH_KEY("NORMAL"), 0);
}
if(ENTITY::DOES_ENTITY_EXIST(Global_112842)){
if(!PED::IS_PED_INJURED(Global_112842)){
...
struct<3> Var0;
Var0={
ENTITY::GET_ENTITY_COORDS(Local_54.f_0, 0) 
};
if(!Local_54.f_2){
if(!Local_54.f_3){
if(func_68(Var0, Local_54.f_14, Local_54.f_6, &(Local_54.f_17), &(Local_54.f_6))){
if(!ENTITY::IS_ENTITY_DEAD(Local_54.f_1, 0)){
PED::SET_DRIVER_ABILITY(Local_54.f_1, 0.5f);
if(Local_54.f_4){
TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_54.f_1, Local_54.f_0, Local_54.f_17, 10f, 0, ENTITY::GET_ENTITY_MODEL(Local_54.f_0), Local_54.f_29, 5f, MISC::GET_DISTANCE_BETWEEN_COORDS(Var0, Local_54.f_17, 1));
Local_54.f_4=0;
}else{
TASK::TASK_VEHICLE_PARK(Local_54.f_1, Local_54.f_0, Local_54.f_17, Local_54.f_6, 3, 90f, 1);
}}
Local_54.f_2=1;
}}else{
PED::SET_DRIVER_ABILITY(Local_54.f_1, 0.5f);
...
Local_54.f_2=1;
}}elseif(!func_19(Local_54.f_1, joaat("script_task_vehicle_park"))){
...
return 1;
}elseif(func_38(Var0, Local_241, 5f)){
Local_54.f_14={
Local_241 
};
return 1;
}elseif(!func_19(Local_54.f_1, joaat("script_task_vehicle_drive_to_coord"))){
Local_54.f_2=0;
Local_54.f_8=0;
}}
return 0;
...
STREAMING::REQUEST_MODEL(iLocal_67);
...
Local_54.f_5=func_77(ENTITY::GET_ENTITY_COORDS(Local_54.f_0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
Local_54.f_2=0;
Local_54.f_8=0;
iLocal_51=2;
}}elseif(Local_54.f_8 >=5){
Local_54.f_10++;
if(Local_54.f_10 > 10){
func_13();
}
...
*uParam0=VEHICLE::CREATE_VEHICLE(func_146(), Param2, uParam3, 1, 1, 0);
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam0, 0)){
...
return 1;
}}elseif(PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(Var14, *uParam2, &Var0, &fVar3, &uVar4, iParam3, fVar8, fVar9)){
while (!bVar6 && iVar7 < 5){
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_54.f_1, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}
Var0={
ENTITY::GET_ENTITY_COORDS(Local_54.f_0, 0) 
...
if(ENTITY::GET_ENTITY_MODEL(uVar13[iVar4])==iLocal_68){
Var9={
ENTITY::GET_ENTITY_COORDS(uVar13[iVar4], 0) 
};
fVar10=vdist2(Local_241, Var9);
...
iLocal_242=0;
}elseif(iLocal_242 !=uVar13[iVar2]){
func_109(&iLocal_242, 0);
...
if(func_141(func_83())){
func_140();
func_139(&uLocal_69, 0, PLAYER::PLAYER_PED_ID(), sLocal_234, 0, 1);
...
iLocal_59=0;
iLocal_50=2;
}}elseif(func_118(&uLocal_69, 131, "TAXISAU", sLocal_235, sLocal_235, "TX_2A", "TX_2A", 2, 1, 0, 0, 0)){
iLocal_50=1;
}}}}elseif(iLocal_50==1){
if(func_117()){
iLocal_50=0;
...
if(!PATHFIND::GET_CLOSEST_VEHICLE_NODE(Local_241, &Var0, iVar2, 100f, 2.5f)){
return 0;
}
...
return func_137(Param0, Global_43378[iParam1 /*5*/].f_4);
}}
return 0;
}
