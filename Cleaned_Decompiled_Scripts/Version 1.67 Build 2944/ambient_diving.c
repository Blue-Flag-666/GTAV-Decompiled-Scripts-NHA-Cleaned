...
if(MISC::IS_BIT_SET(Global_113810.f_10052.f_108, func_31(func_32(iParam0), iVar1))){
iVar0++;
}
iVar1++;
}}elseif(iParam0==6){
...
func_59();
VEHICLE::SET_BOAT_ANCHOR(uLocal_62, 0);
iLocal_64=1;
if(iLocal_47==2){
func_2(3);
}}}elseif(func_48(uLocal_62) && func_48(PLAYER::PLAYER_PED_ID())){
if(ENTITY::IS_ENTITY_IN_WATER(PLAYER::PLAYER_PED_ID())){
fVar0=500f;
}else{
fVar0=250f;
}
if(func_58(PLAYER::PLAYER_PED_ID(), uLocal_62, 0) > fVar0){
func_57();
if(iLocal_47==2){
func_2(3);
}}}else{
...
VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_62, 0, 1, 0);
if(VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(uLocal_62))){
if(!ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(uLocal_62)){
VEHICLE::SET_BOAT_ANCHOR(uLocal_62, 1);
}}
iLocal_64=0;
}}
break;
...
ENTITY::SET_ENTITY_RECORDS_COLLISIONS(uLocal_62, 0);
if(ENTITY::IS_ENTITY_A_MISSION_ENTITY(uLocal_62)){
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_62);
}}}
...
if(func_48(PLAYER::PLAYER_PED_ID())){
if(func_48(uLocal_62)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_62, 0)){
return 1;
}}elseif(func_61()){
uLocal_62=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_62)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_62, 1, 1);
ENTITY::SET_ENTITY_RECORDS_COLLISIONS(uLocal_62, 1);
return 1;
}}}
return 0;
}
...
if(!HUD::DOES_BLIP_EXIST(uLocal_51)){
uLocal_51=HUD::ADD_BLIP_FOR_RADIUS(Var1, 200f);
HUD::SET_BLIP_ALPHA(uLocal_51, 128);
HUD::SET_BLIP_COLOUR(uLocal_51, 2);
HUD::SET_BLIP_HIDDEN_ON_LEGEND(uLocal_51, 0);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_51, "B_WRE");
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_51, 0);
iLocal_52=iLocal_49;
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_51)){
HUD::REMOVE_BLIP(&uLocal_51);
}}else{
if(func_61()){
if(!func_25(42)){
...
iLocal_59=0;
if(func_61()){
AUDIO::PLAY_SOUND_FROM_COORD(uLocal_61, "SINGLE_BLIP_FROM_BOAT", Var1, "ABIGAIL_SONAR_SOUNDSET", 0, 0, 0);
}else{
AUDIO::PLAY_SOUND_FROM_COORD(uLocal_61, "SCRIPT_TRIGGERED_FROM_PROP", Var0, "ABIGAIL_SONAR_SOUNDSET", 0, 0, 0);
}}else{
fLocal_56=(fLocal_56 + fLocal_58);
fLocal_56=func_63(fLocal_56, 0f, fLocal_57);
if(!HUD::DOES_BLIP_EXIST(uLocal_53)){
uLocal_53=HUD::ADD_BLIP_FOR_RADIUS(Var1, fLocal_56);
HUD::SET_BLIP_ALPHA(uLocal_53, 255);
HUD::SET_BLIP_COLOUR(uLocal_53, 4);
HUD::SET_BLIP_AS_SHORT_RANGE(uLocal_53, 1);
HUD::SET_RADIUS_BLIP_EDGE(uLocal_53, 1);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_53, 0);
}else{
HUD::SET_BLIP_SCALE(uLocal_53, fLocal_56);
}
iVar3=0;
if(func_61()){
iVar3=0;
while (iVar3 <=3){
if(!HUD::DOES_BLIP_EXIST(uLocal_54[iVar3])){
uLocal_54[iVar3]=HUD::ADD_BLIP_FOR_RADIUS(Var1, (fLocal_56 + fLocal_55[iVar3]));
HUD::SET_BLIP_ALPHA(uLocal_54[iVar3], 255);
HUD::SET_BLIP_COLOUR(uLocal_54[iVar3], 4);
HUD::SET_BLIP_AS_SHORT_RANGE(uLocal_54[iVar3], 1);
HUD::SET_RADIUS_BLIP_EDGE(uLocal_54[iVar3], 1);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_54[iVar3], 0);
}else{
HUD::SET_BLIP_SCALE(uLocal_54[iVar3], (fLocal_56 + fLocal_55[iVar3]));
}
iVar3++;
}}else{
iVar3=0;
while (iVar3 <=3){
if(HUD::DOES_BLIP_EXIST(uLocal_54[iVar3])){
HUD::SET_BLIP_SCALE(uLocal_54[iVar3], fLocal_56);
}
iVar3++;
}}
...
func_64();
if(!AUDIO::HAS_SOUND_FINISHED(uLocal_61)){
AUDIO::STOP_SOUND(uLocal_61);
}
func_57();
iVar0=0;
