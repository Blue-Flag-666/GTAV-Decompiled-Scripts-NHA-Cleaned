...
Global_78935=1;
iLocal_35=0;
while (!func_472(&Local_37)){
wait(0);
}
func_357(&iVar0, 410.74f, -778.37f, 28.87f, 359.2f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
Global_78935=0;
}
if(func_356(Local_37.f_28[0])){
func_355(&iLocal_43, &(Local_37.f_28[0]));
}
func_354(1);
while (true){
wait(0);
RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("SF_GRF", 0);
func_338(Local_37.f_9, 0, 0, 0, 0, 0);
if(iLocal_39==5){
func_332();
}elseif(!func_313()){
...
func_8(13, floor(Global_113810.f_10197.f_3853));
}
...
Global_78472[1 /*14*/]={
func_84(iVar10, iVar0, func_40(iParam0, iVar0, -1), -1) 
};
...
var func__69(int iParam0, var uParam1){
...
func_87(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_87(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_87(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_76(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_76(iParam1))){
return 1;
}
return 0;
}
...
func_162(&uVar1, Var0.f_3, Global_100870, iParam1, iParam2);
}}
...
if(!bLocal_57[3] && func_238(PLAYER::PLAYER_PED_ID(), iLocal_43, 15f, 1)){
bLocal_57[3]=func_223(&uLocal_65, "BARR3AU", sLocal_63[3], 7, 1, 0, 0);
}
if(!bLocal_53){
func_222(1);
TASK::TASK_PERFORM_SEQUENCE(iLocal_43, uLocal_42);
if(PED::IS_PED_HEADTRACKING_PED(iLocal_43, PLAYER::PLAYER_PED_ID())){
TASK::TASK_CLEAR_LOOK_AT(iLocal_43);
}}
if(PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), iLocal_43)){
...
if(func_356(uLocal_45[0]) && func_356(uLocal_45[1])){
if((func_221(uLocal_45[0], Local_235, 30f, 1) || func_218(uLocal_45[0], PLAYER::PLAYER_PED_ID(), 1126825984, 0)) || func_218(uLocal_45[1], PLAYER::PLAYER_PED_ID(), 1126825984, 0)){
...
float fVar2;
Var0={
func_220(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var1={
func_220(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_42);
TASK::TASK_PLAY_ANIM(0, sLocal_41, "barry_get_up", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
TASK::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_44, 0), 200f, -1, 0, 0);
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_42);
}else{
TASK::OPEN_SEQUENCE_TASK(&uLocal_42);
TASK::TASK_PLAY_ANIM(0, sLocal_41, "barry_get_up", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
...
if(ENTITY::DOES_ENTITY_EXIST(Local_37.f_41[0])){
if(bParam0){
if(!ENTITY::IS_ENTITY_ATTACHED(Local_37.f_41[0])){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_37.f_41[0], iLocal_43, PED::GET_PED_BONE_INDEX(iLocal_43, 60309), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}elseif(ENTITY::IS_ENTITY_ATTACHED(Local_37.f_41[0])){
ENTITY::DETACH_ENTITY(Local_37.f_41[0], 1, 1);
ENTITY::SET_ENTITY_HAS_GRAVITY(Local_37.f_41[0], 1);
}}}

int func_241(){
struct<3> Var0;
float fVar1;
if((!ENTITY::DOES_ENTITY_EXIST(iLocal_44) && STREAMING::HAS_MODEL_LOADED(iLocal_47)) && STREAMING::HAS_MODEL_LOADED(iLocal_48)){
Var0={
Local_233 
};
fVar1=fLocal_238;
if(func_242(PLAYER::PLAYER_PED_ID(), Local_233, 1) < func_242(PLAYER::PLAYER_PED_ID(), Local_234, 1)){
Var0={
Local_234 
};
fVar1=fLocal_239;
}
iLocal_44=VEHICLE::CREATE_VEHICLE(iLocal_47, Var0, fVar1, 1, 1, 0);
uLocal_45[0]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_44, 6, iLocal_48, -1, 1, 1);
WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uLocal_45[0], joaat("weapon_pistol"), -1, 1);
WEAPON::SET_PED_INFINITE_AMMO(uLocal_45[0], 1, joaat("weapon_pistol"));
uLocal_45[1]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_44, 6, iLocal_48, 0, 1, 1);
WEAPON::GIVE_DELAYED_WEAPON_TO_PED(uLocal_45[1], joaat("weapon_pistol"), -1, 1);
WEAPON::SET_PED_INFINITE_AMMO(uLocal_45[1], 1, joaat("weapon_pistol"));
VEHICLE::SET_VEHICLE_SIREN(iLocal_44, 1);
VEHICLE::SET_VEHICLE_FORWARD_SPEED(iLocal_44, 20f);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(uLocal_45[0], iLocal_44, Local_235, 20f, 1, iLocal_47, 786603, 5f, 5f);
return 1;
}
return 0;
}
...
MISC::CLEAR_AREA_OF_COPS(ENTITY::GET_ENTITY_COORDS(iLocal_43, 1), 1000f, 0);
uLocal_241=PED::CREATE_SYNCHRONIZED_SCENE(Local_245, Local_246, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_241, 1);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_43, uLocal_241, sLocal_41, "barry_3_sit_loop", 1000f, -8f, 1, 16, 1148846080, 0);
}
...
func_247();
if(iLocal_56 < 3){
if(func_238(PLAYER::PLAYER_PED_ID(), iLocal_43, 15f, 1)){
if(!bLocal_57[iLocal_56]){
if((MISC::GET_GAME_TIMER() - iLocal_64) > iLocal_230[iLocal_56]){
...
func_244();
}}}elseif(func_238(PLAYER::PLAYER_PED_ID(), iLocal_43, 15f, 1)){
if(!bLocal_59){
bLocal_59=func_223(&uLocal_65, "BARR3AU", "BARRY3_TRICK", 7, 0, 0, 0);
}}
if(!iLocal_51){
if((MISC::GET_GAME_TIMER() - iLocal_50) > 40000 || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) > 0){
iLocal_51=1;
iLocal_40=2;
}elseif(!func_238(PLAYER::PLAYER_PED_ID(), iLocal_43, 100f, 1)){
iLocal_40=2;
}}
break;
case 2:
...
void func_247(){
if(func_238(iLocal_43, PLAYER::PLAYER_PED_ID(), 7f, 1)){
if(!PED::IS_PED_HEADTRACKING_PED(iLocal_43, PLAYER::PLAYER_PED_ID())){
TASK::TASK_LOOK_AT_ENTITY(iLocal_43, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
}}elseif(AUDIO::IS_PED_IN_CURRENT_CONVERSATION(iLocal_43)){
if(!PED::IS_PED_HEADTRACKING_PED(iLocal_43, PLAYER::PLAYER_PED_ID())){
TASK::TASK_LOOK_AT_ENTITY(iLocal_43, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
}}elseif(PED::IS_PED_HEADTRACKING_PED(iLocal_43, PLAYER::PLAYER_PED_ID())){
TASK::TASK_CLEAR_LOOK_AT(iLocal_43);
}
if(func_238(iLocal_43, PLAYER::PLAYER_PED_ID(), 6f, 1)){
if(!PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), iLocal_43)){
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_43, -1, 0, 2);
}}elseif(PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), iLocal_43)){
TASK::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
}}
...
if(func_238(iLocal_43, PLAYER::PLAYER_PED_ID(), 40f, 1)){
bLocal_52=true;
}else{
bLocal_52=false;
}
...
if(func_238(iLocal_43, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 15f, 1)){
bLocal_53=true;
AUDIO::STOP_SCRIPTED_CONVERSATION(0);
func_222(0);
TASK::TASK_PERFORM_SEQUENCE(iLocal_43, uLocal_42);
...
iVar0=0;
while (iVar0 < 6){
if(func_356(uParam0->f_28[iVar0])){
...
iVar0=0;
while (iVar0 < 5){
if(func_356(uParam0->f_35[iVar0])){
...
iVar0=0;
while (iVar0 < 6){
if(func_356(uParam0->f_41[iVar0])){
...
if(func_356(iLocal_43)){
uLocal_240=PED::CREATE_SYNCHRONIZED_SCENE(417.533f, -765.23f, 28.41f, 0f, 0f, 12.96f, 2);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_43, uLocal_240, sLocal_41, "lead_out", 1000f, -8f, 1, 16, 1148846080, 0);
}}
func_240(1);
iLocal_62=0;
iLocal_40=1;
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_240) > 0.99f){
iLocal_40=2;
}}else{
iLocal_40=2;
}
...
if(func_356(PLAYER::PLAYER_PED_ID())){
func_286(sLocal_242, PLAYER::PLAYER_PED_ID(), 0, 2);
}
CUTSCENE::SET_CUTSCENE_PED_PROP_VARIATION(sLocal_243, 1, 0, 0, 0);
}
if(func_279(1, 1093140480, 0)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_43, sLocal_243, 0, 0, 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), sLocal_242, 0, 0, 0);
if(ENTITY::DOES_ENTITY_EXIST(Local_37.f_41[0])){
func_240(0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_37.f_41[0], "Barrys_Clipboard", 0, 0, 0);
}
func_278();
...
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_242, 0)){
...
iLocal_46=OBJECT::CREATE_OBJECT(iLocal_49, 416.3885f, -764.8415f, 28.3848f, 1, 1, 0);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_46)){
ENTITY::SET_ENTITY_ROTATION(iLocal_46, 0f, 0f, 20f, 2, 1);
}}
...
Var3={
func_84(iVar4, 2, uParam1->f_59, -1) 
};
...
Var3={
func_84(iVar4, 1, uParam1->f_62, -1) 
};
...
var uVar0;
var uVar1;
uVar0=func_290(iParam0, uParam1);
...
if(!func_482()){
if(func_356(iLocal_43)){
TASK::TASK_PLAY_ANIM(iLocal_43, sLocal_41, "lead_in", 8f, -8f, -1, 2, 0, 0, 0, 0);
iLocal_40=1;
}}else{
func_253(1);
}}elseif(iLocal_40==1){
if(func_256(iLocal_43)){
if(!bLocal_55 && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 415.4781f, -771.7041f, 27.85562f, 415.5606f, -759.9372f, 31.36162f, 7.25f, 0, 1, 0) || func_294())){
bLocal_55=true;
if(func_238(PLAYER::PLAYER_PED_ID(), iLocal_43, 5f, 1)){
bLocal_61=true;
}}
if(bLocal_55){
if(!bLocal_61){
if(func_294()){
CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_43, 0f, 0f, 0.5f, 1, 5000, 2000, 2000, 0);
}else{
CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_43, 0.5f, 0f, 0.5f, 1, 5000, 2000, 2000, 0);
...
if(func_238(PLAYER::PLAYER_PED_ID(), iLocal_43, 2.5f, 1)){
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 256);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_43, 0);
}}
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_43, sLocal_41, "lead_in", 3)){
if(iLocal_60==0){
...
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_43, sLocal_41, "lead_in") > 0.9f){
iLocal_40=2;
}}else{
iLocal_40=2;
}}}
...
void func_295(){
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && func_356(iLocal_43)){
PED::SET_IK_TARGET(iLocal_43, 1, PLAYER::PLAYER_PED_ID(), 31086, 0f, 0f, 0f, 0, -1, -1);
PED::SET_IK_TARGET(PLAYER::PLAYER_PED_ID(), 1, iLocal_43, 31086, 0f, 0f, 0f, 0, -1, -1);
}}
...
iLocal_230[1]=20000;
iLocal_230[2]=7000;
uLocal_244=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_43, uLocal_244);
PED::SET_PED_CONFIG_FLAG(iLocal_43, 132, 1);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_43, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_43, 185, 1);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_43, 0);
func_312(&uLocal_65, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
func_312(&uLocal_65, 3, iLocal_43, "BARRY", 0, 1);
HUD::REQUEST_ADDITIONAL_TEXT("BARY3", 0);
STREAMING::REQUEST_MODEL(iLocal_49);
STREAMING::REQUEST_ANIM_DICT(sLocal_41);
iLocal_40=1;
}
if(iLocal_40==1){
if((HUD::HAS_ADDITIONAL_TEXT_LOADED(0) && STREAMING::HAS_MODEL_LOADED(iLocal_49)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_41)){
if(func_482()){
switch (func_311()){
case 0:
STREAMING::REQUEST_MODEL(iLocal_47);
STREAMING::REQUEST_MODEL(iLocal_48);
func_310(0, 0);
func_309(iLocal_43, Local_232, fLocal_237, 1, 1);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
if(func_356(iLocal_43)){
uLocal_241=PED::CREATE_SYNCHRONIZED_SCENE(Local_245, Local_246, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_241, 1);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_43, uLocal_241, sLocal_41, "barry_3_sit_loop", 1000f, -8f, 0, 0, 1148846080, 0);
}
func_266();
func_308(Local_231, fLocal_236, 1, 0);
func_306(0, -1, 1);
func_253(2);
break;
default:
...
int func_309(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_356(iParam0)){
...
if(!func_356(PLAYER::PLAYER_PED_ID())){
return 1;
}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_43)){
if(ENTITY::IS_ENTITY_DEAD(iLocal_43, 0)){
func_240(0);
func_331("B3BARRYDEAD");
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_43, PLAYER::PLAYER_PED_ID(), 1) || func_330(PLAYER::PLAYER_PED_ID(), iLocal_43, 1)){
TASK::TASK_SMART_FLEE_PED(iLocal_43, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
func_240(0);
func_331("B3BARRYHURT");
return 1;
}elseif(func_314(iLocal_43, 1, 1116471296, 1126825984, 0, 0, 0, 0) || func_330(PLAYER::PLAYER_PED_ID(), iLocal_43, 1)){
if(!iLocal_51){
if((iLocal_39==-2 && PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_240)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_240) < 0.82f){
}else{
func_222(0);
TASK::TASK_PERFORM_SEQUENCE(iLocal_43, uLocal_42);
}
...
struct<3> Var0;
if(func_356(PLAYER::PLAYER_PED_ID()) && func_356(iParam0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}
if(func_325(iParam0, bParam1, bParam5, bParam6, bParam7)){
return 1;
}
...
return func_324(PLAYER::PLAYER_PED_ID(), iParam0, fParam2);
}}}
if(bParam4){
return 0;
}elseif(func_315(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
float fVar0;
if(func_356(PLAYER::PLAYER_PED_ID()) && func_356(iParam0)){
if(func_323(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0)){
if(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)){
fVar0=40f;
}else{
fVar0=3f;
...
struct<3> Var1;
int iVar2;
iVar2=func_322(iParam0, iParam1);
if(!func_356(iParam0) || !func_356(iParam1)){
if(iVar2 !=-1){
func_321(&(Local_33[iVar2 /*4*/]));
}
return 0;
}
...
uVar0=func_318(&(Local_33[iVar2 /*4*/]), Var1, iParam1, &(Local_33[iVar2 /*4*/].f_3), iParam0, iParam5);
return (uVar0 || (MISC::GET_GAME_TIMER() - Local_33[iVar2 /*4*/].f_3) < iParam4);
}

int func_318(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5){
var uVar0;
struct<3> Var1;
var uVar2;
int iVar3;
...
Vector3 func__319(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
bool func_324(int iParam0, int iParam1, float fParam2){
struct<3> Var0;
struct<3> Var1;
Var0={
ENTITY::GET_ENTITY_FORWARD_VECTOR(iParam0) 
...
int func_325(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4){
float fVar0;
float fVar1;
int iVar2;
fVar0=8f;
...
if(!bParam2){
if(func_329(iParam0, bParam1, fVar0, fVar1)){
return 1;
}
if(func_326(iParam0, fVar1, bParam3, bParam4)){
return 1;
}}else{
...
int func_326(int iParam0, float fParam1, bool bParam2, bool bParam3){
struct<3> Var0;
struct<3> Var1;
Var0={
ENTITY::GET_ENTITY_COORDS(iParam0, 1) 
...
if(func_328(iParam0, Var1, 90f, 0)){
return 1;
}}
return 0;
}

int func_328(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
func_220(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
if(fParam2 < 0.1f || fParam2 > 360f){
return 1;
}
...
int func_329(int iParam0, bool bParam1, float fParam2, float fParam3){
if(bParam1){
if(PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())){
...
if(func_256(iParam0) && PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0)){
if(func_256(iParam1)){
...
switch (iLocal_40){
case 0:
if(MISC::ARE_STRINGS_EQUAL(sLocal_38, "DEFAULT")){
func_498(1);
}else{
func_336(sLocal_38, 1);
}
iLocal_40=1;
break;
case 1:
if(func_335()){
func_483();
}elseif(!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_38)){
if(func_256(iLocal_43)){
if(func_256(PLAYER::PLAYER_PED_ID()) && func_238(PLAYER::PLAYER_PED_ID(), iLocal_43, 15f, 1)){
func_333();
}}}
break;
}}
...
if(iVar0==0){
bLocal_58=func_334(&uLocal_65, "BARR3AU", "BARRY3_EEP", "BARRY3_EEP_1", 9, 1, 0);
}elseif(iVar0==1){
bLocal_58=func_334(&uLocal_65, "BARR3AU", "BARRY3_EEP", "BARRY3_EEP_2", 9, 1, 0);
}else{
bLocal_58=func_334(&uLocal_65, "BARR3AU", "BARRY3_EEP", "BARRY3_EEP_3", 9, 1, 0);
}}}
if(bLocal_58){
return 1;
}
...
void func_338(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_340(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
break;
default:
StringCopy(&Var0, func_341(iVar1), 8);
break;
}
break;
default:
...
int func_349(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6){
...
break;
case 5:
if((CUTSCENE::IS_CUTSCENE_PLAYING() || func_302(0)) || func_350(1)){
}else{
return 1;
}
break;
...
void func_357(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11){
int iVar0;
iVar0=1;
if(!func_482() || !func_471()){
iVar0=0;
}
if(iVar0==1){
if(!func_468(iParam4, iParam5, iParam6, iParam11)){
iVar0=0;
}}
if(iVar0==1){
func_466();
...
func_430(iParam10, 0);
while (!func_358(iParam0, iParam10, Param1, fParam2, 1, 0)){
wait(0);
}}else{
...
int func_358(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5){
var uVar0;
var uVar1;
struct<97> Var2;
int iVar3;
...
func_421(iParam0, &(Global_113810.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_113810.f_2366.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
...
func_421(iParam0, &(Global_113810.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_113810.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
if(iParam1==2){
if(ENTITY::GET_ENTITY_MODEL(*iParam0)==joaat("bodhi2")){
func_419(iParam0);
...
if(VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >=0 && func_364(*iParam1, 0, &uVar0)){
...
Global_113810.f_20121[iParam0 /*43*/].f_31=func_362(*iParam1);
...
func_360(Global_113810.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_113810.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_113810.f_20121[iParam0 /*43*/].f_1));
...
func_360(Global_113810.f_2366.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_113810.f_20121[iParam0 /*43*/].f_2));
}}}}
...
int iVar4;
iVar0=0;
while (func_361(iVar0, &sVar2, &iVar1, &iVar3, &iVar4)){
...
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
if((!func_397(iVar0, bParam1, uParam2) && !func_396(PLAYER::PLAYER_ID())) && !func_377(iParam0)){
return 0;
}
...
bVar1=false;
if(func_373(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0))){
bVar1=true;
}
if(((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_370(iParam0)) && !bVar1) && !(func_369(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_366(PLAYER::PLAYER_ID()))){
...
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
if((func_365(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) !=joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) !=joaat("issi2")){
*uParam2=2;
return 0;
}}
return 1;
...
return func_367(Global_2657704[iParam0 /*463*/].f_321.f_7)==11;
}}}
return 0;
}
...
if(func_368(iParam0, 1, 1)){
if(Global_2657704[iParam0 /*463*/].f_321.f_7 !=-1){
return func_367(Global_2657704[iParam0 /*463*/].f_321.f_7)==26;
}}}
return 0;
}
...
if(func_368(iParam0, 1, 1)){
if(Global_2657704[iParam0 /*463*/].f_321.f_7 !=-1){
return func_367(Global_2657704[iParam0 /*463*/].f_321.f_7)==13;
}}}
return 0;
}
...
if(func_368(iParam0, 1, 1)){
if(Global_2657704[iParam0 /*463*/].f_321.f_7 !=-1){
return func_367(Global_2657704[iParam0 /*463*/].f_321.f_7)==7;
}}}
return 0;
}
...
if((((!func_376(PLAYER::PLAYER_ID()) && iParam0 !=joaat("thruster")) && iParam0 !=joaat("avenger")) && iParam0 !=func_375(1)) && !bVar0){
return 0;
}
return 1;
}
...
if(func_381(PLAYER::PLAYER_ID()) && ((((!func_374(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel1"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel2"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula2")))){
return 0;
}
...
if(ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)){
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
if((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_370(iParam0)) || func_380(iVar0)){
return 1;
}
switch (iVar0){
...
if(func_396(iParam0) && Global_2657704[iParam0 /*463*/].f_321.f_10==iParam0){
return 1;
}
return 0;
}
...
return 1;
}elseif(func_383(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if(iParam0 !=func_229()){
if(func_368(iParam0, 1, 1)){
if(Global_2657704[iParam0 /*463*/].f_321.f_7 !=-1 && Global_2657704[iParam0 /*463*/].f_321.f_10 !=func_229()){
return func_367(Global_2657704[iParam0 /*463*/].f_321.f_7)==5;
}}}
return 0;
}
...
if(func_368(iParam0, 1, 1)){
if(Global_2657704[iParam0 /*463*/].f_321.f_7 !=-1 && Global_2657704[iParam0 /*463*/].f_321.f_10 !=func_229()){
return func_367(Global_2657704[iParam0 /*463*/].f_321.f_7)==8;
}}}
return 0;
}
...
if(func_368(iParam0, 1, 1)){
if(Global_2657704[iParam0 /*463*/].f_321.f_7 !=-1){
return func_367(Global_2657704[iParam0 /*463*/].f_321.f_7)==9;
}}}
return 0;
}

int func_397(int iParam0, bool bParam1, var uParam2){
bool bVar0;
if(!bParam1){
...
bVar0=false;
if(func_373(PLAYER::PLAYER_ID()) && (VEHICLE::IS_THIS_MODEL_A_HELI(iParam0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iParam0))){
bVar0=true;
}
...
func_400(iParam0, &(Global_113810.f_32752.f_5510));
}
...
MISC::SET_BIT(&(uParam1->f_77), func_401(iVar0 + 1));
}
iVar0++;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_273(iParam0, 0, 0)) || func_273(iParam0, 1, 0)) || func_273(iParam0, 2, 0)) || func_417(iParam0) !=145) || func_416(iParam0)) || func_415(iParam0)) || func_365(iParam0)) || func_414(iParam0)) || !func_404(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_415(iParam0)){
}
if(func_415(iParam0)){
}
...
if((((!func_412() && !func_411()) && !func_410()) && !func_409()) && !func_413()){
return 0;
}}
...
if(!func_427() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
if(iParam1==0 || ENTITY::GET_ENTITY_MODEL(Global_98144[iVar0])==func_431(iParam0, iParam1)){
...
void func_432(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
if(func_437(&(Global_77479.f_555[0 /*21*/]), iVar0)){
...
if(func_437(&(Global_77479.f_555[0 /*21*/]), iParam0)){
...
if(((((iParam0==24 && func_184(iParam0, 0)) && Global_78388.f_66==0) && Global_113810.f_32752.f_1958[Global_77479.f_555[0 /*21*/].f_14] !=0) && Global_113810.f_32752.f_1958[Global_77479.f_555[0 /*21*/].f_14] > 3) && (!func_435(0, Global_77479.f_555[0 /*21*/].f_12) || !func_435(1, Global_77479.f_555[0 /*21*/].f_12))){
func_434(&(Global_113810.f_32752.f_69[Global_77479.f_555[0 /*21*/].f_14 /*78*/]), &Global_78388);
...
return func_405(Global_113810.f_32752.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}
...
if(!func_438(Global_113810.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
if(!func_438(Global_113810.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
if(!func_438(Global_113810.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
return func_440(&(Global_107357.f_2890), Param0, fParam1, 0);
}
...
}elseif((!func_442(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
switch (iVar0){
case joaat("cargobob"):
if(func_444(iParam0, Global_77479.f_139[38], 0)){
func_433(38);
return 1;
}
break;
case joaat("firetruk"):
if(func_444(iParam0, Global_77479.f_139[43], 1)){
func_433(43);
return 1;
}
break;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_444(iParam0, uVar1[iVar3], 1) && func_443(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_438(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
...
iVar0=1;
if(MISC::IS_BIT_SET(uParam1->f_77, func_401(iVar0 + 1))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_401(iVar0 + 1));
}}elseif(uParam1->f_66==joaat("sandking") || uParam1->f_66==joaat("sandking2")){
iVar1=1;
if(MISC::IS_BIT_SET(uParam1->f_77, func_401(iVar1 + 1))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_401(iVar1 + 1));
}}elseif(uParam1->f_66==joaat("formula") || uParam1->f_66==joaat("formula2")){
iVar2=1;
while (iVar2 <=9){
if(MISC::IS_BIT_SET(uParam1->f_77, func_401(iVar2))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_401(iVar2));
}
iVar2++;
}}elseif(uParam1->f_66==joaat("openwheel1")){
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_401(iVar3))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_401(iVar3));
}
iVar3++;
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_401(iVar4))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_401(iVar4));
}}
iVar4++;
}}elseif(uParam1->f_66==joaat("surfer3")){
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_401(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_401(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_401(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_401(iVar6))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_401(iVar6));
}
iVar6++;
}}
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_453(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_452()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_401(iVar7 + 1))){
...
if((((func_446() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_375(1))){
...
if(!func_405(uParam0->f_12.f_66, 0, -1)){
return 0;
}
...
break;
case 1:
if(!func_480(&iVar0) || !func_478(&(uParam0->f_48))){
return 0;
}
iLocal_35=2;
break;
...
if(func_475(&(uParam0->f_28[0]), 49, Var1, fVar2, "RC LAUNCHER:
BARRY 3", 1)){
...
func_473(&(uParam0->f_41[0]), iVar0[1], Var1 + Vector(0f, 0f, 5f), -115.18f);
if(func_356(uParam0->f_41[0]) && func_356(uParam0->f_28[0])){
...
void func_473(var uParam0, int iParam1, struct<3> Param2, float fParam3){
func_474(uParam0);
...
int func_475(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_476(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
int func_476(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_153(iParam1)){
...
void func_481(var uParam0, char* sParam1, char* sParam2, char* sParam3){
*uParam0=sParam1;
uParam0->f_1=sParam2;
uParam0->f_2=sParam3;
STREAMING::REQUEST_ANIM_DICT(*uParam0);
...
func_496(&uLocal_65, 1);
func_496(&uLocal_65, 3);
HUD::CLEAR_PRINTS();
...
func_495(&iLocal_46, 0);
func_494(1);
func_354(0);
PED::SET_CREATE_RANDOM_COPS(1);
func_484(&Local_37, 0, 0, 0);
...
func_493(&(uLocal_45[0]));
func_493(&(uLocal_45[1]));
func_489(&iLocal_44);
}}
...
int iVar0;
int iVar1;
iVar0=func_503(&(Global_100833.f_3), 0);
iVar1=0;
if(iVar0==53){
iVar1=1;
}
