...
if(!CAM::DOES_CAM_EXIST(uLocal_179)){
uLocal_179=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 1, 2);
CAM::SET_CAM_PARAMS(uLocal_179, -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 0, 1, 1, 2);
CAM::SET_CAM_ACTIVE(uLocal_179, 1);
...
if(CAM::DOES_CAM_EXIST(uLocal_179)){
CAM::SET_CAM_PARAMS(uLocal_179, -1651.501f, -1118.395f, 23.5181f, 3.435f, 0f, -152.2412f, 50.1098f, 5000, 1, 1, 2);
iVar6=MISC::GET_GAME_TIMER() + 5000;
}
while (!func_50(&uLocal_39) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_53();
func_56(PLAYER::PLAYER_PED_ID());
wait(0);
}
...
wait(0);
func_15();
if(func_56(PLAYER::PLAYER_PED_ID()) && func_56(Local_162.f_9)){
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), -1648.4f, -1127.6f, 18.3f, 1, 0, 0, 1);
ENTITY::ATTACH_ENTITY_TO_ENTITY(PLAYER::PLAYER_PED_ID(), Local_162.f_9, 0, 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}
...
if(CAM::DOES_CAM_EXIST(uLocal_179)){
CAM::SET_CAM_ACTIVE(uLocal_179, 0);
CAM::DESTROY_CAM(uLocal_179, 0);
}
if(func_56(PLAYER::PLAYER_PED_ID())){
Local_167.f_20=60;
Local_167.f_21=20;
...
func_14(&Local_167, Var1, ENTITY::GET_ENTITY_ROTATION(Local_162.f_9, 2), 50f, Local_167.f_20, Local_167.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
CAM::ATTACH_CAM_TO_ENTITY(Local_167.f_0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0.5f, 1);
}
wait(0);
if(func_56(PLAYER::PLAYER_PED_ID()) && func_56(Local_163.f_9)){
func_12(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_163.f_9, 1), &fVar4, &fVar5, 1);
func_9(&Local_167, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
CAM::SET_CAM_ROT(Local_167.f_0, Vector(fVar5, 0f, fVar4) + Local_167.f_14, 2);
}
AUDIO::START_AUDIO_SCENE("FAIRGROUND_RIDES_LEVIATHAN");
iLocal_185=MISC::GET_GAME_TIMER() + 5000;
...
fVar7=(sin(((Local_162.f_10 - IntToFloat(floor(Local_162.f_10))) * 360f)) * fLocal_186);
if(func_56(PLAYER::PLAYER_PED_ID()) && func_56(Local_163.f_9)){
func_12(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_163.f_9, 1), &fVar4, &fVar5, 1);
func_9(&Local_167, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
CAM::SET_CAM_ROT(Local_167.f_0, Vector((fVar5 + (fVar7 * (fVar8 * 2f))), 0f, (fVar4 + fVar7)) + Local_167.f_14, 2);
}
func_53();
func_2();
...
iLocal_185=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(8000, 13000));
}}
if(iLocal_177==0){
...
fVar0=to_float(MISC::ABSI((Local_190[iLocal_189 + 1 /*3*/] - Local_190[iLocal_189 /*3*/])));
fVar1=(Local_190[iVar3 /*3*/].f_1 - Local_190[iLocal_189 /*3*/].f_1);
fVar2=(1f - ((to_float(Local_190[iVar3 /*3*/]) - Local_162.f_10) / fVar0));
...
if(uParam0->f_26){
uParam0->f_14=func_7(uParam0->f_14, to_float(-uParam0->f_21), to_float(uParam0->f_21));
uParam0->f_14.f_1=func_7(uParam0->f_14.f_1, to_float(-uParam0->f_22), to_float(uParam0->f_22));
uParam0->f_14.f_2=func_7(uParam0->f_14.f_2, to_float(-uParam0->f_20), to_float(uParam0->f_20));
}
...
float fVar0;
fVar0=uParam0->f_3;
uParam0->f_3=(uParam0->f_3 + (((fLocal_161 * fLocal_188) * fLocal_187) * timestep()));
if(uParam0->f_3 >=1f){
...
PAD::SET_CONTROL_SHAKE(0, iLocal_182, iLocal_183);
}}
*uParam0={
func_18(&(Local_157[uParam0->f_4[0] /*3*/]), &(Local_157[uParam0->f_4[1] /*3*/]), &(Local_157[uParam0->f_4[2] /*3*/]), &(Local_157[uParam0->f_4[3] /*3*/]), uParam0->f_3) 
};
*uParam0={
*uParam0 + Local_158 
};
...
switch (iLocal_166){
case 0:
fLocal_161=(fLocal_161 + (MISC::GET_FRAME_TIME() / 2f));
if(fLocal_161 >=5f){
fLocal_161=5f;
iLocal_166=1;
}
...
break;
case 2:
fLocal_161=(fLocal_161 - MISC::GET_FRAME_TIME());
if(fLocal_161 <=0f){
fLocal_161=0f;
iLocal_166=3;
}
...
uParam0->f_9=OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_38, *uParam0, 1, 1, 0);
...
void func_29(){
int iVar0;
iLocal_178[0]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1643.524f, -1124.681f, 17.4326f, 2f, joaat("prop_roller_car_01"), 1, 0, 1);
iLocal_178[1]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1645.146f, -1126.613f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
iLocal_178[2]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1646.768f, -1128.545f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
iLocal_178[3]=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1648.39f, -1130.478f, 17.4326f, 2f, joaat("prop_roller_car_02"), 1, 0, 1);
iVar0=0;
while (iVar0 < iLocal_178){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_178[iVar0])){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_178[iVar0], 1, 0);
ENTITY::SET_ENTITY_VISIBLE(iLocal_178[iVar0], 0, 0);
ENTITY::SET_ENTITY_COLLISION(iLocal_178[iVar0], 0, 0);
ENTITY::SET_ENTITY_INVINCIBLE(iLocal_178[iVar0], 1);
}
iVar0++;
}}
...
if(iParam5==0){
Global_78472[1 /*14*/]={
func_114(iVar10, iParam1, iParam2, -1) 
};
if(!func_113(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78472[1 /*14*/]={
func_114(iVar10, iVar0, uVar11[iVar0], -1) 
};
...
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_114(iVar10, 14, uVar12[iVar1], -1) 
};
...
Global_78472[1 /*14*/]={
func_114(iVar10, iVar0, func_70(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_114(iVar10, 14, uVar15[iVar1], -1) 
};
func_81(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
func_104(14);
if(Global_78470==1){
...
if(!func_178(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_64, Global_113810.f_2366.f_539[iVar0 /*65*/].f_63)){
...
Global_78472[1 /*14*/]={
func_114(iParam0, iParam1, iParam2, -1) 
};
...
if(!func_178(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_61, Global_113810.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3==1){
...
func_117(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_117(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_117(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
iVar10=(iParam1 - iParam2);
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_71(iParam0));
if(iVar11 > iVar10){
...
Global_78472[1 /*14*/]={
func_114(iVar0, iParam1, iParam2, -1) 
};
if(!MISC::IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0)){
return 0;
}
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_71(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_71(iParam1))){
return 1;
}
return 0;
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_185(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
}}elseif(MISC::IS_BIT_SET(Global_113810.f_20567.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_198() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_198() /*5568*/].f_681.f_10, iParam0);
}
...
Vector3 func__224(int iParam0, struct<3> Param1){
var uVar0;
...
iLocal_178[0]=OBJECT::CREATE_OBJECT(joaat("prop_roller_car_01"), -1643.524f, -1124.681f, 17.4326f, 1, 1, 0);
}
if(!func_56(iLocal_178[1])){
iLocal_178[1]=OBJECT::CREATE_OBJECT(joaat("prop_roller_car_02"), -1645.146f, -1126.613f, 17.4326f, 1, 1, 0);
}
if(!func_56(iLocal_178[2])){
iLocal_178[2]=OBJECT::CREATE_OBJECT(joaat("prop_roller_car_02"), -1646.768f, -1128.545f, 17.4326f, 1, 1, 0);
}
if(!func_56(iLocal_178[3])){
iLocal_178[3]=OBJECT::CREATE_OBJECT(joaat("prop_roller_car_02"), -1648.39f, -1130.478f, 17.4326f, 1, 1, 0);
}
iVar0=0;
while (iVar0 < iLocal_178){
if(func_56(iLocal_178[iVar0])){
ENTITY::SET_ENTITY_HEADING(iLocal_178[iVar0], 140f);
ENTITY::SET_ENTITY_VISIBLE(iLocal_178[iVar0], 1, 0);
...
func_217(13, floor(Global_113810.f_10197.f_3853));
}
