...
if(!func_8(&(Local_99.f_1))){
func_5(&(Local_99.f_1));
}elseif(func_2(&(Local_99.f_1)) > 20f){
...
int func_9(struct<3> Param0, int iParam1, int iParam2, bool bParam3){
struct<3> Var0[15];
struct<3> Var1[15];
float fVar2[15];
int iVar3;
...
Local_99.f_4=PED::ADD_SCENARIO_BLOCKING_AREA(1413.703f, 2341.517f, -232.3945f, 2016.209f, 2998.893f, 161.0299f, 0, 1, 1, 1);
}
...
case 2:
if(Global_1836158 || func_24(3)){
PED::REMOVE_SCENARIO_BLOCKING_AREA(Local_99.f_4, 0);
}
return 1;
break;
}
...
void func_49(var uParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
func_44();
}
