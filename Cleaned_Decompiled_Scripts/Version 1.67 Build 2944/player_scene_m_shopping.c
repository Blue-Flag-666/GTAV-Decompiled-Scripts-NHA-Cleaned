...
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_267, &cLocal_285, 2)){
TASK::CLEAR_PED_TASKS(*uParam0);
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(*uParam0, -16f, 1);
PED::SET_PED_MOVE_ANIMS_BLEND_OUT(*uParam0);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_263 + Local_265, 1f, -1, (fLocal_266 * 0.1f), 0, 1193033728);
...
if(!ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_267, &cLocal_285, "WalkInterruptible", &fVar1, &uVar2)){
}
else{
if(fLocal_305 >=0f){
if(fVar0 >=fLocal_305){
func_134(*uParam0, "DISMISS_MICHAEL", "AMANDA_NORMAL", 24);
fLocal_305=-1f;
}}
if(fVar0 >=fVar1){
TASK::CLEAR_PED_TASKS(*uParam0);
...
TASK::TASK_START_SCENARIO_AT_POSITION(*uParam0, &cLocal_294, Local_263 + Local_303, (fLocal_264 + fLocal_304), 0, 0, 1);
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_263 + Local_265) < (fLocal_266 * fLocal_266)){
if(fLocal_266==0f){
fLocal_266=(vmag(Local_265) * 0.75f);
}
TASK::TASK_WANDER_IN_AREA(*uParam0, Local_263 + Local_265, fLocal_266, 1077936128, 1086324736);
func_135(4, 0);
return 1;
}}
break;
...
func_7(*uParam0);
if(vdist2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_263 + Local_265) < (fLocal_266 * fLocal_266)){
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_263 + Local_265, fLocal_266, 1)){
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*uParam0, Local_263 + Local_265, fLocal_266, 0);
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_306, 0);
func_135(5, 0);
return 1;
}}
break;
...
Var4={
func_4(Local_263 + Local_265, (fLocal_266 * 0.9f), 0f) 
};
if(PATHFIND::GET_SAFE_COORD_FOR_PED(Var4, 0, &Var5, 14)){
if(vdist2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Var5) > 100f){
...
uLocal_306=PED::ADD_SCENARIO_BLOCKING_AREA(Var6, Var7, 0, 0, 1, 1);
...
func_7(*uParam0);
if(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_267, &cLocal_276, 2)){
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_267, &cLocal_285, 2)){
}
break;
case 8:
if(func_131(uParam0)){
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), ENTITY::GET_ENTITY_COORDS(*uParam0, 1)) > (50f * 1.25f)){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_263 + Local_265, 1f, -1, (fLocal_266 * 0.1f), 0, 1193033728);
...
Vector3 func__4(struct<3> Param0, float fParam1, float fParam2){
struct<3> Var0;
float fVar1;
float fVar2;
int iVar3;
...
Vector3 func__5(struct<3> Param0, float fParam1, float fParam2){
struct<3> Var0;
float fVar1;
Var0={
...
fVar1=(fParam2 / 2f);
Var0={
func_6(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) 
};
...
Vector3 func__6(struct<3> Param0, float fParam1){
float fVar0;
if(fParam1==0f){
return 0f, 0f, 0f;
}
...
float fVar4;
if(PED::IS_PED_INJURED(uParam0)){
if(!iLocal_309 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0, PLAYER::PLAYER_PED_ID(), 1)){
bVar0=func_130(uParam0);
...
func_114(75, ENTITY::GET_ENTITY_COORDS(uParam0, 0), 250f, -1);
...
if(iLocal_307 > 0){
if(iLocal_308==0){
if(iLocal_307 + 15000 < MISC::GET_GAME_TIMER()){
func_8(uParam0, "FRIEND_FOLLOWED_BY_PLAYER", 24);
iLocal_307=-1;
iLocal_308++;
}}elseif(iLocal_307 + 10000 < MISC::GET_GAME_TIMER()){
...
return 0;
}}}elseif(func_103(iVar1, iParam2, -1, &sVar8)){
...
}}elseif(MISC::IS_BIT_SET(Global_113810.f_20567.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_54() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
if(Global_2694571){
if(iVar1==14){
func_94(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(Global_22908), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}}
Global_8939[iVar0]=1;
}}}
iVar1++;
...
func_94(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(Global_22913), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}elseif(iVar1==7){
if(Global_78689){
iVar4=0;
...
func_94(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}else{
switch (Global_20500){
case 0:
iVar6=Global_44580;
...
func_94(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}}elseif(iVar1==14){
func_94(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(Global_22908), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}elseif(iVar1==20){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_20481, "SET_DATA_SLOT");
...
func_94(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}else{
func_94(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}
Global_8939[iVar0]=1;
}}}
iVar1++;
...
iParam2=1;
}elseif(func_104(&(Var1[1 /*4*/]), iVar2)){
iParam2=0;
}else{
...
iParam2=1;
}elseif(func_104(&(Var0[1 /*4*/]), iVar1)){
iParam2=0;
}else{
iParam2=MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
}}else{
...
int func_136(){
if(!func_138()){
func_35(&uLocal_67, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
switch (func_38(Global_100554)){
case 0:
func_35(&uLocal_67, 1, Global_100554, func_137(0), 0, 1);
break;
case 1:
func_35(&uLocal_67, 2, Global_100554, func_137(1), 0, 1);
break;
case 2:
func_35(&uLocal_67, 3, Global_100554, func_137(2), 0, 1);
break;
default:
break;
}
...
func_3(&Global_100554);
if(iLocal_260 !=0){
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_259)){
uLocal_259=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_263 + Local_261, 1f, iLocal_260, 1, 0, 1);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_259)){
ENTITY::SET_ENTITY_COORDS(uLocal_259, Local_263 + Local_261, 1, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_259, Vector(fLocal_264, 0f, 0f) + Local_262, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_259, 1);
}}}
return 0;
}
...
return 0;
}}}elseif(iParam1==func_140(Global_100554) && iParam1 !=0){
Global_100554=0;
}}
return 1;
}
...
bool bVar1;
if(iLocal_258 !=0){
VEHICLE::REQUEST_VEHICLE_ASSET(iLocal_258, 3);
}
iVar0=0;
bVar1=false;
...
if(iLocal_258 !=0){
if(!VEHICLE::HAS_VEHICLE_ASSET_LOADED(iLocal_258)){
bVar1=false;
}}
if(!bVar1){
iVar0++;
...
case 99:
Local_265={
Vector(24.3224f, -700.7733f, -1306.836f) - Local_263 
};
fLocal_266=40f;
iLocal_257=2;
break;
case 100:
Local_265={
Vector((82.0206f + 1f), 272.6104f, -566.2225f) - Local_263 
};
fLocal_266=30f;
iLocal_257=2;
break;
case 101:
Local_265={
Vector((53.6418f + 1f), -217.321f, 77.2686f) - Local_263 
};
fLocal_266=25f;
iLocal_257=2;
break;
case 102:
Local_265={
Vector((102.0191f + 1f), 313.2252f, 412.1519f) - Local_263 
};
fLocal_266=15f;
iLocal_257=2;
break;
case 170:
Local_265={
Vector((37.8417f + 1f), -275.1926f, -616.7041f) - Local_263 
};
fLocal_266=30f;
break;
case 171:
Local_265={
Vector((56.8469f + 1f), -125.1416f, -106.3491f) - Local_263 
};
fLocal_266=25f;
break;
case 172:
...
case 94:
Local_265={
Vector((112.1615f + 1f), 328.301f, -16.8925f) - Local_263 
};
fLocal_266=25f;
break;
case 152:
...
Var1.f_31=49;
Var1.f_81=2;
if(func_152(0, iLocal_66, &Var1, &uVar2, &uVar3, &uVar4, &uVar5)){
iLocal_258=Var1.f_0;
}}else{
iLocal_258=0;
}
if(iLocal_257==0){
func_150(iLocal_66, &cLocal_267, &cLocal_276, &cLocal_285, &uVar6, &uVar7);
iLocal_257=0;
}else{
...
void func_175(){
if(iLocal_258 !=0){
VEHICLE::REMOVE_VEHICLE_ASSET(iLocal_258);
}
