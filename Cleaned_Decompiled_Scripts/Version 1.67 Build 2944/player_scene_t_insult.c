...
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_317)){
if(!iLocal_321){
if(fVar1 < fLocal_320){
}elseif(func_3(&uLocal_66, "PRSAUD", &Local_317, 3, 0, 0, 0)){
iLocal_321=1;
}}}}
Var2={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
if(vdist(Var2, Local_242) < 100f){
return 0;
}
iVar0=0;
while (iVar0 < iLocal_232){
...
Var3={
ENTITY::GET_ENTITY_COORDS(iLocal_232[iVar0], 1) 
};
...
case 0:
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &cLocal_296, &(Local_306[iParam1 /*16*/]), 2)){
fVar0=-1f;
fVar1=-1f;
if(ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_296, &(Local_306[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1) || func_35(&cLocal_296, &(Local_306[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1)){
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, Local_242 + Local_245[iParam1 /*3*/], fVar3, -1, (fLocal_247[iParam1] * 0.1f), 0, 1193033728);
...
TASK::CLEAR_PED_TASKS(iParam0);
if(MISC::IS_STRING_NULL_OR_EMPTY(&(Local_307[iParam1 /*16*/]))){
if(func_32(Local_245[iParam1 /*3*/], 0f, 0f, 0f, 0)){
Var5={
ENTITY::GET_ENTITY_COORDS(iParam0, 1) 
};
Local_245[iParam1 /*3*/]={
Var5 - Local_242 * Vector(4f, 4f, 4f) 
};
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_315[iParam1 /*16*/]))){
PED::SET_PED_MOVEMENT_CLIPSET(iParam0, &(Local_315[iParam1 /*16*/]), 1048576000);
}
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam0, Local_242 + Local_245[iParam1 /*3*/], 1f, -1, 0.25f, 0, 1193033728);
iLocal_233[iParam1]=1;
}else{
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_316)){
iLocal_316=PED::CREATE_SYNCHRONIZED_SCENE(Local_242, 0f, 0f, fLocal_243, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_316, 1);
}
iVar6=5;
iVar7=144;
iVar8=0;
...
ENTITY::SET_ENTITY_HEALTH(iLocal_232[iParam1], ENTITY::GET_ENTITY_MAX_HEALTH(iLocal_232[iParam1]), 0);
...
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(iLocal_238[iVar9], 0);
OBJECT::SET_OBJECT_TARGETTABLE(iLocal_238[iVar9], 0);
iVar9++;
}
}
if(!func_31(iVar7, 16)){
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_232[iParam1], iLocal_316, &cLocal_296, &(Local_307[iParam1 /*16*/]), 1000f, -1000f, iVar6, iVar7, 1000f, iVar8);
iVar9=0;
while (iVar9 < iLocal_238){
if(iLocal_239[iVar9] !=0){
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_312[iVar9 /*16*/]))){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_238[iVar9], iLocal_316, &(Local_312[iVar9 /*16*/]), &cLocal_296, 8f, 8f, 0, 1148846080);
}}
iVar9++;
}
Local_245[iParam1 /*3*/]={
...
break;
case 1:
if(!PED::IS_PED_GROUP_MEMBER(iLocal_232[iParam1], uLocal_237)){
if(!PED::DOES_GROUP_EXIST(uLocal_237)){
uLocal_237=PED::CREATE_GROUP(0);
}
if(iParam1==0){
PED::SET_PED_AS_GROUP_LEADER(iLocal_232[iParam1], uLocal_237);
}else{
PED::SET_PED_AS_GROUP_MEMBER(iLocal_232[iParam1], uLocal_237);
}}
if(TASK::GET_SCRIPT_TASK_STATUS(iParam0, joaat("script_task_follow_nav_mesh_to_coord")) !=1){
if(fLocal_247[iParam1]==0f){
fLocal_247[iParam1]=(vmag(Local_245[iParam1 /*3*/]) * 0.75f);
}
TASK::TASK_WANDER_IN_AREA(iParam0, Local_242 + Local_245[iParam1 /*3*/], fLocal_247[iParam1], 1077936128, 1086324736);
...
PED::SET_PED_RESET_FLAG(iLocal_232[iParam1], 249, 1);
PED::SET_PED_RESET_FLAG(iLocal_232[iParam1], 335, 1);
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_232[iParam1], &cLocal_296, &(Local_307[iParam1 /*16*/]), 2)){
if(iLocal_65==288){
if(iLocal_322 <=0){
iLocal_322=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(10000, 15000));
}
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_232[iParam1], iLocal_316, &cLocal_296, &(Local_307[iParam1 /*16*/]), 1000f, -1000f, iVar11, iVar12, 1000f, iVar13);
iVar14=0;
while (iVar14 < iLocal_238){
if(iLocal_239[iVar14] !=0){
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_312[iVar14 /*16*/]))){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_238[iVar14], iLocal_316, &(Local_312[iVar14 /*16*/]), &cLocal_296, 8f, 8f, 0, 1148846080);
}
}
iVar14++;
}}
...
TASK::TASK_LOOK_AT_ENTITY(iLocal_232[iParam1], PLAYER::PLAYER_PED_ID(), iVar15, 0, 2);
iLocal_236[iParam1]=((MISC::GET_GAME_TIMER() + iVar15) + MISC::GET_RANDOM_INT_IN_RANGE(500, 2000));
iLocal_235[iParam1]=1;
break;
case 1:
if(MISC::GET_GAME_TIMER() > iLocal_236[iParam1]){
...
if(bVar16){
PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_316, 0f);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_316, 1);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_316, 0);
iVar17=4;
iVar18=4276;
iVar19=0;
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_232[iParam1], iLocal_316, &cLocal_296, &(Local_308[iParam1 /*16*/]), 8f, -1000f, iVar17, iVar18, 8f, iVar19);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(iLocal_232[iParam1], 0);
PED::SET_RAGDOLL_BLOCKING_FLAGS(iLocal_232[iParam1], iVar18);
PED::SET_PED_CONFIG_FLAG(iLocal_232[iParam1], 208, 1);
iVar20=0;
while (iVar20 < iLocal_238){
if(iLocal_239[iVar20] !=0){
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_313[iVar20 /*16*/]))){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_238[iVar20], iLocal_316, &(Local_313[iVar20 /*16*/]), &cLocal_296, 8f, 8f, 0, 1148846080);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(iLocal_238[iVar20], 0);
}
}
iVar20++;
}
...
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_316)){
bVar21=false;
}elseif(PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_316) >=0.99f){
bVar21=false;
}
if(!bVar21){
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_316)){
...
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_316, 0);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_316, 1);
iVar22=0;
iVar23=180;
iVar24=0;
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_232[iParam1], iLocal_316, &cLocal_296, &(Local_309[iParam1 /*16*/]), 1000f, -1000f, iVar22, iVar23, 1000f, iVar24);
iVar25=0;
while (iVar25 < iLocal_238){
if(iLocal_239[iVar25] !=0){
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_314[iVar25 /*16*/]))){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_238[iVar25], iLocal_316, &(Local_314[iVar25 /*16*/]), &cLocal_296, 8f, 8f, 0, 1148846080);
}
}
iVar25++;
}
...
PED::SET_PED_RESET_FLAG(iLocal_232[iParam1], 249, 1);
PED::SET_PED_RESET_FLAG(iLocal_232[iParam1], 335, 1);
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_232[iParam1], &cLocal_296, &(Local_309[iParam1 /*16*/]), 2)){
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_316)){
iLocal_316=PED::CREATE_SYNCHRONIZED_SCENE(Local_242, 0f, 0f, fLocal_243, 2);
}
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_232[iParam1], iLocal_316, &cLocal_296, &(Local_309[iParam1 /*16*/]), 1000f, -1000f, 0, 0, 1148846080, 0);
iVar26=0;
while (iVar26 < iLocal_238){
if(iLocal_239[iVar26] !=0){
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_314[iVar26 /*16*/]))){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_238[iVar26], iLocal_316, &(Local_314[iVar26 /*16*/]), &cLocal_296, 8f, 8f, 0, 1148846080);
}
}
iVar26++;
}}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_238[iVar27])){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_238[iVar27], -8f, 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_238[iVar27], 0);
ENTITY::SET_ENTITY_DYNAMIC(iLocal_238[iVar27], 1);
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(iLocal_238[iVar27]));
}
iVar27++;
}}}}
...
if(iLocal_233[iVar0] < 0 && ENTITY::DOES_ENTITY_EXIST(iLocal_232[iVar0])){
return 1;
}}
iVar0++;
}
...
fVar6=-1f;
fVar7=-1f;
if(ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_296, &(Local_306[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7) || func_35(&cLocal_296, &(Local_306[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7)){
fVar1=-8f;
iVar2=2;
iVar3=0;
fVar4=8f;
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_232[iVar0], Global_98143, &cLocal_296, &(Local_306[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
iLocal_233[iVar0]=0;
}
iVar0++;
}
...
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_238[iVar0], Global_98143, &(Local_311[iVar0 /*16*/]), &cLocal_296, 8f, -1000f, 0, 1148846080);
}}
iVar0++;
}
...
while (iVar0 < iLocal_232){
if(!PED::IS_PED_INJURED(iLocal_232[iVar0])){
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_232[iVar0], Global_98142, &cLocal_296, &(Local_305[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
}
iVar0++;
}
iVar0=0;
while (iVar0 < iLocal_238){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_238[iVar0])){
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_310[iVar0 /*16*/]))){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_238[iVar0], Global_98142, &(Local_310[iVar0 /*16*/]), &cLocal_296, 8f, -1000f, 0, 1148846080);
}}
iVar0++;
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_317)){
func_27(&uLocal_66, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
return 0;
}}}elseif(iParam1==func_40(Global_100554) && iParam1 !=0){
Global_100554=0;
}}
return 1;
}
...
STREAMING::REQUEST_MODEL(iLocal_234[iVar0]);
if(!STREAMING::HAS_MODEL_LOADED(iLocal_234[iVar0])){
bVar2=false;
STREAMING::REQUEST_MODEL(iLocal_234[iVar0]);
}}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_315[iVar0 /*16*/]))){
STREAMING::REQUEST_CLIP_SET(&(Local_315[iVar0 /*16*/]));
if(!STREAMING::HAS_CLIP_SET_LOADED(&(Local_315[iVar0 /*16*/]))){
bVar2=false;
}}
iVar0++;
}
...
while (iVar0 < iLocal_232){
if(iLocal_234[iVar0] !=0){
iLocal_232[iVar0]=PED::CREATE_PED(26, iLocal_234[iVar0], Local_242 + Local_244[iVar0 /*3*/], 0, 1, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_232[iVar0], (fLocal_243 + fLocal_246[iVar0]));
...
TASK::TASK_PLAY_ANIM(iLocal_232[iVar0], &cLocal_296, &(Local_305[iVar0 /*16*/]), 8f, -8f, -1, 1, 0f, 0, 0, 0);
}
iVar0++;
}
iVar0=0;
while (iVar0 < iLocal_238){
if(iLocal_239[iVar0] !=0){
iLocal_238[iVar0]=OBJECT::CREATE_OBJECT(iLocal_239[iVar0], Local_242 + Local_244[iVar0 /*3*/] + Local_240[iVar0 /*3*/], 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_238[iVar0], Vector((fLocal_243 + fLocal_246[iVar0]), 0f, 0f) + Local_241[iVar0 /*3*/], 2, 1);
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_310[iVar0 /*16*/]))){
ENTITY::PLAY_ENTITY_ANIM(iLocal_238[iVar0], &(Local_310[iVar0 /*16*/]), &cLocal_296, 8f, 1, 0, 0, 0, 0);
}}
iVar0++;
}}
...
fLocal_246[0]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
fLocal_246[1]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
fLocal_247[0]=50f;
fLocal_247[1]=50f;
...
Local_245[0 /*3*/]={
Vector(1.5806f, -1719.606f, -1291.475f) - Local_242 
};
Local_245[1 /*3*/]={
Local_245[0 /*3*/] 
};
...
Local_245[0 /*3*/]={
Vector(10.9545f, -1419.537f, -605.8271f) - Local_242 
};
fLocal_246[0]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
fLocal_247[0]=40f;
...
Local_245[0 /*3*/]={
Vector(28.2925f, -1451.728f, 507.6885f) - Local_242 
};
fLocal_246[0]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
fLocal_247[0]=40f;
...
while (iVar0 < iLocal_234){
if(iLocal_234[iVar0] !=0){
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_234[iVar0]);
}
iVar0++;
}
iVar0=0;
