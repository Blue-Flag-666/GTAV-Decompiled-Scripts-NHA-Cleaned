...
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_144(uLocal_56, 4194304)){
if(iLocal_67 !=263){
...
fVar1=0f;
if(MISC::GET_GROUND_Z_FOR_3D_COORD(ScriptParam_272.f_1[0 /*3*/], &fVar1, 0, 0)){
if(fVar1 !=0f){
...
fLocal_55=vdist2(Local_53, ScriptParam_272.f_1[0 /*3*/]);
fLocal_55=fLocal_55;
Local_73={
Local_53 
};
...
if((!func_144(uLocal_56, 1) || !ENTITY::DOES_ENTITY_EXIST(func_115())) && !Global_100867){
func_137(10);
break;
}}
}
...
if(bVar3){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_51, ScriptParam_272.f_1[0 /*3*/], fLocal_75, fLocal_75, 2f, 0, 1, iLocal_65)){
bVar3=false;
}
...
}}}elseif(iVar4 < iLocal_77 || iVar4 >=iLocal_78){
func_103(&uLocal_56, 128);
bVar3=false;
if(fLocal_55 < ((fLocal_75 * fLocal_75) + 4f)){
if(!func_144(uLocal_56, 134217728)){
...
elseif(!func_144(uLocal_56, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_92(&iLocal_58);
...
if(func_144(uLocal_56, 2097152)){
if(!func_116(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_48)){
func_137(10);
}}
if(!SCRIPT::IS_THREAD_ACTIVE(uLocal_48)){
STATS::PLAYSTATS_ODDJOB_DONE(round((func_25(&uLocal_69) * 1000f)), iLocal_61, 0);
func_24(&uLocal_69);
...
if(iLocal_61 !=-1){
if(func_144(Global_112460, 0)){
STATS::PLAYSTATS_MISSION_CHECKPOINT(func_32(iLocal_61), 0, Global_100870, 0);
func_19(func_32(iLocal_61), 0, Global_100870, 1, 0);
}else{
STATS::PLAYSTATS_MISSION_CHECKPOINT(func_32(iLocal_61), 0, Global_100870, 0);
func_19(func_32(iLocal_61), 0, Global_100870, 0, 0);
}
}
func_5();
func_151(&Global_112460, 0);
...
void func_8(){
if(Global_113810.f_19019.f_18 < Global_113810.f_19019.f_19[iLocal_80] || Global_113810.f_19019.f_19[iLocal_80]==0){
Global_113810.f_19019.f_19[iLocal_80]=Global_113810.f_19019.f_18;
Global_113810.f_19019.f_18=999;
}
if(iLocal_80==Global_113810.f_19019.f_1 || Global_113810.f_19019.f_1==-1){
...
wait(400);
iVar2=start_new_script_with_args(&Local_49, &Var0, 18, iLocal_59);
...
void func_52(){
float fVar0;
fVar0=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_79);
if(fVar0 < 62500f){
func_82();
func_79();
if(iLocal_95){
...
iVar0=0;
while (iVar0 < func_55()){
if(!ENTITY::DOES_ENTITY_EXIST(Local_265[iVar0 /*14*/]) || !ENTITY::DOES_ENTITY_EXIST(Local_265[iVar0 /*14*/].f_1)){
return 0;
}
iVar0++;
}
if(!ENTITY::DOES_ENTITY_EXIST(Local_265.f_83) || !ENTITY::DOES_ENTITY_EXIST(Local_265.f_83.f_1)){
return 0;
}
return 1;
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_93) && !ENTITY::IS_ENTITY_DEAD(iLocal_93, 0)){
if(AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_93)){
return;
}}
if(func_25(&uLocal_88) >=8f){
iVar0=(MISC::GET_RANDOM_INT_IN_RANGE(0, 65535) % 3) + 1;
if(iVar0 > 0 && iVar0 <=3){
if(ENTITY::IS_ENTITY_DEAD(Local_265[(iVar0 - 1) /*14*/], 0)){
return;
}
switch (iVar0){
case 1:
...
void func_78(){
int iVar0;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !ENTITY::IS_ENTITY_DEAD(Local_265.f_83, 0)){
iVar0=CLOCK::GET_CLOCK_HOURS();
if(iVar0 <=iLocal_77 && iVar0 >=iLocal_78){
iLocal_95=0;
return;
}
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_265.f_83, 0f, 0f, 0.75f, 1, 2000, 2000, 2000, 0);
}}
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_93, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
switch (iLocal_264){
case 0:
if(vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_93, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 64f && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
iLocal_97=0;
iLocal_98=0;
iLocal_264=1;
}
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_93, uVar1);
TASK::CLEAR_SEQUENCE_TASK(&uVar1);
iLocal_264=2;
break;
case 2:
if((TASK::GET_SCRIPT_TASK_STATUS(iLocal_93, joaat("script_task_perform_sequence")) !=1 || PED::IS_PED_FACING_PED(iLocal_93, PLAYER::PLAYER_PED_ID(), 20f)) && !AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_93, PLAYER::PLAYER_PED_ID(), -1);
if(!iLocal_98){
func_80(iLocal_93, "PRERACE_CHAT", "A_M_Y_RACER_01_WHITE_MINI_01", 11);
}else{
func_80(iLocal_93, "PRERACE_TAUNT", "A_M_Y_RACER_01_WHITE_MINI_01", 11);
}
iLocal_264=3;
}
break;
...
if(!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_93)){
func_35(&uLocal_85);
TASK::TASK_PLAY_ANIM(iLocal_93, "random@street_race", "_streetracer_wait_loop", 4f, -4f, -1, 9, 0, 0, 0, 0);
iLocal_264=4;
}
break;
case 4:
if(vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_93, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 225f){
TASK::OPEN_SEQUENCE_TASK(&uVar2);
TASK::TASK_ACHIEVE_HEADING(0, Local_265.f_83.f_9, 1000);
TASK::TASK_PLAY_ANIM(0, Local_265.f_83.f_12, Local_265.f_83.f_13, 4f, -8f, -1, 1, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar2);
TASK::TASK_PERFORM_SEQUENCE(iLocal_93, uVar2);
...
iLocal_97=1;
iLocal_264=1;
}elseif(func_25(&uLocal_85) >=10f && !iLocal_98){
iLocal_98=1;
iLocal_264=1;
}}
break;
...
iVar2=0;
while (iVar2 < 5){
if(ENTITY::DOES_ENTITY_EXIST(Local_265[iVar2 /*14*/].f_1) && ENTITY::DOES_ENTITY_EXIST(Local_265[iVar2 /*14*/])){
if(func_87(Local_265[iVar2 /*14*/], 1, 0, 0, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_265[iVar2 /*14*/].f_1, 1)){
func_85();
func_84(iLocal_67);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0);
}
if(!PED::IS_PED_INJURED(Local_265[iVar2 /*14*/])){
if(func_28(&(Local_81[iVar2 /*3*/]))){
if(func_25(&(Local_81[iVar2 /*3*/])) > uLocal_91[iVar2]){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Local_265[iVar2 /*14*/].f_1, 0) && PED::IS_PED_IN_VEHICLE(Local_265[iVar2 /*14*/], Local_265[iVar2 /*14*/].f_1, 0)){
iVar0=MISC::GET_RANDOM_INT_IN_RANGE(250, 500);
iVar1=MISC::GET_RANDOM_INT_IN_RANGE(250, 500);
TASK::OPEN_SEQUENCE_TASK(&uVar3);
TASK::TASK_VEHICLE_TEMP_ACTION(0, Local_265[iVar2 /*14*/].f_1, 1, iVar0);
TASK::TASK_VEHICLE_TEMP_ACTION(0, Local_265[iVar2 /*14*/].f_1, 31, iVar1);
TASK::CLOSE_SEQUENCE_TASK(uVar3);
if(!PED::IS_PED_INJURED(Local_265[iVar2 /*14*/])){
TASK::TASK_PERFORM_SEQUENCE(Local_265[iVar2 /*14*/], uVar3);
}
TASK::CLEAR_SEQUENCE_TASK(&uVar3);
}
func_35(&(Local_81[iVar2 /*3*/]));
uLocal_91[iVar2]=MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 3f);
}}else{
func_37(&(Local_81[iVar2 /*3*/]));
}}
if(!ENTITY::IS_ENTITY_DEAD(Local_265[iVar2 /*14*/], 0)){
if((ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_265[iVar2 /*14*/]) && !PED::IS_PED_RAGDOLL(Local_265[iVar2 /*14*/])) && !TASK::IS_PED_GETTING_UP(Local_265[iVar2 /*14*/])){
Local_265[iVar2 /*14*/].f_11=1;
}elseif(Local_265[iVar2 /*14*/].f_11){
TASK::OPEN_SEQUENCE_TASK(&uVar3);
TASK::TASK_ACHIEVE_HEADING(0, Local_265[iVar2 /*14*/].f_9, 1000);
TASK::TASK_PLAY_ANIM(0, Local_265[iVar2 /*14*/].f_12, Local_265[iVar2 /*14*/].f_13, 4f, -8f, -1, 1, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar3);
TASK::TASK_PERFORM_SEQUENCE(Local_265[iVar2 /*14*/], uVar3);
TASK::CLEAR_SEQUENCE_TASK(&uVar3);
Local_265[iVar2 /*14*/].f_11=0;
}
if(PED::IS_PED_RAGDOLL(Local_265[iVar2 /*14*/]) || TASK::IS_PED_GETTING_UP(Local_265[iVar2 /*14*/])){
if(!Local_265[iVar2 /*14*/].f_10 && (PED::IS_PED_RAGDOLL(Local_265[iVar2 /*14*/]) || TASK::IS_PED_GETTING_UP(Local_265[iVar2 /*14*/]))){
Local_265.f_101++;
}
Local_265[iVar2 /*14*/].f_10=1;
}elseif(Local_265[iVar2 /*14*/].f_10){
TASK::OPEN_SEQUENCE_TASK(&uVar3);
...
if(ENTITY::DOES_ENTITY_EXIST(Local_265.f_83.f_1) && ENTITY::DOES_ENTITY_EXIST(Local_265.f_83)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_265.f_83.f_1, 0)){
...
if(!PED::IS_PED_INJURED(Local_265.f_83)){
if(func_28(&uLocal_82)){
if(func_25(&uLocal_82) > fLocal_92){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Local_265.f_83.f_1, 0) && PED::IS_PED_IN_VEHICLE(Local_265.f_83, Local_265.f_83.f_1, 0)){
iVar0=MISC::GET_RANDOM_INT_IN_RANGE(250, 500);
iVar1=MISC::GET_RANDOM_INT_IN_RANGE(250, 500);
TASK::OPEN_SEQUENCE_TASK(&uVar3);
TASK::TASK_VEHICLE_TEMP_ACTION(0, Local_265.f_83.f_1, 1, iVar0);
TASK::TASK_VEHICLE_TEMP_ACTION(0, Local_265.f_83.f_1, 31, iVar1);
TASK::CLOSE_SEQUENCE_TASK(uVar3);
if(!PED::IS_PED_INJURED(Local_265.f_83)){
TASK::TASK_PERFORM_SEQUENCE(Local_265.f_83, uVar3);
}
TASK::CLEAR_SEQUENCE_TASK(&uVar3);
}
func_35(&uLocal_82);
fLocal_92=MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 3f);
}}else{
func_37(&uLocal_82);
}}
if(!ENTITY::IS_ENTITY_DEAD(Local_265.f_83, 0)){
if((ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_265.f_83) && !PED::IS_PED_RAGDOLL(Local_265.f_83)) && !TASK::IS_PED_GETTING_UP(Local_265.f_83)){
Local_265.f_83.f_11=1;
}elseif(Local_265.f_83.f_11){
TASK::OPEN_SEQUENCE_TASK(&uVar3);
TASK::TASK_ACHIEVE_HEADING(0, Local_265.f_83.f_9, 1000);
TASK::TASK_PLAY_ANIM(0, Local_265.f_83.f_12, Local_265.f_83.f_13, 4f, -8f, -1, 1, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar3);
...
if(PED::IS_PED_RAGDOLL(Local_265.f_83) || TASK::IS_PED_GETTING_UP(Local_265.f_83)){
if(!Local_265.f_83.f_10){
Local_265.f_101++;
}
Local_265.f_83.f_10=1;
}elseif(Local_265.f_83.f_10){
TASK::OPEN_SEQUENCE_TASK(&uVar3);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1000);
TASK::TASK_PLAY_ANIM(0, "gestures@m@standing@casual", func_83(), 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_ACHIEVE_HEADING(0, Local_265.f_83.f_9, 1000);
TASK::TASK_PLAY_ANIM(0, Local_265.f_83.f_12, Local_265.f_83.f_13, 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar3);
TASK::TASK_PERFORM_SEQUENCE(Local_265.f_83, uVar3);
TASK::CLEAR_SEQUENCE_TASK(&uVar3);
iLocal_264=4;
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_113()) || Global_112857) || Global_32286) || func_112()) || func_98(8, -1)) || func_111()) || func_110()) || func_109()) || func_100()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_113()) || Global_32286) || func_112()) || func_98(8, -1)) || func_109()) || func_111()) || func_110()) || func_100()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_113()) || Global_112857) || Global_32286) || func_112()) || func_98(8, -1)) || func_109()) || func_111()) || func_110()) || func_100()) || Global_113810.f_7691.f_919[iVar0]==5) || Global_43924 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_113()) || Global_112857) || Global_32286) || func_112()) || func_98(8, -1)) || func_111()) || func_110()) || func_100()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_113()) || Global_32286) || func_112()) || func_98(8, -1)) || func_110()) || func_109()) || func_100()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_113()) || func_110()) || Global_112857) || Global_32286) || func_112()) || Global_44569) || func_98(8, -1)) || func_109()) || func_108()) || func_100()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_113()) || Global_112857) || Global_32286) || func_112()) || func_98(8, -1)) || func_109()) || func_108()) || func_111()) || func_110()) || func_100()){
return 0;
}
break;
}}else{
...
char* sVar1;
iVar0=CLOCK::GET_CLOCK_HOURS();
if((iVar0 <=iLocal_77 && iVar0 >=iLocal_78) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) !=0){
return;
}
if(bLocal_94){
func_129();
...
Local_265[iVar5 /*14*/].f_1=VEHICLE::CREATE_VEHICLE(func_124(0), Local_265[iVar5 /*14*/].f_2, Local_265[iVar5 /*14*/].f_5, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_265[iVar5 /*14*/].f_1, 1084227584);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_265[iVar5 /*14*/].f_1, 1);
if(func_125(Local_265[iVar5 /*14*/].f_6)){
Local_265[iVar5 /*14*/]=PED::CREATE_PED_INSIDE_VEHICLE(Local_265[iVar5 /*14*/].f_1, 4, func_123(), -1, 1, 1);
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_265[iVar5 /*14*/].f_1, 1, 0, 0);
}else{
Local_265[iVar5 /*14*/]=PED::CREATE_PED(4, func_123(), Local_265[iVar5 /*14*/].f_6, Local_265[iVar5 /*14*/].f_9, 1, 1);
iVar1=iVar5;
switch (iVar1){
case 0:
case 3:
...
TASK::TASK_PERFORM_SEQUENCE(Local_265[iVar5 /*14*/], uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
}
PED::SET_PED_HELMET(Local_265[iVar5 /*14*/], 1);
PED::GIVE_PED_HELMET(Local_265[iVar5 /*14*/], 1, 4096, -1);
}
iVar5++;
}
Local_265.f_83.f_1=VEHICLE::CREATE_VEHICLE(func_124(1), Local_265.f_83.f_2, Local_265.f_83.f_5, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_265.f_83.f_1, 1084227584);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_265.f_83.f_1, 1);
if(func_125(Local_265.f_83.f_6)){
Local_265.f_83=PED::CREATE_PED_INSIDE_VEHICLE(Local_265.f_83.f_1, 4, func_123(), -1, 1, 1);
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_265.f_83.f_1, 1, 0, 0);
}else{
Local_265.f_83=PED::CREATE_PED(4, func_123(), Local_265.f_83.f_6, Local_265.f_83.f_9, 1, 1);
...
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(Local_265.f_83, uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
}}elseif(fLocal_72 < 225f){}
iLocal_93=Local_265.f_83;
if(!ENTITY::IS_ENTITY_DEAD(Local_265[0 /*14*/], 0)){
func_121(&uLocal_99, 1, Local_265[0 /*14*/], "MALE1", 0, 1);
}
if(!ENTITY::IS_ENTITY_DEAD(Local_265[1 /*14*/], 0)){
func_121(&uLocal_99, 2, Local_265[1 /*14*/], "MALE2", 0, 1);
}
if(!ENTITY::IS_ENTITY_DEAD(Local_265[2 /*14*/], 0)){
...
if(STREAMING::IS_MODEL_A_VEHICLE(Local_265.f_71[iVar1])){
iVar0++;
}
iVar1++;
}
...
Local_265[iVar0 /*14*/].f_2={
Param0 
};
Local_265[iVar0 /*14*/].f_5=fParam1;
Local_265[iVar0 /*14*/].f_6={
Param2 
};
...
var func__130(){
return ((((((((func_131(&(Local_265.f_71)) && func_131(&(Local_265.f_77))) && func_131(&(Local_265.f_99))) && STREAMING::HAS_ANIM_DICT_LOADED("amb@world_human_hang_out_street@male_a@idle_a")) && STREAMING::HAS_ANIM_DICT_LOADED("amb@world_human_hang_out_street@male_b@idle_a")) && STREAMING::HAS_ANIM_DICT_LOADED("amb@world_human_hang_out_street@male_c@idle_a")) && STREAMING::HAS_ANIM_DICT_LOADED("amb@world_human_aa_smoke@male@idle_a")) && STREAMING::HAS_ANIM_DICT_LOADED("random@street_race")) && STREAMING::HAS_ANIM_DICT_LOADED("gestures@m@standing@casual"));
}
...
fLocal_64=(to_float(func_147(iLocal_67)) + 5f);
if(func_141(0, iLocal_61)){
bLocal_94=true;
}else{
func_84(iLocal_67);
...
if(iLocal_80 > Global_113810.f_19019.f_1){
if(func_117(func_148(iLocal_80))){
}
iLocal_67=263;
func_84(iLocal_67);
}
if(!func_117(func_148(iLocal_80)) && CAM::IS_SCREEN_FADED_IN()){
if(iLocal_67 !=263){
...
if(bParam1){
return MISC::IS_BIT_SET(Global_32663[iVar0 /*23*/].f_11, 15);
}
return MISC::IS_BIT_SET(Global_32663[iVar0 /*23*/].f_11, 0);
}
