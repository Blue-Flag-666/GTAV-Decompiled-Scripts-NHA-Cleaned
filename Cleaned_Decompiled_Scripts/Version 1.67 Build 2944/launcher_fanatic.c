...
if(Var0.f_0==21){
func_205(&Var0, Var1, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
}elseif(Var0.f_0==22){
func_200(&Var0, Var1, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
}elseif(Var0.f_0==23){
if(iLocal_54==0){
if(func_205(&Var0, Var1, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50)){
iLocal_54=1;
}}else{
func_197(&Var0);
}}
...
func_300("ARE_RC_TRIGGER_CONDITIONS_MET:
RC_TRIG_CHAR - Used special case Eps 4 trigger.");
return 1;
}}
}}else{
return 0;
}}elseif(func_208(iParam0->f_28[0])){
if(func_184(iParam0)){
if(func_188(2)){
if(func_186(iParam0->f_27)){
func_185(iParam0->f_27, *iParam0);
...
if(*iParam0==6){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_208(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
...
if(func_186(iParam0->f_27)){
func_185(iParam0->f_27, *iParam0);
func_300("RC5_IN_ACTIVATION_RANGE:
...
if(func_186(1)){
func_185(1, *iParam0);
func_300("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_300("RC_STOP_PLAYER_VEHICLE_CHECK:
...
if((MISC::GET_GAME_TIMER() - iLocal_55) >=900){
if(func_208(iParam0->f_28[0])){
if(!func_155()){
...
void func_198(var uParam0, char* sParam1, char* sParam2, int iParam3){
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(uParam0, sParam1, sParam2, func_199(iParam3), 0);
}
...
int func_200(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7){
var uVar0;
if((((func_208(PLAYER::PLAYER_PED_ID()) && func_208(iParam0->f_28[0])) && !func_155()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_204(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7){
uVar0=16;
func_203(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
...
int func_205(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6){
var uVar0;
if(func_188(2)){
if(!func_155()){
if(((func_208(PLAYER::PLAYER_PED_ID()) && func_208(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_204(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f){
uVar0=16;
func_203(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
func_201(&uVar0, cParam2, sParam3, 7, 0, 0);
iParam0->f_60=MISC::GET_GAME_TIMER();
return 1;
}}elseif(func_206(sParam3)){
...
struct<27> Var0;
if(Global_78689){
func_300("IS_RC_FINE_AND_IN_RANGE():
...
uParam1->f_3=5;
}elseif((func_220(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
if(func_208(PLAYER::PLAYER_PED_ID()) && func_208(uParam0)){
...
int func_258(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_259(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
int func_259(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_36(iParam1)){
...
iVar1=0;
while (iVar1 <=1){
if(func_208(uParam0->f_35[iVar1])){
...
void func_268(var uParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4){
func_269(uParam0);
