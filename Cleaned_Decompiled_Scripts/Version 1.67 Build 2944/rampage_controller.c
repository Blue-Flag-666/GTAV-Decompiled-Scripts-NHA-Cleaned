...
func_23(iVar1, 1);
func_22(iVar1, 44);
if(((Global_113810.f_2355[iVar0 /*2*/] >=1 || func_36(108)==1) || func_21((iLocal_27 + iVar0), 0)) || MISC::IS_BIT_SET(Global_113810.f_18577[(iLocal_28 + iVar0) /*6*/], 3)){
func_20(iVar1, 1);
}
iVar0++;
}}
...
func_32(13, floor(Global_113810.f_10197.f_3853));
}
