...
if(func_70()){
func_67(&uLocal_113, -271.6364f, 289.377f, 103.994f, 63, "MSG_BLP_EL", 0.8f, 0, 0);
}else{
func_66(&uLocal_113);
}}
if(func_65()){
...
if(((((((((((func_54(uParam0) || func_50(uParam0)) || func_49(uParam0)) || !func_48(uParam0)) || func_46(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || MISC::IS_BIT_SET(Global_1950844.f_4, 2)){
...
Var2={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_38(uParam0), func_37(uParam0), 0, 2) 
};
Var3={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_38(uParam0), func_37(uParam0), 0, 2) 
};
uVar4=Var3.f_2;
fVar5=0.05f;
...
PAD::DISABLE_CONTROL_ACTION(0, 0, 1);
uParam0->f_8=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(func_38(uParam0), func_37(uParam0), 2, 1, 0, 1065353216, 0, 1.12f);
...
func_25(uParam0);
func_14(uParam0);
uVar9=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_8);
if(func_23(&(uParam0->f_7), 13)){
PAD::DISABLE_CONTROL_ACTION(0, 0, 1);
}
...
break;
case 8:
uVar10=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_8);
...
if((PED::GET_SYNCHRONIZED_SCENE_PHASE(uVar10) >=0.7f || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), MISC::GET_HASH_KEY("BREAKOUT_FINISH"))) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), MISC::GET_HASH_KEY("BREAK_OUT"))){
NETWORK::NETWORK_STOP_SYNCHRONISED_SCENE(uParam0->f_8);
func_3(-1);
func_4(uParam0);
func_2(uParam0, 0);
...
if(iParam2==3){
if(func_24(ENTITY::GET_ENTITY_HEADING(uParam0), (Param1.f_2 - 180f), 45f)){
return 1;
}}elseif(func_24(ENTITY::GET_ENTITY_HEADING(uParam0), Param1.f_2, 45f)){
return 1;
}}
return 0;
}
...
func_63(&(uParam0->f_7), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0));
func_63(&(uParam0->f_7), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1));
...
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(*uParam0, sParam3);
HUD::SET_BLIP_DISPLAY(*uParam0, 4);
HUD::SET_BLIP_SCALE(*uParam0, fParam4);
HUD::SET_BLIP_AS_SHORT_RANGE(*uParam0, iParam5);
if(bParam6){
...
bool func_70(){
return MISC::IS_BIT_SET(Global_1950844.f_11, 17);
}
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_83(PLAYER::PLAYER_ID()), Global_1950844.f_1030[161 /*3*/], 1) >=150f){
return 1;
}
if(func_75()){
return 1;
...
}elseif((Global_1575063 && iParam0==PLAYER::PLAYER_ID()) && func_53(iParam0, 1, 0)){
return Global_2657704[iParam0 /*463*/].f_321.f_7 !=-1;
}}
return 0;
}
...
}elseif(bVar14 || ((!func_99(PLAYER::PLAYER_ID(), 0) && !func_98()) && !func_97(PLAYER::PLAYER_ID()))){
...
func_108(func_109(), fVar1) + Var0 
};
uParam1->f_16[iParam2 /*14*/].f_6.f_4={
func_108(func_107(), fVar1) + Var0 
};
...
Vector3 func__108(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
case 0:
*uParam1={
-279.9811f, 283.0351f, 104.0037f 
};
*uParam2=90f;
break;
case 1:
*uParam1={
-279.9811f, 284.4101f, 104.0037f 
};
*uParam2=90f;
break;
case 2:
*uParam1={
-278.4811f, 286.0601f, 104.0037f 
};
*uParam2=0f;
break;
case 3:
*uParam1={
-276.1936f, 284.2101f, 104.0037f 
};
*uParam2=-90f;
break;
case 4:
*uParam1={
-276.1936f, 283.022f, 104.0037f 
};
*uParam2=-90f;
break;
case 5:
*uParam1={
-270.1061f, 284.4601f, 104.0037f 
};
*uParam2=-90f;
break;
case 6:
*uParam1={
-271.7186f, 286.0476f, 104.0037f 
};
*uParam2=0f;
break;
case 7:
*uParam1={
-274.4186f, 284.9351f, 104.0037f 
};
*uParam2=69f;
break;
}}
