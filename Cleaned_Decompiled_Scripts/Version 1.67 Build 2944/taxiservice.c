...
iLocal_39=49;
iLocal_40=64;
iLocal_42=HUD::GET_STANDARD_BLIP_ENUM_ID();
iLocal_43=HUD::GET_WAYPOINT_BLIP_ENUM_ID();
...
iLocal_103=-1;
iLocal_104=-1;
sLocal_105=PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 195, 1);
...
func_5();
if(func_3(Global_112841) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_112841, 1)){
...
if(!PED::IS_PED_INJURED(Global_112842) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
if(PED::IS_PED_IN_VEHICLE(Global_112842, Global_112841, 0)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(Global_112842, Global_112841, PLAYER::PLAYER_PED_ID(), 8, 25f, 790564, 300f, 15f, 1);
}}elseif(!PED::IS_PED_FLEEING(Global_112842)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
TASK::TASK_SMART_FLEE_PED(Global_112842, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
}}
PED::SET_PED_KEEP_TASK(Global_112842, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_112842, 0);
}}elseif(!PED::IS_PED_INJURED(Global_112842) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
if(PED::IS_PED_IN_VEHICLE(Global_112842, Global_112841, 0)){
...
if(!ENTITY::IS_ENTITY_DEAD(Global_112841, 0)){
if(PED::IS_PED_IN_VEHICLE(iVar2, Global_112841, 0)){
...
void func_7(){
bool bVar0;
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
...
func_45(Global_112842, &iLocal_816);
func_9(func_56(), 21, iLocal_99);
bVar0=false;
}
}
elseif(iLocal_64 || iLocal_819==3){
if(iLocal_99 > 0){
iLocal_816=13;
func_45(Global_112842, &iLocal_816);
func_9(func_56(), 21, iLocal_99);
...
elseif(ENTITY::GET_ENTITY_SPEED(Global_112841) > 5f){
if(!func_8()){
iLocal_816=12;
func_45(Global_112842, &iLocal_816);
...
}}elseif(MISC::IS_BIT_SET(Global_113810.f_20567.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_15() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
var func__24(int iParam0, int iParam1){
if(iParam1==-1){
iParam1=func_19();
}
...
if(!PED::IS_PED_INJURED(Global_112842) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
if(PED::IS_PED_SITTING_IN_VEHICLE(Global_112842, Global_112841)){
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112842, &cLocal_822, "leanover_enter", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112842, &cLocal_822, "leanover_idle", 3)){
...
func_175(&Global_112841, iLocal_837);
if(func_174()){
...
if(!MISC::ARE_STRINGS_EQUAL(sLocal_105, sVar0)){
sLocal_105=sVar0;
iLocal_56=1;
}
if(iLocal_56){
...
func_77(&uLocal_111);
func_76(0, 75, "TXM_EXIT", &uLocal_111, 0, 363);
if(iLocal_89 > 1){
func_76(2, 218, "TXM_CDES", &uLocal_111, 0, 363);
}
if(!bLocal_58){
if(iLocal_89 > 0){
func_76(2, 176, "TXM_SLCT", &uLocal_111, 0, 363);
}}elseif(iLocal_819==2){
func_76(2, 177, "TXM_STOP", &uLocal_111, 0, 363);
if(bLocal_57){
func_76(2, 176, "TXM_SLCT", &uLocal_111, 0, 363);
}
if(func_75()){
func_76(2, 176, "TXM_SKIP", &uLocal_111, 0, 363);
}
if(!bLocal_62){
func_76(2, 179, "TXM_HURY", &uLocal_111, 0, 363);
}}elseif(iLocal_819==3){
func_76(2, 177, "TXM_STRT", &uLocal_111, 0, 363);
if(bLocal_57){
func_76(2, 176, "TXM_SLCT", &uLocal_111, 0, 363);
}}
iLocal_56=0;
...
func_70(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(iVar1, iVar2, 1));
if(iVar3 < 363){
func_70(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(iVar1, iVar3, 1));
}}else{
uVar4=uParam2->f_1[bVar0 /*57*/].f_54;
uVar5=uParam2->f_1[bVar0 /*57*/].f_55;
func_70(PAD::GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTONS_STRING(uVar4, uVar5, 1));
}
...
if(CAM::DOES_CAM_EXIST(uLocal_66)){
if(CAM::IS_CAM_ACTIVE(uLocal_66)){
return 0;
}}
return 1;
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
AUDIO::SET_VEHICLE_RADIO_ENABLED(Global_112841, 0);
}
HUD::CLEAR_PRINTS();
...
Global_112858=0;
CAM::SET_CAM_ACTIVE(uLocal_66, 0);
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
...
func_117();
func_116();
MISC::CLEAR_AREA(Global_112848, 5f, 1, 0, 0, 0);
func_112(1097859072);
if(!PED::IS_PED_INJURED(Global_112842) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
ENTITY::SET_ENTITY_COORDS(Global_112841, Global_112848, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(Global_112841, Global_112854);
ENTITY::FREEZE_ENTITY_POSITION(Global_112841, 1);
}
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
STREAMING::NEW_LOAD_SCENE_STOP();
MISC::CLEAR_AREA(Global_112848, 5000f, 1, 0, 0, 0);
...
iLocal_55=1;
iLocal_821=5;
}elseif(func_161(iLocal_87, 2500)){
iLocal_821=5;
}
break;
case 5:
...
iLocal_821=6;
}elseif(func_161(iLocal_87, 20000)){
if(iLocal_813 !=-1){
STREAMING::NEW_LOAD_SCENE_STOP();
iLocal_55=0;
func_107(iLocal_813);
...
if(iLocal_813 !=-1){
bVar1=true;
if(Global_91601[iLocal_813 /*34*/].f_13==-1 && Global_91601[iLocal_813 /*34*/].f_14==-1){
bVar1=false;
}
if(bVar1){
if(((func_56()==0 && !MISC::IS_BIT_SET(Global_91601[iLocal_813 /*34*/].f_15, 8)) || (func_56()==1 && !MISC::IS_BIT_SET(Global_91601[iLocal_813 /*34*/].f_15, 9))) || (func_56()==2 && !MISC::IS_BIT_SET(Global_91601[iLocal_813 /*34*/].f_15, 10))){
bVar1=false;
}}
if(bVar1){
if(func_104(Global_91601[iLocal_813 /*34*/].f_13, Global_91601[iLocal_813 /*34*/].f_14)){
bVar1=false;
}}
if(bVar1){
CLOCK::ADVANCE_CLOCK_TIME_TO(Global_91601[iLocal_813 /*34*/].f_13, 0, 0);
}}
...
if(iLocal_65){
iLocal_65=0;
MISC::GET_GROUND_Z_FOR_3D_COORD(Global_112848 + Vector(100f, 0f, 0f), &fVar2, 0, 0);
...
func_82();
if(!PED::IS_PED_INJURED(Global_112842) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
ENTITY::FREEZE_ENTITY_POSITION(Global_112841, 0);
ENTITY::SET_ENTITY_HEADING(Global_112841, Global_112854);
ENTITY::SET_ENTITY_COORDS(Global_112841, Global_112848, 1, 0, 0, 1);
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
AUDIO::SET_VEHICLE_RADIO_ENABLED(Global_112841, 1);
}
if(!func_81()){
...
if(((!Global_97741 && iLocal_813 !=-1) && iLocal_813 !=72) && iLocal_813 !=87){
func_110(iLocal_813);
}
func_162(0);
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_112841, 1)){
TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}}
TASK::TASK_VEHICLE_TEMP_ACTION(Global_112842, Global_112841, 24, 5000);
PED::SET_PED_KEEP_TASK(Global_112842, 1);
...
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Global_112848, Var0, 1);
if(fVar1 < 100f){
Var0={
func_83(Global_112848 - Var0) 
};
Var0={
(Global_112848 + (Var0.f_0 * IntToFloat((100 - round(fVar1))))), (Global_112848.f_1 + (Var0.f_1 * IntToFloat((100 - round(fVar1))))), Global_112848.f_2 
};
PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(Var0, &Global_112848, &Global_112854, 1, 1077936128, 0);
ENTITY::SET_ENTITY_COORDS(Global_112841, Global_112848, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(Global_112841, Global_112854);
}
break;
...
return (func_89(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return uParam0->f_1;
}
...
iVar1=70;
while (iVar1 <=72){
fVar2=vdist2(func_84(iVar1, 0), Param0);
if(fVar2 <=1225f){
iVar0++;
}
iVar1++;
...
bVar1=false;
if(PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(Global_112848, iVar2, &Var3, 1, 1077936128, 0)){
iVar2++;
}}}
if(vdist2(Var3, Global_112848) > 2f){
PATHFIND::GET_SAFE_COORD_FOR_PED(Var3, 0, &Global_112848, 0);
}}
...
fVar0=func_120(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Global_112848);
if(bLocal_62){
...
func_118((to_float((iVar1 * 60 + iVar2)) / 60f));
}
...
float fVar0;
int iVar1;
fVar0=(((func_120(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Global_112848) / 50f) * fLocal_71) * 2.4f);
iVar1=(floor(fLocal_80) + round(fVar0));
...
void func_122(){
iLocal_101=(iLocal_101 + round((MISC::GET_FRAME_TIME() * 1000f)));
if(iLocal_101 > 5000){
fLocal_80=(fLocal_80 + fLocal_71);
iLocal_101=0;
}
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_831, 0) > 50f){
fLocal_80=(fLocal_80 + fLocal_71);
iLocal_101=0;
Local_831={
...
iLocal_99=ceil(fLocal_80);
if(iLocal_99 !=iLocal_100){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_109, "SET_TAXI_PRICE");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_99);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
fLocal_81=vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Global_112848);
...
if(!func_39(14)){
fVar1=PATHFIND::CALCULATE_TRAVEL_DISTANCE_BETWEEN_POINT(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Global_112848);
...
if(func_126(&Global_112841, ENTITY::GET_ENTITY_COORDS(Global_112841, 0), Local_827, uParam1, uParam2, &iLocal_86, iParam0, 1000)){
iLocal_818=3;
return 0;
}else{
return 0;
...
*uParam3={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(*uParam3, *uParam4, fVar9, 0f, 0f) 
};
if(VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam0, 0)){
iVar5=*uParam0;
}
...
*uParam2=163.87f;
return 1;
}elseif(func_144(Param0, -3800f, 5400f, -100f, -1900f, 8500f, 100f)){
*uParam1={
-1577.16f, 5166.51f, 19.1864f 
};
*uParam2=0f;
return 1;
}elseif(func_144(Param0, -874.9833f, 125.7645f, -100f, -768.6254f, 193.0297f, 100f)){
*uParam1={
-856.6151f, 163.7361f, 65.093f 
};
*uParam2=355.3355f;
return 1;
}elseif(func_144(Param0, -39.2005f, -1473.55f, -100f, 10.6133f, -1430.099f, 100f)){
*uParam1={
-15.5181f, -1456.4f, 29.4244f 
};
*uParam2=94.6893f;
return 1;
}elseif(func_144(Param0, 1964.742f, 3792.59f, -100f, 1992.636f, 3840.253f, 100f)){
*uParam1={
...
return vdist2(Param1, func_143(iParam0)) < func_142(iParam0);
}
...
while (iVar4 < 63){
*iParam1=iVar4;
if(MISC::IS_BIT_SET(Global_113810.f_18577[*iParam1 /*6*/], 0) && !MISC::IS_BIT_SET(Global_113810.f_18577[*iParam1 /*6*/], 3)){
func_98(*iParam1, &Var5);
if(MISC::IS_BIT_SET(Var5.f_26, func_156())){
Var3={
Var5.f_6 
};
if(uParam0->f_2==1f){
...
iVar4=0;
while (iVar4 < 8){
if(Global_97746[iVar4 /*17*/]){
if(Global_97746[iVar4 /*17*/].f_9 !=263){
if(HUD::DOES_BLIP_EXIST(Global_32663[Global_97746[iVar4 /*17*/].f_9 /*23*/].f_19)){
Var3={
HUD::GET_BLIP_COORDS(Global_32663[Global_97746[iVar4 /*17*/].f_9 /*23*/].f_19) 
};
if(uParam0->f_2==1f){
Var3.f_2=1f;
}
fVar2=vdist(*uParam0, Var3);
if(fVar2 < fVar1){
if(fVar2 < Global_97746[iVar4 /*17*/].f_10.f_2){
fVar1=fVar2;
iVar0=iVar4;
}}}}}
iVar4++;
...
iVar3=0;
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112841, iVar3, 0)){
...
func_175(&Global_112841, iLocal_837);
}elseif(!func_2(Global_112842, joaat("script_task_vehicle_park"))){
Var0={
ENTITY::GET_ENTITY_COORDS(Global_112841, 1) 
};
uVar1=ENTITY::GET_ENTITY_HEADING(Global_112841);
TASK::TASK_VEHICLE_PARK(Global_112842, Global_112841, Var0, uVar1, 3, 60f, 0);
}}}}
...
bLocal_63=true;
iLocal_820=2;
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112842, &cLocal_822, "leanover_enter", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112842, &cLocal_822, "leanover_idle", 3)){
if(PED::IS_PED_HEADTRACKING_PED(Global_112842, PLAYER::PLAYER_PED_ID())){
TASK::TASK_CLEAR_LOOK_AT(Global_112842);
}
TASK::TASK_PLAY_ANIM(Global_112842, &cLocal_822, "leanover_exit", 4f, -4f, -1, 0, 0, 0, 0, 0);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112842, &cLocal_822, "leanover_exit", 3)){
ENTITY::SET_ENTITY_ANIM_SPEED(Global_112842, &cLocal_822, "leanover_exit", 1.2f);
iLocal_88=MISC::GET_GAME_TIMER();
func_175(&Global_112841, iLocal_837);
}elseif(!func_2(Global_112842, joaat("script_task_perform_sequence"))){
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_811);
TASK::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, Global_112841, Global_112848, fVar1, iVar0, 45f);
TASK::TASK_VEHICLE_PARK(0, Global_112841, Global_112848, Global_112854, iLocal_108, 60f, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_811);
TASK::TASK_PERFORM_SEQUENCE(Global_112842, uLocal_811);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_811);
}}}}}}}
...
bVar4=true;
iVar2=VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_112841, iVar6, 0);
...
int func_173(){
if((ENTITY::IS_ENTITY_AT_COORD(Global_112841, Global_112848, 45f, 45f, 20f, 0, 1, 0) || iLocal_54) || iLocal_819==4){
iLocal_54=1;
...
if(bLocal_59){
return 1;
}elseif(func_125(&Local_41, &Global_112848, &Global_112854)){
iLocal_101=0;
Local_831={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0) 
};
...
if(!PED::IS_PED_INJURED(Global_112842) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
if(PED::IS_PED_SITTING_IN_VEHICLE(Global_112842, Global_112841)){
STREAMING::REQUEST_ANIM_DICT(&cLocal_822);
if(STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_822)){
if(PED::IS_PED_HEADTRACKING_PED(Global_112842, PLAYER::PLAYER_PED_ID())){
TASK::TASK_CLEAR_LOOK_AT(Global_112842);
}
TASK::OPEN_SEQUENCE_TASK(&uLocal_811);
TASK::TASK_PLAY_ANIM(0, &cLocal_822, "leanover_enter", 4f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, &cLocal_822, "leanover_idle", 4f, -8f, -1, 1, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_811);
TASK::TASK_PERFORM_SEQUENCE(Global_112842, uLocal_811);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_811);
return 1;
...
if(ENTITY::DOES_ENTITY_EXIST(Global_112841)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
iLocal_107=OBJECT::CREATE_OBJECT(iLocal_106, ENTITY::GET_ENTITY_COORDS(Global_112841, 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_107, Global_112841, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(Global_112841, "Chassis"), Local_835, Local_836, 0, 0, 0, 0, 2, 1, 0);
VEHICLE::SET_TAXI_LIGHTS(Global_112841, 0);
if(!HUD::IS_NAMED_RENDERTARGET_REGISTERED("taxi")){
HUD::REGISTER_NAMED_RENDERTARGET("taxi", 0);
HUD::LINK_NAMED_RENDERTARGET(ENTITY::GET_ENTITY_MODEL(iLocal_107));
}
uLocal_91=HUD::GET_NAMED_RENDERTARGET_RENDER_ID("taxi");
}}
return 0;
}
...
uLocal_109=GRAPHICS::REQUEST_SCALEFORM_MOVIE("taxi_display");
uLocal_110=GRAPHICS::REQUEST_SCALEFORM_MOVIE("instructional_buttons");
STREAMING::REQUEST_ANIM_DICT(&cLocal_822);
if(((STREAMING::HAS_MODEL_LOADED(iLocal_106) && GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_109)) && GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_110)) && STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_822)){
return 1;
}
return 0;
}
...
uLocal_66=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 0);
CAM::ATTACH_CAM_TO_ENTITY(uLocal_66, Global_112841, Local_833, 1);
func_183();
CAM::SET_CAM_CONTROLS_MINI_MAP_HEADING(uLocal_66, 1);
}}elseif(!bLocal_58 || bLocal_57){
if(!func_187() && !func_186(8, -1)){
if(!CAM::IS_CAM_ACTIVE(uLocal_66)){
func_182(4, 1, -1);
CAM::SET_CAM_CONTROLS_MINI_MAP_HEADING(uLocal_66, 1);
func_181();
CAM::SET_CAM_ACTIVE(uLocal_66, 1);
...
}}elseif(CAM::IS_CAM_ACTIVE(uLocal_66)){
CAM::SET_CAM_ACTIVE(uLocal_66, 0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_109, "HIGHLIGHT_DESTINATION");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_90);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
Var0={
HUD::GET_BLIP_COORDS(Local_41.f_0) 
};
if(CAM::DOES_CAM_EXIST(uLocal_66) && CAM::IS_CAM_ACTIVE(uLocal_66)){
...
void func_183(){
if(CAM::DOES_CAM_EXIST(uLocal_66)){
func_184(Global_112841, &uLocal_66, Local_834);
CAM::SET_CAM_FOV(uLocal_66, fLocal_72);
CAM::SET_CAM_NEAR_CLIP(uLocal_66, 0.01f);
CAM::SET_CAM_IS_INSIDE_VEHICLE(uLocal_66, 1);
...
uVar3=Var0.f_1;
Var4={
func_83(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_112841, Param2) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_112841, Local_833)) 
};
...
iVar0=0;
func_193();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_109, "CLEAR_TAXI_DISPLAY");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
iVar0=0;
while (iVar0 < iLocal_89){
if(!HUD::DOES_BLIP_EXIST(Local_817[iVar0 /*3*/])){
}elseif(func_128(Local_817[iVar0 /*3*/])==-1){
}elseif(func_132(HUD::GET_BLIP_COORDS(Local_817[iVar0 /*3*/]), 0f, 0f, 0f, 1056964608, 0)){
}else{
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_109, "ADD_TAXI_DESTINATION");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(HUD::GET_BLIP_SPRITE(Local_817[bVar0 /*3*/]));
HUD::GET_HUD_COLOUR(HUD::GET_BLIP_HUD_COLOUR(Local_817[bVar0 /*3*/]), &iVar1, &iVar2, &iVar3, &uVar4);
...
HUD::ADD_TEXT_COMPONENT_SUBSTRING_BLIP_NAME(Local_817[bVar0 /*3*/]);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}else{
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_189(iVar6));
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}
if(HUD::GET_BLIP_INFO_ID_TYPE(Local_817[bVar0 /*3*/])==2){
if(!PED::IS_PED_INJURED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(Local_817[bVar0 /*3*/])))){
Var5={
ENTITY::GET_ENTITY_COORDS(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(Local_817[bVar0 /*3*/])), 1) 
};
}}elseif(HUD::GET_BLIP_INFO_ID_TYPE(Local_817[bVar0 /*3*/])==1){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(Local_817[bVar0 /*3*/]), 0)){
Var5={
ENTITY::GET_ENTITY_COORDS(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(Local_817[bVar0 /*3*/]), 1) 
};
}}else{
Var5={
HUD::GET_BLIP_COORDS(Local_817[bVar0 /*3*/]) 
};
}
...
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL_HASH_KEY(Local_817[bVar0 /*3*/].f_1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}}else{
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRTNM2");
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL_HASH_KEY(Local_817[bVar0 /*3*/].f_1);
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL_HASH_KEY(Local_817[bVar0 /*3*/].f_2);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
if(bLocal_58){
...
if(bLocal_58){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_109, "SHOW_TAXI_DESTINATION");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_109, "HIGHLIGHT_DESTINATION");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(bLocal_90);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}else{
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_109, "SET_TAXI_PRICE");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(bLocal_99);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_109, "SHOW_TAXI_DESTINATION");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_109, "HIGHLIGHT_DESTINATION");
...
func_197(117, 1);
iLocal_92=func_194();
iLocal_93=HUD::GET_NUMBER_OF_ACTIVE_BLIPS();
...
while (iVar0 < 40){
if(HUD::DOES_BLIP_EXIST(Local_817[iVar0 /*3*/])){
if(Local_817[iVar0 /*3*/]==Global_112845){
bLocal_90=iVar0;
iVar0=40;
}}
iVar0++;
}}}}elseif(!Global_112845==0){
Global_112845=0;
}
if(MISC::GET_MISSION_FLAG()){
if(!Global_112847==-1){
...
while (iVar0 < 40){
if(HUD::DOES_BLIP_EXIST(Local_817[iVar0 /*3*/])){
if(func_128(Local_817[iVar0 /*3*/])==Global_112847){
bLocal_90=iVar0;
iVar0=40;
}}
iVar0++;
}}}elseif(!Global_112847==-1){
Global_112847=-1;
}}
...
int iVar1;
iVar0=0;
iVar1=HUD::GET_FIRST_BLIP_INFO_ID(iLocal_42);
...
iVar1=HUD::GET_NEXT_BLIP_INFO_ID(iLocal_42);
}
...
if(func_128(Local_817[iParam1 /*3*/])==HUD::GET_WAYPOINT_BLIP_ENUM_ID()){
iLocal_95=iParam1;
Local_832={
HUD::GET_BLIP_COORDS(Local_817[iParam1 /*3*/]) 
};
}}
...
if(HUD::DOES_BLIP_EXIST(uParam0)){
Var0={
func_48(iParam0) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
}}
return vmag(Var0);
}
...
if(Global_32663[Global_97746[iVar0 /*17*/].f_9 /*23*/].f_19==*uParam0){
return Global_97746[iVar0 /*17*/].f_5;
}}}}
iVar0++;
}
...
if(func_208(HUD::GET_BLIP_COORDS(*uParam0), 0f, 0f, 0f, 0)){
return 1;
}
...
var uVar2;
bVar0=false;
if(!HUD::DOES_BLIP_EXIST(Local_817[bLocal_90 /*3*/])){
if(bLocal_90 !=iLocal_95){
return 1;
}}
if(timerb() > 250){
if(!bVar0){
if(iLocal_93 !=HUD::GET_NUMBER_OF_ACTIVE_BLIPS()){
bVar0=true;
}
iLocal_93=HUD::GET_NUMBER_OF_ACTIVE_BLIPS();
...
if(!bVar0){
if(iLocal_95 !=-1){
if(HUD::DOES_BLIP_EXIST(Local_817[iLocal_95 /*3*/])){
if(func_128(Local_817[iLocal_95 /*3*/])==HUD::GET_WAYPOINT_BLIP_ENUM_ID()){
Var1={
HUD::GET_BLIP_COORDS(Local_817[iLocal_95 /*3*/]) 
};
...
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112841, -1, 0)){
iVar0++;
}
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112841, 0, 0)){
iVar0++;
}
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112841, 1, 0)){
iVar0++;
}
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112841, 2, 0)){
iVar0++;
}}
return iVar0;
}
...
void func_213(){
if(iLocal_819 !=0){
HUD::SET_TEXT_RENDER_ID(uLocal_91);
GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(4);
GRAPHICS::SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU(1);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_109, fLocal_84, fLocal_85, fLocal_82, fLocal_83, 0, 0, 0, 255, 0);
}}}
...
fLocal_71=(0.22f * 2f);
if(!PED::IS_PED_INJURED(Global_112842)){
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112842, &cLocal_822, "leanover_enter", 3)){
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112842, &cLocal_822, "leanover_idle", 3)){
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112842, &cLocal_822, "leanover_exit", 3)){
TASK::CLEAR_PED_TASKS(Global_112842);
}}}
}}}
if(func_75()){
...
void func_216(){
struct<3> Var0;
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_109, "SET_INPUT_EVENT");
...
if(HUD::DOES_BLIP_EXIST(Local_817[bLocal_90 /*3*/])){
Var0={
HUD::GET_BLIP_COORDS(Local_817[bLocal_90 /*3*/]) 
};
if(!func_217(Var0)){
HUD::LOCK_MINIMAP_POSITION(Var0.f_0, Var0.f_1);
}}}
...
if(func_59(PLAYER::PLAYER_PED_ID()) !=iLocal_69){
return 1;
}
if(!ENTITY::DOES_ENTITY_EXIST(Global_112841)){
return 1;
...
Var0={
ENTITY::GET_ENTITY_COORDS(Global_112841, 0) 
};
...
Local_830={
ENTITY::GET_ENTITY_COORDS(Global_112841, 1) - ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
Local_830.f_2=0f;
fLocal_70=vmag(Local_830);
iLocal_69=func_59(PLAYER::PLAYER_PED_ID());
func_232();
iLocal_94=func_212();
iLocal_56=1;
PAD::DISABLE_CONTROL_ACTION(0, 75, 1);
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112841, 1, 0)){
iVar0=VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_112841, 1, 0);
...
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112841, 2, 0)){
iVar0=VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_112841, 2, 0);
if(PLAYER::PLAYER_PED_ID() !=iVar0){
if(!PED::IS_PED_GROUP_MEMBER(iVar0, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID()))){
TASK::TASK_SMART_FLEE_PED(iVar0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
}}}}}
...
Global_112856=1;
if(bParam2){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_112842, 1, 1);
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_112841, 1, 1);
StringCopy(&Global_112872, SCRIPT::GET_THIS_SCRIPT_NAME(), 24);
}else{
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_112842)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_112842, 1, 0);
}
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_112841)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_112841, 1, 0);
StringCopy(&Global_112872, SCRIPT::GET_THIS_SCRIPT_NAME(), 24);
}}
PED::SET_PED_CONFIG_FLAG(Global_112842, 251, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Global_112842, 5, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(Global_112842, 17, 1);
PED::SET_PED_FLEE_ATTRIBUTES(Global_112842, 512, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_112842, 1);
...
VEHICLE::SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Global_112841, 1);
VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Global_112841, 0, 0);
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Global_112841, 1);
return 1;
}}}}
return 0;
}
...
if(ENTITY::DOES_ENTITY_EXIST(Global_112842)){
if(!PED::IS_PED_INJURED(Global_112842)){
PED::SET_PED_CONFIG_FLAG(Global_112842, 251, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_112842, 0);
if(!PED::IS_PED_FLEEING(Global_112842) && !PED::IS_PED_IN_COMBAT(Global_112842, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(Global_112842, 0)){
if(ENTITY::DOES_ENTITY_EXIST(Global_112841)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
if(PED::IS_PED_SITTING_IN_VEHICLE(Global_112842, Global_112841)){
...
if((!VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112841, 1, 0) || !VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112841, 2, 0)) || !VEHICLE::IS_VEHICLE_SEAT_FREE(Global_112841, 0, 0)){
...
TASK::TASK_PERFORM_SEQUENCE(Global_112842, uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
}}else{
TASK::TASK_SMART_FLEE_PED(Global_112842, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
}
}
else{
TASK::TASK_SMART_FLEE_PED(Global_112842, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
}}}elseif(TASK::GET_SCRIPT_TASK_STATUS(Global_112842, joaat("script_task_wander_standard")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(Global_112842, joaat("script_task_wander_standard")) !=0){
TASK::TASK_WANDER_STANDARD(Global_112842, 1193033728, 0);
}}}}
if(ENTITY::DOES_ENTITY_EXIST(Global_112842)){
if(ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_112842)){
if(ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_112842, 0)){
if(!PED::IS_PED_INJURED(Global_112842)){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Global_112842, 0, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Global_112842, 0);
}
...
if(ENTITY::DOES_ENTITY_EXIST(Global_112841)){
if(ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_112841)){
if(ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(Global_112841, 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112841, 0)){
VEHICLE::SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Global_112841, 0);
VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(Global_112841, 1, 0);
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(Global_112841, 0);
}
...
GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_109);
GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_110);
if(func_239(Global_112842)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112842, &cLocal_822, "leanover_enter", 3)){
ENTITY::STOP_ENTITY_ANIM(Global_112842, "leanover_enter", &cLocal_822, -2f);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112842, &cLocal_822, "leanover_idle", 3)){
ENTITY::STOP_ENTITY_ANIM(Global_112842, "leanover_idle", &cLocal_822, -2f);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112842, &cLocal_822, "leanover_exit", 3)){
ENTITY::STOP_ENTITY_ANIM(Global_112842, "leanover_exit", &cLocal_822, -2f);
}
if(PED::IS_PED_HEADTRACKING_PED(Global_112842, PLAYER::PLAYER_PED_ID())){
TASK::TASK_CLEAR_LOOK_AT(Global_112842);
}}
STREAMING::REMOVE_ANIM_DICT(&cLocal_822);
if(iLocal_819==4){
if(iLocal_821 !=10){
if(iLocal_55){
if(STREAMING::IS_NEW_LOAD_SCENE_ACTIVE()){
...
if(func_3(Global_112841)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_112841, 1)){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(Global_112841, -1, 0) !=PLAYER::PLAYER_PED_ID()){
if(!func_2(PLAYER::PLAYER_PED_ID(), joaat("script_task_leave_any_vehicle")) && !func_2(PLAYER::PLAYER_PED_ID(), joaat("script_task_leave_vehicle"))){
TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}}}}}
func_5();
