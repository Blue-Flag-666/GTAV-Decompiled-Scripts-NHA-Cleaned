...
while (true){
wait(0);
if((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_58) || (func_111() && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_44, 500f, 500f, 500f, 0, 1, 0))){
if(!func_111()){
if(func_110()){
func_142();
}}
...
iLocal_69=0;
while (iLocal_69 < 6){
if(!PED::IS_PED_INJURED(iLocal_61[iLocal_69])){
if(HUD::DOES_BLIP_EXIST(uLocal_66[iLocal_69])){
HUD::REMOVE_BLIP(&(uLocal_66[iLocal_69]));
}
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_61[iLocal_69]));
}
iLocal_69++;
}
...
if(vdist(func_2(PLAYER::PLAYER_ID()), Local_44) > 150f){
func_142();
}}
...
switch (iLocal_43){
case 0:
if(OBJECT::DOES_PICKUP_EXIST(uLocal_63)){
if(HUD::DOES_BLIP_EXIST(uLocal_64)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_47, Local_48, fLocal_49, 0, 1, 0)){
func_67();
if(!bLocal_59){
...
break;
case 1:
if((((PED::IS_PED_INJURED(iLocal_61[0]) && PED::IS_PED_INJURED(iLocal_61[1])) && PED::IS_PED_INJURED(iLocal_61[2])) && PED::IS_PED_INJURED(iLocal_61[3])) && PED::IS_PED_INJURED(iLocal_61[4])){
func_25();
}elseif(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_44, 100f, 100f, 100f, 0, 1, 0)){
func_25();
}
break;
}
...
void func_70(){
if(OBJECT::HAS_PICKUP_BEEN_COLLECTED(uLocal_63)){
if(HUD::DOES_BLIP_EXIST(uLocal_64)){
HUD::REMOVE_BLIP(&uLocal_64);
}
settimera(0);
...
if((func_95() && iLocal_71 !=2) || (iLocal_71==1 && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))){
func_93();
wait(0);
if(func_92()){
...
if((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_61[iLocal_69], PLAYER::PLAYER_PED_ID(), 15f, 15f, 40f, 0, 1, 0) && PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_61[iLocal_69])) || PED::CAN_PED_SEE_HATED_PED(iLocal_61[iLocal_69], PLAYER::PLAYER_PED_ID())){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_47, Local_48, fLocal_49, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 2205.918f, 5633.455f, 55.7472f, 15f, 15f, 40f, 0, 1, 0)){
if(!func_56()){
...
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(iLocal_61[iLocal_69]);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_61[iVar0], uLocal_68);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_68);
PED::SET_PED_USING_ACTION_MODE(iLocal_61[iVar0], 1, -1, 0);
iVar0++;
}
...
TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_68);
TASK::TASK_PERFORM_SEQUENCE(iLocal_61[iVar1], uLocal_68);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_68);
PED::SET_PED_USING_ACTION_MODE(iLocal_61[iVar1], 1, -1, 0);
iLocal_54[iVar1]=1;
}
iVar1++;
}
if(!PED::IS_PED_INJURED(iLocal_61[iLocal_69])){
if(!PED::IS_PED_FACING_PED(iLocal_61[iLocal_69], PLAYER::PLAYER_PED_ID(), 50f)){
TASK::TASK_LOOK_AT_ENTITY(iLocal_61[iLocal_69], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
PED::SET_PED_KEEP_TASK(iLocal_61[iLocal_69], 1);
}}
...
if((MISC::GET_GAME_TIMER() - iLocal_74) > 12000){
if(!func_56()){
func_91(&uLocal_75, 3, iLocal_61[iLocal_69], "SalvadorGang", 0, 1);
func_74(&uLocal_75, "RECSHAU", "RECSH_GOAW", 4, 0, 0, 0);
iLocal_56=1;
...
if(iLocal_54[iLocal_69]){
if(((MISC::GET_GAME_TIMER() - iLocal_74) > 18000 || (iLocal_73 - iLocal_72) > 5000) || PED::IS_PED_IN_COMBAT(iLocal_61[iLocal_69], 0)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_47, Local_48, fLocal_49, 0, 1, 0) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_61[iLocal_69], PLAYER::PLAYER_PED_ID(), 15f, 15f, 5f, 0, 1, 0)){
func_93();
wait(0);
if(func_92()){
func_91(&uLocal_75, 4, iLocal_61[iLocal_69], "DRUGFARMGOON", 0, 1);
...
if(!PED::IS_PED_IN_COMBAT(iLocal_61[iLocal_69], 0)){
TASK::CLEAR_PED_TASKS(iLocal_61[iLocal_69]);
if(!PED::IS_PED_INJURED(iLocal_61[0])){
TASK::OPEN_SEQUENCE_TASK(&uLocal_68);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_68, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_68);
TASK::TASK_PERFORM_SEQUENCE(iLocal_61[0], uLocal_68);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_68);
PED::SET_PED_USING_ACTION_MODE(iLocal_61[0], 0, -1, 0);
}
if(!PED::IS_PED_INJURED(iLocal_61[1])){
TASK::OPEN_SEQUENCE_TASK(&uLocal_68);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_68, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_68);
TASK::TASK_PERFORM_SEQUENCE(iLocal_61[1], uLocal_68);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_68);
PED::SET_PED_USING_ACTION_MODE(iLocal_61[1], 0, -1, 0);
}
if(!PED::IS_PED_INJURED(iLocal_61[2])){
TASK::OPEN_SEQUENCE_TASK(&uLocal_68);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_68, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_68);
TASK::TASK_PERFORM_SEQUENCE(iLocal_61[2], uLocal_68);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_68);
PED::SET_PED_USING_ACTION_MODE(iLocal_61[2], 0, -1, 0);
}
if(!PED::IS_PED_INJURED(iLocal_61[3]) && !PED::IS_PED_INJURED(iLocal_61[4])){
TASK::OPEN_SEQUENCE_TASK(&uLocal_68);
TASK::TASK_GO_TO_ENTITY(0, iLocal_61[4], -1, 2f, 1f, 1073741824, 0);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_61[4], 0);
TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_68);
TASK::TASK_PERFORM_SEQUENCE(iLocal_61[3], uLocal_68);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_68);
PED::SET_PED_USING_ACTION_MODE(iLocal_61[3], 0, -1, 0);
}
if(!PED::IS_PED_INJURED(iLocal_61[4])){
TASK::OPEN_SEQUENCE_TASK(&uLocal_68);
TASK::TASK_GO_TO_ENTITY(0, iLocal_61[3], -1, 2f, 1f, 1073741824, 0);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_61[3], 0);
TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_68);
TASK::TASK_PERFORM_SEQUENCE(iLocal_61[4], uLocal_68);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_68);
PED::SET_PED_USING_ACTION_MODE(iLocal_61[4], 0, -1, 0);
}
if(!PED::IS_PED_INJURED(iLocal_61[5])){
TASK::TASK_GUARD_CURRENT_POSITION(iLocal_61[5], 0f, 3f, 1);
PED::SET_PED_USING_ACTION_MODE(iLocal_61[5], 0, -1, 0);
}}
iVar1=0;
...
if(!PED::IS_PED_IN_COMBAT(iLocal_61[iLocal_69], 0)){
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(iLocal_61[iLocal_69]);
TASK::TASK_COMBAT_PED(iLocal_61[iLocal_69], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_KEEP_TASK(iLocal_61[iLocal_69], 1);
if(!HUD::DOES_BLIP_EXIST(uLocal_66[iLocal_69])){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_62[iVar0], 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_62[iVar0], PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}}
iVar0++;
}
iVar0=0;
while (iVar0 < iLocal_61){
if(!PED::IS_PED_INJURED(iLocal_61[iVar0])){
if(PED::CAN_PED_SEE_HATED_PED(iLocal_61[iVar0], PLAYER::PLAYER_PED_ID())){
if(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_61[iVar0]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_61[iVar0])){
return 1;
}}
if((((((MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_61[iVar0], 1), 5f, 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_61[iVar0], PLAYER::PLAYER_PED_ID(), 1)) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_61[iVar0])) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_61[iVar0], 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_61[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_smokegrenade"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_61[iVar0], 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_61[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_grenade"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_61[iVar0], 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_61[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_grenadelauncher"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_61[iVar0], 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_61[iVar0], 1) + Vector(15f, 15f, 15f), joaat("weapon_stickybomb"), 1)){
return 1;
}}
iVar0++;
}
if(FIRE::IS_EXPLOSION_IN_ANGLED_AREA(-1, Local_47, Local_48, fLocal_49)){
return 1;
}
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_47, Local_48, fLocal_49, 0, 1, 0)){
...
PED::ADD_SCENARIO_BLOCKING_AREA(Local_44 - Vector(20f, 50f, 50f), Local_44 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("bobcatxl"), 1);
PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
MISC::ENABLE_DISPATCH_SERVICE(3, 0);
iLocal_62[0]=VEHICLE::CREATE_VEHICLE(joaat("bobcatxl"), 2209.17f, 5572.897f, 52.7565f, 255.5161f, 1, 1, 0);
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_62[0], 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_62[0], 1084227584);
VEHICLE::SET_VEHICLE_EXTRA(iLocal_62[0], 1, 1);
iLocal_62[1]=VEHICLE::CREATE_VEHICLE(joaat("bobcatxl"), 2195.473f, 5607.506f, 52.5648f, 168.4012f, 1, 1, 0);
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_62[1], 1, 0);
VEHICLE::SET_VEHICLE_EXTRA(iLocal_62[1], 1, 0);
iVar0=0;
MISC::SET_BIT(&iVar0, 1);
uLocal_63=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), Local_45, -1.368082f, 0.230633f, 176.8749f, iVar0, MISC::GET_RANDOM_INT_IN_RANGE(40000, 100000), 2, 1, joaat("prop_cash_case_01"));
Local_46[0 /*3*/]={
...
PED::ADD_RELATIONSHIP_GROUP("DrugCult", &iLocal_67);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, iLocal_67, joaat("COP"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, joaat("COP"), iLocal_67);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_67, joaat("player"));
iLocal_69=0;
while (iLocal_69 < 6){
iLocal_61[iLocal_69]=PED::CREATE_PED(26, joaat("g_m_y_salvagoon_01"), Local_46[iLocal_69 /*3*/], fLocal_50[iLocal_69], 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_61[iLocal_69], 1);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_61[iLocal_69], 2);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_61[iLocal_69], 50, 1);
PED::SET_PED_COMBAT_RANGE(iLocal_61[iLocal_69], 0);
PED::SET_PED_ACCURACY(iLocal_61[iLocal_69], 13);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_61[iLocal_69], iLocal_67);
iLocal_70=MISC::GET_RANDOM_INT_IN_RANGE(0, 3);
if(iLocal_70==0){
WEAPON::GIVE_WEAPON_TO_PED(iLocal_61[iLocal_69], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
}elseif(iLocal_70==1){
WEAPON::GIVE_WEAPON_TO_PED(iLocal_61[iLocal_69], joaat("weapon_microsmg"), -1, 1, 1);
}else{
WEAPON::GIVE_WEAPON_TO_PED(iLocal_61[iLocal_69], joaat("weapon_assaultrifle"), -1, 1, 1);
}
PED::SET_PED_CONFIG_FLAG(iLocal_61[iLocal_69], 42, 1);
func_91(&uLocal_75, 3, iLocal_61[iLocal_69], "SalvadorGang", 0, 1);
iLocal_69++;
}
if(!PED::IS_PED_INJURED(iLocal_61[0])){
...
PED::SET_PED_NAME_DEBUG(iLocal_61[0], "piDrugCult[0]");
if(!PED::IS_PED_INJURED(iLocal_61[1])){
TASK::OPEN_SEQUENCE_TASK(&uLocal_68);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2210.584f, 5580.684f, 52.8132f, 1f, -1, 1048576000, 0, 1193033728);
TASK::TASK_TURN_PED_TO_FACE_COORD(0, 2205.466f, 5583.631f, 52.8682f, 8000);
...
PED::SET_PED_NAME_DEBUG(iLocal_61[1], "piDrugCult[1]");
if(!PED::IS_PED_INJURED(iLocal_61[2])){
TASK::OPEN_SEQUENCE_TASK(&uLocal_68);
...
PED::SET_PED_NAME_DEBUG(iLocal_61[2], "piDrugCult[2]");
if(!PED::IS_PED_INJURED(iLocal_61[3]) && !PED::IS_PED_INJURED(iLocal_61[4])){
TASK::OPEN_SEQUENCE_TASK(&uLocal_68);
TASK::TASK_GO_TO_ENTITY(0, iLocal_61[4], -1, 2f, 1f, 1073741824, 0);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_61[4], 0);
...
PED::SET_PED_NAME_DEBUG(iLocal_61[3], "piDrugCult[3]");
if(!PED::IS_PED_INJURED(iLocal_61[4])){
TASK::OPEN_SEQUENCE_TASK(&uLocal_68);
TASK::TASK_GO_TO_ENTITY(0, iLocal_61[3], -1, 2f, 1f, 1073741824, 0);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_61[3], 0);
...
PED::SET_PED_NAME_DEBUG(iLocal_61[4], "piDrugCult[4]");
TASK::TASK_GUARD_CURRENT_POSITION(iLocal_61[5], 0f, 3f, 1);
PED::SET_PED_NAME_DEBUG(iLocal_61[5], "piDrugCult[5]");
uLocal_64=func_97(Local_45, 0);
HUD::SET_BLIP_SPRITE(uLocal_64, 140);
...
if(!func_136(Global_113810.f_24998.f_43[iParam1])){
return 0;
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_112857) || Global_32286) || func_133()) || func_88(8, -1)) || func_132()) || func_131()) || func_130()) || func_129()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_134()) || Global_32286) || func_133()) || func_88(8, -1)) || func_130()) || func_132()) || func_131()) || func_129()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_112857) || Global_32286) || func_133()) || func_88(8, -1)) || func_130()) || func_132()) || func_131()) || func_129()) || Global_113810.f_7691.f_919[iVar0]==5) || Global_43924 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_112857) || Global_32286) || func_133()) || func_88(8, -1)) || func_132()) || func_131()) || func_129()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_134()) || func_131()) || Global_112857) || Global_32286) || func_133()) || Global_44569) || func_88(8, -1)) || func_130()) || func_128()) || func_129()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 8:
