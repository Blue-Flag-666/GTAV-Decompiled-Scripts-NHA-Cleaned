...
bool bVar0;
if(iLocal_40){
if(func_50(uLocal_42)){
if((((!func_49() && !PED::IS_PED_FLEEING(uLocal_42)) && !PED::IS_PED_RAGDOLL(uLocal_42)) && !PED::IS_PED_PRONE(uLocal_42)) && !PED::IS_PED_INJURED(uLocal_42)){
if(func_48(uLocal_42, PLAYER::PLAYER_PED_ID(), 1) <=3f){
if((MISC::GET_GAME_TIMER() - iLocal_41) > 8000){
if(func_25(&uLocal_43, "JOSH1AU", "JOSH1_AMB2", 7, 0, 0, 0)){
iLocal_41=MISC::GET_GAME_TIMER();
}}}}
if(func_48(uLocal_42, PLAYER::PLAYER_PED_ID(), 1) > 150f){
func_24(&uLocal_42);
}}else{
...
}}elseif(!MISC::IS_BIT_SET(Global_113810.f_10052.f_108, bVar0)){
func_11(&(Local_208[bVar0 /*11*/]), iLocal_36, 0, 200f);
}
bVar0++;
}
func_9();
if(!bLocal_209 && !bLocal_37){
if(func_2(2)){
iLocal_35=2;
}}}
...
if(!MISC::IS_BIT_SET(Global_113810.f_10052.f_108, func_3(func_4(iParam0), iVar0))){
return 0;
}
iVar0++;
}}
...
if(MISC::IS_BIT_SET(Global_113810.f_10052.f_108, func_3(func_4(iParam0), iVar1))){
iVar0++;
}
iVar1++;
}}elseif(iParam0==6){
...
uLocal_39=GRAPHICS::REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_39)){
...
break;
case 1:
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_39, "SHOW_SHARD_MIDSIZED_MESSAGE");
...
case 2:
if(timerb() > 7000){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_39, "SHARD_ANIM_OUT");
...
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_39)){
GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_39, 100, 100, 100, 255, 0);
}}
break;
case 3:
if(timerb() > 7500){
...
case 4:
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_39)){
GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_39);
}
bLocal_209=false;
bLocal_37=false;
iLocal_38=0;
...
bool func_13(var uParam0, struct<3> Param1, float fParam2, int iParam3){
...
PED::SET_PED_NAME_DEBUG(uLocal_42, "POSTJOSH");
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_42, joaat("player"));
func_53(&uLocal_43, 5, uLocal_42, "JOSH", 1, 1);
return 1;
}}
iVar1++;
}
...
func_68(13, floor(Global_113810.f_10197.f_3853));
}
