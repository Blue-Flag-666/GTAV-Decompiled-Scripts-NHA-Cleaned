...
if(MISC::IS_BIT_SET(Local_152.f_0, bParam0)){
...
func_11(&(Local_152.f_76), bParam1);
}
...
uParam0->f_32=0;
if(bVar1){
iVar2=func_18(PLAYER::PLAYER_ID());
if(bParam1){
iVar2=func_12(1, 1);
}
if(iVar2 !=0){
uParam0->f_32=1;
SCRIPT::SEND_TU_SCRIPT_EVEN(1, &Var0, 39, iVar2);
}}}
...
if(func_28()){
if(!func_27(6)){
TASK::STOP_ANIM_PLAYBACK(Local_152.f_64, 1, 1);
TASK::STOP_ANIM_PLAYBACK(Local_152.f_64, 0, 1);
func_26(6);
}
if(ENTITY::PLAY_ENTITY_ANIM(Local_152.f_64, "prop_body_loop_outro", func_7(Local_152.f_10), 0.125f, 0, 0, 0, 0, 0)){
if(func_25(PLAYER::PLAYER_ID(), Local_152.f_64)){
Local_152.f_8=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FROM_COORD(Local_152.f_8, "fortune_bell", ENTITY::GET_ENTITY_COORDS(Local_152.f_64, 1), "dlc_ch_nazar_speaks_sounds", 0, 0, 0);
}
func_9(6);
func_6(5);
}}}}}
...
return MISC::IS_BIT_SET(Local_152.f_0, iParam0);
}
...
void func_41(){
if(func_28()){
if(ENTITY::PLAY_ENTITY_ANIM(Local_152.f_64, "prop_body_loop_intro", func_7(Local_152.f_10), 0.125f, 0, 0, 0, 0, 0)){
if(func_25(PLAYER::PLAYER_ID(), Local_152.f_64)){
Local_152.f_7=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FROM_COORD(Local_152.f_7, "fortune_mech_loop", ENTITY::GET_ENTITY_COORDS(Local_152.f_64, 1), "dlc_ch_nazar_speaks_sounds", 0, 0, 0);
}
func_6(2);
}}}
...
}elseif(bVar14 || ((!func_13(PLAYER::PLAYER_ID(), 0) && !func_54()) && !func_53(PLAYER::PLAYER_ID()))){
...
if(!func_49(uVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar27)){
if(!bVar22){
...
func_62(10);
func_59(18, 0);
}}elseif(Local_152.f_2==41){
MISC::SET_BIT(&Global_44572, true);
}elseif(Local_152.f_2==42){
MISC::SET_BIT(&Global_44572, 2);
}elseif(Local_152.f_2==43){
MISC::SET_BIT(&Global_44572, 3);
}elseif(Local_152.f_2==44){
MISC::SET_BIT(&Global_44572, 4);
}elseif(Local_152.f_2==45){
MISC::SET_BIT(&Global_44572, 5);
}elseif(Local_152.f_2==46){
MISC::SET_BIT(&Global_44572, 7);
}elseif(Local_152.f_2==47){
MISC::SET_BIT(&Global_44572, 10);
}elseif(Local_152.f_2==48){
MISC::SET_BIT(&Global_44572, 8);
}elseif(Local_152.f_2==22){
func_64(28250, 1, -1);
}elseif(Local_152.f_2==23){
func_64(28251, 1, -1);
}elseif(Local_152.f_2==24){
func_64(28252, 1, -1);
}}
...
if(bParam0){
if(!MISC::IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_429.f_2, 14)){
MISC::SET_BIT(&(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_429.f_2), 14);
}}elseif(MISC::IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_429.f_2, 14)){
...
Var1={
func_34(Local_152.f_2) 
};
Var0.f_8=MISC::GET_HASH_KEY(func_72(&Var1));
if(Local_152.f_2==19){
Var0.f_9=1;
}
...
Var0.f_10=589001948;
}elseif(func_69(PLAYER::PLAYER_ID())){
...
func_26(5);
}}elseif(func_76(PLAYER::PLAYER_PED_ID(), 11)){
...
if(bVar2){
iVar3=func_18(PLAYER::PLAYER_ID());
if(iVar3 !=-1){
...
}elseif(func_98(PLAYER::PLAYER_ID())==Local_152.f_66 && Local_152.f_66==11){
func_97();
}elseif(func_21(&(Local_152.f_17))){
...
if(Local_152.f_76.f_32){
func_33(&(Local_152.f_17), 0, 0);
}}}elseif(func_19(&(Local_152.f_17), 40000, 0)){
func_5(&(Local_152.f_17));
}}
...
if(iParam0 !=func_23()){
return MISC::IS_BIT_SET(Global_2657704[iParam0 /*463*/].f_436, 1);
}
return 0;
}
...
if(iParam0 !=func_23()){
return MISC::IS_BIT_SET(Global_2657704[iParam0 /*463*/].f_436, 0);
}
return 0;
}
...
return MISC::IS_BIT_SET(Global_1978241, func_104(iParam0));
}
...
bool func_109(){
return MISC::IS_BIT_SET(Global_1978241, 0);
}
