...
iLocal_49=Global_113810.f_10052.f_103;
func_93();
if(func_92()){
func_96();
}
...
func_89(&Local_39, 2);
Local_39.f_4=3;
MISC::CLEAR_AREA_OF_VEHICLES(Local_38, 5f, 0, 0, 0, 0, 0, 0, 0);
func_88(&Local_59, -691.9059f, 515.8249f, 108.6139f, -684.0605f, 493.0171f, 110.8504f, 8.25f);
PATHFIND::SET_ROADS_IN_ANGLED_AREA(Local_59[0 /*3*/], Local_59[1 /*3*/], 8.25f, 0, 0, 1);
...
uLocal_62=PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var1, 0, 1, 1, 1);
if(func_95(90)==1){
func_94();
func_96();
}
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_39.f_14, 8.5f, 0, 0, 0, 0, 0, 0, 0);
Global_113810.f_10052.f_103=iLocal_49;
func_40();
func_39(&uLocal_63, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
if(Global_113810.f_10052.f_104 !=0){
iLocal_47=(Global_113810.f_10052.f_104 + 14 % func_18(CLOCK::GET_CLOCK_MONTH(), CLOCK::GET_CLOCK_YEAR()));
if(((CLOCK::GET_CLOCK_DAY_OF_MONTH()==iLocal_47 && !func_17(0)) && !PLAYER::IS_PLAYER_DEAD(PLAYER::PLAYER_ID())) && PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
func_4(func_16());
}}
func_1(&iLocal_228, &uLocal_230, &iLocal_229);
if((iLocal_57 > 0 && MISC::GET_GAME_TIMER() > iLocal_57) && iLocal_229==99){
iLocal_57=0;
if(func_92()){
func_82(6);
}}
...
bVar0=false;
while (bVar0 < 5){
if(MISC::IS_BIT_SET(iLocal_49, bVar0)){
iVar1++;
}
bVar0++;
}
...
return MISC::IS_BIT_SET(iLocal_49, iParam0);
}
...
return MISC::IS_BIT_SET(iLocal_49, iParam0 + 5);
}
...
if(iVar2==1){
Global_113810.f_10052.f_104=CLOCK::GET_CLOCK_DAY_OF_MONTH();
iLocal_57=(MISC::GET_GAME_TIMER() + iLocal_58);
}
return iVar2;
}
...
if(bParam1){
MISC::SET_BIT(&iLocal_49, bParam0);
bLocal_50=bParam0;
}else{
MISC::CLEAR_BIT(&iLocal_49, bParam0);
}}


void func_45(int iParam0, bool bParam1){
if(bParam1){
MISC::SET_BIT(&iLocal_49, iParam0 + 5);
}else{
MISC::CLEAR_BIT(&iLocal_49, iParam0 + 5);
}}
...
uParam0->f_17=0f;
uParam0->f_4=2;
AUDIO::STOP_SOUND(iLocal_45);
iLocal_46=0;
AUDIO::PLAY_SOUND_FROM_COORD(-1, "CLOSED", *uParam0, "DOOR_GARAGE", 0, 0, 1);
}elseif(!iLocal_46){
AUDIO::PLAY_SOUND_FROM_COORD(iLocal_45, "CLOSING", *uParam0, "DOOR_GARAGE", 0, 0, 1);
iLocal_46=1;
}}
...
AUDIO::PLAY_SOUND_FROM_COORD(iLocal_45, "OPENING", *uParam0, "DOOR_GARAGE", 0, 0, 1);
iLocal_46=1;
}}
...
if(iLocal_54==0){
if(func_65(iVar0)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, Local_39.f_6[0 /*3*/], Local_39.f_6[1 /*3*/], Local_39.f_6.f_7, 0, 1, 0)){
...
if(func_63(PLAYER::PLAYER_PED_ID(), Local_39.f_14, 0) < 3f){
func_60(&iLocal_42);
}
if(func_63(PLAYER::PLAYER_PED_ID(), Local_39, 0) > (15f + 5f)){
func_89(&Local_39, 2);
Local_39.f_4=3;
iLocal_54=0;
iLocal_53=0;
...
if(func_62(&Local_39) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_89(&Local_39, 2);
Local_39.f_4=3;
iLocal_56=0;
func_82(0);
...
if((Local_39.f_26 && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID())){
if(iLocal_56==0){
iLocal_56=MISC::GET_GAME_TIMER();
}
elseif((MISC::GET_GAME_TIMER() - iLocal_56) > 500){
if(iLocal_53==0){
HUD::CLEAR_PRINTS();
...
switch (*iParam0){
case 1:
if(!HUD::DOES_BLIP_EXIST(iLocal_42)){
iLocal_42=HUD::ADD_BLIP_FOR_COORD(Local_38);
if(HUD::DOES_BLIP_EXIST(iLocal_42)){
HUD::SET_BLIP_SPRITE(iLocal_42, 206);
HUD::SET_BLIP_COLOUR(iLocal_42, 42);
}}
*iParam0=2;
iLocal_48=0;
break;
...
if(func_63(PLAYER::PLAYER_PED_ID(), Local_39, 0) < 15f){
*iParam0=4;
return;
}
break;
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_39.f_6[0 /*3*/], Local_39.f_6[1 /*3*/], Local_39.f_6.f_7, 0, 1, 0) && func_48(&Local_39)){
...
break;
case 4:
if(iLocal_51==0 && func_66(PLAYER::PLAYER_PED_ID())){
if(iLocal_61 !=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 1)){
iLocal_61=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 1);
...
func_74();
func_73(&Local_39);
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_62, 0);
PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(-683.4503f, 492.9922f, 108.8737f, -688.8357f, 506.9997f, 112.1928f, 11.25f, 1);
PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(Local_59[0 /*3*/], Local_59[1 /*3*/], 8.25f, 1);
}
...
iVar0=0;
while (iVar0 < 5){
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_41[iVar0]);
iVar0++;
}}
