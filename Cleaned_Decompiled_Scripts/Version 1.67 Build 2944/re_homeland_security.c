...
while (true){
wait(0);
if((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_74) || iLocal_101){
if(!func_167()){
if(func_166()){
func_213();
}}
...
case 1:
if(!func_144()){
if((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_57, 75f, 75f, 75f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_56)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 15f, 15f, 15f, 0, 1, 0)){
if(!func_167()){
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, -1, 0, 2);
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_48[0], PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_48[1], PLAYER::PLAYER_PED_ID(), 1)){
func_143();
bLocal_77=true;
}
}
...
if(!PED::IS_PED_INJURED(iLocal_56) && VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_51, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_56, uLocal_51, 0)){
iLocal_101=1;
}
}
if(bLocal_102){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_51, 0)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_51, 150f, 150f, 150f, 0, 1, 0)){
iLocal_45=9;
}
}
}}
...
if(!PED::IS_PED_INJURED(iLocal_56)){
AUDIO::PLAY_PAIN(iLocal_56, 3, 0, 0);
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_56, 0)){
if(!iLocal_83){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_56, "random@homelandsecurity", "idle_girl", 3) && !PED::IS_PED_RAGDOLL(iLocal_56)){
PED::SET_RAGDOLL_BLOCKING_FLAGS(iLocal_56, 16);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_56, uLocal_100);
...
elseif((((!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_56, "random@homelandsecurity", "idle_girl", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_56, "random@homelandsecurity", "idle_to_knees_girl", 1)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_56, "random@homelandsecurity", "knees_loop_girl", 1)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_56, joaat("script_task_cower")) !=0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_56, joaat("script_task_cower")) !=1){
iLocal_83=0;
}
}
elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_51, 0)){
...
elseif(!PED::IS_PED_INJURED(iLocal_48[1])){
func_115(&uLocal_118, "REHOMAU", "REHOM_YELL2", 4, 0, 0, 0);
}
iLocal_93=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(4500, 5000));
}}
if(PED::IS_PED_INJURED(iLocal_48[0])){
if(HUD::DOES_BLIP_EXIST(uLocal_87[0])){
HUD::REMOVE_BLIP(&(uLocal_87[0]));
}
func_114(&uLocal_118, 5);
}elseif(PED::CAN_PED_SEE_HATED_PED(iLocal_48[0], PLAYER::PLAYER_PED_ID()) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_48[0], PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0)){
}elseif(HUD::DOES_BLIP_EXIST(uLocal_87[0])){
HUD::REMOVE_BLIP(&(uLocal_87[0]));
}
if(PED::IS_PED_INJURED(iLocal_48[1])){
if(HUD::DOES_BLIP_EXIST(uLocal_87[1])){
HUD::REMOVE_BLIP(&(uLocal_87[1]));
}
func_114(&uLocal_118, 4);
}elseif(PED::CAN_PED_SEE_HATED_PED(iLocal_48[1], PLAYER::PLAYER_PED_ID()) || ENTITY::IS_ENTITY_AT_ENTITY(iLocal_48[1], PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0)){
}elseif(HUD::DOES_BLIP_EXIST(uLocal_87[1])){
HUD::REMOVE_BLIP(&(uLocal_87[1]));
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_48[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_48[1])){
if(((WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_48[0], joaat("weapon_stungun"), 0) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_48[1], joaat("weapon_stungun"), 0)) || (PED::IS_PED_DEAD_OR_DYING(iLocal_48[0], 1) && PED::IS_PED_DEAD_OR_DYING(iLocal_48[1], 1))) || func_113()){
if(HUD::DOES_BLIP_EXIST(uLocal_87[0])){
HUD::REMOVE_BLIP(&(uLocal_87[0]));
}
if(HUD::DOES_BLIP_EXIST(uLocal_87[1])){
...
bLocal_62=false;
iLocal_74=1;
PED::CLEAR_RAGDOLL_BLOCKING_FLAGS(iLocal_56, 16);
...
if(!bLocal_62){
if(!PED::IS_PED_INJURED(iLocal_56)){
if((ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_56, "random@homelandsecurity", "idle_to_knees_girl", 1) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_56, "random@homelandsecurity", "knees_loop_girl", 1)) && !PED::IS_PED_RAGDOLL(iLocal_56)){
TASK::TASK_PLAY_ANIM(iLocal_56, "random@homelandsecurity", "knees_to_stand_girl", 4f, -4f, -1, 0, 0.3f, 0, 0, 0);
}
else{
TASK::CLEAR_PED_TASKS(iLocal_56);
}
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_56, 0);
PED::SET_PED_AS_GROUP_MEMBER(iLocal_56, func_112());
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_56, 1);
func_111();
bLocal_62=true;
}}
if(!PED::IS_PED_INJURED(iLocal_56)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_56, "random@homelandsecurity", "knees_to_stand_girl", 3)){
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_56, "random@homelandsecurity", "knees_to_stand_girl") > 0.8f){
TASK::CLEAR_PED_TASKS(iLocal_56);
}
}}
if(!iLocal_64){
...
if(bLocal_62){
if(!PED::IS_PED_INJURED(iLocal_56)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 8f, 8f, 8f, 0, 1, 0) || PED::IS_PED_IN_ANY_TAXI(PLAYER::PLAYER_PED_ID())){
if(HUD::DOES_BLIP_EXIST(uLocal_86)){
HUD::REMOVE_BLIP(&uLocal_86);
}
}
elseif(!HUD::DOES_BLIP_EXIST(uLocal_86)){
uLocal_86=func_108(iLocal_56, 0, 145);
}
}}
if(!PED::IS_PED_INJURED(iLocal_48[0])){
if(PED::CAN_PED_SEE_HATED_PED(iLocal_48[0], PLAYER::PLAYER_PED_ID())){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 2){
}
}}
if(!PED::IS_PED_INJURED(iLocal_48[1])){
if(PED::CAN_PED_SEE_HATED_PED(iLocal_48[1], PLAYER::PLAYER_PED_ID())){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 2){
}
}}
...
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_48[iVar0]));
}
iVar0++;
}
...
if(!PED::IS_PED_INJURED(iLocal_56)){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_65, Global_22, 1, 1, 0) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0)){
if(PED::IS_PED_IN_GROUP(iLocal_56)){
if(HUD::DOES_BLIP_EXIST(uLocal_86)){
HUD::REMOVE_BLIP(&uLocal_86);
}
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_66, 1f, -1, 0.25f, 0, 38.9844f);
...
if(iLocal_45 !=6){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_113)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_113) > 0.85f){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_51, 0)){
if(!PED::IS_PED_INJURED(iLocal_56)){
if(!PED::IS_PED_IN_VEHICLE(iLocal_56, iLocal_51, 0)){
if(!PED::IS_PED_RAGDOLL(iLocal_56)){
TASK::CLEAR_PED_TASKS(iLocal_56);
PED::SET_PED_INTO_VEHICLE(iLocal_56, iLocal_51, 2);
PED::SET_PED_KEEP_TASK(iLocal_56, 1);
iLocal_115=1;
}
else{
...
if(!PED::IS_PED_INJURED(iLocal_56)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 150f, 150f, 150f, 0, 1, 0) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), 1)){
TASK::TASK_SMART_FLEE_PED(iLocal_56, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
func_105();
func_118();
}}
}
...
}}elseif(MISC::IS_BIT_SET(Global_113810.f_20567.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_41() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
var func__43(int iParam0, var uParam1){
...
iLocal_59=0;
}}}elseif(!iLocal_59 && AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()){
Local_61={
func_71() 
};
Local_60={
...
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1) && PED::IS_PED_IN_VEHICLE(iLocal_56, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)){
func_69(0);
func_105();
wait(0);
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0) && PED::IS_PED_IN_VEHICLE(iLocal_56, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)){
iLocal_71=0;
}}
if(!iLocal_72){
...
void func_93(){
if(!PED::IS_PED_INJURED(iLocal_56)){
if(PED::IS_PED_ON_FOOT(iLocal_56)){
if(!iLocal_106){
...
HUD::SET_BLIP_SPRITE(uLocal_89, 269);
func_100();
}}}}else{
if(!HUD::DOES_BLIP_EXIST(uLocal_86)){
uLocal_86=func_108(iLocal_56, 0, 145);
...
var func__103(struct<3> Param0, int iParam1){
var uVar0;
...
int func_107(){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
uLocal_84=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_84, 0)){
if(!PED::IS_PED_INJURED(iLocal_56)){
if(PED::IS_PED_SITTING_IN_VEHICLE(iLocal_56, iLocal_84)){
return 1;
}}}}
return 0;
}
...
var func__108(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
if(((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_51, 0) && PED::IS_PED_IN_VEHICLE(iLocal_56, iLocal_51, 0)) && !PED::IS_PED_IN_VEHICLE(iLocal_48[0], iLocal_51, 0)) && !PED::IS_PED_IN_VEHICLE(iLocal_48[1], iLocal_51, 0)){
return 1;
}}
return 0;
}
...
if(!iLocal_75){
if(!PED::IS_PED_INJURED(iLocal_48[0])){
PED::SET_PED_COMBAT_MOVEMENT(iLocal_48[0], 0);
TASK::CLEAR_PED_TASKS(iLocal_48[0]);
TASK::OPEN_SEQUENCE_TASK(&uLocal_100);
TASK::TASK_CLEAR_LOOK_AT(0);
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_100);
TASK::TASK_PERFORM_SEQUENCE(iLocal_48[0], uLocal_100);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_100);
PED::SET_PED_KEEP_TASK(iLocal_48[0], 1);
if(HUD::DOES_BLIP_EXIST(uLocal_87[0])){
HUD::SET_BLIP_AS_FRIENDLY(uLocal_87[0], false);
}
settimerb(0);
iLocal_75=1;
}else{
...
if(!iLocal_76){
if(HUD::DOES_BLIP_EXIST(uLocal_87[1])){
HUD::SET_BLIP_AS_FRIENDLY(uLocal_87[1], false);
}
func_105();
wait(0);
if(!PED::IS_PED_INJURED(iLocal_48[1])){
func_120(iLocal_48[1], "GENERIC_INSULT_HIGH", 24);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_48[1], 2);
if((ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48[1], "random@homelandsecurity", "idle_cop_ground", 3) || PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_113)) && !PED::IS_PED_RAGDOLL(iLocal_48[1])){
PED::SET_RAGDOLL_BLOCKING_FLAGS(iLocal_48[1], 16);
TASK::OPEN_SEQUENCE_TASK(&uLocal_100);
TASK::TASK_PLAY_ANIM(0, "random@homelandsecurity", "idle_to_stand_cop_ground", 4f, -2f, 1400, 8192, 0, 0, 0, 0);
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_100);
TASK::TASK_PERFORM_SEQUENCE(iLocal_48[1], uLocal_100);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_100);
PED::SET_PED_KEEP_TASK(iLocal_48[1], 1);
iLocal_76=1;
}else{
TASK::TASK_COMBAT_PED(iLocal_48[1], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_KEEP_TASK(iLocal_48[1], 1);
iLocal_76=1;
}}}elseif(!PED::IS_PED_INJURED(iLocal_48[1])){
if(((!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48[1], "random@homelandsecurity", "idle_cop_ground", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48[1], "random@homelandsecurity", "idle_to_stand_cop_ground", 1)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_48[1], joaat("script_task_combat")) !=0) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_48[1], joaat("script_task_combat")) !=1){
iLocal_76=1;
}}}


void func_120(var uParam0, char* sParam1, int iParam2){
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_121(iParam2), 1);
}
...
iLocal_90=0;
while (iLocal_90 <=1){
if(ENTITY::IS_ENTITY_DEAD(iLocal_48[iLocal_90], 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_48[iLocal_90], PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}}
iLocal_90++;
}
...
if(!iLocal_81 && timera() > 5000){
TASK::OPEN_SEQUENCE_TASK(&uLocal_100);
TASK::TASK_LOOK_AT_ENTITY(0, iLocal_56, -1, 2054, 2);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_56, -1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_100);
TASK::TASK_PERFORM_SEQUENCE(iLocal_48[0], uLocal_100);
PED::SET_PED_KEEP_TASK(iLocal_48[0], 1);
iLocal_81=1;
...
if(((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_51, 0) && !PED::IS_PED_INJURED(iLocal_48[0])) && !PED::IS_PED_INJURED(iLocal_48[1])) && !PED::IS_PED_INJURED(iLocal_56)){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_113)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_113) > 0.98f){
if(!func_117()){
if(PED::IS_PED_FACING_PED(iLocal_48[0], iLocal_56, 10f)){
if(func_115(&uLocal_118, "REHOMAU", "REHOM_ARR", 4, 0, 0, 0)){
TASK::TASK_CLEAR_LOOK_AT(iLocal_48[0]);
uLocal_113=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_113, iLocal_51, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_56, uLocal_113, "random@homelandsecurity", "exit_girl", 2f, -4f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_48[0], uLocal_113, "random@homelandsecurity", "exit_cop_gun", 2f, -4f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_48[1], uLocal_113, "random@homelandsecurity", "exit_cop_ground", 2f, -4f, 1, 0, 1148846080, 0);
ENTITY::PLAY_ENTITY_ANIM(iLocal_51, "exit_car", "random@homelandsecurity", 4f, 0, 0, 0, 0, 0);
iLocal_114=1;
iLocal_91=MISC::GET_GAME_TIMER();
iLocal_47=6;
}
...
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_48[0], uLocal_113, "random@homelandsecurity", "exit_cop_gun", 2f, -4f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_48[1], uLocal_113, "random@homelandsecurity", "exit_cop_ground", 2f, -4f, 1, 0, 1148846080, 0);
ENTITY::PLAY_ENTITY_ANIM(iLocal_51, "exit_car", "random@homelandsecurity", 2f, 0, 0, 0, 0, 0);
iLocal_114=1;
iLocal_91=MISC::GET_GAME_TIMER();
iLocal_47=6;
}}
...
func_129();
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_113)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_113) > 0.45f){
if((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_51, 0) && !PED::IS_PED_INJURED(iLocal_56)) && !PED::IS_PED_INJURED(iLocal_48[0])){
}}}
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_113)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_113) > 0.9f){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_51, 0)){
if(!PED::IS_PED_INJURED(iLocal_48[0])){
TASK::TASK_ENTER_VEHICLE(iLocal_48[0], iLocal_51, -1, -1, 1f, 9, 0);
iLocal_47=7;
}
}}}
break;
...
func_129();
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_113)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_113) > 0.95f){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_51, 0)){
if(!PED::IS_PED_INJURED(iLocal_48[1])){
TASK::TASK_ENTER_VEHICLE(iLocal_48[1], iLocal_51, -1, 0, 1f, 9, 0);
PED::SET_PED_KEEP_TASK(iLocal_48[1], 1);
iLocal_47=8;
}
}}}
...
case 8:
func_129();
if((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_51, 0) && !PED::IS_PED_INJURED(iLocal_48[0])) && !PED::IS_PED_INJURED(iLocal_48[1])){
if((PED::IS_PED_SITTING_IN_VEHICLE(iLocal_56, iLocal_51) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_48[0], iLocal_51)) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_48[1], iLocal_51)){
TASK::TASK_VEHICLE_DRIVE_WANDER(iLocal_48[0], iLocal_51, 15f, 786468);
VEHICLE::SET_VEHICLE_SIREN(iLocal_51, 1);
bLocal_102=true;
}}
break;
case 9:
...
break;
case 10:
if(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_48[0], 15f, 15f, 15f, 0, 1, 0)){
iLocal_99=MISC::GET_GAME_TIMER();
}else{
iLocal_47=13;
}
if(((iLocal_99 - iLocal_98) > 6000 && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)) && !iLocal_79){
...
if(((iLocal_99 - iLocal_98) > 9000 && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)) || iLocal_104){
...
if(!PED::IS_PED_INJURED(iLocal_48[1])){
if(!PED::IS_PED_INJURED(iLocal_56)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_48[1], joaat("script_task_synchronized_scene")) !=1){
TASK::OPEN_SEQUENCE_TASK(&uLocal_100);
TASK::TASK_CLEAR_LOOK_AT(0);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_56, 0);
TASK::TASK_LOOK_AT_ENTITY(0, iLocal_56, 20000, 0, 2);
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_56, -1f, 0f, 0f, 1f, -1, 1036831949, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_100);
TASK::TASK_PERFORM_SEQUENCE(iLocal_48[1], uLocal_100);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_100);
}
}
elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_48[1], joaat("script_task_synchronized_scene")) !=1){
TASK::OPEN_SEQUENCE_TASK(&uLocal_100);
TASK::TASK_CLEAR_LOOK_AT(0);
...
if(!PED::IS_PED_INJURED(iLocal_56)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_56, joaat("script_task_synchronized_scene")) !=1){
TASK::TASK_SEEK_COVER_FROM_PED(iLocal_56, PLAYER::PLAYER_PED_ID(), -1, 0);
PED::SET_PED_KEEP_TASK(iLocal_56, 1);
}}}
iLocal_47=14;
break;
...
iLocal_81=0;
settimera(0);
iLocal_91=(MISC::GET_GAME_TIMER() - 4500);
iLocal_47=5;
}}}}
...
iLocal_93=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(3500, 4000));
}}}}}}}
...
int func_131(){
if((!PED::IS_PED_INJURED(iLocal_48[0]) && !PED::IS_PED_INJURED(iLocal_48[1])) && !PED::IS_PED_INJURED(iLocal_56)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_48[0], 1.5f, 1.5f, 5f, 0, 1, 2) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_48[1], 2.5f, 2.5f, 5f, 0, 1, 2)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 1.5f, 1.5f, 5f, 0, 1, 2)){
return 1;
}}elseif((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_48[0], 0.5f, 0.5f, 5f, 0, 1, 1) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_48[1], 0.5f, 0.5f, 5f, 0, 1, 1)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 0.5f, 0.5f, 5f, 0, 1, 1)){
return 1;
}}
return 0;
}
...
int func_132(){
if(!PED::IS_PED_INJURED(iLocal_48[1])){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_48[1], 6f, 6f, 6f, 0, 1, 0)){
if(PED::IS_PED_FACING_PED(iLocal_48[1], PLAYER::PLAYER_PED_ID(), 120f)){
if(!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)){
return 1;
}}}}
if(!PED::IS_PED_INJURED(iLocal_48[0])){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_48[0], 6f, 6f, 6f, 0, 1, 0)){
if(!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)){
return 1;
}}}
return 0;
...
int func_133(){
if(!PED::IS_PED_INJURED(iLocal_48[1])){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_48[1], 6f, 6f, 6f, 0, 1, 1)){
if(PED::IS_PED_FACING_PED(iLocal_48[1], PLAYER::PLAYER_PED_ID(), 120f)){
if(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)){
return 1;
}}}}
if(!PED::IS_PED_INJURED(iLocal_48[0])){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_48[0], 6f, 6f, 6f, 0, 1, 1)){
if(PED::IS_PED_FACING_PED(iLocal_48[0], PLAYER::PLAYER_PED_ID(), 120f)){
if(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)){
return 1;
}}}}
return 0;
...
if(!HUD::DOES_BLIP_EXIST(uLocal_86)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_56, 0)){
uLocal_86=func_108(iLocal_56, 0, 145);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_86, 0);
}}else{
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_86, 1);
}
iLocal_90=0;
while (iLocal_90 <=1){
if(!HUD::DOES_BLIP_EXIST(uLocal_87[iLocal_90])){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_48[iLocal_90], 0)){
uLocal_87[iLocal_90]=func_108(iLocal_48[iLocal_90], 0, 145);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_87[iLocal_90], 0);
}}else{
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_87[iLocal_90], 1);
}
iLocal_90++;
}}
...
var uVar1;
if(!bLocal_97){
if(MISC::IS_PROJECTILE_IN_AREA(Local_52 - Vector(30f, 30f, 30f), Local_52 + Vector(30f, 30f, 30f), 1) || MISC::IS_BULLET_IN_BOX(Local_52 - Vector(30f, 30f, 30f), Local_52 + Vector(30f, 30f, 30f), 1)){
iLocal_46=2;
return 1;
}
if(!PED::IS_PED_INJURED(iLocal_48[0]) && !PED::IS_PED_INJURED(iLocal_48[1])){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_48[0], PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0)){
if(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 7) || (PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_48[0], PLAYER::PLAYER_PED_ID(), 6f, 6f, 6f, 0, 1, 0))){
if(((PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_48[0]) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_48[0])) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_48[1])) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_48[1])){
if(PED::CAN_PED_SEE_HATED_PED(iLocal_48[0], PLAYER::PLAYER_PED_ID()) || PED::CAN_PED_SEE_HATED_PED(iLocal_48[1], PLAYER::PLAYER_PED_ID())){
iLocal_46=2;
return 1;
}}}}}
...
if(PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_51) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 0.1f){
iLocal_46=2;
return 1;
}
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_51, 0)){
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_51, iVar0, 1)){
iLocal_46=2;
return 1;
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_51, 0)){
if(VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(uVar1, iLocal_51)){
iLocal_46=2;
return 1;
}}}}
if(!PED::IS_PED_INJURED(iLocal_48[0]) || ENTITY::IS_ENTITY_DEAD(iLocal_48[0], 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_48[0], PLAYER::PLAYER_PED_ID(), 1)){
iLocal_46=5;
return 1;
}
if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_48[0]) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 0.1f){
iLocal_46=5;
return 1;
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_48[0], iVar0, 1)){
iLocal_46=5;
return 1;
}}}
if(!PED::IS_PED_INJURED(iLocal_48[1]) || ENTITY::IS_ENTITY_DEAD(iLocal_48[1], 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_48[1], PLAYER::PLAYER_PED_ID(), 1)){
iLocal_46=5;
return 1;
}
if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_48[1]) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 0.1f){
iLocal_46=5;
return 1;
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_48[1], iVar0, 1)){
iLocal_46=5;
return 1;
}}}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_56, 0)){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_56, iVar0, 1)){
iLocal_46=4;
return 1;
}}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), 1)){
iLocal_46=4;
return 1;
}}
return 0;
...
MISC::CLEAR_AREA_OF_PEDS(Local_57, 50f, 0);
PATHFIND::SET_PED_PATHS_IN_AREA(419f, -1387f, 28f, 427f, -1370f, 29f, 0, 0);
MISC::SET_BIT(&uLocal_95, 5);
iLocal_56=PED::CREATE_PED(26, iLocal_58, Local_57, 0, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_56, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_58);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_56, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_56, 185, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_56, 206, 1);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_56, 2, 0);
AUDIO::STOP_PED_SPEAKING(iLocal_56, 1);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_56, "REHOMGirl");
PED::SET_PED_COMPONENT_VARIATION(iLocal_56, 0, 2, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_56, 2, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_56, 3, 1, 4, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_56, 4, 0, 5, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_56, 6, 1, 0, 0);
PED::ADD_RELATIONSHIP_GROUP("OFFICERS", &iLocal_117);
iLocal_90=0;
while (iLocal_90 <=1){
iLocal_48[iLocal_90]=PED::CREATE_PED(6, iLocal_54, Local_49[iLocal_90 /*3*/], fLocal_50[iLocal_90], 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_48[iLocal_90], 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_54);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_48[iLocal_90], iLocal_117);
PED::SET_PED_CONFIG_FLAG(iLocal_48[iLocal_90], 42, 1);
iLocal_90++;
}
WEAPON::GIVE_WEAPON_TO_PED(iLocal_48[0], joaat("weapon_pistol"), -1, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_48[1], joaat("weapon_pistol"), -1, 0, 1);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_117, joaat("player"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_117, joaat("COP"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("COP"), iLocal_117);
iLocal_51=VEHICLE::CREATE_VEHICLE(iLocal_55, Local_52, fLocal_53, 1, 1, 0);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_55, 1);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_51, 1084227584);
VEHICLE::SET_VEHICLE_SIREN(iLocal_51, 1);
...
if(func_110()==0){
func_146(&uLocal_118, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
}elseif(func_110()==1){
func_146(&uLocal_118, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}
uLocal_113=PED::CREATE_SYNCHRONIZED_SCENE(0f, 0f, 0f, 0f, 0f, 0f, 2);
PED::ATTACH_SYNCHRONIZED_SCENE_TO_ENTITY(uLocal_113, iLocal_51, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_56, uLocal_113, "random@homelandsecurity", "idle_girl", 4f, -2f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_48[0], uLocal_113, "random@homelandsecurity", "idle_cop_gun", 4f, -2f, 1, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_48[1], uLocal_113, "random@homelandsecurity", "idle_cop_ground", 4f, -2f, 1, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_113, 1);
}
...
if(func_11()==0){
return MISC::IS_BIT_SET(func_47(func_149(iParam0), -1), iParam1);
}}else{
...
if(((STREAMING::HAS_MODEL_LOADED(iLocal_58) && STREAMING::HAS_MODEL_LOADED(iLocal_54)) && STREAMING::HAS_MODEL_LOADED(iLocal_55)) && STREAMING::HAS_ANIM_DICT_LOADED("random@homelandsecurity")){
bLocal_70=true;
}else{
STREAMING::REQUEST_MODEL(iLocal_58);
STREAMING::REQUEST_MODEL(iLocal_54);
...
if(vmag2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_165()){
return 0;
}}
if(func_161()){
return 1;
...
if(!func_207(Global_113810.f_24998.f_43[iParam1])){
return 0;
}
...
return (shift_right(iParam0, 26) & 31 * func_185(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_205()) || Global_112857) || Global_32286) || func_204()) || func_85(8, -1)) || func_203()) || func_202()) || func_201()) || func_200()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_205()) || Global_32286) || func_204()) || func_85(8, -1)) || func_201()) || func_203()) || func_202()) || func_200()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_205()) || Global_112857) || Global_32286) || func_204()) || func_85(8, -1)) || func_201()) || func_203()) || func_202()) || func_200()) || Global_113810.f_7691.f_919[iVar0]==5) || Global_43924 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_205()) || Global_112857) || Global_32286) || func_204()) || func_85(8, -1)) || func_203()) || func_202()) || func_200()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_205()) || Global_32286) || func_204()) || func_85(8, -1)) || func_202()) || func_201()) || func_200()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_205()) || func_202()) || Global_112857) || Global_32286) || func_204()) || Global_44569) || func_85(8, -1)) || func_201()) || func_199()) || func_200()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_205()) || Global_112857) || Global_32286) || func_204()) || func_85(8, -1)) || func_201()) || func_199()) || func_203()) || func_202()) || func_200()){
return 0;
}
break;
}}else{
...
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
TASK::TASK_AIM_GUN_AT_COORD(iLocal_48[iVar0], func_225(PLAYER::PLAYER_ID()), -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_48[iVar0], 1);
if(!PED::IS_PED_INJURED(iLocal_56)){
TASK::TASK_COWER(iLocal_56, -1);
PED::SET_PED_KEEP_TASK(iLocal_56, 1);
}}
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_48[iVar0], 0);
}
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_48[iVar0]));
}
iVar0++;
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_51)){
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_51);
}
