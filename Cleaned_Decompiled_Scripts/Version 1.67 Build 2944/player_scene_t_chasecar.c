...
fVar3=vdist2(ENTITY::GET_ENTITY_COORDS(uLocal_446[iVar1], 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0));
...
fVar1=(10f + ((to_float(iLocal_471) / to_float(iLocal_470)) * 10f));
...
fVar2=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(uLocal_446[*iParam2], 0));
if(fVar2 > (30f * 30f)){
if(fVar2 > (150f * 150f)){
if(CAM::IS_GAMEPLAY_HINT_ACTIVE()){
func_68(&uLocal_433, 0, 0);
...
func_30(&uLocal_268, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
}elseif((Global_1575063 && iParam0==PLAYER::PLAYER_ID()) && func_48(iParam0, 1, 0)){
return Global_2657704[iParam0 /*463*/].f_321.f_7 !=-1;
}}
return 0;
}
...
if(fLocal_462 >=0f){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_449[iParam0], 0)){
if(!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_449[iParam0])){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(uLocal_449[iParam0], iLocal_460[iParam0], &Local_457, 1);
...
VEHICLE::SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(uLocal_449[iParam0], (fLocal_462 - VEHICLE::GET_TIME_POSITION_IN_RECORDING(uLocal_449[iParam0])));
...
if(!PED::IS_PED_SITTING_IN_VEHICLE(uLocal_446[iParam0], uLocal_449[iParam0])){
...
func_70(uLocal_449[iParam0], PLAYER::PLAYER_PED_ID(), &(fLocal_480[iParam0]), 17.5f, 7.5f, 30f, 0.7f, 1.2f, 1f, bVar1);
}else{
fLocal_480[iParam0]=1f;
fVar2=ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID());
fVar3=ENTITY::GET_ENTITY_SPEED(uLocal_449[iParam0]);
fLocal_480[iParam0]=1f;
if(fVar3 > fVar2){
fLocal_480[iParam0]=(fVar2 / fVar3);
}}}
if(fLocal_480[iParam0] <=0.05f){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_449[iParam0]);
return 0;
}
VEHICLE::SET_PLAYBACK_SPEED(uLocal_449[iParam0], fLocal_480[iParam0]);
fVar4=(VEHICLE::GET_TIME_POSITION_IN_RECORDING(uLocal_449[iParam0]) / VEHICLE::GET_TOTAL_DURATION_OF_VEHICLE_RECORDING(iLocal_460[iParam0], &Local_457));
if(!VEHICLE::IS_PLAYBACK_USING_AI_GOING_ON_FOR_VEHICLE(uLocal_449[iParam0])){
if(!PED::GET_PED_TYPE(uLocal_446[iParam0])==6){
if(MISC::IS_AREA_OCCUPIED(ENTITY::GET_ENTITY_COORDS(uLocal_449[iParam0], 1) - Vector(1f, 1f, 1f), ENTITY::GET_ENTITY_COORDS(uLocal_449[iParam0], 1) + Vector(1f, 1f, 1f), 0, 1, 0, 0, 0, 0, 0)){
VEHICLE::SET_PLAYBACK_TO_USE_AI(uLocal_449[iParam0], iLocal_265);
}}else{
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_446[iParam0], PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_449[iParam0], PLAYER::PLAYER_PED_ID(), 1)){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_449[iParam0]);
return 0;
}
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uLocal_449[iParam0])){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_449[iParam0]);
return 0;
}
if(PED::GET_PED_TYPE(uLocal_446[iParam0])==6){
...
if(!PED::GET_PED_TYPE(uLocal_446[iParam0])==6){
TASK::TASK_VEHICLE_DRIVE_WANDER(uLocal_446[iParam0], uLocal_449[iParam0], fLocal_264, iLocal_265);
PED::SET_PED_KEEP_TASK(uLocal_446[iParam0], 1);
if(iLocal_267==281){
VEHICLE::SET_VEHICLE_ENGINE_HEALTH(uLocal_449[iParam0], 0f);
}
...
func_77(iParam0, iParam1);
if(PED::IS_PED_SITTING_IN_VEHICLE(uLocal_446[iParam0], uLocal_449[iParam0])){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_446[iParam0], joaat("script_task_vehicle_drive_wander")) !=1){
TASK::TASK_VEHICLE_DRIVE_WANDER(uLocal_446[iParam0], uLocal_449[iParam0], fLocal_264, iLocal_265);
}else{
...
TASK::TASK_ENTER_VEHICLE(uLocal_446[iParam0], uLocal_449[iParam0], 20000, -1, 1073741824, 1, 0);
}}else{
iLocal_479[iParam0]=1;
return 0;
}
...
case -2:
if(!PED::IS_PED_INJURED(uLocal_446[iParam0])){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_446[iParam0], joaat("script_task_smart_flee_ped")) !=1){
...
if(PED::IS_PED_IN_ANY_VEHICLE(iParam1, 0)){
uVar5=PED::GET_VEHICLE_PED_IS_IN(iParam1, 0);
Var3.f_0=ENTITY::GET_ENTITY_FORWARD_X(uVar5);
...
iVar1=0;
while (iVar1 < 4){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_449[iVar1], 0) && !PED::IS_PED_INJURED(uLocal_446[iVar1])){
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_457) && iLocal_460[iVar1] > 0){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(uLocal_449[iVar1], iLocal_460[iVar1], &Local_457, 1);
VEHICLE::SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(uLocal_449[iVar1], uLocal_461);
TASK::TASK_VEHICLE_MISSION(uLocal_446[iVar1], uLocal_449[iVar1], 0, 15, 20f, iLocal_265, 0.5f, 2f, 1);
if(PED::GET_PED_TYPE(uLocal_446[iVar1])==6){
VEHICLE::SET_VEHICLE_SIREN(uLocal_449[iVar1], 1);
}}}
iVar1++;
}
return 1;
...
return 0;
}}}elseif(iParam1==func_82(Global_100554) && iParam1 !=0){
Global_100554=0;
}}
return 1;
}
...
STREAMING::REQUEST_MODEL(iLocal_447[iVar0]);
if(!STREAMING::HAS_MODEL_LOADED(iLocal_447[iVar0])){
STREAMING::REQUEST_MODEL(iLocal_447[iVar0]);
bVar2=false;
}}
if(iLocal_450[iVar0] !=0){
STREAMING::REQUEST_MODEL(iLocal_450[iVar0]);
if(!STREAMING::HAS_MODEL_LOADED(iLocal_450[iVar0])){
STREAMING::REQUEST_MODEL(iLocal_450[iVar0]);
bVar2=false;
}}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_457) && iLocal_460[iVar0] > 0){
VEHICLE::REQUEST_VEHICLE_RECORDING(iLocal_460[iVar0], &Local_457);
if(!VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_460[iVar0], &Local_457)){
VEHICLE::REQUEST_VEHICLE_RECORDING(iLocal_460[iVar0], &Local_457);
bVar2=false;
}}
iVar0++;
...
PED::ADD_RELATIONSHIP_GROUP("chasecar", &uLocal_454);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_454, joaat("player"));
iVar0=0;
while (iVar0 < 4){
if(iLocal_450[iVar0] !=0){
MISC::CLEAR_AREA(Local_455 + Local_451[iVar0 /*3*/], 20f, 1, 0, 0, 0);
uLocal_449[iVar0]=VEHICLE::CREATE_VEHICLE(iLocal_450[iVar0], Local_455 + Local_451[iVar0 /*3*/], (fLocal_456 + fLocal_452[iVar0]), 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_449[iVar0], iLocal_453);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_450[iVar0]);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(uLocal_449[iVar0], 1);
}
if(iLocal_447[iVar0] !=0){
uLocal_446[iVar0]=PED::CREATE_PED_INSIDE_VEHICLE(uLocal_449[iVar0], iLocal_448, iLocal_447[iVar0], -1, 1, 1);
PED::SET_PED_RANDOM_COMPONENT_VARIATION(uLocal_446[iVar0], 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_447[iVar0]);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_446[iVar0], uLocal_454);
...
fLocal_452[1]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
fLocal_452[2]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
fLocal_452[3]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
...
fLocal_452[0]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
fLocal_452[1]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
fLocal_452[2]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
fLocal_452[3]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
iLocal_447[0]=joaat("s_m_y_ranger_01");
...
break;
default:
fVar5=((fLocal_456 + 90f) + MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f));
Local_451[0 /*3*/]={
Vector(0f, cos(fVar5), sin(fVar5)) * FtoV(MISC::GET_RANDOM_FLOAT_IN_RANGE(15f, 25f)) 
};
fLocal_452[0]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f);
iLocal_453=0;
iLocal_447[0]=joaat("a_m_y_genstreet_01");
...
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_449[iVar0]));
if(iLocal_447[iVar0] !=0){
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_447[iVar0]);
}
if(iLocal_450[iVar0] !=0){
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_457) && iLocal_460[iVar0] > 0){
VEHICLE::REMOVE_VEHICLE_RECORDING(iLocal_460[iVar0], &Local_457);
}
iVar0++;
}
func_68(&uLocal_433, 0, 0);
