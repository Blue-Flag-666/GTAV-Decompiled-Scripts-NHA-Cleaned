...
fLocal_29=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_30);
}
func_181(&iVar1);
func_31(&iVar2);
if(iLocal_37 > 3){
if(fLocal_29 < 600f){
if(func_28(0)==0 && (MISC::GET_GAME_TIMER() - iLocal_57) > 2000){
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_43, 4f, 0, 0, 0, 0, 0, 0, 0);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_42)){
VEHICLE::DELETE_VEHICLE(&iLocal_42);
}
iLocal_42=VEHICLE::CREATE_VEHICLE(func_172(), Local_43, fLocal_44, 1, 1, 0);
AUDIO::SET_VEHICLE_RADIO_ENABLED(iLocal_42, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_172());
if(ENTITY::DOES_ENTITY_EXIST(iLocal_42)){
if(VEHICLE::DOES_EXTRA_EXIST(iLocal_42, 1)){
VEHICLE::SET_VEHICLE_EXTRA(iLocal_42, 1, 1);
}
if(VEHICLE::DOES_EXTRA_EXIST(iLocal_42, 2)){
VEHICLE::SET_VEHICLE_EXTRA(iLocal_42, 2, 0);
}
if(VEHICLE::DOES_EXTRA_EXIST(iLocal_42, 3)){
VEHICLE::SET_VEHICLE_EXTRA(iLocal_42, 3, 0);
}
VEHICLE::SET_VEHICLE_COLOURS(iLocal_42, 0, 0);
}
iLocal_41=4;
}
break;
...
if(!iLocal_45){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_26, 0)){
iVar1=PED::GET_VEHICLE_PED_IS_USING(iLocal_26);
if(iVar1==iLocal_42){
iLocal_45=1;
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_42);
iLocal_41=9;
}}}
return;
}
if(*iParam0){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_42, 0)){
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_42, -1);
}}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_42, 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_42, 1)){
func_170();
}}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_42, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
iVar2=PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID());
if(iVar2==iLocal_42){
if(vdist2(Local_43, ENTITY::GET_ENTITY_COORDS(iLocal_26, 1)) < 100f){
SCRIPT::REQUEST_SCRIPT("Traffick_Ground");
if(ENTITY::DOES_ENTITY_EXIST(iLocal_27) && !ENTITY::IS_ENTITY_DEAD(iLocal_27, 0)){
...
iVar3=func_140(&iLocal_31, 6, 9, 0, 0);
iLocal_35=1;
}
if(iVar3==1){
...
Var4.f_85=4;
Var4.f_90=6;
iLocal_28=start_new_script_with_args("Traffick_Ground", &Var4, 97, 57500);
func_81(16);
...
Global_113810.f_19986.f_12=iVar5;
func_1(106, 0, 0);
Global_113810.f_19986.f_13=0;
}
*iParam0=0;
...
return (shift_right(iParam0, 26) & 31 * func_40(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
iVar5=0;
while (iVar5 < iVar6){
if((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_102(Var7.f_1)) && iVar9 < 51){
...
}elseif(func_108(*uParam0, "v_hospital", 307.3065f, -589.9595f, 43.302f)){
*uParam0={
...
if(func_139()){
*uParam0=func_117(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
if(func_115()==0){
return MISC::IS_BIT_SET(func_90(func_114(iParam0), -1), iParam1);
}}else{
...
iVar0=0;
while (iVar0 <=60){
if(iParam1==6 || iParam1==func_138(iVar0)){
if(!bParam3 || func_137(iVar0)){
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_118(iVar0, 0), 1);
...
return func_125(2, 2);
}elseif(func_124(Global_1853823)){
...
Vector3 func__122(struct<3> Param0){
...
Vector3 func__125(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var1;
Var1={
...
int func_126(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4){
struct<4> Var0;
struct<3> Var1;
struct<4> Var2;
struct<3> Var3;
...
Var3={
func_127(Var3, -Var0.f_3.f_2) 
};
Var3={
func_127(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__127(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
void func_142(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4){
struct<60> Var0;
if(ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)){
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_20(iParam0, 0, 0)) || func_20(iParam0, 1, 0)) || func_20(iParam0, 2, 0)) || func_9(iParam0) !=145) || func_160(iParam0)) || func_159(iParam0)) || func_158(iParam0)) || func_157(iParam0)) || !func_146(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_159(iParam0)){
}
if(func_159(iParam0)){
}
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_30) < 2500f){
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_40, 8f, 0, 0, 0, 0, 0, 0, 0);
iLocal_38=VEHICLE::CREATE_VEHICLE(joaat("cuban800"), Local_40, 25.29f, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("cuban800"));
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_38, 2);
...
case 4:
if(ENTITY::DOES_ENTITY_EXIST(iLocal_38)){
if(ENTITY::IS_ENTITY_DEAD(iLocal_38, 0) || ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
iLocal_37=9;
return;
}}
if(func_28(9)){
...
if(iVar1==iLocal_38){
iLocal_39=1;
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_38);
iLocal_37=9;
}}}}
if(*iParam0){
PED::SET_PED_INTO_VEHICLE(iLocal_26, iLocal_38, -1);
}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_38, 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_38, 1)){
func_170();
}}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_27) && !ENTITY::IS_ENTITY_DEAD(iLocal_27, 0)){
if(ENTITY::GET_ENTITY_MODEL(iLocal_27) !=joaat("dune") && ENTITY::GET_ENTITY_MODEL(iLocal_27) !=joaat("cuban800")){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_27, 2137.12f, 4799.97f, 39.67854f, 2116.64f, 4790.417f, 45.45295f, 25f, 0, 1, 0)){
func_142(iLocal_27, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, 0);
}}elseif(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
VEHICLE::SET_PLAYERS_LAST_VEHICLE(iLocal_27);
}
...
iLocal_28=start_new_script("Traffick_Air", 57500);
func_81(15);
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_38)){
if(bParam0){
VEHICLE::DELETE_VEHICLE(&iLocal_38);
}else{
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_38);
}}
...
if(ENTITY::IS_ENTITY_DEAD(iLocal_26, 0)){}
if(func_193()){
return 1;
}
if(func_22() !=2){
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_112857) || Global_32286) || func_186()) || func_185(8, -1)) || func_139()) || func_191()) || func_184()) || func_190()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_192()) || Global_32286) || func_186()) || func_185(8, -1)) || func_184()) || func_139()) || func_191()) || func_190()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_112857) || Global_32286) || func_186()) || func_185(8, -1)) || func_184()) || func_139()) || func_191()) || func_190()) || Global_113810.f_7691.f_919[iVar0]==5) || Global_43924 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_192()) || Global_112857) || Global_32286) || func_186()) || func_185(8, -1)) || func_139()) || func_191()) || func_190()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_192()) || Global_32286) || func_186()) || func_185(8, -1)) || func_191()) || func_184()) || func_190()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_192()) || func_191()) || Global_112857) || Global_32286) || func_186()) || Global_44569) || func_185(8, -1)) || func_184()) || func_189()) || func_190()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_192()) || Global_112857) || Global_32286) || func_186()) || func_185(8, -1)) || func_184()) || func_189()) || func_139()) || func_191()) || func_190()){
return 0;
}
break;
}}else{
...
void func_197(){
if(!iLocal_56){
iLocal_55=PED::ADD_SCENARIO_BLOCKING_AREA(Vector(40.073f, 4788.559f, 2157.109f) - Vector(25f, 25f, 25f), Vector(40.073f, 4788.559f, 2157.109f) + Vector(25f, 25f, 25f), 0, 1, 1, 1);
iLocal_56=1;
}}
...
iVar0=0;
while (iVar0 < 5){
if(OBJECT::DOES_PICKUP_EXIST(uLocal_48[iVar0])){
OBJECT::REMOVE_PICKUP(uLocal_48[iVar0]);
}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_47[iVar0])){
OBJECT::DELETE_OBJECT(&(uLocal_47[iVar0]));
}
iVar0++;
}}