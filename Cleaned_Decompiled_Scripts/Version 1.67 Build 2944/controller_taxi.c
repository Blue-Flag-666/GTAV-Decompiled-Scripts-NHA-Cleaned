...
iLocal_51=49;
iLocal_52=64;
uLocal_75=HUD::GET_STANDARD_BLIP_ENUM_ID();
uLocal_76=HUD::GET_WAYPOINT_BLIP_ENUM_ID();
Local_81={
500f, 500f, 500f 
};
iLocal_102=-1;
...
}}elseif(!func_84(Global_113810.f_19100, 16)){
if(!iLocal_110){
...
if(func_65(&uLocal_115)){
func_87(&uLocal_115);
}
if(func_61(&uLocal_112) > 20f){
if(!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_60()){
iLocal_101=9;
StringCopy(&Local_95, "Taxi_Procedural", 24);
func_59(&uLocal_118, 8, 0, "TaxiDispatch", 0, 1);
func_58(&uLocal_118, "OJTXAUD", "OJTX_PRO_OFF", 2, 0, 0, 0);
func_79(&uLocal_112);
iLocal_100=1;
}elseif(!func_60()){
...
if(func_61(&uLocal_112) > 15f){
if(!func_84(Global_113810.f_19100, 32)){
func_57("TC_MISSEDJOB", -1);
func_82(&(Global_113810.f_19100), 32);
}
fLocal_105=(MISC::GET_RANDOM_FLOAT_IN_RANGE(10f, 40f) + func_61(&uLocal_112));
iLocal_100=3;
}
elseif(iLocal_106){
if(func_61(&uLocal_112) > 6f){
...
if(func_61(&uLocal_112) > fLocal_105){
func_87(&uLocal_112);
iLocal_100=0;
}
break;
}
if(((PAD::IS_CONTROL_PRESSED(0, 86) && !ENTITY::IS_ENTITY_UPSIDEDOWN(PLAYER::PLAYER_PED_ID())) && !Global_32436) && (MISC::GET_GAME_TIMER() - iLocal_103) > 3000){
iVar4=func_70();
if(iVar4==0){
if(iLocal_100==0 || iLocal_100==3){
func_81(&uLocal_118);
iLocal_101=9;
func_35(iLocal_101, &Local_95, &uLocal_118, 0);
iLocal_109=1;
iVar1=4;
}
else{
...
SCRIPT::REQUEST_SCRIPT(&Local_95);
func_87(&uLocal_112);
iVar2=0;
}
elseif(iVar4==2){
...
if(func_61(&uLocal_115) < 10f){
if((MISC::GET_GAME_TIMER() % 1000) < 50){
}
}
if(func_61(&uLocal_115) > 10f && iLocal_100 !=0){
iLocal_100=0;
}}
...
if(((MISC::GET_GAME_TIMER() - iLocal_104) > 60000 && !func_66("TC_HOWTOSTART")) && iLocal_110){
iLocal_110=0;
}
if(bLocal_108){
bLocal_108=false;
...
if(SCRIPT::HAS_SCRIPT_LOADED(&Local_95)){
iVar5=func_26(&iLocal_102, 2, 9, 0, 0);
if(iVar5==1){
Global_112865=1;
if(iLocal_109){
iVar1=5;
...
func_25("PROCESS_TAXI_DBG_SKIP=Scene is loading.", &iLocal_111, 1000);
}}
break;
case 5:
StringCopy(&Var6, "OJTX_PLRDE1", 24);
func_24(&Var6, 1);
func_58(&uLocal_118, "OJTXAUD", &Var6, 8, 0, 0, 0);
iVar1=6;
break;
case 6:
if(!func_23()){
func_58(&uLocal_118, "OJTXAUD", "OJTX_DIS_JOB", 8, 0, 0, 0);
iVar1=7;
}
break;
case 7:
...
func_24(&Var7, 1);
func_81(&uLocal_118);
func_58(&uLocal_118, "OJTXAUD", &Var7, 8, 0, 0, 0);
iVar1=8;
}
break;
case 8:
...
iLocal_94=start_new_script(&Local_95, 57500);
SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&Local_95);
...
break;
case 10:
if(!SCRIPT::IS_THREAD_ACTIVE(iLocal_94)){
...
iVar1=11;
iVar2=0;
}elseif(func_84(Global_113810.f_19100, 1024)){
func_92(&(Global_113810.f_19100), 1024);
func_13(func_19(iLocal_101), 0, 0);
bLocal_108=true;
func_11(iLocal_101, bLocal_108);
func_10(1, 0);
func_7();
}
break;
...
if(iLocal_94 !=0){
if(SCRIPT::IS_THREAD_ACTIVE(iLocal_94)){
SCRIPT::TERMINATE_THREAD(iLocal_94);
iLocal_94=0;
}}
func_87(&uLocal_112);
func_1(0);
...
iVar1=round(VEHICLE::GET_VEHICLE_ENGINE_HEALTH(uVar0));
...
if(HUD::GET_LENGTH_OF_LITERAL_STRING(&Local_95) !=0){
SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&Local_95);
}
if(HUD::DOES_BLIP_EXIST(uLocal_99)){
HUD::REMOVE_BLIP(&uLocal_99);
