...
func_289();
if(func_288()){
func_287(-1339.786f, -1277.51f, 3.8874f, 261.2839f, 1, 0);
}
if(func_286(0)){
...
while ((MISC::GET_GAME_TIMER() - iLocal_197) < 3000){
wait(0);
}}}
if(!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_185)){
func_19(sLocal_185);
...
fVar3=0f;
if(!func_8(Global_113810.f_18536[iVar0], &Var2, &fVar3)){
...
break;
case 1:
if(func_95(PLAYER::PLAYER_PED_ID(), Local_194, 2f, 1) && func_88(21)){
...
iLocal_79=2;
}elseif(!func_95(PLAYER::PLAYER_PED_ID(), Local_193, 75f, 1)){
if(!iLocal_199){
func_22(&uLocal_190);
iLocal_199=1;
}
func_85(&uLocal_190, Local_194, 1, 1, "PRD_SHOP");
}elseif(func_95(PLAYER::PLAYER_PED_ID(), Local_194, 12f, 1)){
if(iLocal_199){
func_22(&uLocal_190);
iLocal_199=0;
}
...
HUD::SET_BLIP_COLOUR(uLocal_190, 2);
HUD::SET_BLIP_ROUTE_COLOUR(uLocal_190, 2);
}}}
break;
case 2:
if((MISC::GET_GAME_TIMER() - iLocal_196) > 2000){
func_22(&uLocal_190);
...
if(func_94()==0){
return MISC::IS_BIT_SET(func_90(func_93(iParam0), -1), iParam1);
}}else{
...
case 2:
if(bParam1){
func_97(PLAYER::PLAYER_PED_ID(), Local_194, 261.2839f);
bLocal_26=false;
func_24(1, 1, 1);
}else{
return 1;
...
case 1:
if(!iLocal_195){
if(func_95(PLAYER::PLAYER_PED_ID(), Local_193, 60f, 1)){
...
break;
case 3:
func_97(PLAYER::PLAYER_PED_ID(), Local_194, 0f);
func_24(1, 1, 1);
iLocal_79=1;
break;
}}
...
if(iVar0==1){
if(!func_234(iParam4, iParam5, iParam6, iParam11)){
iVar0=0;
}}
if(iVar0==1){
func_232();
...
*iParam0=func_206(Param1, fParam2);
}elseif(iParam7==1){
...
func_185(iParam0, &(Var2.f_31), &(Var2.f_81));
VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
if(iParam1==1){
...
return 1;
}elseif(func_142(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_180(iParam0, 0, 0)) || func_180(iParam0, 1, 0)) || func_180(iParam0, 2, 0)) || func_179(iParam0) !=145) || func_178(iParam0)) || func_177(iParam0)) || func_124(iParam0)) || func_176(iParam0)) || !func_164(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_177(iParam0)){
}
if(func_177(iParam0)){
}
...
}elseif(func_190(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_191() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
return func_207(&(Global_107357.f_2890), Param0, fParam1, 0);
}

int func_207(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
}elseif((!func_209(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
iVar4=func_208(iVar0);
if(iVar4==-1){
uParam0->f_10=0;
}else{
func_197(iVar4);
...
int func_209(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_210(iParam0, uVar1[iVar3], 1) && func_100(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_205(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
...
void func_211(int iParam0, var uParam1, bool bParam2, bool bParam3){
int iVar0;
int iVar1;
int iVar2;
int iVar3;
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_160(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_160(iVar4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_160(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_160(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_160(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_160(iVar6))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_219(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_218()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_160(iVar7 + 1))){
...
var func__216(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
if(!bLocal_188){
if(!func_95(PLAYER::PLAYER_PED_ID(), Local_193, 150f, 1)){
func_246(2);
}elseif(!func_95(PLAYER::PLAYER_PED_ID(), Local_193, 75f, 1)){
if(!iLocal_198){
HUD::CLEAR_PRINTS();
...
func_250(sLocal_200[0], sLocal_200[1], sLocal_200[2]);
}elseif(Global_113810.f_2366.f_539.f_2395[1]==-99){
func_250(sLocal_200[1], sLocal_200[0], sLocal_200[2]);
}elseif(Global_113810.f_2366.f_539.f_2395[2]==-99){
func_250(sLocal_200[2], sLocal_200[1], sLocal_200[0]);
}
break;
case 1:
if(Global_113810.f_2366.f_539.f_2395[1]==-99){
func_250(sLocal_200[1], sLocal_200[0], sLocal_200[2]);
}elseif(Global_113810.f_2366.f_539.f_2395[0]==-99){
func_250(sLocal_200[0], sLocal_200[1], sLocal_200[2]);
}elseif(Global_113810.f_2366.f_539.f_2395[2]==-99){
func_250(sLocal_200[2], sLocal_200[1], sLocal_200[0]);
}
...
Global_78472[1 /*14*/]={
func_292(iParam0, iParam1, iParam2, -1) 
};
...
int func_291(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6){
if(iParam0==0){
if(iParam5==1){
...
struct<14> func_292(int iParam0, int iParam1, int iParam2, int iParam3){
func_357();
...
break;
default:
func_302(iVar7, iParam0, 155, -1);
return;
break;
}
func_295(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
bool func_300(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5){
int iVar0;
*uParam2=14385;
...
func_295(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_295(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
iVar10=(iParam1 - iParam2);
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(uVar1, 10, -1, 0, -1, func_303(iParam0));
if(iVar11 > iVar10){
...
void func_361(var uParam0, var uParam1, float fParam2){
int iVar0;
int iVar1;
int iVar2;
struct<3> Var3;
...
if(func_362(uParam1, *(uParam1[iVar1 /*3*/]) + Var5)){
Var5={
-Var5 
};
}
...
bool func_362(var uParam0, struct<2> Param1, Vector3 vParam2){
bool bVar0;
int iVar1;
int iVar2;
if(uParam0->f_46 < 3){}
...
if(CAM::DOES_CAM_EXIST(uLocal_191)){
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
CAM::DESTROY_CAM(uLocal_191, 0);
}}
...
void func_377(bool bParam0, int iParam1, int iParam2){
bool bVar0;
bVar0=true;
