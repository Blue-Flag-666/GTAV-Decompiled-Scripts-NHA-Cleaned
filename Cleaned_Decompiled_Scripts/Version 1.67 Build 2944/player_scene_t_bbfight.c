...
iVar1=func_27();
if(func_26(iVar1)){
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_356)){
if(!iLocal_360){
if(fVar0 < fLocal_359){
}else{
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_350)){
func_20(&uLocal_109, func_21(), PLAYER::PLAYER_PED_ID(), &Local_350, 0, 1);
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_353)){
func_20(&uLocal_109, 4, iLocal_275[0], &Local_353, 0, 1);
}
if(func_3(&uLocal_109, "PRSAUD", &Local_356, 3, 0, 0, 0)){
iLocal_360=1;
}}}}}}
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_282) > 100f){
return 1;
}
return 0;
}
...
TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_98142, &cLocal_337, &(Local_346[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
(*iParam1)[iVar0]=101;
...
case 101:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98143)){
TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_98143, &cLocal_337, &(Local_347[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
STREAMING::REQUEST_ANIM_DICT(&cLocal_337);
(*iParam1)[iVar0]=102;
}
break;
case 102:
if(STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_337) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_337, &(Local_347[iVar0 /*16*/]), 2)){
sVar1="victim_fall";
fVar2=-1f;
fVar3=-1f;
if(ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_337, &(Local_347[iVar0 /*16*/]), sVar1, &fVar2, &fVar3)){
...
if(iLocal_108==165){
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_348[iVar0 /*16*/]))){
...
TASK::TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_348[iVar0 /*16*/]), 0, 0);
...
case 200:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98142)){
TASK::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_337, &(Local_346[iVar0 /*16*/]), 8f, -1000f, -1, 0, 0, 0, 0, 0);
(*iParam1)[iVar0]=201;
}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98143)){
(*iParam1)[iVar0]=201;
}
...
case 201:
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98143)){
TASK::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_337, &(Local_347[iVar0 /*16*/]), 8f, -1.5f, -1, 32768, 0, 0, 0, 0);
...
break;
case 202:
if(STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_337) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_337, &(Local_347[iVar0 /*16*/]), 1)){
sVar5="victim_fall";
fVar6=-1f;
fVar7=-1f;
if(ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_337, &(Local_347[iVar0 /*16*/]), sVar5, &fVar6, &fVar7)){
if(fVar6 < ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*iParam0)[iVar0], &cLocal_337, &(Local_347[iVar0 /*16*/]))){
if(!PED::IS_PED_RUNNING_RAGDOLL_TASK((*iParam0)[iVar0])){
TASK::CLEAR_PED_TASKS((*iParam0)[iVar0]);
PED::SET_PED_TO_RAGDOLL_WITH_FALL((*iParam0)[iVar0], 1000, 3000, 4, ENTITY::GET_ENTITY_FORWARD_VECTOR((*iParam0)[iVar0]), 100f, 0f, 0f, 0f, 0f, 0f, 0f);
PED::SET_PED_CONFIG_FLAG((*iParam0)[iVar0], 137, 1);
...
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*iParam0)[iVar0], &cLocal_337, &(Local_347[iVar0 /*16*/])) > 0.954f){
if(iLocal_108==108){
Local_284[iVar0 /*3*/]={
Vector(224.5948f, 1213.466f, 199.6328f) - Local_282 
};
}elseif(iLocal_108==109){
Local_284[iVar0 /*3*/]={
Vector(5.9049f, -717.1404f, -1908.287f) - Local_282 
};
}
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], Local_282 + Local_284[iVar0 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
...
Var9={
Local_282 + Local_284[iVar0 /*3*/] + Vector(1f, 0f, 0f) 
};
...
break;
case 11:
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_282) > 50f && vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], 1)) > 50f){
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_278, joaat("player"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, joaat("player"), iLocal_278);
TASK::CLEAR_PED_TASKS((*iParam0)[iVar0]);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], Local_282 + Local_284[iVar0 /*3*/], 0.5f, -1, 1048576000, 0, 1193033728);
(*iParam1)[iVar0]=1;
}
...
OBJECT::DELETE_OBJECT(&(uLocal_279[iVar0]));
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(uLocal_279[iVar0]));
}
TASK::CLEAR_PED_TASKS((*iParam0)[iVar0]);
...
if(MISC::ARE_STRINGS_EQUAL(&(Local_348[iVar0 /*16*/]), "any")){
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_282 + Local_284[iVar0 /*3*/], 20f, 1)){
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD((*iParam0)[iVar0], Local_282 + Local_284[iVar0 /*3*/], 20f, 0);
iLocal_349[iVar0]=MISC::GET_GAME_TIMER();
}
}
else{
iVar18=1;
...
TASK::TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_348[iVar0 /*16*/]), 0, iVar18);
iLocal_349[iVar0]=MISC::GET_GAME_TIMER();
}}elseif(ENTITY::DOES_ENTITY_EXIST(uLocal_279[iVar0])){
if(iLocal_349[iVar0] > 0){
if(MISC::GET_GAME_TIMER() > iLocal_349[iVar0] + 1000){
OBJECT::DELETE_OBJECT(&(uLocal_279[iVar0]));
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(uLocal_279[iVar0]));
}
}}
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(uParam0, 1), Var1) < (fParam1 * fParam1)){
return 1;
}
if(MISC::IS_BIT_SET(Global_32663[iVar0 /*23*/].f_11, 19)){
iVar3=3;
iVar2=0;
while (iVar2 < iVar3){
Var4={
...
if(!func_30(Var4)){
if(vdist2(ENTITY::GET_ENTITY_COORDS(uParam0, 1), Var4) < (fParam1 * fParam1)){
return 1;
}
}
iVar2++;
...
if(func_33(PLAYER::PLAYER_PED_ID(), Local_282 + Local_286[iVar1 /*3*/], Local_287[iVar1 /*3*/], (fLocal_283 + fLocal_288[iVar1]), 0, 1, 0)){
fVar2=50f;
...
struct<3> Var0;
struct<3> Var1;
Var0.f_0=(Param1.f_0 - (cos(fParam3) * Param2.f_0));
Var0.f_1=(Param1.f_1 - (sin(fParam3) * Param2.f_0));
Var0.f_2=(Param1.f_2 - Param2.f_2);
Var1.f_0=(Param1.f_0 + (cos(fParam3) * Param2.f_0));
Var1.f_1=(Param1.f_1 + (sin(fParam3) * Param2.f_0));
...
return 0;
}}}elseif(iParam1==func_49(Global_100554) && iParam1 !=0){
Global_100554=0;
}}
return 1;
}
...
STREAMING::REQUEST_MODEL(iLocal_277[iVar0]);
if(!STREAMING::HAS_MODEL_LOADED(iLocal_277[iVar0])){
bVar2=false;
STREAMING::REQUEST_MODEL(iLocal_277[iVar0]);
}}
...
PED::ADD_RELATIONSHIP_GROUP("FIGHTERS", &iLocal_278);
iVar0=0;
while (iVar0 < iLocal_275){
if(iLocal_277[iVar0] !=0){
iLocal_275[iVar0]=PED::CREATE_PED(26, iLocal_277[iVar0], Local_282 + Local_284[iVar0 /*3*/], 0, 1, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_275[iVar0], (fLocal_283 + fLocal_285[iVar0]));
...
}}elseif(PED::GET_PED_DRAWABLE_VARIATION(iLocal_275[iVar0], 10)==1){
if(PED::GET_PED_DRAWABLE_VARIATION(iLocal_275[iVar0], 10) !=0){
PED::SET_PED_COMPONENT_VARIATION(iLocal_275[iVar0], 10, 0, 0, 0);
}}}
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_275[iVar0], iLocal_278);
TASK::TASK_STAND_STILL(iLocal_275[iVar0], -1);
if(iLocal_108==285){
ENTITY::SET_ENTITY_MAX_HEALTH(iLocal_275[iVar0], 105);
ENTITY::SET_ENTITY_HEALTH(iLocal_275[iVar0], 105, 0);
}}
if(iLocal_280[iVar0] !=0){
uLocal_279[iVar0]=OBJECT::CREATE_OBJECT(iLocal_280[iVar0], Local_282 + Local_284[iVar0 /*3*/], 1, 1, 0);
ENTITY::SET_ENTITY_HEADING(uLocal_279[iVar0], (fLocal_283 + fLocal_285[iVar0]));
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_279[iVar0], iLocal_275[iVar0], PED::GET_PED_BONE_INDEX(iLocal_275[iVar0], iLocal_281[iVar0]), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}
iVar0++;
}
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_278, joaat("player"));
...
case 166:
Local_284[0 /*3*/]={
Vector(36.037f, -476.663f, -1050.724f) - Local_282 
};
fLocal_285[0]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
...
case 246:
Local_284[0 /*3*/]={
Vector(4.6f, -1570.924f, -1194.77f) - Local_282 + Vector(-1f, 0f, 0f) 
};
...
case 257:
Local_284[0 /*3*/]={
Vector(7.1578f, -978.6192f, -1666.374f) - Local_282 
};
...
fLocal_285[0]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
fLocal_285[1]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
...
case 239:
Local_284[0 /*3*/]={
Vector(113.05f, 354.39f, -52.2f) - Local_282 + Vector(-1f, 0f, 0f) 
};
Local_284[1 /*3*/]={
Vector(113.05f, 354.08f, -53.18f) - Local_282 + Vector(-1f, 0f, 0f) 
};
fLocal_285[0]=-100f;
fLocal_285[1]=-100f;
iLocal_277[0]=joaat("a_m_m_business_01");
...
fLocal_288[0]=MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
break;
}}
...
if(iLocal_277[iVar0] !=0){
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_277[iVar0]);
}
iVar0++;
}
PED::REMOVE_RELATIONSHIP_GROUP(iLocal_278);
