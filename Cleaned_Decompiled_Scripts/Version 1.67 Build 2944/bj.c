...
bVar112=false;
bVar113=false;
if(ENTITY::DOES_ENTITY_EXIST(ScriptParam_515.f_1)){
...
func_563(&Var3, &uVar51, &iVar33, &iVar34, &iVar36, &iVar39, &iVar40, &uVar32, &iVar42, &iVar43, &iVar44, uVar85, &iVar80, uVar45, uVar46, bVar13, &uVar41, bVar111);
}
if(bVar77 < 0){
return;
}
if(MISC::IS_BIT_SET(Global_113810.f_18970.f_1, bVar77)){
fVar65=0.1f;
}
bVar13=bVar77;
func_562(0);
...
if(func_534(&Var3) !=0 && ENTITY::GET_ENTITY_MODEL(iVar33)==func_534(&Var3)){
iVar36=iVar33;
iVar33=0;
}}
while (true){
...
func_514(&uVar4);
func_510(&Var6, iVar7);
func_506(&Var6, iVar7, bVar13, bVar93);
switch (iVar7){
case 0:
func_505();
...
if(ENTITY::DOES_ENTITY_EXIST(ScriptParam_515.f_2)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(ScriptParam_515.f_2, 1, 1);
OBJECT::DELETE_OBJECT(&(ScriptParam_515.f_2));
}
func_480(&uVar5, &Var3, bVar13, bVar13==6);
bVar102=true;
}
iVar7=1;
break;
...
Var57={
func_478(cos(Var57.f_2), sin(Var57.f_2), MISC::TAN(Var57.f_0)) 
};
if(func_477(bVar13)){
STREAMING::NEW_LOAD_SCENE_START(func_476(bVar13), Var57, 4000f, 0);
}
}
func_470(&Var3, bVar13, &uVar0, &uVar1, &iVar2, &uVar51, &iVar84);
}elseif(func_468(func_469(bVar13))){
Var62={
Vector(1.2f, 1.2f, 1.2f) * Vector(0f, -cos((-97.4239f + func_467(&Var3))), sin((-97.4239f + func_467(&Var3)))) 
};
Var61={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar33, 1.12046f, -0.317773f, 1.3385f) 
};
Var62={
func_466(Var62, 8.909f) 
};
if(func_477(bVar13)){
STREAMING::NEW_LOAD_SCENE_START(Var61 + Var62, Var62, 4000f, 0);
}}else{
Var57={
-10f, 0f, func_467(&Var3) 
};
Var57={
func_478(cos(Var57.f_2), sin(Var57.f_2), MISC::TAN(Var57.f_0)) 
};
...
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_476(bVar13), 0, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), func_467(&Var3));
ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), 1);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 0);
}
iVar7=2;
}elseif(!CAM::IS_SCREEN_FADING_OUT() && (!func_465(&uVar23) || func_464(&uVar23) > 0.05f)){
...
break;
case 2:
if(func_462(&uVar0, &uVar16, &uVar51, bVar13, iVar84, ((bVar13 !=5 && bVar13 !=6) && bVar13 !=12))){
func_461(&uVar16);
func_438(&Var3, &uVar32, &iVar72, &iVar33, &iVar34, &iVar36, &uVar35, &uVar37, &iVar42, &iVar43, uVar1, iVar2, &uVar19, bVar13, &iVar81);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 1, 0);
if(!bVar93 && !bVar102){
func_480(&uVar5, &Var3, bVar13, 0);
}
iVar7=3;
}
break;
case 3:
if(!func_465(&uVar16) && !bVar93){
func_437(0, 0, 1);
func_489(&uVar16);
}elseif((func_465(&uVar16) && func_464(&uVar16) > 0.2f) || bVar93){
if(func_468(func_469(bVar13)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "oddjobs@basejump@", "Heli_door_loop", 3)){
}elseif(bVar93){
CAM::DO_SCREEN_FADE_OUT(800);
if(func_465(&uVar16)){
func_461(&uVar16);
...
wait(1000);
CAM::SET_CAM_ACTIVE_WITH_INTERP(func_436(&uVar5, 1), func_436(&uVar5, 0), 10000, 1, 1);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
CAM::DO_SCREEN_FADE_IN(800);
}
STREAMING::NEW_LOAD_SCENE_STOP();
if(func_468(func_469(bVar13))){
Var62={
Vector(1.2f, 1.2f, 1.2f) * Vector(0f, -cos((-97.4239f + func_467(&Var3))), sin((-97.4239f + func_467(&Var3)))) 
};
Var61={
...
if(!func_434(func_435(bVar13)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, 1);
if(PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID())){
PED::SET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID(), 0, 0);
}
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_435(bVar13), 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), func_433(func_435(bVar13), func_476(bVar13)));
PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, 1);
if(func_431()==0){
...
if(func_430(bVar13) > 0){
TASK::TASK_STAND_STILL(0, func_430(bVar13));
}
TASK::TASK_GO_STRAIGHT_TO_COORD(0, func_476(bVar13), 1f, -1, func_467(&Var3), 1056964608);
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(iVar39[iVar82], 0), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)) < 2500f){
...
if(func_468(func_469(bVar13))){
func_419(&uVar5, &Var3, &Var56, &Var61, &Var62, iVar33, &uVar63, &uVar64);
...
elseif(func_464(&uVar30) > 4f || (func_468(func_469(bVar13)) && func_464(&uVar30) > 0.5f)){
func_403(&uVar32, "OJBJAUD", func_418(&Var3), 8, 0, 0, 0);
bVar104=true;
}}
if(!CAM::IS_SCREEN_FADING_OUT() && !bVar93){
if(func_381(&Var3, bVar13, &iVar36, &uVar5, &uVar4, &uVar17, &uVar18, &uVar22, &uVar28, iVar84, &bVar94, &bVar106, bVar98)){
HUD::CLEAR_HELP(1);
bVar98=false;
if(func_380(&Var3)){
CAM::DO_SCREEN_FADE_OUT(800);
...
if(CAM::IS_SCREEN_FADED_OUT()){
if(bVar93 && bVar103){
CLOCK::SET_CLOCK_TIME(func_376(iVar15), func_375(iVar15), func_374(iVar15));
}
wait(2000);
if(bVar93){
ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), 0);
...
uVar45=HUD::ADD_BLIP_FOR_COORD(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar34, func_372(&Var3)));
HUD::SET_BLIP_COLOUR(uVar45, 5);
HUD::SHOW_HEIGHT_ON_BLIP(uVar45, 1);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uVar45, "BJ_BLIP_TGT");
}else{
uVar45=HUD::ADD_BLIP_FOR_COORD(func_371(&Var3, 0));
HUD::SET_BLIP_COLOUR(uVar45, 5);
if(iVar72==1){
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uVar45, "BJ_BLIP_TGT");
}else{
...
if(iVar72 > 1){
uVar46=HUD::ADD_BLIP_FOR_COORD(func_371(&Var3, 1));
...
if(func_369(func_370(&Var3))){
VEHICLE::DELETE_MISSION_TRAIN(&iVar34);
}else{
ENTITY::SET_ENTITY_COORDS(iVar34, func_371(&Var3, 0), 1, 0, 0, 1);
}}
if(MISC::IS_BIT_SET(Global_113810.f_18970.f_1, (func_368(&Var3) - 125))){
...
if((func_363(&Var3) && !bVar106) && !bVar93){
CAM::STOP_RENDERING_SCRIPT_CAMS_USING_CATCH_UP(1, 0, 3, 0);
}
elseif(bVar13==4 && !func_362()){
CAM::SET_CAM_COORD(func_436(&uVar5, 0), -76.7226f, -829.9866f, 326.0427f);
CAM::SET_CAM_ROT(func_436(&uVar5, 0), 0.8541f, 0f, -17.012f, 2);
CAM::SET_CAM_FOV(func_436(&uVar5, 0), 53.883f);
CAM::SET_CAM_ACTIVE(func_436(&uVar5, 0), 1);
}
else{
if(CAM::IS_SCRIPT_GLOBAL_SHAKING()){
CAM::STOP_SCRIPT_GLOBAL_SHAKING(0);
...
iVar7=12;
break;
}elseif((bVar97 || bVar96) || func_361(&Var3, bVar13, &bVar99)){
HUD::CLEAR_HELP(1);
HUD::CLEAR_PRINTS();
iVar7=10;
}else{
...
func_360(&uVar19);
func_350(&Var3, iVar34, iVar42, &iVar44, &uVar49, &uVar50, &iVar71, &iVar73, &iVar74, iVar72, &iVar75, &uVar45, &uVar46, &iVar70, &iVar14, &uVar66, &uVar67, &uVar68, &uVar95, 0, 1, fVar65);
func_349(&uVar52);
if(func_465(&uVar16)){
if(func_464(&uVar16) > 10f){
func_345(&uVar20, &iVar80);
}}else{
func_344(&uVar16, 0f);
}
if(ENTITY::DOES_ENTITY_EXIST(iVar36) && !ENTITY::IS_ENTITY_DEAD(iVar36, 0)){
if(!ENTITY::IS_ENTITY_ON_SCREEN(iVar36) && vdist2(ENTITY::GET_ENTITY_COORDS(iVar36, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 40000f){
...
if(HUD::IS_MESSAGE_BEING_DISPLAYED() || !func_465(&uVar31)){
func_373(&uVar31);
}
elseif(func_464(&uVar31) > 0.25f){
Var55={
func_343(bVar13) 
};
func_342(&Var55, 7500, 0);
func_461(&uVar31);
MISC::SET_BIT(&uVar78, false);
}}
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_341(&Var6, 1);
...
if(!MISC::IS_BIT_SET(uVar78, 1)){
if(!func_465(&uVar24)){
func_489(&uVar24);
}elseif(func_464(&uVar24) > 0.15f){
func_340("BJ_VEHHELP", -1);
func_461(&uVar24);
MISC::SET_BIT(&uVar78, true);
}}
}
else{
MISC::CLEAR_BIT(&uVar78, true);
...
func_350(&Var3, iVar34, iVar42, &iVar44, &uVar49, &uVar50, &iVar71, &iVar73, &iVar74, iVar72, &iVar75, &uVar45, &uVar46, &iVar70, &iVar14, &uVar66, &uVar67, &uVar68, &uVar95, 0, 1, fVar65);
func_349(&uVar52);
if(func_468(func_469(bVar13)) && !ENTITY::IS_ENTITY_DEAD(iVar33, 0)){
func_338(iVar33, func_476(bVar13));
}
if(func_465(&uVar16)){
if(func_464(&uVar16) > 10f){
func_345(&uVar20, &iVar80);
...
if(func_334(&Var3, &uVar5, &uVar4, &uVar18, &Var56, &uVar60, Var61, Var62) || bVar98){
func_461(&uVar16);
HUD::CLEAR_HELP(1);
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(ENTITY::DOES_ENTITY_EXIST(iVar33) && !ENTITY::IS_ENTITY_DEAD(iVar33, 0)){
ENTITY::SET_ENTITY_COORDS(iVar33, func_476(bVar13), 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iVar33, func_467(&Var3));
...
if(ENTITY::DOES_ENTITY_EXIST(iVar33)){
if(func_331(&uVar5, &uVar17, Var61, Var62, Var56, &uVar63, &uVar64)){
...
HUD::CLEAR_PRINTS();
iVar7=10;
}elseif(func_330(&uVar4, 3, 1000) && !Global_23251.f_135){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 1);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 256);
CAM::DO_SCREEN_FADE_OUT(800);
while (CAM::IS_SCREEN_FADING_OUT()){
func_350(&Var3, iVar34, iVar43, &iVar44, &uVar49, &uVar50, &iVar71, &iVar73, &iVar74, iVar72, &iVar75, &uVar45, &uVar46, &iVar70, &iVar14, &uVar66, &uVar67, &uVar68, &uVar95, 0, 1, fVar65);
wait(0);
}
...
func_278(PLAYER::PLAYER_PED_ID(), Var58);
bVar98=false;
}
func_360(&uVar19);
if(func_369(func_370(&Var3))){
if(!ENTITY::DOES_ENTITY_EXIST(iVar34) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_371(&Var3, 0), 0) <=200f){
iVar34=VEHICLE::CREATE_MISSION_TRAIN(6, func_371(&Var3, 0), 1, 0, 0);
if(!ENTITY::IS_ENTITY_DEAD(iVar34, 0)){
VEHICLE::SET_TRAIN_CRUISE_SPEED(iVar34, 7.5f);
}
}}elseif((ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, 0)) && !func_434(func_371(&Var3, 0))){
PED::IS_PED_INJURED(iVar43);
if(func_277(PLAYER::PLAYER_PED_ID(), iVar34, 0) <=325f){
if(bVar13==5){
Var115={
...
iVar8=func_350(&Var3, iVar34, iVar43, &iVar44, &uVar49, &uVar50, &iVar71, &iVar73, &iVar74, iVar72, &iVar75, &uVar45, &uVar46, &iVar70, &iVar14, &uVar66, &uVar67, &uVar68, &uVar95, 1, 1, fVar65);
if(iVar8==1 || iVar8 >=2){
...
if(func_370(&Var3)==0){
func_270(func_371(&Var3, (iVar72 - 1)), Var27);
}
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(((((ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iVar34, Var59, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_371(&Var3, iVar71), Var59, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())){
bVar117=false;
...
if(bVar117){
if(func_330(&uVar4, 3, 1000) && !Global_23251.f_135){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 1);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 256);
CAM::DO_SCREEN_FADE_OUT(800);
while (CAM::IS_SCREEN_FADING_OUT()){
...
if(((bVar96 || bVar97) || bVar99) || (func_465(&uVar21) && func_464(&uVar21) > 0.25f)){
if(func_465(&uVar21) && func_464(&uVar21) > 0.25f){
func_266(func_371(&Var3, iVar71), iVar34, iVar43, &iVar8, &iVar75, &fVar69);
}
func_461(&uVar21);
if(bVar96 || iVar8==1){
uVar10=func_265();
...
func_403(&uVar32, "OJBJAUD", "BJ_01D", 8, 1, 1, 0);
}
}
iVar7=11;
if(!func_264(&Var6, 7)){
iVar79=125;
MISC::SET_BIT(&(Global_113810.f_18970.f_1), (func_368(&Var3) - iVar79));
func_263(func_368(&Var3), 1);
iVar89=1;
bVar90=true;
bVar91=true;
bVar83=false;
while (bVar83 < 13){
if(!MISC::IS_BIT_SET(Global_113810.f_18970.f_1, bVar83)){
if(func_468(func_469(bVar83))){
bVar91=false;
}
else{
bVar90=false;
...
}elseif(!CAM::IS_SCREEN_FADING_OUT() && (!func_77() || func_464(&uVar25) >=2f)){
...
if(func_465(&uVar18)){
if((iVar9==1 || func_464(&uVar18) >=60f) || ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())) || (!bVar108 && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)))){
if(!bVar113){
func_76(&(Var6.f_26));
bVar113=true;
}
...
if(bParam0){
func_563(uParam1, uParam2, iParam3, iParam4, iParam5, iParam6, &uParam7, uParam8, iParam9, iParam10, iParam11, uParam12, iParam13, uParam14, uParam15, bParam16, uParam17, bParam18);
}else{
func_563(uParam1, uParam2, iParam3, iParam4, iParam5, iParam6, &uParam7, uParam8, iParam9, iParam10, iParam11, uParam12, iParam13, uParam14, uParam15, bParam16, uParam17, bParam18);
}}
...
if(func_464(&(uParam0->f_2)) * 1000f) > to_float(uParam0->f_1){
...
uParam0->f_563=func_49((uParam0->f_563 + (((1f / 0.3f) * uParam0->f_577) * timestep())), 0f, 1f);
uParam0->f_577=func_49((uParam0->f_577 + 0.07f), 0.75f, 1.15f);
}}else{
uParam0->f_563=func_49((uParam0->f_563 - ((((1f / 0.3f) * uParam0->f_577) * 0.01f) * timestep())), 0f, 1f);
uParam0->f_577=func_49((uParam0->f_577 + 0.07f), 0.75f, 1.15f);
}
...
func_71();
GRAPHICS::DRAW_RECT(0.5f, (fVar1 - (func_74((2f - 0.5f)) - 0.001388889f)), fVar6, func_65(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), 0);
}else{
return;
}
...
func_62(uParam0, iVar17, (fVar1 + func_74(2f)), fVar9, fVar10, round((IntToFloat(iVar0) * fVar12)));
}else{
return;
}
...
fVar12=func_49((fVar11 / (0.6f * func_74(25f))), 0f, 1f);
func_71();
GRAPHICS::DRAW_RECT(0.5f, (fVar1 + func_74((2f * 0.5f))), fVar6, func_65(1f), iVar13, iVar14, iVar15, round((fVar12 * IntToFloat(iVar16))), 0);
fVar1=(fVar1 + func_74((2f * 0.3f)));
if(uParam0->f_56 > 0){
fVar1=(fVar1 + func_74((25f * 0.2f)));
}}}}
...
func_563(uParam0, uParam1, iParam2, iParam3, iParam4, iParam5, &uParam6, uParam7, iParam8, iParam9, iParam10, uParam11, iParam12, uParam13, uParam14, bParam15, uParam16, bParam17);
}
...
*iParam9=0;
func_214(uParam1, 0, 215, "BJ_CONTINUE", 216, "BJ_RETRY", 211, "HUD_INPUT68", 363, 0);
}}elseif(func_330(uParam3, 5, 1000)){
func_76(&(uParam1->f_26));
return 1;
}elseif(func_330(uParam3, 4, 1000)){
return 0;
}elseif((!*iParam9 && func_330(uParam3, 8, 1000)) && (!PLAYER::IS_PLAYER_ONLINE() || func_264(uParam1, 26))){
*iParam9=1;
if(PLAYER::IS_PLAYER_ONLINE()){
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*uParam0, "DRAW_INSTRUCTIONAL_BUTTONS");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(to_float(uParam0->f_2));
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(*uParam0, "SET_BACKGROUND_COLOUR");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(0f);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(0f);
...
iParam15=floor(func_108(to_float(iParam15)));
}else{
iParam15=floor(func_107(to_float(iParam15)));
}}
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("NUMBER");
HUD::ADD_TEXT_COMPONENT_INTEGER(iParam15);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
...
return floor(func_111(-fVar5, -fVar6, fVar7, 1));
}
...
}elseif(func_120(Var0) && Global_2097536.f_2704[bVar9] < 11){
...
func_186(&(uParam0->f_26), 3, "BJ_SC_ACC_RWD", "", round(((50f + (1.5f * IntToFloat(iParam4))) * fParam6)), 0, 0, 0);
...
Global_2097536.f_2780.f_29[1]=5;
Global_2097536.f_2780.f_29[2]=5;
}elseif(func_206(Global_4718592.f_171044)){
StringCopy(&(Global_2097536.f_2717[0 /*6*/]), "SCLB_C_SCORE", 24);
StringCopy(&(Global_2097536.f_2717[1 /*6*/]), "SCLB_C_DEATH", 24);
StringCopy(&(Global_2097536.f_2717[2 /*6*/]), "SCLB_C_RANK", 24);
Global_2097536.f_2710[0]=0;
...
if(MISC::IS_BIT_SET(Global_2097536.f_2769, Global_2097536.f_2710[bVar2])){
MISC::SET_BIT(&(Global_2097536.f_2770), bVar2);
}
bVar2++;
}
...
int func_204(struct<8> Param0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5){
char cVar0[64];
MemCopy(&cVar0,{
Param0
}
...
}}elseif(MISC::IS_BIT_SET(Global_113810.f_20567.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_229() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
func_254(13, floor(Global_113810.f_10197.f_3853));
}
...
fVar15=sqrt(((Var14.f_0 * Var14.f_0) + (Var14.f_1 * Var14.f_1)));
*fParam5=fVar15;
if((Var14.f_2 < 5f && Var14.f_2 > -2f) && fVar15 < 15f){
*uParam4=func_269(ceil(((100f * (15f - fVar15)) / 15f)) + 4, 0, 100);
*iParam3=1;
}else{
*iParam3=3;
}}
...
Var18={
ENTITY::GET_ENTITY_COORDS(iVar16, 1) 
};
}}
...
Var5.f_0=func_268((MISC::ABSF(Var5.f_0) - 1.305f), 0f);
if(Var5.f_1 >=0f){
...
if(func_339("BJ_FALLHLP") && Global_23251.f_135){
HUD::CLEAR_HELP(1);
...
Var4.f_2=0f;
fVar9=MISC::ABSF(func_276(Var4, Var3));
if(func_275(*iParam0)){
...
float fVar0;
fVar0=((1f - cos(func_274((fParam2 * 3.141593f)))) * 0.5f);
...
Var2={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - ENTITY::GET_ENTITY_COORDS((*uParam1)[iVar5], 1) 
};
...
Var2={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - ENTITY::GET_ENTITY_COORDS(uVar0[iVar5], 1) 
};
fVar3=((Var2.f_0 * Var2.f_0) + (Var2.f_1 * Var2.f_1));
if(Var2.f_2 * Var2.f_2) > (3f * fVar3){
bVar7=false;
...
*bParam30=0;
func_329(uParam2);
if(func_465(uParam24)){
func_461(uParam24);
}
if(func_465(uParam23)){
func_461(uParam23);
}
...
if(!func_328(*iParam9) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(*iParam9, -1, 0))){
...
func_287(*uParam6, func_327(bParam20), func_326(bParam20), 24, 0);
ENTITY::SET_ENTITY_VELOCITY(iVar0, 0f, 0f, 0f);
ENTITY::SET_ENTITY_COORDS(iVar0, func_327(bParam20), 1, 0, 0, 1);
...
func_312(iParam3, &Var0, Param1, uParam2, func_318(iParam0));
...
func_320(iParam0, &(Global_113810.f_32752.f_5510));
}

int func_290(int iParam0){
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_306(iParam0, 0, 0)) || func_306(iParam0, 1, 0)) || func_306(iParam0, 2, 0)) || func_318(iParam0) !=145) || func_305(iParam0)) || func_304(iParam0)) || func_303(iParam0)) || func_302(iParam0)) || !func_291(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_304(iParam0)){
}
if(func_304(iParam0)){
}
...
if(!func_319(Global_113810.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
if(!func_319(Global_113810.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
if(!func_319(Global_113810.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
int func_331(var uParam0, var uParam1, struct<3> Param2, struct<3> Param3, struct<3> Param4, var uParam5, var uParam6){
struct<3> Var0;
switch (uParam0->f_3){
case 0:
if(func_464(uParam1) >=0f){
Param4.f_2=func_49(Param4.f_2, -8.909f, 8.909f);
uParam5->f_2=(uParam5->f_2 + Param4.f_2);
Var0={
func_466(Param3, Param4.f_2) 
};
CAM::SET_CAM_PARAMS(func_436(uParam0, 0), Param2 + Var0, *uParam5, *uParam6, 300, 1, 1, 2);
CAM::SET_CAM_ACTIVE_WITH_INTERP(func_436(uParam0, 1), func_436(uParam0, 0), floor((1000f * (1.1f - 0f))), 2, 1);
uParam0->f_3=1;
}
break;
case 1:
...
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
CAM::RENDER_SCRIPT_CAMS(0, 1, floor((1000f * (1.1f - 0f))), 0, 0, 0);
uParam0->f_3=2;
}
break;
case 2:
if(func_464(uParam1) >=1.1f){
uParam0->f_3=3;
return 1;
}
break;
...
var uVar2;
struct<3> Var3;
uVar1=func_436(uParam1, 0);
uVar2=func_436(uParam1, 1);
CAM::SET_CAM_NEAR_CLIP(uVar2, func_333());
Var3={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam0, 2f, -0.3f, -7.7824f) 
};
CAM::SET_CAM_COORD(uVar2, Var3);
Var0={
CAM::GET_CAM_ROT(uVar1, 2) 
};
Var0.f_0=0f;
...
int func_334(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, struct<3> Param6, struct<3> Param7){
var uVar0;
struct<3> Var1;
struct<3> Var2;
uVar0=func_436(uParam1, 0);
Var1={
func_337(uParam2) 
};
...
Var2={
func_466(Param7, uParam4->f_2) 
};
CAM::SET_CAM_COORD(uVar0, Param6 + Var2);
CAM::SET_CAM_ROT(uVar0, (-33f + *uParam4), 0f, ((-88.515f + func_467(uParam0)) + uParam4->f_2), 2);
CAM::SET_CAM_NEAR_CLIP(uVar0, func_333());
if(!CAM::IS_SCREEN_FADED_IN() || !func_465(uParam3)){
func_373(uParam3);
}else{
if(!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_336("BJ_VLOOKHLP");
}
if(func_465(uParam3) && func_464(uParam3) > 0.5f){
...
float fVar1;
float fVar2;
fVar0=(0.006f * sin((((0.25f * 0.5f) * to_float(MISC::GET_GAME_TIMER())) + 1.5f)));
fVar1=(0.006f * sin((((0.25f * 0.4f) * to_float(MISC::GET_GAME_TIMER())) + 3f)));
fVar2=(0.006f * sin(((0.25f * 1f) * to_float(MISC::GET_GAME_TIMER()))));
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
...
struct<4> func_343(bool bParam0){
struct<4> Var0;
switch (bParam0){
case 3:
case 12:
...
if(func_465(uParam0)){
if(func_347(uParam0, (7.5f * IntToFloat(*iParam1)))){
*iParam1++;
...
int func_350(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, int iParam6, int iParam7, var uParam8, int iParam9, var uParam10, var uParam11, var uParam12, int iParam13, int iParam14, var uParam15, var uParam16, var uParam17, var uParam18, bool bParam19, bool bParam20, float fParam21){
struct<3> Var0;
var uVar1;
var uVar2;
struct<3> Var3;
...
Var9={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam1, func_372(uParam0)) 
};
...
GRAPHICS::DRAW_MARKER(6, Var9, 0f, 0f, 1f, 0f, 0f, 0f, 4f, 4f, 4f, 240, 200, 80, func_359(Var9, 170, 200), 0, 0, 2, 0, 0, 0, 0);
GRAPHICS::DRAW_MARKER(6, Var9, 0f, 0f, 1f, 0f, 0f, 0f, 9f, 9f, 9f, 240, 200, 80, func_359(Var9, 170, 200), 0, 0, 2, 0, 0, 0, 0);
GRAPHICS::DRAW_MARKER(6, Var9, 0f, 0f, 1f, 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_359(Var9, 170, 200), 0, 0, 2, 0, 0, 0, 0);
}
if(*iParam7 !=-1){
...
Var5={
func_371(uParam0, *iParam6 + 1) 
};
GRAPHICS::DRAW_MARKER(6, Var4, func_478(Var6), 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_359(Var4, 25, 200), 0, 0, 2, 0, 0, 0, 0);
if(*iParam7 !=*iParam6){
if(*iParam7 >=0){
GRAPHICS::DELETE_CHECKPOINT(*uParam4);
*uParam4=0;
...
*uParam4=GRAPHICS::CREATE_CHECKPOINT(17, Var4, Var5, 9f, uVar17, uVar18, uVar19, func_359(Var9, 25, ceil((200f * (to_float(113) / to_float(170))))), 0);
if(*iParam6 < (iParam9 - 2)){
*uParam5=GRAPHICS::CREATE_CHECKPOINT(17, Var5, func_371(uParam0, *iParam6 + 2), (9f * 0.5f), uVar17, uVar18, uVar19, func_359(Var9, 25, ceil((200f * (to_float(113) / to_float(170))))), 0);
}
*iParam7=*iParam6;
}
if(*iParam6 + 1==(iParam9 - 1)){
GRAPHICS::DRAW_MARKER(6, Var5, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 4f), (0.5f * 4f), (0.5f * 4f), 240, 200, 80, func_359(Var5, 170, 200), 0, 0, 2, 0, 0, 0, 0);
GRAPHICS::DRAW_MARKER(6, Var5, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 9f), (0.5f * 9f), (0.5f * 9f), 240, 200, 80, func_359(Var5, 170, 200), 0, 0, 2, 0, 0, 0, 0);
GRAPHICS::DRAW_MARKER(6, Var5, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 14f), (0.5f * 14f), (0.5f * 14f), 240, 200, 80, func_359(Var5, 170, 200), 0, 0, 2, 0, 0, 0, 0);
}else{
GRAPHICS::DRAW_MARKER(6, Var5, func_478(Var3 - Var5), 0f, 0f, 0f, (0.5f * 14f), (0.5f * 14f), (0.5f * 14f), 240, 200, 80, func_359(Var5, 25, 200), 0, 0, 2, 0, 0, 0, 0);
}
if(*uParam4 !=0){
GRAPHICS::SET_CHECKPOINT_RGBA(*uParam4, uVar17, uVar18, uVar19, func_359(Var4, 25, ceil((200f * (to_float(113) / to_float(170))))));
}
if(*uParam5 !=0){
GRAPHICS::SET_CHECKPOINT_RGBA(*uParam5, uVar17, uVar18, uVar19, func_359(Var5, 25, ceil((200f * (to_float(113) / to_float(170))))));
}}
if(!bParam19){
return 0;
}
...
if(iLocal_510){
func_357(Var4, uParam15, uParam16, uParam17);
if(func_465(&uLocal_512)){
func_461(&uLocal_512);
}}elseif(func_465(&uLocal_512)){
if(func_355(&uLocal_512) > 0.5f){
func_461(&uLocal_512);
iLocal_510=1;
}}else{
func_489(&uLocal_512);
...
fVar12=sqrt(((Var6.f_0 * Var6.f_0) + (Var6.f_1 * Var6.f_1)));
if(((Var6.f_2 < 5f && Var6.f_2 > -2f) && fVar12 < 15f) || func_267(iParam1, iParam2)){
*uParam10=func_269(ceil(((100f * (15f - fVar12)) / 15f)) + 4, 0, 100);
return 1;
}else{
return 3;
}}elseif(func_353()){
...
if(fVar11 < (10f * 10f)){
bVar16=true;
}elseif(func_276(Var0, -Var6 / FtoV(sqrt(fVar11))) < 0.08f){
bVar16=true;
}
if(bVar16){
*uParam8++;
func_352(iParam13, 1);
func_223(func_431(), 1, floor((30f * fParam21)), 0, 0);
iLocal_511=0;
}
...
Var7={
-Var6.f_0, -Var6.f_1, 0f 
};
Var7={
func_478(Var7) 
};
fVar13=((Var3.f_2 - 32f) + (32f * func_351(Var8, Var7)));
fVar12=sqrt(((Var6.f_0 * Var6.f_0) + (Var6.f_1 * Var6.f_1)));
...
if(*iParam6 < (iParam9 - 1)){
if(!HUD::DOES_BLIP_EXIST(*uParam12)){
*uParam12=HUD::ADD_BLIP_FOR_COORD(func_371(uParam0, *iParam6 + 1));
...
float func_351(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3){
...
bool func_354(var uParam0, var uParam1, int iParam2){
int iVar0;
int iVar1;
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
return 1;
...
void func_357(struct<3> Param0, var uParam1, var uParam2, var uParam3){
var uVar0;
var uVar1;
float fVar2;
float fVar3;
...
void func_358(struct<3> Param0, var uParam1, var uParam2){
float fVar0;
float fVar1;
struct<3> Var2;
...
int func_359(struct<3> Param0, int iParam1, int iParam2){
float fVar0;
int iVar1;
float fVar2;
float fVar3;
...
if(func_465(uParam0) && func_464(uParam0) > 7.5f){
func_461(uParam0);
}}

int func_361(var uParam0, bool bParam1, var uParam2){
int iVar0;
struct<3> Var1;
struct<3> Var2;
float fVar3;
...
return 0;
}elseif(!MISC::GET_GROUND_Z_FOR_3D_COORD(ENTITY::GET_ENTITY_COORDS(iVar0, 1), &fVar3, 0, 0)){
return 0;
}elseif(Var1.f_2 >=(fVar3 + 1.5f)){
return 0;
}}
if(ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())){
return 0;
}elseif(!MISC::GET_GROUND_Z_FOR_3D_COORD(Var1, &fVar3, 0, 0)){
return 0;
}elseif(Var1.f_2 >=(fVar3 + 1.5f)){
return 0;
}
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_476(bParam1)) > 3600f){
*uParam2=1;
return 1;
}}
return 0;
...
Vector3 func__371(var uParam0, int iParam1){
...
int func_381(var uParam0, bool bParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9, var uParam10, var uParam11, var uParam12){
if(CAM::IS_CAM_INTERPOLATING(func_436(uParam3, 1))){
func_373(uParam5);
}
if(!*uParam10){
if(func_465(uParam7) && func_464(uParam7) >=func_402(uParam0)){
func_364(iParam2, 0);
func_461(uParam7);
*uParam10=1;
...
if(func_465(uParam5) && func_464(uParam5) > 0.2f){
func_461(uParam5);
func_461(uParam6);
return 1;
}
if(!func_465(uParam6)){
func_489(uParam6);
}elseif((uParam12 && CAM::IS_SCREEN_FADED_IN()) || (func_464(uParam6) > 0.5f && func_335(uParam4, 2))){
*uParam11=1;
func_461(uParam5);
func_461(uParam6);
return 1;
...
func_461(uParam8);
}elseif(func_464(uParam8) > func_429(bParam1, iParam9)){
switch (iParam9){
case 0:
...
struct<6> Var0;
int iVar1;
iVar1=Global_113810.f_18970;
func_383(Var0, 0, 0, 0, 0, iVar1);
}


void func_383(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_386(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
break;
default:
StringCopy(&Var0, func_387(iVar1), 8);
break;
}
break;
default:
...
int func_397(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6){
...
int func_403(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6){
...
int func_404(char* sParam0, int iParam1, bool bParam2){
Global_21846=0;
...
var func__408(int iParam0, int iParam1){
...
void func_417(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5){
Global_21299={
*uParam0 
};
Global_7686=iParam1;
...
var func__418(var uParam0){
return uParam0->f_4;
}


void func_419(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, var uParam6, var uParam7){
var uVar0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
uVar0=func_436(uParam0, 0);
if(ENTITY::DOES_ENTITY_EXIST(iParam5) && !ENTITY::IS_ENTITY_DEAD(iParam5, 0)){
*uParam2={
10.2986f, 0f, 8.909f 
};
*uParam4={
Vector(1.2f, 1.2f, 1.2f) * Vector(0f, -cos((-97.4239f + func_467(uParam1))), sin((-97.4239f + func_467(uParam1)))) 
};
*uParam3={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iParam5, 1.12046f, -0.317773f, 1.3385f) 
};
Var1={
func_466(*uParam4, uParam2->f_2) 
};
Var3={
*uParam3 + Var1 
};
*uParam6={
(-33f + *uParam2), 0f, (-88.515f + func_467(uParam1)) 
};
*uParam7=26f;
Var2={
*uParam6 
...
void func_420(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6){
if(bParam0){
...
float func_429(bool bParam0, int iParam1){
switch (bParam0){
case 3:
switch (iParam1){
case 0:
...
if(func_39(iVar0) && (!func_253(14) || Global_112760)){
...
Vector3 func__435(bool bParam0){
switch (bParam0){
case 5:
...
void func_438(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, var uParam7, int iParam8, var uParam9, int iParam10, int iParam11, var uParam12, bool bParam13, int iParam14){
int iVar0;
int iVar1;
struct<3> Var2;
int iVar3;
...
if(func_434(func_460(uParam0))){}else{
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(func_460(uParam0), func_459(uParam0), 0, 1);
}
iVar3=0;
while (iVar3 < 12){
if(!func_434(func_371(uParam0, iVar3))){
*uParam2=iVar3 + 1;
}else{
iVar3=999999;
}
...
ENTITY::SET_ENTITY_COORDS(*iParam3, func_476(bParam13), 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(*iParam3, func_467(uParam0));
}else{
*iParam3=VEHICLE::CREATE_VEHICLE(iVar0, func_476(bParam13), func_467(uParam0), 1, 1, 0);
}
if(func_468(iVar0)){
...
}elseif(func_452(PLAYER::PLAYER_PED_ID(), *iParam3)==1){
ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), 0);
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam3, 2);
}}
...
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_476(bParam13), 1, 0, 0, 1);
...
MISC::CLEAR_AREA(func_371(uParam0, 0), 100f, 1, 0, 0, 0);
...
*iParam4=VEHICLE::CREATE_VEHICLE(iVar0, func_371(uParam0, 0), func_443(uParam0), 1, 1, 0);
if(func_442(func_370(uParam0))){
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*iParam4, 11);
}elseif(func_441(func_370(uParam0))){
...
ENTITY::SET_ENTITY_COORDS(*iParam4, func_371(uParam0, 0), 1, 0, 0, 1);
...
*iParam6=VEHICLE::CREATE_VEHICLE(joaat("trflat"), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(*iParam4, 0f, -10f, 0f), func_443(uParam0), 1, 1, 0);
...
func_440(*uParam9, bParam13);
if(bParam13==0){
func_439(uParam1, 2, *uParam9, "EX3MERC1", 0, 1);
}}else{
...
*uParam1=VEHICLE::CREATE_VEHICLE(func_447(uParam0), func_446(uParam0), func_445(uParam0), 1, 1, 0);
}elseif(ENTITY::IS_ENTITY_DEAD(*uParam1, 0)){
VEHICLE::DELETE_VEHICLE(uParam1);
*iParam1=VEHICLE::CREATE_VEHICLE(func_447(uParam0), func_446(uParam0), func_445(uParam0), 1, 1, 0);
}else{
...
int iVar2;
if(ENTITY::DOES_ENTITY_EXIST(*uParam1)){
if(!func_328(*uParam1) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(*uParam1, -1, 0))){
...
iVar2=VEHICLE::CREATE_VEHICLE(func_534(uParam0), func_450(uParam0), func_449(uParam0), 1, 1, 0);
}else{
ENTITY::SET_ENTITY_COORDS(iVar2, func_450(uParam0), 1, 0, 0, 1);
...
var func__449(var uParam0){
return uParam0->f_78;
}


Vector3 func__450(var uParam0){
return uParam0->f_70;
}
...
void func_456(var uParam0, int iParam1, char* sParam2){
int iVar0;
iVar0=0;
if(!PED::IS_PED_INJURED(iParam1)){
func_439(uParam0, iVar0, iParam1, sParam2, 1, 1);
...
int func_462(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4, bool bParam5){
char cVar0[64];
if(!func_468(func_469(bParam3))){
STREAMING::REQUEST_ADDITIONAL_COLLISION_AT_COORD(func_476(bParam3));
}
if(func_465(uParam1)){
if(func_464(uParam1) >=5f){
return 1;
}}else{
func_344(uParam1, 0f);
}
...
Vector3 func__466(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
void func_470(var uParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6){
int iVar0;
int iVar1;
func_26(1);
...
if(CAM::IS_SCREEN_FADED_OUT()){
MISC::CLEAR_AREA(func_476(bParam1), 5000f, 1, 0, 0, 0);
}
...
if(CAM::IS_SCREEN_FADED_OUT()){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_476(bParam0), 15f, 15f, 15f, 0, 1, 0)){
return 1;
}
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_476(bParam0), 0, 0, 0, 1);
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_476(bParam0), 15f, 15f, 15f, 0, 1, 0)){
return 1;
}}
return 0;
...
Vector3 func__479(bool bParam0){
switch (bParam0){
case 0:
...
void func_480(var uParam0, var uParam1, bool bParam2, bool bParam3){
struct<3> Var0;
struct<3> Var1;
var uVar2;
struct<3> Var3;
...
uVar2=func_486(uParam1);
if(!CAM::DOES_CAM_EXIST(func_436(uParam0, 0))){
func_485(uParam0, 0, CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var0, Var1, 1115815936, 0, 2), 1);
}else{
CAM::SET_CAM_COORD(func_436(uParam0, 0), Var0);
CAM::SET_CAM_ROT(func_436(uParam0, 0), Var1, 2);
}
CAM::SET_CAM_FOV(func_436(uParam0, 0), uVar2);
CAM::SET_CAM_ACTIVE(func_436(uParam0, 0), 1);
if(bParam3){
Var3={
Var0 
};
Var3.f_2=(Var3.f_2 + 8f);
CAM::SET_CAM_PARAMS(func_436(uParam0, 0), Var3, Var1, fVar2, func_484(bParam2), 1, 1, 2);
}
Var0={
func_483(uParam1) 
};
...
fVar2=func_481(uParam1);
if(!CAM::DOES_CAM_EXIST(func_436(uParam0, 1))){
func_485(uParam0, 1, CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var0, Var1, 1115815936, 0, 2), 1);
}else{
CAM::SET_CAM_COORD(func_436(uParam0, 1), Var0);
CAM::SET_CAM_ROT(func_436(uParam0, 1), Var1, 2);
}
CAM::SET_CAM_FOV(func_436(uParam0, 1), fVar2);
if(!CAM::IS_SCREEN_FADED_OUT()){
...
var func__481(var uParam0){
return uParam0->f_82;
}


Vector3 func__482(var uParam0){
return uParam0->f_58;
}


Vector3 func__483(var uParam0){
return uParam0->f_55;
}
...
void func_485(var uParam0, int iParam1, var uParam2, int iParam3){
if(iParam1 >=2){
return;
}
...
void func_490(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
if(func_309(&(Global_77479.f_555[0 /*21*/]), iVar0)){
...
if(iParam0 < 0 || iParam0 >=func_493(&(Global_113810.f_32752.f_5038[iVar0 /*157*/]))){
return 0;
}
return func_292(Global_113810.f_32752.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}
...
}}}}elseif(iParam1==10 && !func_264(uParam0, 23)){
func_507(func_509(bParam2, 22), &(uParam0->f_607), 23);
}elseif(!func_264(uParam0, 23) && !PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
AUDIO::STOP_AUDIO_SCENES();
}}}


void func_507(char* sParam0, var uParam1, bool bParam2){
if(!MISC::IS_BIT_SET(*uParam1, bParam2)){
AUDIO::STOP_AUDIO_SCENE(sParam0);
MISC::SET_BIT(uParam1, bParam2);
}}

int func_508(char* sParam0, char* sParam1, var uParam2, bool bParam3){
...
}elseif(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_367(ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))){
...
if(func_512(func_513(12), &(uParam0->f_607), 12)){
func_511(func_513(16), &(uParam0->f_607), 16);
}}}elseif(iParam1==10 && !func_264(uParam0, 17)){
...
int func_512(char* sParam0, var uParam1, bool bParam2){
if(!MISC::IS_BIT_SET(*uParam1, bParam2)){
if(AUDIO::PREPARE_MUSIC_EVENT(sParam0)){
MISC::SET_BIT(uParam1, bParam2);
return 1;
...
func_521(&uVar1, &uVar2, &iVar3, &iVar4, PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()), PAD::IS_USING_KEYBOARD_AND_MOUSE(2));
...
void func_521(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, int iParam5){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
return (shift_right(iParam0, 26) & 31 * func_529(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_529(bool bParam0, int iParam1, int iParam2){
if(bParam0){
return iParam1;
}
return iParam2;
...
func_551(uParam0, 0f);
func_550(uParam0, 0, -1039.712f, -1731.145f, 1f);
...
func_542(uParam0, -1151.402f, -1864.369f, 214.9385f);
...
func_550(uParam0, 3, 2273.787f, 1885.168f, 152.702f);
func_550(uParam0, 4, 2111.912f, 1887.456f, 92.5308f);
func_549(uParam0, 0f);
func_548(uParam0, 0f, 0f, 0f);
...
func_542(uParam0, 2038.807f, 1971.563f, 591.7618f);
...
func_556(uParam0, 402.6013f, 5736.451f, 696.3928f);
...
func_542(uParam0, 409.9299f, 5701.477f, 696.7185f);
...
func_552(uParam0, -1310.948f, 4330.126f, 7.2444f);
...
func_542(uParam0, -1242.731f, 4536.298f, 186.6862f);
...
func_552(uParam0, 0f, 0f, 0f);
func_551(uParam0, 0f);
func_550(uParam0, 0, -487.5452f, 4252.192f, 87.712f);
...
func_542(uParam0, -337.5233f, 4110.16f, 315.6679f);
...
func_552(uParam0, 0f, 0f, 0f);
func_551(uParam0, 0f);
func_550(uParam0, 0, -1154.443f, 204.1726f, 64.4915f);
func_549(uParam0, 0f);
func_548(uParam0, 0f, 0f, 0f);
if(iVar0==0){
...
func_554(uParam0, 0f);
func_553(uParam0, joaat("blazer"));
func_552(uParam0, -818.3042f, 4405.675f, 20.1095f);
...
func_550(uParam0, 5, -1063.995f, 4246.137f, 163.291f);
func_550(uParam0, 6, -938.541f, 4360.14f, 82.372f);
func_550(uParam0, 7, -828.1418f, 4413.562f, 20.062f);
func_549(uParam0, 0f);
func_548(uParam0, 0f, 0f, 0f);
...
func_542(uParam0, -1286.976f, 3660.137f, 1082.208f);
...
func_550(uParam0, 9, 2473.344f, 4715.347f, 33.524f);
func_549(uParam0, 0f);
func_548(uParam0, 0f, 0f, 0f);
...
func_542(uParam0, 1012.673f, 3960.436f, 1367.701f);
...
func_552(uParam0, 1280.933f, -50.6157f, 61.8195f);
...
func_542(uParam0, 1628.156f, -431.2605f, 1332.761f);
...
func_554(uParam0, 0f);
func_553(uParam0, joaat("sanchez"));
func_552(uParam0, -885.2659f, 4433.592f, 20.381f);
func_551(uParam0, 104.35f);
func_550(uParam0, 0, -771.9196f, 4400.453f, 60.5786f);
...
void func_548(var uParam0, struct<3> Param1){
uParam0->f_6={
Param1 
};
}
...
void func_550(var uParam0, int iParam1, struct<3> Param2){
if(iParam1 < 0 || iParam1 >=12){
return;
}
...
void func_552(var uParam0, struct<3> Param1){
uParam0->f_9={
Param1 
};
}
...
void func_556(var uParam0, struct<3> Param1){
uParam0->f_70={
Param1 
};
}
...
void func_563(var uParam0, var uParam1, int iParam2, var uParam3, int iParam4, var uParam5, var uParam6, var uParam7, int iParam8, var uParam9, var uParam10, var uParam11, int iParam12, var uParam13, var uParam14, int iParam15, var uParam16, bool bParam17){
int iVar0;
int iVar1;
int iVar2;
func_378();
...
VEHICLE::SET_PLAYERS_LAST_VEHICLE(*uParam6);
func_287(*uParam6, func_327(iParam15), func_326(iParam15), 24, 0);
}
