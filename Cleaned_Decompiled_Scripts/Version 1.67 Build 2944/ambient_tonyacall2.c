...
if(vdist2(Local_42, Local_41) > fLocal_40){
func_33();
}
switch (iLocal_35){
case 0:
...
if(!ENTITY::IS_ENTITY_DEAD(uLocal_36, 0)){
Var1={
ENTITY::GET_ENTITY_COORDS(uLocal_36, 1) 
};
}else{
Var1={
...
if((vdist2(Var0, Var1) > 10000f || ENTITY::IS_ENTITY_DEAD(uLocal_36, 0)) || func_27()){
return 1;
}
switch (iLocal_38){
case 0:
if(ENTITY::DOES_ENTITY_EXIST(uLocal_36) && !ENTITY::IS_ENTITY_DEAD(uLocal_36, 0)){
if(ENTITY::IS_ENTITY_AT_COORD(uLocal_36, Local_47, 1f, 1f, 1f, 0, 1, 0)){
TASK::CLEAR_SEQUENCE_TASK(&uVar3);
TASK::OPEN_SEQUENCE_TASK(&uVar3);
TASK::TASK_ACHIEVE_HEADING(0, fLocal_48, 0);
...
TASK::TASK_PERFORM_SEQUENCE(uLocal_36, uVar3);
TASK::CLEAR_SEQUENCE_TASK(&uVar3);
iLocal_38=1;
}}
break;
case 1:
if(ENTITY::DOES_ENTITY_EXIST(uLocal_36) && !ENTITY::IS_ENTITY_DEAD(uLocal_36, 0)){
if(TASK::GET_SEQUENCE_PROGRESS(uLocal_36)==1){
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_37)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_36, "amb@world_human_stand_mobile@female@standing@call@enter", "enter", 3)){
fVar4=ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_36, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
if(fVar4 >=0.157f){
uLocal_37=OBJECT::CREATE_OBJECT(joaat("prop_phone_ing"), 1f, 1f, 1f, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_37, uLocal_36, PED::GET_PED_BONE_INDEX(uLocal_36, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1, 0);
}
}}}elseif(TASK::GET_SEQUENCE_PROGRESS(uLocal_36)==2){
iVar2=(MISC::GET_RANDOM_INT_IN_RANGE(0, 65535) % 2);
if(iVar2==0){
if(func_4(&uLocal_51, "TOWAUD", "TONYA_CALL3", 8, 0, 0, 0)){
iLocal_38=2;
}}elseif(func_4(&uLocal_51, "TOWAUD", "TONYA_CALL4", 8, 0, 0, 0)){
iLocal_38=2;
}}}
break;
case 2:
...
if(TASK::GET_SEQUENCE_PROGRESS(uLocal_36)==1){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_37)){
OBJECT::DELETE_OBJECT(&uLocal_37);
TASK::TASK_LOOK_AT_ENTITY(uLocal_36, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
}}}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_36) && !ENTITY::IS_ENTITY_DEAD(uLocal_36, 0)){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_37)){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_36, joaat("script_task_start_scenario_in_place"))==1){
OBJECT::DELETE_OBJECT(&uLocal_37);
}}}}
...
int func_27(){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(uLocal_36, 0)){
if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_36) || PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_37)){
ENTITY::DETACH_ENTITY(uLocal_37, 1, 1);
}
AUDIO::STOP_SCRIPTED_CONVERSATION(0);
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_36, joaat("script_task_smart_flee_ped")) !=1){
PED::SET_PED_KEEP_TASK(uLocal_36, 1);
TASK::TASK_SMART_FLEE_PED(uLocal_36, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
return 1;
}}}
return 0;
}
...
PED::GET_CLOSEST_PED(Var0, fLocal_39, 1, 1, &uVar1, 0, 1, -1);
...
PED::SET_PED_NAME_DEBUG(uLocal_36, "TONYA");
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_36, joaat("player"));
func_31(&uLocal_51, 3, uLocal_36, "TONYA", 1, 1);
func_30();
if(!func_29(Local_47)){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_36, joaat("script_task_follow_nav_mesh_to_coord")) !=1){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_36, Local_47, 1f, -1, 0.25f, 0, fLocal_48);
PED::SET_PED_KEEP_TASK(uLocal_36, 1);
}
return 1;
}}}
...
if(func_29(Local_47)){
fLocal_49=vdist(Var0, Local_43);
fLocal_50=vdist(Var0, Local_45);
...
if(ENTITY::IS_ENTITY_OCCLUDED(uLocal_36)){
PED::DELETE_PED(&uLocal_36);
}else{
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_36);
}}
SCRIPT::TERMINATE_THIS_THREAD();
}