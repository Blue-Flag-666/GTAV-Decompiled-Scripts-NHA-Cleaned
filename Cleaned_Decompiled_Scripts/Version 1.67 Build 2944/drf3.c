...
iLocal_46=2;
}}elseif(func_76(iLocal_1259, &uLocal_72, 36, "DrfAud", &uLocal_237, &uLocal_285, "SHRINK_CELL_Q", 9, 1, 0, 0, 0)){
...
fVar3=0f;
if(!func_5(Global_113810.f_18536[iVar0], &Var2, &fVar3)){
...
return (func_67(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return uParam0->f_1;
}
...
uParam0->f_1=(func_67(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
Var1={
func_117(iParam11, &uVar2, &uVar3, 1) 
};
iVar0=func_116(&Var1);
...
Var0={
func_94(uParam6, &iVar2, iParam7, 1) 
};
...
if(bParam3){
func_95(&(Global_113810.f_19964), iVar1, 1);
}
...
iVar2[iParam0]=0;
}elseif((iParam1 > 0 && iParam1 < 13) && !func_100(&(Global_113810.f_19964), iParam1)){
iVar2[iParam1]=0;
}elseif((iParam2 > 0 && iParam2 < 13) && !func_100(&(Global_113810.f_19964), iParam2)){
iVar2[iParam2]=0;
}elseif((iParam3 > 0 && iParam3 < 13) && !func_100(&(Global_113810.f_19964), iParam3)){
iVar2[iParam3]=0;
}elseif((iParam4 > 0 && iParam4 < 13) && !func_100(&(Global_113810.f_19964), iParam4)){
iVar2[iParam4]=0;
}
...
int iVar4;
bool bVar5;
if((((!func_110(&(Global_113810.f_19964), 8) && iParam1) && iParam0 !=4) && func_108(3) > 0) && MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.75f){
bVar1=8;
*uParam3=4;
}else{
...
if(bParam2){
func_106(&(Global_113810.f_19964), bVar1, 1);
}
...
int iVar2;
Var0={
func_117(iParam3, &iVar1, &iVar2, 1) 
};
