...
bLocal_335=true;
sLocal_337="MP_INTRO_MCS_13";
func_260(ScriptParam_348);
while (true){
func_259();
if(func_252()){
func_248();
...
func_19();
}elseif(HUD::DOES_BLIP_EXIST(Global_1935835)){
func_12();
HUD::SET_BLIP_ROUTE(Global_1935835, 0);
HUD::REMOVE_BLIP(&Global_1935835);
if(MISC::IS_BIT_SET(uLocal_336, 3)){
...
if(NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT()){
if(iLocal_162==0){
MISC::CLEAR_BIT(&uLocal_336, false);
MISC::SET_BIT(&uLocal_336, true);
if(Local_86.f_2 !=-1){
...
MISC::CLEAR_BIT(&uLocal_336, true);
}
if(func_4(iVar1, 0, 1)){
if(MISC::IS_BIT_SET(Local_163[iLocal_162 /*3*/].f_2, 1)){
MISC::SET_BIT(&uLocal_336, 12);
if(Local_86.f_2==-1){
if(Local_86.f_2 !=iLocal_162){
Local_86.f_2=iLocal_162;
}}}elseif(Local_86.f_2==iLocal_162){
Local_86.f_2=-1;
}}}
iLocal_162++;
if(iLocal_162==32){
if(MISC::IS_BIT_SET(uLocal_336, 1)){
MISC::SET_BIT(&(Local_86.f_1), false);
}
if(!MISC::IS_BIT_SET(uLocal_336, 12)){
if(Local_86.f_2 !=-1){
Local_86.f_2=-1;
}}
MISC::SET_BIT(&uLocal_336, false);
iLocal_162=0;
}}}
...
case 0:
if(!MISC::IS_BIT_SET(uLocal_336, 2)){
if(!MISC::IS_BIT_SET(uLocal_336, 5)){
if(!func_239()){
if(!func_238()){
if(!func_236()){
...
if(HUD::DOES_BLIP_EXIST(Global_1935835)){
if(!MISC::IS_BIT_SET(uLocal_336, 14)){
if(Local_86.f_2 !=-1){
if(Local_86.f_2 !=NETWORK::PARTICIPANT_ID_TO_INT()){
HUD::SET_BLIP_COLOUR(Global_1935835, 39);
HUD::SET_BLIP_SCALE(Global_1935835, 0.7f);
MISC::SET_BIT(&uLocal_336, 14);
}}
}
elseif(Local_86.f_2==-1 || Local_86.f_2==NETWORK::PARTICIPANT_ID_TO_INT()){
HUD::SET_BLIP_COLOUR(Global_1935835, 0);
HUD::SET_BLIP_SCALE(Global_1935835, 1f);
MISC::CLEAR_BIT(&uLocal_336, 14);
}}
if(MISC::IS_BIT_SET(uLocal_336, 8)){
MISC::CLEAR_BIT(&uLocal_336, 8);
}
if(func_201()){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if((bLocal_334 && CUTSCENE::HAS_CUTSCENE_LOADED()) || !bLocal_334){
...
MISC::SET_BIT(&uLocal_336, 25);
MISC::CLEAR_AREA(1274.854f, -1721.154f, 53.6808f, 2f, 1, 0, 0, 1);
if(bLocal_335){
func_197();
uLocal_344=GRAPHICS::REQUEST_SCALEFORM_MOVIE("SECURITY_CAM");
}
Local_163[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1=1;
}
elseif(Local_86.f_2 !=-1){
if(!MISC::IS_BIT_SET(uLocal_336, 13)){
if(func_191(1, 1, 1, 1)){
func_190("FM_LCUT_LRB", -1);
MISC::SET_BIT(&uLocal_336, 13);
}
}
}}}
}
...
if(!MISC::IS_BIT_SET(uLocal_336, 9)){
if(func_191(0, 1, 1, 1)){
if(!func_229()){
...
HUD::SET_BLIP_FLASHES(Global_1935835, 1);
...
if(!func_188(&uLocal_339)){
func_7(&uLocal_339, 0, 0);
}elseif(func_187(&uLocal_339, 10, 0)){
MISC::CLEAR_BIT(&uLocal_336, 5);
...
if(func_25()==0){
return MISC::IS_BIT_SET(func_88(func_24(iParam0), -1), iParam1);
}}else{
...
var func__32(var uParam0, var uParam1){
return unk_0xD69CE161FE614531(2, uParam0, func_33(uParam1));
}
...
uVar0=func_48(0);
if(Global_262145.f_63==1 && func_50(135, 0, 0)){
bParam0=true;
}
...
var func__53(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
return unk_0xD69CE161FE614531(0, iParam0, func_33(uParam1));
}
...
switch (iLocal_164){
case 0:
if(!MISC::IS_BIT_SET(uLocal_336, 18)){
if(!PED::IS_PED_INJURED(uLocal_165)){
uLocal_338=HUD::ADD_BLIP_FOR_ENTITY(uLocal_165);
HUD::SET_BLIP_AS_FRIENDLY(uLocal_338, 1);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_338, "FM_LEST_BLP");
func_139("FM_LEST_GTL", 0);
MISC::SET_BIT(&uLocal_336, 18);
}}
if(!MISC::IS_BIT_SET(uLocal_336, 20)){
...
uLocal_168=PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_165, uLocal_168, "missfinale_c2leadinoutfin_c_int", "_LEADIN_ACTION_LESTER", 1000f, -8f, 5, 16, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_167, uLocal_168, "_LEADIN_ACTION_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, 8f, 4, 1148846080);
MISC::SET_BIT(&uLocal_336, 20);
}}}}
if(!MISC::IS_BIT_SET(uLocal_336, 3)){
CUTSCENE::REQUEST_CUTSCENE(sLocal_337, 8);
MISC::SET_BIT(&uLocal_336, 3);
}elseif(!MISC::IS_BIT_SET(uLocal_336, 10)){
...
if(MISC::IS_BIT_SET(uLocal_336, 10)){
iLocal_164++;
}}}
break;
case 1:
...
if(MISC::IS_BIT_SET(uLocal_336, 25)){
PLAYER::SET_PLAYER_INVINCIBLE(PLAYER::PLAYER_ID(), 0);
}
if(iLocal_341 !=0){
INTERIOR::UNPIN_INTERIOR(iLocal_341);
}
MISC::CLEAR_BIT(&(Local_163[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), true);
func_91();
iLocal_164++;
...
if(!MISC::IS_BIT_SET(uLocal_336, 11)){
...
if(!MISC::IS_BIT_SET(uLocal_336, 26)){
if(iLocal_164 > 2){
...
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
MISC::SET_BIT(&uLocal_336, 26);
}}}}
if(MISC::IS_BIT_SET(uLocal_336, 19)){
...
}elseif(!func_96(PLAYER::PLAYER_ID(), 0)){
...
if(!func_187(&(Global_2803715[bParam0 /*2*/]), 3500, 1) || NETWORK::NETWORK_IS_PLAYER_FADING(bParam0)){
if(!func_99()){
if(CAM::IS_SCREEN_FADED_OUT()){
func_98(&(Global_2803715[bParam0 /*2*/]), 1, 0);
}elseif(!func_96(bParam0, 0)){
...
func_186(&(Global_2803715[bParam0 /*2*/]));
...
void func_109(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6){
if(bParam0){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_102(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
HUD::REMOVE_BLIP(&uLocal_338);
}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_165)){
uVar0=uLocal_165;
ENTITY::DELETE_ENTITY(&uVar0);
}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_167)){
uVar0=uLocal_167;
ENTITY::DELETE_ENTITY(&uVar0);
}
func_12();
...
}elseif(bVar14 || ((!func_96(PLAYER::PLAYER_ID(), 0) && !func_103()) && !func_102(PLAYER::PLAYER_ID()))){
...
if(!func_133(uVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar27)){
if(!bVar22){
...
func_135(joaat("mpply_is_char_spectating"), iParam0);
}}
...
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_344) && func_197()){
func_178();
func_177();
...
func_171(1, 1, 0, 1);
if(!PED::IS_PED_INJURED(uLocal_166)){
MISC::CLEAR_AREA(1273.885f, -1718.004f, 53.7715f, 3f, 1, 0, 0, 0);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_166);
ENTITY::SET_ENTITY_COORDS(uLocal_166, 1275.256f, -1722.368f, 53.655f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(uLocal_166, 12.6638f);
PED::FORCE_PED_MOTION_STATE(uLocal_166, joaat("MotionState_Walk"), 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
WEAPON::SET_CURRENT_PED_WEAPON(uLocal_166, joaat("weapon_unarmed"), 1);
}
uLocal_345=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 0);
CAM::SET_CAM_ACTIVE(uLocal_345, 1);
CAM::SET_CAM_PARAMS(uLocal_345, 1276.409f, -1719.918f, 56.1054f, -29.932f, 0f, 137.9132f, 50f, 0, 1, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_344, "SET_DETAILS");
func_170("FM_LEST_CAM");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_344, "SET_LOCATION");
func_170("FM_LEST_CAM2");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
if(GRAPHICS::GET_TIMECYCLE_MODIFIER_INDEX()==-1){
GRAPHICS::SET_TIMECYCLE_MODIFIER("scanline_cam");
}
MISC::SET_BIT(&uLocal_336, 15);
func_7(&uLocal_346, 0, 0);
...
case 1:
if(!PED::IS_PED_INJURED(uLocal_166)){
if(!MISC::IS_BIT_SET(uLocal_336, 21)){
if(func_187(&uLocal_346, 1000, 0)){
TASK::TASK_LOOK_AT_COORD(uLocal_166, 1276.409f, -1719.918f, 56.1054f, -1, 0, 2);
MISC::SET_BIT(&uLocal_336, 21);
}}}
if(func_187(&uLocal_346, 1500, 0)){
if(MISC::IS_BIT_SET(uLocal_336, 17)){
if(!PED::IS_PED_INJURED(uLocal_166)){
if(!PED::IS_PED_INJURED(uLocal_165)){
if(func_151(&uLocal_169, "FM_1AU", "FM_LESTCUT", 7, 0, 0, 0)){
func_186(&uLocal_346);
func_7(&uLocal_346, 0, 0);
iLocal_343++;
}
...
if(!PED::IS_PED_INJURED(uLocal_166)){
if(!func_239()){
PED::SET_PED_CONFIG_FLAG(uLocal_166, 104, 1);
MISC::SET_BIT(&uLocal_336, 22);
TASK::TASK_CLEAR_LOOK_AT(uLocal_166);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_166, 1273.576f, -1718.459f, 53.7715f, 1f, 20000, 1048576000, 0, 1193033728);
func_186(&uLocal_346);
func_7(&uLocal_346, 0, 0);
iLocal_343++;
}}
...
case 3:
if(!PED::IS_PED_INJURED(uLocal_166)){
if(func_187(&uLocal_346, 5000, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_166, 1275.138f, -1718.426f, 53.72994f, 1272.451f, -1719.627f, 55.45897f, 1.5625f, 0, 1, 0)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
...
if(MISC::IS_BIT_SET(uLocal_336, 15)){
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_344)){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_344, "SET_TIME");
...
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_344, 255, 255, 255, 255, 0);
}}
if(MISC::IS_BIT_SET(uLocal_336, 22)){
if(!PED::IS_PED_INJURED(uLocal_166)){
PED::SET_PED_CONFIG_FLAG(uLocal_166, 104, 1);
PED::SET_PED_RESET_FLAG(uLocal_166, 60, 1);
PED::SET_PED_RESET_FLAG(uLocal_166, 342, 1);
PED::SET_PED_RESET_FLAG(uLocal_166, 348, 1);
}}
if(MISC::IS_BIT_SET(uLocal_336, 23)){
if(func_146()){
MISC::CLEAR_BIT(&uLocal_336, 23);
}}
return 0;
}
...
if(func_148(&iLocal_165, 12, 1276.39f, -1712.845f, 54.372f, 338.0729f, 1)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_165, 1);
ENTITY::SET_ENTITY_INVINCIBLE(iLocal_165, 1);
func_147(&uLocal_169, 8, iLocal_165, "Lester", 0, 1);
PED::SET_PED_PROP_INDEX(iLocal_165, 1, 0, 0, 0, 1);
}}}
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_167)){
if(STREAMING::HAS_MODEL_LOADED(joaat("prop_wheelchair_01_s"))){
iLocal_167=OBJECT::CREATE_OBJECT(joaat("prop_wheelchair_01_s"), 1276.39f, -1712.845f, 54.372f, 0, 0, 0);
}}
...
if(!PED::IS_PED_INJURED(iLocal_165)){
uLocal_168=PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_165, uLocal_168, "missfinale_c2leadinoutfin_c_int", "_LEADIN_LOOP1_LESTER", 1000f, -8f, 5, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_167, uLocal_168, "_LEADIN_LOOP1_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, -8f, 4, 1148846080);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_168, 1);
bVar0=true;
}
if(!bVar0){
return 0;
...
int func_148(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
int iVar0;
if(!func_124(iParam1)){
...
void func_150(){
var uVar0;
if(CAM::DOES_CAM_EXIST(uLocal_345)){
CAM::SET_CAM_ACTIVE(uLocal_345, 0);
CAM::DESTROY_CAM(uLocal_345, 0);
}
MISC::CLEAR_BIT(&uLocal_336, 15);
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_166)){
uVar0=iLocal_166;
ENTITY::DELETE_ENTITY(&uVar0);
}
GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_344);
...
void func_171(bool bParam0, int iParam1, bool bParam2, bool bParam3){
func_173();
func_116(1);
HUD::CLEAR_HELP(1);
HUD::CLEAR_PRINTS();
...
void func_174(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6){
int iVar0;
func_176();
func_114(1);
func_106(1);
...
iLocal_166=PED::CREATE_PED(4, uVar0, 1273.827f, -1717.873f, 53.7715f, 19.2225f, 0, 0);
ENTITY::SET_ENTITY_INVINCIBLE(iLocal_166, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_166, 1);
PED::CLONE_PED_TO_TARGET(PLAYER::PLAYER_PED_ID(), iLocal_166);
}}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_166)){
return 0;
}
if(!PED::IS_PED_INJURED(iLocal_166)){
if(!PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(iLocal_166)){
return 0;
}}
return 1;
}
...
if(bLocal_335){
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1274.547f, -1720.694f, 53.6807f) > 500f){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_166)){
uVar0=iLocal_166;
ENTITY::DELETE_ENTITY(&uVar0);
}
...
var func__223(var uParam0, int iParam1){
...
return 1;
}elseif((iParam0 >=17 && iParam0 <=31) && func_227()){
return 1;
}
...
var func__227(){
return MISC::IS_BIT_SET(func_88(2482, -1), 2);
}


var func__228(){
return MISC::IS_BIT_SET(func_88(2482, -1), 1);
}
...
}}elseif(HUD::DOES_BLIP_EXIST(*uParam0) && (HUD::IS_BLIP_SHORT_RANGE(*uParam0) && !func_244())){
...
if(MISC::IS_BIT_SET(uLocal_336, 24)){
...
void func_260(struct<21> Param0){
...
void func_264(var uParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
func_249();
}
