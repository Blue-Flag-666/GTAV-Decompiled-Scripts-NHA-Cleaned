...
case 2:
break;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_334, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) > (3f + 2f)){
func_83();
}}else{
func_83();
}}}
...
if(func_74()==5){
uLocal_325=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_336, Local_337, 2, 0, 1, 1065353216, 0, 1065353216);
...
if((((func_50(Local_334, Var0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==INTERIOR::GET_INTERIOR_AT_COORDS(Local_334)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_332, Local_333, 2f, 0, 1, 0)) && func_49()) && !func_46(PLAYER::PLAYER_ID())){
if(iLocal_327==-1){
func_45(&iLocal_327, 3, "SA_BED_IN", 0, 0, 0, 0);
}
iLocal_321=1;
}}
break;
case 1:
if(func_44(1, 0, 1)){
if(((((func_50(Local_334, Var0) && func_54(8)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==INTERIOR::GET_INTERIOR_AT_COORDS(Local_334)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_332, Local_333, 2f, 0, 1, 0)) && func_49()) && !func_46(PLAYER::PLAYER_ID())){
if(func_42(iLocal_327, 1)){
func_40(&iLocal_327);
func_39();
Global_1835488=8;
...
Local_334={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_328, sLocal_329, Local_336, Local_337, 0, 2) 
};
Var1={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_328, sLocal_329, Local_336, Local_337, 0, 2) 
};
fLocal_335=Var1.f_2;
...
PED::SET_PED_DESIRED_HEADING(PLAYER::PLAYER_PED_ID(), func_15(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_39, 1)));
...
uLocal_325=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_336, Local_337, 2, 0, 0, 1065353216, 0, 1065353216);
...
func_11(1);
HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
uLocal_326=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uLocal_325);
...
break;
case 7:
if(((INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(Local_334)) && !func_7()) && !func_5()) && Global_1574632.f_8==0){
bLocal_323=true;
uLocal_325=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_336, Local_337, 2, 0, 0, 1065353216, 0, 1065353216);
...
var func__15(struct<2> Param0, Vector3 vParam1, struct<2> Param2, Vector3 vParam3){
...
}elseif(bVar14 || ((!func_18(PLAYER::PLAYER_ID(), 0) && !func_23()) && !func_22(PLAYER::PLAYER_ID()))){
...
return MISC::IS_BIT_SET(Global_1654054.f_241.f_136[func_48(9) /*33*/][iParam0], func_47(9));
}
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar0[iVar2], Local_332, Local_333, 2f, 0, 1, 0)){
return 0;
}}
iVar2++;
}}
