...
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_87, 1, 1);
}
func_442();
if(func_453()){
iVar0=func_441();
...
func_17(13, floor(Global_113810.f_10197.f_3853));
}
...
Global_78472[1 /*14*/]={
func_93(iVar0, iParam1, iParam2, -1) 
};
...
Global_78472[1 /*14*/]={
func_93(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
if(iParam5==0){
Global_78472[1 /*14*/]={
func_93(iVar10, iParam1, iParam2, -1) 
};
if(!func_83(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78472[1 /*14*/]={
func_93(iVar10, iVar0, uVar11[iVar0], -1) 
};
if(MISC::IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0)){
if(iVar0==13){
uVar12=9;
...
uVar12={
func_86(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_93(iVar10, 14, uVar12[iVar1], -1) 
};
...
Global_78472[1 /*14*/]={
func_93(iVar10, iVar0, func_49(iParam0, iVar0, -1), -1) 
};
...
uVar15={
func_86(iVar10, iParam2) 
};
iVar1=0;
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_93(iVar10, 14, uVar15[iVar1], -1) 
};
func_59(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
func_75(14);
if(Global_78470==1){
...
Global_78472[1 /*14*/]={
func_93(iParam0, iParam1, iParam2, -1) 
};
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_85(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_85(iParam2));
...
var func__78(int iParam0, var uParam1){
...
func_96(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_96(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_96(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
iVar10=(iParam1 - iParam2);
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_85(iParam0));
if(iVar11 > iVar10){
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_85(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_85(iParam1))){
return 1;
}
return 0;
}
...
func_171(&uVar1, Var0.f_3, Global_100870, iParam1, iParam2);
}}
...
}elseif(MISC::IS_PS3_VERSION() || func_179()){
...
if(MISC::IS_BIT_SET(Global_100833.f_20, 17)){
return 0;
}
...
var func__234(int iParam0, int iParam1){
...
func_299(4);
}elseif(func_297(PLAYER::PLAYER_PED_ID(), iLocal_87) > 250f){
...
func_251();
TASK::SET_PED_DESIRED_MOVE_BLEND_RATIO(iLocal_87, 1.8f);
}
break;
case 2:
break;
...
void func_251(){
if(!bLocal_278){
if(func_263(PLAYER::PLAYER_PED_ID(), iLocal_87, fLocal_265, 1)){
if(PED::IS_PED_BEING_JACKED(iLocal_87)){
...
if(!iLocal_295){
if(!*iParam0){
if((func_253(iLocal_87) && !PED::IS_PED_RAGDOLL(iLocal_87)) && !TASK::IS_PED_IN_WRITHE(iLocal_87)){
if(func_263(PLAYER::PLAYER_PED_ID(), iLocal_87, fLocal_265, 1)){
if(!func_246()){
...
}}}}}}elseif((bParam6 && !iLocal_302==0) && !func_246()){
if(*iParam1 < (iParam2 - 1)){
*iParam1++;
}else{
*iParam0=1;
}
if(iLocal_302==1 && ENTITY::DOES_ENTITY_EXIST(iLocal_87)){
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_87);
}
iLocal_302=0;
}}
...
func_247();
iLocal_302=2;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_87, PLAYER::PLAYER_PED_ID(), iParam0) && iLocal_286 < 4){
func_247();
iLocal_302=1;
}}
if(iLocal_302==1){
...
float fVar2;
Var0={
func_260(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var1={
func_260(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__260(struct<3> Param0){
float fVar0;
float fVar1;
fVar0=vmag(Param0);
if(fVar0 !=0f){
...
uParam0->f_5=0;
}elseif(!func_294(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}
break;
case 3:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || func_291(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==2){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
...
void func_301(){
if(func_443(iLocal_87)){
if(WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_87, joaat("weapon_stungun"), 0)){
if(func_443(iLocal_87)){
ENTITY::SET_ENTITY_HEALTH(iLocal_87, 99, 0);
}}}}
...
switch (iLocal_86){
case 0:
PATHFIND::SET_ROADS_IN_AREA(Local_81, Local_81.f_3, 1, 1);
MISC::SET_INSTANCE_PRIORITY_HINT(2);
if(func_443(Local_80.f_35[0])){
iVar0=0;
while (iVar0 < 3){
Local_293[iVar0 /*3*/]={
ENTITY::GET_ENTITY_COORDS(Local_80.f_35[0], 1) 
};
iVar0++;
}}
...
if(func_443(Local_80.f_35[0])){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(Local_80.f_35[0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
...
if(((!iLocal_263 && !iLocal_264) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_87)) && !ENTITY::IS_ENTITY_AT_COORD(Local_80.f_35[0], -1474.445f, 519.4703f, 117.0069f, 15f, 15f, 15f, 0, 1, 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_87, Local_80.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 90f, 786469, 100f, 1f, 1);
iLocal_264=1;
}}
func_254(0);
func_267(&uLocal_303, iLocal_87, 0, 0, 1, 1, 1);
if(((!iLocal_263 && func_263(PLAYER::PLAYER_PED_ID(), iLocal_87, 10f, 1)) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_87)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_87, Local_80.f_35[0], PLAYER::PLAYER_PED_ID(), 8, 90f, 786468, 100f, 1f, 1);
iLocal_263=1;
}
if(!func_308()){
func_303();
...
iLocal_263=1;
func_299(3);
}elseif(PED::IS_PED_BEING_JACKED(iLocal_87) || !func_3(Local_80.f_35[0])){
iLocal_263=1;
func_299(3);
}}else{
iLocal_263=1;
...
int func_304(){
if(func_443(Local_80.f_35[0])){
if(PED::IS_PED_IN_VEHICLE(iLocal_87, Local_80.f_35[0], 0)){
if((MISC::GET_GAME_TIMER() - iLocal_294) > 3000){
func_306();
...
if(func_443(Local_80.f_35[0])){
iVar0=0;
if(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_80.f_35[0], 0, 0)){
iVar0++;
}
if(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_80.f_35[0], 1, 0)){
iVar0++;
}
if(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_80.f_35[0], 4, 0)){
iVar0++;
}
if(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_80.f_35[0], 5, 0)){
iVar0++;
}
if(iVar0 > 1){
...
int iVar0;
iVar0=VEHICLE::GET_CLOSEST_VEHICLE(ENTITY::GET_ENTITY_COORDS(Local_80.f_35[0], 1), 20f, iParam0, 6);
if(ENTITY::DOES_ENTITY_EXIST(iVar0)){
if(VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iVar0, Local_80.f_35[0])){
...
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_80.f_35[0], 1);
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_80.f_35[0], 1, 1, 0);
VEHICLE::SET_VEHICLE_DOOR_OPEN(Local_80.f_35[0], 0, 0, 0);
}
if(func_443(iLocal_87)){
PED::SET_PED_MIN_MOVE_BLEND_RATIO(iLocal_87, 3f);
if(!HUD::DOES_BLIP_EXIST(iLocal_88)){
...
TASK::TASK_ENTER_VEHICLE(0, Local_80.f_35[0], 20000, -1, 3f, 1, 0);
TASK::TASK_VEHICLE_DRIVE_WANDER(0, Local_80.f_35[0], 15f, 262144);
TASK::CLOSE_SEQUENCE_TASK(uLocal_90);
TASK::TASK_PERFORM_SEQUENCE(iLocal_87, uLocal_90);
uLocal_261=VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(ENTITY::GET_ENTITY_COORDS(Local_80.f_35[0], 1), 100f, 10f, 0);
}else{
TASK::TASK_SMART_FLEE_PED(iLocal_87, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
}}
...
iLocal_92=VEHICLE::CREATE_VEHICLE(iLocal_93, -1482.366f, 529.0344f, 117.2725f, 201.5764f, 1, 1, 0);
...
break;
case 1:
if(iLocal_317==0 && CAM::IS_SCREEN_FADED_IN()){
...
if(iLocal_262){
if(func_443(iLocal_87)){
if((MISC::GET_GAME_TIMER() - iLocal_89) > 3000){
PED::SET_PED_MIN_MOVE_BLEND_RATIO(iLocal_87, 3f);
}
else{
iLocal_262=0;
...
if((func_311(joaat("script_task_perform_sequence")) && TASK::GET_SEQUENCE_PROGRESS(iLocal_87) > 0) && func_307()){
func_299(3);
}}
break;
case 2:
...
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_87, iParam0)==1 || TASK::GET_SCRIPT_TASK_STATUS(iLocal_87, iParam0)==0){
return 1;
}
return 0;
}
...
if(TASK::GET_SEQUENCE_PROGRESS(iLocal_87) > 0){
if(!ENTITY::IS_ENTITY_AT_COORD(Local_80.f_35[0], Local_78, 20f, 20f, 100f, 0, 1, 0)){
sLocal_272="DREY1_CGONE";
iLocal_263=1;
func_299(3);
return 1;
}elseif(!ENTITY::IS_ENTITY_AT_COORD(Local_80.f_35[0], Local_78, 5f, 5f, 100f, 0, 1, 0)){
...
float fVar2;
Var0={
func_260(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
if(fParam2 < 0.1f || fParam2 > 360f){
return 1;
}
...
if(PED::IS_PED_SITTING_IN_VEHICLE(iLocal_87, Local_80.f_35[0])){
if(HUD::DOES_BLIP_EXIST(iLocal_88)){
HUD::SET_BLIP_SCALE(iLocal_88, 1f);
}
iLocal_86=2;
}}}
...
if(((CAM::IS_SCREEN_FADED_IN() && !func_453()) && func_443(iLocal_87)) && func_298(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], 1) > 4f){
CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_87, 0f, 0f, -0.5f, 1, -1, 3000, 2000, 0);
...
iLocal_319=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1459.57f, 485.16f, 115.2f, 10f, joaat("prop_yoga_mat_02"), 1, 0, 1);
...
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, -1, 0, 2);
iLocal_316++;
}}
break;
case 1:
...
if(func_443(iLocal_87)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_87, sLocal_95, 0, 0, 0);
}
func_392();
...
func_383(-1457.842f, 485.8195f, 114.2016f, -1474.227f, 482.811f, 117.2016f, 3f, Local_298, fLocal_299, 1, 1, 1, 0, 0);
func_383(-1473.984f, 510.0452f, 114.6034f, -1474.227f, 482.811f, 118.2016f, 4f, Local_298, fLocal_299, 1, 1, 1, 0, 0);
func_383(-1472.341f, 508.3621f, 114.6158f, -1475.958f, 520.1589f, 120.0448f, 10f, Local_298, fLocal_299, 1, 1, 1, 0, 0);
func_334(Local_298, fLocal_299, 0, 145);
}
else{
func_383(-1457.842f, 485.8195f, 114.2016f, -1474.227f, 482.811f, 117.2016f, 3f, Local_300, fLocal_301, 1, 1, 1, 0, 0);
func_383(-1473.984f, 510.0452f, 114.6034f, -1474.227f, 482.811f, 118.2016f, 4f, Local_300, fLocal_301, 1, 1, 1, 0, 0);
func_383(-1472.341f, 508.3621f, 114.6158f, -1475.958f, 520.1589f, 120.0448f, 10f, Local_300, fLocal_301, 1, 1, 1, 0, 0);
...
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Dreyfuss", 0) && func_443(iLocal_87)){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_87, -1475.366f, 500.3797f, 116.6013f, 3f, 20000, 0.25f, 1, 1193033728);
}}
break;
}
break;
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_327(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
if(iParam2==1){
if(func_379(ENTITY::GET_ENTITY_COORDS(Global_104373.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
}}
func_335(Global_104373.f_4, Param0, fParam1, 24, 0);
}}}}
...
func_370(iParam3, &Var0, Param1, uParam2, func_373(iParam0));
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_354(iParam0, 0, 0)) || func_354(iParam0, 1, 0)) || func_354(iParam0, 2, 0)) || func_373(iParam0) !=145) || func_353(iParam0)) || func_352(iParam0)) || func_351(iParam0)) || func_350(iParam0)) || !func_339(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_352(iParam0)){
}
if(func_352(iParam0)){
}
...
return (shift_right(iParam0, 26) & 31 * func_362(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_370(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_367(&(Global_77479.f_555[0 /*21*/]), iParam0)){
...
void func_383(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
func_384(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}


void func_384(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, var uParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
if(func_386(iVar0, Param0, Param1, fParam2)){
bVar1=true;
}}}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
...
int func_386(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
if(((((((((((((((func_387(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_387(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_387(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_387(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_387(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_387(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_387(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_387(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_387(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_387(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_387(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_387(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_387(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_387(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_387(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_387(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4)){
return 1;
}}
return 0;
}

int func_387(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
bool func_389(struct<3> Param0, int iParam1){
return func_390(Global_104373.f_2890.f_12.f_66, Param0, iParam1);
}

int func_390(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
struct<3> Var1;
if(iParam0==0){
return 0;
...
int func_393(int iParam0, float fParam1, int iParam2){
int iVar0;
iVar0=1;
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
if(!func_397(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
int func_397(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6){
...
if(iLocal_318==0){
if(func_443(iLocal_87)){
if(func_298(PLAYER::PLAYER_PED_ID(), iLocal_87, 1) < 3f){
iLocal_318=1;
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_87, 0);
}}}}
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_397(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
func_430();
if(!func_436()){
func_428(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 100f, 12, 5000, 0, 0);
}
func_427(0, -1, 1);
if(iParam0==1){
if(func_443(iLocal_87)){
...
Local_80.f_35[0]=VEHICLE::CREATE_VEHICLE(iLocal_94, Local_78, fLocal_79, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_94);
}
if(func_443(Local_80.f_35[0])){
VEHICLE::SET_VEHICLE_INFLUENCES_WANTED_LEVEL(Local_80.f_35[0], 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_80.f_35[0], 1);
VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(Local_80.f_35[0], "DR3YFU55");
}}
...
PED::SET_PED_CONFIG_FLAG(iLocal_87, 177, 1);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_87, 1);
ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_87, 1, 0);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_87, 1, 1);
TASK::SET_PED_PATH_MAY_ENTER_WATER(iLocal_87, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_87, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_87, 281, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_87, 42, 1);
}}
...
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_77, 1);
func_438();
MISC::CLEAR_BIT(&(Global_113810.f_18577.f_382), 0);
HUD::REQUEST_ADDITIONAL_TEXT("DREY1", 0);
func_432(&uLocal_96, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
func_431();
func_430();
}
...
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_77, 0);
func_194(99, 0, 1, 1, 0);
func_407(&iLocal_319, 0);
...
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_87, 0, 1);
}
func_464(&iLocal_87, 1, 0, 1);
func_461(&iLocal_92);
func_466();
PATHFIND::SET_ROADS_IN_AREA(Local_81, Local_81.f_3, 1, 1);
VEHICLE::REMOVE_ROAD_NODE_SPEED_ZONE(uLocal_261);
}
...
iVar2=func_473(SCRIPT::GET_THIS_SCRIPT_NAME());
if(iVar2 > -1){
