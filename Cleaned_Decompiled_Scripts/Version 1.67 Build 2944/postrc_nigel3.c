...
switch (iLocal_19){
case 0:
if((MISC::GET_GAME_TIMER() - iLocal_185) > 5000 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_186, PLAYER::PLAYER_PED_ID(), 1)){
if(func_3(&uLocal_20, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0)){
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_186);
iLocal_19=1;
}}elseif((MISC::GET_GAME_TIMER() - iLocal_185) > 12000 && vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(uLocal_186, 1)) <=900f){
if(func_3(&uLocal_20, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0)){
iLocal_19=1;
}}
break;
...
float fVar0;
fVar0=200f;
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(uLocal_186, 1)) >=(fVar0 * fVar0) && !ENTITY::IS_ENTITY_ON_SCREEN(uLocal_186)){
return 0;
}
return 1;
}
...
int func_24(){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_186)){
if(!PED::IS_PED_INJURED(uLocal_186)){
return 1;
}}
return 0;
}
...
func_33(&uLocal_20, 1);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_186)){
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_186);
}
