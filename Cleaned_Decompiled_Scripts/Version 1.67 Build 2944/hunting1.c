...
fLocal_28=180f;
iLocal_31=3;
uLocal_76=func_574(54);
iLocal_77=joaat("dune");
uLocal_78=WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_sniperrifle"));
uLocal_79=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("component_at_scope_large"));
uLocal_80=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("component_at_ar_supp_02"));
Local_81={
...
Global_78935=1;
iLocal_75=0;
while (!func_527(&Local_86)){
wait(0);
}
func_526(&Local_86, 0, 1);
Global_78935=0;
}
...
func_525(25);
func_524();
func_523(&uLocal_87, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
func_523(&uLocal_87, 3, iLocal_346, "CLETUS", 0, 1);
while (true){
RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("SF_TP", 0);
func_506(Local_86.f_9, 0, 0, 0, 0, 0);
...
HUD::CLEAR_HELP(1);
func_7();
if(MISC::IS_STRING_NULL_OR_EMPTY(sLocal_350)){
func_551(1);
}else{
func_5(sLocal_350, 1);
}
...
func_16(13, floor(Global_113810.f_10197.f_3853));
}
...
Global_78472[1 /*14*/]={
func_92(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_92(iVar10, 14, uVar12[iVar1], -1) 
};
...
Global_78472[1 /*14*/]={
func_92(iVar10, iVar0, func_48(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_92(iVar10, 14, uVar15[iVar1], -1) 
};
func_58(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
func_74(14);
if(Global_78470==1){
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_84(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
func_95(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_95(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_95(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
iVar10=(iParam1 - iParam2);
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_84(iParam0));
if(iVar11 > iVar10){
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_84(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_84(iParam1))){
return 1;
}
return 0;
}
...
func_170(&uVar1, Var0.f_3, Global_100870, iParam1, iParam2);
}}
...
WEAPON::SET_PED_AMMO_BY_TYPE(PLAYER::PLAYER_PED_ID(), joaat("AMMO_SNIPER"), uLocal_335);
}else{
...
if(!func_216()){
func_233(PLAYER::PLAYER_PED_ID(), Local_413, fLocal_414, 0, 1);
}
if(func_318(iLocal_346)){
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_346, -1, 0, 2);
}
func_232(1);
func_230(0);
}
...
if(!PED::IS_PED_GROUP_MEMBER(iLocal_346, func_231())){
TASK::CLEAR_PED_TASKS(iLocal_346);
PED::SET_PED_AS_GROUP_MEMBER(iLocal_346, func_231());
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_346, 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_346, 0);
}}}elseif(PED::IS_PED_GROUP_MEMBER(iLocal_346, func_231())){
TASK::CLEAR_PED_TASKS(iLocal_346);
PED::REMOVE_PED_FROM_GROUP(iLocal_346);
}}}
...
iVar6=func_312(&(Global_100833.f_3));
if(iVar6 > -1){
...
var func__257(int iParam0, var uParam1){
...
iVar5=0;
while (iVar5 < iVar6){
if((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_264(Var7.f_1)) && iVar9 < 51){
...
}elseif(func_270(*uParam0, "v_hospital", 307.3065f, -589.9595f, 43.302f)){
*uParam0={
...
if(func_15()==0){
return MISC::IS_BIT_SET(func_79(func_276(iParam0), -1), iParam1);
}}else{
...
iVar0=0;
while (iVar0 <=60){
if(iParam1==6 || iParam1==func_299(iVar0)){
if(!bParam3 || func_298(iVar0)){
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_279(iVar0, 0), 1);
...
Vector3 func__279(int iParam0, bool bParam1){
switch (iParam0){
case -1:
return 0f, 0f, 0f;
break;
...
return func_286(2, 2);
}elseif(func_285(Global_1853823)){
...
Vector3 func__283(struct<3> Param0){
...
Vector3 func__286(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var1;
Var1={
...
int func_287(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4){
struct<4> Var0;
struct<3> Var1;
struct<4> Var2;
struct<3> Var3;
...
Var3={
func_288(Var3, -Var0.f_3.f_2) 
};
Var3={
func_288(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__288(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
return (shift_right(iParam0, 26) & 31 * func_307(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
if(iLocal_336 < 3){
if(!bLocal_292){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_363, Local_364, 20f, 0, 1, 0)){
func_331();
if(iLocal_299[17]){
...
uLocal_423[iVar3]=VEHICLE::CREATE_VEHICLE(iVar2[iVar3], Var0[iVar3 /*3*/], fVar1[iVar3], 1, 1, 0);
}
iVar3++;
}
...
if(!HUD::DOES_BLIP_EXIST(iLocal_261)){
iLocal_261=func_325(iLocal_346, 1, 1, 5);
}
if(HUD::DOES_BLIP_EXIST(iLocal_261)){
if(!bParam0){
HUD::SET_BLIP_SCALE(iLocal_261, 0.75f);
}
HUD::SET_BLIP_FLASHES(iLocal_261, iParam1);
}}
...
if(!func_318(Local_258[iVar0 /*54*/][iVar1 /*17*/].f_6)){
if(!Local_258[iVar0 /*54*/][iVar1 /*17*/].f_1){
iLocal_275=0;
func_358(iVar0, iVar1);
Local_419[iVar0 /*3*/]={
ENTITY::GET_ENTITY_COORDS(Local_258[iVar0 /*54*/][iVar1 /*17*/].f_6, 1) 
};
iLocal_301[iVar0]=1;
Local_258[iVar0 /*54*/][iVar1 /*17*/].f_1=1;
if(Local_258[iVar0 /*54*/][0 /*17*/].f_1==1){
if(!ENTITY::IS_ENTITY_DEAD(Local_258[iVar0 /*54*/][1 /*17*/].f_6, 0)){
Local_258[iVar0 /*54*/][1 /*17*/].f_4=0;
iLocal_327=1;
}elseif(!ENTITY::IS_ENTITY_DEAD(Local_258[iVar0 /*54*/][2 /*17*/].f_6, 0)){
...
}}elseif(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_258[iVar0 /*54*/][iVar1 /*17*/].f_6, 1), 2f, 0)){
iLocal_275=0;
iLocal_279=1;
iLocal_328=0;
iLocal_328=0;
...
Local_258[iVar0 /*54*/][iLocal_328 /*17*/].f_14={
ENTITY::GET_ENTITY_COORDS(Local_258[iVar0 /*54*/][iLocal_328 /*17*/].f_6, 1) 
};
Local_258[iVar0 /*54*/].f_52=4;
}
elseif(!Local_258[iVar0 /*54*/][iVar1 /*17*/].f_1){
iLocal_279=0;
}
iLocal_328++;
}}}
...
elseif(Local_258[iVar0 /*54*/][iVar1 /*17*/].f_4==1){
...
iLocal_328=0;
while (iLocal_328 < 3){
if((ENTITY::DOES_ENTITY_EXIST(Local_258[iVar0 /*54*/][iLocal_328 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_258[iVar0 /*54*/][iLocal_328 /*17*/].f_6, 0)) && !PED::IS_PED_INJURED(Local_258[iVar0 /*54*/][iLocal_328 /*17*/].f_6)){
...
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iVar0 /*54*/][iLocal_328 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_258[iVar0 /*54*/][iLocal_328 /*17*/].f_6, 0)){
TASK::TASK_GO_TO_COORD_ANY_MEANS(Local_258[iVar0 /*54*/][iLocal_328 /*17*/].f_6, Local_419[iVar0 /*3*/], MISC::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
...
if(!ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
PED::SET_PED_INCREASED_AVOIDANCE_RADIUS(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6);
}
...
break;
case 3:
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
Local_258[iParam0 /*54*/][iParam1 /*17*/].f_7=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(3000, 8000));
...
case 4:
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
if(MISC::GET_GAME_TIMER() > Local_258[iParam0 /*54*/][iParam1 /*17*/].f_7 && Local_258[iParam0 /*54*/][iParam1 /*17*/].f_4==0){
func_358(iParam0, iParam1);
iVar0=0;
iVar0=0;
while (iVar0 < 3){
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iVar0 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iVar0 /*17*/].f_6, 0)){
...
case 5:
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
Local_258[iParam0 /*54*/][iParam1 /*17*/].f_10=MISC::GET_RANDOM_INT_IN_RANGE(0, 8);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_417[Local_258[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], 1f, -1, 0.25f, 512, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f));
}elseif(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iLocal_327 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iLocal_327 /*17*/].f_6, 0)){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_258[iParam0 /*54*/][iLocal_327 /*17*/].f_6, Local_258[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
}
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
if(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_4==0 && ENTITY::IS_ENTITY_AT_COORD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_417[Local_258[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_336(iParam0), 0, 0, 0)){
iVar1=0;
iVar1=0;
while (iVar1 < 3){
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
TASK::CLEAR_PED_TASKS(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6);
TASK::TASK_WANDER_IN_AREA(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_417[Local_258[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], 7.5f, 0f, 1f);
...
TASK::TASK_SMART_FLEE_COORD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_419[iParam0 /*3*/], 50f, -1, 0, 0);
}else{
TASK::TASK_SMART_FLEE_COORD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_258[iParam0 /*54*/][iParam1 /*17*/].f_14, 50f, -1, 0, 0);
}
PED::SET_PED_KEEP_TASK(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
...
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
if(iLocal_301[iParam0]){
if(func_335(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_419[iParam0 /*3*/], 1) >=45f){
TASK::TASK_GO_TO_COORD_ANY_MEANS(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_419[iParam0 /*3*/], MISC::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
Local_258[iParam0 /*54*/][iParam1 /*17*/].f_3=10;
}}elseif(func_335(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_258[iParam0 /*54*/][iParam1 /*17*/].f_14, 1) >=45f){
if(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_4==0){
...
case 10:
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
if(func_335(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_419[iParam0 /*3*/], 0) < 2f){
TASK::CLEAR_PED_TASKS(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6);
...
case 8:
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iLocal_327 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iLocal_327 /*17*/].f_6, 0)){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_258[iParam0 /*54*/][iLocal_327 /*17*/].f_6, Local_258[iParam0 /*54*/][iParam1 /*17*/].f_11, 1f, -1, 1.5f, 1);
...
break;
case 13:
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6)){
if(ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
if(func_334(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6)){
iLocal_336++;
iLocal_275=0;
}else{
bLocal_292=true;
}}
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6);
}
...
func_351(767);
if(func_338(&uLocal_87, cLocal_351, "HUNT1_KILL", "HUNT1_KILL_1", 7, 0, 0)){
iLocal_265=1;
}}}}
...
int func_339(char* sParam0, int iParam1, bool bParam2){
Global_21846=0;
...
var func__343(int iParam0, int iParam1){
...
if((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_363, Local_364, 20f, 0, 1, 0) && ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) && iLocal_284) && iLocal_336 < 3){
if(!HUD::DOES_BLIP_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/])){
Local_258[iParam0 /*54*/][iParam1 /*17*/]=func_325(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 1, 0, 5);
if(HUD::DOES_BLIP_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/])){
HUD::SET_BLIP_SCALE(Local_258[iParam0 /*54*/][iParam1 /*17*/], 0.7f);
}
if(!ENTITY::IS_ENTITY_DEAD(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
}}}else{
...
struct<3> Var0;
if(!func_318(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6)){
if(iParam1==1){
Var0={
Local_417[Local_258[iParam0 /*54*/][0 /*17*/].f_9 /*3*/] + Local_380 
};
Local_258[iParam0 /*54*/][iParam1 /*17*/].f_11={
Local_380 
};
}elseif(iParam1==2){
Var0={
Local_417[Local_258[iParam0 /*54*/][0 /*17*/].f_9 /*3*/] + Local_381 
};
Local_258[iParam0 /*54*/][iParam1 /*17*/].f_11={
Local_381 
};
}
Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6=PED::CREATE_PED(26, iLocal_339, Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f), 1, 1);
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6)){
ENTITY::SET_ENTITY_HEALTH(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
Local_258[iParam0 /*54*/][iParam1 /*17*/].f_3=8;
}}}
...
Local_258[iParam0 /*54*/][iParam1 /*17*/].f_10=MISC::GET_RANDOM_INT_IN_RANGE(0, 8);
if(!iLocal_298[Local_258[iParam0 /*54*/][iParam1 /*17*/].f_10]){
Local_258[iParam0 /*54*/][iParam1 /*17*/].f_5=MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f);
Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6=PED::CREATE_PED(26, iLocal_339, Local_417[Local_258[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], Local_258[iParam0 /*54*/][iParam1 /*17*/].f_5, 1, 1);
if(ENTITY::DOES_ENTITY_EXIST(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6)){
ENTITY::SET_ENTITY_HEALTH(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
Local_258[iParam0 /*54*/][iParam1 /*17*/].f_9=Local_258[iParam0 /*54*/][iParam1 /*17*/].f_10;
...
if(func_359()){
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "COYOTE_BARK_MASTER", Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
}else{
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "COYOTE_CRY_MASTER", Local_258[iParam0 /*54*/][iParam1 /*17*/].f_6, 0, 0, 0);
}}
...
func_232(1);
if(!func_216()){
func_233(PLAYER::PLAYER_PED_ID(), Local_375, fLocal_376, 0, 1);
func_362();
}
iLocal_255=2;
}
...
iVar0=0;
while (iVar0 < 3){
if(HUD::DOES_BLIP_EXIST(Local_256[iVar0 /*10*/].f_9)){
HUD::REMOVE_BLIP(&(Local_256[iVar0 /*10*/].f_9));
}
func_367(&(Local_256[iVar0 /*10*/]));
iVar0++;
}
if(iLocal_269){
...
while (!STREAMING::HAS_MODEL_LOADED(iLocal_341) || !STREAMING::HAS_MODEL_LOADED(iLocal_342)){
wait(0);
}}
...
iVar1=0;
while (iVar1 < 3){
func_372(Local_258[iVar0 /*54*/][iVar1 /*17*/].f_6);
iVar1++;
}
iVar0++;
}
...
int func_371(){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_346) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_346, PLAYER::PLAYER_PED_ID(), Local_365, 0, 0, 0)){
return 1;
}}
return 0;
}
...
func_374();
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_411, Local_412, 3.5f, 0, 1, 0) || iLocal_299[16]){
func_368();
func_361();
iLocal_252=15;
}
...
func_388(iVar0);
if(ENTITY::DOES_ENTITY_EXIST(Local_257[iVar0 /*29*/].f_28)){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_361, Local_362, 10f, 0, 1, 0)){
if(!bLocal_287){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)){
bLocal_287=true;
func_328(6);
}}}}}
...
break;
case 2:
Local_257[iVar0 /*29*/].f_7=MISC::GET_RANDOM_INT_IN_RANGE(0, 5);
if((!VEHICLE::IS_ANY_VEHICLE_NEAR_POINT(Local_257[Local_257[iVar0 /*29*/].f_7 /*29*/].f_16, 4.5f) && iLocal_317 < 3) && ENTITY::WOULD_ENTITY_BE_OCCLUDED(Local_257[iVar0 /*29*/].f_9, Local_257[iVar0 /*29*/].f_16, 1)){
Local_257[iVar0 /*29*/].f_28=VEHICLE::CREATE_VEHICLE(Local_257[iVar0 /*29*/].f_9, Local_257[iVar0 /*29*/].f_16, Local_257[iVar0 /*29*/].f_4, 1, 1, 0);
if(ENTITY::DOES_ENTITY_EXIST(Local_257[iVar0 /*29*/].f_28) && !ENTITY::IS_ENTITY_DEAD(Local_257[iVar0 /*29*/].f_28, 0)){
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_257[iVar0 /*29*/].f_28, 1);
VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(Local_257[iVar0 /*29*/].f_28, 1);
Local_257[iVar0 /*29*/].f_7=MISC::GET_RANDOM_INT_IN_RANGE(0, 5);
Local_257[iVar0 /*29*/].f_12=PED::CREATE_PED_INSIDE_VEHICLE(Local_257[iVar0 /*29*/].f_28, 26, Local_257[Local_257[iVar0 /*29*/].f_7 /*29*/].f_10, -1, 1, 1);
if(ENTITY::DOES_ENTITY_EXIST(Local_257[iVar0 /*29*/].f_12)){
Local_257[iVar0 /*29*/].f_11=OBJECT::CREATE_OBJECT(iLocal_343, Local_257[iVar0 /*29*/].f_16, 1, 1, 0);
if(ENTITY::DOES_ENTITY_EXIST(Local_257[iVar0 /*29*/].f_11)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_257[iVar0 /*29*/].f_11, Local_257[iVar0 /*29*/].f_12, PED::GET_PED_BONE_INDEX(Local_257[iVar0 /*29*/].f_12, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::SET_ENTITY_VISIBLE(Local_257[iVar0 /*29*/].f_11, 0, 0);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_257[iVar0 /*29*/].f_12, 1, 1);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_257[iVar0 /*29*/].f_12, 1);
Local_257[iVar0 /*29*/].f_2=0;
Local_257[iVar0 /*29*/].f_1=0;
Local_257[iVar0 /*29*/].f_3=0;
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_257[iVar0 /*29*/].f_12, 1);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_257[iVar0 /*29*/].f_12, Local_257[iVar0 /*29*/].f_28, Local_257[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
iLocal_317++;
...
break;
case 4:
if(func_318(Local_257[iVar0 /*29*/].f_12) && func_387(Local_257[iVar0 /*29*/].f_28)){
if(!ENTITY::IS_ENTITY_AT_COORD(Local_257[iVar0 /*29*/].f_28, Local_257[iVar0 /*29*/].f_19, 10f, 10f, 10f, 0, 0, 0)){
if(!func_386(Local_257[iVar0 /*29*/].f_12, joaat("script_task_vehicle_drive_to_coord"))){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_257[iVar0 /*29*/].f_12, 1);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_257[iVar0 /*29*/].f_12, Local_257[iVar0 /*29*/].f_28, Local_257[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
}
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)){
if(func_334(Local_257[iVar0 /*29*/].f_28)){
if(func_385(iVar0)){
...
func_384(iVar0);
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_257[iVar0 /*29*/].f_28);
...
elseif(!iLocal_280){
if(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_257[iVar0 /*29*/].f_28, 1), 5f, 1)){
iLocal_280=1;
}
}}else{
TASK::CLEAR_PED_TASKS(Local_257[iVar0 /*29*/].f_12);
VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(Local_257[iVar0 /*29*/].f_28, 0);
TASK::TASK_VEHICLE_DRIVE_WANDER(Local_257[iVar0 /*29*/].f_12, Local_257[iVar0 /*29*/].f_28, 8f, 786599);
PED::SET_PED_KEEP_TASK(Local_257[iVar0 /*29*/].f_12, 1);
Local_257[iVar0 /*29*/].f_13=15;
}}else{
Local_257[iVar0 /*29*/].f_13=15;
}
...
TASK::CLEAR_PED_TASKS(Local_257[iVar0 /*29*/].f_12);
Var1={
func_378(Local_257[iVar0 /*29*/].f_28) 
};
if(!func_272(Var1, 0f, 0f, 0f, 0)){
TASK::TASK_VEHICLE_PARK(Local_257[iVar0 /*29*/].f_12, Local_257[iVar0 /*29*/].f_28, Var1, ENTITY::GET_ENTITY_HEADING(Local_257[iVar0 /*29*/].f_28), 3, 270f, 1);
}elseif(func_359()){
TASK::TASK_VEHICLE_TEMP_ACTION(Local_257[iVar0 /*29*/].f_12, Local_257[iVar0 /*29*/].f_28, 5, 2000);
}else{
TASK::TASK_VEHICLE_TEMP_ACTION(Local_257[iVar0 /*29*/].f_12, Local_257[iVar0 /*29*/].f_28, 4, 2000);
}
func_2();
...
break;
case 6:
if((func_234(Local_257[iVar0 /*29*/].f_28) && func_318(Local_257[iVar0 /*29*/].f_12)) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)){
if(VEHICLE::IS_VEHICLE_STOPPED(Local_257[iVar0 /*29*/].f_28)){
TASK::CLEAR_PED_TASKS(Local_257[iVar0 /*29*/].f_12);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_257[iVar0 /*29*/].f_12, 1);
if(!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) || !Local_257[iVar0 /*29*/].f_2){
TASK::TASK_LEAVE_VEHICLE(Local_257[iVar0 /*29*/].f_12, Local_257[iVar0 /*29*/].f_28, 1);
}
else{
func_379(iVar0);
}
...
break;
case 7:
if(func_318(Local_257[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)){
if(!PED::IS_PED_IN_ANY_VEHICLE(Local_257[iVar0 /*29*/].f_12, 0)){
if(!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) || !Local_257[iVar0 /*29*/].f_2){
Local_257[iVar0 /*29*/].f_13=8;
}
else{
func_379(iVar0);
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)){
func_379(iVar0);
}}else{
Local_257[iVar0 /*29*/].f_13=15;
}
break;
case 8:
if((func_318(Local_257[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)) && func_387(Local_257[iVar0 /*29*/].f_28)){
Var2={
ENTITY::GET_ENTITY_COORDS(Local_257[iVar0 /*29*/].f_12, 1) 
};
if(!PED::IS_PED_IN_ANY_VEHICLE(Local_257[iVar0 /*29*/].f_12, 0)){
if(!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(Var2, 3f, 1)){
Local_257[iVar0 /*29*/].f_25={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_257[iVar0 /*29*/].f_28, Local_257[iVar0 /*29*/].f_22) 
};
Local_257[iVar0 /*29*/].f_6=(ENTITY::GET_ENTITY_HEADING(Local_257[iVar0 /*29*/].f_28) + Local_257[iVar0 /*29*/].f_5);
TASK::CLEAR_PED_TASKS(Local_257[iVar0 /*29*/].f_12);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_257[iVar0 /*29*/].f_12, 1);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_257[iVar0 /*29*/].f_12, Local_257[iVar0 /*29*/].f_25, 1f, -1, 0.25f, 0, Local_257[iVar0 /*29*/].f_6);
...
if(!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(Var2, 3f, 1)){
if(ENTITY::IS_ENTITY_AT_COORD(Local_257[iVar0 /*29*/].f_12, Local_257[iVar0 /*29*/].f_25, 1f, 1f, 1f, 0, 0, 1)){
TASK::CLEAR_PED_TASKS(Local_257[iVar0 /*29*/].f_12);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_257[iVar0 /*29*/].f_12, 1);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_257[iVar0 /*29*/].f_12, Local_257[iVar0 /*29*/].f_28, 0);
...
if(!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(Var2, 3f, 1)){
Local_257[iVar0 /*29*/].f_15=TASK::GET_SCRIPT_TASK_STATUS(Local_257[iVar0 /*29*/].f_12, joaat("script_task_turn_ped_to_face_entity"));
...
if(!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(Var2, 3f, 1)){
TASK::OPEN_SEQUENCE_TASK(&(Local_257[iVar0 /*29*/].f_14));
...
TASK::CLOSE_SEQUENCE_TASK(Local_257[iVar0 /*29*/].f_14);
TASK::TASK_PERFORM_SEQUENCE(Local_257[iVar0 /*29*/].f_12, Local_257[iVar0 /*29*/].f_14);
TASK::CLEAR_SEQUENCE_TASK(&(Local_257[iVar0 /*29*/].f_14));
Local_257[iVar0 /*29*/].f_8=MISC::GET_GAME_TIMER() + 20000;
...
if(!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(Var2, 3f, 1)){
if(MISC::GET_GAME_TIMER() > Local_257[iVar0 /*29*/].f_8){
if(ENTITY::IS_ENTITY_VISIBLE(Local_257[iVar0 /*29*/].f_11)){
ENTITY::SET_ENTITY_VISIBLE(Local_257[iVar0 /*29*/].f_11, 0, 0);
}else{
TASK::CLEAR_PED_TASKS(Local_257[iVar0 /*29*/].f_12);
func_377(iVar0);
...
elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_257[iVar0 /*29*/].f_12, "ODDJOBS@HUNTER", "enter_call", 3) && !ENTITY::IS_ENTITY_VISIBLE(Local_257[iVar0 /*29*/].f_11)){
ENTITY::SET_ENTITY_VISIBLE(Local_257[iVar0 /*29*/].f_11, 1, 0);
}}else{
TASK::CLEAR_PED_TASKS(Local_257[iVar0 /*29*/].f_12);
func_379(iVar0);
}}else{
...
case 13:
if(!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_257[iVar0 /*29*/].f_28, 0), ENTITY::GET_ENTITY_COORDS(Local_257[iVar0 /*29*/].f_12, 1), 0) > 100f){
Local_257[iVar0 /*29*/].f_13=15;
}}else{
Local_257[iVar0 /*29*/].f_13=15;
}
...
func_384(iVar0);
if(ENTITY::DOES_ENTITY_EXIST(Local_257[iVar0 /*29*/].f_12)){
if(!ENTITY::IS_ENTITY_DEAD(Local_257[iVar0 /*29*/].f_12, 0)){
PED::SET_PED_KEEP_TASK(Local_257[iVar0 /*29*/].f_12, 1);
}
func_376(&(Local_257[iVar0 /*29*/].f_12), 1, 0, 1);
}
if(ENTITY::DOES_ENTITY_EXIST(Local_257[iVar0 /*29*/].f_28)){
func_375(&(Local_257[iVar0 /*29*/].f_28));
}
Local_257[iVar0 /*29*/].f_13=1;
break;
}
if(func_387(Local_257[iVar0 /*29*/].f_28) && func_318(Local_257[iVar0 /*29*/].f_12)){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_374, ENTITY::GET_ENTITY_COORDS(Local_257[iVar0 /*29*/].f_28, 1), 1) > 450f){
Local_257[iVar0 /*29*/].f_13=15;
}}
iVar0++;
}}
...
if(func_318(iVar0)){
if(func_387(Local_257[iParam0 /*29*/].f_28)){
TASK::CLEAR_PED_TASKS(iVar0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iVar0, 1);
TASK::OPEN_SEQUENCE_TASK(&(Local_257[iParam0 /*29*/].f_14));
TASK::TASK_ENTER_VEHICLE(0, Local_257[iParam0 /*29*/].f_28, 60000, -1, 1f, 1, 0);
TASK::TASK_VEHICLE_DRIVE_WANDER(0, Local_257[iParam0 /*29*/].f_28, 60f, 786468);
TASK::CLOSE_SEQUENCE_TASK(Local_257[iParam0 /*29*/].f_14);
TASK::TASK_PERFORM_SEQUENCE(iVar0, Local_257[iParam0 /*29*/].f_14);
PED::SET_PED_KEEP_TASK(iVar0, 1);
TASK::CLEAR_SEQUENCE_TASK(&(Local_257[iParam0 /*29*/].f_14));
}
Local_257[iParam0 /*29*/].f_2=1;
}}


Vector3 func__378(int iParam0){
struct<3> Var0;
struct<3> Var1;
if(func_387(iParam0)){
Var0={
...
if(func_318(Local_257[iParam0 /*29*/].f_12)){
TASK::CLEAR_PED_TASKS(Local_257[iParam0 /*29*/].f_12);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_257[iParam0 /*29*/].f_12, 1);
if(func_387(Local_257[iParam0 /*29*/].f_28)){
if(PED::IS_PED_IN_VEHICLE(Local_257[iParam0 /*29*/].f_12, Local_257[iParam0 /*29*/].f_28, 0)){
TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_257[iParam0 /*29*/].f_12, Local_257[iParam0 /*29*/].f_28, Local_257[iParam0 /*29*/].f_19, 80f, 1, 0, 786469, 5f, 2f);
Local_257[iParam0 /*29*/].f_13=14;
}else{
TASK::TASK_SMART_FLEE_COORD(Local_257[iParam0 /*29*/].f_12, Local_356, 10000f, -1, 0, 0);
Local_257[iParam0 /*29*/].f_13=13;
}}
Local_257[iParam0 /*29*/].f_2=1;
PED::SET_PED_KEEP_TASK(Local_257[iParam0 /*29*/].f_12, 1);
}else{
...
iLocal_276=1;
}}elseif(MISC::GET_GAME_TIMER() > iLocal_316){
if(func_382() && !func_227()){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_CARH", 7, 0, 0, 0)){
iLocal_276=0;
}}
iLocal_276=0;
}}
...
if(func_318(iLocal_346)){
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_346, 1) 
};
if(func_383(PLAYER::PLAYER_PED_ID(), iLocal_346, 0) <=10f && MISC::ABSF((Var0.f_2 - Var1.f_2)) < 1.5f){
return 1;
}}}
return 0;
}
...
float func_383(int iParam0, int iParam1, int iParam2){
struct<3> Var0;
struct<3> Var1;
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
Var0={
...
if(!ENTITY::IS_ENTITY_DEAD(Local_257[iParam0 /*29*/].f_28, 0)){
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(Local_257[iParam0 /*29*/].f_28, 0);
}
...
if(ENTITY::DOES_ENTITY_EXIST(Local_257[iParam0 /*29*/].f_28) && !ENTITY::IS_ENTITY_DEAD(Local_257[iParam0 /*29*/].f_28, 0)){
if(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_257[iParam0 /*29*/].f_28, 1, 0)){
Local_257[iParam0 /*29*/].f_22={
2.5f, 3f, 0f 
};
Local_257[iParam0 /*29*/].f_5=90f;
return 1;
}elseif(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_257[iParam0 /*29*/].f_28, 5, 0)){
Local_257[iParam0 /*29*/].f_22={
2.5f, -3f, 0f 
};
Local_257[iParam0 /*29*/].f_5=90f;
return 1;
}elseif(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_257[iParam0 /*29*/].f_28, 4, 0)){
Local_257[iParam0 /*29*/].f_22={
-2.5f, -3f, 0f 
};
Local_257[iParam0 /*29*/].f_5=-90f;
return 1;
}elseif(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_257[iParam0 /*29*/].f_28, 0, 0)){
Local_257[iParam0 /*29*/].f_22={
-2.5f, 3f, 0f 
};
Local_257[iParam0 /*29*/].f_5=-90f;
...
if(ENTITY::DOES_ENTITY_EXIST(Local_257[iParam0 /*29*/].f_12)){
if(ENTITY::IS_ENTITY_DEAD(Local_257[iParam0 /*29*/].f_12, 0) || !ENTITY::IS_ENTITY_DEAD(Local_257[iParam0 /*29*/].f_12, 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iParam0 /*29*/].f_12, PLAYER::PLAYER_PED_ID(), 1)){
func_379(iParam0);
}}}}
...
func_365();
if(iLocal_299[14]){
fVar0=(300f / to_float(iLocal_334));
iVar1=ceil(fVar0);
...
void func_391(){
if(bLocal_290){
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_257[0 /*29*/].f_9);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_257[1 /*29*/].f_9);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_257[2 /*29*/].f_9);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_257[3 /*29*/].f_9);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_257[4 /*29*/].f_9);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_257[0 /*29*/].f_10);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_257[1 /*29*/].f_10);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_257[2 /*29*/].f_10);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_257[3 /*29*/].f_10);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_257[4 /*29*/].f_10);
...
iLocal_253=13;
MISC::CLEAR_AREA_OF_VEHICLES(Local_374, 50f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(Local_372, 50f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(Local_373, 50f, 0, 0, 0, 0, 0, 0, 0);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
func_390();
func_364();
func_363();
...
func_395();
if(!func_216()){
func_233(PLAYER::PLAYER_PED_ID(), Local_356, fLocal_303, 0, 1);
func_362();
}
iLocal_255=2;
}
...
void func_396(){
func_397();
STREAMING::REQUEST_MODEL(Local_257[0 /*29*/].f_9);
STREAMING::REQUEST_MODEL(Local_257[1 /*29*/].f_9);
STREAMING::REQUEST_MODEL(Local_257[2 /*29*/].f_9);
STREAMING::REQUEST_MODEL(Local_257[3 /*29*/].f_9);
STREAMING::REQUEST_MODEL(Local_257[4 /*29*/].f_9);
STREAMING::REQUEST_MODEL(Local_257[0 /*29*/].f_10);
STREAMING::REQUEST_MODEL(Local_257[1 /*29*/].f_10);
STREAMING::REQUEST_MODEL(Local_257[2 /*29*/].f_10);
STREAMING::REQUEST_MODEL(Local_257[3 /*29*/].f_10);
STREAMING::REQUEST_MODEL(Local_257[4 /*29*/].f_10);
STREAMING::REQUEST_MODEL(iLocal_343);
while ((((((((((!STREAMING::HAS_MODEL_LOADED(Local_257[0 /*29*/].f_9) || !STREAMING::HAS_MODEL_LOADED(Local_257[1 /*29*/].f_9)) || !STREAMING::HAS_MODEL_LOADED(Local_257[2 /*29*/].f_9)) || !STREAMING::HAS_MODEL_LOADED(Local_257[3 /*29*/].f_9)) || !STREAMING::HAS_MODEL_LOADED(Local_257[4 /*29*/].f_9)) || !STREAMING::HAS_MODEL_LOADED(Local_257[0 /*29*/].f_10)) || !STREAMING::HAS_MODEL_LOADED(Local_257[1 /*29*/].f_10)) || !STREAMING::HAS_MODEL_LOADED(Local_257[2 /*29*/].f_10)) || !STREAMING::HAS_MODEL_LOADED(Local_257[3 /*29*/].f_10)) || !STREAMING::HAS_MODEL_LOADED(Local_257[4 /*29*/].f_10)) || !STREAMING::HAS_MODEL_LOADED(iLocal_343)){
wait(0);
}
bLocal_290=true;
}
...
void func_397(){
Local_257[0 /*29*/]={
func_398(joaat("habanero"), 1155.058f, 3533.135f, 33.9186f, 34.9236f, joaat("a_m_y_hippy_01"), Local_372) 
};
Local_257[1 /*29*/]={
func_398(joaat("dubsta"), 1655.803f, 3492.451f, 35.5714f, 105.5303f, joaat("a_m_m_salton_01"), Local_373) 
};
Local_257[2 /*29*/]={
func_398(joaat("patriot"), 1516.076f, 3376.604f, 36.6333f, 359.8644f, joaat("a_m_m_hillbilly_01"), Local_373) 
};
Local_257[3 /*29*/]={
func_398(joaat("rebel"), 1140.058f, 3533.135f, 33.9186f, 269f, joaat("a_m_m_salton_01"), Local_372) 
};
Local_257[4 /*29*/]={
func_398(joaat("sadler"), 1508.076f, 3372.604f, 36.6333f, 359.8644f, joaat("a_m_y_hippy_01"), Local_373) 
};
}
struct<29> func_398(int iParam0, struct<3> Param1, float fParam2, int iParam3, struct<3> Param4){
struct<29> Var0;
Var0.f_9=iParam0;
Var0.f_16={
Param1 
...
void func_399(){
int iVar0;
OBJECT::SET_FORCE_OBJECT_THIS_FRAME(Local_357, fLocal_313);
OBJECT::SET_FORCE_OBJECT_THIS_FRAME(Local_358, fLocal_313);
VEHICLE::SET_VEHICLE_DENSITY_MULTIPLIER_THIS_FRAME(0f);
PED::SET_SCENARIO_PED_DENSITY_MULTIPLIER_THIS_FRAME(0f, 0f);
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==4){
PED::SET_PED_MAX_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID(), 1f);
...
iVar0=0;
while (iVar0 < 5){
func_372(Local_257[iVar0 /*29*/].f_28);
iVar0++;
}
func_400();
if(bLocal_281){
...
void func_400(){
if(!PED::IS_PED_INJURED(iLocal_346) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(!bLocal_281){
if(!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_346, PLAYER::PLAYER_PED_ID(), Local_382, 0, 1, 0) || INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) !=0){
if(!PED::IS_PED_FALLING(iLocal_346)){
bLocal_281=true;
}}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_346, PLAYER::PLAYER_PED_ID(), Local_383, 0, 1, 0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==0){
...
if(!bLocal_281){
func_8(&iLocal_261);
iLocal_260=func_402(Local_355, 5, 1);
func_329("HT_NXTLOC");
iLocal_252=9;
}
if(func_371()){
...
if(!iLocal_291){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_355, 50f, 50f, 50f, 0, 1, 0)){
func_405();
iLocal_291=1;
}}else{
PED::SET_SCENARIO_PED_DENSITY_MULTIPLIER_THIS_FRAME(0f, 0f);
...
if(!bLocal_281){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_355, 5f, 5f, 5f, 0, 1, 0) && func_404(1077936128, 1)){
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_372, Local_373, 0, 1);
func_8(&iLocal_260);
func_395();
func_2();
func_361();
...
void func_405(){
PED::ADD_SCENARIO_BLOCKING_AREA(Local_399, Local_400, 0, 1, 1, 1);
PED::SET_PED_NON_CREATION_AREA(Local_399, Local_400);
MISC::CLEAR_AREA_OF_PEDS(Local_410, 5f, 0);
}
...
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_424, 1);
}
if(iLocal_334 <=3){
func_392(769, 3, 1);
}
...
OBJECT::SET_FORCE_OBJECT_THIS_FRAME(Local_357, fLocal_313);
OBJECT::SET_FORCE_OBJECT_THIS_FRAME(Local_358, fLocal_313);
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_359, Local_360, 7f, 1, 1, 0)){
if(iLocal_299[1]){
iLocal_288=0;
...
OBJECT::SET_FORCE_OBJECT_THIS_FRAME(Local_357, fLocal_313);
OBJECT::SET_FORCE_OBJECT_THIS_FRAME(Local_358, fLocal_313);
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_359, Local_360, 7f, 0, 1, 0)){
func_331();
func_414();
func_393();
if(!func_227() || MISC::GET_PROFILE_SETTING(203)==0){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && (ENTITY::IS_ENTITY_AT_COORD(iLocal_346, Local_366, 2f, 2f, 2f, 0, 1, 0) || iLocal_336 >=3)){
if(!bLocal_292){
if(iLocal_336 >=3){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_346, Local_366, 2f, 2f, 2f, 0, 1, 0)){
func_230(1);
}
iLocal_252=8;
}}else{
...
Local_256[iVar0 /*10*/].f_9=func_411(Local_256[iVar0 /*10*/]);
HUD::SET_BLIP_COLOUR(Local_256[iVar0 /*10*/].f_9, 1);
}}}
iVar0++;
}}
...
float func_413(bool bParam0, float fParam1, float fParam2){
if(bParam0){
return fParam1;
}
return fParam2;
...
if(func_334(Local_256[iVar0 /*10*/])){
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_256[iVar0 /*10*/]);
iLocal_336++;
}else{
bLocal_292=true;
}
...
if(ENTITY::DOES_ENTITY_EXIST(Local_256[iParam0 /*10*/]) && !Local_256[iParam0 /*10*/].f_7){
Local_256[iParam0 /*10*/].f_5=ENTITY::GET_ENTITY_HEALTH(Local_256[iParam0 /*10*/]);
if(Local_256[iParam0 /*10*/].f_5 < 100){
func_2();
Local_256[iParam0 /*10*/].f_7=1;
iLocal_275=0;
func_8(&(Local_256[iParam0 /*10*/].f_9));
OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(Local_256[iParam0 /*10*/], 1, 0);
}}}
...
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
if(!func_216()){
func_233(PLAYER::PLAYER_PED_ID(), Local_354, fLocal_302, 0, 1);
}
func_8(&iLocal_260);
func_232(1);
...
void func_417(){
MISC::CLEAR_AREA_OF_PEDS(Local_401, 3f, 0);
PED::SET_PED_NON_CREATION_AREA(Local_402, Local_403);
MISC::CLEAR_AREA_OF_PEDS(Local_404, 3f, 0);
PED::SET_PED_NON_CREATION_AREA(Local_405, Local_406);
MISC::CLEAR_AREA_OF_PEDS(Local_407, 3f, 0);
PED::SET_PED_NON_CREATION_AREA(Local_408, Local_409);
}
...
iVar0=0;
while (iVar0 < 3){
MISC::CLEAR_AREA_OF_OBJECTS(Local_256[iVar0 /*10*/].f_1, 2f, 0);
Local_256[iVar0 /*10*/]=OBJECT::CREATE_OBJECT(iLocal_338, Local_256[iVar0 /*10*/].f_1, 1, 1, 0);
if(ENTITY::DOES_ENTITY_EXIST(Local_256[iVar0 /*10*/])){
ENTITY::SET_ENTITY_HEADING(Local_256[iVar0 /*10*/], Local_256[iVar0 /*10*/].f_4);
OBJECT::SET_OBJECT_TARGETTABLE(Local_256[iVar0 /*10*/], 0);
ENTITY::SET_ENTITY_HEALTH(Local_256[iVar0 /*10*/], 100, 0);
ENTITY::SET_ENTITY_DYNAMIC(Local_256[iVar0 /*10*/], 1);
Local_256[iVar0 /*10*/].f_7=0;
Local_256[iVar0 /*10*/].f_8=0;
}
iVar0++;
}
if(((ENTITY::DOES_ENTITY_EXIST(Local_256[0 /*10*/]) && ENTITY::DOES_ENTITY_EXIST(Local_256[1 /*10*/])) && ENTITY::DOES_ENTITY_EXIST(Local_256[2 /*10*/])) && func_419()){
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_338);
iLocal_269=0;
return 1;
}}
...
int func_419(){
iLocal_333=MISC::GET_RANDOM_INT_IN_RANGE(0, 3);
if(ENTITY::DOES_ENTITY_EXIST(Local_256[iLocal_333 /*10*/])){
...
while (!STREAMING::HAS_MODEL_LOADED(iLocal_338)){
wait(0);
}
iLocal_269=1;
}
...
if(HUD::DOES_BLIP_EXIST(iLocal_261)){
if(!HUD::IS_BLIP_FLASHING(iLocal_261)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_346, PLAYER::PLAYER_PED_ID(), Local_382, 0, 1, 0)){
func_2();
func_324(1, 0);
func_329("HT_BKHTER");
}}else{
...
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_346, PLAYER::PLAYER_PED_ID(), Local_383, 0, 1, 0)){
func_324(1, 0);
if(func_408("HT_BKHTER", 0, 0)){
HUD::CLEAR_PRINTS();
}
...
if(!func_216()){
func_233(PLAYER::PLAYER_PED_ID(), Local_378, fLocal_379, 0, 1);
func_362();
}
func_232(1);
MISC::CLEAR_AREA_OF_VEHICLES(Local_377, 2f, 0, 0, 0, 0, 0, 0, 0);
func_7();
iLocal_255=2;
}
break;
...
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_346, sLocal_353, 0, 0, 0);
CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_353, PLAYER::PLAYER_PED_ID(), 0);
iLocal_345=func_446(iLocal_346, joaat("weapon_sniperrifle"), 1, 0, 0, 0, 0, 0, 0);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_345)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_345, "Daves_Rifle", 0, 0, 0);
}
func_445();
...
func_439(Local_384, Local_385, 5f, Local_392, fLocal_312, 1, 1, 1, 0, 0);
func_439(Local_386, Local_387, 5f, Local_392, fLocal_312, 1, 1, 1, 0, 0);
func_439(Local_388, Local_389, 5f, Local_392, fLocal_312, 1, 1, 1, 0, 0);
func_439(Local_390, Local_391, 5f, Local_392, fLocal_312, 1, 1, 1, 0, 0);
if(func_234(iLocal_424)){
ENTITY::SET_ENTITY_COORDS(iLocal_424, 1806.732f, 3934.353f, 33.3275f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_424, 76.1155f);
}
func_435(Local_377, 1, 0, 1, 1, 1, 1, 1, 1, 1, 1);
iLocal_318++;
}
break;
case 1:
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_353, joaat("p_cletus_necklace_s"))){
if(!bLocal_274){
...
WEAPON::GIVE_WEAPON_OBJECT_TO_PED(iLocal_345, PLAYER::PLAYER_PED_ID());
}
...
if(!bLocal_274){
func_233(iLocal_346, Local_371, fLocal_310, 0, 1);
WEAPON::REMOVE_WEAPON_FROM_PED(iLocal_346, joaat("weapon_sniperrifle"));
TASK::CLEAR_PED_TASKS(iLocal_346);
iLocal_253=2;
}}
if(func_318(PLAYER::PLAYER_PED_ID())){
...
void func_426(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6){
if(bParam0){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_431(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
int func_433(int iParam0, var uParam1, var uParam2, int iParam3){
int iVar0;
iVar0=0;
...
void func_435(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
int iVar0;
iVar0=PLAYER::GET_PLAYER_INDEX();
...
void func_439(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
func_440(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}
...
if(func_441(iVar0, Param0, Param1, fParam2)){
bVar1=true;
}}}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
...
int func_441(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
if(((((((((((((((func_442(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_442(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_442(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_442(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_442(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_442(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_442(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_442(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_442(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_442(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_442(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_442(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_442(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_442(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_442(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_442(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4)){
return 1;
}}
return 0;
}

int func_442(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
int func_446(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8){
int iVar0;
var uVar1;
int iVar2;
int iVar3;
...
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
if(WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_265(iVar2, iVar6))){
if(func_449(func_265(iVar2, iVar6))){
uVar7=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_265(iVar2, iVar6));
}}}
iVar6++;
}
...
WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_265(iVar2, iVar8));
func_447(uVar1, func_265(iVar2, iVar8));
}}
iVar8++;
}
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
...
if(!func_453(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
int func_453(int iParam0, int iParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6){
...
void func_456(){
if(!CAM::IS_GAMEPLAY_HINT_ACTIVE() && func_383(PLAYER::PLAYER_PED_ID(), iLocal_346, 1) > 3f){
iLocal_323=MISC::GET_GAME_TIMER() + 2000;
if(func_318(iLocal_346)){
if(func_318(PLAYER::PLAYER_PED_ID())){
}
CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_346, 0f, 0f, 0f, 1, 13000, 2000, 2000, 0);
CAM::SET_GAMEPLAY_HINT_FOV(fLocal_304);
CAM::SET_GAMEPLAY_HINT_FOLLOW_DISTANCE_SCALAR(fLocal_305);
CAM::SET_GAMEPLAY_HINT_BASE_ORBIT_PITCH_OFFSET(fLocal_306);
CAM::SET_GAMEPLAY_HINT_CAMERA_RELATIVE_SIDE_OFFSET(fLocal_307);
CAM::SET_GAMEPLAY_HINT_CAMERA_RELATIVE_VERTICAL_OFFSET(fLocal_308);
CAM::SET_GAMEPLAY_HINT_CAMERA_BLEND_TO_FOLLOW_PED_MEDIUM_VIEW_MODE(1);
}}elseif(func_318(iLocal_346) && func_318(PLAYER::PLAYER_PED_ID())){
if(MISC::GET_GAME_TIMER() > iLocal_323 || func_383(PLAYER::PLAYER_PED_ID(), iLocal_346, 1) <=3f){
if(func_383(PLAYER::PLAYER_PED_ID(), iLocal_346, 1) <=3f){
}
iLocal_318=0;
iLocal_255=0;
iLocal_252=2;
...
func_460();
if(func_318(iLocal_346)){
ENTITY::SET_ENTITY_LOD_DIST(iLocal_346, 200);
TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_346, 0);
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_346, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_346, 169, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_346, 206, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_346, 32, 0);
PED::SET_PED_DIES_IN_WATER(iLocal_346, 0);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_346);
PED::SET_PED_STAY_IN_VEHICLE_WHEN_JACKED(iLocal_346, 1);
PED::SET_PED_CAN_BE_DRAGGED_OUT(iLocal_346, 0);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_346, 1);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_346, 0);
PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(iLocal_346, 1);
PED::SET_PED_GET_OUT_UPSIDE_DOWN_VEHICLE(iLocal_346, 1);
}
iLocal_255=0;
if(func_538()){
...
switch (iVar0){
case 0:
func_458(Local_378, fLocal_379, 1, 0);
iLocal_252=3;
break;
case 1:
func_458(Local_354, fLocal_302, 1, 0);
iLocal_252=5;
break;
case 2:
func_458(Local_356, fLocal_303, 1, 0);
iLocal_252=12;
break;
case 3:
func_458(Local_375, fLocal_376, 1, 0);
iLocal_252=16;
break;
case 4:
func_458(Local_413, fLocal_414, 1, 0);
iLocal_252=20;
break;
case 5:
func_458(Local_413, fLocal_414, 1, 0);
...
iLocal_272=1;
uLocal_335=WEAPON::GET_PED_AMMO_BY_TYPE(PLAYER::PLAYER_PED_ID(), joaat("AMMO_SNIPER"));
}}
...
void func_466(){
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() !=4){
if((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_395, Local_396, 16f, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_397, Local_398, 19f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_399, Local_400, 19f, 0, 1, 0)){
...
ENTITY::SET_ENTITY_COORDS(iLocal_346, Local_371, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_346, fLocal_310);
iLocal_253=2;
break;
case 2:
if(func_318(iLocal_346)){
if(func_498()){
bLocal_274=true;
iLocal_332=MISC::GET_GAME_TIMER() + 5000;
WEAPON::REMOVE_WEAPON_FROM_PED(iLocal_346, joaat("weapon_sniperrifle"));
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_346, Local_366, 1f, 60000, 0.25f, 512, Local_256[iLocal_333 /*10*/].f_6);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_346, 0);
iLocal_253=4;
}}
break;
case 4:
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_346, joaat("script_task_follow_nav_mesh_to_coord"))==7){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_346, Local_366, 1.5f, 1.5f, 1.5f, 0, 1, 0)){
TASK::CLEAR_PED_TASKS(iLocal_346);
TASK::TASK_LOOK_AT_ENTITY(iLocal_346, PLAYER::PLAYER_PED_ID(), -1, 1024, 2);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_346, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_346, 1);
iLocal_253=6;
}}elseif(!iLocal_299[0]){
if(MISC::GET_GAME_TIMER() > iLocal_332){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_1", 7, 0, 0, 0)){
iLocal_299[0]=1;
}}}else{
func_497(&uLocal_434, &uLocal_87, cLocal_351, &sLocal_435, &cLocal_441);
}
break;
case 5:
if(!PED::IS_PED_INJURED(iLocal_346)){
if(WEAPON::HAS_PED_GOT_WEAPON(iLocal_346, joaat("weapon_sniperrifle"), 0)){
WEAPON::REMOVE_WEAPON_FROM_PED(iLocal_346, joaat("weapon_sniperrifle"));
}
if(func_498()){
if(ENTITY::IS_ENTITY_VISIBLE(iLocal_344)){
ENTITY::SET_ENTITY_VISIBLE(iLocal_344, 0, 0);
}
func_364();
func_363();
func_8(&iLocal_261);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_346);
ENTITY::SET_ENTITY_COORDS(iLocal_346, Local_366, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_346, fLocal_302);
iLocal_286=0;
iLocal_253=6;
}}
break;
...
if(func_419()){
iLocal_267=1;
}}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_359, Local_360, 7f, 0, 1, 0) && func_382()){
if(func_495()){
func_390();
if(func_381(&uLocal_87, cLocal_351, "HUNT1_DIARR", 7, 0, 0, 0)){
...
func_390();
func_414();
if(iLocal_288 && !func_408("HT_SHDISH", 0, 0)){
func_490(0);
}
if(iLocal_336==1 && func_489()){
if(!iLocal_297[0]){
if(func_408("HT_SHDISH", 0, 0)){
if(func_338(&uLocal_87, cLocal_351, "HUNT1_DISH", "HUNT1_DISH_1", 7, 1, 0)){
iLocal_267=0;
func_500(0);
iLocal_297[0]=1;
}}elseif(func_338(&uLocal_87, cLocal_351, "HUNT1_DISH", "HUNT1_DISH_1", 7, 0, 0)){
iLocal_267=0;
func_500(0);
iLocal_297[0]=1;
}}elseif(!func_227()){
...
elseif(iLocal_336==2 && func_489()){
if(!iLocal_297[1]){
if(func_338(&uLocal_87, cLocal_351, "HUNT1_DISH", "HUNT1_DISH_2", 7, 0, 0)){
iLocal_267=0;
func_500(0);
iLocal_297[1]=1;
}}elseif(!bLocal_264){
...
if(!iLocal_297[2]){
func_326();
if(func_381(&uLocal_87, cLocal_351, "HUNT1_1A", 7, 0, 0, 0)){
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(2f, 5f, 4);
iLocal_267=0;
iLocal_297[2]=1;
iLocal_299[3]=1;
...
if(func_381(&uLocal_87, cLocal_351, "HUNT1_LAREA", 7, 1, 0, 0)){
iLocal_299[2]=1;
}}
break;
case 8:
...
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_346, PLAYER::PLAYER_PED_ID(), Local_383, 0, 1, 0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || VEHICLE::ARE_ANY_VEHICLE_SEATS_FREE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_ENCAR", 7, 0, 0, 0)){
func_8(&iLocal_261);
func_230(1);
...
break;
case 12:
if(func_381(&uLocal_87, cLocal_351, "HUNT1_TYARR", 7, 0, 0, 0)){
if(iLocal_331==-1){
iLocal_331=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Local_393, Local_394, 0f, 0, 7);
}
func_390();
iLocal_299[9]=1;
func_230(0);
...
iLocal_326=0;
TASK::TASK_LOOK_AT_ENTITY(iLocal_346, PLAYER::PLAYER_PED_ID(), -1, 1024, 2);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_346, Local_367, 1f, 60000, 0.25f, 512, fLocal_303);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_346, 0);
iLocal_253=14;
}
break;
...
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_346);
ENTITY::SET_ENTITY_COORDS(iLocal_346, Local_367, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_346, fLocal_303);
func_390();
func_363();
func_364();
func_8(&iLocal_261);
...
case 14:
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_346, joaat("script_task_follow_nav_mesh_to_coord"))==7){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_346, Local_367, 1.25f, 1.25f, 2.5f, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_361, Local_362, 10f, 0, 1, 0)){
if(func_495()){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_HERE", 7, 0, 0, 0) || iLocal_326==1){
...
if(iLocal_280){
if(func_359()){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_TYIN", 7, 0, 0, 0)){
iLocal_280=0;
iLocal_275=0;
}}else{
iLocal_280=0;
...
if(func_338(&uLocal_87, cLocal_351, "HUNT1_TYRE", "HUNT1_TYRE_1", 7, 0, 0)){
iLocal_297[0]=1;
}
}
elseif(iLocal_336==2 && !iLocal_297[1]){
if(func_338(&uLocal_87, cLocal_351, "HUNT1_TYRE", "HUNT1_TYRE_2", 7, 0, 0)){
iLocal_297[1]=1;
}
}
elseif(iLocal_336==3){
if(!iLocal_297[2]){
if(iLocal_334 <=6 && func_381(&uLocal_87, cLocal_351, "HUNT1_TYR2", 7, 0, 0, 0)){
iLocal_297[2]=1;
}elseif(iLocal_334 <=10 && func_381(&uLocal_87, cLocal_351, "HUNT1_TRY3", 7, 0, 0, 0)){
iLocal_297[2]=1;
}elseif(func_381(&uLocal_87, cLocal_351, "HUNT1_TYR4", 7, 0, 0, 0)){
iLocal_297[2]=1;
...
iLocal_329=0;
func_468();
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_346, Local_418[0 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_346, 1);
func_324(0, 0);
iLocal_253=17;
}
break;
case 17:
PED::SET_PED_MIN_MOVE_BLEND_RATIO(iLocal_346, 1.4f);
if(!iLocal_299[15]){
if(func_382()){
if(!func_227()){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_356, 1) > 10f){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_3", 8, 0, 0, 0)){
iLocal_299[15]=1;
}}
}}}
switch (iLocal_329){
case 0:
if(func_335(iLocal_346, Local_418[0 /*3*/], 0) < 2f){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_346, Local_418[1 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
iLocal_329++;
}
break;
case 1:
if(func_335(iLocal_346, Local_418[1 /*3*/], 0) < 2f){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_346, Local_418[2 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
iLocal_329++;
}
break;
case 2:
if(func_335(iLocal_346, Local_418[2 /*3*/], 0) < 2f){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_346, Local_418[3 /*3*/], 1f, 60000, 0.25f, 0, 40000f);
iLocal_329++;
}
break;
case 3:
if(func_335(iLocal_346, Local_418[3 /*3*/], 0) < 2f){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_346, Local_368, 1f, 60000, 0.25f, 512, fLocal_309);
iLocal_329++;
}
break;
case 4:
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_346, joaat("script_task_follow_nav_mesh_to_coord"))==7 || (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_411, Local_412, 3.5f, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_346, Local_411, Local_412, 3.5f, 0, 1, 0))){
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_346, 0);
iLocal_253=18;
}
break;
...
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_346);
ENTITY::SET_ENTITY_COORDS(iLocal_346, Local_368, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_346, fLocal_369);
func_363();
func_364();
func_324(1, 0);
iLocal_253=18;
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_411, Local_412, 3.5f, 0, 1, 0) || Var0.f_2 > 41f){
if(func_381(&uLocal_87, cLocal_351, "HUNT_ROOF", 7, 0, 0, 0)){
TASK::CLEAR_PED_TASKS(iLocal_346);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_346, Local_370, 1f, 60000, 0.25f, 512, fLocal_311);
iLocal_299[16]=1;
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_346, 0);
iLocal_253=21;
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_346, joaat("script_task_turn_ped_to_face_entity")) !=1){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_346, PLAYER::PLAYER_PED_ID(), -1);
}}
break;
case 21:
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_363, Local_364, 20f, 0, 1, 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_346, joaat("script_task_follow_nav_mesh_to_coord"))==7){
if((func_381(&uLocal_87, cLocal_351, "HUNT1_COARR", 7, 0, 0, 0) || iLocal_336 > 0) || iLocal_326==1){
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 5f, 4);
iLocal_326=0;
iLocal_299[17]=1;
func_494(1, 0);
...
func_326();
iLocal_320=MISC::GET_GAME_TIMER() + 2000;
bLocal_277=true;
}
if(func_495()){
func_390();
...
if(!func_227()){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_FIRST", 7, 0, 0, 0)){
if(iLocal_279){
iLocal_279=0;
}
iLocal_299[18]=1;
...
if(!func_227()){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_SEC", 7, 0, 0, 0)){
if(iLocal_279){
iLocal_279=0;
}
iLocal_299[19]=1;
...
if(iLocal_279){
if(!func_227()){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_COYMIS", 7, 0, 0, 0)){
iLocal_279=0;
}}
}}else{
func_493();
...
func_326();
if(func_381(&uLocal_87, cLocal_351, "HUNT1_FIN", 8, 0, 0, 0)){
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 4f, 4);
func_500(0);
iLocal_253=23;
}}}
...
if(func_318(iLocal_346)){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_346);
ENTITY::SET_ENTITY_COORDS(iLocal_346, Local_415, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_346, fLocal_416);
TASK::TASK_LOOK_AT_ENTITY(iLocal_346, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
...
if(!func_227()){
if(!iLocal_299[21]){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_4", 7, 0, 0, 0)){
iLocal_299[21]=1;
}}elseif(!func_227()){
if(func_318(iLocal_346)){
TASK::CLEAR_PED_TASKS(iLocal_346);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_420, 1f, 60000, 0.25f, 0, 40000f);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_346, uLocal_349);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_349);
PED::SET_PED_KEEP_TASK(iLocal_346, 1);
}
iLocal_253=0;
}}
break;
...
if(PED::IS_PED_RAGDOLL(iLocal_346)){
func_2();
iLocal_322=MISC::GET_GAME_TIMER() + 2400;
iLocal_278=1;
}}
if(((ENTITY::IS_ENTITY_DEAD(iLocal_346, 0) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_346, PLAYER::PLAYER_PED_ID(), 1)) || WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_346, 0, 2)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_346, 0), 10f)){
func_2();
iLocal_322=MISC::GET_GAME_TIMER() + 2400;
iLocal_278=1;
}}elseif(MISC::GET_GAME_TIMER() > iLocal_322){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_346)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_346, 0)){
TASK::CLEAR_PED_TASKS(iLocal_346);
TASK::TASK_SMART_FLEE_PED(iLocal_346, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_346, 1);
func_328(2);
}else{
func_328(1);
...
void func_473(){
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_346, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(!iLocal_431){
iLocal_432=MISC::GET_GAME_TIMER() + 3000;
iLocal_431=1;
}elseif(MISC::GET_GAME_TIMER() > iLocal_432){
if(func_382()){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_TYRBAN", 7, 0, 0, 0)){
iLocal_299[10]=1;
}}}}}


void func_474(){
if(!PED::IS_PED_DEAD_OR_DYING(iLocal_346, 1) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_346, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(!iLocal_289){
iLocal_315=MISC::GET_GAME_TIMER() + 3000;
iLocal_289=1;
}elseif(MISC::GET_GAME_TIMER() > iLocal_315){
if(!func_227()){
if(!iLocal_299[8]){
if(func_476(&uLocal_87, cLocal_351, "HUNT1_BANTER", &Local_426, 7, 0, 0)){
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_426)){
Local_426={
func_475() 
};
}else{
...
bool func_476(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6){
func_350(uParam0, 145, sParam1, iParam5, iParam6, 0);
if(iParam4 > 7){
if(iParam4 < 12){
iParam4=7;
...
void func_477(){
int iVar0;
if(func_318(PLAYER::PLAYER_PED_ID()) && func_318(iLocal_346)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_346, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_234(iLocal_424)){
if(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)==iLocal_424 && PED::GET_VEHICLE_PED_IS_IN(iLocal_346, 0)==iLocal_424){
if(!iLocal_429){
iLocal_430=ENTITY::GET_ENTITY_HEALTH(iLocal_424);
iLocal_429=1;
}else{
iVar0=ENTITY::GET_ENTITY_HEALTH(iLocal_424);
if(iVar0 < iLocal_430){
func_478();
if(func_381(&uLocal_87, cLocal_351, "HUNT1_DAMCAR", 8, 0, 0, 0)){
iLocal_429=0;
}
}}}}}}}
...
if(!func_227()){
if(func_382()){
if(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)==iLocal_424){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_CLVEH", 7, 0, 0, 0)){
iLocal_299[7]=1;
}}elseif(VEHICLE::ARE_ANY_VEHICLE_SEATS_FREE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_OWNVEH", 7, 0, 0, 0)){
iLocal_299[7]=1;
}}}}}}}
...
if(!PED::IS_PED_DEAD_OR_DYING(iLocal_346, 1) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1)){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_359, Local_360, 7f, 0, 1, 0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_346, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)){
if(!iLocal_295){
if(!func_408("HT_NXTLOC", 0, 0) && iLocal_299[4]){
iLocal_330=MISC::GET_GAME_TIMER() + 20000;
iLocal_295=1;
}}elseif(MISC::GET_GAME_TIMER() > iLocal_330){
if(!func_227() && func_382()){
if(!iLocal_299[6]){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_NOVEH", 7, 0, 0, 0)){
iLocal_299[6]=1;
}
}}}}elseif(func_482("HUNT1_NOVEH")){
func_2();
}}}}
...
if(!PED::IS_PED_DEAD_OR_DYING(iLocal_346, 1) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1)){
if(!iLocal_427){
if(iLocal_300[1] && !func_408("HT_NXTLOC", 0, 0)){
iLocal_428=MISC::GET_GAME_TIMER() + 3000;
iLocal_427=1;
}}elseif(MISC::GET_GAME_TIMER() > iLocal_428){
if(!func_227() && func_382()){
if(!iLocal_299[4]){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_2", 7, 0, 0, 0)){
iLocal_299[4]=1;
}}}}}}


void func_485(){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_359, Local_360, 16f, 0, 1, 0)){
if((iLocal_300[1] && !func_408("HT_NXTLOC", 0, 0)) && !func_227()){
if(!iLocal_294){
iLocal_314=MISC::GET_GAME_TIMER() + 15000;
iLocal_294=1;
}elseif(MISC::GET_GAME_TIMER() > iLocal_314){
if(!iLocal_299[5] && func_382()){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_WAIT", 7, 0, 0, 0)){
iLocal_294=0;
}}}}}else{
iLocal_299[5]=1;
}}
...
if(!iLocal_271){
uLocal_433=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_346, 1)){
if(!VEHICLE::ARE_ANY_VEHICLE_SEATS_FREE(uLocal_433)){
if(func_382()){
if(!func_227()){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_NOCAR", 7, 0, 0, 0)){
iLocal_271=1;
}
}}}}}}else{
iLocal_271=0;
...
int func_487(){
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_346, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_346, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3)){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_344)){
TASK::CLEAR_PED_TASKS(iLocal_346);
return 1;
}else{
OBJECT::DELETE_OBJECT(&iLocal_344);
}}elseif(!ENTITY::DOES_ENTITY_EXIST(iLocal_344)){
TASK::CLEAR_PED_TASKS(iLocal_346);
return 1;
}
return 0;
...
iVar0=0;
while (iVar0 < 3){
if(MISC::IS_BULLET_IN_AREA(Local_256[iVar0 /*10*/].f_1, 10f, 1)){
if(!func_227()){
if(!func_408("HT_SHDISH", 0, 0) || MISC::GET_PROFILE_SETTING(203)==0){
if(!Local_256[iVar0 /*10*/].f_7){
if(func_381(&uLocal_87, cLocal_351, "HUNT_MISS", 7, 0, 0, 0)){
iLocal_275=0;
}}}}}
iVar0++;
}
...
if(!func_227()){
if(!func_408("HT_SHDISH", 0, 0) || MISC::GET_PROFILE_SETTING(203)==0){
if(func_381(&uLocal_87, cLocal_351, "HUNT_MISS2", 6, 0, 0, 0)){
iLocal_275=0;
}}}}}
...
if(((iLocal_336 < 3 && !func_408("HT_SHDISH", 0, 0)) && !func_408("HT_SHTYRE", 0, 0)) && !func_408("HT_SHCOY", 0, 0)){
if(iLocal_275){
if(MISC::GET_GAME_TIMER() > iLocal_324){
if(MISC::ARE_STRINGS_EQUAL(sVar0, "HUNT1_DIIN")){
if((func_359() || iLocal_321 > 2) || iLocal_336==0){
if(func_381(&uLocal_87, cLocal_351, sVar0, 7, 0, 0, 0)){
iLocal_275=0;
}}else{
switch (iLocal_321){
case 0:
if(func_381(&uLocal_87, cLocal_351, "HUNT1_SAT", 7, 0, 0, 0)){
iLocal_275=0;
iLocal_321++;
}
break;
case 1:
if(func_381(&uLocal_87, cLocal_351, "HUNT1_SAT2", 7, 0, 0, 0)){
iLocal_275=0;
iLocal_321++;
}
break;
case 2:
if(func_381(&uLocal_87, cLocal_351, "HUNT1_SAT3", 7, 0, 0, 0)){
iLocal_275=0;
iLocal_321++;
}
break;
}}}elseif(MISC::ARE_STRINGS_EQUAL(sVar0, "HUNT_TYIN")){
if((func_359() || iLocal_337 > 2) || iLocal_336==0){
if(func_381(&uLocal_87, cLocal_351, sVar0, 7, 0, 0, 0)){
iLocal_275=0;
}}else{
switch (iLocal_337){
case 0:
if(func_381(&uLocal_87, cLocal_351, "HUNT1_BANT1", 7, 0, 0, 0)){
iLocal_275=0;
iLocal_337++;
}
break;
case 1:
if(func_381(&uLocal_87, cLocal_351, "HUNT1_BANT2", 7, 0, 0, 0)){
iLocal_275=0;
iLocal_337++;
}
break;
case 2:
if(func_381(&uLocal_87, cLocal_351, "HUNT1_BANT3", 7, 0, 0, 0)){
iLocal_275=0;
iLocal_337++;
}
break;
}}}elseif(func_359() || iLocal_425 > 2){
if(func_381(&uLocal_87, cLocal_351, sVar0, 7, 0, 0, 0)){
iLocal_275=0;
}}else{
switch (iLocal_425){
case 0:
if(func_381(&uLocal_87, cLocal_351, "HUNT1_COYB1", 7, 0, 0, 0)){
iLocal_275=0;
iLocal_425++;
}
break;
case 1:
if(func_381(&uLocal_87, cLocal_351, "HUNT1_COYB2", 7, 0, 0, 0)){
iLocal_275=0;
iLocal_425++;
}
break;
case 2:
if(func_381(&uLocal_87, cLocal_351, "HUNT1_COYB3", 7, 0, 0, 0)){
iLocal_275=0;
iLocal_425++;
}
break;
}}}}elseif(!func_227()){
iLocal_325=MISC::GET_RANDOM_INT_IN_RANGE(10000, 15000);
iLocal_324=(MISC::GET_GAME_TIMER() + iLocal_325);
iLocal_275=1;
}}}
...
if(iLocal_267){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_346, Local_366, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !PED::IS_PED_HEADING_TOWARDS_POSITION(iLocal_346, Local_256[iLocal_333 /*10*/].f_1, 30f)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_346, joaat("script_task_follow_nav_mesh_to_coord")) !=1 || TASK::GET_SCRIPT_TASK_STATUS(iLocal_346, joaat("script_task_follow_nav_mesh_to_coord")) !=7){
iLocal_326=1;
}}
}
break;
case 1:
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_346, Local_367, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_492(iLocal_346, fLocal_303, 30f)){
iLocal_326=1;
}
break;
case 2:
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_346, Local_370, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_492(iLocal_346, fLocal_311, 30f)){
iLocal_326=1;
}
break;
}
...
int func_492(int iParam0, float fParam1, float fParam2){
float fVar0;
float fVar1;
...
if(!iLocal_286){
if(func_381(&uLocal_87, cLocal_351, "HUNT1_UGUN", 9, 0, 0, 0)){
iLocal_286=1;
iLocal_285=0;
}}}elseif(!iLocal_285){
if(func_381(&uLocal_87, cLocal_351, "HUNT_UGUN2", 9, 0, 0, 0)){
iLocal_285=1;
iLocal_286=0;
}}}}}
...
if(bParam1){
TASK::TASK_TURN_PED_TO_FACE_COORD(0, Local_256[iLocal_333 /*10*/].f_1, 0);
}
if(bParam0){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_346, uVar0);
...
void func_497(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4){
switch (*uParam0){
case 0:
break;
case 1:
...
int func_498(){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_344) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_344, iLocal_346)){
return 1;
}
if(!iLocal_263){
func_499();
...
if(func_318(iLocal_346)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_346, "ODDJOBS@HUNTER", "BINOCULARS_LOOP", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_346, "ODDJOBS@HUNTER", "BINOCULARS_INTRO", 3)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_346, 1);
TASK::TASK_CLEAR_LOOK_AT(iLocal_346);
TASK::OPEN_SEQUENCE_TASK(&uVar0);
...
int iVar1;
iVar1=0;
if(func_318(iLocal_346) && func_318(PLAYER::PLAYER_PED_ID())){
if(func_472()){
iVar1=0;
while (iVar1 < func_471()){
if(ENTITY::DOES_ENTITY_EXIST(func_470(iVar1))){
iVar0=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(func_470(iVar1));
if(iVar0 !=PLAYER::PLAYER_PED_ID() && iVar0 !=iLocal_346){
...
iVar1=0;
while (iVar1 < 5){
if(ENTITY::DOES_ENTITY_EXIST(Local_257[iVar1 /*29*/].f_12)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_257[iVar1 /*29*/].f_12, PLAYER::PLAYER_PED_ID(), 1)){
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_257[iVar1 /*29*/].f_12);
iLocal_319++;
}}
iVar1++;
}
if(iLocal_319==1){
if(!iLocal_299[13]){
if(func_338(&uLocal_87, cLocal_351, "HUNT1_INOC", "HUNT1_INOC_1", 8, 0, 0)){
iLocal_299[13]=1;
}}}elseif(iLocal_319 > 1){
if(!bParam0){
if(!func_227()){
...
void func_502(){
if(!PED::IS_PED_INJURED(iLocal_346)){
if(((MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_346, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_346, 0) - Vector(2f, 2f, 2f), joaat("weapon_grenade"), 0) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_346, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_346, 0) - Vector(2f, 2f, 2f), joaat("weapon_stickybomb"), 0)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_346, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_346, 0) - Vector(2f, 2f, 2f), joaat("weapon_molotov"), 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_346, 0), 10f)){
PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_259, joaat("player"));
}
if(!iLocal_270){
if(func_504() || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_346)){
if(func_227()){
func_326();
}
func_503(&uLocal_87, cLocal_351, "HUNT1_PTREAC", 6, 0, 0);
iLocal_270=1;
}}
if(!bLocal_296){
if(PED::IS_PED_FALLING(iLocal_346)){
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_346, 0);
bLocal_296=true;
}}elseif(TASK::IS_PED_GETTING_UP(iLocal_346)){
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_346, 1);
bLocal_296=false;
}}}


void func_503(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5){
...
if(func_318(iLocal_346)){
if(iLocal_253 !=25){
if((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) && func_383(iLocal_346, PLAYER::PLAYER_PED_ID(), 1) <=3f){
return 1;
}}elseif(((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) && PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_346, 30f)) && func_383(iLocal_346, PLAYER::PLAYER_PED_ID(), 1) <=2f){
return 1;
}}
return 0;
}
...
void func_505(){
if(!PED::IS_PED_INJURED(iLocal_346)){
if((ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_346, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_346, "ODDJOBS@HUNTER", "BINOCULARS_OUTRO") >=0.68f) || iLocal_326==1){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_344)){
OBJECT::DELETE_OBJECT(&iLocal_344);
}}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_344)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_346, "ODDJOBS@HUNTER", "binoculars_intro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_346, "ODDJOBS@HUNTER", "binoculars_intro") >=0.242f){
iLocal_344=OBJECT::CREATE_OBJECT(iLocal_340, ENTITY::GET_ENTITY_COORDS(iLocal_346, 1), 0, 0, 0);
}}elseif(!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_344, iLocal_346)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_344, iLocal_346, PED::GET_PED_BONE_INDEX(iLocal_346, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}}


void func_506(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_508(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
break;
default:
StringCopy(&Var0, func_509(iVar1), 8);
break;
}
break;
default:
...
void func_523(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5){
...
void func_524(){
if(!iLocal_282){
PED::ADD_RELATIONSHIP_GROUP("FRIENDLIES", &iLocal_259);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_346, iLocal_259);
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_259, -2065892691);
...
func_528(&(uParam0->f_35[0]), 1806.732f, 3934.353f, 33.3275f, 76.1155f, 0);
...
void func_528(var uParam0, struct<3> Param1, float fParam2, int iParam3){
func_529(uParam0, iLocal_77, Param1, fParam2);
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
void func_529(var uParam0, int iParam1, struct<3> Param2, var uParam3){
func_530(uParam0);
...
int func_531(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_532(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
int func_532(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_161(iParam1)){
...
iVar2=func_312(SCRIPT::GET_THIS_SCRIPT_NAME());
if(iVar2 > -1){
