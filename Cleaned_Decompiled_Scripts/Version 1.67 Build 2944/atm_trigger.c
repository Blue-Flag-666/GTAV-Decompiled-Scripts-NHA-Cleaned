...
iVar0=0;
if(!ENTITY::DOES_ENTITY_EXIST(iScriptParam_541)){
func_99();
SCRIPT::TERMINATE_THIS_THREAD();
}
if(!ENTITY::IS_ENTITY_AN_OBJECT(iScriptParam_541)){
func_99();
SCRIPT::TERMINATE_THIS_THREAD();
}
iVar1=INTERIOR::GET_INTERIOR_FROM_ENTITY(iScriptParam_541);
if(func_98(ENTITY::GET_ENTITY_COORDS(iScriptParam_541, 1))){
func_99();
SCRIPT::TERMINATE_THIS_THREAD();
}
...
bVar2=true;
Local_506={
ENTITY::GET_ENTITY_COORDS(iScriptParam_541, 1) 
};
Local_506.f_2=(Local_506.f_2 + 1f);
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() !=4){
Local_511={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iScriptParam_541, Local_509) 
};
}else{
Local_511={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iScriptParam_541, Local_510) 
};
}
if(MISC::GET_GROUND_Z_FOR_3D_COORD(Local_511, &fVar3, 0, 0)){
Local_511.f_2=(fVar3 + 1f);
}
settimera(0);
AUDIO::HINT_SCRIPT_AUDIO_BANK("ATM", 0, -1);
while (bVar2){
iLocal_529=(iLocal_529 + round((0f + (1000f * timestep()))));
bVar4=false;
settimera(0);
if(ENTITY::DOES_ENTITY_EXIST(iScriptParam_541) && ENTITY::IS_ENTITY_AN_OBJECT(iScriptParam_541)){
if(OBJECT::HAS_OBJECT_BEEN_BROKEN(iScriptParam_541, 0)){
func_99();
SCRIPT::TERMINATE_THIS_THREAD();
}}
...
if((((((((((((((!PED::IS_PED_USING_ANY_SCENARIO(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !func_82(0)) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_506, 1f, 1f, 1f, 0, 1, 1)) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0)) && !func_81()) && !func_80(iScriptParam_541, 0)) && !func_79()) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 4f) && func_76(PLAYER::PLAYER_ID()) !=171) && !func_75(Global_4718592.f_171044)) && !func_74(Global_4718592.f_171044)) && !func_73(Global_4718592.f_171044)) && !MISC::IS_BIT_SET(Global_4718592.f_28, 1)) && !func_72(PLAYER::PLAYER_ID())){
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_506, 2f, 0)){
bVar5=false;
}
bVar6=false;
...
if(TASK::IS_SCENARIO_OCCUPIED(Local_506, 2f, 1)){
bVar6=true;
}
if(Global_78689){
...
if(!bVar6){
if(iLocal_530==-1){
func_69(&iLocal_530, 4, "FINH_ATMNEAR", 0, 0, 0, 0);
}
bVar4=true;
if(func_68(iLocal_530, 1)){
Global_44316=1;
while (!AUDIO::REQUEST_SCRIPT_AUDIO_BANK("ATM", 0, -1) && !func_63(iScriptParam_541, 1)){
wait(0);
}
wait(100);
StringCopy(&Var7, "", 64);
...
if(func_62(0, &Var7)){
TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), Local_511, 1f, 5000, ENTITY::GET_ENTITY_HEADING(iScriptParam_541), 0.25f);
iLocal_507=0;
}}
wait(100);
wait(100);
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
iLocal_516=func_61(1, 1, 1, 1);
iLocal_535=1;
if(Global_78689){
iLocal_525[NETWORK::PARTICIPANT_ID_TO_INT()]=1;
...
func_6(0, &iVar0, iScriptParam_541, bVar5);
...
iLocal_508=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_511, ENTITY::GET_ENTITY_ROTATION(iScriptParam_541, 2), 2, 0, 0, 1065353216, 0, 1065353216);
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_508, &Var7, "exit", 8f, -4f, 5, 0, 1148846080, 0);
...
iVar8=0;
while (iVar8 < 1000 && !func_63(iScriptParam_541, 1)){
iVar8=(iVar8 + round((0f + (1000f * timestep()))));
...
if(Global_78689){
iLocal_525[NETWORK::PARTICIPANT_ID_TO_INT()]=0;
}
iLocal_535=0;
}}
func_4(&iLocal_530);
...
bVar9=false;
if(ENTITY::DOES_ENTITY_EXIST(iScriptParam_541)){
if(!BRAIN::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(iScriptParam_541)){
bVar9=true;
}}else{
bVar9=true;
}
...
Global_60666=1;
bVar0=false;
iLocal_531=GRAPHICS::REQUEST_SCALEFORM_MOVIE("ATM");
iLocal_532=GRAPHICS::REQUEST_SCALEFORM_MOVIE_INSTANCE("INSTRUCTIONAL_BUTTONS");
if(func_60(uParam2)){
if(func_59(4)){
func_58(4, 0);
iLocal_534=1;
...
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_531) && !func_63(uParam2, 1)){
wait(0);
func_55();
func_54(uParam2);
}
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_532) && !func_63(uParam2, 1)){
wait(0);
func_55();
func_54(uParam2);
}
...
iLocal_528=0;
while (bVar4){
iLocal_528=(iLocal_528 + round((0f + (1000f * timestep()))));
func_39();
...
if(MISC::GET_GAME_TIMER() > iVar2){
GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_532, 255, 255, 255, 255, 0);
...
case 0:
bVar4=false;
iLocal_516=func_61(0, 1, iLocal_516, 1);
break;
case 1:
iLocal_538=1;
*iParam1=0;
...
iLocal_516=func_61(0, 1, iLocal_516, 0);
bVar4=false;
}}}
if(!bVar5){
if(!Global_78689){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_531, "SET_DATA_SLOT_EMPTY");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
func_31(iLocal_531);
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_531, "UPDATE_TEXT");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
bVar5=true;
}
...
while (iLocal_538){
iLocal_538=0;
func_25(uParam2, iLocal_531, iParam1);
}}}
if(Global_78689){
func_24(iLocal_531);
}
...
fVar2=(1f + (Global_75952 * timestep()));
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(0f);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT((to_float(iVar1) * fVar2));
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}else{
...
fVar2=(1f + (Global_75952 * timestep()));
if(!iLocal_539==iVar0 || !iLocal_540==iVar1){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_ANALOG_STICK_INPUT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(0f);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT((-to_float(iVar0) * fVar2));
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT((-to_float(iVar1) * fVar2));
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
iLocal_539=iVar0;
iLocal_540=iVar1;
...
var uVar0;
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_531, "SET_INPUT_SELECT");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_531, "GET_CURRENT_SELECTION");
uVar0=GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
while (!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uVar0) && !func_63(uParam0, 1)){
func_39();
}
iLocal_537=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uVar0);
switch (*uParam1){
case 0:
switch (iLocal_537){
case 2:
...
case 1:
func_23(uParam1, 5);
iLocal_533=func_20(0, 1);
break;
case 2:
func_23(uParam1, 5);
iLocal_533=func_20(1, 1);
break;
case 3:
func_23(uParam1, 5);
iLocal_533=func_20(2, 1);
break;
case 5:
func_23(uParam1, 5);
iLocal_533=func_20(3, 1);
break;
case 6:
func_23(uParam1, 5);
iLocal_533=func_20(4, 1);
break;
case 7:
func_23(uParam1, 5);
iLocal_533=func_20(5, 1);
break;
}}
return;
case 7:
...
case 1:
func_23(uParam1, 9);
iLocal_533=func_20(0, 0);
break;
case 2:
func_23(uParam1, 9);
iLocal_533=func_20(1, 0);
break;
case 3:
func_23(uParam1, 9);
iLocal_533=func_20(2, 0);
break;
case 5:
func_23(uParam1, 9);
iLocal_533=func_20(3, 0);
break;
case 6:
func_23(uParam1, 9);
iLocal_533=func_20(4, 0);
break;
case 7:
func_23(uParam1, 9);
iLocal_533=func_20(5, 0);
break;
}}
return;
case 5:
...
while (iVar3==1 && !func_63(uParam0, 1)){
...
iLocal_536=MONEY::WITHDRAW_VC(iParam1);
bLocal_515=true;
if(Global_78689 && NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
func_11(1920, 1, -1);
}
...
var func__13(int iParam0, var uParam1){
...
if(PAD::IS_USING_KEYBOARD_AND_MOUSE(2)){
if(fLocal_520==-1f){
fLocal_520=PAD::GET_CONTROL_NORMAL(2, 239);
fLocal_521=PAD::GET_CONTROL_NORMAL(2, 240);
}elseif(fLocal_520 !=PAD::GET_CONTROL_NORMAL(2, 239) || fLocal_521 !=PAD::GET_CONTROL_NORMAL(2, 240)){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SHOW_CURSOR");
...
void func_25(var uParam0, int iParam1, var uParam2){
int iVar0;
bool bVar1;
bool bVar2;
...
while (iVar0 > MISC::GET_GAME_TIMER() && !func_63(uParam0, 1)){
func_39();
}
func_23(uParam2, 11);
break;
...
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_20(0, 1), 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(2);
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("ESDOLLA");
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_20(1, 1), 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(3);
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("ESDOLLA");
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_20(2, 1), 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam1, "SET_DATA_SLOT");
...
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("ESDOLLA");
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_20(3, 1), 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("ESDOLLA");
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_20(4, 1), 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("ESDOLLA");
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_20(5, 1), 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(iLocal_533, 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam1, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("ESDOLLA");
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_20(0, 0), 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(2);
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("ESDOLLA");
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_20(1, 0), 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(3);
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("ESDOLLA");
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_20(2, 0), 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam1, "SET_DATA_SLOT");
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(5);
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("ESDOLLA");
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_20(3, 0), 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(6);
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("ESDOLLA");
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_20(4, 0), 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(7);
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("ESDOLLA");
HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(func_20(5, 0), 1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam1, "DISPLAY_CASH_OPTIONS");
...
while (!MONEY::HAS_VC_WITHDRAWAL_COMPLETED(iVar0) && !func_63(uParam0, 1)){
func_39();
}
while (iVar1 > MISC::GET_GAME_TIMER() && !func_63(uParam0, 1)){
func_39();
}
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(3);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(to_float(Global_60659[iVar0]));
func_30("W_BA_BAL");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
iVar1=4;
iVar2=0;
...
int iVar0;
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_532, "CLEAR_ALL");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_532, "SET_CLEAR_SPACE");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(200);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
if(MISC::IS_PC_VERSION()){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_532, "TOGGLE_MOUSE_BUTTONS");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(1);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
iVar0=0;
if(Global_78689){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_532, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
func_53(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 201, 1));
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
if(bParam1){
func_53(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 198, 1));
}else{
func_53(PAD::GET_CONTROL_GROUP_INSTRUCTIONAL_BUTTONS_STRING(2, 7, 1));
}
func_30("MPATM_NAV");
if(MISC::IS_PC_VERSION()){
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(0);
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_532, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
func_53(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 202, 1));
func_30("MPATM_EXIT");
if(MISC::IS_PC_VERSION()){
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(1);
...
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
iVar0++;
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_532, "DRAW_INSTRUCTIONAL_BUTTONS");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
iLocal_508=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_511, ENTITY::GET_ENTITY_ROTATION(uParam0, 2), 2, 0, 0, 1065353216, 0, 1065353216);
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_508, &sVar0, "enter", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_508);
...
iVar5=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iLocal_508);
if(STREAMING::HAS_ANIM_DICT_LOADED(&sVar1) && (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar5) || PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar5))){
iLocal_508=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_511, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, 0, 1, 1065353216, 0, 1065353216);
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_508, &sVar1, "base", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_508);
iLocal_507=2;
}
break;
...
iVar5=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iLocal_508);
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_508) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar5)){
iLocal_508=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_511, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, 0, 1, 1065353216, 0, 1065353216);
iVar5=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iLocal_508);
...
if((((MISC::ARE_STRINGS_EQUAL(&cLocal_512, "idle_a") && iVar6==0) || (MISC::ARE_STRINGS_EQUAL(&cLocal_512, "idle_b") && iVar6==1)) || (MISC::ARE_STRINGS_EQUAL(&cLocal_512, "idle_c") && iVar6==2)) || (MISC::ARE_STRINGS_EQUAL(&cLocal_512, "idle_d") && iVar6==3)){
iVar6++;
if(iVar6 >=iVar4){
iVar6=0;
}}
...
switch (iVar6){
case 0:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_508, &sVar2, "idle_a", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_508);
StringCopy(&cLocal_512, "idle_a", 16);
iLocal_507=3;
break;
case 1:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_508, &sVar2, "idle_b", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_508);
StringCopy(&cLocal_512, "idle_b", 16);
iLocal_507=3;
break;
case 2:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_508, &sVar2, "idle_c", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_508);
StringCopy(&cLocal_512, "idle_c", 16);
iLocal_507=3;
break;
case 3:
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_508, &sVar2, "idle_d", 4f, -2f, 5, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_508);
...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &sVar2, "idle_b", 2)){
GRAPHICS::DRAW_DEBUG_TEXT("idle_b", ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 256, 64, 64, 64);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &sVar2, "idle_c", 2)){
GRAPHICS::DRAW_DEBUG_TEXT("idle_c", ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 256, 64, 64, 64);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &sVar2, "idle_d", 2)){
...
if(bParam1){
if(!MISC::IS_BIT_SET(Global_96822, bParam0)){
MISC::SET_BIT(&Global_96822, bParam0);
}}elseif(MISC::IS_BIT_SET(Global_96822, bParam0)){
MISC::CLEAR_BIT(&Global_96822, bParam0);
}}


bool func_59(int iParam0){
return MISC::IS_BIT_SET(Global_96823, iParam0);
}
...
if(iParam1 && iLocal_528 > 1000){
if(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_506, 1.5f, 1.5f, 1.5f, 0, 1, 1)){
return 1;
}}
...
iVar1=0;
while (iVar1 < 32){
if(iLocal_525[iVar1] && NETWORK::PARTICIPANT_ID_TO_INT() !=iVar1){
return 1;
}
iVar1++;
}}
...
iLocal_527=SHAPETEST::START_SHAPE_TEST_CAPSULE(Var0, Var0 - Vector(3f, 0f, 0f), 0.33f, 2, PLAYER::PLAYER_PED_ID(), 4);
return iLocal_526;
}else{
iVar1=0;
iVar5=SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_527, &iVar1, &uVar2, &uVar3, &uVar4);
if(iVar5==2){
iLocal_526=0;
if(iVar1 !=0){
iLocal_527=0;
if(ENTITY::IS_ENTITY_A_VEHICLE(uVar4) && !NETWORK::IS_ENTITY_A_GHOST(uVar4)){
iLocal_526=1;
}}
return iLocal_526;
}else{
...
func_107(0, -1, 0);
NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_522, 35, 0);
NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&iLocal_525, 33, 0);
iVar0=0;
while (iVar0 < 32){
iLocal_522[iVar0]=-1;
iVar0++;
