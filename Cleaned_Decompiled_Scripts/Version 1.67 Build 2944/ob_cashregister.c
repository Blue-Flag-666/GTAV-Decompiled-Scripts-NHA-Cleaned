...
if(MISC::IS_BIT_SET(Global_1666708, 1)){
func_25();
}else{
...
if(ENTITY::DOES_ENTITY_EXIST(uScriptParam_19)){
if(BRAIN::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(uScriptParam_19)){
switch (iLocal_16){
case 0:
if(ENTITY::DOES_ENTITY_HAVE_DRAWABLE(uScriptParam_19)){
Local_17={
ENTITY::GET_ENTITY_COORDS(uScriptParam_19, 1) 
};
iLocal_16=1;
}
break;
case 1:
if((OBJECT::HAS_OBJECT_BEEN_BROKEN(uScriptParam_19, 0) && ENTITY::IS_ENTITY_VISIBLE(uScriptParam_19)) && !ENTITY::IS_ENTITY_A_MISSION_ENTITY(uScriptParam_19)){
func_1();
iLocal_16=2;
}
break;
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
func_2(iVar1, OBJECT::GET_SAFE_PICKUP_COORDS(Local_17, 1067030938, 1069547520), uVar2, iVar3, iVar0, 0, 0);
}else{
OBJECT::CREATE_PICKUP(iVar1, OBJECT::GET_SAFE_PICKUP_COORDS(Local_17, 1067030938, 1069547520), uVar2, iVar3, 0, iVar0);
}}
