...
while (bVar0==0){
bVar0=((MISC::GET_MISSION_FLAG()==0 && func_70()==0) && func_69(PLAYER::PLAYER_PED_ID(), Local_63, fLocal_64, 1));
func_67();
}}
func_66(65, 0);
func_65(1);
func_64(joaat("akuma"), 1);
func_64(iLocal_244, 1);
while (true){
...
uVar1=MISC::ACOS(func_56(Local_243, 0.73f, 0.683f, -0.013f));
...
func_51(&uLocal_67, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
if(func_50()){
...
uParam0->f_1=VEHICLE::CREATE_VEHICLE(joaat("akuma"), Param1, fParam2, 1, 1, 0);
...
if(PED::IS_PED_MODEL(uVar2[iVar1], iLocal_244)){
...
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var1.f_0, Var2.f_1, 0f) 
};
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Param1, Param2, fParam3, 0, 1)){
return 1;
}
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, 0f, Var2.f_1, 0f) 
};
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Param1, Param2, fParam3, 0, 1)){
return 1;
}
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var2.f_0, Var2.f_1, 0f) 
};
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Param1, Param2, fParam3, 0, 1)){
return 1;
}
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var1.f_0, Var1.f_1, 0f) 
};
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Param1, Param2, fParam3, 0, 1)){
return 1;
}
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, 0f, Var1.f_1, 0f) 
};
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Param1, Param2, fParam3, 0, 1)){
return 1;
}
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0, Var2.f_0, Var1.f_1, 0f) 
};
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var0, Param1, Param2, fParam3, 0, 1)){
return 1;
}
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
uVar2=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
uVar1=MISC::ACOS(func_56(Local_243, -0.37f, -0.927f, -0.053f));
...
if(!func_69(PLAYER::PLAYER_PED_ID(), Local_63, (fLocal_64 + 30f), 1)){
func_77();
}
wait(0);
func_75(PLAYER::PLAYER_PED_ID());
