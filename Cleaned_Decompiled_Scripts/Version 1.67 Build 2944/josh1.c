...
Global_78935=1;
iLocal_75=0;
while (!func_301(&Local_79)){
wait(0);
}
func_300(&Local_79, 0, 1);
Global_78935=0;
}
if(func_299(PLAYER::PLAYER_PED_ID())){
uLocal_260=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
}
if(func_298(Local_79.f_28[0])){
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_79.f_28[0], uLocal_260);
PED::SET_PED_CONFIG_FLAG(Local_79.f_28[0], 132, 1);
}
while (true){
RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("SF_EC", 0);
wait(0);
func_282(Local_79.f_9, 0, 0, 0, 0, 0);
switch (iLocal_80){
case 0:
func_273();
break;
...
iLocal_83=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 1, 0, 1);
}
iLocal_81=1;
}
break;
...
if((MISC::GET_GAME_TIMER() - iLocal_91) >=500){
func_236(1, 1, 1);
iLocal_90=0;
}}
if(!iLocal_92){
if(func_299(Local_79.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_83)){
uLocal_85=PED::CREATE_SYNCHRONIZED_SCENE(Local_86, Local_87, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_79.f_28[0], uLocal_85, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_83, uLocal_85, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_83);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_79.f_28[0], 1, 0);
func_248("Done Josh leadout anim");
iLocal_92=1;
}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_85)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_85) > 0.29f){
if(!iLocal_93){
func_235(&uLocal_95, 2, PLAYER::PLAYER_PED_ID(), "Trevor", 0, 1);
func_235(&uLocal_95, 5, Local_79.f_28[0], "Josh", 0, 1);
if(func_220(&uLocal_95, "JOSH1AU", "JOSH1_OUT", 8, 0, 0, 0)){
func_248("Leadout convo done");
iLocal_93=1;
}}}
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_85) > 0.98f){
...
if(func_298(Local_79.f_28[0])){
TASK::CLEAR_PED_TASKS(Local_79.f_28[0]);
func_248("Stopping Josh?");
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_83)){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_83, -8f, 1);
}
iLocal_94=1;
}
if(func_219(Local_79.f_28[0], PLAYER::PLAYER_PED_ID(), 1) > 17.5f){
if(func_298(Local_79.f_28[0])){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_79.f_28[0], -8f, 1);
TASK::CLEAR_PED_TASKS(Local_79.f_28[0]);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_83)){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_83, -8f, 1);
...
if((PED::IS_PED_INJURED(Local_79.f_28[0]) || FIRE::IS_ENTITY_ON_FIRE(Local_79.f_28[0])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_79.f_28[0], 1), 5f)){
if(func_298(Local_79.f_28[0])){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_79.f_28[0], -8f, 1);
TASK::CLEAR_PED_TASKS(Local_79.f_28[0]);
}
...
TASK::TASK_PERFORM_SEQUENCE(Local_79.f_28[0], uLocal_82);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_82);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_79.f_28[0], 0);
if(iLocal_94==0){
PED::FORCE_PED_MOTION_STATE(Local_79.f_28[0], joaat("MotionState_Walk"), 0, 0, 1);
}}
if(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0)){
OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, 0, 0f, 0);
}
...
var func__225(int iParam0, int iParam1){
...
if(func_298(Local_79.f_28[0])){
CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Josh", Local_79.f_28[0], 0);
}}
switch (iLocal_81){
case 0:
...
if(func_298(Local_79.f_28[0])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_79.f_28[0], "Josh", 0, 0, 0);
}
if(func_298(PLAYER::PLAYER_PED_ID())){
...
if(func_299(Local_79.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_83)){
uLocal_85=PED::CREATE_SYNCHRONIZED_SCENE(Local_86, Local_87, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_79.f_28[0], uLocal_85, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_83, uLocal_85, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
func_248("Done Josh leadout anim on Josh exit state");
ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_83);
PED::FORCE_PED_MOTION_STATE(Local_79.f_28[0], joaat("MotionState_Idle"), 0, 1, 1);
iLocal_92=1;
}}}
...
if(func_299(Local_79.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_83)){
uLocal_85=PED::CREATE_SYNCHRONIZED_SCENE(Local_86, Local_87, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_79.f_28[0], uLocal_85, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_83, uLocal_85, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
func_248("Done Josh leadout anim on non active cutscene");
ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_83);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_79.f_28[0], 0, 0);
iLocal_92=1;
}}
iLocal_81=2;
}
...
if(!func_271(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
if(func_299(Local_79.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_83)){
uLocal_84=PED::CREATE_SYNCHRONIZED_SCENE(Local_86, Local_87, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_79.f_28[0], uLocal_84, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_83, uLocal_84, "leadin_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_79.f_28[0], -1, 0, 2);
TASK::TASK_LOOK_AT_ENTITY(Local_79.f_28[0], PLAYER::PLAYER_PED_ID(), 4000, 2060, 2);
...
iLocal_81=2;
}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_84)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_84) > 0.15f){
if(!iLocal_89){
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_84) > 0.9f){
func_248("Leadin anim done, launch cutscene");
iLocal_81=2;
}
if(func_219(PLAYER::PLAYER_PED_ID(), Local_79.f_28[0], 1) <=2.5f){
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_271(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
void func_282(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_284(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
break;
default:
StringCopy(&Var0, func_285(iVar1), 8);
break;
}
break;
default:
...
func_304(uParam0, iLocal_77, Var0, fVar1);
...
void func_304(var uParam0, int iParam1, struct<3> Param2, float fParam3){
func_305(uParam0);
...
int func_306(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
...
int func_307(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_154(iParam1)){
...
func_326(&(Local_79.f_28[0]), 1, 1, 1);
func_315(&Local_79, 1, 0, 0);
