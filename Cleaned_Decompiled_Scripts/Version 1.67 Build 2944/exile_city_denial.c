...
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
MISC::CREATE_INCIDENT_WITH_ENTITY(11, PLAYER::PLAYER_PED_ID(), iVar0, 0f, &uLocal_31, 0, 0);
}}}
...
if(bLocal_27){
if(!MISC::IS_INCIDENT_VALID(uLocal_31)){
if(MISC::GET_NUMBER_RESOURCES_ALLOCATED_TO_WANTED_LEVEL(11) < 256){
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
MISC::CREATE_INCIDENT_WITH_ENTITY(11, PLAYER::PLAYER_PED_ID(), iVar0, 0f, &uLocal_31, 0, 0);
}}}}}
if(bLocal_27 && timerb() > 60000){
settimerb(0);
iVar0=(iVar0 + MISC::GET_RANDOM_INT_IN_RANGE(1, 2));
if(iVar0 < 8){
if(MISC::IS_INCIDENT_VALID(uLocal_31)){
MISC::SET_INCIDENT_REQUESTED_UNITS(uLocal_31, 11, iVar0);
...
bLocal_28=false;
Global_43342=0;
MISC::DELETE_INCIDENT(uLocal_31);
}
...
func_30(Global_113810.f_7691.f_137[iVar1 /*15*/].f_6);
iVar2=iVar1;
