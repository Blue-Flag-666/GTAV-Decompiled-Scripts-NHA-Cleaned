...
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_81, "rcmabigail", "loop_talk", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_81, "rcmabigail", "loop_look", 3)){
TASK::TASK_PLAY_ANIM(iLocal_81, "rcmabigail", "loop_2_cs", 8f, -8f, -1, 2, 0, 0, 0, 0);
...
case 1:
func_305();
if((func_309(iLocal_81) && ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_81, "rcmabigail", "loop_2_cs", 3)) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_81, "rcmabigail", "loop_2_cs") > 0.99f){
iLocal_85++;
}
break;
case 2:
...
if(func_309(iLocal_81)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_81, "ABIGAIL", 0, 0, 0);
}
func_295();
...
uLocal_82=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
CAM::SET_CAM_PARAMS(uLocal_82, -1606.249f, 5273.964f, 5.199186f, -1.633685f, 0f, -175.2748f, 30.16609f, 0, 1, 1, 2);
CAM::SET_CAM_PARAMS(uLocal_82, -1605.681f, 5274.014f, 3.870102f, -2.089875f, 0f, -178.064f, 30.16609f, 10000, 1, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
CAM::SHAKE_CAM(uLocal_82, "HAND_SHAKE", 0.3f);
}
...
if(func_309(iLocal_81) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Abigail", 0)){
TASK::CLEAR_PED_TASKS(iLocal_81);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_81, -1581.559f, 5198.014f, 3.0091f, 1f, 20000, 1048576000, 0, 1193033728);
}}else{
iLocal_84=MISC::GET_GAME_TIMER() + 10000;
iLocal_85++;
}
break;
case 5:
if((iLocal_87==0 && CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==4) && MISC::GET_GAME_TIMER() > (iLocal_84 - 300)){
GRAPHICS::ANIMPOSTFX_PLAY("CamPushInNeutral", 0, 0);
AUDIO::PLAY_SOUND_FRONTEND(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 1);
iLocal_87=1;
}
if(func_229(1000) || MISC::GET_GAME_TIMER() > iLocal_84){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_223(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
if(iParam2==1){
if(func_284(ENTITY::GET_ENTITY_COORDS(Global_104373.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
}}
func_239(Global_104373.f_4, Param0, fParam1, 24, 0);
}}}}
...
func_274(iParam3, &Var0, Param1, uParam2, func_277(iParam0));
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_258(iParam0, 0, 0)) || func_258(iParam0, 1, 0)) || func_258(iParam0, 2, 0)) || func_277(iParam0) !=145) || func_257(iParam0)) || func_256(iParam0)) || func_255(iParam0)) || func_254(iParam0)) || !func_243(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_256(iParam0)){
}
if(func_256(iParam0)){
}
...
iVar0=0;
while (func_259(iParam1, iVar0, &sVar1, &iVar2)){
...
return (shift_right(iParam0, 26) & 31 * func_266(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_274(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_271(&(Global_77479.f_555[0 /*21*/]), iParam0)){
...
bool func_278(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_284(struct<3> Param0, int iParam1, var uParam2, var uParam3){
int iVar0;
iVar0=func_285(Param0, iParam1, 1);
switch (iVar0){
case 0:
*uParam2={
...
void func_288(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
func_289(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}


void func_289(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, var uParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
var uVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
if(func_291(iVar0, Param0, Param1, fParam2)){
bVar1=true;
}}}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
...
int func_291(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
if(((((((((((((((func_292(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_292(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_292(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_292(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_292(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_292(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_292(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_292(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_292(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_292(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_292(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_292(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_292(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_292(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_292(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_292(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4)){
return 1;
}}
return 0;
}
...
Vector3 func__293(struct<3> Param0){
float fVar0;
float fVar1;
fVar0=vmag(Param0);
if(fVar0 !=0f){
...
if(iLocal_86==0){
if(func_309(iLocal_81)){
if(func_306(PLAYER::PLAYER_PED_ID(), iLocal_81, 1) < 4f || (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 2f && func_306(PLAYER::PLAYER_PED_ID(), iLocal_81, 1) < 6f)){
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_303(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
Var4={
func_320(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
