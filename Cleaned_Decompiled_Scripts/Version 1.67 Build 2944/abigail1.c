...
int func_33(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_78472[1 /*14*/] = { func_86(iVar0, iParam1, uVar6[iParam1], -1) };
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78472[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78472[1 /*14*/] = { func_86(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78472[1 /*14*/] = { func_86(iVar10, 14, uVar15[iVar1], -1) };
			func_52(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_68(14);
			if (Global_78470 == 1)
			{
...
{
	return (shift_right(iParam0, 26) & 31 * func_266(BitTest(iParam0, 31), -1, 1)) + 2011;
}
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_320(Global_78945, Global_78947, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
