...
func_508(&Local_39);
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_39.f_59)){
PED::TAKE_OWNERSHIP_OF_SYNCHRONIZED_SCENE(Local_39.f_59);
...
ENTITY::FREEZE_ENTITY_POSITION(iLocal_53, 0);
}
...
func_16(&uLocal_61, 3);
func_15(iLocal_56, 0);
if(!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_56)){
if(func_14(iLocal_56, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f, 1)){
AUDIO::STOP_PED_SPEAKING(iLocal_56, 0);
func_12(iLocal_56, "GENERIC_FRIGHTENED_HIGH", "MAUDE", 3);
}}}
if(func_10()){
iLocal_44=1;
}
...
if(func_10()){
iLocal_44=1;
}}elseif(func_17(iLocal_56)){
if(!func_2(iLocal_56, joaat("script_task_smart_flee_ped"))){
if(!PED::IS_PED_FLEEING(iLocal_56)){
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_56, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 3)){
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_56, 2, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_56, 64, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_56, 128, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_56, 8, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_56, 1, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_56, 32, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_56, 5, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_56, 17, 1);
TASK::TASK_SMART_FLEE_PED(iLocal_56, PLAYER::PLAYER_PED_ID(), 50f, -1, 0, 0);
...
int iVar0;
if(func_17(iLocal_56)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_56, "special_ped@maude@base", "base", 3)){
if(!PED::IS_PED_RAGDOLL(iLocal_56) || TASK::IS_PED_GETTING_UP(iLocal_56)){
STREAMING::REQUEST_ANIM_DICT("special_ped@maude@exit_flee");
if(STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@exit_flee")){
iLocal_48=PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_48, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_48, 0);
if(func_2(iLocal_56, joaat("script_task_synchronized_scene"))){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_56, -1000f, 1);
}
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_56, iLocal_48, "special_ped@maude@exit_flee", "female_Flee_Table_Left_Maude", 1000f, -4f, 4626, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_56, 0, 0);
if(func_11(iLocal_52)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_52, "special_ped@maude@base", "base_chair", 3)){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_52, -16f, 0);
}
iVar0=0;
iVar0 +=16;
iVar0 +=64;
iVar0 +=512;
iVar0 +=4096;
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_52, iLocal_48, "Female_Flee_Table_Left_Maude_Chair", "special_ped@maude@exit_flee", 16f, -4f, iVar0, 1148846080);
}
return 1;
}}else{
return 1;
...
iLocal_54=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2727.4f, 4145.56f, 43.68f, 10f, joaat("prop_table_03b"), 1, 0, 1);
if(func_11(iLocal_54)){
ENTITY::SET_ENTITY_COORDS(iLocal_54, 2727.4f, 4145.56f, 43.68f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_54, -92.17f);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_54, 1);
}}}
if(func_17(iLocal_56)){
if(!PED::IS_PED_HEADTRACKING_PED(iLocal_56, PLAYER::PLAYER_PED_ID())){
...
if(func_17(iLocal_56)){
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_56, 0) 
};
if(!func_247(0)){
if(vdist2(Var0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)) > 14400f){
if(!CAM::IS_SPHERE_VISIBLE(Var0, 2.5f) || ENTITY::IS_ENTITY_OCCLUDED(iLocal_56)){
iLocal_41=2;
}}else{
...
func_35(13, floor(Global_113810.f_10197.f_3853));
}
...
Global_78472[1 /*14*/]={
func_111(iVar0, iParam1, iParam2, -1) 
};
...
Global_78472[1 /*14*/]={
func_111(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
if(iParam5==0){
Global_78472[1 /*14*/]={
func_111(iVar10, iParam1, iParam2, -1) 
};
if(!func_101(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78472[1 /*14*/]={
func_111(iVar10, iVar0, uVar11[iVar0], -1) 
};
if(MISC::IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0)){
if(iVar0==13){
uVar12=9;
...
uVar12={
func_104(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_111(iVar10, 14, uVar12[iVar1], -1) 
};
...
Global_78472[1 /*14*/]={
func_111(iVar10, iVar0, func_67(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_111(iVar10, 14, uVar15[iVar1], -1) 
};
func_77(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
func_93(14);
if(Global_78470==1){
...
Global_78472[1 /*14*/]={
func_111(iParam0, iParam1, iParam2, -1) 
};
...
var func__96(int iParam0, var uParam1){
...
func_114(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_114(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_114(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_103(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_103(iParam1))){
return 1;
}
return 0;
}
...
func_189(&uVar1, Var0.f_3, Global_100870, iParam1, iParam2);
}}
...
}elseif(MISC::IS_PS3_VERSION() || func_197()){
...
if(MISC::GET_GAME_TIMER() - iLocal_50) > (iParam2 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000)){
...
if(func_17(iLocal_56)){
if((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_56) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(iLocal_56)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(iLocal_56)){
return 1;
}
...
if(PED::HAS_PED_RECEIVED_EVENT(iLocal_56, 61)){
return 1;
}
if(PED::IS_PED_RAGDOLL(iLocal_56)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_56, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0)){
return 1;
}}
if(PED::HAS_PED_RECEIVED_EVENT(iLocal_56, 51)){
return 1;
}
...
if(FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_56, 1), 15f)){
return 1;
}
if(PED::HAS_PED_RECEIVED_EVENT(iLocal_56, 73)){
return 1;
}
if(bParam0){
...
Vector3 func__259(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_58, iLocal_56, 0);
}}
func_358();
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_355()){
if(func_350(1, 1093140480, 0)){
func_349(&Local_39, 0, 1);
func_348(&iLocal_56, &(Local_39.f_28[0]));
func_347(&iLocal_52, &(Local_39.f_41[0]));
func_347(&iLocal_53, &(Local_39.f_41[1]));
func_346();
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), sLocal_57, 0, 0, 0);
if(func_11(iLocal_56)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_56, sLocal_58, 0, 0, 0);
}
if(func_11(iLocal_52)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_52, sLocal_59, 0, 0, 0);
}
...
if(func_11(iLocal_52)){
if(func_17(iLocal_56)){
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_58, 0) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_59, 0)){
if(STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base")){
iLocal_45=PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_45, 1);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_45, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_56, iLocal_45, "special_ped@maude@base", "base", 1000f, -8f, 4688, 0, 1148846080, 0);
iVar0=0;
iVar0=16;
iVar0=64;
iVar0=512;
iVar0=4096;
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_52, iLocal_45, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar0, 1148846080);
PED::SET_PED_KEEP_TASK(iLocal_56, 1);
}}}}
...
if(!func_11(iVar0)){
iVar0=VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(Local_227, 10f, 0, 16390);
if(!func_11(iVar0)){
return;
}}
...
case 31:
if(bParam1){
uLocal_38=PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var1, 0, 1, 1, 1);
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_38, 0);
...
if(func_338(Var2, 0)){
func_332(Var0, Var1, fVar3, 2719.87f, 4143.46f, 43.46f, 261.91f, 1, 1, 1, 0, 0);
func_282(2719.87f, 4143.46f, 43.46f, 261.91f, 0, 145);
Local_227={
2719.87f, 4143.46f, 43.46f 
};
}else{
func_332(Var0, Var1, fVar3, 2710.665f, 4149.075f, 42.7026f, 180.9488f, 1, 1, 1, 0, 0);
...
if(iParam2==1){
if(func_328(ENTITY::GET_ENTITY_COORDS(Global_104373.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
}}
func_283(Global_104373.f_4, Param0, fParam1, 24, 0);
}}}}
...
func_318(iParam3, &Var0, Param1, uParam2, func_321(iParam0));
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_302(iParam0, 0, 0)) || func_302(iParam0, 1, 0)) || func_302(iParam0, 2, 0)) || func_321(iParam0) !=145) || func_301(iParam0)) || func_300(iParam0)) || func_299(iParam0)) || func_298(iParam0)) || !func_287(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_300(iParam0)){
}
if(func_300(iParam0)){
}
...
return (shift_right(iParam0, 26) & 31 * func_310(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_318(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_315(&(Global_77479.f_555[0 /*21*/]), iParam0)){
...
bool func_322(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_328(struct<3> Param0, int iParam1, var uParam2, var uParam3){
int iVar0;
iVar0=func_329(Param0, iParam1, 1);
switch (iVar0){
case 0:
*uParam2={
...
int func_329(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
void func_332(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
func_333(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}


void func_333(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
if(func_335(iVar0, Param0, Param1, fParam2)){
bVar1=true;
}}}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
...
int func_335(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
if(((((((((((((((func_336(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_336(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_336(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_336(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_336(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_336(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_336(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_336(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_336(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_336(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_336(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_336(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_336(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_336(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_336(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_336(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4)){
return 1;
}}
return 0;
}

int func_336(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
bool func_338(struct<3> Param0, int iParam1){
return func_339(Global_104373.f_2890.f_12.f_66, Param0, iParam1);
}

int func_339(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
struct<3> Var1;
if(iParam0==0){
return 0;
...
iLocal_55=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Var0, 10f, iVar1, 1, 0, 1);
}}}}
...
void func_349(var uParam0, int iParam1, bool bParam2){
int iVar0;
iVar0=0;
while (iVar0 < 6){
...
if(!func_353(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
int func_353(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6){
...
if(!func_356(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0], 7f, 1)){
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_39.f_28[0], 0f, 0f, 0f, 1, -1, 2000, 2000, 0);
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0], 0f, 1.2f, 0f, 1f, -1, 1036831949, 1);
}
iLocal_47=MISC::GET_GAME_TIMER();
}else{
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0], 0);
}
iLocal_47=-1;
}
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0], 4000, 0, 2);
}
iLocal_46++;
}elseif(iLocal_46==1){
if((iLocal_47==-1 || (MISC::GET_GAME_TIMER() - iLocal_47) > 3000) || (func_11(Local_39.f_28[0]) && func_356(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0], 4.5f, 1))){
return 1;
}}
return 0;
}
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_353(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
if(iVar0==1){
if(!func_467(iParam4, iParam5, iParam6, iParam11)){
iVar0=0;
}}
if(iVar0==1){
func_465();
...
*iParam0=func_437(Param1, fParam2);
}elseif(iParam7==1){
if(func_322(Param1, 0f, 0f, 0f, 0)){
Param1={
...
var uVar5;
var uVar6;
if((func_180(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0)){
...
return 1;
}elseif(func_405(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
}elseif(func_429(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_430() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
void func_433(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
return func_438(&(Global_107357.f_2890), Param0, fParam1, 0);
}
...
}elseif((!func_440(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
iVar4=func_439(iVar0);
if(iVar4==-1){
uParam0->f_10=0;
}else{
func_434(iVar4);
...
int func_440(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_442(iParam0, uVar1[iVar3], 1) && func_441(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_322(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
...
int func_441(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_452(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_451()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
var func__449(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
iVar2=func_491(SCRIPT::GET_THIS_SCRIPT_NAME());
if(iVar2 > -1){
