...
CAM::SET_CAM_ROT(Local_176.f_0, ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2) + Local_176.f_14, 2);
}}
wait(0);
}}
...
if(uParam0->f_26){
uParam0->f_14=func_2(uParam0->f_14, to_float(-uParam0->f_21), to_float(uParam0->f_21));
uParam0->f_14.f_1=func_2(uParam0->f_14.f_1, to_float(-uParam0->f_22), to_float(uParam0->f_22));
uParam0->f_14.f_2=func_2(uParam0->f_14.f_2, to_float(-uParam0->f_20), to_float(uParam0->f_20));
}
...
func_18(&Local_176, Var0, ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2), 50f, Local_176.f_20, Local_176.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
CAM::ATTACH_CAM_TO_PED_BONE(Local_176.f_0, PLAYER::PLAYER_PED_ID(), 31086, 0f, -0.25f, 0f, 1);
}else{
...
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uParam0->f_1, sLocal_158, uVar0, 1000f, -8f, 0, 0, 1148846080, 0);
...
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_158, func_21(iLocal_168), 1000f, -8f, -1, 1, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
}
...
struct<3> Var0;
Var0.f_0=(sin(fParam0) * Local_165.f_0);
Var0.f_1=(cos(fParam0) * Local_165.f_1);
...
int iVar0;
struct<3> Var1;
fLocal_162=(fLocal_162 + (fLocal_163 * timestep()));
if(fLocal_162 >=360f){
fLocal_162=(fLocal_162 - 360f);
iLocal_161++;
}
if(func_30(iLocal_159)){
ENTITY::SET_ENTITY_COORDS(iLocal_159, Local_164, 1, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_159, (-fLocal_162 - (360f / 16f)), 0f, 0f, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_159, 1);
}
if(AUDIO::IS_AUDIO_SCENE_ACTIVE("FAIRGROUND_RIDES_FERRIS_WHALE")){
if(func_30(PLAYER::PLAYER_PED_ID())){
Var1={
...
return ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_159, 0f, (15.3f * sin(fVar0)), (-15.3f * cos(fVar0)));
}
...
MISC::CLEAR_AREA_OF_PROJECTILES(Local_164, 60f, 0);
FIRE::STOP_FIRE_IN_RANGE(Local_164, 60f);
if(!CAM::DOES_CAM_EXIST(uLocal_175)){
uLocal_175=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -1659.446f, -1120.833f, 12.9255f, -3.6667f, 0f, 56.0716f, 50.1098f, 1, 2);
CAM::SET_CAM_PARAMS(uLocal_175, -1659.446f, -1120.833f, 12.9255f, -3.6667f, 0f, 56.0716f, 50.1098f, 0, 1, 1, 2);
CAM::SET_CAM_ACTIVE(uLocal_175, 1);
CAM::SET_CAM_PARAMS(uLocal_175, -1659.11f, -1120.752f, 12.9489f, -5.5053f, 0f, 56.0716f, 50.1098f, 7000, 1, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
iLocal_173=MISC::GET_GAME_TIMER() + 6000;
}
...
while (MISC::GET_GAME_TIMER() < iLocal_173){
wait(0);
}
wait(0);
...
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_169, "GENERATOR", iLocal_159, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
iLocal_171=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_171, "SLOW_SQUEAK", iLocal_159, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
iLocal_172=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_172, "SLOW_SQUEAK", Local_160[1 /*7*/].f_3, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
iLocal_170=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_170, "CARRIAGE", Local_160[1 /*7*/].f_3, "THE_FERRIS_WHALE_SOUNDSET", 0, 0);
}
...
int iVar0;
func_43(64, 1, 0, 1, 0);
iLocal_159=OBJECT::CREATE_OBJECT(iLocal_156, 0f, 1f, 2f, 1, 1, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_159, Local_164, 1, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_159, fLocal_162, 0f, 0f, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_159, 1);
...
func_38(uParam0);
uParam0->f_2=iParam1;
uParam0->f_3=OBJECT::CREATE_OBJECT(iLocal_157, 0f, 1f, 2f, 1, 1, 0);
func_25(uParam0);
if(bParam2==1){
...
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_4[iVar0], uParam0->f_1, sLocal_158, uVar3, 1000f, -8f, 0, 0, 1148846080, 0);
...
if(iParam5==0){
Global_78472[1 /*14*/]={
func_124(iVar10, iParam1, iParam2, -1) 
};
if(!func_123(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78472[1 /*14*/]={
func_124(iVar10, iVar0, uVar11[iVar0], -1) 
};
...
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_124(iVar10, 14, uVar12[iVar1], -1) 
};
...
Global_78472[1 /*14*/]={
func_124(iVar10, iVar0, func_80(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_124(iVar10, 14, uVar15[iVar1], -1) 
};
func_91(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
func_114(14);
if(Global_78470==1){
...
if(!func_188(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_64, Global_113810.f_2366.f_539[iVar0 /*65*/].f_63)){
...
Global_78472[1 /*14*/]={
func_124(iParam0, iParam1, iParam2, -1) 
};
...
if(!func_188(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_61, Global_113810.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3==1){
...
func_127(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_127(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_127(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
...
Global_78472[1 /*14*/]={
func_124(iVar0, iParam1, iParam2, -1) 
};
if(!MISC::IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0)){
return 0;
}
...
func_218(13, floor(Global_113810.f_10197.f_3853));
}
