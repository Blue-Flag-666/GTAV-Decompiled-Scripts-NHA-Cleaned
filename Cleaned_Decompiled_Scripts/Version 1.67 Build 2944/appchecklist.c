...
if(Global_20496==0){
while (iVar0 < 5){
func_7(Global_20481, "SET_DATA_SLOT", to_float(18), to_float(iLocal_19), to_float(0), -1f, -1f, &(Local_30[iVar0 /*6*/]), 0, 0, 0, 0);
...
func_7(Global_20481, "SET_DATA_SLOT", to_float(18), to_float(iLocal_19), to_float(0), -1f, -1f, &(Local_30[iVar1 /*6*/]), 0, 0, 0, 0);
...
if(iLocal_19==0){
func_7(Global_20481, "SET_DATA_SLOT", to_float(18), to_float(0), to_float(0), -1f, -1f, "CELL_3092", 0, 0, 0, 0);
}else{
bLocal_29=true;
}
...
while (!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_28)){
wait(0);
}
iVar0=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_28);
...
HUD::ADD_TEXT_COMPONENT_INTEGER(iLocal_25);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_20481, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(18);
...
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
func_33(Global_20481, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
func_5(Global_20481, "SET_HEADER", &(Local_30[iLocal_21 /*6*/]), 0, 0, 0, 0);
...
switch (iLocal_21){
case 0:
iLocal_25=Global_113529;
iLocal_26=Global_113546;
break;
case 1:
iLocal_25=(Global_113530 + Global_113531);
iLocal_26=(Global_113547 + Global_113548);
break;
case 2:
iLocal_25=Global_113532;
iLocal_26=Global_113549;
break;
case 3:
iLocal_25=Global_113533;
iLocal_26=Global_113550;
break;
case 4:
iLocal_25=(Global_113534 + Global_113535);
iLocal_26=(Global_113551 + Global_113552);
break;
default:
iLocal_25=0;
iLocal_26=0;
...
func_33(Global_20481, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
if(func_17(0)){
func_7(Global_20481, "SET_DATA_SLOT", to_float(18), to_float(iVar0), to_float(0), -1f, -1f, "CELL_229", 0, 0, 0, 0);
}else{
while (iVar0 < Global_95814){
func_7(Global_20481, "SET_DATA_SLOT", to_float(18), to_float(iVar0), to_float(0), -1f, -1f, &(Global_95605[iVar0 /*4*/]), 0, 0, 0, 0);
iLocal_19++;
...
MemCopy(&(Global_95605[Global_95814 /*4*/]),{
func_24(iVar1)
}
, 4);
Global_95814++;
...
bVar0=false;
while (bVar0 < 63){
if((MISC::IS_BIT_SET(Global_113810.f_18577[bVar0 /*6*/], 0) && MISC::IS_BIT_SET(Global_113810.f_18577[bVar0 /*6*/], 1)) && !MISC::IS_BIT_SET(Global_113810.f_18577[bVar0 /*6*/], 3)){
if(Global_95814 < 52){
MemCopy(&(Global_95605[Global_95814 /*4*/]),{
func_22(bVar0)
}
...
bVar0=false;
while (bVar0 < 20){
if(MISC::IS_BIT_SET(Global_113810.f_9088.f_99.f_219[0], bVar0)){
if(Global_95814 < 52){
...
void func_26(){
func_33(Global_20481, "SET_INPUT_EVENT", to_float(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_28(){
func_33(Global_20481, "SET_INPUT_EVENT", to_float(1), -1082130432, -1082130432, -1082130432, -1082130432);
AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_20489, 1);
func_29();
}
...
void func_30(){
func_33(Global_20481, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
func_7(Global_20481, "SET_DATA_SLOT", to_float(18), to_float(0), to_float(0), -1f, -1f, "CELL_3301", 0, 0, 0, 0);
func_7(Global_20481, "SET_DATA_SLOT", to_float(18), to_float(1), to_float(0), -1f, -1f, "CELL_3302", 0, 0, 0, 0);
iLocal_19=2;
func_33(Global_20481, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
func_5(Global_20481, "SET_HEADER", "CELL_23", 0, 0, 0, 0);
if(Global_20488){
