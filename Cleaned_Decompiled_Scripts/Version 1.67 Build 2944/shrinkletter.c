...
HUD::DISPLAY_RADAR(0);
HUD::DISPLAY_HUD(0);
uLocal_51=GRAPHICS::REQUEST_SCALEFORM_MOVIE("PSYCHOLOGY_REPORT");
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_51)){
func_43();
wait(0);
}
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_51, "SET_PLAYER_NAME");
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_51, "SET_LETTER_TEXT");
func_42("HEADER_1");
func_42("HEADER_2");
Var0={
func_41(&uLocal_52) 
...
GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_51, 255, 255, 255, 255, 0);
wait(0);
}}
func_43();
GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
...
if(iParam0 < 9){
return MISC::IS_BIT_SET(Global_113810.f_18106.f_175[iParam0 /*19*/].f_18, 0);
}
return 0;
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_57(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
