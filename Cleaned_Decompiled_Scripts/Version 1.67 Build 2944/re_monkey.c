...
func_41(Global_113810.f_7691.f_137[iVar1 /*15*/].f_6);
iVar2=iVar1;
...
break;
case 1:
uLocal_56[iVar1]=OBJECT::CREATE_OBJECT(joaat("prop_paints_can02"), -335.66f, -95.24f, 46.16f, 1, 1, 0);
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uLocal_56[iVar1], -335.66f, -95.24f, 46.16f, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_56[iVar1], -2.32f, 0.66f, -0.8f, 2, 1);
break;
case 2:
uLocal_56[iVar1]=OBJECT::CREATE_OBJECT(joaat("prop_paint_brush05"), -336.04f, -94.9f, 46.02f, 1, 1, 0);
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uLocal_56[iVar1], -336.04f, -94.9f, 46.02f, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_56[iVar1], 0.01f, 3.85f, 2.72f, 2, 1);
break;
case 3:
uLocal_56[iVar1]=OBJECT::CREATE_OBJECT(joaat("prop_paint_spray01b"), -336.34f, -95.66f, 46.02f, 1, 1, 0);
ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uLocal_56[iVar1], -336.34f, -95.66f, 46.02f, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_56[iVar1], -2.86f, 0.76f, 28.89f, 2, 1);
break;
}
iVar0++;
}}
...
if(PED::IS_PED_DEAD_OR_DYING(iLocal_46, 1)){
func_150();
}}elseif(iLocal_45 > 0){
if(iLocal_50){
return 1;
...
if(CAM::GET_FOCUS_PED_ON_SCREEN(1106247680, 31086, 1061997773, 1060320051, 1048576000, 1090519040, 1051361018, 31086, 24818)==iLocal_46){
iLocal_67=MISC::GET_GAME_TIMER() + 2000;
iLocal_45++;
}}}
break;
case 2:
...
iLocal_46=PED::CREATE_PED(26, joaat("u_m_m_streetart_01"), Local_47, fLocal_48, 1, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("u_m_m_streetart_01"));
uLocal_56[0]=OBJECT::CREATE_OBJECT(joaat("prop_cs_spray_can"), Local_57, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_56[0], iLocal_46, PED::GET_PED_BONE_INDEX(iLocal_46, 28422), 0f, -0.01f, -0.02f, Local_64, 1, 1, 0, 0, 2, 1, 0);
PED::SET_PED_KEEP_TASK(iLocal_46, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_46, 42, 1);
uLocal_51=func_68(iLocal_46, 0, 145);
func_58(1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_46, joaat("player"));
PED::SET_PED_LOD_MULTIPLIER(iLocal_46, 2.5f);
}}
return 0;
}
...
void func_71(){
func_72();
if(!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && iLocal_49 < 3){
func_150();
}}
...
Var2={
ENTITY::GET_ENTITY_COORDS(iLocal_46, 0) 
};
fVar4=7.5f;
Var5={
fVar4, fVar4, fVar4 
...
switch (iLocal_49){
case 0:
STREAMING::REQUEST_ANIM_DICT(sLocal_60);
if(STREAMING::HAS_ANIM_DICT_LOADED(sLocal_60)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_46, 1);
TASK::TASK_PLAY_ANIM(iLocal_46, sLocal_60, sLocal_61, 1000f, -8f, -1, 8193, 0, 0, 0, 0);
iLocal_49++;
}
break;
case 1:
...
if(func_82(PLAYER::PLAYER_PED_ID(), iLocal_46, 35f)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_66);
TASK::TASK_PLAY_ANIM(0, sLocal_60, sLocal_62, 8f, -8f, -1, 8192, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_60, sLocal_63, 8f, -2f, -1, 8193, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_66);
TASK::TASK_PERFORM_SEQUENCE(iLocal_46, uLocal_66);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_66);
STREAMING::REMOVE_ANIM_DICT(sLocal_60);
iLocal_49++;
}
break;
case 2:
...
if((bVar0 && bVar1) && func_82(PLAYER::PLAYER_PED_ID(), iLocal_46, fVar8)){
iLocal_49=3;
}
if(iLocal_50){
iLocal_49=3;
...
break;
case 4:
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_46, 8, 1);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_46, 32, 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_66);
...
if(!ENTITY::IS_ENTITY_ON_SCREEN(iLocal_46) && vdist2(Var2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)) > 2500f){
uLocal_65=SHAPETEST::START_SHAPE_TEST_LOS_PROBE(Var3, Var2, 1, 0, 7);
iLocal_49++;
}
break;
case 6:
...
iVar13=SHAPETEST::GET_SHAPE_TEST_RESULT(uLocal_65, &iVar9, &uVar10, &uVar11, &uVar12);
if(iVar13==2){
if(iVar9==1){
iLocal_49++;
}else{
...
break;
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_46)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_46, 0);
}}
...
switch (iLocal_54){
case 0:
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_46, sLocal_60, sLocal_63, 3)){
fLocal_52=0.349f;
iLocal_53=900;
Local_55={
Var0 
...
iLocal_54=1;
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_46, sLocal_60, sLocal_62, 3)){
fLocal_52=ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_46, sLocal_60, sLocal_62);
fLocal_52=func_77(fLocal_52, 0.2f, 0.349f);
if(fLocal_52 !=0.2f){
fVar2=((1f / (0.349f - 0.161f)) * to_float(900));
iLocal_53=round(((fLocal_52 - 0.161f) * fVar2));
Local_55={
ENTITY::GET_ENTITY_COORDS(iLocal_46, 0) - Vector(1f, 0f, 0f) 
};
iLocal_54=1;
}else{
iLocal_54=3;
...
TASK::TASK_PLAY_ANIM(iLocal_46, sLocal_60, sLocal_62, 4f, -8f, -1, 0, fLocal_52, 1, 0, 0);
iLocal_67=MISC::GET_GAME_TIMER();
func_76(&uLocal_51);
func_75();
if(ENTITY::DOES_ENTITY_EXIST(uLocal_56[0])){
ENTITY::DETACH_ENTITY(uLocal_56[0], 1, 1);
}
iLocal_54++;
break;
case 2:
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_46, sLocal_60, sLocal_62, 3)){
iVar3=(MISC::GET_GAME_TIMER() - iLocal_67);
fVar4=(to_float(iVar3) / to_float(iLocal_53));
fVar5=(fLocal_52 - ((fLocal_52 - 0.161f) * fVar4));
fVar5=func_77(fVar5, 0.161f, fLocal_52);
ENTITY::SET_ENTITY_ANIM_CURRENT_TIME(iLocal_46, sLocal_60, sLocal_62, fVar5);
fVar6=(fVar4 - 0.12f);
fVar6=func_77(fVar6, 0f, 0.8f);
Var7={
func_74(Local_55, Var1, fVar6) 
};
ENTITY::SET_ENTITY_COORDS(iLocal_46, Var7, 0, 1, 0, 1);
if(fVar5==0.161f){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_46, 0);
return 1;
}}
...
void func_75(){
if(iLocal_58 !=0){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_58, 0);
iLocal_58=0;
}}
...
float fVar0;
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_46, sLocal_60, sLocal_62, 3)){
fVar0=ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_46, sLocal_60, sLocal_62);
if(fVar0 < 0.383793f){
func_75();
...
func_75();
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_46, sLocal_60, sLocal_63, 3)){
fVar0=ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_46, sLocal_60, sLocal_63);
if(fVar0 < 0.1124f){
func_75();
...
void func_79(){
if(iLocal_58==0){
iLocal_58=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY(sLocal_59, uLocal_56[0], Local_64, Local_64, 1065353216, 0, 0, 0);
GRAPHICS::SET_PARTICLE_FX_LOOPED_COLOUR(iLocal_58, 1f, 1f, 1f, 0);
GRAPHICS::SET_PARTICLE_FX_LOOPED_ALPHA(iLocal_58, 0.2f);
}}
...
return vdist2(ENTITY::GET_ENTITY_COORDS(iParam0, 0), ENTITY::GET_ENTITY_COORDS(iParam1, 0)) <=fVar0;
}
return 0;
}
...
func_76(&uLocal_51);
TASK::TASK_SMART_FLEE_PED(iLocal_46, PLAYER::PLAYER_PED_ID(), 9999f, -1, 1, 0);
return 1;
}
return 0;
}
...
if(!func_133(Global_113810.f_24998.f_43[iParam1])){
return 0;
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_130()) || Global_112857) || Global_32286) || func_129()) || func_128(8, -1)) || func_127()) || func_126()) || func_125()) || func_124()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_130()) || Global_32286) || func_129()) || func_128(8, -1)) || func_125()) || func_127()) || func_126()) || func_124()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_130()) || Global_112857) || Global_32286) || func_129()) || func_128(8, -1)) || func_127()) || func_126()) || func_124()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_130()) || Global_32286) || func_129()) || func_128(8, -1)) || func_126()) || func_125()) || func_124()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_130()) || func_126()) || Global_112857) || Global_32286) || func_129()) || Global_44569) || func_128(8, -1)) || func_125()) || func_123()) || func_124()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_130()) || Global_112857) || Global_32286) || func_129()) || func_128(8, -1)) || func_125()) || func_123()) || func_127()) || func_126()) || func_124()){
return 0;
}
break;
}}else{
