...
fLocal_28=180f;
iLocal_31=3;
uLocal_76=func_374(60);
uLocal_77=func_374(14);
...
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_79.f_35[0], 1);
}
...
if(MISC::ARE_STRINGS_EQUAL(sLocal_87, "DEFAULT")){
func_354(1);
}else{
func_3(sLocal_87, 1);
}
...
iVar2=0;
func_13(&iVar2);
iVar3=func_12(Var1, Global_113810.f_7691.f_765[iVar2 /*10*/]);
if(iVar3==2){
func_10(Global_113810.f_7691.f_765[iVar2 /*10*/]);
...
if(!func_8(Global_113810.f_7691.f_765[iVar2 /*10*/])){
Global_113810.f_7691.f_765[iVar2 /*10*/]={
Var1 
};
func_9(&Var1);
...
func_6(13, floor(Global_113810.f_10197.f_3853));
}
...
Global_78472[1 /*14*/]={
func_97(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
Global_78472[1 /*14*/]={
func_97(iVar10, iVar0, func_53(iParam0, iVar0, -1), -1) 
};
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_89(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_89(iParam2));
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_89(iParam0));
if(iVar11 > iVar10){
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_89(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_89(iParam1))){
return 1;
}
return 0;
}
...
func_175(&uVar1, Var0.f_3, Global_100870, iParam1, iParam2);
}}
...
}elseif(MISC::IS_PS3_VERSION() || func_183()){
...
func_246(PLAYER::PLAYER_PED_ID(), Local_254, 201.2074f, 0, 1);
if(!STREAMING::IS_NEW_LOAD_SCENE_ACTIVE()){
STREAMING::NEW_LOAD_SCENE_START_SPHERE(Local_254, 100f, 1);
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_86)){
iLocal_86=VEHICLE::CREATE_VEHICLE(iLocal_85, 1970.362f, 2859.594f, 49.2307f, 151.6095f, 1, 1, 0);
}
if(func_218(iLocal_83)){
PED::SET_PED_CAN_BE_TARGETTED(iLocal_83, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_83, joaat("player"));
PED::SET_PED_KEEP_TASK(iLocal_83, 1);
if(func_218(iLocal_86)){
VEHICLE::SET_VEHICLE_COLOURS(iLocal_86, 0, 0);
VEHICLE::SET_VEHICLE_EXTRA_COLOURS(iLocal_86, 0, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_86, 1084227584);
VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iLocal_86, 0);
TASK::TASK_WARP_PED_INTO_VEHICLE(iLocal_83, iLocal_86, -1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_86, 3);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_86, 1, 1, 0);
}}
if(func_218(PLAYER::PLAYER_PED_ID())){
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_88, "back_armsdown", 1000f, -8f, -1, 1, 0, 0, 0, 0);
...
uLocal_262=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 1966.059f, 2861.493f, 50.10657f, 5.965983f, 0f, -30.2506f, 50f, 0, 2);
CAM::SET_CAM_ACTIVE(uLocal_262, 1);
uLocal_263=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 1970.629f, 2872.505f, 49.44081f, 5.712656f, 0f, -160.9523f, 50f, 0, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
}}elseif(func_218(iLocal_83)){
if(func_218(iLocal_86)){
...
TASK::TASK_VEHICLE_DRIVE_WANDER(iLocal_83, iLocal_86, fLocal_256, 786599);
...
if(!CAM::IS_CAM_ACTIVE(uLocal_263)){
CAM::SET_CAM_ACTIVE(uLocal_263, 1);
CAM::SET_CAM_ACTIVE(uLocal_262, 0);
CAM::SET_CAM_PARAMS(uLocal_263, 1970.766f, 2872.221f, 49.47233f, 5.712656f, 0f, -160.9523f, 50f, 5000, 3, 3, 2);
}}
}
elseif(func_218(PLAYER::PLAYER_PED_ID())){
...
settimera(0);
func_221(2000, 0);
CAM::SET_CAM_PARAMS(uLocal_262, 1966.352f, 2861.772f, 50.31656f, 4.433831f, 0f, -30.38087f, 50f, 10000, 0, 0, 2);
}
}}else{
TASK::TASK_WARP_PED_INTO_VEHICLE(iLocal_83, iLocal_86, -1);
}}}
...
var func__232(int iParam0, int iParam1){
...
void func_247(){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_83)){
iLocal_83=PED::CREATE_PED(26, iLocal_84, Local_255, 0, 1, 1);
}
if(func_218(iLocal_83)){
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_83, 1);
...
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_79.f_35[0], sLocal_82, 0, joaat("bison"), 0);
}
func_285();
...
STREAMING::REQUEST_ANIM_DICT(sLocal_88);
while (((!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_88) || !HUD::HAS_ADDITIONAL_TEXT_LOADED(0)) || !STREAMING::HAS_MODEL_LOADED(iLocal_85)) || !STREAMING::HAS_MODEL_LOADED(iLocal_84)){
wait(0);
}
PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
OBJECT::SUPPRESS_PICKUP_REWARD_TYPE(128, 0);
func_245(&uLocal_89, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
if(func_218(PLAYER::PLAYER_PED_ID())){
...
iVar5=0;
while (iVar5 < iVar6){
if((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_301(Var7.f_1)) && iVar9 < 51){
...
Var4={
func_307(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
void func_323(var uParam0, int iParam1, struct<3> Param2, float fParam3){
func_324(uParam0);
...
func_346(iParam0, iVar3, Var10.f_3);
if(func_345(Var10.f_3)){
WEAPON::SET_PED_WEAPON_COMPONENT_TINT_INDEX(iParam0, iVar3, Var10.f_3, uParam1->f_221[iVar11 /*5*/].f_4);
func_344(iParam0, iVar3, Var10.f_3, uParam1->f_221[iVar11 /*5*/].f_4);
}
}
}
...
func_342(iParam0, iVar3, Var10.f_3);
}
bVar12++;
}}
bVar6++;
...
func_342(iParam0, iVar2, Var10.f_3);
}}
bVar6++;
}}}
if(!bParam2){
...
void func_344(int iParam0, int iParam1, int iParam2, var uParam3){
int iVar0;
iVar0=func_343(iParam2);
if(iVar0 !=0){
