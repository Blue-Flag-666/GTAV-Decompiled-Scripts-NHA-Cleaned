...
iLocal_50=func_303(56);
iLocal_51=func_303(57);
iLocal_52=func_303(59);
...
if(!func_280(&iVar2, &Var0, Var1, 1f)){
func_279();
...
if(!func_217(329.513f, 3402.691f, 36.258f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[1], 1), 1056964608)){
func_300("Player has moved SURFER2 vehicle [TERMINATING]");
func_214(&Var0);
func_283(&Var0, 1);
}}}
func_213(Var0.f_0);
func_206(&iLocal_54, &(Var0.f_9), Var1);
if(Var0.f_0==32){
func_202(&Var0, Var1, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_57);
}elseif(Var0.f_0==34){
func_197(&Var0, Var1, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
}
if(func_183(&Var0, 0)){
...
var uVar0;
if((((func_136(PLAYER::PLAYER_PED_ID()) && func_136(iParam0->f_28[0])) && !func_156()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_201(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7){
uVar0=16;
...
int func_202(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8){
var uVar0;
if(!*uParam8==3){
if(func_188(2)){
if(!func_156()){
...
if(*uParam8==0){
func_200(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
func_200(&uVar0, iParam6, iParam0->f_28[1], sParam7, 0, 1);
func_198(&uVar0, cParam2, sParam3, 7, 0, 0);
*uParam8=2;
}elseif(*uParam8==2){
...
*uParam8=3;
return 1;
}}}elseif(((func_204(sParam3) && !*uParam8==1) && func_136(PLAYER::PLAYER_PED_ID())) && func_201(PLAYER::PLAYER_PED_ID(), Param1, 1) >=20f){
func_300("pause conversation");
func_203(1);
*uParam8=1;
}
if(func_201(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam8==1){
...
int func_217(struct<2> Param0, float fParam1, struct<2> Param2, Vector3 vParam3, float fParam4){
if(fParam4 < 0f){
fParam4=0f;
}
...
struct<3> Var1;
int iVar2;
iVar2=func_240(iParam0, iParam1);
if(!func_136(iParam0) || !func_136(iParam1)){
if(iVar2 !=-1){
func_239(&(Local_35[iVar2 /*4*/]));
}
return 0;
}
...
uVar0=func_233(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
return (uVar0 || (MISC::GET_GAME_TIMER() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_233(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5){
var uVar0;
struct<3> Var1;
var uVar2;
int iVar3;
...
Vector3 func__234(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar2;
Var0={
func_238(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var1={
func_238(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__238(struct<3> Param0){
float fVar0;
float fVar1;
fVar0=vmag(Param0);
if(fVar0 !=0f){
...
if(func_245(uParam0, Var1, 90f, 0)){
return 1;
}}
return 0;
}

int func_245(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
func_238(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
if(fParam2 < 0.1f || fParam2 > 360f){
return 1;
}
...
void func_258(var uParam0, var uParam1, struct<3> Param2, float fParam3){
func_259(uParam0);
...
int func_280(int iParam0, int iParam1, struct<3> Param2, float fParam3){
int iVar0;
if(*iParam0==1){
if(func_281((*iParam0)[0], Param2, fParam3, iParam1)){
return 1;
}}else{
iVar0=0;
while (iVar0 < *iParam0){
if(func_281((*iParam0)[iVar0], Param2, fParam3, iParam1)){
iVar0=*iParam0;
return 1;
}
iVar0++;
...
int func_281(int iParam0, struct<3> Param1, float fParam2, var uParam3){
int iVar0;
struct<7> Var1;
iVar0=0;
func_119(iParam0, &Var1);
if(func_282(Var1.f_6, Param1, fParam2, 0)){
...
int func_282(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
