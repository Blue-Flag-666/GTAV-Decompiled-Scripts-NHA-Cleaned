...
iVar2[0]=35;
if(!func_253(&iVar2, &Var0, Var1, 1f)){
func_252();
...
func_241(&Var0);
uLocal_50=PED::ADD_SCENARIO_BLOCKING_AREA(Var1 - Vector(20f, 20f, 20f), Var1 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
...
func_202(Var0.f_0);
func_194(&iLocal_49, &(Var0.f_9), Var1);
if(func_179(&Var0, 0)){
if(Var0.f_0==35){
if(iLocal_51==0){
...
func_270("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_183(uParam0->f_27)){
func_182(uParam0->f_27, *uParam0);
func_270("RC5_IN_ACTIVATION_RANGE:
...
if(func_183(1)){
func_182(1, *uParam0);
func_270("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_270("RC_STOP_PLAYER_VEHICLE_CHECK:
...
struct<27> Var0;
if(Global_78689){
func_270("IS_RC_FINE_AND_IN_RANGE():
...
int func_253(int iParam0, int iParam1, struct<3> Param2, float fParam3){
int iVar0;
if(*iParam0==1){
if(func_254((*iParam0)[0], Param2, fParam3, iParam1)){
return 1;
}}else{
iVar0=0;
while (iVar0 < *iParam0){
if(func_254((*iParam0)[iVar0], Param2, fParam3, iParam1)){
iVar0=*iParam0;
return 1;
}
iVar0++;
...
int func_254(int iParam0, struct<3> Param1, float fParam2, var uParam3){
int iVar0;
struct<7> Var1;
iVar0=0;
func_119(iParam0, &Var1);
if(func_255(Var1.f_6, Param1, fParam2, 0)){
...
int func_255(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
