...
uLocal_206=PED::CREATE_PED(25, iLocal_34, Local_208, ScriptParam_334.f_17[0], 0, 1);
func_103();
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_34);
iLocal_207=1;
if(ENTITY::DOES_ENTITY_EXIST(uLocal_206) && func_102(uLocal_206)){
...
fVar12=func_96(PLAYER::PLAYER_PED_ID(), uLocal_206);
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_206) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_206)) && fVar12 < 25f) && func_88(PLAYER::PLAYER_PED_ID()) !=joaat("weapon_unarmed")) && func_85(uLocal_206, PLAYER::PLAYER_PED_ID(), 1126825984, 0)){
if(!func_89()){
func_91();
TASK::TASK_PLAY_ANIM(uLocal_206, &cLocal_232, &Local_201, 2f, -2f, -1, 0, 0, 0, 0, 0);
iLocal_214=24;
...
if(func_84(uLocal_206, PLAYER::PLAYER_PED_ID(), 1) < 25f){
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_206, Local_208, 1f, -1, 1f, 1024, ScriptParam_334.f_17[0]);
iLocal_214=6;
}
break;
case 6:
...
if(func_84(uLocal_206, PLAYER::PLAYER_PED_ID(), 1) < fVar9){
if(func_58()==1){
iLocal_214=8;
iLocal_267=0;
}}
...
func_52(Global_113755[iLocal_215], iLocal_221, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_206, &Local_251, &Local_250));
}}
break;
case 9:
...
bVar36=func_61();
bVar37=func_62();
func_51(Global_113755[iLocal_215]);
if(!bVar37 && (!bVar36 || bLocal_264)){
if(bLocal_331){
Global_113755[iLocal_215]=uLocal_330;
}else{
...
if(bLocal_264){
iVar35=1;
}elseif(func_33(&uLocal_35, &cLocal_225, &cVar3, 3, 0, 0, 0)){
iVar35=1;
}
if(iVar35==1){
iLocal_214=11;
...
if(((((((((((((iLocal_214==0 || iLocal_214==1) || iLocal_214==3) || iLocal_214==8) || iLocal_214==9) || iLocal_214==7) && func_84(uLocal_206, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_263==1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar6==0) && bLocal_266==1) && !Global_3) && func_7()) && bVar18){
if(iLocal_222==-1){
...
if((ENTITY::IS_ENTITY_OCCLUDED(uLocal_206) && func_84(uLocal_206, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_113(1);
}
wait(0);
}}
...
void func_1(){
if(!Global_3 || iLocal_277){
return;
}
if((ENTITY::DOES_ENTITY_EXIST(uLocal_275) && !ENTITY::IS_ENTITY_DEAD(uLocal_275, 0)) && !ENTITY::IS_ENTITY_DEAD(uLocal_206, 0)){
if(!iLocal_276){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_206, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1) < 15f){
...
TASK::TASK_FOLLOW_POINT_ROUTE(uLocal_275, 1f, 0);
iLocal_276=1;
}}else{
PED::SET_IK_TARGET(uLocal_275, 1, uLocal_206, 0, 0f, 0f, 0f, 0, -1, -1);
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_275, 1), 377.4565f, 154.6708f, 102.0838f, 1) > 25f){
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_275);
iLocal_277=1;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_275, 1), ENTITY::GET_ENTITY_COORDS(uLocal_206, 1), 1) < 3f && iLocal_278==0){
iLocal_278=1;
}}}}
...
void func_8(){
func_9();
if(func_102(uLocal_206) && func_102(PLAYER::PLAYER_PED_ID())){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_206, 0);
...
void func_9(){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_206, 0)){
AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(uLocal_206, 0);
}}
...
char* sVar0;
struct<16> Var1;
func_57(Global_113755[iLocal_215] + 1, &sVar0, &Var1);
...
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uLocal_206, 0, 0);
func_55(Global_113755[iLocal_215]);
}
...
void func_104(){
PED::SET_PED_PROP_INDEX(uLocal_206, 1, 0, 0, 0, 1);
if(!Global_3 || iLocal_277){
return;
}
...
uLocal_275=PED::CREATE_PED(4, joaat("a_m_m_business_01"), 396.8498f, 143.3195f, 101.4659f, 360f, 1, 1);
if((ENTITY::DOES_ENTITY_EXIST(uLocal_275) && !ENTITY::IS_ENTITY_DEAD(uLocal_275, 0)) && !ENTITY::IS_ENTITY_DEAD(uLocal_206, 0)){
PED::SET_IK_TARGET(uLocal_275, 1, uLocal_206, 0, 0f, 0f, 0f, 0, -1, -1);
}
if(!ENTITY::IS_ENTITY_DEAD(uLocal_206, 0)){
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(uLocal_206, "MAG_2_PAM_PED_GROUP", 0);
}}
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_275)){
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_275);
}}
