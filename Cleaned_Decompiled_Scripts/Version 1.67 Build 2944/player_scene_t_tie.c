...
fVar0=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_69);
if(fVar0 > (100f * 100f)){
return 1;
}
return 0;
...
return 0;
}}}elseif(iParam1==func_7(Global_100554) && iParam1 !=0){
Global_100554=0;
}}
return 1;
}
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_74)){
STREAMING::REQUEST_ANIM_DICT(&cLocal_74);
if(!STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_74)){
STREAMING::REQUEST_ANIM_DICT(&cLocal_74);
bVar2=false;
}}
if(!bVar2){
...
if(iLocal_68[iVar0] !=0){
iLocal_67[iVar0]=PED::CREATE_PED(26, iLocal_68[iVar0], Local_69 + Local_71[iVar0 /*3*/], 0, 1, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_67[iVar0], Vector(uLocal_70, 0f, 0f) + Local_72[iVar0 /*3*/], 2, 1);
...
TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_67[iVar0], &cLocal_74, &(Local_79[iVar0 /*8*/]), Local_69 + Local_71[iVar0 /*3*/], Vector(uLocal_70, 0f, 0f) + Local_72[iVar0 /*3*/], 1000f, -8f, -1, iLocal_80, 0, 2, 0);
...
fVar10=1f;
fVar11=-1f;
iLocal_81[iVar0]=GRAPHICS::ADD_DECAL(iLocal_82[iVar0], Local_69 + Local_83[iVar0 /*3*/], Var3, Var4, fVar5, fVar6, fVar7, fVar8, fVar9, fVar10, fVar11, 0, 0, 0);
wait(0);
}
iVar0++;
}}
...
iLocal_82[3]=1110;
Local_83[0 /*3*/]={
Vector(0.37364f, -1445.534f, 2803.76f) - Local_69 + Vector(0.1f, 0f, 0f) 
};
Local_83[1 /*3*/]={
Vector(0.28778f, -1444.863f, 2800.022f) - Local_69 + Vector(0.1f, 0f, 0f) 
};
Local_83[2 /*3*/]={
Vector(0.6045f, -1452.404f, 2795.934f) - Local_69 + Vector(0.1f, 0f, 0f) 
};
Local_83[3 /*3*/]={
Vector(0.28483f, -1448.033f, 2794.301f) - Local_69 + Vector(0.1f, 0f, 0f) 
};
iLocal_82[4]=1015;
iLocal_82[5]=1015;
Local_83[4 /*3*/]={
Local_83[0 /*3*/] + Local_83[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) 
};
Local_83[5 /*3*/]={
Local_83[1 /*3*/] + Local_83[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) 
};
break;
default:
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_74)){
STREAMING::REMOVE_ANIM_DICT(&cLocal_74);
}
iVar0=0;
while (iVar0 < iLocal_81){
if(GRAPHICS::IS_DECAL_ALIVE(iLocal_81[iVar0])){
}
iVar0++;
}
