...
iLocal_207=1;
if(ENTITY::DOES_ENTITY_EXIST(uLocal_206) && func_105(uLocal_206)){
...
fVar12=func_99(PLAYER::PLAYER_PED_ID(), uLocal_206);
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_206) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_206)) && fVar12 < 25f) && func_91(PLAYER::PLAYER_PED_ID()) !=joaat("weapon_unarmed")) && func_88(uLocal_206, PLAYER::PLAYER_PED_ID(), 1126825984, 0)){
if(!func_92()){
func_94();
TASK::TASK_PLAY_ANIM(uLocal_206, &cLocal_232, &Local_201, 2f, -2f, -1, 0, 0, 0, 0, 0);
iLocal_214=24;
...
if(func_87(uLocal_206, PLAYER::PLAYER_PED_ID(), 1) < 25f){
...
if(func_87(uLocal_206, PLAYER::PLAYER_PED_ID(), 1) < fVar9){
if(func_62()==1){
iLocal_214=8;
iLocal_267=0;
}}
...
func_56(Global_113755[iLocal_215], iLocal_221, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_206, &Local_251, &Local_250));
}}
break;
case 9:
...
if(bLocal_264){
iVar35=1;
}elseif(func_37(&uLocal_35, &cLocal_225, &cVar3, 3, 0, 0, 0)){
iVar35=1;
}
if(iVar35==1){
iLocal_214=11;
...
if(((((((((((((iLocal_214==0 || iLocal_214==1) || iLocal_214==3) || iLocal_214==8) || iLocal_214==9) || iLocal_214==7) && func_87(uLocal_206, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_263==1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar6==0) && bLocal_266==1) && !Global_3) && func_7()) && bVar18){
if(iLocal_222==-1){
...
if((ENTITY::IS_ENTITY_OCCLUDED(uLocal_206) && func_87(uLocal_206, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_116(1);
}
wait(0);
}}
...
void func_8(){
func_9();
if(func_105(uLocal_206) && func_105(PLAYER::PLAYER_PED_ID())){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_206, 0);
...
char* sVar0;
struct<16> Var1;
func_61(Global_113755[iLocal_215] + 1, &sVar0, &Var1);
...
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uLocal_206, 0, 0);
func_59(Global_113755[iLocal_215]);
}
...
void func_107(){
uLocal_275=OBJECT::CREATE_OBJECT(joaat("prop_cs_pamphlet_01"), ENTITY::GET_ENTITY_COORDS(uLocal_206, 1), 1, 1, 0);
