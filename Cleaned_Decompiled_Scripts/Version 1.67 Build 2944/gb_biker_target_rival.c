...
var uVar0;
uVar0=iParam0;
MISC::CLEAR_BIT(&(Global_2646835.f_388), uVar0);
MISC::CLEAR_BIT(&(Global_2646835.f_389), bVar0);
MISC::CLEAR_BIT(&(Global_2646835.f_390), bVar0);
MISC::CLEAR_BIT(&(Global_2646835.f_392), bVar0);
MISC::CLEAR_BIT(&(Global_2646835.f_396), bVar0);
MISC::CLEAR_BIT(&(Global_2646835.f_391), bVar0);
}
...
elseif(func_21(Global_2672524, iParam0, 1)){
return func_70(6);
}
else{
return func_70(5);
...
if(((func_67(PLAYER::PLAYER_ID()) || (func_66() && func_65())) && !MISC::IS_BIT_SET(Global_2794162.f_4697, 31)) && !bParam4){
uVar1=func_64();
...
return func_41(iParam0, NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(uVar1), iParam1, bParam2, bParam3);
}
}
else{
return func_41(iParam0, NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(uVar1), iParam1, bParam2, bParam3);
...
if(bParam1){
if(iParam2 > -1){
if(func_30(iVar0, iParam2, 0, -1) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18)){
if(iVar0==iParam2){
return func_23(1);
}else{
return func_23(0);
...
while (iVar5 <=31){
iVar1=iVar5;
if(((!func_5(iVar1, 1, 1) || func_33(iVar1, 0)) || MISC::IS_BIT_SET(Global_2657704[iVar1 /*463*/].f_199, 2)) || func_32(iVar1)){
...
if((func_69(iParam1, iParam0, iVar0, 0) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18)) || ((func_30(PLAYER::GET_PLAYER_TEAM(iParam1), PLAYER::GET_PLAYER_TEAM(iParam0), 0, -1) && MISC::IS_BIT_SET(Global_4718592.f_15, 23)) && !MISC::IS_BIT_SET(Global_4718592.f_15, 18))){
return func_23(1);
...
if(MISC::IS_BIT_SET(Global_4718592.f_15, 26) && !func_30(iParam0, PLAYER::GET_PLAYER_TEAM(iParam1), 0, -1)){
iVar0=func_42(1);
}}else{
iVar0=1;
}
...
int func_74(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, bool bParam5, var uParam6){
if(bParam5){
...
void func_79(bool bParam0, bool bParam1, bool bParam2, bool bParam3){
var uVar0;
if(func_75(bParam0)){
return;
}
...
void func_83(bool bParam0, var uParam1, bool bParam2, bool bParam3){
var uVar0;
if(func_75(bParam0)){
return;
}
...
void func_87(bool bParam0, int iParam1, bool bParam2, bool bParam3){
bool bVar0;
if(func_75(bParam0)){
return;
}
