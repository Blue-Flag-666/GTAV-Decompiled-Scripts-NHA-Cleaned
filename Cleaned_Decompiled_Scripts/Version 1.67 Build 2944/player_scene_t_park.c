...
struct<3> Var0;
float fVar1;
if(!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_79)){
if(!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uLocal_76)){
Var0={
Vector(32.856f, 3819.65f, 1971.62f) - Local_74 
};
uLocal_76=GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD(&cLocal_79, Local_74 + Var0, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
}}
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &sLocal_109, &cLocal_125, 2)){
...
if(fVar1 > fLocal_107){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_67) || iLocal_78 !=-1){
if(GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE(&cLocal_88, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 0f, 0f, 0f, iLocal_78, 1f, 0, 0, 0)){
if(MISC::ARE_STRINGS_EQUAL(&cLocal_88, "scr_meth_pipe_smoke")){
func_17(PLAYER::PLAYER_PED_ID(), 0, 1, 0, -1);
}
uLocal_168=AUDIO::GET_SOUND_ID();
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_168, &cLocal_159, PLAYER::PLAYER_PED_ID(), &cLocal_150, 0, 0);
iLocal_169++;
}
}
elseif(GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(&cLocal_88, iLocal_67, 0f, 0f, -1f, 0f, 0f, 0f, 1065353216, 0, 0, 0)){
if(MISC::ARE_STRINGS_EQUAL(&cLocal_88, "scr_meth_pipe_smoke")){
func_17(PLAYER::PLAYER_PED_ID(), 0, 1, 0, -1);
}
uLocal_168=AUDIO::GET_SOUND_ID();
...
break;
case 2:
if(!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_97)){
if(GRAPHICS::START_PARTICLE_FX_NON_LOOPED_AT_COORD(&cLocal_97, Local_74 + Local_106, 0f, 0f, 0f, 1f, 0, 0, 0)){
iLocal_169++;
}}else{
iLocal_169++;
}
...
iLocal_77=0;
AUDIO::STOP_SOUND(uLocal_168);
AUDIO::RELEASE_SOUND_ID(uLocal_168);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_67)){
if(ENTITY::IS_ENTITY_ATTACHED(iLocal_67)){
if(iLocal_73 !=-1){
...
ENTITY::SET_ENTITY_ROTATION(*iParam0, Var2.f_0, Var2.f_1, Var2.f_2, 2, 1);
}
...
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(*iParam0, Global_98143, &sVar15, &sVar18, 1000f, -8f, uVar17, 1148846080);
}}}
...
iLocal_67=OBJECT::CREATE_OBJECT(iLocal_68, Local_74, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_67, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), iLocal_71), Local_69, Local_70, 0, 0, 0, 0, 2, 1, 0);
}else{
iLocal_67=OBJECT::CREATE_OBJECT(iLocal_68, Local_74 + Local_69, 1, 1, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_67, Local_74 + Local_69, 1, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_67, Vector(uLocal_75, 0f, 0f) + Local_70, 2, 1);
...
if(!AUDIO::REQUEST_AMBIENT_AUDIO_BANK(&cLocal_141, 0, -1)){
bVar1=false;
}}
if(!iLocal_68==0){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_67)){
...
if(iLocal_65==273){
Local_106={
Vector((34.97325f + 0.25f), -441.7662f, -118.3218f) - Local_74 
};
}elseif(iLocal_65==274){
Local_106={
...
uParam1->f_110=joaat("script_task_stand_still");
func_57(uParam1);
uParam1->f_118=Global_100532[Param0.f_3];
return 1;
break;
case 6:
*uParam1={
