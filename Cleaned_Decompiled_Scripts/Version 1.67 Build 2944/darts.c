...
uLocal_137[0]=PLAYER::PLAYER_PED_ID();
bLocal_150=true;
Var17={
...
if(!ENTITY::DOES_ENTITY_EXIST(ScriptParam_227.f_4)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(iLocal_174==2){
ScriptParam_227={
Var18 
...
if(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(ScriptParam_227, 5f, joaat("prop_dart_bd_cab_01"), 0)){
ScriptParam_227.f_4=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(ScriptParam_227, 5f, joaat("prop_dart_bd_cab_01"), 1, 0, 1);
OBJECT::GET_COORDS_AND_ROTATION_OF_CLOSEST_OBJECT_OF_TYPE(ScriptParam_227, 5f, joaat("prop_dart_bd_cab_01"), &ScriptParam_227, &Var19, 0);
ScriptParam_227.f_3=Var19.f_2;
}}}else{
Var19={
ENTITY::GET_ENTITY_COORDS(ScriptParam_227.f_4, 1) 
};
}
if(!ENTITY::IS_ENTITY_DEAD(func_506(), 0)){
func_504(iLocal_169, 1);
if(PED::IS_PED_IN_ANY_VEHICLE(func_506(), 0)){
...
fVar15=(to_float(iLocal_165) / 100f);
fVar16=(fVar15 * 1200f);
iLocal_95=round(fVar16);
if(iLocal_95 < 660){
iLocal_95=660;
}
func_471(23, 1);
...
if((PED::IS_PED_INJURED(ScriptParam_227.f_5) && !ENTITY::DOES_ENTITY_EXIST(func_506())) || (ENTITY::DOES_ENTITY_EXIST(func_506()) && PED::IS_PED_INJURED(func_506()))){
func_477(&Var0, &Var5, &Var6);
}
if(!PED::IS_PED_INJURED(uLocal_137[0])){
PED::SET_PED_RESET_FLAG(uLocal_137[0], 239, 1);
PED::SET_PED_RESET_FLAG(uLocal_137[0], 124, 1);
func_470();
...
uLocal_82=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Local_206, Local_207, 65f, 0, 2);
CAM::SET_CAM_FOV(uLocal_82, 30f);
}
func_467();
settimera(0);
Var0.f_0=1;
...
MISC::CLEAR_AREA(ScriptParam_227, 0.5f, 1, 0, 0, 0);
...
if(!MISC::IS_BIT_SET(Global_113771, 0)){
...
uLocal_34=OBJECT::CREATE_OBJECT(iLocal_35, Var3, 1, 1, 0);
Var0.f_446[0]=0;
Var0.f_446[1]=0;
Var0.f_0=4;
}
...
TASK::CLEAR_PED_TASKS(uLocal_137[1]);
uLocal_173=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, 0, 2);
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
PED::FORCE_PED_MOTION_STATE(PLAYER::PLAYER_PED_ID(), joaat("MotionState_Idle"), 0, 0, 0);
}
func_445(&(Var0.f_257), 0, PLAYER::PLAYER_PED_ID(), sLocal_218, 0, 1);
if(ENTITY::IS_ENTITY_DEAD(func_506(), 0)){
if(iLocal_174==2){
...
break;
case 5:
if((((!PED::IS_PED_INJURED(uLocal_137[1]) && PED::IS_PED_ON_FOOT(uLocal_137[0])) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_137[0], 1)) && PED::IS_PED_ON_FOOT(uLocal_137[1])) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_137[1], 1)){
bLocal_145=func_440(&uLocal_161);
if((func_439() && MISC::GET_GAME_TIMER() >=iLocal_163 + 1000) && iVar13 !=9){
...
switch (iVar13){
case -1:
if(!PED::IS_PED_INJURED(uLocal_137[1])){
uLocal_167=PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(ScriptParam_227.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, (ENTITY::GET_ENTITY_HEADING(ScriptParam_227.f_4) - 3.783146f), 2);
uLocal_173=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_173, uLocal_167, "darts_ig_intro_cam", "mini@dartsintro");
CAM::SET_CAM_ACTIVE(uLocal_173, 1);
CAM::RENDER_SCRIPT_CAMS(1, false, 3000, 1, 0, 0);
TASK::TASK_CLEAR_LOOK_AT(uLocal_137[0]);
TASK::TASK_CLEAR_LOOK_AT(uLocal_137[1]);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_137[0]);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_137[1]);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_137[1], uLocal_167, "mini@dartsintro", "darts_ig_intro_guy1", 1000f, -1000f, 0, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_137[0], uLocal_167, "mini@dartsintro", "darts_ig_intro_guy2", 1000f, -1000f, 0, 0, 1148846080, 0);
TASK::TASK_PLAY_ANIM(uLocal_137[1], "mini@dartsintro", "darts_ig_intro_guy1_face", 8f, -8f, -1, 32, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(uLocal_137[0], "mini@dartsintro", sVar22, 8f, -8f, -1, 32, 0, 0, 0, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uVar27, uLocal_167, "darts_ig_intro_dart", "mini@dartsintro", 1000f, 1090519040, 0, 1148846080);
func_432(&uVar25);
iVar13++;
}
break;
...
elseif(!AUDIO::IS_AMBIENT_SPEECH_PLAYING(uLocal_137[0])){
if(!bVar10){
if(!func_428(&uVar25)){
func_443(&uVar25);
}elseif(func_431(&uVar25) > 0.5f){
...
break;
case 1:
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_167) > 0.25f){
func_432(&uVar25);
...
break;
case 2:
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_167) > 0.55f){
func_426("DARTS_HOW_3A", -1);
iLocal_29++;
}
break;
case 3:
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_167) > 0.85f){
func_426("DARTS_HOW_3A", -1);
iLocal_29++;
}
break;
}
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_167) > 0.95f){
iLocal_157=1;
iVar13++;
}
...
uLocal_167=PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(ScriptParam_227.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, (ENTITY::GET_ENTITY_HEADING(ScriptParam_227.f_4) - 3.783146f), 2);
uLocal_173=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_173, uLocal_167, "darts_ig_intro_alt1_cam", "mini@dartsintro_alt1");
CAM::SET_CAM_ACTIVE(uLocal_173, 1);
CAM::RENDER_SCRIPT_CAMS(1, false, 3000, 1, 0, 0);
TASK::TASK_CLEAR_LOOK_AT(uLocal_137[0]);
TASK::TASK_CLEAR_LOOK_AT(uLocal_137[1]);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_137[0]);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_137[1]);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_137[1], uLocal_167, "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy1", 1000f, -1000f, 0, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_137[0], uLocal_167, "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy2", 1000f, -1000f, 0, 0, 1148846080, 0);
TASK::TASK_PLAY_ANIM(uLocal_137[1], "mini@dartsintro_alt1", "darts_ig_intro_alt1_guy1_face", 8f, -8f, -1, 32, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(uLocal_137[0], "mini@dartsintro_alt1", sVar22, 8f, -8f, -1, 32, 0, 0, 0, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uVar27, uLocal_167, "darts_ig_intro_alt1_dart", "mini@dartsintro_alt1", 1000f, 1090519040, 0, 1148846080);
func_432(&uVar25);
iVar13++;
}
break;
...
HUD::CLEAR_HELP(1);
if(!PED::IS_PED_INJURED(uLocal_137[1])){
ENTITY::SET_ENTITY_COORDS(uLocal_137[0], Var2, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(uLocal_137[0], Var0.f_243.f_4);
ENTITY::SET_ENTITY_COORDS(uLocal_137[1], Var2.f_3, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(uLocal_137[1], Var0.f_243.f_4);
TASK::CLEAR_PED_TASKS(uLocal_137[0]);
TASK::CLEAR_PED_TASKS(uLocal_137[1]);
}
CAM::DESTROY_CAM(uLocal_173, 0);
...
if(!MISC::IS_BIT_SET(Global_113771, 10)){
...
if(fLocal_87 !=GRAPHICS::GET_ASPECT_RATIO(0)){
fLocal_87=GRAPHICS::GET_ASPECT_RATIO(0);
CAM::SET_CAM_FOV(uLocal_73, func_412(fLocal_87));
CAM::SET_CAM_FOV(uLocal_74, func_412(fLocal_87));
}}
...
elseif(Global_113810.f_18973.f_5 >=3 && Global_113810.f_18973.f_7 >=0.66f){
Var0.f_249.f_4=1;
}
else{
Var0.f_249.f_4=0;
}
if(func_339(Global_113810.f_18973.f_5, &iLocal_166)){
func_338(&(Var5.f_666), 24, 1);
}
fLocal_43=func_337(Global_113810.f_18973.f_5);
fLocal_44=func_336(Global_113810.f_18973.f_5);
fLocal_41=fLocal_43;
fLocal_42=fLocal_44;
iLocal_104[4]++;
if(!PED::IS_PED_INJURED(uLocal_137[1])){
...
iVar33=func_247();
uLocal_167=PED::CREATE_SYNCHRONIZED_SCENE(Var20, Var21, 2);
uLocal_173=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_173, uLocal_167, sLocal_226[iVar33], "mini@dartsoutro");
CAM::SET_CAM_ACTIVE(uLocal_173, 1);
CAM::RENDER_SCRIPT_CAMS(1, false, 3000, 1, 0, 0);
if(!PED::IS_PED_INJURED(uLocal_137[0]) && !PED::IS_PED_INJURED(uLocal_137[1])){
if(Var0.f_454){
...
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_137[0], uLocal_167, "mini@dartsoutro", sLocal_224[iVar33], 1000f, -1.5f, 0, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_137[1], uLocal_167, "mini@dartsoutro", sLocal_225[iVar33], 1000f, -1.5f, 0, 0, 1148846080, 0);
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_222, sLocal_223[MISC::GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
}
else{
AUDIO::PLAY_SOUND_FRONTEND(-1, "OTHER_TEXT", "HUD_AWARDS", 1);
func_245(&uLocal_137);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_137[1], uLocal_167, "mini@dartsoutro", sLocal_224[iVar33], 1000f, -1.5f, 0, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_137[0], uLocal_167, "mini@dartsoutro", sLocal_225[iVar33], 1000f, -1.5f, 0, 0, 1148846080, 0);
TASK::TASK_PLAY_ANIM(uLocal_137[1], sLocal_221, sLocal_223[MISC::GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
}}
iVar13++;
}
break;
...
TASK::CLEAR_PED_TASKS(uLocal_137[0]);
if(!bLocal_153){
CAM::RENDER_SCRIPT_CAMS(0, bLocal_153, 3000, 1, 0, 0);
}else{
...
HUD::CLEAR_PRINTS();
TASK::TASK_LOOK_AT_ENTITY(uLocal_137[0], uLocal_137[1], 5000, 2049, 3);
func_443(&uVar25);
iVar13++;
break;
case 1:
...
if(!ENTITY::IS_ENTITY_DEAD(func_506(), 0) || iParam2){
func_430(iParam0, sParam1, iParam3);
}elseif(!PED::IS_PED_INJURED(iParam0)){
func_5(iParam0, sParam1, sLocal_55, iParam3);
}}
...
if((PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_167) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_167) >=0.995f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_167)){
bLocal_153=true;
if(CAM::DOES_CAM_EXIST(uLocal_173)){
CAM::DESTROY_CAM(uLocal_173, 0);
if(!PED::IS_PED_INJURED(uLocal_137[0]) && !PED::IS_PED_INJURED(uLocal_137[1])){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_137[0]);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_137[1]);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uLocal_137[0], 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uLocal_137[1], 0, 0);
}}
func_110();
}
...
if(iLocal_139){
Var3={
ENTITY::GET_ENTITY_COORDS(uParam0->f_5[iLocal_28 /*79*/][iLocal_162 /*26*/], 1) 
};
...
func_53(Var3);
}}elseif(((PAD::IS_CONTROL_JUST_PRESSED(0, 211) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 211)) && bVar1) && (iLocal_158 || !PLAYER::IS_PLAYER_ONLINE())){
uParam1->f_680=1;
func_122(&(uParam1->f_509), 0, 0, 1, 1);
func_121(&(uParam1->f_509), "DARTS_CONT", 2, 215, 1, 1, 0);
func_121(&(uParam1->f_509), "DARTS_REMATCH", 2, 216, 1, 1, 0);
...
iVar7=func_247();
uLocal_167=PED::CREATE_SYNCHRONIZED_SCENE(Var5, Var6, 2);
uLocal_173=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_173, uLocal_167, sLocal_226[iVar7], "mini@dartsoutro");
CAM::SET_CAM_ACTIVE(uLocal_173, 1);
CAM::RENDER_SCRIPT_CAMS(1, false, 3000, 1, 0, 0);
if(!PED::IS_PED_INJURED(uLocal_137[0]) && !PED::IS_PED_INJURED(uLocal_137[1])){
if(uParam0->f_454){
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_137[0], uLocal_167, "mini@dartsoutro", sLocal_224[iVar7], 1000f, -1.5f, 0, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_137[1], uLocal_167, "mini@dartsoutro", sLocal_225[iVar7], 1000f, -1.5f, 0, 0, 1148846080, 0);
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), sLocal_222, sLocal_223[MISC::GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
}else{
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_137[1], uLocal_167, "mini@dartsoutro", sLocal_224[iVar7], 1000f, -1.5f, 0, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_137[0], uLocal_167, "mini@dartsoutro", sLocal_225[iVar7], 1000f, -1.5f, 0, 0, 1148846080, 0);
TASK::TASK_PLAY_ANIM(uLocal_137[1], sLocal_221, sLocal_223[MISC::GET_RANDOM_INT_IN_RANGE(0, 3)], 4f, -4f, -1, 32, 0, 0, 0, 0);
}}
bLocal_153=false;
uParam0->f_457=1;
...
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_84, uLocal_83, 500, 1, 1);
bLocal_86=false;
}else{
CAM::SET_CAM_COORD(uLocal_83, Var0);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_83, uLocal_84, 500, 1, 1);
bLocal_86=true;
}}
...
if(bParam1){
CAM::SET_CAM_COORD(uLocal_83, Var0);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_83, uLocal_82, 1500, 1, 1);
CAM::SET_CAM_ACTIVE(uLocal_82, 0);
CAM::SET_CAM_COORD(uLocal_84, Var0);
bLocal_86=true;
}elseif(bParam2){
CAM::SET_CAM_COORD(uLocal_83, Var0);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_83, uLocal_75, 2000, 1, 1);
bLocal_86=true;
}else{
if(bLocal_86){
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_82, uLocal_83, 1500, 1, 1);
}else{
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_82, uLocal_84, 1500, 1, 1);
}
...
Global_2097536.f_2825=1;
func_99(&(Global_2097536.f_2823));
}elseif(func_155(&(Global_2097536.f_2823), 300, 0)){
...
return 1;
}}elseif((!PAD::IS_CONTROL_PRESSED(2, iParam1) && !PAD::IS_DISABLED_CONTROL_PRESSED(2, iParam1)) || func_155(&(uParam0->f_246.f_3), 250, 0)){
return 1;
}
return 0;
}
...
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(func_143(func_146(iParam15), 0));
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}else{
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("SC_LB_EMPTY");
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
...
iParam15=floor(func_137(to_float(iParam15)));
}else{
...
if(bParam16){
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("NUMBER");
HUD::ADD_TEXT_COMPONENT_INTEGER(func_139(iParam15));
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}else{
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("SC_LB_EMPTY");
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
...
return floor(func_140(-fVar5, -fVar6, fVar7, 1));
}
...
return 0;
}elseif(!func_155(&(Global_2097536.f_2827), 1000, 1)){
return 0;
}}
if(((!NETWORK::NETWORK_HAS_VALID_ROS_CREDENTIALS() || !PLAYER::IS_PLAYER_ONLINE()) || (!NETWORK::NETWORK_HAVE_ONLINE_PRIVILEGES() && NETWORK::NETWORK_HAS_AGE_RESTRICTIONS())) || Global_2097536.f_2832 !=0){
...
}elseif(func_155(&(Global_2097536.f_2830), 30000, 1)){
...
}elseif(func_149(Var0) && Global_2097536.f_2704[iVar9] < 11){
...
if(iParam1==156){
}elseif(func_226(iParam0, 4, iVar1)){
...
Global_2097536.f_2780.f_29[1]=5;
Global_2097536.f_2780.f_29[2]=5;
}elseif(func_236(Global_4718592.f_171044)){
StringCopy(&(Global_2097536.f_2717[0 /*6*/]), "SCLB_C_SCORE", 24);
StringCopy(&(Global_2097536.f_2717[1 /*6*/]), "SCLB_C_DEATH", 24);
StringCopy(&(Global_2097536.f_2717[2 /*6*/]), "SCLB_C_RANK", 24);
Global_2097536.f_2710[0]=0;
...
int func_234(struct<8> Param0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5){
char cVar0[64];
MemCopy(&cVar0,{
Param0
}
...
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_75, uLocal_73, 1500, 1, 1);
CAM::SET_CAM_ACTIVE(uLocal_76, 1);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_75, uLocal_76, 8000, 1, 1);
CAM::ATTACH_CAM_TO_ENTITY(uLocal_78, iParam0, -0.0301f, 1.498f, 0.7435f, 1);
CAM::POINT_CAM_AT_ENTITY(uLocal_78, iParam0, 0.0557f, -1.4905f, 0.4958f, 1);
CAM::SET_CAM_FOV(uLocal_78, 35f);
}


void func_253(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4){
bool bVar0;
if(!CAM::IS_CAM_INTERPOLATING(uLocal_73)){
bVar0=false;
func_334(uParam0);
if(!bLocal_146){
if(uParam0->f_1==5){
...
if(!MISC::IS_BIT_SET(Global_113771, 3)){
...
if(!MISC::IS_BIT_SET(Global_113771, 4)){
...
if(uParam0->f_1==1){
if(!CAM::IS_CAM_INTERPOLATING(uLocal_82) && uParam0->f_3==2){
func_333(uParam3);
}}else{
...
MISC::SET_BIT(&(Global_113810.f_18973.f_6), iLocal_166);
...
iLocal_144=1;
}elseif(uParam0->f_422[iLocal_28]==50 && !iLocal_144){
if(!func_3(&(uParam3->f_666), 6)){
func_338(&(uParam3->f_666), 6, 1);
}
iLocal_144=1;
}elseif(func_300(&(uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/]), &(uParam0->f_243), uParam1, bVar0, 0, 0, uParam0->f_248)){
HUD::CLEAR_PRINTS();
...
}}elseif(uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_24){
if(bLocal_147){
...
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_11, (uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_11.f_1 + fLocal_32), uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_11.f_2) 
};
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/])){
ENTITY::SET_ENTITY_COORDS(uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/], Var0, 1, 0, 0, 1);
}}
func_277(&(uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/]), &(uParam0->f_243), 0);
func_262(uParam0, uParam1);
if(bLocal_147){
if(iLocal_149){
uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/]=OBJECT::CREATE_OBJECT(uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_1, Local_38, 1, 1, 0);
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_11, (uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_11.f_1 + fLocal_32), uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_11.f_2) 
};
ENTITY::SET_ENTITY_COORDS(uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/], Var0, 1, 0, 0, 1);
fVar1=MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_17={
90f, fVar1, uParam0->f_243.f_4 
};
ENTITY::SET_ENTITY_ROTATION(uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/], uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_17, 0, 1);
uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_23=1;
uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_24=0;
}}}else{
func_296(&(uParam0->f_422), &(uParam0->f_249));
...
uParam0->f_5[iLocal_28 /*79*/][iVar2 /*26*/]=OBJECT::CREATE_OBJECT(uParam0->f_5[iLocal_28 /*79*/][iVar2 /*26*/].f_1, Local_38, 1, 1, 0);
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_28 /*79*/][iVar2 /*26*/].f_11, (uParam0->f_5[iLocal_28 /*79*/][iVar2 /*26*/].f_11.f_1 + fLocal_32), uParam0->f_5[iLocal_28 /*79*/][iVar2 /*26*/].f_11.f_2) 
};
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_5[iLocal_28 /*79*/][iVar2 /*26*/])){
ENTITY::SET_ENTITY_COORDS(uParam0->f_5[iLocal_28 /*79*/][iVar2 /*26*/], Var0, 1, 0, 0, 1);
}
fVar3=MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
uParam0->f_5[iLocal_28 /*79*/][iVar2 /*26*/].f_17={
90f, fVar3, uParam0->f_243.f_4 
};
ENTITY::SET_ENTITY_ROTATION(uParam0->f_5[iLocal_28 /*79*/][iVar2 /*26*/], uParam0->f_5[iLocal_28 /*79*/][iVar2 /*26*/].f_17, 0, 1);
...
break;
case 2:
if(PAD::IS_CONTROL_JUST_PRESSED(2, 201) || (iLocal_148 && bLocal_147)){
iLocal_138=1;
}
...
if(iVar1 < 50){
func_4(PLAYER::PLAYER_PED_ID(), "GAME_BAD_SELF", 1, 4);
}elseif(iVar1 < 68 && !ENTITY::DOES_ENTITY_EXIST(func_506())){
func_4(*uParam1, "DARTS_PLAYING_POORLY", 0, 4);
}elseif(iVar1 < 86){
func_4(*uParam1, "GAME_BAD_OTHER", 0, 4);
}elseif(iVar1 < 100){
...
func_338(&(uParam1->f_666), 5, 0);
settimerb(0);
}elseif((uParam0->f_422[iLocal_28]==1 || uParam0->f_422[iLocal_28] < 0) || (uParam0->f_422[iLocal_28]==0 && uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_21 !=2)){
if(uParam0->f_422[iLocal_28]==0 && uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_21 !=2){
func_260("DARTS_PLR_DUB", uParam0->f_5[iLocal_28 /*79*/][iLocal_29 /*26*/].f_20, 5000, 0);
func_338(&(uParam1->f_666), 3, 1);
}elseif(uParam0->f_422[iLocal_28]==1){
...
}elseif(iLocal_28==1 && iLocal_29==2){
...
break;
case 7:
Global_113810.f_18973.f_7=(to_float(Global_113810.f_18973.f_2) / to_float(Global_113810.f_18973.f_5));
break;
case 8:
Global_113810.f_18973.f_8=(to_float(Global_113810.f_18973.f_4) / to_float(Global_113810.f_18973.f_5));
break;
}}
...
uParam0->f_24=0;
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_11, (uParam0->f_11.f_1 + fLocal_32), uParam0->f_11.f_2) 
};
ENTITY::SET_ENTITY_COORDS(*uParam0, Var0, 1, 0, 0, 1);
return 1;
}
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_2, (uParam0->f_2.f_1 + fLocal_32), uParam0->f_2.f_2) 
};
ENTITY::SET_ENTITY_COORDS(*uParam0, Var0, 1, 0, 0, 1);
...
if(iParam3==1){
GRAPHICS::DRAW_SPRITE(sParam0, sParam1, func_283(Var0.f_0), func_282(Var0.f_1), Var0.f_2, Var0.f_3, Var0.f_8, Var0.f_4, Var0.f_5, Var0.f_6, Var0.f_7, iParam6, 0);
}else{
GRAPHICS::DRAW_SPRITE(sParam0, sParam1, func_283(Var0.f_0), func_282(Var0.f_1), Var0.f_2, Var0.f_3, Var0.f_8, Var0.f_4, Var0.f_5, Var0.f_6, Var0.f_7, iParam6, 0);
}
...
var func__282(var uParam0){
return uParam0;
}


var func__283(var uParam0){
return uParam0;
}
...
uParam0->f_24=1;
func_294(uParam0);
*uParam0=OBJECT::CREATE_OBJECT(uParam0->f_1, Local_38, 0, 0, 0);
fVar1=MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
Var7={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, Local_39) 
};
Var8={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_8, (uParam0->f_8.f_1 + fLocal_32), uParam0->f_8.f_2) 
};
...
*uParam1=20;
uParam1->f_1=3;
}}elseif((*uParam0)[iLocal_28] < 61){
if((*uParam0)[iLocal_28]==50){
*uParam1=50;
uParam1->f_1=1;
}elseif((*uParam0)[iLocal_28] > 52){
*uParam1=((*uParam0)[iLocal_28] - 40);
uParam1->f_1=1;
}elseif((*uParam0)[iLocal_28] > 40){
*uParam1=((*uParam0)[iLocal_28] - 32);
uParam1->f_1=1;
}elseif(((*uParam0)[iLocal_28] % 2)==0){
iVar0=1;
iVar0=0;
while (iVar0 < 20){
...
if(!(PAD::IS_CONTROL_JUST_PRESSED(2, 223) && iLocal_54) && !bParam4){
iLocal_51=1;
iLocal_52=1;
if(!iLocal_53){
...
if(iLocal_89 < -100){
iLocal_94=round(fVar1);
}
break;
case 1:
if(iLocal_89 > 120){
iLocal_90=MISC::GET_GAME_TIMER();
}elseif((iLocal_89 < 120 && iLocal_89 > -120) && (MISC::GET_GAME_TIMER() - iLocal_90) > 500){
iLocal_88=0;
}elseif(iLocal_89 < -100){
...
fLocal_96=(to_float(iLocal_93) / to_float(iLocal_92));
...
if(iLocal_94 > 7){
fLocal_98=(to_float(iLocal_94) / fLocal_103);
fLocal_99=(fLocal_101 * fLocal_98);
uParam0->f_8=(uParam0->f_8 + fLocal_99);
}elseif(iLocal_94 < -7){
fLocal_98=(to_float(iLocal_94) / fLocal_102);
fLocal_99=(fLocal_101 * fLocal_98);
uParam0->f_8=(uParam0->f_8 - fLocal_99);
}else{
fLocal_99=0f;
...
func_304();
}elseif(fLocal_97 <=0.066477f && fLocal_99 < 0.06f){
func_303();
}else{
func_302();
}
...
struct<3> Var0;
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_14, (uParam0->f_14.f_1 + fLocal_32), uParam0->f_14.f_2) 
};
if(iParam3==1){
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_14, (uParam0->f_14.f_1 + fLocal_32), uParam0->f_14.f_2) 
...
GRAPHICS::GET_SCREEN_COORD_FROM_WORLD_COORD(Var0, &Local_36, &(Local_36.f_1));
...
if(iParam1==0){
fVar2=MISC::GET_RANDOM_FLOAT_IN_RANGE((0f - fLocal_42), (0f + fLocal_42));
fVar1=MISC::GET_RANDOM_FLOAT_IN_RANGE((0f - fLocal_41), (0f + fLocal_41));
...
bLocal_47=true;
iLocal_46++;
}elseif((((((!func_310("DARTS_FST_HLP") && !func_310("DARTS_AIM_HLP")) && !func_310("DARTS_CLOCK")) && !func_310("DARTS_STD_HLP")) && !func_310("DARTS_INSTR_W")) && !func_310("DARTS_INSTR_B")) && !iLocal_48){
iLocal_48=1;
if(!MISC::IS_BIT_SET(Global_113771, 1)){
...
float fVar5;
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
ENTITY::SET_ENTITY_COORDS(*uParam0, Local_38, 1, 0, 0, 1);
}else{
*uParam0=OBJECT::CREATE_OBJECT(uParam0->f_1, Local_38, 0, 0, 0);
}
bLocal_47=false;
...
Var2={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, (uParam0->f_14 + 0.0035f), (uParam0->f_14.f_1 + fLocal_32), uParam0->f_14.f_2) 
};
...
if(iParam0==0){
if(!MISC::IS_BIT_SET(Global_113771, 9)){
...
}}elseif(iParam1 && !MISC::IS_BIT_SET(Global_113771, 7)){
...
if(!MISC::IS_BIT_SET(Global_113771, 8)){
if((!func_310("DARTS_SHT_USE") && !func_310("DARTS_INSTR_W")) && !func_310("DARTS_INSTR_B")){
...
if(!MISC::IS_BIT_SET(Global_113771, 2)){
...
void func_313(){
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_73, uLocal_85, 2000, 1, 1);
...
uLocal_85=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Param0, Var0, 65f, 0, 2);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_85, uLocal_73, 2000, 1, 1);
}


Vector3 func__315(int iParam0){
float fVar0;
struct<3> Var1;
if(iParam0==50){
Var1={
...
func_326(0);
func_507();
if(CAM::DOES_CAM_EXIST(uLocal_175)){
if(CAM::IS_CAM_ACTIVE(uLocal_175)){
CAM::SET_CAM_ACTIVE(uLocal_175, 0);
}
CAM::DESTROY_CAM(uLocal_175, 0);
}
*uParam0=0;
return 0;
break;
...
if(bParam0){
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_82, uLocal_73, 1000, 1, 1);
}else{
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_73, uLocal_82, 1000, 1, 1);
}}
...
if((PAD::IS_CONTROL_PRESSED(2, 201) || PAD::IS_CONTROL_JUST_PRESSED(2, 223)) && iLocal_52){
*uParam0=6;
}}}
...
}elseif(iLocal_46 > 0 && !func_3(&(uParam0->f_666), 17)){
func_122(&(uParam0->f_509), 0, 0, 0, 1);
func_121(&(uParam0->f_509), "DARTS_THROW", 2, 223, 0, 1, 0);
func_121(&(uParam0->f_509), "DARTS_END_QT", 2, 235, 1, 1, 0);
func_332(&(uParam0->f_509), "DARTS_AIM", 2, 20, 1, 0);
...
if(iParam0 >=10){
if(!MISC::IS_BIT_SET(Global_113810.f_18973.f_6, 12)){
*uParam1=12;
return 1;
}}
return 0;
...
HUD::DISPLAY_RADAR(0);
if(CAM::IS_CAM_ACTIVE(uLocal_75)){
...
}elseif(func_404() && MISC::GET_GAME_TIMER() > Global_4541035){
if(Global_4541034==uParam0->f_660){
iVar2=func_403(0);
if(iVar2==-1 || iVar2==1){
iVar1=1;
...
func_373(Global_23387, Global_23388, fParam5, fVar55, 0, 0, 0, 255);
...
func_373(Global_23387, (Global_23388 + fVar55), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
...
func_373(Global_23387, (fVar49 + 0f), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
Var38={
...
func_373(Global_23387, (fVar49 - 0.00277776f), fParam5, 0.00277776f, iVar1, iVar2, iVar3, iVar4);
...
GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_5165), func_23(Global_23390.f_5165, 1), ((Global_23387 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
...
GRAPHICS::DRAW_SPRITE(func_26(Global_4540958.f_67), func_23(Global_4540958.f_67, 1), ((Global_23387 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
fVar49=(fVar49 + (((HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
...
func_360(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar53, iVar72, bVar51, bVar50);
...
func_360(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar53, 0, bVar51, bVar50);
...
if(iVar5==1){
if(Global_23390.f_5526[iVar8]==2){
GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_4824[(iVar22 + iVar28)]), func_23(Global_23390.f_4824[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
else{
GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_4824[(iVar22 + iVar28)]), func_23(Global_23390.f_4824[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
}
...
func_360(0, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar53, 0, bVar51, bVar50);
...
GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_4824[(iVar22 + iVar14)]), func_23(Global_23390.f_4824[(iVar22 + iVar14)], bVar32), (Global_23387 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
elseif(Global_23390.f_5526[iVar8]==2){
GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_4824[(iVar22 + iVar14)]), func_23(Global_23390.f_4824[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
else{
GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_4824[(iVar22 + iVar14)]), func_23(Global_23390.f_4824[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
}
}
...
if(bVar33){
if(!Global_23390.f_6172){
func_360(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar53, 0, 0, 0);
if(Global_23390.f_8888 && Global_23390.f_8889==iVar6){
func_359(bVar32);
}
...
if(iVar5==1){
func_360(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar53, 0, 0, 0);
func_357((fVar34 + fVar40), fVar35, "NUMBER", Global_23390.f_4309[iVar20], 0);
}}
bVar39=true;
iVar20++;
break;
...
func_360(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar53, 0, 0, 0);
func_356((fVar34 + fVar40), fVar35, "NUMBER", Global_23390.f_4566[iVar21], Global_23390.f_4695[iVar21]);
}
bVar39=true;
iVar21++;
break;
...
GRAPHICS::DRAW_SPRITE(func_26(Global_23390.f_4824[iVar22]), func_23(Global_23390.f_4824[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_355(Global_23390.f_4824[iVar22])), (fVar37 * func_355(Global_23390.f_4824[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
}
}}
bVar39=true;
...
var func__380(int iParam0, int iParam1){
switch (iParam0){
case 5:
if(iParam1 > -1){
...
int iVar0;
int iVar1;
if((func_439() && MISC::GET_GAME_TIMER() >=iLocal_163 + 1000) && *iParam0 !=8){
if(!CAM::IS_SCREEN_FADED_OUT() && !CAM::IS_SCREEN_FADING_OUT()){
CAM::DO_SCREEN_FADE_OUT(500);
}}
...
switch (iLocal_29){
case 0:
if(!CAM::IS_CAM_INTERPOLATING(uLocal_80)){
if(*uParam3==2){
*uParam2=50;
uParam2->f_1=1;
...
break;
case 5:
if(!CAM::IS_CAM_INTERPOLATING(uLocal_81) && !func_310("DARTS_DBL_WIN")){
...
case 6:
AUDIO::PLAY_SOUND_FRONTEND(-1, "CAM_PAN_DARTS", "HUD_MINI_GAME_SOUNDSET", 1);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_73, uLocal_81, 1500, 1, 1);
*iParam0=7;
break;
case 7:
if(!CAM::IS_CAM_INTERPOLATING(uLocal_73)){
...
CAM::SET_CAM_COORD(uLocal_81, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Param0, fParam1, Param2));
CAM::SET_CAM_ROT(uLocal_81, Vector(fParam1, 0f, 0f) - Param3, 2);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_81, uLocal_80, iParam4, 1, 1);
}
...
CAM::STOP_CAM_POINTING(uLocal_80);
CAM::SET_CAM_FOV(uLocal_80, 35f);
CAM::SET_CAM_COORD(uLocal_80, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Param0, fParam1, Param2));
CAM::SET_CAM_ROT(uLocal_80, Vector(fParam1, 0f, 0f) - Param3, 2);
if(bParam5){
CAM::SET_CAM_ACTIVE(uLocal_80, 1);
}else{
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_80, uLocal_81, iParam4, 1, 1);
}}


Vector3 func__424(bool bParam0){
if(bParam0){
...
if(!func_441(iVar0)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_AT_ENTITY(iVar0, PLAYER::PLAYER_PED_ID(), Local_136, 0, 1, 0)){
...
TASK::CLEAR_PED_TASKS(uLocal_137[1]);
}elseif(func_449(uParam4)){
TASK::CLEAR_PED_TASKS(uLocal_137[1]);
}else{
uLocal_137[1]=PED::CREATE_PED(26, iLocal_171, Param1.f_3, uParam0, 1, 1);
}
if(DECORATOR::DECOR_EXIST_ON(uLocal_137[1], "Darts_name")){
iVar0=DECORATOR::DECOR_GET_INT(uLocal_137[1], "Darts_name");
if(954610991==iVar0){
sLocal_219=func_453("RAYMOND");
iLocal_220=954610991;
...
DECORATOR::DECOR_SET_INT(uLocal_137[1], "Darts_name", iLocal_220);
}
iVar1=ENTITY::GET_ENTITY_MODEL(uLocal_137[1]);
func_448(iVar1);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(uLocal_137[1], uLocal_137[0], 0);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(uLocal_137[0], uLocal_137[1], 0);
}
...
Local_39={
0f, (-2.3685f + fLocal_32), 0.1f 
};
Local_39={
Local_39 + Local_33 
};
Local_38={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_1, uParam0->f_4, Local_39) 
};
...
*uParam0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, -0.4f, (-2.4f + fLocal_32), -1.7272f) 
};
uParam0->f_3={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, 0.5f, (-2.4f + fLocal_32), -1.7272f) 
};
}
...
if((((((((((((!STREAMING::HAS_MODEL_LOADED(iLocal_26) || !STREAMING::HAS_MODEL_LOADED(iLocal_27)) || !STREAMING::HAS_MODEL_LOADED(iLocal_35)) || !STREAMING::HAS_MODEL_LOADED(iLocal_171)) || !GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*uParam0)) || !GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uParam1->f_645)) || !GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uParam1->f_57)) || !GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uParam1->f_62)) || !HUD::HAS_ADDITIONAL_TEXT_LOADED(3)) || !GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("Darts")) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_221)) || !STREAMING::HAS_ANIM_DICT_LOADED(sLocal_222)) || !func_458(0, -1, 0)){
return 0;
}
return 1;
}
...
uLocal_73=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var0, Var2, fVar7, 0, 2);
uLocal_74=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var1, Var3, fVar7, 0, 2);
uLocal_75=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var4, Var5, 65f, 0, 2);
uLocal_76=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var15, Var6, 65f, 0, 2);
uLocal_77=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 0f, 0f, 0f, 0f, 0f, 0f, 65f, 0, 2);
...
uLocal_79=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, 1996.235f, 3048.456f, 48.0237f, -3.4831f, 0.0223f, 60.6925f, 38.1f, 0, 2);
CAM::SET_CAM_FOV(uLocal_75, 43.35f);
CAM::SET_CAM_FOV(uLocal_76, 42.35f);
CAM::SHAKE_CAM(uLocal_75, "HAND_SHAKE", 0.1f);
...
var func__472(int iParam0, int iParam1){
var uVar0;
var uVar1;
...
var func__473(int iParam0, int iParam1){
var uVar0;
var uVar1;
...
func_87(13, floor(Global_113810.f_10197.f_3853));
}
...
STATS::LEADERBOARDS_WRITE_ADD_COLUMN(103, iLocal_104[1], 0f);
STATS::LEADERBOARDS_WRITE_ADD_COLUMN(99, iLocal_104[2], 0f);
STATS::LEADERBOARDS_WRITE_ADD_COLUMN(109, iLocal_104[3], 0f);
STATS::LEADERBOARDS_WRITE_ADD_COLUMN(106, iLocal_104[5], 0f);
STATS::LEADERBOARDS_WRITE_ADD_COLUMN(2, iLocal_104[10], 0f);
STATS::LEADERBOARDS_WRITE_ADD_COLUMN(107, iLocal_104[8], 0f);
STATS::LEADERBOARDS_WRITE_ADD_COLUMN(116, iLocal_104[6], 0f);
}}
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_172);
TASK::OPEN_SEQUENCE_TASK(&uLocal_172);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_137[0])){
TASK::TASK_LOOK_AT_ENTITY(0, uLocal_137[0], 8000, 2049, 3);
}
TASK::TASK_STAND_STILL(0, 1000);
if(bLocal_150){
if(!MISC::IS_BIT_SET(Global_113771, 10)){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_487(iLocal_174==2, Local_209, Local_211), 1f, 20000, 0.25f, 0, func_125(iLocal_174==2, fLocal_213, fLocal_215));
}else{
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_487(iLocal_174==2, Local_208, Local_210), 1f, 20000, 0.25f, 0, func_125(iLocal_174==2, fLocal_212, fLocal_214));
}
TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
}else{
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, func_487(iLocal_174==2, Local_208, Local_210), 1f, 20000, 0.25f, 0, func_125(iLocal_174==2, 172.6813f, 142.6717f));
...
Vector3 func__487(bool bParam0, struct<3> Param1, struct<3> Param2){
if(bParam0){
return Param1;
}
return Param2;
...
void func_493(){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_34)){
...
fVar3=0f;
if(!func_500(Global_113810.f_18536[iVar0], &Var2, &fVar3)){
