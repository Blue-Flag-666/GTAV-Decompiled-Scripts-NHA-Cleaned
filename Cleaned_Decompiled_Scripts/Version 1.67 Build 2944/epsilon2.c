...
fLocal_28=180f;
iLocal_31=3;
uLocal_79=func_360(60);
uLocal_80=func_360(14);
...
wait(0);
func_222(Local_82.f_9, 0, 0, 0, 0, 0);
switch (iLocal_83){
case 0:
func_46();
break;
...
var uVar0;
float fVar1;
OBJECT::GET_STATE_OF_CLOSEST_DOOR_OF_TYPE(iLocal_85, 241.3494f, 361.0303f, 105.9036f, &uVar0, &fVar1);
switch (iLocal_84){
case 0:
iLocal_89=0;
iLocal_90=0;
...
if(!iLocal_89 && (MISC::GET_GAME_TIMER() - iLocal_86) > 15000){
if(func_35(1343538152, 6, 1, 60, 15000, 10000, -1, 0, -1, 0)){
iLocal_89=1;
}}
if(!iLocal_91 && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, 1, 0)){
...
if(MISC::ABSF(fVar1) <=0.05f && !iLocal_91){
func_3(109, 6);
func_3(109, 1);
iLocal_90=1;
iLocal_91=1;
...
iVar2=0;
func_41(&iVar2);
iVar3=func_40(Var1, Global_113810.f_7691.f_765[iVar2 /*10*/]);
if(iVar3==2){
func_38(Global_113810.f_7691.f_765[iVar2 /*10*/]);
...
if(!func_36(Global_113810.f_7691.f_765[iVar2 /*10*/])){
Global_113810.f_7691.f_765[iVar2 /*10*/]={
Var1 
};
func_37(&Var1);
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_55(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
if(iParam5==0){
Global_78472[1 /*14*/]={
func_115(iVar10, iParam1, iParam2, -1) 
};
if(!func_114(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78472[1 /*14*/]={
func_115(iVar10, iVar0, uVar11[iVar0], -1) 
};
...
uVar12={
func_93(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_115(iVar10, 14, uVar12[iVar1], -1) 
};
...
Global_78472[1 /*14*/]={
func_115(iVar10, iVar0, func_72(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_115(iVar10, 14, uVar15[iVar1], -1) 
};
func_83(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
func_106(14);
if(Global_78470==1){
...
if(!func_179(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_64, Global_113810.f_2366.f_539[iVar0 /*65*/].f_63)){
...
Global_78472[1 /*14*/]={
func_115(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}elseif(func_101(iParam0, iParam2, iParam3, -1)){
...
if(!func_179(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_61, Global_113810.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3==1){
...
if(func_84(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, FILES::GET_HASH_NAME_FOR_PROP(iParam0, 0, iParam2, iParam3))){
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_73(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_73(iParam2));
...
var func__109(int iParam0, var uParam1){
...
func_118(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_118(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_118(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
iVar10=(iParam1 - iParam2);
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_73(iParam0));
if(iVar11 > iVar10){
...
Global_78472[1 /*14*/]={
func_115(iVar0, iParam1, iParam2, -1) 
};
if(!MISC::IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0)){
return 0;
}
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_73(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_73(iParam1))){
return 1;
}
return 0;
}
...
if(!func_220(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
void func_222(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_225(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
struct<2> func_225(int iParam0, int iParam1, int iParam2){
struct<2> Var0;
int iVar1;
StringCopy(&Var0, "", 8);
switch (iParam1){
...
int func_234(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6){
...
int func_240(char* sParam0, int iParam1, int iParam2, bool bParam3){
int iVar0;
...
struct<6> func_249(int iParam0, bool bParam1){
struct<6> Var0;
switch (iParam0){
case -1:
Var0={
...
int iVar0;
func_190();
if(!iLocal_89 && func_257(3)==-1){
func_256(3, 0);
iVar0=func_255(3, 8, 1);
func_254(iVar0, 3, 8, "EPS_EMAIL5K");
iLocal_89=1;
}
...
int func_254(int iParam0, int iParam1, int iParam2, char* sParam3){
int iVar0;
int iVar1;
iVar0=7;
iVar1=0;
...
func_325(13, floor(Global_113810.f_10197.f_3853));
}
...
iVar3=0;
while (iVar3 <=8){
if(!func_284(iParam0, 14, uVar5[iVar3])){
iVar4=0;
}
iVar3++;
}
...
Global_78472[1 /*14*/]={
func_115(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
func_290(&uVar1, Var0.f_3, Global_100870, iParam1, iParam2);
}}
...
}elseif(MISC::IS_PS3_VERSION() || func_295()){
...
bool func_312(int iParam0, bool bParam1, int iParam2, bool bParam3){
bool bVar0;
int iVar1;
int iVar2;
struct<5> Var3;
...
if(!func_320(68)){
func_317("DI_HLP_STRY", 2, 0, 20000, 10000, 7, 0, 208, 0);
}}}}}
...
void func_318(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9){
int iVar0;
