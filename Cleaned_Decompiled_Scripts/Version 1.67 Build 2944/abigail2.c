...
void func_9()
{
	switch (iLocal_58)
	{
		...
		case 1:
			...
			else if (func_236(PLAYER::PLAYER_PED_ID(), iLocal_59) > 250f)
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) == 0)
				{
					iLocal_58 = 2;
			...
			else
			{
				...
				else if (((((iLocal_236 < 15 && !func_233()) && (MISC::GET_GAME_TIMER() - iLocal_233) > 10000) && func_232(iLocal_59, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_59)) && func_215(&uLocal_63, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0))
				{
...
int func_40(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_78472[1 /*14*/] = { func_93(iVar0, iParam1, uVar6[iParam1], -1) };
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (BitTest(Global_78472[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_78472[1 /*14*/] = { func_93(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_78472[1 /*14*/] = { func_93(iVar10, 14, uVar15[iVar1], -1) };
			func_59(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
			func_75(14);
			if (Global_78470 == 1)
			{
		...
		if (Var0.f_5 != 4)
		{
			...
			while (iVar3 < 63)
			{
				...
				if (iVar5 != iParam0)
				{
					...
					{
						if (!BitTest(Global_113810.f_18577[iVar5 /*6*/], 3))
						{
							bVar2 = false;
						}
						if (!BitTest(Global_113810.f_18577[iVar5 /*6*/], 0))
						{
							func_189(iVar5);
						}
					}
...
void func_273()
{
	switch (iLocal_58)
	{
		...
		case 1:
			...
			else if (ENTITY::IS_ENTITY_AT_COORD(iLocal_59, Local_237, 5f, 5f, 5f, 0, 1, 0))
			{
				func_238(3);
			}
			else
...
int func_286(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_288(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		Var1 = { func_288(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_296(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_288(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_350(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		if (!bParam2 || BitTest(Global_113810.f_7232[iVar2], 0))
		{
	...
	if (Global_78944 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_373(Global_78945, Global_78947, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
int func_398(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)
{
	...
	if (func_162(iParam1))
	{
		...
		else if (Global_113810.f_2366.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var2.f_0)
		{
