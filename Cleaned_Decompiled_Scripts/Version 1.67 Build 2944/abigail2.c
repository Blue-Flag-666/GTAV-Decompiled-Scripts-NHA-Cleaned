...
if(func_475(Local_52.f_28[0])){
iLocal_59=Local_52.f_28[0];
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_59, 1, 1);
}
func_474();
if(func_473()){
iVar0=func_472();
...
func_371(Local_52.f_9, 0, 0, 0, 0, 0);
...
if(iLocal_228==0){
if(((!func_233() && func_232(iLocal_59, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_59)) && func_215(&uLocal_63, "SONARAU", "SONAR_SHOOTS", 7, 0, 0, 0)){
iLocal_228=1;
}}elseif(((((iLocal_236 < 15 && !func_233()) && (MISC::GET_GAME_TIMER() - iLocal_233) > 10000) && func_232(iLocal_59, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_59)) && func_215(&uLocal_63, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0)){
...
}elseif((Global_1575063 && iParam0==PLAYER::PLAYER_ID()) && func_250(iParam0, 1, 0)){
return Global_2657704[iParam0 /*463*/].f_321.f_7 !=-1;
}}
return 0;
}
...
void func_269(){
if(!HUD::DOES_BLIP_EXIST(iLocal_60) && func_475(iLocal_59)){
iLocal_60=func_270(iLocal_59, 1, 0, 5);
}
if(HUD::DOES_BLIP_EXIST(iLocal_60) && HUD::GET_BLIP_COLOUR(iLocal_60) !=1){
HUD::SET_BLIP_AS_FRIENDLY(iLocal_60, 0);
HUD::SET_BLIP_COLOUR(iLocal_60, 1);
}}
...
if(((iLocal_230==0 && !func_233()) && func_232(iLocal_59, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_215(&uLocal_63, "SONARAU", "SONAR_ARRIVE", 7, 0, 0, 0)){
iLocal_230=1;
func_269();
}
if(func_236(PLAYER::PLAYER_PED_ID(), iLocal_59) > 250f){
iLocal_58=2;
}}
...
switch (iLocal_58){
case 0:
uLocal_241=PED::ADD_SCENARIO_BLOCKING_AREA(Vector(2.99f, 5194.44f, -1578.62f) - Vector(10f, 10f, 10f), Vector(2.99f, 5194.44f, -1578.62f) + Vector(10f, 10f, 10f), 0, 1, 1, 1);
func_301();
if(func_475(iLocal_59)){
func_299();
if(func_3(iLocal_54)){
...
TASK::TASK_ENTER_VEHICLE(0, iLocal_54, 20000, -1, 1f, 1, 0);
}
TASK::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, iLocal_54, Local_237, 20f, 786469, 10f);
TASK::TASK_VEHICLE_PARK(0, iLocal_54, Local_237, 49.567f, 3, 1092616192, 0);
TASK::TASK_LEAVE_VEHICLE(0, iLocal_54, 256);
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 250f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_234);
TASK::TASK_PERFORM_SEQUENCE(iLocal_59, uLocal_234);
}else{
TASK::TASK_WANDER_STANDARD(iLocal_59, 1193033728, 0);
}}
...
func_276();
func_238(4);
}elseif(ENTITY::IS_ENTITY_AT_COORD(iLocal_59, Local_237, 5f, 5f, 5f, 0, 1, 0)){
func_238(3);
}else{
func_274(&iLocal_60, "", "", &iLocal_61, iLocal_62, 0);
if(iLocal_229==0){
if(((func_475(iLocal_54) && PED::IS_PED_IN_VEHICLE(iLocal_59, iLocal_54, 1)) && func_232(iLocal_59, PLAYER::PLAYER_PED_ID(), 20f, 1)) && func_215(&uLocal_63, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0)){
iLocal_229=1;
}
if(((((iLocal_235 < 7 && !func_233()) && (MISC::GET_GAME_TIMER() - iLocal_232) > 10000) && func_232(iLocal_59, PLAYER::PLAYER_PED_ID(), 20f, 1)) && !PED::IS_PED_RAGDOLL(iLocal_59)) && func_215(&uLocal_63, "SONARAU", "SONAR_FOLLOW", 7, 0, 0, 0)){
iLocal_232=MISC::GET_GAME_TIMER();
iLocal_235++;
}}}
break;
...
if(PED::IS_PED_BEING_JACKED(iLocal_59)){
return 1;
}
if(func_475(iLocal_54)){
if(PED::IS_PED_IN_VEHICLE(iLocal_59, iLocal_54, 0) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_54, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}
if(((VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_54, 0, 0) || VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_54, 1, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_54, 4, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_54, 5, 0)){
return 1;
}}}
return 0;
}
...
if(bParam4){
return 0;
}elseif(func_280(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
Vector3 func__284(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar2;
Var0={
func_288(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var1={
func_288(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
float fVar2;
Var0={
func_288(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
if(fParam2 < 0.1f || fParam2 > 360f){
return 1;
}
...
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_59, 4, 1);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_59, 1024, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_59, 281, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_59, 29, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_59, 116, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_59, 118, 1);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_59, 1);
TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_59, 0);
TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(iLocal_59, 0);
}}
...
void func_301(){
if(!func_475(iLocal_54)){
iLocal_54=VEHICLE::CREATE_VEHICLE(iLocal_53, Local_55, fLocal_56, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_53);
}
if(func_475(iLocal_54)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_54, 3);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_54, 1);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_53, 1);
...
if(func_475(iLocal_59)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_59, "ABIGAIL", 0, 0, 0);
}
func_355();
...
case 2:
if(CUTSCENE::IS_CUTSCENE_PLAYING()){
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ABIGAIL", func_510(16)) && func_475(iLocal_59)){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_59, -1579.27f, 5194.96f, 2.99f, 1f, 20000, 0.25f, 1, 1193033728);
}
...
}}elseif(MISC::IS_BIT_SET(Global_113810.f_20567.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_309() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_309() /*5568*/].f_681.f_10, iParam0);
}


var func__312(int iParam0, int iParam1){
if(iParam1==-1){
iParam1=func_19();
}
...
if(!func_360(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
if((!func_233() && HUD::HAS_ADDITIONAL_TEXT_LOADED(0)) && STREAMING::HAS_MODEL_LOADED(iLocal_53)){
PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.1f);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_53, 1);
if(func_475(Local_52.f_35[0])){
...
void func_371(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_373(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
break;
default:
StringCopy(&Var0, func_374(iVar1), 8);
break;
}
break;
default:
...
break;
case 1:
func_393(-1595.201f, 5217.495f, 3.0009f, 208.2675f, -1580.236f, 5169.585f, 18.5846f, 189.4926f, -1587.11f, 5204.18f, 3.02f, -143.87f, Local_55, fLocal_56);
func_238(2);
break;
case 2:
func_393(0f, 0f, 0f, 0f, -1580.236f, 5169.585f, 18.5846f, 189.4926f, 0f, 0f, 0f, 0f, Local_55, fLocal_56);
func_238(2);
break;
case 3:
...
if(!func_392()){
func_390(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1112014848, 12, 5000, 0, 0);
}
func_389(0, -1, 1);
func_388(1, 1, 1);
}
...
void func_390(struct<3> Param0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5){
var uVar0;
int iVar1;
...
void func_393(struct<3> Param0, float fParam1, struct<3> Param2, float fParam3, struct<3> Param4, float fParam5, struct<3> Param6, float fParam7){
int iVar0;
if(func_349(Param0)){
while (!func_398(&iVar0, 0, Param2, fParam3, 1, 0)){
wait(0);
}
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar0, -1);
func_397(&iVar0);
}elseif(!func_473()){
func_342(PLAYER::PLAYER_PED_ID(), Param0, fParam1, 0, 1);
}
STREAMING::REQUEST_MODEL(iLocal_53);
while (!STREAMING::HAS_MODEL_LOADED(iLocal_53)){
wait(0);
}
while (!func_394(&iLocal_59, 16, Param4, fParam5, "RC ABIGAIL 2", 1)){
wait(0);
}
iLocal_54=VEHICLE::CREATE_VEHICLE(iLocal_53, Param6, fParam7, 1, 1, 0);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_53, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_53);
func_301();
if(func_349(Param4)){
PED::SET_PED_INTO_VEHICLE(iLocal_59, iLocal_54, -1);
}}

int func_394(var uParam0, int iParam1, struct<3> Param2, var uParam3, char* sParam4, int iParam5){
if(func_395(uParam0, iParam1, Param2, uParam3, 1)){
...
int func_395(int iParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_162(iParam1)){
...
int func_398(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5){
var uVar0;
var uVar1;
struct<97> Var2;
int iVar3;
...
var uVar5;
var uVar6;
if((func_162(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0)){
...
return 1;
}elseif(func_422(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_350(iParam0, 0, 0)) || func_350(iParam0, 1, 0)) || func_350(iParam0, 2, 0)) || func_456(iParam0) !=145) || func_455(iParam0)) || func_454(iParam0)) || func_405(iParam0)) || func_453(iParam0)) || !func_443(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_454(iParam0)){
}
if(func_454(iParam0)){
}
...
}elseif(func_465(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_466() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
func_7(&uLocal_40, 0, 0);
PLAYER::SET_WANTED_LEVEL_MULTIPLIER(1f);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_53, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_53);
func_6(&iLocal_60);
func_487(&iLocal_59, 1, 0, 1);
if(func_475(iLocal_54)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_54, 1);
}
func_397(&iLocal_54);
func_355();
func_486(&uLocal_63, 3);
func_477(&Local_52, 0, 0, 0);
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_241, 0);
if(iParam0==1){
...
void func_487(var uParam0, int iParam1, int iParam2, int iParam3){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!PED::IS_PED_INJURED(*uParam0)){
