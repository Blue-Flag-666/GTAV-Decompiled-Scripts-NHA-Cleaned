...
void func_9(){
bool bVar0;
if(ENTITY::IS_ENTITY_DEAD(Local_41.f_1, 0)){
func_181();
}
if(bLocal_44){
...
struct<53> Var2;
int iVar3;
if(!MISC::IS_BIT_SET(Global_1950844.f_3, 27)){
PED::SET_PED_TO_RAGDOLL(Local_41.f_1, 3000, 3500, 0, 1, 1, 0);
}
Global_1945110=1;
...
if(MISC::IS_BIT_SET(Global_1950844, 15)){
MISC::CLEAR_BIT(&Global_1950844, 15);
}
if(MISC::IS_BIT_SET(Global_1950844.f_2, 6)){
...
if(!ENTITY::IS_ENTITY_DEAD(Local_41.f_1, 0)){
ENTITY::SET_ENTITY_COORDS(Local_41.f_1, Var2.f_5, 1, 0, 0, 1);
}
wait(500);
...
MISC::CLEAR_AREA_OF_VEHICLES(uParam1->f_5 + uParam1->f_19, (vmag(uParam1->f_22) + 25f), 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA(uParam1->f_5 + uParam1->f_19, (vmag(uParam1->f_22) + 25f), 1, 0, 0, 0);
}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
...
while ((!VEHICLE::HAS_INSTANT_FILL_VEHICLE_POPULATION_FINISHED() && !func_58()) && timera() < 1500){
wait(0);
}
if(timera() > 1500){
if(iParam3==1){
...
if(iVar0==0){
if(iParam0==1){
if(!MISC::IS_BIT_SET(Global_100833.f_20, 2)){
MISC::SET_GAME_PAUSED(1);
MISC::SET_BIT(&(Global_100833.f_20), 2);
}}elseif(MISC::IS_BIT_SET(Global_100833.f_20, 2)){
MISC::SET_GAME_PAUSED(0);
...
}elseif(bVar14 || ((!func_103(PLAYER::PLAYER_ID(), 0) && !func_102()) && !func_101(PLAYER::PLAYER_ID()))){
...
Local_41.f_4=0;
if(!func_110(Global_44355[iLocal_52 /*5*/].f_2)){
return;
}
iVar0=MISC::GET_RANDOM_INT_IN_RANGE(500, 3000);
Local_50.f_0=5;
Local_49.f_2=(timera() + iVar0);
}
...
if(PED::IS_PED_IN_ANY_VEHICLE(Local_41.f_1, 0) || PED::IS_PED_GETTING_INTO_A_VEHICLE(Local_41.f_1)){
return 0;
}
...
if((Global_44355[iLocal_52 /*5*/].f_3 < 3 && Global_44355[iLocal_52 /*5*/].f_3 !=0) && Global_44355[iLocal_52 /*5*/].f_3 > Global_44355[iLocal_52 /*5*/].f_4){
return 0;
}
if((Global_44355[iLocal_52 /*5*/].f_4 < 9 && Global_44355[iLocal_52 /*5*/].f_4 !=0) && Global_44355[iLocal_52 /*5*/].f_4 > Global_44355[iLocal_52 /*5*/].f_3){
return 0;
}
...
if(!PED::IS_PED_INJURED(Local_41.f_1)){
TASK::TASK_PLAY_ANIM(Local_41.f_1, sVar2, sVar3, 1.5f, -1.5f, -1, 48, 0, 0, 0, 0);
sLocal_48=sVar3;
}}}
...
PED::SET_PED_ALTERNATE_MOVEMENT_ANIM(Local_41.f_1, 0, sVar1, "idle", 2f, 1);
Local_50.f_2=sVar1;
bLocal_45=true;
iVar4=0;
...
}}elseif(PED::IS_PED_MALE(Local_41.f_1)){
iVar4="FACIALS@GEN_MALE@BASE";
}else{
iVar4="FACIALS@GEN_FEMALE@BASE";
}
...
PED::SET_PED_RESET_FLAG(Local_41.f_1, 200, 1);
PED::SET_PED_RESET_FLAG(Local_41.f_1, 46, 1);
PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(Local_41.f_1, 0);
PED::SET_PED_FLEE_ATTRIBUTES(Local_41.f_1, 262144, 1);
AUDIO::SET_PED_IS_DRUNK(Local_41.f_1, 1);
return 1;
}
...
if(MISC::IS_STRING_NULL_OR_EMPTY(Local_50.f_2)){
if(MISC::IS_STRING_NULL_OR_EMPTY(uVar1)){
return 1;
}else{
return 0;
}}
return MISC::ARE_STRINGS_EQUAL(Local_50.f_2, sVar1);
}
...
if(ENTITY::IS_ENTITY_DEAD(Local_41.f_4, 0)){
return 0;
}
Var0={
ENTITY::GET_ENTITY_COORDS(Local_41.f_1, 1) 
};
Var1={
ENTITY::GET_ENTITY_COORDS(Local_41.f_4, 1) 
};
...
if(Global_44355[iLocal_52 /*5*/].f_2==0 || Global_44355[iLocal_52 /*5*/].f_2==2){
PED::SET_PED_STEALTH_MOVEMENT(Local_41.f_1, 0, 0);
}}
if(PED::IS_PED_DUCKING(Local_41.f_1)){
PED::SET_PED_DUCKING(Local_41.f_1, 0);
}}
if(Local_49.f_0 !=-2){
if(Local_49.f_0==-1){
if(Global_44355[iLocal_52 /*5*/].f_2 !=0){
Global_44355[iLocal_52 /*5*/].f_2=0;
}}else{
iVar0=(Local_49.f_0 - timera());
if(iVar0 <=0){
iVar0=0;
...
if(Global_44355[iLocal_52 /*5*/].f_2==0){
if(iVar0 < 30){
Global_44355[iLocal_52 /*5*/].f_2=2;
if(!func_110(2)){
Global_44355[iLocal_52 /*5*/].f_2=0;
return;
}}}
if(Global_44355[iLocal_52 /*5*/].f_2==2){
if(iVar0 < 10){
Global_44355[iLocal_52 /*5*/].f_2=1;
if(!func_110(2)){
Global_44355[iLocal_52 /*5*/].f_2=2;
return;
}}}
if(Global_44355[iLocal_52 /*5*/].f_2==1){
}}}else{
return;
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_48)){
if(!func_113(Local_41.f_1)){
sVar1="MOVE_M@DRUNK@TRANSITIONS";
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_41.f_1, sVar1, sLocal_48, 3)){
TASK::STOP_ANIM_TASK(Local_41.f_1, sVar1, sLocal_48, -4f);
}
sLocal_48="";
return;
}}
if((Global_44355[iLocal_52 /*5*/].f_3 >=10 || Global_44355[iLocal_52 /*5*/].f_4 >=15) || MISC::IS_BIT_SET(Global_44572, 9)){
if(TASK::GET_SCRIPT_TASK_STATUS(Local_41.f_1, joaat("script_task_synchronized_scene"))==1 && !MISC::IS_BIT_SET(Global_1950844.f_3, 27)){
return;
}
if(AUDIO::IS_ANY_SPEECH_PLAYING(Local_41.f_1)){
return;
}
if(PED::IS_PED_IN_ANY_VEHICLE(Local_41.f_1, 1)){
if(Global_44355[iLocal_52 /*5*/].f_3 >=10){
Global_44355[iLocal_52 /*5*/].f_3=9;
}
if(Global_44355[iLocal_52 /*5*/].f_4 >=15){
Global_44355[iLocal_52 /*5*/].f_4=14;
}
return;
}
...
iVar0=0;
iVar0=PED::GET_VEHICLE_PED_IS_IN(Local_41.f_1, 0);
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
return 0;
}
if(!VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar0, -1, 0)==Local_41.f_1){
return 0;
}
Local_41.f_4=iVar0;
Local_50.f_0=7;
...
void func_141(){
if(!PED::IS_PED_IN_ANY_VEHICLE(Local_41.f_1, 0)){
Local_50.f_0=4;
return;
}}
...
iVar0=Local_41.f_1;
if(PED::IS_PED_IN_ANY_VEHICLE(Local_41.f_1, 0)){
iVar1=PED::GET_VEHICLE_PED_IS_IN(Local_41.f_1, 0);
...
iVar0=iVar1;
}elseif(!PLAYER::PLAYER_PED_ID()==Local_41.f_1){
return;
...
if(timera() < Local_49.f_4){
func_145(iVar0, fLocal_47);
return;
}
if(ENTITY::IS_ENTITY_A_PED(iVar0)){
Local_49.f_4=timera() + 2000;
}else{
Local_49.f_4=timera() + 1000;
}
...
if(Local_49.f_1==-1){
fLocal_47=func_144(iVar0, 0.13f, 0.06f);
}else{
iVar4=(Local_49.f_1 - timera());
if(iVar4 < 5000){
fLocal_47=0f;
}elseif(iVar4 < 15000){
fLocal_47=func_144(iVar0, 0.05f, 0.02f);
}elseif(iVar4 < 30000){
fLocal_47=func_144(iVar0, 0.07f, 0.03f);
}elseif(iVar4 < 45000){
fLocal_47=func_144(iVar0, 0.09f, 0.04f);
}elseif(iVar4 < 600000){
fLocal_47=func_144(iVar0, 0.1f, 0.05f);
}else{
fLocal_47=func_144(iVar0, 0.13f, 0.06f);
}}
func_145(iVar0, fLocal_47);
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
if(Global_44355[iLocal_52 /*5*/].f_3 >=10 || Global_44355[iLocal_52 /*5*/].f_4 >=15){
if(Global_44355[iLocal_52 /*5*/].f_3 >=10){
Global_44355[iLocal_52 /*5*/].f_3=9;
}
if(Global_44355[iLocal_52 /*5*/].f_4 >=15){
...
TASK::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(Local_41.f_1, iVar1, 0);
Local_50.f_0=9;
Local_49.f_3=timera() + 1000;
}
...
iVar2=VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_41.f_4, -1, 0);
if(iVar2==Local_41.f_1){
func_148();
return;
}
TASK::TASK_SHUFFLE_TO_NEXT_VEHICLE_SEAT(Local_41.f_1, iVar0, 0);
Local_50.f_0=9;
Local_49.f_3=timera() + 1000;
return;
}
...
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(Local_41.f_4, 0)){
Local_41.f_4=0;
Local_50.f_0=4;
return;
}
...
Local_50.f_0=5;
Local_49.f_2=timera() + 2000;
return;
}
iVar3=VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(Local_41.f_4);
iVar4=0;
bVar5=true;
iVar4=1;
while (bVar5){
if(iVar4 < iVar3){
if(VEHICLE::IS_VEHICLE_SEAT_FREE(Local_41.f_4, iVar4, 0)){
bVar5=false;
}else{
iVar4++;
}}else{
...
func_152();
TASK::TASK_ENTER_VEHICLE(Local_41.f_1, Local_41.f_4, -1, iVar4, 1073741824, 1, 0);
Local_50.f_0=7;
}
...
if(!PED::IS_PED_INJURED(Local_41.f_1)){
PED::RESET_PED_MOVEMENT_CLIPSET(Local_41.f_1, 1048576000);
PED::RESET_PED_STRAFE_CLIPSET(Local_41.f_1);
PED::CLEAR_PED_ALTERNATE_MOVEMENT_ANIM(Local_41.f_1, 0, -1056964608);
Local_50.f_2="";
PED::CLEAR_FACIAL_IDLE_ANIM_OVERRIDE(Local_41.f_1);
PED::SET_PED_RESET_FLAG(Local_41.f_1, 200, 0);
PED::SET_PED_RESET_FLAG(Local_41.f_1, 46, 0);
PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(Local_41.f_1, 1);
PED::SET_PED_FLEE_ATTRIBUTES(Local_41.f_1, 262144, 0);
AUDIO::SET_PED_IS_DRUNK(Local_41.f_1, 0);
}
if(!bLocal_45){
return;
}
...
if(Local_49.f_0==-1){
Global_44355[iLocal_52 /*5*/].f_2=0;
}elseif(Global_44355[iLocal_52 /*5*/].f_3 < 3 && Global_44355[iLocal_52 /*5*/].f_3 !=0){
Global_44355[iLocal_52 /*5*/].f_2=-1;
}else{
iVar0=(Local_49.f_0 - timera());
if(iVar0 <=0){
...
if(!iVar0==6){
if(Global_44436[iVar1 /*6*/].f_1==iLocal_42){
func_160(iVar1);
func_159(iVar1);
}elseif(Global_44436[iVar1 /*6*/].f_1==2){
if(!iLocal_43==-1){
if(iLocal_43==Global_44436[iVar1 /*6*/]){
func_160(iVar1);
}}}}
iVar1++;
}}
...
void func_162(){
int iVar0;
Global_44355[iLocal_52 /*5*/].f_4++;
if(Local_49.f_0==-1){
Global_44355[iLocal_52 /*5*/].f_2=0;
}elseif(Global_44355[iLocal_52 /*5*/].f_4 < 9 && Global_44355[iLocal_52 /*5*/].f_4 !=0){
Global_44355[iLocal_52 /*5*/].f_2=-1;
}else{
iVar0=(Local_49.f_0 - timera());
if(iVar0 <=0){
...
if(!func_117(Local_41.f_1)){
func_110(Global_44355[iLocal_52 /*5*/].f_2);
}}}


void func_163(int iParam0){
int iVar0;
Global_44355[iLocal_52 /*5*/].f_3=(Global_44355[iLocal_52 /*5*/].f_3 + iParam0);
if(Local_49.f_0==-1){
Global_44355[iLocal_52 /*5*/].f_2=0;
}elseif(Global_44355[iLocal_52 /*5*/].f_3 < 3 && Global_44355[iLocal_52 /*5*/].f_3 !=0){
Global_44355[iLocal_52 /*5*/].f_2=-1;
...
if(iLocal_51 < 0){
iLocal_51=PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
return;
}
...
if(!Local_49.f_0==-1){
if(!Local_49.f_0==-2){
if(timera() >=Local_49.f_0){
func_152();
Local_49.f_0=-2;
Local_50.f_0=12;
}}
if(timera() > Local_49.f_1){
func_181();
}}}
...
if(!ENTITY::IS_ENTITY_DEAD(Local_41.f_1, 0)){
iVar0=func_70(Local_41.f_1);
if(Global_44355[iLocal_52 /*5*/].f_4 > 0){
switch (iVar0){
case 0:
...
uVar0=Local_41.f_1;
if(PED::IS_PED_IN_ANY_VEHICLE(Local_41.f_1, 0)){
uVar1=PED::GET_VEHICLE_PED_IS_IN(Local_41.f_1, 0);
iVar2=VEHICLE::GET_PED_IN_VEHICLE_SEAT(uVar1, -1, 0);
if(!Local_41.f_1==iVar2){
return;
}
uVar0=iVar1;
}elseif(!CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==4 || !PLAYER::PLAYER_PED_ID()==Local_41.f_1){
return;
}
fLocal_47=0f;
func_145(uVar0, 0f);
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_184(iParam2), 1);
}
