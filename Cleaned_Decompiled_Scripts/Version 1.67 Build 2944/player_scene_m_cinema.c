...
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_71) > 100f){
return 1;
}
return 0;
}
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_70[iParam1 /*4*/]))){
start_new_script_with_args(&(Local_70[iParam1 /*4*/]), &(iLocal_67[iParam1]), 1, 1424);
iLocal_69[iParam1]=4;
return 0;
}
if(func_4(iParam0)){
...
return 0;
}}}elseif(iParam1==func_8(Global_100554) && iParam1 !=0){
Global_100554=0;
}}
return 1;
}
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_70[iVar0 /*4*/]))){
SCRIPT::REQUEST_SCRIPT(&(Local_70[iVar0 /*4*/]));
if(!SCRIPT::HAS_SCRIPT_LOADED(&(Local_70[iVar0 /*4*/]))){
bVar2=false;
}}
iVar0++;
}
...
while (iVar0 < iLocal_67){
if(iLocal_68[iVar0] !=0){
iLocal_67[iVar0]=PED::CREATE_PED(4, iLocal_68[iVar0], Local_71 + Local_73[iVar0 /*3*/], 0, 1, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_67[iVar0], (fLocal_72 + fLocal_74[iVar0]));
...
case 97:
Local_73[0 /*3*/]={
Vector(45.5004f, -205.8167f, -1416.54f) - Local_71 
};
Local_73[1 /*3*/]={
Vector(45.5004f, -207.5375f, -1423.898f) - Local_71 
};
Local_73[2 /*3*/]={
Vector(45.5004f, -210.4254f, -1428.501f) - Local_71 
};
Local_73[3 /*3*/]={
Vector(45.5004f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-205.8167f, -210.4254f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1416.54f, -1428.501f)) - Local_71 
};
