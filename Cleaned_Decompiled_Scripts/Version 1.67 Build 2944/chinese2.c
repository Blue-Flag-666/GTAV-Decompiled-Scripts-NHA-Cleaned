...
void func_1(){
if(iLocal_400){
if(INTERIOR::IS_INTERIOR_READY(iLocal_399)){
INTERIOR::PIN_INTERIOR_IN_MEMORY(iLocal_399);
iLocal_400=0;
}}}
...
if(iLocal_401){
if(iLocal_402){
if(AUDIO::PREPARE_MUSIC_EVENT(sLocal_404)){
if(AUDIO::TRIGGER_MUSIC_EVENT(sLocal_404)){
iLocal_401=0;
iLocal_402=0;
return 1;
}}}elseif(AUDIO::TRIGGER_MUSIC_EVENT(sLocal_404)){
iLocal_401=0;
return 1;
}}elseif(iLocal_403){
if(AUDIO::PREPARE_MUSIC_EVENT(sLocal_405)){
iLocal_403=0;
}}
return 0;
}
...
iLocal_142=PLAYER::GET_PLAYERS_LAST_VEHICLE();
if(func_74(iLocal_142) && func_73(iLocal_142, 1995.202f, 3062.156f, 46.0491f, 1) < 5f){
VEHICLE::REQUEST_VEHICLE_ASSET(ENTITY::GET_ENTITY_MODEL(iLocal_142), 3);
}
...
iLocal_381=0;
Local_151[iVar0 /*6*/].f_5=MISC::GET_GAME_TIMER() + 3000;
break;
case 1:
if(!func_65()){
if(!func_34()){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(MISC::GET_GAME_TIMER() > Local_151[iVar0 /*6*/].f_5){
if(iLocal_381 < 13){
if(func_35("DRI1", 2, PLAYER::PLAYER_PED_ID(), "Trevor", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8)){
iLocal_381++;
Local_151[iVar0 /*6*/].f_5=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(4000, 10000));
}}else{
Local_151[iVar0 /*6*/].f_1=0;
}
}
...
break;
case 1:
if(((((((((((((((STREAMING::HAS_MODEL_LOADED(joaat("a_m_m_hillbilly_01")) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_m_hillbilly_02"))) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_methhead_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("burrito"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_cs_fertilizer"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_cs_beer_bot_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_can_01"))) && STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_bank5")) && STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_bank1")) && STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_barrelRoll")) && STREAMING::HAS_ANIM_DICT_LOADED("reaction@male_stand@big_variations@b")) && STREAMING::HAS_ANIM_DICT_LOADED("reaction@male_stand@big_intro@left")) && STREAMING::HAS_ANIM_DICT_LOADED("reaction@male_stand@big_intro@right")) && STREAMING::HAS_ANIM_DICT_LOADED("reaction@male_stand@big_intro@backward")) && ((iLocal_147 <=3 && STREAMING::HAS_MODEL_LOADED(joaat("prop_phone_ing"))) || iLocal_147 > 3)) && ((iLocal_147 <=3 && STREAMING::HAS_MODEL_LOADED(joaat("dubsta"))) || iLocal_147 > 3)){
...
func_31(8, 1);
if(iLocal_177 !=0){
INTERIOR::UNPIN_INTERIOR(iLocal_177);
iLocal_177=0;
}
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 2460.073f, 4964.176f, 46.2405f, 1) > 300f){
Local_151[iVar0 /*6*/].f_2=1;
}elseif(iLocal_147 >=3 && !func_30(22)){
func_27();
Local_151[iVar0 /*6*/].f_1=0;
}
break;
...
break;
case 0:
iLocal_177=INTERIOR::GET_INTERIOR_AT_COORDS(2440.492f, 4969.948f, 52.5247f);
Local_151[iVar0 /*6*/].f_2++;
break;
case 1:
if(!INTERIOR::IS_VALID_INTERIOR(iLocal_177)){
iLocal_177=INTERIOR::GET_INTERIOR_AT_COORDS(2440.492f, 4969.948f, 52.5247f);
}else{
INTERIOR::PIN_INTERIOR_IN_MEMORY(iLocal_177);
Local_151[iVar0 /*6*/].f_2++;
}
break;
case 2:
...
iVar2=func_18(8);
if(iVar2 !=-1){
if(!PED::IS_PED_INJURED(Local_111[iVar2 /*33*/])){
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iVar2 /*33*/], joaat("script_task_synchronized_scene"))==7){
iVar2=func_18(9);
if(iVar2 !=-1){
if(!PED::IS_PED_INJURED(Local_111[iVar2 /*33*/])){
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iVar2 /*33*/], joaat("script_task_synchronized_scene"))==7){
...
switch (Local_151[iVar0 /*6*/].f_2){
case 0:
Local_151[iVar0 /*6*/].f_5=MISC::GET_GAME_TIMER() + 7000;
Local_151[iVar0 /*6*/].f_2++;
break;
case 1:
if(MISC::GET_GAME_TIMER() > Local_151[iVar0 /*6*/].f_5){
...
switch (Local_151[iVar0 /*6*/].f_2){
case 0:
uLocal_171=OBJECT::GET_RAYFIRE_MAP_OBJECT(2457.15f, 4968.79f, 48.677f, 45f, "DES_FarmHs");
if(OBJECT::DOES_RAYFIRE_MAP_OBJECT_EXIST(uLocal_171)){
OBJECT::SET_STATE_OF_RAYFIRE_MAP_OBJECT(uLocal_171, 2);
Local_151[iVar0 /*6*/].f_2++;
}
break;
case 1:
if(OBJECT::GET_STATE_OF_RAYFIRE_MAP_OBJECT(uLocal_171)==3){
OBJECT::SET_STATE_OF_RAYFIRE_MAP_OBJECT(uLocal_171, 4);
Local_151[iVar0 /*6*/].f_2++;
}
break;
case 2:
if(iLocal_172==1){
if(OBJECT::GET_STATE_OF_RAYFIRE_MAP_OBJECT(uLocal_171)==5){
OBJECT::SET_STATE_OF_RAYFIRE_MAP_OBJECT(uLocal_171, 6);
...
if(!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_petrolcan"), 0) || !OBJECT::DOES_PICKUP_EXIST(uLocal_174)){
iLocal_178=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 20f, WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_petrolcan")), 0, 0, 1);
if(iLocal_178 !=0){
...
func_10(157, 0);
if(iLocal_165==0){
iLocal_165=WEAPON::GET_AMMO_IN_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_petrolcan"));
}else{
func_9(158, (iLocal_165 - WEAPON::GET_AMMO_IN_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_petrolcan"))), 1);
}
}
if(func_8()){
func_11(0, 157);
...
break;
case 17:
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2447.671f, 4951.438f, 43.25576f, 2454.664f, 4957.856f, 47.89117f, 6.8125f, 0, 1, 0) && MISC::GET_GAME_TIMER() > Local_151[iVar0 /*6*/].f_5){
if(HUD::DOES_BLIP_EXIST(uLocal_176)){
HUD::REMOVE_BLIP(&uLocal_176);
}
Local_151[iVar0 /*6*/].f_1=0;
...
Local_151[iVar0 /*6*/].f_5=MISC::GET_GAME_TIMER() + 2000;
...
break;
case 20:
if(!MISC::IS_BIT_SET(Local_151[iVar0 /*6*/].f_5, 0)){
iLocal_378=func_18(4);
if(iLocal_378 !=-1){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), false);
}}elseif(!MISC::IS_BIT_SET(Local_151[iVar0 /*6*/].f_5, 1)){
if(!PED::IS_PED_INJURED(Local_111[iLocal_378 /*33*/]) && ENTITY::DOES_ENTITY_EXIST(Local_111[iLocal_378 /*33*/].f_20)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[iLocal_378 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", 3) && ENTITY::IS_ENTITY_ATTACHED(Local_111[iLocal_378 /*33*/].f_20)){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), true);
}
}}elseif(!MISC::IS_BIT_SET(Local_151[iVar0 /*6*/].f_5, 2)){
if(PED::IS_PED_INJURED(Local_111[iLocal_378 /*33*/])){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), 2);
}
if(!PED::IS_PED_INJURED(Local_111[iLocal_378 /*33*/])){
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[iLocal_378 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", 3)){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), 2);
}
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iLocal_378 /*33*/], joaat("script_task_play_anim"))==2 || TASK::GET_SCRIPT_TASK_STATUS(Local_111[iLocal_378 /*33*/], joaat("script_task_play_anim"))==7){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), 2);
}
if(PED::IS_PED_IN_COMBAT(Local_111[iLocal_378 /*33*/], PLAYER::PLAYER_PED_ID()) || Local_117[iLocal_378 /*24*/].f_3 > 3){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), 2);
}
}}elseif(ENTITY::DOES_ENTITY_EXIST(Local_111[iLocal_378 /*33*/].f_20) && ENTITY::IS_ENTITY_ATTACHED(Local_111[iLocal_378 /*33*/].f_20)){
ENTITY::DETACH_ENTITY(Local_111[iLocal_378 /*33*/].f_20, 0, 0);
}
if(!MISC::IS_BIT_SET(Local_151[iVar0 /*6*/].f_5, 4)){
iLocal_379=func_18(5);
if(iLocal_379 !=-1){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), 4);
}}elseif(!MISC::IS_BIT_SET(Local_151[iVar0 /*6*/].f_5, 5)){
if(!PED::IS_PED_INJURED(Local_111[iLocal_379 /*33*/])){
if(ENTITY::DOES_ENTITY_EXIST(Local_111[iLocal_379 /*33*/].f_20)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[iLocal_379 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 3)){
if(ENTITY::IS_ENTITY_ATTACHED(Local_111[iLocal_379 /*33*/].f_20)){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), 5);
}}}
}}elseif(!MISC::IS_BIT_SET(Local_151[iVar0 /*6*/].f_5, 6)){
if(PED::IS_PED_INJURED(Local_111[iLocal_379 /*33*/])){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), 6);
}
if(!PED::IS_PED_INJURED(Local_111[iLocal_379 /*33*/])){
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[iLocal_379 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 3)){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), 6);
}
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iLocal_379 /*33*/], joaat("script_task_play_anim"))==2 || TASK::GET_SCRIPT_TASK_STATUS(Local_111[iLocal_379 /*33*/], joaat("script_task_play_anim"))==7){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), 6);
}
if(PED::IS_PED_IN_COMBAT(Local_111[iLocal_379 /*33*/], PLAYER::PLAYER_PED_ID()) || Local_117[iLocal_379 /*24*/].f_3 > 3){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), 6);
}
}}elseif(ENTITY::DOES_ENTITY_EXIST(Local_111[iLocal_379 /*33*/].f_20) && ENTITY::IS_ENTITY_ATTACHED(Local_111[iLocal_379 /*33*/].f_20)){
ENTITY::DETACH_ENTITY(Local_111[iLocal_379 /*33*/].f_20, 0, 0);
}
break;
case 21:
break;
...
switch (Local_151[iVar0 /*6*/].f_2){
case 1:
iLocal_168[0]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.496f, 4970.916f, 44.5112f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_168[0], -3.44f, 0f, 38.88f, 2, 1);
iLocal_168[1]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.863f, 4970.595f, 44.5425f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_168[1], -3.44f, 0f, 38.88f, 2, 1);
iLocal_168[2]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.896f, 4970.417f, 44.5475f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_168[2], -3.44f, 0f, 38.88f, 2, 1);
iLocal_168[3]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.795f, 4970.246f, 44.5525f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_168[3], -3.44f, 0f, 38.88f, 2, 1);
iLocal_168[4]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.204f, 4970.269f, 44.5201f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_168[4], -3.44f, 0f, 38.88f, 2, 1);
iLocal_168[5]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.372f, 4970.744f, 44.51f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_168[5], -3.44f, 0f, 38.88f, 2, 1);
iLocal_168[6]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.372f, 4971.092f, 44.4987f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_168[6], -3.44f, 0f, 38.88f, 2, 1);
iLocal_168[7]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2493.77f, 4971f, 44.6287f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_168[7], 3.955f, 0f, 139.68f, 2, 1);
iLocal_168[8]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2493.98f, 4971.279f, 44.6038f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_168[8], 3.955f, 0f, 139.68f, 2, 1);
iLocal_168[9]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_ld_can_01"), 2494.104f, 4971.438f, 44.5826f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_168[9], 3.955f, 0f, 139.68f, 2, 1);
iVar4=0;
while (iVar4 < iLocal_168){
ENTITY::SET_ENTITY_DYNAMIC(iLocal_168[iVar4], 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_168[iVar4], 1);
iVar4++;
}
Local_151[iVar0 /*6*/].f_2++;
break;
case 0:
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_179) && !ENTITY::DOES_ENTITY_EXIST(iLocal_180)){
...
iLocal_179=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(2493.5f, 4969.2f, 43.9f, 1f, joaat("prop_barrel_pile_03"), 1, 0, 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_179, 1);
ENTITY::CREATE_MODEL_HIDE(2493.4f, 4971.8f, 43.6f, 1f, joaat("prop_pallet_pile_01"), 0);
iLocal_180=OBJECT::CREATE_OBJECT(joaat("prop_pallet_pile_01"), 2493.427f, 4971.729f, 43.54362f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_180, -1.436373f, 0.176147f, -36.6601f, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_180, 1);
func_32(24, 0);
Local_151[iVar0 /*6*/].f_2++;
}}else{
OBJECT::DELETE_OBJECT(&iLocal_180);
iLocal_180=OBJECT::CREATE_OBJECT(joaat("prop_pallet_pile_01"), 2493.427f, 4971.729f, 43.54362f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_180, -1.436373f, 0.176147f, -36.6601f, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_180, 1);
func_32(24, 0);
...
iVar4=0;
while (iVar4 < iLocal_168){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_168[iVar4])){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_168[iVar4], 0);
}
iVar4++;
}
Local_151[iVar0 /*6*/].f_1=0;
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_179, PLAYER::PLAYER_PED_ID(), 1) || func_4(PLAYER::PLAYER_PED_ID(), iLocal_179, 1) < 30f){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_179, 0);
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), false);
}}
}}
if(!MISC::IS_BIT_SET(Local_151[iVar0 /*6*/].f_5, 1)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_180)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_180, PLAYER::PLAYER_PED_ID(), 1) || func_4(PLAYER::PLAYER_PED_ID(), iLocal_180, 1) < 30f){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_180, 0);
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), true);
}}
}}
if((MISC::IS_BIT_SET(Local_151[iVar0 /*6*/].f_5, 0) && MISC::IS_BIT_SET(Local_151[iVar0 /*6*/].f_5, 1)) || iLocal_147==6){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_179)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_179, 0);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_180)){
...
switch (Local_151[iVar0 /*6*/].f_2){
case -1:
if(ENTITY::DOES_ENTITY_EXIST(Local_111[12 /*33*/])){
PED::DELETE_PED(&(Local_111[12 /*33*/]));
}
if(ENTITY::DOES_ENTITY_EXIST(Local_111[13 /*33*/])){
PED::DELETE_PED(&(Local_111[13 /*33*/]));
}
if(ENTITY::DOES_ENTITY_EXIST(Local_111[14 /*33*/])){
PED::DELETE_PED(&(Local_111[14 /*33*/]));
}
...
if(ENTITY::DOES_ENTITY_EXIST(Local_111[13 /*33*/]) && !PED::IS_PED_INJURED(Local_111[13 /*33*/])){
ENTITY::SET_ENTITY_COORDS(Local_111[13 /*33*/], 1986.06f, 3051.708f, 46.2151f, 1, 0, 0, 1);
}
if(ENTITY::DOES_ENTITY_EXIST(Local_111[14 /*33*/]) && !PED::IS_PED_INJURED(Local_111[14 /*33*/])){
ENTITY::SET_ENTITY_COORDS(Local_111[14 /*33*/], 1986.105f, 3051.659f, 46.2151f, 1, 0, 0, 1);
}
Local_151[iVar0 /*6*/].f_2++;
}}
break;
...
if(!ENTITY::DOES_ENTITY_EXIST(Local_111[13 /*33*/])){
Local_111[13 /*33*/]=PED::CREATE_PED(26, joaat("ig_old_man1a"), 1987.231f, 3052.741f, 46.214f, 0, 1, 1);
}
if(!ENTITY::DOES_ENTITY_EXIST(Local_111[14 /*33*/])){
Local_111[14 /*33*/]=PED::CREATE_PED(26, joaat("ig_old_man2"), 1987.231f, 3052.741f, 46.214f, 0, 1, 1);
}
if(!ENTITY::DOES_ENTITY_EXIST(Local_111[12 /*33*/])){
Local_111[12 /*33*/]=PED::CREATE_PED(26, joaat("ig_janet"), 1987.231f, 3052.741f, 46.214f, 0, 1, 1);
}
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), true);
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_111[14 /*33*/], 1984.89f, 3052.46f, 46.98f, 0.3f, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[14 /*33*/], 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_111[14 /*33*/], 0);
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), false);
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_111[13 /*33*/], 1985.322f, 3053.087f, 46.98f, 0.3f, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[13 /*33*/], 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_111[13 /*33*/], 0);
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_151[iVar0 /*6*/].f_5)){
Local_151[iVar0 /*6*/].f_5=PED::CREATE_SYNCHRONIZED_SCENE(1987.231f, 3052.741f, 46.214f, 0f, 0f, 57.6f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(Local_151[iVar0 /*6*/].f_5, 1);
}
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[12 /*33*/], Local_151[iVar0 /*6*/].f_5, "MISSChinese2_crystalMazeMCS1_IG", "bar_peds_action_janet", 1000f, -1000f, 1, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[12 /*33*/], 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_111[12 /*33*/], 0);
Local_151[iVar0 /*6*/].f_5=0;
Local_151[iVar0 /*6*/].f_2++;
}
break;
...
if(!PED::IS_PED_INJURED(Local_111[13 /*33*/]) && !PED::IS_PED_INJURED(Local_111[14 /*33*/])){
PED::SET_PED_CONFIG_FLAG(Local_111[13 /*33*/], 152, 1);
PED::SET_PED_CONFIG_FLAG(Local_111[14 /*33*/], 152, 1);
if(MISC::IS_BIT_SET(Local_151[iVar0 /*6*/].f_5, 0) && MISC::IS_BIT_SET(Local_151[iVar0 /*6*/].f_5, 1)){
Local_151[iVar0 /*6*/].f_2++;
}else{
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[13 /*33*/], joaat("script_task_start_scenario_in_place")) !=1){
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(1984.89f, 3052.46f, 46.98f, 0.3f, 1)){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), false);
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_111[13 /*33*/], 1984.89f, 3052.46f, 46.98f, 0.3f, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_111[13 /*33*/], 0);
}
}
else{
...
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[14 /*33*/], joaat("script_task_start_scenario_in_place")) !=1){
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(1985.322f, 3053.087f, 46.98f, 0.3f, 1)){
MISC::SET_BIT(&(Local_151[iVar0 /*6*/].f_5), true);
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_111[14 /*33*/], 1985.322f, 3053.087f, 46.98f, 0.3f, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_111[14 /*33*/], 0);
}
}
else{
...
break;
case 6:
if(!PED::IS_PED_INJURED(Local_111[12 /*33*/])){
TASK::TASK_SMART_FLEE_PED(Local_111[12 /*33*/], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(Local_111[12 /*33*/], 1);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_111[12 /*33*/]));
}
if(!PED::IS_PED_INJURED(Local_111[13 /*33*/])){
TASK::TASK_SMART_FLEE_PED(Local_111[13 /*33*/], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(Local_111[13 /*33*/], 1);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_111[13 /*33*/]));
}
if(!PED::IS_PED_INJURED(Local_111[14 /*33*/])){
TASK::TASK_SMART_FLEE_PED(Local_111[14 /*33*/], PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(Local_111[14 /*33*/], 1);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_111[14 /*33*/]));
}
...
if(HUD::DOES_BLIP_EXIST(Local_107[iVar0 /*5*/].f_3)){
if(HUD::GET_BLIP_ALPHA(Local_107[iVar0 /*5*/].f_3) < 255){
HUD::REMOVE_BLIP(&(Local_107[iVar0 /*5*/].f_3));
}else{
HUD::SET_BLIP_ALPHA(Local_107[iVar0 /*5*/].f_3, 0);
}}
iVar0++;
}
iLocal_84=1;
...
while (iVar0 < Local_107.f_0){
if(HUD::DOES_BLIP_EXIST(Local_107[iVar0 /*5*/].f_3)){
HUD::SET_BLIP_ALPHA(Local_107[iVar0 /*5*/].f_3, 255);
}else{
Local_107[iVar0 /*5*/].f_3=func_5(Local_107[iVar0 /*5*/], 0);
HUD::SET_BLIP_HIDDEN_ON_LEGEND(Local_107[iVar0 /*5*/].f_3, 1);
HUD::SET_BLIP_SCALE(Local_107[iVar0 /*5*/].f_3, 0.4f);
HUD::SET_BLIP_ALPHA(Local_107[iVar0 /*5*/].f_3, 0);
HUD::SET_BLIP_COLOUR(Local_107[iVar0 /*5*/].f_3, 5);
HUD::SHOW_HEIGHT_ON_BLIP(Local_107[iVar0 /*5*/].f_3, 0);
}
iVar0++;
}
iLocal_84=0;
...
iLocal_143=VEHICLE::CREATE_VEHICLE(joaat("burrito"), 2479.579f, 4980.503f, 44.8051f, 341.8158f, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_143, 1);
VEHICLE::SET_VEHICLE_LIVERY(iLocal_143, 2);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_143, 1084227584);
if(iLocal_147 < 5){
func_29(1, 1, 4);
func_29(1, 1, 5);
func_29(1, 1, 2);
...
Local_111[15 /*33*/]=PED::CREATE_PED(26, joaat("a_m_y_methhead_01"), 2436.901f, 4959.1f, 45.8106f, 209.7559f, 1, 1);
TASK::TASK_PLAY_ANIM(Local_111[15 /*33*/], "DEAD", "DEAD_C", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[15 /*33*/], 1, 0);
AUDIO::DISABLE_PED_PAIN_AUDIO(Local_111[15 /*33*/], 1);
Local_111[16 /*33*/]=PED::CREATE_PED(26, joaat("a_m_m_hillbilly_01"), 2440.266f, 4970.705f, 45.8306f, 15.7982f, 1, 1);
TASK::TASK_PLAY_ANIM(Local_111[16 /*33*/], "DEAD", "DEAD_D", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[16 /*33*/], 1, 0);
AUDIO::DISABLE_PED_PAIN_AUDIO(Local_111[16 /*33*/], 1);
Local_111[17 /*33*/]=PED::CREATE_PED(26, joaat("a_m_m_hillbilly_02"), 2443.42f, 4974.523f, 45.8106f, 121.834f, 1, 1);
TASK::TASK_PLAY_ANIM(Local_111[17 /*33*/], "DEAD", "DEAD_E", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[17 /*33*/], 1, 0);
AUDIO::DISABLE_PED_PAIN_AUDIO(Local_111[17 /*33*/], 1);
Local_111[18 /*33*/]=PED::CREATE_PED(26, joaat("a_m_y_methhead_01"), 2448.888f, 4971.561f, 45.8106f, 194.7676f, 1, 1);
TASK::TASK_PLAY_ANIM(Local_111[18 /*33*/], "DEAD", "DEAD_G", 1000f, -1000f, -1, 1, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[18 /*33*/], 1, 0);
AUDIO::DISABLE_PED_PAIN_AUDIO(Local_111[18 /*33*/], 1);
while (((!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[15 /*33*/], "DEAD", "DEAD_C", 3) || !ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[16 /*33*/], "DEAD", "DEAD_D", 3)) || !ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[17 /*33*/], "DEAD", "DEAD_E", 3)) || !ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[18 /*33*/], "DEAD", "DEAD_G", 3)){
func_28(54343, 1);
if(((!PED::IS_PED_INJURED(Local_111[15 /*33*/]) && !PED::IS_PED_INJURED(Local_111[16 /*33*/])) && !PED::IS_PED_INJURED(Local_111[17 /*33*/])) && !PED::IS_PED_INJURED(Local_111[18 /*33*/])){
}}
ENTITY::SET_ENTITY_HEALTH(Local_111[15 /*33*/], 0, 0);
ENTITY::SET_ENTITY_HEALTH(Local_111[16 /*33*/], 0, 0);
ENTITY::SET_ENTITY_HEALTH(Local_111[17 /*33*/], 0, 0);
ENTITY::SET_ENTITY_HEALTH(Local_111[18 /*33*/], 0, 0);
...
uLocal_166=OBJECT::CREATE_PICKUP(joaat("pickup_health_standard"), 2446.896f, 4990.972f, 45.5477f, iVar0, -1, 1, 0);
if(!PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(iLocal_146)){
iLocal_146=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(2464.956f, 4990.051f, 44.48415f, 2.5f, 3.125f, 2.0625f, 0f, 0, 7);
}
iLocal_167[0]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_health_standard"), 2444.497f, 4975.956f, 50.565f, 0f, 0f, 100f, iVar0, -1, 2, 1, 0);
INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(iLocal_167[0], "V_8_Bed1Rm");
iLocal_167[1]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_health_standard"), 2443.4f, 4978.52f, 46.8107f, 0f, 0f, 100f, iVar0, -1, 2, 1, 0);
INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(iLocal_167[1], "V_8_KitchnRm");
iLocal_167[3]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_health_standard"), 2441.028f, 4963.851f, 46.5605f, 0f, 0f, -80.6f, iVar0, -1, 2, 1, 0);
INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(iLocal_167[3], "V_8_StudyRm");
iLocal_167[4]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_health_standard"), 2435.165f, 4971.467f, 45.91f, 0f, 0f, -50.4f, iVar0, -1, 2, 1, 0);
INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(iLocal_167[4], "V_8_Hall2Rm");
iVar0=0;
MISC::SET_BIT(&iVar0, 2);
MISC::SET_BIT(&iVar0, true);
MISC::SET_BIT(&iVar0, 3);
iLocal_167[2]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_weapon_sawnoffshotgun"), 2438.788f, 4970.79f, 50.565f, 0f, 0f, 0f, iVar0, -1, 2, 1, 0);
INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(iLocal_167[2], "V_8_Bed1Rm");
}
...
iLocal_390=1;
return 1;
}}elseif(func_36(&uLocal_407, "CHI2AUD", sParam0, iParam13, 0, 0, 0)){
iLocal_390=0;
return 1;
}}}
return 0;
...
int iVar0;
if(MISC::IS_STRING_NULL_OR_EMPTY(uLocal_49) || !MISC::ARE_STRINGS_EQUAL(uLocal_49, uParam0)){
sLocal_49=sParam0;
iVar0=0;
while (iVar0 <=15){
...
if((!PED::IS_PED_INJURED(Local_111[iVar0 /*33*/]) && !PED::IS_PED_DEAD_OR_DYING(Local_111[iVar0 /*33*/], 1)) || Local_117[iVar0 /*24*/].f_3==1){
...
Local_111[iVar0 /*33*/].f_20=OBJECT::CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2460.098f, 4957.283f, 44.1304f, 1, 1, 0);
...
func_106(&Local_117, iVar0, Local_111[iVar0 /*33*/], 0, 0, 0);
Local_111[iVar0 /*33*/].f_20=OBJECT::CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2478.444f, 4976.921f, 44.5614f, 1, 1, 0);
Local_111[iVar0 /*33*/].f_5=1;
...
Local_111[iVar0 /*33*/].f_20=OBJECT::CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2455.753f, 4952.719f, 44.1445f, 1, 1, 0);
Local_111[iVar0 /*33*/].f_5=1;
func_105(iVar0, 3, 0, 0);
}
}
...
func_106(&Local_117, iVar0, Local_111[iVar0 /*33*/], 0, 0, 0);
Local_111[iVar0 /*33*/].f_20=OBJECT::CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2476.582f, 4978.492f, 44.5734f, 1, 1, 0);
...
func_106(&Local_117, iVar0, Local_111[iVar0 /*33*/], 0, 0, 0);
Local_111[iVar0 /*33*/].f_14=PED::CREATE_SYNCHRONIZED_SCENE(2505.451f, 4970.663f, 43.548f, 0f, 0f, 88.725f, 2);
func_104(Local_111[iVar0 /*33*/], 20f, 5f, 90f, -90f, 60f, 1101004800, 1125515264);
AUDIO::SET_AMBIENT_VOICE_NAME(Local_111[iVar0 /*33*/], "A_M_M_HillBilly_02_WHITE_MINI_02");
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[iVar0 /*33*/], Local_111[iVar0 /*33*/].f_14, "misschinese2_bank5", "peds_shootcans_a", 1000f, -4f, 1, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(Local_111[iVar0 /*33*/].f_14, 1);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[iVar0 /*33*/], 0, 0);
...
Local_111[iVar0 /*33*/].f_14=PED::CREATE_SYNCHRONIZED_SCENE(2507.879f, 4970.188f, 43.5f, 0f, 0f, 93.42f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(Local_111[iVar0 /*33*/].f_14, 1);
func_106(&Local_117, iVar0, Local_111[iVar0 /*33*/], 0, 0, 0);
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[iVar0 /*33*/], Local_111[iVar0 /*33*/].f_14, "misschinese2_bank5", "peds_shootcans_b", 1000f, -4f, 1, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[iVar0 /*33*/], 0, 0);
func_105(iVar0, 4, 0, Local_111[iVar0 /*33*/].f_14);
}
break;
}
if(ENTITY::DOES_ENTITY_EXIST(Local_111[iVar0 /*33*/])){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_111[iVar0 /*33*/], 1, 1);
PED::SET_PED_TO_LOAD_COVER(Local_111[iVar0 /*33*/], 1);
}
break;
case 2:
switch (Local_111[iVar0 /*33*/].f_2){
...
PED::SET_PED_ACCURACY(Local_111[iVar0 /*33*/], 5);
func_105(iVar0, 25, 0, 0);
func_106(&Local_117, iVar0, Local_111[iVar0 /*33*/], 0, 1, 0);
}
break;
...
if(!PED::IS_PED_INJURED(Local_111[iVar0 /*33*/])){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_111[iVar0 /*33*/], 1, 1);
}
break;
case 5:
...
if(!PED::IS_PED_INJURED(Local_111[iVar0 /*33*/])){
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_111[iVar0 /*33*/], 1);
...
case 0:
if(ENTITY::DOES_ENTITY_EXIST(Local_111[iVar0 /*33*/].f_20)){
if(ENTITY::DOES_ENTITY_HAVE_DRAWABLE(Local_111[iVar0 /*33*/].f_20) && ENTITY::DOES_ENTITY_HAVE_PHYSICS(Local_111[iVar0 /*33*/].f_20)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_111[iVar0 /*33*/].f_20, Local_111[iVar0 /*33*/], PED::GET_PED_BONE_INDEX(Local_111[iVar0 /*33*/], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1, 0);
Local_111[iVar0 /*33*/].f_5++;
}
if(ENTITY::DOES_ENTITY_EXIST(Local_111[iVar0 /*33*/].f_20)){
if(Local_111[iVar0 /*33*/].f_2==4){
TASK::TASK_PLAY_ANIM(Local_111[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", 1000f, -1f, -1, 1, 0, 0, 0, 0);
}else{
TASK::TASK_PLAY_ANIM(Local_111[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 1000f, -1f, -1, 1, 0, 0, 0, 0);
}
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_111[iVar0 /*33*/], 1, 1);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[iVar0 /*33*/], 0, 0);
Local_111[iVar0 /*33*/].f_5++;
...
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", 3)){
ENTITY::SET_ENTITY_ANIM_SPEED(Local_111[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", 1.4f);
}
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 3)){
ENTITY::SET_ENTITY_ANIM_SPEED(Local_111[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 1.4f);
}
if(ENTITY::DOES_ENTITY_EXIST(Local_111[iVar0 /*33*/].f_20)){
if(Local_111[iVar0 /*33*/].f_5 > 2 && Local_111[iVar0 /*33*/].f_5 <=6){
if(ENTITY::IS_ENTITY_ATTACHED(Local_111[iVar0 /*33*/].f_20)){
Local_111[iVar0 /*33*/].f_12=(func_102(ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*33*/], 1), Local_111[iVar0 /*33*/].f_6, 1) - ENTITY::GET_ENTITY_HEADING(Local_111[iVar0 /*33*/]));
Local_111[iVar0 /*33*/].f_12=func_101((Local_111[iVar0 /*33*/].f_12 / 4f), -15f, 15f);
if(!PED::IS_PED_RAGDOLL(Local_111[iVar0 /*33*/])){
ENTITY::SET_ENTITY_HEADING(Local_111[iVar0 /*33*/], (ENTITY::GET_ENTITY_HEADING(Local_111[iVar0 /*33*/]) + (timestep() * Local_111[iVar0 /*33*/].f_12)));
}
}
}}
switch (Local_111[iVar0 /*33*/].f_5){
...
break;
case 2:
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 3)){
Local_111[iVar0 /*33*/].f_6={
...
break;
case 3:
if(ENTITY::IS_ENTITY_AT_COORD(Local_111[iVar0 /*33*/], Local_111[iVar0 /*33*/].f_6, 1.5f, 1.5f, 2f, 0, 1, 0)){
Local_111[iVar0 /*33*/].f_6={
...
if(ENTITY::IS_ENTITY_AT_COORD(Local_111[iVar0 /*33*/], Local_111[iVar0 /*33*/].f_6, 1.5f, 1.5f, 2f, 0, 1, 0)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", 3)){
TASK::STOP_ANIM_TASK(Local_111[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", -1.5f);
}
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_111[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", 3)){
TASK::STOP_ANIM_TASK(Local_111[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_A", -1.5f);
}
Local_111[iVar0 /*33*/].f_6={
0f, 0f, 0f 
};
if(ENTITY::DOES_ENTITY_EXIST(Local_111[iVar0 /*33*/].f_20)){
ENTITY::DETACH_ENTITY(Local_111[iVar0 /*33*/].f_20, 0, 1);
}
if(func_74(iLocal_143)){
if(Local_111[iVar0 /*33*/].f_2==4){
PED::SET_PED_MOVEMENT_CLIPSET(Local_111[iVar0 /*33*/], "move_m@gangster@var_e", 1048576000);
TASK::TASK_ENTER_VEHICLE(Local_111[iVar0 /*33*/], iLocal_143, -1, -1, 1f, 1, 0);
func_105(func_18(6), 14, 0, 0);
func_105(func_18(7), 33, 0, 0);
}else{
PED::SET_PED_MOVEMENT_CLIPSET(Local_111[iVar0 /*33*/], "move_m@gangster@var_f", 1048576000);
TASK::TASK_ENTER_VEHICLE(Local_111[iVar0 /*33*/], iLocal_143, -1, 0, 1f, 1, 0);
}}
Local_111[iVar0 /*33*/].f_5++;
...
case 7:
func_100(iVar0);
if(PED::IS_PED_IN_ANY_VEHICLE(Local_111[iVar0 /*33*/], 0)){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_111[iVar0 /*33*/], 0, 1);
Local_111[iVar0 /*33*/].f_5++;
}
break;
case 8:
if(func_74(iLocal_143)){
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_143, -1, 0)){
if(Local_111[iVar0 /*33*/].f_2==4){
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_143, 0, 0)){
iVar1=func_18(5);
if(iVar1 >=0){
if(!PED::IS_PED_INJURED(Local_111[iVar1 /*33*/])){
if(PED::IS_PED_SITTING_IN_ANY_VEHICLE(Local_111[iVar1 /*33*/])){
func_99();
TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_143, 2367.668f, 5098.645f, 46.8185f, 12f, 0, joaat("burrito"), 786599, 5f, 5f);
TASK::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_143, 19f, 786599);
...
break;
case 1:
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iVar0 /*33*/], joaat("script_task_perform_sequence"))==7){
...
break;
case 6:
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iVar0 /*33*/], joaat("script_task_start_scenario_in_place"))==7 && Local_111[iVar0 /*33*/].f_5 > 1){
Local_111[iVar0 /*33*/].f_5=0;
}
switch (Local_111[iVar0 /*33*/].f_5){
case 0:
WEAPON::SET_CURRENT_PED_WEAPON(Local_111[iVar0 /*33*/], joaat("weapon_unarmed"), 1);
TASK::TASK_ACHIEVE_HEADING(Local_111[iVar0 /*33*/], 219f, 1500);
Local_111[iVar0 /*33*/].f_5++;
break;
case 1:
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iVar0 /*33*/], joaat("script_task_achieve_heading"))==7){
TASK::TASK_START_SCENARIO_IN_PLACE(Local_111[iVar0 /*33*/], "WORLD_HUMAN_GUARD_STAND_ARMY", 0, 0);
Local_111[iVar0 /*33*/].f_5++;
}
break;
}
...
case 32:
if(!PED::IS_PED_INJURED(Local_111[iVar0 /*33*/])){
if(Local_111[iVar0 /*33*/].f_1==1 || func_4(PLAYER::PLAYER_PED_ID(), Local_111[iVar0 /*33*/], 1) < 20f){
func_103(Local_111[iVar0 /*33*/], &(Local_111[iVar0 /*33*/].f_25), -1, 0, 1, 0, -1082130432, 0, -1, -1, 1, 0, 0);
}
...
switch (Local_111[iVar0 /*33*/].f_5){
case 0:
TASK::TASK_START_SCENARIO_IN_PLACE(Local_111[iVar0 /*33*/], "WORLD_HUMAN_AA_SMOKE", Local_111[iVar0 /*33*/].f_14, 0);
Local_111[iVar0 /*33*/].f_5++;
break;
case 1:
if(func_4(PLAYER::PLAYER_PED_ID(), Local_111[iVar0 /*33*/], 1) < 10f){
iVar3=MISC::GET_RANDOM_INT_IN_RANGE(0, 3);
if(iVar3==0){
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_111[iVar0 /*33*/], "GENERIC_CURSE_MED", "A_M_M_Hillbilly_01_White_mini_03", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
}elseif(iVar3==1){
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_111[iVar0 /*33*/], "GENERIC_INSULT_MED", "A_M_M_Hillbilly_01_White_mini_03", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
}else{
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_111[iVar0 /*33*/], "CHAT_STATE", "A_M_M_Hillbilly_01_White_mini_03", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
}
Local_111[iVar0 /*33*/].f_5++;
Local_111[iVar0 /*33*/].f_14=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000));
}
break;
case 2:
if(MISC::GET_GAME_TIMER() > Local_111[iVar0 /*33*/].f_14){
Local_111[iVar0 /*33*/].f_5=1;
}
break;
case 10:
...
Local_111[iVar0 /*33*/].f_5++;
Local_111[iVar0 /*33*/].f_14=MISC::GET_GAME_TIMER() + 1000;
}
break;
case 11:
if(MISC::GET_GAME_TIMER() > Local_111[iVar0 /*33*/].f_14){
TASK::TASK_TURN_PED_TO_FACE_COORD(Local_111[iVar0 /*33*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 5000);
Local_111[iVar0 /*33*/].f_5++;
Local_111[iVar0 /*33*/].f_14=MISC::GET_GAME_TIMER() + 5000;
}
break;
case 12:
if(PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), Local_111[iVar0 /*33*/]) && func_73(Local_111[iVar0 /*33*/], 2448.003f, 4982.305f, 45.8519f, 1) < 10f){
if(MISC::GET_GAME_TIMER() > (Local_111[iVar0 /*33*/].f_14 - 3000)){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_111[iVar0 /*33*/], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1f, 20000, 0.25f, 0, 1193033728);
Local_111[iVar0 /*33*/].f_5=15;
}}elseif(MISC::GET_GAME_TIMER() > Local_111[iVar0 /*33*/].f_14){
...
func_98(&(Local_111[iVar0 /*33*/]), 0);
Local_111[iVar0 /*33*/].f_14=MISC::GET_GAME_TIMER() + 3000;
Local_111[iVar0 /*33*/].f_5++;
break;
case 14:
if(MISC::GET_GAME_TIMER() > Local_111[iVar0 /*33*/].f_14 || TASK::GET_SCRIPT_TASK_STATUS(Local_111[iVar0 /*33*/], joaat("script_task_perform_sequence"))==7){
Local_111[iVar0 /*33*/].f_5=0;
}
break;
case 15:
...
break;
case 16:
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iVar0 /*33*/], joaat("script_task_follow_nav_mesh_to_coord"))==7){
Local_111[iVar0 /*33*/].f_14=MISC::GET_GAME_TIMER() + 3000;
...
if(MISC::GET_GAME_TIMER() > Local_111[iVar0 /*33*/].f_14){
if(func_74(iLocal_143)){
TASK::TASK_ENTER_VEHICLE(Local_111[iVar0 /*33*/], iLocal_143, 20000, 1, 1f, 1, 0);
Local_111[iVar0 /*33*/].f_5++;
Local_111[iVar0 /*33*/].f_14=0;
Local_111[iVar0 /*33*/].f_15=0;
}
...
if(WEAPON::GET_CURRENT_PED_WEAPON(Local_111[iVar0 /*33*/], &iVar4, 1)){
TASK::TASK_SWAP_WEAPON(Local_111[iVar0 /*33*/], 0);
}
Local_111[iVar0 /*33*/].f_5++;
break;
case 1:
...
func_99();
if(iVar0==1){
if(!PED::IS_PED_INJURED(Local_111[2 /*33*/])){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_111[2 /*33*/], 2000);
}}elseif(iVar0==2){
if(!PED::IS_PED_INJURED(Local_111[1 /*33*/])){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_111[1 /*33*/], 2000);
}}elseif(iVar0==6){
if(!PED::IS_PED_INJURED(Local_111[7 /*33*/])){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_111[7 /*33*/], 2000);
}}elseif(iVar0==7){
if(!PED::IS_PED_INJURED(Local_111[6 /*33*/])){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, Local_111[6 /*33*/], 2000);
}}
if(Local_111[iVar0 /*33*/].f_14 !=0){
TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", Local_111[iVar0 /*33*/].f_14, 0);
}else{
TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
}
func_98(&(Local_111[iVar0 /*33*/]), 0);
Local_111[iVar0 /*33*/].f_5++;
Local_111[iVar0 /*33*/].f_15=MISC::GET_GAME_TIMER() + 15000;
}
break;
case 2:
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iVar0 /*33*/], joaat("script_task_perform_sequence"))==7 || MISC::GET_GAME_TIMER() > Local_111[iVar0 /*33*/].f_15){
TASK::CLEAR_PED_TASKS(Local_111[iVar0 /*33*/]);
Local_111[iVar0 /*33*/].f_5++;
}
break;
case 3:
...
TASK::TASK_SWAP_WEAPON(Local_111[iVar0 /*33*/], 1);
Local_111[iVar0 /*33*/].f_5++;
}else{
Local_111[iVar0 /*33*/].f_5++;
}
...
break;
case 4:
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iVar0 /*33*/], joaat("script_task_swap_weapon"))==7){
if(Local_111[iVar0 /*33*/].f_4==5){
...
switch (Local_111[iVar0 /*33*/].f_5){
case 0:
TASK::TASK_START_SCENARIO_IN_PLACE(Local_111[iVar0 /*33*/], "WORLD_HUMAN_GUARD_STAND", 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[iVar0 /*33*/], 0, 0);
Local_111[iVar0 /*33*/].f_5++;
break;
}
...
switch (Local_111[iVar0 /*33*/].f_5){
case 0:
TASK::TASK_START_SCENARIO_IN_PLACE(Local_111[iVar0 /*33*/], "WORLD_HUMAN_AA_SMOKE", 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[iVar0 /*33*/], 0, 0);
Local_111[iVar0 /*33*/].f_5++;
break;
case 1:
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iVar0 /*33*/], joaat("script_task_start_scenario_in_place"))==7){
Local_111[iVar0 /*33*/].f_5=0;
}
break;
}
...
switch (Local_111[iVar0 /*33*/].f_5){
case 0:
TASK::TASK_START_SCENARIO_IN_PLACE(Local_111[iVar0 /*33*/], "WORLD_HUMAN_BINOCULARS", 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[iVar0 /*33*/], 0, 0);
Local_111[iVar0 /*33*/].f_5++;
break;
}
...
switch (Local_111[iVar0 /*33*/].f_5){
case 0:
TASK::TASK_START_SCENARIO_IN_PLACE(Local_111[iVar0 /*33*/], "WORLD_HUMAN_DRINKING", 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_111[iVar0 /*33*/], 0, 0);
Local_111[iVar0 /*33*/].f_5++;
break;
}
...
case 17:
if(Local_111[iVar0 /*33*/].f_5 < 10){
if(PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), Local_111[iVar0 /*33*/])){
...
TASK::TASK_START_SCENARIO_IN_PLACE(Local_111[iVar0 /*33*/], "WORLD_HUMAN_DRINKING", 0, 1);
Local_111[iVar0 /*33*/].f_5++;
}
break;
case 2:
if(func_4(PLAYER::PLAYER_PED_ID(), Local_111[iVar0 /*33*/], 1) < 21.6f){
TASK::TASK_PLAY_ANIM(Local_111[iVar0 /*33*/], "misscarsteal2peeing", "peeing_loop", 8f, -8f, 25000, 1, 0, 0, 0, 0);
Local_111[iVar0 /*33*/].f_5++;
Local_111[iVar0 /*33*/].f_14=MISC::GET_GAME_TIMER() + 23000;
}
break;
case 3:
if(MISC::GET_GAME_TIMER() > Local_111[iVar0 /*33*/].f_14){
...
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_111[iVar0 /*33*/], 2433.04f, 4967.87f, 46.28f, 0.8f, 0);
Local_111[iVar0 /*33*/].f_5++;
}
break;
case 13:
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(2432.56f, 4968.38f, 46.27f, 0.8f, 0)){
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_111[iVar0 /*33*/], 2432.56f, 4968.38f, 46.27f, 0.8f, 0);
Local_111[iVar0 /*33*/].f_5++;
}
break;
case 14:
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(2433.12f, 4965.59f, 46.27f, 0.8f, 0)){
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_111[iVar0 /*33*/], 2433.12f, 4965.59f, 46.27f, 0.8f, 0);
Local_111[iVar0 /*33*/].f_5++;
}
break;
case 15:
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(2439.61f, 4960.99f, 46.27f, 0.4f, 0)){
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_111[iVar0 /*33*/], 2439.697f, 4960.996f, 46.28f, 0.4f, 0);
Local_111[iVar0 /*33*/].f_5++;
}
break;
case 16:
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(2440.16f, 4962.99f, 46.27f, 0.4f, 0)){
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_111[iVar0 /*33*/], 2440.16f, 4962.99f, 46.27f, 0.4f, 0);
Local_111[iVar0 /*33*/].f_5++;
}
break;
case 17:
if(TASK::DOES_SCENARIO_EXIST_IN_AREA(2438.23f, 4962.25f, 46.27f, 0.4f, 0)){
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(Local_111[iVar0 /*33*/], 2438.23f, 4962.25f, 46.27f, 0.4f, 0);
Local_111[iVar0 /*33*/].f_5++;
}
break;
}
break;
case 1:
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iVar0 /*33*/], joaat("script_task_use_nearest_scenario_to_pos"))==7){
Local_111[iVar0 /*33*/].f_5=0;
}
break;
}
...
switch (Local_111[iVar0 /*33*/].f_5){
case 0:
if(PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_111[iVar0 /*33*/]) || (func_96(ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*33*/], 1), 1f, 1120403456) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2448.583f, 4969.292f, 45.1856f, 2439.538f, 4978.061f, 46.82762f, 5.75f, 0, 1, 0))){
TASK::TASK_HANDS_UP(Local_111[iVar0 /*33*/], 20000, 0, -1, 0);
...
Local_111[iVar0 /*33*/].f_5++;
Local_111[iVar0 /*33*/].f_14=MISC::GET_GAME_TIMER() + 2000;
}
}
else{
Local_111[iVar0 /*33*/].f_5++;
...
case 4:
if(MISC::GET_GAME_TIMER() > Local_111[iVar0 /*33*/].f_14){
TASK::TASK_SMART_FLEE_PED(Local_111[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 200f, 200000, 0, 0);
PED::SET_PED_KEEP_TASK(Local_111[iVar0 /*33*/], 1);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_111[iVar0 /*33*/]));
Local_111[iVar0 /*33*/].f_5++;
}
break;
}
...
if(WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(Local_111[iVar0 /*33*/], 0, 2)){
if(!WEAPON::HAS_PED_GOT_WEAPON(Local_111[iVar0 /*33*/], 0, 2)){
WEAPON::GIVE_WEAPON_TO_PED(Local_111[iVar0 /*33*/], joaat("weapon_pistol"), -1, 0, 1);
TASK::TASK_COMBAT_PED(Local_111[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
func_94();
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_111[iVar0 /*33*/], 0);
TASK::TASK_COMBAT_PED(Local_111[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[iVar0 /*33*/], iLocal_114);
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_111[iVar0 /*33*/], 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[iVar0 /*33*/], iLocal_114);
Local_111[iVar0 /*33*/].f_5++;
break;
case 1:
...
if(!PED::IS_PED_INJURED(Local_111[iVar0 /*33*/])){
uLocal_368=PED::CREATE_SYNCHRONIZED_SCENE(2435.312f, 4967.087f, 41.35f, 0f, 0f, 11.4f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_368, 1);
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[iVar0 /*33*/], iLocal_368, "misschinese2_crystalmaze", "_cower_loop", 1000f, -8f, 0, 0, 1148846080, 0);
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_371)){
iLocal_371=WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_sawnoffshotgun"), 40, 2433.59f, 4969.7f, 42.1854f, 1, 1065353216, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_371, 90f, 0f, 0f, 2, 1);
}
TASK::TASK_LOOK_AT_ENTITY(Local_111[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
Local_111[iVar0 /*33*/].f_5++;
}
}
break;
...
break;
case 3:
uLocal_367=PED::CREATE_SYNCHRONIZED_SCENE(2435.312f, 4967.087f, 41.35f, 0f, 0f, 11.4f, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[iVar0 /*33*/], uLocal_367, "misschinese2_crystalmaze", "_cower_to_stand", 4f, -8f, 0, 0, 1148846080, 0);
TASK::TASK_LOOK_AT_ENTITY(Local_111[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
Local_111[iVar0 /*33*/].f_5++;
break;
case 4:
...
if((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_367) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_367) > 0.98f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_367)){
Local_111[iVar0 /*33*/].f_5=5;
}
break;
case 5:
if((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_367) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_367) > 0.98f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_367)){
iLocal_366=PED::CREATE_SYNCHRONIZED_SCENE(2435.312f, 4967.087f, 41.35f, 0f, 0f, 11.4f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_366, 1);
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[iVar0 /*33*/], iLocal_366, "misschinese2_crystalmaze", "_stand_loop", 4f, -8f, 0, 0, 1148846080, 0);
Local_111[iVar0 /*33*/].f_5++;
Local_111[iVar0 /*33*/].f_14=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(1000, 2000));
}
break;
case 6:
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_369) || iLocal_369==0){
if(MISC::GET_GAME_TIMER() > Local_111[iVar0 /*33*/].f_14){
iLocal_369=PED::CREATE_SYNCHRONIZED_SCENE(2435.312f, 4967.087f, 41.35f, 0f, 0f, 11.4f, 2);
if(MISC::GET_RANDOM_INT_IN_RANGE(0, 2)==1){
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[iVar0 /*33*/], iLocal_369, "misschinese2_crystalmaze", "_stand_loop_a", 4f, -8f, 0, 0, 1148846080, 0);
}else{
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[iVar0 /*33*/], iLocal_369, "misschinese2_crystalmaze", "_stand_loop_b", 4f, -8f, 0, 0, 1148846080, 0);
}}
}
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_366) || iLocal_366==0){
...
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[iVar0 /*33*/], iLocal_370, "misschinese2_crystalmaze", "_stand_to_aim", 4f, -8f, 0, 0, 1148846080, 0);
WEAPON::GIVE_WEAPON_OBJECT_TO_PED(iLocal_371, Local_111[iVar0 /*33*/]);
Local_111[iVar0 /*33*/].f_5++;
break;
case 9:
if((PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_370) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_370) > 0.98f) || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_370)){
PED::SET_PED_TARGET_LOSS_RESPONSE(Local_111[iVar0 /*33*/], 1);
TASK::CLEAR_PED_TASKS(Local_111[iVar0 /*33*/]);
TASK::TASK_AIM_GUN_AT_ENTITY(Local_111[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 1);
Local_111[iVar0 /*33*/].f_5++;
}
break;
case 10:
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_111[iVar0 /*33*/], 0);
TASK::TASK_COMBAT_PED(Local_111[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
Local_111[iVar0 /*33*/].f_14=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(3000, 4000));
Local_111[iVar0 /*33*/].f_15=0;
Local_111[iVar0 /*33*/].f_5++;
}
}
...
case 31:
if(!PED::IS_PED_INJURED(Local_111[iVar0 /*33*/])){
if(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_111[iVar0 /*33*/], 1), 2f, 1)){
Local_111[iVar0 /*33*/].f_5=5;
}}
switch (Local_111[iVar0 /*33*/].f_5){
case 0:
...
break;
case 1:
if(func_35("WRK2", 1, Local_111[iVar0 /*33*/], "oneilcook", 2, PLAYER::PLAYER_PED_ID(), "trevor", -1, 0, 0, -1, 0, 0, 8)){
Local_111[iVar0 /*33*/].f_5++;
Local_111[iVar0 /*33*/].f_14=MISC::GET_GAME_TIMER() + 1300;
}
break;
case 2:
if(MISC::GET_GAME_TIMER() > Local_111[iVar0 /*33*/].f_14){
...
break;
case 5:
TASK::TASK_SMART_FLEE_PED(Local_111[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 50f, 1000, 0, 0);
Local_111[iVar0 /*33*/].f_5++;
break;
case 6:
if(func_88("WRK2")){
...
PED::SET_PED_KEEP_TASK(Local_111[iVar0 /*33*/], 1);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_111[iVar0 /*33*/]));
if(HUD::DOES_BLIP_EXIST(Local_111[iVar0 /*33*/].f_19)){
HUD::REMOVE_BLIP(&(Local_111[iVar0 /*33*/].f_19));
}
Local_111[iVar0 /*33*/].f_5++;
break;
}
...
case 4:
if(iLocal_374==1){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_111[iVar0 /*33*/].f_14)){
PED::SET_SYNCHRONIZED_SCENE_PHASE(Local_111[iVar0 /*33*/].f_14, 0.69f);
}
if(iVar0==9){
iLocal_374=0;
}}
if(iLocal_375==1){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_111[iVar0 /*33*/].f_14)){
PED::SET_SYNCHRONIZED_SCENE_PHASE(Local_111[iVar0 /*33*/].f_14, 0f);
}
if(iVar0==9){
iLocal_375=0;
}
...
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iVar0 /*33*/], joaat("script_task_synchronized_scene"))==1){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(Local_111[iVar0 /*33*/].f_14) > 0.024f && PED::GET_SYNCHRONIZED_SCENE_PHASE(Local_111[iVar0 /*33*/].f_14) < 0.033f){
iVar5=0;
if(!PED::IS_PED_INJURED(Local_111[iVar0 /*33*/])){
iVar6=joaat("weapon_unarmed");
if(WEAPON::GET_CURRENT_PED_WEAPON(Local_111[iVar0 /*33*/], &iVar6, 1)){
PED::SET_PED_ACCURACY(Local_111[iVar0 /*33*/], 100);
if(iVar6==joaat("weapon_pistol")){
if(func_86(&iVar5)){
WEAPON::SET_AMMO_IN_CLIP(Local_111[iVar0 /*33*/], joaat("weapon_pistol"), 12);
PED::SET_PED_SHOOTS_AT_COORD(Local_111[iVar0 /*33*/], ENTITY::GET_ENTITY_COORDS(iLocal_168[iVar5], 1), 0);
func_103(Local_111[iVar0 /*33*/], &(Local_111[iVar0 /*33*/].f_25), -1, 0, 1, 0, -1082130432, 0, -1, -1, 1, 0, 0);
Local_111[iVar0 /*33*/].f_5=1;
}
else{
WEAPON::SET_AMMO_IN_CLIP(Local_111[iVar0 /*33*/], joaat("weapon_pistol"), 12);
PED::SET_PED_SHOOTS_AT_COORD(Local_111[iVar0 /*33*/], 2493.1f, 4971f, 44.9f, 0);
func_103(Local_111[iVar0 /*33*/], &(Local_111[iVar0 /*33*/].f_25), -1, 0, 1, 0, -1082130432, 0, -1, -1, 1, 0, 0);
Local_111[iVar0 /*33*/].f_5=1;
}
}
...
elseif(Local_111[iVar0 /*33*/].f_5==1){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(Local_111[iVar0 /*33*/].f_14) > 0.04f){
Local_111[iVar0 /*33*/].f_5=2;
if(iLocal_372==0){
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_111[iVar0 /*33*/], "generic_cheer", "A_M_M_Hillbilly_01_White_mini_02", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
}}
}
elseif(Local_111[iVar0 /*33*/].f_5==2){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(Local_111[iVar0 /*33*/].f_14) > 0.6f){
Local_111[iVar0 /*33*/].f_5=0;
}
}
}}
if(Local_111[iVar0 /*33*/].f_5==3){
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[iVar0 /*33*/], joaat("script_task_go_straight_to_coord"))==7){
func_105(iVar0, 7, 0, 0);
}}
break;
}}
...
case 1:
PED::SET_PED_ANGLED_DEFENSIVE_AREA(Local_111[iVar0 /*33*/], 2431.704f, 4961.62f, 45.33136f, 2455.376f, 4985.934f, 48.68555f, 13.5625f, 0, 0);
TASK::TASK_COMBAT_PED(Local_111[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_TARGET_LOSS_RESPONSE(Local_111[iVar0 /*33*/], 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iVar0 /*33*/], 50, 1);
...
switch (Local_117[iVar0 /*24*/].f_4){
case 1:
PED::SET_PED_ANGLED_DEFENSIVE_AREA(Local_111[iVar0 /*33*/], 2437.982f, 4959.021f, 45.31057f, 2432.93f, 4961.941f, 48.69256f, 3.1875f, 0, 0);
TASK::TASK_COMBAT_PED(Local_111[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_TARGET_LOSS_RESPONSE(Local_111[iVar0 /*33*/], 1);
Local_117[iVar0 /*24*/].f_4++;
break;
case 2:
if(func_93(18)){
PED::REMOVE_PED_DEFENSIVE_AREA(Local_111[iVar0 /*33*/], 0);
Local_117[iVar0 /*24*/].f_4++;
}
break;
}
...
if(iLocal_112==0){
PED::REMOVE_PED_DEFENSIVE_AREA(Local_111[iVar0 /*33*/], 0);
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_111[iVar0 /*33*/], 2451.677f, 4954.251f, 44.988f, 3f, 0, 0);
iLocal_112++;
Local_117[iVar0 /*24*/].f_4++;
}
else{
Local_117[iVar0 /*24*/].f_4=(MISC::GET_GAME_TIMER() + iLocal_112 * 4000);
iLocal_112++;
}
...
break;
default:
if(MISC::GET_GAME_TIMER() > Local_117[iVar0 /*24*/].f_4){
PED::REMOVE_PED_DEFENSIVE_AREA(Local_111[iVar0 /*33*/], 0);
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_111[iVar0 /*33*/], 2451.677f, 4954.251f, 44.988f, 3f, 0, 0);
...
switch (Local_117[iVar0 /*24*/].f_4){
case 1:
PED::SET_PED_ANGLED_DEFENSIVE_AREA(Local_111[iVar0 /*33*/], 2453.084f, 4969.897f, 50.44285f, 2460.996f, 4977.822f, 53.38035f, 2.9375f, 0, 0);
TASK::TASK_COMBAT_PED(Local_111[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_TARGET_LOSS_RESPONSE(Local_111[iVar0 /*33*/], 1);
Local_117[iVar0 /*24*/].f_4++;
break;
...
switch (Local_117[iVar0 /*24*/].f_4){
case 1:
PED::SET_PED_ANGLED_DEFENSIVE_AREA(Local_111[iVar0 /*33*/], 2442.963f, 4964.217f, 50.44285f, 2449.251f, 4970.534f, 53.38035f, 2f, 0, 0);
TASK::TASK_COMBAT_PED(Local_111[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_TARGET_LOSS_RESPONSE(Local_111[iVar0 /*33*/], 1);
Local_117[iVar0 /*24*/].f_4++;
break;
...
switch (Local_117[iVar0 /*24*/].f_4){
case 1:
PED::SET_PED_ANGLED_DEFENSIVE_AREA(Local_111[iVar0 /*33*/], 2461.362f, 4976.084f, 50.44285f, 2448.743f, 4988.774f, 53.60143f, 2f, 0, 0);
TASK::TASK_COMBAT_PED(Local_111[iVar0 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_TARGET_LOSS_RESPONSE(Local_111[iVar0 /*33*/], 1);
Local_117[iVar0 /*24*/].f_4++;
break;
...
bVar1=false;
while (!bVar1){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_168[*iParam0]) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_168[*iParam0], 2495.017f, 4970.17f, 44.21808f, 2493.501f, 4971.556f, 45.40248f, 1.375f, 0, 1, 0)){
return 1;
}else{
*iParam0++;
iVar0++;
...
TASK::TASK_PERFORM_SEQUENCE(*iParam0, uLocal_79);
}
...
Local_111[iParam0 /*33*/].f_15=(Local_111[iParam0 /*33*/].f_15 + floor((timestep() * 1000f)));
switch (Local_111[iParam0 /*33*/].f_2){
case 7:
if(Local_111[iParam0 /*33*/].f_15 > 2000 && !MISC::IS_BIT_SET(Local_111[iParam0 /*33*/].f_14, 0)){
TASK::TASK_LOOK_AT_COORD(Local_111[iParam0 /*33*/], 2505.634f, 4996.994f, 46.6624f, 4000, 0, 2);
MISC::SET_BIT(&(Local_111[iParam0 /*33*/].f_14), false);
}elseif(Local_111[iParam0 /*33*/].f_15 > 8000 && !MISC::IS_BIT_SET(Local_111[iParam0 /*33*/].f_14, 1)){
TASK::TASK_LOOK_AT_COORD(Local_111[iParam0 /*33*/], 2472.297f, 4962.687f, 47.2297f, 6000, 0, 2);
MISC::SET_BIT(&(Local_111[iParam0 /*33*/].f_14), true);
}
break;
case 5:
if(Local_111[iParam0 /*33*/].f_15 > 3000 && !MISC::IS_BIT_SET(Local_111[iParam0 /*33*/].f_14, 0)){
if(!PED::IS_PED_INJURED(Local_111[6 /*33*/])){
TASK::TASK_LOOK_AT_ENTITY(Local_111[iParam0 /*33*/], Local_111[6 /*33*/], 4000, 0, 2);
MISC::SET_BIT(&(Local_111[iParam0 /*33*/].f_14), false);
}}elseif(Local_111[iParam0 /*33*/].f_15 > 11000 && !MISC::IS_BIT_SET(Local_111[iParam0 /*33*/].f_14, 1)){
TASK::TASK_LOOK_AT_COORD(Local_111[iParam0 /*33*/], 2494.634f, 5001.994f, 46.6624f, 7000, 0, 2);
MISC::SET_BIT(&(Local_111[iParam0 /*33*/].f_14), true);
}elseif(Local_111[iParam0 /*33*/].f_15 > 20000 && !MISC::IS_BIT_SET(Local_111[iParam0 /*33*/].f_14, 2)){
TASK::TASK_LOOK_AT_COORD(Local_111[iParam0 /*33*/], 2477.634f, 4966.994f, 46.6624f, 7000, 0, 2);
MISC::SET_BIT(&(Local_111[iParam0 /*33*/].f_14), 2);
}
break;
case 4:
if(Local_111[iParam0 /*33*/].f_15 > 3000 && !MISC::IS_BIT_SET(Local_111[iParam0 /*33*/].f_14, 0)){
TASK::TASK_LOOK_AT_COORD(Local_111[iParam0 /*33*/], 2505.634f, 4996.994f, 46.6624f, 5000, 0, 2);
MISC::SET_BIT(&(Local_111[iParam0 /*33*/].f_14), false);
}elseif(Local_111[iParam0 /*33*/].f_15 > 10000 && !MISC::IS_BIT_SET(Local_111[iParam0 /*33*/].f_14, 1)){
TASK::TASK_LOOK_AT_COORD(Local_111[iParam0 /*33*/], 2461.449f, 4977.48f, 51.7483f, 6000, 0, 2);
MISC::SET_BIT(&(Local_111[iParam0 /*33*/].f_14), true);
}elseif(Local_111[iParam0 /*33*/].f_15 > 18000 && !MISC::IS_BIT_SET(Local_111[iParam0 /*33*/].f_14, 2)){
TASK::TASK_LOOK_AT_COORD(Local_111[iParam0 /*33*/], 2505.634f, 4996.994f, 46.6624f, 6000, 0, 2);
MISC::SET_BIT(&(Local_111[iParam0 /*33*/].f_14), 2);
}
break;
}}
...
switch (iLocal_109){
case 0:
Local_111[iParam0 /*33*/]=PED::CREATE_PED(26, joaat("a_m_m_hillbilly_01"), Param2, iParam3, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 0, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 2, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 3, 1, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 4, 1, 1, 0);
break;
case 1:
Local_111[iParam0 /*33*/]=PED::CREATE_PED(26, joaat("a_m_m_hillbilly_02"), Param2, iParam3, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 2, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 4, 0, 1, 0);
break;
case 2:
Local_111[iParam0 /*33*/]=PED::CREATE_PED(26, joaat("a_m_y_methhead_01"), Param2, iParam3, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 0, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 3, 1, 0, 0);
break;
case 3:
Local_111[iParam0 /*33*/]=PED::CREATE_PED(26, joaat("a_m_m_hillbilly_01"), Param2, iParam3, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 0, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 2, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 3, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 4, 1, 0, 0);
break;
case 4:
Local_111[iParam0 /*33*/]=PED::CREATE_PED(26, joaat("a_m_m_hillbilly_02"), Param2, iParam3, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
...
Local_111[iParam0 /*33*/]=PED::CREATE_PED(26, joaat("a_m_y_methhead_01"), Param2, iParam3, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 4, 1, 2, 0);
break;
case 6:
Local_111[iParam0 /*33*/]=PED::CREATE_PED(26, joaat("a_m_m_hillbilly_01"), Param2, iParam3, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 2, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 3, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 4, 0, 1, 0);
break;
case 7:
Local_111[iParam0 /*33*/]=PED::CREATE_PED(26, joaat("a_m_m_hillbilly_02"), Param2, iParam3, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 0, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 2, 2, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 3, 2, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 4, 0, 2, 0);
break;
case 8:
Local_111[iParam0 /*33*/]=PED::CREATE_PED(26, joaat("a_m_y_methhead_01"), Param2, iParam3, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
...
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 0, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 3, 1, 2, 0);
break;
case 10:
Local_111[iParam0 /*33*/]=PED::CREATE_PED(26, joaat("a_m_y_methhead_01"), Param2, iParam3, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
...
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 2, 2, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 3, 2, 2, 0);
break;
case 12:
Local_111[iParam0 /*33*/]=PED::CREATE_PED(26, joaat("a_m_m_hillbilly_01"), Param2, iParam3, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 0, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 2, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 3, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 4, 1, 2, 0);
break;
case 13:
...
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_111[iParam0 /*33*/]);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 0, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 3, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 4, 0, 2, 0);
break;
case 15:
Local_111[iParam0 /*33*/]=PED::CREATE_PED(26, joaat("a_m_m_hillbilly_02"), Param2, iParam3, 1, 1);
...
if(iLocal_109 > 17){
Local_111[iParam0 /*33*/]=PED::CREATE_PED(26, joaat("a_m_y_methhead_01"), Param2, iParam3, 1, 1);
PED::SET_PED_RANDOM_COMPONENT_VARIATION(Local_111[iParam0 /*33*/], 0);
}
iLocal_109++;
if(Local_111[iParam0 /*33*/].f_1==5){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_111[iParam0 /*33*/], 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[iParam0 /*33*/], iLocal_115);
}else{
WEAPON::GIVE_WEAPON_TO_PED(Local_111[iParam0 /*33*/], iParam4, 3000, iParam5, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[iParam0 /*33*/], iLocal_114);
PED::SET_PED_AS_ENEMY(Local_111[iParam0 /*33*/], 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iParam0 /*33*/], 9, 1);
PED::SET_PED_HEARING_RANGE(Local_111[iParam0 /*33*/], 120f);
PED::SET_PED_SEEING_RANGE(Local_111[iParam0 /*33*/], 22f);
PED::SET_PED_ID_RANGE(Local_111[iParam0 /*33*/], 22f);
PED::SET_PED_CONFIG_FLAG(Local_111[iParam0 /*33*/], 118, 0);
PED::SET_COMBAT_FLOAT(Local_111[iParam0 /*33*/], 14, 3f);
if(Local_111[iParam0 /*33*/].f_1==2){
PED::SET_PED_ACCURACY(Local_111[iParam0 /*33*/], 12);
}else{
PED::SET_PED_ACCURACY(Local_111[iParam0 /*33*/], 45);
}
PED::SET_PED_DIES_WHEN_INJURED(Local_111[iParam0 /*33*/], 1);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_111[iParam0 /*33*/], 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iParam0 /*33*/], 15, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[iParam0 /*33*/], 17, 0);
func_108(Local_111[iParam0 /*33*/], 1);
}
PED::STOP_PED_WEAPON_FIRING_WHEN_DROPPED(Local_111[iParam0 /*33*/]);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_111[iParam0 /*33*/], 1);
PED::SET_PED_SHOULD_PLAY_DIRECTED_NORMAL_SCENARIO_EXIT(Local_111[iParam0 /*33*/], 0f, 0f, 0f);
PED::SET_PED_SHOULD_IGNORE_SCENARIO_NAV_CHECKS(Local_111[iParam0 /*33*/], 1);
PED::SET_PED_SHOULD_PROBE_FOR_SCENARIO_EXITS_IN_ONE_FRAME(Local_111[iParam0 /*33*/], 1);
ENTITY::SET_ENTITY_HEALTH(Local_111[iParam0 /*33*/], 150, 0);
return 1;
}
...
case 1:
if(iLocal_59 > -1){
if(!PED::IS_PED_DEAD_OR_DYING((*uParam0)[iLocal_59 /*24*/], 1)){
switch (iLocal_58){
case 8:
if(!bLocal_51){
if(!bLocal_54){
...
iLocal_78=0;
return 1;
}elseif(iLocal_77 !=MISC::GET_GAME_TIMER()){
iLocal_78++;
...
case 2:
if(!MISC::ARE_STRINGS_EQUAL("chi2_hear", Param3.f_1)){
if((PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), (*uParam1)[iParam0 /*24*/]) || iLocal_71==1) && func_73((*uParam1)[iParam0 /*24*/], (uParam1[iParam0 /*24*/])->f_12, 1) < (uParam1[iParam0 /*24*/])->f_19){
...
Var4={
ENTITY::GET_ENTITY_COORDS((*uParam0)[iLocal_56 /*24*/], 0) 
};
...
if(FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_69, fLocal_70)){
bLocal_52=true;
}
if(!iLocal_53){
...
iLocal_57=MISC::GET_GAME_TIMER() + 1000;
iLocal_53=1;
}}elseif(((!func_88(Param1.f_1) && !func_88(Param3.f_1)) && !func_88(Param5.f_1)) && !func_88(Param7.f_1)){
iLocal_53=0;
}elseif(MISC::GET_GAME_TIMER() > iLocal_57){
if(func_88(Param1.f_1) || func_88(Param3.f_1)){
bLocal_51=true;
}
if(func_88(Param5.f_1) || func_88(Param7.f_1)){
...
if(!bLocal_80 && !PED::IS_PED_RAGDOLL((*uParam0)[iVar0 /*24*/])){
...
iLocal_60=iVar11;
}}}elseif(PED::IS_PED_DEAD_OR_DYING((*uParam0)[iLocal_60 /*24*/], 1)){
iLocal_60=-1;
}}
...
void func_123(){
if(iLocal_390){
if(MISC::IS_STRING_NULL_OR_EMPTY(&Local_395)){
if(func_65()){
if(AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()){
if(!HUD::IS_MESSAGE_BEING_DISPLAYED()){
cLocal_391={
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_391) && !MISC::ARE_STRINGS_EQUAL(&cLocal_391, "NULL")){
Local_395={
func_89() 
};
func_91();
...
if(iLocal_100==0){
if(FIRE::GET_CLOSEST_FIRE_POS(&Var1, Local_107[0 /*5*/])){
fVar2=0f;
fVar5=999999f;
iVar0=0;
while (iVar0 < Local_107.f_0){
if(iVar0 > 0){
fVar2=(fVar2 + MISC::GET_DISTANCE_BETWEEN_COORDS(Local_107[(iVar0 - 1) /*5*/], Local_107[iVar0 /*5*/], 1));
}
if(Local_107[iVar0 /*5*/].f_4){
if(FIRE::GET_CLOSEST_FIRE_POS(&Var1, Local_107[iVar0 /*5*/])){
fVar4=MISC::GET_DISTANCE_BETWEEN_COORDS(Local_107[iVar0 /*5*/], Var1, 1);
if(fVar4 < fVar5){
fVar5=fVar4;
fVar6=fVar2;
iVar3=iVar0;
...
fVar7=(to_float((MISC::GET_GAME_TIMER() - iLocal_102)) / fLocal_108);
...
if((MISC::GET_GAME_TIMER() - Local_99[iVar0 /*5*/].f_4) > 1000){
GRAPHICS::FADE_DECALS_IN_RANGE(Local_99[iVar0 /*5*/].f_1, 0.4f, 1f);
}
if((MISC::GET_GAME_TIMER() - Local_99[iVar0 /*5*/].f_4) > 6000){
FIRE::REMOVE_SCRIPT_FIRE(Local_99[iVar0 /*5*/]);
}
iVar0++;
}}}
...
FIRE::REMOVE_SCRIPT_FIRE(Local_99[iLocal_104 /*5*/]);
if(Local_99[iLocal_104 /*5*/].f_4 !=0){
GRAPHICS::FADE_DECALS_IN_RANGE(Local_99[iLocal_104 /*5*/].f_1, 0.4f, 1f);
}
Local_99[iLocal_104 /*5*/].f_4=MISC::GET_GAME_TIMER();
Local_99[iLocal_104 /*5*/].f_1={
Param0 
};
Local_99[iLocal_104 /*5*/]=FIRE::START_SCRIPT_FIRE(Param0, uLocal_92, iParam1);
iLocal_104++;
if(iLocal_104 >=31){
iLocal_104=0;
}}
...
iLocal_93=MISC::GET_GAME_TIMER() + 250;
}
if(MISC::GET_GAME_TIMER() > iLocal_93){
if(!bLocal_83){
fVar4=9999.9f;
Local_96={
func_130() 
...
while (iVar0 < Local_107.f_0){
if(HUD::DOES_BLIP_EXIST(Local_107[iVar0 /*5*/].f_3)){
fVar2=MISC::GET_DISTANCE_BETWEEN_COORDS(Local_96, HUD::GET_BLIP_COORDS(Local_107[iVar0 /*5*/].f_3), 1);
fVar3=MISC::GET_DISTANCE_BETWEEN_COORDS(Local_107[iVar0 /*5*/], HUD::GET_BLIP_COORDS(Local_107[iVar0 /*5*/].f_3), 1);
...
if(fVar4 < 2f){
if(iLocal_89 !=-1){
if(MISC::ABSI((iLocal_90 - iVar5)) > 1){
iLocal_90=-1;
}
if(iLocal_90==-1){
iLocal_90=iLocal_89;
}
if(MISC::ABSI((iLocal_90 - iVar5)) < 3 && MISC::ABSI((iLocal_90 - iVar5)) > 0){
if(iLocal_90 < iVar5){
iVar6=iLocal_90;
while (iVar6 <=(iVar5 - 1)){
if(HUD::DOES_BLIP_EXIST(Local_107[iVar6 /*5*/].f_3)){
if(HUD::GET_BLIP_ALPHA(Local_107[iVar6 /*5*/].f_3) > 0){
HUD::SET_BLIP_ALPHA(Local_107[iVar6 /*5*/].f_3, 0);
...
if(iVar5==0){
if(HUD::DOES_BLIP_EXIST(Local_107[iVar5 /*5*/].f_3)){
if(HUD::GET_BLIP_ALPHA(Local_107[iVar5 /*5*/].f_3) > 0){
HUD::SET_BLIP_ALPHA(Local_107[iVar5 /*5*/].f_3, 0);
...
if(PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_111[iVar0 /*33*/])==iLocal_114){
func_103(Local_111[iVar0 /*33*/], &(Local_111[iVar0 /*33*/].f_25), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
}}elseif(Local_111[iVar0 /*33*/] !=0){
...
if(MISC::IS_STRING_NULL(sLocal_149)){
sLocal_149="CHFAIL";
}
func_138(sLocal_149);
while (!func_137()){
...
fVar3=0f;
if(!func_143(Global_113810.f_18536[iVar0], &Var2, &fVar3)){
...
Local_387[iParam0 /*4*/].f_3=MISC::GET_GAME_TIMER() + 1000;
Local_387[iParam0 /*4*/].f_2++;
}
break;
case 1:
if(MISC::GET_GAME_TIMER() > Local_387[iParam0 /*4*/].f_3){
if(PAD::IS_USING_KEYBOARD_AND_MOUSE(0)){
...
Local_387[iParam0 /*4*/].f_3=MISC::GET_GAME_TIMER() + 4000;
Local_387[iParam0 /*4*/].f_2++;
}
break;
case 1:
...
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_176, "FRMBLIPB");
Local_387[iParam0 /*4*/].f_1=1;
break;
case 8:
switch (Local_387[iParam0 /*4*/].f_2){
...
case 0:
Local_388[iParam0 /*7*/].f_4=MISC::GET_GAME_TIMER() + 2000;
Local_388[iParam0 /*7*/].f_3++;
break;
case 1:
if(MISC::GET_GAME_TIMER() > Local_388[iParam0 /*7*/].f_4){
if(func_65()){
Local_388[iParam0 /*7*/].f_4=MISC::GET_GAME_TIMER() + 2000;
}else{
iVar0=0;
...
Local_388[iParam0 /*7*/].f_4=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(8000, 14000));
}
}
else{
Local_388[iParam0 /*7*/].f_1=1;
...
if(!PED::IS_PED_INJURED(Local_111[Local_388[iParam0 /*7*/].f_4 /*33*/])){
...
case 0:
if(!PED::IS_PED_INJURED(Local_111[Local_388[iParam0 /*7*/].f_4 /*33*/])){
Local_388[iParam0 /*7*/].f_3=MISC::GET_RANDOM_INT_IN_RANGE(1, 3);
}
break;
case 1:
...
break;
case 1:
if(!PED::IS_PED_INJURED(Local_111[Local_388[iParam0 /*7*/].f_5 /*33*/])){
...
Local_388[iParam0 /*7*/].f_4=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(7000, 12000));
Local_388[iParam0 /*7*/].f_6++;
Local_388[iParam0 /*7*/].f_3=0;
}}elseif(Local_388[iParam0 /*7*/].f_6 < 6){
...
Local_388[iParam0 /*7*/].f_4=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(6000, 10000));
Local_388[iParam0 /*7*/].f_6++;
Local_388[iParam0 /*7*/].f_3=0;
}
break;
...
if(!PED::IS_PED_INJURED(Local_111[iVar2 /*33*/])){
if(PED::IS_PED_IN_COMBAT(Local_111[iVar2 /*33*/], 0)){
if(PED::CAN_PED_IN_COMBAT_SEE_TARGET(Local_111[iVar2 /*33*/], PLAYER::PLAYER_PED_ID())){
...
switch (Local_388[iParam0 /*7*/].f_3){
case 0:
if(MISC::GET_GAME_TIMER() > Local_388[iParam0 /*7*/].f_5){
fVar4=999f;
Local_388[iParam0 /*7*/].f_4=-1;
iVar3=0;
while (iVar3 < Local_111.f_0){
if(Local_111[iVar3 /*33*/].f_1==2){
if(!PED::IS_PED_INJURED(Local_111[iVar3 /*33*/])){
fVar5=func_4(PLAYER::PLAYER_PED_ID(), Local_111[iVar3 /*33*/], 1);
if(fVar5 < fVar4){
fVar4=fVar5;
...
Local_388[iParam0 /*7*/].f_5=MISC::GET_GAME_TIMER() + 6000;
Local_388[iParam0 /*7*/].f_3=0;
}
break;
}
...
case 1:
if(!func_65()){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_111[Local_388[iParam0 /*7*/].f_4 /*33*/].f_14)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(Local_111[Local_388[iParam0 /*7*/].f_4 /*33*/].f_14) > 0.15f){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(Local_111[Local_388[iParam0 /*7*/].f_4 /*33*/].f_14) < 0.65f){
if(func_4(Local_111[Local_388[iParam0 /*7*/].f_4 /*33*/], PLAYER::PLAYER_PED_ID(), 1) < 30f){
...
case 3:
if(!PED::IS_PED_INJURED(Local_111[Local_388[iParam0 /*7*/].f_5 /*33*/])){
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_111[Local_388[iParam0 /*7*/].f_5 /*33*/], "generic_cheer", "A_M_M_Hillbilly_01_White_mini_03", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
Local_388[iParam0 /*7*/].f_3++;
}else{
Local_388[iParam0 /*7*/].f_3=1;
}
...
if(!PED::IS_PED_INJURED(Local_111[Local_388[iParam0 /*7*/].f_4 /*33*/])){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_111[Local_388[iParam0 /*7*/].f_4 /*33*/].f_14)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(Local_111[Local_388[iParam0 /*7*/].f_4 /*33*/].f_14) > 0.75f){
Local_388[iParam0 /*7*/].f_3=1;
}}}
break;
}
...
break;
case 1:
Local_388[iParam0 /*7*/].f_4=(Local_388[iParam0 /*7*/].f_4 - floor((timestep() * 1000f)));
...
Local_388[iParam0 /*7*/].f_3=1;
Local_388[iParam0 /*7*/].f_4=(12000 + MISC::GET_RANDOM_INT_IN_RANGE(3000, 5000));
...
if(iParam2==0 || (iParam2==1 && !PED::IS_PED_INJURED(Local_111[iVar0 /*33*/]))){
fVar1=func_4(PLAYER::PLAYER_PED_ID(), Local_111[iVar0 /*33*/], 1);
if(fVar1 < fVar2){
fVar2=fVar1;
*iParam0=iVar0;
}}}
...
if(ENTITY::DOES_ENTITY_EXIST(Local_111[11 /*33*/])){
PED::DELETE_PED(&(Local_111[11 /*33*/]));
}
if(ENTITY::DOES_ENTITY_EXIST(Local_111[10 /*33*/])){
PED::DELETE_PED(&(Local_111[10 /*33*/]));
}
if(ENTITY::DOES_ENTITY_EXIST(Local_111[12 /*33*/])){
PED::DELETE_PED(&(Local_111[12 /*33*/]));
}
...
break;
case 7:
if((!PED::IS_PED_INJURED(Local_111[12 /*33*/]) && !PED::IS_PED_INJURED(Local_111[13 /*33*/])) && !PED::IS_PED_INJURED(Local_111[14 /*33*/])){
if(func_175(6, 6) < 2){
...
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[12 /*33*/], joaat("script_task_look_at_entity"))==7){
TASK::TASK_LOOK_AT_ENTITY(Local_111[13 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
TASK::TASK_LOOK_AT_ENTITY(Local_111[14 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
TASK::TASK_LOOK_AT_ENTITY(Local_111[12 /*33*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
}}
}}
break;
case 8:
...
}}elseif(Local_383[iParam0 /*10*/].f_6==1){
STREAMING::REMOVE_ANIM_DICT("missrampageintrooutro");
Local_383[iParam0 /*10*/].f_3=1;
}
break;
...
case 0:
if((!PED::IS_PED_INJURED(Local_111[12 /*33*/]) && !PED::IS_PED_INJURED(Local_111[13 /*33*/])) && !PED::IS_PED_INJURED(Local_111[14 /*33*/])){
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[12 /*33*/], uLocal_152);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[13 /*33*/], iLocal_152);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[14 /*33*/], iLocal_152);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[12 /*33*/], 17, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[13 /*33*/], 17, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_111[14 /*33*/], 17, 1);
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_111[12 /*33*/]);
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_111[13 /*33*/]);
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_111[14 /*33*/]);
Local_383[iParam0 /*10*/].f_6++;
}
break;
case 1:
...
if(!PED::IS_PED_INJURED(Local_111[12 /*33*/])){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(Local_111[12 /*33*/])){
Local_383[iParam0 /*10*/].f_6=2;
}}
if(!PED::IS_PED_INJURED(Local_111[13 /*33*/])){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(Local_111[13 /*33*/])){
Local_383[iParam0 /*10*/].f_6=2;
}}
if(!PED::IS_PED_INJURED(Local_111[14 /*33*/])){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(Local_111[14 /*33*/])){
Local_383[iParam0 /*10*/].f_6=2;
}}
break;
case 2:
...
switch (Local_383[iParam0 /*10*/].f_6){
case 1:
if(MISC::GET_GAME_TIMER() > Local_383[iParam0 /*10*/].f_7){
...
Local_383[iParam0 /*10*/].f_7=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(250, 520));
}else{
Local_383[iParam0 /*10*/].f_6=2;
}}
break;
...
if(!MISC::IS_BIT_SET(Local_383[iParam0 /*10*/].f_7, bVar5)){
if(FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_382[bVar5 /*3*/], 5f)){
MISC::SET_BIT(&(Local_383[iParam0 /*10*/].f_7), bVar5);
if(Local_383[iParam0 /*10*/].f_6==0){
Local_383[iParam0 /*10*/].f_6=MISC::GET_GAME_TIMER() + 1500;
}
}}
bVar5++;
}
if(MISC::GET_GAME_TIMER() > Local_383[iParam0 /*10*/].f_8){
Local_383[iParam0 /*10*/].f_8=0;
bVar5=false;
while (bVar5 < Local_382.f_0){
if(!MISC::IS_BIT_SET(Local_383[iParam0 /*10*/].f_7, bVar5 + 9) && MISC::IS_BIT_SET(Local_383[iParam0 /*10*/].f_7, bVar5)){
FIRE::ADD_EXPLOSION(Local_382[bVar5 /*3*/], 16, 1.5f, 1, 0, 1065353216, 0);
MISC::SET_BIT(&(Local_383[iParam0 /*10*/].f_7), bVar5 + 9);
bVar5=8;
Local_383[iParam0 /*10*/].f_8=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(150, 320));
}
bVar5++;
}}
if(Local_383[iParam0 /*10*/].f_6 !=0){
if(MISC::GET_GAME_TIMER() > Local_383[iParam0 /*10*/].f_6){
Local_383[iParam0 /*10*/].f_6=1;
Local_383[iParam0 /*10*/].f_7=MISC::GET_GAME_TIMER() + 300;
...
iLocal_142=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_142, 0)){
if(!VEHICLE::GET_IS_VEHICLE_ENGINE_RUNNING(iLocal_142)){
Local_383[iParam0 /*10*/].f_6++;
}
}}}
break;
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_142, 0)){
if(VEHICLE::GET_IS_VEHICLE_ENGINE_RUNNING(iLocal_142)){
Local_383[iParam0 /*10*/].f_7=(Local_383[iParam0 /*10*/].f_7 + MISC::GET_GAME_TIMER() + 7000);
Local_383[iParam0 /*10*/].f_6++;
}}}
break;
case 5:
...
Local_383[iParam0 /*10*/].f_7=MISC::GET_GAME_TIMER() + 5000;
}
}}}
break;
case 6:
...
AUDIO::PLAY_SOUND_FRONTEND(iLocal_175, "Change_Station_Loud", "Radio_Soundset", 1);
Local_383[iParam0 /*10*/].f_6++;
}}else{
...
Local_383[iParam0 /*10*/].f_7=WEAPON::GET_AMMO_IN_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_petrolcan"));
Local_383[iParam0 /*10*/].f_6++;
}
break;
case 1:
...
}elseif(iVar8 < Local_383[iParam0 /*10*/].f_7){
...
elseif(Local_383[iParam0 /*10*/].f_8==1){
func_11(0, 157);
Local_383[iParam0 /*10*/].f_8=0;
}}elseif(Local_383[iParam0 /*10*/].f_8==1){
func_11(0, 157);
...
if(iLocal_91==0){
Local_383[iParam0 /*10*/].f_9=(Local_383[iParam0 /*10*/].f_9 + (timestep() * 2f));
}
elseif(iLocal_91 < 30 && Local_383[iParam0 /*10*/].f_9 < 70f){
Local_383[iParam0 /*10*/].f_9=(Local_383[iParam0 /*10*/].f_9 + (timestep() * 1.5f));
}
else{
Local_383[iParam0 /*10*/].f_9=(Local_383[iParam0 /*10*/].f_9 + timestep());
}
iVar11=floor((IntToFloat(Local_383[iParam0 /*10*/].f_7) * (1f - (Local_383[iParam0 /*10*/].f_9 / 90f))));
if(iVar11 > 0){
...
switch (Local_383[iParam0 /*10*/].f_6){
case 0:
if(ENTITY::DOES_ENTITY_EXIST(Local_111[4 /*33*/].f_20)){
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(Local_111[4 /*33*/].f_20));
}
if(ENTITY::DOES_ENTITY_EXIST(Local_111[5 /*33*/].f_20)){
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(Local_111[5 /*33*/].f_20));
}
iVar12=0;
while (iVar12 < iLocal_168){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_168[iVar12])){
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(iLocal_168[iVar12]));
}
iVar12++;
}
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("prop_cs_beer_bot_01"));
...
break;
case 1:
if(PED::IS_PED_INJURED(Local_111[23 /*33*/])){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_371)){
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&iLocal_371);
...
break;
case 47:
if(!PED::IS_PED_INJURED(Local_111[11 /*33*/])){
if(!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_111[11 /*33*/])){
if(MISC::GET_GAME_TIMER() > Local_383[iParam0 /*10*/].f_7){
if(!PED::IS_PED_INJURED(Local_111[11 /*33*/])){
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_111[11 /*33*/], "WHIMPER", "WAVELOAD_PAIN_MALE", "SPEECH_PARAMS_FORCE_NORMAL", 0);
Local_383[iParam0 /*10*/].f_7=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(3500, 5000));
}}
}}
break;
case 41:
...
STREAMING::REQUEST_ANIM_DICT("misschinese2_crystalmaze");
if(iLocal_377==-1 || (iLocal_377 !=-1 && !PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(iLocal_377))){
iLocal_377=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(1991.081f, 3054.517f, 46.71474f, 4f, 4f, 4f, 0f, 0, 3);
}
Local_383[iParam0 /*10*/].f_6++;
break;
case 1:
...
if(!ENTITY::DOES_ENTITY_EXIST(Local_111[11 /*33*/])){
Local_111[11 /*33*/]=PED::CREATE_PED(26, joaat("ig_taocheng"), 1991.988f, 3054.51f, 46.215f, 0, 1, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[11 /*33*/], iLocal_116);
PED::SET_PED_CAN_BE_TARGETTED(Local_111[11 /*33*/], 0);
}elseif(!PED::IS_PED_INJURED(Local_111[11 /*33*/])){
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[11 /*33*/], iLocal_116);
PED::SET_PED_CAN_BE_TARGETTED(Local_111[11 /*33*/], 0);
}
if(!ENTITY::DOES_ENTITY_EXIST(Local_111[10 /*33*/])){
Local_111[10 /*33*/]=PED::CREATE_PED(26, joaat("ig_taostranslator"), 1991.988f, 3054.51f, 46.215f, 0, 1, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[10 /*33*/], iLocal_116);
PED::SET_PED_CAN_BE_TARGETTED(Local_111[10 /*33*/], 0);
PED::SET_PED_PROP_INDEX(Local_111[10 /*33*/], 1, 0, 1, 0, 1);
}elseif(!PED::IS_PED_INJURED(Local_111[10 /*33*/])){
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[10 /*33*/], iLocal_116);
PED::SET_PED_CAN_BE_TARGETTED(Local_111[10 /*33*/], 0);
}
if(!PED::IS_PED_INJURED(Local_111[11 /*33*/])){
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_383[iParam0 /*10*/].f_7)){
Local_383[iParam0 /*10*/].f_7=PED::CREATE_SYNCHRONIZED_SCENE(1991.988f, 3054.51f, 46.215f, 0f, 0f, 50.76f, 2);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(Local_383[iParam0 /*10*/].f_7, 1);
}
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[11 /*33*/], Local_383[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
}
if(!PED::IS_PED_INJURED(Local_111[10 /*33*/])){
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_383[iParam0 /*10*/].f_7)){
Local_383[iParam0 /*10*/].f_7=PED::CREATE_SYNCHRONIZED_SCENE(1991.988f, 3054.51f, 46.215f, 0f, 0f, 50.76f, 2);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(Local_383[iParam0 /*10*/].f_7, 1);
}
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[10 /*33*/], Local_383[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_A_taotranslator", 1000f, -4f, 257, 16, 1148846080, 0);
}
Local_383[iParam0 /*10*/].f_6++;
}
break;
case 2:
if(!PED::IS_PED_INJURED(Local_111[10 /*33*/]) && !PED::IS_PED_INJURED(Local_111[11 /*33*/])){
PED::SET_PED_COMPONENT_VARIATION(Local_111[10 /*33*/], 0, 0, 0, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_111[11 /*33*/], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_111[10 /*33*/], 1);
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_383[iParam0 /*10*/].f_7)){
Local_383[iParam0 /*10*/].f_7=PED::CREATE_SYNCHRONIZED_SCENE(1991.988f, 3054.51f, 46.215f, 0f, 0f, 50.76f, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[11 /*33*/], Local_383[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[10 /*33*/], Local_383[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_A_taotranslator", 1000f, -4f, 257, 16, 1148846080, 0);
...
PED::SET_PED_CONFIG_FLAG(Local_111[11 /*33*/], 118, 0);
PED::SET_PED_CONFIG_FLAG(Local_111[11 /*33*/], 208, 1);
PED::SET_PED_CONFIG_FLAG(Local_111[10 /*33*/], 118, 0);
PED::SET_PED_CONFIG_FLAG(Local_111[10 /*33*/], 208, 1);
Local_383[iParam0 /*10*/].f_6=900;
}
break;
case 900:
if(!PED::IS_PED_INJURED(Local_111[11 /*33*/])){
if(!PED::IS_PED_RAGDOLL(Local_111[11 /*33*/])){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Local_383[iParam0 /*10*/].f_7)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(Local_383[iParam0 /*10*/].f_7)==1f){
Local_383[iParam0 /*10*/].f_7=PED::CREATE_SYNCHRONIZED_SCENE(1991.988f, 3054.51f, 46.215f, 0f, 0f, 50.76f, 2);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(Local_383[iParam0 /*10*/].f_7, 1);
if(MISC::GET_RANDOM_INT_IN_RANGE(0, 3) < 2){
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[11 /*33*/], Local_383[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_Base_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
if(!PED::IS_PED_INJURED(Local_111[10 /*33*/])){
if(!PED::IS_PED_RAGDOLL(Local_111[10 /*33*/])){
if(!MISC::IS_BIT_SET(Local_383[iParam0 /*10*/].f_8, 0)){
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[10 /*33*/], Local_383[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_Base_taotranslator", 1000f, -4f, 257, 16, 1148846080, 0);
}
}}}else{
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[11 /*33*/], Local_383[iParam0 /*10*/].f_7, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
if(!PED::IS_PED_INJURED(Local_111[10 /*33*/])){
...
if(!PED::IS_PED_INJURED(Local_111[10 /*33*/])){
if(((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_111[10 /*33*/], PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_RAGDOLL(Local_111[10 /*33*/])) || PED::IS_PED_INJURED(Local_111[11 /*33*/])) || (!PED::IS_PED_INJURED(Local_111[10 /*33*/]) && TASK::GET_SCRIPT_TASK_STATUS(Local_111[10 /*33*/], joaat("script_task_synchronized_scene"))==2)){
if(!MISC::IS_BIT_SET(Local_383[iParam0 /*10*/].f_8, 0)){
TASK::CLEAR_PED_TASKS(Local_111[10 /*33*/]);
func_99();
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 30f, 20000, 0, 0);
TASK::TASK_COWER(0, -1);
func_98(&(Local_111[10 /*33*/]), 0);
MISC::SET_BIT(&(Local_383[iParam0 /*10*/].f_8), false);
}}}
if(!PED::IS_PED_INJURED(Local_111[11 /*33*/])){
if(((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_111[11 /*33*/], PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_RAGDOLL(Local_111[11 /*33*/])) || MISC::IS_BIT_SET(Local_383[iParam0 /*10*/].f_8, 1)) || (!PED::IS_PED_INJURED(Local_111[11 /*33*/]) && TASK::GET_SCRIPT_TASK_STATUS(Local_111[11 /*33*/], joaat("script_task_synchronized_scene"))==2)){
ENTITY::SET_ENTITY_HEALTH(Local_111[11 /*33*/], 0, 0);
if(!PED::IS_PED_RAGDOLL(Local_111[11 /*33*/])){
}}}
if(func_73(PLAYER::PLAYER_PED_ID(), 1991.988f, 3054.51f, 46.215f, 1) > 200f){
if(ENTITY::DOES_ENTITY_EXIST(Local_111[11 /*33*/]) && ENTITY::DOES_ENTITY_EXIST(Local_111[10 /*33*/])){
PED::DELETE_PED(&(Local_111[11 /*33*/]));
PED::DELETE_PED(&(Local_111[10 /*33*/]));
}
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("ig_taocheng"));
...
if(!PED::IS_PED_INJURED(Local_111[11 /*33*/])){
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[11 /*33*/], joaat("script_task_look_at_entity")) !=1){
TASK::TASK_LOOK_AT_ENTITY(Local_111[11 /*33*/], PLAYER::PLAYER_PED_ID(), 4000, 2096, 2);
}
}
if(!PED::IS_PED_INJURED(Local_111[10 /*33*/])){
if(TASK::GET_SCRIPT_TASK_STATUS(Local_111[10 /*33*/], joaat("script_task_look_at_entity")) !=1){
TASK::TASK_LOOK_AT_ENTITY(Local_111[10 /*33*/], PLAYER::PLAYER_PED_ID(), 4000, 2096, 2);
}
}}
break;
case 13:
...
if(ENTITY::DOES_ENTITY_EXIST(Local_111[iVar13 /*33*/])){
if(PED::IS_PED_INJURED(Local_111[iVar13 /*33*/])){
if(Local_111[iVar13 /*33*/].f_21==0){
if(((PED::GET_PED_CAUSE_OF_DEATH(Local_111[iVar13 /*33*/])==392730790 || PED::GET_PED_CAUSE_OF_DEATH(Local_111[iVar13 /*33*/])==joaat("weapon_heavysniper")) || PED::GET_PED_CAUSE_OF_DEATH(Local_111[iVar13 /*33*/])==joaat("weapon_remotesniper")) || PED::GET_PED_CAUSE_OF_DEATH(Local_111[iVar13 /*33*/])==joaat("weapon_sniperrifle")){
iLocal_380++;
}
...
break;
case 16:
if(OBJECT::DOES_PICKUP_EXIST(uLocal_174)){
OBJECT::REMOVE_PICKUP(uLocal_174);
}
iVar14=0;
...
if(!OBJECT::DOES_PICKUP_EXIST(uLocal_174)){
uLocal_174=OBJECT::CREATE_PICKUP(joaat("pickup_weapon_petrolcan"), 2436.775f, 4967.487f, 41.4f, iVar14, -1, 1, 0);
INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(uLocal_174, "V_8_BasementRm");
uLocal_176=func_170(uLocal_174);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_176, "FRMBLIP");
}
Local_383[iParam0 /*10*/].f_3=1;
break;
case 17:
...
switch (Local_383[iParam0 /*10*/].f_6){
case 0:
Local_383[iParam0 /*10*/].f_7=MISC::GET_GAME_TIMER() + 4000;
Local_383[iParam0 /*10*/].f_6++;
break;
case 1:
if(MISC::GET_GAME_TIMER() > Local_383[iParam0 /*10*/].f_7){
...
if(!PED::IS_PED_INJURED(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/])){
if(INTERIOR::GET_INTERIOR_FROM_ENTITY(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/])==0){
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/], iLocal_115);
...
while (Local_383[iParam0 /*10*/].f_7 < Local_111.f_0){
if(!PED::IS_PED_INJURED(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/])){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/], 2457.885f, 4981.169f, 50.00518f, 2441.58f, 4965.088f, 56.24006f, 34.3125f, 0, 1, 0)){
PED::DELETE_PED(&(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/]));
}
}
Local_383[iParam0 /*10*/].f_7++;
}
...
if(!PED::IS_PED_INJURED(Local_111[iVar15 /*33*/])){
if(INTERIOR::GET_ROOM_KEY_FROM_ENTITY(Local_111[iVar15 /*33*/]) !=MISC::GET_HASH_KEY("V_8_BasementRm")){
...
break;
case 45:
if((func_93(9) || (!PED::IS_PED_INJURED(Local_111[8 /*33*/]) && PED::IS_PED_IN_COMBAT(Local_111[8 /*33*/], 0))) || (!PED::IS_PED_INJURED(Local_111[9 /*33*/]) && PED::IS_PED_IN_COMBAT(Local_111[9 /*33*/], 0))){
if(!PED::IS_PED_INJURED(Local_111[8 /*33*/])){
PED::SET_PED_ACCURACY(Local_111[8 /*33*/], 45);
}
if(!PED::IS_PED_INJURED(Local_111[9 /*33*/])){
PED::SET_PED_ACCURACY(Local_111[9 /*33*/], 45);
}
Local_383[iParam0 /*10*/].f_3=1;
}
break;
...
while (Local_383[iParam0 /*10*/].f_7 < Local_111.f_0){
if(!PED::IS_PED_INJURED(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/])){
PED::SET_PED_SEEING_RANGE(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/], 60f);
}
Local_383[iParam0 /*10*/].f_7++;
}
Local_383[iParam0 /*10*/].f_3=1;
...
PED::SET_PED_SEEING_RANGE(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/], 5f);
}
}
Local_383[iParam0 /*10*/].f_7++;
}
...
if(!PED::IS_PED_INJURED(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/])){
if(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/].f_1==1){
PED::SET_PED_SEEING_RANGE(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/], 30f);
}
}
Local_383[iParam0 /*10*/].f_7++;
}
...
if(!PED::IS_PED_INJURED(Local_111[23 /*33*/])){
Local_383[iParam0 /*10*/].f_7=PED::CREATE_SYNCHRONIZED_SCENE(2435.312f, 4967.087f, 41.35f, 0f, 0f, 11.4f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(Local_383[iParam0 /*10*/].f_7, 1);
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/], Local_383[iParam0 /*10*/].f_8, "misschinese2_crystalmaze", "_stand_to_aim", 1000f, -8f, 0, 0, 1148846080, 0);
Local_383[iParam0 /*10*/].f_6++;
}}
break;
case 2:
...
iLocal_144=VEHICLE::CREATE_VEHICLE(joaat("blazer"), 2478.587f, 4941.803f, 43.6736f, 227.2903f, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_144, 1084227584);
Local_383[iParam0 /*10*/].f_3=1;
}
break;
}
...
AUDIO::PLAY_SOUND_FROM_COORD(uLocal_169, "FarmhouseFire_Ignite", Local_170, "CHINESE2_SOUNDS", 0, 0, 0);
Local_383[iParam0 /*10*/].f_3=1;
break;
case 37:
...
break;
case 1:
if(func_73(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/], 2454.895f, 4950.895f, 44.1488f, 1) > 100f && func_4(Local_111[Local_383[iParam0 /*10*/].f_7 /*33*/], PLAYER::PLAYER_PED_ID(), 1) > 100f){
iVar16=func_18(4);
func_134(&(Local_111[iVar16 /*33*/].f_25));
if(!PED::IS_PED_INJURED(Local_111[iVar16 /*33*/])){
PED::SET_PED_KEEP_TASK(Local_111[iVar16 /*33*/], 1);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_111[iVar16 /*33*/]));
}
...
func_134(&(Local_111[iVar16 /*33*/].f_25));
Local_111[iVar16 /*33*/]=0;
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_143, 0)){
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_143);
}
Local_383[iParam0 /*10*/].f_3=1;
}
break;
...
PED::SET_PED_ACCURACY(Local_111[24 /*33*/], 100);
if(!PED::IS_PED_INJURED(Local_111[15 /*33*/])){
PED::SET_PED_ACCURACY(Local_111[15 /*33*/], 100);
}
if(!PED::IS_PED_INJURED(Local_111[16 /*33*/])){
PED::SET_PED_ACCURACY(Local_111[16 /*33*/], 100);
}
if(!PED::IS_PED_INJURED(Local_111[17 /*33*/])){
PED::SET_PED_ACCURACY(Local_111[17 /*33*/], 100);
}
TASK::TASK_COMBAT_PED(Local_111[24 /*33*/], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_TARGET_LOSS_RESPONSE(Local_111[24 /*33*/], 1);
ENTITY::SET_ENTITY_HEALTH(Local_111[24 /*33*/], 200, 0);
Local_383[iParam0 /*10*/].f_3=1;
}
break;
}
...
FIRE::STOP_FIRE_IN_RANGE(Local_107[iVar0 /*5*/], 4f);
MISC::CLEAR_AREA(Local_107[iVar0 /*5*/], 2f, 1, 0, 0, 0);
iVar1=0;
while (iVar1 < Local_111.f_0){
if(ENTITY::DOES_ENTITY_EXIST(Local_111[iVar1 /*33*/])){
Var2={
ENTITY::GET_ENTITY_COORDS(Local_111[iVar1 /*33*/], 0) 
};
if(vdist2(Var2, Local_107[iVar0 /*5*/]) < 2f && Var2.f_2 > 43.9f){
PED::DELETE_PED(&(Local_111[iVar1 /*33*/]));
}}
iVar1++;
}}
iVar0++;
...
iVar0=0;
while (iVar0 < Local_107.f_0){
GRAPHICS::REMOVE_DECALS_IN_RANGE(Local_107[iVar0 /*5*/], 1f);
if(!HUD::DOES_BLIP_EXIST(Local_107[iVar0 /*5*/].f_3)){
if(!func_168(Local_107[iVar0 /*5*/], 0f, 0f, 0f, 0)){
iLocal_91++;
Local_107[iVar0 /*5*/].f_3=func_5(Local_107[iVar0 /*5*/], 0);
...
Local_107[iVar0 /*5*/]={
HUD::GET_BLIP_COORDS(Local_107[iVar0 /*5*/].f_3) 
};
if(!bParam0){
HUD::SET_BLIP_ALPHA(Local_107[iVar0 /*5*/].f_3, 0);
}else{
...
if(ENTITY::DOES_ENTITY_EXIST(Local_111[Local_386[iVar3 /*8*/].f_5 /*33*/]) && ENTITY::DOES_ENTITY_EXIST(Local_111[Local_386[iVar3 /*8*/].f_6 /*33*/])){
if(PED::IS_PED_INJURED(Local_111[Local_386[iVar3 /*8*/].f_5 /*33*/]) || PED::IS_PED_INJURED(Local_111[Local_386[iVar3 /*8*/].f_6 /*33*/])){
Local_386[iVar3 /*8*/].f_2=1;
}}}
break;
}}
...
break;
case 1:
if(ENTITY::DOES_ENTITY_EXIST(Local_111[Local_386[iVar3 /*8*/].f_5 /*33*/])){
if(PED::IS_PED_INJURED(Local_111[Local_386[iVar3 /*8*/].f_5 /*33*/])){
...
if(!PED::IS_PED_INJURED(Local_111[iVar4 /*33*/])){
bVar5=true;
...
if(!PED::IS_PED_INJURED(Local_111[iVar7 /*33*/])){
iVar8++;
if(iVar8 > 1){
Local_386[iVar3 /*8*/].f_2=0;
iVar7=Local_111.f_0;
...
switch (Local_386[iVar3 /*8*/].f_4){
case 0:
if(!PED::IS_PED_INJURED(Local_111[4 /*33*/]) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(Local_111[4 /*33*/])){
Local_386[iVar3 /*8*/].f_4++;
}
if(!PED::IS_PED_INJURED(Local_111[5 /*33*/]) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(Local_111[5 /*33*/])){
Local_386[iVar3 /*8*/].f_4++;
}
if(!PED::IS_PED_INJURED(Local_111[7 /*33*/]) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(Local_111[7 /*33*/])){
Local_386[iVar3 /*8*/].f_4++;
}
Local_386[iVar3 /*8*/].f_5=MISC::GET_GAME_TIMER() + 8000;
break;
case 1:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_143, 0)){
if(func_96(ENTITY::GET_ENTITY_COORDS(iLocal_143, 1), 5f, 150f)){
Local_386[iVar3 /*8*/].f_6=(Local_386[iVar3 /*8*/].f_6 + floor((timestep() * 1000f)));
}
}
if(Local_386[iVar3 /*8*/].f_6 > 1500){
Local_386[iVar3 /*8*/].f_2=1;
}
if(MISC::GET_GAME_TIMER() > Local_386[iVar3 /*8*/].f_5){
Local_386[iVar3 /*8*/].f_4++;
}
break;
}
...
case 0:
if(OBJECT::DOES_PICKUP_EXIST(uLocal_174)){
if(OBJECT::DOES_PICKUP_OBJECT_EXIST(uLocal_174)){
Local_386[iVar3 /*8*/].f_4++;
}
}
break;
...
switch (Local_386[iVar3 /*8*/].f_4){
case 0:
Local_386[iVar3 /*8*/].f_5=MISC::GET_GAME_TIMER() + 30000;
Local_386[iVar3 /*8*/].f_4++;
break;
case 1:
if(MISC::GET_GAME_TIMER() > Local_386[iVar3 /*8*/].f_5){
...
if(FIRE::GET_NUMBER_OF_FIRES_IN_RANGE(Local_107[iParam0 /*5*/], 0.6f) > 0){
return 1;
}
return 0;
}
...
while (iVar0 >=0){
if(Local_107[iVar0 /*5*/].f_4){
if(FIRE::GET_NUMBER_OF_FIRES_IN_RANGE(Local_107[iVar0 /*5*/], 0.6f) > 0){
Local_97={
Local_107[iVar0 /*5*/] 
};
iLocal_98=iVar0;
...
if((func_202() && iLocal_148 > 0) && MISC::GET_GAME_TIMER() > iLocal_157){
...
while (iVar0 <=55){
Local_107[iVar0 /*5*/]={
Local_107[iVar0 /*5*/] + Vector(0.6f, 0f, 0f) 
};
iVar0++;
}
...
if(ENTITY::DOES_ENTITY_EXIST(Local_111[iVar1 /*33*/].f_20)){
OBJECT::DELETE_OBJECT(&(Local_111[iVar1 /*33*/].f_20));
}
iVar1++;
}
iLocal_148++;
...
Local_135[iVar2 /*18*/].f_3={
CAM::GET_CAM_ROT(CAM::GET_RENDERING_CAM(), 2) 
};
Local_135[iVar2 /*18*/].f_14=CAM::GET_CAM_FOV(CAM::GET_RENDERING_CAM());
}
if(iLocal_139[iVar2]){
iLocal_139[iVar2]=0;
Local_135[iVar2 /*18*/].f_6={
CAM::GET_CAM_COORD(CAM::GET_RENDERING_CAM()) 
};
Local_135[iVar2 /*18*/].f_9={
CAM::GET_CAM_ROT(CAM::GET_RENDERING_CAM(), 2) 
};
Local_135[iVar2 /*18*/].f_15=CAM::GET_CAM_FOV(CAM::GET_RENDERING_CAM());
}
iVar2++;
}
if(iLocal_131){
...
if(bLocal_132){
fLocal_136=(fLocal_136 + timestep());
if(iLocal_137==-1 || ((iLocal_137 !=-1 && iLocal_137 < 4) && fLocal_136 > (Local_135[iLocal_137 /*18*/].f_13 / 1000f))){
iLocal_137++;
if(iLocal_137==3){
if(STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze")){
uLocal_153=CAM::CREATE_CAMERA(964613260, 1);
uLocal_154=PED::CREATE_SYNCHRONIZED_SCENE(2452.914f, 4962.096f, 45.585f, 0f, 0f, 45f, 2);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_153, uLocal_154, "trevor_barn_walk_cam", "misschinese2_crystalmaze");
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_154, "misschinese2_crystalmaze", "trevor_barn_walk", 1000f, -8f, 0, 0, 1148846080, 0);
}
...
CAM::DESTROY_ALL_CAMS(0);
uLocal_153=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", Local_135[iLocal_137 /*18*/], Local_135[iLocal_137 /*18*/].f_3, Local_135[iLocal_137 /*18*/].f_14, 1, 2);
CAM::SET_CAM_PARAMS(uLocal_153, Local_135[iLocal_137 /*18*/].f_6, Local_135[iLocal_137 /*18*/].f_9, Local_135[iLocal_137 /*18*/].f_15, floor(Local_135[iLocal_137 /*18*/].f_12), Local_135[iLocal_137 /*18*/].f_16, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
if(iLocal_137 < 2){
...
OBJECT::SET_STATE_OF_RAYFIRE_MAP_OBJECT(uLocal_171, 9);
MISC::SET_TIME_SCALE(1f);
STREAMING::END_SRL();
if(CAM::IS_SCREEN_FADED_OUT()){
while (OBJECT::GET_STATE_OF_RAYFIRE_MAP_OBJECT(uLocal_171) !=10){
func_28(29, 1);
}
CAM::DO_SCREEN_FADE_IN(1000);
}
...
case 0:
iLocal_141=0;
if(MISC::GET_GAME_TIMER() > Local_134[iVar3 /*6*/].f_5){
func_128(Local_140[iLocal_141 /*3*/], 0);
Local_134[iVar3 /*6*/].f_5=MISC::GET_GAME_TIMER() + 200;
...
CAM::SHAKE_CAM(uLocal_153, "LARGE_EXPLOSION_SHAKE", fLocal_155);
CAM::SET_CAM_MOTION_BLUR_STRENGTH(uLocal_153, 0.1f);
Local_134[iVar3 /*6*/]=1;
}
break;
case 4:
...
fLocal_173=1f;
Local_134[iVar3 /*6*/].f_4++;
Local_134[iVar3 /*6*/].f_5=MISC::GET_GAME_TIMER() + 1300;
AUDIO::ACTIVATE_AUDIO_SLOWMO_MODE("SLOW_MO_METH_HOUSE_RAYFIRE");
break;
case 1:
fLocal_173=(fLocal_173 - (timestep() * 1f));
if(fLocal_173 < 0.2f){
fLocal_173=0.2f;
}
MISC::SET_TIME_SCALE(fLocal_173);
if(MISC::GET_GAME_TIMER() > Local_134[iVar3 /*6*/].f_5){
Local_134[iVar3 /*6*/].f_4++;
}
break;
...
if(((func_202() && iLocal_148 > 0) && iLocal_148 < 7) && MISC::GET_GAME_TIMER() > iLocal_157){
iLocal_148=10;
iLocal_156=0;
bLocal_163=true;
}
...
iLocal_156=6000;
}elseif(fVar1 < func_224(0.96f) && fVar1 > func_224(-1.33f)){
iLocal_148=2;
settimera(6000);
STREAMING::SET_SRL_TIME(6000f);
iLocal_156=12000;
}elseif(fVar1 < func_224(2.29f) && fVar1 > func_224(0.96f)){
iLocal_148=3;
settimera(12000);
STREAMING::SET_SRL_TIME(12000f);
iLocal_156=18000;
}elseif(fVar1 < func_224(-2.81f) || fVar1 > func_224(2.29f)){
iLocal_148=4;
settimera(18000);
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
iLocal_82=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
Local_110={
ENTITY::GET_ENTITY_VELOCITY(iLocal_82) 
};
ENTITY::FREEZE_ENTITY_POSITION(iLocal_82, 1);
ENTITY::SET_ENTITY_VISIBLE(iLocal_82, 0, 0);
}
AUDIO::PLAY_STREAM_FRONTEND();
if(iLocal_148==1){
iLocal_376=1;
...
uLocal_153=CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2538.6f, 4976.9f, 50.6f, -1.8f, 0f, 93.2f, 5000, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2536.153f, 4976.7f, 50.5267f, -1.8f, 0f, 93.2f, 6000, 3, 2);
CAM::SET_CAM_FOV(uLocal_153, 34.9f);
CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(uLocal_153, 0);
}else{
switch (iLocal_148){
case 2:
uLocal_153=CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2426.8f, 5088.3f, 51.2f, 0f, 0f, -169f, 5000, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2427.8f, 5087.2f, 51.2f, 0f, 0f, -169.7f, 6000, 3, 2);
CAM::SET_CAM_FOV(uLocal_153, 28.5f);
CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(uLocal_153, 0);
break;
case 3:
uLocal_153=CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2326.3f, 4985.6f, 51.5f, 0f, 0f, -89.1f, 5000, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2328f, 4985.4f, 52.1f, 0f, 0f, -89.1f, 6000, 3, 2);
CAM::SET_CAM_FOV(uLocal_153, 28.5f);
CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(uLocal_153, 0);
break;
case 4:
uLocal_153=CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2403.6f, 4889.7f, 47.5f, 3.4f, 0f, -19.5f, 5000, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, Vector(47.5f, 4889.7f, 2403.6f) + Vector(0.07f, 2.15f, 0.8f), 3.4f, 0f, -19.5f, 6000, 3, 2);
CAM::SET_CAM_FOV(uLocal_153, 29.8f);
CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(uLocal_153, 0);
break;
case 5:
uLocal_153=CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2493.4f, 4934.8f, 45.7f, 5.2f, 0f, 48f, 5000, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, Vector(45.7f, 4934.8f, 2493.4f) + Vector(0f, 1f, -1f), 5.2f, 0f, 48f, 6000, 3, 2);
CAM::SET_CAM_FOV(uLocal_153, 28.5f);
CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(uLocal_153, 0);
break;
case 6:
uLocal_153=CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2570.6f, 4982f, 151.6f, -47.9f, 0f, 88.1f, 5000, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2487.8f, 4896.9f, 151.9f, -47.2f, 0f, 28.8f, 15000, 3, 2);
CAM::SET_CAM_FOV(uLocal_153, 28.5f);
CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(uLocal_153, 0);
break;
case 7:
uLocal_153=CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2487.8f, 4896.9f, 151.9f, -47.2f, 0f, 28.8f, 5000, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2570.6f, 4982f, 151.6f, -47.9f, 0f, 88.1f, 15000, 3, 2);
CAM::SET_CAM_FOV(uLocal_153, 28.5f);
CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(uLocal_153, 0);
break;
}}
if(iLocal_148 < 6){
CAM::SHAKE_CAM(uLocal_153, "Hand_shake", 0.2f);
}else{
CAM::SHAKE_CAM(uLocal_153, "Hand_shake", 0.7f);
}
CAM::SET_CAM_ACTIVE(uLocal_153, 1);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
RECORDING::REPLAY_START_EVENT(4);
...
while (iVar4 < Local_111.f_0){
if(!PED::IS_PED_INJURED(Local_111[iVar4 /*33*/])){
AUDIO::STOP_PED_SPEAKING(Local_111[iVar4 /*33*/], 1);
}
iVar4++;
}
iLocal_158=PED::CREATE_PED(26, joaat("a_m_y_methhead_01"), 2460.449f, 4976.938f, 45.5765f, 243.4917f, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_158, joaat("weapon_microsmg"), -1, 1, 1);
if(!PED::IS_PED_INJURED(iLocal_158)){
func_99();
TASK::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
...
iLocal_145=VEHICLE::CREATE_VEHICLE(joaat("dubsta"), 2479.961f, 4990f, 45.8f, -5.37f, 1, 1, 0);
func_15("CHN2_MISSION_START", 1, "CHN2_EXPLODE");
iLocal_148=3;
}
break;
case 3:
if(timera() > iLocal_156){
CAM::DESTROY_ALL_CAMS(0);
uLocal_153=CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2445.944f, 4962.986f, 51.4782f, 7.9159f, 0f, 34.5909f, 5000, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2445.684f, 4963.368f, 51.6659f, 3.6033f, 0f, 34.5909f, 3500, 3, 2);
CAM::SET_CAM_FOV(uLocal_153, 34f);
CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(uLocal_153, 0);
CAM::SHAKE_CAM(uLocal_153, "Hand_shake", 0.5f);
iLocal_156 +=3500;
iLocal_148++;
}
break;
...
CAM::DESTROY_ALL_CAMS(0);
uLocal_153=CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2465.07f, 4946.688f, 45.3372f, 7.1461f, 0f, 30.9281f, 5000, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2466.011f, 4947.377f, 45.3509f, 7.1461f, 0f, 32.3761f, 3000, 3, 2);
CAM::SET_CAM_FOV(uLocal_153, 34f);
CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(uLocal_153, 0);
CAM::SHAKE_CAM(uLocal_153, "Hand_shake", 0.5f);
iLocal_156 +=3000;
...
CAM::DESTROY_ALL_CAMS(0);
uLocal_153=CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", 1);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2509.691f, 4971.024f, 44.1325f, 7.2578f, 0f, 88.5226f, 5000, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_153, 2509.415f, 4971.163f, 44.1674f, 6.6554f, 0f, 89.4229f, 2500, 3, 2);
CAM::SET_CAM_FOV(uLocal_153, 37.34f);
CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(uLocal_153, 0);
CAM::SHAKE_CAM(uLocal_153, "Hand_shake", 0.5f);
iLocal_156 +=2500;
iLocal_148++;
...
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_145, "EXL_2_abandoned_car", 1, joaat("dubsta"), 0);
}
...
VEHICLE::REQUEST_VEHICLE_HIGH_DETAIL_MODEL(iLocal_82);
}
...
PED::DELETE_PED(&iLocal_158);
}
iLocal_378=func_18(4);
if(iLocal_378 !=-1){
if(!PED::IS_PED_INJURED(Local_111[iLocal_378 /*33*/])){
PED::DELETE_PED(&(Local_111[iLocal_378 /*33*/]));
}
if(ENTITY::DOES_ENTITY_EXIST(Local_111[iLocal_378 /*33*/].f_20)){
OBJECT::DELETE_OBJECT(&(Local_111[iLocal_378 /*33*/].f_20));
}
...
if(iLocal_379 !=-1){
if(!PED::IS_PED_INJURED(Local_111[iLocal_379 /*33*/])){
PED::DELETE_PED(&(Local_111[iLocal_379 /*33*/]));
}
if(ENTITY::DOES_ENTITY_EXIST(Local_111[iLocal_379 /*33*/].f_20)){
OBJECT::DELETE_OBJECT(&(Local_111[iLocal_379 /*33*/].f_20));
}
...
func_31(20, 0);
if(!PED::IS_PED_INJURED(iLocal_159)){
PED::DELETE_PED(&iLocal_159);
}
...
OBJECT::DELETE_OBJECT(&iLocal_181);
}
func_209();
iLocal_109=0;
func_27();
...
if(!PED::IS_PED_INJURED(Local_111[iVar5 /*33*/])){
AUDIO::STOP_PED_SPEAKING(Local_111[iVar5 /*33*/], 0);
}
iVar5++;
}
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
...
if(VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iLocal_82))){
ENTITY::SET_ENTITY_VELOCITY(iLocal_82, Local_110);
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_82, -1);
}
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_82, 1, 1, 0);
if(VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iLocal_82))){
ENTITY::SET_ENTITY_ROTATION(iLocal_82, 0f, 0f, ENTITY::GET_ENTITY_HEADING(iLocal_82), 2, 1);
VEHICLE::SET_HELI_BLADES_FULL_SPEED(iLocal_82);
ENTITY::SET_ENTITY_VELOCITY(iLocal_82, 1f, 1f, 1f);
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_82, -1);
}
if(iLocal_376==0){
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_82, -1);
}
ENTITY::SET_ENTITY_VISIBLE(iLocal_82, 1, 0);
}}
...
VEHICLE::DELETE_VEHICLE(&iLocal_143);
}
iVar0=0;
while (iVar0 < Local_111.f_0){
if(ENTITY::DOES_ENTITY_EXIST(Local_111[iVar0 /*33*/])){
PED::DELETE_PED(&(Local_111[iVar0 /*33*/]));
}
if(ENTITY::DOES_ENTITY_EXIST(Local_111[iVar0 /*33*/].f_20)){
OBJECT::DELETE_OBJECT(&(Local_111[iVar0 /*33*/].f_20));
}
...
if(OBJECT::DOES_PICKUP_EXIST(uLocal_166)){
OBJECT::REMOVE_PICKUP(uLocal_166);
}
iVar0=0;
while (iVar0 < iLocal_167){
if(OBJECT::DOES_PICKUP_EXIST(iLocal_167[iVar0])){
OBJECT::REMOVE_PICKUP(iLocal_167[iVar0]);
}
iVar0++;
}
iVar0=0;
...
OBJECT::DELETE_OBJECT(&(iLocal_168[iVar0]));
}
iVar0++;
}
...
if(bParam1){
if(PED::IS_PED_GROUP_MEMBER(uParam0->f_17[bVar0], func_220()) && uParam0->f_17[bVar0] !=PLAYER::PLAYER_PED_ID()){
...
if(HUD::DOES_BLIP_EXIST(Local_182.f_5)){
HUD::SET_BLIP_ROUTE(Local_182.f_6, 0);
}
func_182(11);
}else{
switch (iLocal_148){
...
break;
case 1:
if(func_229(&Local_182, 2608.151f, 4949.754f, 39.4f, 9f, 9f, 2f, 1, "FRMCHSE_1", 1, 1, -1)){
...
break;
case 3:
if(func_229(&Local_182, 2573.63f, 4983.677f, 50.6978f, 12f, 12f, 2f, 0, "FRMCHSE_5", 1, 1, -1)){
if(AUDIO::IS_AUDIO_SCENE_ACTIVE("CHI_2_DRIVE_ROCK_RADIO")){
AUDIO::STOP_AUDIO_SCENE("CHI_2_DRIVE_ROCK_RADIO");
}
...
bool func_229(var uParam0, struct<3> Param1, struct<3> Param2, int iParam3, char* sParam4, bool bParam5, bool bParam6, int iParam7){
return func_230(uParam0, Param1, Param2, func_268(), func_268(), iParam3, 1, 0, 0, 0, 0, sParam4, func_173(), func_173(), func_173(), func_173(), func_173(), 0, bParam5, func_173(), 0, 0, bParam6, iParam7, 0, 0, 0, 1, 1065353216);
}

int func_230(var uParam0, struct<3> Param1, struct<3> Param2, struct<3> Param3, struct<3> Param4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, char* sParam11, char* sParam12, char* sParam13, char* sParam14, char* sParam15, char* sParam16, bool bParam17, bool bParam18, char* sParam19, bool bParam20, int iParam21, bool bParam22, int iParam23, int iParam24, int iParam25, int iParam26, bool bParam27, float fParam28){
int iVar0;
bool bVar1;
int iVar2;
struct<3> Var3;
...
func_266(uParam0);
func_265();
if(func_249(uParam0, uParam0->f_17[0], uParam0->f_17[1], uParam0->f_17[2], sParam12, sParam13, sParam14, sParam15, uParam0->f_8, bParam17, iParam10, 0, 0, iParam24, iParam25, iParam26, iParam6, bParam18)){
func_248(sParam12);
func_248(sParam13);
func_248(sParam14);
func_248(sParam15);
...
if((!func_243(uParam0, 1) && !func_242(uParam0)) && !MISC::IS_BIT_SET(uParam0->f_13, 0)){
if(bParam22){
func_241(uParam0, "LOSE_WANTED", 0);
if(!PED::IS_PED_INJURED(uParam0->f_17[0])){
func_239(uParam0->f_17[0], "VEHICLE_POLICE_PURSUIT", 3);
}
}
...
if(!PED::IS_PED_INJURED(uParam0->f_17[0])){
func_239(uParam0->f_17[0], "LOSE_WANTED_LEVEL", 3);
}
MISC::CLEAR_BIT(&(uParam0->f_13), true);
}}
if(!HUD::DOES_BLIP_EXIST(uParam0->f_5)){
...
if(bParam27){
func_238(uParam0->f_5, uParam0);
}}elseif(!func_237(Var3, HUD::GET_BLIP_COORDS(uParam0->f_5), 0.1f, 0)){
...
bVar1=false;
}}elseif(!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar2], func_220()) || !func_235(uParam0->f_17[iVar2], 1)){
bVar1=false;
}}
iVar2++;
}
...
if(!MISC::IS_BIT_SET(uParam0->f_13, 23)){
if(!PED::IS_PED_INJURED(uParam0->f_17[0])){
func_239(uParam0->f_17[0], "GET_IN_CAR", 3);
}
...
func_239(uParam0->f_17[iVar7], "NEED_A_BIGGER_VEHICLE", 3);
}
func_241(uParam0, "MORE_SEATS", 0);
...
if(func_233(1, 0, 1) || MISC::IS_BIT_SET(uParam0->f_13, 7)){
return 1;
}}}elseif(func_233(1, 0, 1) || MISC::IS_BIT_SET(uParam0->f_13, 7)){
return 1;
}
return 0;
}
...
return 1;
}}elseif(PED::IS_PED_GROUP_MEMBER(iParam0, func_220())){
PED::SET_GROUP_SEPARATION_RANGE(func_220(), 50f);
return 1;
}}else{
return 1;
...
int func_237(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
...
void func_241(var uParam0, char* sParam1, bool bParam2){
if(!bParam2){
...
int func_249(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, var uParam8, bool bParam9, int iParam10, bool bParam11, int iParam12, var uParam13, var uParam14, var uParam15, int iParam16, bool bParam17){
int iVar0;
int iVar1;
int iVar2;
int iVar3;
...
if(!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_220())){
if(func_262(uParam0, uParam0->f_17[iVar0], uParam8, 1)){
...
func_239(uParam0->f_17[iVar18], "NEED_A_BIGGER_VEHICLE", 3);
}
func_241(uParam0, "MORE_SEATS", 0);
MISC::SET_BIT(&(uParam0->f_13), 13);
}}
...
if(func_247(iVar21, uParam0, 0)){
if(func_258(iVar0, uParam0) || !MISC::IS_BIT_SET(uParam0->f_13, 27)){
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(uParam0->f_17[iVar0], iVar0);
func_221(iVar0, uParam0);
iVar4++;
if(iVar4 >=iVar3){
MISC::SET_BIT(&(uParam0->f_13), 27);
}}}elseif(!func_258(iVar0, uParam0)){
...
if(func_262(uParam0, uParam0->f_17[iVar0], uParam8, bParam11)){
if(!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_220())){
...
if(((func_235(uParam0->f_17[iVar0], 1) || func_256(uParam0->f_17[iVar0], iParam10)) || iParam12) || (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam10, 0) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam10, 0))){
if(HUD::DOES_BLIP_EXIST(uParam0->f_1[iVar0])){
HUD::REMOVE_BLIP(&(uParam0->f_1[iVar0]));
func_248(uVar12[iVar0]);
}
}
else{
if(bParam9){
...
iVar11=TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], joaat("script_task_enter_vehicle"));
if(iVar11==7 && !func_264(uParam0->f_17[iVar0], iParam10)){
...
HUD::SET_BLIP_DISPLAY(uParam0->f_1[iVar0], 2);
iVar6=0;
}}}elseif(!PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_220())){
if(func_262(uParam0, uParam0->f_17[iVar0], uParam8, bParam11)){
if(!PED::IS_PED_RAGDOLL(uParam0->f_17[iVar0]) && !TASK::IS_PED_GETTING_UP(uParam0->f_17[iVar0])){
iVar11=TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_17[iVar0], joaat("script_task_enter_vehicle"));
if(iVar11==7){
...
elseif(PED::IS_PED_GROUP_MEMBER(uParam0->f_17[iVar0], func_220()) && !FIRE::IS_ENTITY_ON_FIRE(iParam10)){
PED::REMOVE_PED_FROM_GROUP(uParam0->f_17[iVar0]);
}}}elseif(HUD::DOES_BLIP_EXIST(uParam0->f_1[iVar0])){
HUD::REMOVE_BLIP(&(uParam0->f_1[iVar0]));
func_248(uVar12[iVar0]);
...
if(iVar7[iVar0]){
if(!PED::IS_PED_INJURED(uParam0->f_17[iVar0])){
if(func_259(uParam0->f_17[iVar0]) || ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER::PLAYER_PED_ID(), uParam0->f_8, uParam0->f_8, uParam0->f_8, 0, 1, 0)){
iVar1=(iVar1 - 1);
iVar7[iVar0]=0;
}
}}elseif(!PED::IS_PED_INJURED(uParam0->f_17[iVar0])){
if(!ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_17[iVar0], PLAYER::PLAYER_PED_ID(), (uParam0->f_8 * 0.85f), (uParam0->f_8 * 0.85f), uParam0->f_8, 0, 1, 0) && !func_259(uParam0->f_17[iVar0])){
}}
iVar0++;
}}
...
func_251(uParam0, uVar12[iVar0], uVar13[iVar0], 0);
func_250(iVar0, uParam0);
uParam0->f_12=iVar1;
}
}
if(!func_253(iVar0, uParam0)){
func_241(uParam0, uVar12[iVar0], 0);
func_250(iVar0, uParam0);
uParam0->f_12=iVar1;
}
}
...
void func_251(var uParam0, char* sParam1, var uParam2, bool bParam3){
if(!bParam3){
if(!MISC::IS_STRING_NULL(sParam1)){
if(!MISC::ARE_STRINGS_EQUAL(sParam1, "")){
func_252(sParam1, uParam2, 7500, 1);
}}}
uParam0->f_10=MISC::GET_GAME_TIMER();
}


void func_252(char* sParam0, int iParam1, int iParam2, int iParam3){
iParam3=iParam3;
HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
int func_262(var uParam0, int iParam1, float fParam2, bool bParam3){
int iVar0;
if(!PED::IS_PED_INJURED(iParam1)){
...
Local_111[14 /*33*/]=Global_97310.f_9[2];
Local_111[13 /*33*/]=Global_97310.f_9[1];
Local_111[11 /*33*/]=Global_97310.f_9[4];
Local_111[10 /*33*/]=Global_97310.f_9[3];
Local_111[12 /*33*/]=Global_97310.f_9[0];
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_111[14 /*33*/], 1, 1);
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_111[13 /*33*/], 1, 1);
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_111[11 /*33*/], 1, 1);
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_111[10 /*33*/], 1, 1);
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_111[12 /*33*/], 1, 1);
if(!PED::IS_PED_INJURED(Local_111[13 /*33*/])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_111[13 /*33*/], "Old_Man1A", 0, joaat("ig_old_man1a"), 0);
}
if(!PED::IS_PED_INJURED(Local_111[14 /*33*/])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_111[14 /*33*/], "Old_Man2", 0, joaat("ig_old_man2"), 0);
}
if(!PED::IS_PED_INJURED(Local_111[11 /*33*/])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_111[11 /*33*/], "tao", 0, joaat("ig_taocheng"), 0);
}
if(!PED::IS_PED_INJURED(Local_111[10 /*33*/])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_111[10 /*33*/], "Taos_Translator", 0, joaat("ig_taostranslator"), 0);
}
if(!PED::IS_PED_INJURED(Local_111[12 /*33*/])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_111[12 /*33*/], "Janet", 0, joaat("ig_janet"), 0);
}}else{
Local_111[13 /*33*/]=PED::CREATE_PED(26, joaat("ig_old_man1a"), 1987.231f, 3052.741f, 46.214f, 0, 1, 1);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_111[13 /*33*/], "Old_Man1A", 0, joaat("ig_old_man1a"), 0);
Local_111[14 /*33*/]=PED::CREATE_PED(26, joaat("ig_old_man2"), 1987.231f, 3052.741f, 46.214f, 0, 1, 1);
...
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_111[11 /*33*/], "tao", 2, joaat("ig_taocheng"), 0);
}
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_111[10 /*33*/], "Taos_Translator", 2, joaat("ig_taostranslator"), 0);
Local_111[12 /*33*/]=PED::CREATE_PED(26, joaat("ig_janet"), 1987.231f, 3052.741f, 46.214f, 0, 1, 1);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_111[12 /*33*/], "Janet", 0, joaat("ig_janet"), 0);
}
func_272();
...
Local_111[13 /*33*/]=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Old_Man1A", 0));
}}
if(!ENTITY::DOES_ENTITY_EXIST(Local_111[14 /*33*/])){
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Old_Man2", 0)){
Local_111[14 /*33*/]=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Old_Man2", 0));
}}
if(!ENTITY::DOES_ENTITY_EXIST(Local_111[11 /*33*/])){
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("tao", 0)){
Local_111[11 /*33*/]=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("tao", 0));
}}
if(!ENTITY::DOES_ENTITY_EXIST(Local_111[10 /*33*/])){
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Taos_Translator", 0)){
Local_111[10 /*33*/]=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Taos_Translator", 0));
}}
if(!ENTITY::DOES_ENTITY_EXIST(Local_111[12 /*33*/])){
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Janet", 0)){
Local_111[12 /*33*/]=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Janet", 0));
}}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("tao", 0)){
if(!PED::IS_PED_INJURED(Local_111[11 /*33*/])){
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[11 /*33*/], iLocal_116);
...
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[11 /*33*/], uVar0, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 1, 16, 1148846080, 0);
}}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Taos_Translator", 0)){
if(!PED::IS_PED_INJURED(Local_111[10 /*33*/])){
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_111[10 /*33*/], iLocal_116);
...
TASK::TASK_SYNCHRONIZED_SCENE(Local_111[10 /*33*/], uVar1, "misschinese2_crystalmaze", "2int_Loop_A_taotranslator", 1000f, -4f, 1, 16, 1148846080, 0);
}}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Trevor", 0)){
iLocal_142=PLAYER::GET_PLAYERS_LAST_VEHICLE();
if(func_74(iLocal_142) && func_73(iLocal_142, 1995.202f, 3062.156f, 46.0491f, 1) < 5f){
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_142, -1);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
VEHICLE::REMOVE_VEHICLE_ASSET(ENTITY::GET_ENTITY_MODEL(iLocal_142));
...
func_62(&uLocal_201, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
func_210(&Local_117, &uLocal_201, cLocal_129, 12f, 2482.197f, 4975.367f, 44.7288f, 121f, 1);
func_381(&Local_118, "ONEILGUARD4", 5, "ONEILGUARD1");
func_381(&Local_119, "ONEILGUARD4", 5, "ONEILGUARD1");
func_381(&Local_123, "CHI2_nope", 8, "ONEILGUARD1");
func_381(&Local_120, "SEETREVOR", 3, "chin2goon1");
func_381(&Local_121, "CHI2_hear", 8, "ONEILGUARD1");
func_381(&Local_122, "CHI2_hear", 8, "ONEILGUARD1");
func_381(&Local_124, "ONEILGUARD3", 5, "ONEILGUARD1");
func_381(&Local_125, "ONEILGUARD2", 5, "ONEILGUARD1");
func_381(&Local_126, "ONEILGUARD4", 5, "ONEILGUARD1");
func_381(&Local_127, "GOON2TREV", 4, "CHIN2goon2");
func_32(6, 1);
func_32(25, 1);
iLocal_142=VEHICLE::GET_LAST_DRIVEN_VEHICLE();
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("bodhi2"), 1);
PED::ADD_RELATIONSHIP_GROUP("TAOGROUP", &iLocal_116);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_116, joaat("player"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("player"), iLocal_116);
func_17(0, -1);
...
while (!func_371(&(Local_111[11 /*33*/]), 21, 1985.666f, 3052.661f, 46.2151f, 0, 1)){
wait(0);
}
...
PED::SET_PED_COMPONENT_VARIATION(Local_111[11 /*33*/], 9, 1, 0, 0);
break;
case 2:
if(bParam1){
func_370(1992.878f, 3057.846f, 46.0568f, 311f, 1, 0);
}else{
if(func_74(iLocal_142)){
ENTITY::SET_ENTITY_COORDS(iLocal_142, 1994.387f, 3061.94f, 46.0491f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_142, 50.7724f);
}
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(-7f, 1065353216);
...
case 3:
if(bParam1){
func_370(2574.049f, 4981.824f, 50.44f, 50f, 1, 0);
}else{
...
if(bParam1){
if((ENTITY::DOES_ENTITY_EXIST(iLocal_142) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_142, 0)) && func_279()){
func_283(iLocal_142, -1, 1);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_142, 0)){
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_142, 1, 1, 0);
if(VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iLocal_142))){
VEHICLE::SET_VEHICLE_FORWARD_SPEED(iLocal_142, 15f);
}
if(VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iLocal_142))){
VEHICLE::SET_HELI_BLADES_FULL_SPEED(iLocal_142);
ENTITY::SET_ENTITY_VELOCITY(iLocal_142, 1f, 1f, 1f);
}}}else{
func_283(0, -1, 1);
}}
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_282(), 2570.538f, 4982.031f, 50.6239f, 1) < 10f){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_277(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
}
break;
case 5:
STREAMING::SET_VEHICLE_POPULATION_BUDGET(1);
...
case 6:
if(bParam1){
func_370(2450.871f, 4960.999f, 44.3759f, 351f, 1, 0);
}else{
...
case 7:
if(bParam1){
func_370(2435.319f, 4966.153f, 41.3476f, 104.2964f, 1, 0);
}else{
...
iLocal_177=INTERIOR::GET_INTERIOR_AT_COORDS(2432.982f, 4964.823f, 41.3476f);
while (!INTERIOR::IS_VALID_INTERIOR(iLocal_177)){
iLocal_177=INTERIOR::GET_INTERIOR_AT_COORDS(2432.982f, 4964.823f, 41.3476f);
func_28(14, 1);
}
while (!INTERIOR::IS_INTERIOR_READY(iLocal_177)){
func_28(15, 1);
}
STREAMING::SET_INTERIOR_ACTIVE(iLocal_177, 1);
INTERIOR::UNPIN_INTERIOR(iLocal_177);
iLocal_177=0;
...
case 9:
if(bParam1){
func_370(2472.3f, 4948.181f, 44.0937f, 220f, 1, 0);
}else{
...
func_19(55, 1, 0, 1, 0);
uLocal_171=OBJECT::GET_RAYFIRE_MAP_OBJECT(2457.15f, 4968.79f, 48.677f, 45f, "DES_FarmHs");
while (!OBJECT::DOES_RAYFIRE_MAP_OBJECT_EXIST(uLocal_171)){
func_28(161, 1);
}
OBJECT::SET_STATE_OF_RAYFIRE_MAP_OBJECT(uLocal_171, 9);
...
func_31(6, 0);
if(bParam1){
func_370(2625.776f, 4802.217f, 32.5747f, 206f, 1, 0);
}else{
...
if(bParam2){
iLocal_142=func_363(1994.387f, 3061.94f, 46.0491f, 50f);
}else{
iLocal_142=func_363(0f, 0f, 0f, 0f);
}}}}elseif(func_362()){
func_360();
while (!func_359()){
func_28(544, 1);
}
iLocal_142=func_287(0f, 0f, 0f, 0f);
}
if(bParam1){
if(func_279()){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_142, 0)){
...
return func_288(&(Global_107357.f_2890), Param0, fParam1, 0);
}

int func_288(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
}elseif((!func_325(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
...
int func_292(int iParam0, var uParam1, var uParam2){
int iVar0;
int iVar1;
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam0, 0)){
return 0;
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_78(iParam0, 0, 0)) || func_78(iParam0, 1, 0)) || func_78(iParam0, 2, 0)) || func_313(iParam0) !=145) || func_312(iParam0)) || func_311(iParam0)) || func_310(iParam0)) || func_309(iParam0)) || !func_296(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_311(iParam0)){
}
if(func_311(iParam0)){
}
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_326(iParam0, uVar1[iVar3], 1) && func_237(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_168(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_291(iVar6))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_345(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_344()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_291(iVar7 + 1))){
...
var func__334(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
}elseif(func_341(*iParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
void func_356(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
int func_363(struct<3> Param0, float fParam1){
return func_288(&(Global_104373.f_2890), Param0, fParam1, 0);
}
...
int func_366(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
struct<3> Var1;
if(iParam0==0){
return 0;
...
void func_370(struct<3> Param0, float fParam1, int iParam2, int iParam3){
if(func_380()){
...
int func_371(var uParam0, int iParam1, struct<3> Param2, int iParam3, bool bParam4){
int iVar0;
if(!func_50(iParam1)){
...
*uParam0=PED::CREATE_PED(26, iVar0, Param2, iParam3, 0, 0);
...
if(!PED::IS_PED_INJURED(Local_111[iVar0 /*33*/])){
if(iParam0==3){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_111[iVar0 /*33*/]);
}}
...
PED::REMOVE_RELATIONSHIP_GROUP(Local_111[iVar0 /*33*/].f_24);
iVar0++;
}
if(iParam0 !=3){
func_375();
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_371)){
OBJECT::DELETE_OBJECT(&iLocal_371);
}
if(iParam0 !=0 && iParam0 !=2){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_168[iVar1])){
OBJECT::DELETE_OBJECT(&(iLocal_168[iVar1]));
}
iVar1++;
}
...
if(iParam0 !=0 && iParam0 !=2){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_142, 0)){
if(ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_142, 1)){
if(PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_179)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_179, 0);
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&iLocal_179);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_180)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_180, 0);
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&iLocal_180);
}}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_158)){
PED::DELETE_PED(&iLocal_158);
}
...
void func_381(var uParam0, char* sParam1, int iParam2, char* sParam3){
*uParam0=sParam3;
uParam0->f_1=sParam1;
uParam0->f_2=iParam2;
}
...
void func_382(){
PED::ADD_RELATIONSHIP_GROUP("MYFRIEND", &iLocal_113);
PED::ADD_RELATIONSHIP_GROUP("FOE", &iLocal_114);
PED::ADD_RELATIONSHIP_GROUP("IGNORE", &iLocal_115);
PED::ADD_RELATIONSHIP_GROUP("BARpeds", &iLocal_152);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, iLocal_152, joaat("player"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID()), iLocal_114);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_114, PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID()));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_113, iLocal_115);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_114, iLocal_115);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_115, PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID()));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_115, iLocal_114);
}
...
iVar4=func_453(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
if(iVar4 !=-1){
...
iVar6=func_451(&(Global_100833.f_3));
if(iVar6 > -1){
...
void func_386(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5){
int iVar0;
int iVar1;
*uParam0=func_48();
...
var func__397(int iParam0, var uParam1){
return unk_0xD69CE161FE614531(0, iParam0, func_398(uParam1));
}
...
var uVar0;
var uVar1;
uVar0=func_400(iParam0, iParam1);
...
var func__400(int iParam0, var uParam1){
return unk_0xD69CE161FE614531(2, uParam0, func_398(uParam1));
}
...
iVar5=0;
while (iVar5 < iVar6){
if((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_407(Var7.f_1)) && iVar9 < 51){
...
}elseif(func_413(*uParam0, "v_hospital", 307.3065f, -589.9595f, 43.302f)){
*uParam0={
...
int func_413(struct<3> Param0, char* sParam1, struct<3> Param2){
int iVar0;
int iVar1;
...
if(func_34()){
*uParam0=func_420(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
if(func_25()==0){
return MISC::IS_BIT_SET(func_396(func_418(iParam0), -1), iParam1);
}}else{
...
int func_420(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_421(iVar0, 0), 1);
...
Vector3 func__421(int iParam0, bool bParam1){
switch (iParam0){
case -1:
return 0f, 0f, 0f;
break;
...
return func_427(2, 2);
}elseif(func_426(Global_1853823)){
...
Vector3 func__424(struct<3> Param0){
...
Var3={
func_429(Var3, -Var0.f_3.f_2) 
};
Var3={
func_429(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__429(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
return (shift_right(iParam0, 26) & 31 * func_446(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_453(char* sParam0, int iParam1){
int iVar0;
char* sVar1;
int iVar2;
int iVar3;
...
break;
case 5:
func_455(uParam1, "Barry3A", func_457(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_456(iParam0), 0, 1);
break;
case 6:
...
break;
case 8:
func_455(uParam1, "Dreyfuss1", func_457(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_456(iParam0), 0, 0);
break;
case 9:
...
break;
case 38:
func_455(uParam1, "Nigel1A", func_457(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_456(iParam0), 1, 1);
break;
case 39:
...
break;
case 49:
func_455(uParam1, "Paparazzo3A", func_457(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_456(iParam0), 0, 1);
break;
case 50:
...
break;
case 58:
func_455(uParam1, "Tonya1", func_457(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_456(iParam0), 0, 1);
break;
case 59:
...
void func_455(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21){
uParam0->f_4=iParam4;
*uParam0=sParam1;
uParam0->f_1={
Param2 
