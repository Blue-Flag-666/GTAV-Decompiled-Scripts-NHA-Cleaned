...
HUD::SET_TEXT_RENDER_ID(uLocal_51);
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_49, 0.2f, 0.34f, 0.410001f, 0.69f, 100, 100, 100, 255, 0);
HUD::SET_TEXT_RENDER_ID(uLocal_52);
if(bLocal_53){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_50, "SET_TEXT");
func_3("KEYNOTE_NAME");
func_3("KEYNOTE_TITLE");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_50, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
}}else{
return 1;
}
break;
...
while (bVar1 <=(16 - 1)){
if(Local_20[bVar1] !=-1){
if((!MISC::IS_BIT_SET(uLocal_37, bVar1) && iVar0 >=Local_20[bVar1]) && iVar0 < Local_20.f_17[bVar1]){
func_5();
MISC::SET_BIT(&uLocal_37, bVar1);
}}
bVar1++;
}}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_14(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
uLocal_51=HUD::GET_NAMED_RENDERTARGET_RENDER_ID("Big_Disp");
uLocal_52=HUD::GET_DEFAULT_SCRIPT_RENDERTARGET_RENDER_ID();
...
struct<3> Var0;
func_29(uParam0);
MISC::CLEAR_BIT(&uLocal_41, iParam1);
switch (iParam1){
case 0:
Var0={
0f, 0f, (func_28(-4.29f) + 180f) 
};
...
GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_49);
