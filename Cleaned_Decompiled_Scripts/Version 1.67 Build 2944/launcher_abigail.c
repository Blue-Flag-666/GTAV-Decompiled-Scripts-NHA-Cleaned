...
iVar3[0]=0;
iVar3[1]=1;
if(!func_282(&iVar3, &Var0, Var1, 1f)){
func_281();
...
func_223(Var0.f_0);
func_216(&iLocal_54, &(Var0.f_9), Var1);
switch (Var0.f_0){
case 0:
func_203(&Var2, &(Var0.f_28[0]), "SONAR_PRE");
break;
case 1:
func_198(&Var0, Var1, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
break;
}
if(func_183(&Var0, 0)){
...
func_303("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_187(uParam0->f_27)){
func_186(uParam0->f_27, *uParam0);
func_303("RC5_IN_ACTIVATION_RANGE:
...
if(func_187(1)){
func_186(1, *uParam0);
func_303("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_303("RC_STOP_PLAYER_VEHICLE_CHECK:
...
int func_198(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7){
var uVar0;
if((((func_136(PLAYER::PLAYER_PED_ID()) && func_136(uParam0->f_28[0])) && !func_156()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_202(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7){
uVar0=16;
...
void func_203(int iParam0, var uParam1, char* sParam2){
...
TASK::TASK_PLAY_ANIM(*uParam1, cLocal_53, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
*iParam0=1;
break;
case 1:
if(MISC::GET_GAME_TIMER() > iParam0->f_166){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_50, Local_51, 8f, 0, 1, 0)){
TASK::TASK_PLAY_ANIM(*uParam1, cLocal_53, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
*iParam0=3;
}elseif(func_215(PLAYER::PLAYER_PED_ID(), *uParam1, 1) < 15f){
*iParam0=4;
}}
if(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_53, "outro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_53, "outro") > 0.99f){
TASK::TASK_PLAY_ANIM(*uParam1, cLocal_53, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
}
break;
case 3:
if(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_53, "intro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_53, "intro") > 0.99f){
*iParam0=4;
}
break;
case 4:
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_50, Local_51, 8f, 0, 1, 0)){
TASK::TASK_PLAY_ANIM(*uParam1, cLocal_53, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
}
*iParam0=5;
}
break;
case 5:
if(!func_156()){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_53, "loop_talk", 3)){
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_53, "loop_talk") > 0.99f){
iParam0->f_166=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(7000, 10000));
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_50, Local_51, 8f, 0, 1, 0)){
TASK::TASK_PLAY_ANIM(*uParam1, cLocal_53, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
*iParam0=1;
}else{
TASK::TASK_PLAY_ANIM(*uParam1, cLocal_53, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
*iParam0=2;
}
}}else{
iParam0->f_166=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(7000, 10000));
...
break;
case 2:
if(ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_53, "loop_look", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_53, "loop_look") > 0.99f){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_50, Local_51, 8f, 0, 1, 0)){
if(MISC::GET_GAME_TIMER() > iParam0->f_166){
*iParam0=4;
}}else{
...
var func__209(int iParam0, int iParam1){
...
struct<27> Var0;
if(Global_78689){
func_303("IS_RC_FINE_AND_IN_RANGE():
...
STREAMING::REQUEST_ANIM_DICT(cLocal_53);
func_270(&(uParam0->f_48), cLocal_53, "base", 0);
iLocal_49=1;
break;
case 1:
if(!func_269(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_53)){
return 0;
}
iLocal_49=2;
break;
...
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0])){
func_264(&(uParam0->f_35[0]), iVar0[1], -1584.013f, 5158.539f, 18.6057f, 210.5309f);
...
int func_266(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_267(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
int func_267(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_36(iParam1)){
...
break;
case 1:
if(!STREAMING::HAS_MODEL_LOADED(iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_53)){
return 0;
}
iLocal_49=2;
break;
