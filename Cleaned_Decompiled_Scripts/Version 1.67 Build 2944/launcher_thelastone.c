...
func_208(Var0.f_0);
func_201(&iLocal_51, &uLocal_52, &(Var0.f_9), Var1, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
func_194(&Var0, Var1, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
if(func_179(&Var0, 0)){
if(!func_2(&Var0)){
func_265(&Var0, 1);
}
...
func_279("ARE_RC_TRIGGER_CONDITIONS_MET:
...
if(func_183(uParam0->f_27)){
func_182(uParam0->f_27, *uParam0);
func_279("RC5_IN_ACTIVATION_RANGE:
...
if(func_183(1)){
func_182(1, *uParam0);
func_279("RC_IN_ACTIVATION_RANGE:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
func_279("RC_STOP_PLAYER_VEHICLE_CHECK:
...
int func_194(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6){
var uVar0;
if(func_185(2)){
if(!func_156()){
if(((func_136(PLAYER::PLAYER_PED_ID()) && func_136(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam6) && func_200(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f){
uVar0=16;
func_199(&uVar0, iParam4, uParam0->f_28[0], sParam5, 0, 1);
func_197(&uVar0, cParam2, sParam3, 7, 0, 0);
uParam0->f_60=MISC::GET_GAME_TIMER();
return 1;
}}elseif(func_195(sParam3)){
...
void func_201(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5){
float fVar0;
float fVar1;
float fVar2;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
...
fVar0=func_200(PLAYER::PLAYER_PED_ID(), Param4, 1);
fVar1=func_200(PLAYER::PLAYER_PED_ID(), Param5, 1);
fVar2=(fVar0 - fVar1);
if(fVar2 < 0f){
fVar2=(fVar2 * -1f);
}
...
struct<27> Var0;
if(Global_78689){
func_279("IS_RC_FINE_AND_IN_RANGE():
...
case 2:
bVar2=true;
uParam0->f_28[0]=PED::CREATE_PED(25, iLocal_50, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
