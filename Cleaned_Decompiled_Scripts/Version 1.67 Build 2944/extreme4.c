...
func_323();
if(!func_340()){
if((func_322(Local_78.f_28[0]) && func_322(PLAYER::PLAYER_PED_ID())) && !func_321(PLAYER::PLAYER_PED_ID(), Local_78.f_28[0], 4f, 1)){
iLocal_303=1;
}}
while (true){
wait(0);
RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("SF_UR", 0);
func_304(Local_78.f_9, 0, 0, 0, 0, 0);
if(iLocal_82 !=4 && iLocal_82 !=0){
func_303();
}
if(iLocal_82 < 3 && iLocal_303){
if(func_322(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, 1, 0)){
if(func_322(Local_89.f_0)){
if(func_321(PLAYER::PLAYER_PED_ID(), Local_89.f_0, 10f, 1)){
func_302();
}}}}
switch (iLocal_82){
case 0:
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_100, 0)){
if(func_321(PLAYER::PLAYER_PED_ID(), iLocal_100, 1f, 1)){
...
if(func_232(Local_89.f_0)){
if(timera() > 5000){
if((MISC::GET_GAME_TIMER() > iLocal_290 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0)){
iLocal_83=2;
}}}elseif((MISC::GET_GAME_TIMER() > iLocal_290 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0)){
iLocal_83=2;
}}
...
if(!CAM::DOES_CAM_EXIST(uLocal_272)){}
...
while (MISC::GET_GAME_TIMER() < iLocal_294 + 11000 && !CAM::IS_SCREEN_FADED_OUT()){
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_291) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_292)){
if(func_247(400)){
bLocal_301=true;
}}
if(bLocal_301){
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_291)==1f){
if(func_322(Local_89.f_0)){
...
TASK::TASK_SYNCHRONIZED_SCENE(Local_89.f_0, uLocal_292, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_292, 0);
CAM::SET_CAM_ACTIVE(uLocal_284, 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_284, uLocal_292, "Base_Jump_Spot_02_CAM", "rcmextreme4");
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_89.f_0, 0, 0);
CAM::DESTROY_CAM(uLocal_283, 0);
iLocal_299=1;
}}}}elseif(!iLocal_300){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_292) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_292) >=0.2f){
...
TASK::TASK_SYNCHRONIZED_SCENE(Local_89.f_0, uLocal_293, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_293, 1);
CAM::SET_CAM_ACTIVE(uLocal_285, 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_285, uLocal_293, "Fall_and_impact_CAM", "rcmextreme4");
AUDIO::PLAY_SYNCHRONIZED_AUDIO_EVENT(uLocal_293);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_89.f_0, 0, 0);
CAM::DESTROY_CAM(uLocal_284, 0);
iLocal_300=1;
}}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_293) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_293) >=0.323f){
if(!iLocal_296){
...
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_293) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_293) >=0.44f){
uLocal_102=GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
GRAPHICS::SET_PARTICLE_FX_LOOPED_ALPHA(uLocal_102, 1f);
iLocal_302=1;
}}}
if(MISC::GET_GAME_TIMER() > iLocal_294 + 600 && fVar1==1f){
if(!iLocal_297){
iLocal_297=1;
}}
fVar2=(1f / 30f);
fVar3=(MISC::GET_FRAME_TIME() / fVar2);
if(MISC::GET_GAME_TIMER() > iLocal_294 + 630){
...
if(MISC::GET_GAME_TIMER() > iLocal_294 + 563){
if(iVar0==1){
func_3(&uLocal_97);
if(func_322(Local_89.f_0)){
}
...
if(MISC::GET_GAME_TIMER() > iLocal_294 + 871){
if(iVar0==2){
if(func_322(Local_89.f_0)){
}
iVar0=3;
}}
if(MISC::GET_GAME_TIMER() > iLocal_294 + 2000){
if(iVar0==3){
if(func_322(Local_89.f_0)){
}
iVar0=4;
}}
if(MISC::GET_GAME_TIMER() > iLocal_294 + 3500){
if(iVar0==4){
iVar0=5;
}}
if(MISC::GET_GAME_TIMER() > iLocal_294 + 10000){
if(iVar0 !=7){
CAM::DESTROY_CAM(uLocal_285, 0);
uLocal_282=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
CAM::SET_CAM_PARAMS(uLocal_282, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
CAM::SET_CAM_ACTIVE(uLocal_282, 1);
iVar0=7;
}}}
if(bLocal_301){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_293)){
AUDIO::STOP_SYNCHRONIZED_AUDIO_EVENT(uLocal_293);
}
...
if(func_322(Local_89.f_0)){
if(iVar0 < 3){
ENTITY::SET_ENTITY_HEALTH(Local_89.f_0, 101, 0);
Var4={
ENTITY::GET_ENTITY_COORDS(Local_89.f_0, 1) 
};
if(Var4.f_2 > 155f){
fVar5=155f;
}else{
...
ENTITY::SET_ENTITY_COORDS(Local_89.f_0, 1657.046f, -17.4571f, fVar5, 1, 0, 0, 1);
}}
...
if(func_232(Local_89.f_0)){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_293)){
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_293, 1f);
}
TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_89.f_0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_89.f_0, 0, 0);
ENTITY::SET_ENTITY_COORDS(Local_89.f_0, 1655.77f, -20.04f, 135.8f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEALTH(Local_89.f_0, 0, 0);
}
func_234(&uLocal_104, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_241(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
AUDIO::STOP_SOUND(uLocal_287);
if(CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY()){
CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION("Dom", 8, 2, 0, 0);
}
if(!func_271()){
if(func_265(1, 20f, 1)){
if((!iLocal_303 || MISC::GET_GAME_TIMER() > iLocal_304 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, 1, 0)){
RECORDING::REPLAY_START_EVENT(1);
CUTSCENE::START_CUTSCENE(2048);
if(func_322(Local_89.f_0)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_89.f_0, "Dom", 0, joaat("cs_dom"), 0);
}
wait(0);
iLocal_303=0;
...
if(func_322(Local_89.f_0)){
ENTITY::FREEZE_ENTITY_POSITION(Local_89.f_0, 0);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_101) && !ENTITY::IS_ENTITY_DEAD(iLocal_101, 0)){
ENTITY::SET_ENTITY_VISIBLE(iLocal_101, 0, 0);
}
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
iLocal_94=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
iLocal_103=ENTITY::GET_ENTITY_MODEL(iLocal_94);
if(VEHICLE::IS_THIS_MODEL_A_CAR(iLocal_103)==1 || VEHICLE::IS_THIS_MODEL_A_BIKE(iLocal_103)==1){
Local_270={
...
uLocal_286=PED::ADD_SCENARIO_BLOCKING_AREA(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
iLocal_83=1;
}}}
break;
case 1:
...
uLocal_283=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
}
CAM::SET_CAM_ACTIVE(uLocal_283, 1);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
uLocal_291=PED::CREATE_SYNCHRONIZED_SCENE(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_89.f_0, uLocal_291, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_291, 1);
CAM::SET_CAM_ACTIVE(uLocal_283, 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_283, uLocal_291, "Base_Jump_Spot_CAM", "rcmextreme4");
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_89.f_0, 0, 0);
iLocal_88=1;
}
...
Vector3 func__263(struct<3> Param0){
float fVar0;
float fVar1;
fVar0=vmag(Param0);
if(fVar0 !=0f){
...
switch (iLocal_83){
case 0:
if(func_322(Local_78.f_28[0])){
PED::SET_PED_COMBAT_ATTRIBUTES(Local_78.f_28[0], 17, 1);
}
iLocal_288=0;
iLocal_303=1;
func_283("EXT4_01", 7500, 1);
uLocal_92=func_282(Local_89.f_0, 1, 1, 5);
settimera(0);
iLocal_83=1;
break;
case 1:
...
if(func_322(PLAYER::PLAYER_PED_ID())){
if(func_322(Local_89.f_0)){
if(func_321(PLAYER::PLAYER_PED_ID(), Local_89.f_0, 100f, 1)){
CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("es_4_rcm_p2_concat", 6, 8);
if(CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY()){
CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION("Dom", 8, 2, 0, 0);
}}
if(PED::IS_PED_RAGDOLL(Local_89.f_0)){
ENTITY::SET_ENTITY_HEALTH(Local_89.f_0, 0, 0);
}
if(func_321(PLAYER::PLAYER_PED_ID(), Local_89.f_0, 32f, 1)){
if(func_276(Local_89.f_0, 1, 0, 0, 0)){
if(iLocal_91==0){
if(!func_271()){
func_275(&uLocal_104, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_1", 7, 0, 0);
iLocal_91=1;
}}elseif(iLocal_91==1){
if(!func_271()){
func_275(&uLocal_104, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_2", 7, 0, 0);
iLocal_91=2;
}}
}
else{
if(!iLocal_298){
if(func_321(PLAYER::PLAYER_PED_ID(), Local_89.f_0, 30f, 1) && !func_271()){
if(func_215(&uLocal_104, "EXT4AUD", "EXT4_COMM", 7, 0, 0, 0)){
iLocal_298=1;
}}}
func_274();
if(!PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), Local_89.f_0)){
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_89.f_0, -1, 0, 2);
}
}}
...
void func_273(){
if(func_322(Local_89.f_0)){
if(TASK::GET_SCRIPT_TASK_STATUS(Local_89.f_0, joaat("script_task_perform_sequence")) !=1){
TASK::TASK_PERFORM_SEQUENCE(Local_89.f_0, uLocal_93);
}}}
...
if(!func_271()){
if(iLocal_288 < 5){
if(MISC::GET_GAME_TIMER() > (iLocal_289 + (8000 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000)))){
if(AUDIO::HAS_SOUND_FINISHED(uLocal_287)){
...
if(AUDIO::HAS_SOUND_FINISHED(uLocal_287)){
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_287, "DOM", Local_89.f_0, "EXTREME_04_SOUNDSET", 0, 0);
}}}}
...
int func_279(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
func_263(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var1={
func_263(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
func_290(Local_78.f_28[0], 1737.453f, 101.7498f, 170.0243f, 288.5211f, 0, 1);
}else{
func_287(&(Local_78.f_28[0]), 1737.453f, 101.7498f, 170.0243f, 288.5211f);
}
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_78.f_28[0], 1826.662f, 146.9161f, 170.4472f, 1f, -1, 0.25f, 0, 40000f);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 0);
MISC::CLEAR_AREA_OF_VEHICLES(Local_89.f_1, 20f, 0, 0, 0, 0, 0, 0, 0);
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_95)){
iLocal_95=VEHICLE::CREATE_VEHICLE(joaat("sanchez"), 1662.88f, -14.255f, 172.7742f, 205.3516f, 1, 1, 0);
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_96)){
iLocal_96=VEHICLE::CREATE_VEHICLE(joaat("bmx"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, 1, 1, 0);
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_98)){
iLocal_98=OBJECT::CREATE_OBJECT(joaat("prop_box_wood01a"), 1666.282f, -11.20408f, 172.7773f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_98, 0.000637f, -0.000136f, 10.66059f, 2, 1);
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_99)){
iLocal_99=OBJECT::CREATE_OBJECT(joaat("prop_box_wood01a"), 1667.076f, -12.07778f, 173.2611f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_99, 90.03932f, -0.257438f, -13.86142f, 2, 1);
}
if(func_322(Local_89.f_0)){
if(TASK::GET_SCRIPT_TASK_STATUS(Local_89.f_0, joaat("script_task_perform_sequence")) !=1){
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_93, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_93);
TASK::TASK_PERFORM_SEQUENCE(Local_89.f_0, uLocal_93);
}}
if(func_322(Local_89.f_0)){
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_89.f_0, 0);
func_234(&uLocal_104, 4, Local_89.f_0, "DOM", 0, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_89.f_0, PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID()));
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_101)){
iLocal_101=OBJECT::CREATE_AMBIENT_PICKUP(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, -1, joaat("p_parachute_s"), 1, 1);
}
ENTITY::SET_ENTITY_ROTATION(iLocal_101, -111.8225f, -0.454914f, -162.2231f, 2, 1);
ENTITY::PLAY_ENTITY_ANIM(iLocal_101, "Chute_Off_Bag", "skydive@parachute@", 4f, 0, 1, 0, 0.99f, 0);
func_251(1);
}


void func_287(var uParam0, struct<3> Param1, float fParam2){
func_288(uParam0, iLocal_77, Param1, fParam2, 26);
...
void func_288(var uParam0, int iParam1, struct<3> Param2, var uParam3, int iParam4){
func_289(uParam0);
...
int func_290(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_232(iParam0)){
...
if(!iLocal_303 || MISC::GET_GAME_TIMER() > iLocal_304 + 3500){
func_297();
RECORDING::REPLAY_START_EVENT(1);
CUTSCENE::START_CUTSCENE(0);
if(func_232(Local_78.f_28[0])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_78.f_28[0], "Hudson", 0, joaat("a_c_retriever"), 0);
}
wait(0);
CAM::STOP_GAMEPLAY_HINT(0);
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if((!PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_BOAT(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID())){
if(!func_269(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
if(!func_268(PLAYER::PLAYER_PED_ID(), joaat("script_task_leave_any_vehicle"))){
...
fVar3=-0.85f;
fVar4=0f;
if(((!func_340() && func_322(Local_78.f_28[0])) && func_322(PLAYER::PLAYER_PED_ID())) && iLocal_303==1){
if(!CAM::IS_GAMEPLAY_HINT_ACTIVE()){
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_78.f_28[0], -1, 0, 2);
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(PLAYER::PLAYER_PED_ID(), Local_78.f_28[0], 0f, 0f, 0f, 1f, -1, 0.5f, 1);
CAM::SET_GAMEPLAY_HINT_CAMERA_BLEND_TO_FOLLOW_PED_MEDIUM_VIEW_MODE(1);
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_78.f_28[0], -0.5f, 0f, -0.2f, 1, 30000, 2000, 2000, 0);
...
if(func_321(PLAYER::PLAYER_PED_ID(), Local_78.f_28[0], 4f, 1)){
...
CAM::SET_GAMEPLAY_HINT_CAMERA_BLEND_TO_FOLLOW_PED_MEDIUM_VIEW_MODE(1);
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_89.f_0, 0f, 0f, 0f, 1, 30000, 2000, 2000, 0);
CAM::SET_GAMEPLAY_HINT_FOV(fVar0);
CAM::SET_GAMEPLAY_HINT_FOLLOW_DISTANCE_SCALAR(fVar1);
CAM::SET_GAMEPLAY_HINT_BASE_ORBIT_PITCH_OFFSET(fVar2);
CAM::SET_GAMEPLAY_HINT_CAMERA_RELATIVE_SIDE_OFFSET(fVar3);
...
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_89.f_0, 1), 1);
if(iLocal_87==0){
if(fVar0 > 160f){
iLocal_87=1;
}}elseif(fVar0 > 200f){
...
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_92)){
HUD::SET_BLIP_FLASHES(uLocal_92, 0);
}}
...
void func_304(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_306(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
break;
default:
StringCopy(&Var0, func_307(iVar1), 8);
break;
}
break;
default:
...
iLocal_97=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_97, 90f, 0f, -63f, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_97, 1);
ENTITY::SET_ENTITY_VISIBLE(iLocal_97, 0, 0);
}
func_327(1);
if(!ENTITY::DOES_ENTITY_EXIST(Local_89.f_0)){
func_324(&Local_89, 52, Local_89.f_1, Local_89.f_4, "Ext4-Dom", 1);
ENTITY::FREEZE_ENTITY_POSITION(Local_89.f_0, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_89.f_0, 1);
WEAPON::REMOVE_ALL_PED_WEAPONS(Local_89.f_0, 1);
PED::SET_PED_COMPONENT_VARIATION(Local_89.f_0, 8, 2, 0, 0);
AUDIO::DISABLE_PED_PAIN_AUDIO(Local_89.f_0, 1);
PED::SET_PED_CONFIG_FLAG(Local_89.f_0, 137, 1);
PED::SET_PED_CONFIG_FLAG(Local_89.f_0, 118, 0);
PED::SET_PED_CONFIG_FLAG(Local_89.f_0, 208, 1);
PED::SET_PED_MONEY(Local_89.f_0, 5000);
}
if(func_232(PLAYER::PLAYER_PED_ID())){
func_234(&uLocal_104, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}
...
int func_324(var uParam0, int iParam1, struct<3> Param2, var uParam3, char* sParam4, int iParam5){
if(func_325(uParam0, iParam1, Param2, uParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
STREAMING::REQUEST_MODEL(Local_89.f_5);
...
if(iParam0==1){
while ((((!STREAMING::HAS_MODEL_LOADED(Local_89.f_5) || !STREAMING::HAS_MODEL_LOADED(joaat("sanchez"))) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmextreme4")) || !STREAMING::HAS_ANIM_DICT_LOADED("skydive@parachute@")) || !STREAMING::HAS_PTFX_ASSET_LOADED()){
wait(0);
}}}
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_286, 0);
AUDIO::RELEASE_SCRIPT_AUDIO_BANK();
func_353(&iLocal_98, 0);
func_353(&iLocal_99, 0);
func_353(&iLocal_100, 0);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_BICYCLE_MOUNTAIN", 1);
func_342(&Local_78, 1, 0, 0);
...
void func_354(){
func_342(&Local_78, 1, 0, 0);
func_352(&(Local_78.f_28[0]), 1, 0, 1);
