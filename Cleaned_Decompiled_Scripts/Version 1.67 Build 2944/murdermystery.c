...
func_83(ScriptParam_77.f_1[0 /*3*/]);
while (true){
func_82();
if(func_77()){
func_1();
...
case 2:
case 3:
if(!func_76(iLocal_69)){
if(((func_73() && !func_72()) && func_71()) && !func_70(0)){
if(iLocal_71 !=0){
if(GRAPHICS::IS_TRACKED_POINT_VISIBLE(iLocal_71)){
func_68(iLocal_69, 1, 0);
}}}}
break;
case 4:
if(func_67(uLocal_64)){
PED::SET_PED_CAPSULE(uLocal_64, 0.75f);
}
if(!func_76(4)){
...
if(((!func_76(5) && iLocal_59==4) && func_71()) && !func_70(0)){
func_68(5, 1, 0);
}
break;
case 6:
...
ENTITY::CREATE_MODEL_HIDE(Local_56, 200f, joaat("prop_mineshaft_door"), 0);
func_33(2, 1);
}}
if(func_73() && !func_72()){
...
if(bParam1){
MISC::SET_BIT(&uLocal_76, iParam0);
}else{
MISC::CLEAR_BIT(&uLocal_76, iParam0);
}}


bool func_34(int iParam0){
return MISC::IS_BIT_SET(uLocal_76, iParam0);
}
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_49, Local_55, 1, 1, 0)){
if(func_62()){
iLocal_58=2;
func_61(0, 800);
}}}
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_50, Local_55, 1, 1, 0)){
func_54(0);
iLocal_58=3;
func_61(0, 800);
}
...
STREAMING::NEW_LOAD_SCENE_START_SPHERE(Local_53, 20f, 0);
func_39(24, &iLocal_57);
INTERIOR::PIN_INTERIOR_IN_MEMORY(iLocal_57);
iLocal_70=(MISC::GET_GAME_TIMER() + 40000);
while ((!STREAMING::IS_NEW_LOAD_SCENE_LOADED() || !INTERIOR::IS_INTERIOR_READY(iLocal_57)) && iLocal_70 > MISC::GET_GAME_TIMER()){
wait(0);
}
STREAMING::NEW_LOAD_SCENE_STOP();
if(iLocal_70 <=MISC::GET_GAME_TIMER()){
INTERIOR::UNPIN_INTERIOR(iLocal_57);
func_44(PLAYER::PLAYER_PED_ID(), Local_51, fLocal_52);
func_61(1, 800);
iLocal_58=0;
}else{
func_61(1, 800);
...
func_51(0);
HUD::DISPLAY_RADAR(0);
if(!func_50(sLocal_75)){
func_53(sLocal_75);
}
if(PAD::IS_CONTROL_JUST_PRESSED(2, 51)){
if(CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(0)==4){
iLocal_70=MISC::GET_GAME_TIMER() + 300;
...
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 && iLocal_58==0){
return 0;
}
if(func_70(0)){
return 0;
...
if(!bParam2){
AUDIO::PLAY_SOUND_FRONTEND(uLocal_67, sLocal_65, sLocal_66, 0);
}
func_69();
}else{
...
bool func_73(){
return vdist2(func_75(iLocal_69), Local_68) < func_74(iLocal_69);
}
...
return MISC::IS_BIT_SET(Global_113810.f_10052.f_133, iParam0);
}
...
case 2:
case 3:
return (!func_76(iLocal_69) && func_79());
case 4:
return func_79();
case 5:
return ((((func_22(iLocal_69) && func_79()) || iLocal_58==1) || iLocal_58==3) || iLocal_58==2);
case 6:
return (func_79() || (func_34(2) && func_78(Local_56)));
default:
}
return 0;
}
...
bool func_79(){
return vdist2(func_81(iLocal_69), Local_68) < func_80(iLocal_69);
}
...
case 2:
case 3:
func_87(&iLocal_71, func_75(iLocal_69), 0.2f);
break;
case 4:
func_86(joaat("u_f_m_drowned_01"));
func_85(sLocal_72);
uLocal_64=PED::CREATE_PED(26, joaat("u_f_m_drowned_01"), func_75(4), 184.5548f, 1, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("u_f_m_drowned_01"));
TASK::TASK_PLAY_ANIM(uLocal_64, sLocal_72, sLocal_73, 1000f, -1000f, -1, 9, 0, 0, 0, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_64, 1);
PED::SET_PED_KEEP_TASK(uLocal_64, 1);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_64, 1);
AUDIO::STOP_PED_SPEAKING(uLocal_64, 1);
AUDIO::DISABLE_PED_PAIN_AUDIO(uLocal_64, 1);
PED::SET_PED_CONFIG_FLAG(uLocal_64, 118, 0);
PED::SET_PED_CONFIG_FLAG(uLocal_64, 208, 1);
ENTITY::SET_ENTITY_INVINCIBLE(uLocal_64, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_64, joaat("player"));
break;
case 5:
iLocal_61=731806707;
OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_61, joaat("v_ilev_sol_off_door01"), -1002.147f, -478.064f, 50.117f, 1, 1, 0);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iLocal_61, 1, 1, 0);
uLocal_60=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1008.056f, -476.7573f, 50.2493f, -89.5003f, 0f, 38.7952f, 50f, 0, 2);
break;
case 6:
func_86(joaat("u_m_o_filmnoir"));
uLocal_62=PED::CREATE_PED(26, joaat("u_m_o_filmnoir"), func_75(6), 22.9631f, 1, 1);
PED::SET_PED_PROP_INDEX(uLocal_62, 0, 0, 0, 0, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("u_m_o_filmnoir"));
AUDIO::STOP_PED_SPEAKING(uLocal_62, 1);
AUDIO::DISABLE_PED_PAIN_AUDIO(uLocal_62, 1);
PED::EXPLODE_PED_HEAD(uLocal_62, joaat("weapon_sniperrifle"));
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_62, joaat("player"));
uLocal_63=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_vintage_filmcan"), -543.71f, 1986.2f, 126.05f, 1, 1, 0);
break;
}}
...
case 2:
case 3:
GRAPHICS::DESTROY_TRACKED_POINT(iLocal_71);
iLocal_71=0;
break;
case 4:
...
break;
case 5:
if(OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(iLocal_61)){
OBJECT::REMOVE_DOOR_FROM_SYSTEM(iLocal_61, 0);
}
if(CAM::DOES_CAM_EXIST(uLocal_60)){
...
if(func_50(sLocal_74) || func_50(sLocal_75)){
HUD::CLEAR_HELP(1);
}
break;
case 6:
...
if(func_34(2)){
ENTITY::REMOVE_MODEL_HIDE(Local_56, 200f, joaat("prop_mineshaft_door"), 0);
}
break;
}}