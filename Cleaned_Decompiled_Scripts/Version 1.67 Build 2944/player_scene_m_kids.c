...
if(ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0, &sLocal_248, &(Local_297[iParam1 /*16*/]), 2)){
...
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98143)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_238[iParam1], 0)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_238[iParam1], &sLocal_248, &(Local_243[iParam1 /*16*/]), 2)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_98143) > 0.817f){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_238[iParam1], -8f, 1);
Var6={
...
Var6.f_0=-824.333f;
fVar7=140.49f;
ENTITY::SET_ENTITY_COORDS(iLocal_238[iParam1], Var6, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_238[iParam1], fVar7);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_238[iParam1], 1084227584);
}}
}
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_98143) > fLocal_312){
...
uLocal_311=PED::CREATE_SYNCHRONIZED_SCENE(Var0 + Var12, 0f, 0f, (fVar1 + fVar13), 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_311, 1);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_311, 0);
}
TASK::TASK_SYNCHRONIZED_SCENE(uParam0, uLocal_311, &sVar8, &cVar9, 1000f, -8f, 0, 0, 1000f, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_311, 1);
iLocal_234[iParam1]=1;
}
break;
case 1:
if(iLocal_236[iParam1] !=Global_95819[iLocal_235[iParam1]]){
if(!ENTITY::DOES_ENTITY_EXIST(Global_100554)){
Global_95819[iLocal_235[iParam1]]=140;
Global_95835=iLocal_236[iParam1];
Global_100554=uParam0;
return;
}
if(ENTITY::DOES_ENTITY_EXIST(Global_100554)){
}}else{
...
if(!func_34()){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98143)){
if(MISC::IS_STRING_NULL_OR_EMPTY(&Local_298)){
}elseif(!iLocal_302){
...
int iVar0;
int iVar1;
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_298) && !iLocal_302){
if(func_11(&uLocal_66, "PRSAUD", &Local_298, 3, 0, 0, 0, 0)){
iLocal_302=1;
}}
if(!func_34()){
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_238[iVar0], 0)){
if(PED::IS_PED_SITTING_IN_VEHICLE(iLocal_232[iVar0], iLocal_238[iVar0])){
ENTITY::SET_ENTITY_COORDS(iLocal_232[iVar0], ENTITY::GET_ENTITY_COORDS(iLocal_232[iVar0], 1), 1, 0, 0, 1);
}}
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_232[iVar0], Global_98143, &sLocal_248, &(Local_297[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
iLocal_234[iVar0]=0;
}else{
iLocal_234[iVar0]=-1;
}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_238[iVar0], 0)){
if(VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_238[iVar0])){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_238[iVar0]);
}
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_238[iVar0], Global_98143, &(Local_243[iVar0 /*16*/]), &sLocal_248, 8f, 1090519040, 0, 1148846080);
}
iVar0++;
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_298) && iLocal_302){
...
while (iVar0 < iLocal_232){
if(!PED::IS_PED_INJURED(iLocal_232[iVar0])){
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_232[iVar0], Global_98142, &sLocal_248, &(Local_296[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_238[iVar0], 0)){
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_242[iVar0 /*16*/]))){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_238[iVar0], Global_98142, &(Local_242[iVar0 /*16*/]), &sLocal_248, 8f, 1090519040, 0, 1148846080);
}else{
if(!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_238[iVar0])){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(iLocal_238[iVar0], iLocal_307[iVar0], &Local_304, 1);
}
VEHICLE::SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(iLocal_238[iVar0], (fLocal_309 - VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_238[iVar0])));
VEHICLE::SET_PLAYBACK_SPEED(iLocal_238[iVar0], uLocal_310);
}}
iVar0++;
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_298)){
func_37(&uLocal_66, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
if(iLocal_65==156){
func_37(&uLocal_66, 3, Global_100554, "JIMMY", 0, 1);
func_37(&uLocal_66, 5, iLocal_232[0], "AMANDA", 0, 1);
func_37(&uLocal_66, 4, iLocal_232[1], "TRACEY", 0, 1);
}elseif(iLocal_65==173){
func_37(&uLocal_66, 4, iLocal_232[0], "JIMMY", 0, 1);
}}
return 1;
}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98143)){
...
return 0;
}}}elseif(iParam1==func_39(Global_100554) && iParam1 !=0){
Global_100554=0;
}}
return 1;
}
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_304) && iLocal_307[iVar0] > 0){
VEHICLE::REQUEST_VEHICLE_RECORDING(iLocal_307[iVar0], &Local_304);
if(!VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(iLocal_307[iVar0], &Local_304)){
VEHICLE::REQUEST_VEHICLE_RECORDING(iLocal_307[iVar0], &Local_304);
bVar2=false;
}}
iVar0++;
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&sLocal_248)){
STREAMING::REQUEST_ANIM_DICT(&sLocal_248);
if(!STREAMING::HAS_ANIM_DICT_LOADED(&sLocal_248)){
bVar2=false;
STREAMING::REQUEST_ANIM_DICT(&sLocal_248);
}}
StringCopy(&Var3, "", 64);
...
if(iLocal_239[iVar0] !=0){
iLocal_238[iVar0]=VEHICLE::CREATE_VEHICLE(iLocal_239[iVar0], Local_244 + Local_240[iVar0 /*3*/], (fLocal_245 + fLocal_241[iVar0]), 0, 0, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_238[iVar0], 1084227584);
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_242[iVar0 /*16*/]))){
ENTITY::PLAY_ENTITY_ANIM(iLocal_238[iVar0], &(Local_242[iVar0 /*16*/]), &sLocal_248, 8f, 1, 0, 0, 0, 0);
}else{
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(iLocal_238[iVar0], iLocal_307[iVar0], &Local_304, 1);
}}
iVar0++;
}
PED::ADD_RELATIONSHIP_GROUP("KIDSS", &uLocal_237);
iVar0=0;
while (iVar0 < iLocal_232){
if(iLocal_233[iVar0] !=145){
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_232[iVar0], uLocal_237);
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_296[iVar0 /*16*/]))){
TASK::TASK_PLAY_ANIM(iLocal_232[iVar0], &sLocal_248, &(Local_296[iVar0 /*16*/]), 8f, -8f, -1, 9, 0, 0, 0, 0);
iLocal_234[iVar0]=0;
}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_238[iVar0], 0)){
PED::SET_PED_INTO_VEHICLE(iLocal_232[iVar0], iLocal_238[iVar0], -1);
iLocal_234[iVar0]=20;
}}}
iVar0++;
}}
...
iVar0=12;
iVar1=32;
if(MISC::IS_BIT_SET(Global_113810.f_2366.f_539.f_3816[0 /*166*/][iVar0 /*11*/][(iVar1 / 32)], (iVar1 % 32))){
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_50(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(uParam0, func_50(iParam1))){
return 1;
}
return 0;
}
...
func_73(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_73(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_73(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
...
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_70(iVar10, 14, uVar12[iVar1], -1) 
};
func_157(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
func_163(14);
if(Global_78470==1){
iVar2=0;
while (iVar2 < 15){
...
if(iParam4==-1){
PED::SET_PED_COMPONENT_VARIATION(uParam0, func_50(iVar0), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_50(iVar0)));
}
else{
...
Global_78472[1 /*14*/]={
func_70(iVar10, iVar0, func_147(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_70(iVar10, 14, uVar15[iVar1], -1) 
};
...
if(!func_49(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_64, Global_113810.f_2366.f_539[iVar0 /*65*/].f_63)){
...
if(!func_49(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_61, Global_113810.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3==1){
...
if(!MISC::IS_STRING_NULL_OR_EMPTY(&Local_304) && iLocal_307[iVar0] > 0){
VEHICLE::REMOVE_VEHICLE_RECORDING(iLocal_307[iVar0], &Local_304);
}
iVar0++;
}
PED::REMOVE_RELATIONSHIP_GROUP(uLocal_237);
