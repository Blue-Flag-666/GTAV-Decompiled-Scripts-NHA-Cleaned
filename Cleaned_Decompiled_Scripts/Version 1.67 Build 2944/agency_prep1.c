...
if(!iLocal_972){
if(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_969, 200f, 200f, 200f, 0, 1, 0) && !CAM::IS_SPHERE_VISIBLE(Local_969, 50f)){
MISC::CLEAR_AREA(Local_969, 50f, 1, 0, 0, 0);
iLocal_972=1;
}}elseif(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_969, 200f, 200f, 200f, 0, 1, 0)){
iLocal_972=0;
}
if(!iLocal_977){
...
iVar0=0;
while (iVar0 <=7){
if((ENTITY::DOES_ENTITY_EXIST(iLocal_800[iVar0]) && !PED::IS_PED_INJURED(iLocal_800[iVar0])) && ENTITY::DOES_ENTITY_EXIST(iLocal_798)){
if(vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_800[iVar0], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 2500f){
PED::SET_PED_KEEP_TASK(iLocal_800[iVar0], 1);
TASK::TASK_SMART_FLEE_PED(iLocal_800[iVar0], PLAYER::PLAYER_PED_ID(), 300f, 20000, 1, 0);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_800[iVar0]));
}}
iVar0++;
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_800[iVar1])){
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_801);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_801, joaat("player"));
...
iLocal_798=PLAYER::GET_PLAYERS_LAST_VEHICLE();
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_798, 1, 1);
}}else{
func_45();
if(!iLocal_973 && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_798, 0)){
func_44(iLocal_798, -1);
func_43(iLocal_798, -1);
func_42(541, 0);
iLocal_973=1;
}
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_969) < pow(100f, 2f)){
PATHFIND::SET_IGNORE_NO_GPS_FLAG(1);
}
func_94();
if(bLocal_978){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_798, 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_799, 0)){
func_36(iLocal_799);
if(PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_799) && ENTITY::IS_ENTITY_AT_COORD(iLocal_798, Local_969, Global_19, 1, 1, 0)){
if(HUD::DOES_BLIP_EXIST(uLocal_796)){
HUD::REMOVE_BLIP(&uLocal_796);
}
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(5f, 15f, 4);
iLocal_967++;
}
}}elseif(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_798, 0)){
func_36(iLocal_798);
if(PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_798) && ENTITY::IS_ENTITY_AT_COORD(iLocal_798, Local_969, Global_19, 1, 1, 0)){
if(HUD::DOES_BLIP_EXIST(uLocal_796)){
HUD::REMOVE_BLIP(&uLocal_796);
}
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(5f, 15f, 4);
...
if((vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_798, 1)) > 22500f && ENTITY::IS_ENTITY_OCCLUDED(iLocal_798)) || vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_798, 1)) > 90000f){
func_14("AHP_LOSTTRUCK");
}}else{
...
break;
case 1:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_798, 0)){
...
case 2:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_798, 0)){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_798, Local_969, Global_19 + Vector(2f, 2f, 2f), 1, 1, 0)){
iLocal_967=0;
}elseif(bLocal_978){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_799)){
if(!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_799, iLocal_798)){
VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_798, 0, 0);
if(VEHICLE::IS_VEHICLE_SIREN_ON(iLocal_798)){
VEHICLE::SET_VEHICLE_SIREN(iLocal_798, 0);
}
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_798, 2);
HUD::CLEAR_PRINTS();
settimera(0);
iLocal_967++;
}else{
VEHICLE::DETACH_VEHICLE_FROM_TOW_TRUCK(iLocal_799, iLocal_798);
}
}}elseif(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_798, 0)){
if(VEHICLE::IS_VEHICLE_SIREN_ON(iLocal_798)){
VEHICLE::SET_VEHICLE_SIREN(iLocal_798, 0);
}
...
if(!iLocal_979){
if((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_798, 0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_798, 0)) || (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_799, 0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_799, 0))){
...
HUD::CLEAR_PRINTS();
iLocal_967=0;
}elseif(PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_798)){
if(!iLocal_975){
func_11("AHP_LOSECOPS", 7500, 1);
iLocal_975=1;
iLocal_968=MISC::GET_GAME_TIMER();
}}elseif((iLocal_975 && (MISC::GET_GAME_TIMER() - iLocal_968) < 7500) && HUD::IS_MESSAGE_BEING_DISPLAYED()){
HUD::CLEAR_PRINTS();
}
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_798, 1)) > 22500f){
func_14("AHP_LOSTTRUCK");
}}else{
func_14("AHP_DEADTRUCK");
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_798)){
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_798, 0)){
VEHICLE::DELETE_VEHICLE(&iLocal_798);
}}
iVar0=0;
while (iVar0 < iLocal_800){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_800[iVar0])){
PED::DELETE_PED(&(iLocal_800[iVar0]));
}
iVar0++;
}
iVar0=0;
...
fVar3=0f;
if(!func_25(Global_113810.f_18536[iVar0], &Var2, &fVar3)){
...
}}elseif(!HUD::DOES_BLIP_EXIST(uLocal_797)){
uLocal_797=func_40(iParam0, 0, 0);
...
uLocal_796=func_37(Local_969, 1);
...
if((((PED::IS_PED_INJURED(func_92(iLocal_981)) || VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar0, -1, 0) !=func_92(iLocal_981)) || !PED::IS_PED_IN_VEHICLE(func_92(iLocal_981), iVar0, 0)) || !func_91(func_92(iLocal_981))) || !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar0, 0)){
func_88(func_92(iLocal_981));
iLocal_980=0;
}else{
switch (iLocal_1001){
case 0:
...
break;
case 1:
if(PATHFIND::ARE_NODES_LOADED_FOR_AREA(Local_984.f_0, Local_984.f_1, Local_986.f_0, Local_986.f_1)){
iLocal_1001++;
}
break;
case 2:
TASK::TASK_VEHICLE_DRIVE_TO_COORD(func_92(iLocal_981), iVar0, Local_969, 15f, 0, joaat("firetruk"), 786484, 5f, 5f);
if(vdist(ENTITY::GET_ENTITY_COORDS(iVar0, 1), Local_969) > 250f){
VEHICLE::SET_VEHICLE_CUSTOM_PATH_NODE_STREAMING_RADIUS(iVar0, vdist(ENTITY::GET_ENTITY_COORDS(iLocal_798, 1), Local_969));
}
iLocal_1001++;
break;
case 3:
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, 697.6884f, -1013.364f, 27.4968f, 688.3482f, -1013.179f, 22.32968f, 29.25f, 0, 1, 0)){
if(vdist(ENTITY::GET_ENTITY_COORDS(iVar0, 1), Local_982) < vdist(ENTITY::GET_ENTITY_COORDS(iVar0, 1), Local_983)){
if(bLocal_978){
TASK::TASK_VEHICLE_DRIVE_TO_COORD(func_92(iLocal_981), iVar0, Local_983, 5f, 0, ENTITY::GET_ENTITY_MODEL(iVar0), 262144, 2f, 2f);
}
else{
TASK::TASK_VEHICLE_PARK(func_92(iLocal_981), iVar0, Local_969, 180f, 1, 15f, 0);
}
}
elseif(bLocal_978){
TASK::TASK_VEHICLE_DRIVE_TO_COORD(func_92(iLocal_981), iVar0, Local_982, 5f, 0, ENTITY::GET_ENTITY_MODEL(iVar0), 262144, 2f, 2f);
}
else{
TASK::TASK_VEHICLE_PARK(func_92(iLocal_981), iVar0, Local_969, 0f, 1, 15f, 0);
}
iLocal_1001++;
}
break;
...
var uVar1;
bVar0=false;
if(!PED::IS_PED_INJURED(func_92(iLocal_981)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if((((ENTITY::DOES_ENTITY_EXIST(iLocal_798) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_798, 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_798, 0)) && PED::IS_PED_IN_VEHICLE(func_92(iLocal_981), iLocal_798, 0)) || (((ENTITY::DOES_ENTITY_EXIST(iLocal_799) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_799, 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_799, 0)) && PED::IS_PED_IN_VEHICLE(func_92(iLocal_981), iLocal_799, 0))){
bVar0=true;
}}
switch (iLocal_988){
case 0:
uVar1=func_85();
if(func_71(0, 1, 145, 0, uVar1, &cLocal_989, &cLocal_993, 1)){
func_70(&uLocal_802, 0);
func_70(&uLocal_802, 1);
func_70(&uLocal_802, 2);
if(func_28()==1){
func_69(&uLocal_802, 0, func_92(0), "MICHAEL", 0, 1);
func_69(&uLocal_802, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}else{
func_69(&uLocal_802, 1, func_92(1), "FRANKLIN", 0, 1);
func_69(&uLocal_802, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
}
if(!iLocal_998){
iLocal_1000=MISC::GET_GAME_TIMER();
}
iLocal_988=1;
}
break;
case 1:
if(bVar0){
if((MISC::GET_GAME_TIMER() - iLocal_1000) > 5000 || iLocal_998){
if(func_68(&uLocal_802, &cLocal_989, &cLocal_993, 8, 0, 0, 0)){
iLocal_998=1;
iLocal_988=2;
}}}
break;
...
if(func_50(&uLocal_802, &cLocal_989, &cLocal_993, &cLocal_999, 8, 0, 0)){
bLocal_997=false;
}}
if(STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() || (!bLocal_997 && !func_49())){
func_47();
iLocal_988=3;
iLocal_1000=MISC::GET_GAME_TIMER();
}
break;
case 3:
if((MISC::GET_GAME_TIMER() - iLocal_1000) > 10000){
iLocal_988=0;
}
break;
}}
...
return 0;
}}elseif(func_80(&(Global_113810.f_18106.f_175[iVar5 /*19*/].f_9), iParam3, &iVar3, &iVar4, uParam4)){
if(bParam7){
...
int func_94(){
if(((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)) && PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0) !=iLocal_798) && PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0) !=iLocal_799){
if(VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), joaat("firetruk"))){
iLocal_798=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_798, 1, 1);
iLocal_973=0;
return 1;
}
...
iLocal_799=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_799, 1, 1);
if(ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(VEHICLE::GET_ENTITY_ATTACHED_TO_TOW_TRUCK(iLocal_799)) !=iLocal_798){
iLocal_798=ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(VEHICLE::GET_ENTITY_ATTACHED_TO_TOW_TRUCK(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)));
iLocal_973=0;
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_798, 1, 1);
}
return 1;
...
if(iLocal_1002 < 8){
if(iLocal_1002 < 4){
if(ENTITY::DOES_ENTITY_EXIST(Global_97310.f_9[iLocal_1002])){
if(!PED::IS_PED_INJURED(Global_97310.f_9[iLocal_1002])){
if(vdist2(ENTITY::GET_ENTITY_COORDS(Global_97310.f_9[iLocal_1002], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 900f){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97310.f_9[iLocal_1002], 1, 1);
iLocal_800[iLocal_1002]=Global_97310.f_9[iLocal_1002];
bVar0=true;
Global_97310.f_9[iLocal_1002]=0;
}elseif(vdist2(ENTITY::GET_ENTITY_COORDS(Global_97310.f_9[iLocal_1002], 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) > 2500f && ENTITY::IS_ENTITY_OCCLUDED(Global_97310.f_9[iLocal_1002])){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97310.f_9[iLocal_1002], 1, 1);
PED::DELETE_PED(&(Global_97310.f_9[iLocal_1002]));
}}}}
if(!bVar0){
if(PED::GET_CLOSEST_PED(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 30f, 1, 1, &iVar1, 0, 1, 21)){
if((ENTITY::DOES_ENTITY_EXIST(iVar1) && !PED::IS_PED_INJURED(iVar1)) && !func_96(iVar1, &iLocal_800)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iVar1, 1, 1);
iLocal_800[iLocal_1002]=iVar1;
bVar0=true;
}}}
if(bVar0){
if(!PED::IS_PED_INJURED(iLocal_800[iLocal_1002])){
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_800[iLocal_1002], iLocal_801);
PLAYER::SET_PLAYER_WANTED_LEVEL_NO_DROP(PLAYER::PLAYER_ID(), 1, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_800[iLocal_1002], 17, 0);
PLAYER::SET_WANTED_LEVEL_DIFFICULTY(PLAYER::PLAYER_ID(), 0f);
}
iLocal_1002++;
}}}
...
void func_97(){
if(bLocal_978){
if(((!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_799, 0) || (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_799, 0) && !ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_798, iLocal_799))) || (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_798, 0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_798, 0))) || (ENTITY::DOES_ENTITY_EXIST(iLocal_799) && vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_799, 1)) > 250f)){
bLocal_978=false;
}}elseif((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_799, 0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_799, 0)) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_798, iLocal_799)){
bLocal_978=true;
}}
...
struct<3> Var0;
int iVar1;
if((ENTITY::DOES_ENTITY_EXIST(Global_97310[0]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97310[0], 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_97310[0], 0)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97310[0], 1, 1);
iLocal_798=Global_97310[0];
Global_97310[0]=0;
}
if((ENTITY::DOES_ENTITY_EXIST(Global_97310[1]) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_97310[1], 0)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_97310[1], 0)){
...
PED::ADD_RELATIONSHIP_GROUP("FireMen", &iLocal_801);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_801);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_801, joaat("player"));
if(func_10(0)){
...
uLocal_1003=PED::ADD_SCENARIO_BLOCKING_AREA(Var0 - Vector(10f, 30f, 30f), Var0 + Vector(10f, 30f, 30f), 0, 1, 1, 1);
MISC::CLEAR_AREA(Var0, 20f, 1, 0, 0, 0);
iLocal_800[0]=PED::CREATE_PED(21, joaat("s_m_y_fireman_01"), 215.7186f, -1644.622f, 28.7719f, 357.5736f, 1, 1);
iLocal_800[1]=PED::CREATE_PED(21, joaat("s_m_y_fireman_01"), 214.4446f, -1643.72f, 28.7776f, 279.1055f, 1, 1);
iLocal_800[2]=PED::CREATE_PED(21, joaat("s_m_y_fireman_01"), 217.0826f, -1644.117f, 28.7155f, 72.8262f, 1, 1);
iVar1=0;
while (iVar1 <=(iLocal_800 - 1)){
if(!PED::IS_PED_INJURED(iLocal_800[iVar1])){
TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_800[iVar1], "WORLD_HUMAN_HANG_OUT_STREET", 0, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_800[iVar1], 17, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_800[iVar1], iLocal_801);
}
iVar1++;
}
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, joaat("player"), iLocal_801);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, iLocal_801, joaat("player"));
iLocal_967=-1;
if(func_106()){
...
func_108();
if(ENTITY::DOES_ENTITY_EXIST(iLocal_798)){
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_798);
}
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_1003, 0);
