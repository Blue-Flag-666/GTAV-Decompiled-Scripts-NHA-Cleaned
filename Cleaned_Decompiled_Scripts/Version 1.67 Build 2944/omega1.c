...
fLocal_28=180f;
iLocal_31=3;
uLocal_36=func_490(69);
fLocal_45=100f;
fLocal_46=20f;
sLocal_212="Omega";
uLocal_213=WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_digiscanner"));
...
func_330(iVar0);
while (!func_322(&Local_37)){
wait(0);
}
func_321(&Local_37, 0, 1);
Global_78935=0;
}
func_320(1, 1, 1, 1);
while (true){
...
func_304(Local_37.f_9, 0, 0, 0, 0, 0);
switch (iLocal_38){
case 0:
func_302();
break;
...
if(!iLocal_43){
if(func_230(PLAYER::PLAYER_PED_ID(), Local_37.f_28[0]) > fLocal_46){
func_228();
iLocal_43=1;
}elseif((MISC::GET_GAME_TIMER() - iLocal_222) > 7500){
if(!bLocal_41){
...
elseif(!bLocal_44 && func_230(PLAYER::PLAYER_PED_ID(), Local_37.f_28[0]) > 50f){
bLocal_44=func_211(&uLocal_47, "SCRAPAU", "SCRAP_WALK", 7, 0, 0, 0);
}
if(func_230(PLAYER::PLAYER_PED_ID(), Local_37.f_28[0]) > fLocal_45){
iLocal_39=2;
}}}
break;
case 2:
...
Global_78472[1 /*14*/]={
func_89(iVar0, iParam1, iParam2, -1) 
};
...
Global_78472[1 /*14*/]={
func_89(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
if(iParam5==0){
Global_78472[1 /*14*/]={
func_89(iVar10, iParam1, iParam2, -1) 
};
if(!func_79(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78472[1 /*14*/]={
func_89(iVar10, iVar0, uVar11[iVar0], -1) 
};
if(MISC::IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0)){
if(iVar0==13){
uVar12=9;
...
uVar12={
func_82(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_89(iVar10, 14, uVar12[iVar1], -1) 
};
...
Global_78472[1 /*14*/]={
func_89(iVar10, iVar0, func_45(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_89(iVar10, 14, uVar15[iVar1], -1) 
};
func_55(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
func_71(14);
if(Global_78470==1){
...
Global_78472[1 /*14*/]={
func_89(iParam0, iParam1, iParam2, -1) 
};
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_81(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
func_92(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_92(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_92(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
iVar10=(iParam1 - iParam2);
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_81(iParam0));
if(iVar11 > iVar10){
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_81(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_81(iParam1))){
return 1;
}
return 0;
}
...
func_167(&uVar1, Var0.f_3, Global_100870, iParam1, iParam2);
}}
...
}elseif(MISC::IS_PS3_VERSION() || func_175()){
...
func_255(5);
return 0;
}elseif(PED::IS_PED_INJURED(Local_37.f_28[0])){
iLocal_40=2;
func_255(5);
return 0;
}elseif(func_236(Local_37.f_28[0], 1, 1116471296, 1126825984, 0, 0, 0, 0)){
TASK::TASK_SMART_FLEE_PED(Local_37.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
iLocal_40=3;
func_255(5);
return 0;
}elseif(func_234(PLAYER::PLAYER_PED_ID(), Local_37.f_28[0], 1)){
TASK::TASK_SMART_FLEE_PED(Local_37.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
iLocal_40=3;
func_255(5);
return 0;
}elseif(PED::IS_PED_RAGDOLL(Local_37.f_28[0])){
iLocal_40=3;
func_255(5);
return 0;
}}
...
if(func_235(iParam0) && PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0)){
if(func_235(iParam1)){
...
if(bParam4){
return 0;
}elseif(func_237(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
Vector3 func__241(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar2;
Var0={
func_245(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var1={
func_245(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__245(struct<3> Param0){
float fVar0;
float fVar1;
fVar0=vmag(Param0);
if(fVar0 !=0f){
...
float fVar2;
Var0={
func_245(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
if(fParam2 < 0.1f || fParam2 > 360f){
return 1;
}
...
case 0:
if(func_232(Local_37.f_28[0])){
TASK::TASK_PERFORM_SEQUENCE(Local_37.f_28[0], uLocal_218);
}
...
case 1:
if(func_232(Local_37.f_28[0])){
if((MISC::GET_GAME_TIMER() - iLocal_220) > 3000){
iLocal_39=2;
}}
break;
case 2:
...
if(func_232(Local_37.f_28[0])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_37.f_28[0], sLocal_212, 0, 0, 0);
}
func_282();
func_281(1, 0, 1, 0);
...
OBJECT::DELETE_OBJECT(&(Local_37.f_41[0]));
}
if(ENTITY::DOES_ENTITY_EXIST(Local_37.f_41[1])){
OBJECT::DELETE_OBJECT(&(Local_37.f_41[1]));
}
iLocal_39=1;
}
break;
...
func_321(&Local_37, 0, 1);
if(!ENTITY::DOES_ENTITY_EXIST(Local_37.f_41[0])){
Local_37.f_41[0]=OBJECT::CREATE_OBJECT(uLocal_213, 2468.51f, 3437.39f, 55f, 1, 1, 0);
}
iLocal_215=OBJECT::CREATE_OBJECT(iLocal_214, 2472.3f, 3437.3f, 49.3f, 1, 1, 0);
if(func_232(Local_37.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(Local_37.f_41[0])){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_37.f_41[0], Local_37.f_28[0], PED::GET_PED_BONE_INDEX(Local_37.f_28[0], 18905), 0.09f, 0.072f, -0.006f, 298f, 194f, 178f, 0, 0, 0, 0, 2, 1, 0);
}
if(func_232(Local_37.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_215)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_215, Local_37.f_28[0], PED::GET_PED_BONE_INDEX(Local_37.f_28[0], 64729), Local_216, Local_217, 0, 0, 0, 0, 2, 1, 0);
}
...
func_281(0, 0, 1, 0);
if(func_232(Local_37.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(Local_37.f_41[0])){
if(ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_37.f_41[0], Local_37.f_28[0])){
func_257(3);
}}
break;
}}
...
iVar0=0;
while (iVar0 < 16){
if(func_232(uVar1[iVar0]) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar1[iVar0], Local_223[0 /*3*/], Local_223[1 /*3*/], fLocal_224, 0, 1, 0)){
...
func_294();
if(func_233()){
if(MISC::GET_GAME_TIMER() < iLocal_219 && !func_293(PLAYER::PLAYER_PED_ID(), Local_37.f_28[0], 4f, 1)){
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_37.f_28[0], 0f, 0f, 0f, 1, -1, 2500, 2000, 0);
...
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_37.f_28[0], 2000, 0, 2);
}else{
func_257(2);
}}}


bool func_293(int iParam0, int iParam1, float fParam2, int iParam3){
...
STREAMING::REQUEST_MODEL(iLocal_213);
STREAMING::REQUEST_MODEL(iLocal_214);
if(func_233()){
if((((STREAMING::HAS_ANIM_DICT_LOADED("rcmrc_omega_1leadinoutscrap_1_rcm") && STREAMING::HAS_ANIM_DICT_LOADED("rcmrc_omega_1")) && HUD::HAS_ADDITIONAL_TEXT_LOADED(0)) && STREAMING::HAS_MODEL_LOADED(iLocal_213)) && STREAMING::HAS_MODEL_LOADED(iLocal_214)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_218);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_218);
if(func_232(Local_37.f_28[0])){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_37.f_28[0], 1);
PED::SET_PED_KEEP_TASK(Local_37.f_28[0], 1);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_37.f_28[0], 0);
PED::SET_PED_CONFIG_FLAG(Local_37.f_28[0], 185, 1);
}
if(func_235(PLAYER::PLAYER_PED_ID()) && func_235(Local_37.f_28[0])){
uLocal_221=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_37.f_28[0], uLocal_221);
PED::SET_PED_CONFIG_FLAG(Local_37.f_28[0], 132, 1);
func_303(&uLocal_47, 3, Local_37.f_28[0], "OMEGA", 0, 1);
func_303(&uLocal_47, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}
iLocal_219=MISC::GET_GAME_TIMER() + 3500;
func_257(1);
}}}
...
int func_323(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_324(uParam0, iParam1, Param2, fParam3, 1)){
...
bVar2=false;
if(func_232(iParam0)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iParam0, Local_223[0 /*3*/], Local_223[1 /*3*/], fLocal_224, 0, 1, 0)){
...
Var1={
Var1 * Vector(1.1f, 1.1f, 1.1f) 
};
}elseif(iVar3==joaat("t20") || iVar3==joaat("virgo")){
Var1={
Var1 * Vector(1.2f, 1.2f, 1.2f) 
};
}
if(Var0[0 /*3*/] > Var1.f_0){
bVar2=true;
}elseif(Var0[0 /*3*/].f_1 > Var1.f_1){
bVar2=true;
}elseif(Var0[0 /*3*/].f_2 > Var1.f_2){
bVar2=true;
}
if(bVar2){
...
void func_333(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11){
int iVar0;
iVar0=1;
...
if(iVar0==1){
if(!func_444(iParam4, iParam5, iParam6, iParam11)){
iVar0=0;
}}
if(iVar0==1){
func_442();
...
*iParam0=func_415(Param1, fParam2);
}elseif(iParam7==1){
...
func_406(iParam10, 0);
while (!func_334(iParam0, iParam10, Param1, fParam2, 1, 0)){
wait(0);
}}else{
...
int func_334(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5){
var uVar0;
var uVar1;
struct<97> Var2;
int iVar3;
...
func_397(iParam0, &(Var2.f_31), &(Var2.f_81));
VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
if(iParam1==1){
...
int iVar4;
iVar0=0;
while (func_337(iVar0, &sVar2, &iVar1, &iVar3, &iVar4)){
...
return 1;
}elseif(func_359(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_275(iParam0, 0, 0)) || func_275(iParam0, 1, 0)) || func_275(iParam0, 2, 0)) || func_393(iParam0) !=145) || func_392(iParam0)) || func_391(iParam0)) || func_341(iParam0)) || func_390(iParam0)) || !func_380(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_391(iParam0)){
}
if(func_391(iParam0)){
}
...
void func_408(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
bool func_414(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_415(struct<3> Param0, float fParam1){
return func_416(&(Global_107357.f_2890), Param0, fParam1, 0);
}

int func_416(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
}elseif((!func_418(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
iVar4=func_417(iVar0);
if(iVar4==-1){
uParam0->f_10=0;
}else{
func_409(iVar4);
...
int func_418(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_420(iParam0, uVar1[iVar3], 1) && func_419(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_414(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
...
int func_419(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_377(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_377(iVar4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_377(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_377(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_377(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_377(iVar6))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_429(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_428()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_377(iVar7 + 1))){
...
var func__426(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
if(func_467()){}
func_466(0);
func_465(&uLocal_47, 1);
func_465(&uLocal_47, 3);
func_464(&(Local_37.f_28[0]), 1, 0, 1);
if(ENTITY::DOES_ENTITY_EXIST(Local_37.f_41[0])){
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(Local_37.f_41[0]));
}
if(ENTITY::DOES_ENTITY_EXIST(Local_37.f_41[1])){
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(Local_37.f_41[1]));
}
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_213);
func_451(&Local_37, 0, 0, 0);
