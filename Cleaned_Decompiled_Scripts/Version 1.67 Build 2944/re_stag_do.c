...
iLocal_270=6000;
Local_48={
ScriptParam_285.f_1[0 /*3*/] 
};
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11)){
if(!PED::IS_PED_INJURED(iLocal_49)){
if(PED::IS_PED_IN_GROUP(iLocal_49)){
...
while (true){
wait(0);
if(BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || bLocal_78){
if(!func_151()){
if(func_150()){
func_185();
}}
...
func_123();
func_112();
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_280)){
func_111();
}}else{
func_108();
if(!bLocal_86){
...
if(iLocal_45==3){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_65, 1) < 100f){
if(!CUTSCENE::IS_CUTSCENE_ACTIVE()){
CUTSCENE::REQUEST_CUTSCENE("sdrm_mcs_2", 8);
}
if(CUTSCENE::IS_CUTSCENE_ACTIVE()){
if(CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY()){
if((((!PED::IS_PED_INJURED(iLocal_49) && !PED::IS_PED_INJURED(iLocal_51)) && !PED::IS_PED_INJURED(iLocal_50)) && !PED::IS_PED_INJURED(iLocal_52)) && !ENTITY::IS_ENTITY_DEAD(iLocal_94, 0)){
CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Groom", iLocal_49, 0);
CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Groomsman", iLocal_51, 0);
CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Bride", iLocal_50, 0);
CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Father_of_the_bride", iLocal_52, 0);
}
...
if(func_67(1, 0, 1)){
func_31();
}}elseif(!PED::IS_PED_INJURED(iLocal_51)){
...
if(func_3()){
if(!PED::IS_PED_INJURED(iLocal_49)){
TASK::TASK_SMART_FLEE_PED(iLocal_49, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}
if(!PED::IS_PED_INJURED(iLocal_51)){
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_49, PLAYER::PLAYER_PED_ID(), 1) || ENTITY::IS_ENTITY_IN_WATER(iLocal_49)){
return 1;
}
if(bLocal_78){
...
if((!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_53, 0) || VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(iLocal_53)) || ENTITY::IS_ENTITY_IN_WATER(iLocal_53)){
func_27();
...
if(!PED::IS_PED_INJURED(iLocal_49)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49, PLAYER::PLAYER_PED_ID(), 150f, 150f, 150f, 0, 1, 0)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_53, 0)){
...
func_27();
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_51, PLAYER::PLAYER_PED_ID(), 1)){
func_27();
return 1;
}}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_53, 0)){
...
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_50, PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_52, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}}
if(!PED::IS_PED_INJURED(iLocal_51)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_51, PLAYER::PLAYER_PED_ID(), 20f, 20f, 20f, 0, 1, 0) && iLocal_272){
if(!iLocal_89){
func_27();
...
var func__29(struct<3> Param0, int iParam1){
var uVar0;
...
if((((!PED::IS_PED_INJURED(iLocal_49) && !PED::IS_PED_INJURED(iLocal_51)) && !PED::IS_PED_INJURED(iLocal_50)) && !PED::IS_PED_INJURED(iLocal_52)) && !ENTITY::IS_ENTITY_DEAD(iLocal_94, 0)){
if(func_57()){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_94, "SDRM_Car", 0, 0, 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_49, "Groom", 0, 0, 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_51, "Groomsman", 0, 0, 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_50, "Bride", 0, 0, 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_52, "Father_of_the_bride", 0, 0, 0);
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_63(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
void func_68(){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_53, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_49, 0)){
if(!iLocal_79){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_53, 0) && PED::IS_PED_IN_VEHICLE(iLocal_49, iLocal_53, 0)){
iLocal_79=1;
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_53, 0)){
if(!PED::IS_PED_IN_VEHICLE(iLocal_49, iLocal_53, 0)){
if(!func_72()){
}
if(HUD::DOES_BLIP_EXIST(uLocal_281)){
HUD::REMOVE_BLIP(&uLocal_281);
...
HUD::SET_BLIP_AS_FRIENDLY(uLocal_281, 1);
}
iLocal_79=0;
iLocal_81=1;
}}}
...
var func__71(int iParam0, bool bParam1, int iParam2){
var uVar0;
...
if(!PED::IS_PED_INJURED(iLocal_49)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49, PLAYER::PLAYER_PED_ID(), 4f, 4f, 4f, 0, 1, 0)){
if((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_49, 0)) || PED::IS_PED_IN_ANY_TAXI(PLAYER::PLAYER_PED_ID())){
if(HUD::DOES_BLIP_EXIST(uLocal_283)){
HUD::REMOVE_BLIP(&uLocal_283);
if(!HUD::DOES_BLIP_EXIST(uLocal_282)){
uLocal_282=func_29(Local_57, 1);
}}}elseif(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_49, 0)){
if(HUD::DOES_BLIP_EXIST(uLocal_283)){
HUD::REMOVE_BLIP(&uLocal_283);
if(!HUD::DOES_BLIP_EXIST(uLocal_282)){
uLocal_282=func_29(Local_57, 1);
}}}elseif(HUD::DOES_BLIP_EXIST(uLocal_282)){
HUD::REMOVE_BLIP(&uLocal_282);
if(!HUD::DOES_BLIP_EXIST(uLocal_283)){
...
if(!PED::IS_PED_IN_GROUP(iLocal_49)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_49, 10f, 10f, 10f, 0, 1, 0)){
TASK::CLEAR_PED_TASKS(iLocal_49);
PED::SET_PED_AS_GROUP_MEMBER(iLocal_49, func_74());
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_49, 1);
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_49, 0);
}
...
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_49, joaat("script_task_go_to_entity")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_49, joaat("script_task_go_to_entity")) !=0){
TASK::TASK_GO_TO_ENTITY(iLocal_49, PLAYER::PLAYER_PED_ID(), -1, 6f, 1073741824, 1073741824, 0);
}
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_49, 0)){
TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_49, 0, 0);
}
if(!iLocal_87){
if(!func_72()){
iLocal_87=1;
...
iLocal_87=0;
if(((TASK::GET_SCRIPT_TASK_STATUS(iLocal_49, joaat("script_task_go_to_entity"))==1 || TASK::GET_SCRIPT_TASK_STATUS(iLocal_49, joaat("script_task_go_to_entity"))==0) || TASK::GET_SCRIPT_TASK_STATUS(iLocal_49, joaat("script_task_perform_sequence"))==1) || TASK::GET_SCRIPT_TASK_STATUS(iLocal_49, joaat("script_task_perform_sequence"))==0){
TASK::CLEAR_PED_TASKS(iLocal_49);
if(!PED::IS_PED_IN_GROUP(iLocal_49)){
PED::SET_PED_AS_GROUP_MEMBER(iLocal_49, func_74());
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_49, 1);
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_49, 0);
}}}}elseif(((!PED::IS_PED_IN_GROUP(iLocal_49) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_49, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_49, joaat("script_task_perform_sequence")) !=1) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_49, joaat("script_task_perform_sequence")) !=0){
PED::SET_PED_AS_GROUP_MEMBER(iLocal_49, func_74());
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_49, 1);
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_49, 0);
}}}
...
void func_80(){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_49)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_49, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_49, uLocal_75);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_75);
}}}
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_49, 13.5f, 13.5f, 13.5f, 0, 1, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_49, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0)){
if(iLocal_45==0){
if(timerb() > 5000){
if(iLocal_92==0){
if(!func_72()){
...
if(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_65, 150f, 150f, 150f, 0, 1, 0)){
if(iLocal_265==0){
...
return (shift_right(iParam0, 26) & 31 * func_88(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_49, -2002.008f, 455.58f, 101.0381f, -2009.761f, 453.2027f, 105.9135f, 12.4375f, 0, 1, 0) || timera() > 5000){
iLocal_91=1;
settimera(0);
func_58(1, 1, 1, 0, 0, 0, 0);
HUD::CLEAR_HELP(1);
...
uLocal_96=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -2014.228f, 456.4961f, 103.5524f, -6.509435f, -0.037031f, -95.98762f, 29.00143f, 0, 2);
uLocal_97=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -2014.334f, 456.418f, 103.3152f, -6.198685f, -0.037031f, -100.5736f, 29.00143f, 0, 2);
CAM::SHAKE_CAM(uLocal_96, "HAND_SHAKE", 0.25f);
CAM::SHAKE_CAM(uLocal_97, "HAND_SHAKE", 0.25f);
CAM::SET_CAM_ACTIVE(uLocal_96, 1);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
wait(1000);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_97, uLocal_96, 4000, 1, 1);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(Local_69, 10f, 0, 0, 0, 0, 0, 0, 0);
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), Local_69, 8f, 8f, 8f, 0, 1, 0)){
...
if(!HUD::DOES_BLIP_EXIST(uLocal_281)){
uLocal_281=func_69(iLocal_53, 0, 0);
HUD::SET_BLIP_AS_FRIENDLY(uLocal_281, true);
}
}
iLocal_79=0;
}}
if(iLocal_91 && CAM::DOES_CAM_EXIST(uLocal_96)){
if(timera() > 5700 && !iLocal_279){
...
HUD::DISPLAY_RADAR(1);
func_58(0, 1, 1, 0, 0, 0, 0);
CAM::SET_CAM_ACTIVE(uLocal_96, 0);
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
CAM::DESTROY_CAM(uLocal_96, 0);
CAM::STOP_GAMEPLAY_HINT(0);
}}
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -2201.417f, 4296.06f, 47.5076f, 100f, 100f, 100f, 0, 1, 0)){
MISC::CLEAR_AREA_OF_VEHICLES(Local_65, 5f, 0, 0, 0, 0, 0, 0, 0);
}}
if(!bLocal_85){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_71, 100f, 100f, 100f, 0, 1, 0)){
STREAMING::REQUEST_MODEL(joaat("ig_bestmen"));
if(STREAMING::HAS_MODEL_LOADED(joaat("ig_bestmen"))){
iLocal_51=PED::CREATE_PED(4, joaat("ig_bestmen"), -2202.747f, 4299.008f, 47.4293f, 73.0028f, 1, 1);
...
PED::SET_PED_CONFIG_FLAG(iLocal_51, 185, 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_75);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
TASK::CLOSE_SEQUENCE_TASK(uLocal_75);
TASK::TASK_PERFORM_SEQUENCE(iLocal_51, uLocal_75);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_75);
bLocal_85=true;
}}}
if(!bLocal_86){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_61, 20f, 20f, 20f, 0, 1, 0)){
func_27();
if(!func_72()){
func_4(&uLocal_98, "stagdau", "stagd_spot", 4, 0, 0, 0);
bLocal_86=true;
}}}
if(((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_58, Local_59, fLocal_60, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_49, Local_58, Local_59, fLocal_60, 0, 1, 0)) || (ENTITY::IS_ENTITY_AT_COORD(iLocal_49, Local_57, 0f, 0f, 2f, 1, 1, 0) && func_67(1, 0, 1))) || bLocal_80){
switch (iLocal_45){
case 0:
HUD::REMOVE_BLIP(&uLocal_282);
if(!bLocal_80){
...
if(iVar3==4){
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_49, 5000, 0, 2);
}
else{
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_53, 5000, 2052, 4);
CAM::SET_GAMEPLAY_VEHICLE_HINT(iLocal_53, 0f, 0f, 0f, 1, -1, 3000, 2000);
}}}
func_27();
if(!func_72()){
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_69, 3f, 20000, 1048576000, 0, 1193033728);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
TASK::CLOSE_SEQUENCE_TASK(uLocal_75);
TASK::TASK_PERFORM_SEQUENCE(iLocal_49, uLocal_75);
...
if(!PED::IS_PED_INJURED(iLocal_49) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, 0)){
if((bLocal_80 && ENTITY::IS_ENTITY_AT_COORD(iLocal_49, Local_69, 1f, 1f, 1f, 0, 1, 0)) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_49, 0)){
if(PED::IS_PED_IN_GROUP(iLocal_49)){
if(!func_72()){
if(func_16()==2){
...
if(ENTITY::IS_ENTITY_OCCLUDED(iLocal_49)){
if(!PED::IS_PED_INJURED(iLocal_49)){
ENTITY::SET_ENTITY_VISIBLE(iLocal_49, 0, 0);
ENTITY::SET_ENTITY_COLLISION(iLocal_49, 0, 0);
ENTITY::SET_ENTITY_INVINCIBLE(iLocal_49, 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_49, 1);
}
if(timera() > 15000){
if(!PED::IS_PED_INJURED(iLocal_49)){
PED::SET_PED_COMPONENT_VARIATION(iLocal_49, 2, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_49, 0, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_49, 3, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_49, 4, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_49, 11, 0, 0, 0);
ENTITY::SET_ENTITY_VISIBLE(iLocal_49, 1, 0);
ENTITY::SET_ENTITY_COLLISION(iLocal_49, 1, 0);
ENTITY::SET_ENTITY_INVINCIBLE(iLocal_49, 0);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_49, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_49, Local_69, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_49, 106.5078f);
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_49, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_49, 17, 1);
PED::SET_PED_STAY_IN_VEHICLE_WHEN_JACKED(iLocal_49, 1);
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_49, -1, 2048, 4);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_53, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_75);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
TASK::TASK_ENTER_VEHICLE(0, iLocal_53, -1, 0, 2f, 1, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_75);
TASK::TASK_PERFORM_SEQUENCE(iLocal_49, uLocal_75);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_75);
}
...
case 1:
if(!PED::IS_PED_INJURED(iLocal_49) && !ENTITY::IS_ENTITY_DEAD(iLocal_53, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49, iLocal_53, 5f, 5f, 5f, 0, 1, 0) && !iLocal_90){
...
if(iLocal_270 !=0 && MISC::GET_GAME_TIMER() > iLocal_270 + 6000){
...
if(!PED::IS_PED_INJURED(iLocal_51) && !PED::IS_PED_INJURED(iLocal_49)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_49, 0)){
iLocal_94=PED::GET_VEHICLE_PED_IS_IN(iLocal_49, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_75);
TASK::TASK_ENTER_VEHICLE(0, iLocal_94, -1, 2, 1f, 1, 0);
TASK::TASK_CLEAR_LOOK_AT(0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_75);
TASK::TASK_PERFORM_SEQUENCE(iLocal_51, uLocal_75);
PED::SET_PED_CONFIG_FLAG(iLocal_51, 185, 0);
}
else{
TASK::TASK_GO_TO_ENTITY(iLocal_51, iLocal_49, -1, 8f, 1073741824, 1073741824, 0);
}
if(!HUD::DOES_BLIP_EXIST(uLocal_284)){
...
if(bLocal_80 && !PED::IS_PED_INJURED(iLocal_49)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_49, joaat("script_task_perform_sequence"))==7 || timera() > 12000){
Local_57={
Local_61 
};
Local_58={
...
iLocal_50=PED::CREATE_PED(5, joaat("ig_bride"), -330.36f, 6154.03f, 30.8f, 90f, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_50, 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_75);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_75);
TASK::TASK_PERFORM_SEQUENCE(iLocal_50, uLocal_75);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_75);
iLocal_52=PED::CREATE_PED(4, joaat("ig_bestmen"), -333.3692f, 6157.644f, 30.489f, 83.2763f, 1, 1);
...
uLocal_54[0]=VEHICLE::CREATE_VEHICLE(joaat("washington"), -342.1295f, 6141.404f, 30.4839f, 133.4604f, 1, 1, 0);
uLocal_54[1]=VEHICLE::CREATE_VEHICLE(joaat("baller2"), -338.3777f, 6137.41f, 30.476f, 135.6866f, 1, 1, 0);
uLocal_54[2]=VEHICLE::CREATE_VEHICLE(joaat("primo"), -329.4687f, 6143.247f, 30.4893f, 313.82f, 1, 1, 0);
uLocal_54[3]=VEHICLE::CREATE_VEHICLE(joaat("washington"), -322.3235f, 6135.427f, 30.4924f, 316.5898f, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOURS(uLocal_54[0], MISC::GET_RANDOM_INT_IN_RANGE(0, 127), 0);
VEHICLE::SET_VEHICLE_COLOURS(uLocal_54[1], MISC::GET_RANDOM_INT_IN_RANGE(0, 127), 0);
VEHICLE::SET_VEHICLE_COLOURS(uLocal_54[2], MISC::GET_RANDOM_INT_IN_RANGE(0, 127), 0);
VEHICLE::SET_VEHICLE_COLOURS(uLocal_54[3], MISC::GET_RANDOM_INT_IN_RANGE(0, 127), 0);
iLocal_45=3;
bLocal_80=false;
iLocal_92=0;
}}
...
break;
}}}elseif(ENTITY::IS_ENTITY_DEAD(iLocal_49, 0)){
func_185();
}}}
...
void func_98(){
if((iLocal_272 && iLocal_269 !=func_81(func_82())) && !CAM::DOES_CAM_EXIST(uLocal_96)){
...
if(!PED::IS_PED_INJURED(iLocal_49)){
TASK::TASK_USE_MOBILE_PHONE(iLocal_49, 1, 1);
}
if(!PED::IS_PED_INJURED(iLocal_50)){
TASK::TASK_SMART_FLEE_PED(iLocal_50, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
}
if(!PED::IS_PED_INJURED(iLocal_52)){
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_49, 0)){
TASK::CLEAR_PED_TASKS(iLocal_49);
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_49, 5000, 2048, 2);
TASK::TASK_LOOK_AT_ENTITY(iLocal_49, PLAYER::PLAYER_PED_ID(), 5000, 2048, 2);
TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_49, 0, 0);
PED::REMOVE_PED_FROM_GROUP(iLocal_49);
}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_51, 0)){
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_49, 5000, 0, 2);
TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_51, 500, 0);
}
wait(1000);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_53, 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_53, 0)){
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_49, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_75);
if(PLAYER::GET_PLAYERS_LAST_VEHICLE()==iLocal_53){
TASK::TASK_ENTER_VEHICLE(0, iLocal_53, -1, -1, 1f, 8, 0);
TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_53, PLAYER::PLAYER_PED_ID(), 8, 15f, 786469, 10f, 10f, 1);
}else{
...
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_271++;
}}elseif(iLocal_271==10){
if(iVar1==59 && iVar2 >=15){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_271++;
}}elseif(iLocal_271==11){
if(iVar1==59 && iVar2 >=30){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_271++;
}}elseif(iLocal_271==12){
if(iVar1==59 && iVar2 >=45){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_271++;
}}elseif(iLocal_271==13){
...
void func_106(){
if(!PED::IS_PED_INJURED(iLocal_49)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_53, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_49, iLocal_53, 0) && ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_53)){
if(!func_72()){
if(func_107()){
func_4(&uLocal_98, "stagdau", "stagd_crash", 4, 0, 0, 0);
}else{
func_4(&uLocal_98, "stagdau", "stagd_bump1", 4, 0, 0, 0);
}}}elseif(PED::IS_PED_IN_VEHICLE(iLocal_49, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0) && ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))){
if(!func_72()){
func_4(&uLocal_98, "stagdau", "stagd_bump1", 4, 0, 0, 0);
}}}}}
...
void func_108(){
if(!PED::IS_PED_INJURED(iLocal_49)){
PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(iLocal_49, 0);
}
if(!PED::IS_PED_INJURED(iLocal_51)){
PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(iLocal_51, 0);
}
if(((((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49, PLAYER::PLAYER_PED_ID(), 4f, 4f, 4f, 0, 1, 0) || iLocal_45==1) || iLocal_88) || iLocal_89) || iLocal_87) || bLocal_80){
...
void func_112(){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(iLocal_49)){
if(!iLocal_77){
if((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_49, 130f, 60f, 50f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_49)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_49, 10f, 10f, 10f, 0, 1, 0)){
if(!HUD::DOES_BLIP_EXIST(uLocal_283)){
uLocal_283=func_71(iLocal_49, 0, 145);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_283, 0);
TASK::TASK_LOOK_AT_ENTITY(iLocal_49, PLAYER::PLAYER_PED_ID(), -1, 2052, 4);
}
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_49, 10f, 10f, 10f, 0, 1, 0)){
if(HUD::DOES_BLIP_EXIST(uLocal_283)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_283, 1);
}
settimerb(0);
func_99();
while (func_72()){
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_INJURED(iLocal_49)){
if((!func_151() && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1131.777f, 2636.418f, 15.589f, -1040.995f, 2717.077f, 31.715f, 60.75f, 0, 1, 0)) && HUD::DOES_BLIP_EXIST(uLocal_283)){
if(!func_72()){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_49)){
if(!PED::IS_PED_INJURED(iLocal_49)){
if(FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_49, 1), 3f)){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_49);
ENTITY::SET_ENTITY_HEALTH(iLocal_49, 99, 0);
}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)){
...
ENTITY::FREEZE_ENTITY_POSITION(iLocal_49, 0);
if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), iLocal_49)){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_49);
ENTITY::SET_ENTITY_HEALTH(iLocal_49, 99, 0);
}}}
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_49, 2f, 2f, 2f, 0, 1, 0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_67(1, 0, 1)){
if(!iLocal_273){
func_113(1);
...
HUD::DISPLAY_RADAR(0);
if(!PED::IS_PED_INJURED(iLocal_49)){
MISC::CLEAR_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_49, 1), 5f, 1, 0, 0, 0);
GRAPHICS::REMOVE_PARTICLE_FX_IN_RANGE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 5f);
}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), iLocal_49, 5f, 5f, 5f, 0, 1, 0)){
ENTITY::SET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), ENTITY::GET_ENTITY_COORDS(iLocal_49, 1) - Vector(1.5f, 4f, 3f), 1, 0, 0, 1);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1084227584);
}}
if(!PED::IS_PED_INJURED(iLocal_49)){
uLocal_280=PED::CREATE_SYNCHRONIZED_SCENE(-935.57f, 2767.616f, 24.448f, 2.433f, 0.152f, 53.743f, 2);
uLocal_96=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_280, 0.158f);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_96, uLocal_280, "untie_cam", "re@stag_do@");
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_49);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_49, uLocal_280, "re@stag_do@", "untie_ped", 1000f, -1000f, 4, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_49, 0, 0);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_280, "re@stag_do@", "untie_player", 1000f, -1000f, 0, 0, 1148846080, 0);
...
if(!iLocal_278){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_280) > 0.2f && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_280) < 0.3f){
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "ROPE_CUT", PLAYER::PLAYER_PED_ID(), "ROPE_CUT_SOUNDSET", 0, 0);
iLocal_278=1;
}}
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_280) > 0.4647059f && !iLocal_279){
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==4){
GRAPHICS::ANIMPOSTFX_PLAY("CamPushInNeutral", 0, 0);
AUDIO::PLAY_SOUND_FRONTEND(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 1);
iLocal_279=1;
}}
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_280) > 0.5f){
iLocal_274=1;
}
if(func_124(1000)){
...
ENTITY::SET_ENTITY_COORDS(iLocal_49, -935.6716f, 2767.772f, 24.4289f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_49, 136.9073f);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_49, 0, 0);
}
if(iLocal_277){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_49, uLocal_75);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_75);
}elseif(!PED::IS_PED_IN_GROUP(iLocal_49)){
PED::SET_PED_AS_GROUP_MEMBER(iLocal_49, func_74());
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_49, 1);
PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_49, 0);
}}elseif(!PED::IS_PED_IN_GROUP(iLocal_49)){
...
iLocal_95=VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(ENTITY::GET_ENTITY_COORDS(iLocal_49, 0), 30f, 0, 4);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_95, 0)){
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_95, -1, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_95, iLocal_49, 30f, 30f, 30f, 0, 1, 0)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_95, 1, 0);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_95, 0)){
VEHICLE::START_VEHICLE_HORN(iLocal_95, 3000, 0, 0);
if(!PED::IS_PED_INJURED(iLocal_49)){
...
iLocal_49=PED::CREATE_PED(26, joaat("u_m_y_staggrm_01"), -935.57f, 2767.616f, 24.448f, 140.5f, 1, 1);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_49, "GROOM");
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_49, joaat("player"));
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_49, 1);
PED::SET_PED_MONEY(iLocal_49, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_49, 2, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_49, 0, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_49, 3, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_49, 4, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_49, 11, 1, 0, 0);
TASK::TASK_SET_DECISION_MAKER(iLocal_49, joaat("empty"));
PED::SET_PED_COMBAT_MOVEMENT(iLocal_49, 3);
PED::SET_PED_CONFIG_FLAG(iLocal_49, 206, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_49, 134, 1);
iLocal_56=OBJECT::CREATE_OBJECT(joaat("prop_stag_do_rope"), ENTITY::GET_ENTITY_COORDS(iLocal_49, 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_56, iLocal_49, PED::GET_PED_BONE_INDEX(iLocal_49, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
iLocal_53=VEHICLE::CREATE_VEHICLE(joaat("superd"), -2009.015f, 455.3556f, 101.6528f, 274.8103f, 0, 0, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iLocal_53, 1);
VEHICLE::SET_VEHICLE_DIRT_LEVEL(iLocal_53, 0f);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_53, 3);
VEHICLE::SET_VEHICLE_MOD_KIT(iLocal_53, 0);
VEHICLE::SET_VEHICLE_MOD_COLOR_1(iLocal_53, 0, 73, 0);
VEHICLE::SET_VEHICLE_MOD_COLOR_2(iLocal_53, 2, 48);
VEHICLE::SET_VEHICLE_MOD(iLocal_53, 11, 1, 0);
VEHICLE::SET_VEHICLE_MOD(iLocal_53, 12, 1, 0);
VEHICLE::REQUEST_VEHICLE_ASSET(joaat("superd"), 3);
ENTITY::SET_ENTITY_LOD_DIST(iLocal_53, 10000);
VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(iLocal_53, 5f);
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(iLocal_53);
Local_61={
...
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_65 - Vector(10f, 10f, 10f), Local_65 + Vector(10f, 10f, 10f), 0, 1);
PED::ADD_SCENARIO_BLOCKING_AREA(Local_65 - Vector(20f, 20f, 20f), Local_65 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
PED::ADD_SCENARIO_BLOCKING_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_49, 0) - Vector(10f, 10f, 10f), ENTITY::GET_ENTITY_COORDS(iLocal_49, 0) + Vector(10f, 10f, 10f), 0, 1, 1, 1);
...
MISC::CLEAR_AREA_OF_PEDS(ENTITY::GET_ENTITY_COORDS(iLocal_49, 1), 10f, 0);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_49, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_75);
...
if(func_16()==0){
func_97(&uLocal_98, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
}
if(func_16()==1){
func_97(&uLocal_98, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}
if(func_16()==2){
func_97(&uLocal_98, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
}
...
var func__132(int iParam0, var uParam1){
...
if(func_40()==0){
return MISC::IS_BIT_SET(func_134(func_135(iParam0), -1), iParam1);
}}else{
...
if(vmag2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_149()){
return 0;
}}
if(func_145()){
return 1;
...
if(!func_178(Global_113810.f_24998.f_43[iParam1])){
return 0;
}
...
iVar3=(iVar3 - 1);
iVar0=round(func_162(to_float(iVar0 + 1), 0f, 12f));
}
while (iVar3 < 0){
iVar3 +=12;
iVar2=(iVar2 - 1);
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_176()) || Global_112857) || Global_32286) || func_175()) || func_24(8, -1)) || func_174()) || func_173()) || func_172()) || func_171()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_176()) || Global_32286) || func_175()) || func_24(8, -1)) || func_172()) || func_174()) || func_173()) || func_171()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_176()) || Global_112857) || Global_32286) || func_175()) || func_24(8, -1)) || func_172()) || func_174()) || func_173()) || func_171()) || Global_113810.f_7691.f_919[iVar0]==5) || Global_43924 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_176()) || Global_112857) || Global_32286) || func_175()) || func_24(8, -1)) || func_174()) || func_173()) || func_171()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_176()) || Global_32286) || func_175()) || func_24(8, -1)) || func_173()) || func_172()) || func_171()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_176()) || func_173()) || Global_112857) || Global_32286) || func_175()) || Global_44569) || func_24(8, -1)) || func_172()) || func_170()) || func_171()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_176()) || Global_112857) || Global_32286) || func_175()) || func_24(8, -1)) || func_172()) || func_170()) || func_174()) || func_173()) || func_171()){
return 0;
}
break;
}}else{
...
if(iLocal_47){
func_224(0);
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_65 - Vector(10f, 10f, 10f), Local_65 + Vector(10f, 10f, 10f), 1, 1);
PED::REMOVE_SCENARIO_BLOCKING_AREAS();
func_27();
PLAYER::RESET_WANTED_LEVEL_DIFFICULTY(PLAYER::PLAYER_ID());
if(!ENTITY::IS_ENTITY_DEAD(iLocal_55, 0)){
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_55, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 50f, 50f, 50f, 0, 1, 0)){
func_197(iLocal_55, 0, 145);
}}
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_65, 100f, 100f, 100f, 0, 1, 0)){
if(!PED::IS_PED_INJURED(iLocal_49) && !PED::IS_PED_INJURED(iLocal_51)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_75);
...
TASK::TASK_CHAT_TO_PED(0, iLocal_49, 16, 0f, 0f, 0f, 0f, 0f);
TASK::CLOSE_SEQUENCE_TASK(uLocal_75);
TASK::TASK_PERFORM_SEQUENCE(iLocal_51, uLocal_75);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_75);
}}
...
if(!PED::IS_PED_INJURED(iLocal_49)){
PED::SET_PED_CONFIG_FLAG(iLocal_49, 317, 1);
if(!ENTITY::IS_ENTITY_ATTACHED(iLocal_49)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_49, 0);
}
PED::REMOVE_PED_FROM_GROUP(iLocal_49);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_49, 0);
}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_56)){
ENTITY::DETACH_ENTITY(iLocal_56, 1, 1);
}
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_49);
if(!PED::IS_PED_INJURED(iLocal_51)){
PED::SET_PED_CONFIG_FLAG(iLocal_51, 317, 1);
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_222(iParam0, 0, 0)) || func_222(iParam0, 1, 0)) || func_222(iParam0, 2, 0)) || func_221(iParam0) !=145) || func_220(iParam0)) || func_219(iParam0)) || func_218(iParam0)) || func_217(iParam0)) || !func_205(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_219(iParam0)){
}
if(func_219(iParam0)){
}
...
iVar0=0;
while (func_223(iParam1, iVar0, &sVar1, &iVar2)){
