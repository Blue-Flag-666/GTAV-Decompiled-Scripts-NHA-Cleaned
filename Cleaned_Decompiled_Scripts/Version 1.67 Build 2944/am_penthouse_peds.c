...
Local_37.f_1=func_46(iScriptParam_39);
...
iVar0=func_2();
if(iVar0 > -1){
if(ENTITY::DOES_ENTITY_EXIST(Local_38[iVar0 /*47*/]) && !ENTITY::IS_ENTITY_DEAD(Local_38[iVar0 /*47*/], 0)){
AUDIO::PLAY_STREAM_FROM_PED(Local_38[iVar0 /*47*/]);
iLocal_36++;
}}}
if(iLocal_36==2){
if(AUDIO::IS_STREAM_PLAYING()){
fVar1=(to_float(Local_37.f_1) / 5f);
...
iVar3=0;
while (iVar3 < 50){
if(Local_38[iVar3 /*47*/].f_46 <=Local_37.f_1){
fVar1=vdist(Local_38[iVar3 /*47*/].f_40, 945f, 15f, 117f);
if(fVar1 < fVar0){
fVar0=fVar1;
iVar2=iVar3;
}}
...
iVar0=0;
while (iVar0 < 50){
if(func_22(&(Local_38[iVar0 /*47*/]))){
if(!ENTITY::DOES_ENTITY_EXIST(Local_38[iVar0 /*47*/])){
func_12(&(Local_38[iVar0 /*47*/]));
}elseif(ENTITY::IS_ENTITY_DEAD(Local_38[iVar0 /*47*/], 0)){
func_11(&(Local_38[iVar0 /*47*/]));
}
func_4(&(Local_38[iVar0 /*47*/]));
}
iVar0++;
}
iLocal_35=0;
...
iVar0=0;
while (iVar0 < 50){
func_41(&(Local_38[iVar0 /*47*/]), iVar0);
iVar0++;
}}
...
if(iParam0 >=Global_262145.f_27240){
return 5;
}elseif(iParam0 >=Global_262145.f_27239){
return 4;
}elseif(iParam0 >=Global_262145.f_27238){
return 3;
}elseif(iParam0 >=Global_262145.f_27237){
return 2;
}
return 1;
}
...
void func_47(){
while (!NETWORK::NETWORK_TRY_TO_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, Global_1579703)){
wait(0);
}
Global_1579703++;
func_48(0, -1, 0);
