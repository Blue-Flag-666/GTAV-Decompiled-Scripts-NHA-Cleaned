...
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_37[bLocal_29 /*3*/]) < fLocal_38){
...
if(func_16()){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_39, Local_40, fLocal_43, 0, 1, 0)){
bLocal_31=true;
iLocal_25=1;
}
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_41, Local_42, fLocal_43, 0, 1, 0)){
bLocal_32=true;
iLocal_25=1;
}
}
...
if(iLocal_35){
if(iLocal_34){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_39, Local_40, fLocal_43, 0, 1, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_41, Local_42, fLocal_43, 0, 1, 0)){
func_15();
func_1();
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 1073741824, 3);
}
}
elseif(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_39, Local_40, fLocal_43, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_41, Local_42, fLocal_43, 0, 1, 0)){
iLocal_34=1;
}
elseif(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_39, Local_40, fLocal_43, 0, 1, 0) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_41, Local_42, fLocal_43, 0, 1, 0)){
func_15();
...
bool bVar0;
if(bLocal_29 < 32){
bVar0=MISC::IS_BIT_SET(Global_113810.f_10052.f_96, bLocal_29);
}elseif(bLocal_29 < 64){
bVar0=MISC::IS_BIT_SET(Global_113810.f_10052.f_97, (bLocal_29 - 32));
}else{
bVar0=MISC::IS_BIT_SET(Global_113810.f_10052.f_98, (bLocal_29 - 64));
}
if(bVar0){}else{
if(!bLocal_45){
if(bLocal_36){
...
void func_17(){
if((MISC::GET_GAME_TIMER() - iLocal_46) > 500){
if(bLocal_29==29){
if(MISC::IS_BIT_SET(Global_113810.f_10052.f_96, bLocal_29)){
bLocal_45=true;
}}
...
if(!func_24()){
uLocal_28=GRAPHICS::REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_28)){
wait(0);
}
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_28, "SHOW_BRIDGES_KNIVES_PROGRESS");
if(bLocal_36){
func_23("FU_KNIFE");
...
break;
case 1:
if((((((timerb() > 3750 || CAM::IS_SCREEN_FADED_OUT()) || !PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || func_24()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || func_22()) || func_21()){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_28, "SHARD_ANIM_OUT");
...
break;
case 2:
if((((((timerb() > 500 || CAM::IS_SCREEN_FADED_OUT()) || !PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || func_24()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || func_22()) || func_21()){
iLocal_26=3;
}else{
func_20();
if(Global_32519 > iLocal_30){
...
void func_19(){
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_28)){
...
if(!func_24()){
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_28)){
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_28, 0.5f, 0.5f, 1f, 1f, 100, 100, 100, 255, 0);
}}}
...
if(MISC::IS_BIT_SET(Global_113810.f_10052.f_97, (bLocal_29 - 32))){
bLocal_45=true;
}}elseif(MISC::IS_BIT_SET(Global_113810.f_10052.f_98, (bLocal_29 - 64))){
bLocal_45=true;
}
if(bLocal_45){}else{
func_28(bLocal_29);
...
func_49(13, floor(Global_113810.f_10197.f_3853));
}
...
bVar1=false;
while (bVar1 < 32){
if(MISC::IS_BIT_SET(Global_113810.f_10052.f_96, bVar1)){
if(func_51(bVar1)){
iVar0++;
}}
if(MISC::IS_BIT_SET(Global_113810.f_10052.f_97, bVar1)){
if(func_51(bVar1 + 32)){
iVar0++;
}}
if(MISC::IS_BIT_SET(Global_113810.f_10052.f_98, bVar1)){
if(func_51(bVar1 + 64)){
iVar0++;
}}
bVar1++;
