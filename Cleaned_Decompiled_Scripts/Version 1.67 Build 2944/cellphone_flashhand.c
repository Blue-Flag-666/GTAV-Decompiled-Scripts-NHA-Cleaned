...
HUD::GET_HUD_COLOUR(18, &iLocal_103, &iLocal_104, &iLocal_105, &uLocal_106);
func_113(Global_20481, "SET_SOFT_KEYS_COLOUR", 2f, to_float(iLocal_103), to_float(iLocal_104), to_float(iLocal_105), -1082130432);
HUD::GET_HUD_COLOUR(9, &iLocal_103, &iLocal_104, &iLocal_105, &uLocal_106);
func_113(Global_20481, "SET_SOFT_KEYS_COLOUR", 1f, to_float(iLocal_103), to_float(iLocal_104), to_float(iLocal_105), -1082130432);
HUD::GET_HUD_COLOUR(6, &iLocal_103, &iLocal_104, &iLocal_105, &uLocal_106);
func_113(Global_20481, "SET_SOFT_KEYS_COLOUR", 3f, to_float(iLocal_103), to_float(iLocal_104), to_float(iLocal_105), -1082130432);
}else{
if(!MISC::IS_JAPANESE_VERSION()){
HUD::GET_HUD_COLOUR(9, &iLocal_103, &iLocal_104, &iLocal_105, &uLocal_106);
func_113(Global_20481, "SET_SOFT_KEYS_COLOUR", 2f, to_float(iLocal_103), to_float(iLocal_104), to_float(iLocal_105), -1082130432);
HUD::GET_HUD_COLOUR(126, &iLocal_103, &iLocal_104, &iLocal_105, &uLocal_106);
func_113(Global_20481, "SET_SOFT_KEYS_COLOUR", 1f, to_float(iLocal_103), to_float(iLocal_104), to_float(iLocal_105), -1082130432);
HUD::GET_HUD_COLOUR(6, &iLocal_103, &iLocal_104, &iLocal_105, &uLocal_106);
func_113(Global_20481, "SET_SOFT_KEYS_COLOUR", 3f, to_float(iLocal_103), to_float(iLocal_104), to_float(iLocal_105), -1082130432);
}
...
iLocal_95=ENTITY::GET_ENTITY_HEALTH(PLAYER::PLAYER_PED_ID());
}
...
func_113(Global_20481, "SET_THEME", to_float(Global_4542578), -1082130432, -1082130432, -1082130432, -1082130432);
func_106();
if(func_122()){
if(Global_1836503==1){
Global_4542579=16;
...
if((NETWORK::NETWORK_CLAN_PLAYER_IS_ACTIVE(&Var1) && NETWORK::NETWORK_HAVE_USER_CONTENT_PRIVILEGES(0)) && Global_4542582==0){
...
func_113(Global_20481, "SET_BACKGROUND_IMAGE", to_float(0), -1082130432, -1082130432, -1082130432, -1082130432);
}}else{
func_113(Global_20481, "SET_BACKGROUND_IMAGE", to_float(0), -1082130432, -1082130432, -1082130432, -1082130432);
}}else{
func_113(Global_20481, "SET_BACKGROUND_IMAGE", to_float(Global_4542579), -1082130432, -1082130432, -1082130432, -1082130432);
}}else{
if(Global_20443){
Global_20706=0;
}elseif(Global_113810.f_14054.f_88==1 || Global_113810.f_14054.f_89==1){
Global_20706=0;
}else{
Global_20706=0;
}
func_113(Global_20481, "SET_THEME", to_float(Global_113810.f_14054[Global_20500 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
if(Global_9174==0){
func_113(Global_20481, "SET_BACKGROUND_IMAGE", to_float(Global_113810.f_14054[Global_20500 /*20*/].f_9), -1082130432, -1082130432, -1082130432, -1082130432);
}else{
...
func_84();
func_83(1);
AUDIO::PLAY_SOUND_FRONTEND(-1, "Pull_Out", &Global_20489, 1);
settimerb(0);
...
if(func_82(14)){
func_113(Global_20481, "DISPLAY_VIEW", 1f, to_float(6), -1082130432, -1082130432, -1082130432);
}else{
func_113(Global_20481, "DISPLAY_VIEW", 1f, to_float(Global_20504), -1082130432, -1082130432, -1082130432);
}
...
while (true){
wait(0);
if(MISC::IS_BIT_SET(Global_4542302, 24)){
if(!Global_20705){
...
func_113(Global_20481, "DISPLAY_VIEW", 1f, to_float(Global_20480), -1082130432, -1082130432, -1082130432);
}}}}
if(func_75()){
...
if(Global_20500.f_1 > 4){
if((MISC::IS_BIT_SET(Global_8370, 14) && Global_4542581==0) && Global_20440==0){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(func_74()){
...
Global_20707=1;
}}elseif((Global_43377==15 && func_64(0)==0) && Global_8375==0){
if(!Global_20705){
if(Global_20500.f_1==6){
Global_8376=255;
func_113(Global_20481, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
...
Global_20708=1;
}}elseif(!MISC::IS_BIT_SET(Global_8371, 3)){
if(!Global_20705){
if(Global_20500.f_1==6){
func_113(Global_20481, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
func_85();
...
if(Global_21898==1 || MISC::IS_BIT_SET(Global_8371, 23)){
...
if(MISC::IS_BIT_SET(Global_8370, 17)){
...
func_53();
func_52();
HUD::SET_TEXT_RENDER_ID(iLocal_82);
if(Global_20486==1){
...
if(MISC::IS_BIT_SET(Global_8371, 25)){
if(Global_78689==1){
func_49();
}}elseif(!MISC::IS_BIT_SET(Global_8371, 24)){
if(MISC::IS_BIT_SET(Global_8371, 26)){
if(func_62(2, Global_20467, 0)){
MISC::SET_BIT(&Global_8371, 25);
MISC::CLEAR_BIT(&Global_8371, 26);
MISC::CLEAR_BIT(&Global_8372, 2);
}}}elseif(Global_78689==1){
func_48();
}}}
if(iLocal_73){
if(Global_20500.f_1==6){
func_44();
}}elseif(!MISC::IS_BIT_SET(Global_8370, 23)){
if(Global_20500.f_1==5 || Global_20500.f_1==6){
if(Global_20704==0){
...
elseif(Global_2694571){
func_42();
}
}}elseif(MISC::IS_BIT_SET(Global_8372, 9)){
func_41();
}else{
func_24();
}}
...
elseif(Global_22904==0){
if(!MISC::IS_BIT_SET(Global_4542302, 3)){
if(Global_78689){
func_21();
}
func_20();
...
if(!MISC::IS_BIT_SET(Global_4542302, 3)){
if(Global_22904==1){
if(MISC::IS_BIT_SET(Global_4542302, 1)){
if(MISC::IS_BIT_SET(Global_8370, 14)){
if(Global_78689){
func_22(7, 0, 1, 0);
}else{
...
elseif(MISC::IS_BIT_SET(Global_8370, 14)){
func_22(7, 0, 1, 0);
Global_22904=0;
}}else{
if(Global_22904==3){
...
}}}}}elseif(SCRIPT::HAS_SCRIPT_LOADED(&(Global_8377[Global_20503 /*15*/].f_5))){
if(Global_20503==0){
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_8377[Global_20503 /*15*/].f_9)==0){
Global_20498=start_new_script(&(Global_8377[Global_20503 /*15*/].f_5), 4000);
}}else{
iVar5=0;
if(Global_20503==23){
if(MISC::IS_BIT_SET(Global_4542302, 4)==0 && Global_1836104==0){
}}
if(Global_20503==2 || iVar5==1){
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_8377[Global_20503 /*15*/].f_9)==0){
Global_20498=start_new_script(&(Global_8377[Global_20503 /*15*/].f_5), 4592);
}}elseif(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_8377[Global_20503 /*15*/].f_9)==0){
Global_20498=start_new_script(&(Global_8377[Global_20503 /*15*/].f_5), 2552);
}}
...
if(Global_78689){
if(!MISC::IS_BIT_SET(Global_8372, 0)){
...
if(MISC::IS_BIT_SET(Global_4718592.f_37, 17) && (NETWORK::NETWORK_IS_ACTIVITY_SESSION() || Global_1927335)){
func_5(1, 1);
...
iLocal_102=(iLocal_99 - iLocal_98);
if(iLocal_102 < 4000){
MISC::SET_BIT(&Global_8371, 4);
}else{
iLocal_100=0;
...
if(Global_78689){
WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iLocal_108, 1);
if(iLocal_108 !=joaat("weapon_unarmed") && Global_20500.f_1 < 7){
MISC::SET_BIT(&Global_8371, 4);
}}}
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
uLocal_109=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(ENTITY::GET_ENTITY_MODEL(uLocal_109)==joaat("submersible") || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("submersible2")){
iLocal_112=1;
}else{
iLocal_112=0;
}
if(((((ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("rhino") || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("cutter")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("chernobog")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("khanjali")) || iLocal_112) || VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_109, 0)==0){
MISC::SET_BIT(&Global_8371, 4);
}
if(((((((((((((((ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("valkyrie") || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("insurgent")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("technical")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("trash")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("trash2")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("limo2")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("insurgent3")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("halftrack")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("dune3")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("trailersmall2")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("technical2")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("boxville5")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("mogul")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("bombushka")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("tula")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("chernobog")){
if(PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_109)){
iVar6=func_2(PLAYER::PLAYER_PED_ID(), iLocal_109);
if(iVar6 !=-2){
if(ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("insurgent") || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("limo2")){
if(iVar6==3){
MISC::SET_BIT(&Global_8371, 4);
}}
if(ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("trash") || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("trash2")){
if(iVar6==2 || iVar6==1){
MISC::SET_BIT(&Global_8371, 4);
}}
if(ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("technical2")){
if(iVar6==1){
MISC::SET_BIT(&Global_8371, 4);
}}
if(ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("boxville5")){
if(iVar6==3){
MISC::SET_BIT(&Global_8371, 4);
}}
if(ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("insurgent3")){
if(iVar6==3){
MISC::SET_BIT(&Global_8371, 4);
}}
if(ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("halftrack")){
if(iVar6==1){
MISC::SET_BIT(&Global_8371, 4);
}}
if(ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("dune3")){
if(iVar6==0){
MISC::SET_BIT(&Global_8371, 4);
}}
if(ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("trailersmall2")){
if(iVar6==-1){
MISC::SET_BIT(&Global_8371, 4);
}}
if(VEHICLE::IS_TURRET_SEAT(iLocal_109, iVar6)){
MISC::SET_BIT(&Global_8371, 4);
}}
}}
...
if(Global_20500.f_1==6 || Global_20500.f_1==7){
bVar7=true;
if(ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("stromberg") && ENTITY::IS_ENTITY_IN_WATER(iLocal_109)){
bVar7=false;
}
if(((VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iLocal_109)) || VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(iLocal_109))) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("submersible")) || ENTITY::GET_ENTITY_MODEL(iLocal_109)==joaat("submersible2")){
bVar7=false;
}
if(bVar7){
func_65(0);
...
if(Global_78689==0){
if(ENTITY::GET_ENTITY_HEALTH(PLAYER::PLAYER_PED_ID()) < iLocal_95){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
Global_20485=1;
func_68();
func_65(0);
...
if(!func_75()){
WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iLocal_108, 1);
if((iLocal_108==joaat("weapon_sniperrifle") || iLocal_108==joaat("weapon_heavysniper")) || iLocal_108==joaat("weapon_remotesniper")){
bLocal_107=true;
}else{
bLocal_107=false;
}
...
iVar8=1;
if(!MISC::IS_BIT_SET(Global_8371, 24)){
if(MISC::IS_BIT_SET(Global_8371, 26)){
MISC::SET_BIT(&Global_8371, 25);
MISC::CLEAR_BIT(&Global_8371, 26);
MISC::CLEAR_BIT(&Global_8372, 2);
...
fVar0=350f;
if(MISC::IS_BIT_SET(Global_8370, 30) || MISC::IS_BIT_SET(Global_8372, 2)){
fVar0=25f;
}
Var1={
Global_20460 
...
if((MISC::IS_BIT_SET(Global_8371, 26) || MISC::IS_BIT_SET(Global_8370, 30)) || MISC::IS_BIT_SET(Global_8372, 2)){
Local_114={
Global_20446[Global_20445 /*3*/] 
};
}else{
...
fVar2=func_15(Local_114, Global_20446[Global_20445 /*3*/], Global_20460, Var1, fVar0, 0);
if(!iLocal_83 && fVar2 >=1f){
MOBILE::DESTROY_MOBILE_PHONE();
iLocal_83=1;
}
if(iLocal_83 && (MISC::GET_GAME_TIMER() - iLocal_16) > 500){
PAD::SET_INPUT_EXCLUSIVE(0, Global_20470);
if(Global_20500.f_1==3){
}
if(Global_20500.f_1==1){
...
fVar1=func_17((to_float((MISC::GET_GAME_TIMER() - iLocal_16)) / fParam4), 0f, 1f);
if(fVar1 < 1f){
fVar2=fVar1;
if(bParam5){
fVar2=(fVar2 - 1f);
...
func_83(2);
func_19();
func_113(Global_20481, "DISPLAY_VIEW", 1f, to_float(Global_20505), -1082130432, -1082130432, -1082130432);
...
void func_20(){
if(MISC::IS_BIT_SET(Global_8371, 10) || iLocal_115==1){
Global_8977=MISC::GET_GAME_TIMER();
Global_8976=0;
Global_20478=1;
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_20481, "GET_CURRENT_SELECTION");
uLocal_72=GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
iLocal_73=1;
...
void func_26(){
func_113(Global_20481, "SET_INPUT_EVENT", to_float(1), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_29(){
func_113(Global_20481, "SET_INPUT_EVENT", to_float(4), -1082130432, -1082130432, -1082130432, -1082130432);
AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_20489, 1);
func_30();
}
...
void func_31(){
func_113(Global_20481, "SET_INPUT_EVENT", to_float(3), -1082130432, -1082130432, -1082130432, -1082130432);
AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_20489, 1);
func_32();
}
...
void func_33(){
func_113(Global_20481, "SET_INPUT_EVENT", to_float(2), -1082130432, -1082130432, -1082130432, -1082130432);
AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_20489, 1);
func_34();
}
...
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
func_19();
func_113(Global_20481, "DISPLAY_VIEW", 4f, to_float(0), -1082130432, -1082130432, -1082130432);
func_113(Global_20481, "DISPLAY_VIEW", 1f, to_float(0), -1082130432, -1082130432, -1082130432);
func_80();
}
...
var uVar1;
char* sVar2;
if(GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_72)){
iLocal_73=0;
iLocal_71=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_72);
if(Global_20705==0){
...
if(MISC::IS_BIT_SET(Global_8371, 10)){
Global_20503=2;
MISC::CLEAR_BIT(&Global_8371, 10);
}
if(iLocal_115==1){
...
if(PAD::IS_CONTROL_PRESSED(0, 25) || PAD::IS_CONTROL_PRESSED(0, 68)){
WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iLocal_108, 1);
if(iLocal_108 !=joaat("weapon_unarmed")){
iVar0=1;
}}}}}
if(Global_20503==2){
...
if(Global_20503==23){
if(((MISC::IS_BIT_SET(Global_4542302, 4)==0 && Global_1836104==0) && MISC::IS_BIT_SET(Global_4542302, 20)==0) && MISC::IS_BIT_SET(Global_4542302, 22)==0){
}
if((((MISC::IS_BIT_SET(Global_4542302, 20)==1 && MISC::IS_BIT_SET(Global_4542302, 4)==0) && Global_1836104==0) && MISC::IS_BIT_SET(Global_4542302, 22)==0) && MISC::IS_BIT_SET(Global_4542302, 26)==0){
iVar0=1;
...
MISC::CLEAR_BIT(&Global_8370, 17);
Global_20500.f_1=7;
if(MISC::IS_BIT_SET(Global_8370, 23)){
}else{
func_38();
...
float fVar0;
float fVar1;
if(MISC::IS_BIT_SET(Global_8372, 2)){
...
fVar1=func_15(Global_20446[Global_20445 /*3*/], Local_81, -90f, 0f, 90f, -90f, 0f, 90f, 450f, 1);
if(fVar1 >=1f){
MISC::SET_BIT(&Global_8371, 8);
MISC::SET_BIT(&Global_8370, 14);
Global_20440=0;
...
void func_52(){
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
iLocal_102=NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), uLocal_101);
}else{
iLocal_97=MISC::GET_GAME_TIMER();
iLocal_102=(iLocal_97 - iLocal_96);
}
if(iLocal_102 > 4000){
iLocal_85=func_104();
...
if(MISC::IS_BIT_SET(Global_8371, 8)){
if(Global_21892==0){
func_45();
Global_20478=1;
Global_20499=3;
...
if(iLocal_94==0){
if(MISC::IS_BIT_SET(Global_8370, 27)){
iLocal_94=1;
settimerb(0);
}}else{
if(Global_20500.f_1 > 3){
...
}elseif(!MISC::IS_BIT_SET(Global_8372, 5)){
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "Put_Away", &Global_20489, 1);
}
iLocal_16=0;
Global_20500.f_1=3;
}
...
break;
case 7:
if(MISC::IS_BIT_SET(Global_8370, 23)==1){
}
if((Global_8978 - Global_8977) > Global_8979 && MISC::IS_BIT_SET(Global_8370, 23)==0){
...
func_36("CELL_217");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}elseif(func_57(Global_7685, Global_20500)==0){
func_81(Global_20481, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(2), -1f, -1f, &(Global_117[Global_7685 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
}else{
func_81(Global_20481, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(2), -1f, -1f, &(Global_2058[Global_7685 /*29*/].f_3), &(Global_2058[Global_7685 /*29*/].f_7), "CELL_217", &(Global_2058[Global_7685 /*29*/].f_3), 0);
}
func_113(Global_20481, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
...
func_81(Global_20481, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_117[Global_7685 /*10*/].f_4), "CELL_300", &Var0, "CELL_195", 0);
}else{
func_113(Global_20481, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
func_81(Global_20481, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_2058[Global_7685 /*29*/].f_3), &(Global_2058[Global_7685 /*29*/].f_7), &Var0, &(Global_2058[Global_7685 /*29*/].f_3), 0);
}}
func_113(Global_20481, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
}
func_55();
...
func_81(Global_20481, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_117[Global_7685 /*10*/].f_4), "CELL_300", "CELL_219", "CELL_195", 0);
}else{
func_81(Global_20481, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_2058[Global_7685 /*29*/].f_3), &(Global_2058[Global_7685 /*29*/].f_7), "CELL_219", &(Global_2058[Global_7685 /*29*/].f_3), 0);
}}
func_113(Global_20481, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
}}
...
struct<2> Var0;
MOBILE::GET_MOBILE_PHONE_POSITION(&Var0);
if(Global_20446[Global_20445 /*3*/].f_1==Var0.f_1){}else{
Global_4542581=1;
}}
...
void func_79(){
MOBILE::GET_MOBILE_PHONE_RENDER_I(&iLocal_82);
if(iLocal_82==-1){}}
...
if(Global_2694571){
if(iVar1==14){
func_81(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(Global_22908), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}}
Global_8939[iVar0]=1;
}}}
iVar1++;
...
func_81(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(Global_22913), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}elseif(iVar1==7){
if(Global_78689){
iVar4=0;
...
func_81(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}else{
switch (Global_20500){
case 0:
iVar6=Global_44580;
...
func_81(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}}elseif(iVar1==14){
func_81(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(Global_22908), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}elseif(iVar1==20){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_20481, "SET_DATA_SLOT");
...
func_81(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}else{
func_81(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}
Global_8939[iVar0]=1;
}}}
iVar1++;
...
void func_92(){
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
iLocal_110=ZONE::GET_ZONE_SCUMMINESS(ZONE::GET_ZONE_AT_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)));
}
switch (iLocal_110){
case 0:
iLocal_86=5;
...
iLocal_111=MISC::GET_RANDOM_INT_IN_RANGE(0, 8);
if(iLocal_111 < 2){
if(iLocal_86 > 2){
iLocal_86=(iLocal_86 - 1);
}}
if(iLocal_112==1 || func_93()){
iLocal_86=0;
}
func_113(Global_20481, "SET_PROVIDER_ICON", to_float(iLocal_85), to_float(iLocal_86), -1082130432, -1082130432, -1082130432);
}
...
iVar2=0;
while (iVar2 < Global_113810.f_7691.f_136){
if(MISC::IS_BIT_SET(Global_113810.f_7691[iVar2 /*15*/].f_2, bVar0)){
...
if(MISC::IS_BIT_SET(Global_113810.f_7691.f_651[iVar2 /*14*/].f_2, bVar0)){
...
iVar2=0;
while (iVar2 < Global_113810.f_7691.f_866){
if(MISC::IS_BIT_SET(Global_113810.f_7691.f_765[iVar2 /*10*/].f_2, bVar0)){
...
if(iParam1 !=-1){
if(iParam1 >=Global_43378){
return 0;
}
if(vdist2(Param0, Global_43378[iParam1 /*5*/]) <=(Global_43378[iParam1 /*5*/].f_3 * Global_43378[iParam1 /*5*/].f_3)){
return 1;
}elseif(Global_43378[iParam1 /*5*/].f_4 !=-1){
return func_96(Param0, Global_43378[iParam1 /*5*/].f_4);
}}
return 0;
}
...
var uVar1;
if(iParam0 !=14385){
uVar0=func_108(iParam0, iParam1);
...
var func__108(int iParam0, var uParam1){
...
if(Global_20500.f_1==6){
if(Global_20480==7){
func_113(Global_20481, "DISPLAY_VIEW", 1f, to_float(7), -1082130432, -1082130432, -1082130432);
}else{
Global_20480=6;
func_113(Global_20481, "DISPLAY_VIEW", 1f, to_float(6), -1082130432, -1082130432, -1082130432);
}}}elseif(Global_20500.f_1==6){
func_113(Global_20481, "DISPLAY_VIEW", 1f, to_float(6), -1082130432, -1082130432, -1082130432);
}}
iLocal_88=CLOCK::GET_CLOCK_MINUTES();
if(iLocal_88 !=Global_8373){
Global_8373=iLocal_88;
iLocal_87=CLOCK::GET_CLOCK_HOURS();
iLocal_89=CLOCK::GET_CLOCK_DAY_OF_WEEK();
switch (iLocal_89){
case 0:
StringCopy(&cLocal_90, "CELL_920", 16);
break;
case 1:
StringCopy(&cLocal_90, "CELL_921", 16);
break;
case 2:
StringCopy(&cLocal_90, "CELL_922", 16);
break;
case 3:
StringCopy(&cLocal_90, "CELL_923", 16);
break;
case 4:
StringCopy(&cLocal_90, "CELL_924", 16);
break;
case 5:
StringCopy(&cLocal_90, "CELL_925", 16);
break;
case 6:
StringCopy(&cLocal_90, "CELL_926", 16);
break;
default:
StringCopy(&cLocal_90, "CELL_206", 16);
break;
}
func_81(Global_20481, "SET_TITLEBAR_TIME", to_float(iLocal_87), to_float(iLocal_88), -1f, -1f, -1f, &cLocal_90, 0, 0, 0, 0);
if(Global_20443==0){
func_92();
}
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
...
Global_2801145=0;
Global_2801145.f_2=0;
}elseif(func_118(Global_2801145.f_20)){
...
if(MISC::IS_PC_VERSION()){
if(DECORATOR::DECOR_EXIST_ON(PLAYER::PLAYER_PED_ID(), "Synched")){
}elseif(((MISC::GET_GAME_TIMER() - iLocal_113) >=300 || iLocal_113==0) || iLocal_113 > MISC::GET_GAME_TIMER()){
PAD::SET_CONTROL_SHAKE(0, 100, 100);
iLocal_113=MISC::GET_GAME_TIMER();
}}elseif(Global_113810.f_14054[Global_20500 /*20*/].f_10==1){
if(((MISC::GET_GAME_TIMER() - iLocal_113) >=300 || iLocal_113==0) || iLocal_113 > MISC::GET_GAME_TIMER()){
PAD::SET_CONTROL_SHAKE(0, 100, 100);
iLocal_113=MISC::GET_GAME_TIMER();
}}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
...
AUDIO::PLAY_PED_RINGTONE(&(Global_9175[3 /*2811*/][1 /*281*/].f_144[func_107(1199, -1) /*6*/]), PLAYER::PLAYER_PED_ID(), 1);
}}elseif(!MISC::ARE_STRINGS_EQUAL(&(Global_113810.f_14054[Global_20500 /*20*/].f_11), "Silent Ringtone Dummy")){
if(!Global_9175[Global_20500 /*2811*/][0 /*281*/].f_259==1){
if(MISC::IS_PC_VERSION()){
if(DECORATOR::DECOR_EXIST_ON(PLAYER::PLAYER_PED_ID(), "Synched")){
}
else{
AUDIO::PLAY_PED_RINGTONE(&(Global_113810.f_14054[Global_20500 /*20*/].f_11), PLAYER::PLAYER_PED_ID(), 1);
}}else{
AUDIO::PLAY_PED_RINGTONE(&(Global_113810.f_14054[Global_20500 /*20*/].f_11), PLAYER::PLAYER_PED_ID(), 1);
}}}}}}
