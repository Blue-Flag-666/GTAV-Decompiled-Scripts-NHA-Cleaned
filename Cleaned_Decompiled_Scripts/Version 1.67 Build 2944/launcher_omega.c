...
func_212(Var0.f_0);
func_205(&iLocal_51, &(Var0.f_9), Var1);
if(Var0.f_0==44){
func_197(&Var0, Var1, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_52);
func_196();
}elseif(Var0.f_0==45){
func_197(&Var0, Var1, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_53);
func_194(&Var0);
}
if(func_179(&Var0, 0)){
if(!func_2(&Var0)){
...
float fVar3;
float fVar4;
if((MISC::GET_GAME_TIMER() - iLocal_56) > 1250){
...
bool func_195(int iParam0, int iParam1, float fParam2, int iParam3){
...
float fVar2;
float fVar3;
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_54, "SET_COLOUR");
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_54, "SET_DISTANCE");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(10f);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
HUD::SET_TEXT_RENDER_ID(uLocal_55);
fVar0=0.1f;
fVar1=0.24f;
fVar2=0.21f;
fVar3=0.51f;
...
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_54, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
if((MISC::GET_GAME_TIMER() - iLocal_56) > 1250){
AUDIO::PLAY_SOUND_FROM_COORD(uLocal_57, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
iLocal_56=MISC::GET_GAME_TIMER();
}}

int func_197(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6){
var uVar0;
if(!*uParam6==3){
if(func_185(2)){
if(!func_156()){
...
if(func_204(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam6==1){
...
void func_205(int iParam0, char* sParam1, struct<3> Param2){
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
...
uParam1->f_3=5;
}elseif((func_216(uParam1) && uParam1->f_4==0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f){
uParam1->f_3=3;
}}
break;
case 3:
...
void func_252(){
uLocal_54=GRAPHICS::REQUEST_SCALEFORM_MOVIE("digiscanner");
...
if(HUD::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner")){
uLocal_55=HUD::GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");
}
uLocal_57=AUDIO::GET_SOUND_ID();
iLocal_56=MISC::GET_GAME_TIMER();
}
...
if(!func_257(&(uParam0->f_28[0]), 69, 2319.443f, 2583.588f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1)){
bVar2=false;
}}
...
int func_258(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_36(iParam1)){
...
int func_274(int iParam0, int iParam1, struct<3> Param2, float fParam3){
int iVar0;
if(*iParam0==1){
...
int func_275(int iParam0, struct<3> Param1, float fParam2, var uParam3){
int iVar0;
struct<7> Var1;
iVar0=0;
...
int func_276(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
