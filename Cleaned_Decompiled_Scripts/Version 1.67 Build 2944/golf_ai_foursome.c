...
break;
case 3:
if(((STREAMING::HAS_ANIM_DICT_LOADED(func_337()) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("GOLF_I", 0, -1)) && STREAMING::HAS_ANIM_SET_LOADED("move_m@golfer@")) && func_332(&uVar4)){
func_329(&uVar3);
iVar2=4;
}
break;
...
if(((!CAM::IS_SPHERE_VISIBLE(func_327(&Var1, (2 + iVar5 * 2)), 10f) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_327(&Var1, (2 + iVar5 * 2)), 10f, 10f, 10f, 0, 1, 0)) || ((func_326() || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) || CAM::IS_SCREEN_FADED_OUT())) || func_325(4)){
if(iVar6==0){
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(func_284(uParam2, iVar0), Var7, 1f, -1, 1048576000, 0, 1193033728);
}
}
iVar0++;
}
...
if(!ENTITY::IS_ENTITY_DEAD(func_294(uParam0, iVar5), 0) && !CAM::IS_SPHERE_VISIBLE(Var2 + FtoV(to_float(iVar5)) * Var3, 5f)){
ENTITY::SET_ENTITY_COORDS(func_294(uParam0, iVar5), Var2 + FtoV(to_float(iVar5)) * Var3, 1, 0, 0, 1);
...
return 0;
}elseif((vdist2(Param0, *uParam3) > 100f && !VEHICLE::IS_ANY_VEHICLE_NEAR_POINT(*uParam3, 5f)) && !func_7(*uParam3)){
Var3={
func_6(Vector(0f, uParam3->f_1, *uParam3) - Vector(0f, Param6.f_1, Param6.f_0)) 
};
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(func_64(uParam0), 1), func_41(uParam1, func_313(uParam0))) < IntToFloat(iVar1)){
if(ENTITY::DOES_ENTITY_EXIST(func_25(uParam0)) && !ENTITY::IS_ENTITY_DEAD(func_294(uParam0, func_253(uParam0)), 0)){
if(vdist2(ENTITY::GET_ENTITY_COORDS(func_25(uParam0), 1), func_41(uParam1, func_313(uParam0))) > IntToFloat(iVar1)){
return 1;
}
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(func_64(uParam0), 1), func_19(uParam0)) < IntToFloat(iVar0)){
return 0;
}
return 1;
}
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(func_64(uParam2), 1), func_19(uParam2)) > 9f){
...
struct<3> Var0;
Var0={
func_6(Vector(0f, Param3.f_1, Param3.f_0) - Vector(0f, Param1.f_1, Param1.f_0)) * Vector(9f, 9f, 9f) 
};
...
Var7={
func_6(cos(fVar6), sin(fVar6), 0f) 
};
Var8={
func_115(Var7, 0) 
};
Var9={
Var7 * Vector(-Var5.f_0, -Var5.f_0, -Var5.f_0) * Vector(0.05f, 0.05f, 0.05f) + Var8 * Vector(Var5.f_1, Var5.f_1, Var5.f_1) * Vector(0.2f, 0.2f, 0.2f) 
};
GRAPHICS::DRAW_DEBUG_LINE(ENTITY::GET_ENTITY_COORDS(iVar0, 1), ENTITY::GET_ENTITY_COORDS(iVar0, 1) + func_6(Var9), 0, 0, 0, 255);
if(func_100(uParam0, uParam1, uParam2)){
return;
}
if(ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iVar0)){
...
if(!bLocal_228){
Var9={
Var7 * Vector(-Var5.f_0, -Var5.f_0, -Var5.f_0) * Vector(0.2f, 0.2f, 0.2f) + Var8 * Vector(Var5.f_1, Var5.f_1, Var5.f_1) * Vector(0.2f, 0.2f, 0.2f) 
};
Var9={
...
Var16={
FtoV(func_8(Local_235, Var15)) * Var15 
};
Var14={
FtoV(-(1f + fVar11)) * Var16 + Local_235 
};
Var17={
Local_235 - Var16 
};
Var14={
Var14 - Var17 * Vector(fVar13, fVar13, fVar13) 
};
...
if(fVar10 !=1f){
Var18={
Var18 * Vector(fVar10, fVar10, fVar10) 
};
...
if(func_110(uParam2)){
PAD::SET_CONTROL_SHAKE(0, 50, func_108(0, func_109(256, (MISC::ABSI(round(uParam2->f_1.f_6)) + MISC::ABSI(round(uParam2->f_1.f_5))) + 30)));
}
...
func_78(uParam2, vdist(ENTITY::GET_ENTITY_COORDS(iVar0, 1), func_19(uParam2)));
func_74(uParam2, 2);
func_169(&(uParam2->f_159));
func_106(uParam2);
}}elseif(func_97() && !func_98(uParam1, uParam2)){
func_92(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, 1), func_41(uParam1, func_313(uParam2)));
}elseif((fVar3 < 0.5f && (MISC::ABSF(uParam2->f_1.f_5) + MISC::ABSF(uParam2->f_1.f_6)) < 0.05f) || (fVar3 < 6f && func_98(uParam1, uParam2))){
if(!func_96(&(uParam2->f_159))){
func_59(uParam2, ENTITY::GET_ENTITY_COORDS(iVar0, 1), func_99(ENTITY::GET_LAST_MATERIAL_HIT_BY_ENTITY(iVar0)));
func_58(uParam2, ENTITY::GET_COLLISION_NORMAL_OF_LAST_HIT_FOR_ENTITY(iVar0));
func_260(&(uParam2->f_159));
...
Vector3 func__115(struct<3> Param0, int iParam1){
struct<3> Var0;
switch (iParam1){
case 0:
Var0.f_0=-Param0.f_1;
...
return 1;
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, func_119(0), &cVar1, 3)){
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iParam0, func_119(0), &cVar1) >=fParam1){
return 1;
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, func_119(0), &cVar2, 3)){
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iParam0, func_119(0), &cVar2) >=fParam1){
return 1;
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, func_119(0), &cVar3, 3)){
...
fVar1=func_142(&(uParam2->f_15[func_270(uParam2) /*34*/]), uParam0, &(uParam2->f_1), bVar0, !bLocal_226, 0);
fVar2=1f;
...
if(func_194(uParam2)){
Var6={
(cos(fVar4) * fVar1), (sin(fVar4) * fVar1), 0f 
};
}else{
fVar11=(1f - fVar3);
...
Var8={
func_6(cos(fVar4), sin(fVar4), 0f) 
};
Var9={
-func_6(Var8 - FtoV(func_8(Var8, Var7)) * Var7) 
};
Var10={
func_6(-Var8 * Vector(fVar12, fVar12, fVar12) + Var7 * Vector(fVar13, fVar13, fVar13)) 
};
Var14={
func_6(Var9 * Vector(fVar12, fVar12, fVar12) + Var7 * Vector(fVar13, fVar13, fVar13)) 
};
fVar15=func_8(Var8, func_6(Var14.f_0, Var14.f_1, 0f));
fVar16=func_27(((Var8.f_0 * Var14.f_1) - (Var8.f_1 * Var14.f_0)) < 0f, -1f, 1f);
if(MISC::ABSF(fVar15) < cos(15f)){
Var14={
func_131(Var14, (fVar16 * (MISC::ACOS(MISC::ABSF(fVar15)) - 15f))) 
};
}
Var10.f_1=((Var14.f_1 / MISC::ABSF(Var14.f_1)) * sqrt(MISC::ABSF((((Var10.f_2 * Var10.f_2) - 1f) / (((Var14.f_0 * Var14.f_0) / (Var14.f_1 * Var14.f_1)) + 1f)))));
...
Vector3 func__131(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
Vector3 func__132(bool bParam0, struct<3> Param1, struct<3> Param2){
if(bParam0){
return Param1;
}
return Param2;
...
float fVar0;
fVar0=sin(MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f));
if(fVar0 < 0f){
fVar0=(fVar0 + 1f);
}else{
fVar0=(fVar0 - 1f);
...
if(uParam2->f_12 > 0){
uParam2->f_12=(uParam2->f_12 + floor((MISC::GET_FRAME_TIME() * 1000f)));
}
...
return (pow((Var0.f_0 - Var1.f_0), 2f) + pow((Var0.f_1 - Var1.f_1), 2f));
}
...
if(bLocal_0){
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iVar0, func_119(0), &cVar10, 3)){
...
Vector3 func__180(struct<3> Param0, struct<3> Param1){
struct<3> Var0;
Var0={
Param1 * FtoV(func_8(Param0, Param1)) 
};
return Var0;
}


Vector3 func__181(struct<3> Param0, struct<3> Param1){
...
Vector3 func__182(struct<3> Param0, struct<3> Param1){
struct<3> Var0;
Var0={
Param0 - func_180(Param0, Param1) 
};
return Var0;
}
...
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_19(uParam0), (func_116(uParam0) + fVar1), (((-func_144(uParam1, func_140(uParam0)) * func_197(func_136(uParam0))) * func_143(func_28(&(uParam0->f_15[func_270(uParam0) /*34*/])))) * ((func_165(uParam0, 1) * fVar2) / 100f)), 0f, 0f) 
};
...
if(MISC::GET_GROUND_Z_FOR_3D_COORD(Var1 + Vector(1f, 0f, 0f), &fVar3, 0, 0)){
...
if(((bParam7 && func_220(PLAYER::PLAYER_ID(), 1, 0)) && STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && Global_2657704[PLAYER::PLAYER_ID() /*463*/].f_232==1){
}elseif(func_219()==28){
}else{
return 0;
}}}
...
if(func_216(&(Global_2672524.f_1031), Param0, fParam1, iVar0)){
func_225(bParam4, bParam7);
return 1;
}}else{
if(bParam7){
...
func_228();
if(!MISC::IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_31, 14) && !func_227()){
func_226();
}}
...
fVar1=144f;
bVar6=vdist2(ENTITY::GET_ENTITY_COORDS(func_294(uParam0, func_272(uParam0, iParam1)), 1), uParam0->f_15[iParam1 /*34*/].f_10) < fVar1;
if(!PED::IS_PED_IN_VEHICLE(iVar2, func_274(uParam0, iParam1), 0) && !bVar6){
...
if(iVar8 && bParam3){
func_277(uParam0, 2);
}}elseif((vdist2(func_265(uParam0, iParam1), func_41(uParam2, func_313(uParam0))) < 1600f && vdist2(ENTITY::GET_ENTITY_COORDS(func_274(uParam0, iParam1), 1), func_41(uParam2, func_313(uParam0))) < 1600f) && !func_298(uParam0, iParam1, 67108864)){
...
if(MISC::GET_GROUND_Z_FOR_3D_COORD(Var4, &uVar3, 0, 0)){
...
Var7={
Var2 + Var6 * Vector(fVar5, fVar5, fVar5) * Vector(0.5f, 0.5f, 0.5f) 
};
...
func_267(uParam2, -1);
if(MISC::GET_GROUND_Z_FOR_3D_COORD(Var2, &uVar3, 0, 0)){
Var2.f_2=uVar3;
...
func_285(uParam1, VEHICLE::CREATE_VEHICLE(joaat("caddy"), Var0, uVar1, 1, 1, 0), iVar2);
VEHICLE::SET_VEHICLE_EXTRA(func_294(uParam1, iVar2), 5, 1);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(func_294(uParam1, iVar2), 1);
}}
iVar2++;
}}
...
func_315(uParam1, iParam2, PED::CREATE_PED(iVar2, uVar1, Var0, 0, 1, 1));
