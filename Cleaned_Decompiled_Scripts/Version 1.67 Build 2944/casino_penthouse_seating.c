...
if((((((((((((func_55(uParam0) || func_51(uParam0)) || func_50(uParam0)) || !func_49(uParam0)) || func_47(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) || MISC::IS_BIT_SET(Global_1950844.f_4, 2)) || func_46(uParam0->f_16[uParam0->f_9 /*14*/].f_13)){
...
Var2={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0, 2) 
};
Var3={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_31(uParam0), func_30(uParam0), 0, 2) 
};
uVar4=Var3.f_2;
fVar5=0.05f;
...
}elseif(bVar14 || ((!func_97(PLAYER::PLAYER_ID(), 0) && !func_96()) && !func_95(PLAYER::PLAYER_ID()))){
...
void func_102(){
NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, func_113());
func_111(0, -1, 0);
func_110();
func_103();
...
func_106(func_108(), func_107(iParam3, fVar1)) + Var0 
};
uParam1->f_16[iParam2 /*14*/].f_6.f_4={
func_106(func_105(), func_107(iParam3, fVar1)) + Var0 
};
