...
bVar0=false;
}elseif(!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_88)){
bVar0=false;
NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(iLocal_88);
}}
...
case 0:
if(iLocal_282==-1){
if(TASK::IS_PED_ACTIVE_IN_SCENARIO(iLocal_88)){
iLocal_282=func_501();
}elseif(func_499()){
iLocal_282=4;
}}elseif(func_494()){
if(func_493()){
if(func_551()){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_88)){
TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_88, "WORLD_HUMAN_PROSTITUTE_HIGH_CLASS", 0, 0);
}
else{
NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(iLocal_88);
}
...
if(!PED::IS_PED_IN_VEHICLE(iLocal_89, iLocal_90, 0)){
func_97();
}}}}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_89) || ENTITY::IS_ENTITY_DEAD(iLocal_89, 0)){
func_96(15);
}
switch (iLocal_284){
case 0:
...
iLocal_62=(iLocal_61 - iLocal_60);
if(iLocal_62 >=10000 || !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_88, iLocal_89, 12f, 12f, 5f, 0, 1, 0)){
...
TASK::TASK_VEHICLE_DRIVE_TO_COORD(iLocal_89, iLocal_90, Local_86, (VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(iLocal_90) * 0.65f), 0, 0, 786859, 4f, -1f);
iLocal_284=8;
}
break;
case 8:
if(vdist2(Local_86, ENTITY::GET_ENTITY_COORDS(iLocal_88, 1)) < 25f && TASK::GET_SCRIPT_TASK_STATUS(iLocal_89, joaat("script_task_vehicle_drive_to_coord")) !=1){
iLocal_286=MISC::GET_RANDOM_INT_IN_RANGE(1, 3);
iLocal_284=11;
}
if(func_55(iLocal_89)){
func_96(15);
}
break;
case 11:
...
break;
case 15:
if(ENTITY::DOES_ENTITY_EXIST(iLocal_88) && ENTITY::DOES_ENTITY_EXIST(iLocal_90)){
if(PED::IS_PED_IN_VEHICLE(iLocal_88, iLocal_90, 0)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_89, 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_89, joaat("script_task_leave_any_vehicle")) !=1){
TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_88, 0, 16842752);
}}}else{
func_2(0);
}}
break;
...
switch (iLocal_291){
case 0:
PED::SET_SCRIPTED_ANIM_SEAT_OFFSET(iLocal_88, 0.916f);
if(func_42(iLocal_89)){
func_40(&uLocal_111);
iLocal_291=1;
}
break;
case 1:
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(iLocal_88, 0)) < 22500f){
func_38();
}
func_35(iLocal_90);
if(func_33(iLocal_89)){
func_11(&uLocal_114, "pbproau", "pbpro_pic", 4, 0, 0, 0);
func_96(15);
}
if(func_7(&uLocal_111) > 1f){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_perform_sequence"))==7){
...
ENTITY::APPLY_FORCE_TO_ENTITY(*uParam0, 1, Var0, Var1, 0, 1, 1, 1, 1, 0);
}}


bool func_37(){
return ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_88, 876132797);
}
...
if(MISC::IS_STRING_NULL_OR_EMPTY(sLocal_59)){
sLocal_59=func_50(iParam0, 0, 0);
return 0;
}
if(!STREAMING::HAS_ANIM_DICT_LOADED(sLocal_59)){
return 0;
}else{
func_43(iLocal_88, func_49(), 1, floor((15000f * (1f + (to_float(iLocal_68) / 2f)))), 1);
if(iParam0==PLAYER::PLAYER_PED_ID()){
func_43(iParam0, func_49(), 0, floor((15000f * (1f + (to_float(iLocal_68) / 2f)))), 1);
}
...
struct<3> Var0;
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
if(PED::IS_PED_BEING_JACKED(iParam0) || !func_57(iParam0, iLocal_90, -1)){
Var0={
...
TASK::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_90, 10f, 786603);
TASK::CLOSE_SEQUENCE_TASK(uLocal_93);
TASK::TASK_PERFORM_SEQUENCE(iLocal_89, uLocal_93);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_93);
Local_86={
func_60(ENTITY::GET_ENTITY_COORDS(iLocal_88, 1)) 
};
STREAMING::REQUEST_ANIM_DICT(func_50(iLocal_88, 0, 0));
iLocal_284=7;
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_90, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_89, iLocal_90, 0)){
fVar0=ENTITY::GET_ENTITY_SPEED(iLocal_90);
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_89, iLocal_88, 15f, 15f, 5f, 0, 1, 0) && fVar0 <=1f){
func_69(iLocal_88);
iLocal_61=MISC::GET_GAME_TIMER();
iLocal_62=(iLocal_61 - iLocal_60);
if(iLocal_62 >=iLocal_64){
if(func_551()){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_89)){
...
iLocal_64=MISC::GET_RANDOM_INT_IN_RANGE(0, 10000);
if(iLocal_64 > 2500){
TASK::CLEAR_PED_TASKS(iLocal_88);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_93);
TASK::OPEN_SEQUENCE_TASK(&uLocal_93);
TASK::TASK_ENTER_VEHICLE(0, iLocal_90, -1, 0, 1f, 8388609, 0);
TASK::TASK_STAND_STILL(0, -1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_93);
TASK::TASK_PERFORM_SEQUENCE(iLocal_88, uLocal_93);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_93);
...
TASK::TASK_WANDER_STANDARD(iLocal_88, 1193033728, 0);
}elseif(func_491(iLocal_47, 4194304)){
TASK::OPEN_SEQUENCE_TASK(&uVar0);
if(func_491(iLocal_71, 524288)){
TASK::TASK_PLAY_ANIM(0, func_67(iLocal_282), func_66(7), 8f, -1.5f, -1, 0, 0, 0, 0, 0);
}
func_64(1);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(iLocal_88, uVar0);
...
if(func_491(iLocal_71, 524288)){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_88)){
TASK::TASK_PLAY_ANIM(iLocal_88, func_67(iLocal_282), func_66(7), 8f, -1.5f, -1, 0, 0, 0, 0, 0);
}else{
NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(iLocal_88);
return 0;
}}
...
if(func_491(iLocal_71, 524288)){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_88)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_play_anim"))==7){
func_64(0);
iLocal_52=3;
}}else{
NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(iLocal_88);
...
struct<3> Var0;
if(((TASK::PED_HAS_USE_SCENARIO_TASK(iLocal_88) || TASK::IS_PED_ACTIVE_IN_SCENARIO(iLocal_88)) || PED::IS_PED_USING_SCENARIO(iLocal_88, func_65(0))) || PED::IS_PED_USING_SCENARIO(iLocal_88, func_65(1))){
return;
}
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_88, 1) 
...
if(!bParam0){
TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(iLocal_88, Var0, 20f, 0);
}else{
...
if(!AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_88)){
if(func_23()==2){
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "HOOKER_DECLINED_TREVOR", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}else{
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "HOOKER_DECLINED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}}}
...
if(!PED::IS_PED_INJURED(iParam0)){
if((ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, func_67(iLocal_282), func_66(1), 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, func_67(iLocal_282), func_66(2), 3)) || ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, func_67(iLocal_282), func_66(3), 3)){
return 1;
}}
return 0;
}
...
if(PED::IS_PED_IN_VEHICLE(iLocal_89, iLocal_90, 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_perform_sequence"))==1){
if(TASK::GET_SEQUENCE_PROGRESS(iLocal_88) > 1){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_88, iLocal_89, 20f, 20f, 10f, 0, 1, 0)){
fVar0=ENTITY::GET_ENTITY_SPEED(iLocal_90);
if(fVar0 <=1f){
func_72(0);
iLocal_60=MISC::GET_GAME_TIMER();
iLocal_64=MISC::GET_RANDOM_INT_IN_RANGE(4000, 8000);
...
if(!func_551()){
if(bParam0){
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_88, "PROSTITUTE_GROUP", 0);
...
TASK::TASK_PLAY_ANIM(0, func_67(iLocal_282), func_66(0), 2f, -2f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, func_67(iLocal_282), func_66(iVar0), 2f, -2f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, func_67(iLocal_282), func_66(4), 2f, -2f, -1, 1, 0, 0, 0, 0);
...
if(func_491(iLocal_47, 4194304)){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_88)){
TASK::TASK_PLAY_ANIM(iLocal_88, func_67(iLocal_282), func_66(0), 2f, -2f, -1, 0, 0, 0, 0, 0);
iLocal_51=2;
}else{
NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(iLocal_88);
}}
...
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_play_anim"))==7){
iVar0=MISC::GET_RANDOM_INT_IN_RANGE(1, 4);
TASK::TASK_PLAY_ANIM(iLocal_88, func_67(iLocal_282), func_66(iVar0), 2f, -2f, -1, 0, 0, 0, 0, 0);
iLocal_51=3;
}}else{
NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(iLocal_88);
}
...
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_88)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_play_anim"))==7){
TASK::TASK_PLAY_ANIM(iLocal_88, func_67(iLocal_282), func_66(4), 2f, -2f, -1, 1, 0, 0, 0, 0);
iLocal_51=4;
}}else{
NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(iLocal_88);
}
...
switch (func_23()){
case 0:
if(!func_74(iLocal_88)){
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "SOLICIT_MICHAEL", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}else{
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "SOLICIT_MICHAEL_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}
break;
case 1:
if(!func_74(iLocal_88)){
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "SOLICIT_FRANKLIN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}else{
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "SOLICIT_FRANKLIN_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}
break;
case 2:
if(!func_74(iLocal_88)){
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "SOLICIT_TREVOR", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}else{
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "SOLICIT_TREVOR_RETURN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}
break;
}}}
...
if(PED::IS_PED_IN_VEHICLE(iLocal_89, iLocal_90, 0)){
fVar0=ENTITY::GET_ENTITY_SPEED(iLocal_90);
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_89, joaat("script_task_vehicle_park"))==7 || fVar0 <=1f){
MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iLocal_90), &Var2, &Var1);
Var3={
Var1 - Var2 
};
Var3={
...
Var4={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_90, 0.2f, 0.2f, 0f) 
};
Var5={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_90, 0.2f, 0.2f, 0f) 
};
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_93);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Var4.f_0, Var4.f_1, Var4.f_2, 1f, -1, 0.5f, 8192, 1193033728);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_89, 0);
TASK::TASK_STAND_STILL(0, -1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_93);
TASK::TASK_PERFORM_SEQUENCE(iLocal_88, uLocal_93);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_93);
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_90, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_89, iLocal_90, 0)){
if(func_91(&iLocal_90)){
if(func_90(ENTITY::GET_ENTITY_COORDS(iLocal_89, 1), 1106247680)){
return;
}
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_88, 1) 
...
PED::SET_DRIVER_ABILITY(iLocal_89, 1f);
PED::SET_DRIVER_RACING_MODIFIER(iLocal_89, 0.2f);
PED::SET_DRIVER_AGGRESSIVENESS(iLocal_89, 0.05f);
TASK::TASK_VEHICLE_PARK(iLocal_89, iLocal_90, Var0, 0f, 3, 360f, 1);
TASK::TASK_LOOK_AT_ENTITY(iLocal_89, iLocal_88, -1, 2048, 4);
...
if(((iVar1==0 && VEHICLE::IS_VEHICLE_SEAT_FREE(*iParam0, 0, 0)) && (!VEHICLE::IS_VEHICLE_DOOR_DAMAGED(*iParam0, 1) && !VEHICLE::IS_VEHICLE_DOOR_DAMAGED(*iParam0, 0))) || VEHICLE::GET_PED_IN_VEHICLE_SEAT(*iParam0, 0, 0)==iLocal_88){
if(func_47(*iParam0)){
...
iLocal_89=0;
iLocal_90=0;
TASK::TASK_PLAY_ANIM(iLocal_88, func_67(iLocal_282), func_66(4), 2f, -2f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.9f), 0, 0, 0);
func_96(0);
iLocal_285=0;
iLocal_283=1;
}
...
if(func_471(&uLocal_105, 25f)){
func_5(&iLocal_47, 16384);
func_5(&iLocal_47, 8388608);
}}elseif(iLocal_285 !=0 && !func_470("PROS_NO_MONEY")){
func_64(0);
switch (func_23()){
case 0:
func_469(&uLocal_114, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
break;
case 1:
func_469(&uLocal_114, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
break;
case 2:
func_469(&uLocal_114, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
break;
}
iLocal_284=1;
}else{
...
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_88, 32768, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_88, 196624, 1);
}
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "HOOKER_LEAVES_ANGRY", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
func_96(15);
}}}
...
switch (iLocal_292){
case 0:
if(!AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_88) || func_121(&uLocal_99) > 4f){
func_116(iLocal_88);
if(func_76(func_77(iLocal_88))==1){
iLocal_292=2;
}else{
func_115(&uLocal_99);
...
case 1:
func_113();
if(AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_88) || func_112()){
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 256);
func_482(&iLocal_47, 2048);
}else{
if(!func_10(&uLocal_99)){
func_40(&uLocal_99);
}
if(func_121(&uLocal_99) > 15f || iLocal_295 !=0){
HUD::CLEAR_HELP(1);
func_111();
iLocal_292=2;
}}
...
if(func_551()){
if(NETWORK::NETWORK_HAS_ENTITY_BEEN_REGISTERED_WITH_THIS_THREAD(iLocal_88)){
if(NETWORK::IS_NETWORK_ID_OWNED_BY_PARTICIPANT(NETWORK::NETWORK_GET_NETWORK_ID_FROM_ENTITY(iLocal_88))){
...
if((iVar0 <=333 && iLocal_295==0) || iLocal_295==3){
...
}elseif(((iVar0 > 333 && iVar0 <=666) && iLocal_295==0) || iLocal_295==1){
...
}elseif(iLocal_295==0 || iLocal_295==2){
...
func_11(&uLocal_114, "pbproau", &Var1, 4, 0, 0, 0);
}}
...
iVar0=func_77(iParam0);
if(iVar0 > -1){
func_120(&uLocal_114, 4);
func_469(&uLocal_114, 6, iParam0, func_119(iVar0), 0, 1);
}}
...
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar1, 0, 0) !=iLocal_88){
bVar0=true;
}
...
func_124(&(Local_298[0 /*7*/]));
func_124(&(Local_298[3 /*7*/]));
func_124(&(Local_298[2 /*7*/]));
func_124(&(Local_298[1 /*7*/]));
...
VEHICLE::SET_VEHICLE_BRAKE_LIGHTS(iLocal_91, 1);
}
if(iLocal_291 !=5){
if((((((!func_219(iLocal_72) && !func_219(iLocal_73)) && !func_219(iLocal_74)) && !func_219(iLocal_75)) && !func_219(iLocal_76)) && !func_219(iLocal_77)) && !func_219(iLocal_78)){
if(!PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_88) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(PLAYER::PLAYER_PED_ID())){
iLocal_291=5;
}
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
if(!AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_88)){
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "SEX_FINISHED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}}
...
if(!AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_88)){
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "HOOKER_HAD_ENOUGH", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}}
...
if(func_179(iLocal_73) >=fVar0){
func_482(&iLocal_48, 4);
}}}
if(func_219(iLocal_72)){
...
if(iLocal_69 >=func_168(func_551(), func_174(), func_169())){
func_482(&iLocal_48, 64);
func_5(&iLocal_47, 16777216);
}}}elseif(!func_491(iLocal_48, 64)){
func_482(&iLocal_48, 64);
}
if(func_491(iLocal_48, 64)){
if(!func_551()){
...
}}}elseif(!func_491(iLocal_48, 1024)){
func_482(&iLocal_48, 1024);
}
...
}}}elseif(!func_491(iLocal_48, 2048)){
func_482(&iLocal_48, 2048);
}
if(func_491(iLocal_48, 1024) && func_491(iLocal_48, 2048)){
func_183(iLocal_88, 0);
TASK::TASK_PLAY_ANIM(iLocal_88, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(iLocal_294, 1, bVar1, bVar2), 4f, -4f, -1, 1, 0, 0, 0, 0);
func_183(PLAYER::PLAYER_PED_ID(), -1);
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(iLocal_294, 0, bVar1, bVar2), 4f, -4f, -1, 1, 0, 0, 0, 0);
func_123(1);
iLocal_48=0;
iLocal_69=0;
iLocal_57=0;
...
void func_135(){
int iVar0;
if(iLocal_68==0 && !func_551()){
if(func_26(PLAYER::PLAYER_PED_ID())==0){
func_157();
}
func_152(296, 0, 0);
iVar0=func_77(iLocal_88);
if(iVar0 > -1){
func_151(iVar0);
}else{
func_143(iLocal_88);
...
var func__139(int iParam0, var uParam1){
...
func_155(13, floor(Global_113810.f_10197.f_3853));
}
...
func_159(iLocal_88, iLocal_77, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
func_159(PLAYER::PLAYER_PED_ID(), iLocal_78, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(4, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}


void func_159(int iParam0, int iParam1, var uParam2, var uParam3, float fParam4, float fParam5, int iParam6, int iParam7, float fParam8, int iParam9){
if(func_551()){
...
func_162(&iLocal_77, 1, 0, 0);
func_161(iLocal_88, iLocal_77, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(4, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
func_162(&iLocal_78, 0, 0, 0);
func_161(PLAYER::PLAYER_PED_ID(), iLocal_78, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(4, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}


void func_161(int iParam0, int iParam1, var uParam2, var uParam3, float fParam4, float fParam5, int iParam6, int iParam7, int iParam8){
if(func_551()){
...
*iParam0=func_165(Var0, 0f, 0f, 0f, bParam3, iParam2, 2);
if(iParam1==0){
func_164(*iParam0, iLocal_91, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_91, "seat_dside_f"));
}elseif(iParam1==1){
func_164(*iParam0, iLocal_91, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_91, "seat_pside_f"));
}
func_163(*iParam0, Var0, 0f, 0f, 0f, 0);
}


void func_163(var uParam0, struct<3> Param1, struct<3> Param2, int iParam3){
if(!func_551()){
PED::SET_SYNCHRONIZED_SCENE_ORIGIN(uParam0, Param1, Param2, iParam3);
}}


void func_164(var uParam0, int iParam1, var uParam2){
...
var func__165(struct<3> Param0, struct<3> Param1, bool bParam2, int iParam3, int iParam4){
var uVar0;
if(func_551()){
if(bParam2){
iParam3=0;
}
uVar0=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Param0, Param1, iParam4, bParam2, iParam3, 1065353216, 0, 1065353216);
}else{
uVar0=PED::CREATE_SYNCHRONIZED_SCENE(Param0, Param1, iParam4);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uVar0, bParam2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uVar0, iParam3);
}
return uVar0;
}
...
func_159(iLocal_88, iLocal_76, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
func_159(PLAYER::PLAYER_PED_ID(), iLocal_76, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(3, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
func_161(iLocal_88, iLocal_76, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(3, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
func_161(PLAYER::PLAYER_PED_ID(), iLocal_76, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(3, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
func_159(iLocal_88, iLocal_75, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(2, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
func_159(PLAYER::PLAYER_PED_ID(), iLocal_75, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(2, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
func_162(&iLocal_75, 0, 1, 0);
func_161(iLocal_88, iLocal_75, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(2, 1, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080);
func_161(PLAYER::PLAYER_PED_ID(), iLocal_75, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(2, 0, bParam0, bParam1), 1000f, -1000f, iVar0, 0, 1148846080);
}
...
func_159(iLocal_88, iLocal_74, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
func_159(PLAYER::PLAYER_PED_ID(), iLocal_74, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(1, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f, 0);
}
...
func_162(&iLocal_74, 0, 0, 1);
func_161(iLocal_88, iLocal_74, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(1, 1, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
func_161(PLAYER::PLAYER_PED_ID(), iLocal_74, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(1, 0, bParam0, bParam1), 0.7f, -0.7f, iVar0, 0, 0.7f);
}
...
func_159(iLocal_88, iLocal_72, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(0, 1, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
func_159(PLAYER::PLAYER_PED_ID(), iLocal_73, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(0, 0, bParam0, bParam1), 8f, -0.7f, iVar0, 0, 1000f, 0);
}
...
func_162(&iLocal_72, 1, 0, 1);
func_161(iLocal_88, iLocal_72, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(0, 1, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080);
func_162(&iLocal_73, 0, 0, 1);
func_161(PLAYER::PLAYER_PED_ID(), iLocal_73, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_44(0, 0, bParam0, bParam1), 4f, -1000f, iVar0, 0, 1148846080);
}


void func_183(int iParam0, int iParam1){
if(!PED::IS_PED_IN_VEHICLE(iParam0, iLocal_91, 0)){
if(!func_551()){
PED::SET_PED_INTO_VEHICLE(iParam0, iLocal_91, iParam1);
}elseif(!PED::IS_PED_IN_VEHICLE(iParam0, iLocal_91, 0)){
TASK::TASK_ENTER_VEHICLE(iParam0, iLocal_91, -1, iParam1, 2f, 16, 0);
}}}
...
float fVar7;
float fVar8;
uVar0=func_186(func_187(2), ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_91, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_91, "windscreen")));
uVar1=func_186(func_187(1), ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_91, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_91, "windscreen")));
Var2={
ENTITY::GET_ENTITY_ROTATION(iLocal_91, 2) 
};
fVar3=ENTITY::GET_ENTITY_HEADING(iLocal_91);
if(fVar3 >=180f){
fVar4=(fVar3 - 180f);
}else{
fVar4=(fVar3 + 180f);
...
if(!CAM::DOES_CAM_EXIST(Local_298[2 /*7*/])){
func_185(&(Local_298[2 /*7*/]), func_187(2), fVar5, Var2.f_0, uVar0, 50f);
}
if(!CAM::DOES_CAM_EXIST(Local_298[1 /*7*/])){
func_185(&(Local_298[1 /*7*/]), func_187(1), fVar8, -Var2.f_1, uVar1, 37.3f);
}
if(!CAM::DOES_CAM_EXIST(Local_298[0 /*7*/])){
func_185(&(Local_298[0 /*7*/]), func_187(0), fVar6, -Var2.f_1, fVar4, 50f);
}
if(!CAM::DOES_CAM_EXIST(Local_298[3 /*7*/])){
func_185(&(Local_298[3 /*7*/]), func_187(3), fVar7, Var2.f_1, fVar3, 45f);
}
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
CAM::SET_CAM_ACTIVE(Local_298[*iParam0 /*7*/], 1);
}


void func_185(var uParam0, struct<3> Param1, struct<3> Param2, float fParam3){
uParam0->f_1={
Param2 
};
uParam0->f_4={
...
var func__186(struct<2> Param0, var uParam1, struct<2> Param2, Vector3 vParam3){
...
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0)){}
MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iLocal_91), &uVar1, &Var2);
Var3={
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_91, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_91, "windscreen")) 
};
Var4={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_91, Var3) 
};
switch (iParam0){
case 0:
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, 0f, (Var2.f_1 + 1.4f), Var4.f_2) 
};
break;
case 1:
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, 1.5f, (Var2.f_1 + 1.2f), (Var4.f_2 - 0.1f)) 
};
break;
case 2:
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, -3.7f, 0.7f, Var4.f_2) 
};
break;
case 3:
Var0={
...
struct<2> Var2;
var uVar3;
MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iLocal_91), &Var2, &uVar3);
Var0={
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_91, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_91, "windscreen")) 
};
Var1={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_91, Var0) 
};
Var1.f_2=(Var1.f_2 + 0.09f);
Var2.f_1=(Var2.f_1 - 1f);
return ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, 0f, -MISC::ABSF(Var2.f_1), Var1.f_2);
}
...
if(!CAM::DOES_CAM_EXIST(Local_298[*iParam0 /*7*/])){
return;
}
if(!CAM::IS_CAM_RENDERING(Local_298[*iParam0 /*7*/])){
return;
}
CAM::SHAKE_CAM(Local_298[*iParam0 /*7*/], "HAND_SHAKE", 0.25f);
if(!HUD::IS_PAUSE_MENU_ACTIVE()){
func_193(&(Local_298[*iParam0 /*7*/]));
}
if(func_192()){
if(!func_551()){
...
Var1.f_0=((to_float(uVar0[3]) / 127f) * 10f);
}else{
Var1.f_0=(-(to_float(uVar0[3]) / 127f) * 10f);
}
fVar2=(30f * timestep());
...
uParam0->f_4=func_194((uParam0->f_4 + (Var3.f_0 * 0.05f)), -3f, 3f);
uParam0->f_4.f_1=func_194((uParam0->f_4.f_1 + (Var3.f_1 * 0.05f)), -3f, 3f);
uParam0->f_4.f_2=func_194((uParam0->f_4.f_2 + (Var3.f_2 * 0.05f)), -3f, 3f);
}else{
uParam0->f_4=(uParam0->f_4 + func_194((((Var3.f_0 - uParam0->f_4) * 0.05f) * fVar2), -3f, 3f));
uParam0->f_4.f_1=(uParam0->f_4.f_1 + func_194((((Var3.f_1 - uParam0->f_4.f_1) * 0.05f) * fVar2), -3f, 3f));
uParam0->f_4.f_2=(uParam0->f_4.f_2 + func_194((((Var3.f_2 - uParam0->f_4.f_2) * 0.05f) * fVar2), -3f, 3f));
}
...
void func_195(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5){
...
switch (iLocal_287){
case 0:
if(ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_88, 876132797)){
PAD::SET_CONTROL_SHAKE(0, 200, 84);
ENTITY::APPLY_FORCE_TO_ENTITY(iLocal_91, 1, 0f, 0f, -0.05f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
func_198();
}
break;
case 1:
...
if(func_491(iLocal_47, 32768)){
if(func_551()){
iVar0=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iLocal_75);
}else{
iVar0=iLocal_75;
}
...
ENTITY::APPLY_FORCE_TO_ENTITY(iLocal_91, 1, 0f, 0f, -0.1f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
func_198();
func_197(512);
}
}
...
func_528(512);
}}}elseif(ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_88, 876132797)){
PAD::SET_CONTROL_SHAKE(0, 200, 252);
ENTITY::APPLY_FORCE_TO_ENTITY(iLocal_91, 1, 0f, 0f, -0.1f, 0f, 0f, 0f, 0, 1, 1, 1, 1, 0);
func_198();
}
...
bool func_201(){
return ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_88, func_50(PLAYER::PLAYER_PED_ID(), 0, 0), func_202(iLocal_88, func_49(), 1), 3);
}


char* func_202(int iParam0, bool bParam1, bool bParam2){
char* sVar0;
int iVar1;
sVar0="";
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
...
if(AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_88) || AUDIO::IS_ANY_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID())){
return;
}
...
if(!func_10(&uLocal_99)){
func_472(&uLocal_99);
}elseif(func_7(&uLocal_99) > MISC::GET_RANDOM_FLOAT_IN_RANGE(2f, 5f)){
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "SEX_ORAL", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}else{
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "SEX_ORAL_FEM", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}
break;
case 1:
case 2:
if(func_206(PLAYER::PLAYER_ID())){
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "SEX_GENERIC", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}else{
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "SEX_GENERIC_FEM", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}
break;
}}
...
if(func_524(4)){
if(!func_10(&uLocal_102)){
func_472(&uLocal_102);
}elseif(func_7(&uLocal_102) > 2f){
...
void func_223(){
int iVar0;
if(func_225(&uLocal_96, 3f) && !CAM::IS_CAM_ACTIVE(uLocal_95)){
iVar0=floor(((func_224() - 2f) * 1000f));
CAM::SET_CAM_ACTIVE(uLocal_94, 0);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_95, uLocal_94, iVar0, 1, 1);
}
if(func_225(&uLocal_96, func_224())){
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_88)){
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
iVar0=ENTITY::GET_ENTITY_HEALTH(iLocal_88);
if((iVar0 - iLocal_56) < 0){
func_123(0);
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
func_542();
func_536(uParam0);
...
VEHICLE::SET_VEHICLE_HANDBRAKE(iLocal_91, 1);
VEHICLE::SET_VEHICLE_LIGHTS(iLocal_91, 4);
VEHICLE::SET_VEHICLE_INTERIORLIGHT(iLocal_91, 1);
...
if(!func_377() || !PED::IS_PED_IN_VEHICLE(iLocal_88, iLocal_91, 0)){
func_473(0);
return;
}}else{
func_473(0);
...
func_213(0);
if((!VEHICLE::IS_VEHICLE_STOPPED(iLocal_91) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) && !func_491(iLocal_47, 1024)){
iLocal_284=7;
func_375(1, -1);
...
PED::RESET_PED_IN_VEHICLE_CONTEXT(iLocal_88);
iLocal_290=2;
}
break;
case 2:
if(func_368(iLocal_293)){
func_367(&iLocal_293);
func_5(&iLocal_71, 2);
}
func_365(iLocal_88, 0);
...
if(iVar2 !=4 && iLocal_46==4){
CAM::SET_FOLLOW_PED_CAM_VIEW_MODE(4);
}
elseif(iVar2==4 && iLocal_46 !=4){
...
func_289(0, -1, 1);
if(func_288()){
if(Global_4541034 !=iLocal_66){
AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
iLocal_66=Global_4541034;
func_492("Player highlighted a new option using the mouse!");
}
else{
iVar0=1;
}}}}
if(((PAD::IS_CONTROL_JUST_PRESSED(2, 187) || (PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_CONTROL_JUST_PRESSED(2, 242))) || (PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 33))) || (((MISC::IS_PC_VERSION() && !PAD::IS_USING_KEYBOARD_AND_MOUSE(2)) && iVar4 > 100) && (MISC::GET_GAME_TIMER() - iLocal_85) > 300)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
...
}elseif(((PAD::IS_CONTROL_JUST_PRESSED(2, 188) || (PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_CONTROL_JUST_PRESSED(2, 241))) || (PAD::IS_USING_KEYBOARD_AND_MOUSE(2) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 32))) || (((MISC::IS_PC_VERSION() && !PAD::IS_USING_KEYBOARD_AND_MOUSE(2)) && iVar4 < -100) && (MISC::GET_GAME_TIMER() - iLocal_85) > 300)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
func_492("UP pressed!");
if(iLocal_66 > 0){
...
func_283(iLocal_66, 1, 1);
break;
case 4:
iVar7=PED::GET_PED_MONEY(iLocal_88);
if(iLocal_286==3){
func_375(1, -1);
func_282();
func_281(0);
...
iVar7 +=20;
func_234(20);
PED::SET_PED_MONEY(iLocal_88, iVar7);
}
func_473(1);
return;
}}
...
if(iLocal_286 !=3){
if(func_276() > func_233(iLocal_286)){
func_234(func_233(iLocal_286));
iVar7=(iVar7 + func_233(iLocal_286));
}
func_41(&uLocal_99, (14f - 4f));
...
}}elseif(MISC::IS_BIT_SET(Global_113810.f_20567.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_254() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
iLocal_287=iLocal_281[iLocal_66];
func_285();
if(iLocal_287==0){
...
fVar60=1f;
func_324(bParam7, &uVar58, &uVar59, &fVar60);
if(bParam3){
if(Global_23390.f_5661 <=1){
func_320(Global_23390.f_5661 + 1, "DFLT_MNU_OPT", 0, 1, 0, 0, 0);
...
func_291(Global_23387, Global_23388, fParam5, fVar55, 0, 0, 0, 255);
...
func_291(Global_23387, (Global_23388 + fVar55), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
...
func_315();
func_313((((Global_23387 + fParam5) - 0.00390625f) - func_314("CM_ITEM_COUNT", Global_23390.f_6179, Global_23390.f_6180)), ((Global_23388 + fVar55) + 0.00416664f), "CM_ITEM_COUNT", Global_23390.f_6179, Global_23390.f_6180);
}elseif(Global_23390.f_6174 > Global_23390.f_5668){
if(Global_23390.f_6177 !=0){
func_315();
func_313((((Global_23387 + fParam5) - 0.00390625f) - func_314("CM_ITEM_COUNT", Global_23390.f_6177, Global_23390.f_6176)), ((Global_23388 + fVar55) + 0.00416664f), "CM_ITEM_COUNT", Global_23390.f_6177, Global_23390.f_6176);
}}}
...
func_291(Global_23387, (fVar49 + 0f), fParam5, 0.034722f, iVar1, iVar2, iVar3, iVar4);
Var38={
...
func_291(Global_23387, (fVar49 - 0.00277776f), fParam5, 0.00277776f, iVar1, iVar2, iVar3, iVar4);
...
if(Global_23390.f_5165 !=0){
func_326(Global_23390.f_5165, 1, 1, &fVar36, &fVar37, bParam7);
func_311(Global_23390.f_5165, 1, &iVar45, &iVar46, &iVar47, &iVar48);
GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_5165), func_316(Global_23390.f_5165, 1), ((Global_23387 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
...
if(Global_4540958.f_67 !=0){
func_326(Global_4540958.f_67, 1, 1, &fVar36, &fVar37, bParam7);
func_311(Global_4540958.f_67, 1, &iVar45, &iVar46, &iVar47, &iVar48);
GRAPHICS::DRAW_SPRITE(func_319(Global_4540958.f_67), func_316(Global_4540958.f_67, 1), ((Global_23387 + (fVar36 * 0.5f)) + (0.00078125f * 2f)), ((fVar49 + (fVar37 * 0.5f)) - (0.00138888f * 4f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
fVar49=(fVar49 + (((HUD::GET_RENDERED_CHARACTER_HEIGHT(0.35f, 0) * IntToFloat(iVar6)) + (0.00138888f * 13f)) + ((0.00138888f * 5f) * IntToFloat((iVar6 - 1)))));
...
func_304(uVar58, iParam1, iParam8, 0, 0, 0, bParam4, 1, 0);
GRAPHICS::SET_SCRIPT_GFX_ALIGN(76, 84);
GRAPHICS::SET_SCRIPT_GFX_ALIGN_PARAMS(-0.05f, -0.05f, 0f, 0f);
}
if(iVar5==1 || !Global_23390.f_6171){
...
func_302(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar53, iVar72, bVar51, bVar50);
...
if(iVar5==1){
GRAPHICS::DRAW_SPRITE(func_319(26), func_316(26, 1), ((fVar34 + fVar40) + fVar43), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}}
}
...
if(iVar5==1){
GRAPHICS::DRAW_SPRITE(func_319(27), func_316(27, 1), (((fVar34 + fVar40) + fVar43) + (fVar41 + fVar42)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}}
}
}
iVar25=0;
...
func_302(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar53, 0, bVar51, bVar50);
...
func_311(Global_23390.f_4824[(iVar22 + iVar28)], bVar32, &iVar45, &iVar46, &iVar47, &iVar48);
if(iVar5==1){
if(Global_23390.f_5526[iVar8]==2){
GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_4824[(iVar22 + iVar28)]), func_316(Global_23390.f_4824[(iVar22 + iVar28)], bVar32), (((fVar34 + fVar40) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
else{
GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_4824[(iVar22 + iVar28)]), func_316(Global_23390.f_4824[(iVar22 + iVar28)], bVar32), ((fVar34 + fVar40) - (0.00078125f * 8f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
}
...
func_302(0, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar53, 0, bVar51, bVar50);
...
func_311(Global_23390.f_4824[(iVar22 + iVar14)], bVar32, &iVar45, &iVar46, &iVar47, &iVar48);
if(Global_23390.f_4824[(iVar22 + iVar14)]==30){
GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_4824[(iVar22 + iVar14)]), func_316(Global_23390.f_4824[(iVar22 + iVar14)], bVar32), (Global_23387 + (fVar36 * 0.5f)), (((fVar35 + 0.00277776f) + (fVar37 * 0.5f)) - (0.00078125f * 11f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
elseif(Global_23390.f_5526[iVar8]==2){
GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_4824[(iVar22 + iVar14)]), func_316(Global_23390.f_4824[(iVar22 + iVar14)], bVar32), ((((fVar34 + fVar40) + fVar41) - (0.00078125f * 8f)) + (0.00078125f * 4f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
else{
GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_4824[(iVar22 + iVar14)]), func_316(Global_23390.f_4824[(iVar22 + iVar14)], bVar32), (((fVar34 + fVar40) + fVar41) - (0.00078125f * 12f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), fVar36, fVar37, 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
}
}
...
if(bVar33){
if(!Global_23390.f_6172){
func_302(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar53, 0, 0, 0);
if(Global_23390.f_8888 && Global_23390.f_8889==iVar6){
func_301(bVar32);
}
...
if(iVar5==1){
func_302(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar53, 0, 0, 0);
func_299((fVar34 + fVar40), fVar35, "NUMBER", Global_23390.f_4309[iVar20], 0);
}}
bVar39=true;
iVar20++;
break;
...
func_302(bVar32, Global_23390.f_1616[iVar24], Global_23390.f_1873[iVar24], bVar53, 0, 0, 0);
func_298((fVar34 + fVar40), fVar35, "NUMBER", Global_23390.f_4566[iVar21], Global_23390.f_4695[iVar21]);
}
bVar39=true;
iVar21++;
break;
...
func_311(Global_23390.f_4824[iVar22], bVar32, &iVar45, &iVar46, &iVar47, &iVar48);
GRAPHICS::DRAW_SPRITE(func_319(Global_23390.f_4824[iVar22]), func_316(Global_23390.f_4824[iVar22], bVar32), ((fVar34 + fVar40) + (fVar36 * 0.5f)), ((fVar35 - 0.00277776f) + (fVar54 * 0.5f)), (fVar36 * func_297(Global_23390.f_4824[iVar22])), (fVar37 * func_297(Global_23390.f_4824[iVar22])), 0f, iVar45, iVar46, iVar47, iVar48, 0, 0);
}
}
}}
bVar39=true;
...
if(!func_368(iLocal_293)){
iLocal_293=func_349();
func_340(&iLocal_293, 0, 0, MISC::GET_RANDOM_INT_IN_RANGE(1, 2), 0, 0, 0);
}elseif(!func_491(iLocal_71, 2)){
if(func_332(iLocal_293)){
iLocal_293=func_349();
func_340(&iLocal_293, 0, 0, MISC::GET_RANDOM_INT_IN_RANGE(1, 2), 0, 0, 0);
func_482(&iLocal_71, 2);
}}elseif(func_332(iLocal_293)){
func_282();
func_473(0);
}}
...
iVar2=func_233(2);
if(func_276() >=iVar0){
func_320(iLocal_67, "PROS_DOLLAR", 1, 1, 0, 0, 0);
func_354(iVar0, 0);
iLocal_281[iLocal_67]=0;
iLocal_67++;
}
if(func_276() >=iVar1 && func_353(iLocal_91)){
func_320(iLocal_67, "PROS_DOLLAR", 1, 1, 0, 0, 0);
func_354(iVar1, 0);
iLocal_281[iLocal_67]=1;
iLocal_67++;
}
if(func_276() >=iVar2 && func_353(iLocal_91)){
func_320(iLocal_67, "PROS_DOLLAR", 1, 1, 0, 0, 0);
func_354(iVar2, 0);
iLocal_281[iLocal_67]=2;
iLocal_67++;
}
func_320(iLocal_67, "PROS_QUIT", 0, 1, 0, 0, 0);
iLocal_66=0;
func_283(iLocal_66, 1, 1);
func_352();
iLocal_85=MISC::GET_GAME_TIMER();
...
func_197(256);
iLocal_82=iVar0;
iLocal_83=PED::GET_PED_TEXTURE_VARIATION(PLAYER::PLAYER_PED_ID(), 6);
...
AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(iLocal_88);
if(!AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_88)){
if(iLocal_68 < 1){
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "HOOKER_OFFER_SERVICE", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}else{
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "HOOKER_OFFER_AGAIN", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}}}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_88)){
iLocal_56=ENTITY::GET_ENTITY_HEALTH(iLocal_88);
}}
...
iLocal_91=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(!iLocal_91==0){
if((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0) && !FIRE::IS_ENTITY_ON_FIRE(iLocal_91)) && !ENTITY::IS_ENTITY_UPSIDEDOWN(iLocal_91)){
if(func_91(&iLocal_91)){
func_5(&iLocal_47, 1);
return 1;
}}}}}}
return 0;
...
if(iLocal_297[iParam0]==0){
if(ENTITY::GET_ENTITY_MODEL(iLocal_91)==joaat("tyrant")){
iLocal_297[iParam0]=SHAPETEST::START_SHAPE_TEST_SWEPT_SPHERE(Var0, Var1, 0.1f, 511, iLocal_91, 3);
}elseif(((ENTITY::GET_ENTITY_MODEL(iLocal_91)==joaat("casco") || ENTITY::GET_ENTITY_MODEL(iLocal_91)==joaat("feltzer3")) || ENTITY::GET_ENTITY_MODEL(iLocal_91)==joaat("fagaloa")) || ENTITY::GET_ENTITY_MODEL(iLocal_91)==joaat("warrener2")){
iLocal_297[iParam0]=SHAPETEST::START_SHAPE_TEST_SWEPT_SPHERE(Var0, Var1, 0.15f, 511, iLocal_91, 3);
}else{
iLocal_297[iParam0]=SHAPETEST::START_SHAPE_TEST_SWEPT_SPHERE(Var0, Var1, 0.25f, 511, iLocal_91, 3);
}}else{
switch (SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_297[iParam0], &iVar2, &uVar3, &uVar4, &uVar5)){
case 2:
iLocal_297[iParam0]=0;
if(iVar2 !=0){
func_380(iParam0);
return 0;
}else{
...
uLocal_94=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
}
if(!CAM::DOES_CAM_EXIST(uLocal_95)){
uLocal_95=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
}
func_383(&Var0, &Var1);
CAM::SET_CAM_COORD(uLocal_94, Var0);
CAM::SET_CAM_ROT(uLocal_94, Var0.f_3, 2);
CAM::SET_CAM_FOV(uLocal_94, Var0.f_6);
CAM::SET_CAM_COORD(uLocal_95, Var1);
CAM::SET_CAM_ROT(uLocal_95, Var1.f_3, 2);
CAM::SET_CAM_FOV(uLocal_95, Var1.f_6);
...
bool func_386(){
return vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_388()) < (func_387() * func_387());
}
...
if(func_377() && PED::IS_PED_IN_VEHICLE(iLocal_88, iLocal_91, 0)){
if(VEHICLE::IS_VEHICLE_STOPPED(iLocal_91) && VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(iLocal_91)){
if((func_396() && !func_386()) && !func_395()){
func_394();
if(func_7(&uLocal_108) > 2.5f){
uLocal_81=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(ENTITY::GET_ENTITY_COORDS(iLocal_91, 0), 40f, 40f, 40f, ENTITY::GET_ENTITY_HEADING(iLocal_91), 0, 7);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 896);
func_482(&iLocal_47, 2048);
iLocal_92=0;
PED::ADD_RELATIONSHIP_GROUP("ProstituteInPlay", &uLocal_296);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, uLocal_296, joaat("player"));
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_88, uLocal_296);
...
if((!AUDIO::IS_ANY_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID()) && func_7(&uLocal_99) > 15f) && func_392()){
...
if(!AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_88)){
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "HOOKER_SECLUDED", "SPEECH_PARAMS_FORCE_SHOUTED_CLEAR", 1);
}}
...
void func_393(){
if(func_551()){
PED::SET_PED_CONFIG_FLAG(iLocal_88, 229, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_88, 26, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_88, 115, 1);
...
Var1={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, 0f, 0f, -2f) 
};
iLocal_92=SHAPETEST::START_SHAPE_TEST_CAPSULE(Var0, Var1, 2f, 511, iLocal_91, 7);
}elseif(SHAPETEST::GET_SHAPE_TEST_RESULT_INCLUDING_MATERIAL(iLocal_92, &iVar4, &uVar5, &uVar6, &iVar3, &uVar7)==2){
if(iVar4 !=0){
if((iVar3==-1447280105 || iVar3==1925605558) || iVar3==2128369009){
func_40(&uLocal_108);
}}
iLocal_80=MISC::GET_GAME_TIMER() + 1500;
iLocal_92=0;
}}}}
...
if(!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_88, iLocal_91, 0, 0, 0)){
return 0;
}
...
if(ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iVar0, iLocal_91, 17)){
return 0;
}}}else{
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Param0) > 400f){
return 1;
}}elseif(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Param0) > 56.25f){
return 1;
...
if(func_154()==0){
uVar0=func_142(func_407(iParam0), -1);
MISC::CLEAR_BIT(&uVar0, bParam1);
func_138(func_407(iParam0), uVar0, -1, 1);
}}else{
...
if(func_154()==0){
return MISC::IS_BIT_SET(func_142(func_407(iParam0), -1), iParam1);
}}else{
...
void func_411(){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_88, PLAYER::PLAYER_PED_ID(), 5f, 5f, 5f, 0, 1, 0) || func_491(iLocal_47, 8192)){
PAD::DISABLE_CONTROL_ACTION(0, 101, 1);
PAD::DISABLE_CONTROL_ACTION(0, 74, 1);
PAD::SET_INPUT_EXCLUSIVE(0, 51);
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_88, 0)){
ENTITY::SET_ENTITY_LOD_DIST(iLocal_88, 50);
PED::SET_PED_LOD_MULTIPLIER(iLocal_88, 5f);
if(func_491(iLocal_47, 16)){
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
PLAYER::SET_PLAYER_CAN_DO_DRIVE_BY(PLAYER::PLAYER_ID(), 1);
func_5(&iLocal_47, 16);
...
iLocal_91=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0)){
if(PED::IS_PED_SITTING_IN_VEHICLE(iLocal_88, iLocal_91) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_91, 0)){
func_492("***** prostitute IN VEHICLE****** ");
if(func_491(iLocal_47, 8)){
if(STREAMING::HAS_CLIP_SET_LOADED(func_92())){
if(func_428(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_RESTRICTED_PASSENGER"));
}elseif(func_427(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_RESTRICTED_NOAMBIENT_PASSENGER"));
}elseif(func_426(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_LOWRIDER_PASSENGER"));
}elseif(func_425(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_LOWRIDER2_PASSENGER"));
}elseif(func_424(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_INFERNUS2_PASSENGER"));
}elseif(func_423(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_SC1_PASSENGER"));
}elseif(func_422(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_TEZERACT_PASSENGER"));
}elseif(func_421(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_DOMINATOR3_PASSENGER"));
}elseif(func_420(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_ITALIGTO_PASSENGER"));
}elseif(func_419(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_RESTRICTED_SCHLAGEN_PASSENGER"));
}elseif(func_418(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_NEO_PASSENGER"));
}elseif(func_417(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_PEYOTE2_PASSENGER"));
}elseif(func_416(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_ZR350_PASSENGER"));
}elseif(func_415(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_IGNUS_PASSENGER"));
}elseif(func_414(iLocal_91)){
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_ZENO_PASSENGER"));
}else{
PED::SET_PED_IN_VEHICLE_CONTEXT(iLocal_88, MISC::GET_HASH_KEY("MINI_PROSTITUTE_LOW_PASSENGER"));
}}
}
if(func_551()){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_88, 0, 0);
}
else{
...
if((func_413(iLocal_88, PLAYER::PLAYER_PED_ID(), 1) > 11f || func_412(20f)) || !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_91, 0)){
func_115(&uLocal_105);
...
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0)){
iLocal_91=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
}elseif(!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_88, iLocal_91, 0, 0, 0)){
if(!func_112()){
if(!func_491(iLocal_71, 1)){
func_40(&uLocal_111);
func_482(&iLocal_71, 1);
}elseif(func_7(&uLocal_111) > 20f){
func_126();
func_492("prostitute couldn't get into the car");
iLocal_284=6;
}
}}}}}elseif(!func_491(iLocal_71, 1)){
...
return func_121(&uLocal_105) > fParam0;
}
...
if(func_121(&uLocal_105) >=20f || !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_88, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0)){
if(func_491(iLocal_71, 524288)){
func_115(&uLocal_105);
iLocal_284=6;
}elseif(func_437()){
func_40(&uLocal_105);
func_482(&iLocal_71, 524288);
}}
func_69(iLocal_88);
if(((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_88, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0) || func_491(iLocal_71, 1)) && !func_217(0)) && !func_402()){
if(!VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_88, iLocal_91, 0, 0, 0)){
if(!func_112()){
if(!func_491(iLocal_71, 1)){
func_40(&uLocal_111);
func_482(&iLocal_71, 1);
}elseif(func_7(&uLocal_111) > 10f){
func_68();
TASK::CLEAR_PED_TASKS(iLocal_88);
func_492("prostitute couldn't get into the car");
iLocal_284=6;
...
func_468();
if(func_551()){
iVar0=TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_play_anim"));
if(iVar0 !=1 && iVar0 !=0){
func_542();
func_536(uParam0);
}}}}
...
void func_430(){
char* sVar0;
if(iLocal_284 !=5 && func_363(&sVar0, 0)){
func_433();
if(func_431(iLocal_70, 1) || PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID())){
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_enter_vehicle")) !=1 && !PED::IS_PED_IN_VEHICLE(iLocal_88, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 1)){
TASK::TASK_ENTER_VEHICLE(iLocal_88, iLocal_91, -1, 0, 1f, 8388609, 0);
}}
sLocal_59=func_50(PLAYER::PLAYER_PED_ID(), 1, 0);
STREAMING::REQUEST_ANIM_DICT(sLocal_59);
sLocal_59=func_50(PLAYER::PLAYER_PED_ID(), 0, 1);
STREAMING::REQUEST_ANIM_DICT(sLocal_59);
func_40(&uLocal_99);
iLocal_284=5;
}}}
...
if(!func_491(iLocal_47, 8192)){
if(iLocal_70==-1){
func_435(&iLocal_70, 5, "PROS_ACCEPT", 0, 0, 0, 0);
}}}elseif(func_434(iLocal_70, 0)){
func_468();
}}
...
TASK::OPEN_SEQUENCE_TASK(&uVar1);
TASK::TASK_PLAY_ANIM(0, func_67(iLocal_282), func_66(5), 2f, -2f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, func_67(iLocal_282), func_66(iVar0), 8f, -8f, -1, 1, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar1);
TASK::TASK_PERFORM_SEQUENCE(iLocal_88, uVar1);
TASK::CLEAR_SEQUENCE_TASK(&uVar1);
}
...
case 1:
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_88)){
TASK::TASK_PLAY_ANIM(iLocal_88, func_67(iLocal_282), func_66(5), 2f, -2f, -1, 0, 0, 0, 0, 0);
iLocal_53=2;
}else{
NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(iLocal_88);
}
...
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_play_anim"))==7){
iVar0=MISC::GET_RANDOM_INT_IN_RANGE(8, 11);
TASK::TASK_PLAY_ANIM(iLocal_88, func_67(iLocal_282), func_66(iVar0), 8f, -8f, -1, 1, 0, 0, 0, 0);
iLocal_53=3;
}}else{
NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(iLocal_88);
}
...
if(func_491(iLocal_47, 8192)){}
if(func_413(iLocal_88, PLAYER::PLAYER_PED_ID(), 1) > 11f){
return 0;
}
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
return 0;
...
if(func_90(ENTITY::GET_ENTITY_COORDS(iLocal_88, 1), 1106247680)){
...
if(!func_377()){
if(!func_551()){
if((!iLocal_84 && !Global_112857) && func_440(PLAYER::PLAYER_PED_ID(), 0)==-1){
func_350("PROS_CAR", -1);
iLocal_84=1;
}
func_439();
...
if(!AUDIO::IS_ANY_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID()) && !AUDIO::IS_ANY_SPEECH_PLAYING(iLocal_88)){
...
if(func_438(0)){
func_430();
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_perform_sequence"))==7 && !func_491(iLocal_47, 8192)){
if(func_72(1)){
func_115(&uLocal_105);
iLocal_60=MISC::GET_GAME_TIMER();
...
MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(iLocal_91), &Var2, &Var1);
Var0={
Var1 - Var2 
};
Var0={
...
Var3={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, -(Var0.f_0 + 0.2f), 0f, 0f) 
};
Var4={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_91, (Var0.f_0 + 0.2f), 0f, 0f) 
};
...
if((TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_enter_vehicle")) !=1 || !func_491(iLocal_47, 8192)) && vdist2(Local_87, Var3) > 0f){
if(func_551()){
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_88)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_88, 0, 1);
}
func_453(&uLocal_279, func_67(iLocal_282));
func_447(uParam0, 1);
func_444(&uLocal_279, uParam0);
}
TASK::OPEN_SEQUENCE_TASK(&uVar6);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Var3.f_0, Var3.f_1, Var3.f_2, 1f, -1, 1f, 8192, 1193033728);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_88, uVar6);
...
Global_32436=1;
func_430();
if(func_471(&uLocal_105, 2f) || func_491(iLocal_47, 8192)){
...
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_88, -1, 2048, 4);
func_443(uParam0);
func_482(&iLocal_47, 4);
Global_32435=1;
Global_2657704[PLAYER::PLAYER_ID() /*463*/].f_428=1;
...
int func_485(){
int iVar0;
iLocal_90=VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(ENTITY::GET_ENTITY_COORDS(iLocal_88, 1), 15f, 0, 6);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_90) && !ENTITY::IS_ENTITY_DEAD(iLocal_90, 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_90, 0)){
if(func_91(&iLocal_90) && !func_487(iLocal_90, 1)){
iLocal_89=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_90, -1, 0);
if(!iLocal_89==0){
if(func_486(&iLocal_89)){
iVar0=ENTITY::GET_ENTITY_MODEL(iLocal_90);
if(!iVar0==joaat("taxi") && !iVar0==joaat("taxi")){
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_89)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_89, 1, 0);
}
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_90)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_90, 1, 0);
}
...
int func_488(){
if(ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) || ENTITY::IS_ENTITY_DEAD(iLocal_88, 0)){
return 0;
}
return 1;
}
...
int func_489(){
if((!func_488() || !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) || func_491(iLocal_47, 4096)){
return 0;
}
if(func_491(iLocal_47, 32)){
iLocal_285=2;
...
void func_490(){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0)){
if(!PED::IS_PED_FLEEING(iLocal_88)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_smart_flee_ped")) !=1){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_88, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_88, 196628, 1);
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(iLocal_88);
TASK::TASK_SMART_FLEE_PED(iLocal_88, PLAYER::PLAYER_PED_ID(), 300f, -1, 1, 0);
...
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_any"))==1){
return 0;
}
if(PED::IS_PED_USING_ANY_SCENARIO(iLocal_88)){
return 0;
}
return 1;
}
...
if(!func_551()){
func_453(&uLocal_279, func_67(iLocal_282));
func_444(&uLocal_279, &uLocal_351);
...
if(!func_551()){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_88, 0);
PED::SET_PED_CAN_EVASIVE_DIVE(iLocal_88, 0);
func_469(&uLocal_114, 4, iLocal_88, "Prostitutes", 0, 1);
return 1;
}elseif(!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_88)){
NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(iLocal_88);
}else{
...
func_469(&uLocal_114, 4, iLocal_88, "Prostitutes", 0, 1);
PED::SET_PED_CAN_EVASIVE_DIVE(iLocal_88, 0);
PED::SET_PED_SHOULD_PLAY_NORMAL_SCENARIO_EXIT(iLocal_88);
return 1;
}}
break;
}
...
if(STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()){
if(func_23()==0){
if(func_500(iLocal_88, 537.0014f, 119.0252f, 96.0997f, 1) <=8f){
if(!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_88, 1)){
if(func_551()){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_88, 0, 0);
}else{
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_88, 1, 1);
...
float func_500(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
Var0={
ENTITY::GET_ENTITY_COORDS(iParam0, 1) 
...
int func_501(){
if(PED::IS_PED_USING_SCENARIO(iLocal_88, func_65(0))){
if(PED::IS_SCRIPTED_SCENARIO_PED_USING_CONDITIONAL_ANIM(iLocal_88, "amb@world_human_prostitute@crackhooker@base", "base")){
return 0;
}
if(PED::IS_SCRIPTED_SCENARIO_PED_USING_CONDITIONAL_ANIM(iLocal_88, "amb@world_human_prostitute@cokehead@base", "base")){
return 1;
}}
if(PED::IS_PED_USING_SCENARIO(iLocal_88, func_65(1))){
if(PED::IS_SCRIPTED_SCENARIO_PED_USING_CONDITIONAL_ANIM(iLocal_88, "amb@world_human_prostitute@french@base", "base")){
return 3;
}
if(PED::IS_SCRIPTED_SCENARIO_PED_USING_CONDITIONAL_ANIM(iLocal_88, "amb@world_human_prostitute@hooker@base", "base")){
return 2;
}}
return -1;
}
...
if(func_413(iParam0, iLocal_88, 1) < 30f){
if(!PED::IS_PED_HEADTRACKING_PED(iLocal_88, iParam0)){
if(func_551()){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_88)){
TASK::TASK_CLEAR_LOOK_AT(iLocal_88);
TASK::TASK_LOOK_AT_ENTITY(iLocal_88, iParam0, -1, 2048, 4);
}}else{
TASK::TASK_CLEAR_LOOK_AT(iLocal_88);
TASK::TASK_LOOK_AT_ENTITY(iLocal_88, iParam0, -1, 2048, 4);
}}}elseif(PED::IS_PED_HEADTRACKING_PED(iLocal_88, iParam0)){
if(func_551()){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_88)){
TASK::TASK_CLEAR_LOOK_AT(iLocal_88);
}}else{
...
if(Global_32435){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_88, iLocal_91, 0)){
func_505();
}}
return;
}
...
if(ENTITY::IS_ENTITY_DEAD(iLocal_88, 0) || !ENTITY::DOES_ENTITY_EXIST(iLocal_88)){
if(Global_32439 !=SCRIPT::GET_ID_OF_THIS_THREAD() && func_491(iLocal_47, 32)){
func_5(&iLocal_47, 32);
}
return;
}
if((vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_88, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < Global_32438 || Global_32438==0f) && iLocal_285 !=4){
Global_32438=vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_88, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
Global_32439=SCRIPT::GET_ID_OF_THIS_THREAD();
func_482(&iLocal_47, 32);
}elseif(Global_32439==SCRIPT::GET_ID_OF_THIS_THREAD()){
Global_32438=vdist2(ENTITY::GET_ENTITY_COORDS(iLocal_88, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
}else{
func_5(&iLocal_47, 32);
}}
...
if(func_551()){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_88)){
PED::SET_PED_RESET_FLAG(iLocal_88, 323, 1);
}}else{
PED::SET_PED_RESET_FLAG(iLocal_88, 323, 1);
}}
...
if(!iLocal_284==12){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(func_510()){
if(func_551()){
func_123(0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_88, 196624, 1);
...
TASK::TASK_SMART_FLEE_PED(iLocal_88, PLAYER::PLAYER_PED_ID(), 300f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_88, 1);
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
func_542();
func_536(uParam0);
...
func_96(12);
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_88, PLAYER::PLAYER_PED_ID(), 1)){
iLocal_63++;
if(iLocal_63 >=2){
...
AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(iLocal_88);
AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(iLocal_88, "APOLOGY_NO_TROUBLE", "SPEECH_PARAMS_FORCE_SHOUTED_CRITICAL", 1);
}
...
struct<3> Var0;
if(!func_491(iLocal_47, 4096)){
if(func_413(iLocal_88, PLAYER::PLAYER_PED_ID(), 1) < 30f){
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_88, 1) 
};
...
int func_511(){
if((ENTITY::DOES_ENTITY_EXIST(iLocal_88) && !ENTITY::IS_ENTITY_DEAD(iLocal_88, 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(func_551()){
...
if(!func_513(9)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_88, PLAYER::PLAYER_PED_ID(), 100f, 100f, 50f, 0, 1, 0)){
return 1;
}
else{
...
if(!PED::IS_PED_INJURED(iLocal_88)){
if(ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_88)){
if((func_551() && TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_smart_flee_ped")) !=1) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, -251125078) !=1){
TASK::TASK_WANDER_STANDARD(iLocal_88, 1193033728, 0);
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_88)){
PED::SET_PED_KEEP_TASK(iLocal_88, 1);
}
...
if(func_551()){
if(PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(uLocal_81)){
PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(uLocal_81);
}}
iLocal_90=0;
func_540();
func_537();
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(func_524(256)){
PED::SET_PED_COMPONENT_VARIATION(PLAYER::PLAYER_PED_ID(), 6, iLocal_82, iLocal_83, 0);
func_197(1024);
}}
if(func_470("PROS_ACCEPT") && !Global_32435){
HUD::CLEAR_HELP(1);
}
...
bool func_539(){
return MISC::IS_BIT_SET(Global_1963820, 3);
}
...
if(!PED::IS_PED_INJURED(iLocal_88)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_88, 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_88, joaat("script_task_leave_any_vehicle")) !=1){
TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_88, 0, 65536);
}}
if(bParam0){
if(func_551()){
if(ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_88)){
...
void func_542(){
if(!func_551()){
if(iLocal_284==11 || iLocal_284==13){
return;
}}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_88, 0)){
if(!PED::IS_PED_FLEEING(iLocal_88)){
...
AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_88, 0);
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_91, 0)){
if(func_551()){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_91)){
if(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_33 <=0 && !MISC::IS_BIT_SET(Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_31, 11)){
VEHICLE::SET_VEHICLE_HANDBRAKE(iLocal_91, 0);
VEHICLE::SET_VEHICLE_LIGHTS(iLocal_91, 3);
VEHICLE::SET_VEHICLE_INTERIORLIGHT(iLocal_91, 0);
}
VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(iLocal_91, 1, 0);
}}else{
VEHICLE::SET_VEHICLE_HANDBRAKE(iLocal_91, 0);
VEHICLE::SET_VEHICLE_LIGHTS(iLocal_91, 3);
VEHICLE::SET_VEHICLE_INTERIORLIGHT(iLocal_91, 0);
...
if((func_551() && iLocal_286 !=3) && func_491(iLocal_47, 2048)){
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
}
...
}}}elseif(NETWORK::NETWORK_GET_ENTITY_IS_NETWORKED(iLocal_91)){
if(NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iLocal_91)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_91, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED_FOR_ALL_PLAYERS(iLocal_91, 0);
VEHICLE::SET_VEHICLE_RESPECTS_LOCKS_WHEN_HAS_DRIVER(iLocal_91, 0);
}else{
NETWORK::NETWORK_REQUEST_CONTROL_OF_ENTITY(iLocal_91);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_91, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED_FOR_ALL_PLAYERS(iLocal_91, 0);
VEHICLE::SET_VEHICLE_RESPECTS_LOCKS_WHEN_HAS_DRIVER(iLocal_91, 0);
}}}}
