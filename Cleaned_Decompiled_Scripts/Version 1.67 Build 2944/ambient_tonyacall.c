...
if((vdist2(Var0, Var1) > 10000f || ENTITY::IS_ENTITY_DEAD(uLocal_36, 0)) || func_4()){
...
TASK::TASK_PERFORM_SEQUENCE(uLocal_36, uVar2);
TASK::CLEAR_SEQUENCE_TASK(&uVar2);
iLocal_38=1;
}}
break;
...
fVar3=ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_36, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
if(fVar3 >=0.157f){
...
iLocal_38=2;
}}elseif(func_5(&uLocal_51, "TOWAUD", "TONYA_CALL2", 8, 0, 0, 0)){
iLocal_38=2;
}}}
break;
case 2:
