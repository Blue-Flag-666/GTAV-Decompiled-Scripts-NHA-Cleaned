...
if(!func_3(&uVar0)){
Var1={
ENTITY::GET_ENTITY_COORDS(uLocal_67, 0) 
};
fVar2=vdist2(Local_169 + Local_172, Var1);
if(fVar2 < (4.5f * 4.5f)){
TASK::TASK_VEHICLE_DRIVE_WANDER(uLocal_67, uLocal_69, uLocal_170, 786599);
return 1;
}}
return 0;
}
...
if(!PED::IS_PED_INJURED(Global_100554)){}else{
iLocal_64=3;
return 1;
}
if(!PED::IS_PED_INJURED(uLocal_67)){}else{
iLocal_64=3;
return 1;
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_69, 0)){}else{
iLocal_64=3;
return 1;
}
return 0;
...
if(!func_5(Global_100554, uLocal_69, 2)){
if(fVar1 >=0.9f){
PED::SET_PED_INTO_VEHICLE(Global_100554, uLocal_69, 2);
}}
if(!iLocal_171){
...
TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_69, Local_169 + Local_172, uLocal_170, 0, uLocal_70, 786599, ((4.5f / 2f) - 1f), 10f);
...
return 0;
}}}elseif(iParam1==func_9(Global_100554) && iParam1 !=0){
Global_100554=0;
}}
return 1;
}
...
uLocal_69=VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(Local_172 + Local_168, 15f, uLocal_70, 2);
iVar0=0;
while ((!ENTITY::DOES_ENTITY_EXIST(Global_100554) || !ENTITY::DOES_ENTITY_EXIST(uLocal_69)) || (!STREAMING::HAS_MODEL_LOADED(iLocal_68) && iVar0 < 400)){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_69)){
iLocal_69=VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(Local_172 + Local_168, 15f, uLocal_70, 2);
}
iVar0++;
wait(0);
}
...
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_69, 1, 1, 0);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_69, 2);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_69, 1084227584);
...
func_45(iLocal_65, &Local_172, &uLocal_173, &cVar0);
...
bool func_47(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_48(int iParam0, var uParam1, char* sParam2){
struct<3> Var0;
int iVar1;
var uVar2;
float fVar3;
...
int func_49(int iParam0, int iParam1, var uParam2, var uParam3){
switch (iParam1){
case 0:
switch (iParam0){
case 0:
...
int func_51(int iParam0, var uParam1, var uParam2){
switch (iParam0){
case 11:
*uParam1={
...
void func_53(){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_67, 0) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_67, 1)){
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_67);
}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_69, 0) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_69, 1)){
