...
while ((MISC::GET_GAME_TIMER() - iLocal_371) < 2000){
wait(0);
}}}
if(!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_187)){
func_19(sLocal_187);
...
if((MISC::GET_GAME_TIMER() - iLocal_370) > 2000){
func_22(&uLocal_195);
...
bLocal_26=false;
func_24(1, 1, 1);
}elseif(func_98(1, Local_197, 0)){
return 1;
}
break;
case 1:
if(bParam1){
func_39(PLAYER::PLAYER_PED_ID(), Local_198, 354.7487f);
bLocal_26=false;
func_24(1, 1, 1);
}else{
return 1;
...
HUD::REQUEST_ADDITIONAL_TEXT(sLocal_200, 6);
...
HUD::SET_BLIP_COLOUR(uLocal_195, 2);
HUD::SET_BLIP_ROUTE_COLOUR(uLocal_195, 2);
}
...
case 1:
func_108();
if(func_107(PLAYER::PLAYER_PED_ID(), Local_198, 2f, 1) && func_106(28)){
if(!iLocal_194){
PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
...
if(!func_107(PLAYER::PLAYER_PED_ID(), Local_198, 75f, 1)){
if(!iLocal_193){
func_22(&uLocal_195);
iLocal_193=1;
}
func_110(&uLocal_195, Local_198, 1, 1, "PRE_SHOP");
}elseif(func_107(PLAYER::PLAYER_PED_ID(), Local_198, 12f, 1)){
if(iLocal_193){
func_22(&uLocal_195);
iLocal_193=0;
}
...
if(iVar0==1){
if(!func_236(iParam4, iParam5, iParam6, iParam11)){
iVar0=0;
}}
if(iVar0==1){
func_234();
...
*iParam0=func_208(Param1, fParam2);
}elseif(iParam7==1){
...
func_187(iParam0, &(Var2.f_31), &(Var2.f_81));
VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
if(iParam1==1){
...
return 1;
}elseif(func_144(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_182(iParam0, 0, 0)) || func_182(iParam0, 1, 0)) || func_182(iParam0, 2, 0)) || func_181(iParam0) !=145) || func_180(iParam0)) || func_179(iParam0)) || func_126(iParam0)) || func_178(iParam0)) || !func_166(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_179(iParam0)){
}
if(func_179(iParam0)){
}
...
}elseif(func_192(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_193() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
int func_208(struct<3> Param0, float fParam1){
return func_209(&(Global_107357.f_2890), Param0, fParam1, 0);
}

int func_209(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
}elseif((!func_211(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
iVar4=func_210(iVar0);
if(iVar4==-1){
uParam0->f_10=0;
}else{
func_199(iVar4);
...
int func_211(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_212(iParam0, uVar1[iVar3], 1) && func_99(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_207(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
...
var func__218(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
bool func_240(struct<3> Param0, int iParam1){
return func_241(Global_107357.f_2890.f_12.f_66, Param0, iParam1);
}

int func_241(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
struct<3> Var1;
if(iParam0==0){
return 0;
...
if(!bLocal_191){
if(!func_107(PLAYER::PLAYER_PED_ID(), Local_198, 150f, 1)){
func_250(2);
}elseif(!func_107(PLAYER::PLAYER_PED_ID(), Local_198, 75f, 1)){
if(!bLocal_199){
HUD::CLEAR_PRINTS();
func_244("PRE_RETSHOP", &bLocal_199);
}}}}}}
...
if(!func_246(bLocal_191, iVar0) && !bLocal_191){
return 0;
}
return 1;
}
...
}elseif(Global_113810.f_2366.f_539.f_2403[1]==-99){
func_253(sLocal_78[1], sLocal_78[0], sLocal_78[2]);
}elseif(Global_113810.f_2366.f_539.f_2403[2]==-99){
...
func_253(sLocal_78[1], sLocal_78[0], sLocal_78[2]);
}elseif(Global_113810.f_2366.f_539.f_2403[0]==-99){
func_253(sLocal_78[0], sLocal_78[1], sLocal_78[2]);
}elseif(Global_113810.f_2366.f_539.f_2403[2]==-99){
func_253(sLocal_78[2], sLocal_78[1], sLocal_78[0]);
}
...
}}elseif(MISC::IS_BIT_SET(Global_113810.f_20567.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_264() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
return MISC::IS_BIT_SET(Global_2359296[func_264() /*5568*/].f_681.f_10, iParam0);
}
...
func_265(func_93(iParam0), uVar0, -1, 1);
}}else{
...
void func_297(struct<3> Param0, float fParam1, int iParam2, int iParam3){
if(func_298()){
...
Global_78472[1 /*14*/]={
func_302(iParam0, iParam1, iParam2, -1) 
};
...
func_305(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_305(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_305(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
iVar10=(iParam1 - iParam2);
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(uVar1, 10, -1, 0, -1, func_313(iParam0));
if(iVar11 > iVar10){
...
func_374(&uLocal_82, *(uParam0[iVar0 /*3*/]));
iVar0++;
}
func_373(&uLocal_82);
func_371(&uLocal_134, &uLocal_82, 50f);
}
...
if(CAM::DOES_CAM_EXIST(uLocal_196)){
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
CAM::DESTROY_CAM(uLocal_196, 0);
}}
