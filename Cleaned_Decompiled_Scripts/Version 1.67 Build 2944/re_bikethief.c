...
Local_52={
ScriptParam_289.f_1[0 /*3*/] 
};
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11)){
func_227();
}
if(vdist2(Local_52, 421.92f, -1930.95f, 23.18f) < 16f){
bLocal_261=true;
}elseif(vdist2(Local_52, 769.3f, -151.66f, 73.79f) < 16f){
bLocal_261=2;
}elseif(vdist2(Local_52, -1923.93f, 254.48f, 85.7f) < 16f){
bLocal_261=3;
}
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) !=0){
SCRIPT::TERMINATE_THIS_THREAD();
}elseif(func_226(PLAYER::PLAYER_PED_ID(), Local_52, 1) < 100f){
SCRIPT::TERMINATE_THIS_THREAD();
}}
if(bLocal_261 !=3){
...
SCRIPT::TERMINATE_THIS_THREAD();
}}elseif(func_186(Local_52, 8, 0, 0, 0)){
func_183(8);
}else{
SCRIPT::TERMINATE_THIS_THREAD();
}
iLocal_260=func_181();
uLocal_269=PED::ADD_SCENARIO_BLOCKING_AREA(Local_52 - Vector(20f, 20f, 20f), Local_52 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
while (true){
wait(0);
func_180();
...
if(BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_45 > 1){
if(func_160()){
func_159();
func_227();
}else{
...
void func_1(){
if(func_65(PLAYER::PLAYER_PED_ID()) && func_65(iLocal_48)){
if(func_64(PLAYER::PLAYER_PED_ID(), iLocal_48, 1) > 50f){
func_63(8);
func_26();
}elseif((MISC::GET_GAME_TIMER() - iLocal_75) > 10000){
func_63(8);
func_26();
}elseif((iLocal_273==0 && !func_25()) && func_2(&uLocal_80, "REBTHAU", sLocal_247, 4, 0, 0, 0)){
iLocal_273=1;
}}}
...
iVar2=0;
func_36(&iVar2);
iVar3=func_35(Var1, Global_113810.f_7691.f_765[iVar2 /*10*/]);
if(iVar3==2){
func_33(Global_113810.f_7691.f_765[iVar2 /*10*/]);
...
if(!func_31(Global_113810.f_7691.f_765[iVar2 /*10*/])){
Global_113810.f_7691.f_765[iVar2 /*10*/]={
Var1 
};
func_32(&Var1);
...
func_43(13, floor(Global_113810.f_10197.f_3853));
}
...
func_73(&uLocal_286);
func_72(&uLocal_78);
if(iLocal_76==0 && !HUD::DOES_BLIP_EXIST(uLocal_77)){
...
if(fLocal_70 > 0f){
fVar0=func_64(PLAYER::PLAYER_PED_ID(), iLocal_48, 1);
...
fLocal_70=func_64(PLAYER::PLAYER_PED_ID(), iLocal_48, 1);
if(AUDIO::IS_AUDIO_SCENE_ACTIVE("RE_CAR_STEAL_SCENE")){
AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_49, 0);
...
func_91();
if(iLocal_257==0){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_48, 25f, 25f, 25f, 0, 1, 0)){
if(((((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_49, 0) && PED::IS_PED_FACING_PED(iLocal_48, PLAYER::PLAYER_PED_ID(), 30f)) && func_82(iLocal_48, PLAYER::PLAYER_PED_ID(), 1126825984, 1, 250, 7)) && !PED::IS_PED_RAGDOLL(iLocal_48)) && !TASK::IS_PED_GETTING_UP(iLocal_48)) && func_2(&uLocal_80, "REBTHAU", "REBTH_APEBIK", 4, 0, 0, 0)){
TASK::TASK_PLAY_ANIM(iLocal_48, sLocal_267, "RETURNING_FRONT_B", 8f, -8f, -1, 0, 0, 0, 0, 0);
PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, 0);
PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), 0);
iLocal_257=1;
}}else{
iLocal_257=1;
}}}}elseif(((!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49, iLocal_48, 35f, 35f, 35f, 0, 1, 0) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_49, 0)) && !func_81()) && func_2(&uLocal_80, "REBTHAU", "REBTH_PLASTE", 4, 0, 0, 0)){
func_79(0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_48, 0);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_68, joaat("player"));
PED::SET_PED_CAN_BE_TARGETTED(iLocal_48, 1);
...
if(PED::IS_PED_IN_VEHICLE(iLocal_48, iLocal_49, 0)){
if(!func_25() && func_2(&uLocal_80, "REBTHAU", "REBTH_GETOFF", 4, 0, 0, 0)){
}
iLocal_75=MISC::GET_GAME_TIMER();
iLocal_45=4;
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_49, iLocal_48, 20f, 20f, 20f, 0, 1, 0)){
if(func_78()){
...
func_72(&uLocal_78);
func_72(&uLocal_77);
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_49, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_51);
if(iLocal_254==0){
TASK::TASK_ENTER_VEHICLE(0, iLocal_49, 20000, -1, 2f, 8, 0);
}else{
TASK::TASK_ENTER_VEHICLE(0, iLocal_49, 20000, -1, 2f, 262152, 0);
}
TASK::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_49, fLocal_60, 786485);
...
switch (iLocal_254){
case 0:
if((((iLocal_257==1 && !func_76(iLocal_48, joaat("script_task_play_anim"))) && !PED::IS_PED_RAGDOLL(iLocal_48)) && !TASK::IS_PED_GETTING_UP(iLocal_48)) && func_2(&uLocal_80, "REBTHAU", "REBTH_THANKS", 4, 0, 0, 0)){
if(PED::IS_PED_FACING_PED(iLocal_48, PLAYER::PLAYER_PED_ID(), 30f) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_48, joaat("script_task_turn_ped_to_face_entity"))==7){
TASK::TASK_PLAY_ANIM(iLocal_48, sLocal_267, "RETURNING_FRONT_A", 8f, -8f, -1, 0, 0, 0, 0, 0);
}
...
break;
case 1:
if(((((MISC::GET_GAME_TIMER() - iLocal_255) > 10000 && !func_76(iLocal_48, joaat("script_task_play_anim"))) && !PED::IS_PED_RAGDOLL(iLocal_48)) && !TASK::IS_PED_GETTING_UP(iLocal_48)) && func_2(&uLocal_80, "REBTHAU", sLocal_251, 4, 0, 0, 0)){
if(PED::IS_PED_FACING_PED(iLocal_48, PLAYER::PLAYER_PED_ID(), 30f)){
func_79(0);
TASK::TASK_PLAY_ANIM(iLocal_48, sLocal_268, "THANKS_A", 8f, -8f, -1, 0, 0, 0, 0, 0);
}
iLocal_255=MISC::GET_GAME_TIMER();
iLocal_254++;
}
...
break;
case 2:
if(((((MISC::GET_GAME_TIMER() - iLocal_255) > 10000 && !func_76(iLocal_48, joaat("script_task_play_anim"))) && !PED::IS_PED_RAGDOLL(iLocal_48)) && !TASK::IS_PED_GETTING_UP(iLocal_48)) && func_2(&uLocal_80, "REBTHAU", sLocal_252, 4, 0, 0, 0)){
if(PED::IS_PED_FACING_PED(iLocal_48, PLAYER::PLAYER_PED_ID(), 30f)){
func_79(0);
TASK::TASK_PLAY_ANIM(iLocal_48, sLocal_266, "BIKE_BACK_NOW_A", 8f, -8f, -1, 0, 0, 0, 0, 0);
}
iLocal_254++;
}
else{
...
if(func_65(iLocal_47) && PED::IS_PED_BEING_JACKED(iLocal_47)){
return 0;
}
if(!VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_49, -1, 0)){
return 0;
}
return 1;
}
...
if(iParam0==1){
if(!PED::IS_PED_IN_GROUP(iLocal_48) && func_65(PLAYER::PLAYER_PED_ID())){
PED::SET_PED_AS_GROUP_MEMBER(iLocal_48, PED::GET_PED_GROUP_INDEX(PLAYER::PLAYER_PED_ID()));
PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_48, 1);
...
}}elseif(PED::IS_PED_IN_GROUP(iLocal_48)){
...
return (uVar0 || (MISC::GET_GAME_TIMER() - Local_42[iVar2 /*4*/].f_3) < iParam4);
}
...
float fVar2;
Var0={
func_88(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
if((((!func_76(iLocal_48, joaat("script_task_play_anim")) && !PED::IS_PED_FACING_PED(iLocal_48, PLAYER::PLAYER_PED_ID(), 20f)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_48, joaat("script_task_turn_ped_to_face_entity"))==7) && !PED::IS_PED_RAGDOLL(iLocal_48)) && !TASK::IS_PED_GETTING_UP(iLocal_48)){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_48, PLAYER::PLAYER_PED_ID(), 0);
TASK::TASK_LOOK_AT_ENTITY(iLocal_48, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
}}}
...
if(iLocal_66==0){
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_47, 2, 0);
TASK::CLEAR_PED_TASKS(iLocal_47);
if(func_74(iLocal_49)){
if(bLocal_261==2){
if(VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_49)){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_49);
}
VEHICLE::REMOVE_VEHICLE_RECORDING(1, "RE_BikeThief2");
}
if(PED::IS_PED_IN_VEHICLE(iLocal_47, iLocal_49, 1)){
PED::KNOCK_PED_OFF_VEHICLE(iLocal_47);
}}
PED::SET_PED_KEEP_TASK(iLocal_47, 1);
TASK::TASK_SMART_FLEE_PED(iLocal_47, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
iLocal_66=1;
}else{
if(((((iLocal_67==0 && func_64(iLocal_47, PLAYER::PLAYER_PED_ID(), 1) < 30f) && !PED::IS_PED_RAGDOLL(iLocal_47)) && func_76(iLocal_47, joaat("script_task_smart_flee_ped"))) && !func_25()) && func_2(&uLocal_80, "REBTHAU", sLocal_249, 4, 0, 0, 0)){
iLocal_67=1;
}
if(func_64(iLocal_47, PLAYER::PLAYER_PED_ID(), 1) > 50f){
...
func_99(&iLocal_47);
func_98(&iLocal_49);
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_48, PLAYER::PLAYER_PED_ID(), 25f, 25f, 25f, 0, 1, 0) && func_2(&uLocal_80, "REBTHAU", sLocal_253, 4, 0, 0, 0)){
}
TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_48, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
func_97();
}else{
...
int func_102(){
if(func_64(iLocal_49, PLAYER::PLAYER_PED_ID(), 1) > (fLocal_63 + 100f)){
return 1;
}
if(func_64(iLocal_49, PLAYER::PLAYER_PED_ID(), 1) > fLocal_63){
if(((ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, sLocal_265, "IDLE_A", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_48, sLocal_265, "IDLE_A") > 0.99f) || (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, sLocal_265, "IDLE_B", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_48, sLocal_265, "IDLE_B") > 0.99f)) || (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, sLocal_265, "IDLE_C", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_48, sLocal_265, "IDLE_C") > 0.99f)){
return 1;
}}
return 0;
}
...
void func_103(){
if((((((((((iLocal_73 > -1 && (MISC::GET_GAME_TIMER() - iLocal_73) > 5000) && !func_25()) && func_65(iLocal_47)) && func_65(iLocal_48)) && func_74(iLocal_49)) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_47, 13f, 13f, 13f, 0, 1, 0)) && !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_48, iLocal_47, 13f, 13f, 13f, 0, 1, 0)) && PED::IS_PED_IN_VEHICLE(iLocal_47, iLocal_49, 0)) && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_48, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0)) && func_2(&uLocal_80, "REBTHAU", sLocal_248, 4, 0, 0, 0)){
iLocal_73=-1;
}}
...
iLocal_50=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 1);
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_50, 1, 1);
}
if(func_65(iLocal_48)){
TASK::TASK_CLEAR_LOOK_AT(iLocal_48);
}
if((func_65(iLocal_47) && !func_25()) && func_2(&uLocal_80, "REBTHAU", "REBTH_INAIR", 4, 0, 0, 0)){
}
iLocal_45=3;
}else{
if(((iLocal_270==0 && HUD::DOES_BLIP_EXIST(uLocal_77)) && func_65(PLAYER::PLAYER_PED_ID())) && func_65(iLocal_47)){
if(func_64(PLAYER::PLAYER_PED_ID(), iLocal_47, 1) < 30f || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_47, 1), 10f, 1)){
iLocal_270=1;
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_77, iLocal_270);
}}
if(((bLocal_261==2 && func_65(iLocal_47)) && func_74(iLocal_49)) && PED::IS_PED_IN_VEHICLE(iLocal_47, iLocal_49, 0)){
if(iLocal_258==0){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE_USING_AI(iLocal_49, 1, "RE_BikeThief2", 30f, 786468);
iLocal_258=1;
Local_259={
...
}elseif(!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_49) || func_226(iLocal_49, Local_259, 1) < 5f){
if(VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_49)){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_49);
}
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_47, iLocal_49, PLAYER::PLAYER_PED_ID(), 8, fLocal_60, 786468, 10f, 1f, 0);
}}}}

int func_105(){
if(!func_65(iLocal_47)){
return 1;
}elseif(func_65(iLocal_49)){
if(iLocal_288==0){
if(PED::IS_PED_IN_VEHICLE(iLocal_47, iLocal_49, 0)){
iLocal_288=1;
}}elseif(!PED::IS_PED_IN_VEHICLE(iLocal_47, iLocal_49, 0)){
return 1;
}
...
void func_106(){
if((func_65(iLocal_47) && func_74(iLocal_49)) && PED::IS_PED_IN_VEHICLE(iLocal_47, iLocal_49, 0)){
if(iLocal_65){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_47, 40f, 40f, 40f, 0, 1, 0)){
fLocal_60=fLocal_62;
TASK::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_47, fLocal_60);
TASK::TASK_LOOK_AT_ENTITY(iLocal_47, PLAYER::PLAYER_PED_ID(), 20000, 16, 2);
iLocal_65=0;
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_47, 40f, 40f, 40f, 0, 1, 0)){
fLocal_60=fLocal_61;
TASK::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_47, fLocal_60);
TASK::TASK_LOOK_AT_ENTITY(iLocal_47, PLAYER::PLAYER_PED_ID(), 20000, 16, 2);
iLocal_65=1;
...
void func_107(){
if(((((((((iLocal_71 < 5 && !func_25()) && func_65(iLocal_47)) && func_65(iLocal_48)) && func_74(iLocal_49)) && PED::IS_PED_IN_VEHICLE(iLocal_47, iLocal_49, 0)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_47, 13f, 13f, 13f, 0, 1, 0)) && !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_48, iLocal_47, 13f, 13f, 13f, 0, 1, 0)) && (MISC::GET_GAME_TIMER() - iLocal_72) > 15000) && func_2(&uLocal_80, "REBTHAU", sLocal_250, 4, 0, 0, 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_47, joaat("script_task_vehicle_mission"))==1 && !TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_47)){
TASK::TASK_DRIVE_BY(iLocal_47, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 15f, 50, 1, -753768974);
}
...
void func_108(){
if((((iLocal_256==0 && func_65(iLocal_48)) && func_65(iLocal_47)) && func_74(iLocal_49)) && PED::IS_PED_IN_VEHICLE(iLocal_47, iLocal_49, 0)){
if(iLocal_271==0){
if(func_2(&uLocal_80, "REBTHAU", sLocal_245, 4, func_111(), 0, 0)){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_48);
TASK::OPEN_SEQUENCE_TASK(&uLocal_51);
TASK::TASK_LOOK_AT_ENTITY(0, iLocal_47, -1, 2048, 2);
TASK::TASK_GO_STRAIGHT_TO_COORD(0, Local_55, 2f, 20000, 1193033728, 1056964608);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_49, 1000);
TASK::TASK_PLAY_ANIM(0, sLocal_263, sLocal_264, 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_265, "IDLE_A", 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_265, "IDLE_B", 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_265, "IDLE_C", 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_265, "IDLE_B", 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_265, "IDLE_A", 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_265, "IDLE_B", 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, sLocal_265, "IDLE_C", 8f, -8f, -1, 1, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_51);
TASK::TASK_PERFORM_SEQUENCE(iLocal_48, uLocal_51);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_51);
iLocal_72=MISC::GET_GAME_TIMER();
...
iLocal_271=1;
}}elseif(func_65(PLAYER::PLAYER_PED_ID())){
if(func_64(PLAYER::PLAYER_PED_ID(), iLocal_48, 1) < 30f){
if(!func_25()){
...
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_48, PLAYER::PLAYER_PED_ID(), Var1, 0, 1, 0)){
iVar0=0;
}else{
iVar0=1;
}}
...
}elseif((Global_1575063 && iParam0==PLAYER::PLAYER_ID()) && func_124(iParam0, 1, 0)){
return Global_2657704[iParam0 /*463*/].f_321.f_7 !=-1;
}}
return 0;
}
...
if(!func_139(bParam1, bParam2, bParam3) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==2){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
}elseif(!func_140(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}
break;
case 3:
...
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || func_137(bParam1, bParam2, bParam3)){
uParam0->f_5=0;
}}elseif(uParam0->f_6==2){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) || TASK::GET_IS_TASK_ACTIVE(PLAYER::PLAYER_PED_ID(), 2)){
uParam0->f_5=0;
...
if(func_14()==0){
func_153(&uLocal_80, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
sLocal_247="REBTH_RESPM";
}elseif(func_14()==1){
func_153(&uLocal_80, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
sLocal_247="REBTH_RESPF";
}elseif(func_14()==2){
func_153(&uLocal_80, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
sLocal_247="REBTH_RESPT";
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49, 0) && !PED::IS_PED_INJURED(iLocal_47)){
if(bLocal_261==2){
TASK::TASK_ENTER_VEHICLE(iLocal_47, iLocal_49, 20000, -1, 1073741824, 1, 0);
}else{
TASK::OPEN_SEQUENCE_TASK(&uLocal_51);
TASK::TASK_ENTER_VEHICLE(0, iLocal_49, 20000, -1, 1073741824, 1, 0);
TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, iLocal_49, PLAYER::PLAYER_PED_ID(), 8, fLocal_60, 786468, 10f, 1f, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_51);
TASK::TASK_PERFORM_SEQUENCE(iLocal_47, uLocal_51);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_51);
PED::SET_PED_KEEP_TASK(iLocal_47, 1);
}}
func_72(&uLocal_79);
...
if(func_65(iLocal_48)){
if(MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_48, 31086, 0f, 0f, 0f), 3f, 1)){
return 1;
}
Var0={
Var0 + PED::GET_PED_BONE_COORDS(iLocal_48, 31086, 0f, 0f, 0f) 
};
Var1={
Var1 + PED::GET_PED_BONE_COORDS(iLocal_48, 31086, 0f, 0f, 0f) 
};
...
if(FIRE::IS_EXPLOSION_IN_SPHERE(-1, PED::GET_PED_BONE_COORDS(iLocal_48, 31086, 0f, 0f, 0f), 6f)){
return 1;
}
if(PED::IS_PED_FLEEING(iLocal_48)){
return 1;
}
...
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_54 - Vector(20f, 20f, 20f), Local_54 + Vector(20f, 20f, 20f), 0, 1);
VEHICLE::REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA(Local_54 - Vector(20f, 20f, 20f), Local_54 + Vector(20f, 20f, 20f), 0);
MISC::CLEAR_AREA(Local_54, 20f, 1, 0, 0, 0);
iLocal_64=1;
}
...
if((((STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_strpunk_01")) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_beachvesp_01"))) && STREAMING::HAS_MODEL_LOADED(iLocal_46)) && func_158()) && func_157()){
iLocal_49=VEHICLE::CREATE_VEHICLE(iLocal_46, Local_53, fLocal_57, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_46);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_46, 1);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_49, 1, 1, 0);
VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(iLocal_49, 0);
VEHICLE::SET_VEHICLE_INFLUENCES_WANTED_LEVEL(iLocal_49, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(iLocal_49, 1);
AUDIO::START_AUDIO_SCENE("RE_CAR_STEAL_SCENE");
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_49, "RE_CAR_STEAL_STOLEN_VEHICLE", 0);
fLocal_60=fLocal_62;
if(bLocal_261==3){
VEHICLE::SET_VEHICLE_COLOURS(iLocal_49, 49, 0);
VEHICLE::SET_VEHICLE_MOD_KIT(iLocal_49, 0);
VEHICLE::SET_VEHICLE_MOD(iLocal_49, 16, 2, 0);
VEHICLE::SET_VEHICLE_MOD(iLocal_49, 11, 3, 0);
VEHICLE::SET_VEHICLE_MOD(iLocal_49, 12, 2, 0);
VEHICLE::SET_VEHICLE_MOD(iLocal_49, 13, 2, 0);
VEHICLE::SET_VEHICLE_MOD(iLocal_49, 23, 10, 0);
VEHICLE::SET_VEHICLE_MOD(iLocal_49, 24, 10, 0);
VEHICLE::TOGGLE_VEHICLE_MOD(iLocal_49, 22, 1);
VEHICLE::TOGGLE_VEHICLE_MOD(iLocal_49, 17, 1);
VEHICLE::TOGGLE_VEHICLE_MOD(iLocal_49, 21, 1);
VEHICLE::TOGGLE_VEHICLE_MOD(iLocal_49, 20, 1);
VEHICLE::TOGGLE_VEHICLE_MOD(iLocal_49, 19, 1);
VEHICLE::SET_VEHICLE_COLOURS(iLocal_49, 89, 89);
VEHICLE::SET_VEHICLE_EXTRA_COLOURS(iLocal_49, 0, 1);
VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iLocal_49, 1);
}
PED::ADD_RELATIONSHIP_GROUP("re_bikethief_relGroupVictim", &uLocal_68);
PED::ADD_RELATIONSHIP_GROUP("re_bikethief_relGroupThief", &uLocal_69);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_69, uLocal_68);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_69, joaat("player"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_68, joaat("player"));
iLocal_47=PED::CREATE_PED(19, joaat("g_m_y_strpunk_01"), Local_56, fLocal_59, 1, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("g_m_y_strpunk_01"));
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_47, 1);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_47, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_47, uLocal_69);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_47, 3);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_47, 17, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_47, 13, 0);
PED::SET_PED_FLEE_ATTRIBUTES(iLocal_47, 1, 1);
PED::SET_PED_HELMET(iLocal_47, 0);
PED::SET_PED_CONFIG_FLAG(iLocal_47, 42, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_47, 281, 1);
PED::SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(iLocal_47, 2);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_47, "G_M_Y_StreetPunk_01_BLACK_MINI_03");
TASK::TASK_PLAY_ANIM(iLocal_47, sLocal_262, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
iLocal_48=PED::CREATE_PED(19, joaat("a_m_y_beachvesp_01"), Local_54, fLocal_58, 1, 1);
...
if(bLocal_261==3){
PED::SET_PED_HELMET(iLocal_48, 1);
}else{
PED::SET_PED_HELMET(iLocal_48, 0);
}
PED::SET_PED_CONFIG_FLAG(iLocal_48, 26, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_48, 42, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_48, 167, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_48, 281, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_48, iLocal_68);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_48, 0);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_48, "A_M_Y_BeachVesp_01_LATINO_MINI_01");
TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_48, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
...
if(((((STREAMING::HAS_ANIM_DICT_LOADED(sLocal_262) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_263)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_265)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_266)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_268)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_267)){
return 1;
}
return 0;
}
...
if(!PED::IS_PED_INJURED(iLocal_47)){
PED::SET_PED_KEEP_TASK(iLocal_47, 1);
TASK::TASK_SMART_FLEE_PED(iLocal_47, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 1);
}}
...
if(PED::IS_PED_INJURED(iLocal_48)){
return 1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_48, PLAYER::PLAYER_PED_ID(), 1)){
func_165();
func_164(&uLocal_80, "REBTHAU", "REBTH_ATTACK", 4, 0, 0);
return 1;
}elseif(func_161(iLocal_48, 170f)){
func_165();
func_164(&uLocal_80, "REBTHAU", "REBTH_ATTACK", 4, 0, 0);
return 1;
}}
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 && iLocal_257==1){
return 1;
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_49) && !VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49, 0)){
return 1;
}
return 0;
}
...
return (shift_right(iParam0, 26) & 31 * func_199(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_218()) || Global_32286) || func_217()) || func_22(8, -1)) || func_214()) || func_216()) || func_215()) || func_213()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_218()) || Global_112857) || Global_32286) || func_217()) || func_22(8, -1)) || func_216()) || func_215()) || func_213()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_218()) || Global_32286) || func_217()) || func_22(8, -1)) || func_215()) || func_214()) || func_213()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_218()) || func_215()) || Global_112857) || Global_32286) || func_217()) || Global_44569) || func_22(8, -1)) || func_214()) || func_212()) || func_213()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 8:
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_269, 0);
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_54 - Vector(20f, 20f, 20f), Local_54 + Vector(20f, 20f, 20f), 1, 1);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_49, 0)){
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_49, 1);
if(VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_49)){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_49);
}}
if(bLocal_261==2){
...
if((func_65(iLocal_48) && func_65(iLocal_49)) && PED::IS_PED_IN_VEHICLE(iLocal_48, iLocal_49, 0)){
TASK::TASK_VEHICLE_DRIVE_WANDER(iLocal_48, iLocal_49, fLocal_60, 786485);
PED::SET_PED_KEEP_TASK(iLocal_48, 1);
}
func_94(&iLocal_47, 1, 0, 1);
...
VEHICLE::SET_LAST_DRIVEN_VEHICLE(iLocal_50);
func_228(&iLocal_50);
}
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("g_m_y_strpunk_01"));
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("a_m_y_beachvesp_01"));
