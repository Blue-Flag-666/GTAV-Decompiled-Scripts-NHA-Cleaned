...
uLocal_206=PED::CREATE_PED(25, iLocal_34, Local_208, ScriptParam_331.f_17[0], 0, 1);
func_103();
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_206, Local_208, 1f, -1, 1f, 1024, ScriptParam_331.f_17[0]);
iLocal_214=6;
}
break;
case 6:
...
if(bLocal_328){
Global_113755[iLocal_215]=uLocal_327;
}else{
...
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_275);
}}
...
void func_104(){
PED::SET_PED_COMPONENT_VARIATION(uLocal_206, 1, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_206, 11, 0, 0, 0);
PED::SET_PED_PROP_INDEX(uLocal_206, 1, 0, 0, 0, 1);
PED::SET_PED_PROP_INDEX(uLocal_206, 0, 0, 0, 0, 1);
uLocal_275=OBJECT::CREATE_OBJECT(joaat("prop_cs_protest_sign_01"), ENTITY::GET_ENTITY_COORDS(uLocal_206, 1), 1, 1, 0);
