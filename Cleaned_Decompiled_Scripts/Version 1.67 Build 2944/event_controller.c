...
if(func_2(iVar3)){
Global_55736.f_1[iVar3]=uVar1;
iVar3++;
}}elseif(ENTITY::IS_ENTITY_A_PED(uVar1)){
if(func_2(iVar5)){
Global_55736.f_25[iVar5]=uVar1;
iVar5++;
}}}
break;
case 142:
...
if(ENTITY::IS_ENTITY_A_VEHICLE(uVar1)){
if(func_2(iVar4)){
Global_55736.f_13[iVar4]=uVar1;
iVar4++;
}}elseif(ENTITY::IS_ENTITY_A_PED(uVar1)){
if(func_2(iVar6)){
Global_55736.f_37[iVar6]=uVar1;
iVar6++;
}}}
break;
}
...
iVar4=NETWORK::NETWORK_GET_PRESENCE_INVITE_INDEX_BY_ID(uParam2);
if(iVar4 !=-1){
...
}elseif(bVar14 || ((!func_86(PLAYER::PLAYER_ID(), 0) && !func_85()) && !func_84(PLAYER::PLAYER_ID()))){
...
if(!func_80(uVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar27)){
if(!bVar22){
...
MemCopy(&(Global_1936071.f_16[iParam0 /*44*/].f_6),{
Var1
}
, 6);
}else{
...
Global_1936071.f_16[iParam0 /*44*/].f_12={
Var1 
};
}else{
bVar0=false;
...
Global_1936071.f_16[iParam0 /*44*/].f_28={
Var1 
};
}else{
bVar0=false;
...
Global_1936071.f_16[iParam0 /*44*/].f_1=uVar2;
}else{
...
Global_1936071.f_16[iParam0 /*44*/].f_2=uVar2;
}}
if(bVar0){
if(iParam0 !=1){
...
}elseif(func_137(Global_2801145.f_20)){
