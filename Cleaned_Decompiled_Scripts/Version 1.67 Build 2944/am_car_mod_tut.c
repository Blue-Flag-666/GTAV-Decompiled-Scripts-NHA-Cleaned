...
case 0:
if(func_205()==2){
Local_137[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/]=2;
}elseif(func_205()==6){
Local_137[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/]=5;
}
break;
case 2:
if(func_205()==2){
if(!func_204(0)){
func_82();
}elseif(!MISC::IS_BIT_SET(Local_137[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1)){
func_8();
}}elseif(func_205()==6){
Local_137[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/]=5;
}
...
Local_137[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/]=6;
}
break;
case 3:
Local_137[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/]=6;
...
if(NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT()){
if(iLocal_136==0){
MISC::CLEAR_BIT(&uLocal_139, false);
MISC::SET_BIT(&uLocal_139, true);
}
iVar0=iLocal_136;
if(NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar0)){
iVar1=NETWORK::NETWORK_GET_PLAYER_INDEX(iVar0);
if(!MISC::IS_BIT_SET(Local_137[iLocal_136 /*3*/].f_2, 0)){
MISC::CLEAR_BIT(&uLocal_139, true);
}
if(func_4(iVar1, 0, 1)){
if(!MISC::IS_BIT_SET(Global_1853988[iLocal_136 /*867*/].f_143, 4)){
}}}
iLocal_136++;
if(iLocal_136==32){
if(MISC::IS_BIT_SET(uLocal_139, 1)){
MISC::SET_BIT(&(Local_60.f_1), false);
}
MISC::SET_BIT(&uLocal_139, false);
iLocal_136=0;
}}}
...
MISC::SET_BIT(&(Local_137[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), false);
MISC::SET_BIT(&(Local_137[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), true);
func_78(10, 0);
func_77(0);
func_31(1);
func_24();
...
if(func_18()==0){
return MISC::IS_BIT_SET(func_16(func_17(iParam0), -1), iParam1);
}}else{
...
var func__51(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
if(!MISC::IS_BIT_SET(uLocal_139, 5)){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if(MISC::IS_BIT_SET(uLocal_139, 3)){
MISC::CLEAR_BIT(&uLocal_139, 10);
}
if(!PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())){
if(MISC::IS_BIT_SET(uLocal_139, 3)){
MISC::CLEAR_BIT(&uLocal_139, 3);
}
if(MISC::IS_BIT_SET(uLocal_139, 7)){
MISC::CLEAR_BIT(&uLocal_139, 7);
}
if(MISC::IS_BIT_SET(uLocal_139, 8)){
MISC::CLEAR_BIT(&uLocal_139, 8);
}
if(MISC::IS_BIT_SET(uLocal_139, 11)){
MISC::CLEAR_BIT(&uLocal_139, 11);
}
if(!MISC::IS_BIT_SET(uLocal_139, 2)){
if(iLocal_138 !=-1){
func_80(iLocal_138, 0);
func_79(iLocal_138, 0);
iLocal_138=-1;
...
MISC::CLEAR_BIT(&uLocal_139, 3);
func_200("FM_CTUT_CAR", 0);
MISC::SET_BIT(&uLocal_139, 2);
}}else{
if(MISC::IS_BIT_SET(uLocal_139, 2)){
...
if(!MISC::IS_BIT_SET(uLocal_139, 7)){
func_200("FM_CTUT_ANO", 0);
MISC::SET_BIT(&uLocal_139, 7);
}
if(!MISC::IS_BIT_SET(uLocal_139, 8)){
if(func_159()){
...
func_158("FM_CTUT_PRM", -1);
MISC::SET_BIT(&uLocal_139, 8);
MISC::SET_BIT(&uLocal_139, 11);
func_7(&uLocal_144, 0, 0);
}
elseif(!func_167(iVar0)){
MISC::SET_BIT(&uLocal_139, 8);
func_158("FM_CTUT_DRI", -1);
}
elseif(!func_168(iVar0, 0, &uVar1)){
MISC::SET_BIT(&uLocal_139, 8);
func_158("FM_CTUT_HMD", -1);
}}}
}
}
elseif(MISC::IS_BIT_SET(uLocal_139, 11)){
if(func_157(&uLocal_144, 30000, 0)){
if(func_166(ENTITY::GET_ENTITY_MODEL(iVar0))){
if(func_159()){
func_158("FM_CTUT_PRM", -1);
func_156(&uLocal_144);
...
if(func_155("FM_CTUT_HMD")){
HUD::CLEAR_HELP(1);
}
if(!func_154() || (func_154() && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))){
if(!MISC::IS_BIT_SET(uLocal_139, 3)){
func_200("FM_CTUT_MOD", 0);
MISC::SET_BIT(&uLocal_139, 3);
func_156(&uLocal_140);
...
if(iLocal_138==-1){
iLocal_138=func_133(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 4, -1);
if(iLocal_138 !=-1){
...
elseif(func_154() && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())){
if(!MISC::IS_BIT_SET(uLocal_139, 3)){
MISC::SET_BIT(&uLocal_139, 3);
}
}}}
if(!MISC::IS_BIT_SET(uLocal_139, 4)){
if(MISC::IS_BIT_SET(uLocal_139, 3)){
if(func_157(&uLocal_140, 10000, 0)){
if(!HUD::IS_PAUSE_MENU_ACTIVE()){
if(!func_132()){
if(func_159()){
MISC::SET_BIT(&uLocal_139, 4);
}}
}
}}}
}
else{
if(!MISC::IS_BIT_SET(uLocal_139, 10)){
if(!MISC::IS_BIT_SET(uLocal_139, 9)){
func_200("FM_IHELP_LCP", 0);
if(iLocal_138 !=-1){
func_80(iLocal_138, 0);
func_79(iLocal_138, 0);
iLocal_138=-1;
...
if(MISC::IS_BIT_SET(uLocal_139, 3) || (func_154() && MISC::IS_BIT_SET(uLocal_139, 10))){
if(func_154()){
if(((func_155("FM_IHELP_CAR") || func_155("FM_IHELP_MOD")) || func_155("FM_CMOD_GPS")) || func_155("FM_CMOD_STOL")){
HUD::CLEAR_HELP(1);
}
...
if(!MISC::IS_BIT_SET(uLocal_139, 9)){
if(func_127()){
MISC::SET_BIT(&uLocal_139, 9);
MISC::SET_BIT(&(Global_2794162.f_1829), 25);
if(func_129("FM_CTUT_MOD")){
func_24();
}}}
if(func_126()){
if(!MISC::IS_BIT_SET(Global_2794162.f_1829, 25)){
MISC::SET_BIT(&(Global_2794162.f_1829), 25);
}
...
func_24();
}}elseif(MISC::IS_BIT_SET(uLocal_139, 9)){
if(func_122(PLAYER::PLAYER_ID()) || (!func_120() && func_119())){
iVar3=func_113(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0);
if(iVar3 > 0){
if(!func_129("FM_CTUT_REP")){
func_200("FM_CTUT_REP", 0);
}
}
elseif(!func_111()){
if(!func_129("FM_CTUT_RSP")){
func_200("FM_CTUT_RSP", 0);
}
}
elseif(!func_109()){
if(!func_129("FM_IHELP_PTRK")){
func_200("FM_IHELP_PTRK", 0);
}
}
elseif(!func_106()){
if(!func_129("FM_IHELP_PINS")){
func_200("FM_IHELP_PINS", 0);
}
}}}
}
elseif(MISC::IS_BIT_SET(uLocal_139, 9)){
...
MISC::CLEAR_BIT(&uLocal_139, 9);
MISC::CLEAR_BIT(&uLocal_139, 3);
MISC::CLEAR_BIT(&uLocal_139, 10);
func_24();
iLocal_138=-1;
func_93(PLAYER::PLAYER_ID(), 1, 0, 0);
}}elseif(!MISC::IS_BIT_SET(Local_137[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0)){
MISC::SET_BIT(&(Local_137[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), false);
}
}}elseif(MISC::IS_BIT_SET(uLocal_139, 9)){
MISC::CLEAR_BIT(&uLocal_139, 9);
...
MISC::SET_BIT(&uLocal_139, 5);
func_24();
}}elseif(PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || func_154()){
if(CAM::IS_SCREEN_FADED_IN()){
if((((!func_90(PLAYER::PLAYER_ID(), 1, 0) && !func_89()) && func_88()==0) && func_86()) || func_154()){
if(!func_85(&uLocal_142)){
func_7(&uLocal_142, 0, 0);
}elseif(func_157(&uLocal_142, 7000, 0) || func_154()){
...
if(!MISC::IS_BIT_SET(Local_137[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1)){
if(func_84()){
func_8();
}else{
func_83();
...
}elseif(func_157(&uLocal_148, 1000, 0)){
func_158("FM_CMOD_GPS", -1);
iLocal_147++;
}
}}}}
break;
...
if(!func_85(&uLocal_148)){
func_7(&uLocal_148, 0, 0);
}elseif(func_157(&uLocal_148, 5000, 0)){
func_158("FM_IHELP_BLP", -1);
iLocal_147++;
}}}
break;
case 5:
...
if(func_107() >=0){
if(MISC::IS_BIT_SET(Global_1586488[func_107() /*142*/].f_103, 2)){
return 1;
}}
return 0;
}
...
return MISC::IS_BIT_SET(Global_1853988[iParam0 /*867*/].f_143, 19);
}
...
return MISC::IS_BIT_SET(Global_1853988[iParam0 /*867*/].f_143, 20);
}
...
return MISC::IS_BIT_SET(Global_1853988[iParam0 /*867*/].f_143, 21);
}
...
iVar4=iVar0;
if(func_152(iVar4)){
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_134(iVar0, 0), 1);
...
return func_141(2, 2);
}elseif(func_140(Global_1853823)){
...
Vector3 func__138(struct<3> Param0){
...
int func_142(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4){
struct<4> Var0;
struct<3> Var1;
struct<4> Var2;
struct<3> Var3;
...
Var3={
func_143(Var3, -Var0.f_3.f_2) 
};
Var3={
func_143(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__143(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
return MISC::IS_BIT_SET(Global_1853988[iParam0 /*867*/].f_143, 18);
}
...
int func_157(var uParam0, int iParam1, bool bParam2){
if(iParam1==-1){
return 1;
}
...
bool func_165(){
return MISC::IS_BIT_SET(Global_2794162.f_1832, 4);
}
...
return 1;
}elseif(func_185(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if(!func_204(0)){
if(func_124(PLAYER::PLAYER_ID()) || iLocal_146){
func_32(122, 1, -1, 1);
}}
func_77(0);
func_208();
