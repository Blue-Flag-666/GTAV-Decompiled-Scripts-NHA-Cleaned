...
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("auto_shop_seating", Global_2657704[PLAYER::PLAYER_ID() /*463*/].f_321.f_10, 1, 0)){
return 0;
}
...
uParam1->f_16[iParam2 /*14*/].f_6.f_1={
func_107(func_105(), func_108(iParam3, fVar1)) + Var0 
};
uParam1->f_16[iParam2 /*14*/].f_6.f_4={
func_107(func_104(), func_108(iParam3, fVar1)) + Var0 
};
}
