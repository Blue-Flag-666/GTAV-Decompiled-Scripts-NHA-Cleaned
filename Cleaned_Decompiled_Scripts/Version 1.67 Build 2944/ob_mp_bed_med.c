...
case 2:
break;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_333, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) > 6f){
func_84();
}}else{
func_84();
}}}
...
void func_1(){
uLocal_327=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uLocal_326);
switch (iLocal_322){
case 0:
break;
case 1:
...
uLocal_326=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_337, Local_338, 2, 0, 1, 1065353216, 0, 1065353216);
...
if((((func_51(Local_333, Var0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==INTERIOR::GET_INTERIOR_AT_COORDS(Local_333)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_335, Local_336, 2f, 0, 1, 0)) && func_50()) && !func_47(PLAYER::PLAYER_ID())){
if(iLocal_328==-1){
func_46(&iLocal_328, 3, "SA_BED_IN", 0, 0, 0, 0);
}
iLocal_322=1;
}}
break;
...
if(func_45(1, 0, 1)){
if((((((func_51(Local_333, Var0) && Local_339.f_2 < (Local_333.f_2 + 1f)) && func_55(9)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==INTERIOR::GET_INTERIOR_AT_COORDS(Local_333)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_335, Local_336, 2f, 0, 1, 0)) && func_50()) && !func_47(PLAYER::PLAYER_ID())){
if(func_43(iLocal_328, 1)){
func_41(&iLocal_328);
func_40();
...
Local_333={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_329, sLocal_330, Local_337, Local_338, 0, 2) 
};
Var1={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_329, sLocal_330, Local_337, Local_338, 0, 2) 
};
fLocal_334=Var1.f_2;
TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), Local_333, 1f, 5000, fLocal_334, 0.05f);
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==4 && ENTITY::DOES_ENTITY_EXIST(iLocal_39)){
PED::SET_PED_DESIRED_HEADING(PLAYER::PLAYER_PED_ID(), func_16(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_39, 1)));
...
MISC::CLEAR_BIT(&uLocal_320, 0);
uLocal_326=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_337, Local_338, 2, 0, 0, 1065353216, 0, 1065353216);
...
if(((INTERIOR::IS_INTERIOR_READY(INTERIOR::GET_INTERIOR_AT_COORDS(Local_333)) && !func_8()) && !func_6()) && Global_1574632.f_8==0){
bLocal_324=true;
MISC::CLEAR_BIT(&uLocal_320, 0);
uLocal_326=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_337, Local_338, 2, 0, 0, 1065353216, 0, 1065353216);
...
var func__16(struct<2> Param0, Vector3 vParam1, struct<2> Param2, Vector3 vParam3){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_23(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
}elseif(bVar14 || ((!func_19(PLAYER::PLAYER_ID(), 0) && !func_24()) && !func_23(PLAYER::PLAYER_ID()))){
...
if(!func_32(uVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar27)){
if(!bVar22){
...
return MISC::IS_BIT_SET(Global_1654054.f_241.f_136[func_49(9) /*33*/][iParam0], func_48(9));
}
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar0[iVar2], Local_335, Local_336, 2f, 0, 1, 0)){
return 0;
}}
iVar2++;
}}
...
int func_51(struct<3> Param0, float fParam1, var uParam2, var uParam3){
...
if(func_52(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Param0, fParam1, 0)){
return 1;
}}}}}
return 0;
}

int func_52(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
...
if((((((MISC::IS_BIT_SET(Global_1835487, iParam0) || Global_1835488 !=-1) || func_65()) || PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID())) || PLAYER::IS_PLAYER_TARGETTING_ANYTHING(PLAYER::PLAYER_ID())) || func_64()) || func_61(iParam0)){
return 0;
}
