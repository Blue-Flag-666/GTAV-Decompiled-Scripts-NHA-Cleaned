...
if(((((!func_28() && !PED::IS_PED_FLEEING(uLocal_203)) && !PED::IS_PED_RAGDOLL(uLocal_203)) && !PED::IS_PED_PRONE(uLocal_203)) && !PED::IS_PED_INJURED(uLocal_203)) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_203, 0)){
if(func_27(uLocal_203, PLAYER::PLAYER_PED_ID(), 1) <=2.3f){
if((MISC::GET_GAME_TIMER() - iLocal_201) > 8000){
if(func_4(&uLocal_36, "EPS4AUD", "EPS4_FOLLJ", 7, 0, 0, 0)){
iLocal_201=MISC::GET_GAME_TIMER();
}}}}
if(func_27(uLocal_203, PLAYER::PLAYER_PED_ID(), 1) > 150f){
func_3(&uLocal_203);
}}else{
func_2(&uLocal_203, 1, 0, 1);
}
if(func_29(uLocal_202)){
if(((((!func_28() && !PED::IS_PED_FLEEING(uLocal_202)) && !PED::IS_PED_RAGDOLL(uLocal_202)) && !PED::IS_PED_PRONE(uLocal_202)) && !PED::IS_PED_INJURED(uLocal_202)) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_202, 0)){
if(func_27(uLocal_202, PLAYER::PLAYER_PED_ID(), 1) <=2.7f){
if((MISC::GET_GAME_TIMER() - iLocal_201) > 8000){
if(func_4(&uLocal_36, "EPS4AUD", "EPS4_FOLLM", 7, 0, 0, 0)){
iLocal_201=MISC::GET_GAME_TIMER();
}}}}
if(func_27(uLocal_202, PLAYER::PLAYER_PED_ID(), 1) > 150f){
func_3(&uLocal_202);
}}else{
...
PED::SET_PED_NAME_DEBUG(uLocal_203, "POSTJIMMY");
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_203, joaat("player"));
func_31(&uLocal_36, 5, uLocal_203, "JIMMYBOSTON", 1, 1);
}
if(ENTITY::GET_ENTITY_MODEL(uVar2[iVar1])==func_32(60)){
uLocal_202=uVar2[iVar1];
if(!ENTITY::IS_ENTITY_A_MISSION_ENTITY(uLocal_202)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(uLocal_202, 1, 0);
}
PED::SET_PED_MONEY(uLocal_202, 0);
PED::SET_PED_CAN_BE_TARGETTED(uLocal_202, 0);
PED::SET_PED_NAME_DEBUG(uLocal_202, "POSTMARNIE");
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_202, joaat("player"));
...
if(((!func_16()==iParam0 || func_35()) || func_34()) || Global_78686 !=-1){
if(!func_16()==1){
}
if(func_35()){
}
