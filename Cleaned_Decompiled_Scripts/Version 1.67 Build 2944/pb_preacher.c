...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_46, 10f, 10f, 10f, 0, 1, 0) && iLocal_48==0){
settimerb(0);
Local_44={
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_46, 3f, 3f, 3f, 0, 1, 0) && iLocal_47==0){
Local_44={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
settimerb(0);
...
uLocal_46=PED::CREATE_PED(19, joaat("s_m_m_strpreach_01"), Local_43.f_0, Local_43.f_1, Local_44.f_2, 0f, 1, 1);
if(!ENTITY::IS_ENTITY_DEAD(uLocal_46, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_49);
TASK::TASK_TURN_PED_TO_FACE_COORD(0, Local_44, 0);
TASK::TASK_PLAY_ANIM(0, "amb@PREACHER", "PREACH", 8f, -8f, -1, 1, 0, 0, 0, 0);
