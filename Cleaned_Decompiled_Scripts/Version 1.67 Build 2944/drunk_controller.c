...
GRAPHICS::SET_TRANSITION_OUT_OF_TIMECYCLE_MODIFIER((to_float((Global_44537 / 2)) / 1000f));
}
fLocal_16=-99f;
Global_44542=0f;
...
if(Global_44536 !=-1){
fVar1=(to_float(iVar2) / to_float(Global_44537));
}}
return fVar1;
}
...
if(ENTITY::IS_ENTITY_DEAD(Global_44329[iParam0 /*5*/].f_1, 0)){
func_19(iParam0);
return;
}
