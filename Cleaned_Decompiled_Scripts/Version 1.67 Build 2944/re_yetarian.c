...
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_55) < (fVar0 * fVar0)){
RECORDING::REPLAY_DISABLE_CAMERA_MOVEMENT_THIS_FRAME();
}
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_57) < (fVar0 * fVar0)){
RECORDING::REPLAY_DISABLE_CAMERA_MOVEMENT_THIS_FRAME();
}
...
if(func_2(uLocal_46)){
if(func_1(uLocal_46, PLAYER::PLAYER_PED_ID(), 1) > 120f){
func_100();
}}}else{
func_100();
}
...
iLocal_65=1;
iLocal_60=1;
TASK::CLEAR_PED_TASKS(uLocal_46);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_50)){
OBJECT::DELETE_OBJECT(&uLocal_50);
}
if(!bLocal_62){
if(!bLocal_63){
...
TASK::TASK_PERFORM_SEQUENCE(uLocal_46, uLocal_85);
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
if(func_1(uLocal_46, PLAYER::PLAYER_PED_ID(), 1) <=4f){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1500);
}
...
func_36();
PED::SET_PED_MAX_MOVE_BLEND_RATIO(uLocal_46, 2f);
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_46, 0), 1) >=100f && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(uLocal_46, 0), 3f)){
PED::DELETE_PED(&uLocal_46);
}
...
if(func_2(uLocal_46)){
PED::SET_PED_RESET_FLAG(uLocal_46, 60, 1);
}}}else{
...
func_13(13, floor(Global_113810.f_10197.f_3853));
}
...
}elseif(func_2(Local_43[1 /*20*/].f_1)){
...
iLocal_66=1;
}}elseif(func_39(&uLocal_90, cLocal_89, "RE_YETA_FRAN", 7, 0, 0, 0)){
iLocal_66=1;
}}}}elseif(iLocal_67==0){
if(!func_57()){
if(func_2(Local_43[0 /*20*/].f_1)){
...
if(func_2(uLocal_46)){
if(!bLocal_62){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_46, 0), 1) <=7f || TASK::GET_SCRIPT_TASK_STATUS(uLocal_46, joaat("script_task_perform_sequence"))==7){
if(!iLocal_64){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_46, 0), 1) <=7f){
}
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_46, joaat("script_task_perform_sequence"))==7){
}}
return 1;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_46, 0), 1) <=4.5f || TASK::GET_SCRIPT_TASK_STATUS(uLocal_46, joaat("script_task_perform_sequence"))==7){
if(!iLocal_64){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_46, 0), 1) <=4.5f){
}
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_46, joaat("script_task_perform_sequence"))==7){
}}
return 1;
...
void func_59(){
if(func_2(uLocal_46)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_46, "cellphone@", "cellphone_call_out", 3)){
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_46, "cellphone@", "cellphone_call_out") >=0.24f){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_50)){
OBJECT::DELETE_OBJECT(&uLocal_50);
}}}}}
...
int func_60(){
int iVar0;
iVar0=INTERIOR::GET_INTERIOR_AT_COORDS(Local_43[0 /*20*/].f_10);
if(iVar0 !=0){
...
if((MISC::GET_GAME_TIMER() - iLocal_53) >=iLocal_54){
func_62();
...
void func_62(){
if(func_55()==1){
func_56(&uLocal_90, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}else{
func_56(&uLocal_90, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
}
...
int func_65(){
if(!PED::IS_COP_PED_IN_AREA_3D(Local_76, Local_77) && !(MISC::IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && MISC::IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0))){
...
return 1;
}}elseif(PED::IS_COP_PED_IN_AREA_3D(Local_76, Local_77) || (MISC::IS_POSITION_OCCUPIED(-61.01321f, -1093.393f, 25.75297f, 2f, 0, 1, 0, 0, 0, 0, 0) && MISC::IS_POSITION_OCCUPIED(-38.59683f, -1109.284f, 25.68742f, 2f, 0, 1, 0, 0, 0, 0, 0))){
if(INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==MISC::GET_HASH_KEY("rm_showroom")){
...
if(bParam0){
if(func_2(uLocal_48)){
ENTITY::SET_ENTITY_VISIBLE(uLocal_48, 1, 0);
...
func_66(&uLocal_47);
func_78(&uLocal_51);
}}elseif(func_2(uLocal_47)){
ENTITY::SET_ENTITY_VISIBLE(uLocal_47, 1, 0);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_47, 0);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(uLocal_47, 1);
uLocal_46=uLocal_47;
uLocal_50=uLocal_51;
func_66(&uLocal_48);
func_78(&uLocal_52);
...
if(func_2(uLocal_47)){
ENTITY::SET_ENTITY_VISIBLE(uLocal_47, 0, 0);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(uLocal_47, 0);
PED::SET_PED_CAN_BE_TARGETTED(uLocal_47, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_47, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_47, iLocal_88);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_47, 1);
WEAPON::GIVE_WEAPON_TO_PED(uLocal_47, joaat("weapon_pistol"), 999, 0, 0);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_47, 0, iLocal_86);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_86, joaat("player"));
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_47, 1, 1);
PED::SET_PED_CONFIG_FLAG(uLocal_47, 104, 1);
uLocal_51=OBJECT::CREATE_OBJECT(iLocal_72, ENTITY::GET_ENTITY_COORDS(uLocal_47, 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_51, uLocal_47, PED::GET_PED_BONE_INDEX(uLocal_47, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_85, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(uLocal_47, uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_48, iLocal_88);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_48, 1);
WEAPON::GIVE_WEAPON_TO_PED(uLocal_48, joaat("weapon_pistol"), 999, 0, 0);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_48, 0, iLocal_86);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_86, joaat("player"));
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_48, 1, 1);
PED::SET_PED_CONFIG_FLAG(uLocal_48, 104, 1);
uLocal_52=OBJECT::CREATE_OBJECT(iLocal_72, ENTITY::GET_ENTITY_COORDS(uLocal_48, 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_52, uLocal_48, PED::GET_PED_BONE_INDEX(uLocal_48, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
TASK::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_b", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_f", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, "cellphone@str", "cellphone_call_listen_no_a", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_85, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(uLocal_48, uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_47, 1);
}}else{
func_80();
uLocal_73=VEHICLE::CREATE_VEHICLE(joaat("baller2"), -46.2722f, -1097.466f, 25.42f, 112.5363f, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_73, 7);
VEHICLE::SET_VEHICLE_WINDOW_TINT(uLocal_73, 3);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_73, 2);
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_73, 0);
uLocal_74=VEHICLE::CREATE_VEHICLE(joaat("tailgater"), -41.07354f, -1099.567f, 25.42f, 138.4292f, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_74, 12);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_74, 2);
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_74, 0);
uLocal_75=VEHICLE::CREATE_VEHICLE(joaat("bjxl"), -36.74456f, -1101.583f, 25.42f, 155.1573f, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_75, 4);
VEHICLE::SET_VEHICLE_WINDOW_TINT(uLocal_75, 3);
...
if(vmag2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_95()){
return 0;
}}
if(func_91()){
return 1;
...
int func_96(){
if(((((((((((STREAMING::HAS_MODEL_LOADED(Local_43[0 /*20*/]) && STREAMING::HAS_MODEL_LOADED(Local_43[1 /*20*/])) && WEAPON::HAS_WEAPON_ASSET_LOADED(Local_43[0 /*20*/].f_17)) && WEAPON::HAS_WEAPON_ASSET_LOADED(Local_43[1 /*20*/].f_17)) && func_60()) && STREAMING::HAS_ANIM_DICT_LOADED("cellphone@")) && STREAMING::HAS_ANIM_DICT_LOADED("cellphone@str")) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED("reyetarian_simeonoffice")) && STREAMING::HAS_MODEL_LOADED(iLocal_72)) && STREAMING::HAS_MODEL_LOADED(joaat("bjxl"))) && STREAMING::HAS_MODEL_LOADED(joaat("tailgater"))) && STREAMING::HAS_MODEL_LOADED(joaat("baller2"))){
return 1;
}
return 0;
}
...
Local_43[iParam0 /*20*/].f_1=PED::CREATE_PED(22, Local_43[iParam0 /*20*/], Local_43[iParam0 /*20*/].f_10, Local_43[iParam0 /*20*/].f_13, 1, 1);
if(func_2(Local_43[iParam0 /*20*/].f_1)){
if(iParam0==0){
TASK::TASK_START_SCENARIO_AT_POSITION(Local_43[iParam0 /*20*/].f_1, "PROP_HUMAN_SEAT_CHAIR", Local_78[iParam0 /*3*/], fLocal_79[iParam0], 0, 0, 1);
PED::SET_PED_SHOULD_PLAY_NORMAL_SCENARIO_EXIT(Local_43[iParam0 /*20*/].f_1);
PED::SET_PED_SHOULD_IGNORE_SCENARIO_EXIT_COLLISION_CHECKS(Local_43[iParam0 /*20*/].f_1, 1);
PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_43[iParam0 /*20*/].f_1, -37.34785f, -1102.022f, 25.42232f, 3f, 0, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_43[iParam0 /*20*/].f_1, 37, 1);
}
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_43[iParam0 /*20*/].f_1, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_43[iParam0 /*20*/].f_1, iLocal_86);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(Local_43[iParam0 /*20*/].f_1, 0, iLocal_86);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_43[iParam0 /*20*/].f_1, 23, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_43[iParam0 /*20*/].f_1, 1, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_43[iParam0 /*20*/].f_1, 28, 1);
WEAPON::SET_PED_CHANCE_OF_FIRING_BLANKS(Local_43[iParam0 /*20*/].f_1, 0.7f, 0.3f);
iLocal_68[iParam0]=0;
if(func_55()==0){
WEAPON::GIVE_WEAPON_TO_PED(Local_43[iParam0 /*20*/].f_1, Local_43[iParam0 /*20*/].f_17, -1, 1, 1);
}
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_43[iParam0 /*20*/]);
...
TASK::CLEAR_PED_TASKS(Local_43[iParam0 /*20*/].f_1);
PED::SET_PED_USING_ACTION_MODE(Local_43[iParam0 /*20*/].f_1, 1, -1, "DEFAULT_ACTION");
TASK::OPEN_SEQUENCE_TASK(&uLocal_85);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 12, 2);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_43[iParam0 /*20*/].f_14, 1f, -1, 3f, 0, 1193033728);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_85);
TASK::TASK_PERFORM_SEQUENCE(Local_43[iParam0 /*20*/].f_1, uLocal_85);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_85);
Local_43[iParam0 /*20*/].f_18=3;
}
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(Local_43[iParam0 /*20*/].f_1, 0), 1) >=250f){
...
if(func_2(Local_43[iParam0 /*20*/].f_1)){
func_99(Local_43[iParam0 /*20*/].f_1, &(Local_43[iParam0 /*20*/].f_2), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0, 0);
if(TASK::GET_SCRIPT_TASK_STATUS(Local_43[iParam0 /*20*/].f_1, joaat("script_task_perform_sequence"))==7 || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(Local_43[iParam0 /*20*/].f_1, 0), 1) <=5f){
TASK::TASK_LOOK_AT_ENTITY(Local_43[iParam0 /*20*/].f_1, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
TASK::TASK_COMBAT_PED(Local_43[iParam0 /*20*/].f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_ALERTNESS(Local_43[iParam0 /*20*/].f_1, 3);
PED::SET_PED_KEEP_TASK(Local_43[iParam0 /*20*/].f_1, 1);
...
WEAPON::GIVE_WEAPON_TO_PED(Local_43[iParam0 /*20*/].f_1, Local_43[iParam0 /*20*/].f_17, -1, 0, 1);
iLocal_68[iParam0]=1;
}}
if(TASK::GET_SCRIPT_TASK_STATUS(Local_43[iParam0 /*20*/].f_1, joaat("script_task_combat"))==7){
TASK::TASK_COMBAT_PED(Local_43[iParam0 /*20*/].f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
}
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(Local_43[iParam0 /*20*/].f_1, 0), 1) >=75f){
Local_43[iParam0 /*20*/].f_18=5;
}}
break;
case 5:
func_98(&(Local_43[iParam0 /*20*/].f_2));
if(ENTITY::DOES_ENTITY_EXIST(Local_43[iParam0 /*20*/].f_1)){
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(Local_43[iParam0 /*20*/].f_1));
}
...
func_101(-1);
PED::REMOVE_RELATIONSHIP_GROUP(iLocal_86);
PED::REMOVE_RELATIONSHIP_GROUP(uLocal_87);
...
fLocal_79[1]=136.57f;
PED::ADD_RELATIONSHIP_GROUP("GoonGroup", &iLocal_86);
PED::ADD_RELATIONSHIP_GROUP("PlayerGroup", &iLocal_87);
PED::ADD_RELATIONSHIP_GROUP("YetarianGroup", &iLocal_88);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_88, joaat("player"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("player"), iLocal_88);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_86, joaat("player"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_86);
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(-51.0518f, -1104.685f, 25.2975f, -29.9812f, -1094.079f, 27.5686f, 0, 1);
uLocal_80=PED::ADD_SCENARIO_BLOCKING_AREA(-79.95f, -1126.33f, 20.65f, -3.5f, -1081.6f, 30.67f, 0, 1, 1, 1);
TASK::ADD_COVER_BLOCKING_AREA(-34.2476f, -1107.283f, 24.9621f, -24.7924f, -1102.557f, 29.8287f, 1, 1, 1, 0);
if(iLocal_84==-1){
iLocal_84=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(-29.3f, -1086.35f, 25.57f, 5.5f, 3f, 2f, -10f, 0, 7);
}
func_131(196, 0);
func_131(197, 0);
func_131(194, 0);
func_131(195, 0);
STREAMING::REQUEST_MODEL(Local_43[0 /*20*/]);
STREAMING::REQUEST_MODEL(Local_43[1 /*20*/]);
...
WEAPON::REQUEST_WEAPON_ASSET(Local_43[0 /*20*/].f_17, 31, 0);
WEAPON::REQUEST_WEAPON_ASSET(Local_43[1 /*20*/].f_17, 31, 0);
...
if(!func_166(Global_113810.f_24998.f_43[iParam1])){
return 0;
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_112857) || Global_32286) || func_163()) || func_52(8, -1)) || func_162()) || func_161()) || func_160()) || func_159()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_164()) || Global_32286) || func_163()) || func_52(8, -1)) || func_160()) || func_162()) || func_161()) || func_159()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_112857) || Global_32286) || func_163()) || func_52(8, -1)) || func_160()) || func_162()) || func_161()) || func_159()) || Global_113810.f_7691.f_919[iVar0]==5) || Global_43924 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_112857) || Global_32286) || func_163()) || func_52(8, -1)) || func_162()) || func_161()) || func_159()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_164()) || func_161()) || Global_112857) || Global_32286) || func_163()) || Global_44569) || func_52(8, -1)) || func_160()) || func_158()) || func_159()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 8:
