...
TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), Var2, 1f, 20000, uVar4, fVar5);
func_3(uParam0->f_9);
func_2(uParam0, 5);
break;
case 5:
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_73(PLAYER::PLAYER_ID()), Global_1950844.f_1030[154 /*3*/], 1) >=150f){
return 1;
}
if(func_65()){
return 1;
...
func_84(func_86(), func_85(iParam3, fVar1)) + Var0 
};
uParam1->f_16[iParam2 /*14*/].f_6.f_4={
func_84(func_83(), func_85(iParam3, fVar1)) + Var0 
};
