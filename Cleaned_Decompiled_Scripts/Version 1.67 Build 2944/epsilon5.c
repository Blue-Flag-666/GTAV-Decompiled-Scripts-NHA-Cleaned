...
fLocal_28=180f;
iLocal_31=3;
uLocal_76=func_355(60);
uLocal_77=func_355(14);
sLocal_81="Marnie";
fLocal_251=40f;
fLocal_252=0.35f;
fLocal_253=0f;
...
wait(0);
func_286(Local_82.f_9, 0, 0, 0, 0, 0);
switch (iLocal_79){
case 0:
func_260();
break;
...
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_82.f_28[0], sLocal_81, 0, 0, 0);
}
...
func_203(13, floor(Global_113810.f_10197.f_3853));
}
...
iVar2=iVar5;
Var3={
func_211(Global_44588[iVar5 /*12*/].f_1) 
};
...
Var3={
func_211(Global_44588[iVar11 /*12*/].f_1) 
};
}}
if(!bParam4){
...
if(bVar1){
func_207(HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar2, &cVar2, 0, 2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(func_208(iParam1)), 0));
}else{
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_226(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
if(!func_257(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
break;
case 1:
if(func_277(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 1) >=4.5f){
if(!CAM::IS_GAMEPLAY_HINT_ACTIVE()){
if(func_276()){
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_82.f_28[0], 0f, 0f, 0.5f, 1, 30000, 2000, 2000, 0);
}else{
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_82.f_28[0], -1f, 0f, 0f, 0, 30000, 2000, 2000, 0);
}
CAM::SET_GAMEPLAY_HINT_FOV(fLocal_251);
CAM::SET_GAMEPLAY_HINT_FOLLOW_DISTANCE_SCALAR(fLocal_252);
CAM::SET_GAMEPLAY_HINT_BASE_ORBIT_PITCH_OFFSET(fLocal_253);
CAM::SET_GAMEPLAY_HINT_CAMERA_RELATIVE_SIDE_OFFSET(fLocal_254);
CAM::SET_GAMEPLAY_HINT_CAMERA_RELATIVE_VERTICAL_OFFSET(fLocal_255);
CAM::SET_GAMEPLAY_HINT_CAMERA_BLEND_TO_FOLLOW_PED_MEDIUM_VIEW_MODE(1);
}else{
CAM::STOP_GAMEPLAY_HINT_BEING_CANCELLED_THIS_UPDATE(1);
}}
if(iLocal_250==0){
if(func_277(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 1) <=2.5f){
...
if(func_249(Local_82.f_28[0])){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_82.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall", 3)){
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_82.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall") < 0.1f){
func_275(&uLocal_83, 4, Local_82.f_28[0], "MARNIE", 0, 1);
func_275(&uLocal_83, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
TASK::TASK_LOOK_AT_ENTITY(Local_82.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 12, 2);
TASK::TASK_PLAY_ANIM(Local_82.f_28[0], "rcmepsilonism5", "leadin_action", 8f, -8f, -1, 2, 0, 0, 0, 0);
iLocal_80=2;
}}}}
break;
case 2:
if(func_249(Local_82.f_28[0])){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_82.f_28[0], "rcmepsilonism5", "leadin_action", 3)){
if(iLocal_249==0){
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_82.f_28[0], "rcmepsilonism5", "leadin_action") >=0.38f){
if(func_261(&uLocal_83, "EPS5AUD", "EP5_RCM_LI", 8, 0, 0, 0)){
iLocal_249=1;
}
}}
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_82.f_28[0], "rcmepsilonism5", "leadin_action") >=0.95f){
iLocal_80=3;
}
if(iLocal_250==0){
if(func_277(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 1) <=2.5f){
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_257(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
void func_286(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_288(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
int func_310(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_311(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
int func_311(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_153(iParam1)){
...
if(func_332()){}
if(func_249(Local_82.f_28[0])){
PED::SET_PED_CAN_BE_TARGETTED(Local_82.f_28[0], 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_82.f_28[0], joaat("player"));
}
func_319(&Local_82, 0, 0, 0);
...
iVar2=func_336(SCRIPT::GET_THIS_SCRIPT_NAME());
if(iVar2 > -1){
