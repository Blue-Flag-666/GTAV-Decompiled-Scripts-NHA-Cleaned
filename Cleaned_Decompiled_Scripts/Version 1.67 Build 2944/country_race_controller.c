...
StringIntConCat(&cVar0, Global_113810.f_25076 + 1, 16);
func_9(&cVar0, -1);
}
...
if(iLocal_148==2){
iLocal_148=func_17(&Global_113808, 2, 9, 0, 0);
}elseif(iLocal_148==1){
func_15(&uLocal_150, 0);
func_14(&uLocal_149, 0);
...
PAD::DISABLE_CONTROL_ACTION(0, 74, 1);
PED::SET_IK_TARGET(uLocal_150, 1, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 0, 150, 400);
if(func_41()){
if(func_38()){
func_35();
func_33();
...
void func_33(){
if(((((CAM::GET_FOLLOW_VEHICLE_CAM_VIEW_MODE() !=3 && CAM::GET_FOLLOW_VEHICLE_CAM_VIEW_MODE() !=4) && !CAM::IS_GAMEPLAY_CAM_LOOKING_BEHIND()) && PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) && func_34(uLocal_150)) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 20f){
if(iLocal_152){
if(!CAM::IS_GAMEPLAY_HINT_ACTIVE()){
CAM::SET_GAMEPLAY_ENTITY_HINT(uLocal_150, 0f, 0f, 0f, 1, 2000, 2000, 2000, 0);
iLocal_152=0;
}}}else{
if(CAM::IS_GAMEPLAY_HINT_ACTIVE()){
CAM::STOP_GAMEPLAY_HINT(0);
...
void func_35(){
if(MISC::GET_GAME_TIMER() > iLocal_151 + 5000){
func_36(uLocal_150, "PRERACE_CHAT", 11);
...
int func_43(){
if((!Global_113810.f_25076.f_9 && !Global_113810.f_25076.f_8) && vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_60()) < 84100f){
Global_113810.f_25076.f_9=func_54();
func_51();
if(!Global_113810.f_25076.f_9){
if(func_61(uLocal_150) && func_61(uLocal_149)){
...
func_15(&uLocal_150, 1);
func_14(&uLocal_149, 1);
if(Global_113810.f_25076.f_9){
...
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_149) && !ENTITY::DOES_ENTITY_EXIST(uLocal_150)){
...
uLocal_149=VEHICLE::CREATE_VEHICLE(func_50(), func_49(), func_48(), 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_149, 1084227584);
if(Global_113810.f_25076==4){
VEHICLE::SET_VEHICLE_LIVERY(uLocal_149, 0);
VEHICLE::SET_VEHICLE_COLOURS(uLocal_149, 44, 83);
VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_149, 111, 111);
}
VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_149, 3);
VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(uLocal_149, 0, 0);
VEHICLE::SET_VEHICLE_DISABLE_TOWING(uLocal_149, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_50());
uLocal_150=PED::CREATE_PED(26, joaat("a_m_y_motox_02"), func_47(), func_46(), 1, 1);
func_45(uLocal_150);
AUDIO::SET_AMBIENT_VOICE_NAME(uLocal_150, "A_M_Y_RACER_01_WHITE_MINI_01");
TASK::TASK_START_SCENARIO_IN_PLACE(uLocal_150, "WORLD_HUMAN_STAND_IMPATIENT", -1, 1);
...
void func_51(){
if(func_61(uLocal_150)){
if((!PED::IS_PED_FLEEING(uLocal_150) && !PED::IS_PED_IN_COMBAT(uLocal_150, 0)) && !PED::IS_PED_RAGDOLL(uLocal_150)){
if(!func_53(uLocal_150, joaat("script_task_start_scenario_in_place"), 1)){
TASK::TASK_START_SCENARIO_IN_PLACE(uLocal_150, "WORLD_HUMAN_STAND_IMPATIENT", -1, 1);
}
if(func_52(uLocal_149) || Global_113810.f_25076.f_9){
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(uLocal_150);
TASK::TASK_COMBAT_PED(uLocal_150, PLAYER::PLAYER_PED_ID(), 0, 16);
}
fLocal_153=ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID());
}elseif(PED::IS_PED_RAGDOLL(uLocal_150)){
if(!func_53(uLocal_150, joaat("script_task_combat"), 1)){
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(uLocal_150);
TASK::TASK_COMBAT_PED(uLocal_150, PLAYER::PLAYER_PED_ID(), 0, 16);
}}}}
...
if(func_61(uParam0)){
if((func_61(uVar0) && fLocal_153 !=0f) && fLocal_153 >=9f){
fVar1=ENTITY::GET_ENTITY_SPEED(uVar0);
if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(uParam0, uVar0) && fVar1 <=(fLocal_153 * 0.5f)){
return 1;
}}
...
return 1;
}elseif(PED::IS_PED_FLEEING(uLocal_150)){
return 1;
}elseif(PED::IS_PED_IN_COMBAT(uLocal_150, 0)){
return 1;
}elseif(PED::IS_PED_RAGDOLL(uLocal_150)){
return 1;
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_149)){
if(ENTITY::IS_ENTITY_DEAD(uLocal_149, 0)){
return 1;
}else{
if(func_55(uLocal_149, func_49(), 1) > 2f){
return 1;
}
if(WEAPON::HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(PLAYER::PLAYER_PED_ID(), uLocal_149, 0, -1)){
return 1;
}}}
return 0;
}
...
func_12(&Global_113808);
if(func_61(uLocal_150)){
if(func_53(uLocal_150, joaat("script_task_start_scenario_at_position"), 1) || func_53(uLocal_150, joaat("script_task_start_scenario_in_place"), 1)){
TASK::TASK_WANDER_STANDARD(uLocal_150, 1193033728, 0);
}}
func_15(&uLocal_150, bParam0);
func_14(&uLocal_149, bParam0);
if(bParam0){
