...
func_292(&uLocal_96, 4494.842f, -4522.146f, 4.9819f, -10.7044f, 0.1567f, 155.8207f, "HS4_NIMB_ISD_LSA", 0, 0, 1, 0);
}


void func_292(var uParam0, struct<3> Param1, struct<3> Param2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7){
func_293(uParam0, sParam3, iParam4, iParam5, iParam6);
uParam0->f_9={
Param1 
};
uParam0->f_12={
