...
iVar4=0;
iVar4=0;
while (iVar4 < Global_43338){
if(func_15(Global_43344[iVar4 /*4*/].f_2)){
iVar2[iVar4]=0;
}
else{
iVar2[iVar4]=1;
}
if(Global_43344[iVar4 /*4*/].f_1==7){
iVar2[iVar4]=1;
}
iVar4++;
}
...
iVar4=0;
iVar4=0;
while (iVar4 < (Global_43338 - 1)){
if(!iVar2[iVar4 + 1]){
if(Global_43344[iVar4 + 1 /*4*/].f_1 < Global_43344[iVar5 /*4*/].f_1){
iVar5=iVar4 + 1;
}
}
iVar4++;
...
iVar3=iVar5;
if(Global_43344[iVar3 /*4*/].f_2==15){
iVar3=-1;
}
if(iVar3 !=-1){
if(!func_15(Global_43344[iVar3 /*4*/].f_2)){
iVar3=-1;
}}}
if(iVar3 > -1){
Global_43339=Global_43344[iVar3 /*4*/];
Global_43340=Global_43344[iVar3 /*4*/].f_3;
Global_43377=Global_43344[iVar3 /*4*/].f_2;
Global_43338=0;
Global_43343=0;
}else{
Global_43338=0;
...
return (shift_right(iParam0, 26) & 31 * func_7(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
