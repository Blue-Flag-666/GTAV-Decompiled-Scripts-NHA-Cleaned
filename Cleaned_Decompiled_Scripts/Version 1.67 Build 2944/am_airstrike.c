...
}elseif(func_10(&uLocal_63, 10000, 0)){
Local_236.f_0=3;
}}
if(func_9()){
Local_236.f_0=3;
}
if(!MISC::IS_BIT_SET(Global_44572, 10)){
if(Local_236.f_55==1){
if(!Local_236.f_56){
...
Local_59={
ENTITY::GET_ENTITY_COORDS(NETWORK::NET_TO_VEH(Local_236.f_2), 1) 
};
...
if(!MISC::IS_BIT_SET(uLocal_235, Local_236.f_50)){
Var1={
Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 
};
...
Var2={
Var2 + Vector(0f, 0.1f, 0.1f) 
};
MISC::GET_GROUND_Z_FOR_3D_COORD(Var2 + Vector(10f, 0f, 0f), &(Var2.f_2), 0, 0);
Var2.f_2=(Var2.f_2 - 25f);
MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS_IGNORE_ENTITY_NEW(Var1, Var2, iVar3, 1, joaat("weapon_airstrike_rocket"), PLAYER::PLAYER_PED_ID(), 1, 0, -1f, iVar0, 1, 1, 0, 0, 0, 0, 0);
func_11(&(Local_236.f_51), 0, 0);
iLocal_55=1;
MISC::SET_BIT(&uLocal_235, Local_236.f_50);
if(func_41()){
if(func_38()){
func_15(&uLocal_67, "HS4FAUD", "HS4F_SAAIP1", 12, 0, 0, 0);
}}}}elseif(func_10(&(Local_236.f_51), 750, 0)){
...
if(!MISC::IS_BIT_SET(uLocal_235, Local_236.f_50)){
Var1={
Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(0f, 5f, 5f) 
};
Var1.f_2=Local_59.f_2;
Var2={
Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(0f, 5f, 5f) 
...
MISC::GET_GROUND_Z_FOR_3D_COORD(Var2 + Vector(10f, 0f, 0f), &(Var2.f_2), 0, 0);
Var2.f_2=(Var2.f_2 - 25f);
MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS_IGNORE_ENTITY_NEW(Var1, Var2, iVar3, 1, joaat("weapon_airstrike_rocket"), NETWORK::NET_TO_PED(Local_236.f_2.f_3), 1, 0, -1f, iVar0, 1, 0, 0, 0, 0, 0, 0);
func_11(&(Local_236.f_51), 0, 0);
MISC::SET_BIT(&uLocal_235, Local_236.f_50);
}}elseif(func_10(&(Local_236.f_51), 500, 0)){
func_14(&(Local_236.f_51));
Local_236.f_50++;
}
break;
...
if(!MISC::IS_BIT_SET(uLocal_235, Local_236.f_50)){
Var1={
Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(0f, 5f, 10f) 
};
Var1.f_2=Local_59.f_2;
Var2={
Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(0f, 5f, 10f) 
...
if(!MISC::IS_BIT_SET(uLocal_235, Local_236.f_50)){
Var1={
Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(0f, 10f, 10f) 
};
Var1.f_2=Local_59.f_2;
Var2={
Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(0f, 10f, 10f) 
...
int iVar4;
if(func_42(Local_236.f_2)){
uVar0=NETWORK::NET_TO_VEH(Local_236.f_2);
Var2={
ENTITY::GET_ENTITY_COORDS(uVar0, 1) 
};
}
if(!iLocal_57){
if(!func_44(Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2)){
Var1={
Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 
};
...
if(iLocal_56 && !MISC::IS_BIT_SET(Global_44572, 10)){
if(!iLocal_57){
if(func_42(Local_236.f_2)){
if(!ENTITY::IS_ENTITY_AT_COORD(iVar0, Local_58, 75f, 75f, 1000f, 0, 1, 0)){
fLocal_60=MISC::GET_DISTANCE_BETWEEN_COORDS(Var2, Var1, 0);
}else{
iLocal_57=1;
}}else{
iLocal_57=1;
...
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(!iLocal_54 && !MISC::IS_BIT_SET(Global_44572, 10)){
...
iLocal_54=1;
}}elseif(MISC::IS_BIT_SET(Global_44572, 10) || MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(PLAYER::PLAYER_PED_ID(), joaat("weapon_flare"), 100f, &(Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 1)){
if(MISC::IS_BIT_SET(Global_44572, 10)){
Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
}elseif(func_96(Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 0f, 0f, 0f, 0)){
Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2={
Var0 
};
}
...
if(func_42(Local_236.f_2)){
func_94();
TASK::CLEAR_PED_TASKS(NETWORK::NET_TO_PED(Local_236.f_2.f_3));
TASK::TASK_PERFORM_SEQUENCE(NETWORK::NET_TO_PED(Local_236.f_2.f_3), uLocal_47);
VEHICLE::SET_TASK_VEHICLE_GOTO_PLANE_MIN_HEIGHT_ABOVE_TERRAIN(NETWORK::NET_TO_VEH(Local_236.f_2), round(50f));
iLocal_53=1;
}}}}elseif(!iLocal_52 && !MISC::IS_BIT_SET(Global_44572, 10)){
...
uLocal_45=HUD::ADD_BLIP_FOR_ENTITY(uVar0);
HUD::SET_BLIP_SPRITE(uLocal_45, 16);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_45, func_60());
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_45, 0);
}else{
HUD::SET_BLIP_ROTATION(uLocal_45, ceil(ENTITY::GET_ENTITY_HEADING(uVar0)));
}
if(!iLocal_51){
if(!func_44(Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2)){
Var3={
...
AUDIO::PLAY_STREAM_FROM_VEHICLE(NETWORK::NET_TO_VEH(Local_236.f_2));
iLocal_51=1;
}}
if(!iLocal_233 && !MISC::IS_BIT_SET(Global_44572, 10)){
if(!Local_236.f_54){
if(!func_95(Local_236.f_2.f_3)){
if(!func_44(Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2)){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_59(PLAYER::PLAYER_ID()), ENTITY::GET_ENTITY_COORDS(NETWORK::NET_TO_VEH(Local_236.f_2.f_3), 1), 0) <=250f){
...
}elseif(func_10(&uLocal_61, 7500, 0)){
Local_236.f_53=1;
}
Var1={
Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 - Vector(1000f, 25f, 25f) 
};
Var2={
Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(1000f, 25f, 25f) 
};
...
elseif(ENTITY::IS_ENTITY_AT_COORD(iVar0, Local_58, 75f, 75f, 1000f, 0, 1, 0)){
Local_236.f_53=1;
Local_236.f_50=100;
Local_236.f_54=1;
if(!iLocal_234 && !MISC::IS_BIT_SET(Global_44572, 10)){
if(func_41()){
if(!func_38()){
...
if(NETWORK::NETWORK_HAS_CONTROL_OF_NETWORK_ID(Local_236.f_2.f_3)){
uVar0=NETWORK::NET_TO_PED(Local_236.f_2.f_3);
...
if(func_95(Local_236.f_2.f_3)){
func_92(3);
}}elseif(func_95(Local_236.f_2.f_3)){
func_92(3);
}
break;
case 3:
...
}elseif(func_91(Local_236.f_2.f_1) && func_91(Local_236.f_2.f_3.f_1)){
...
int func_65(){
if((!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_236.f_2.f_3) && func_91(Local_236.f_2.f_3.f_1)) && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_236.f_2)){
if(func_42(Local_236.f_2)){
if(func_67(&(Local_236.f_2.f_3), Local_236.f_2, 22, Local_236.f_2.f_3.f_1, -1, 1, 1, 1)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(NETWORK::NET_TO_PED(Local_236.f_2.f_3), 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(NETWORK::NET_TO_PED(Local_236.f_2.f_3), Global_1837216);
PED::SET_PED_RANDOM_COMPONENT_VARIATION(NETWORK::NET_TO_PED(Local_236.f_2.f_3), 0);
PED::SET_PED_KEEP_TASK(NETWORK::NET_TO_PED(Local_236.f_2.f_3), 1);
func_66();
TASK::TASK_PERFORM_SEQUENCE(NETWORK::NET_TO_PED(Local_236.f_2.f_3), uLocal_46);
VEHICLE::SET_TASK_VEHICLE_GOTO_PLANE_MIN_HEIGHT_ABOVE_TERRAIN(NETWORK::NET_TO_VEH(Local_236.f_2), round(50f));
}}}
if(!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_236.f_2.f_3)){
return 0;
}
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_236.f_2.f_3.f_1);
return 1;
}
...
TASK::TASK_PLANE_MISSION(0, NETWORK::NET_TO_VEH(Local_236.f_2), 0, 0, Local_58 + Vector((50f + 5f), 0f, 0f), 4, 60f, 15f, -1f, ceil((50f + 5f)), 20, 1);
TASK::TASK_PLANE_MISSION(0, NETWORK::NET_TO_VEH(Local_236.f_2), 0, 0, Local_236.f_2.f_14, 4, 60f, 25f, -1f, ceil((50f + 5f)), 20, 1);
...
struct<3> Var0;
var uVar1;
if(!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_236.f_2)){
...
VEHICLE::SET_VEHICLE_DOORS_LOCKED(NETWORK::NET_TO_VEH(Local_236.f_2), 2);
ENTITY::FREEZE_ENTITY_POSITION(NETWORK::NET_TO_VEH(Local_236.f_2), 0);
ENTITY::SET_ENTITY_DYNAMIC(NETWORK::NET_TO_VEH(Local_236.f_2), 1);
PHYSICS::ACTIVATE_PHYSICS(NETWORK::NET_TO_VEH(Local_236.f_2));
VEHICLE::SET_VEHICLE_FORWARD_SPEED(NETWORK::NET_TO_VEH(Local_236.f_2), 60f);
VEHICLE::SET_VEHICLE_ENGINE_ON(NETWORK::NET_TO_VEH(Local_236.f_2), 1, 1, 0);
VEHICLE::SET_VEHICLE_EXTENDED_REMOVAL_RANGE(NETWORK::NET_TO_VEH(Local_236.f_2), 1000);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(NETWORK::NET_TO_VEH(Local_236.f_2), 0);
VEHICLE::CONTROL_LANDING_GEAR(NETWORK::NET_TO_VEH(Local_236.f_2), 3);
VEHICLE::OPEN_BOMB_BAY_DOORS(NETWORK::NET_TO_VEH(Local_236.f_2));
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_236.f_2.f_1);
return 1;
}}}}}
return 0;
}
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_79(PLAYER::PLAYER_ID()), Param0, 1) <=(fVar2 + fParam1)){
...
if((func_74(iVar1) || !bParam8) && !Global_2657704[iVar1 /*463*/].f_270){
fVar2=fParam4;
if(fParam7 > 0f){
...
if(((PLAYER::GET_PLAYER_TEAM(PLAYER::PLAYER_ID())==-1 && uParam7) && bParam4) && func_82(iVar1)){
...
float fVar0;
*uParam0={
func_89(Local_58 + Vector(200f, 0f, 0f), 600f, 600f, (200f / 2f)) 
};
...
var func__88(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3){
return MISC::GET_HEADING_FROM_VECTOR_2D((Param2.f_0 - Param0.f_0), (Param2.f_1 - Param0.f_1));
}


Vector3 func__89(struct<3> Param0, float fParam1, float fParam2, float fParam3){
struct<3> Var0;
float fVar1;
Var0={
...
fVar1=(fParam3 / 2f);
Var0={
func_90(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(fParam1, fParam2)) 
};
...
TASK::TASK_PLANE_MISSION(0, NETWORK::NET_TO_VEH(Local_236.f_2), 0, 0, Local_238[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector((50f + 5f), 0f, 0f), 4, 60f, 15f, -1f, ceil((50f + 5f)), 20, 1);
TASK::TASK_PLANE_MISSION(0, NETWORK::NET_TO_VEH(Local_236.f_2), 0, 0, Local_236.f_2.f_14, 4, 60f, 25f, -1f, ceil((50f + 5f)), 20, 1);
...
func_99(&uLocal_67, 3, NETWORK::NET_TO_PED(Local_236.f_2.f_3), sVar0, 1, 1);
iLocal_232=1;
}}}
...
void func_100(){
Global_2794162.f_4493=Local_236.f_53;
}
...
void func_104(){
if(NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_236.f_2.f_3) && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_236.f_2)){
if(func_42(Local_236.f_2) && !func_95(Local_236.f_2.f_3)){
TASK::TASK_PLANE_MISSION(NETWORK::NET_TO_PED(Local_236.f_2.f_3), NETWORK::NET_TO_VEH(Local_236.f_2), 0, PLAYER::PLAYER_PED_ID(), 1f, 1f, 1f, 8, 60f, 1000f, -1f, 400, 400, 1);
}}
...
func_121(0, -1, 0);
NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&Local_236, 58, 0);
NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_238, 11, 0);
