...
iLocal_402=func_275(func_276(), 0, 1);
uLocal_403=func_275(func_276(), 0, 1);
uLocal_404=func_275(func_276(), 0, 1);
if(PLAYER::HAS_FORCE_CLEANUP_OCCURRED(67)){
func_274();
if(bVar13){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_378) && PED::IS_PED_INJURED(iLocal_378)){
func_273(80, 1);
...
func_256(&iLocal_377, &iLocal_380, uLocal_382, iLocal_58);
}
iLocal_60=func_255();
func_254(&Local_59, iLocal_60);
...
func_139(&cLocal_385, PLAYER::PLAYER_PED_ID(), 0, 2);
}
...
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_377, 0)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), &cLocal_385, 0, 0, 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_377, &cLocal_389, 0, 0, 0);
}
...
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&cLocal_385, 0)){
func_134(iLocal_377, 1, 0);
}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(&cLocal_389, 0)){
...
if(!bVar2){
if(!bLocal_405 && !CUTSCENE::IS_CUTSCENE_ACTIVE()){
Local_59.f_20=0;
...
HUD::CLEAR_HELP(1);
bVar2=true;
}elseif(func_137(&uLocal_229) >=14f){
Local_59.f_20=2;
bVar2=true;
HUD::CLEAR_HELP(1);
}elseif(!bVar3 && func_137(&uLocal_229) >=7f){
StringCopy(&cVar11, "DRF_PROMPT", 16);
func_98(&uLocal_61, &cVar10, &cVar11, 9, 0, 0, 0);
bVar3=true;
}}elseif((func_137(&uLocal_229) > 5f && func_136()) || (CUTSCENE::HAS_CUTSCENE_LOADED() && ((Local_59.f_20 !=1 || func_137(&uLocal_229) > fVar12) || func_95(iLocal_60, iLocal_377, &uLocal_382)))){
func_92();
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), &cLocal_385, 0, 0, 0);
}
...
break;
case 14:
if(CAM::DOES_CAM_EXIST(uLocal_382)){
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
CAM::DESTROY_CAM(uLocal_382, 0);
}
...
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), fLocal_396);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
func_79(0, 1, 1, 0, 0, 0, 0);
iLocal_380=PLAYER::GET_PLAYERS_LAST_VEHICLE();
if(ENTITY::DOES_ENTITY_EXIST(iLocal_380)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_380, 0)){
ENTITY::SET_ENTITY_COORDS(iLocal_380, func_78(iLocal_380), 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_380, 231f);
}}
if(CAM::IS_SCREEN_FADED_OUT()){
if(!iLocal_406){
...
if(!func_76(&uVar7)){
func_246(&uVar7);
}elseif(func_137(&uVar7) > func_75(func_255())){
if(func_255()==4){
iLocal_378=PED::CREATE_PED(26, iLocal_54, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_378, 3, iLocal_402, uLocal_403, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_378, 4, 0, uLocal_404, 0);
PED::SET_PED_MONEY(iLocal_378, (2000 + MISC::GET_RANDOM_INT_IN_RANGE(5, 301)));
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_378, 1, 1);
...
if(ENTITY::IS_ENTITY_DEAD(iLocal_378, 0)){
func_273(80, 1);
STATS::STAT_SET_BOOL(joaat("sp_killed_dr_friedlander"), 1, 1);
func_98(&uLocal_61, "DrfAud", "DRF_KILL", 9, 0, 0, 0);
if(HUD::DOES_BLIP_EXIST(uLocal_381)){
HUD::SET_BLIP_COLOUR(uLocal_381, 1);
}
iLocal_58=17;
}elseif(!ENTITY::DOES_ENTITY_EXIST(iLocal_378) || func_73(iLocal_378, PLAYER::PLAYER_PED_ID(), 1) > 300f){
func_98(&uLocal_61, "DrfAud", "DRF_AWAY", 9, 0, 0, 0);
if(HUD::DOES_BLIP_EXIST(uLocal_381)){
HUD::SET_BLIP_COLOUR(uLocal_381, 3);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_378)){
MISC::CLEAR_AREA_OF_PROJECTILES(ENTITY::GET_ENTITY_COORDS(iLocal_378, 1), 10f, 0);
}
iLocal_58=17;
}else{
func_56();
PED::SET_PED_CONFIG_FLAG(iLocal_378, 26, 1);
...
uLocal_382=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var16, Var17, 50f, 0, 2);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_382, uLocal_383, 2660, 1, 1);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_380) && !ENTITY::IS_ENTITY_DEAD(iLocal_380, 0)){
VEHICLE::SET_VEHICLE_FIXED(iLocal_380);
ENTITY::SET_ENTITY_INVINCIBLE(iLocal_380, 0);
VEHICLE::SET_VEHICLE_CAN_BREAK(iLocal_380, 1);
}
func_121(&uLocal_241);
iLocal_409=1;
}}elseif(!bVar13){
...
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
}}elseif(CAM::DOES_CAM_EXIST(uLocal_383)){
...
if(iLocal_408 && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())){
...
if(!HUD::DOES_BLIP_EXIST(uLocal_381)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_378, 0)){
uLocal_381=HUD::ADD_BLIP_FOR_ENTITY(iLocal_378);
HUD::SET_BLIP_COLOUR(uLocal_381, 1);
func_121(&uLocal_235);
}}elseif(HUD::GET_BLIP_COLOUR(uLocal_381) !=3){
HUD::SET_BLIP_COLOUR(uLocal_381, 3);
...
if(!PED::IS_PED_INJURED(iLocal_378)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_379)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_378, 0)){
iVar0=1;
}
if(!PED::IS_PED_FLEEING(iLocal_378)){
if((((((((!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_379, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_379, 1)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_379, 0, 2000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_379, 1, 2000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_379, 2, 2000)) || VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(iLocal_379, 3, 2000)) || (iVar0 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_378, 0))) || func_49(iLocal_379)) || func_45(iLocal_379)){
TASK::TASK_SMART_FLEE_PED(iLocal_378, PLAYER::PLAYER_PED_ID(), 3000f, -1, 0, 0);
}}
}
elseif(!PED::IS_PED_FLEEING(iLocal_378)){
TASK::TASK_SMART_FLEE_PED(iLocal_378, PLAYER::PLAYER_PED_ID(), 3000f, -1, 0, 0);
}
if(!bVar15 && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_378, -1892.139f, -567.194f, 10.5f, -1904.935f, -556.4423f, 13.5f, 4.73f, 0, 1, 0)){
...
if(func_137(&uLocal_232) > 4f || CAM::IS_SCREEN_FADED_OUT()){
HUD::REMOVE_BLIP(&uLocal_381);
if(CAM::DOES_CAM_EXIST(uLocal_382)){
CAM::DESTROY_CAM(uLocal_382, 0);
}
func_274();
...
if(!func_1(80)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_378)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_379) && PED::IS_PED_IN_VEHICLE(iLocal_378, iLocal_379, 0)){
VEHICLE::DELETE_VEHICLE(&iLocal_379);
}
}
...
}}elseif(MISC::IS_BIT_SET(Global_113810.f_20567.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_8() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
int iVar0;
int iVar1;
if((func_48(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_46(iParam0)){
...
bool bVar2;
float fVar3;
if((!ENTITY::DOES_ENTITY_EXIST(iLocal_378) || ENTITY::IS_ENTITY_DEAD(iLocal_378, 0)) || ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
return;
}
...
fVar3=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_378, 1));
if(iLocal_399 < 7){
if(iLocal_399 <=0){
if(func_137(&uLocal_247) > 0.2f){
bVar1=MISC::GET_RANDOM_INT_IN_RANGE(0, 7);
MISC::SET_BIT(&uLocal_398, bVar1);
StringCopy(&Var0, "DRF_RUNOFF_", 16);
StringIntConCat(&Var0, bVar1 + 1, 16);
func_57(&uLocal_61, "DrfAud", "DRF_RUNOFF", &Var0, 8, 0, 0);
iLocal_399=1;
func_121(&uLocal_247);
}}elseif(func_137(&uLocal_247) > 12f){
if(fVar3 <=144f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(PLAYER::PLAYER_PED_ID())){
bVar1=MISC::GET_RANDOM_INT_IN_RANGE(0, (7 - iLocal_399));
while (bVar2 >=0 && bVar2 < 7){
if(!MISC::IS_BIT_SET(uLocal_398, bVar2)){
if(bVar1==0){
MISC::SET_BIT(&uLocal_398, bVar2);
bVar1=bVar2;
bVar2=-2;
}
else{
...
if(iLocal_401 < 8){
if(iLocal_401 <=0){
if(func_137(&uLocal_250) > 1f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_378)){
...
iLocal_401=1;
func_121(&uLocal_250);
}}elseif(func_137(&uLocal_250) > 10.3f){
if(fVar3 <=2500f && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_378)){
bVar1=MISC::GET_RANDOM_INT_IN_RANGE(0, (8 - iLocal_401));
bVar2=false;
while (bVar2 >=0){
if(!MISC::IS_BIT_SET(uLocal_400, bVar2)){
if(bVar1==0){
...
if(((!iLocal_408 && iLocal_399 >=1) && iLocal_401 >=1) && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
iLocal_408=1;
}}
...
Vector3 func__77(struct<3> Param0){
float fVar0;
float fVar1;
fVar0=vmag(Param0);
if(fVar0 !=0f){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_84(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
Vector3 func__88(int iParam0, struct<3> Param1){
var uVar0;
...
void func_90(){
float fVar0;
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_379, 0)){
VEHICLE::DELETE_VEHICLE(&iLocal_379);
iLocal_379=VEHICLE::CREATE_VEHICLE(iLocal_55, Local_394, fLocal_397, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_379, 6);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_377)){
PED::DELETE_PED(&iLocal_377);
}
if((!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_379, 0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_379, 0)){
...
ENTITY::SET_ENTITY_COORDS(iLocal_379, Local_394, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_379, fLocal_397);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_380)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_380, 0)){
VEHICLE::SET_VEHICLE_FIXED(iLocal_380);
ENTITY::SET_ENTITY_INVINCIBLE(iLocal_380, 1);
VEHICLE::SET_VEHICLE_CAN_BREAK(iLocal_380, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_380, func_78(iLocal_380), 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_380, 231f);
}}
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
TASK::TASK_STAND_STILL(PLAYER::PLAYER_PED_ID(), -1);
if((!iLocal_407 || !ENTITY::DOES_ENTITY_EXIST(iLocal_378)) || ENTITY::IS_ENTITY_DEAD(iLocal_378, 0)){
iLocal_378=PED::CREATE_PED(26, iLocal_54, -1899.7f, -562.2f, 10.7945f, 217.9453f, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_378, 3, iLocal_402, uLocal_403, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_378, 4, 0, uLocal_404, 0);
PED::SET_PED_MONEY(iLocal_378, (2000 + MISC::GET_RANDOM_INT_IN_RANGE(5, 301)));
...
ENTITY::SET_ENTITY_COORDS(iLocal_378, -1899.7f, -562.2f, 10.7945f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_378, 217.9453f);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_378);
TASK::TASK_STAND_STILL(iLocal_378, -1);
}
if(CAM::IS_SCREEN_FADED_OUT()){
if(!iLocal_406){
...
while (!STREAMING::IS_NEW_LOAD_SCENE_LOADED() || (!PED::IS_PED_INJURED(iLocal_378) && !PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(iLocal_378))){
wait(0);
}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
...
fVar0=2f;
if(!PED::IS_PED_INJURED(iLocal_378) && !ENTITY::IS_ENTITY_DEAD(iLocal_379, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_384);
TASK::TASK_ENTER_VEHICLE(0, iLocal_379, -1, -1, fVar0, 1, 0);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_379, -1783.73f, -629.1945f, 9.89f, 20f, 0, ENTITY::GET_ENTITY_MODEL(iLocal_379), 786484, 10f, 12f);
TASK::TASK_VEHICLE_DRIVE_WANDER(0, iLocal_379, 19f, 786484);
TASK::CLOSE_SEQUENCE_TASK(uLocal_384);
TASK::TASK_PERFORM_SEQUENCE(iLocal_378, uLocal_384);
PED::FORCE_PED_MOTION_STATE(iLocal_378, joaat("MotionState_Run"), 1, 1, 1);
}
uLocal_381=HUD::ADD_BLIP_FOR_ENTITY(iLocal_378);
HUD::SET_BLIP_COLOUR(uLocal_381, 1);
func_121(&uLocal_235);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
uLocal_383=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1904.615f, -558.892f, 12.8339f, -9.0794f, 0f, -127.4455f, 50f, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
HUD::DISPLAY_RADAR(0);
HUD::DISPLAY_HUD(0);
}
MISC::CLEAR_AREA(-1886.884f, -571.1942f, 11.3828f, 2.5f, 1, 1, 0, 0);
VEHICLE::CREATE_VEHICLE(iLocal_56, -1886.884f, -571.1942f, 11.3828f, -40.83f, 1, 1, 0);
}
...
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
}elseif(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(PLAYER::PLAYER_PED_ID(), &cVar1, &Var3) >=0.99f){
return 1;
}}}
return 0;
}
...
struct<4> Var1;
Var1={
func_111(uParam0, &uVar0, iParam1, 1) 
};
...
if(bParam3){
func_112(&(Global_113810.f_19964), iVar1, 1);
}
...
iVar2[iParam0]=0;
}elseif((iParam1 > 0 && iParam1 < 13) && !func_117(&(Global_113810.f_19964), iParam1)){
iVar2[iParam1]=0;
}elseif((iParam2 > 0 && iParam2 < 13) && !func_117(&(Global_113810.f_19964), iParam2)){
iVar2[iParam2]=0;
}elseif((iParam3 > 0 && iParam3 < 13) && !func_117(&(Global_113810.f_19964), iParam3)){
iVar2[iParam3]=0;
}elseif((iParam4 > 0 && iParam4 < 13) && !func_117(&(Global_113810.f_19964), iParam4)){
iVar2[iParam4]=0;
}
...
if(!ENTITY::DOES_ENTITY_EXIST(*uParam1)){
*uParam1=VEHICLE::CREATE_VEHICLE(iParam7, Param5, fParam6, 1, 1, 0);
...
return (func_51(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return uParam0->f_1;
}
...
iVar1=0;
while (iVar1 < 12){
CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION(cParam0, iVar1, Var0.f_13[iVar1], Var0[iVar1], iParam2);
iVar1++;
}
iVar1=0;
while (iVar1 < 9){
...
CUTSCENE::SET_CUTSCENE_PED_PROP_VARIATION(cParam0, iVar1, Var0.f_39[iVar1], Var0.f_49[iVar1], iParam2);
}
iVar1++;
}}
...
Var3={
func_152(iVar4, 2, uParam1->f_59, -1) 
};
...
Var3={
func_152(iVar4, 1, uParam1->f_62, -1) 
};
...
func_155(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_155(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_155(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
...
iVar1=(iVar1 || shift_left(func_227(iParam1), iVar0));
...
int iVar4;
bool bVar5;
if((((!func_233(&(Global_113810.f_19964), 8) && iParam1) && iParam0 !=4) && func_231(3) > 0) && MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.75f){
bVar1=8;
*uParam3=4;
}else{
...
bVar5=true;
while (iVar4 > 0){
if(MISC::IS_BIT_SET(uVar2, bVar5)){
iVar4=(iVar4 - 1);
if(iVar4==0){
bVar1=bVar5;
}}
...
if(bParam2){
func_229(&(Global_113810.f_19964), bVar1, 1);
}
...
return 32;
}elseif(!func_235(84) && !func_235(85)){
return 16;
}}
break;
}
...
void func_256(int iParam0, int iParam1, var uParam2, int iParam3){
HUD::DISPLAY_HUD(1);
HUD::DISPLAY_RADAR(1);
func_260();
...
fVar3=0f;
if(!func_266(Global_113810.f_18536[iVar0], &Var2, &fVar3)){
