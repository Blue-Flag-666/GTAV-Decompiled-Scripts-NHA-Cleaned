...
iVar0=0;
while (iVar0 < 3){
if(!PED::IS_PED_INJURED(uLocal_61[iVar0])){
iVar1=0;
}
iVar0++;
}
...
while (iVar0 < 3){
if(!PED::IS_PED_INJURED(uLocal_61[iVar0])){
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_61[iVar0], 0)) < 400f){
if(!iLocal_50){
if(iLocal_59==2){
...
if(((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_61[iVar0], PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_61[iVar0])) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_61[iVar0])){
iLocal_50=1;
iLocal_53=1;
iLocal_52=1;
iLocal_59=3;
...
if(timera() > 5000){
if(!TASK::IS_PED_IN_WRITHE(uLocal_61[iVar0])){
func_54(&uLocal_66, 1);
...
if(!func_55() && !TASK::IS_PED_IN_WRITHE(uLocal_61[iVar0])){
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_64, joaat("player"));
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_61[iVar0], 2, 1);
func_54(&uLocal_66, 1);
func_53(&uLocal_66, 1, uLocal_61[iVar0], "BorderPatrol", 0, 1);
if(func_35()==0){
...
if(timera() > 5000 && !TASK::IS_PED_IN_WRITHE(uLocal_61[iVar0])){
func_54(&uLocal_66, 1);
func_53(&uLocal_66, 1, uLocal_61[iVar0], "BorderPatrol", 0, 1);
if(func_35()==0){
...
while (iVar0 < 3){
if(!PED::IS_PED_INJURED(uLocal_61[iVar0])){
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_61[iVar0], 0)) < 62500f){
return 1;
}else{
iLocal_60++;
}}
...
if(PED::IS_PED_IN_ANY_VEHICLE(uLocal_61[iVar0], 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_55[iVar0]){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_62[iVar0], 0)){
TASK::TASK_VEHICLE_MISSION(uLocal_61[iVar0], uLocal_62[iVar0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
}
if(!iLocal_53){
...
if(!PED::IS_PED_INJURED(uLocal_61[iVar0])){
if(PED::IS_PED_IN_ANY_VEHICLE(uLocal_61[iVar0], 0)){
TASK::TASK_DRIVE_BY(uLocal_61[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 1000f, 60, 1, -753768974);
PED::SET_PED_KEEP_TASK(uLocal_61[iVar0], 1);
}
}
iLocal_56[iVar0]=0;
iLocal_55[iVar0]=1;
}elseif(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_56[iVar0]){
if(!PED::IS_PED_INJURED(uLocal_61[iVar0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_62[iVar0], 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_61[iVar0], uLocal_62[iVar0], PLAYER::PLAYER_PED_ID(), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
if(!iLocal_53){
wait(MISC::GET_RANDOM_INT_IN_RANGE(400, 800));
}else{
wait(0);
...
iLocal_55[iVar0]=0;
iLocal_56[iVar0]=1;
}}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(uLocal_61[iVar0], 0)){
TASK::TASK_COMBAT_PED(uLocal_61[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_KEEP_TASK(uLocal_61[iVar0], 1);
}}elseif(PED::IS_PED_IN_ANY_VEHICLE(uLocal_61[iVar0], 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_57[iVar0]){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_61[iVar0], joaat("script_task_vehicle_chase")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_61[iVar0], joaat("script_task_vehicle_chase")) !=0){
TASK::CLEAR_PED_TASKS(uLocal_61[iVar0]);
if(!ENTITY::IS_ENTITY_DEAD(uLocal_62[iVar0], 0)){
TASK::TASK_VEHICLE_MISSION(uLocal_61[iVar0], uLocal_62[iVar0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
TASK::TASK_LOOK_AT_ENTITY(uLocal_61[iVar0], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
}
iLocal_58[iVar0]=0;
iLocal_57[iVar0]=1;
}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_58[iVar0]){
if((!PED::IS_PED_INJURED(uLocal_61[iVar0]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && !ENTITY::IS_ENTITY_DEAD(uLocal_62[iVar0], 0)){
TASK::CLEAR_PED_TASKS(uLocal_61[iVar0]);
TASK::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_61[iVar0], uLocal_62[iVar0], PLAYER::PLAYER_PED_ID(), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
TASK::TASK_LOOK_AT_ENTITY(uLocal_61[iVar0], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
iLocal_57[iVar0]=0;
...
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uLocal_61[iVar0], PLAYER::PLAYER_PED_ID(), 1f, 0f, 0f, 2f, -1, 1036831949, 1);
}
if(!PED::IS_PED_INJURED(uLocal_61[iVar0])){
if(ENTITY::IS_ENTITY_IN_WATER(uLocal_61[iVar0])){
if(PED::IS_PED_IN_ANY_VEHICLE(uLocal_61[iVar0], 0)){
TASK::TASK_LEAVE_ANY_VEHICLE(uLocal_61[iVar0], 0, 0);
}
if(!PED::IS_PED_IN_COMBAT(uLocal_61[iVar0], 0)){
TASK::TASK_COMBAT_PED(uLocal_61[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
}}}
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_ANY_VEHICLE(uLocal_61[iVar0], 0)){
if(ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 13f){
if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), PED::GET_VEHICLE_PED_IS_IN(uLocal_61[iVar0], 0))){
PED::SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(uLocal_61[iVar0], 3);
}else{
PED::SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(uLocal_61[iVar0], 1);
}}else{
PED::SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(uLocal_61[iVar0], 1);
}}
if(func_133()){
TASK::TASK_SMART_FLEE_PED(uLocal_61[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}}elseif(ENTITY::DOES_ENTITY_EXIST(uLocal_61[iVar0])){
iLocal_53=1;
iLocal_52=1;
}
iVar0++;
...
if(!HUD::DOES_BLIP_EXIST(uLocal_63[iVar0])){
uLocal_63[iVar0]=func_59(uLocal_61[iVar0], 1, 145);
}}}elseif(HUD::DOES_BLIP_EXIST(uLocal_63[iVar0])){
HUD::REMOVE_BLIP(&(uLocal_63[iVar0]));
}
iVar0++;
}}
...
if((VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_62[0], 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_62[1], 0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_62[2], 0)){
return 1;
}else{
...
PED::ADD_RELATIONSHIP_GROUP("re_border badGuys", &uLocal_64);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_64, joaat("player"));
iVar2=0;
while (iVar2 < 3){
...
if(iVar3 > 1){
uLocal_62[iVar2]=VEHICLE::CREATE_VEHICLE(iVar4, Var0, uVar1, 1, 1, 0);
}
else{
uLocal_62[iVar2]=VEHICLE::CREATE_VEHICLE(iVar5, Var0, uVar1, 1, 1, 0);
}
uLocal_61[iVar2]=PED::CREATE_PED_INSIDE_VEHICLE(uLocal_62[iVar2], 22, iVar6, -1, 1, 1);
TASK::TASK_LOOK_AT_ENTITY(uLocal_61[iVar2], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
PED::SET_PED_KEEP_TASK(uLocal_61[iVar2], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_61[iVar2], 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_61[iVar2], uLocal_64);
WEAPON::GIVE_WEAPON_TO_PED(uLocal_61[iVar2], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_62[iVar2], ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()));
PED::SET_PED_COMBAT_MOVEMENT(uLocal_61[iVar2], 2);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_61[iVar2], 50, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_61[iVar2], 2, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_61[iVar2], 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_61[iVar2], 52, 1);
PED::SET_PED_ACCURACY(uLocal_61[iVar2], 5);
PED::SET_PED_FIRING_PATTERN(uLocal_61[iVar2], 1566631136);
PED::SET_PED_SHOOT_RATE(uLocal_61[iVar2], MISC::GET_RANDOM_INT_IN_RANGE(50, 100));
PED::SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(uLocal_61[iVar2], 1);
PED::SET_PED_CONFIG_FLAG(uLocal_61[iVar2], 42, 1);
PED::SET_PED_HELMET(uLocal_61[iVar2], 0);
PED::SET_PED_MONEY(uLocal_61[iVar2], 233);
AUDIO::SET_AMBIENT_VOICE_NAME(uLocal_61[iVar2], "A_M_M_HILLBILLY_02_WHITE_MINI_04");
AUDIO::STOP_PED_SPEAKING(uLocal_61[iVar2], 1);
iVar2++;
}
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_62[0], 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_62[1], 1);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_62[2], 2);
}}
switch (func_35()){
case 0:
sLocal_65="MICHAEL";
...
func_53(&uLocal_66, 0, PLAYER::PLAYER_PED_ID(), sLocal_65, 0, 1);
...
if(!func_127(Global_113810.f_24998.f_43[iParam1])){
return 0;
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_125()) || Global_112857) || Global_32286) || func_124()) || func_49(8, -1)) || func_123()) || func_122()) || func_121()) || func_120()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_125()) || Global_32286) || func_124()) || func_49(8, -1)) || func_121()) || func_123()) || func_122()) || func_120()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_125()) || Global_112857) || Global_32286) || func_124()) || func_49(8, -1)) || func_121()) || func_123()) || func_122()) || func_120()) || Global_113810.f_7691.f_919[iVar0]==5) || Global_43924 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_125()) || Global_112857) || Global_32286) || func_124()) || func_49(8, -1)) || func_123()) || func_122()) || func_120()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_125()) || Global_32286) || func_124()) || func_49(8, -1)) || func_122()) || func_121()) || func_120()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
}
break;
...
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_125()) || Global_112857) || Global_32286) || func_124()) || func_49(8, -1)) || func_121()) || func_119()) || func_123()) || func_122()) || func_120()){
return 0;
}
break;
}}else{
...
iVar0=0;
while (iVar0 < 3){
if(!PED::IS_PED_INJURED(uLocal_61[iVar0]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
TASK::TASK_SMART_FLEE_PED(uLocal_61[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(uLocal_61[iVar0], 1);
}
iVar0++;
...
float fVar0;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_45, 1);
bLocal_48=true;
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_46, 1) < fVar0){
