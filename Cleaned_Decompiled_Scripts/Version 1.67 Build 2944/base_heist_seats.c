...
void func_11(){
func_19(&Local_45);
if(Global_1853830==PLAYER::PLAYER_ID() && !MISC::IS_BIT_SET(Global_1890739[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*138*/].f_38.f_27, 5)){
if(func_18(&Local_45, 1, 1)){
func_17(&Local_45);
}
if(func_18(&Local_45, 0, 0)){
MISC::SET_BIT(&Global_1836156, 1);
if((((((iLocal_62==0 && !MISC::IS_BIT_SET(Global_1890739[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*138*/].f_38.f_27, 3)) && !func_16()) && !HUD::IS_PAUSE_MENU_ACTIVE()) && !func_15(0)) && !func_14()) && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 225)){
func_12(&Local_45);
}}else{
MISC::CLEAR_BIT(&Global_1836156, 1);
}}else{
...
if(Var2.f_0 !=3){
Var3={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(&sVar0, &sVar1, func_45(iParam0), func_44(iParam0), 0, 2) 
};
Var4={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&sVar0, &sVar1, func_45(iParam0), func_44(iParam0), 0, 2) 
};
uVar5=Var4.f_2;
...
func_33(iParam0);
func_26(iParam0);
uVar7=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iParam0->f_421.f_1);
...
break;
case 8:
uVar8=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iParam0->f_421.f_1);
...
int func_75(){
if(Global_1853830 !=func_65()){
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_heist_seats", Global_1853830, 1, 0)){
return 0;
}
NETWORK::NETWORK_SET_THIS_SCRIPT_IS_NETWORK_SCRIPT(32, 0, Global_1853830);
func_87(0, -1, 0);
...
if(func_81(PLAYER::PLAYER_ID()) || MISC::IS_BIT_SET(iLocal_62, 0)){
return 0;
}
Var0={
uParam0->f_1 
...
if(MISC::IS_BIT_SET(Global_1890739[iParam0 /*138*/].f_38.f_27, 3)){
return 1;
}}}
return 0;
}
...
Local_45[iParam0 /*14*/].f_1={
Param1 + func_83(Param3, (fParam2 - 180f)) 
};
Local_45[iParam0 /*14*/].f_1.f_3={
Param1 + func_83(Param4, (fParam2 - 180f)) 
};
Local_45[iParam0 /*14*/].f_1.f_6=1f;
Local_45[iParam0 /*14*/].f_8={
Param1 
};
Local_45[iParam0 /*14*/].f_8.f_3={
0f, 0f, fParam2 
};
}


Vector3 func__83(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
