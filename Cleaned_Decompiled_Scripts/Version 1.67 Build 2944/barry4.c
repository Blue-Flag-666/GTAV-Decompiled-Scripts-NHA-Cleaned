...
func_225(&uLocal_81, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
var func__213(int iParam0, int iParam1){
...
Var4={
func_237(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
if(iVar0==1){
if(!func_366(iParam4, iParam5, iParam6, iParam11)){
iVar0=0;
}}
if(iVar0==1){
func_364();
...
*iParam0=func_336(Param1, fParam2);
}elseif(iParam7==1){
...
func_318(iParam0, &(Var2.f_31), &(Var2.f_81));
VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_96);
if(iParam1==1){
...
return 1;
}elseif(func_278(iParam0) !=-1 && !bParam1){
return 1;
}}
break;
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_313(iParam0, 0, 0)) || func_313(iParam0, 1, 0)) || func_313(iParam0, 2, 0)) || func_312(iParam0) !=145) || func_311(iParam0)) || func_310(iParam0)) || func_260(iParam0)) || func_309(iParam0)) || !func_299(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_310(iParam0)){
}
if(func_310(iParam0)){
}
...
iVar0=0;
while (func_314(iParam1, iVar0, &sVar1, &iVar2)){
...
}elseif(func_323(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_324() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
void func_329(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
bool func_335(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
return func_337(&(Global_107357.f_2890), Param0, fParam1, 0);
}

int func_337(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
}elseif((!func_339(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning")){
iVar4=func_338(iVar0);
if(iVar4==-1){
uParam0->f_10=0;
}else{
func_330(iVar4);
...
int func_339(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_341(iParam0, uVar1[iVar3], 1) && func_340(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_335(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
...
int func_340(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_296(iVar5))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_296(iVar6))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_350(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_349()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_296(iVar7 + 1))){
...
var func__347(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
