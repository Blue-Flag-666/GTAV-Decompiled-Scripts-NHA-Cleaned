...
Local_52={
ScriptParam_262.f_1[0 /*3*/] 
};
func_323();
if(CLOCK::GET_CLOCK_HOURS() > 7 && CLOCK::GET_CLOCK_HOURS() < 19){
SCRIPT::TERMINATE_THIS_THREAD();
}
if(func_297(Local_52, 23, bLocal_261, 0, 0)){
func_295(-1);
}else{
SCRIPT::TERMINATE_THIS_THREAD();
}
...
while (true){
wait(0);
if((BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() && !PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || iLocal_241){
if(!func_238()){
if(func_237()){
func_239();
}}
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_232, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_232, 0)){
func_221();
}}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_233, 0)){
...
if(func_206(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_234, 1), 1) < IntToFloat(iLocal_254) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_234)){
if(!iLocal_248){
func_204();
wait(0);
if(iLocal_48==1){
if(func_203()==0){
func_188(&uLocal_64, "re_acau", "re_ac_approM", 4, 0, 0, 0);
}
elseif(func_203()==1){
func_188(&uLocal_64, "re_acau", "re_ac_approF", 4, 0, 0, 0);
}
elseif(func_203()==2){
func_188(&uLocal_64, "re_acau", "re_ac_approT", 4, 0, 0, 0);
}
}
elseif(iLocal_48==2){
if(func_203()==0){
func_188(&uLocal_64, "reac2au", "reac2_approM", 4, 0, 0, 0);
}
elseif(func_203()==1){
func_188(&uLocal_64, "reac2au", "reac2_approF", 4, 0, 0, 0);
}
elseif(func_203()==2){
func_188(&uLocal_64, "reac2au", "reac2_approT", 4, 0, 0, 0);
}
}
if(HUD::DOES_BLIP_EXIST(uLocal_231)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_231, 1);
}
iLocal_248=1;
}}
}
...
if(!iLocal_243){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_234, 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_234, 0)){
if(!PED::IS_PED_INJURED(iLocal_232)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_251);
TASK::TASK_ENTER_VEHICLE(0, iLocal_234, -1, -1, 2f, 524296, 0);
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_251);
TASK::TASK_PERFORM_SEQUENCE(iLocal_232, uLocal_251);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_251);
PED::SET_PED_KEEP_TASK(iLocal_232, 1);
}
iLocal_243=1;
}}
}
...
void func_2(){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_232, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_232, 10f, 10f, 10f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if((timerb() > 3000 && iLocal_252==0) && !func_3()){
func_188(&uLocal_64, "re_acau", "re_ac_attac2", 4, 0, 0, 0);
TASK::TASK_LOOK_AT_ENTITY(iLocal_232, PLAYER::PLAYER_PED_ID(), 4000, 0, 2);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_61, joaat("player"));
settimerb(0);
iLocal_252++;
}
if((timerb() > 4000 && iLocal_252==1) && !func_3()){
func_188(&uLocal_64, "re_acau", "re_ac_attac1", 4, 0, 0, 0);
TASK::TASK_LOOK_AT_ENTITY(iLocal_232, PLAYER::PLAYER_PED_ID(), 4000, 0, 2);
settimerb(0);
iLocal_252++;
}
if((timerb() > 3000 && iLocal_252==2) && !func_3()){
func_188(&uLocal_64, "re_acau", "re_ac_attac2", 4, 0, 0, 0);
TASK::TASK_LOOK_AT_ENTITY(iLocal_232, PLAYER::PLAYER_PED_ID(), 4000, 0, 2);
settimerb(0);
iLocal_252=0;
...
iLocal_244=1;
iLocal_255++;
func_188(&uLocal_64, "re_acau", "re_ac_rambl", 4, 0, 0, 0);
settimera(0);
}}elseif(timera() > 4000){
if(!PED::IS_PED_INJURED(iLocal_232)){
TASK::TASK_COMBAT_PED(iLocal_232, PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_KEEP_TASK(iLocal_232, 1);
}
...
if(!PED::IS_PED_INJURED(iLocal_232)){
if((iLocal_255 >=1 && PED::IS_PED_BEING_STUNNED(PLAYER::PLAYER_PED_ID(), 0)) && iLocal_244){
TASK::TASK_PLAY_ANIM(iLocal_232, "amb@world_human_guard_patrol@male@idle_b", "idle_e", 2f, -2f, -1, 0, 0, 0, 0, 0);
AUDIO::TRIGGER_MUSIC_EVENT(sLocal_257);
...
switch (iLocal_258){
case 0:
if(HUD::DOES_BLIP_EXIST(uLocal_229)){
if(PED::IS_PED_INJURED(iLocal_232)){
HUD::REMOVE_BLIP(&uLocal_229);
}}
wait(2000);
iLocal_258++;
break;
...
if(!PED::IS_PED_INJURED(iLocal_232)){
func_169();
uLocal_62=STREAMING::STREAMVOL_CREATE_SPHERE(923.5159f, 3203.386f, 40.173f, 30f, 13, 127);
func_161(1);
CAM::DO_SCREEN_FADE_OUT(500);
wait(2000);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_232)){
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_232);
}
iLocal_258++;
}else{
...
iLocal_235=VEHICLE::CREATE_MISSION_TRAIN(0, 1063.595f, 3227.571f, 39.3899f, 1, 0, 0);
uVar0=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_235, 26, iLocal_238, -1, 1, 1);
uVar0=uVar0;
if(!iLocal_246){
if(AUDIO::REQUEST_SCRIPT_AUDIO_BANK("Train_Horn", 0, -1)){
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "Warning_Once", iLocal_235, "TRAIN_HORN", 0, 0);
}}
...
break;
case 3:
STREAMING::STREAMVOL_DELETE(uLocal_62);
...
if(timera() > 2000 && timera() < 3000){
if(func_203()==0){
func_188(&uLocal_64, "re_acau", "re_ac_awakeM", 4, 0, 0, 0);
}elseif(func_203()==1){
func_188(&uLocal_64, "re_acau", "re_ac_awakeF", 4, 0, 0, 0);
}elseif(func_203()==2){
func_188(&uLocal_64, "re_acau", "re_ac_awakeT", 4, 0, 0, 0);
}}
...
if(iParam5==0){
Global_78472[1 /*14*/]={
func_97(iVar10, iParam1, iParam2, -1) 
};
if(!func_96(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78472[1 /*14*/]={
func_97(iVar10, iVar0, uVar11[iVar0], -1) 
};
...
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_97(iVar10, 14, uVar12[iVar1], -1) 
};
...
Global_78472[1 /*14*/]={
func_97(iVar10, iVar0, func_54(iParam0, iVar0, -1), -1) 
};
...
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_97(iVar10, 14, uVar15[iVar1], -1) 
};
func_65(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
func_88(14);
if(Global_78470==1){
...
Global_78472[1 /*14*/]={
func_97(iVar0, iParam1, iParam2, -1) 
};
if(!MISC::IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0)){
return 0;
}
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_55(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_55(iParam1))){
return 1;
}
return 0;
}
...
Global_78472[1 /*14*/]={
func_97(iParam0, iParam1, iParam2, -1) 
};
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_55(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
func_100(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_100(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_100(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
iVar10=(iParam1 - iParam2);
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_55(iParam0));
if(iVar11 > iVar10){
...
void func_171(){
if((PED::IS_PED_INJURED(iLocal_232) && PED::IS_PED_INJURED(iLocal_233)) && !iLocal_247){
func_15();
}
if(iLocal_48==1){
if(!iLocal_247){
if(!PED::IS_PED_INJURED(iLocal_232)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_232, 50f, 50f, 50f, 0, 1, 0)){
func_15();
}}}}elseif(iLocal_48==2){
if(!PED::IS_PED_INJURED(iLocal_232) && !PED::IS_PED_INJURED(iLocal_233)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_232, 200f, 200f, 200f, 0, 1, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_232, 200f, 200f, 200f, 0, 1, 0)){
func_15();
}}}}
...
if(iLocal_48==1){
if(!PED::IS_PED_BEING_STUNNED(PLAYER::PLAYER_PED_ID(), 0)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_232, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_232, Local_57, 215f, 215f, 215f, 0, 1, 0)){
if((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_232) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_232)) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_232, Local_57, 215f, 215f, 215f, 0, 1, 0)){
if(WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_232, Local_57, 215f, 215f, 215f, 0, 1, 0)){
TASK::TASK_SMART_FLEE_PED(iLocal_232, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_232, 1);
func_204();
wait(0);
func_188(&uLocal_64, "re_acau", "re_ac_aim", 4, 0, 0, 0);
func_15();
}}}}}
...
if(iLocal_48==1){
if(!PED::IS_PED_INJURED(iLocal_232)){
if(!TASK::IS_PED_IN_WRITHE(iLocal_232)){
if(iLocal_258 < 3){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_232, 20f, 20f, 10f, 0, 1, 0)){
if(func_178()){
func_177(0);
}}elseif(func_3()){
func_177(1);
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_232, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_232, 31f, 31f, 11f, 0, 1, 0)){
if(func_178()){
func_177(0);
}}elseif(func_3()){
func_177(1);
}}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_233, 0)){
...
if(!func_3()){
if(!iLocal_250){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_232, 30f, 30f, 10f, 0, 1, 0)){
if(func_203()==0){
func_188(&uLocal_64, "reac2au", "reac2_attacM", 4, 0, 0, 0);
}elseif(func_203()==1){
func_188(&uLocal_64, "reac2au", "reac2_attacF", 4, 0, 0, 0);
}elseif(func_203()==2){
func_188(&uLocal_64, "reac2au", "reac2_attacT", 4, 0, 0, 0);
}}
iLocal_250=1;
}
if(iLocal_256 < MISC::GET_GAME_TIMER()){
if(func_176()){
if(!PED::IS_PED_INJURED(iLocal_232)){
if(!TASK::IS_PED_IN_WRITHE(iLocal_232)){
func_188(&uLocal_64, "reac2au", "reac2_attac2", 4, 0, 0, 0);
iLocal_256=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(4500, 5000));
}}}elseif(!PED::IS_PED_INJURED(iLocal_233)){
if(!TASK::IS_PED_IN_WRITHE(iLocal_233)){
func_188(&uLocal_64, "reac2au", "reac2_attac3", 4, 0, 0, 0);
iLocal_256=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(4500, 5000));
}}}}}
if(!PED::IS_PED_INJURED(iLocal_232)){
if(!TASK::IS_PED_IN_WRITHE(iLocal_232)){
if((PED::IS_PED_RAGDOLL(iLocal_232) || PED::IS_PED_BEING_STUNNED(iLocal_232, joaat("weapon_stungun"))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_232, PLAYER::PLAYER_PED_ID(), 1)){
func_204();
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_232);
}
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_232, Local_60, 0, 1, 0) || !ENTITY::IS_ENTITY_AT_COORD(iLocal_232, Local_57, 290f, 290f, 290f, 0, 1, 0)){
if((!iLocal_245 && !func_174("reac2_attac1")) && iLocal_258 < 3){
func_204();
wait(0);
if(iLocal_48==1){
func_188(&uLocal_64, "re_acau", "re_ac_flee", 4, 0, 0, 0);
}elseif(iLocal_48==2){
func_188(&uLocal_64, "reac2au", "reac2_flee", 4, 0, 0, 0);
}
iLocal_245=1;
}}}}}
...
if(!PED::IS_PED_INJURED(iLocal_232)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_232, 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(iLocal_232, 0), 0)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy", 3)){
if((((((((ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.1f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.075f) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.25f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.225f)) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.38f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.355f)) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.53f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.505f)) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.638f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.613f)) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.7f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.675f)) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 0.833f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.808f)) || (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") < 1f && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy") > 0.983f)){
ENTITY::APPLY_FORCE_TO_ENTITY(PED::GET_VEHICLE_PED_IS_IN(iLocal_232, 0), 0, 0f, 0f, 15f, -0.4f, 0f, 0f, 0, 1, 1, 1, 0, 1);
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "SUSPENSION_SCRIPT_FORCE", PED::GET_VEHICLE_PED_IS_IN(iLocal_232, 0), 0, 0, 0);
}}
if(func_238() && !iLocal_249){
if(!func_3()){
func_188(&uLocal_64, "reac2au", "reac2_sex", 4, 0, 0, 0);
iLocal_249=1;
}}}}
if(!PED::IS_PED_INJURED(iLocal_233)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_233, PLAYER::PLAYER_PED_ID(), 1)){
TASK::TASK_PLAY_ANIM(iLocal_233, "random@train_tracks", "frontseat_carsex_death_exit_top_guy", 2f, -2f, -1, 2097152, 0, 0, 0, 0);
}}}}


void func_181(){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_234, 0)){
if((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_234, 0)) || iLocal_48==2){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_234, Local_59, 0, 1, 0) || iLocal_240){
if(iLocal_48==1){
Local_53={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - Vector(-1f, 8.8f, 0f) 
};
PATHFIND::GET_SAFE_COORD_FOR_PED(Local_53, 0, &Local_53, 0);
Local_54={
...
if(!CAM::IS_SPHERE_VISIBLE(Local_53, 2f)){
iLocal_232=PED::CREATE_PED(19, iLocal_238, Local_53 - Vector(1f, 0f, 0f), func_186(Local_53, func_187(PLAYER::PLAYER_ID())), 1, 1);
}elseif(!CAM::IS_SPHERE_VISIBLE(Local_54, 2f)){
iLocal_232=PED::CREATE_PED(19, iLocal_238, Local_54 - Vector(1f, 0f, 0f), func_186(Local_54, func_187(PLAYER::PLAYER_ID())), 1, 1);
}elseif(!CAM::IS_SPHERE_VISIBLE(Local_55, 2f)){
iLocal_232=PED::CREATE_PED(19, iLocal_238, Local_55 - Vector(1f, 0f, 0f), func_186(Local_55, func_187(PLAYER::PLAYER_ID())), 1, 1);
}elseif(!CAM::IS_SPHERE_VISIBLE(Local_56, 2f)){
iLocal_232=PED::CREATE_PED(19, iLocal_238, Local_56 - Vector(1f, 0f, 0f), func_186(Local_56, func_187(PLAYER::PLAYER_ID())), 1, 1);
}
if(!PED::IS_PED_INJURED(iLocal_232)){
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_232, "A_M_M_HillBilly_01_WHITE_MINI_02");
WEAPON::GIVE_WEAPON_TO_PED(iLocal_232, joaat("weapon_stungun"), -1, 1, 1);
PED::SET_PED_SHOOT_RATE(iLocal_232, 100);
PED::SET_PED_CONFIG_FLAG(iLocal_232, 137, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_232, 188, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_232, 286, 1);
PED::SET_PED_MIN_GROUND_TIME_FOR_STUNGUN(PLAYER::PLAYER_PED_ID(), 10000);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_232, 0, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_232, 27, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_232, 13, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_232, 50, 1);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_232, 2);
PED::SET_PED_COMBAT_ABILITY(iLocal_232, 2);
PED::SET_PED_COMBAT_RANGE(iLocal_232, 0);
PED::SET_COMBAT_FLOAT(iLocal_232, 2, 11f);
PED::SET_COMBAT_FLOAT(iLocal_232, 13, 1f);
AUDIO::STOP_PED_SPEAKING(iLocal_232, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_232, iLocal_61);
func_185(&uLocal_64, 4, iLocal_232, "RAPIST", 0, 1);
PED::CLEAR_PED_ALTERNATE_WALK_ANIM(PLAYER::PLAYER_PED_ID(), -8f);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_232, 1);
if(!HUD::DOES_BLIP_EXIST(uLocal_229)){
uLocal_229=func_182(iLocal_232, 1, 145);
}
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_251);
PED::SET_PED_KEEP_TASK(iLocal_232, 1);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_232, 0, 0);
iLocal_241=1;
}}elseif(iLocal_48==2){
iLocal_240=1;
AUDIO::TRIGGER_MUSIC_EVENT(sLocal_257);
...
if(!PED::IS_PED_INJURED(iLocal_233)){
uLocal_230=func_182(iLocal_233, 1, 145);
ENTITY::SET_ENTITY_HEALTH(iLocal_233, 200, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_251);
...
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_251);
TASK::TASK_PERFORM_SEQUENCE(iLocal_233, uLocal_251);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_251);
...
wait(0);
if(!PED::IS_PED_INJURED(iLocal_232) && !PED::IS_PED_INJURED(iLocal_233)){
func_188(&uLocal_64, "reac2au", "reac2_attac1", 4, 0, 0, 0);
}
iLocal_241=1;
}}}}}


var func__182(int iParam0, bool bParam1, int iParam2){
var uVar0;
uVar0=func_183(iParam0, !bParam1, 0);
...
HUD::SET_BLIP_SCALE(uVar0, func_184(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
if(!bParam2){
HUD::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
}else{
HUD::SET_BLIP_COLOUR(uVar0, 2);
}}elseif(ENTITY::IS_ENTITY_A_PED(iParam0)){
HUD::SET_BLIP_SCALE(uVar0, func_184(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
HUD::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
...
var func__186(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3){
...
var func__193(int iParam0, int iParam1){
...
if(!func_238()){
if(func_206(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_234, 1), 1) < IntToFloat(iLocal_253)){
if(HUD::DOES_BLIP_EXIST(uLocal_231)){
HUD::REMOVE_BLIP(&uLocal_231);
}
uLocal_231=func_219(iLocal_234, 0, 0);
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_231, 0);
...
if(iLocal_48==1){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_232, 0)){
if((((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_232, 13f, 13f, 13f, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_232, 1)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_232, PLAYER::PLAYER_PED_ID(), 1)) || CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(iLocal_232, 1), 2f)){
iLocal_240=1;
settimerb(0);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_232, 0)){
if(!iLocal_63){
...
settimerb(0);
if(!PED::IS_PED_INJURED(iLocal_232)){
TASK::TASK_LOOK_AT_ENTITY(iLocal_232, PLAYER::PLAYER_PED_ID(), 30000, 0, 2);
}}}}}}
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_234, 0)){
if(iLocal_48==1){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_234, Local_57, 15f, 15f, 15f, 0, 1, 0)){
func_14();
}}elseif(iLocal_48==2){
if((((((((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_234, PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), Local_57 - Vector(50f, 50f, 50f), Local_57 + Vector(50f, 50f, 50f), 0, 1)) || FIRE::IS_EXPLOSION_IN_AREA(2, Local_57 - Vector(50f, 50f, 50f), Local_57 + Vector(50f, 50f, 50f))) || FIRE::IS_EXPLOSION_IN_AREA(4, Local_57 - Vector(50f, 50f, 50f), Local_57 + Vector(50f, 50f, 50f))) || FIRE::IS_EXPLOSION_IN_AREA(0, Local_57 - Vector(50f, 50f, 50f), Local_57 + Vector(50f, 50f, 50f))) || FIRE::IS_EXPLOSION_IN_AREA(1, Local_57 - Vector(50f, 50f, 50f), Local_57 + Vector(50f, 50f, 50f))) || PED::IS_COP_PED_IN_AREA_3D(Local_57 - Vector(50f, 50f, 50f), Local_57 + Vector(50f, 50f, 50f))) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(Local_57 - Vector(50f, 50f, 50f), Local_57 + Vector(50f, 50f, 50f))) || (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_234, 50f, 50f, 50f, 0, 1, 2) && PLAYER::IS_PLAYER_PRESSING_HORN(PLAYER::PLAYER_ID()))){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)){
iLocal_236=PLAYER::GET_PLAYERS_LAST_VEHICLE();
}
func_209(1);
...
if(iLocal_48==1){
PED::ADD_SCENARIO_BLOCKING_AREA(Local_57 - Vector(20f, 50f, 50f), Local_57 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
}elseif(iLocal_48==2){
PED::ADD_SCENARIO_BLOCKING_AREA(Local_57 - Vector(50f, 100f, 100f), Local_57 + Vector(50f, 100f, 100f), 0, 1, 1, 1);
}
MISC::CLEAR_AREA_OF_VEHICLES(Local_52, 50f, 0, 0, 0, 0, 0, 0, 0);
...
AUDIO::PREPARE_MUSIC_EVENT(sLocal_257);
AUDIO::REGISTER_SCRIPT_WITH_AUDIO(0);
AUDIO::START_AUDIO_SCENE("RE_ABANDONED_VEHICLE_SCENE");
while (((((!STREAMING::HAS_MODEL_LOADED(iLocal_238) || !STREAMING::HAS_MODEL_LOADED(iLocal_239)) || !STREAMING::HAS_ANIM_DICT_LOADED("random@train_tracks")) || !STREAMING::HAS_ANIM_DICT_LOADED("amb@world_human_guard_patrol@male@idle_b")) || !AUDIO::PREPARE_MUSIC_EVENT(sLocal_257)) || !AUDIO::IS_AUDIO_SCENE_ACTIVE("RE_ABANDONED_VEHICLE_SCENE")){
wait(0);
}
if(func_203()==0){
func_185(&uLocal_64, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
}elseif(func_203()==1){
func_185(&uLocal_64, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}elseif(func_203()==2){
func_185(&uLocal_64, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
}
MISC::ENABLE_DISPATCH_SERVICE(3, 0);
MISC::ENABLE_DISPATCH_SERVICE(5, 0);
iLocal_234=VEHICLE::CREATE_VEHICLE(iLocal_239, Local_57, fLocal_58, 1, 1, 0);
ENTITY::SET_ENTITY_LOD_DIST(iLocal_234, 10000);
VEHICLE::SET_LAST_DRIVEN_VEHICLE(iLocal_234);
VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(iLocal_234, 5f);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_239);
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_234, "RE_ABANDONED_VEHICLE_MOTORHOME", 0);
AUDIO::SET_AUDIO_VEHICLE_PRIORITY(iLocal_234, 3);
PED::ADD_RELATIONSHIP_GROUP("Redneck", &iLocal_61);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_61, joaat("player"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("COP"), iLocal_61);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_61, joaat("COP"));
if(iLocal_48==1){
VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_234, 0, 1, 0);
VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_234, 1, 1, 0);
VEHICLE::SET_VEHICLE_DAMAGE(iLocal_234, Local_57, 0f, 1700f, 1);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_234, 0, 1, 0);
VEHICLE::SET_VEHICLE_LIGHTS(iLocal_234, 2);
}elseif(iLocal_48==2){
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_234, 0, 1, 0);
VEHICLE::SET_VEHICLE_LIGHTS(iLocal_234, 1);
iLocal_232=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_234, 26, iLocal_238, -1, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_232, 0, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_232, 2, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_232, 3, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_232, 4, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_232, 8, 0, 0, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_232, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_232, iLocal_61);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_232, joaat("weapon_sawnoffshotgun"), -1, 0, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_232, 1, 0);
PED::SET_PED_ACCURACY(iLocal_232, 25);
AUDIO::STOP_PED_SPEAKING(iLocal_232, 1);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_232, "A_M_M_HillBilly_02_WHITE_MINI_01");
func_185(&uLocal_64, 4, iLocal_232, "INCESTBRO1", 0, 1);
iLocal_233=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_234, 26, iLocal_238, 0, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_233, 0, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_233, 2, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_233, 3, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_233, 4, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(iLocal_233, 8, 0, 0, 0);
ENTITY::SET_ENTITY_HEALTH(iLocal_233, 100000000, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_233, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_233, iLocal_61);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_233, joaat("weapon_pistol"), -1, 0, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_233, 1, 0);
PED::SET_PED_ACCURACY(iLocal_233, 25);
AUDIO::STOP_PED_SPEAKING(iLocal_233, 1);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_233, "A_M_M_HillBilly_02_WHITE_MINI_02");
func_185(&uLocal_64, 5, iLocal_233, "INCESTBRO2", 0, 1);
TASK::TASK_PLAY_ANIM(iLocal_232, "random@train_tracks", "frontseat_carsex_loop_low_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(iLocal_233, "random@train_tracks", "frontseat_carsex_loop_top_guy", 1000f, -8f, -1, 1, 0, 0, 0, 0);
...
void func_224(){
if(iLocal_48==1){
iLocal_238=joaat("a_m_m_hillbilly_01");
iLocal_239=joaat("surfer");
Local_57={
...
sLocal_257="RE8A_TASERED";
}elseif(iLocal_48==2){
iLocal_238=joaat("a_m_y_acult_01");
iLocal_239=joaat("journey");
Local_53={
2162.552f, 2122.646f, 124.7956f 
};
Local_57={
...
if(vmag2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_236()){
return 0;
}}
if(func_232()){
return 1;
...
void func_228(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21){
uParam0->f_4=iParam4;
*uParam0=sParam1;
uParam0->f_1={
Param2 
...
AUDIO::CANCEL_MUSIC_EVENT(sLocal_257);
...
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_236, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_236, 50f, 50f, 50f, 0, 1, 0)){
func_267(iLocal_236, 0, 145);
}}
if(!PED::IS_PED_INJURED(iLocal_232) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
WEAPON::SET_PED_DROPS_WEAPON(iLocal_232);
TASK::TASK_SMART_FLEE_PED(iLocal_232, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_232, 1);
}
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_293(iParam0, 0, 0)) || func_293(iParam0, 1, 0)) || func_293(iParam0, 2, 0)) || func_292(iParam0) !=145) || func_291(iParam0)) || func_290(iParam0)) || func_289(iParam0)) || func_288(iParam0)) || !func_275(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_290(iParam0)){
}
if(func_290(iParam0)){
}
...
int func_297(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4){
bool bVar0;
struct<3> Var1;
int iVar2;
struct<3> Var3;
...
if(func_27(func_203())){
if(!func_319(iParam1, bParam2, 145)){
return 0;
}}
if(!func_318(Global_113810.f_24998.f_43[iParam1])){
return 0;
}
...
if(func_307(iParam1, bParam2) && !bParam3){
return 0;
}
...
if((iParam1==9 && (bParam2==2 || bParam2==5)) && !func_307(0, 0)){
return 0;
}
if(Global_32430){
return 0;
...
bool func_298(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
iVar3=(iVar3 - 1);
iVar0=round(func_304(to_float(iVar0 + 1), 0f, 12f));
}
while (iVar3 < 0){
iVar3 +=12;
iVar2=(iVar2 - 1);
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_316()) || Global_112857) || Global_32286) || func_315()) || func_200(8, -1)) || func_314()) || func_313()) || func_312()) || func_311()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_316()) || Global_32286) || func_315()) || func_200(8, -1)) || func_312()) || func_314()) || func_313()) || func_311()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
...
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_316()) || Global_112857) || Global_32286) || func_315()) || func_200(8, -1)) || func_314()) || func_313()) || func_311()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_316()) || Global_32286) || func_315()) || func_200(8, -1)) || func_313()) || func_312()) || func_311()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_316()) || func_313()) || Global_112857) || Global_32286) || func_315()) || Global_44569) || func_200(8, -1)) || func_312()) || func_310()) || func_311()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_316()) || Global_112857) || Global_32286) || func_315()) || func_200(8, -1)) || func_312()) || func_310()) || func_314()) || func_313()) || func_311()){
return 0;
}
break;
}}else{
...
float fVar0;
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_259, 1);
bLocal_261=true;
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_260, 1) < fVar0){
