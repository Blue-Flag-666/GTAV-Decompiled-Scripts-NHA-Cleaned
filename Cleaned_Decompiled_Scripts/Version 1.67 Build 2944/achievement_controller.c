...
int func_32()
{
	...
	Var1 = { func_56(joaat("mpply_started_mp")) };
...
{
	return (shift_right(iParam0, 26) & 31 * func_41(BitTest(iParam0, 31), -1, 1)) + 2011;
}
...
var func_44(struct<7> Param0, int iParam1)
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var func_54(struct<6> Param0, var uParam1)
{
	var uVar0;
...
void func_67(char* sParam0, char[8] cParam1, char[4] cParam2, char[4] cParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, int iParam12)
{
	...
	switch (iParam5)
	{
		...
		case 4:
			...
			else if (iParam4 == Global_75778)
			{
				StringCopy(sParam0, "VE_BIG_TRUCK_t0_v0", 64);
			}
			else if (iParam4 == Global_75779)
			{
				StringCopy(sParam0, "VE_BALLISTIC_EQUIPMENT_t0_v0", 64);
			}
			else if (iParam4 == Global_75780)
			{
				StringCopy(sParam0, "VE_BIG_PLANE_t0_v0", 64);
			}
			else if (iParam4 == Global_75781)
			{
				StringCopy(sParam0, "VE_HACKER_TRUCK_t0_v0", 64);
			}
			else if (iParam4 == func_72())
			{
				StringCopy(sParam0, "VE_KOSATKA_t0_v0", 64);
			}
			else if (iParam4 == func_71())
			{
				if (iParam6 == 40)
				{
...
float func_109(var uParam0)
{
	if (func_112(uParam0))
	{
		...
		{
			return (func_110(BitTest(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
void func_169(var uParam0)
{
	if (func_112(uParam0))
	{
		if (!func_111(uParam0))
		{
			uParam0->f_2 = (func_110(BitTest(*uParam0, 4)) - uParam0->f_1);
...
{
	uParam0->f_1 = (func_110(BitTest(*uParam0, 4)) - fParam1);
