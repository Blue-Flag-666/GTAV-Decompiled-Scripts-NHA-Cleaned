...
void func_17(struct<4> Param0, struct<16> Param1, var uParam2, var uParam3){
Local_97={
Param0 
};
Local_98={
...
void func_18(struct<4> Param0, var uParam1){
Local_97={
Param0 
};
bLocal_94=true;
...
func_39();
}}}elseif(MISC::IS_PS3_VERSION() || func_38()){
if(func_37(Var0[0 /*13*/])){
switch (iLocal_101){
case 0:
iLocal_102=NETWORK::NETWORK_DISPLAYNAMES_FROM_HANDLES_START(&Var0, 1);
if(iLocal_102 >=0){
iLocal_101++;
}
break;
case 1:
iVar2=NETWORK::NETWORK_GET_DISPLAYNAMES_FROM_HANDLES(iLocal_102, &Var1, 1);
switch (iVar2){
case -1:
func_39();
break;
case 0:
MemCopy(&(Global_2359296[func_40() /*5568*/].f_5391.f_18[Global_1835457 /*6*/]),{
Var1[0 /*16*/]
}
, 6);
func_39();
