...
if((!PED::IS_PED_INJURED(uLocal_56) && !PED::IS_PED_INJURED(iLocal_57[0])) && !PED::IS_PED_INJURED(iLocal_57[1])){
...
if(!PED::IS_PED_INJURED(iLocal_57[iVar0])){
TASK::TASK_SMART_FLEE_PED(iLocal_57[iVar0], PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
}
iVar0++;
}
if(!PED::IS_PED_INJURED(uLocal_56)){
TASK::TASK_SMART_FLEE_PED(uLocal_56, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
}
func_69();
}
break;
...
if(!PED::IS_PED_INJURED(uLocal_56)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_56, PLAYER::PLAYER_PED_ID(), 1)){
TASK::TASK_SMART_FLEE_PED(uLocal_56, PLAYER::PLAYER_PED_ID(), 150f, -1, 0, 0);
func_69();
}
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_56, 150f, 150f, 50f, 0, 1, 0)){
...
break;
case 1:
if(iLocal_44 < 7 && !PED::IS_PED_INJURED(uLocal_56)){
if(PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), uLocal_56, 90f)){
if(PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_56) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_56)){
func_64();
}
}}
func_59();
...
if(((!PED::IS_PED_INJURED(iLocal_57[0]) && !PED::IS_PED_INJURED(iLocal_57[1])) && !ENTITY::IS_ENTITY_DEAD(iLocal_59[0], 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_59[1], 0)){
func_69();
}
iVar1=0;
iVar2=0;
while (iVar2 < iLocal_57){
if(!PED::IS_PED_INJURED(iLocal_57[iVar2])){
TASK::TASK_COMBAT_PED(iLocal_57[iVar2], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_KEEP_TASK(iLocal_57[iVar2], 1);
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_57[iVar2], 150f, 150f, 50f, 0, 1, 0)){
func_69();
}
iVar1=1;
}
elseif(HUD::DOES_BLIP_EXIST(uLocal_55[iVar2])){
HUD::REMOVE_BLIP(&(uLocal_55[iVar2]));
}
iVar2++;
}
if(iVar1==0){
...
if(!PED::IS_PED_INJURED(uLocal_56)){
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_56, 0);
...
if(!PED::IS_PED_INJURED(iLocal_57[iVar0]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(iVar0 < 2){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_59[iVar0], 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_57[iVar0], iLocal_59[iVar0], PLAYER::PLAYER_PED_ID(), 8, 20f, 786469, 150f, 10f, 1);
PED::SET_PED_KEEP_TASK(iLocal_57[iVar0], 1);
}else{
TASK::TASK_SMART_FLEE_PED(iLocal_57[iVar0], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
}}else{
TASK::TASK_SMART_FLEE_PED(iLocal_57[iVar0], PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
}
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_57[iVar0], 0);
}
iVar0++;
}
iVar0=0;
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_59[iVar0], 0)){
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&(iLocal_59[iVar0]));
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_2(PLAYER::PLAYER_ID()), Local_46, 1) > 50f){
func_146();
}}
...
iVar0=0;
while (iVar0 < iLocal_57){
if(!PED::IS_PED_INJURED(iLocal_57[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_59[iVar0], 0)){
if(!HUD::DOES_BLIP_EXIST(uLocal_55[iVar0])){
uLocal_55[iVar0]=func_80(iLocal_57[iVar0], 1, 145);
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_57[iVar0], 0)){
if(!bLocal_49){
TASK::TASK_DRIVE_BY(iLocal_57[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 150f, 100, 1, -753768974);
}else{
TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
TASK::TASK_PERFORM_SEQUENCE(iLocal_57[iVar0], uLocal_60);
...
if(!PED::IS_PED_INJURED(iLocal_57[iVar1])){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_57[iVar1], 904.3153f, 3631.684f, 31.574f, 7f, 7f, 7f, 0, 1, 0)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_59[iVar1], 0)){
AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(iLocal_59[iVar1], 0);
}
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_57[iVar1], 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
TASK::TASK_PERFORM_SEQUENCE(iLocal_57[iVar1], uLocal_60);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_60);
PED::SET_PED_KEEP_TASK(iLocal_57[iVar1], 1);
}}
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_57[iVar1], 0)){
TASK::TASK_COMBAT_PED(iLocal_57[iVar1], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_KEEP_TASK(iLocal_57[iVar1], 1);
}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_59[iVar1], 0)){
if(VEHICLE::IS_PLAYBACK_USING_AI_GOING_ON_FOR_VEHICLE(iLocal_59[iVar1])){
}}}
if(PED::IS_PED_INJURED(iLocal_57[iVar1])){
if(HUD::DOES_BLIP_EXIST(uLocal_55[iVar1])){
HUD::REMOVE_BLIP(&(uLocal_55[iVar1]));
}}
iVar1++;
}
if(((PED::IS_PED_INJURED(iLocal_57[2]) && PED::IS_PED_INJURED(iLocal_57[3])) && PED::IS_PED_INJURED(iLocal_57[4])) && PED::IS_PED_INJURED(iLocal_57[5])){
AUDIO::STOP_AUDIO_SCENE("RE_COUNTRYSIDE_GANG_FIGHT_SCENE");
iLocal_44++;
}
break;
...
func_41(1500);
if(!PED::IS_PED_INJURED(uLocal_56)){
TASK::CLEAR_PED_TASKS(uLocal_56);
TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2056, 2);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
TASK::TASK_PERFORM_SEQUENCE(uLocal_56, uLocal_60);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_60);
}
if(!ENTITY::IS_ENTITY_DEAD(uLocal_58, 0)){
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(uLocal_58);
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_56, 5f, 5f, 5f, 0, 1, 0)){
...
case 3:
if(!PED::IS_PED_INJURED(uLocal_56)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_56, 6f, 6f, 6f, 0, 1, 0)){
if(PED::IS_PED_FACING_PED(uLocal_56, PLAYER::PLAYER_PED_ID(), 60f)){
if(!func_8()){
...
if(!PED::IS_PED_INJURED(uLocal_56)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(uLocal_56, PLAYER::PLAYER_PED_ID(), 120f, 120f, 120f, 0, 1, 0)){
func_10();
}}
if(!ENTITY::IS_ENTITY_DEAD(uLocal_58, 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_58, PLAYER::PLAYER_PED_ID(), 0)){
func_69();
}}
break;
case 4:
...
break;
case 5:
if(!PED::IS_PED_INJURED(uLocal_56) && !ENTITY::IS_ENTITY_DEAD(uLocal_58, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 1500);
TASK::TASK_ENTER_VEHICLE(0, uLocal_58, -1, -1, 2f, 8, 0);
TASK::TASK_PAUSE(0, 2000);
TASK::TASK_PLAY_ANIM(0, "veh@drivebystd_ds_grenades", "drop_grenade", 2f, -2f, -1, 0, 0, 0, 0, 0);
TASK::TASK_VEHICLE_DRIVE_WANDER(0, uLocal_58, 10f, 786603);
TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
TASK::TASK_PERFORM_SEQUENCE(uLocal_56, uLocal_60);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_60);
PED::SET_PED_KEEP_TASK(uLocal_56, 1);
VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(uLocal_58, 1);
iLocal_44++;
}
break;
case 6:
if(!PED::IS_PED_INJURED(uLocal_56)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_56, "veh@drivebystd_ds_grenades", "drop_grenade", 3)){
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_56, "veh@drivebystd_ds_grenades", "drop_grenade") > 0.436f && PED::IS_PED_IN_ANY_VEHICLE(uLocal_56, 0)){
OBJECT::CREATE_MONEY_PICKUPS(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PED::GET_VEHICLE_PED_IS_IN(uLocal_56, 0), -1f, 0f, 0f), 1000, 1, 0);
iLocal_44++;
}}}
break;
case 7:
...
case 1:
if(!PED::IS_PED_INJURED(uLocal_56)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), uLocal_56, 20f, 20f, 20f, 0, 1, 0)){
TASK::TASK_LOOK_AT_ENTITY(uLocal_56, PLAYER::PLAYER_PED_ID(), -1, 2060, 2);
func_42(&uLocal_61, "RECGFAU", "RECGF_THX", 4, 0, 0, 0);
iLocal_44++;
}}
break;
case 2:
if(!PED::IS_PED_INJURED(iLocal_56) && !ENTITY::IS_ENTITY_DEAD(uLocal_58, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 916.5764f, 3602.146f, 31.9262f, 1f, 40000, 1048576000, 0, 1193033728);
TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
TASK::TASK_PERFORM_SEQUENCE(iLocal_56, uLocal_60);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_60);
iLocal_44++;
}
break;
...
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_56, 916.5764f, 3602.146f, 31.9262f, 3.3f, 3.3f, 3.3f, 0, 1, 0)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 8f, 8f, 8f, 0, 1, 0)){
if(!func_8()){
...
if(func_62()){
func_41(1000);
if((!PED::IS_PED_INJURED(iLocal_56) && !PED::IS_PED_INJURED(iLocal_57[2])) && !ENTITY::IS_ENTITY_DEAD(uLocal_58, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
TASK::TASK_OPEN_VEHICLE_DOOR(0, uLocal_58, -1, -1, 1f);
TASK::TASK_LOOK_AT_ENTITY(0, iLocal_57[2], 2000, 0, 2);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_57[2], 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
TASK::TASK_PERFORM_SEQUENCE(iLocal_56, uLocal_60);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_60);
func_41(2000);
...
if((!PED::IS_PED_INJURED(iLocal_56) && !ENTITY::IS_ENTITY_DEAD(uLocal_58, 0)) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_56, 0)){
iLocal_44++;
}else{
if(!PED::IS_PED_INJURED(iLocal_56) && !PED::IS_PED_INJURED(iLocal_57[2])){
TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
TASK::TASK_COWER(0, -1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
TASK::TASK_PERFORM_SEQUENCE(iLocal_56, uLocal_60);
...
break;
case 7:
if((((!PED::IS_PED_INJURED(iLocal_56) && !ENTITY::IS_ENTITY_DEAD(uLocal_58, 0)) && !PED::IS_PED_IN_VEHICLE(iLocal_56, uLocal_58, 0)) && !PED::IS_PED_IN_COVER(iLocal_56, 0)) && !PED::IS_PED_GOING_INTO_COVER(iLocal_56)){
}
iVar0=0;
while (iVar0 < iLocal_57){
if(!PED::IS_PED_INJURED(iLocal_57[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_59[iVar0], 0)){
if(((((PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), (916.3351f - 100f), (3602.048f - 100f), (31.9209f - 100f), (916.3351f + 100f), (3602.048f + 100f), (31.9209f + 100f), 0, 1) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_57[iVar0], 5f, 5f, 5f, 0, 1, 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_57[iVar0], PLAYER::PLAYER_PED_ID(), 1)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_59[iVar0], PLAYER::PLAYER_PED_ID(), 1)) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_57[iVar0])) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_59[iVar0])){
bLocal_49=true;
settimerb(2000);
iLocal_44=0;
iLocal_43=2;
...
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_57[2], 970.3641f, 3629.886f, 31.3694f, 5f, 5f, 5f, 0, 1, 0) || timerb() > 13000){
func_41(2000);
iVar0=0;
while (iVar0 < iLocal_57){
if(!PED::IS_PED_INJURED(iLocal_57[iVar0])){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_59[iVar0], 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_57[iVar0], iLocal_59[iVar0], 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_57[iVar0], iLocal_59[iVar0], PLAYER::PLAYER_PED_ID(), (iVar0 - 2) + 10, 60f, 786475, 5f, 10f, 1);
}
}}
iVar0++;
}
...
int func_62(){
int iVar0;
if(((((((!ENTITY::DOES_ENTITY_EXIST(iLocal_59[2]) && !ENTITY::DOES_ENTITY_EXIST(iLocal_59[3])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_59[4])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_59[5])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_57[2])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_57[3])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_57[4])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_57[5])){
...
iLocal_59[2]=VEHICLE::CREATE_VEHICLE(joaat("hexer"), 863.4697f, 3633.5f, 31.9874f, 290.5797f, 1, 1, 0);
iLocal_59[3]=VEHICLE::CREATE_VEHICLE(joaat("hexer"), 866.4073f, 3636.039f, 31.9514f, 270.3649f, 1, 1, 0);
iLocal_59[4]=VEHICLE::CREATE_VEHICLE(joaat("hexer"), 866.3153f, 3631.587f, 31.9545f, 276.6327f, 1, 1, 0);
iLocal_59[5]=VEHICLE::CREATE_VEHICLE(joaat("hexer"), 868.5937f, 3633.523f, 31.9622f, 267.0991f, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("hexer"));
AUDIO::SET_AUDIO_VEHICLE_PRIORITY(iLocal_59[2], 3);
AUDIO::SET_AUDIO_VEHICLE_PRIORITY(iLocal_59[4], 3);
iLocal_53=MISC::GET_GAME_TIMER() + 1500;
}
...
iLocal_57[2]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_59[2], 22, joaat("g_m_y_lost_01"), -1, 1, 1);
iLocal_57[3]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_59[3], 22, joaat("g_m_y_lost_02"), -1, 1, 1);
iLocal_57[4]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_59[4], 22, joaat("g_m_y_lost_01"), -1, 1, 1);
iLocal_57[5]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_59[5], 22, joaat("g_m_y_lost_02"), -1, 1, 1);
func_63(&uLocal_61, 4, iLocal_57[4], "RECGFLost3", 0, 1);
iLocal_53=MISC::GET_GAME_TIMER() + 1500;
iVar0=0;
while (iVar0 < iLocal_57){
if(!PED::IS_PED_INJURED(iLocal_57[iVar0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_59[iVar0], 0)){
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_59[iVar0], "RE_COUNTRYSIDE_GANG_BIKES", 0);
PED::SET_PED_CONFIG_FLAG(iLocal_57[iVar0], 137, 1);
PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_57[iVar0], 0);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_57[iVar0], 2);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_57[iVar0], 50, 1);
PED::SET_PED_COMBAT_ABILITY(iLocal_57[iVar0], 2);
PED::SET_PED_TO_INFORM_RESPECTED_FRIENDS(iLocal_57[iVar0], 50f, 20);
PED::SET_PED_COMBAT_RANGE(iLocal_57[iVar0], 1);
PED::SET_PED_ACCURACY(iLocal_57[iVar0], 13);
PED::SET_PED_HEARING_RANGE(iLocal_57[iVar0], 100f);
PED::SET_PED_SEEING_RANGE(iLocal_57[iVar0], 100f);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_57[iVar0], uLocal_226);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_57[iVar0], 1);
PED::SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(iLocal_57[iVar0], 3);
PED::SET_PED_HELMET(iLocal_57[iVar0], 0);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_57[iVar0], 1);
ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(iLocal_57[iVar0], 1, 1000f);
if(iVar0 > 1 && iVar0 < 5){
WEAPON::GIVE_WEAPON_TO_PED(iLocal_57[iVar0], joaat("weapon_pistol"), -1, 1, 1);
}else{
WEAPON::GIVE_WEAPON_TO_PED(iLocal_57[iVar0], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
}
TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_59[2], 966.7098f, 3633.926f, 31.3974f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
TASK::TASK_LOOK_AT_COORD(0, Local_46, 5000, 0, 2);
TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
TASK::TASK_PERFORM_SEQUENCE(iLocal_57[2], uLocal_60);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_60);
TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_59[3], 970.6208f, 3636.743f, 31.3666f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
TASK::TASK_LOOK_AT_COORD(0, Local_46, 5000, 0, 2);
TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
TASK::TASK_PERFORM_SEQUENCE(iLocal_57[3], uLocal_60);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_60);
PED::SET_PED_KEEP_TASK(iLocal_57[3], 1);
TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_59[4], 971.023f, 3631.225f, 31.3807f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
TASK::TASK_LOOK_AT_COORD(0, Local_46, 5000, 0, 2);
TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
TASK::TASK_PERFORM_SEQUENCE(iLocal_57[4], uLocal_60);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_60);
TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_59[5], 974.8073f, 3633.771f, 31.3818f, 10f, 0, joaat("hexer"), 786725, 4f, 100f);
TASK::TASK_LOOK_AT_COORD(0, Local_46, 5000, 0, 2);
TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
TASK::TASK_PERFORM_SEQUENCE(iLocal_57[5], uLocal_60);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_60);
}
iVar0++;
}
...
void func_64(){
if(!PED::IS_PED_INJURED(iLocal_56)){
TASK::TASK_SMART_FLEE_PED(iLocal_56, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_56, 1);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_57[0], 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_57[1], 0)){
ENTITY::SET_ENTITY_HEALTH(iLocal_56, 101, 0);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_56, 0);
TASK::TASK_SHOOT_AT_ENTITY(iLocal_57[0], iLocal_56, 1000, 0);
TASK::TASK_SHOOT_AT_ENTITY(iLocal_57[1], iLocal_56, 1000, 0);
}else{
func_4();
func_41(0);
if(!PED::IS_PED_INJURED(iLocal_56)){
...
switch (iLocal_44){
case 0:
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 45f, 45f, 20f, 0, 1, 0)){
if(!func_8()){
if(func_54()==0){
...
case 1:
if(!PED::IS_PED_INJURED(iLocal_56)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 40f, 40f, 20f, 0, 1, 0)){
...
break;
case 3:
if((!PED::IS_PED_INJURED(iLocal_56) && !PED::IS_PED_INJURED(iLocal_57[0])) && !PED::IS_PED_INJURED(iLocal_57[1])){
if((timera() > 5000 && !iLocal_50) && !func_8()){
func_42(&uLocal_61, "RECGFAU", "RECGF_PAYUP", 4, 0, 0, 0);
iLocal_50=1;
}
if(timera() < 28000){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 12f, 12f, 2.5f, 0, 1, 0)){
if(((PED::CAN_PED_SEE_HATED_PED(iLocal_57[0], PLAYER::PLAYER_PED_ID()) || PED::CAN_PED_SEE_HATED_PED(iLocal_57[1], PLAYER::PLAYER_PED_ID())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_57[0], PLAYER::PLAYER_PED_ID())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_57[1], PLAYER::PLAYER_PED_ID())){
TASK::TASK_LOOK_AT_ENTITY(iLocal_57[0], PLAYER::PLAYER_PED_ID(), 4000, 2056, 4);
TASK::TASK_LOOK_AT_ENTITY(iLocal_57[1], PLAYER::PLAYER_PED_ID(), 4000, 2056, 4);
if(!iLocal_51){
func_4();
func_41(0);
...
}}elseif(!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_57[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 3)){
if(!PED::IS_PED_FACING_PED(iLocal_57[0], iLocal_56, 10f)){
TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_57[0], iLocal_56, -1, 0);
}}}elseif(!ENTITY::IS_ENTITY_DEAD(iLocal_59[0], 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_59[1], 0)){
func_4();
func_41(0);
...
while (iVar0 < iLocal_57){
if(!PED::IS_PED_INJURED(iLocal_57[iVar0])){
PED::SET_PED_RESET_FLAG(iLocal_57[iVar0], 156, 1);
TASK::TASK_COMBAT_PED(iLocal_57[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
PED::SET_PED_KEEP_TASK(iLocal_57[iVar0], 1);
}
iVar0++;
}
...
if(PED::IS_PED_INJURED(iLocal_57[0]) && PED::IS_PED_INJURED(iLocal_57[1])){
iLocal_44=0;
iLocal_43=1;
}
break;
...
struct<3> Var1;
if(!bLocal_49){
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(255, uLocal_226, joaat("player"));
if(!ENTITY::IS_ENTITY_DEAD(iLocal_57[0], 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_57[1], 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_57[0], PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_57[1], PLAYER::PLAYER_PED_ID(), 1)){
func_4();
return 1;
}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_57[0], PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_57[1], PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1)){
func_4();
return 1;
}}}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_59[0], 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_59[1], 0)){
if(((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_59[0], 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_59[1], 0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_59[0], PLAYER::PLAYER_PED_ID(), 1)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_59[1], PLAYER::PLAYER_PED_ID(), 1)){
if(!PED::IS_PED_INJURED(iLocal_57[0]) && !PED::IS_PED_INJURED(iLocal_57[1])){
if(func_99()){
func_4();
func_41(0);
...
if(!PED::IS_PED_INJURED(iLocal_57[0])){
if(MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_57[0], 31086, 0f, 0f, 0f), 5f, 1)){
func_4();
return 1;
}
Var0={
Var0 + PED::GET_PED_BONE_COORDS(iLocal_57[0], 31086, 0f, 0f, 0f) 
};
Var1={
Var1 + PED::GET_PED_BONE_COORDS(iLocal_57[0], 31086, 0f, 0f, 0f) 
};
...
if(GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(PED::GET_PED_BONE_COORDS(iLocal_57[0], 31086, 0f, 0f, 0f), 3f)){
func_4();
return 1;
}}
...
if((!PED::IS_PED_INJURED(iLocal_56) && !PED::IS_PED_INJURED(iLocal_57[0])) && !PED::IS_PED_INJURED(iLocal_57[1])){
if(iLocal_45 !=-1){
if(((PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_57[0]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_57[1])) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_57[0])) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_57[1])){
func_4();
return 1;
}}
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_56, 12f, 12f, 2.5f, 0, 1, 0)){
if(((PED::CAN_PED_SEE_HATED_PED(iLocal_57[0], PLAYER::PLAYER_PED_ID()) || PED::CAN_PED_SEE_HATED_PED(iLocal_57[1], PLAYER::PLAYER_PED_ID())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_57[0], PLAYER::PLAYER_PED_ID())) || ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_57[1], PLAYER::PLAYER_PED_ID())){
if(!iLocal_48){
TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_57[0], PLAYER::PLAYER_PED_ID(), -1, 0);
iLocal_48=1;
}
if(HUD::DOES_BLIP_EXIST(uLocal_54)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_54, 1);
}
if(HUD::DOES_BLIP_EXIST(uLocal_55[0])){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_55[0], 1);
}
if(HUD::DOES_BLIP_EXIST(uLocal_55[1])){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_55[1], 1);
}
...
if(iLocal_45 !=-1 && MISC::GET_GAME_TIMER() > iLocal_45 + 10000){
func_4();
func_41(0);
...
if((!ENTITY::IS_ENTITY_AT_COORD(uLocal_58, 915.7905f, 3603.449f, 31.9111f, 5f, 5f, 5f, 0, 1, 0) && !PED::IS_PED_IN_VEHICLE(iLocal_56, iLocal_58, 0)) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_58, 1)){
func_64();
}}else{
func_64();
}}
...
int func_85(){
int iVar0;
if(((((!ENTITY::DOES_ENTITY_EXIST(iLocal_56) && !ENTITY::DOES_ENTITY_EXIST(iLocal_57[0])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_57[1])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_58)) && !ENTITY::DOES_ENTITY_EXIST(iLocal_59[0])) && !ENTITY::DOES_ENTITY_EXIST(iLocal_59[1])){
...
PED::ADD_SCENARIO_BLOCKING_AREA(Local_46 - Vector(20f, 50f, 80f), Local_46 + Vector(20f, 50f, 70f), 0, 1, 1, 1);
MISC::ENABLE_DISPATCH_SERVICE(3, 0);
MISC::ENABLE_DISPATCH_SERVICE(5, 0);
PED::ADD_RELATIONSHIP_GROUP("rghLost", &uLocal_226);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_226, joaat("player"));
iLocal_56=PED::CREATE_PED(26, joaat("a_m_m_skidrow_01"), 973.053f, 3616.738f, 31.6181f, 110.2753f, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(iLocal_56, 0, 0, 1, 0);
...
TASK::TASK_PLAY_ANIM(iLocal_56, "random@countryside_gang_fight", "gangmember_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
PED::SET_PED_MOVEMENT_CLIPSET(iLocal_56, "move_m@gangster@var_i", 1048576000);
iLocal_58=VEHICLE::CREATE_VEHICLE(joaat("picador"), 915.7905f, 3603.449f, 31.9111f, 111.9593f, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOURS(iLocal_58, 37, 0);
VEHICLE::SET_VEHICLE_EXTRA_COLOURS(iLocal_58, 4, 0);
VEHICLE::SET_VEHICLE_PROVIDES_COVER(iLocal_58, 1);
VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(iLocal_58, "WDU 696");
iLocal_57[0]=PED::CREATE_PED(22, joaat("g_m_y_lost_01"), 970.2217f, 3614.821f, 31.6909f, 297.4345f, 1, 1);
func_63(&uLocal_61, 3, iLocal_57[0], "RECGFLost2", 0, 1);
iLocal_57[1]=PED::CREATE_PED(22, joaat("g_m_y_lost_02"), 971.504f, 3618.054f, 31.5565f, 216.9967f, 1, 1);
func_63(&uLocal_61, 2, iLocal_57[1], "RECGFLost1", 0, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("g_m_y_lost_01"));
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("g_m_y_lost_02"));
iLocal_59[0]=VEHICLE::CREATE_VEHICLE(joaat("hexer"), 968.2626f, 3611.717f, 31.7874f, 296.8978f, 1, 1, 0);
iLocal_59[1]=VEHICLE::CREATE_VEHICLE(joaat("hexer"), 970.8362f, 3625.563f, 31.3415f, 212.3456f, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("hexer"));
TASK::TASK_PLAY_ANIM(iLocal_57[0], "random@countryside_gang_fight", "biker_02_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(iLocal_57[1], "random@countryside_gang_fight", "biker_01_stickup_loop", 1000f, -2f, -1, 1, 0, 0, 0, 0);
iVar0=0;
while (iVar0 < iLocal_57){
if(iVar0 < 2){
PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_57[iVar0], 0);
...
PED::SET_PED_COMBAT_MOVEMENT(iLocal_57[iVar0], 2);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_57[iVar0], 50, 1);
PED::SET_PED_COMBAT_RANGE(iLocal_57[iVar0], 0);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_57[0], joaat("weapon_pistol"), -1, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_57[1], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
PED::SET_PED_KEEP_TASK(iLocal_57[iVar0], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_57[iVar0], 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_57[iVar0], 1, 1);
}
iVar0++;
}
iLocal_53=MISC::GET_GAME_TIMER() + 1500;
if(func_54()==0){
func_63(&uLocal_61, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
}elseif(func_54()==1){
func_63(&uLocal_61, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}elseif(func_54()==2){
func_63(&uLocal_61, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
}
return 1;
}}
return 0;
...
if(!func_140(Global_113810.f_24998.f_43[iParam1])){
return 0;
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_138()) || Global_112857) || Global_32286) || func_137()) || func_56(8, -1)) || func_136()) || func_135()) || func_134()) || func_133()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_138()) || Global_32286) || func_137()) || func_56(8, -1)) || func_134()) || func_136()) || func_135()) || func_133()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_138()) || Global_112857) || Global_32286) || func_137()) || func_56(8, -1)) || func_134()) || func_136()) || func_135()) || func_133()) || Global_113810.f_7691.f_919[iVar0]==5) || Global_43924 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_138()) || Global_112857) || Global_32286) || func_137()) || func_56(8, -1)) || func_136()) || func_135()) || func_133()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_138()) || Global_32286) || func_137()) || func_56(8, -1)) || func_135()) || func_134()) || func_133()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_138()) || func_135()) || Global_112857) || Global_32286) || func_137()) || Global_44569) || func_56(8, -1)) || func_134()) || func_132()) || func_133()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_138()) || Global_112857) || Global_32286) || func_137()) || func_56(8, -1)) || func_134()) || func_132()) || func_136()) || func_135()) || func_133()){
return 0;
}
break;
}}else{
