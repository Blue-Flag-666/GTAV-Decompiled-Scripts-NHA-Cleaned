...
start_new_script_with_name_hash_and_args(-949873222, &ScriptParam_60, 23, 1424);
}
SCRIPT::TERMINATE_THIS_THREAD();
}
...
bVar0=(func_61(uVar1) || func_60(uVar1));
bLocal_56=VEHICLE::DOES_VEHICLE_HAVE_ROOF(uVar1);
func_59(bLocal_56);
}
iVar3=0;
...
void func_54(struct<3> Param0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6){
int iVar0;
float fVar1;
struct<3> Var2;
struct<3> Var3;
...
void func_55(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4){
func_56(*(uParam0[0 /*3*/]), *(uParam0[1 /*3*/]), uParam0->f_7, iParam1, iParam2, iParam3, iParam4);
}


void func_56(struct<3> Param0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6){
struct<3> Var0;
struct<3> Var1;
float fVar2;
struct<3> Var3;
...
Vector3 func__57(struct<3> Param0, struct<3> Param1){
...
if(MISC::GET_GAME_TIMER() > uLocal_58[iParam0]){
iLocal_59[iParam0]=SHAPETEST::START_SHAPE_TEST_SWEPT_SPHERE(Local_57[iParam0 /*3*/], Local_57[iParam0 /*3*/] + Vector(1f, 0f, 0f), 2f, 2, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 4);
}}else{
iVar0=SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_59[iParam0], &iVar4, &uVar2, &uVar3, &uVar1);
if(iVar0==2){
Local_38[iParam0 /*24*/].f_8=0;
if(iVar4 > 0){
...
uLocal_58[iParam0]=MISC::GET_GAME_TIMER() + 250;
}}
...
float func_65(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
...
}elseif(MISC::IS_XBOX360_VERSION() || func_68()){
...
void func_70(var uParam0, struct<3> Param1, float fParam2){
uParam0->f_12={
func_20(Param1 * Vector(5f, 5f, 5f)) 
};
uParam0->f_15=func_71(fParam2, 0f, 360f);
}
...
void func_72(var uParam0, int iParam1, char* sParam2, struct<3> Param3, int iParam4, char* sParam5, int iParam6, float fParam7){
uParam0->f_5=sParam2;
uParam0->f_1={
Param3 
};
