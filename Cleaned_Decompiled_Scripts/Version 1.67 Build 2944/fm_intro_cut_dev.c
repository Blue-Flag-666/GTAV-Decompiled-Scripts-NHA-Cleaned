...
Global_1936383=1;
}elseif(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_1936380)){
if(!Global_1936382){
...
uParam0->f_295=1;
uParam0->f_294=1;
}elseif(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(func_217()) > 0){
uParam0->f_295=1;
}
...
if(!func_214(&(uParam0->f_15))){
func_213(&(uParam0->f_15), 0, 0);
}
...
func_213(&(uParam0->f_17), 0, 0);
MISC::SET_BIT(uParam0, 4);
}}elseif(AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_START") && (STREAMING::IS_NEW_LOAD_SCENE_LOADED() || func_135(&(uParam0->f_17), 5000, 0))){
...
func_110(uParam0);
}elseif(func_109(uParam0) && func_102(uParam0)){
func_100(uParam0);
}
func_133(uParam0, 15);
...
func_96(uParam0);
func_133(uParam0, 19);
if(func_131(uParam0, 19, 0) && MISC::IS_BIT_SET(uParam0->f_3, 0)){
if(MISC::IS_BIT_SET(*uParam0, 12)){
MISC::CLEAR_BIT(uParam0, 12);
}
uParam0->f_6=22;
}elseif(func_131(uParam0, 19, -4968)){
if(!MISC::IS_BIT_SET(*uParam0, 12)){
HUD::CLEAR_HELP(1);
MISC::SET_BIT(uParam0, 12);
}}elseif(func_131(uParam0, 19, -5618)){
...
func_133(uParam0, 28);
if((AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_DRIVE_START") && MISC::IS_BIT_SET(uParam0->f_3, 3)) && func_131(uParam0, 28, 0)){
uParam0->f_6=29;
}
break;
case 29:
...
func_133(uParam0, 49);
if(AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_DRIVE_END") && func_131(uParam0, 49, 0)){
...
if(func_131(uParam0, 50, 0) && MISC::IS_BIT_SET(*uParam0, 20)){
...
}}elseif(func_135(&(uParam0->f_17), 10000, 0)){
if(func_32(uParam0)){
func_125(uParam0);
func_70(uParam0);
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
...
uParam0->f_289=to_float(func_37(uParam0));
}
...
ENTITY::SET_ENTITY_HEADING(uParam0->f_58[bParam1], uVar1);
...
var func__11(var uParam0, var uParam1){
...
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uParam0->f_104[iVar0], func_87(iVar0), 0, 0, 64);
}
iVar0++;
}}
...
Vector3 func__137(struct<3> Param0){
...
struct<6> func_159(int iParam0, bool bParam1){
struct<6> Var0;
switch (iParam0){
case -1:
Var0={
...
if(func_181(PLAYER::PLAYER_ID()) && MISC::IS_BIT_SET(Global_1950844.f_4, 22)){
return 0;
}
if(Global_1577891){
return 0;
...
var func__174(var uParam0, int iParam1){
...
var func__183(var uParam0, bool bParam1, bool bParam2){
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1){
if(!bParam2){
...
void func_202(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6){
int iVar0;
func_141();
func_17(1);
func_140(1);
...
}elseif(bVar14 || ((!func_79(PLAYER::PLAYER_ID(), 0) && !func_83()) && !func_82(PLAYER::PLAYER_ID()))){
...
if(!func_207(uVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar27)){
if(!bVar22){
...
func_209(joaat("mpply_is_char_spectating"), iParam0);
}}
...
}}elseif(func_131(uParam0, 33, -3390)){
...
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 33, -450)){
...
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 36, -4740)){
...
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 36, -600)){
...
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 37, -1350)){
...
func_221("prog", 0.16f);
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 38, -4320)){
func_220("prog", 0.16f);
uParam0->f_5++;
}
break;
...
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 38, -870)){
...
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 39, -1620)){
...
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 40, -1470)){
...
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 41, -1200)){
...
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 42, -1320)){
...
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 43, -1320)){
...
func_221("uides", 0f);
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 45, -1650)){
...
func_221("concre", 0f);
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 46, -1950)){
...
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 48, -1320)){
...
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 49, -5070)){
...
MISC::SET_BIT(&(uParam0->f_4), uParam0->f_5);
}}elseif(func_131(uParam0, 49, -720)){
...
void func_221(char* sParam0, float fParam1){
...
void func_223(char* sParam0, char* sParam1, float fParam2, char* sParam3, int iParam4){
...
void func_224(char* sParam0, float fParam1, float fParam2, char* sParam3, float fParam4, float fParam5){
