...
iLocal_278=MISC::GET_RANDOM_INT_IN_RANGE(0, 4);
func_77();
...
if(ENTITY::DOES_ENTITY_EXIST(uScriptParam_284)){
iLocal_39=iScriptParam_284;
...
if(((((BRAIN::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(iLocal_39) && !ENTITY::IS_ENTITY_DEAD(iLocal_39, 0)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && func_64()) && func_63(0)) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()){
switch (iLocal_274){
case 0:
if(func_61() && func_59()){
iLocal_274=1;
...
switch (iLocal_275){
case 0:
if(func_53(Var0, Var1) && PED::IS_PED_HEADING_TOWARDS_POSITION(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_39, 1), 90f)){
func_77();
...
uLocal_276=PED::CREATE_SYNCHRONIZED_SCENE(func_37(), func_36(), 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_276, func_35(), func_34(iLocal_278), 8f, -2f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_39, uLocal_276, func_33(iLocal_278), func_35(), 8f, -2f, 0, 1148846080);
if(PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_276)){
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_276, 0);
}
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() !=4){
uLocal_277=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_277, uLocal_276, func_30(iLocal_278), func_35());
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
}else{
CAM::DESTROY_ALL_CAMS(0);
}
iLocal_281=0;
iLocal_282=(MISC::GET_GAME_TIMER() + func_29());
iLocal_275=3;
break;
case 3:
func_38();
HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
PAD::DISABLE_CONTROL_ACTION(1, 0, 1);
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_276)){
func_27();
if(iLocal_279){
fVar2=PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_276);
if(ENTITY::FIND_ANIM_EVENT_PHASE(func_35(), func_34(iLocal_278), "WalkInterruptible", &fVar3, &fVar4)){
if(fVar2 >=fVar3 && fVar2 <=fVar4){
iLocal_275=5;
}}}
if(!iLocal_281 && MISC::GET_GAME_TIMER() > iLocal_282){
...
break;
case 5:
if(func_2(uLocal_277)){
CAM::STOP_RENDERING_SCRIPT_CAMS_USING_CATCH_UP(0, 0, 3, 0);
}
AUDIO::RELEASE_AMBIENT_AUDIO_BANK();
if(STATS::STAT_GET_INT(joaat("num_sh_mr_jam_used"), &iLocal_283, -1)){
STATS::STAT_SET_INT(joaat("num_sh_mr_jam_used"), iLocal_283 + 1, 1);
}
...
int func_53(struct<3> Param0, float fParam1, var uParam2, var uParam3){
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
...
if(func_54(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Param0, fParam1, 0)){
return 1;
}}}}}
return 0;
}

int func_54(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
...
int func_59(){
if(AUDIO::REQUEST_AMBIENT_AUDIO_BANK(func_60(), 0, -1)){
return 1;
}
return 0;
}
...
if(func_54(ENTITY::GET_ENTITY_COORDS(iLocal_39, 0), func_58(), 5f, 0)){
return 1;
