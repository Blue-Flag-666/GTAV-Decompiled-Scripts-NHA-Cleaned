...
func_656("Force cleanup [TERMINATING]");
...
func_603(Local_103, 200f, &Var0, &Var1);
func_602(iLocal_285);
func_602(iLocal_288);
func_602(iLocal_283);
if(func_601(0)){
...
func_585(Local_92.f_9, 0, 0, 0, 0, 0);
iLocal_116=0;
iLocal_511=0;
fLocal_295=(fLocal_295 + MISC::GET_FRAME_TIME());
func_584();
...
if(func_37()){
if(AUDIO::IS_AUDIO_SCENE_ACTIVE(sLocal_246)){
AUDIO::SET_AUDIO_SCENE_VARIABLE(sLocal_246, "DrugsEffect", ((sin((((to_float(MISC::GET_GAME_TIMER()) / 1000f) * 45f) % 360f)) * 0.25f) + 0.25f));
}
func_32();
func_1();
}
...
func_25(&uLocal_333, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
if(func_2(&uLocal_333, "BARY2AU", "BARY2_FREAK", 6, 0, 0, 0)){
iLocal_307=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(20000, 40000));
if((iLocal_306 - MISC::GET_GAME_TIMER()) < 2500){
iLocal_306=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(3000, 5000));
}}}
...
void func_32(){
if(bLocal_112){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_109[0 /*3*/], Local_109[1 /*3*/], Local_109.f_7, 0, 1, 0)){
func_36("B2_WARN", 7500, 1);
func_35(&uLocal_114);
uLocal_114=func_34(Local_103, 5, 1);
iLocal_113=MISC::GET_GAME_TIMER() + 10000;
bLocal_112=false;
}}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_110[0 /*3*/], Local_110[1 /*3*/], Local_110.f_7, 0, 1, 0)){
func_36("B2_PRIME", 7500, 1);
func_35(&uLocal_114);
bLocal_112=true;
}elseif(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_108[0 /*3*/], Local_108[1 /*3*/], Local_108.f_7, 0, 1, 0)){
...
if(MISC::IS_STRING_NULL_OR_EMPTY(sLocal_94)){
func_642(1);
}else{
func_71(sLocal_94, 1);
}
...
func_64(1, 0, 1, 1);
func_637();
}elseif(MISC::ARE_STRINGS_EQUAL(sLocal_94, "B2_FAIL2")){
if(func_39(0) && func_601(0)){
func_637();
}}
break;
}}
...
CUTSCENE::SET_CUTSCENE_PED_PROP_VARIATION(sLocal_237, 1, 0, 0, 0);
}
switch (iLocal_96){
case 0:
if(iParam0==1){
...
ENTITY::DETACH_ENTITY(iLocal_98, 1, 0);
}}
...
iLocal_93=MISC::GET_GAME_TIMER() + 6000;
func_25(&uLocal_333, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
iLocal_96=2;
break;
case 2:
bVar1=false;
if(iParam0==1){
if(func_2(&uLocal_333, "BARY2AU", "BARY2_PREOUT", 8, 0, 0, 0) || MISC::GET_GAME_TIMER() > iLocal_93){
if(MISC::GET_GAME_TIMER() < iLocal_93){
}
iLocal_93=MISC::GET_GAME_TIMER() + 5000;
bVar1=true;
}}else{
iLocal_93=MISC::GET_GAME_TIMER() + 2000;
bVar1=true;
}
if(bVar1==1){
iLocal_96=3;
...
if(MISC::GET_GAME_TIMER() > iLocal_93){
func_49();
GRAPHICS::ANIMPOSTFX_PLAY(sLocal_243, 0, 0);
iLocal_93=MISC::GET_GAME_TIMER() + 3500;
bVar1=true;
}}else{
bVar1=true;
}
...
case 4:
if(iParam0==1){
bVar1=MISC::GET_GAME_TIMER() > iLocal_93;
}else{
if(MISC::GET_GAME_TIMER() < iLocal_93){
}
iLocal_98=func_41(PLAYER::PLAYER_PED_ID(), 1, 0, 0, 0, 0);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_98)){
if(func_50(PLAYER::PLAYER_PED_ID())){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_98, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
...
if(func_50(iLocal_98) && ENTITY::IS_ENTITY_ATTACHED(iLocal_98)){
ENTITY::DETACH_ENTITY(iLocal_98, 1, 0);
}
bVar1=true;
}}else{
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_105, 200f, 0, 0, 0, 0, 0, 0, 0);
GRAPHICS::REMOVE_DECALS_IN_RANGE(Local_105, 500f);
if(func_50(PLAYER::PLAYER_PED_ID())){
...
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
if(WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_46(iVar2, bVar6))){
if(func_45(func_46(iVar2, bVar6))){
uVar7=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_46(iVar2, bVar6));
}}}
bVar6++;
}
...
WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_46(iVar2, bVar8));
...
void func_49(){
if(GRAPHICS::ANIMPOSTFX_IS_RUNNING(sLocal_241)){
GRAPHICS::ANIMPOSTFX_STOP(sLocal_241);
}
...
func_67(&(Global_107357.f_2890), Param0, fParam1);
}
...
if(func_69(Global_78930, 0f, 0f, 0f, 0)){
Global_78930={
Param0 
};
...
TASK::TASK_SMART_FLEE_COORD(Local_248[iVar0 /*19*/].f_3, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 400f, -1, 0, 0);
}
iVar0++;
}}}
...
case 0:
func_51("bar_4_rcm", 0);
func_399(Local_105, 1112014848, 12, 5000, 0, 0);
if(!SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2")){
SCRIPT::REQUEST_SCRIPT("postRC_Barry1and2");
}
func_323(2, "Outro", 1, 0, 0, 1);
*iParam0=1;
break;
case 1:
if(!func_321()){
...
AUDIO::CLEAR_AMBIENT_ZONE_STATE(sLocal_498, 1);
if(func_314(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2")){
if(func_50(PLAYER::PLAYER_PED_ID())){
PED::RESET_PED_VISIBLE_DAMAGE(PLAYER::PLAYER_PED_ID());
PED::CLEAR_PED_BLOOD_DAMAGE(PLAYER::PLAYER_PED_ID());
}
func_308();
iLocal_247=0;
MISC::CLEAR_AREA_OF_VEHICLES(Local_105, 250f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_PEDS(Local_105, 50f, 0);
MISC::CLEAR_AREA_OF_OBJECTS(Local_105, 30f, 0);
GRAPHICS::REMOVE_DECALS_IN_RANGE(Local_105, 500f);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_237, 2, func_659(49), 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_239, 2, joaat("prop_protest_table_01"), 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_238, 2, joaat("prop_chair_08"), 0);
if(func_63(PLAYER::PLAYER_PED_ID())){
...
STREAMING::SET_SRL_POST_CUTSCENE_CAMERA(183.434f, -949.1876f, 30.8535f, func_304(-3f, 0f, 72.9999f));
*iParam0=2;
}
break;
case 2:
...
if(iVar0 > 15000){
if(func_300(PLAYER::PLAYER_PED_ID(), 10000, 0)){
}}
if(!iLocal_247){
...
func_299(PLAYER::PLAYER_PED_ID(), 180.1684f, -948.6075f, 29.0919f);
...
PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 2f, 750, 0, 1, 0, 0);
iLocal_247=1;
}
...
if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_237, 0))){
Local_92.f_28[0]=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_237, 0));
PED::SET_PED_PROP_INDEX(Local_92.f_28[0], 1, 0, 0, false, 1);
}}
if(!func_63(Local_92.f_41[0])){
if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_239, 0))){
Local_92.f_41[0]=ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_239, 0));
}}
if(!func_63(Local_92.f_41[1])){
if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_238, 0))){
Local_92.f_41[1]=ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY(sLocal_238, 0));
}}
if(CUTSCENE::CAN_SET_ENTER_STATE_FOR_REGISTERED_ENTITY(sLocal_239, 0)){
if(func_63(Local_92.f_41[0]) && func_63(Local_92.f_41[2])){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_92.f_41[2], Local_92.f_41[0], 0, 0f, -0.25f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}}
break;
case 3:
...
func_64(1, 1, 1, 1);
func_299(PLAYER::PLAYER_PED_ID(), Local_105);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), fLocal_106);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
wait(250);
func_307(250, 0);
...
void func_83(){
if(WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_253, 0)){
WEAPON::SET_PED_INFINITE_AMMO(PLAYER::PLAYER_PED_ID(), 0, iLocal_253);
}
WEAPON::REMOVE_ALL_PED_WEAPONS(PLAYER::PLAYER_PED_ID(), 1);
func_293(&Global_104373);
if(func_63(PLAYER::PLAYER_PED_ID())){
func_280(PLAYER::PLAYER_PED_ID(), 1, 0);
}
...
func_248(&(Global_112897[iVar0 /*10*/].f_9));
}
if(bParam1){
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
...
func_89(13, floor(Global_113810.f_10197.f_3853));
}
...
Global_78472[1 /*14*/]={
func_164(iVar0, iParam1, iParam2, -1) 
};
...
Global_78472[1 /*14*/]={
func_164(iVar0, iParam1, uVar6[iParam1], -1) 
};
if(PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_156(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_156(iParam1), Global_78472[1 /*14*/].f_3) > 0){
PED::SET_PED_COMPONENT_VARIATION(iParam0, func_156(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, 0);
}}
...
if(!func_228(iParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_64, Global_113810.f_2366.f_539[iVar0 /*65*/].f_63)){
...
if(iParam5==0){
Global_78472[1 /*14*/]={
func_164(iVar10, iParam1, iParam2, -1) 
};
if(!func_154(iParam3)){
...
if(uVar11[iVar0] !=-99){
Global_78472[1 /*14*/]={
func_164(iVar10, iVar0, uVar11[iVar0], -1) 
};
if(MISC::IS_BIT_SET(Global_78472[1 /*14*/].f_6, 0)){
if(iVar0==13){
uVar12=9;
...
uVar12={
func_157(iVar10, uVar11[iVar0]) 
};
}
iVar1=0;
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_164(iVar10, 14, uVar12[iVar1], -1) 
};
func_130(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
func_146(14);
if(Global_78470==1){
iVar2=0;
while (iVar2 < 15){
...
if(iParam4==-1){
PED::SET_PED_COMPONENT_VARIATION(iParam0, func_156(iVar0), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_156(iVar0)));
}
else{
PED::SET_PED_COMPONENT_VARIATION(iParam0, func_156(iVar0), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
}
func_146(iVar0);
if(Global_78470==1){
iVar2=0;
...
Global_78472[1 /*14*/]={
func_164(iVar10, iVar0, func_120(iParam0, iVar0, -1), -1) 
};
...
uVar15={
func_157(iVar10, iParam2) 
};
iVar1=0;
while (iVar1 <=8){
Global_78472[1 /*14*/]={
func_164(iVar10, 14, uVar15[iVar1], -1) 
};
func_130(iParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
func_146(14);
if(Global_78470==1){
...
if(iParam4==-1){
PED::SET_PED_COMPONENT_VARIATION(iParam0, func_156(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_156(iParam1)));
}else{
PED::SET_PED_COMPONENT_VARIATION(iParam0, func_156(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
}
if(Global_78470==1){
iVar2=0;
while (iVar2 < 15){
...
Global_78472[1 /*14*/]={
func_164(iParam0, iParam1, iParam2, -1) 
};
...
return 1;
}elseif(func_141(iParam0, iParam2, iParam3, -1)){
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_156(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_156(iParam2));
...
func_153(iParam0, Global_78472[1 /*14*/].f_5, Global_78472[1 /*14*/].f_2, 2, Global_78472[1 /*14*/].f_1, 1, 0);
}
if(MISC::IS_BIT_SET(Global_78472[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_78472[1 /*14*/].f_6, 6)){
if(iParam0==12){
...
var func__149(int iParam0, var uParam1){
...
if(!func_228(iParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_61, Global_113810.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3==1){
...
break;
case 5:
func_163(&Var1, -99, -99, Global_113810.f_2366.f_539.f_196[0], Global_113810.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
break;
case 6:
...
break;
case 2:
func_163(&Var1, -99, -99, Global_113810.f_2366.f_539.f_196[1], Global_113810.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
break;
case 3:
...
break;
case 4:
func_163(&Var1, -99, -99, Global_113810.f_2366.f_539.f_196[2], Global_113810.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
break;
case 5:
...
func_167(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
uVar0=func_151(func_170(iParam1, uParam0->f_2), Global_78469);
if(MISC::IS_BIT_SET(uVar0, uParam0->f_1)){
MISC::SET_BIT(&(uParam0->f_6), true);
}
uVar0=func_151(func_169(iParam1, uParam0->f_2), Global_78469);
if(MISC::IS_BIT_SET(uVar0, uParam0->f_1)){
MISC::SET_BIT(&(uParam0->f_6), 2);
}
if(func_168(iParam1, uParam0->f_2, &iVar1)){
uVar0=func_151(iVar1, Global_78469);
if(!MISC::IS_BIT_SET(uVar0, uParam0->f_1)){
MISC::SET_BIT(&(uParam0->f_6), 4);
}}}else{
MISC::SET_BIT(&(uParam0->f_6), true);
...
func_167(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
return;
}}}elseif(iParam0==13){
func_167(&(Global_78472[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
}elseif(iParam0==14){
...
func_167(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_167(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
iVar10=(iParam1 - iParam2);
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_156(iParam0));
if(iVar11 > iVar10){
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_156(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_156(iParam1))){
return 1;
}
return 0;
}
...
func_236(&uVar1, Var0.f_3, Global_100870, iParam1, iParam2);
}}
...
if(Global_98125){
func_15();
GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_242(Global_113810.f_2366.f_539.f_4321));
}else{
...
}elseif(MISC::IS_PS3_VERSION() || func_244()){
...
func_253(iParam0, 1);
Global_113810.f_18577[iParam0 /*6*/].f_3=func_252();
...
func_281(iParam0, &(Global_113810.f_2366.f_539.f_298[iVar0 /*477*/]), bParam1);
iVar1=0;
while (iVar1 <=(8 - 1)){
...
if(!FILES::IS_CONTENT_ITEM_LOCKED(Var9.f_0) && !func_287(Var9.f_1)){
if(iVar7==0){
...
struct<2> Var1;
if(iParam0==-61829581){
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_291()){
return 1;
}else{
return 0;
}}
...
if(!func_289() || NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
return 0;
}
break;
case joaat("weapon_hatchet"):
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
if(!func_289() && !Global_262145.f_20404){
return 0;
}}
break;
case joaat("weapon_knuckle"):
...
if(Var1.f_1==iParam0){
if(FILES::IS_CONTENT_ITEM_LOCKED(Var1.f_0) || func_287(Var1.f_1)){
return 0;
}}}
iVar0++;
}
...
Vector3 func__299(int iParam0, struct<3> Param1){
var uVar0;
...
if(iParam4==1){
MISC::CLEAR_AREA_OF_PEDS(func_306(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
}
if(iParam5==1){
...
void func_308(){
if(AUDIO::IS_AUDIO_SCENE_ACTIVE(sLocal_246)){
AUDIO::STOP_AUDIO_SCENE(sLocal_246);
}
func_76(&iLocal_512);
func_80(1);
func_78();
func_73(1);
func_310();
if(ENTITY::DOES_ENTITY_EXIST(Local_92.f_28[0])){
PED::DELETE_PED(&(Local_92.f_28[0]));
}
...
void func_309(){
if(CAM::DOES_CAM_EXIST(uLocal_508)){
CAM::SET_CAM_ACTIVE(uLocal_508, 0);
CAM::DESTROY_CAM(uLocal_508, 0);
}}
...
iVar0=0;
if(!func_318(PLAYER::PLAYER_PED_ID(), joaat("script_task_leave_any_vehicle"))){
...
iVar6=func_393(&(Global_100833.f_3));
if(iVar6 > -1){
...
func_325(&Global_107357, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
func_352(&(uParam0->f_2884), 0);
func_351(PLAYER::PLAYER_PED_ID());
...
var uVar0;
var uVar1;
uVar0=func_345(iParam0, iParam1);
...
var func__345(int iParam0, var uParam1){
...
if(func_16(iVar0) && !PED::IS_PED_INJURED(iParam0)){
if(iParam0==PLAYER::PLAYER_PED_ID()){
func_350(iParam0, &(Global_113810.f_2366.f_539.f_298[iVar0 /*477*/]));
iVar2=0;
while (iVar2 <=(8 - 1)){
...
}elseif(func_353(*uParam0, "v_hospital", 307.3065f, -589.9595f, 43.302f)){
*uParam0={
...
int func_353(struct<3> Param0, char* sParam1, struct<3> Param2){
int iVar0;
int iVar1;
...
if(func_381()){
*uParam0=func_360(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
if(func_88()==0){
return MISC::IS_BIT_SET(func_151(func_358(iParam0), -1), iParam1);
}}else{
...
int func_360(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_361(iVar0, 0), 1);
...
Vector3 func__361(int iParam0, bool bParam1){
switch (iParam0){
case -1:
return 0f, 0f, 0f;
break;
...
break;
case 45:
return func_376(Global_102986);
break;
case 46:
if(Global_1853823 !=func_8()){
if(func_375(Global_1853823)){
return func_368(2, 2);
}elseif(func_367(Global_1853823)){
...
Vector3 func__365(struct<3> Param0){
return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_366(), 0f, Param0);
}
...
Vector3 func__368(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var1;
Var1={
...
Var3={
func_370(Var3, -Var0.f_3.f_2) 
};
Var3={
func_370(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__370(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
var func__387(int iParam0){
return (shift_right(iParam0, 26) & 31 * func_388(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
case 69:
case 70:
return func_395(Global_113810.f_9088.f_99.f_205[10]);
break;
case 74:
case 75:
return func_395(Global_113810.f_9088.f_99.f_205[8]);
break;
case 84:
case 85:
return func_395(Global_113810.f_9088.f_99.f_205[11]);
break;
case 90:
return func_395(Global_113810.f_9088.f_99.f_205[7]);
break;
case 93:
return func_395(Global_113810.f_9088.f_99.f_205[9]);
break;
}
return 0;
}
...
void func_399(struct<3> Param0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5){
var uVar0;
int iVar1;
...
func_426(&uLocal_529);
if(func_425(&iVar0)){
if(func_419(&(Local_248[iVar0 /*19*/]), 195.1091f, -933.9568f, 29.6918f, 325f, 1, 0)){
}}
*iParam0=2;
break;
case 2:
...
func_408();
if((func_406() && iLocal_290==0) && iLocal_282 >=10){
func_403(&iLocal_501);
if(iLocal_287==0){
iLocal_501=0;
*iParam0=4;
...
iVar0=func_405();
if(iVar0 !=-1){
func_404(&(Local_248[iVar0 /*19*/]), 1, 1);
Local_248[iVar0 /*19*/].f_11=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_302, (iLocal_302 + iLocal_301)));
PED::REMOVE_PED_DEFENSIVE_AREA(Local_248[iVar0 /*19*/].f_3, 0);
}
*bParam0=1;
}}}
...
iVar0=0;
while (iVar0 < Local_249.f_0){
if(!func_407(&(Local_249[iVar0 /*15*/]))){
return 0;
}
iVar0++;
}
...
return (func_412(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return uParam0->f_1;
}
...
uParam0->f_1=(func_412(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
int func_419(var uParam0, struct<3> Param1, int iParam2, bool bParam3, bool bParam4){
int iVar0;
var uVar1;
if(iLocal_95 !=9){
...
uParam0->f_3=PED::CREATE_PED(26, iLocal_250, Param1, iParam2, 1, 1);
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_3)){
return 0;
}
uParam0->f_5=-1;
...
func_420(uParam0->f_3, &uLocal_254, 0);
StringCopy(&(uParam0->f_7), "clown_idle_", 16);
StringIntConCat(&(uParam0->f_7), MISC::GET_RANDOM_INT_IN_RANGE(0, 6), 16);
TASK::TASK_PLAY_ANIM(uParam0->f_3, sLocal_245, &(uParam0->f_7), 8f, -2f, -1, 0, 0, 0, 0, 0);
...
float fVar0;
fVar0=func_424(ENTITY::GET_ENTITY_COORDS(uParam0, 1), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1);
ENTITY::SET_ENTITY_HEADING(iParam0, fVar0);
}


float func_424(struct<2> Param0, Vector3 vParam1, struct<2> Param2, Vector3 vParam3, int iParam4){
float fVar0;
float fVar1;
float fVar2;
...
fLocal_289=20f;
if(func_441(&iVar0)){
func_440(&(Local_249[iVar0 /*15*/]), 247.8f, -880.3f, 33f, 129.46f, 1, 6000, 600, 2000);
}
if(func_441(&iVar0)){
func_440(&(Local_249[iVar0 /*15*/]), 218.4f, -868.5f, 33f, 228.6f, -1, 14000, 1100, 2000);
}
func_415(&uLocal_529);
fLocal_532=MISC::GET_RANDOM_FLOAT_IN_RANGE(5f, 8f);
*iParam0=2;
break;
case 2:
if(!iLocal_501){
if(func_439(&uLocal_529, fLocal_532)){
func_429(2, 5, 5, 0);
fLocal_532=MISC::GET_RANDOM_FLOAT_IN_RANGE(20f, 30f);
func_415(&uLocal_529);
}}
if(iLocal_282 >=5){
iLocal_290=0;
}
if(func_406() && iLocal_290==0){
func_403(&iLocal_501);
if(iLocal_287==0){
iLocal_501=0;
*iParam0=4;
...
if(func_435(iParam0, &iVar3, !bParam3)){
if(bParam3){
if(func_425(&iVar2)){
if(func_419(&(Local_248[iVar2 /*19*/]), Local_526[iVar3 /*7*/].f_1, Local_526[iVar3 /*7*/].f_4, 1, 1)){
func_422(&(Local_248[iVar2 /*19*/]), 2);
func_430(&(Local_526[iVar3 /*7*/]), iVar1, 0);
}}}else{
func_430(&(Local_526[iVar3 /*7*/]), iVar1, !bParam3);
}}}


void func_430(var uParam0, int iParam1, bool bParam2){
int iVar0;
int iVar1;
var uVar2;
struct<3> Var3;
...
if(func_434(&iVar1)){
Var3={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_1, uParam0->f_4, Local_519[iVar0 /*3*/]) 
};
if(bParam2){
uVar2=func_433(uParam0->f_1, Var3);
}else{
uVar2=func_433(Var3, uParam0->f_1);
}
func_432(iVar1, Var3, uVar2);
func_431(iVar1);
if(iLocal_512==-1 && !bParam2){
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_512, "CROWD_WATCHING", Local_520[iVar1 /*11*/], 0, 0, 0);
}
...
var uVar0;
if(MISC::GET_GROUND_Z_FOR_3D_COORD(Local_520[iParam0 /*11*/].f_2, &uVar0, 0, 0)){
Local_520[iParam0 /*11*/].f_2.f_2=uVar0;
}
if(Local_520[iParam0 /*11*/].f_2.f_2 < 28f){
return 0;
}
Local_520[iParam0 /*11*/]=PED::CREATE_PED(26, Local_520[iParam0 /*11*/].f_1, Local_520[iParam0 /*11*/].f_2, Local_520[iParam0 /*11*/].f_5, 1, 1);
if(!ENTITY::DOES_ENTITY_EXIST(Local_520[iParam0 /*11*/])){
return 0;
}
PED::DISABLE_PED_INJURED_ON_GROUND_BEHAVIOUR(Local_520[iParam0 /*11*/]);
AUDIO::STOP_PED_SPEAKING(Local_520[iParam0 /*11*/], 1);
PED::SET_PED_DIES_WHEN_INJURED(Local_520[iParam0 /*11*/], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_520[iParam0 /*11*/], 1);
PED::SET_PED_MONEY(Local_520[iParam0 /*11*/], 0);
ENTITY::SET_ENTITY_HEALTH(Local_520[iParam0 /*11*/], 100, 0);
...
void func_432(int iParam0, struct<3> Param1, var uParam2){
if(func_421()){
Local_520[iParam0 /*11*/].f_1=iLocal_510;
}else{
Local_520[iParam0 /*11*/].f_1=iLocal_509;
}
Local_520[iParam0 /*11*/].f_2={
Param1 
};
...
var func__433(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3){
...
if(!PED::IS_ANY_PED_NEAR_POINT(Local_525[iVar0 /*7*/].f_1, 7f)){
...
Local_526[iParam1 /*7*/].f_1={
Local_525[iParam0 /*7*/].f_1 
};
...
iVar0=0;
while (iVar0 < Local_520.f_0){
if(ENTITY::DOES_ENTITY_EXIST(Local_520[iVar0 /*11*/])){
if(!PED::IS_PED_INJURED(Local_520[iVar0 /*11*/])){
iVar1++;
}}
iVar0++;
}
...
int func_440(var uParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6){
float fVar0;
MISC::CLEAR_AREA_OF_VEHICLES(Param1, 5f, 0, 0, 0, 0, 0, 0, 0);
if(MISC::GET_GROUND_Z_FOR_3D_COORD(Param1 + Vector(0.23f, 0f, 0f), &fVar0, 0, 0)){
Param1.f_2=fVar0;
}
uParam0->f_3=VEHICLE::CREATE_VEHICLE(iLocal_251, Param1, fParam2, 1, 1, 0);
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_3)){
return 0;
}
fVar0=(to_float(ENTITY::GET_ENTITY_HEALTH(uParam0->f_3)) / 1.5f);
ENTITY::SET_ENTITY_HEALTH(uParam0->f_3, floor(fVar0), 0);
uParam0->f_8=0;
uParam0->f_9=0;
...
iLocal_290=0;
func_323(1, "Half Way", 0, 0, 0, 1);
if(func_441(&iVar0)){
func_440(&(Local_249[iVar0 /*15*/]), 173.7f, -918.9f, 32.2f, 235.72f, -1, 1250, 1150, 1750);
}
if(func_441(&iVar0)){
func_440(&(Local_249[iVar0 /*15*/]), 214.2f, -947.3f, 32.2f, 53.64f, -1, 8250, 850, 2000);
}
func_415(&uLocal_529);
*iParam0=2;
break;
case 2:
if(iLocal_287 > 1){
if(func_439(&uLocal_529, MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 12f))){
func_429(1, 5, 5, 0);
}}
if(func_406()){
func_403(&iLocal_501);
...
iLocal_281=5;
if(func_425(&iVar0)){
func_419(&(Local_248[iVar0 /*19*/]), 202.1f, -999.3f, 30.6f, 0, 0, 0);
}
if(func_425(&iVar0)){
func_419(&(Local_248[iVar0 /*19*/]), 200.6f, -989.3f, 30.6f, 0, 0, 0);
}
if(func_425(&iVar0)){
func_419(&(Local_248[iVar0 /*19*/]), 192.3f, -994.7f, 30.6f, 0, 0, 0);
}
func_429(0, 2, 5, 1);
*iParam0=2;
break;
...
iLocal_281=5;
if(func_441(&iVar0)){
if(func_440(&(Local_249[iVar0 /*15*/]), 151.2f, -962.3f, 30.1f, 213.2f, 1, 0, 1250, 2500)){
*iParam0=2;
}}
break;
case 2:
...
if(func_425(&iVar0)){
if(func_419(&(Local_248[iVar0 /*19*/]), 181.1f, -951.9f, 30.1f, 0, 0, 0)){
}}
if(func_425(&iVar0)){
if(func_419(&(Local_248[iVar0 /*19*/]), 173f, -956.9f, 30.1f, 0, 0, 0)){
Local_248[iVar0 /*19*/].f_11=0;
}}
if(func_425(&iVar0)){
if(func_419(&(Local_248[iVar0 /*19*/]), 174.7f, -948.1f, 30.1f, 0, 0, 0)){
Local_248[iVar0 /*19*/].f_11=0;
}}
func_429(0, 5, 5, 1);
iLocal_118=1;
...
*iParam0=1;
iLocal_281=5;
func_463(&Local_92, 0, 1);
func_452(&Local_92, 1, 1, 0);
func_451();
func_323(0, "Mission Start", 0, 0, 0, 1);
break;
case 1:
HUD::CLEAR_PRINTS();
func_450(PLAYER::PLAYER_PED_ID(), -1);
if(!AUDIO::IS_AUDIO_SCENE_ACTIVE(sLocal_246)){
AUDIO::START_AUDIO_SCENE(sLocal_246);
}
PED::CLEAR_PED_BLOOD_DAMAGE(PLAYER::PLAYER_PED_ID());
AUDIO::SET_AMBIENT_ZONE_STATE(sLocal_498, 1, 0);
func_449();
func_464();
func_307(500, 0);
*iParam0=2;
...
void func_449(){
func_25(&uLocal_333, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
iLocal_307=MISC::GET_RANDOM_INT_IN_RANGE(20000, 30000);
iLocal_306=MISC::GET_RANDOM_INT_IN_RANGE(10000, 20000);
bLocal_304=false;
}
...
if(!iLocal_507){
if(iLocal_521==9 && MISC::GET_GAME_TIMER() > iLocal_305){
func_25(&uLocal_333, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
if((func_471(&(Local_248[iLocal_504 /*19*/]), "clown_idle_0", 0) && func_471(&(Local_248[iLocal_505 /*19*/]), "clown_idle_6", 0.1f)) && func_471(&(Local_248[iLocal_506 /*19*/]), "clown_idle_3", 0.1f)){
iLocal_521=1;
}
break;
case 1:
if(!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_248[iLocal_506 /*19*/].f_3)){
func_469(Local_248[iLocal_506 /*19*/].f_3, "CLOWN_LAUGH", "CLOWNS", 10);
}
if(CAM::DOES_CAM_EXIST(uLocal_508)){
if(CAM::IS_CAM_ACTIVE(uLocal_508)){
func_468(PLAYER::PLAYER_PED_ID(), 187.789f, -959.6204f, 29.00801f, 85f, 0, 1);
func_426(&uLocal_522);
iLocal_521=6;
}}
break;
...
func_467(&(Local_248[iLocal_505 /*19*/]));
func_467(&(Local_248[iLocal_506 /*19*/]));
if(func_465(&(Local_248[iLocal_504 /*19*/]))){
iLocal_305=MISC::GET_GAME_TIMER() + 1500;
iLocal_521=9;
}
break;
case 9:
func_465(&(Local_248[iLocal_504 /*19*/]));
func_465(&(Local_248[iLocal_505 /*19*/]));
func_465(&(Local_248[iLocal_506 /*19*/]));
if(iLocal_287==0){
iLocal_521=10;
return 1;
}
...
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_3, sLocal_245, &(uParam0->f_7), 3)){
uParam0->f_11=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_301, iLocal_302));
uParam0->f_2=12;
...
if(func_63(PLAYER::PLAYER_PED_ID())){
if(!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_253, 0)){
WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), iLocal_253, -1, 1, 1);
}elseif(!WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iVar0, 1) || iVar0 !=iLocal_253){
WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_253, 1);
}
WEAPON::ADD_AMMO_TO_PED(PLAYER::PLAYER_PED_ID(), iLocal_253, 10000);
WEAPON::SET_PED_INFINITE_AMMO(PLAYER::PLAYER_PED_ID(), 1, iLocal_253);
WEAPON::SET_PED_CURRENT_WEAPON_VISIBLE(PLAYER::PLAYER_PED_ID(), 1, 1, 1, 0);
PED::SET_PED_CAN_SWITCH_WEAPON(PLAYER::PLAYER_PED_ID(), 0);
if(WEAPON::DOES_WEAPON_TAKE_WEAPON_COMPONENT(iLocal_253, joaat("component_assaultshotgun_clip_02"))){
WEAPON::GIVE_WEAPON_COMPONENT_TO_PED(PLAYER::PLAYER_PED_ID(), iLocal_253, joaat("component_assaultshotgun_clip_02"));
}
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(uParam0, sParam1, sParam2, func_470(iParam3), 0);
}
...
int func_471(var uParam0, char* sParam1, int iParam2){
if(uParam0->f_2==0){
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_3, sLocal_245, sParam1, 3)){
StringCopy(&(uParam0->f_7), sParam1, 16);
TASK::TASK_PLAY_ANIM(uParam0->f_3, sLocal_245, &(uParam0->f_7), 8f, -1f, -1, 0, iParam2, 0, 0, 0);
}else{
return 1;
}}
return 0;
...
int iVar0;
if(func_425(&iVar0)){
if(func_419(&(Local_248[iVar0 /*19*/]), 163.9249f, -956.996f, 29.09192f, 262.4564f, 1, 0)){
iLocal_504=iVar0;
func_422(&(Local_248[iLocal_504 /*19*/]), 1);
}}
if(func_425(&iVar0)){
func_419(&(Local_248[iVar0 /*19*/]), 166.4477f, -955.0585f, 29.09192f, 263.4564f, 0, 0);
iLocal_505=iVar0;
func_422(&(Local_248[iLocal_505 /*19*/]), 1);
}
if(func_425(&iVar0)){
func_419(&(Local_248[iVar0 /*19*/]), 168.952f, -960.7564f, 29.07847f, 265.4564f, 0, 0);
iLocal_506=iVar0;
func_422(&(Local_248[iLocal_506 /*19*/]), 1);
}}
...
func_475(uParam0, uParam0->f_115);
uParam0->f_115++;
}
...
if(func_63(Local_92.f_28[0])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_28[0], sLocal_237, 0, 0, 0);
}else{
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_28[0], sLocal_237, 2, func_659(49), 0);
}
if(func_63(Local_92.f_41[0])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[0], sLocal_239, 0, 0, 0);
}else{
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[0], sLocal_239, 2, joaat("prop_protest_table_01"), 0);
}
if(func_63(Local_92.f_41[1])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[1], sLocal_238, 0, 0, 0);
}else{
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_41[1], sLocal_238, 2, joaat("prop_chair_08"), 0);
}
if(func_63(Local_92.f_41[2])){
ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(Local_92.f_41[2]));
func_534(sLocal_240);
}
if(func_63(PLAYER::PLAYER_PED_ID())){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Trevor", 0, 0, 0);
}
uLocal_508=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 188.1366f, -957.7827f, 30.6514f, -5.5067f, -8f, 92.8053f, 40f, 0, 2);
func_533();
CUTSCENE::START_CUTSCENE(0);
RECORDING::REPLAY_START_EVENT(1);
...
case 2:
if(!CUTSCENE::IS_CUTSCENE_PLAYING()){
MISC::SET_TIME_SCALE(fLocal_107);
...
func_486(0.1f, 0.1f, "NUMBER", iVar0, 0);
}
if(func_473(&uLocal_119)){
if(!iLocal_499){
...
RECORDING::REPLAY_STOP_EVENT();
if(CAM::DOES_CAM_EXIST(uLocal_508)){
CAM::SET_CAM_ACTIVE(uLocal_508, 1);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
CAM::SHAKE_CAM(uLocal_508, "DRUNK_SHAKE", 1065353216);
}}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Trevor", 0)){
}}
break;
...
void func_486(float fParam0, float fParam1, char* sParam2, var uParam3, int iParam4){
...
void func_487(){
func_492(&uLocal_119, 0, 4, "SCRIPT\BARRY_02_CLOWN_A", 0);
func_492(&uLocal_119, 1, 4, "SCRIPT\BARRY_02_CLOWN_B", 0);
func_492(&uLocal_119, 2, 4, "SCRIPT\BARRY_02_CLOWN_C", 0);
func_491(&uLocal_119, 3, iLocal_250);
func_491(&uLocal_119, 4, iLocal_251);
func_490(&uLocal_119, 5, "BARY2", 0);
func_492(&uLocal_119, 6, 2, sLocal_244, 0);
func_488(&uLocal_119, 7);
func_492(&uLocal_119, 8, 2, sLocal_245, 0);
func_491(&uLocal_119, 9, iLocal_509);
func_491(&uLocal_119, 10, iLocal_510);
func_492(&uLocal_119, 11, 2, sLocal_513, 0);
func_492(&uLocal_119, 12, 2, sLocal_515, 0);
func_492(&uLocal_119, 13, 2, sLocal_517, 0);
func_491(&uLocal_119, 14, iLocal_252);
}
...
int func_490(var uParam0, int iParam1, char* sParam2, int iParam3){
if(MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1)){
return 1;
}
func_489(uParam0[iParam1 /*7*/]);
...
int func_492(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4){
if(MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1)){
return 1;
}
...
void func_494(){
int iVar0;
if(!func_63(PLAYER::GET_PLAYERS_LAST_VEHICLE())){
return;
}
...
fLocal_102=206.45f;
func_526(Local_111[0 /*3*/], Local_111[1 /*3*/], Local_111.f_7, Local_101, fLocal_102, 0f, 0f, 0f, 1, 0, 1, 0, 0);
func_498(Local_101, fLocal_102, 0, 145);
}else{
func_526(Local_111[0 /*3*/], Local_111[1 /*3*/], Local_111.f_7, Local_101, fLocal_102, func_497(), 1, 0, 1, 0, 0);
if(func_495(0f, 0f, 0f, 1)){
func_498(Local_101, fLocal_102, 0, 145);
}}}


bool func_495(struct<3> Param0, int iParam1){
return func_496(Global_104373.f_2890.f_12.f_66, Param0, iParam1);
}

int func_496(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
struct<3> Var1;
if(iParam0==0){
return 0;
...
void func_498(struct<3> Param0, float fParam1, int iParam2, int iParam3){
struct<3> Var0;
var uVar1;
if(ENTITY::DOES_ENTITY_EXIST(Global_104373.f_4)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_104373.f_4, 0)){
if(func_525(24) !=Global_104373.f_4){
if(iParam2==1){
if(func_522(ENTITY::GET_ENTITY_COORDS(Global_104373.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
}}
func_499(Global_104373.f_4, Param0, fParam1, 24, 0);
}}}}


void func_499(int iParam0, struct<3> Param1, var uParam2, int iParam3, bool bParam4){
struct<60> Var0;
if(ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)){
...
func_518(iParam3, &Var0, Param1, uParam2, func_332(iParam0));
func_500(iParam3, iParam0, 0);
}}
...
if(!func_517(&(Global_77479.f_555[0 /*21*/]), iParam0)){
return;
}
...
if(iParam0==24){
Global_113810.f_32752.f_4801=func_382();
}
...
func_336(iParam0, &(Global_113810.f_32752.f_5510));
}

int func_502(int iParam0){
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_341(iParam0, 0, 0)) || func_341(iParam0, 1, 0)) || func_341(iParam0, 2, 0)) || func_332(iParam0) !=145) || func_516(iParam0)) || func_515(iParam0)) || func_514(iParam0)) || func_513(iParam0)) || !func_503(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_515(iParam0)){
}
if(func_515(iParam0)){
}
...
if((((!func_512() && !func_511()) && !func_510()) && !func_509()) && !func_289()){
return 0;
}}
...
if(!func_69(Global_113810.f_32752.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
if(!func_69(Global_113810.f_2366.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
if(!func_69(Global_113810.f_2366.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0)){
*uParam0={
...
void func_518(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_517(&(Global_77479.f_555[0 /*21*/]), iParam0)){
if(MISC::IS_BIT_SET(Global_77479.f_555[0 /*21*/].f_9, 10)){
func_520(iParam0);
func_519(uParam1, &(Global_113810.f_32752.f_69[Global_77479.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_522(struct<3> Param0, int iParam1, var uParam2, var uParam3){
int iVar0;
iVar0=func_523(Param0, iParam1, 1);
switch (iVar0){
case 0:
*uParam2={
...
int func_523(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
void func_526(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
func_527(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}
...
if(func_528(iVar0, Param0, Param1, fParam2)){
bVar1=true;
}}}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
...
int func_528(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
if(((((((((((((((func_529(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_529(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_529(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_529(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_529(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_529(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_529(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_529(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_529(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_529(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_529(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_529(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_529(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_529(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_529(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_529(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4)){
return 1;
}}
return 0;
}

int func_529(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
Vector3 func__530(struct<3> Param0){
float fVar0;
float fVar1;
fVar0=vmag(Param0);
if(fVar0 !=0f){
...
case 0:
func_487();
func_536(sLocal_245, 0);
*iParam0=1;
if(func_63(Local_92.f_28[0])){
if(CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(0)==4){
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_92.f_28[0], 0f, 0f, 0.3f, 1, -1, 3000, 2000, 0);
CAM::SET_GAMEPLAY_HINT_CAMERA_RELATIVE_SIDE_OFFSET(0f);
}else{
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_92.f_28[0], 0.6f, 0f, 0.3f, 1, -1, 3000, 2000, 0);
...
if(func_63(PLAYER::PLAYER_PED_ID())){
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_92.f_28[0], -1, 0, 2);
}}
break;
case 1:
if(STREAMING::HAS_ANIM_DICT_LOADED(sLocal_245) && !func_29()){
uVar0=16;
...
TASK::TASK_PLAY_ANIM(Local_92.f_28[0], sLocal_245, "lead_in", 8f, -4f, -1, 2, 0, 0, 0, 0);
TASK::TASK_LOOK_AT_ENTITY(Local_92.f_28[0], PLAYER::PLAYER_PED_ID(), -1, 2048, 4);
*iParam0=2;
iLocal_296=MISC::GET_GAME_TIMER() + 30000;
}}
break;
case 2:
if(func_63(Local_92.f_28[0])){
if(!func_29() || MISC::GET_GAME_TIMER() > iLocal_296){
if(func_63(PLAYER::PLAYER_PED_ID())){
...
int func_536(char* sParam0, int iParam1){
int iVar0;
...
if(func_63(Local_92.f_28[0])){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_92.f_28[0], 0);
}}}}}
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_319(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
if(MISC::GET_GAME_TIMER() < iLocal_275){
return;
}
if(!func_425(&iVar0)){
return;
...
if(iLocal_291){
Var1={
func_544(Local_292, fLocal_289, 2f) 
};
}else{
Var1={
func_544(Local_103, fLocal_289, 2f) 
};
}
if(!func_541(&Var1)){
return;
}
if(func_419(&(Local_248[iVar0 /*19*/]), Var1, 0, 0, 0)){
if(iLocal_95==9){
iLocal_275=MISC::GET_GAME_TIMER() + 25;
iLocal_533++;
}else{
iLocal_275=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_276, iLocal_277));
}}}
...
if(!MISC::GET_GROUND_Z_FOR_3D_COORD(Var0, &uVar1, 0, 0)){
return 0;
}
Var0.f_2=uVar1;
if(iLocal_95 !=9){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(Var0, Local_103, 1) > fLocal_104){
return 0;
}}
if(func_543(PLAYER::PLAYER_PED_ID(), Var0, 1) < fLocal_280){
return 0;
}
if(bLocal_297){
if(func_542(Var0, fVar2, PLAYER::PLAYER_PED_ID(), 1)){
return 0;
}}elseif(PED::IS_ANY_PED_NEAR_POINT(Var0, fVar2)){
return 0;
}
if(iLocal_95==9){
Var3={
...
bool func_542(struct<3> Param0, float fParam1, var uParam2, int iParam3){
return MISC::IS_POSITION_OCCUPIED(Param0, fParam1, 0, 0, 1, 0, 0, uParam2, iParam3);
}


float func_543(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
if(!ENTITY::IS_ENTITY_DEAD(uParam0, 0)){
Var0={
ENTITY::GET_ENTITY_COORDS(iParam0, 1) 
...
Vector3 func__544(struct<3> Param0, float fParam1, float fParam2){
struct<3> Var0;
float fVar1;
Var0={
...
fVar1=(fParam2 / 2f);
Var0={
func_545(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam1)) 
};
...
Vector3 func__545(struct<3> Param0, float fParam1){
float fVar0;
if(fParam1==0f){
return 0f, 0f, 0f;
}
...
iVar0=0;
while (iVar0 < Local_249.f_0){
if(func_547(&(Local_249[iVar0 /*15*/]))){
iLocal_288++;
}
iVar0++;
}}
...
if(uParam0->f_9==0){
if(func_557(uParam0->f_3, PLAYER::PLAYER_PED_ID(), 1) < fLocal_286 || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_3, PLAYER::PLAYER_PED_ID(), 1)){
uParam0->f_6=(MISC::GET_GAME_TIMER() + iVar4);
uParam0->f_9=1;
}}
if(bLocal_115){
if(uParam0->f_9==0){
func_556(ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1), fLocal_286, 255, 0, 0, 255, 32);
}else{
func_556(ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1), fLocal_286, 0, 0, 255, 255, 32);
}}
switch (uParam0->f_2){
case 1:
...
uParam0->f_2=2;
uParam0->f_5=0f;
func_555(uParam0->f_3, floor(uParam0->f_5), &iLocal_116);
...
ENTITY::RESET_ENTITY_ALPHA(uParam0->f_3);
func_35(&(uParam0->f_4));
uParam0->f_4=func_554(uParam0->f_3, 0, 5);
uParam0->f_2=12;
VEHICLE::START_VEHICLE_HORN(uParam0->f_3, 4000, 0, 0);
VEHICLE::SET_VEHICLE_ENGINE_ON(uParam0->f_3, 1, 1, 0);
VEHICLE::SET_VEHICLE_FORWARD_SPEED(uParam0->f_3, fLocal_303);
uParam0->f_6=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_278, iLocal_279));
if(uParam0->f_13 !=0){
uParam0->f_2=10;
}}
break;
...
if(func_425(&iVar0)){
uParam0->f_14=iVar0;
if(func_552(&(Local_248[uParam0->f_14 /*19*/]), uParam0->f_3, 1)){
Local_248[uParam0->f_14 /*19*/].f_2=0;
func_35(&(Local_248[uParam0->f_14 /*19*/].f_4));
TASK::CLEAR_PED_TASKS(Local_248[uParam0->f_14 /*19*/].f_3);
...
TASK::TASK_PERFORM_SEQUENCE(Local_248[uParam0->f_14 /*19*/].f_3, uVar2);
...
if(TASK::GET_SCRIPT_TASK_STATUS(Local_248[uParam0->f_14 /*19*/].f_3, joaat("script_task_perform_sequence"))==7){
TASK::OPEN_SEQUENCE_TASK(&uVar5);
TASK::TASK_LEAVE_VEHICLE(0, uParam0->f_3, 0);
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uVar5);
TASK::TASK_PERFORM_SEQUENCE(Local_248[uParam0->f_14 /*19*/].f_3, uVar5);
TASK::CLEAR_SEQUENCE_TASK(&uVar5);
Local_248[uParam0->f_14 /*19*/].f_4=func_551(Local_248[uParam0->f_14 /*19*/].f_3, 1, 0, 5);
...
if(MISC::GET_GAME_TIMER() > iLocal_300 && ENTITY::IS_ENTITY_ON_SCREEN(uParam0->f_3)){
if(func_557(PLAYER::PLAYER_PED_ID(), uParam0->f_3, 1) < 50f){
func_550();
}}}
if(MISC::GET_GAME_TIMER() < uParam0->f_6){
return 1;
...
if(bLocal_115){
func_556(Var6, 1.5f, 255, 0, 0, 255, 32);
}
if(func_549(Var6, 1.5f)){
return 1;
}
if(func_425(&iVar0)){
if(func_552(&(Local_248[iVar0 /*19*/]), uParam0->f_3, 0)){
GRAPHICS::START_PARTICLE_FX_NON_LOOPED_ON_ENTITY("scr_clown_appears", uParam0->f_3, Local_293, 0f, 0f, 0f, fLocal_294, 0, 0, 0);
Local_248[iVar0 /*19*/].f_2=14;
func_422(&(Local_248[iVar0 /*19*/]), 4);
uParam0->f_8=1;
uParam0->f_10++;
uParam0->f_5=0f;
ENTITY::SET_ENTITY_VISIBLE(Local_248[iVar0 /*19*/].f_3, 0, 0);
Var6={
...
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Var6, PLAYER::PLAYER_PED_ID(), 1f, 1, 1.5f, 2f, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 20000);
TASK::CLOSE_SEQUENCE_TASK(uVar7);
TASK::TASK_PERFORM_SEQUENCE(Local_248[iVar0 /*19*/].f_3, uVar7);
TASK::CLEAR_SEQUENCE_TASK(&uVar7);
if(uParam0->f_9==0){
uParam0->f_6=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_278 * 4, iLocal_279 * 4));
}else{
uParam0->f_6=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_278 + 500, iLocal_279));
}
if(uParam0->f_10 > 5){
uParam0->f_6=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_278 * 4, iLocal_279 * 4));
uParam0->f_10=0;
...
if(iLocal_298==0){
func_548("B2_CAR_HLP", -1);
iLocal_298=1;
}
if(!iLocal_527){
iLocal_300=(MISC::GET_GAME_TIMER() + iLocal_279 + 500);
iLocal_527=1;
}}}
break;
case 15:
...
int func_549(struct<3> Param0, float fParam1){
int iVar0;
iVar0=0;
while (iVar0 < Local_248.f_0){
if(ENTITY::DOES_ENTITY_EXIST(Local_248[iVar0 /*19*/].f_3)){
if(func_543(Local_248[iVar0 /*19*/].f_3, Param0, 1) < fParam1){
return 1;
}}
iVar0++;
}
...
int func_551(var uParam0, bool bParam1, int iParam2, int iParam3){
int iVar0;
bool bVar1;
iVar0=0;
bVar1=true;
...
int func_552(var uParam0, var uParam1, int iParam2){
int iVar0;
int iVar1;
iVar1=-1;
if(iParam2==0){
...
uParam0->f_3=PED::CREATE_PED_INSIDE_VEHICLE(uParam1, 26, iLocal_250, iVar1, 1, 1);
func_35(&(uParam0->f_4));
uParam0->f_4=func_551(uParam0->f_3, 1, 0, 5);
uParam0->f_5=-1;
PED::SET_PED_COMBAT_ATTRIBUTES(uParam0->f_3, 24, false);
PED::SET_PED_RANDOM_COMPONENT_VARIATION(uParam0->f_3, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(uParam0->f_3, -2065892691);
...
uParam0->f_2=0;
func_422(uParam0, 0);
uParam0->f_11=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(round((IntToFloat(iLocal_301) * 1.5f)), iLocal_302));
PED::SET_PED_CAN_COWER_IN_COVER(uParam0->f_3, 0);
PED::SET_PED_CAN_PEEK_IN_COVER(uParam0->f_3, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(uParam0->f_3, 1, false);
PED::SET_PED_AS_ENEMY(uParam0->f_3, 1);
...
uParam0->f_13=(MISC::GET_GAME_TIMER() + (30000 + round((30000f * 0.5f))));
iLocal_282++;
return 1;
}
...
void func_556(struct<3> Param0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6){
int iVar0;
float fVar1;
struct<3> Var2;
struct<3> Var3;
...
float func_557(int iParam0, int iParam1, int iParam2){
struct<3> Var0;
struct<3> Var1;
if(!ENTITY::IS_ENTITY_DEAD(uParam0, 0)){
Var0={
...
func_572("CLOWN_DEATH", "CLOWNS", ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1), 10);
uParam0->f_2=15;
uParam0->f_12=(MISC::GET_GAME_TIMER() + iVar2);
func_76(&(uParam0->f_5));
if(func_571(uParam0) !=0){
func_422(uParam0, 0);
}
if(!ENTITY::IS_ENTITY_DEAD(uParam0->f_3, 0)){
...
switch (uParam0->f_2){
case 1:
if(MISC::GET_GAME_TIMER() >=uParam0->f_12 || iLocal_95==9){
ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_3, 1);
...
if(func_421()){
func_469(uParam0->f_3, "CLOWN_LAUGH", "CLOWNS", 10);
}}
break;
case 3:
func_35(&(uParam0->f_4));
...
break;
case 12:
if(func_571(uParam0)==3){
if(func_569(uParam0->f_3, &(uParam0->f_15), 22f)){
func_404(uParam0, 1, 0);
uParam0->f_2=13;
return;
}}elseif(func_569(uParam0->f_3, &(uParam0->f_15), 12f)){
func_404(uParam0, 1, 0);
uParam0->f_2=13;
return;
}
if(func_571(uParam0)==4 && TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_3, joaat("script_task_perform_sequence")) <=1){
return;
}elseif(func_571(uParam0) !=0){
func_422(uParam0, 0);
}
if(TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_3, joaat("script_task_combat")) > 1){
if(MISC::GET_GAME_TIMER() > uParam0->f_13){
func_404(uParam0, 1, 1);
}else{
func_404(uParam0, 0, 0);
}
TASK::TASK_COMBAT_PED(uParam0->f_3, PLAYER::PLAYER_PED_ID(), 134217728, 16);
if(func_421()){
func_469(uParam0->f_3, "CLOWN_LAUGH", "CLOWNS", 10);
...
uParam0->f_11=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_301, (iLocal_302 / 2)));
}}
Var0={
ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1) 
};
...
break;
case 13:
if(!func_568(uParam0) || func_567(uParam0->f_3, uParam0->f_15) > 22f){
uParam0->f_11=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_301, iLocal_302));
uParam0->f_15=0;
uParam0->f_2=12;
}else{
...
break;
case 9:
if(MISC::ARE_STRINGS_EQUAL(&(uParam0->f_7), sLocal_518)){
sVar3=sLocal_517;
fVar4=0.802f;
fVar5=0.815f;
}else{
...
if(func_564(uParam0, sVar3, fVar4, fVar5, &iLocal_503)){
func_422(&(Local_248[iLocal_504 /*19*/]), 3);
uParam0->f_11=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_301, iLocal_302));
uParam0->f_2=12;
}
break;
...
func_563(uParam0->f_3, floor(uParam0->f_6), &iLocal_116);
}else{
ENTITY::RESET_ENTITY_ALPHA(uParam0->f_3);
}}
break;
...
int func_564(var uParam0, char* sParam1, float fParam2, float fParam3, int iParam4){
...
TASK::TASK_PLAY_ANIM(uParam0->f_3, sLocal_517, &(uParam0->f_7), 8f, -4f, -1, 0, 0.625f, 0, 0, 0);
}else{
StringCopy(&(uParam0->f_7), "clown_idle_", 16);
StringIntConCat(&(uParam0->f_7), MISC::GET_RANDOM_INT_IN_RANGE(0, 6), 16);
TASK::TASK_PLAY_ANIM(uParam0->f_3, sLocal_245, &(uParam0->f_7), 8f, -1f, -1, 0, 0, 0, 0, 0);
}}
...
if(func_557(uParam0->f_3, uParam0->f_15, 0) <=5f){
...
return func_557(uParam0, uParam1, 1);
}
...
int func_569(int iParam0, var uParam1, float fParam2){
int iVar0;
float fVar1;
float fVar2;
if(PED::IS_PED_INJURED(uParam0)){
...
if(ENTITY::DOES_ENTITY_EXIST(Local_520[iVar0 /*11*/])){
if(!ENTITY::IS_ENTITY_DEAD(Local_520[iVar0 /*11*/], 0)){
if(!PED::IS_PED_INJURED(Local_520[iVar0 /*11*/]) && !PED::IS_PED_DEAD_OR_DYING(Local_520[iVar0 /*11*/], 1)){
fVar1=func_567(iParam0, Local_520[iVar0 /*11*/]);
if(fVar1 < fVar2){
fVar2=fVar1;
...
iLocal_306=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(10000, 20000));
...
void func_572(char* sParam0, char* sParam1, struct<3> Param2, int iParam3){
AUDIO::PLAY_AMBIENT_SPEECH_FROM_POSITION_NATIVE(sParam0, sParam1, Param2, func_470(iParam3));
}
...
if(ENTITY::IS_ENTITY_DEAD(Local_520[iParam0 /*11*/], 0) || PED::IS_PED_DEAD_OR_DYING(Local_520[iParam0 /*11*/], 1)){
if(Local_520[iParam0 /*11*/].f_6 < 5){
if(WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(Local_520[iParam0 /*11*/], iLocal_253, 0)){
}
func_76(&iLocal_512);
Local_520[iParam0 /*11*/].f_8=MISC::GET_GAME_TIMER() + 500;
Local_520[iParam0 /*11*/].f_6=5;
}}
switch (Local_520[iParam0 /*11*/].f_6){
case 0:
Local_520[iParam0 /*11*/].f_9=(Local_520[iParam0 /*11*/].f_9 + (MISC::GET_FRAME_TIME() * 512f));
if(Local_520[iParam0 /*11*/].f_9 < 2f){
ENTITY::SET_ENTITY_VISIBLE(Local_520[iParam0 /*11*/], 0, 0);
}else{
ENTITY::SET_ENTITY_VISIBLE(Local_520[iParam0 /*11*/], 1, 0);
if(Local_520[iParam0 /*11*/].f_9 > 255f){
Local_520[iParam0 /*11*/].f_9=255f;
ENTITY::RESET_ENTITY_ALPHA(Local_520[iParam0 /*11*/]);
Local_520[iParam0 /*11*/].f_6=1;
}elseif(ENTITY::IS_ENTITY_ON_SCREEN(Local_520[iParam0 /*11*/])){
func_563(Local_520[iParam0 /*11*/], floor(Local_520[iParam0 /*11*/].f_9), &iLocal_511);
}else{
ENTITY::RESET_ENTITY_ALPHA(Local_520[iParam0 /*11*/]);
}}
break;
case 1:
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(Local_520[iParam0 /*11*/])){
Local_520[iParam0 /*11*/].f_6=4;
if(WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(Local_520[iParam0 /*11*/], iLocal_253, 0)){
}
func_76(&iLocal_512);
}elseif(func_577(iParam0)){
...
TASK::TASK_SMART_FLEE_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_520[iParam0 /*11*/], Var0), 200f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar1);
TASK::CLEAR_PED_TASKS(Local_520[iParam0 /*11*/]);
TASK::TASK_PERFORM_SEQUENCE(Local_520[iParam0 /*11*/], uVar1);
TASK::CLEAR_SEQUENCE_TASK(&uVar1);
Local_520[iParam0 /*11*/].f_6=3;
}}
break;
case 3:
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_520[iParam0 /*11*/], Local_108[0 /*3*/], Local_108[1 /*3*/], Local_108.f_7, 0, 1, 0)){
Local_520[iParam0 /*11*/].f_8=MISC::GET_GAME_TIMER() + 500;
Local_520[iParam0 /*11*/].f_6=4;
}
break;
case 4:
PED::EXPLODE_PED_HEAD(Local_520[iParam0 /*11*/], joaat("weapon_sniperrifle"));
PED::APPLY_DAMAGE_TO_PED(Local_520[iParam0 /*11*/], 1000, 1, 0);
Local_520[iParam0 /*11*/].f_8=MISC::GET_GAME_TIMER() + 500;
Local_520[iParam0 /*11*/].f_6=5;
break;
case 5:
if(MISC::GET_GAME_TIMER() > Local_520[iParam0 /*11*/].f_8){
if(ENTITY::IS_ENTITY_DEAD(Local_520[iParam0 /*11*/], 0) || PED::IS_PED_INJURED(Local_520[iParam0 /*11*/])){
Local_520[iParam0 /*11*/].f_8=MISC::GET_GAME_TIMER() + 500;
Local_520[iParam0 /*11*/].f_9=255f;
...
case 6:
if(MISC::GET_GAME_TIMER() > Local_520[iParam0 /*11*/].f_8){
Local_520[iParam0 /*11*/].f_9=(Local_520[iParam0 /*11*/].f_9 - (MISC::GET_FRAME_TIME() * 1024f));
if(Local_520[iParam0 /*11*/].f_9 < 0f){
Local_520[iParam0 /*11*/].f_9=0f;
}
func_563(Local_520[iParam0 /*11*/], floor(Local_520[iParam0 /*11*/].f_9), &iLocal_511);
if(Local_520[iParam0 /*11*/].f_9 <=0f || !ENTITY::IS_ENTITY_ON_SCREEN(Local_520[iParam0 /*11*/])){
Local_520[iParam0 /*11*/].f_7=0;
func_482(&(Local_520[iParam0 /*11*/]));
...
if(!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_520[iParam0 /*11*/], sLocal_515, sLocal_516, 3)){
TASK::TASK_PLAY_ANIM(Local_520[iParam0 /*11*/], sLocal_515, sLocal_516, 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.5f), 0, 0, 0);
}}elseif(!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_520[iParam0 /*11*/], sLocal_513, sLocal_514, 3)){
TASK::TASK_PLAY_ANIM(Local_520[iParam0 /*11*/], sLocal_513, sLocal_514, 8f, -8f, -1, 1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.5f), 0, 0, 0);
}}
...
Var0={
ENTITY::GET_ENTITY_COORDS(Local_520[iParam0 /*11*/], 0) 
};
if(Local_520[iParam0 /*11*/].f_10){
return 1;
}
...
if(iVar1 !=iParam0){
if(ENTITY::DOES_ENTITY_EXIST(Local_520[iVar1 /*11*/])){
if(PED::IS_PED_DEAD_OR_DYING(Local_520[iVar1 /*11*/], 1) || PED::IS_PED_INJURED(Local_520[iVar1 /*11*/])){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(Var0, ENTITY::GET_ENTITY_COORDS(Local_520[iVar1 /*11*/], 0), 0) < 20f){
return 1;
}}}}
iVar1++;
}
...
void func_585(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_587(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
struct<2> func_587(int iParam0, int iParam1, int iParam2){
struct<2> Var0;
int iVar1;
StringCopy(&Var0, "", 8);
switch (iParam1){
...
break;
default:
StringCopy(&Var0, func_588(iVar1), 8);
break;
}
break;
default:
...
int func_596(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6){
if(((!func_598(0) || Global_78960) || Global_78948==1) || !CAM::IS_SCREEN_FADED_IN()){
return 0;
}
switch (Global_78944){
case 0:
...
break;
case 5:
if((CUTSCENE::IS_CUTSCENE_PLAYING() || func_582(0)) || func_597(1)){
}else{
return 1;
}
break;
...
return func_600(iParam0, Global_43377);
}
...
void func_603(struct<3> Param0, float fParam1, var uParam2, var uParam3){
struct<3> Var0;
Var0={
...
int iVar0;
func_487();
func_636(&Local_109, 226.2213f, -848.2081f, 25.42136f, 163.9146f, -1012.38f, 54.88147f, 131.75f);
Local_110={
func_635(Local_109, -10f) 
};
Local_108={
func_635(Local_109, 20f) 
};
func_636(&Local_111, 168.85f, -1001.024f, 23.09129f, 225.9042f, -862.5969f, 34.09233f, 55f);
...
uLocal_500=PED::GET_PED_ARMOUR(PLAYER::PLAYER_PED_ID());
}
func_630(0);
func_628(1);
...
switch (iVar0){
case 0:
func_611(Local_105, fLocal_106, 0, 0);
func_606(1);
if(!GRAPHICS::ANIMPOSTFX_IS_RUNNING(sLocal_242)){
GRAPHICS::ANIMPOSTFX_PLAY(sLocal_242, 0, 1);
}
break;
case 1:
func_611(188.932f, -952.0983f, 29.0923f, 325.7944f, 0, 0);
func_449();
func_606(6);
func_36("B2_PRIME", 7500, 1);
if(!GRAPHICS::ANIMPOSTFX_IS_RUNNING(sLocal_242)){
...
break;
case 3:
func_299(PLAYER::PLAYER_PED_ID(), 179.1285f, -961.58f, 29.0923f);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), 143.3596f);
iLocal_99=4;
break;
case 4:
func_299(PLAYER::PLAYER_PED_ID(), 176.0677f, -976.4255f, 29.0923f);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), 324.8268f);
iLocal_99=5;
break;
case 5:
func_299(PLAYER::PLAYER_PED_ID(), 188.0644f, -948.7751f, 29.0923f);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), 329.9782f);
iLocal_99=6;
break;
case 6:
if(!func_609()){
func_299(PLAYER::PLAYER_PED_ID(), 188.932f, -952.0983f, 29.0923f);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), 325.7944f);
}
iLocal_99=7;
break;
case 7:
func_299(PLAYER::PLAYER_PED_ID(), 213.3817f, -919.8522f, 29.6929f);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), 323.943f);
iLocal_99=8;
break;
case 8:
func_299(PLAYER::PLAYER_PED_ID(), 209.8298f, -912.4507f, 29.6921f);
...
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
GRAPHICS::ANIMPOSTFX_PLAY(sLocal_241, 0, 1);
}
...
func_621(&(uParam0->f_48), "rcm_barry2", "lead_in_loop", "lead_in_loop");
iLocal_78=1;
break;
case 1:
if(!func_620(&iVar0) || !func_618(&(uParam0->f_48))){
return 0;
}
iLocal_78=2;
break;
...
if(func_615(&(uParam0->f_28[0]), 49, Var1, fVar2, "RC LAUNCHER:
BARRY 2", 1)){
...
func_298(&(uParam0->f_41[0]), iVar0[1], 189.5964f, -956.0344f, 29.09179f, func_614(-2.01f));
if(func_63(uParam0->f_41[0])){
ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[0], 1);
func_298(&(uParam0->f_41[2]), iVar0[3], 189.7901f, -956.1675f, 29.8229f, func_614(-2.01f));
...
ENTITY::SET_ENTITY_COORDS(uParam0->f_28[0], Var1, 1, 0, 0, 1);
...
float func_614(float fParam0){
return (fParam0 * 57.29578f);
}

int func_615(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_616(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
int func_616(var uParam0, int iParam1, struct<3> Param2, int iParam3, bool bParam4){
int iVar0;
if(!func_16(iParam1)){
...
void func_621(var uParam0, char* sParam1, char* sParam2, char* sParam3){
*uParam0=sParam1;
uParam0->f_1=sParam2;
uParam0->f_2=sParam3;
STREAMING::REQUEST_ANIM_DICT(*uParam0);
...
if(bParam1){
if(!func_357(iParam0, 2, 1)){
func_634(iParam0, 2, 1);
}}elseif(func_357(iParam0, 2, 1)){
...
if(func_88()==0){
uVar0=func_151(func_358(iParam0), -1);
MISC::CLEAR_BIT(&uVar0, bParam1);
func_148(func_358(iParam0), uVar0, -1, 1);
}}else{
...
struct<8> func_635(struct<8> Param0, float fParam1){
struct<8> Var0;
struct<3> Var1;
Var0=2;
Var1={
func_530(Param0[1 /*3*/] - Param0[0 /*3*/]) * Vector(fParam1, fParam1, fParam1) 
};
Var0[0 /*3*/]={
Param0[0 /*3*/] - Var1 
};
...
void func_636(var uParam0, struct<3> Param1, struct<3> Param2, float fParam3){
*(uParam0[0 /*3*/])={
Param1 
};
*(uParam0[1 /*3*/])={
...
func_481();
if(func_63(PLAYER::PLAYER_PED_ID())){
PED::SET_PED_ARMOUR(PLAYER::PLAYER_PED_ID(), uLocal_500);
}
func_35(&uLocal_114);
func_73(1);
PED::CLEAR_PED_BLOOD_DAMAGE(PLAYER::PLAYER_PED_ID());
...
bVar0=false;
while (bVar0 < *uParam0){
func_640(uParam0, bVar0);
bVar0++;
}}

int func_640(var uParam0, bool bParam1){
...
if(bParam0){
func_235(iVar0, 1, 0);
func_643(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
}else{
...
void func_643(char* sParam0, int iParam1){
if(Global_100833 !=12){
if(func_644(sParam0, 6, iParam1)){
Global_100833.f_1=iParam1;
}}}

int func_644(char* sParam0, int iParam1, int iParam2){
var uVar0;
struct<32> Var1;
int iVar2;
func_96();
...
int iVar0;
int iVar1;
iVar0=func_396(&(Global_100833.f_3), 0);
iVar1=0;
if(iVar0==53){
iVar1=1;
}
...
if(func_393(&(Global_100833.f_3)) > -1){
return 1;
}}
return 0;
}
...
void func_656(char* sParam0){
if(!MISC::IS_STRING_NULL_OR_EMPTY(sParam0)){}}


void func_657(var uParam0){
func_658(&(uParam0->f_28));
func_658(&(uParam0->f_35));
func_658(&(uParam0->f_41));
}
