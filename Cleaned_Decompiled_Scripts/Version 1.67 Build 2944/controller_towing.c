...
iLocal_271=0;
func_2(&iLocal_270, iVar2, &uVar0, &iLocal_271, bVar1);
}
wait(iLocal_271);
}else{
func_1();
...
if(ENTITY::IS_ENTITY_OCCLUDED(iLocal_266)){
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("a_f_y_soucent_01"));
...
if(ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_267)){
VEHICLE::DELETE_VEHICLE(&iLocal_267);
}}else{
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("towtruck"));
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_267);
}}}
...
func_156(Global_113810.f_19976.f_3, &Var1, &uVar3, &uVar0, &uVar2);
if(Global_113810.f_19976.f_3 >=5 || uLocal_255){
func_155(iParam1, Var1, uVar3, iParam0);
func_153(iParam0, iParam1);
}
switch (*iParam0){
case 0:
uLocal_261=uLocal_261;
...
func_124();
func_122();
Local_49.f_0=iLocal_266;
Local_49.f_1=iLocal_267;
*iParam0=16;
}}
break;
case 16:
...
break;
case 17:
if(!SCRIPT::IS_THREAD_ACTIVE(iLocal_243)){
...
elseif(func_22(Global_113810.f_19976.f_1, 4096)){
iLocal_247=10000;
}
elseif(func_22(Global_113810.f_19976.f_1, 8192)){
iLocal_247=60000;
}
elseif(func_22(Global_113810.f_19976.f_1, 16384)){
iLocal_247=120000;
}
else{
iLocal_247=30000;
...
func_151(&(Global_113810.f_19976.f_1), 8192);
func_151(&(Global_113810.f_19976.f_1), 16384);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_266) && !ENTITY::IS_ENTITY_DEAD(iLocal_266, 0)){
PED::REMOVE_PED_FROM_GROUP(iLocal_266);
}
...
if(Global_100867){
bParam4=true;
if(iLocal_263==joaat("towtruck")){
STREAMING::REQUEST_MODEL(joaat("towtruck"));
}
elseif(iLocal_263==joaat("towtruck2")){
STREAMING::REQUEST_MODEL(joaat("towtruck2"));
}
else{
STREAMING::REQUEST_MODEL(joaat("towtruck"));
iLocal_263=joaat("towtruck");
}
...
iLocal_267=VEHICLE::CREATE_VEHICLE(iLocal_263, 408.8376f, -1638.952f, 28.2928f, 230.2387f, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_263);
}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(iLocal_267, 0)){
...
ENTITY::SET_ENTITY_HEADING(iLocal_267, 230.2387f);
*iParam0=16;
}}
}
else{
...
break;
case 19:
if((MISC::GET_GAME_TIMER() - *uParam2) > iLocal_247){
*uParam2=0;
*iParam0=0;
}
break;
...
void func_23(){
if(func_22(uLocal_245, 1)){
func_151(&uLocal_245, 1);
func_21(&iLocal_244);
}
if(SCRIPT::IS_THREAD_ACTIVE(iLocal_243)){
SCRIPT::TERMINATE_THREAD(iLocal_243);
}
...
var func__55(int iParam0, var uParam1){
...
if(func_77()==0){
return MISC::IS_BIT_SET(func_50(func_76(iParam0), -1), iParam1);
}}else{
...
Vector3 func__84(struct<3> Param0){
...
Var3={
func_89(Var3, -Var0.f_3.f_2) 
};
Var3={
func_89(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
return (shift_right(iParam0, 26) & 31 * func_108(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
Local_49.f_2=1;
iLocal_243=start_new_script_with_args("Towing", &Local_49, 9, 57500);
SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("Towing");
if(!ENTITY::IS_ENTITY_DEAD(iLocal_266, 0)){
PED::SET_PED_KEEP_TASK(iLocal_266, 1);
}
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_266);
STREAMING::REMOVE_ANIM_DICT("amb@world_human_smoking@male@male_a@base");
STREAMING::REMOVE_ANIM_DICT("oddjobs@towingcome_here");
func_115(&uLocal_245, 1);
return 1;
}elseif(iVar0==0){
return 2;
}}
...
case 1:
if(!func_149()){
if(!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_148(&uLocal_56)){
AUDIO::SET_FRONTEND_RADIO_ACTIVE(0);
func_146(&uLocal_56);
}elseif(!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_148(&uLocal_56)){
if(func_143(&uLocal_56) >=2f){
iLocal_68=0;
}}}
break;
case 0:
if(!func_149()){
func_142(&uLocal_78, 4, 0, "TOWDISPATCH", 0, 1);
if(func_127(&uLocal_78, "TOWAUD", "TOW_DISP_GEN", 9, 0, 0, 0)){
iLocal_68=2;
}}
break;
case 2:
...
return (func_144(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return uParam0->f_1;
}
...
uParam0->f_1=(func_144(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
...
iLocal_267=iVar0;
if(ENTITY::DOES_ENTITY_EXIST(iLocal_267) && !ENTITY::IS_ENTITY_DEAD(iLocal_267, 0)){
iLocal_263=ENTITY::GET_ENTITY_MODEL(iLocal_267);
}
return 1;
}}}}
return 0;
...
func_142(&uLocal_78, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
func_142(&uLocal_78, 4, 0, "TOWDISPATCH", 0, 1);
if(func_127(&uLocal_78, "TOWAUD", "TOW_JOBS_AVL", 4, 0, 0, 0)){
if(!func_148(&uLocal_65)){
func_154(&uLocal_65);
}
else{
func_146(&uLocal_65);
...
if(iLocal_262){
if(func_148(&uLocal_65)){
if(func_143(&uLocal_65) > 4f){
if(func_127(&uLocal_78, "TOWAUD", "TOW_NO_JOBS", 4, 0, 0, 0)){
iLocal_262=0;
}}}}}
...
void func_155(int iParam0, struct<3> Param1, float fParam2, var uParam3){
float fVar0;
var uVar1;
int iVar2;
fVar0=vdist2(Param1, ENTITY::GET_ENTITY_COORDS(uParam0, 1));
switch (iLocal_69){
case 0:
...
if(!CAM::IS_SPHERE_VISIBLE(Local_252, fLocal_253) || func_22(Global_113810.f_19976.f_1, 1073741824)){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_267)){
iLocal_267=VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Param1, uParam2, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("towtruck"));
iLocal_69=3;
}}}
break;
case 3:
if(PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0)){
if(PED::GET_VEHICLE_PED_IS_IN(iParam0, 0)==iLocal_267){
iLocal_69=0;
}}
if(ENTITY::IS_ENTITY_DEAD(iLocal_267, 0)){
iLocal_69=0;
}
if(fVar0 > 62500f){
VEHICLE::DELETE_VEHICLE(&iLocal_267);
