...
start_new_script_with_name_hash_and_args(-43879923, &ScriptParam_28, 4, 1424);
}
...
start_new_script_with_name_hash_and_args(1179280373, &ScriptParam_28, 4, 1424);
}
SCRIPT::TERMINATE_THIS_THREAD();
}
...
HUD::SET_SAVEGAME_LIST_UNIQUE_ID(ScriptParam_28.f_3);
}
break;
case 154:
...
return 0;
}elseif(Global_113810.f_10019.f_21 > 0){
return 1;
}
return 0;
}
...
if(func_18()==0){
return MISC::IS_BIT_SET(func_13(func_17(iParam0), -1), iParam1);
}}else{
...
switch (Global_78939){
case 1:
Global_78940=func_37(&Local_27, 1, 0, 1);
break;
case 7:
Global_78940=func_37(&Local_27, 0, 1, 1);
break;
default:
break;
}}
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(ceil(fVar0));
if(iParam6==0){
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("PM_RP_STATD");
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(sParam4);
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_56(iParam5));
