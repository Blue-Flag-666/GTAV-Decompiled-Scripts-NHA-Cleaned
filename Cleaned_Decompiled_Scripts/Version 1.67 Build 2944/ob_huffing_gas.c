...
if(ENTITY::DOES_ENTITY_EXIST(uScriptParam_296)){
iLocal_39=iScriptParam_296;
...
if(iLocal_286){
if(!iLocal_288){
iLocal_289=MISC::GET_GAME_TIMER() + 50;
iLocal_288=1;
}elseif(MISC::GET_GAME_TIMER() > iLocal_289){
if(fLocal_290 < fVar1){
fLocal_290=(fLocal_290 + 0.003f);
if(fLocal_290 > 1f){
fLocal_290=1f;
iLocal_293=1;
}
MISC::SET_TIME_SCALE(fLocal_290);
}
if(fLocal_291 > fVar0){
fLocal_291=(fLocal_291 - 0.02f);
if(fLocal_291 < 0f){
fLocal_291=0f;
iLocal_294=1;
}
if(func_2(uLocal_278)){
CAM::SET_CAM_MOTION_BLUR_STRENGTH(uLocal_278, fLocal_291);
}}
if(fLocal_292 > fVar2){
...
GRAPHICS::SET_TIMECYCLE_MODIFIER_STRENGTH(fLocal_292);
}
iLocal_288=0;
if((iLocal_293 && iLocal_294) && iLocal_295){
iLocal_286=0;
}}}}
...
if(fLocal_290 > fVar1){
fLocal_290=(fLocal_290 - 0.004f);
MISC::SET_TIME_SCALE(fLocal_290);
}
if(fLocal_291 < fVar0){
fLocal_291=(fLocal_291 + 0.075f);
if(func_2(uLocal_278)){
CAM::SET_CAM_MOTION_BLUR_STRENGTH(uLocal_278, fLocal_291);
}}
if(fLocal_292 < fVar2){
...
switch (iLocal_275){
case 0:
if((func_65(Var0, Var1) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) >=(func_64() - 90f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) <=(func_64() + 90f)){
func_63();
...
if(func_60(1, 0, 1)){
if((((func_65(Var0, Var1) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) >=(func_64() - 90f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) <=(func_64() + 90f)) && Var2.f_2 > 33f) && !PED::IS_PED_JUMPING(PLAYER::PLAYER_PED_ID())){
...
uLocal_279=PED::CREATE_SYNCHRONIZED_SCENE(func_47(), func_46(), 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_279, func_76(), func_45(0), 1000f, -8f, 0, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_39, uLocal_279, func_44(0), func_76(), 1000f, -8f, 0, 1148846080);
if(!PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_279)){
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_279, 1);
}
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() !=4){
uLocal_278=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_278, uLocal_279, func_41(0), func_76());
...
HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
PAD::DISABLE_CONTROL_ACTION(0, 0, 1);
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_279) > 0.95f){
iLocal_275=4;
}elseif(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_279) > 0.35f){
if(!iLocal_277){
...
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_279)){
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_279, 1f);
}
if(CAM::DOES_CAM_EXIST(uLocal_278)){
CAM::DESTROY_CAM(uLocal_278, 0);
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
}
iLocal_280=MISC::GET_RANDOM_INT_IN_RANGE(0, 6);
switch (iLocal_280){
case 0:
Local_284={
...
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_284, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), fLocal_285);
CLOCK::ADD_TO_CLOCK_TIME(6, 0, 0);
func_33(to_float(6));
func_32(Local_284, 10f, 13);
iLocal_275=5;
}
break;
case 5:
...
fLocal_292=1f;
if(func_31()){
sLocal_282="ig_8_wake_up_front_player";
sLocal_283="ig_8_wake_up_front_cam";
}else{
sLocal_282="ig_8_wake_up_right_player";
sLocal_283="ig_8_wake_up_right_cam";
}
Var3={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
...
uLocal_279=PED::CREATE_SYNCHRONIZED_SCENE(Var3.f_0, Var3.f_1, Var3.f_2, 0f, 0f, fLocal_285, 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_279, func_76(), sLocal_282, 1000f, -4f, 0, 0, 1148846080, 0);
if(PED::IS_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_279)){
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_279, 0);
}
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() !=4){
uLocal_278=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_278, uLocal_279, sLocal_283, func_76());
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
}else{
CAM::DESTROY_ALL_CAMS(0);
}}else{
...
if(STATS::STAT_GET_INT(joaat("num_sh_gas_huffed"), &iLocal_281, -1)){
STATS::STAT_SET_INT(joaat("num_sh_gas_huffed"), iLocal_281 + 1, 1);
}
iLocal_277=0;
...
void func_32(struct<3> Param0, float fParam1, int iParam2){
var uVar0;
int iVar1;
...
fVar2=MISC::GET_DISTANCE_BETWEEN_COORDS(Var1, Local_271[0 /*3*/], 1);
fVar3=MISC::GET_DISTANCE_BETWEEN_COORDS(Var1, Local_271[1 /*3*/], 1);
if(fVar2 < fVar3){
...
int func_65(struct<3> Param0, float fParam1, var uParam2, var uParam3){
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
...
if(func_66(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Param0, fParam1, 0)){
return 1;
}}}}}
return 0;
}
...
int func_71(){
if(AUDIO::REQUEST_AMBIENT_AUDIO_BANK(func_72(), 0, -1)){
return 1;
}
return 0;
}
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_39, 0) && Var0.f_2 > 33f){
return 1;
}}
return 0;
}
...
iVar4=(iParam1 - func_84(iParam0, func_81(iParam2)));
if(iVar4 < 0){
return -1;
}
...
if(iVar4 !=-1){
return (func_84(iParam0, func_81(iParam2)) + iVar4);
}}
return -99;
}
...
if(func_66(ENTITY::GET_ENTITY_COORDS(iLocal_39, 0), func_70(), 5f, 0)){
return 1;
}}elseif(iLocal_38==joaat("p_w_grass_gls_s")){
if(func_66(ENTITY::GET_ENTITY_COORDS(iLocal_39, 0), func_70(), 5f, 0)){
return 1;
}}elseif(iLocal_38==joaat("prop_mr_raspberry_01")){
if(func_66(ENTITY::GET_ENTITY_COORDS(iLocal_39, 0), func_70(), 5f, 0)){
return 1;
...
if(CAM::DOES_CAM_EXIST(uLocal_278)){
CAM::SET_CAM_MOTION_BLUR_STRENGTH(uLocal_278, 0f);
CAM::DESTROY_CAM(uLocal_278, 0);
}
func_104();
