...
iLocal_940=PLAYER::PLAYER_PED_ID();
...
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_1077, 1);
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_1078, 1);
CAM::INVALIDATE_IDLE_CAM();
if(func_546()){
bLocal_328=true;
iLocal_1031=func_540();
if(Global_94990){
if(iLocal_1031 <=1){
iLocal_1031++;
}}
...
if(func_470()){
func_469();
}}elseif(!PED::IS_PED_INJURED(iLocal_940)){
func_462();
if(iLocal_933 < 10){
Local_318.f_6=1;
}else{
...
func_55(&uLocal_1104);
}elseif(iLocal_933 < 8 || func_52(&uLocal_1104) > 5f){
if(iLocal_939==1){
func_37(1);
}elseif(iLocal_939==5){
func_37(5);
...
func_37(2);
}}elseif(func_52(&uLocal_1104) > 2.5f){
if(!iLocal_997){
if(!bLocal_1016){
...
if(!PED::IS_PED_INJURED(iLocal_945)){
TASK::CLEAR_PED_TASKS(iLocal_945);
if(iLocal_939==1){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1069)){
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_945, 0)){
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_945, iLocal_1069, iLocal_1069, 2f, 0, 0.5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
}
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_945) && !PED::IS_PED_INJURED(iLocal_945)){
func_34(iLocal_945, 6, "OJAvaGUARD2");
func_33(&uLocal_1114, "OJASAUD", "OJASva_CAR2", "OJASva_CAR2_1", 9, 0, 0);
}}elseif(iLocal_939==8){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1067) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_945, iLocal_1067, iLocal_1067, 2f, 0, 0.5f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
}
func_34(func_31(25f), 6, "OJAvaGUARD2");
func_33(&uLocal_1114, "OJASAUD", "OJASva_CAR3", "OJASva_CAR3_1", 9, 0, 0);
}else{
TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_945, PLAYER::PLAYER_PED_ID(), -1, 0);
func_2(iLocal_945);
}}
}
iLocal_997=1;
...
void func_1(){
int iVar0;
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_940, 0)){
iVar0=PED::GET_VEHICLE_PED_IS_IN(iLocal_940, 0);
...
if(bLocal_971){
if(VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iVar0, iLocal_1067)){
VEHICLE::DETACH_VEHICLE_FROM_TOW_TRUCK(iVar0, iLocal_1067);
}}}
...
iVar0=0;
while (iVar0 <=2){
if(!PED::IS_PED_INJURED(uLocal_943[iVar0])){
...
iVar0=0;
while (iVar0 <=1){
if(!PED::IS_PED_INJURED(uLocal_944[iVar0])){
...
while (iVar0 <=2){
if(!PED::IS_PED_INJURED(uLocal_943[iVar0])){
if(bParam1 || (!bParam1 && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_943[iVar0], 0))){
...
while (iVar0 <=1){
if(!PED::IS_PED_INJURED(uLocal_944[iVar0])){
if(bParam1 || (!bParam1 && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_944[iVar0], 0))){
...
fVar3=0f;
if(!func_42(Global_113810.f_18536[iVar0], &Var2, &fVar3)){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_941, iLocal_1067, 0)){
bVar1=true;
}}}
if(bLocal_991){
fVar0=100f;
...
if(bVar1){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
if(ENTITY::IS_ENTITY_OCCLUDED(iLocal_1067) || !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_1067)){
*iParam0=6;
return 1;
}
}}elseif(ENTITY::IS_ENTITY_OCCLUDED(iLocal_941)){
*iParam0=6;
return 1;
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_952)){
if(func_30(iLocal_940, iLocal_941, 1) >=(fVar0 * 0.5f)){
if(!HUD::IS_BLIP_FLASHING(uLocal_952)){
HUD::SET_BLIP_FLASHES(uLocal_952, 1);
}}elseif(HUD::IS_BLIP_FLASHING(uLocal_952)){
HUD::SET_BLIP_FLASHES(uLocal_952, 0);
}}}}}
return 0;
}
...
}elseif((Global_1575063 && iParam0==PLAYER::PLAYER_ID()) && func_73(iParam0, 1, 0)){
return Global_2657704[iParam0 /*463*/].f_321.f_7 !=-1;
}}
return 0;
}
...
iLocal_1035=round((*fParam1 - fVar0));
iLocal_1035 *=1000;
...
case 0:
if(!func_28()){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_943[0], 0)){
TASK::TASK_CLEAR_LOOK_AT(uLocal_943[0]);
}
if(!ENTITY::IS_ENTITY_DEAD(uLocal_943[1], 0)){
TASK::TASK_CLEAR_LOOK_AT(uLocal_943[1]);
}
iVar0=func_101();
if(bLocal_984){
if(!iLocal_1000){
...
iLocal_1000=1;
}}}elseif(!bLocal_991 && PED::IS_PED_INJURED(iLocal_941)){
if(!iLocal_1000){
func_34(iVar0, 3, "OJAvaGUARD");
...
break;
case 2:
if(iLocal_1000 || !PED::IS_PED_INJURED(iLocal_941)){
...
iLocal_998=1;
}}elseif(!bLocal_1008 && PED::IS_PED_INJURED(iLocal_941)){
iVar0=func_101();
func_100(iVar0);
}}}elseif(bLocal_984){
if(!iLocal_1000){
...
if(func_58(&uLocal_1089)){
if((func_52(&uLocal_1089) > fLocal_1050 && func_98()) || PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())){
func_3();
if(!iLocal_961){
iLocal_961=1;
iLocal_1005=1;
...
iVar0=0;
while (iVar0 < 3){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_943[iVar0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_943[iVar0], 0)){
PED::SET_PED_RESET_FLAG(uLocal_943[iVar0], 85, 1);
if(PED::CAN_PED_SEE_HATED_PED(uLocal_943[iVar0], PLAYER::PLAYER_PED_ID())){
return 1;
}}
iVar0++;
}
iVar0=0;
while (iVar0 < 2){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_944[iVar0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_944[iVar0], 0)){
PED::SET_PED_RESET_FLAG(uLocal_944[iVar0], 85, 1);
if(PED::CAN_PED_SEE_HATED_PED(uLocal_944[iVar0], PLAYER::PLAYER_PED_ID())){
return 1;
}}
iVar0++;
}
...
iVar1=0;
while (iVar1 < 3){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_943[iVar1]) && !PED::IS_PED_INJURED(uLocal_943[iVar1])){
...
iVar1=0;
while (iVar1 < 2){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_944[iVar1]) && !PED::IS_PED_INJURED(uLocal_944[iVar1])){
...
if(WEAPON::IS_PED_ARMED(iLocal_940, 4)){
if(PED::IS_PED_SHOOTING(iLocal_940)){
fVar1=func_32(PLAYER::PLAYER_PED_ID(), -1230.599f, -196.5408f, 38.1528f, 1);
WEAPON::GET_CURRENT_PED_WEAPON(iLocal_940, &iVar2, 1);
...
if((func_107(iLocal_1067) || func_106(iLocal_1067)) || (ENTITY::DOES_ENTITY_EXIST(iLocal_1067) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1067, iLocal_940, 1))){
return 1;
}
if(func_107(iLocal_1068) || (ENTITY::DOES_ENTITY_EXIST(iLocal_1068) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1068, iLocal_940, 1))){
return 1;
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1067) && !ENTITY::IS_ENTITY_DEAD(iLocal_1067, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_940, iLocal_1067, 0)){
VEHICLE::SET_VEHICLE_ALARM(iLocal_1067, 1);
VEHICLE::START_VEHICLE_ALARM(iLocal_1067);
return 1;
}}
...
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_940, 0)){
iVar0=PED::GET_VEHICLE_PED_IS_IN(iLocal_940, 0);
if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(iVar0, iLocal_1067) || (bLocal_971 && VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iVar0, iLocal_1067))){
*iParam0=4;
return 1;
}}}}
if(iLocal_933==12){
...
if(iLocal_933 < 11){
if(FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_1065, fLocal_1066)){
return 1;
}}elseif(FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_1065, fLocal_1066)){
if(func_104()){
iLocal_1015=1;
}else{
return 1;
...
if(ENTITY::DOES_ENTITY_EXIST(iParam0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)){
if(VEHICLE::GET_VEHICLE_DOOR_LOCK_STATUS(iParam0)==3 && PED::GET_VEHICLE_PED_IS_ENTERING(iLocal_940)==iParam0){
return 1;
}}}
return 0;
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
if(WEAPON::HAS_VEHICLE_GOT_PROJECTILE_ATTACHED(PLAYER::PLAYER_PED_ID(), iLocal_1067, joaat("weapon_stickybomb"), -1)){
...
iVar0=0;
while (iVar0 < 3){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_943[iVar0])){
...
iVar0=0;
while (iVar0 < 2){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_944[iVar0])){
if(iLocal_961 && !bLocal_994){
...
PED::SET_PED_RESET_FLAG(iLocal_942[iVar0], 128, 1);
}}}
iVar0++;
}
if(iLocal_1026==0){
func_147(0);
}elseif(iLocal_1026==1){
func_147(1);
}elseif(iLocal_1026==2){
if(iLocal_933 >=9){
func_136(0);
}}elseif(iLocal_1026==3){
if(iLocal_933 >=9){
func_136(1);
}}elseif(iLocal_1026==4){
if(iLocal_933 >=9){
func_136(2);
func_135(-1222.558f, -173.7471f, 38.32541f, -1220.101f, -169.0531f, 42.07541f, 4f);
}}elseif(iLocal_1026==5){
func_110(0);
func_135(-1213.432f, -191.3261f, 38.32541f, -1208.553f, -193.8618f, 42.07534f, 4f);
}elseif(iLocal_1026==6){
func_110(1);
...
if(iLocal_961){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_941, 0)){
PED::SET_PED_RESET_FLAG(iLocal_941, 120, 1);
}}}
...
if(func_134()){
if(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1068)){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1068, -1, 0)==uLocal_944[iParam0]){
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(uLocal_944[iParam0], iLocal_1068, "OJASva_104", 948, 0, 16, 18, 6f, 0, 1073741824);
}}
...
if(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1068)){
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_1068, 1) 
};
uVar2=ENTITY::GET_ENTITY_HEADING(iLocal_1068);
iLocal_974=0;
...
case 3:
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1068, 0)){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_944[iParam0], 0)){
if(PED::IS_PED_IN_VEHICLE(uLocal_944[iParam0], iLocal_1068, 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
if(!iLocal_961){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1068, -1, 0)==uLocal_944[iParam0]){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_944[iParam0], joaat("script_task_vehicle_mission")) !=1){
TASK::TASK_VEHICLE_ESCORT(uLocal_944[iParam0], iLocal_1068, iLocal_1067, -1, 45f, 786981, 10f, -1, 10f);
}}
}
elseif(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1068, -1, 0)==uLocal_944[iParam0]){
if(!iLocal_975){
if(ENTITY::IS_ENTITY_DEAD(iLocal_941, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
elseif(!bLocal_991){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_944[iParam0], joaat("script_task_combat")) !=1){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(ENTITY::GET_ENTITY_SPEED(iLocal_1068) < 5f){
iLocal_936[iParam0]=8;
}}
TASK::TASK_COMBAT_PED(iVar0, PLAYER::PLAYER_PED_ID(), 0, 16);
}
}
elseif(TASK::GET_SCRIPT_TASK_STATUS(uLocal_944[iParam0], joaat("script_task_combat")) !=1){
TASK::TASK_COMBAT_PED(iVar0, PLAYER::PLAYER_PED_ID(), 0, 16);
}}elseif(!iLocal_985){
iLocal_936[iParam0]=8;
}}}
...
case 5:
if(!func_99(iLocal_940)){
if(func_52(&uLocal_1083) >=27f || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)){
if(!PED::IS_PED_INJURED(iVar0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_940, iVar0, 5f, 5f, 3f, 0, 1, 0)){
...
case 6:
if(bLocal_986){
TASK::OPEN_SEQUENCE_TASK(&uLocal_1074);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_1074);
if(!PED::IS_PED_INJURED(uLocal_944[iParam0])){
TASK::TASK_PERFORM_SEQUENCE(uLocal_944[iParam0], uLocal_1074);
}
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1074);
}else{
TASK::OPEN_SEQUENCE_TASK(&uLocal_1074);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
...
case 7:
if(!PED::IS_PED_INJURED(uLocal_944[iParam0])){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_944[iParam0], joaat("script_task_any")) !=1){
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(uLocal_944[iParam0], iLocal_940, iLocal_940, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
}}
break;
case 8:
...
}}elseif(func_118(iVar0, iLocal_1068, &Local_318, &iLocal_323, 0, 0, 0, 1, 1) || func_117(iLocal_1068)){
...
if(PED::IS_PED_IN_VEHICLE(iVar0, iLocal_1068, 0)){
if(((!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1068, 0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)) || iLocal_973) || !bLocal_964){
if(iLocal_936[iParam0] < 8){
iLocal_936[iParam0]=8;
}}}elseif(iLocal_936[iParam0] < 8){
iLocal_936[iParam0]=8;
}}
...
if(PED::IS_PED_FACING_PED(iParam0, iLocal_940, 120f)){
if(ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iLocal_940, 17)){
...
if(!PED::IS_PED_INJURED(iParam0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_940, iParam0, 5f, 5f, 1f, 0, 1, 0)){
if(PED::IS_PED_FACING_PED(iParam0, iLocal_940, 120f)){
if(ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iLocal_940, 17)){
return 1;
}}}}}}
...
if(ENTITY::IS_ENTITY_DEAD(iLocal_1067, 0) || iLocal_1015){
bLocal_984=true;
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_941)){
if(((WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_941, joaat("weapon_sniperrifle"), 0) || WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_941, joaat("weapon_heavysniper"), 0)) || WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_941, joaat("weapon_remotesniper"), 0)) || WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(iLocal_941, joaat("weapon_marksmanrifle"), 0)){
iLocal_983=1;
iLocal_934=1;
}}
if(iLocal_323==4 || iLocal_323==8){
if(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1067)){
fParam1=(fParam1 * 2f);
iVar0=1;
}}
if(!iLocal_961){
...
var uVar0;
if(!PED::IS_PED_INJURED(iLocal_940) && !PED::IS_PED_INJURED(iParam0)){
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
...
TASK::TASK_AIM_GUN_AT_ENTITY(0, iLocal_940, -1, 0);
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_940, 0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_940, 0)){
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 3, 1);
}
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_1074);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 256);
TASK::TASK_COMBAT_PED(0, iLocal_940, 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_1074);
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
TASK::TASK_PERFORM_SEQUENCE(iParam0, uLocal_1074);
}
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1074);
}elseif(!PED::IS_PED_INJURED(iParam0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iParam0, joaat("script_task_combat")) !=1){
TASK::CLEAR_PED_TASKS(iParam0);
TASK::TASK_COMBAT_PED(iParam0, iLocal_940, 0, 16);
}}}}
...
if(!iLocal_961){
if(!PED::IS_PED_INJURED(iParam0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_940, iParam0, Param1, 0, 1, 0)){
if(PED::IS_PED_FACING_PED(iParam0, iLocal_940, 160f)){
if(ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iLocal_940, 17)){
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iParam0, iLocal_940, iLocal_940, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
iLocal_939=5;
iLocal_961=1;
}}}elseif(!PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0)){
...
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
TASK::OPEN_SEQUENCE_TASK(&uVar0);
TASK::TASK_GO_TO_ENTITY(0, iLocal_940, 20000, 2f, 1f, 1073741824, 0);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_940, -1);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(*iParam0, uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
iLocal_963=1;
...
TASK::TASK_TURN_PED_TO_FACE_ENTITY(*iParam0, iLocal_940, -1);
}}elseif(*iParam0 !=iLocal_945){
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1067, 0)){
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_1067, 1) 
};
}
...
if(!ENTITY::IS_ENTITY_DEAD(uLocal_944[iParam0], 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1068, 0)){
if(!PED::IS_PED_IN_VEHICLE(uLocal_944[iParam0], iLocal_1068, 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_944[iParam0], joaat("script_task_enter_vehicle")) !=1){
TASK::TASK_ENTER_VEHICLE(uLocal_944[iParam0], iLocal_1068, 20000, iVar0, 2f, 1, 0);
}}}}}

int func_134(){
if(!PED::IS_PED_INJURED(uLocal_944[0]) && !PED::IS_PED_INJURED(uLocal_944[1])){
if(PED::IS_PED_IN_VEHICLE(uLocal_944[0], iLocal_1068, 0) && PED::IS_PED_IN_VEHICLE(uLocal_944[1], iLocal_1068, 0)){
return 1;
}}
return 0;
}
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1074);
TASK::OPEN_SEQUENCE_TASK(&uLocal_1074);
TASK::TASK_GO_TO_COORD_ANY_MEANS(0, Local_1056[iParam0 /*3*/], 1f, 0, 0, 786603, -1082130432);
TASK::TASK_ACHIEVE_HEADING(0, fLocal_1043[iParam0], 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_1074);
TASK::TASK_PERFORM_SEQUENCE(iVar0, uLocal_1074);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1074);
...
if(ENTITY::IS_ENTITY_AT_COORD(iVar0, Local_1056[iParam0 /*3*/], 3f, 3f, 3f, 0, 1, 0)){
...
}elseif(func_52(&uLocal_1083) > uLocal_1044[iParam0] || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)){
func_130(&iVar0);
iLocal_935[iParam0]=2;
}
break;
...
break;
}elseif(func_52(&uLocal_1083) >=27f && iLocal_965){
func_129(iVar0, 15f, 15f, 3f);
}elseif(func_52(&uLocal_1083) >=15f){
func_142(iVar0);
}}else{
iLocal_989=0;
bLocal_962=true;
...
if(!PED::IS_PED_INJURED(iVar0)){
if(iParam0==0){
TASK::TASK_LOOK_AT_ENTITY(uLocal_943[0], uLocal_943[1], -1, 0, 2);
if(!PED::IS_PED_IN_VEHICLE(iVar0, iLocal_1067, 0)){
TASK::TASK_ENTER_VEHICLE(iVar0, iLocal_1067, 30000, -1, 1f, 1, 0);
}}elseif(iParam0==1){
TASK::TASK_LOOK_AT_ENTITY(uLocal_943[1], uLocal_943[0], -1, 0, 2);
if(!PED::IS_PED_IN_VEHICLE(iVar0, iLocal_1067, 0)){
TASK::TASK_ENTER_VEHICLE(iVar0, iLocal_1067, 30000, 0, 1f, 1, 0);
}}elseif(iParam0==2){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1068, 0)){
if(!PED::IS_PED_IN_VEHICLE(iVar0, iLocal_1068, 0)){
TASK::TASK_ENTER_VEHICLE(iVar0, iLocal_1068, 30000, 1, 1f, 1, 0);
}
}}}
...
if(iParam0==0){
TASK::TASK_LOOK_AT_ENTITY(uLocal_943[iParam0], uLocal_943[1], -1, 2048, 4);
}elseif(iParam0==1){
TASK::TASK_LOOK_AT_ENTITY(uLocal_943[iParam0], uLocal_943[0], -1, 2048, 4);
}}}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
if(!func_140()){
if(iLocal_961){
...
TASK::TASK_COMBAT_PED(iVar0, iLocal_940, 0, 16);
}
}}}else{
...
if(!iLocal_961){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1067, -1, 0)==iVar0){
if(!PED::IS_PED_INJURED(iVar0)){
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1067, 1, 1, 0);
if(func_138()){
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar0, iLocal_1067, "OJASva_101a", 181, 0, 16, -1, 10f, 0, 1073741824);
}else{
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(iVar0, iLocal_1067, "OJASva_101", 181, 0, 0, -1, -1f, 0, 1073741824);
}
}}
...
case 7:
if(iLocal_961){
if((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1067, -1, 0)==iVar0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1067, 1, 0)==iLocal_941){
if(!PED::IS_PED_INJURED(iVar0)){
if(bLocal_976 || (iLocal_990 && !TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1067))){
TASK::CLEAR_PED_TASKS(iVar0);
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iVar0, joaat("script_task_vehicle_mission")) !=1){
TASK::TASK_VEHICLE_MISSION(iVar0, iLocal_1067, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 8, 35f, 786469, -1f, -1f, 1);
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iVar0, joaat("script_task_vehicle_mission")) !=1){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iVar0, iLocal_1067, PLAYER::PLAYER_PED_ID(), 8, 35f, 786469, -1f, -1f, 1);
}}
}}}elseif(!PED::IS_PED_INJURED(iVar0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iVar0, joaat("script_task_combat")) !=1){
TASK::TASK_COMBAT_PED(iVar0, iLocal_940, 0, 16);
}}}elseif(bLocal_976 || (iLocal_990 && !TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1067))){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
if(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1067, -1, 0)==iVar0){
if(!ENTITY::IS_ENTITY_DEAD(iVar0, 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iVar0, joaat("script_task_vehicle_mission")) !=1){
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iVar0, iLocal_1067, Local_1059, 8, 25f, 786603, -1f, -1f, 1);
}
}}}}
break;
case 8:
...
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, PLAYER::PLAYER_PED_ID(), func_128(), 1f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
TASK::CLOSE_SEQUENCE_TASK(uLocal_1074);
if(!ENTITY::IS_ENTITY_DEAD(uLocal_943[iParam0], 0)){
TASK::TASK_PERFORM_SEQUENCE(uLocal_943[iParam0], uLocal_1074);
}
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1074);
}else{
TASK::OPEN_SEQUENCE_TASK(&uLocal_1074);
...
break;
case 9:
if(!PED::IS_PED_INJURED(uLocal_943[iParam0])){
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_943[iParam0], joaat("script_task_any")) !=1){
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(uLocal_943[iParam0], iLocal_940, iLocal_940, 1f, 0, -1f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
}}
break;
case 10:
if(iLocal_939==4 || iLocal_939==5){
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_941)){
iLocal_939=5;
}}}}}}elseif((iLocal_935[iParam0] !=10 && iLocal_935[iParam0] !=11) && iLocal_935[iParam0] !=7){
iLocal_935[iParam0]=10;
}
...
if(func_118(iParam0, iVar0, &Local_318, &iLocal_323, 0, 0, 0, 1, 1) || (PED::IS_PED_RAGDOLL(iParam0) && func_29(iParam0, 1) < 1.5f)){
return 1;
}}}
return 0;
}
...
int iVar0;
int iVar1[10];
uLocal_1034=PED::GET_PED_NEARBY_VEHICLES(PLAYER::PLAYER_PED_ID(), &iVar1);
...
if(!PED::IS_PED_INJURED(iLocal_941)){
if(!iLocal_961){
if(PED::IS_PED_IN_VEHICLE(iLocal_941, iLocal_1067, 0) && func_141()){
return 1;
}}elseif(PED::IS_PED_IN_VEHICLE(iLocal_941, iLocal_1067, 0)){
return 1;
}}}
return 0;
}
...
while (iVar0 <=1){
if(!PED::IS_PED_INJURED(iLocal_942[iVar0])){
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_942[iVar0], 0)){
iVar1=0;
}}
iVar0++;
}
...
TASK::TASK_AIM_GUN_AT_ENTITY(iParam0, iLocal_940, -1, 0);
...
struct<3> Var4;
struct<3> Var5;
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_942[iParam0])){
return;
}
...
if(iParam0==0){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_942[iParam0], iLocal_941, 1.5f, 0f, 0f, 1f, -1, 1036831949, 1);
}
elseif(iParam0==1){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1068, 0)){
...
TASK::TASK_ENTER_VEHICLE(0, iLocal_1068, 30000, 2, 1f, 1, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar2);
TASK::TASK_PERFORM_SEQUENCE(iLocal_942[iParam0], uVar2);
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_942[iParam0], 0)){
if(!PED::IS_PED_IN_VEHICLE(iLocal_942[iParam0], iVar0, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_941, 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], joaat("script_task_enter_vehicle")) !=1){
TASK::TASK_ENTER_VEHICLE(iLocal_942[iParam0], iVar0, 30000, iVar1, 1f, 1, 0);
}}
}
else{
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_942[iParam0], 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_942[iParam0], iVar0, 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
if(iLocal_961){
if(!bLocal_991){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], joaat("script_task_combat")) !=1){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(ENTITY::GET_ENTITY_SPEED(iVar0) < 5f){
iLocal_938[iParam0]=5;
}
}
TASK::TASK_COMBAT_PED(iLocal_942[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_942[iParam0], joaat("script_task_combat")) !=1){
TASK::TASK_COMBAT_PED(iLocal_942[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
}
}}elseif(!iLocal_985){
iLocal_938[iParam0]=5;
...
case 3:
if(!PED::IS_PED_INJURED(iLocal_942[iParam0])){
if(PED::IS_PED_USING_ANY_SCENARIO(iLocal_942[iParam0])){
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(iLocal_942[iParam0]);
}}
if(bLocal_986){
TASK::OPEN_SEQUENCE_TASK(&uLocal_1074);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
...
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_COORD(0, PLAYER::PLAYER_PED_ID(), func_128(), 1f, 0, 1056964608, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
TASK::CLOSE_SEQUENCE_TASK(uLocal_1074);
TASK::TASK_PERFORM_SEQUENCE(iLocal_942[iParam0], uLocal_1074);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1074);
}elseif(!PED::IS_PED_INJURED(iLocal_942[iParam0])){
PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_942[iParam0], Local_1064, 15f, 0, 0);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_942[iParam0], 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_942[iParam0], 0, 1);
PED::SET_PED_MAX_MOVE_BLEND_RATIO(iLocal_942[iParam0], 2f);
if(!iLocal_958 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_942[iParam0], 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_1074);
if(PED::IS_PED_INJURED(iLocal_941)){
...
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_941, 1.5f, 0f, 0f, 2f, -1, 1036831949, 1);
}
TASK::CLOSE_SEQUENCE_TASK(uLocal_1074);
iLocal_958=1;
}else{
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1067) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
Var4={
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_1067, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_1067, "wheel_lr")) 
};
Var5={
ENTITY::GET_ENTITY_COORDS(iLocal_1067, 1) 
};
...
PED::SET_PED_DEFENSIVE_SPHERE_ATTACHED_TO_VEHICLE(iLocal_942[iParam0], iLocal_1067, Var5, 1.5f, 0);
}
TASK::OPEN_SEQUENCE_TASK(&uLocal_1074);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
if(PED::IS_PED_INJURED(iLocal_941) && !func_50(func_148(), Var4, 0)){
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_941, 0)){
TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, iLocal_941, 0f, -1.5f, 0f, 2f, -1, 1036831949, 1);
}}
TASK::CLOSE_SEQUENCE_TASK(uLocal_1074);
}
if(!ENTITY::IS_ENTITY_DEAD(iLocal_942[iParam0], 0)){
...
case 4:
if(!ENTITY::IS_ENTITY_DEAD(iLocal_942[iParam0], 0)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_942[iParam0], "oddjobs@assassinate@hotel@", "enter", 3)){
fVar3=ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_942[iParam0], "oddjobs@assassinate@hotel@", "enter");
if(fVar3 < 0.5f){
ENTITY::SET_ENTITY_ANIM_SPEED(iLocal_942[iParam0], "oddjobs@assassinate@hotel@", "enter", 3.5f);
}else{
ENTITY::SET_ENTITY_ANIM_SPEED(iLocal_942[iParam0], "oddjobs@assassinate@hotel@", "enter", 1f);
}}}
break;
case 5:
if(iParam0==0){
...
if(!PED::IS_PED_INJURED(iLocal_942[iParam0])){
if(PED::IS_PED_IN_ANY_VEHICLE(iLocal_941, 0)){
TASK::TASK_COMBAT_PED(iLocal_942[iParam0], iLocal_940, 0, 16);
}else{
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(iLocal_942[iParam0], iLocal_941, PLAYER::PLAYER_PED_ID(), 3f, 1, 0.005f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
}}
...
}}elseif(func_137(iLocal_942[iParam0])){
iLocal_961=1;
}}elseif(iLocal_938[iParam0] < 5){
if(!PED::IS_PED_INJURED(iLocal_942[iParam0])){
if(PED::IS_PED_USING_ANY_SCENARIO(iLocal_942[iParam0])){
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(iLocal_942[iParam0]);
}
TASK::TASK_CLEAR_DEFENSIVE_AREA(iLocal_942[iParam0]);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_942[iParam0], 2);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_942[iParam0], 13, 1);
}
iLocal_938[iParam0]=5;
}}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_941)){
Local_1064={
ENTITY::GET_ENTITY_COORDS(iLocal_941, 0) 
};
}
switch (iLocal_937){
case 0:
if(!ENTITY::IS_ENTITY_DEAD(iLocal_941, 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0) && !ENTITY::IS_ENTITY_DEAD(uLocal_943[0], 0)){
if(!PED::IS_PED_IN_VEHICLE(iLocal_941, iLocal_1067, 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_941, joaat("script_task_enter_vehicle")) !=1){
if(!iLocal_961 && !iLocal_985){
TASK::TASK_ENTER_VEHICLE(iLocal_941, iLocal_1067, 30000, 1, 1f, 1, 0);
}else{
TASK::TASK_ENTER_VEHICLE(iLocal_941, iLocal_1067, 30000, 1, 2f, 1, 0);
}
...
if(!iLocal_1006){
if(func_152()){
if(func_30(iLocal_941, PLAYER::PLAYER_PED_ID(), 1) <=5f && !func_28()){
if(func_36(25f, 1)==0){
if(func_151()){
iLocal_1006=1;
}
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_941, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_941, iLocal_1067, 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_941, joaat("script_task_leave_any_vehicle")) !=1){
TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_941, 0, 256);
}}elseif(!bLocal_991){
PED::SET_PED_MAX_MOVE_BLEND_RATIO(iLocal_941, 2f);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
TASK::OPEN_SEQUENCE_TASK(&uVar0);
TASK::TASK_PLAY_ANIM(0, "oddjobs@assassinate@hotel@", "alert_gunshot", 8f, -4f, 1000, 0, 0, 0, 0, 0);
TASK::TASK_SMART_FLEE_PED(0, iLocal_940, 200f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_941, 0)){
TASK::TASK_PERFORM_SEQUENCE(iLocal_941, uVar0);
}
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
bLocal_991=true;
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_941, joaat("script_task_any")) !=1){
TASK::TASK_SMART_FLEE_PED(iLocal_941, iLocal_940, 200f, -1, 0, 0);
}
if(!iLocal_1006){
...
if(!iLocal_961){
if(iLocal_985){
}elseif(func_137(iLocal_941) || iLocal_1015){
...
int iVar0;
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
iVar0=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1067, -1, 0);
if(iVar0==0 || (iVar0 !=0 && PED::IS_PED_INJURED(iVar0))){
iVar0=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1067, 0, 0);
if(iVar0==0 || (iVar0 !=0 && PED::IS_PED_INJURED(iVar0))){
iVar0=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_1067, 2, 0);
if(iVar0==0 || (iVar0 !=0 && PED::IS_PED_INJURED(iVar0))){
return 1;
}}}}
return 0;
...
func_57(&uLocal_1086, Global_113810.f_19966.f_5);
}
iLocal_1031=func_540();
if(Global_94990){
if(iLocal_1031 <=2){
...
Global_113810.f_19966.f_5=func_52(&uLocal_1086);
fLocal_324=Global_113810.f_19966.f_5;
func_246();
iLocal_329=1;
iLocal_1037=1;
}
...
if(func_242(&uLocal_340, 1, 0) && AUDIO::IS_MISSION_COMPLETE_READY_FOR_UI()){
...
}}elseif(MISC::IS_BIT_SET(Global_113810.f_20567.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_168() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
var func__170(int iParam0, var uParam1){
...
var func__177(int iParam0, int iParam1){
if(iParam1==-1){
iParam1=func_172();
}
...
uParam0->f_563=func_212((uParam0->f_563 + (((1f / 0.3f) * uParam0->f_577) * timestep())), 0f, 1f);
uParam0->f_577=func_212((uParam0->f_577 + 0.07f), 0.75f, 1.15f);
}}else{
uParam0->f_563=func_212((uParam0->f_563 - ((((1f / 0.3f) * uParam0->f_577) * 0.01f) * timestep())), 0f, 1f);
uParam0->f_577=func_212((uParam0->f_577 + 0.07f), 0.75f, 1.15f);
}
...
func_207(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 215, 1));
func_206("ES_HELP");
if(MISC::IS_PC_VERSION()){
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(true);
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
func_207(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 216, 1));
func_206("ES_XPAND");
if(MISC::IS_PC_VERSION()){
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(true);
...
func_231();
GRAPHICS::DRAW_RECT(0.5f, (fVar1 - (func_234((2f - 0.5f)) - 0.001388889f)), fVar6, func_228(1f), uVar13, uVar14, uVar15, round((fVar12 * IntToFloat(iVar16))), 0);
}else{
return;
}
...
func_225(uParam0, iVar17, (fVar1 + func_234(2f)), fVar9, fVar10, round((IntToFloat(iVar0) * fVar12)));
}else{
return;
}
...
fVar12=func_212((fVar11 / (0.6f * func_234(25f))), 0f, 1f);
func_231();
GRAPHICS::DRAW_RECT(0.5f, (fVar1 + func_234((2f * 0.5f))), fVar6, func_228(1f), uVar13, uVar14, uVar15, round((fVar12 * IntToFloat(iVar16))), 0);
fVar1=(fVar1 + func_234((2f * 0.3f)));
if(uParam0->f_56 > 0){
fVar1=(fVar1 + func_234((25f * 0.2f)));
}}}}
...
var func__221(int iParam0, bool bParam1){
char* sVar0[2];
var uVar1;
struct<13> Var2;
...
GRAPHICS::DRAW_SPRITE("CommonMenu", func_221(7, 0), (fParam4 - 0.006f), ((fParam2 + func_234(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0, 0);
fVar4=(fVar4 - ((fVar5 * 0.38f) + 0.006f));
break;
case 2:
func_217(5, 0, 1, &fVar5, &fVar6, 0);
GRAPHICS::DRAW_SPRITE("CommonMenu", func_221(5, 0), (fParam4 - 0.006f), ((fParam2 + func_234(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0, 0);
fVar4=(fVar4 - ((fVar5 * 0.38f) + 0.006f));
break;
case 3:
func_217(6, 0, 1, &fVar5, &fVar6, 0);
GRAPHICS::DRAW_SPRITE("CommonMenu", func_221(6, 0), (fParam4 - 0.006f), ((fParam2 + func_234(2f)) + (0.25f * fVar6)), fVar5, fVar6, 0f, 255, 255, 255, iParam5, 0, 0);
fVar4=(fVar4 - ((fVar5 * 0.38f) + 0.006f));
break;
}
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(2);
func_207(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 188, 1));
func_206("ES_HELP_TU");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
func_207(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 187, 1));
func_206("ES_HELP_TD");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
func_207(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 202, 1));
func_206("ES_HELP_AB");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_4, "DRAW_INSTRUCTIONAL_BUTTONS");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
int iVar1;
if(!iLocal_329){
func_252(&uLocal_340, &Local_921, &Global_63500, 0);
fLocal_324=(fLocal_324 * 1000f);
if(Global_94990){
func_251(&uLocal_340, 6, &(Local_921.f_12), "MTPHPERSKI", floor(fLocal_324), 0, 3, 0);
func_251(&uLocal_340, 6, &(Local_921.f_24), "MTPHPERSKI", 0, 0, 3, 0);
func_251(&uLocal_340, 6, &(Local_921.f_30), "MTPHPERSKI", round((fLocal_326 + fLocal_325)), 0, 3, 0);
func_250();
}else{
if(bLocal_328){
func_251(&uLocal_340, 6, &(Local_921.f_12), "MTPHPERRET", floor(fLocal_324), 0, 3, 0);
}else{
func_251(&uLocal_340, 9, &(Local_921.f_12), "", floor(fLocal_324), 0, 0, 0);
}
if(!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_921.f_18))){
if(bLocal_327){
func_251(&uLocal_340, 6, &(Local_921.f_24), "", 0, 0, 2, 0);
func_251(&uLocal_340, 3, &(Local_921.f_30), "", round((fLocal_326 + fLocal_325)), 0, 2, 0);
}else{
func_251(&uLocal_340, 6, &(Local_921.f_24), "", 0, 0, 1, 0);
func_251(&uLocal_340, 3, &(Local_921.f_30), "", round(fLocal_325), 0, 0, 0);
}}else{
func_251(&uLocal_340, 3, &(Local_921.f_30), "", round(fLocal_325), 0, 0, 0);
}}
iVar0=0;
...
func_248(38, floor(fLocal_324), 1);
if(bLocal_327){
func_248(39, 1, 1);
}else{
func_248(39, 0, 1);
...
if(bLocal_327){
func_248(40, round((fLocal_326 + fLocal_325)), 1);
}else{
func_248(40, round(fLocal_325), 1);
}
...
func_248(52, floor(fLocal_324), 1);
if(bLocal_327){
func_248(53, 1, 1);
}else{
func_248(53, 0, 1);
...
if(bLocal_327){
func_248(56, round((fLocal_326 + fLocal_325)), 1);
}else{
func_248(56, round(fLocal_325), 1);
}
...
func_248(66, floor(fLocal_324), 1);
if(bLocal_327){
func_248(67, 1, 1);
}else{
func_248(67, 0, 1);
...
if(bLocal_327){
func_248(68, round((fLocal_326 + fLocal_325)), 1);
}else{
func_248(68, round(fLocal_325), 1);
}
...
func_248(81, floor(fLocal_324), 1);
if(bLocal_327){
func_248(82, 1, 1);
}else{
func_248(82, 0, 1);
...
if(bLocal_327){
func_248(83, round((fLocal_326 + fLocal_325)), 1);
}else{
func_248(83, round(fLocal_325), 1);
}
...
func_248(97, floor(fLocal_324), 1);
if(bLocal_327){
func_248(98, 1, 1);
}else{
func_248(98, 0, 1);
...
if(bLocal_327){
func_248(99, round((fLocal_326 + fLocal_325)), 1);
}else{
func_248(99, round(fLocal_325), 1);
}
...
case 1:
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
fVar0=func_32(PLAYER::PLAYER_PED_ID(), Local_1062, 1);
...
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_941);
}}
iVar0=0;
while (iVar0 < 3){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_943[iVar0])){
...
TASK::CLEAR_PED_TASKS(uLocal_943[iVar0]);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_943[iVar0]));
}}
iVar0++;
}
iVar0=0;
...
TASK::CLEAR_PED_TASKS(uLocal_944[iVar0]);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_944[iVar0]));
}}
iVar0++;
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1067)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_1067, 1);
}
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1067);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1068)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1068, 0)){
if((ENTITY::IS_ENTITY_ON_SCREEN(iLocal_1068) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_1068)) && !CAM::IS_SCREEN_FADED_OUT()){
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1068);
}else{
if(ENTITY::DOES_ENTITY_EXIST(uLocal_944[0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_944[0], 0)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1068, 0)){
if(PED::IS_PED_IN_VEHICLE(uLocal_944[0], iLocal_1068, 0)){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_944[0]);
}}}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_944[1]) && !ENTITY::IS_ENTITY_DEAD(uLocal_944[1], 0)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1068, 0)){
if(PED::IS_PED_IN_VEHICLE(uLocal_944[1], iLocal_1068, 0)){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_944[1]);
}}}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_1068, 0)){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
}}
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1068);
}}}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1071[0])){
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_1071[0]));
}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_1071[1])){
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&(uLocal_1071[1]));
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1072) && !ENTITY::IS_ENTITY_DEAD(iLocal_1072, 0)){
if(ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_1072) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_1072, 1)){
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_1072);
}}}
...
int iVar0;
if(bParam0){
if(HUD::DOES_BLIP_EXIST(uLocal_952)){
HUD::REMOVE_BLIP(&uLocal_952);
}}
iVar0=0;
while (iVar0 < 3){
if(HUD::DOES_BLIP_EXIST(uLocal_953[iVar0])){
HUD::REMOVE_BLIP(&(uLocal_953[iVar0]));
}
iVar0++;
}
iVar0=0;
while (iVar0 < 2){
if(HUD::DOES_BLIP_EXIST(uLocal_954[iVar0])){
HUD::REMOVE_BLIP(&(uLocal_954[iVar0]));
}
iVar0++;
}
iVar0=0;
...
void func_264(){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_1060, Local_1061, fLocal_1049, 1, 0, 0)){
bLocal_979=true;
}else{
bLocal_979=false;
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1067)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_1067, 3);
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
if(func_140()){
if(!PED::IS_PED_INJURED(uLocal_943[0])){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
if(PED::IS_PED_IN_VEHICLE(uLocal_943[0], iLocal_1067, 0)){
bLocal_972=true;
func_265();
iLocal_933=13;
}
...
float fVar2;
int iVar3;
if(ENTITY::DOES_ENTITY_EXIST(iLocal_941) && !ENTITY::IS_ENTITY_DEAD(iLocal_941, 0)){
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_941, 1) 
};
fVar2=ENTITY::GET_ENTITY_HEADING(iLocal_941);
}
Var0[0 /*3*/]={
...
while (iVar3 < 2){
if(iVar3==0){
iLocal_942[iVar3]=PED::CREATE_PED(26, iLocal_1077, Var0[0 /*3*/], Var0[0 /*3*/].f_1, 38.3253f, uLocal_1048[iLocal_1024], 1, 1);
}else{
iLocal_942[iVar3]=PED::CREATE_PED(26, iLocal_1078, Var0[1 /*3*/], Var0[1 /*3*/].f_1, 38.3253f, uLocal_1048[iLocal_1024], 1, 1);
}
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_942[iVar3], 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_942[iVar3]);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_942[iVar3], 3, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_942[iVar3], 23, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_942[iVar3], 30, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_942[iVar3], 13, 1);
PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_942[iVar3], 2);
PED::SET_PED_KEEP_TASK(iLocal_942[iVar3], 1);
func_278(iLocal_942[iVar3], 1);
PED::SET_PED_TO_LOAD_COVER(iLocal_942[iVar3], 1);
iVar3++;
}}
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iParam0, iLocal_1082);
}


void func_279(){
func_281();
iLocal_1024=MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_1022);
iLocal_941=PED::CREATE_PED(26, iLocal_1075, Local_1055[iLocal_1024 /*3*/], uLocal_1048[iLocal_1024], 1, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_941, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_941);
func_278(iLocal_941, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_1075);
if(!HUD::DOES_BLIP_EXIST(uLocal_952)){
uLocal_952=func_280(iLocal_941, 0, 0);
}
HUD::SET_BLIP_SCALE(uLocal_952, 1f);
}
...
if(ENTITY::IS_ENTITY_A_VEHICLE(iParam0)){
HUD::SET_BLIP_SCALE(uVar0, func_205(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
if(!bParam2){
HUD::SET_BLIP_AS_FRIENDLY(uVar0, iParam1);
}else{
HUD::SET_BLIP_COLOUR(uVar0, 2);
}}elseif(ENTITY::IS_ENTITY_A_PED(iParam0)){
HUD::SET_BLIP_SCALE(uVar0, func_205(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
HUD::SET_BLIP_AS_FRIENDLY(uVar0, iParam1);
}elseif(ENTITY::IS_ENTITY_AN_OBJECT(iParam0)){
HUD::SET_BLIP_SCALE(uVar0, func_205(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
}
...
iVar0=0;
while (iVar0 < 3){
if(!CAM::IS_SPHERE_VISIBLE(Local_1054[iVar0 /*3*/], 5f) && !func_285(iVar0, 6f)){
Local_1055[iLocal_1022 /*3*/]={
Local_1054[iVar0 /*3*/] 
};
...
iVar0=0;
while (iVar0 < 3){
fVar2=vdist(Var1, Local_1054[iVar0 /*3*/]);
...
if(VEHICLE::IS_ANY_VEHICLE_NEAR_POINT(Local_1054[iParam0 /*3*/], fParam1)){
return 1;
}
return 0;
}
...
if(STREAMING::HAS_MODEL_LOADED(iLocal_1075)){
iVar0=1;
}else{
iVar0=0;
}
...
int func_288(){
if(((ENTITY::DOES_ENTITY_EXIST(uLocal_943[0]) && ENTITY::DOES_ENTITY_EXIST(uLocal_943[1])) && !PED::IS_PED_INJURED(uLocal_943[0])) && !PED::IS_PED_INJURED(uLocal_943[1])){
if(PED::IS_PED_IN_VEHICLE(uLocal_943[0], iLocal_1067, 0) && PED::IS_PED_IN_VEHICLE(uLocal_943[1], iLocal_1067, 0)){
return 1;
}}
return 0;
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1067, 0, 1, 0);
}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_1072) && !ENTITY::IS_ENTITY_DEAD(iLocal_1072, 0)){
...
Var0={
ENTITY::GET_ENTITY_COORDS(iLocal_1072, 1) 
};
return 1;
}}}
return 0;
...
iVar1=0;
while (iVar1 < 3){
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_943[iVar1])){
if(iVar1==2){
iVar0=iLocal_1078;
}else{
iVar0=iLocal_1077;
}
uLocal_943[iVar1]=PED::CREATE_PED(26, iVar0, Local_1056[iVar1 /*3*/], fLocal_1043[iVar1], 1, 1);
if(iVar1==0){
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 0, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 3, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 4, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 8, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 11, 0, 0, 0);
}elseif(iVar1==1){
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 0, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 3, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 4, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 8, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 11, 0, 2, 0);
}elseif(iVar1==2){
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 0, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 3, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 4, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 8, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iVar1], 11, 1, 1, 0);
}}
if(!PED::IS_PED_INJURED(uLocal_943[iVar1])){
PED::SET_PED_CAN_BE_TARGETTED(uLocal_943[iVar1], 0);
PED::SET_PED_KEEP_TASK(uLocal_943[iVar1], 1);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_943[iVar1], 23, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_943[iVar1], 30, 0);
PED::SET_PED_TARGET_LOSS_RESPONSE(uLocal_943[iVar1], 2);
PED::SET_PED_CONFIG_FLAG(uLocal_943[iVar1], 104, 1);
...
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_944[iVar0])){
if(iVar0==0){
uLocal_944[iVar0]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1068, 26, iLocal_1077, -1, 1, 1);
}elseif(iVar0==1){
uLocal_944[iVar0]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1068, 26, iLocal_1078, 0, 1, 1);
}
func_278(uLocal_944[iVar0], 1);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_944[iVar0], 3, 0);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_944[iVar0], 23, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_944[iVar0], 30, 0);
PED::SET_PED_TARGET_LOSS_RESPONSE(uLocal_944[iVar0], 2);
PED::SET_PED_KEEP_TASK(uLocal_944[iVar0], 1);
}
iVar0++;
}}
...
void func_297(){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_1068)){
iLocal_1068=VEHICLE::CREATE_VEHICLE(iLocal_1079, Local_1057, fLocal_1045, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_1068, 0);
}}
...
iVar4=func_378(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
if(iVar4 !=-1){
...
iVar6=func_376(&(Global_100833.f_3));
if(iVar6 > -1){
...
var func__322(int iParam0, var uParam1){
...
iVar5=0;
while (iVar5 < iVar6){
if((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_329(Var7.f_1)) && iVar9 < 51){
...
}elseif(func_335(*uParam0, "v_hospital", 307.3065f, -589.9595f, 43.302f)){
*uParam0={
...
if(func_364()){
*uParam0=func_343(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
if(func_341()==0){
return MISC::IS_BIT_SET(func_176(func_340(iParam0), -1), iParam1);
}}else{
...
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_344(iVar0, 0), 1);
...
Vector3 func__344(int iParam0, bool bParam1){
switch (iParam0){
case -1:
return 0f, 0f, 0f;
break;
...
return func_351(2, 2);
}elseif(func_350(Global_1853823)){
...
Vector3 func__348(struct<3> Param0){
...
Vector3 func__351(int iParam0, int iParam1){
struct<3> Var0;
struct<3> Var1;
Var1={
...
Var3={
func_353(Var3, -Var0.f_3.f_2) 
};
Var3={
func_353(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__353(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
return (shift_right(iParam0, 26) & 31 * func_371(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_380(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21){
uParam0->f_4=iParam4;
*uParam0=sParam1;
uParam0->f_1={
Param2 
...
switch (iLocal_1020){
case 0:
if(func_419(1084227584, 1) || (bLocal_978 && STREAMING::STREAMVOL_HAS_LOADED(uLocal_957))){
func_418(-1248.398f, -183.366f, 37.72881f, -1216.437f, -196.8727f, 44.07541f, 59.25f, Local_1415, fLocal_1416, 1, 1, 1, 0, 0);
...
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1067, 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(iLocal_1067, 107, "ASSOJva", 1);
VEHICLE::SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(iLocal_1067, 2500f);
}}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
iLocal_1020++;
}elseif(STREAMING::STREAMVOL_HAS_LOADED(uLocal_957)){
}
break;
case 1:
if(func_389()){
...
func_415(0, 0, 1);
func_414();
CAM::SHAKE_CAM(uLocal_1080, "HAND_SHAKE", 0.2f);
CAM::SHAKE_CAM(uLocal_1081, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_1081, uLocal_1080, 6000, 0, 0);
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
if(timera() > 6000){
if(VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1067)){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_1067);
}
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(iLocal_1067, 102, "ASSOJva", 1);
VEHICLE::SKIP_TIME_IN_PLAYBACK_RECORDED_VEHICLE(iLocal_1067, 4500f);
VEHICLE::FORCE_PLAYBACK_RECORDED_VEHICLE_UPDATE(iLocal_1067, 1);
func_260("ASS_VA_SNIPE2", 7500, 1);
CAM::SET_CAM_PARAMS(uLocal_1080, -1218.861f, -191.0496f, 38.83616f, 3.519839f, -0.000706f, 42.27108f, 38f, 0, 1, 1, 2);
CAM::SET_CAM_NEAR_DOF(uLocal_1080, 0.5f);
CAM::SET_CAM_FAR_DOF(uLocal_1080, 7f);
CAM::SHAKE_CAM(uLocal_1080, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_PARAMS(uLocal_1081, -1218.91f, -190.8791f, 38.84585f, 3.519839f, -0.000706f, 43.33815f, 38f, 0, 1, 1, 2);
CAM::SET_CAM_NEAR_DOF(uLocal_1081, 0.7f);
CAM::SET_CAM_FAR_DOF(uLocal_1081, 10f);
CAM::SHAKE_CAM(uLocal_1081, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_1081, uLocal_1080, 2000, 3, 3);
iLocal_1021++;
}}}
break;
case 2:
if(!ENTITY::IS_ENTITY_DEAD(iLocal_1067, 0)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
if(VEHICLE::GET_TIME_POSITION_IN_RECORDING(iLocal_1067) >=7000f){
VEHICLE::PAUSE_PLAYBACK_RECORDED_VEHICLE(iLocal_1067);
iLocal_1019=0;
while (iLocal_1019 < 3){
if(!ENTITY::IS_ENTITY_DEAD(uLocal_943[iLocal_1019], 0)){
if(iLocal_1019==0){
iVar0=1250;
}elseif(iLocal_1019==1){
iVar0=400;
}else{
iVar0=0;
}
if(TASK::GET_SCRIPT_TASK_STATUS(uLocal_943[iLocal_1019], joaat("script_task_perform_sequence")) !=1){
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1074);
TASK::OPEN_SEQUENCE_TASK(&uLocal_1074);
TASK::TASK_LEAVE_ANY_VEHICLE(0, iVar0, 0);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_1054[iLocal_1019 /*3*/], 1f, 20000, 0.25f, 0, 1193033728);
TASK::CLOSE_SEQUENCE_TASK(uLocal_1074);
TASK::TASK_PERFORM_SEQUENCE(uLocal_943[iLocal_1019], uLocal_1074);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_1074);
}}
iLocal_1019++;
}
...
CAM::SET_CAM_PARAMS(uLocal_1080, -1265.549f, -213.4919f, 43.0913f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
CAM::SHAKE_CAM(uLocal_1080, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_PARAMS(uLocal_1081, -1266.063f, -213.922f, 43.0918f, -0.055f, 0.0543f, -50.0795f, 38f, 0, 1, 1, 2);
CAM::SHAKE_CAM(uLocal_1081, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_1081, uLocal_1080, 4000, 3, 3);
iLocal_1039=4000;
}else{
CAM::SET_CAM_PARAMS(uLocal_1080, -1266.193f, -215.217f, 43.2442f, -3.1088f, 0.0498f, -48.5594f, 38f, 0, 1, 1, 2);
CAM::SHAKE_CAM(uLocal_1080, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_PARAMS(uLocal_1081, -1267.53f, -215.7824f, 43.1067f, -9.2365f, 0.0498f, -48.3561f, 38f, 0, 1, 1, 2);
CAM::SHAKE_CAM(uLocal_1081, "HAND_SHAKE", 0.2f);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_1081, uLocal_1080, 4000, 3, 3);
iLocal_1039=4000;
}
...
if(!iLocal_1017){
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==4){
if(timera() >=(iLocal_1039 - 300)){
GRAPHICS::ANIMPOSTFX_PLAY("CamPushInNeutral", 0, 0);
AUDIO::PLAY_SOUND_FRONTEND(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 1);
iLocal_1017=1;
}}}
if(timera() >=iLocal_1039){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_1067, 0)){
if(VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_1067)){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(iLocal_1067);
}}
...
VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_1067, 1, 1);
VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_1067, 0, 1);
VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_1067, 2, 1);
HUD::CLEAR_HELP(1);
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==4){
...
VEHICLE::REMOVE_VEHICLE_RECORDING(102, "ASSOJva");
VEHICLE::REMOVE_VEHICLE_RECORDING(107, "ASSOJva");
ENTITY::SET_ENTITY_COORDS(iLocal_1067, Local_1059, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_1067, fLocal_1042);
VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_1067, 0, 1);
VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_1067, 1, 1);
VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_1067, 2, 1);
VEHICLE::SET_VEHICLE_DOOR_SHUT(iLocal_1067, 2, 1);
...
void func_396(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6){
if(bParam0){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_401(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
func_407(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}
...
if(func_408(iVar0, Param0, Param1, fParam2)){
bVar1=true;
}}}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
...
int func_408(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
if(((((((((((((((func_409(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_409(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_409(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_409(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_409(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_409(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_409(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_409(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_409(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_409(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_409(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_409(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_409(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_409(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_409(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_409(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4)){
return 1;
}}
return 0;
}

int func_409(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_1063, 1, 0, 0, 1);
...
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_1070, 0, 1, 0);
ENTITY::SET_ENTITY_COORDS(iLocal_1070, -1251.873f, -256.7999f, 38.2695f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_1070, 296.7603f);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_1070, 1084227584);
}}}
...
iLocal_1019=0;
while (iLocal_1019 < 3){
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_943[iLocal_1019])){
if(iLocal_1019==0){
uLocal_943[iLocal_1019]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1067, 26, iLocal_1077, -1, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 0, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 3, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 4, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 8, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 11, 0, 0, 0);
}elseif(iLocal_1019==1){
uLocal_943[iLocal_1019]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1067, 26, iLocal_1077, 0, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 0, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 3, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 4, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 8, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 11, 0, 2, 0);
}elseif(iLocal_1019==2){
uLocal_943[iLocal_1019]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_1067, 26, iLocal_1078, 1, 1, 1);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 0, 1, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 3, 0, 2, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 4, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 8, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(uLocal_943[iLocal_1019], 11, 1, 1, 0);
}}
iLocal_1019++;
}}}}
...
void func_417(){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_1067)){
iLocal_1067=VEHICLE::CREATE_VEHICLE(iLocal_1076, Local_1058, fLocal_1041, 1, 1, 0);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_1076);
VEHICLE::SET_VEHICLE_DISABLE_TOWING(iLocal_1067, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_1067, 1, 1);
VEHICLE::SET_VEHICLE_PROVIDES_COVER(iLocal_1067, 1);
}}


void func_418(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
func_407(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

int func_419(int iParam0, int iParam1){
int iVar0;
if(((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && func_420(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam0, 1, 1056964608, 0, 1, 0)) && !ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
}elseif(func_52(&uLocal_319) > 1f || iParam1==0){
return 1;
}}
return 0;
}

int func_420(int iParam0, var uParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6){
...
if(!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)){
if(!func_432()){
if(!HUD::DOES_BLIP_EXIST(uLocal_951)){
uLocal_951=func_431(Local_1063, 1);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_951, "ASS_VA_DESTBLIP");
func_430(&uLocal_951, -1234.307f, -250.6783f, 38.2238f, 28.914f);
if(!iLocal_960){
func_260("ASS_VA_GOHOTEL", 7500, 1);
iLocal_960=1;
}
elseif(func_429("ASS_VA_LOSECOPS", 0, 0)){
HUD::CLEAR_PRINTS();
}}}elseif(STREAMING::STREAMVOL_HAS_LOADED(uLocal_957) && func_428()){
func_427();
func_265();
iLocal_933=8;
}}elseif(!func_432()){
func_426(uLocal_951, "ASS_VA_LOSECOPS");
}else{
func_37(3);
}
func_423();
...
func_425();
uLocal_957=STREAMING::STREAMVOL_CREATE_FRUSTUM(-1244.344f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 80f, 12, 127);
iLocal_959=1;
}}elseif(func_283(Local_1063, 1) > 120f){
if(STREAMING::STREAMVOL_IS_VALID(uLocal_957)){
STREAMING::STREAMVOL_DELETE(uLocal_957);
func_273();
iLocal_959=0;
}}elseif(!STREAMING::STREAMVOL_IS_VALID(uLocal_957)){
if(!func_424()){
iLocal_959=0;
}}}
...
void func_427(){
if(HUD::DOES_BLIP_EXIST(uLocal_951)){
HUD::REMOVE_BLIP(&uLocal_951);
}}

int func_428(){
int iVar0;
func_425();
if(STREAMING::HAS_MODEL_LOADED(iLocal_1077) && STREAMING::HAS_MODEL_LOADED(iLocal_1078)){
iVar0=1;
}else{
iVar0=0;
}
...
bool func_429(char* sParam0, int iParam1, int iParam2){
...
void func_430(var uParam0, struct<3> Param1, float fParam2){
if(HUD::DOES_BLIP_EXIST(*uParam0)){
...
var func__431(struct<3> Param0, int iParam1){
var uVar0;
...
if(func_433()){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_940, Local_1063, 25f, 25f, 90f, 1, 1, 0)){
iVar1=1;
}}
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if((fVar0 < 2f || ENTITY::IS_ENTITY_AT_COORD(iLocal_940, Local_1063, 2f, 2f, 2f, 1, 1, 0)) || iVar1){
...
iVar0=ENTITY::GET_ENTITY_MODEL(iLocal_1070);
...
break;
case 1:
Local_1429[0]=PED::CREATE_PED(4, joaat("a_f_m_bevhills_01"), -1220.679f, -203.2689f, 38.3251f, 321.2841f, 1, 1);
Local_1429[1]=PED::CREATE_PED(4, joaat("a_f_m_bevhills_02"), -1219.596f, -201.3663f, 38.3251f, 110.7199f, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1429[0], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1429[1], 1);
TASK::OPEN_SEQUENCE_TASK(&uVar0);
TASK::TASK_LOOK_AT_ENTITY(0, Local_1429[1], -1, 0, 2);
TASK::TASK_START_SCENARIO_AT_POSITION(0, "WORLD_HUMAN_TOURIST_MOBILE", -1220.679f, -203.2689f, 38.3251f, 321.2841f, 0, 0, 1);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
if(!ENTITY::IS_ENTITY_DEAD(Local_1429[0], 0)){
TASK::TASK_PERFORM_SEQUENCE(Local_1429[0], uVar0);
}
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
TASK::OPEN_SEQUENCE_TASK(&uVar0);
TASK::TASK_LOOK_AT_ENTITY(0, Local_1429[0], -1, 0, 2);
TASK::TASK_START_SCENARIO_AT_POSITION(0, "WORLD_HUMAN_TOURIST_MAP", -1219.596f, -201.3663f, 38.3251f, 110.7199f, 0, 0, 1);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
if(!ENTITY::IS_ENTITY_DEAD(Local_1429[1], 0)){
TASK::TASK_PERFORM_SEQUENCE(Local_1429[1], uVar0);
}
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
Local_1429.f_4=VEHICLE::CREATE_VEHICLE(joaat("taxi"), -1221.73f, -199.0665f, 38.1751f, 152.5038f, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_1429.f_4, 1084227584);
Local_1429.f_3=PED::CREATE_PED_INSIDE_VEHICLE(Local_1429.f_4, 4, joaat("a_m_y_hipster_01"), -1, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1429.f_3, 1);
TASK::TASK_LOOK_AT_ENTITY(Local_1429.f_3, Local_1429[0], -1, 0, 2);
Local_1429.f_8[0]=PED::CREATE_PED(4, joaat("a_m_m_bevhills_01"), -1211.597f, -184.5331f, 38.3255f, 4.5193f, 1, 1);
Local_1429.f_8[1]=PED::CREATE_PED(4, joaat("a_m_y_hipster_01"), -1211.654f, -182.7625f, 38.3255f, 166.2532f, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1429.f_8[0], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1429.f_8[1], 1);
TASK::TASK_PLAY_ANIM(Local_1429.f_8[0], "oddjobs@assassinate@hotel@", "idle_a", 8f, -4f, -1, 1, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(Local_1429.f_8[1], "oddjobs@assassinate@hotel@", "argue_b", 8f, -4f, -1, 1, 0, 0, 0, 0);
Local_1429.f_5[0]=PED::CREATE_PED(4, joaat("a_m_m_bevhills_01"), -1229.099f, -176.3197f, 38.3255f, 231.8036f, 1, 1);
Local_1429.f_5[1]=PED::CREATE_PED(4, joaat("a_f_m_bevhills_02"), -1249.779f, -162.4767f, 39.4131f, 220.1651f, 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1429.f_5[0], 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_1429.f_5[1], 1);
TASK::TASK_PLAY_ANIM(Local_1429.f_5[0], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(Local_1429.f_5[1], "oddjobs@assassinate@hotel@", "base", 8f, -4f, -1, 1, 0, 0, 0, 0);
Local_1429.f_11=1;
...
if(iLocal_1013){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
fLocal_1051=vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_1063);
iLocal_1013=0;
}}elseif(fLocal_1051==0f){
fLocal_1051=vdist(-1510.291f, -946.9932f, 8.278f, Local_1063);
}
if(vdist(Var0, Local_1063) > (fLocal_1051 + 400f)){
func_37(7);
}elseif(vdist(Var0, Local_1063) > (fLocal_1051 + 200f)){
if(!iLocal_1009){
...
var uVar0;
float fVar1;
if(ENTITY::DOES_ENTITY_EXIST(iLocal_946)){
func_442();
if(!PED::IS_PED_INJURED(iLocal_946)){
fVar1=func_29(iLocal_946, 1);
PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(iLocal_946, 0);
PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(iLocal_946, 0);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_946, 0);
PED::SET_RAGDOLL_BLOCKING_FLAGS(iLocal_946, 16);
PED::SET_PED_CONFIG_FLAG(iLocal_946, 208, 1);
if(fVar1 < 5f){
if(func_58(&uLocal_1107)){
if(!func_28()){
if(func_439(&uLocal_1107, 10f)){
func_35(&uLocal_1114, 3, iLocal_946, "LESTER", 0, 1);
func_6(&uLocal_1114, "OJASAUD", "OJAS_FOLLOW", 9, 0, 0, 0);
}}}}elseif(fVar1 > 100f){
if(ENTITY::IS_ENTITY_OCCLUDED(iLocal_946) || !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_946)){
func_438();
}}
switch (iLocal_1018){
case 0:
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if((PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()) || (ENTITY::DOES_ENTITY_EXIST(iLocal_946) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_946, PLAYER::PLAYER_PED_ID(), 1))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1428, PLAYER::PLAYER_PED_ID(), 1)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_1428, PLAYER::PLAYER_PED_ID(), 1)){
}
PED::SET_PED_MOVEMENT_CLIPSET(iLocal_946, "move_lester_CaneUp", 1048576000);
TASK::TASK_PLAY_ANIM(iLocal_946, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 1000f, -4f, -1, 790536, 0, 0, 0, 0);
iLocal_1018=1;
}}
break;
case 1:
if(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_946, "oddjobs@assassinate@hotel@leadin", "Lester_Getup", 3)){
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_946, "oddjobs@assassinate@hotel@leadin", "Lester_Getup") >=0.376f){
TASK::OPEN_SEQUENCE_TASK(&uVar0);
...
TASK::TASK_WANDER_STANDARD(0, ENTITY::GET_ENTITY_HEADING(iLocal_946), 0);
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(iLocal_946, uVar0);
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
PED::FORCE_PED_MOTION_STATE(iLocal_946, joaat("MotionState_Walk"), 0, 0, 0);
iLocal_1018=2;
}}
break;
case 2:
...
void func_442(){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_946)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_946, PLAYER::PLAYER_PED_ID(), 1)){
func_37(9);
}}}
...
if(!MISC::IS_BIT_SET(Global_100833.f_20, 13)){
func_539();
}
func_444(0, -1, 1);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
...
void func_449(){
uLocal_1071[0]=VEHICLE::CREATE_VEHICLE(iLocal_1079, -1270.045f, -251.4953f, 41.4459f, 214.63f, 1, 1, 0);
uLocal_1071[1]=VEHICLE::CREATE_VEHICLE(iLocal_1079, -1265.199f, -218.4823f, 45.9981f, 127.85f, 1, 1, 0);
}


void func_450(){
uLocal_1080=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1244.344f, -251.566f, 50.3194f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
uLocal_1081=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -1243.588f, -251.4826f, 50.3187f, -9.2001f, 0.0498f, 6.3064f, 38f, 0, 2);
}

int func_451(){
int iVar0;
iVar0=0;
if(((((((((STREAMING::HAS_MODEL_LOADED(iLocal_1076) && STREAMING::HAS_MODEL_LOADED(iLocal_1079)) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(102, "ASSOJva")) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(107, "ASSOJva")) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED("OJASva_101")) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED("OJASva_101a")) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED("OJASva_104")) && STREAMING::HAS_ANIM_DICT_LOADED("ODDJOBS@ASSASSINATE@GUARD")) && STREAMING::HAS_ANIM_DICT_LOADED("oddjobs@assassinate@hotel@")) && HUD::HAS_ADDITIONAL_TEXT_LOADED(3)){
iVar0=1;
}
return iVar0;
}
...
PED::ADD_RELATIONSHIP_GROUP("Guards", &iLocal_1082);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, joaat("COP"), iLocal_1082);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_1082, joaat("COP"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_1082, joaat("player"));
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_1082);
...
uLocal_955=PED::ADD_SCENARIO_BLOCKING_AREA(Var0 - Vector(15f, 15f, 15f), Var0 + Vector(15f, 15f, 15f), 0, 1, 1, 1);
uLocal_956=PED::ADD_SCENARIO_BLOCKING_AREA(Var1 - Vector(45f, 35f, 35f), Var1 + Vector(45f, 35f, 35f), 0, 1, 1, 1);
}


void func_455(){
StringCopy(&Local_921, "ASS_VA_PASSED", 24);
MemCopy(&(Local_921.f_6),{
Global_63500
}
, 6);
...
iLocal_1019=0;
while (iLocal_1019 <=4){
uLocal_1044[iLocal_1019]=MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 2f);
iLocal_1019++;
}
fLocal_325=7000f;
fLocal_326=2000f;
...
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_1417, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), fLocal_1418);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
TASK::TASK_PLAY_ANIM(PLAYER::PLAYER_PED_ID(), "oddjobs@assassinate@hotel@leaning@", "idle_a", 1000f, -4f, -1, 513, 0, 0, 0, 0);
if(!CAM::DOES_CAM_EXIST(uLocal_1419)){
uLocal_1419=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Local_1421, Local_1422, 42.2032f, 1, 2);
CAM::SHAKE_CAM(uLocal_1419, "HAND_SHAKE", 0.3f);
}
if(!CAM::DOES_CAM_EXIST(uLocal_1420)){
uLocal_1420=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Local_1423, Local_1424, 42.2032f, 0, 2);
CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_1420, uLocal_1419, 5000, 1, 1);
CAM::SHAKE_CAM(uLocal_1419, "HAND_SHAKE", 0.3f);
}
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
if(func_46(0)){
...
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_946, "Lester", 2, joaat("ig_lestercrest"), 0);
...
iLocal_946=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Lester", 0));
}}}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_947)){
...
iLocal_947=CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("WalkingStick_Lester", 0);
}}}
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_946) && !PED::IS_PED_INJURED(iLocal_946)){
ENTITY::SET_ENTITY_COORDS(iLocal_946, -1509.458f, -948.195f, 7.75f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(iLocal_946, -11f);
TASK::TASK_PLAY_ANIM(iLocal_946, "oddjobs@assassinate@hotel@leadin", "lester_leadin", 1000f, -8f, -1, 790537, 0f, 0, 1, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_946, 0, 0);
}}}
if(ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Lester", 0))){
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("WalkingStick_Lester", 0)){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_946) && !PED::IS_PED_INJURED(iLocal_946)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_947, iLocal_946, PED::GET_PED_BONE_INDEX(iLocal_946, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}}
if(CUTSCENE::HAS_CUTSCENE_FINISHED() && !CUTSCENE::IS_CUTSCENE_PLAYING()){
func_396(0, 1, 1, 0, 0, 0, 0);
if(!PED::IS_PED_INJURED(iLocal_946)){
ENTITY::SET_ENTITY_PROOFS(iLocal_946, 0, 0, 0, 0, 0, 0, 0, 0);
PED::SET_PED_CAN_RAGDOLL(iLocal_946, 1);
}
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0, 1065353216);
if(CAM::IS_SCREEN_FADED_OUT()){
...
iLocal_1428=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1510.103f, -947.7194f, 8.2332f, 5f, joaat("prop_bench_08"), 1, 0, 1);
}}
...
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_1073[iLocal_1038 + 1], 1, 0);
VEHICLE::SET_VEHICLE_HAS_BEEN_DRIVEN_FLAG(iLocal_1073[iLocal_1038 + 1], 0);
iLocal_1038++;
}}}}}}}
...
func_465(Local_1429.f_8[0], 1);
func_465(Local_1429.f_8[1], 1);
func_465(Local_1429.f_5[0], 1);
func_465(Local_1429.f_5[1], 1);
}else{
if((func_29(Local_1429.f_8[0], 0) < 1f || func_29(Local_1429.f_8[1], 0) < 1f) || iLocal_965){
func_464(Local_1429.f_8[0], 1);
func_464(Local_1429.f_8[1], 1);
}
if(!iLocal_965){
func_464(Local_1429.f_5[0], 0);
func_464(Local_1429.f_5[1], 0);
}else{
func_464(Local_1429.f_5[0], 1);
func_464(Local_1429.f_5[1], 1);
}}}}
...
if(!ENTITY::IS_ENTITY_DEAD(Local_1429[0], 0) && !ENTITY::IS_ENTITY_DEAD(Local_1429[1], 0)){
TASK::TASK_LOOK_AT_ENTITY(Local_1429[0], Local_1429[1], -1, 0, 2);
TASK::TASK_LOOK_AT_ENTITY(Local_1429[1], Local_1429[0], -1, 0, 2);
}
if(((ENTITY::DOES_ENTITY_EXIST(Local_1429[1]) && ENTITY::DOES_ENTITY_EXIST(Local_1429.f_4)) && !PED::IS_PED_INJURED(Local_1429[1])) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1429.f_4, 0)){
TASK::CLEAR_PED_TASKS(Local_1429[1]);
TASK::TASK_ENTER_VEHICLE(Local_1429[1], Local_1429.f_4, 20000, 2, 1f, 1, 0);
}
...
if(((ENTITY::DOES_ENTITY_EXIST(Local_1429[0]) && ENTITY::DOES_ENTITY_EXIST(Local_1429.f_4)) && !PED::IS_PED_INJURED(Local_1429[0])) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1429.f_4, 0)){
if(TASK::GET_SCRIPT_TASK_STATUS(Local_1429[0], joaat("script_task_enter_vehicle")) !=1){
TASK::CLEAR_PED_TASKS(Local_1429[0]);
TASK::TASK_ENTER_VEHICLE(Local_1429[0], Local_1429.f_4, 20000, 1, 1f, 1, 0);
iLocal_1001=1;
}
}}}else{
func_55(&uLocal_1098);
}}
if(!PED::IS_PED_INJURED(Local_1429[0]) && !PED::IS_PED_INJURED(Local_1429[1])){
if(PED::IS_PED_IN_VEHICLE(Local_1429[0], Local_1429.f_4, 0) && PED::IS_PED_IN_VEHICLE(Local_1429[1], Local_1429.f_4, 0)){
if(!ENTITY::IS_ENTITY_DEAD(Local_1429.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(Local_1429.f_4, 0)){
TASK::TASK_CLEAR_LOOK_AT(Local_1429.f_3);
func_56(&uLocal_1098);
}
iLocal_1028++;
}}
...
if(func_58(&uLocal_1098)){
if(func_52(&uLocal_1098) > 3f){
if(!PED::IS_PED_INJURED(Local_1429.f_3) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_1429.f_4, 0)){
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_1429.f_3, Local_1429.f_4, "OJAS_HotelTaxi01", 786485, 0, 16, -1, 10f, 0, 1073741824);
iLocal_1028++;
}}}
break;
case 3:
if(!ENTITY::IS_ENTITY_DEAD(Local_1429.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(Local_1429.f_4, 0)){
if(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_1429.f_4) || iLocal_1004){
TASK::TASK_VEHICLE_DRIVE_WANDER(Local_1429.f_3, Local_1429.f_4, 10f, 786603);
iLocal_1028++;
}}
break;
case 4:
if(iLocal_1004){
if(!PED::IS_PED_INJURED(uLocal_944[0])){
iVar0=uLocal_944[0];
}else{
iVar0=func_31(25f);
}
...
void func_467(){
if((ENTITY::DOES_ENTITY_EXIST(Local_1429.f_3) && !ENTITY::IS_ENTITY_DEAD(Local_1429.f_3, 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1429.f_3, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}
if((ENTITY::DOES_ENTITY_EXIST(Local_1429[0]) && !ENTITY::IS_ENTITY_DEAD(Local_1429[0], 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1429[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
PED::SET_PED_FLEE_ATTRIBUTES(Local_1429[0], 2, 0);
}
if((ENTITY::DOES_ENTITY_EXIST(Local_1429[1]) && !ENTITY::IS_ENTITY_DEAD(Local_1429[1], 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1429[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
PED::SET_PED_FLEE_ATTRIBUTES(Local_1429[1], 2, 0);
}
if((ENTITY::DOES_ENTITY_EXIST(Local_1429.f_8[0]) && !ENTITY::IS_ENTITY_DEAD(Local_1429.f_8[0], 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1429.f_8[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}
if((ENTITY::DOES_ENTITY_EXIST(Local_1429.f_8[1]) && !ENTITY::IS_ENTITY_DEAD(Local_1429.f_8[1], 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1429.f_8[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}
if((ENTITY::DOES_ENTITY_EXIST(Local_1429.f_5[0]) && !ENTITY::IS_ENTITY_DEAD(Local_1429.f_5[0], 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1429.f_5[0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}
if((ENTITY::DOES_ENTITY_EXIST(Local_1429.f_5[1]) && !ENTITY::IS_ENTITY_DEAD(Local_1429.f_5[1], 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_SMART_FLEE_PED(Local_1429.f_5[1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}}

int func_468(){
if(!ENTITY::IS_ENTITY_DEAD(Local_1429.f_3, 0)){
if(PED::IS_PED_BEING_JACKED(Local_1429.f_3)){
if(PED::GET_PEDS_JACKER(Local_1429.f_3)==PLAYER::PLAYER_PED_ID()){
return 1;
}}}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0) && !ENTITY::IS_ENTITY_DEAD(Local_1429.f_4, 0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_1429.f_4, 0)){
return 1;
}}
...
void func_471(struct<3> Param0, float fParam1, int iParam2, int iParam3){
if(func_546()){
...
int func_472(struct<3> Param0, float fParam1){
return func_473(&(Global_107357.f_2890), Param0, fParam1, 0);
}

int func_473(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_318(iParam0, 0, 0)) || func_318(iParam0, 1, 0)) || func_318(iParam0, 2, 0)) || func_303(iParam0) !=145) || func_492(iParam0)) || func_491(iParam0)) || func_490(iParam0)) || func_489(iParam0)) || !func_476(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_491(iParam0)){
}
if(func_491(iParam0)){
}
...
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_308(iVar3))){
}else{
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_308(iVar4))){
}else{
...
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_308(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_308(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_308(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_308(iVar6))){
}else{
...
if(((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_523(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)) && func_522()){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_308(iVar7 + 1))){
...
int func_513(var uParam0, var uParam1, var uParam2){
int iVar0;
int iVar1;
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam0, 0)){
return 0;
...
}elseif(func_519(*uParam0, iVar1, ((*uParam1)[iVar0] - 1))){
}else{
...
if(!func_520() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_955, 0);
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_956, 0);
func_539();
func_92(&uLocal_1279, 0, 0);
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
...
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_1077, 0);
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_1078, 0);
func_548();
