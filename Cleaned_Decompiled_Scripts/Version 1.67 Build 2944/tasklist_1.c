...
case 0:
if(uLocal_16[0]){
StringCopy(&(Global_22964[1 /*42*/]), "CL_C1A", 16);
StringCopy(&(Global_22964[1 /*42*/].f_4), "CL_C1A_BR", 16);
Global_22964[1 /*42*/].f_8=0;
Global_22964[1 /*42*/].f_9=2;
StringCopy(&(Global_22964[1 /*42*/].f_10[1 /*4*/]), "CL_C1A_J1", 16);
Global_22964[1 /*42*/].f_37[1]=0;
Global_22964[1 /*42*/].f_32[1]=3;
Global_22964[1 /*42*/].f_27[1]=0;
StringCopy(&(Global_22964[1 /*42*/].f_10[2 /*4*/]), "CL_C1A_J2", 16);
Global_22964[1 /*42*/].f_37[2]=0;
Global_22964[1 /*42*/].f_32[2]=3;
Global_22964[1 /*42*/].f_27[2]=0;
iLocal_17=0;
while (iLocal_17 < Global_22964[1 /*42*/].f_32[1]){
Global_32338[iLocal_17]=0;
Global_32334[iLocal_17]=0;
iLocal_17++;
}
func_4(1, 1, 1, 1);
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_18[iLocal_17])){
if(PED::IS_PED_INJURED(uLocal_18[iLocal_17])){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_18[iLocal_17], PLAYER::PLAYER_PED_ID(), 1)){
if(!Global_32334[iLocal_17]){
Global_22964[1 /*42*/].f_27[1]++;
func_2("CL_C1A_J1", Global_22964[1 /*42*/].f_27[1], Global_22964[1 /*42*/].f_32[1], 2000, 1);
Global_32334[iLocal_17]=1;
}
if(ENTITY::IS_ENTITY_DEAD(uLocal_18[iLocal_17], 0)){
if(!Global_32338[iLocal_17]){
if(MOBILE::CELL_CAM_IS_CHAR_VISIBLE_NO_FACE_CHECK(uLocal_18[iLocal_17]) && func_1()){
Global_22964[1 /*42*/].f_27[2]++;
func_2("CL_C1A_J2", Global_22964[1 /*42*/].f_27[2], Global_22964[1 /*42*/].f_32[2], 2000, 1);
Global_32338[iLocal_17]=1;
}
}
}
...
case 0:
if(uLocal_16[1]){
StringCopy(&(Global_22964[2 /*42*/]), "CL_C1B", 16);
StringCopy(&(Global_22964[2 /*42*/].f_4), "CL_C1B_BR", 16);
Global_22964[2 /*42*/].f_8=0;
Global_22964[2 /*42*/].f_9=3;
StringCopy(&(Global_22964[2 /*42*/].f_10[1 /*4*/]), "CL_C1B_J1", 16);
Global_22964[2 /*42*/].f_37[1]=0;
Global_22964[2 /*42*/].f_32[1]=-1;
Global_22964[2 /*42*/].f_27[1]=-1;
StringCopy(&(Global_22964[2 /*42*/].f_10[2 /*4*/]), "CL_C1B_J2", 16);
Global_22964[2 /*42*/].f_37[2]=0;
Global_22964[2 /*42*/].f_32[2]=-1;
Global_22964[2 /*42*/].f_27[2]=-1;
StringCopy(&(Global_22964[2 /*42*/].f_10[3 /*4*/]), "CL_C1B_J3", 16);
...
Global_23133[iParam0 /*9*/].f_2=uVar0;
Global_23133[iParam0 /*9*/].f_2.f_1=uVar1;
Global_23133[iParam0 /*9*/].f_2.f_2=uVar2;
Global_23133[iParam0 /*9*/].f_2.f_3=uVar3;
Global_23133[iParam0 /*9*/].f_2.f_4=uVar4;
Global_23133[iParam0 /*9*/].f_2.f_5=uVar5;
}
