...
iLocal_50=func_298(52);
iLocal_51=joaat("a_c_retriever");
iLocal_52=-1;
uLocal_54=AUDIO::GET_SOUND_ID();
...
if(!func_279(&iVar2, &Var0, Var1, 1f)){
func_278();
...
if(Var0.f_0==17){
uLocal_55=PED::ADD_SCENARIO_BLOCKING_AREA(Var1 - Vector(40f, 40f, 40f), Var1 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
}elseif(Var0.f_0==18){
uLocal_55=PED::ADD_SCENARIO_BLOCKING_AREA(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
}
...
func_214(Var0.f_0);
func_207(&iLocal_52, &(Var0.f_9), Var1);
if(Var0.f_0==18){
func_206(&Var0);
func_201(&Var0, Var1, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
}elseif(Var0.f_0==19){
func_206(&Var0);
if(AUDIO::HAS_SOUND_FINISHED(uLocal_54)){
func_201(&Var0, Var1, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
}
if((((((!func_200() && func_199(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(uLocal_54)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", 0, -1)){
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_54, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
}
if((iLocal_53==0 && func_199(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var1, Var0.f_15, Var0.f_15, Var0.f_15, 0, 0, 0)){
Var3={
...
func_177(Var0.f_0, &uLocal_56);
}
if(!func_2(&Var0)){
func_282(&Var0, 1);
}elseif(Var0.f_0==19){
AUDIO::STOP_SOUND(uLocal_54);
}
if(func_1(&Var0)){
func_282(&Var0, 0);
}}}}
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_157(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
var func__178(struct<3> Param0, int iParam1){
var uVar0;
uVar0=HUD::ADD_BLIP_FOR_COORD(Param0);
HUD::SET_BLIP_SCALE(uVar0, func_179(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
...
return 1;
}elseif((!func_182(PLAYER::PLAYER_PED_ID(), joaat("script_task_leave_any_vehicle")) && func_199(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))) && func_157(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 3f, 1, 1056964608, 0, 1, 0)){
TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
}}}
return 0;
}
...
return 0;
}}elseif(func_199(uParam0->f_28[0])){
if(func_185(uParam0)){
if(func_189(2)){
if(func_187(uParam0->f_27)){
func_186(uParam0->f_27, *uParam0);
...
int func_201(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7){
var uVar0;
if((((func_199(PLAYER::PLAYER_PED_ID()) && func_199(iParam0->f_28[0])) && !func_200()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_205(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7){
uVar0=16;
func_204(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
func_202(&uVar0, cParam2, sParam3, 7, 0, 0);
...
Vector3 func__231(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar2;
Var0={
func_235(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var1={
func_235(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
if(func_199(PLAYER::PLAYER_PED_ID()) && func_199(uParam0)){
...
float fVar2;
Var0={
func_235(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
if(fParam2 < 0.1f || fParam2 > 360f){
return 1;
}
...
void func_255(var uParam0, struct<3> Param1, float fParam2){
func_256(uParam0, iLocal_51, Param1, fParam2, 26);
...
void func_256(var uParam0, int iParam1, struct<3> Param2, var uParam3, int iParam4){
func_257(uParam0);
