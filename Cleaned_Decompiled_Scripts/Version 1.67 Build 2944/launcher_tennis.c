...
uLocal_60=PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
iLocal_66=0;
...
if(SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_184(uLocal_65, 4194304)){
if(iLocal_76 !=263){
...
if(ENTITY::DOES_ENTITY_EXIST(uLocal_60) && !ENTITY::IS_ENTITY_DEAD(iLocal_60, 0)){
Local_62={
ENTITY::GET_ENTITY_COORDS(iLocal_60, 1) 
};
fLocal_64=vdist2(Local_62, ScriptParam_98.f_1[0 /*3*/]);
fLocal_64=fLocal_64;
Local_82={
Local_62 
};
...
Local_82.f_2=0f;
Local_83.f_2=0f;
fLocal_81=vdist2(Local_82, Local_83);
switch (iLocal_66){
case 0:
...
if(!func_184(uLocal_65, 8)){
bVar1=true;
if(MISC::ARE_STRINGS_EQUAL(&(Global_100833.f_3), &cLocal_51)){
cLocal_51={
Local_50 
};
bVar1=false;
...
if(fLocal_81 > (fLocal_73 * fLocal_73) && !Global_100867){
if(iLocal_76 !=263){
...
if((!func_184(uLocal_65, 1) || !ENTITY::DOES_ENTITY_EXIST(func_168())) && !Global_100867){
func_177(10);
break;
}}
}
...
if(bVar2){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_84, Local_85, fLocal_86, 1, 0, iLocal_74) || (fLocal_88 > 0f && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_143(Local_84, Local_85, 0.5f), 0) > fLocal_88)){
bVar2=false;
}elseif(fLocal_87 > 0f){
if(MISC::ABSF((Local_62.f_2 - Local_84.f_2)) > fLocal_87){
bVar2=false;
}}
...
elseif(!func_184(uLocal_65, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_140(&iLocal_67);
...
func_140(&iLocal_67);
func_190(&uLocal_65, 2048);
SCRIPT::REQUEST_SCRIPT(&cLocal_51);
...
case 5:
PAD::SET_INPUT_EXCLUSIVE(0, 51);
if(SCRIPT::HAS_SCRIPT_LOADED(&cLocal_51)){
if(iLocal_67 !=-1){
func_140(&iLocal_67);
}
iVar3=2;
...
iLocal_49=start_new_script(&cLocal_51, iLocal_68);
SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_51);
Local_50={
cLocal_51 
};
...
if(func_184(uLocal_65, 2097152)){
if(!func_169(3) && !SCRIPT::IS_THREAD_ACTIVE(iLocal_49)){
func_177(10);
}}
if(!SCRIPT::IS_THREAD_ACTIVE(iLocal_49)){
STATS::PLAYSTATS_ODDJOB_DONE(round((func_13(&uLocal_78) * 1000f)), iLocal_70, 0);
func_12(&uLocal_78);
...
if(iLocal_70 !=-1){
if(func_184(Global_112460, 0)){
STATS::PLAYSTATS_MISSION_CHECKPOINT(func_21(iLocal_70), 0, Global_100870, 0);
func_7(func_21(iLocal_70), 0, Global_100870, 1, 0);
}else{
STATS::PLAYSTATS_MISSION_CHECKPOINT(func_21(iLocal_70), 0, Global_100870, 0);
func_7(func_21(iLocal_70), 0, Global_100870, 0, 0);
}
}
func_6();
func_190(&Global_112460, 0);
...
start_new_script("tennis_family", 5050);
...
while (iVar0 <=11){
Var1={
func_57(iParam1, func_126(iVar0), (*uParam2)[func_126(iVar0)], -1) 
};
...
Var1={
func_57(iParam1, 14, uVar6[iVar2], -1) 
};
if(Var1.f_3 !=-1 && Var1.f_3 !=255){
PED::SET_PED_PRELOAD_PROP_DATA(uParam0, iVar4, Var1.f_3, Var1.f_4);
}}
iVar2++;
}}
...
func_60(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
func_60(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_60(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
...
Vector3 func__143(struct<3> Param0, struct<3> Param1, float fParam2){
...
iVar3=0;
while (iVar3 < 10){
fVar1=vdist2(Param0, func_152(iVar3));
if(fVar0 > fVar1){
fVar0=fVar1;
iVar2=iVar3;
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_112857) || Global_32286) || func_163()) || func_146(8, -1)) || func_162()) || func_161()) || func_160()) || func_148()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_164()) || Global_32286) || func_163()) || func_146(8, -1)) || func_160()) || func_162()) || func_161()) || func_148()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_112857) || Global_32286) || func_163()) || func_146(8, -1)) || func_160()) || func_162()) || func_161()) || func_148()) || Global_113810.f_7691.f_919[iVar0]==5) || Global_43924 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_164()) || Global_112857) || Global_32286) || func_163()) || func_146(8, -1)) || func_162()) || func_161()) || func_148()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_164()) || func_161()) || Global_112857) || Global_32286) || func_163()) || Global_44569) || func_146(8, -1)) || func_160()) || func_159()) || func_148()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 8:
...
var uVar2[3];
int iVar3;
if(bLocal_91 && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("tennis_ambient"))==0){
if(iLocal_90==1){
iVar1=MISC::GET_RANDOM_INT_IN_RANGE(1, 4);
uVar2[0]=MISC::GET_RANDOM_INT_IN_RANGE(2, 8);
iVar3=1;
...
if(uVar2[iVar3] > 0){
uVar0=uVar2[iVar3];
start_new_script_with_args("tennis_ambient", &uVar0, 4, 5050);
}
iVar3++;
}}}}
...
func_194();
if(SCRIPT::IS_THREAD_ACTIVE(iLocal_49)){
PLAYER::FORCE_CLEANUP_FOR_THREAD_WITH_THIS_ID(iLocal_49, 3);
}
if(!MISC::IS_STRING_NULL(&cLocal_51)){
if(HUD::GET_LENGTH_OF_LITERAL_STRING(&cLocal_51) !=0){
SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_51);
}}}
