...
func_198();
func_41();
if(!MISC::IS_BIT_SET(uLocal_132, 3)){
func_35();
func_9();
}else{
func_1();
...
void func_1(){
if(((!MISC::IS_BIT_SET(uLocal_132, 7) && !MISC::IS_BIT_SET(uLocal_132, 6)) && iLocal_142==1) && !func_8()){
if(!func_7()){
...
if(func_11(&uLocal_148, "GNRCAUD", func_34(iParam0), 8, 0, 0, 0)){
iLocal_135=-1;
}}
...
void func_35(){
bool bVar0;
if((!MISC::IS_BIT_SET(uLocal_132, 4) && !func_8()) && iLocal_142==1){
...
}elseif(MISC::IS_BIT_SET(uLocal_132, 4)){
if(!func_40(&uLocal_146)){
func_39(&uLocal_146, 0, 0);
}elseif(func_38(&uLocal_146, iLocal_134, 0)){
...
int func_36(){
if((func_5(15378, -1) || MISC::IS_BIT_SET(uLocal_132, 5)) && func_5(15379, -1)){
return 1;
}
return 0;
}
...
int iVar1;
func_196();
if(MISC::IS_BIT_SET(uLocal_132, 0)){
if(GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_314) && GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_315)){
iVar0=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_314);
iVar1=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_315);
switch (iVar0){
case 102:
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_313, "SHOW_OVERLAY");
func_48(sParam0);
...
return MISC::IS_BIT_SET(func_52(5466, -1), iParam0);
}
...
func_62(uParam0, 0, 0, 0f, 0f, 0f, &uVar2, 0f, 0f, 0f, 1, 0, &uVar2, &iVar3, iVar3, 0, uVar4);
HUD::DISPLAY_RADAR(0);
func_61();
...
void func_62(var uParam0, int iParam1, int iParam2, struct<3> Param3, var uParam4, struct<3> Param5, bool bParam6, bool bParam7, var uParam8, var uParam9, int iParam10, bool bParam11, var uParam12){
struct<3> Var0;
struct<3> Var1;
float fVar2;
bool bVar3;
...
int iVar6;
struct<3> Var7;
func_155(uParam0, iParam1, 1, iParam10, 1);
if(func_152(PLAYER::PLAYER_ID(), 0)){
if(bParam7){
if(!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()){
if(!func_151() || bParam11){
func_140(0);
}}
return;
}}
...
fVar2=func_136(iParam1, iParam2);
}
if(!func_135(*uParam4)){
Var0={
*uParam4 
...
if(func_135(Var0)){
if(func_152(PLAYER::PLAYER_ID(), 0)){
if(ENTITY::DOES_ENTITY_EXIST(func_132()) && !ENTITY::IS_ENTITY_DEAD(func_132(), 0)){
Var0={
ENTITY::GET_ENTITY_COORDS(func_132(), 1) 
};
Var1={
0f, 0f, ENTITY::GET_ENTITY_HEADING(func_132()) 
};
...
fVar2=50f;
}elseif(func_126(PLAYER::PLAYER_ID())){
Var0={
...
fVar2=50f;
}elseif(func_125(Global_4718592.f_117591) || MISC::IS_BIT_SET(uParam12, 2)){
...
fVar2=42.6052f;
}}elseif(func_123(Global_4718592.f_117591) || MISC::IS_BIT_SET(uParam12, 1)){
Var0={
...
fVar2=50f;
}elseif(MISC::IS_BIT_SET(uParam12, 4) || func_122(Global_4718592.f_117591)){
Var0={
...
iVar6=func_121(PLAYER::PLAYER_ID());
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_120(iVar6), func_119(iVar6), 3.5688f, 7.9792f, 4.1641f) 
};
Var1={
-21.6791f, 0f, (func_119(iVar6) + 40.237f) 
};
fVar2=70f;
}elseif(MISC::IS_BIT_SET(uParam12, 6) || func_118()){
...
fVar2=50f;
}elseif(MISC::IS_BIT_SET(uParam12, 8) || func_114(Global_4718592.f_117591)){}elseif(MISC::IS_BIT_SET(uParam12, 9) || (func_112() && func_111(249))){
Var0={
...
if(!func_110()){
iVar5=0;
}}elseif(MISC::IS_BIT_SET(uParam12, 10)){}elseif(func_109(Global_4718592.f_117591)){
Var0={
...
fVar2=50f;
}elseif(func_108(Global_4718592.f_117591)){
Var0={
...
func_102();
func_101(&Var7, 144, Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_33);
if(!func_135(Var7)){
Var0={
Var7 
};
}
func_95(&Var7, 144, Global_1853988[PLAYER::PLAYER_ID() /*867*/].f_267.f_33);
Var1={
Var7 
};
}
...
func_63(func_151(), ((MISC::IS_BIT_SET(uParam12, 0) || MISC::IS_BIT_SET(uParam12, 1)) || MISC::IS_BIT_SET(uParam12, 2)));
}
...
}elseif(bVar14 || ((!func_152(PLAYER::PLAYER_ID(), 0) && !func_90()) && !func_89(PLAYER::PLAYER_ID()))){
...
if(!func_85(uVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(uVar27)){
if(!bVar22){
...
func_87(joaat("mpply_is_char_spectating"), iParam0);
}}
...
struct<3> Var1;
Var0[0 /*6*/]={
func_100(iParam3, bParam4) 
};
Var0[1 /*6*/]={
func_100(iParam0, bParam4) 
};
*uParam2={
func_98(iParam1, iParam3) 
};
Var1={
*uParam2 - Var0[0 /*6*/] 
};
Var1={
func_97(Var1, -Var0[0 /*6*/].f_3.f_2) 
};
Var1={
func_97(Var1, Var0[1 /*6*/].f_3.f_2) 
};
*uParam2={
...
Vector3 func__97(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
struct<6> func_98(var uParam0, int iParam1){
struct<6> Var0;
var uVar1;
int iVar2;
iVar2=0;
...
GRAPHICS::ANIMPOSTFX_PLAY(func_141(iParam0), 0, 1);
}}
...
if(func_142(Global_4718592.f_171044) && MISC::IS_BIT_SET(Global_4718592.f_172427.f_2808, 2)){
...
void func_195(){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_313, "HIDE_OVERLAY");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
func_47(0);
...
if(func_197()){
if(!MISC::IS_BIT_SET(uLocal_132, 0)){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_313, "GET_CURRENT_SELECTION");
uLocal_314=GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_313, "GET_CURRENT_SCREEN_ID");
uLocal_315=GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
...
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_EVENT", to_float(205), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 206, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 206)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_EVENT", to_float(206), -1082130432, -1082130432, -1082130432, -1082130432);
}
if(PAD::IS_USING_CURSOR(2)){
PAD::ENABLE_CONTROL_ACTION(2, 188, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 188)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 187, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 187)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
}
if(PAD::IS_CONTROL_JUST_RELEASED(2, 187)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_RELEASE_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
}
if(PAD::IS_CONTROL_JUST_RELEASED(2, 188)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_RELEASE_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
}}else{
PAD::ENABLE_CONTROL_ACTION(2, 188, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 188)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_EVENT", to_float(188), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 187, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 187)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_EVENT", to_float(187), -1082130432, -1082130432, -1082130432, -1082130432);
}}
PAD::ENABLE_CONTROL_ACTION(2, 189, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 189)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_EVENT", to_float(189), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 190, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 190)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_EVENT", to_float(190), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 201, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 201)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_EVENT", to_float(201), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 202, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 202)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_EVENT", to_float(202), -1082130432, -1082130432, -1082130432, -1082130432);
if(iLocal_142==0 || iLocal_142==1){
if(!func_199()){
func_268(1, 0);
}}
if(func_199()){
...
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_EVENT", to_float(203), -1082130432, -1082130432, -1082130432, -1082130432);
}
PAD::ENABLE_CONTROL_ACTION(2, 204, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 204)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_313, "SET_INPUT_EVENT", to_float(204), -1082130432, -1082130432, -1082130432, -1082130432);
}
if(PAD::IS_USING_CURSOR(2)){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_313, "SET_MOUSE_INPUT");
...
if(((iVar0 !=127 || iLocal_316 !=127) || iVar1 !=127) || iLocal_317 !=127){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_313, "SET_ANALOG_STICK_INPUT");
iLocal_316=iVar0;
iLocal_317=iVar1;
...
if(((iVar2 !=127 || iLocal_318 !=127) || iVar3 !=127) || iLocal_319 !=127){
...
bool func_199(){
return MISC::IS_BIT_SET(uLocal_132, 1);
}
...
GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_313, 255, 255, 255, 255, 0);
func_209();
func_203(0);
func_201(1);
}
...
func_268(1, 0);
}elseif(!func_217(PLAYER::PLAYER_ID())){
func_268(0, 0);
}elseif(func_216(PLAYER::PLAYER_ID())){
func_268(0, 0);
}}
...
}elseif((Global_1575063 && iParam0==PLAYER::PLAYER_ID()) && func_71(iParam0, 1, 0)){
return Global_2657704[iParam0 /*463*/].f_321.f_7 !=-1;
}}
return 0;
}
...
void func_220(){
func_215();
uLocal_313=GRAPHICS::REQUEST_SCALEFORM_MOVIE("COVERT_OPS");
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_313)){
wait(0);
}
...
func_224(1);
func_223(&uLocal_148, 2, 0, "AGENT14", 0, 1);
}}
...
void func_225(){
int iVar0;
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_313, "SET_PLAYER_DATA");
...
uVar4=func_261(&(Global_75872[func_45(iParam0) /*6*/]));
fVar5=0f;
fVar6=0f;
if(bVar3){
if(iParam0==3){
...
if(!func_40(&uLocal_144)){
func_39(&uLocal_144, 0, 0);
}elseif(func_38(&uLocal_144, 750, 0)){
iVar1=-1;
}else{
wait(0);
}}
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_313, "ADD_MISSION");
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(floor(fVar6));
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(floor(fVar5));
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}


void func_227(float fParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, var uParam6){
int iVar0;
int iVar1;
iVar0=func_232(iParam2, iParam3, 0, iParam4, iParam5);
iVar1=func_231(uParam6);
func_228(iVar0, iVar1, joaat("xp_multiplier"), fParam0, 1);
func_228(iVar0, iVar1, joaat("cash_multiplier"), fParam1, 1);
}


void func_228(int iParam0, int iParam1, int iParam2, var uParam3, bool bParam4){
func_229(0, iParam2, uParam3, bParam4);
if(iParam0==0){
return;
}
switch (iParam0){
...
case 24:
case 25:
func_229(1, iParam2, uParam3, bParam4);
if(iParam0==1){
return;
}
switch (iParam0){
...
case 4:
case 5:
func_229(2, iParam2, uParam3, bParam4);
if(iParam0==2){
return;
}
switch (iParam0){
...
case 4:
case 5:
func_229(iParam0, iParam2, uParam3, bParam4);
return;
case 1:
case 2:
case 6:
...
case 24:
case 25:
func_229(6, iParam2, uParam3, bParam4);
if(iParam0==6){
return;
}
switch (iParam0){
...
func_229(iParam0, iParam2, uParam3, bParam4);
if(iParam1 !=27){
func_229(iParam1, iParam2, uParam3, bParam4);
}
return;
case 15:
case 20:
...
case 23:
case 25:
func_229(15, iParam2, uParam3, bParam4);
if(iParam0==15){
if(iParam1 !=27){
func_229(iParam1, iParam2, uParam3, bParam4);
}
...
case 13:
case 14:
func_229(8, iParam2, uParam3, bParam4);
if(iParam0==8){
if(iParam1 !=27){
func_229(iParam1, iParam2, uParam3, bParam4);
}
...
void func_229(int iParam0, var uParam1, var uParam2, bool bParam3){
var uVar0;
var uVar1;
...
iVar6=0;
while (iVar6 < 8){
StringCopy(&(Local_138[iVar6 /*16*/]), "", 64);
iVar6++;
}
uVar2=func_255(iParam0, 500);
...
StringCopy(&(Local_138[iVar5 /*16*/]), HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME_WITH_BYTE_LIMIT(uVar2, iVar3, iVar4, 63), 64);
iVar3=(iVar3 + HUD::GET_LENGTH_OF_LITERAL_STRING(&(Local_138[iVar5 /*16*/])));
iVar5++;
}}}
return bVar0;
}
...
var func__255(int iParam0, int iParam1){
if(iParam0==-1){
return func_256();
}
...
GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_313);
func_264(iParam1);
func_266(0);
func_269();
