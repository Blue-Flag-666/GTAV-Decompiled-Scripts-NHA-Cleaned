...
if(!MISC::IS_BIT_SET(iLocal_53, bVar0)){
MISC::SET_BIT(&iLocal_53, bVar0);
}
}
elseif(MISC::IS_BIT_SET(iLocal_53, bVar0)){
...
iVar4=func_13(iVar2);
iLocal_55=start_new_script_with_args("pb_prostitute", &iVar4, 1, 2050);
...
if(func_13(iVar1)==VEHICLE::GET_PED_IN_VEHICLE_SEAT(uVar3, 0, 0) || PED::IS_PED_IN_VEHICLE(func_13(iVar1), uVar3, 1)){
...
Var4={
ENTITY::GET_ENTITY_COORDS(func_13(iVar1), 0) 
};
Var5={
