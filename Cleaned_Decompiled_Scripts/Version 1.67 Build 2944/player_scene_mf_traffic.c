...
uVar1=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_68[iVar0], -1, 0);
if(!PED::IS_PED_INJURED(uVar1)){
fVar2=MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 1f);
fVar3=MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 0.5f);
VEHICLE::START_VEHICLE_HORN(iLocal_68[iVar0], round((fVar2 * 1000f)), 0, 0);
func_3(&uLocal_86, fVar3);
}}}
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_84, 1) > 100f){
return 1;
}
return 0;
}
...
if(!func_15()){
func_13();
func_12(&uLocal_86, MISC::GET_RANDOM_FLOAT_IN_RANGE(1.75f, 2.25f));
return 1;
}
if(!func_9(&uLocal_86)){
func_12(&uLocal_86, (MISC::GET_RANDOM_FLOAT_IN_RANGE(1.75f, 2.25f) * 2f));
}
return 0;
}
...
iVar0=0;
while (iVar0 < 4){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_72[iVar0], 0)){
uVar2=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_72[iVar0], -1, 0);
...
iVar0=0;
while (iVar0 < 4){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_76[iVar0], 0)){
uVar3=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_76[iVar0], -1, 0);
...
iVar0=0;
while (iVar0 < 4){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_80[iVar0], 0)){
uVar4=VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_80[iVar0], -1, 0);
...
return 0;
}}}elseif(iParam1==func_21(Global_100554) && iParam1 !=0){
Global_100554=0;
}}
return 1;
}
...
STREAMING::REQUEST_MODEL(iLocal_81[iVar0]);
iVar0++;
}
iVar1=0;
bVar2=false;
...
MISC::CLEAR_AREA(Local_84 + Local_70[iVar0 /*3*/], 10f, 1, 0, 0, 0);
iLocal_68[iVar0]=VEHICLE::CREATE_VEHICLE(iLocal_69[iVar0], Local_84 + Local_70[iVar0 /*3*/], (fLocal_85 + uLocal_71[iVar0]), 1, 1, 0);
ENTITY::SET_ENTITY_LOD_DIST(iLocal_68[iVar0], 250);
VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(iLocal_68[iVar0], 2f);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_68[iVar0], 1);
}}
iVar0++;
}
iVar0=0;
...
MISC::CLEAR_AREA(Local_84 + Local_74[iVar0 /*3*/], 10f, 1, 0, 0, 0);
iLocal_72[iVar0]=VEHICLE::CREATE_VEHICLE(iLocal_73[iVar0], Local_84 + Local_74[iVar0 /*3*/], (fLocal_85 + uLocal_75[iVar0]), 1, 1, 0);
ENTITY::SET_ENTITY_LOD_DIST(iLocal_72[iVar0], 250);
VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(iLocal_72[iVar0], 2f);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_72[iVar0], 1);
}}
iVar0++;
}
iVar0=0;
...
MISC::CLEAR_AREA(Local_84 + Local_78[iVar0 /*3*/], 10f, 1, 0, 0, 0);
iLocal_76[iVar0]=VEHICLE::CREATE_VEHICLE(iLocal_77[iVar0], Local_84 + Local_78[iVar0 /*3*/], (fLocal_85 + uLocal_79[iVar0]), 1, 1, 0);
ENTITY::SET_ENTITY_LOD_DIST(iLocal_76[iVar0], 250);
VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(iLocal_76[iVar0], 2f);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_76[iVar0], 1);
}}
iVar0++;
}
iVar0=0;
...
if(!STREAMING::HAS_MODEL_LOADED(iLocal_81[iVar0])){
STREAMING::REQUEST_MODEL(iLocal_81[iVar0]);
bVar2=false;
}else{
MISC::CLEAR_AREA(Local_84 + Local_82[iVar0 /*3*/], 10f, 1, 0, 0, 0);
iLocal_80[iVar0]=VEHICLE::CREATE_VEHICLE(iLocal_81[iVar0], Local_84 + Local_82[iVar0 /*3*/], (fLocal_85 + uLocal_83[iVar0]), 1, 1, 0);
ENTITY::SET_ENTITY_LOD_DIST(iLocal_80[iVar0], 250);
VEHICLE::SET_VEHICLE_LOD_MULTIPLIER(iLocal_80[iVar0], 2f);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_80[iVar0], 1);
}}
iVar0++;
}
if(!bVar2){
...
while (iVar0 < 12){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_68[iVar0], 0)){
uVar3=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_68[iVar0], 4, iLocal_67[func_36()], -1, 1, 1);
func_34(uVar3);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_68[iVar0], 1);
...
uVar4=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_72[iVar0], 4, iLocal_67[func_36()], -1, 1, 1);
func_34(uVar4);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_68[iVar0], 1);
...
if(!VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(iLocal_72[2]) > 0){
VEHICLE::ATTACH_VEHICLE_TO_TRAILER(iLocal_72[0], iLocal_72[2], 1065353216);
}
if(!VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(iLocal_72[3]) > 0){
VEHICLE::ATTACH_VEHICLE_TO_TRAILER(iLocal_72[1], iLocal_72[3], 1065353216);
}
iVar0=0;
while (iVar0 < 4){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_76[iVar0], 0)){
if(VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(iLocal_76[iVar0]) > 0){
uVar5=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_76[iVar0], 4, iLocal_67[func_36()], -1, 1, 1);
func_34(uVar5);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_68[iVar0], 1);
...
while (iVar0 < 4){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_80[iVar0], 0)){
if(VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(iLocal_80[iVar0]) > 0){
uVar6=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_80[iVar0], 4, iLocal_67[func_36()], -1, 1, 1);
func_34(uVar6);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_68[iVar0], 1);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(uVar6, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_81[iVar0]);
}}
iVar0++;
}
iVar0=0;
...
if(STREAMING::HAS_MODEL_LOADED(iLocal_67[iVar2])){
...
*(uParam12[0 /*3*/])={
Vector(38.0807f, -1565.916f, -453.6f) - Var3 
};
(*uParam13)[0]=(171.8581f - fVar4);
*(uParam12[1 /*3*/])={
Vector(38.094f, -1599.477f, -467.9528f) - Var3 
};
(*uParam13)[1]=(151.2346f - fVar4);
*(uParam12[2 /*3*/])={
Vector(38.1786f, -1566.734f, -442.0422f) - Var3 
};
(*uParam13)[2]=(170.751f - fVar4);
*(uParam12[3 /*3*/])={
Vector(32.4872f, -1614.501f, -486.7076f) - Var3 
};
...
*(uParam0[iVar1 /*3*/])={
*(uParam0[iVar1 /*3*/]) + Var0 * FtoV((1f + (to_float(iVar1) / to_float((*uParam0 + 1 - 2))))) 
};
*(uParam0[iVar1 /*3*/])={
*(uParam0[iVar1 /*3*/]) + func_45(-1090519040, 1056964608) 
};
...
ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&(iLocal_80[iVar0]));
iVar0++;
}
iVar0=0;
while (iVar0 < iLocal_67){
