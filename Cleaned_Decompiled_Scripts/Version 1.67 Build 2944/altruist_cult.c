...
while (true){
wait(0);
if(BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_75){
PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
switch (iLocal_48){
case 0:
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(Global_113810.f_24998.f_5 >=iLocal_94 && !func_195()){
iLocal_48=2;
}
func_192();
func_189();
...
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42073[9 /*31*/], 0, 0, 1);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42073[10 /*31*/], 0, 0, 1);
break;
case 4:
...
if(PED::IS_PED_INJURED(iLocal_96[iVar0])){
if(HUD::DOES_BLIP_EXIST(uLocal_103[iVar0])){
HUD::REMOVE_BLIP(&(uLocal_103[iVar0]));
}
}
else{
if(TASK::IS_PED_IN_WRITHE(iLocal_96[iVar0])){
if(HUD::DOES_BLIP_EXIST(uLocal_103[iVar0])){
HUD::REMOVE_BLIP(&(uLocal_103[iVar0]));
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_96[iVar0], PLAYER::PLAYER_PED_ID(), 30f, 30f, 30f, 0, 1, 0)){
if(!func_116()){
...
iLocal_93=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(4500, 6000));
}}}
bLocal_77=true;
}
iVar0++;
...
if(!iLocal_75){
uLocal_107=func_63();
if(!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_107)){
break;
}
...
iLocal_92=0;
PED::REMOVE_RELATIONSHIP_GROUP(uLocal_268);
TASK::REMOVE_COVER_POINT(uLocal_106);
iVar0=0;
while (iVar0 < iLocal_96){
if(ENTITY::DOES_ENTITY_EXIST(iLocal_96[iVar0])){
PED::DELETE_PED(&(iLocal_96[iVar0]));
}
iVar0++;
}
iVar0=0;
...
OBJECT::DELETE_OBJECT(&(iLocal_101[iVar0]));
}
iVar0++;
}
...
OBJECT::DELETE_OBJECT(&uLocal_99);
}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_99)){
OBJECT::DELETE_OBJECT(&uLocal_99);
}
...
if(MISC::IS_BIT_SET(iLocal_46, 1) || iParam1){
...
if(MISC::IS_BIT_SET(iLocal_46, 2) || iParam2){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
...
if(iParam0==1){
if(!MISC::IS_BIT_SET(iLocal_46, 0) || iParam1){
...
return (func_37(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
}}
return uParam0->f_1;
}
...
if(func_45(&(uParam0->f_2)) * 1000f) > to_float(uParam0->f_1){
func_48(&(uParam0->f_2));
return 0;
}
return 1;
...
int func_58(){
if(!MISC::IS_BIT_SET(iLocal_46, 0) && !MISC::IS_BIT_SET(iLocal_46, 1)){
settimera(0);
func_14(1, 0);
}
...
func_14(0, 0);
func_59(0);
}elseif(MISC::GET_GAME_TIMER() < iLocal_47){
return 1;
}}}
return 0;
}
...
}}elseif(MISC::IS_BIT_SET(iLocal_46, 3)){
...
uLocal_257=GRAPHICS::REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
func_99(1);
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_257)){
wait(0);
}
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_257, "SHOW_SHARD_MIDSIZED_MESSAGE");
func_53("CULT_PASS");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
while (!func_98()){
wait(0);
...
GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_257, 255, 255, 255, 255, 0);
if(!iLocal_80){
if(timera() > 9500){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_257, "SHARD_ANIM_OUT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
...
if(timera() > 10000){
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_257)){
GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_257);
func_99(0);
}
while (MISC::GET_DISTANCE_BETWEEN_COORDS(func_96(PLAYER::PLAYER_ID()), Local_51, 1) < 209f && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
wait(0);
}
func_65(18);
func_196();
...
return (shift_right(iParam0, 26) & 31 * func_75(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
uLocal_434=func_137(PLAYER::PLAYER_PED_ID(), joaat("weapon_assaultrifle"), 1, 0, 0, 0, 0, 0, 0);
if(ENTITY::DOES_ENTITY_EXIST(uLocal_434)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_434, "Trevors_weapon", 0, 0, 0);
}
...
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_96[11], "Cult_Master", 2, joaat("a_m_o_acult_02"), 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_96[12], "Rear_Cult", 2, joaat("a_m_o_acult_02"), 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_96[13], "Left_Old_Cult", 2, joaat("a_m_o_acult_02"), 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_96[14], "Carbine_Cult", 2, joaat("a_m_y_acult_02"), 0);
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_96[15], "Shotgun_Cult", 2, joaat("a_m_y_acult_02"), 0);
CUTSCENE::START_CUTSCENE(0);
}
wait(0);
if(!bLocal_74 && Global_113810.f_24998.f_5 !=1000){
func_136();
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_96[0])){
PED::DELETE_PED(&(iLocal_96[0]));
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_96[1])){
PED::DELETE_PED(&(iLocal_96[1]));
}
if(CAM::DOES_CAM_EXIST(uLocal_104)){
CAM::SET_CAM_ACTIVE(uLocal_104, 0);
}
...
MISC::CLEAR_AREA(Local_51, 100f, 1, 0, 0, 0);
PED::ADD_SCENARIO_BLOCKING_AREA(Local_51 - Vector(100f, 60f, 80f), Local_51 + Vector(100f, 60f, 80f), 0, 1, 1, 1);
PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
MISC::ENABLE_DISPATCH_SERVICE(3, 0);
MISC::ENABLE_DISPATCH_SERVICE(5, 0);
uLocal_106=TASK::ADD_COVER_POINT(-1173.509f, 4924.365f, 222.21f, 277.2293f, 2, 0, 2, 1);
...
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_96[11])){
iLocal_96[11]=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("CULT_MASTER", 0));
}}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("REAR_CULT", 0)){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_96[12])){
iLocal_96[12]=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("REAR_CULT", 0));
}}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("LEFT_OLD_CULT", 0)){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_96[13])){
iLocal_96[13]=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("LEFT_OLD_CULT", 0));
}}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("CARBINE_CULT", 0)){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_96[14])){
iLocal_96[14]=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("CARBINE_CULT", 0));
}}
if(CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("SHOTGUN_CULT", 0)){
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_96[15])){
iLocal_96[15]=ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("SHOTGUN_CULT", 0));
}}
...
TASK::TASK_PUT_PED_DIRECTLY_INTO_COVER(PLAYER::PLAYER_PED_ID(), -1173.509f, 4924.365f, 222.21f, -1, 0, 0f, 1, 0, uLocal_106, 0);
...
WEAPON::GIVE_WEAPON_OBJECT_TO_PED(iLocal_434, PLAYER::PLAYER_PED_ID());
}
...
PED::ADD_RELATIONSHIP_GROUP("rghCult", &uLocal_268);
iVar1=0;
while (iVar1 < iLocal_96){
if(((iVar1==0 || iVar1==5) || iVar1==6) || iVar1==10){
iLocal_96[iVar1]=PED::CREATE_PED(26, joaat("a_m_o_acult_01"), Local_49[iVar1 /*3*/], fLocal_50[iVar1], 1, 1);
PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_96[iVar1], 0);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_96[iVar1], joaat("weapon_assaultrifle"), -1, 1, 1);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_96[iVar1], 0);
PED::SET_PED_COMBAT_ABILITY(iLocal_96[iVar1], 2);
PED::SET_PED_TO_INFORM_RESPECTED_FRIENDS(iLocal_96[iVar1], 50f, 20);
PED::SET_PED_ACCURACY(iLocal_96[iVar1], 5);
PED::SET_PED_HEARING_RANGE(iLocal_96[iVar1], 100f);
PED::SET_PED_SEEING_RANGE(iLocal_96[iVar1], 100f);
ENTITY::SET_ENTITY_HEALTH(iLocal_96[iVar1], 150, 0);
PED::SET_PED_SHOOT_RATE(iLocal_96[iVar1], MISC::GET_RANDOM_INT_IN_RANGE(40, 60));
TASK::TASK_COMBAT_PED(iLocal_96[iVar1], PLAYER::PLAYER_PED_ID(), 0, 16);
}elseif(iVar1==2){
iLocal_96[iVar1]=PED::CREATE_PED(26, joaat("a_m_o_acult_02"), Local_49[iVar1 /*3*/], fLocal_50[iVar1], 1, 1);
PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_96[iVar1], 0);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_96[iVar1], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_96[iVar1], 50, 1);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_96[iVar1], 2);
PED::SET_PED_COMBAT_ABILITY(iLocal_96[iVar1], 1);
PED::SET_PED_TO_INFORM_RESPECTED_FRIENDS(iLocal_96[iVar1], 50f, 20);
PED::SET_PED_ACCURACY(iLocal_96[iVar1], 5);
PED::SET_PED_HEARING_RANGE(iLocal_96[iVar1], 100f);
PED::SET_PED_SEEING_RANGE(iLocal_96[iVar1], 100f);
...
if(((((!PED::IS_PED_INJURED(iLocal_96[iVar1]) && !PED::IS_PED_INJURED(iLocal_96[11])) && !PED::IS_PED_INJURED(iLocal_96[12])) && !PED::IS_PED_INJURED(iLocal_96[13])) && !PED::IS_PED_INJURED(iLocal_96[14])) && !PED::IS_PED_INJURED(iLocal_96[15])){
WEAPON::GIVE_WEAPON_TO_PED(iLocal_96[11], joaat("weapon_pistol"), -1, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_96[12], joaat("weapon_assaultrifle"), -1, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_96[13], joaat("weapon_assaultrifle"), -1, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_96[14], joaat("weapon_carbinerifle"), -1, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_96[15], joaat("weapon_pumpshotgun"), -1, 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_96[iVar1], 0, 1);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_96[iVar1], 3);
PED::SET_PED_COMBAT_ABILITY(iLocal_96[iVar1], 0);
PED::SET_PED_ACCURACY(iLocal_96[iVar1], 0);
WEAPON::SET_PED_CHANCE_OF_FIRING_BLANKS(iLocal_96[iVar1], 1f, 1f);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_96[15], uLocal_105);
...
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_105);
TASK::TASK_PERFORM_SEQUENCE(iLocal_96[14], uLocal_105);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_105);
TASK::OPEN_SEQUENCE_TASK(&uLocal_105);
...
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_105);
TASK::TASK_PERFORM_SEQUENCE(iLocal_96[13], uLocal_105);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_105);
TASK::OPEN_SEQUENCE_TASK(&uLocal_105);
...
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_105);
TASK::TASK_PERFORM_SEQUENCE(iLocal_96[12], uLocal_105);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_105);
TASK::OPEN_SEQUENCE_TASK(&uLocal_105);
TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 4500, 0);
...
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_105);
TASK::TASK_PERFORM_SEQUENCE(iLocal_96[11], uLocal_105);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_105);
PED::SET_PED_KEEP_TASK(iLocal_96[iVar1], 1);
PED::SET_PED_RESET_FLAG(iLocal_96[iVar1], 156, 1);
}}else{
iLocal_96[iVar1]=PED::CREATE_PED(26, joaat("a_m_o_acult_02"), Local_49[iVar1 /*3*/], fLocal_50[iVar1], 1, 1);
PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_96[iVar1], 0);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_96[iVar1], joaat("weapon_pistol"), -1, 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_96[iVar1], 50, 1);
PED::SET_PED_COMBAT_MOVEMENT(iLocal_96[iVar1], 2);
PED::SET_PED_COMBAT_ABILITY(iLocal_96[iVar1], 0);
PED::SET_PED_TO_INFORM_RESPECTED_FRIENDS(iLocal_96[iVar1], 50f, 20);
PED::SET_PED_COMBAT_RANGE(iLocal_96[iVar1], 1);
PED::SET_PED_ACCURACY(iLocal_96[iVar1], 5);
PED::SET_PED_HEARING_RANGE(iLocal_96[iVar1], 100f);
PED::SET_PED_SEEING_RANGE(iLocal_96[iVar1], 100f);
PED::SET_PED_SHOOT_RATE(iLocal_96[iVar1], MISC::GET_RANDOM_INT_IN_RANGE(40, 60));
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_96[iVar1], uLocal_268);
ENTITY::SET_ENTITY_HEADING(iLocal_96[iVar1], func_135(ENTITY::GET_ENTITY_COORDS(iLocal_96[iVar1], 1), func_96(PLAYER::PLAYER_ID())));
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_96[iVar1], 1);
PED::SET_PED_CONFIG_FLAG(iLocal_96[iVar1], 42, 1);
uLocal_103[iVar1]=func_133(iLocal_96[iVar1], 1, 145);
iVar1++;
}
func_100(&uLocal_269, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
if(!bLocal_74){
uLocal_100[0]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), -1074.165f, 4897.468f, 213.2754f, -72f, 0f, 42.48f, iVar0, 25000, 2, 1, joaat("prop_security_case_01"));
uLocal_100[1]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), -1094.671f, 4892.789f, 215.0707f, -72f, 0f, 42.48f, iVar0, 25000, 2, 1, joaat("prop_security_case_01"));
uLocal_100[2]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), -1113.95f, 4904.385f, 217.6001f, -72f, 0f, 42.48f, iVar0, 25000, 2, 1, joaat("prop_security_case_01"));
uLocal_100[3]=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), -1145.273f, 4907.894f, 219.9734f, -72f, 0f, 42.48f, iVar0, 25000, 2, 1, joaat("prop_security_case_01"));
}
uLocal_100[0]=uLocal_100[0];
uLocal_100[1]=uLocal_100[1];
uLocal_100[2]=uLocal_100[2];
uLocal_100[3]=uLocal_100[3];
iLocal_101[0]=OBJECT::CREATE_OBJECT(joaat("prop_box_wood04a"), -1158.69f, 4915.709f, 220.2644f, 1, 1, 0);
iLocal_101[1]=OBJECT::CREATE_OBJECT(joaat("prop_box_wood03a"), -1156.246f, 4918.6f, 220.5432f, 1, 1, 0);
iLocal_101[2]=OBJECT::CREATE_OBJECT(joaat("prop_box_wood04a"), -1145.802f, 4931.816f, 219.9683f, 1, 1, 0);
iLocal_101[3]=OBJECT::CREATE_OBJECT(joaat("prop_box_wood04a"), -1133.369f, 4919.067f, 218.8385f, 1, 1, 0);
iLocal_101[4]=OBJECT::CREATE_OBJECT(joaat("prop_box_wood05a"), -1132.025f, 4921.483f, 218.8244f, 1, 1, 0);
iLocal_101[5]=OBJECT::CREATE_OBJECT(joaat("prop_box_wood03a"), -1112.66f, 4929.268f, 217.1752f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_101[0], 12.24288f, -0.014582f, 27.06056f, 2, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_101[1], 7.733739f, 9.432779f, -2.865618f, 2, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_101[2], 3.735082f, 4.551246f, 86.30917f, 2, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_101[3], 0.240341f, 1.095195f, 36.59031f, 2, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_101[4], 7.6772f, 1.232743f, 93.27483f, 2, 1);
ENTITY::SET_ENTITY_ROTATION(iLocal_101[5], 3.367802f, -5.14387f, 97.30567f, 2, 1);
if(func_132() < 50){
...
var func__133(var uParam0, bool bParam1, int iParam2){
var uVar0;
...
var func__135(struct<2> Param0, Vector3 vParam1, struct<2> Param2, var uParam3){
...
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
if(WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_141(iVar2, iVar6))){
if(func_140(func_141(iVar2, iVar6))){
iVar7=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_141(iVar2, iVar6));
}}}
iVar6++;
}
...
WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_141(iVar2, iVar8));
...
if(fLocal_85 >=0f){
OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_42073[10 /*31*/], fLocal_85, 0, 1);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42073[10 /*31*/], 4, 0, 1);
}
if(fLocal_84 < 0f){
fLocal_84=(fLocal_84 + (0.6f / (1f / MISC::GET_FRAME_TIME())));
}else{
fLocal_84=0f;
}
if(fLocal_84 <=0f){
OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_42073[9 /*31*/], fLocal_84, 0, 1);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42073[9 /*31*/], 4, 0, 1);
}}
...
fLocal_87=0.75f;
fLocal_86=0.999f;
}elseif(Global_113810.f_24998.f_5 >=2){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_97, 0)){
if(VEHICLE::IS_VEHICLE_STOPPED(uLocal_97)){
iLocal_91++;
}}}else{
uLocal_97=PLAYER::GET_PLAYERS_LAST_VEHICLE();
if(!PED::IS_PED_INJURED(uLocal_95[0]) && !PED::IS_PED_INJURED(uLocal_95[1])){
TASK::CLEAR_PED_TASKS(uLocal_95[0]);
PED::REMOVE_PED_FROM_GROUP(uLocal_95[0]);
TASK::CLEAR_PED_TASKS(uLocal_95[1]);
PED::REMOVE_PED_FROM_GROUP(uLocal_95[1]);
}
iLocal_91++;
}}
break;
...
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_97, Local_52, 13f, 13f, 13f, 0, 1, 0)){
ENTITY::SET_ENTITY_COORDS(iLocal_97, -1028.415f, 4924.863f, 205.9386f, 0, 0, 0, 1);
if(!ENTITY::IS_ENTITY_DEAD(iLocal_97, 0)){
ENTITY::SET_ENTITY_HEADING(iLocal_97, 149.8882f);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_97, 1084227584);
}}}
MISC::CLEAR_AREA(Local_52, 12f, 1, 0, 0, 0);
...
if(!PED::IS_PED_INJURED(uLocal_95[0]) && !PED::IS_PED_INJURED(uLocal_95[1])){
ENTITY::SET_ENTITY_COORDS(uLocal_95[0], Vector(205.5761f, 4915.152f, -1035.625f) - Vector(0f, 0f, 1f), 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(uLocal_95[0], 128.2065f);
ENTITY::SET_ENTITY_COORDS(uLocal_95[1], Vector(205.5761f, 4915.152f, -1035.625f) - Vector(0f, 1f, 0f), 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(uLocal_95[1], 128.2065f);
}
iLocal_96[0]=PED::CREATE_PED(26, joaat("a_m_o_acult_02"), -1042.56f, 4913.516f, 207.0988f, 282.4169f, 1, 1);
func_100(&uLocal_269, 1, iLocal_96[0], "ACULTMember1", 0, 1);
if(Global_113810.f_24998.f_5 >=2){
iLocal_96[1]=PED::CREATE_PED(26, joaat("a_m_o_acult_02"), -1041.757f, 4908.49f, 207.2777f, 305.3168f, 1, 1);
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_96[0], 1);
iLocal_99=WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_assaultrifle"), -1, ENTITY::GET_ENTITY_COORDS(iLocal_96[0], 1), 1, 1065353216, 0, 0, 1);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_99, iLocal_96[0], PED::GET_PED_BONE_INDEX(iLocal_96[0], 60309), 0.12f, 0.028f, -0.003f, -82.208f, -7.06f, -8.038f, 0, 0, 0, 0, 2, 1, 0);
if(Global_113810.f_24998.f_5 < 2){
uLocal_98=OBJECT::CREATE_OBJECT(joaat("prop_anim_cash_pile_02"), Local_51, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_98, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}elseif(Global_113810.f_24998.f_5 >=2){
WEAPON::GIVE_WEAPON_TO_PED(iLocal_96[1], joaat("weapon_assaultrifle"), -1, 1, 1);
}
uLocal_104=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
uLocal_90=PED::CREATE_SYNCHRONIZED_SCENE(-1044.636f, 4915.204f, 212.32f, 0f, 0f, 110.52f, 2);
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_90, "random@altruist_cult", sLocal_263, 1000f, -2f, 4, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_96[0], uLocal_90, "random@altruist_cult", sLocal_261, 1000f, -2f, 4, 0, 1148846080, 0);
if(Global_113810.f_24998.f_5 >=2){
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_96[1], uLocal_90, "random@altruist_cult", sLocal_262, 1000f, -2f, 4, 0, 1148846080, 0);
}
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_104, uLocal_90, sLocal_266, "random@altruist_cult");
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
if(!PED::IS_PED_INJURED(uLocal_95[0]) && !PED::IS_PED_INJURED(uLocal_95[1])){
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_95[0], uLocal_90, "random@altruist_cult", sLocal_264, 1000f, -2f, 4, 0, 1148846080, 0);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_95[1], uLocal_90, "random@altruist_cult", sLocal_265, 1000f, -2f, 4, 0, 1148846080, 0);
}
iLocal_91++;
break;
case 2:
if(!PED::IS_PED_INJURED(uLocal_95[0])){
if(PED::IS_PED_MALE(uLocal_95[0])){
func_182(uLocal_95[0], "WHIMPER", "WAVELOAD_PAIN_MALE", 3);
}else{
func_182(uLocal_95[0], "WHIMPER", "WAVELOAD_PAIN_FEMALE", 3);
}}
if(!PED::IS_PED_INJURED(uLocal_95[1])){
if(PED::IS_PED_MALE(uLocal_95[1])){
func_182(uLocal_95[1], "WHIMPER", "WAVELOAD_PAIN_MALE", 3);
}else{
func_182(uLocal_95[1], "WHIMPER", "WAVELOAD_PAIN_FEMALE", 3);
}}
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_90) > fLocal_87){
iLocal_91++;
}
break;
case 3:
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_90) > fLocal_86){
iLocal_91++;
}
break;
case 4:
...
OBJECT::DELETE_OBJECT(&iLocal_98);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_99)){
OBJECT::DELETE_OBJECT(&iLocal_99);
}
...
}}elseif(MISC::IS_BIT_SET(Global_113810.f_20567.f_471, bParam0) || MISC::IS_BIT_SET(Global_2359296[func_167() /*5568*/].f_681.f_10, bParam0)){
bVar0=true;
MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), bParam0);
...
var func__169(int iParam0, var uParam1){
...
return MISC::IS_BIT_SET(Global_2359296[func_167() /*5568*/].f_681.f_10, iParam0);
}
...
var func__175(int iParam0, int iParam1){
if(iParam1==-1){
iParam1=func_27();
}
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(uParam0, sParam1, sParam2, func_183(iParam3), 0);
}
...
fLocal_87=0.8f;
fLocal_86=0.968f;
}elseif(Global_113810.f_24998.f_5==1){
...
fLocal_87=0.77f;
fLocal_86=0.999f;
}elseif(Global_113810.f_24998.f_5 >=3){
sLocal_267="ACULT_CAPT";
sLocal_261="cult_p7_guard_01";
sLocal_262="cult_p7_guard_02";
sLocal_263="cult_p7_trv";
...
if(VEHICLE::IS_VEHICLE_STOPPED(iLocal_97)){
iLocal_91++;
}}}else{
...
settimerb(0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_96[0], 1);
iLocal_98=OBJECT::CREATE_OBJECT(joaat("prop_anim_cash_pile_02"), Local_51, 1, 1, 0);
iLocal_99=WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_assaultrifle"), -1, ENTITY::GET_ENTITY_COORDS(iLocal_96[0], 1), 1, 1065353216, 0, 0, 1);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_99, iLocal_96[0], PED::GET_PED_BONE_INDEX(iLocal_96[0], 60309), 0.12f, 0.028f, -0.003f, -82.208f, -7.06f, -8.038f, 0, 0, 0, 0, 2, 1, 0);
if(Global_113810.f_24998.f_5 < 3){
if(Global_113810.f_24998.f_5==0){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_98, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), 60309), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}else{
...
if(Global_113810.f_24998.f_5==1 || Global_113810.f_24998.f_5==2){
if((PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_90) > 0.9742857f && !iLocal_83) && CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==4){
...
settimerb(0);
if(ENTITY::DOES_ENTITY_EXIST(iLocal_96[0])){
ENTITY::SET_ENTITY_VISIBLE(iLocal_96[0], 0, 0);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_96[1])){
ENTITY::SET_ENTITY_VISIBLE(iLocal_96[1], 0, 0);
}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_95[0])){
ENTITY::SET_ENTITY_VISIBLE(uLocal_95[0], 0, 0);
}
iLocal_91++;
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_98)){
...
PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 1f, 750, 0, 1, 0, 0);
}
if(MISC::ARE_STRINGS_EQUAL(sLocal_266, "cult_p4_cam")){
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
}else{
CAM::STOP_RENDERING_SCRIPT_CAMS_USING_CATCH_UP(0, 0, 3, 0);
}
...
PED::GET_GROUP_SIZE(func_190(), &uLocal_88, &iLocal_89);
if(iLocal_89==1){
uLocal_95[0]=PED::GET_PED_AS_GROUP_MEMBER(func_190(), 0);
if(ENTITY::IS_ENTITY_AT_COORD(uLocal_95[0], Local_52, 5f, 5f, 5f, 0, 1, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
uLocal_95[0]=PED::GET_PED_AS_GROUP_MEMBER(func_190(), 0);
uLocal_95[1]=PED::GET_PED_AS_GROUP_MEMBER(func_190(), 1);
if(ENTITY::IS_ENTITY_AT_COORD(uLocal_95[0], Local_52, 5f, 5f, 5f, 0, 1, 0) && ENTITY::IS_ENTITY_AT_COORD(uLocal_95[1], Local_52, 5f, 5f, 5f, 0, 1, 0)){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)){
VEHICLE::BRING_VEHICLE_TO_HALT(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 10.5f, 5, 0);
}
...
if(func_195()){
if(iLocal_258==0){
iLocal_258=PED::ADD_SCENARIO_BLOCKING_AREA(Local_51 - Vector(100f, 60f, 80f), Local_51 + Vector(100f, 60f, 80f), 0, 1, 1, 1);
}
while (MISC::GET_DISTANCE_BETWEEN_COORDS(func_96(PLAYER::PLAYER_ID()), Local_51, 1) < 209f){
wait(0);
}}
...
if(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Global_42073[9 /*31*/].f_2, 6f, Global_42073[9 /*31*/].f_5, 0)){
OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(Global_42073[9 /*31*/].f_5, Global_42073[9 /*31*/].f_2, 0, 0f, 0);
}
if(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Global_42073[10 /*31*/].f_2, 6f, Global_42073[10 /*31*/].f_5, 0)){
OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(Global_42073[10 /*31*/].f_5, Global_42073[10 /*31*/].f_2, 0, 0f, 0);
}
bLocal_82=true;
iLocal_81=0;
}}elseif(!iLocal_81){
...
int func_193(){
if((((((MISC::IS_BULLET_IN_ANGLED_AREA(Local_53, Local_54, fLocal_55, 1) || MISC::IS_BULLET_IN_ANGLED_AREA(Local_56, Local_57, fLocal_58, 1)) || MISC::IS_BULLET_IN_ANGLED_AREA(Local_59, Local_60, fLocal_61, 1)) || MISC::IS_BULLET_IN_ANGLED_AREA(Local_62, Local_63, fLocal_64, 1)) || MISC::IS_BULLET_IN_ANGLED_AREA(Local_65, Local_66, fLocal_67, 1)) || MISC::IS_BULLET_IN_ANGLED_AREA(Local_68, Local_69, fLocal_70, 1)) || MISC::IS_BULLET_IN_ANGLED_AREA(Local_71, Local_72, fLocal_73, 1)){
return 1;
}
return 0;
}
...
int func_194(){
if((((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_53, Local_54, fLocal_55, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_56, Local_57, fLocal_58, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_59, Local_60, fLocal_61, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_62, Local_63, fLocal_64, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_65, Local_66, fLocal_67, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_68, Local_69, fLocal_70, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_71, Local_72, fLocal_73, 0, 1, 0)){
return 1;
}
return 0;
}
...
if(Global_113810.f_24998.f_5 >=iLocal_94 && Global_113810.f_24998.f_5 !=1000){
if(bLocal_74){
func_1(1);
func_11();
func_3(0);
...
iLocal_81=0;
func_97();
Global_113810.f_24998.f_5=(iLocal_94 - 1);
SCRIPT::TERMINATE_THIS_THREAD();
}}else{
