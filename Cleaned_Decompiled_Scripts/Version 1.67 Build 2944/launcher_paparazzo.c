...
if(!func_277(&iVar2, &Var0, Var1, 5f)){
func_276();
...
if(Var0.f_0==47){
func_207(&Var0, Var1, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
}elseif(Var0.f_0==51){
func_207(&Var0, Var1, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
}
func_206(Var0.f_0);
func_198(&iLocal_53, &(Var0.f_9), Var1);
if(func_183(&Var0, 0)){
if(func_182(Var0.f_0)){
func_179(Var0.f_0, &uLocal_55);
}
if(!func_2(&Var0)){
func_280(&Var0, 1);
}
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_159(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1, 0)){
...
var func__180(struct<3> Param0, int iParam1){
var uVar0;
...
return 0;
}}elseif(func_136(uParam0->f_28[0])){
if(func_185(uParam0)){
if(func_189(2)){
if(func_187(uParam0->f_27)){
func_186(uParam0->f_27, *uParam0);
...
int func_207(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7){
var uVar0;
if((((func_136(PLAYER::PLAYER_PED_ID()) && func_136(iParam0->f_28[0])) && !func_156()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam6) && func_202(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7){
uVar0=16;
func_210(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
func_208(&uVar0, cParam2, sParam3, 7, 0, 0);
...
Vector3 func__227(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar2;
Var0={
func_231(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var1={
func_231(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__231(struct<3> Param0){
float fVar0;
float fVar1;
fVar0=vmag(Param0);
if(fVar0 !=0f){
...
float fVar2;
Var0={
func_231(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) 
};
if(fParam2 < 0.1f || fParam2 > 360f){
return 1;
}
...
break;
case 1:
if(!func_260(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1)){
return 0;
}
iLocal_49=2;
break;
...
void func_252(var uParam0, var uParam1, struct<3> Param2, float fParam3){
func_217(uParam0);
...
void func_253(var uParam0, var uParam1, struct<3> Param2, float fParam3){
func_254(uParam0);
...
void func_255(var uParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4){
func_256(uParam0);
...
int func_257(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_258(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
int func_258(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
int iVar0;
if(!func_36(iParam1)){
...
break;
case 1:
if(!func_260(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4)){
return 0;
}
iLocal_49=2;
break;
...
case 3:
if(func_136(uParam0->f_41[0])){
uLocal_52=PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(uParam0->f_41[0], 1), ENTITY::GET_ENTITY_ROTATION(uParam0->f_41[0], 2), 2);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], uLocal_52, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1148846080);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_52, 1);
if(func_136(uParam0->f_28[0])){
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_52, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
}
if(func_136(uParam0->f_41[1])){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], uLocal_52, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1148846080);
}
if(func_136(uParam0->f_41[2])){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], uLocal_52, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1148846080);
}}
iVar5=0;
while (iVar5 <=(iVar0 - 1)){
...
uLocal_52=PED::CREATE_SYNCHRONIZED_SCENE(-71.283f, 301.557f, 106.711f, 0f, 0f, 4.659f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_52, 1);
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_52, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
