...
iVar0=200;
iVar1=(ENTITY::GET_ENTITY_HEALTH(iLocal_84) - 800);
if(ENTITY::IS_ENTITY_UPSIDEDOWN(iLocal_84)){
ENTITY::SET_ENTITY_HEALTH(iLocal_84, (ENTITY::GET_ENTITY_HEALTH(iLocal_84) - 5), 0);
}
if(iVar1 <=0){
iLocal_36=4;
}elseif(iVar1 < 75){
...
void func_7(){
int iVar0;
iVar0=(iLocal_72 - MISC::GET_GAME_TIMER());
if(iVar0 < 0){
iVar0=0;
}
if(MISC::GET_GAME_TIMER() >=iLocal_76){
...
switch (iLocal_73){
case 0:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 10000)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
case 1:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 9000)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
...
break;
case 3:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 7000)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
case 4:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 6000)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
case 5:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 5000)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
case 6:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 4500)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
case 7:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 4000)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
case 8:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 3500)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
case 9:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 3000)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
case 10:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 2500)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
case 11:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 2000)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
case 12:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 1500)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
case 13:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 1000)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
case 14:
if(MISC::GET_GAME_TIMER() >=(iLocal_72 - 500)){
AUDIO::PLAY_SOUND_FRONTEND(-1, "10_SEC_WARNING", "HUD_MINI_GAME_SOUNDSET", 1);
iLocal_73++;
}
break;
...
if(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_62, 50f, 50f, 50f, 0, 1, 0)){
...
if(!PED::IS_PED_INJURED(iLocal_83[iVar0])){
TASK::TASK_SMART_FLEE_PED(iLocal_83[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_83[iVar0], 1);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_83[iVar0]));
}
...
if(func_21(&uLocal_37, Local_63, Global_22, 1, iLocal_84, sLocal_90, "", sLocal_91, 1, 0, 1, -1)){
func_19(iLocal_84, 10.5f, 2, 1056964608, 0, 1, 0);
TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 2000, 0);
VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(iLocal_84, 0);
func_14(&uLocal_37, 1, 0);
func_13();
}
iVar1=0;
while (iVar1 < iLocal_82){
if(!PED::IS_PED_INJURED(iLocal_82[iVar1])){
if(!HUD::DOES_BLIP_EXIST(uLocal_87[iVar1])){
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_82[iVar1], uLocal_106);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_106);
PED::SET_PED_KEEP_TASK(iLocal_82[iVar1], 1);
}
if(!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_82[iVar1], PLAYER::PLAYER_PED_ID(), 100f, 100f, 100f, 0, 1, 0)){
if(HUD::DOES_BLIP_EXIST(uLocal_87[iVar1])){
HUD::REMOVE_BLIP(&(uLocal_87[iVar1]));
}
TASK::TASK_SMART_FLEE_PED(iLocal_82[iVar1], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_82[iVar1], 1);
ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(iLocal_82[iVar1]));
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_87[iVar1])){
HUD::REMOVE_BLIP(&(uLocal_87[iVar1]));
}
iVar1++;
}}
...
var func__31(struct<3> Param0, int iParam1){
var uVar0;
...
if(iLocal_34 <=2){
iLocal_72=(CLOCK::GET_MILLISECONDS_PER_GAME_MINUTE() * ((60 * iLocal_74) + iLocal_75));
iLocal_72=(iLocal_72 + MISC::GET_GAME_TIMER());
iLocal_76=(iLocal_72 - CLOCK::GET_MILLISECONDS_PER_GAME_MINUTE() * 30);
}elseif(iLocal_34 > 6){
iLocal_72=(CLOCK::GET_MILLISECONDS_PER_GAME_MINUTE() * ((60 * iLocal_74) + iLocal_75));
iLocal_72=(iLocal_72 + MISC::GET_GAME_TIMER());
iLocal_76=(iLocal_72 - CLOCK::GET_MILLISECONDS_PER_GAME_MINUTE() * 30);
}elseif(iLocal_34 >=3 && iLocal_34 <=4){
iLocal_85=VEHICLE::CREATE_VEHICLE(iLocal_81, Local_64, fLocal_66, 1, 1, 0);
iLocal_83[0]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_85, 6, iLocal_79, -1, 1, 1);
iLocal_83[1]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_85, 6, iLocal_79, 0, 1, 1);
PED::ADD_RELATIONSHIP_GROUP("rghCop", &uLocal_104);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(4, uLocal_104, joaat("player"));
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_83[0], 39, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_83[1], 39, 1);
iVar0=0;
while (iVar0 < iLocal_83){
WEAPON::GIVE_WEAPON_TO_PED(iLocal_83[iVar0], joaat("weapon_pistol"), -1, 0, 1);
PED::SET_PED_SEEING_RANGE(iLocal_83[iVar0], 100f);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_83[iVar0], uLocal_104);
iVar0++;
}}
iLocal_36=2;
}}
...
if(func_101() || PED::IS_PED_INJURED(iLocal_82[0])){
iVar0=0;
...
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_82[iVar0], 1, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_106);
TASK::TASK_LEAVE_ANY_VEHICLE(0, 0, 0);
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_106);
TASK::TASK_PERFORM_SEQUENCE(iLocal_82[iVar0], uLocal_106);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_106);
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_87[iVar0])){
HUD::REMOVE_BLIP(&(uLocal_87[iVar0]));
}
iVar0++;
}}elseif(!iLocal_71){
if(!PED::IS_PED_INJURED(iLocal_82[0])){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_82[0], 50f, 50f, 50f, 0, 1, 0)){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_82[0], iLocal_84, PLAYER::PLAYER_PED_ID(), 8, 25f, 786469, -1f, -1f, 1);
iLocal_71=1;
}}}
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_84, 0)){
if(HUD::DOES_BLIP_EXIST(uLocal_88)){
...
func_100(&uLocal_92, 0, 0);
iLocal_36=2;
}elseif(VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_84, -1, 0) || PED::IS_PED_INJURED(iLocal_82[0])){
func_100(&uLocal_92, 0, 0);
}else{
func_67();
}}}
...
void func_67(){
if(!PED::IS_PED_INJURED(iLocal_82[0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_84, 0)){
if(PED::IS_PED_IN_VEHICLE(iLocal_82[0], iLocal_84, 0)){
func_68(&uLocal_92, iLocal_84, 0, 0, 1, 1, 1);
}}}
...
}elseif((Global_1575063 && iParam0==PLAYER::PLAYER_ID()) && func_79(iParam0, 1, 0)){
return Global_2657704[iParam0 /*463*/].f_321.f_7 !=-1;
}}
return 0;
}
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_84)){
if(!ENTITY::IS_ENTITY_DEAD(iLocal_84, 0)){
if((((((ENTITY::GET_ENTITY_HEALTH(iLocal_84) < 300 || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_84) < 200f) || FIRE::IS_ENTITY_ON_FIRE(iLocal_84)) || (VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_84, 0, 0) && VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_84, 1, 0))) || (VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_84, 4, 0) && VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_84, 5, 0))) || (VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_84, 0, 0) && VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_84, 4, 0))) || (VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_84, 1, 0) && VEHICLE::IS_VEHICLE_TYRE_BURST(iLocal_84, 5, 0))){
return 1;
}}}
return 0;
}
...
int iVar0;
int iVar1;
iLocal_84=func_104(0);
if(!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_84, 0)){
iLocal_84=VEHICLE::CREATE_VEHICLE(iLocal_80, Local_62, uLocal_65, 1, 1, 0);
iVar0=1;
while (iVar0 <=8){
VEHICLE::SET_VEHICLE_EXTRA(iLocal_84, iVar0, 1);
iVar0++;
}
if(iLocal_77 !=-1){
VEHICLE::SET_VEHICLE_EXTRA(iLocal_84, iLocal_77, 0);
}}
VEHICLE::SET_VEHICLE_IS_WANTED(iLocal_84, 1);
uLocal_88=func_103(iLocal_84, 0, 0);
if(iLocal_34 !=5 && iLocal_34 !=6){
if(iLocal_34 > 6){
ENTITY::SET_ENTITY_PROOFS(iLocal_84, 0, 0, 0, 0, 1, 0, 0, 0);
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "BAR_DELIVER_BOOZE_RATTLE_MASTER", iLocal_84, 0, 0, 0);
}
func_35(sLocal_89, 7500, 1);
}else{
iLocal_82[0]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_84, 26, iLocal_78, -1, 1, 1);
iLocal_82[1]=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_84, 26, iLocal_78, 0, 1, 1);
PED::ADD_RELATIONSHIP_GROUP("rghCriminal", &uLocal_105);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_105, joaat("player"));
iVar1=0;
while (iVar1 < iLocal_82){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_82[iVar1], 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_82[iVar1], joaat("weapon_sawnoffshotgun"), -1, 0, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_82[iVar1], uLocal_105);
iVar1++;
}
TASK::TASK_VEHICLE_DRIVE_WANDER(iLocal_82[0], iLocal_84, 25f, 786599);
func_35("PMDL_REC", 7500, 1);
}
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0)){
iLocal_86=PLAYER::GET_PLAYERS_LAST_VEHICLE();
}
iLocal_36=1;
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112519.f_222[iParam0], 0)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_112519.f_222[iParam0], 1, 1);
...
if(ENTITY::DOES_ENTITY_EXIST(iLocal_84)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_84, 0)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_84, PLAYER::PLAYER_PED_ID(), 300f, 300f, 300f, 0, 1, 0)){
return 1;
}}else{
return 1;
}}
...
}elseif(iLocal_34==5 || iLocal_34==6){
...
if(STREAMING::HAS_MODEL_LOADED(iLocal_80) && HUD::HAS_ADDITIONAL_TEXT_LOADED(0)){
if(iLocal_34 >=3 && iLocal_34 <=4){
if(STREAMING::HAS_MODEL_LOADED(iLocal_79) && STREAMING::HAS_MODEL_LOADED(iLocal_81)){
bLocal_67=true;
}}elseif(iLocal_34==5 || iLocal_34==6){
...
float fVar0;
Local_62={
func_109(func_111(), iLocal_34) 
};
fLocal_65=func_108(func_111(), iLocal_34);
if(iLocal_34 > 6){
...
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(Local_62, Local_63, 1);
iLocal_75=round((((fVar0 / 16.5f) + 40f) / 2f));
}elseif(func_111()==13){
Local_63={
...
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(Local_62, Local_63, 1);
iLocal_75=round((((fVar0 / 16.5f) + 15f) / 2f));
}elseif(func_111()==11){
Local_63={
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_141(iParam0, 0, 0)) || func_141(iParam0, 1, 0)) || func_141(iParam0, 2, 0)) || func_140(iParam0) !=145) || func_139(iParam0)) || func_138(iParam0)) || func_137(iParam0)) || func_136(iParam0)) || !func_123(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_138(iParam0)){
}
if(func_138(iParam0)){
}
