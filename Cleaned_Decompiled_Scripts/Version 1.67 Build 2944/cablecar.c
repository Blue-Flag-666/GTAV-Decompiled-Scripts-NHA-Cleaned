...
func_288();
Local_198.f_25=(MISC::GET_GAME_TIMER() + iLocal_61);
Local_199.f_25=(MISC::GET_GAME_TIMER() + iLocal_61);
func_287(iLocal_237);
func_286(fLocal_236);
func_285(Local_235);
func_285(Local_234);
...
if(CAM::IS_SCREEN_FADED_IN() && iLocal_78==0){
if(func_4()){
Var0={
CAM::GET_FINAL_RENDERED_CAM_COORD() 
};
...
if(MISC::GET_GAME_TIMER() > iLocal_228){
Var0={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
HUD::SET_MINIMAP_FOW_REVEAL_COORDINATE(Var0);
iLocal_228=MISC::GET_GAME_TIMER() + 5000;
}}}}
if((iLocal_230==0 && MISC::GET_MISSION_FLAG()) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("bailbond3"))==0){
func_284(&Local_198);
func_284(&Local_199);
...
if(iLocal_230==1 && !MISC::GET_MISSION_FLAG()){
func_1(&Local_198);
func_1(&Local_199);
iLocal_230=0;
}
...
if(uParam0->f_26){
uParam0->f_14=func_8(uParam0->f_14, to_float(-uParam0->f_21), to_float(uParam0->f_21));
uParam0->f_14.f_1=func_8(uParam0->f_14.f_1, to_float(-uParam0->f_22), to_float(uParam0->f_22));
uParam0->f_14.f_2=func_8(uParam0->f_14.f_2, to_float(-uParam0->f_20), to_float(uParam0->f_20));
}
...
if(MISC::GET_GAME_TIMER() < (uParam0->f_26 + iLocal_60)){
return;
}
Var0={
func_14(&(Local_62[uParam0->f_15 /*49*/]), 0, &iVar1) 
};
Var0={
...
Vector3 func__15(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(bParam3){
...
if(iLocal_226==1){
fLocal_227=(fLocal_227 + MISC::GET_FRAME_TIME());
STREAMING::SET_SRL_TIME(fLocal_227);
}
...
uParam0->f_30=MISC::GET_DISTANCE_BETWEEN_COORDS(Local_62[uParam0->f_15 /*49*/][uParam0->f_18 /*3*/], Local_62[uParam0->f_15 /*49*/][uParam0->f_18 + 1 /*3*/], 1);
if(uParam0->f_11==1){
...
if(!uParam0->f_33){
uParam0->f_16=(uParam0->f_16 + ((fLocal_59 * timestep()) * fLocal_57));
...
uParam0->f_16=(uParam0->f_16 - (((fLocal_59 * timestep()) * fLocal_57) * 2f));
if(uParam0->f_16 <=0f){
uParam0->f_16=0f;
*uParam0=8;
...
}}elseif(!func_239(PLAYER::PLAYER_PED_ID(), uParam0, 1.1f, 0)){
*uParam0=10;
AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "DOOR_CLOSE", uParam0->f_2, "CABLE_CAR_SOUNDS", 0, 0);
uParam0->f_11=0;
}
...
*uParam0=1;
uParam0->f_25=(MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE((iLocal_61 - 8000), iLocal_61 + 8000));
...
func_35(uParam0, 0);
return;
}elseif(STREAMING::STREAMVOL_IS_VALID(uLocal_50)){
STREAMING::STREAMVOL_DELETE(uLocal_50);
}
*uParam0=12;
return;
case 12:
...
if(fVar0 !=0f){
fVar2=((fVar0 * timestep()) * fLocal_57);
if(!func_4()){
...
uParam0->f_9=0;
uParam0->f_12={
Local_62[uParam0->f_15 /*49*/][uParam0->f_18 /*3*/] 
};
...
uParam0->f_12={
func_15(Local_62[uParam0->f_15 /*49*/][uParam0->f_18 /*3*/], Local_62[uParam0->f_15 /*49*/][uParam0->f_18 + 1 /*3*/], uParam0->f_19, 1) 
};
func_19(uParam0);
}
...
if(uParam0->f_18 < (Local_62[uParam0->f_15 /*49*/].f_46 - 1)){
uParam0->f_12={
func_14(&(Local_62[uParam0->f_15 /*49*/]), uParam0->f_18, &(uParam0->f_19)) 
};
func_19(uParam0);
}
uParam0->f_20=(uParam0->f_20 + MISC::GET_DISTANCE_BETWEEN_COORDS(uParam0->f_12, Var1, 1));
...
bLocal_77=false;
if(STREAMING::STREAMVOL_IS_VALID(uLocal_50)){
STREAMING::STREAMVOL_DELETE(uLocal_50);
}
func_107(uParam0);
if(bParam1){
...
func_27();
wait(0);
func_105(ENTITY::GET_ENTITY_COORDS(uParam0->f_2, 1), 50f, 13, 5000, 1, 1);
func_39(PLAYER::PLAYER_PED_ID(), uParam0);
...
if(uParam0->f_24==0){
PLAYER::SIMULATE_PLAYER_INPUT_GAIT(PLAYER::PLAYER_ID(), 1f, 1000, 0, 1, 0, 0);
}}
if(func_303(PLAYER::PLAYER_PED_ID())){
if(func_239(PLAYER::PLAYER_PED_ID(), uParam0, 0, 0)){
if(AUDIO::IS_AUDIO_SCENE_ACTIVE("CABLE_CAR_RIDE_UP_SCENE")){
...
uParam0->f_12={
func_14(&(Local_62[uParam0->f_15 /*49*/]), iParam1, &fParam2) 
};
if(func_303(uParam0->f_2)){
ENTITY::SET_ENTITY_COORDS(uParam0->f_2, uParam0->f_12 + Vector(-0.2f, 0f, 0f), 1, 0, 0, 1);
}
...
if(iParam0==1){
func_110(&Local_67, Var0, ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2) + Vector(0f, 0f, fLocal_66), 50f, Local_67.f_20, Local_67.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
}else{
func_110(&Local_67, Var0, ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2), 50f, Local_67.f_20, Local_67.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
}
CAM::ATTACH_CAM_TO_ENTITY(Local_67.f_0, PLAYER::PLAYER_PED_ID(), 0f, 0.2f, 0.5f, 1);
iLocal_51=1;
bLocal_77=true;
}
...
Var0.f_0=-1f;
ENTITY::SET_ENTITY_COORDS(func_95(), ENTITY::GET_ENTITY_COORDS(uParam0->f_2, 1), 1, 0, 0, 1);
if(ENTITY::IS_ENTITY_ATTACHED(func_95())){
ENTITY::DETACH_ENTITY(func_95(), 1, 1);
}
Var0.f_1=(Var0.f_1 * uParam0->f_17);
if(uParam0->f_17==-1f){
ENTITY::ATTACH_ENTITY_TO_ENTITY(func_95(), uParam0->f_2, 0, Var0, 0f, 0f, 180f, 0, 0, 0, 0, 2, 1, 0);
}else{
ENTITY::ATTACH_ENTITY_TO_ENTITY(func_95(), uParam0->f_2, 0, Var0, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}
...
func_137(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
func_160(14);
if(Global_78470==1){
iVar2=0;
while (iVar2 < 15){
...
if(iParam4==-1){
PED::SET_PED_COMPONENT_VARIATION(uParam0, func_127(iVar0), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_127(iVar0)));
}
else{
PED::SET_PED_COMPONENT_VARIATION(uParam0, func_127(iVar0), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
}
func_160(iVar0);
if(Global_78470==1){
iVar2=0;
...
Global_78472[1 /*14*/]={
func_165(iVar10, iVar0, func_126(uParam0, iVar0, -1), -1) 
};
...
if(iParam4==-1){
PED::SET_PED_COMPONENT_VARIATION(uParam0, func_127(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_127(iParam1)));
}else{
PED::SET_PED_COMPONENT_VARIATION(uParam0, func_127(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
}
if(Global_78470==1){
iVar2=0;
while (iVar2 < 15){
...
if(!func_229(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_64, Global_113810.f_2366.f_539[iVar0 /*65*/].f_63)){
...
if(!func_229(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_61, Global_113810.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3==1){
...
if(func_138(ENTITY::GET_ENTITY_MODEL(uParam0), 14, iVar0, FILES::GET_HASH_NAME_FOR_PROP(uParam0, 0, iParam2, iParam3))){
...
return func_144(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 3);
}elseif(iVar0==joaat("mp_f_freemode_01")){
return func_144(ENTITY::GET_ENTITY_MODEL(uParam0), iVar1, 14, 4);
}}
...
if(PED::GET_PED_PROP_INDEX(uParam0, Global_78472[1 /*14*/].f_12, 1)==Global_78472[1 /*14*/].f_3 && (PED::GET_PED_PROP_TEXTURE_INDEX(uParam0, Global_78472[1 /*14*/].f_12)==Global_78472[1 /*14*/].f_4 || Global_78472[1 /*14*/].f_3==-1)){
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_127(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(uParam0, func_127(iParam1))){
return 1;
}
return 0;
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_235(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
func_245(&Var0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam1->f_2, 0f, 2.75f, Local_54.f_2) + Vector(1f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam1->f_2, 0f, -2.75f, Local_54.f_2) - Vector(1f, 0f, 0f), 3f);
if(bParam3){
func_242(&Var0, 0, 0, 255, 255);
}
if(fParam2 > 0f){
Var1={
func_240(Var0, fParam2) 
};
...
Var0=2;
Var1={
func_241(Param0[1 /*3*/] - Param0[0 /*3*/]) * Vector(fParam1, fParam1, fParam1) 
};
Var0[0 /*3*/]={
Param0[0 /*3*/] - Var1 
};
...
Var0={
func_241(Param1 - Param0) 
};
Var1={
func_244(Var0, 0f, 0f, 1f) 
};
fVar2=(fParam2 / 2f);
Var3={
Param0 
...
GRAPHICS::DRAW_DEBUG_LINE(Var5[1 /*3*/], Var5[2 /*3*/], uParam3, uParam4, uParam5, uParam6);
GRAPHICS::DRAW_DEBUG_LINE(Var5[2 /*3*/], Var5[3 /*3*/], uParam3, uParam4, uParam5, uParam6);
GRAPHICS::DRAW_DEBUG_LINE(Var5[3 /*3*/], Var5[0 /*3*/], uParam3, uParam4, uParam5, uParam6);
iVar6=0;
while (iVar6 <=3){
Var5[(4 + iVar6) /*3*/]={
Var5[iVar6 /*3*/] 
...
GRAPHICS::DRAW_DEBUG_LINE(Var5[4 /*3*/], Var5[5 /*3*/], uParam3, uParam4, uParam5, uParam6);
GRAPHICS::DRAW_DEBUG_LINE(Var5[5 /*3*/], Var5[6 /*3*/], uParam3, uParam4, uParam5, uParam6);
GRAPHICS::DRAW_DEBUG_LINE(Var5[6 /*3*/], Var5[7 /*3*/], uParam3, uParam4, uParam5, uParam6);
GRAPHICS::DRAW_DEBUG_LINE(Var5[7 /*3*/], Var5[4 /*3*/], uParam3, uParam4, uParam5, uParam6);
GRAPHICS::DRAW_DEBUG_LINE(Var5[0 /*3*/], Var5[4 /*3*/], uParam3, uParam4, uParam5, uParam6);
GRAPHICS::DRAW_DEBUG_LINE(Var5[1 /*3*/], Var5[5 /*3*/], uParam3, uParam4, uParam5, uParam6);
GRAPHICS::DRAW_DEBUG_LINE(Var5[2 /*3*/], Var5[6 /*3*/], uParam3, uParam4, uParam5, uParam6);
GRAPHICS::DRAW_DEBUG_LINE(Var5[3 /*3*/], Var5[7 /*3*/], uParam3, uParam4, uParam5, uParam6);
}


Vector3 func__244(struct<3> Param0, struct<3> Param1){
...
Var0.f_1=(Var0.f_1 + 0.5f);
ENTITY::ATTACH_ENTITY_TO_ENTITY(func_95(), uParam0->f_2, 0, Var0, 0f, 0f, -90f, 0, 0, 0, 0, 2, 1, 0);
}}
...
if(iLocal_232 > 0 && MISC::GET_GAME_TIMER() > iLocal_232){
iLocal_232=0;
return;
}}
...
uLocal_50=STREAMING::STREAMVOL_CREATE_FRUSTUM(Param0, func_258(Param1), iParam2, 12, 127);
iLocal_51=0;
}elseif(STREAMING::STREAMVOL_IS_VALID(uLocal_50)){
if(STREAMING::IS_STREAMVOL_ACTIVE()){
if(STREAMING::STREAMVOL_HAS_LOADED(uLocal_50)){
STREAMING::STREAMVOL_DELETE(uLocal_50);
}}}}
...
uParam0->f_25=(MISC::GET_GAME_TIMER() + iLocal_61);
...
if(MISC::IS_POSITION_OCCUPIED(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_2, Local_55), 1f, 0, 1, 1, 0, 0, 0, 0)){
return;
}
...
func_245(&Var0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam1->f_2, 0f, 2.75f, (Local_54.f_2 + 2.63f)) + Vector(1f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam1->f_2, 0f, -2.75f, (Local_54.f_2 + 2.63f)) - Vector(1f, 0f, 0f), 3f);
if(bParam3){
func_242(&Var0, 0, 0, 255, 255);
}
if(fParam2 > 0f){
...
uParam0->f_12={
func_14(&(Local_62[iParam1 /*49*/]), iParam2, &iParam3) 
};
MISC::CLEAR_AREA_OF_OBJECTS(uParam0->f_12 + Vector(-0.2f, 0f, 0f), 2f, 0);
uParam0->f_2=OBJECT::CREATE_OBJECT(iLocal_63, uParam0->f_12 + Vector(-0.2f, 0f, 0f), 1, 1, 0);
...
uParam0->f_3[0]=OBJECT::CREATE_OBJECT(iLocal_64, uParam0->f_12 + Vector(-0.2f, 0f, 0f), 1, 1, 0);
ENTITY::SET_ENTITY_HEADING(uParam0->f_3[0], uVar0);
uParam0->f_3[1]=OBJECT::CREATE_OBJECT(iLocal_65, uParam0->f_12 + Vector(-0.2f, 0f, 0f), 1, 1, 0);
...
uParam0->f_6[0]=OBJECT::CREATE_OBJECT(iLocal_64, uParam0->f_12 + Vector(-0.2f, 0f, 0f), 1, 1, 0);
uParam0->f_6[1]=OBJECT::CREATE_OBJECT(iLocal_65, uParam0->f_12 + Vector(-0.2f, 0f, 0f), 1, 1, 0);
...
if(func_4()){
func_39(PLAYER::PLAYER_PED_ID(), &Local_198);
func_39(PLAYER::PLAYER_PED_ID(), &Local_199);
if(func_307(PLAYER::PLAYER_PED_ID(), Local_52, 1) < 200f){
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_52, 1, 0, 0, 1);
}elseif(func_307(PLAYER::PLAYER_PED_ID(), Local_53, 1) < 200f){
