...
case 0:
bLocal_260=false;
func_232(&uLocal_93, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
iLocal_259=1;
break;
case 1:
if(!bLocal_260){
...
if(func_315(Local_92.f_28[0])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_28[0], "Nigel", 0, 0, 0);
}
if(func_315(Local_92.f_28[1])){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_92.f_28[1], "MRS_Thornhill", 0, 0, 0);
}
func_314();
...
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_92.f_35[0], 1084227584);
VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(Local_92.f_35[0], 1);
if(func_315(Local_92.f_28[0])){
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_92.f_28[0], joaat("player"));
TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_92.f_28[0]);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_92.f_28[0], 1);
PED::SET_PED_INTO_VEHICLE(Local_92.f_28[0], Local_92.f_35[0], -1);
PED::SET_PED_KEEP_TASK(Local_92.f_28[0], 1);
}
if(func_315(Local_92.f_28[1])){
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_92.f_28[1], joaat("player"));
TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_92.f_28[1]);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_92.f_28[1], 1);
PED::SET_PED_INTO_VEHICLE(Local_92.f_28[1], Local_92.f_35[0], 0);
PED::SET_PED_KEEP_TASK(Local_92.f_28[1], 1);
}
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_92.f_35[0], 1, 1, 0);
TASK::TASK_VEHICLE_DRIVE_WANDER(Local_92.f_28[0], Local_92.f_35[0], 20f, 786603);
}
...
if(iParam4==1){
while (!STREAMING::HAS_MODEL_LOADED(iLocal_79)){
wait(0);
}}elseif(!STREAMING::HAS_MODEL_LOADED(iLocal_79)){
return 0;
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_248(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
if(iParam2==1){
if(func_302(ENTITY::GET_ENTITY_COORDS(Global_104373.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
}}
func_257(Global_104373.f_4, Param0, fParam1, 24, 0);
}}}}
...
func_292(iParam3, &Var0, Param1, uParam2, func_295(iParam0));
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_276(iParam0, 0, 0)) || func_276(iParam0, 1, 0)) || func_276(iParam0, 2, 0)) || func_295(iParam0) !=145) || func_275(iParam0)) || func_274(iParam0)) || func_273(iParam0)) || func_272(iParam0)) || !func_261(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_274(iParam0)){
}
if(func_274(iParam0)){
}
...
return (shift_right(iParam0, 26) & 31 * func_284(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_292(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_289(&(Global_77479.f_555[0 /*21*/]), iParam0)){
...
int func_302(struct<3> Param0, int iParam1, var uParam2, var uParam3){
int iVar0;
iVar0=func_303(Param0, iParam1, 1);
switch (iVar0){
case 0:
*uParam2={
...
int func_303(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
func_307(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}
...
if(!func_321(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
int func_321(int iParam0, var uParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6){
...
case 2:
bVar3=true;
if(!func_347(&(uParam0->f_28[0]), 64, -1100.5f, 789.8f, 164.34f, 1.82f, "RC:
NIGEL", 1)){
bVar3=false;
}
if(!func_347(&(uParam0->f_28[1]), 63, -1099.35f, 789.15f, 164.47f, 0f, "RC:
MRS THORNHILL", 1)){
bVar3=false;
}
...
case 38:
if(bParam1){
uLocal_91=PED::ADD_SCENARIO_BLOCKING_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", 0);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", 0);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", 0);
...
case 39:
if(bParam1){
uLocal_91=PED::ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
...
case 41:
if(bParam1){
uLocal_91=PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
...
case 42:
if(bParam1){
uLocal_91=PED::ADD_SCENARIO_BLOCKING_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
