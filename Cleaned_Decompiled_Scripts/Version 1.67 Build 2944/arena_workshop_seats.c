...
func_35(uParam0);
func_16(uParam0);
uVar9=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_43.f_1);
...
break;
case 8:
uVar10=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uParam0->f_43.f_1);
...
iVar1=0;
while (iVar1 < 10){
if(((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar1]) && !PED::IS_PED_INJURED(uVar0[iVar1])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar1])) && (func_63(uVar0[iVar1], uParam0[uParam0->f_43.f_2 /*14*/]) || vdist2(ENTITY::GET_ENTITY_COORDS(uVar0[iVar1], 0), (uParam0[uParam0->f_43.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_43.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f)){
return 1;
}
iVar1++;
}
...
bool func_82(){
return MISC::IS_BIT_SET(Global_1950844.f_4, 10);
}

int func_83(){
if(Global_2657704[PLAYER::PLAYER_ID() /*463*/].f_321.f_10 !=func_19()){
if(NETWORK::NETWORK_IS_SCRIPT_ACTIVE("arena_workshop_seats", Global_2657704[PLAYER::PLAYER_ID() /*463*/].f_321.f_10, 1, 0)){
return 0;
}
...
func_87(func_89(), func_88(iParam3, fVar1)) + Var0 
};
(uParam1[iParam2 /*14*/])->f_1.f_3={
func_87(func_86(), func_88(iParam3, fVar1)) + Var0 
};
