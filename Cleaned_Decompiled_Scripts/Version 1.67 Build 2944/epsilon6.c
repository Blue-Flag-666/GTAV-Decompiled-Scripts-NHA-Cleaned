...
fLocal_28=180f;
iLocal_31=3;
uLocal_48=func_532(60);
uLocal_49=func_532(14);
iLocal_92=1;
iLocal_102=-1;
iLocal_103=-1;
fLocal_116=300f;
...
Global_78935=1;
iLocal_47=0;
while (!func_492(&Local_51)){
wait(0);
}
Global_78935=0;
}
if(func_491(Local_51.f_35[0])){
Local_52.f_0=Local_51.f_35[0];
func_490(Local_52.f_0, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_52.f_0, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_52.f_0, 1);
}
if(func_489(PLAYER::PLAYER_PED_ID())){
uLocal_622=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
}
if(func_488(Local_51.f_28[0])){
Local_60.f_0=Local_51.f_28[0];
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_60.f_0, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_60.f_0, uLocal_622);
PED::SET_PED_CONFIG_FLAG(Local_60.f_0, 132, 1);
}
func_480();
...
wait(0);
func_459(Local_51.f_9, 0, 0, 0, 0, 0);
...
func_15(&uLocal_457, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
}
switch (iLocal_126){
case 4:
sVar0="EPS6_FAIL";
...
if(bParam0){
func_531("DeleteEverything:
Releasing entities");
func_7(&Local_59, 1, 0, 1);
func_6(&Local_52);
STREAMING::REMOVE_ANIM_DICT(Local_59.f_6);
func_6(&Local_57);
if(func_488(Local_60.f_0)){
if(PED::IS_PED_IN_GROUP(Local_60.f_0)){
PED::REMOVE_PED_FROM_GROUP(Local_60.f_0);
}}
func_7(&Local_60, 1, 0, 1);
}else{
func_5(&Local_52);
func_531("Deleted Plane");
if(ENTITY::DOES_ENTITY_EXIST(Local_52.f_0)){
...
func_9(&(Global_107357.f_2890), Param0, fParam1);
}
...
if(func_491(Local_57.f_0)){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_57.f_0, 1);
}
if(iLocal_125 !=-1){
PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(iLocal_125);
func_531("Navmesh blocking object removed");
}
iLocal_115=(MISC::GET_GAME_TIMER() - 6000);
...
func_244();
if(func_243()){
if(func_242(PLAYER::PLAYER_PED_ID(), Local_52.f_0, 1) > 300f && !ENTITY::IS_ENTITY_ON_SCREEN(Local_52.f_0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_123);
TASK::TASK_PLANE_MISSION(0, Local_52.f_0, 0, 0, 3891.478f, 2298.554f, 301.6707f, 4, 40f, 10f, -1f, 300, 30, 1);
TASK::TASK_PLANE_MISSION(0, Local_52.f_0, 0, 0, 1562.099f, 2167.677f, 329.9366f, 4, 40f, 10f, -1f, 300, 100, 1);
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_123, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_123);
TASK::TASK_PERFORM_SEQUENCE(Local_59.f_0, uLocal_123);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_123);
iLocal_68=2;
}
if(((((!func_22() && !PED::IS_PED_FLEEING(Local_59.f_0)) && !PED::IS_PED_RAGDOLL(Local_59.f_0)) && !PED::IS_PED_PRONE(Local_59.f_0)) && !PED::IS_PED_INJURED(Local_59.f_0)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_59.f_0, 0)){
if(func_242(Local_59.f_0, PLAYER::PLAYER_PED_ID(), 1) <=2.3f){
if((MISC::GET_GAME_TIMER() - iLocal_115) > 8000){
...
switch (iLocal_109){
case 0:
if(PED::IS_PED_SITTING_IN_VEHICLE(Local_59.f_0, Local_52.f_0)){
iLocal_109++;
}
break;
case 1:
if(!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_52.f_0)){
if(VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff")){
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_52.f_0, 501, "Eps6_Takeoff", 1);
VEHICLE::FORCE_PLAYBACK_RECORDED_VEHICLE_UPDATE(Local_52.f_0, 1);
func_531("Started vehicle recording on plane #2");
iLocal_109++;
iLocal_110=MISC::GET_GAME_TIMER();
}}else{
func_531("Unpaused vehicle recording on plane");
VEHICLE::UNPAUSE_PLAYBACK_RECORDED_VEHICLE(Local_52.f_0);
VEHICLE::SET_HELI_BLADES_SPEED(Local_52.f_0, 1f);
iLocal_109++;
iLocal_110=MISC::GET_GAME_TIMER();
}
break;
...
VEHICLE::SET_HELI_BLADES_SPEED(Local_52.f_0, 1f);
if(iLocal_111==0){
if((MISC::GET_GAME_TIMER() - iLocal_110) > 23000){
func_531(" Retracting Jimmy's landing gear");
VEHICLE::CONTROL_LANDING_GEAR(Local_52.f_0, 1);
iLocal_111=1;
}}}else{
TASK::OPEN_SEQUENCE_TASK(&uLocal_123);
TASK::TASK_PLANE_MISSION(0, Local_52.f_0, 0, 0, 3891.478f, 2298.554f, 301.6707f, 4, 40f, 10f, -1f, 300, 30, 1);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_123);
TASK::TASK_PERFORM_SEQUENCE(Local_59.f_0, uLocal_123);
if(func_491(Local_52.f_0)){
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_52.f_0, 1, 1, 0);
}
TASK::CLEAR_SEQUENCE_TASK(&uLocal_123);
iLocal_109++;
}
...
iLocal_68=0;
iLocal_67=6;
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_52.f_0, 0)){
bLocal_99=true;
}
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
}}
...
if(!bLocal_78){
if(func_243()){
if(VEHICLE::GET_LANDING_GEAR_STATE(Local_52.f_0) !=4 || VEHICLE::GET_LANDING_GEAR_STATE(Local_52.f_0) !=1){
...
func_25(13, floor(Global_113810.f_10197.f_3853));
}
...
Global_78472[1 /*14*/]={
func_107(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
Global_78472[1 /*14*/]={
func_107(iVar10, iVar0, func_63(iParam0, iVar0, -1), -1) 
};
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_99(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_99(iParam2));
...
var func__92(int iParam0, var uParam1){
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_99(iParam0));
if(iVar11 > iVar10){
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_99(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_99(iParam1))){
return 1;
}
return 0;
}
...
func_185(&uVar1, Var0.f_3, Global_100870, iParam1, iParam2);
}}
...
}elseif(MISC::IS_PS3_VERSION() || func_193()){
...
int func_243(){
if(func_491(Local_52.f_0)){
if(VEHICLE::GET_LANDING_GEAR_STATE(Local_52.f_0)==5){
func_531("Detected plane landing gear is broken");
return 0;
}elseif(VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(Local_52.f_0)){
func_531("Detected plane is stuck on roof");
return 0;
}elseif(VEHICLE::GET_VEHICLE_ENGINE_HEALTH(Local_52.f_0) <=0f){
func_531("Detected plane engine health is <=0");
return 0;
}elseif(VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(Local_52.f_0, 3, 30000)){
...
void func_244(){
if(func_488(Local_59.f_0)){
if(func_248(Local_59.f_0, 0, 1116471296, 1126825984, 1, 0, 0, 0) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_59.f_0, 1), 3f, 1)){
...
func_246();
}elseif((func_245(PLAYER::PLAYER_PED_ID(), Local_59.f_0, 1) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_59.f_0, 1), 3f, 0)) || PED::IS_PED_BEING_JACKED(Local_59.f_0)){
if(iLocal_67 !=5 && iLocal_67 !=3){
bLocal_99=true;
}
iLocal_126=5;
...
func_246();
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_59.f_0, PLAYER::PLAYER_PED_ID(), 1)){
if(WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(Local_59.f_0, 0, 2)){
if(iLocal_67 !=5 && iLocal_67 !=3){
bLocal_99=true;
}
iLocal_126=8;
...
if(func_489(iParam0) && PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0)){
if(func_489(iParam1)){
...
void func_246(){
if(func_488(Local_59.f_0)){
TASK::CLEAR_PED_TASKS(Local_59.f_0);
PED::SET_PED_KEEP_TASK(Local_59.f_0, 1);
TASK::TASK_SMART_FLEE_PED(Local_59.f_0, PLAYER::PLAYER_PED_ID(), 100f, -1, 0, 0);
}}
...
if(bParam4){
return 0;
}elseif(func_249(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
Vector3 func__253(int iParam0, int iParam1){
int iVar0;
if(iParam1==7){
...
float fVar2;
Var0={
func_257(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var1={
func_257(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
float fVar2;
Var0={
func_257(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
if(fParam2 < 0.1f || fParam2 > 360f){
return 1;
}
...
int func_270(){
if(func_243()){
if(MISC::IS_PROJECTILE_TYPE_WITHIN_DISTANCE(ENTITY::GET_ENTITY_COORDS(Local_52.f_0, 0), joaat("weapon_stickybomb"), 10f, 0)){
...
while ((!STREAMING::HAS_MODEL_LOADED(iLocal_624) || !STREAMING::HAS_MODEL_LOADED(iLocal_623)) || !STREAMING::HAS_ANIM_DICT_LOADED("rcm_epsilonism4")){
...
STREAMING::REQUEST_MODEL(iLocal_623);
STREAMING::REQUEST_MODEL(iLocal_624);
while (!STREAMING::HAS_MODEL_LOADED(iLocal_623) || !STREAMING::HAS_MODEL_LOADED(iLocal_624)){
...
case 2:
STREAMING::REQUEST_MODEL(iLocal_623);
while (!STREAMING::HAS_MODEL_LOADED(iLocal_623)){
...
if(func_243()){
if(!func_272()){
func_277(ENTITY::GET_ENTITY_COORDS(Local_52.f_0, 1), 200f, 12, 5000, 0, 0);
}
if(func_243()){
ENTITY::FREEZE_ENTITY_POSITION(Local_52.f_0, 0);
if(VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(500, "Eps6_LandingSkip")){
if(!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_52.f_0)){
if(!func_272()){
func_531("Doing plane boost");
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_52.f_0, 500, "Eps6_LandingSkip", 1);
}
}}}}
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_623);
break;
case 3:
STREAMING::REQUEST_ANIM_DICT(Local_59.f_6);
STREAMING::REQUEST_MODEL(iLocal_623);
STREAMING::REQUEST_MODEL(Local_57.f_1);
func_276(55);
while (((!STREAMING::HAS_MODEL_LOADED(iLocal_623) || !STREAMING::HAS_MODEL_LOADED(Local_57.f_1)) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_59.f_6)) || !func_275(55)){
...
STREAMING::REQUEST_MODEL(Local_57.f_1);
STREAMING::REQUEST_MODEL(Local_52.f_1);
STREAMING::REQUEST_ANIM_DICT(Local_59.f_6);
VEHICLE::REQUEST_VEHICLE_RECORDING(501, "Eps6_Takeoff");
func_276(55);
if(!func_272()){
while (((((!STREAMING::HAS_MODEL_LOADED(Local_57.f_1) || !CUTSCENE::HAS_CUTSCENE_LOADED()) || !STREAMING::HAS_MODEL_LOADED(Local_52.f_1)) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_59.f_6)) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff")) || !func_275(55)){
...
while ((((!STREAMING::HAS_MODEL_LOADED(Local_57.f_1) || !STREAMING::HAS_MODEL_LOADED(Local_52.f_1)) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_59.f_6)) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff")) || !func_275(55)){
func_531("WAITING FOR MS_ENDCUTSCENE RESOURCES");
wait(0);
}}
func_16(&(Local_58.f_3));
...
if(iLocal_125==-1){
iLocal_125=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(1687.954f, 3277.727f, 40.25f, 6f, 6f, 6f, 0f, 0, 7);
...
case 5:
if(!func_491(Local_57.f_0)){
Local_57.f_0=VEHICLE::CREATE_VEHICLE(Local_57.f_1, Local_57.f_3, Local_57.f_6, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_57.f_0, 1084227584);
VEHICLE::SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Local_57.f_0, 1);
VEHICLE::SET_VEHICLE_DIRT_LEVEL(Local_57.f_0, 13f);
VEHICLE::SET_VEHICLE_COLOURS(Local_57.f_0, 157, 157);
VEHICLE::SET_VEHICLE_EXTRA_COLOURS(Local_57.f_0, 157, 5);
}
break;
default:
if(!func_491(Local_57.f_0)){
...
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_57.f_0, 1084227584);
VEHICLE::SET_VEHICLE_HAS_BEEN_OWNED_BY_PLAYER(Local_57.f_0, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_57.f_0, 3);
VEHICLE::SET_VEHICLE_DIRT_LEVEL(Local_57.f_0, 13f);
VEHICLE::SET_VEHICLE_COLOURS(Local_57.f_0, 157, 157);
VEHICLE::SET_VEHICLE_EXTRA_COLOURS(Local_57.f_0, 157, 5);
}
...
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_57.f_1, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_57.f_1);
}
...
case 0:
if(func_488(Local_60.f_0)){
ENTITY::SET_ENTITY_HEADING(Local_60.f_0, 254.1723f);
ENTITY::SET_ENTITY_COORDS(Local_60.f_0, -2881.755f, 3188.125f, 10.1136f, 1, 0, 0, 1);
TASK::CLEAR_PED_TASKS(Local_60.f_0);
func_286();
}else{
func_4(&Local_60);
Local_60.f_0=PED::CREATE_PED(26, iLocal_624, -2881.755f, 3188.125f, 10.1136f, 254.1723f, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_60.f_0);
func_286();
}
if(func_488(Local_60.f_0)){
PED::SET_PED_MAX_MOVE_BLEND_RATIO(Local_60.f_0, 0f);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_60.f_0, 1);
PED::SET_PED_CONFIG_FLAG(Local_60.f_0, 167, 1);
AUDIO::STOP_PED_SPEAKING(Local_60.f_0, 1);
PED::SET_PED_DIES_WHEN_INJURED(Local_60.f_0, 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_60.f_0, 0);
PED::SET_PED_CONFIG_FLAG(Local_60.f_0, 185, 1);
PED::SET_PED_CONFIG_FLAG(Local_60.f_0, 188, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_60.f_0, uLocal_622);
PED::SET_PED_CONFIG_FLAG(Local_60.f_0, 132, 1);
...
if(func_488(Local_60.f_0)){
ENTITY::SET_ENTITY_HEADING(Local_60.f_0, 254.1723f);
ENTITY::SET_ENTITY_COORDS(Local_60.f_0, -2889.89f, 3198.69f, 10.11f, 1, 0, 0, 1);
TASK::CLEAR_PED_TASKS(Local_60.f_0);
}else{
func_4(&Local_60);
Local_60.f_0=PED::CREATE_PED(26, iLocal_624, -2889.89f, 3198.69f, 10.11f, 254.1723f, 1, 1);
PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_60.f_0);
}
if(func_488(Local_60.f_0)){
PED::SET_PED_MAX_MOVE_BLEND_RATIO(Local_60.f_0, 0f);
...
void func_286(){
WEAPON::GIVE_WEAPON_TO_PED(Local_60.f_0, joaat("weapon_digiscanner"), 0, 1, 1);
PED::SET_PED_CAN_SWITCH_WEAPON(Local_60.f_0, 0);
AUDIO::STOP_PED_SPEAKING(Local_60.f_0, 1);
PED::SET_PED_DIES_WHEN_INJURED(Local_60.f_0, 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_60.f_0, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_123);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_123, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_123);
TASK::TASK_PERFORM_SEQUENCE(Local_60.f_0, uLocal_123);
}
...
VEHICLE::DELETE_VEHICLE(&Local_52);
}
Local_52.f_0=VEHICLE::CREATE_VEHICLE(iLocal_623, -2892.93f, 3192.37f, 11.66f, -132.35f, 0, 0, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_52.f_0, 1084227584);
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_52.f_0);
VEHICLE::SET_VEHICLE_COLOURS(Local_52.f_0, 157, 157);
VEHICLE::SET_VEHICLE_EXTRA_COLOURS(Local_52.f_0, 157, 5);
VEHICLE::SET_VEHICLE_LIVERY(Local_52.f_0, 3);
VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(Local_52.f_0, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_52.f_0, 1);
func_490(Local_52.f_0, 0);
...
if(func_243()){
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_52.f_0, 1);
ENTITY::SET_ENTITY_HEADING(Local_52.f_0, 290.823f);
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_52.f_0, 1, 1, 0);
VEHICLE::SET_VEHICLE_FORWARD_SPEED(Local_52.f_0, 75f);
VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(Local_52.f_0, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_52.f_0, 1);
VEHICLE::CONTROL_LANDING_GEAR(Local_52.f_0, 3);
ENTITY::FREEZE_ENTITY_POSITION(Local_52.f_0, 1);
}else{
Local_52.f_0=VEHICLE::CREATE_VEHICLE(iLocal_623, 595.7562f, 2926.42f, 173.2301f, 283.3833f, 0, 0, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_52.f_0, 1084227584);
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_52.f_0);
VEHICLE::SET_VEHICLE_COLOURS(Local_52.f_0, 157, 157);
VEHICLE::SET_VEHICLE_EXTRA_COLOURS(Local_52.f_0, 157, 5);
...
func_490(Local_52.f_0, 0);
if(!func_272()){
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_52.f_0, -1);
}
VEHICLE::CONTROL_LANDING_GEAR(Local_52.f_0, 3);
ENTITY::FREEZE_ENTITY_POSITION(Local_52.f_0, 1);
...
if(func_491(Local_52.f_0)){
if(VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_52.f_0)){
VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(Local_52.f_0);
}
func_5(&Local_52);
}
Local_52.f_0=VEHICLE::CREATE_VEHICLE(Local_52.f_1, 1684.78f, 3255.58f, 41.78f, 284.26f, 1, 1, 0);
if(func_491(Local_52.f_0)){
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_52.f_0, 1084227584);
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_52.f_0);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_52.f_0, 3);
VEHICLE::SET_VEHICLE_COLOURS(Local_52.f_0, 157, 157);
VEHICLE::SET_VEHICLE_EXTRA_COLOURS(Local_52.f_0, 157, 5);
VEHICLE::SET_VEHICLE_LIVERY(Local_52.f_0, 3);
VEHICLE::SET_VEHICLE_ENGINE_CAN_DEGRADE(Local_52.f_0, 0);
...
Local_52.f_0=VEHICLE::CREATE_VEHICLE(Local_52.f_1, 1674.91f, 3252.47f, 41.69f, 284.26f, 1, 1, 0);
if(func_491(Local_52.f_0)){
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_52.f_0, 1084227584);
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_52.f_0);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_52.f_0, 3);
...
VEHICLE::START_PLAYBACK_RECORDED_VEHICLE(Local_52.f_0, 501, "Eps6_Takeoff", 1);
VEHICLE::FORCE_PLAYBACK_RECORDED_VEHICLE_UPDATE(Local_52.f_0, 1);
VEHICLE::PAUSE_PLAYBACK_RECORDED_VEHICLE(Local_52.f_0);
...
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_52.f_1, 1);
}
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_59.f_0, 1);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_59.f_0, 0);
PED::SET_PED_CAN_BE_TARGETTED(Local_59.f_0, 0);
PED::SET_PED_CONFIG_FLAG(Local_59.f_0, 185, 1);
PED::SET_PED_PROP_INDEX(Local_59.f_0, 1, 0, 0, false, 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_59.f_0, uLocal_622);
PED::SET_PED_CONFIG_FLAG(Local_59.f_0, 132, 1);
TASK::TASK_PLAY_ANIM(Local_59.f_0, Local_59.f_6, Local_59.f_7, 8f, -8f, -1, 49, 0, 0, 0, 0);
}else{
...
iLocal_124=OBJECT::CREATE_OBJECT(joaat("p_amb_phone_01"), ENTITY::GET_ENTITY_COORDS(Local_59.f_0, 1), 1, 1, 0);
}
if(!ENTITY::IS_ENTITY_ATTACHED(iLocal_124)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_124, Local_59.f_0, PED::GET_PED_BONE_INDEX(Local_59.f_0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 0, 0, 0, 2, 1, 0);
}
func_292(55);
break;
case 5:
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_59.f_0, uLocal_622);
PED::SET_PED_CONFIG_FLAG(Local_59.f_0, 132, 1);
if(!HUD::DOES_BLIP_EXIST(Local_59.f_1)){
Local_59.f_1=func_291(Local_59.f_0, 1, 1, 9);
}
if(func_488(Local_59.f_0) && func_243()){
TASK::OPEN_SEQUENCE_TASK(&uLocal_123);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1682.44f, 3258.81f, 39.81f, 2f, 20000, 7.5f, 1, 1193033728);
TASK::TASK_ENTER_VEHICLE(0, Local_52.f_0, 20000, -1, 1073741824, 1, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_123);
TASK::TASK_PERFORM_SEQUENCE(Local_59.f_0, uLocal_123);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_123);
}
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_59.f_0, 0, 0);
}else{
...
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_59.f_0, 1, 0);
}
func_290(&iLocal_124);
}else{
func_16(&(Local_59.f_1));
...
case 2:
if(!func_272()){
if(func_488(PLAYER::PLAYER_PED_ID()) && func_491(Local_52.f_0)){
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_52.f_0, 0)){
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_52.f_0, -1);
}
...
iVar6=func_372(&(Global_100833.f_3));
if(iVar6 > -1){
...
var func__319(int iParam0, var uParam1){
...
iVar5=0;
while (iVar5 < iVar6){
if((FILES::GET_DLC_WEAPON_DATA_SP(iVar5, &Var7) && !func_326(Var7.f_1)) && iVar9 < 51){
...
if(func_176(iVar0) && !PED::IS_PED_INJURED(uParam0)){
...
}elseif(func_332(*uParam0, "v_hospital", 307.3065f, -589.9595f, 43.302f)){
*uParam0={
...
if(func_360()){
*uParam0=func_339(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 6, -1, 0, 1, -1);
...
if(func_31()==0){
return MISC::IS_BIT_SET(func_94(func_337(iParam0), -1), iParam1);
}}else{
...
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Param0, func_340(iVar0, 0), 1);
...
Vector3 func__340(int iParam0, bool bParam1){
switch (iParam0){
case -1:
return 0f, 0f, 0f;
break;
...
return func_347(2, 2);
}elseif(func_346(Global_1853823)){
...
func_16(&(Local_52.f_2));
if(func_243()){
ENTITY::SET_ENTITY_COORDS(Local_52.f_0, 1674.91f, 3252.47f, 41.69f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(Local_52.f_0, 284.26f);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_52.f_0, 1084227584);
}else{
func_5(&Local_52);
Local_52.f_0=VEHICLE::CREATE_VEHICLE(Local_52.f_1, 1674.91f, 3252.47f, 41.69f, 284.26f, 1, 1, 0);
...
if(func_488(Local_59.f_0)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_59.f_0, "Jimmy_Boston", 0, 0, 0);
}
if(func_488(PLAYER::PLAYER_PED_ID())){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Michael", 0, 0, 0);
}
if(func_488(Local_52.f_0)){
CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_52.f_0, "ep_plane", 0, 0, 0);
}
...
STREAMING::STREAMVOL_DELETE(uLocal_122);
}
...
void func_380(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6){
if(bParam0){
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_385(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
int func_387(int iParam0, var uParam1, var uParam2, int iParam3){
int iVar0;
iVar0=0;
...
if(func_243()){
ENTITY::SET_ENTITY_COORDS(Local_52.f_0, 1684.78f, 3255.58f, 41.78f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(Local_52.f_0, 284.26f);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_52.f_0, 1084227584);
}else{
func_5(&Local_52);
...
PED::FORCE_PED_MOTION_STATE(Local_59.f_0, joaat("MotionState_Run"), 0, 1, 0);
}}}
...
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_59.f_0, -1, 0, 2);
...
void func_394(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
var uVar0;
uVar0=PLAYER::GET_PLAYER_INDEX();
...
void func_397(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
func_398(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}
...
if(func_399(iVar0, Param0, Param1, fParam2)){
bVar1=true;
}}}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
...
int func_399(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
if(((((((((((((((func_400(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var3) || func_400(Var6[0 /*3*/], Var6[1 /*3*/], Var3, Var5)) || func_400(Var6[0 /*3*/], Var6[1 /*3*/], Var4, Var5)) || func_400(Var6[0 /*3*/], Var6[1 /*3*/], Var2, Var4)) || func_400(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var3)) || func_400(Var6[1 /*3*/], Var6[3 /*3*/], Var3, Var5)) || func_400(Var6[1 /*3*/], Var6[3 /*3*/], Var4, Var5)) || func_400(Var6[1 /*3*/], Var6[3 /*3*/], Var2, Var4)) || func_400(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var3)) || func_400(Var6[3 /*3*/], Var6[2 /*3*/], Var3, Var5)) || func_400(Var6[3 /*3*/], Var6[2 /*3*/], Var4, Var5)) || func_400(Var6[3 /*3*/], Var6[2 /*3*/], Var2, Var4)) || func_400(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var3)) || func_400(Var6[2 /*3*/], Var6[0 /*3*/], Var3, Var5)) || func_400(Var6[2 /*3*/], Var6[0 /*3*/], Var4, Var5)) || func_400(Var6[2 /*3*/], Var6[0 /*3*/], Var2, Var4)){
return 1;
}}
return 0;
}

int func_400(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
if(!func_408(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
int func_408(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6){
...
VEHICLE::REQUEST_VEHICLE_RECORDING(501, "Eps6_Takeoff");
while ((((!func_275(55) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_59.f_6)) || !STREAMING::HAS_MODEL_LOADED(Local_57.f_1)) || !STREAMING::HAS_MODEL_LOADED(joaat("p_amb_phone_01"))) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff")){
wait(0);
}
if(iLocal_77){
func_273();
...
if(func_243()){
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_52.f_0, 0, 0, 0);
}
if(!HUD::DOES_BLIP_EXIST(Local_59.f_1)){
Local_59.f_1=func_291(Local_59.f_0, 1, 1, 9);
}
...
iLocal_107=(MISC::GET_GAME_TIMER() - 10000);
iLocal_82=0;
...
if(func_488(Local_59.f_0)){
if(func_242(PLAYER::PLAYER_PED_ID(), Local_59.f_0, 1) < 100f){
if(!CUTSCENE::HAS_CUTSCENE_LOADED()){
CUTSCENE::REQUEST_CUTSCENE("ep_6_rcm", 8);
func_531("Requesting cutscene now");
}}elseif(func_242(PLAYER::PLAYER_PED_ID(), Local_59.f_0, 1) > 120f){
if(CUTSCENE::HAS_CUTSCENE_LOADED()){
...
if(func_411(PLAYER::PLAYER_PED_ID(), Local_59.f_0, 13f, 1)){
...
iLocal_68=2;
}}}elseif(func_411(PLAYER::PLAYER_PED_ID(), Local_59.f_0, 5f, 1)){
if(func_488(PLAYER::PLAYER_PED_ID()) && func_488(Local_59.f_0)){
Local_626={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
Local_627={
ENTITY::GET_ENTITY_COORDS(Local_59.f_0, 1) 
};
if(((Local_626.f_2 - Local_627.f_2) < 1.5f && !PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())){
iLocal_68=2;
}}}}else{
iLocal_126=4;
iLocal_68=0;
...
bool func_411(int iParam0, int iParam1, float fParam2, int iParam3){
return vdist2(ENTITY::GET_ENTITY_COORDS(iParam0, iParam3), ENTITY::GET_ENTITY_COORDS(iParam1, iParam3)) <=(fParam2 * fParam2);
}


void func_412(){
if(func_242(PLAYER::PLAYER_PED_ID(), Local_59.f_0, 1) <=15f){
if(!STREAMING::IS_STREAMVOL_ACTIVE()){
if(!STREAMING::STREAMVOL_HAS_LOADED(uLocal_122)){
func_531("Loading streamvol");
uLocal_122=STREAMING::STREAMVOL_CREATE_FRUSTUM(1684.85f, 3276.16f, 39.93f, func_413(-2.1719f, 0f, -78.5672f), 50f, 12, 127);
...
Vector3 func__413(struct<3> Param0){
...
void func_414(){
float fVar0;
if(func_488(Local_59.f_0) && func_488(PLAYER::PLAYER_PED_ID())){
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_59.f_0, 1), 1);
}
if(fVar0 < 50f){
fLocal_116=100f;
fLocal_117=150f;
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_59.f_0, 1), 1) > fLocal_116){
if(!iLocal_82){
func_415("EPS6_GOBACK", 7500, 1);
iLocal_82=1;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_59.f_0, 1), 1) > fLocal_117){
iLocal_126=2;
iLocal_68=0;
iLocal_67=6;
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
...
if(func_488(Local_59.f_0)){
if(func_242(PLAYER::PLAYER_PED_ID(), Local_59.f_0, 1) <=15f){
if(!PED::IS_PED_HEADTRACKING_PED(Local_59.f_0, PLAYER::PLAYER_PED_ID())){
func_531("Jimmy headlooking");
TASK::TASK_LOOK_AT_ENTITY(Local_59.f_0, PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
}}elseif(func_242(PLAYER::PLAYER_PED_ID(), Local_59.f_0, 1) <=25f && func_22()){
if(!PED::IS_PED_HEADTRACKING_PED(Local_59.f_0, PLAYER::PLAYER_PED_ID())){
func_531("Jimmy headlooking (during conv)");
TASK::TASK_LOOK_AT_ENTITY(Local_59.f_0, PLAYER::PLAYER_PED_ID(), -1, 2096, 2);
}}elseif(PED::IS_PED_HEADTRACKING_PED(Local_59.f_0, PLAYER::PLAYER_PED_ID()) && !func_22()){
func_531("Clear Jimmy headlook");
TASK::TASK_CLEAR_LOOK_AT(Local_59.f_0);
}}
if(!func_22() && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
if(func_488(Local_59.f_0) && func_488(PLAYER::PLAYER_PED_ID())){
if(func_411(PLAYER::PLAYER_PED_ID(), Local_59.f_0, 25f, 1)){
if((MISC::GET_GAME_TIMER() - iLocal_107) > 15000){
...
if(func_243()){
if(iLocal_95==0){
if(func_431(Local_52.f_0, Local_58, 1) < 1100f){
func_297(1, "Landing stage", 0, 0, 0, 1);
iLocal_95=1;
func_531("Landing checkpoint set");
}}
if(iLocal_96==0){
if(func_431(Local_52.f_0, Local_58, 1) < 350f){
STREAMING::REQUEST_MODEL(Local_57.f_1);
func_276(55);
STREAMING::REQUEST_ANIM_DICT(Local_59.f_6);
STREAMING::REQUEST_MODEL(joaat("p_amb_phone_01"));
func_531("Requesting Jimmy resources...");
if(((STREAMING::HAS_MODEL_LOADED(Local_57.f_1) && func_275(55)) && STREAMING::HAS_ANIM_DICT_LOADED(Local_59.f_6)) && STREAMING::HAS_MODEL_LOADED(joaat("p_amb_phone_01"))){
func_289();
func_274();
func_15(&uLocal_457, 3, Local_59.f_0, "JIMMYBOSTON", 0, 1);
func_15(&uLocal_457, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_52.f_0, Local_119, Local_120, 33.25f, 0, 1, 2)){
func_531("Plane detected");
func_531("*** Entering Landing cleanup");
iLocal_68=2;
}}}else{
if(!HUD::DOES_BLIP_EXIST(Local_52.f_2)){
Local_52.f_2=func_427(Local_52.f_0, 1, 5);
...
func_16(&(Local_58.f_3));
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_52.f_0, 1), 1) > 80f){
if(func_431(Local_52.f_0, 1654.72f, 3239.21f, 39.55f, 1) >=50f){
if(!iLocal_82){
func_415("EPS6_BACKPL", 7500, 1);
iLocal_82=1;
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_52.f_0, 1), 1) > 150f){
if(func_424()){
bLocal_99=true;
}
iLocal_126=1;
...
elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_52.f_0, 1), 1) > 250f){
if(func_424()){
bLocal_99=true;
}
iLocal_126=1;
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_52.f_0, Local_119, Local_120, 33.25f, 0, 1, 2)){
func_16(&(Local_52.f_2));
if(VEHICLE::GET_LANDING_GEAR_STATE(Local_52.f_0)==0 || VEHICLE::GET_LANDING_GEAR_STATE(Local_52.f_0)==3){
if(!HUD::DOES_BLIP_EXIST(Local_59.f_1)){
Local_59.f_1=func_291(Local_59.f_0, 1, 1, 9);
}
func_16(&(Local_58.f_3));
...
if(func_423() && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_52.f_0, 0)){
func_531("*** Finishing Landing cleanup");
func_422("*** Plane 'entity' health:
", ENTITY::GET_ENTITY_HEALTH(Local_52.f_0));
func_421("*** Plane engine health:
", VEHICLE::GET_VEHICLE_ENGINE_HEALTH(Local_52.f_0));
func_421("*** Plane petrol tank health:
", VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(Local_52.f_0));
if((ENTITY::GET_ENTITY_HEALTH(Local_52.f_0)==1000 && VEHICLE::GET_VEHICLE_ENGINE_HEALTH(Local_52.f_0)==1000f) && VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(Local_52.f_0)==1000f){
func_420(751);
}
func_16(&(Local_58.f_3));
iLocal_67=3;
...
if((VEHICLE::GET_LANDING_GEAR_STATE(Local_52.f_0)==1 || VEHICLE::GET_LANDING_GEAR_STATE(Local_52.f_0)==4) || VEHICLE::GET_LANDING_GEAR_STATE(Local_52.f_0)==5){
...
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_52.f_0, 1, 0, 0);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_52.f_0, 1);
iLocal_68=1;
}}else{
...
void func_422(char* sParam0, var uParam1){
sParam0=sParam0;
uParam1=uParam1;
}
...
float fVar0;
if(func_243()){
fVar0=ENTITY::GET_ENTITY_SPEED(Local_52.f_0);
...
TASK::CLEAR_PED_TASKS(Local_59.f_0);
TASK::TASK_LOOK_AT_ENTITY(Local_59.f_0, PLAYER::PLAYER_PED_ID(), 10000, 48, 2);
func_531("*** Played diag EPS6_CLOSE");
}}}elseif(!func_22()){
if((MISC::GET_GAME_TIMER() - iLocal_108) > 10000){
bLocal_90=false;
}}}elseif(!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_59.f_0, Local_59.f_6, Local_59.f_7, 3)){
...
if(!HUD::DOES_BLIP_EXIST(Local_58.f_3)){
Local_58.f_3=func_430(Local_58, 5, 1);
}}}
...
switch (iLocal_104){
case 0:
if(func_242(PLAYER::PLAYER_PED_ID(), Local_60.f_0, 1) < 50f){
if(!func_22()){
...
if(func_488(PLAYER::PLAYER_PED_ID()) && func_491(Local_52.f_0)){
if(func_242(PLAYER::PLAYER_PED_ID(), Local_60.f_0, 1) < 10f || func_242(PLAYER::PLAYER_PED_ID(), Local_52.f_0, 1) < 10f){
...
case 1:
if(iLocal_72==0){
if(func_489(Local_60.f_0)){
TASK::CLEAR_PED_TASKS(Local_60.f_0);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_60.f_0, PLAYER::PLAYER_PED_ID(), 0);
...
if((func_488(PLAYER::PLAYER_PED_ID()) && func_491(Local_52.f_0)) && func_489(Local_60.f_0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(func_242(PLAYER::PLAYER_PED_ID(), Local_60.f_0, 1) < 15f || func_242(PLAYER::PLAYER_PED_ID(), Local_52.f_0, 1) < 10f){
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -2915.73f, 3195.936f, 7.80361f, -2897.807f, 3171.756f, 12.6042f, 16f, 0, 1, 0)){
func_268(2);
iLocal_70=1;
}
...
if(HUD::IS_MESSAGE_BEING_DISPLAYED()){
func_442(&uLocal_127, "EPS6AUD", "EPS6_SPOT", "EPS6_SPOT_1", 8, 1, 0);
iLocal_114=0;
iLocal_101=1;
func_531("EPSILONIST:
Play single line with subs");
TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_60.f_0, -1, 0, 2);
...
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 10f, 1);
iLocal_72=1;
}elseif(func_226(&uLocal_127, "EPS6AUD", "EPS6_SPOT", 8, 0, 0, 0)){
iLocal_114=0;
func_531("EPSILONIST:
...
if(!func_22()){
if(!bLocal_98){
if(func_440(&uLocal_127, "EPS6AUD", "EPS6_SPOT", "EPS6_SPOT_3", 8, 0, 0)){
iLocal_101=0;
func_531("EPSILONIST:
...
iLocal_101=0;
}}}elseif((MISC::GET_GAME_TIMER() - iLocal_114) > 1000 || iLocal_114==0){
if(!func_22()){
...
if(func_439(Local_60.f_0, PLAYER::PLAYER_PED_ID()) > 10f){
func_20();
bLocal_94=true;
}
}}else{
...
if(func_491(Local_52.f_0) && func_488(Local_60.f_0)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_52.f_0, 1)){
if(func_22()){
func_20();
...
In EPS_HANDSUP");
if(iLocal_100==0){
func_437(Local_60.f_0, "AIMED_AT_BY_PLAYER", "TOM", 4);
if(!func_407(Local_60.f_0, joaat("script_task_hands_up"))){
TASK::CLEAR_PED_TASKS(Local_60.f_0);
TASK::TASK_HANDS_UP(Local_60.f_0, -1, PLAYER::PLAYER_PED_ID(), -1, 1);
}
iLocal_105=-1;
iLocal_72=1;
}else{
...
}elseif((MISC::GET_GAME_TIMER() - iLocal_105) > 1200){
TASK::CLEAR_PED_TASKS(Local_60.f_0);
TASK::TASK_LOOK_AT_ENTITY(Local_60.f_0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_60.f_0, PLAYER::PLAYER_PED_ID(), 0);
if(iLocal_100==0){
...
func_531("EPSILONIST:
In EPS_WAIT");
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_60.f_0, PLAYER::PLAYER_PED_ID(), -1);
iLocal_72=1;
}elseif(iLocal_72==1){
if(iLocal_79==0){
if((!HUD::IS_MESSAGE_BEING_DISPLAYED() && !func_22()) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_52.f_0, 1)){
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 10f, 1);
...
if(iLocal_72==0){
if(func_489(Local_60.f_0)){
if(func_431(Local_60.f_0, -2884.934f, 3200.156f, 10.7036f, 1) > 2f){
TASK::CLEAR_PED_TASKS(Local_60.f_0);
TASK::TASK_CLEAR_LOOK_AT(Local_60.f_0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_123);
...
if(iLocal_67==0){
if(iLocal_79==0){
if((!func_425("EPS6_SPOT") && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_52.f_0, 1)) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())){
func_436("EPS6_GETIN", 7500, 1);
...
TASK::TASK_SMART_FLEE_PED(Local_60.f_0, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
func_16(&(Local_60.f_1));
}}
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_438(iParam3), 0);
}
...
int func_441(){
if(func_243() && func_488(Local_60.f_0)){
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_52.f_0, 1)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_52.f_0, PLAYER::PLAYER_PED_ID(), 1)){
func_531("Player damaged plane");
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_52.f_0);
return 1;
}}}
return 0;
}
...
break;
case 1:
if(func_488(Local_60.f_0) && func_488(PLAYER::PLAYER_PED_ID())){
TASK::CLEAR_PED_TASKS(Local_60.f_0);
Local_626={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
TASK::OPEN_SEQUENCE_TASK(&uLocal_123);
TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_626, 1f, 20000, 0.25f, 0, 1193033728);
TASK::CLOSE_SEQUENCE_TASK(uLocal_123);
TASK::TASK_PERFORM_SEQUENCE(Local_60.f_0, uLocal_123);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_123);
iLocal_73=2;
...
case 2:
if(func_488(Local_60.f_0) && func_488(PLAYER::PLAYER_PED_ID())){
if(func_242(Local_60.f_0, PLAYER::PLAYER_PED_ID(), 1) < 5f || TASK::GET_SCRIPT_TASK_STATUS(Local_60.f_0, joaat("script_task_perform_sequence"))==7){
TASK::CLEAR_PED_TASKS(Local_60.f_0);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_60.f_0, PLAYER::PLAYER_PED_ID(), -1);
iLocal_73=0;
}}
...
if(STREAMING::HAS_ANIM_DICT_LOADED("rcmepsilonism6") && !ENTITY::IS_ENTITY_PLAYING_ANIM(Local_60.f_0, "rcmepsilonism6", "cultist_idle_a", 3)){
TASK::TASK_PLAY_ANIM(Local_60.f_0, "rcmepsilonism6", "cultist_upperstatic", 8f, -8f, -1, 49, 0, 0, 0, 0);
iLocal_74=1;
func_531("Initialised Eps 6 Tom state machine");
}
break;
case 1:
if(!func_407(Local_60.f_0, joaat("script_task_follow_nav_mesh_to_coord"))){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_60.f_0, Local_76[iLocal_75 /*3*/], 1f, 20000, 0.25f, 0, 1193033728);
func_531("Eps 6:
Nav tasking Tom...");
iLocal_74=2;
}
break;
case 2:
if(func_431(Local_60.f_0, Local_76[iLocal_75 /*3*/], 1) <=1.2f){
iLocal_74=3;
func_531("Eps 6:
Tom at coord;
do idle anim");
...
case 3:
TASK::CLEAR_PED_TASKS(Local_60.f_0);
TASK::TASK_PLAY_ANIM(Local_60.f_0, "rcmepsilonism6", "cultist_idle_a", 16f, -2f, -1, 131072, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_60.f_0, 0, 0);
iLocal_74=4;
func_531("Eps 6:
Done Tom idle anim");
break;
case 4:
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_60.f_0, "rcmepsilonism6", "cultist_idle_a", 3)){
if(ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_60.f_0, "rcmepsilonism6", "cultist_idle_a") >=0.98f){
if(iLocal_75 >=2){
iLocal_75=0;
}
else{
...
TASK::TASK_PLAY_ANIM(Local_60.f_0, "rcmepsilonism6", "cultist_upperstatic", 16f, -8f, -1, 49, 0, 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_60.f_0, 0, 0);
iLocal_74=1;
func_531("Eps 6:
Tom idle anim >0.98");
...
int func_449(){
if(func_488(PLAYER::PLAYER_PED_ID()) && func_488(Local_60.f_0)){
...
return 1;
}}elseif(ENTITY::DOES_ENTITY_EXIST(Local_60.f_0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_60.f_0, PLAYER::PLAYER_PED_ID(), 1)){
...
if(ENTITY::DOES_ENTITY_EXIST(Local_60.f_0)){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_60.f_0, PLAYER::PLAYER_PED_ID(), 1)){
if(ENTITY::IS_ENTITY_DEAD(Local_60.f_0, 0)){
...
int func_451(){
if((func_248(Local_60.f_0, 0, 1116471296, 1126825984, 0, 0, 0, 0) || func_245(PLAYER::PLAYER_PED_ID(), Local_60.f_0, 0)) || func_441()){
if(func_248(Local_60.f_0, 0, 1116471296, 1126825984, 0, 0, 0, 0)){
func_531("Player threatened cultist");
}
if(func_245(PLAYER::PLAYER_PED_ID(), Local_60.f_0, 0)){
...
func_437(Local_60.f_0, "FIGHT_RUN", "TOM", 4);
}
return 1;
}
return 0;
...
void func_452(){
if(bLocal_98==0){
if(func_489(Local_60.f_0) && func_488(PLAYER::PLAYER_PED_ID())){
if(iLocal_97==0){
if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_60.f_0) && PED::IS_PED_RAGDOLL(Local_60.f_0)){
func_20();
func_531("Player knocked Tom over!");
iLocal_97=1;
}}elseif(func_489(Local_60.f_0)){
if(TASK::IS_PED_GETTING_UP(Local_60.f_0) || PED::IS_PED_ON_FOOT(Local_60.f_0)){
if(!func_22() && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
...
func_15(&uLocal_292, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
func_15(&uLocal_127, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
...
HUD::SET_MINIMAP_COMPONENT(3, 0, -1);
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if(func_431(PLAYER::PLAYER_PED_ID(), Local_58, 0) < 2300f){
iLocal_68=2;
}}}else{
if(!HUD::DOES_BLIP_EXIST(Local_52.f_2)){
Local_52.f_2=func_427(Local_52.f_0, 1, 5);
...
elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_52.f_0, 1), 1) > 120f){
if(func_424()){
bLocal_99=true;
}
iLocal_126=1;
...
if(func_243()){
Var0={
ENTITY::GET_ENTITY_COORDS(Local_52.f_0, 1) 
};
if(Var0.f_2 > 15f){
...
break;
case 1:
if((MISC::GET_GAME_TIMER() - iLocal_106) > 12000){
iLocal_69=2;
}
break;
case 2:
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if(func_457(&uLocal_292, 55, "EPS6AUD", "EPS6_FLIGHT", 11, 1, 0, 0, 0)){
PLAYER::SET_MAX_WANTED_LEVEL(5);
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 10f, 1);
iLocal_69=3;
}}
...
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_102, "DEVICE", WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_60.f_0, 1), "EPSILONISM_04_SOUNDSET", 0, 0);
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_103, "IDLE_BEEP_NPC", WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_60.f_0, 1), "EPSILONISM_04_SOUNDSET", 0, 0);
}
...
iLocal_67=6;
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_52.f_0, 1), 1) > 50f){
if(!iLocal_82){
if(AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()){
iLocal_84=AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE();
Local_86={
func_426() 
};
func_20();
iLocal_83=1;
iLocal_85=(MISC::GET_GAME_TIMER() - 7500);
}
func_415("EPS6_BACKPL", 7500, 1);
iLocal_82=1;
}else{
if((MISC::GET_GAME_TIMER() - iLocal_85) > 7500 && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
if(func_226(&uLocal_127, "EPS6AUD", "EPS6_RUNAWAY", 8, 0, 0, 0)){
iLocal_85=MISC::GET_GAME_TIMER();
}}
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_52.f_0, 1), 1) > 100f){
iLocal_126=1;
iLocal_68=0;
iLocal_67=6;
AUDIO::TRIGGER_MUSIC_EVENT("EPS_FAIL");
...
if(func_440(&uLocal_127, "EPS6AUD", &Local_86, &cVar0, 8, 0, 0)){
iLocal_83=0;
iLocal_82=0;
}}else{
iLocal_82=0;
...
void func_459(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_461(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
break;
default:
StringCopy(&Var0, func_462(iVar1), 8);
break;
}
break;
default:
...
break;
case 1:
if(!func_495(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar3)){
return 0;
}
iLocal_47=2;
break;
...
void func_493(var uParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4){
func_4(uParam0);
*uParam0=PED::CREATE_PED(iParam4, uParam1, Param2, fParam3, 0, 0);
}


void func_494(var uParam0, int iParam1, struct<3> Param2, float fParam3){
func_5(uParam0);
...
iVar2=func_372(SCRIPT::GET_THIS_SCRIPT_NAME());
if(iVar2 > -1){
