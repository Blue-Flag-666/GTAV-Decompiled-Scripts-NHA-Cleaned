...
uLocal_206=PED::CREATE_PED(25, iLocal_34, Local_208, ScriptParam_330.f_17[0], 0, 1);
func_103();
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_206, Local_208, 1f, -1, 1f, 1024, ScriptParam_330.f_17[0]);
iLocal_214=6;
}
break;
case 6:
...
if(bLocal_327){
Global_113755[iLocal_215]=uLocal_326;
}else{
...
int func_106(){
if(MISC::IS_BIT_SET(Global_113810.f_18577[58 /*6*/], 0) && !MISC::IS_BIT_SET(Global_113810.f_18577[58 /*6*/], 3)){
return 1;
}
return 0;
}
...
int func_111(){
if(MISC::IS_BIT_SET(Global_113810.f_18577[60 /*6*/], 0) && !MISC::IS_BIT_SET(Global_113810.f_18577[60 /*6*/], 3)){
return 0;
}
if(MISC::IS_BIT_SET(Global_113810.f_18577[61 /*6*/], 0) && !MISC::IS_BIT_SET(Global_113810.f_18577[61 /*6*/], 3)){
return 0;
}
if(MISC::IS_BIT_SET(Global_113810.f_18577[62 /*6*/], 3)){
return 0;
}
if((MISC::IS_BIT_SET(Global_113810.f_18577[58 /*6*/], 2) || MISC::IS_BIT_SET(Global_113810.f_18577[59 /*6*/], 2)) || MISC::IS_BIT_SET(Global_113810.f_18577[62 /*6*/], 2)){
return 1;
}
return 0;
}
...
, 4);
if(MISC::ARE_STRINGS_EQUAL(&uVar0, &Local_325)){
func_13();
}
if(iParam0==1){
