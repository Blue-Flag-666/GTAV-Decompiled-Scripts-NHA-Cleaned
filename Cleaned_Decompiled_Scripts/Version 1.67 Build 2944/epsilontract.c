...
func_37(1, 0);
func_35();
}}elseif(OBJECT::DOES_PICKUP_EXIST(Local_47[iLocal_39 /*11*/].f_1)){
...
if(MISC::IS_BIT_SET(Global_113810.f_10052.f_108, func_8(func_9(iParam0), iVar1))){
iVar0++;
}
iVar1++;
}}elseif(iParam0==6){
...
iVar2=iVar5;
Var3={
func_25(Global_44588[iVar5 /*12*/].f_1) 
};
...
Var3={
func_25(Global_44588[iVar11 /*12*/].f_1) 
};
}}
if(!bParam4){
