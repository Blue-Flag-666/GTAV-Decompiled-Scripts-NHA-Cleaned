...
func_401();
func_387();
uLocal_262=PED::ADD_SCENARIO_BLOCKING_AREA(402.9022f, -1633.604f, 25.0472f, 315.6288f, -1558.814f, 38.7931f, 0, 1, 1, 1);
func_386(27, 0);
if(func_385()){
func_384(409.6954f, -1567.046f, 28.2916f, 138.7093f, 1, 0);
}
...
HUD::CLEAR_HELP(1);
func_33();
if(!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_255)){
func_31(sLocal_255);
}else{
func_15(0);
}
...
if(func_13()){
func_416();
}elseif(func_12(&uLocal_148, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
...
void func_2(){
int iVar0;
VEHICLE::REMOVE_VEHICLE_UPSIDEDOWN_CHECK(Local_288.f_0);
func_5(&Local_288);
func_4(&uLocal_260);
iVar0=0;
while (iVar0 <=2){
...
fVar3=0f;
if(!func_19(Global_113810.f_18536[iVar0], &Var2, &fVar3)){
...
if(iLocal_43==2){
if(func_12(&uLocal_148, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
...
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_288.f_0, 0)){
PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_288.f_0, -1);
}else{
...
func_34(iParam2);
}}}elseif(ENTITY::IS_ENTITY_AT_COORD(iParam0, Param1, fParam10, fParam10, 2f, 0, 1, 2)){
if(*iParam7==-1){
...
*iParam8=1;
VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0, 2);
}elseif((MISC::GET_GAME_TIMER() - *iParam7) > 3000){
return 1;
}}else{
...
bLocal_26=false;
func_36(1, 1, 1);
}elseif(func_83(1, Local_263, 0)){
if(((func_83(2, Local_288.f_1, Local_288.f_4) && func_83(4, Local_263, 0)) && func_83(3, Local_263, 0)) && func_83(5, Local_263, 0)){
uLocal_269=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_82(229.3746f), 0, 7);
if(HUD::GET_BLIP_FROM_ENTITY(Local_288.f_0) !=0){
iVar0=HUD::GET_BLIP_FROM_ENTITY(Local_288.f_0);
...
MISC::CLEAR_AREA_OF_PEDS(Local_287[0 /*22*/].f_1, 5f, 0);
func_78();
func_76();
bLocal_26=false;
func_36(1, 1, 1);
...
iLocal_465=1;
func_386(27, 0);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42073[13 /*31*/], 4, 1, 0);
iLocal_466=0;
}
...
bVar0=false;
while (bVar0 <=(15 - 1)){
MISC::CLEAR_BIT(&(Local_287[iVar1 /*22*/].f_15), bVar0);
bVar0++;
}
...
func_77(&uLocal_292, iVar0, PLAYER::PLAYER_PED_ID(), sVar1, 0, 1);
...
iVar0=0;
while (iVar0 <=2){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_287[iVar0 /*22*/], false);
if(!func_79(Local_287[iVar0 /*22*/], joaat("script_task_start_scenario_at_position"))){
switch (iVar0){
case 0:
case 1:
TASK::TASK_START_SCENARIO_AT_POSITION(Local_287[iVar0 /*22*/], "WORLD_HUMAN_HANG_OUT_STREET", Local_287[iVar0 /*22*/].f_1, Local_287[iVar0 /*22*/].f_4, 0, 0, 1);
break;
case 2:
TASK::TASK_USE_MOBILE_PHONE(Local_287[iVar0 /*22*/], 1, 1);
break;
}}
WEAPON::GIVE_WEAPON_TO_PED(Local_287[iVar0 /*22*/], joaat("weapon_pistol"), -1, 0, 0);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_287[iVar0 /*22*/], uLocal_290);
...
break;
case 1:
HUD::REQUEST_ADDITIONAL_TEXT(sLocal_256, 0);
...
Local_288.f_0=Global_97310[0];
if(func_7(Local_288.f_0)){
if(!VEHICLE::DOES_VEHICLE_HAVE_STUCK_VEHICLE_CHECK(Local_288.f_0)){
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_288.f_0);
}
VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Local_288.f_0, 2, 0);
VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(Local_288.f_0, 3, 0);
func_90(Local_288.f_0, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_288.f_0, 1);
VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_288.f_0, 1);
return 1;
}}elseif(func_89(&Local_288, Local_288.f_5, Local_288.f_1, Local_288.f_4, 1)){
if(!VEHICLE::DOES_VEHICLE_HAVE_STUCK_VEHICLE_CHECK(Local_288.f_0)){
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_288.f_0);
}
func_90(Local_288.f_0, 0);
...
if(!PED::IS_PED_DEAD_OR_DYING(Global_97310.f_9[iVar0], 1)){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97310.f_9[iVar0], 1, 1);
Local_287[iVar0 /*22*/]=Global_97310.f_9[iVar0];
if(func_383(Local_287[iVar0 /*22*/])){
PED::SET_PED_TARGET_LOSS_RESPONSE(Local_287[iVar0 /*22*/], 2);
AUDIO::STOP_PED_SPEAKING(Local_287[iVar0 /*22*/], 1);
func_88(iVar0);
iVar1++;
}}else{
iVar1++;
}}elseif(func_87(&(Local_287[iVar0 /*22*/]), Local_287[iVar0 /*22*/].f_5, Local_287[iVar0 /*22*/].f_1, Local_287[iVar0 /*22*/].f_4, 0, 0, 0, 1)){
func_88(iVar0);
AUDIO::STOP_PED_SPEAKING(Local_287[iVar0 /*22*/], 1);
PED::SET_PED_TARGET_LOSS_RESPONSE(Local_287[iVar0 /*22*/], 2);
StringCopy(&cVar2, "COP ", 16);
StringIntConCat(&cVar2, iVar0, 16);
PED::SET_PED_NAME_DEBUG(Local_287[iVar0 /*22*/], &cVar2);
iVar1++;
}
iVar0++;
}
...
iVar3=1;
while (iVar3 <=3){
if(func_7(Global_97310[iVar3])){
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_97310[iVar3], 1, 1);
Local_289[iVar4 /*6*/]=Global_97310[iVar3];
if(func_7(Local_289[iVar4 /*6*/])){
iVar5++;
}}elseif(func_89(&(Local_289[iVar4 /*6*/]), Local_289[iVar4 /*6*/].f_5, Local_289[iVar4 /*6*/].f_1, Local_289[iVar4 /*6*/].f_4, 1)){
iVar5++;
}
iVar4++;
iVar3++;
...
if(func_7(Local_288.f_0)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_260, Local_288.f_0, 0, 0f, -1.85f, 0.05f, ENTITY::GET_ENTITY_ROTATION(Local_288.f_0, 2), 0, 0, 0, 0, 2, 1, 0);
if(ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_288.f_0, uLocal_260)){
return 1;
}}}
break;
}
...
if(func_383(Local_287[iParam0 /*22*/])){
if(iParam0==0){
PED::SET_PED_COMPONENT_VARIATION(Local_287[iParam0 /*22*/], 0, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_287[iParam0 /*22*/], 3, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_287[iParam0 /*22*/], 4, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_287[iParam0 /*22*/], 8, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_287[iParam0 /*22*/], 9, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_287[iParam0 /*22*/], 10, 0, 0, 0);
}else{
PED::SET_PED_COMPONENT_VARIATION(Local_287[iParam0 /*22*/], 0, 1, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_287[iParam0 /*22*/], 3, 0, 1, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_287[iParam0 /*22*/], 4, 0, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_287[iParam0 /*22*/], 8, 1, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_287[iParam0 /*22*/], 9, 2, 0, 0);
PED::SET_PED_COMPONENT_VARIATION(Local_287[iParam0 /*22*/], 10, 0, 1, 0);
}}}

int func_89(int iParam0, var uParam1, struct<3> Param2, float fParam3, bool bParam4){
if(!ENTITY::DOES_ENTITY_EXIST(*iParam0)){
if(func_86(uParam1, "Loading", 0)){
*iParam0=VEHICLE::CREATE_VEHICLE(uParam1, Param2, uParam3, 1, 1, 0);
if(ENTITY::DOES_ENTITY_EXIST(*iParam0)){
...
*iParam2=2;
}}elseif(func_98(*iParam0) || func_97(*iParam0)){
func_34(iParam3);
if(func_67(func_61(func_70()), 0, 0)){
HUD::CLEAR_THIS_PRINT(func_61(func_70()));
}
...
HUD::CLEAR_THIS_PRINT(func_62(func_70(), bParam7));
}
if(func_70() !=33){
func_95(iParam0);
}else{
...
case 2:
case 1:
if((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, 0) && !func_98(*iParam0)) && !func_97(*iParam0)){
func_34(iParam4);
...
int iVar0;
int iVar1;
if((func_383(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_7(iParam0)){
...
return 1;
}}}elseif(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Param1, fParam9, fParam9, 2f, 1, 1, 2)){
return 1;
}
if(func_67(func_61(func_70()), 0, 0)){
HUD::CLEAR_THIS_PRINT(func_61(func_70()));
...
break;
case 1:
if(func_110(iVar0, iVar1) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar1, 1)){
iLocal_42[iVar0]=0;
func_109(iVar1);
}
break;
...
case 0:
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iParam1, PED::GET_VEHICLE_PED_IS_IN(iParam1, 0), Local_264, 4, 20f, 786469, 3.5f, 5f, 1);
iLocal_41[iParam0]=3;
break;
case 3:
if(!func_112(iParam0, iParam1) || func_64(PLAYER::PLAYER_PED_ID(), Local_264, 2f, 1)){
iLocal_41[iParam0]=4;
}
break;
case 4:
...
switch (iLocal_41[iParam0]){
case 0:
if(!MISC::IS_POSITION_OCCUPIED(Local_252[iLocal_468 /*4*/], 1.5f, 0, 0, 1, 0, 0, iParam1, 0)){
if(func_64(iParam1, Local_252[iLocal_468 /*4*/], 5f, 1)){
fVar0=1f;
}else{
fVar0=2f;
}
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iParam1, Local_252[iLocal_468 /*4*/], fVar0, 20000, 0.25f, 0, Local_252[iLocal_468 /*4*/].f_3);
iLocal_41[iParam0]=1;
}
break;
case 1:
...
if(!func_113()){
if((ENTITY::DOES_ENTITY_EXIST(Local_288.f_0) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_288.f_0, 0)) && !ENTITY::IS_ENTITY_AT_COORD(Local_288.f_0, Local_264, 2f, 2f, 2f, 0, 1, 0)){
if((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_288.f_0, 0)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if(PED::IS_PED_IN_VEHICLE(iParam1, Local_288.f_0, 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_288.f_0, -1, 0)==iParam1){
iLocal_42[iParam0]=2;
return 1;
}}}}
return 0;
...
if(iLocal_38==2){
if(!iLocal_284){
if(!func_64(PLAYER::PLAYER_PED_ID(), Local_288.f_1, 180f, 1)){
iVar0=0;
while (iVar0 <=2){
...
if(ENTITY::DOES_ENTITY_EXIST(Local_287[iVar0 /*22*/]) && !PED::IS_PED_INJURED(Local_287[iVar0 /*22*/])){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_287[iVar0 /*22*/], PLAYER::PLAYER_PED_ID(), 1)){
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_287[iVar0 /*22*/]);
if(((WEAPON::IS_PED_CURRENT_WEAPON_SILENCED(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_BEING_STEALTH_KILLED(Local_287[iVar0 /*22*/])) || PED::WAS_PED_KILLED_BY_STEALTH(Local_287[iVar0 /*22*/])) || PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_287[iVar0 /*22*/])){
if(!bLocal_272){
...
if(MISC::GET_GAME_TIMER() - Local_287[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1000, 1500){
if(!func_79(Local_287[iParam0 /*22*/], joaat("script_task_turn_ped_to_face_entity"))){
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(Local_287[iParam0 /*22*/]);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_287[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 0);
}
Local_287[iParam0 /*22*/].f_14=MISC::GET_GAME_TIMER();
}}else{
func_135(iParam0);
}
break;
case 2:
if(MISC::GET_GAME_TIMER() - Local_287[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(5000, 6000){
if(MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 2)){
func_128(iParam0);
func_126();
return;
}elseif(func_125(iParam0, 15)){
func_135(iParam0);
return;
}else{
...
break;
case 3:
if(MISC::GET_GAME_TIMER() - Local_287[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(2500, 3000){
if(MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 8)){
Local_287[iParam0 /*22*/].f_17=1;
}else{
iLocal_276=0;
func_135(iParam0);
...
func_126();
return;
}elseif(MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 9) && !bLocal_270){
func_128(iParam0);
func_126();
return;
}else{
...
if((MISC::GET_GAME_TIMER() - Local_287[iParam0 /*22*/].f_14) > iVar0){
if(!PED::IS_PED_BEING_STUNNED(Local_287[iParam0 /*22*/], 0) && !TASK::IS_PED_IN_WRITHE(Local_287[iParam0 /*22*/])){
Local_287[iParam0 /*22*/].f_14=MISC::GET_GAME_TIMER();
func_128(iParam0);
}}
break;
case 5:
if(MISC::GET_GAME_TIMER() - Local_287[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1000, 3000){
func_126();
return;
}
break;
case 7:
if((MISC::GET_GAME_TIMER() - Local_287[iParam0 /*22*/].f_14) > 350){
if(!bLocal_272 && func_125(iParam0, 15)){
func_74();
func_135(iParam0);
HUD::REMOVE_COP_BLIP_FROM_PED(Local_287[iParam0 /*22*/]);
return;
}else{
if(iLocal_463 !=-1){
if((MISC::GET_GAME_TIMER() - iLocal_463) > 12000){
func_124(-1);
}
...
if((func_79(Local_287[iParam0 /*22*/], joaat("script_task_invalid")) || func_79(Local_287[iParam0 /*22*/], joaat("script_task_stand_still"))) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 2){
if(!func_79(Local_287[iParam0 /*22*/], joaat("script_task_arrest_ped"))){
TASK::TASK_ARREST_PED(Local_287[iParam0 /*22*/], PLAYER::PLAYER_PED_ID());
}}}}
if(!iLocal_461){
if(MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 1) && MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 14)){
if(iParam0==0){
sVar3="PRA_COPSHT1";
}else{
sVar3="PRA_COPSHT2";
...
iLocal_463=-1;
if(func_383(Local_287[0 /*22*/])){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_287[0 /*22*/], false);
}
if(func_383(Local_287[1 /*22*/])){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_287[1 /*22*/], false);
}
if(func_383(Local_287[2 /*22*/])){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_287[2 /*22*/], false);
}
if(iParam0 !=-1){
...
while (bVar0 <=14){
if(bVar0 !=iParam1){
if(MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, bVar0)){
return 0;
}}
bVar0++;
}
...
func_196(&(Local_287[iVar0 /*22*/].f_6));
Local_287[iVar0 /*22*/].f_14=MISC::GET_GAME_TIMER();
...
if(func_383(Local_287[iParam0 /*22*/])){
if(func_79(Local_287[iParam0 /*22*/], joaat("script_task_perform_sequence")) || PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(Local_287[iParam0 /*22*/])){
TASK::CLEAR_PED_TASKS(Local_287[iParam0 /*22*/]);
}elseif(func_79(Local_287[iParam0 /*22*/], joaat("script_task_start_scenario_at_position")) || func_79(Local_287[iParam0 /*22*/], joaat("script_task_start_scenario_in_place"))){
PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(Local_287[iParam0 /*22*/]);
}
PED::SET_PED_AS_COP(Local_287[iParam0 /*22*/], 1);
TASK::TASK_ARREST_PED(Local_287[iParam0 /*22*/], PLAYER::PLAYER_PED_ID());
WEAPON::GIVE_WEAPON_TO_PED(Local_287[iParam0 /*22*/], joaat("weapon_pistol"), -1, 0, 1);
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_287[iParam0 /*22*/]);
PLAYER::UPDATE_WANTED_POSITION_THIS_FRAME(PLAYER::PLAYER_ID());
func_129(iParam0);
...
char* sVar0;
if((iLocal_38 !=2 && !iLocal_462) && !ENTITY::IS_ENTITY_DEAD(Local_287[iParam0 /*22*/], 0)){
...
if(MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 3)){
iLocal_462=1;
}elseif(!func_125(iParam0, 15) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, 1, 0)){
func_130();
iLocal_459=0;
if(iParam0==2){
func_122(&uLocal_292, cLocal_291, sVar0, 7, 0, 0);
}else{
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_287[iParam0 /*22*/], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", 0);
}
iLocal_462=1;
}}}}
...
TASK::CLEAR_PED_TASKS(Local_287[iParam0 /*22*/]);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_287[iParam0 /*22*/], uLocal_290);
if(iParam0==2){
TASK::OPEN_SEQUENCE_TASK(&uVar0);
if(!func_64(Local_287[iParam0 /*22*/], Local_287[iParam0 /*22*/].f_1, 3f, 1)){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_287[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, 0, Local_287[iParam0 /*22*/].f_4);
}else{
TASK::TASK_ACHIEVE_HEADING(0, Local_287[iParam0 /*22*/].f_4, 0);
}
if(iLocal_457[2] && MISC::IS_STRING_NULL_OR_EMPTY("sResumeRoot")){
TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
}else{
TASK::TASK_USE_MOBILE_PHONE(0, 1, 1);
}
TASK::CLOSE_SEQUENCE_TASK(uVar0);
TASK::TASK_PERFORM_SEQUENCE(Local_287[iParam0 /*22*/], uVar0);
...
func_136();
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_287[iParam0 /*22*/], false);
...
void func_136(){
if(func_12(&uLocal_44, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
if(!func_104()){
if((!MISC::ARE_STRINGS_EQUAL(&cLocal_469, "NONE") && !MISC::ARE_STRINGS_EQUAL(&cLocal_473, "NONE")) && !func_67("PR_TAKBACK", 0, 0)){
...
case 0:
if(func_104()){
if(PED::IS_PED_BEING_STEALTH_KILLED(Local_287[iParam0 /*22*/])){
func_130();
}}elseif(iParam0==2){
if(iLocal_457[2] && !AUDIO::IS_PED_IN_CURRENT_CONVERSATION(Local_287[iParam0 /*22*/])){
TASK::CLEAR_PED_TASKS(Local_287[iParam0 /*22*/]);
TASK::TASK_START_SCENARIO_IN_PLACE(Local_287[iParam0 /*22*/], "WORLD_HUMAN_STAND_MOBILE", 0, 1);
}}
break;
case 1:
break;
...
func_175(iParam0);
if(!func_174(iParam0)){
if(func_155(Local_287[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_287[iParam0 /*22*/], 1), 100f)){
if((!PED::IS_PED_BEING_STEALTH_KILLED(Local_287[iParam0 /*22*/]) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_287[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_287[iParam0 /*22*/])){
func_126();
}elseif(!bLocal_272){
PLAYER::SUPPRESS_CRIME_THIS_FRAME(PLAYER::PLAYER_ID(), 41);
PLAYER::SUPPRESS_CRIME_THIS_FRAME(PLAYER::PLAYER_ID(), 33);
...
PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, 0);
PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), 0);
}}}elseif(func_154(Local_287[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 5f, 1)){
if(!bLocal_272){
PLAYER::SUPPRESS_CRIME_THIS_FRAME(PLAYER::PLAYER_ID(), 41);
PLAYER::SUPPRESS_CRIME_THIS_FRAME(PLAYER::PLAYER_ID(), 33);
}}}
...
if(bParam4){
return 0;
}elseif(func_156(iParam0, fParam3)){
return 1;
}}
return 0;
}
...
float fVar2;
Var0={
func_164(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
...
Var1={
func_164(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) 
};
}
...
Vector3 func__164(struct<3> Param0){
float fVar0;
float fVar1;
fVar0=vmag(Param0);
if(fVar0 !=0f){
...
float fVar2;
Var0={
func_164(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) 
};
if(fParam2 < 0.1f || fParam2 > 360f){
return 1;
}
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_287[iParam0 /*22*/], 0f, -2f, 0f), 2f, 3f, 2f, 0, 1, 0) && !WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)){
return 1;
}
return 0;
}
...
if(((!bLocal_270 && !PED::IS_PED_BEING_STEALTH_KILLED(Local_287[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_287[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_287[iParam0 /*22*/])){
func_176(iParam0);
}}}
...
if(Local_287[func_151(iParam0) /*22*/].f_20 !=3 || (MISC::GET_GAME_TIMER() - iLocal_274) > 7500){
if(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 9)){
if(iParam0==0){
sVar0="PRA_CWCAR1";
}elseif(iParam0==1){
sVar0="PRA_CWCAR2";
...
if(Local_287[func_151(iParam0) /*22*/].f_20 !=4 || (MISC::GET_GAME_TIMER() - iLocal_274) > 7500){
if(!bLocal_271){
if(iParam0==0){
sVar0="PRA_CWCARNP1";
}elseif(iParam0==1){
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_287[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", 0);
}elseif(iParam0==1){
...
Local_287[iParam0 /*22*/].f_14=MISC::GET_GAME_TIMER();
Local_287[func_151(iParam0) /*22*/].f_14=MISC::GET_GAME_TIMER();
...
struct<6> Var0;
if(bParam3){
if(MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 12)){
return;
}}
Var0={
func_182() 
...
if(!func_150(iParam0) || iParam2){
if(iParam1==1){
if(Local_287[iParam0 /*22*/].f_19 !=1 || (MISC::GET_GAME_TIMER() - iLocal_274) > 7500){
if(!bLocal_270){
if(iParam0==0){
sVar0="PRA_COPPRT1";
}elseif(iParam0==1){
...
if(Local_287[iParam0 /*22*/].f_19 !=2 || (MISC::GET_GAME_TIMER() - iLocal_274) > 7500){
if(iParam0==0){
sVar0="PRA_COPPLY1";
}elseif(iParam0==1){
sVar0="PRA_COPPLY2";
...
if(Local_287[iParam0 /*22*/].f_19 !=4 || (MISC::GET_GAME_TIMER() - iLocal_274) > 7500){
if(iParam0==0){
sVar0="PRA_COPST1";
}elseif(iParam0==1){
sVar0="PRA_COPST2";
...
AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(Local_287[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", 0);
func_184(iParam0, iParam1, 0);
}}elseif(iParam1==7){
...
if(bLocal_270){
if(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 12)){
MISC::SET_BIT(&(Local_287[iParam0 /*22*/].f_15), 12);
}}}}
...
return;
}elseif(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 11)){
if((((fVar0 > 16f && !Local_287[iParam0 /*22*/].f_16) && !MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 10)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_287[iParam0 /*22*/], Local_253[1 /*7*/], Local_253[1 /*7*/].f_3, Local_253[1 /*7*/].f_6, 0, 1, 0)){
func_187(iParam0, 11);
return;
}}}
if(((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_253[1 /*7*/], Local_253[1 /*7*/].f_3, Local_253[1 /*7*/].f_6, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_287[iParam0 /*22*/], Local_253[1 /*7*/], Local_253[1 /*7*/].f_3, Local_253[1 /*7*/].f_6, 0, 1, 0)) && !MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 10)) && !MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 11)){
if((fVar0 > 12f && !Local_287[iParam0 /*22*/].f_16) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, 1, 0)){
func_187(iParam0, 11);
}}}elseif((MISC::GET_GAME_TIMER() - iLocal_279) > 4000){
iLocal_280=0;
}}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_253[5 /*7*/], Local_253[5 /*7*/].f_3, Local_253[5 /*7*/].f_6, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_287[iParam0 /*22*/], Local_253[5 /*7*/], Local_253[5 /*7*/].f_3, Local_253[5 /*7*/].f_6, 0, 1, 0)){
...
if(MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, bParam1)){
MISC::CLEAR_BIT(&(Local_287[iParam0 /*22*/].f_15), bParam1);
Local_287[iParam0 /*22*/].f_17=1;
}}
...
if(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, bParam1)){
MISC::SET_BIT(&(Local_287[iParam0 /*22*/].f_15), bParam1);
Local_287[iParam0 /*22*/].f_17=1;
}}
...
bVar0=false;
if(((func_154(Local_287[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 5f, 1) && !PED::IS_PED_BEING_STEALTH_KILLED(Local_287[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_287[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_287[iParam0 /*22*/])){
...
func_187(iParam0, 3);
}}}}elseif(!func_154(Local_287[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 5.5f, 1)){
func_186(iParam0, 5);
func_186(iParam0, 3);
}}
...
if(Local_287[iParam0 /*22*/].f_20 !=7){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_287[iParam0 /*22*/], 1f, -1f, 0f), 1f, 1f, 2f, 0, 1, 0)){
return 1;
}}
return 0;
}
...
if(ENTITY::IS_ENTITY_TOUCHING_ENTITY(Local_287[iParam0 /*22*/], PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_RAGDOLL(Local_287[iParam0 /*22*/])){
*iParam1=1;
}else{
*iParam1=0;
}
...
if(Local_287[iParam0 /*22*/].f_16){
if(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 12)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_253[iVar0 /*7*/], Local_253[iVar0 /*7*/].f_3, Local_253[iVar0 /*7*/].f_6, 0, 1, 0)){
iLocal_280=1;
iLocal_279=MISC::GET_GAME_TIMER();
if(iVar0==4){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
...
}}}elseif(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_253[iVar0 /*7*/], Local_253[iVar0 /*7*/].f_3, Local_253[iVar0 /*7*/].f_6, 0, 1, 0) || MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 12)){
func_192(iParam0, iVar0);
}
iVar0++;
}}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_253[3 /*7*/], Local_253[3 /*7*/].f_3, Local_253[3 /*7*/].f_6, 0, 1, 0)){
func_194(iParam0, 3);
}else{
func_192(iParam0, 3);
}}
...
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, Local_253[4 /*7*/], Local_253[4 /*7*/].f_3, Local_253[4 /*7*/].f_6, 0, 1, 0)){
func_186(iParam0, 8);
func_186(iParam0, 7);
}elseif(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 7)){
func_187(iParam0, 7);
}}else{
func_186(iParam0, 8);
func_186(iParam0, 7);
...
switch (iParam1){
case 1:
if((!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 6) && !MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 1)) && !MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 9)){
if(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 10)){
func_187(iParam0, 10);
}}
break;
case 2:
if(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 1)){
if(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 6)){
func_187(iParam0, 6);
}}
break;
case 0:
...
break;
case 3:
if(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 14)){
func_187(iParam0, 14);
}
break;
case 4:
...
MISC::SET_BIT(&(Local_287[iParam0 /*22*/].f_15), 9);
func_187(iParam0, 8);
}else{
MISC::CLEAR_BIT(&(Local_287[iParam0 /*22*/].f_15), 9);
func_187(iParam0, 8);
}}
break;
case 5:
if(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 4)){
if((!PED::IS_PED_BEING_STEALTH_KILLED(Local_287[iParam0 /*22*/]) && !PED::WAS_PED_KILLED_BY_STEALTH(Local_287[iParam0 /*22*/])) && !PED::WAS_PED_KILLED_BY_TAKEDOWN(Local_287[iParam0 /*22*/])){
func_187(iParam0, 4);
}}
break;
...
if(func_154(PLAYER::PLAYER_PED_ID(), Local_287[iParam0 /*22*/], 30f, 1)){
if(func_158(Local_287[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 140f, 1, 250, 7)){
...
if(ENTITY::DOES_ENTITY_EXIST(Local_287[iVar0 /*22*/])){
if(func_7(PLAYER::GET_PLAYERS_LAST_VEHICLE())){
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_287[iVar0 /*22*/], PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1)){
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_287[iVar0 /*22*/]);
func_126();
}}
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_287[iVar0 /*22*/], PLAYER::PLAYER_PED_ID(), 1)){
...
if((MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 13) && (MISC::GET_GAME_TIMER() - iLocal_274) > 2500) && !iLocal_464){
if(iParam0==0){
sVar0="PRA_COPST1";
}
elseif(iParam0==1){
...
func_122(&uLocal_292, cLocal_291, sVar0, 7, 0, 0);
MISC::CLEAR_BIT(&(Local_287[iParam0 /*22*/].f_15), 13);
MISC::CLEAR_BIT(&(Local_287[func_151(iParam0) /*22*/].f_15), 13);
iLocal_464=1;
}
Local_287[iParam0 /*22*/].f_17=1;
}}
break;
case 2:
if(MISC::GET_GAME_TIMER() - Local_287[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(1500, 2000){
if(func_125(iParam0, 12)){
func_135(iParam0);
return;
}else{
...
case 5:
if(MISC::GET_GAME_TIMER() - Local_287[iParam0 /*22*/].f_14) > MISC::GET_RANDOM_INT_IN_RANGE(2500, 3000){
if(!func_154(Local_287[iParam0 /*22*/], PLAYER::PLAYER_PED_ID(), 1.5f, 1)){
MISC::CLEAR_BIT(&(Local_287[iParam0 /*22*/].f_15), 5);
}
if(func_125(iParam0, 12)){
func_135(iParam0);
return;
...
if(((fVar1 < 12f && !Local_287[iParam0 /*22*/].f_16) && !MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 10)) && !func_79(Local_287[iParam0 /*22*/], joaat("script_task_turn_ped_to_face_entity"))){
MISC::CLEAR_BIT(&(Local_287[iParam0 /*22*/].f_15), 11);
}
if(func_125(iParam0, 12)){
func_135(iParam0);
return;
...
if(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 13)){
if(MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 10)){
if(Local_287[iParam0 /*22*/].f_16){
if(bVar0){
func_187(iParam0, 13);
...
if(bVar0){
if(!func_154(PLAYER::PLAYER_PED_ID(), Local_287[iParam0 /*22*/], 10f, 1)){
if(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 10) && !MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 6)){
MISC::CLEAR_BIT(&(Local_287[iParam0 /*22*/].f_15), 13);
}}}else{
func_186(iParam0, 13);
}}}}
...
if(Local_287[iParam0 /*22*/].f_20 !=6 && Local_287[iParam0 /*22*/].f_20 !=7){
if(func_154(PLAYER::PLAYER_PED_ID(), Local_287[iParam0 /*22*/], 12f, 1)){
if(bVar0){
if(Local_287[iParam0 /*22*/].f_16){
if(!MISC::IS_BIT_SET(Local_287[iParam0 /*22*/].f_15, 2)){
func_187(iParam0, 2);
...
if(bLocal_272){
func_126();
}elseif(func_155(Local_287[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_287[iParam0 /*22*/], 1), 100f)){
func_126();
}elseif(func_205(func_151(iParam0))){
func_126();
}}}
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_287[iParam0 /*22*/], fVar0, fVar0, fVar0, 0, 1, 0)){
if(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_287[iParam0 /*22*/]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_287[iParam0 /*22*/])){
if(Local_287[iParam0 /*22*/].f_16){
return 1;
}}}}
return 0;
...
if((((func_383(Local_287[0 /*22*/]) && func_383(Local_287[1 /*22*/])) && func_12(&uLocal_44, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))) && func_64(Local_287[0 /*22*/], Local_287[0 /*22*/].f_1, 3f, 1)) && func_64(Local_287[1 /*22*/], Local_287[1 /*22*/].f_1, 3f, 1)){
...
iLocal_459=1;
}}}elseif((func_383(Local_287[2 /*22*/]) && func_12(&uLocal_96, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))) && func_64(Local_287[2 /*22*/], Local_287[2 /*22*/].f_1, 3f, 1)){
if(!MISC::IS_BIT_SET(Local_287[2 /*22*/].f_15, 2) && !MISC::IS_BIT_SET(Local_287[2 /*22*/].f_15, 4)){
if(func_207(0, &(iLocal_457[2]), "PRA_COPTLK3", 10f, 4)){
iLocal_459=1;
}}}elseif(iLocal_459 && func_104()){
func_54();
iLocal_459=0;
}}}
...
AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Global_42073[13 /*31*/], 1);
}
iLocal_477=0;
...
if((PED::IS_PED_CLIMBING(PLAYER::PLAYER_PED_ID()) && iLocal_477==0) && func_133(Local_288.f_0, PLAYER::PLAYER_PED_ID(), 1) < 100f){
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0)){
func_226(iVar0, ENTITY::GET_ENTITY_COORDS(iVar0, 1), ENTITY::GET_ENTITY_HEADING(iVar0), 24, 0);
}}}
...
func_264(iParam3, &Var0, Param1, uParam2, func_270(iParam0));
...
if((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_247(iParam0, 0, 0)) || func_247(iParam0, 1, 0)) || func_247(iParam0, 2, 0)) || func_270(iParam0) !=145) || func_246(iParam0)) || func_245(iParam0)) || func_244(iParam0)) || func_243(iParam0)) || !func_230(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(func_245(iParam0)){
}
if(func_245(iParam0)){
}
...
iVar0=0;
while (func_248(iParam1, iVar0, &sVar1, &iVar2)){
...
int func_248(int iParam0, int iParam1, char* sParam2, var uParam3){
...
return (shift_right(iParam0, 26) & 31 * func_256(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_264(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_261(&(Global_77479.f_555[0 /*21*/]), iParam0)){
...
iVar0=ENTITY::GET_ENTITY_MODEL(iParam0);
Global_78472[1 /*14*/]={
func_298(iVar0, iParam1, iParam2, -1) 
};
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_278(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(iParam0, func_278(iParam1))){
return 1;
}
return 0;
}
...
return 1;
}elseif(func_286(iParam0, iParam2, iParam3, -1)){
...
return 1;
}elseif(func_282(iParam0, iParam2, iParam3, -1)){
if(((((((((iParam1==1 || iParam1==2) || iParam1==4) || iParam1==5) || iParam1==10) || iParam1==11) || iParam1==12) || iParam1==14) || iParam1==18) || iParam1==50){
return 0;
}
return 1;
...
iVar1=(iParam1 - func_285(iParam0));
if(iVar1 < 0){
return -1;
}
...
iVar4=(iParam1 - func_284(iParam0, func_278(iParam2)));
if(iVar4 < 0){
return -1;
}
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_278(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
struct<10> func_289(int iParam0, int iParam1){
int iVar0;
struct<10> Var1;
Var1=9;
iVar0=0;
...
(*iParam0)[Var2.f_2]=func_291(iParam1, Var2.f_0, 14, iVar0);
}elseif(Var2.f_1 !=-1){
...
if(iVar3 !=-1){
return (func_285(iParam0) + iVar3);
}}else{
FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_278(iParam2));
iVar4=FILES::GET_SHOP_PED_QUERY_COMPONENT_INDEX(iParam1);
if(iVar4 !=-1){
return (func_284(iParam0, func_278(iParam2)) + iVar4);
}}
return -99;
}
...
(*uParam0)[func_296(Var2.f_2)]=Var2.f_0;
uParam0->f_16=1;
}else{
(*uParam0)[func_296(Var2.f_2)]=func_291(iParam1, Var2.f_0, func_296(Var2.f_2), iVar0);
}}elseif(Var2.f_1 !=-1){
(*uParam0)[func_296(Var2.f_2)]=Var2.f_1;
}}
iVar4++;
}
if(Var1.f_3==0){
...
struct<14> func_298(int iParam0, int iParam1, int iParam2, int iParam3){
func_366();
if(iParam0==joaat("player_zero")){
...
break;
default:
func_312(iVar7, iParam0, 155, -1);
return;
break;
}
func_301(&(Global_78472[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}


void func_301(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10){
var uVar0;
int iVar1;
uParam0->f_6=0;
*uParam0=iParam9;
...
var uVar1;
if(iParam0 !=14385){
uVar0=func_305(iParam0, iParam1);
...
var func__305(int iParam0, var uParam1){
return unk_0xD69CE161FE614531(0, iParam0, func_306(uParam1));
}
...
int func_308(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6){
if(iParam0==0){
if(iParam5==1){
...
func_301(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var5.f_9), Var5.f_3, Var5.f_4, Var5.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var5.f_1, joaat("outfit_only"), 0), iVar6, 2, Var5.f_1 !=0);
return;
}}}else{
...
func_301(&(Global_78472[0 /*14*/]), iParam0, iParam1, &(Var9.f_9), Var9.f_3, Var9.f_4, Var9.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var9.f_1, joaat("outfit_only"), 0), -1, 2, Var9.f_1 !=0);
return;
}
iVar10=(iParam1 - iParam2);
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_278(iParam0));
if(iVar11 > iVar10){
...
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iLocal_267, 0, 1, 1);
}else{
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iLocal_267, 1, 1, 1);
}}
...
if(func_12(&uLocal_148, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
func_372(Global_42073[13 /*31*/], &fLocal_268);
return;
}}else{
func_371(Global_42073[13 /*31*/], &fLocal_268);
}}elseif(PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID()) || iLocal_40==1){
...
if(*fParam1 !=0f){
if(!PATHFIND::DOES_NAVMESH_BLOCKING_OBJECT_EXIST(uLocal_269)){
uLocal_269=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_82(229.3746f), 0, 7);
}
...
PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(uLocal_269);
*fParam1=0f;
}}}}
...
if(!func_64(PLAYER::PLAYER_PED_ID(), 372.0053f, -1604.076f, 36.7536f, 100f, 1) && !bLocal_285){
func_379("PR_AREAWARN", &bLocal_285);
}elseif(!func_64(PLAYER::PLAYER_PED_ID(), 372.0053f, -1604.076f, 36.7536f, 170f, 1) && bLocal_285){
func_378(3);
}}}
...
void func_379(char* sParam0, bool bParam1){
if(!*bParam1){
func_60(sParam0, 7500, 0);
*bParam1=1;
}}
...
func_381();
if(iLocal_38==2 || iLocal_38==3){
if(!func_154(PLAYER::PLAYER_PED_ID(), Local_288.f_0, 50f, 1) && !bLocal_286){
func_379("PR_VANWARN", &bLocal_286);
}elseif(!func_154(PLAYER::PLAYER_PED_ID(), Local_288.f_0, 100f, 1) && bLocal_286){
func_378(4);
}}}}


void func_381(){
if(VEHICLE::IS_VEHICLE_STUCK_ON_ROOF(Local_288.f_0)){
if(iLocal_266){
if((MISC::GET_GAME_TIMER() - iLocal_265) > 5000){
func_378(2);
return;
}}else{
...
void func_388(){
Local_253[1 /*7*/]={
func_389(359.5238f, -1581.445f, 28.29278f, 341.1343f, -1603.052f, 40.37049f, 7.3f) 
};
Local_253[2 /*7*/]={
func_389(352.2312f, -1590.471f, 28.29277f, 341.1343f, -1603.052f, 40.37049f, 6.78f) 
};
Local_253[0 /*7*/]={
func_389(344.5851f, -1601.562f, 28.29278f, 342.4275f, -1604.071f, 40.29278f, 3.79f) 
};
Local_253[3 /*7*/]={
func_389(345.0102f, -1604.096f, 40.6735f, 361.0914f, -1617.46f, 28.29278f, 3.33f) 
};
Local_253[4 /*7*/]={
func_389(362.7986f, -1577.081f, 28.29278f, 341.1343f, -1603.052f, 40.37049f, 6.78f) 
};
Local_253[5 /*7*/]={
func_389(365.9773f, -1611.556f, 28.29277f, 373.1279f, -1617.806f, 40.37049f, 19.19f) 
};
}


struct<7> func_389(struct<3> Param0, struct<3> Param1, float fParam2){
struct<7> Var0;
Var0={
Param0 
};
...
if(!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(iLocal_267)){
OBJECT::ADD_DOOR_TO_SYSTEM(iLocal_267, joaat("prop_fnclink_03gate5"), 391.8602f, -1636.07f, 29.9744f, 1, 1, 0);
}
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42073[13 /*31*/], 1, 1, 0);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iLocal_267, 1, 1, 0);
}
...
func_396(&uLocal_148, &Var0, 4);
func_395(&uLocal_200);
func_394(&uLocal_200, 408.8245f, -1616.011f, 31.7537f);
func_394(&uLocal_200, 376.3118f, -1588.036f, 36.7534f);
func_394(&uLocal_200, 354.1272f, -1614.819f, 31.5335f);
func_394(&uLocal_200, 387.2971f, -1641.943f, 31.833f);
func_393(&uLocal_200);
}
...
void func_394(var uParam0, struct<3> Param1){
if(uParam0->f_51==0){}
if(uParam0->f_46 >=15){}
...
void func_396(var uParam0, var uParam1, int iParam2){
int iVar0;
func_395(uParam0);
iVar0=0;
...
Local_287[0 /*22*/]={
func_398(353.1191f, -1589.606f, 28.2928f, 270.0968f, iVar0) 
};
Local_287[1 /*22*/]={
func_398(354.557f, -1590.549f, 28.2928f, 16.3702f, iVar0) 
};
Local_287[2 /*22*/]={
func_398(369.8186f, -1611.029f, 28.3928f, 9.0837f, iVar0) 
};
iVar1=0;
while (iVar1 <=2){
...
bVar2=false;
while (bVar2 <=(15 - 1)){
MISC::CLEAR_BIT(&(Local_287[iVar1 /*22*/].f_15), bVar2);
bVar2++;
}
iVar1++;
}
...
struct<22> func_398(struct<3> Param0, float fParam1, int iParam2){
struct<22> Var0;
Var0.f_14=-1;
Var0.f_1={
Param0 
...
void func_399(){
Local_288={
func_400(372.9868f, -1623.531f, 28.2928f, 321.7075f, joaat("policet")) 
};
Local_289[0 /*6*/]={
func_400(400.5771f, -1618.927f, 28.2928f, 48.8115f, joaat("police3")) 
};
Local_289[1 /*6*/]={
func_400(396.6843f, -1623.222f, 28.2928f, 231.3392f, joaat("police3")) 
};
Local_289[2 /*6*/]={
func_400(394.3527f, -1625.337f, 28.2928f, 49.3732f, joaat("police3")) 
};
}


struct<6> func_400(struct<3> Param0, float fParam1, int iParam2){
struct<6> Var0;
Var0.f_1={
Param0 
};
...
void func_401(){
PED::ADD_RELATIONSHIP_GROUP("COPS", &uLocal_290);
}


void func_402(){
PED::REMOVE_RELATIONSHIP_GROUP(uLocal_290);
func_413(1);
if(OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Global_42073[13 /*31*/])){
AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Global_42073[13 /*31*/], 0);
}
OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Global_42073[13 /*31*/], 0f, 1, 1);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Global_42073[13 /*31*/], 4, 1, 1);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iLocal_267, 0, 1, 0);
OBJECT::REMOVE_DOOR_FROM_SYSTEM(iLocal_267, 0);
...
if(CAM::DOES_CAM_EXIST(uLocal_261)){
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
CAM::DESTROY_CAM(uLocal_261, 0);
}}
...
void func_409(){
int iVar0;
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_288.f_5);
iVar0=0;
while (iVar0 <=2){
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_289[iVar0 /*6*/].f_5);
iVar0++;
}}
