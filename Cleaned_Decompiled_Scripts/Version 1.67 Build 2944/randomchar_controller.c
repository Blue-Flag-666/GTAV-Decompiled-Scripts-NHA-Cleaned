...
func_3(iLocal_52[Global_112897[iVar0 /*10*/].f_8], 0, 0);
...
if(HUD::DOES_BLIP_EXIST(Global_32663[iVar3 /*23*/].f_19)){
HUD::SET_BLIP_FLASHES(Global_32663[iVar3 /*23*/].f_19, 1);
HUD::SET_BLIP_FLASH_TIMER(Global_32663[iVar3 /*23*/].f_19, 10000);
switch (func_9()){
case 1:
...
return (shift_right(iParam0, 26) & 31 * func_31(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_46(){
if(!func_45(39)){
if(MISC::IS_BIT_SET(Global_113810.f_18577[27 /*6*/], 3)){
...
if(func_75()){
if(!func_43(114)){
if(MISC::IS_BIT_SET(Global_113810.f_18577[46 /*6*/], 3)){
func_72(552744224, 6, 2, 50, 60000, 10000, -1, 181, -1, 0, 1);
func_71(114, 1);
}}elseif(!func_43(83)){
if(MISC::IS_BIT_SET(Global_113810.f_18577[51 /*6*/], 3)){
...
func_62(Global_113810.f_7691.f_137[iVar1 /*15*/].f_6);
iVar2=iVar1;
...
if(!MISC::IS_BIT_SET(Global_113810.f_18577.f_390[iLocal_50], bLocal_49)){
func_18(iVar0, &Var1);
if(iVar0==58){
MISC::SET_BIT(&(Global_113810.f_18577.f_390[iLocal_50]), bLocal_49);
}elseif(HUD::GET_MINIMAP_FOW_COORDINATE_IS_REVEALED(Var1.f_6)){
MISC::SET_BIT(&(Global_113810.f_18577.f_390[iLocal_50]), bLocal_49);
}elseif(Global_112897[iVar0 /*10*/].f_8 !=-1){
if(iLocal_51[Global_112897[iVar0 /*10*/].f_8]){
if(MISC::IS_BIT_SET(Global_32663[iLocal_52[Global_112897[iVar0 /*10*/].f_8] /*23*/].f_11, 6)){
func_81(iLocal_52[Global_112897[iVar0 /*10*/].f_8]);
}}}}elseif(Global_112897[iVar0 /*10*/].f_8 !=-1){
if(iLocal_51[Global_112897[iVar0 /*10*/].f_8]){
if(!MISC::IS_BIT_SET(Global_32663[iLocal_52[Global_112897[iVar0 /*10*/].f_8] /*23*/].f_11, 6)){
func_77(iLocal_52[Global_112897[iVar0 /*10*/].f_8]);
}}}}}
...
if(!MISC::IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 1)){
if(!Var0.f_23){
MISC::SET_BIT(&(Global_113810.f_18577[iParam0 /*6*/]), true);
}}
if(MISC::IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 0) && !MISC::IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 3)){
...
Global_113810.f_18577[iParam0 /*6*/].f_2=uVar1;
...
func_122(Global_113810.f_18577[iParam0 /*6*/].f_2, &uVar4, &uVar5, &uVar6, &iVar7, &iVar8, &iVar9);
...
if(MISC::IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 2) && !MISC::IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 3)){
bVar11=true;
if(func_128(iParam0)){
bVar11=false;
}
...
Global_112897[iParam0 /*10*/].f_3=1;
}elseif(Global_112897[iParam0 /*10*/].f_3){
if(((((Var0.f_4==0 || Var0.f_4==2) || Var0.f_4==3) || Var0.f_4==11) || Var0.f_4==16) || Var0.f_4==17){
fVar13=100f;
}else{
fVar13=209f;
}
if(!func_120() && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Var0.f_6, 0) > fVar13){
Global_112897[iParam0 /*10*/].f_3=0;
}else{
...
iVar14=0;
if((((iVar12 && !MISC::IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 3)) && MISC::IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 0)) && MISC::IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 1)) && MISC::IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 2)){
if(iParam0==58 && func_106()){
}else{
iVar14=2;
}}
if(Global_112897[iParam0 /*10*/].f_7 !=iVar14){
if(func_105(&(Global_112897[iParam0 /*10*/].f_8))){
if(func_16(Var0.f_6, 0f, 0f, 0f, 0)){
}else{
iVar15=iLocal_52[Global_112897[iParam0 /*10*/].f_8];
if(iVar14==0){
func_3(iVar15, 0, 0);
func_104(iVar15, 0);
...
Global_112897[iParam0 /*10*/].f_7=iVar14;
}}
if(!MISC::IS_BIT_SET(Global_113810.f_18577[iParam0 /*6*/], 4)){
...
if(vdist2(Var0.f_6, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)) < 81f){
sVar16="";
...
if(iParam0==2){
if(MISC::IS_BIT_SET(Global_113810.f_18577[3 /*6*/], 3) && Global_112897[3 /*10*/].f_3==1){
return 1;
}}elseif(iParam0==3){
if(MISC::IS_BIT_SET(Global_113810.f_18577[2 /*6*/], 3) && Global_112897[2 /*10*/].f_3==1){
return 1;
}}
return 0;
}
...
if(MISC::IS_BIT_SET(Global_113810.f_18577[2 /*6*/], 0) && MISC::IS_BIT_SET(Global_113810.f_18577[3 /*6*/], 0)){
...
if(bParam1 !=MISC::IS_BIT_SET(Global_32663[iVar0 /*23*/].f_11, 8)){
MISC::SET_BIT(&(Global_32663[iVar0 /*23*/].f_11), 18);
}
MISC::SET_BIT(&(Global_32663[iVar0 /*23*/].f_11), 8);
}else{
Global_32663[iVar0 /*23*/].f_18=iParam2;
if(bParam1 !=MISC::IS_BIT_SET(Global_32663[iVar0 /*23*/].f_11, 10)){
MISC::SET_BIT(&(Global_32663[iVar0 /*23*/].f_11), 18);
}
...
if(MISC::IS_BIT_SET(Global_32663[iVar0 /*23*/].f_11, 8) || MISC::IS_BIT_SET(Global_32663[iVar0 /*23*/].f_11, 10)){
MISC::SET_BIT(&(Global_32663[iVar0 /*23*/].f_11), 18);
}
...
if((MISC::IS_BIT_SET(Global_113810.f_18577[2 /*6*/], 3) || MISC::IS_BIT_SET(Global_113810.f_18577[3 /*6*/], 3)) || MISC::IS_BIT_SET(Global_113810.f_18577[4 /*6*/], 3)){
