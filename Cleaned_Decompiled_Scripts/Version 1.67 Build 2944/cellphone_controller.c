...
if(iLocal_77==2){
iLocal_78=SOCIALCLUB::SC_EMAIL_GET_RETRIEVAL_STATUS();
switch (iLocal_78){
case 3:
break;
case 0:
...
if(Global_78689==1){
if(Global_20500.f_1==3){
if(MISC::IS_BIT_SET(Global_4542302, 15)){
...
if(MISC::IS_BIT_SET(Global_4542302, 16)){
MISC::SET_BIT(&Global_4542302, 14);
wait(0);
...
if(MISC::IS_BIT_SET(Global_4542302, 27)){
MISC::SET_BIT(&Global_4542302, 14);
wait(0);
...
if(MISC::IS_BIT_SET(Global_4542302, 29)){
MISC::SET_BIT(&Global_4542302, 14);
wait(0);
...
if(Global_78689==0){
if(MISC::IS_BIT_SET(Global_4542302, 11)){
if((Global_20500.f_1 !=10 && Global_20500.f_1 !=9) || func_85()==0){
MISC::CLEAR_BIT(&Global_4542302, 11);
MISC::SET_BIT(&Global_8371, 11);
}}elseif(Global_20500.f_1==10 || Global_20500.f_1==9){
if(func_85()){
MISC::SET_BIT(&Global_4542302, 11);
MISC::SET_BIT(&Global_8371, 11);
}}
if(MISC::IS_BIT_SET(Global_4542302, 12)){
MISC::CLEAR_BIT(&Global_4542302, 12);
MISC::SET_BIT(&Global_8371, 11);
}}elseif(MISC::IS_BIT_SET(Global_4542302, 12)){
if((Global_22908==0 || Global_22909==0) && !Global_22910){
MISC::CLEAR_BIT(&Global_4542302, 12);
MISC::SET_BIT(&Global_8371, 11);
}}elseif(Global_22910 || (Global_22908 > 0 && Global_22909==1)){
MISC::SET_BIT(&Global_4542302, 12);
MISC::SET_BIT(&Global_8371, 11);
}
if(MISC::IS_PC_VERSION()){
if(NETWORK::NETWORK_IS_PUSH_TO_TALK_ACTIVE()){
if(!MISC::IS_BIT_SET(Global_4542302, 19)){
MISC::SET_BIT(&Global_4542302, 19);
MISC::SET_BIT(&Global_8371, 11);
}}elseif(MISC::IS_BIT_SET(Global_4542302, 19)){
MISC::CLEAR_BIT(&Global_4542302, 19);
MISC::SET_BIT(&Global_8371, 11);
}}
if(iLocal_75==0){
if(MISC::IS_BIT_SET(Global_8370, 25)){
STATS::STAT_GET_INT(joaat("sp_cellphone_sleep_time"), &iLocal_74, -1);
iLocal_72=MISC::GET_GAME_TIMER();
iLocal_75=1;
}}elseif(!MISC::IS_BIT_SET(Global_8370, 25)){
STATS::STAT_GET_INT(joaat("sp_cellphone_sleep_time"), &iLocal_74, -1);
iLocal_73=MISC::GET_GAME_TIMER();
iLocal_75=0;
STATS::STAT_SET_INT(joaat("sp_cellphone_sleep_time"), (iLocal_74 + (iLocal_73 - iLocal_72)), 1);
}
func_84();
func_83();
func_82();
...
func_61();
func_60();
if(MISC::IS_BIT_SET(Global_8371, 21)){
if(!AUDIO::IS_MOBILE_INTERFERENCE_ACTIVE()){
MISC::CLEAR_BIT(&Global_8371, 21);
}}
if(MISC::IS_BIT_SET(Global_8370, 7)){
func_55();
MISC::CLEAR_BIT(&Global_8370, 7);
}
if(MISC::IS_BIT_SET(Global_8370, 0)){
func_54();
}
if(MISC::IS_BIT_SET(Global_4542302, 0)){
func_53();
}
if(MISC::IS_BIT_SET(Global_8371, 11)){
Global_9074=0;
if(MISC::IS_BIT_SET(Global_8370, 25)){
Global_9074++;
}
...
if(MISC::IS_BIT_SET(Global_4542302, 28)){
if(Global_78689==1){
Global_9074++;
}}
if(MISC::IS_BIT_SET(Global_4542302, 12)){
...
void func_1(){
iLocal_52=GRAPHICS::GET_LOAD_HIGH_QUALITY_PHOTO_STATUS(Global_22884);
switch (iLocal_52){
case 0:
Global_22880=4;
break;
...
void func_3(){
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
iLocal_50=NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), uLocal_48);
}else{
iLocal_49=MISC::GET_GAME_TIMER();
iLocal_50=(iLocal_49 - iLocal_47);
}
if(iLocal_50 > 3000){
HUD::BUSYSPINNER_OFF();
}
...
void func_4(){
iLocal_52=GRAPHICS::GET_STATUS_OF_SAVE_HIGH_QUALITY_PHOTO();
switch (iLocal_52){
case 0:
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
uLocal_48=NETWORK::GET_NETWORK_TIME();
}else{
...
void func_8(){
iLocal_52=GRAPHICS::GET_STATUS_OF_SORTED_LIST_OPERATION(1);
switch (iLocal_52){
case 0:
Global_22880=9;
break;
...
void func_9(){
iLocal_52=GRAPHICS::GET_STATUS_OF_CREATE_LOW_QUALITY_COPY_OF_PHOTO(iLocal_53);
switch (iLocal_52){
case 0:
...
void func_10(){
if(GRAPHICS::BEGIN_CREATE_LOW_QUALITY_COPY_OF_PHOTO(iLocal_53)){
Global_22880=5;
}else{
MISC::SET_BIT(&Global_8371, 15);
func_14();
...
void func_11(){
iLocal_52=GRAPHICS::GET_STATUS_OF_TAKE_HIGH_QUALITY_PHOTO();
switch (iLocal_52){
case 0:
Global_22880=4;
iLocal_53=2;
...
iLocal_58=0;
iLocal_59=0;
while (((func_20(2, Global_20467) && iLocal_58 < 250) && Global_20712==0) && !HUD::IS_HUD_COMPONENT_ACTIVE(19)){
if(Global_9074 > 0){
func_17();
}
wait(0);
iLocal_57=MISC::GET_GAME_TIMER();
iLocal_58=(iLocal_57 - iLocal_56);
if(Global_9074 > 0){
func_17();
}}
...
fLocal_69=-0.055f;
fLocal_70=0.745f;
fLocal_65=GRAPHICS::GET_SAFE_ZONE_SIZE();
fLocal_71=((100f * fLocal_68) - (100f * fLocal_65));
fLocal_66=(fLocal_69 + (fLocal_71 * 0.005f));
fLocal_67=(fLocal_70 - (fLocal_71 * 0.005f));
if(!func_19()){
...
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_35, fLocal_66, fLocal_67, 0.27f, 0.45f, 255, 255, 255, iVar0, 0);
...
bLocal_36=false;
}elseif(MISC::IS_BIT_SET(Global_8370, 13)){
if(MISC::IS_BIT_SET(Global_4542302, 19)){
bLocal_36=false;
}else{
bLocal_36=true;
...
bLocal_36=false;
}}elseif(Global_2646835.f_1593 || MISC::IS_BIT_SET(Global_8370, 13)){
bLocal_36=true;
}else{
bLocal_36=false;
}
...
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_35, (fLocal_66 + fLocal_37), (fLocal_67 + fLocal_38), 0.27f, 0.45f, 255, 255, 255, iVar0, 0);
}
}
else{
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_35, fLocal_66, fLocal_67, 0.27f, 0.45f, 255, 255, 255, iVar0, 0);
...
if(((Global_113810.f_14054[Global_20500 /*20*/].f_18==1 || Global_113810.f_14054[Global_20500 /*20*/].f_17==1) || bLocal_64==1) || Global_22904 !=0){
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20481) && Global_20483==0){
wait(0);
if(Global_9074 > 0){
func_17();
...
func_33(Global_8975);
if(Global_8975==1){
func_35(Global_20481, "DISPLAY_VIEW", 1f, to_float(Global_20504), -1082130432, -1082130432, -1082130432);
Global_20480=Global_20504;
}else{
func_35(Global_20481, "DISPLAY_VIEW", 1f, to_float(Global_20505), -1082130432, -1082130432, -1082130432);
...
if(Global_20499==1){
func_29();
func_35(Global_20481, "SET_THEME", to_float(Global_113810.f_14054[Global_20500 /*20*/].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
if(Global_21858){
...
}elseif(func_27(Global_7685, Global_20500)==0){
func_32(Global_20481, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(2), -1f, -1f, &(Global_117[Global_7685 /*10*/].f_4), "CELL_300", "CELL_217", "CELL_195", 0);
}else{
func_32(Global_20481, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(2), -1f, -1f, &(Global_2058[Global_7685 /*29*/].f_3), &(Global_2058[Global_7685 /*29*/].f_7), "CELL_217", &(Global_2058[Global_7685 /*29*/].f_3), 0);
}
func_35(Global_20481, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
...
func_32(Global_20481, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_117[Global_7685 /*10*/].f_4), "CELL_300", &Var0, "CELL_195", 0);
}else{
func_35(Global_20481, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
func_32(Global_20481, "SET_DATA_SLOT", to_float(4), to_float(0), to_float(3), -1f, -1f, &(Global_2058[Global_7685 /*29*/].f_3), &(Global_2058[Global_7685 /*29*/].f_7), &Var0, &(Global_2058[Global_7685 /*29*/].f_3), 0);
}}
func_35(Global_20481, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
}
func_25();
...
if(Global_2694571){
if(iVar1==14){
func_32(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(Global_22908), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}}
Global_8939[iVar0]=1;
}}}
iVar1++;
...
func_32(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(Global_22913), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}elseif(iVar1==7){
if(Global_78689){
iVar4=0;
...
func_32(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}else{
switch (Global_20500){
case 0:
iVar6=Global_44580;
...
func_32(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}}elseif(iVar1==14){
func_32(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(Global_22908), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}elseif(iVar1==20){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_20481, "SET_DATA_SLOT");
...
func_32(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}else{
func_32(Global_20481, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8377[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_8377[iVar1 /*15*/]), 0, 0, 0, 0);
}
Global_8939[iVar0]=1;
}}}
iVar1++;
...
void func_37(){
if(func_16() || MISC::IS_BIT_SET(Global_8370, 8)){
...
while (iVar1 < Global_4541037[Global_4542286 /*104*/].f_49){
switch (Global_4541037[Global_4542286 /*104*/].f_32){
case 4:
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_2794162.f_1762[iVar1 /*4*/]));
break;
case 5:
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935891[iVar1 /*4*/]));
break;
case 6:
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935932[iVar1 /*4*/]));
break;
case 7:
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935953[iVar1 /*4*/]));
break;
case 8:
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935970[iVar1 /*4*/]));
break;
case 9:
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935983[iVar1 /*4*/]));
break;
case 10:
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1935996[iVar1 /*4*/]));
break;
case 11:
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1936009[iVar1 /*4*/]));
break;
}
iVar1++;
}
StringCopy(&cVar2, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_4541037[Global_4542286 /*104*/].f_17 /*29*/].f_3)), 64);
uLocal_46=HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar0, &cVar0, 0, 2, &cVar2, 0);
MISC::SET_BIT(&Global_4542302, 1);
Global_22903=1;
Global_22902=uLocal_46;
Global_22906=0;
}else{
...
StringConCat(&cVar3, &Global_9058, 64);
StringConCat(&cVar3, "</C>", 64);
uLocal_46=HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar0, &cVar0, 0, 2, &cVar3, 0);
MISC::SET_BIT(&Global_4542302, 1);
Global_22903=1;
Global_22902=uLocal_46;
}else{
StringCopy(&cVar4, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_4541037[Global_4542286 /*104*/].f_17 /*29*/].f_3)), 64);
if(Global_4541037[Global_4542286 /*104*/].f_17==98){
StringCopy(&cVar5, "~HUD_COLOUR_SOCIAL_CLUB~", 64);
StringConCat(&cVar5, &cVar4, 64);
uLocal_46=HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar0, &cVar0, 0, 2, &cVar5, 0);
}else{
uLocal_46=HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar0, &cVar0, 0, 2, &cVar4, 0);
}
MISC::SET_BIT(&Global_4542302, 1);
Global_22903=1;
Global_22902=uLocal_46;
...
Global_4541037[Global_4542286 /*104*/].f_16=uLocal_46;
}
...
void func_55(){
if(MISC::IS_BIT_SET(Global_8370, 1)){
func_58();
func_56();
Global_113810.f_14054[Global_20500 /*20*/].f_18=1;
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
uLocal_43[Global_20500]=NETWORK::GET_NETWORK_TIME();
iLocal_41[Global_20500]=1;
}elseif(!MISC::IS_BIT_SET(Global_8370, 10)){
iLocal_42[Global_20500]=MISC::GET_GAME_TIMER();
iLocal_41[Global_20500]=1;
}else{
iLocal_42[0]=MISC::GET_GAME_TIMER();
iLocal_42[2]=MISC::GET_GAME_TIMER();
iLocal_42[1]=MISC::GET_GAME_TIMER();
iLocal_41[0]=1;
iLocal_41[2]=1;
iLocal_41[1]=1;
}
...
iVar1=0;
iVar2=func_59(9, Global_113810.f_14144[Global_22912 /*104*/].f_49);
switch (iVar2){
case 1:
HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("CELL_CL01");
break;
...
break;
case 12:
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_1936022[iVar1 /*4*/]));
break;
}
iVar1++;
}
StringCopy(&cVar3, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_113810.f_14144[Global_22912 /*104*/].f_17 /*29*/].f_3)), 64);
uLocal_46=HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar0, &cVar0, 0, 1, &cVar3, 0);
Global_22903=3;
Global_22902=uLocal_46;
Global_22906=0;
}else{
...
StringConCat(&cVar4, &Global_9058, 64);
StringConCat(&cVar4, "</C>", 64);
uLocal_46=HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar0, &cVar0, 0, 1, &cVar4, 0);
Global_22903=3;
Global_22902=uLocal_46;
}else{
StringCopy(&cVar5, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_113810.f_14144[Global_22912 /*104*/].f_17 /*29*/].f_3)), 64);
if(Global_113810.f_14144[Global_22912 /*104*/].f_17==98){
StringCopy(&cVar6, "~HUD_COLOUR_SOCIAL_CLUB~", 64);
StringConCat(&cVar6, &cVar5, 64);
uLocal_46=HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar0, &cVar0, 0, 1, &cVar6, 0);
}else{
uLocal_46=HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar0, &cVar0, 0, 1, &cVar5, 0);
}
Global_22903=3;
Global_22902=uLocal_46;
Global_22906=0;
}}
Global_113810.f_14144[Global_22912 /*104*/].f_16=uLocal_46;
}
...
void func_60(){
if(MISC::IS_BIT_SET(Global_8370, 19)){
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
iLocal_45=NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), uLocal_43[Global_20500]);
}else{
iLocal_44[Global_20500]=MISC::GET_GAME_TIMER();
iLocal_45=(iLocal_44[Global_20500] - iLocal_42[Global_20500]);
}
if(iLocal_45 > 300000){
...
iLocal_62=1;
iLocal_63=Global_20500;
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
uLocal_60=NETWORK::GET_NETWORK_TIME();
}else{
iLocal_54=MISC::GET_GAME_TIMER();
}}}else{
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
iLocal_61=NETWORK::GET_TIME_DIFFERENCE(NETWORK::GET_NETWORK_TIME(), uLocal_60);
}else{
iLocal_55=MISC::GET_GAME_TIMER();
iLocal_61=(iLocal_55 - iLocal_54);
}
if(iLocal_61 > 7000){
if(func_63(0)){
Global_8980[1 /*6*/]={
Global_9029[Global_20500 /*4*/] 
};
Global_9056=Global_9051[Global_20500];
Global_9046[Global_20500]=0;
iLocal_62=0;
}}
if(iLocal_63 !=Global_20500){
iLocal_62=0;
}}}}}
...
func_35(Global_20481, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
func_33(1);
func_35(Global_20481, "DISPLAY_VIEW", 1f, to_float(Global_20480), -1082130432, -1082130432, -1082130432);
}}
...
void func_80(){
if(MISC::IS_BIT_SET(Global_8370, 6)){
if(Global_9074 > 0){
if(MISC::IS_BIT_SET(Global_8371, 11)){
if(iLocal_39){
func_81(uLocal_35, "CLEAR_ALL");
if(MISC::IS_BIT_SET(Global_8370, 25)){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_35, "CREATE_ALERT");
...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(222f);
if((MISC::IS_BIT_SET(Global_4542302, 12) || MISC::IS_BIT_SET(Global_4542302, 11)) || MISC::IS_BIT_SET(Global_8370, 25)){
...
func_17();
}}elseif(Global_9074 > 0){
uLocal_35=GRAPHICS::REQUEST_SCALEFORM_MOVIE("cellphone_alert_popup");
while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_35)){
wait(0);
}
GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(4);
...
void func_82(){
if(MISC::IS_BIT_SET(Global_8371, 7)){
...
void func_83(){
if(MISC::IS_BIT_SET(Global_8371, 4)){
...
void func_84(){
if(MISC::IS_BIT_SET(Global_8371, 2)){
...
return 9;
}elseif((iVar1==Global_112780 || iVar1==Global_112781) && func_107(67)){
return 9;
}
iVar2=0;
while (iVar2 <=(19 - 1)){
...
if(func_118()==0){
return MISC::IS_BIT_SET(func_128(func_117(iParam0), -1), iParam1);
}}else{
...
var uVar1;
if(iParam0 !=14385){
uVar0=func_129(iParam0, iParam1);
...
var func__129(int iParam0, var uParam1){
