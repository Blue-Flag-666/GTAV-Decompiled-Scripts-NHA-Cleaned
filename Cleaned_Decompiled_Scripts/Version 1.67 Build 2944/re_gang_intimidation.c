...
case 4:
iVar13=0;
PED::ADD_SCENARIO_BLOCKING_AREA(Local_222 - Vector(10f, 30f, 30f), Local_222 + Vector(10f, 30f, 30f), 0, 1, 1, 1);
PED::SET_PED_NON_CREATION_AREA(Local_222 - Vector(50f, 50f, 50f), Local_222 + Vector(100f, 100f, 100f));
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_222 - Vector(15f, 15f, 15f), Local_222 + Vector(15f, 15f, 15f), 0, 1);
MISC::SET_BIT(&uVar3, 4);
MISC::SET_BIT(&uVar3, 1);
MISC::SET_BIT(&uVar3, 5);
PED::ADD_RELATIONSHIP_GROUP("GangOne", &uLocal_45);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_45, joaat("player"));
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iVar12, uLocal_45);
...
if(func_88()==0){
func_87(&uLocal_51, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
}elseif(func_88()==1){
func_87(&uLocal_51, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}elseif(func_88()==2){
func_87(&uLocal_51, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
}
...
if(!HUD::DOES_BLIP_EXIST(uLocal_217)){
}
iVar14=0;
while (iVar14 <=(iLocal_47 - 1)){
if(!ENTITY::DOES_ENTITY_EXIST(iVar11[iVar14])){
iVar11[iVar14]=PED::CREATE_PED(12, Var1[iVar14], Local_220[iVar14 /*3*/], fLocal_221[iVar14], 1, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iVar11[iVar14], 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Var1[iVar14]);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iVar11[iVar14], uLocal_45);
PED::SET_PED_CONFIG_FLAG(iVar11[iVar14], 42, 1);
WEAPON::GIVE_WEAPON_TO_PED(iVar11[iVar14], func_86(), -1, 1, 1);
...
uLocal_48=PED::CREATE_SYNCHRONIZED_SCENE(1283.205f, -1622.71f, 54.299f, 0f, 0f, 103.68f, 2);
if(!PED::IS_PED_INJURED(iVar11[0])){
TASK::TASK_SYNCHRONIZED_SCENE(iVar11[0], uLocal_48, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
}
if(!PED::IS_PED_INJURED(iVar11[1])){
TASK::TASK_SYNCHRONIZED_SCENE(iVar11[1], uLocal_48, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_c", 4f, -4f, 17, 0, 1148846080, 0);
}
if(!PED::IS_PED_INJURED(iVar11[2])){
TASK::TASK_SYNCHRONIZED_SCENE(iVar11[2], uLocal_48, "random@gang_intimidation@", "001446_02_gangintimidation_2_idle_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
}
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_48, 1);
iLocal_226=1;
iVar0=5;
break;
case 5:
...
TASK::TASK_PERFORM_SEQUENCE(iVar11[iVar15], iLocal_46);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_46);
...
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(iLocal_46);
TASK::TASK_PERFORM_SEQUENCE(iVar12, iLocal_46);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_46);
...
int iVar0;
if(*iParam0 >=3){
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_49)){
if((!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_234, 9f, 9f, 9f, 0, 1, 0) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1276.21f, -1613.05f, 53f, 9f, 9f, 9f, 0, 1, 0)) || TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID())){
*iParam0=6;
}}}
switch (*iParam0){
case 0:
...
*iParam0=9;
}}elseif(PED::IS_PED_RAGDOLL(iParam2)){
...
break;
case 2:
GRAPHICS::DRAW_DEBUG_LINE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_222, 0, 0, 255, 255);
TASK::TASK_PAUSE(PLAYER::PLAYER_PED_ID(), 1000);
Local_234={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
if(!PED::IS_PED_INJURED((*iParam3)[1])){
if(!HUD::DOES_BLIP_EXIST(uLocal_216[1])){
}
...
TASK::TASK_SYNCHRONIZED_SCENE((*iParam3)[0], uLocal_49, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_b", 4f, -4f, 17, 0, 1148846080, 0);
}
if(!PED::IS_PED_INJURED((*iParam3)[1])){
TASK::TASK_SYNCHRONIZED_SCENE((*iParam3)[1], uLocal_49, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_c", 4f, -4f, 16, 0, 1148846080, 0);
}
if(!PED::IS_PED_INJURED((*iParam3)[2])){
TASK::TASK_SYNCHRONIZED_SCENE((*iParam3)[2], uLocal_49, "random@gang_intimidation@", "001446_02_gangintimidation_2_thug_d", 4f, -4f, 17, 0, 1148846080, 0);
}
*iParam0=3;
}
break;
...
*iParam4=0;
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_49)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_49) > 0.3f){
if(!PED::IS_PED_INJURED((*iParam3)[0])){
...
TASK::CLOSE_SEQUENCE_TASK(iLocal_46);
TASK::TASK_PERFORM_SEQUENCE((*iParam3)[0], iLocal_46);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_46);
iLocal_46=0;
}}
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_49) > 0.35f){
if(!PED::IS_PED_INJURED((*iParam3)[1])){
...
TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 25000, 0);
TASK::CLOSE_SEQUENCE_TASK(iLocal_46);
TASK::TASK_PERFORM_SEQUENCE((*iParam3)[1], iLocal_46);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_46);
iLocal_46=0;
}}
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_49) > 0.275f){
if(!PED::IS_PED_INJURED((*iParam3)[2])){
...
TASK::TASK_AIM_GUN_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 25000, 0);
TASK::CLOSE_SEQUENCE_TASK(iLocal_46);
TASK::TASK_PERFORM_SEQUENCE((*iParam3)[2], iLocal_46);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_46);
iLocal_46=0;
}}}
if(!PED::IS_PED_INJURED((*iParam3)[2])){
...
if(TASK::GET_SCRIPT_TASK_STATUS(iParam1, joaat("script_task_perform_sequence"))==7 || ENTITY::IS_ENTITY_AT_ENTITY(iParam1, PLAYER::PLAYER_PED_ID(), 8f, 8f, 8f, 0, 1, 0)){
if(!func_75()){
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_220[0 /*3*/], 1f, -1, 0.25f, 0, 40000f);
TASK::TASK_ACHIEVE_HEADING(0, fLocal_221[0], 0);
TASK::TASK_PLAY_ANIM_ADVANCED(0, Param0.f_5, "sit_down_idle_01", Local_220[0 /*3*/], 0f, 0f, fLocal_221[0], 1000f, -4f, -1, 1, 0, 2, 0);
TASK::CLOSE_SEQUENCE_TASK(iLocal_46);
TASK::TASK_PERFORM_SEQUENCE((*uParam2)[0], iLocal_46);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_46);
iLocal_46=0;
}
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_220[1 /*3*/], 1f, -1, 0.25f, 0, 40000f);
TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
TASK::CLOSE_SEQUENCE_TASK(iLocal_46);
TASK::TASK_PERFORM_SEQUENCE((*uParam2)[1], iLocal_46);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_46);
iLocal_46=0;
}
if(!PED::IS_PED_INJURED((*uParam2)[2])){
...
TASK::TASK_WANDER_STANDARD(0, 1193033728, 0);
TASK::CLOSE_SEQUENCE_TASK(iLocal_46);
TASK::TASK_PERFORM_SEQUENCE((*uParam2)[2], iLocal_46);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_46);
iLocal_46=0;
}}
iLocal_229=3;
...
iVar0=0;
while (iVar0 <=(*uParam0 - 1)){
if(!HUD::DOES_BLIP_EXIST(uLocal_216[iVar0])){
if(!PED::IS_PED_INJURED((*uParam0)[iVar0])){
...
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_218, 0);
}
...
TASK::CLOSE_SEQUENCE_TASK(iLocal_46);
TASK::TASK_PERFORM_SEQUENCE(iParam0, iLocal_46);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_46);
if(HUD::DOES_BLIP_EXIST(uLocal_218)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_218, 1);
}
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_222, 13f, 0, 0, 0, 0, 0, 0, 0);
TASK::CLEAR_PED_SECONDARY_TASK(iParam0);
if(!PED::IS_PED_INJURED(iParam0)){
TASK::OPEN_SEQUENCE_TASK(&iLocal_46);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_222, 2f, 20000, 0.25f, 0, 32.2195f);
...
if(timera() > 8000 && ENTITY::IS_ENTITY_AT_COORD(iParam0, Local_222, 3f, 3f, 3f, 0, 1, 0)){
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_222, 2f, 20000, 0.25f, 0, 40000f);
TASK::CLOSE_SEQUENCE_TASK(iLocal_46);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_46);
iLocal_46=0;
}
...
TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 200f, -1, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(iLocal_46);
TASK::TASK_PERFORM_SEQUENCE((*uParam1)[iVar0], iLocal_46);
TASK::CLEAR_SEQUENCE_TASK(&iLocal_46);
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Param0) > IntToFloat(iParam1)){
return 1;
}}
return 0;
}
...
case 9:
case 0:
if(((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_100()) || Global_112857) || Global_32286) || func_99()) || func_58(8, -1)) || func_98()) || func_97()) || func_96()) || func_95()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 1:
if(((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_100()) || Global_32286) || func_99()) || func_58(8, -1)) || func_96()) || func_98()) || func_97()) || func_95()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 2:
if((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_100()) || Global_112857) || Global_32286) || func_99()) || func_58(8, -1)) || func_96()) || func_98()) || func_97()) || func_95()) || Global_113810.f_7691.f_919[iVar0]==5) || Global_43924 !=-1){
return 0;
}
break;
case 3:
if((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_100()) || Global_112857) || Global_32286) || func_99()) || func_58(8, -1)) || func_98()) || func_97()) || func_95()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 4:
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID())){
if((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_100()) || Global_32286) || func_99()) || func_58(8, -1)) || func_97()) || func_96()) || func_95()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
}
break;
case 7:
if((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_100()) || func_97()) || Global_112857) || Global_32286) || func_99()) || Global_44569) || func_58(8, -1)) || func_96()) || func_94()) || func_95()) || Global_113810.f_7691.f_919[iVar0]==5){
return 0;
}
break;
case 8:
if(((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_100()) || Global_112857) || Global_32286) || func_99()) || func_58(8, -1)) || func_96()) || func_94()) || func_98()) || func_97()) || func_95()){
return 0;
}
break;
}}else{
...
if(vmag2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_112()){
return 0;
}}
if(func_108()){
return 1;
...
if(!func_146(Global_113810.f_24998.f_43[iParam1])){
return 0;
}
...
return (shift_right(iParam0, 26) & 31 * func_133(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_222 - Vector(10f, 10f, 10f), Local_222 + Vector(10f, 10f, 10f), 1, 1);
