...
if(MISC::HAS_BULLET_IMPACTED_IN_BOX(Param0, Param1, 1, 1)){
*uParam2++;
if(*uParam2 > 6){
Global_95836=3;
}}elseif((FIRE::IS_EXPLOSION_IN_AREA(0, Param0, Param1) || FIRE::IS_EXPLOSION_IN_AREA(2, Param0, Param1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(Param0, Param1, joaat("weapon_grenadelauncher"), 1)){
Global_95836=5;
}}}
...
if(ENTITY::IS_ENTITY_IN_AREA(PLAYER::PLAYER_PED_ID(), Param0, Param1, 0, 1, 0)){
if(*uParam2 < 0){
*uParam2=MISC::GET_GAME_TIMER();
}elseif(MISC::GET_GAME_TIMER() > *uParam2 + 10000){
Global_95836=1;
}}else{
*uParam2=-1;
}}else{
...
if(MISC::IS_PROJECTILE_TYPE_IN_AREA(Param0, Param1, iVar0, 1)){
Global_95836=0;
}}}}
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Param1, 1) >=(100f * fParam2)){
return 0;
}
if(Global_100883){
return 0;
...
if(!func_31(iParam0)){}
if(!MISC::IS_BIT_SET(Global_113810.f_9088.f_2[27 /*3*/], 1)){
return 0;
}
return 1;
}
...
func_52(&uLocal_119, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}
...
func_66(Global_113810.f_7691.f_137[iVar1 /*15*/].f_6);
iVar2=iVar1;
...
uVar7=OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Var1, 10f, iVar0, 0, 0, 1);
...
if(iVar2 !=226){
}elseif(!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(iVar3)){
}else{
