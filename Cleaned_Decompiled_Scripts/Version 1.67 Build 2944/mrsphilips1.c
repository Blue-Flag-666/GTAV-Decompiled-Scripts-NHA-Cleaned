...
func_238(Local_75.f_9, 0, 0, 0, 0, 0);
...
PED::CLEAR_PED_PROP(uParam0, Global_78472[1 /*14*/].f_12, 1);
}else{
uVar6={
func_81(iVar0, 0) 
};
...
if(PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(uParam0, func_77(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(uParam0, func_77(iParam1), Global_78472[1 /*14*/].f_3) > 0){
PED::SET_PED_COMPONENT_VARIATION(uParam0, func_77(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, 0);
}}
...
if(!func_150(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_64, Global_113810.f_2366.f_539[iVar0 /*65*/].f_63)){
...
func_51(uParam0, Global_78472[1 /*14*/].f_12, Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4);
func_67(14);
if(Global_78470==1){
iVar2=0;
while (iVar2 < 15){
...
if(iParam4==-1){
PED::SET_PED_COMPONENT_VARIATION(uParam0, func_77(iVar0), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_77(iVar0)));
}
else{
PED::SET_PED_COMPONENT_VARIATION(uParam0, func_77(iVar0), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
}
func_67(iVar0);
if(Global_78470==1){
iVar2=0;
...
Global_78472[1 /*14*/]={
func_85(iVar10, iVar0, func_41(uParam0, iVar0, -1), -1) 
};
...
if(iParam4==-1){
PED::SET_PED_COMPONENT_VARIATION(uParam0, func_77(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(uParam0, func_77(iParam1)));
}else{
PED::SET_PED_COMPONENT_VARIATION(uParam0, func_77(iParam1), Global_78472[1 /*14*/].f_3, Global_78472[1 /*14*/].f_4, iParam4);
}
if(Global_78470==1){
iVar2=0;
while (iVar2 < 15){
...
if(!func_150(uParam0, Global_113810.f_2366.f_539[iVar0 /*65*/].f_61, Global_113810.f_2366.f_539[iVar0 /*65*/].f_60) || iParam3==1){
...
return 1;
}}elseif(Global_78472[1 /*14*/].f_3==PED::GET_PED_DRAWABLE_VARIATION(uParam0, func_77(iParam1)) && Global_78472[1 /*14*/].f_4==PED::GET_PED_TEXTURE_VARIATION(uParam0, func_77(iParam1))){
return 1;
}
return 0;
}
...
}}elseif(((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_216(PLAYER::PLAYER_ID())) && !bParam4) && !bParam5){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 0);
}
Global_78687=0;
}}
...
if(!func_235(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1, 0)){
iVar0=0;
}elseif(iParam2==1){
iVar0=0;
...
void func_238(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_240(Global_78945, Global_78947, iParam5) 
};
if(fVar6==-0.014f){
}
...
break;
default:
StringCopy(&Var0, func_241(iVar1), 8);
break;
}
break;
default:
