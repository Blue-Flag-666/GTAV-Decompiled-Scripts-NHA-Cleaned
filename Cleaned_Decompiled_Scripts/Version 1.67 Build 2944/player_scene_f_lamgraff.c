...
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_100554, &sLocal_238, &cLocal_270, 3)){
if(FIRE::IS_ENTITY_ON_FIRE(Global_100554)){
TASK::STOP_ANIM_PLAYBACK(Global_100554, 0, 0);
TASK::CLEAR_PED_TASKS(Global_100554);
return 0;
}
fVar0=PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_279);
if(!iLocal_233){
...
if(fVar0 < 0.2812f){
if(iLocal_280 !=0){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_280, 0);
iLocal_280=0;
}}elseif(fVar0 < 0.4778f){
if(iLocal_280==0){
iLocal_280=GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_lamgraff_paint_spray", uLocal_234, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
GRAPHICS::SET_PARTICLE_FX_LOOPED_COLOUR(iLocal_280, fLocal_281, fLocal_282, fLocal_283, 0);
...
if(!PED::IS_PED_INJURED(Global_100554)){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_234)){
if(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_100554, &sLocal_238, &cLocal_254, 3)){
if(FIRE::IS_ENTITY_ON_FIRE(Global_100554)){
TASK::STOP_ANIM_PLAYBACK(Global_100554, 0, 0);
TASK::CLEAR_PED_TASKS(Global_100554);
return 0;
...
TASK::CLEAR_PED_TASKS(Global_100554);
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_279)){
iLocal_279=PED::CREATE_SYNCHRONIZED_SCENE(Local_236, 0f, 0f, uLocal_237, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_279, 1);
}
TASK::TASK_SYNCHRONIZED_SCENE(Global_100554, iLocal_279, &sLocal_238, &cLocal_270, 8f, -8f, 257, 0, 8f, 0);
return 1;
}}else{
if(iLocal_280 !=0){
GRAPHICS::STOP_PARTICLE_FX_LOOPED(iLocal_280, 0);
...
return 0;
}}}elseif(iParam1==func_30(Global_100554) && iParam1 !=0){
Global_100554=0;
}}
return 1;
}
...
while (!ENTITY::DOES_ENTITY_EXIST(Global_100554) || !STREAMING::HAS_MODEL_LOADED(iLocal_235)){
wait(0);
}
...
func_38(&uLocal_67, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
uLocal_234=OBJECT::CREATE_OBJECT(iLocal_235, ENTITY::GET_ENTITY_COORDS(Global_100554, 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_234, Global_100554, PED::GET_PED_BONE_INDEX(Global_100554, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}
