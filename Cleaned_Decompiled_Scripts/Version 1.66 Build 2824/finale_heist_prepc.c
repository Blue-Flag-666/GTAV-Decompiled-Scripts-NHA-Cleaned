...
OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(Local_97.f_0, 0f, 1, 0);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_97.f_0, 1, 1, 1);
}
func_2();
func_479();
}
...
int iVar0;
int iVar1;
func_220(&iLocal_122, &uLocal_123, &iLocal_95, &uLocal_103, &uLocal_102, Local_109, 0, 0, 1090519040);
func_213();
switch (iLocal_93){
case 0:
...
if(!OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(Local_97.f_0)){
OBJECT::ADD_DOOR_TO_SYSTEM(Local_97.f_0, joaat("prop_com_gar_door_01"), -445.3054f, -2171.827f, 11.3672f, 1, 1, 0);
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_97.f_0, 1, 1, 1);
}
...
iVar0=-1;
iVar1=0;
func_62(&uLocal_102, Local_109, &iLocal_94, iLocal_95, &iLocal_101, &iLocal_120);
if(func_51(iLocal_122, Local_109, &uLocal_102, iLocal_95, iLocal_94, &iLocal_118, &iLocal_121, &iVar0, &iVar1, &iLocal_101, 7f)){
...
OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(Local_97.f_0, 2, 1, 1);
func_42(1, func_43());
if(func_4(iLocal_122)){
...
int func_50(){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_110, Local_111, fLocal_112, 0, 1, 0)){
return 1;
}
return 0;
}

int func_51(int iParam0, struct<3> Param1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10){
float fVar0;
...
bool func_56(int iParam0, struct<3> Param1, float fParam2, int iParam3){
return vdist2(ENTITY::GET_ENTITY_COORDS(iParam0, iParam3), Param1) <=(fParam2 * fParam2);
}


void func_57(var uParam0, struct<3> Param1, int iParam2){
if(!HUD::DOES_BLIP_EXIST(*uParam0)){
*uParam0=func_58(Param1, 5, iParam2);
}}

int func_58(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
iVar0=0;
...
void func_62(var uParam0, struct<3> Param1, int iParam2, int iParam3, int iParam4, int iParam5){
switch (*iParam2){
case 0:
...
bLocal_28=false;
func_21(1, 1, 1);
}elseif(func_209(1, Local_107, 0)){
if(!func_473()){
if(func_207()){
func_206(func_41());
return 1;
}elseif(func_209(2, Local_107, 0)){
func_206(func_41());
return 1;
}}else{
return 1;
...
void func_66(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5){
var uVar0;
int iVar1;
...
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_124.f_0, 1);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(joaat("gauntlet"), true);
if(!func_473()){
...
void func_79(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11){
int iVar0;
iVar0=1;
...
int func_80(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5){
var uVar0;
var uVar1;
struct<97> Var2;
int iVar3;
...
if(!func_154() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
void func_160(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
bool func_169(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_170(struct<3> Param0, float fParam1){
return func_171(&(Global_107196.f_2890), Param0, fParam1, 0);
}

int func_171(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
int func_173(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_175(iParam0, uVar1[iVar3], 1) && func_174(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_169(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
VEHICLE::DELETE_VEHICLE(&iParam0);
return 1;
}else{
return 0;
...
int func_209(int iParam0, struct<3> Param1, float fParam2){
switch (iParam0){
case 0:
...
int func_210(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
if(!ENTITY::DOES_ENTITY_EXIST(*iParam0)){
...
AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Local_97.f_0, 1);
AUDIO::START_AUDIO_SCENE("BIG_SCORE_PREP_C_GARAGE_DOOR");
iLocal_113=1;
}}elseif(!func_56(PLAYER::PLAYER_PED_ID(), Local_109, 70f, 1)){
if(iLocal_113){
AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Local_96.f_0, 0);
AUDIO::SET_SCRIPT_UPDATE_DOOR_AUDIO(Local_97.f_0, 0);
...
int func_215(struct<15> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8){
if(func_4(iLocal_122)){
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_122, 0)){
...
OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(*uParam0, uParam0->f_1, 1, 1);
uParam0->f_22=0;
}}elseif(iLocal_92==4 && !func_56(PLAYER::PLAYER_PED_ID(), Local_109, 100f, 1)){
...
int func_217(struct<16> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7){
if(func_4(iLocal_122)){
...
int func_219(struct<15> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8){
if(func_4(iLocal_122)){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_122, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_122, Local_110, Local_111, fLocal_112, 0, 1, 0)){
...
void func_220(int iParam0, var uParam1, int iParam2, var uParam3, var uParam4, struct<3> Param5, int iParam6, bool bParam7, int iParam8){
if(func_4(*iParam0)){
switch (*iParam2){
case 0:
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), *iParam0, 0)){
...
void func_229(){
func_220(&iLocal_122, &uLocal_123, &iLocal_95, &uLocal_103, &uLocal_102, Local_109, 0, 1, 1090519040);
func_213();
func_257();
switch (iLocal_93){
case 0:
if(func_65(iLocal_92, bLocal_28)){
func_57(&uLocal_102, Local_109, 1);
...
if(func_240(iLocal_122, Local_109, &uLocal_102, iLocal_94, iLocal_95, &iLocal_101, &iLocal_121, 0, 0, 1086324736) && func_50()){
iLocal_93=2;
}
break;
case 2:
...
int func_240(int iParam0, struct<3> Param1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, float fParam9){
...
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(iVar1, PED::GET_VEHICLE_PED_IS_IN(iVar1, 0), Local_108, 4, 20f, 786469, 2f, 10f, 1);
}}else{
func_233(iVar1);
}}
iVar0++;
...
if(!func_246()){
if((ENTITY::DOES_ENTITY_EXIST(iLocal_122) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_122, 0)) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_122, Local_108, 2f, 2f, 2f, 0, 1, 0)){
...
func_258(1, 81);
func_258(2, 82);
}elseif(func_56(PLAYER::PLAYER_PED_ID(), Local_109, 120f, 1)){
func_3(0);
func_3(1);
func_3(2);
}}
...
void func_260(){
func_220(&iLocal_122, &uLocal_123, &iLocal_95, &uLocal_103, &uLocal_102, Local_108, 0, 0, 1090519040);
switch (iLocal_93){
case 0:
if(func_65(iLocal_92, bLocal_28)){
...
func_57(&uLocal_102, Local_108, 1);
}
break;
case 2:
...
func_62(&uLocal_102, Local_108, &iLocal_94, iLocal_95, &iLocal_101, &iLocal_120);
func_243();
if(func_242(iLocal_122)){
func_19(&uLocal_102);
func_19(&uLocal_103);
...
if(func_240(iLocal_122, Local_108, &uLocal_102, iLocal_94, iLocal_95, &iLocal_101, &iLocal_121, 0, 1, 1086324736) || func_249()){
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_328(iVar10, 14, uVar12[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_328(iVar10, 14, uVar15[iVar1], -1) 
};
func_299(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_322(14);
if(Global_78339==1){
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_289(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_289(iParam0));
if(iVar11 > iVar10){
...
void func_398(int iParam0, struct<3> Param1, var uParam2, int iParam3, bool bParam4){
struct<60> Var0;
if(ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)){
...
func_412(iParam3, &Var0, Param1, uParam2, func_142(iParam0));
...
return (shift_right(iParam0, 26) & 31 * func_407(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
void func_412(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_168(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
int iVar0;
if(!func_4(iLocal_122)){
if(!func_4(uLocal_123) && !func_4(Local_124.f_0)){
func_426(1);
return;
}
...
if(func_4(uLocal_123)){
if(!func_432(PLAYER::PLAYER_PED_ID(), uLocal_123, 500f, 1)){
iVar0++;
}}else{
iVar0++;
}
...
void func_472(int iParam0, struct<3> Param1, float fParam2){
if(func_435(uParam0)){
...
struct<23> func_476(int iParam0, struct<3> Param1, struct<3> Param2, struct<3> Param3, struct<3> Param4, struct<3> Param5, struct<3> Param6){
struct<23> Var0;
Var0.f_15=2;
Var0.f_0=iParam0;
Var0.f_1=0f;
...
struct<7> func_478(struct<3> Param0, float fParam1, int iParam2, int iParam3){
struct<7> Var0;
Var0.f_1={
Param0 
};
