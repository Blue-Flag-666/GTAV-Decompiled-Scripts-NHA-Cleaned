...
uLocal_161[0]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("xm_prop_x17dlc_rep_sign_01a"), 2222.883f, 5612.299f, 55.291f, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_161[0], 0.5f, 0f, 15.325f, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_161[0], 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("xm_prop_x17dlc_rep_sign_01a"));
}}}elseif(ENTITY::DOES_ENTITY_EXIST(uLocal_161[0])){
OBJECT::DELETE_OBJECT(&(uLocal_161[0]));
}
...
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_161[1])){
...
uLocal_161[1]=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("xm_prop_base_cabinet_door_01"), -362.402f, 4829.89f, 142.477f, 0, 0, 1);
ENTITY::SET_ENTITY_ROTATION(uLocal_161[1], 0f, 0f, 320f, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(uLocal_161[1], 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("xm_prop_base_cabinet_door_01"));
}}}elseif(ENTITY::DOES_ENTITY_EXIST(uLocal_161[1])){
OBJECT::DELETE_OBJECT(&(uLocal_161[1]));
}}
...
int iVar3;
float fVar4;
if(MISC::IS_BIT_SET(iLocal_59, bParam0)){
return;
}
...
Global_41953[bParam0 /*31*/].f_22=(Global_41953[bParam0 /*31*/].f_22 - (Global_41953[bParam0 /*31*/].f_23 * timestep()));
if(Global_41953[bParam0 /*31*/].f_22 < -1f){
...
fVar4=vdist2(ENTITY::GET_ENTITY_COORDS(iVar3, 1), Global_41953[bParam0 /*31*/].f_2);
...
Global_41953[iVar0 /*31*/].f_22=(Global_41953[iVar0 /*31*/].f_22 - (Global_41953[iVar0 /*31*/].f_23 * timestep()));
if(Global_41953[iVar0 /*31*/].f_22 < -1f){
...
fVar3=vdist2(ENTITY::GET_ENTITY_COORDS(iVar2, 1), Global_41953[iVar0 /*31*/].f_2);
...
if(vdist2(Global_41953[bParam0 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(iVar1, 1)) < Global_41953[bParam0 /*31*/].f_6){
...
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var5, Global_41953[bParam0 /*31*/].f_9, Global_41953[bParam0 /*31*/].f_12, Global_41953[bParam0 /*31*/].f_8, 0, 1)){
iLocal_54=iVar0;
return 1;
}
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var6, Global_41953[bParam0 /*31*/].f_9, Global_41953[bParam0 /*31*/].f_12, Global_41953[bParam0 /*31*/].f_8, 0, 1)){
iLocal_54=iVar0;
return 1;
}
if(MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 0)){
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var5, Global_41953[bParam0 /*31*/].f_16, Global_41953[bParam0 /*31*/].f_19, Global_41953[bParam0 /*31*/].f_15, 0, 1)){
iLocal_54=iVar0;
return 1;
}
if(OBJECT::IS_POINT_IN_ANGLED_AREA(Var6, Global_41953[bParam0 /*31*/].f_16, Global_41953[bParam0 /*31*/].f_19, Global_41953[bParam0 /*31*/].f_15, 0, 1)){
iLocal_54=iVar0;
return 1;
}}
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar7, Global_41953[bParam0 /*31*/].f_9, Global_41953[bParam0 /*31*/].f_12, Global_41953[bParam0 /*31*/].f_8, 0, 1, 0)){
iLocal_54=iVar0;
return 1;
}
if(MISC::IS_BIT_SET(Global_41953[bParam0 /*31*/].f_1, 0)){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar7, Global_41953[bParam0 /*31*/].f_16, Global_41953[bParam0 /*31*/].f_19, Global_41953[bParam0 /*31*/].f_15, 0, 1, 0)){
iLocal_54=iVar0;
return 1;
}
}}}
...
switch (func_44()){
case 0:
if(vdist2(Global_41953[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)) < 10000f){
...
elseif(vdist2(Global_41953[4 /*31*/].f_2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)) < 10000f){
func_50(4, PLAYER::PLAYER_PED_ID());
}}
break;
case 2:
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_63, 1) > 250f){
...
void func_90(){
if(!iLocal_62 && MISC::IS_BIT_SET(Global_113648.f_9087.f_2[27 /*3*/], 2)){
iLocal_62=1;
bLocal_61=true;
}
