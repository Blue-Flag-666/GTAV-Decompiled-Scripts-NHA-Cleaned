...
func_193(&uLocal_58, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], 1), "BARR3AU", "BARRY3_AMB");
}}
iVar2=0;
...
func_119(*iParam0);
iVar0=start_new_script_with_args(&(iParam0->f_1), iParam0, 61, 54000);
...
var func__174(struct<3> Param0, int iParam1){
var uVar0;
...
void func_193(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3){
switch (*uParam0){
case 0:
...
int func_208(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7){
var uVar0;
...
bool func_258(int iParam0, struct<3> Param1, float fParam2, int iParam3){
...
void func_269(var uParam0, var uParam1, struct<3> Param2, float fParam3){
func_270(uParam0);
...
bVar4=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0])){
if(func_276(&(uParam0->f_28[0]), 49, Var1, fVar2, "RC LAUNCHER:
BARRY 3", 1)){
...
int func_277(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
int iVar0;
if(!func_36(iParam1)){
...
fVar1=23.45f;
func_268(uParam0, uParam1, Var0, fVar1);
}
...
bVar4=true;
if(!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0])){
if(func_276(&(uParam0->f_28[0]), 49, Var1, uVar2, "RC LAUNCHER:
BARRY 1", 1)){
PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, 0, 1);
}else{
bVar4=false;
...
int func_295(int iParam0, struct<3> Param1, float fParam2){
int iVar0[4];
int iVar1;
if(func_108()==0){
...
int func_296(int iParam0, struct<3> Param1, float fParam2, var uParam3){
int iVar0;
struct<7> Var1;
iVar0=0;
...
int func_297(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
