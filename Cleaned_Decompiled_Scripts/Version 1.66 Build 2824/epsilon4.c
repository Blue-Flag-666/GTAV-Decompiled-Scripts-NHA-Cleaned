...
uLocal_90=WEAPON::GET_WEAPONTYPE_MODEL(iLocal_89);
sLocal_91="empty";
iLocal_269=1;
iLocal_426=-1;
iLocal_427=-1;
...
uLocal_92=func_407();
uLocal_93=func_406(1855.08f, 4755.85f, 36.81f, 25f);
...
uLocal_290=GRAPHICS::SET_GRASS_CULL_SPHERE(1751.65f, 4676.77f, 43.03f, 1.5f);
func_402();
func_385();
func_384();
Local_434.f_0=0;
...
Local_434.f_9=1;
Local_434.f_1=3;
}elseif(ENTITY::IS_ENTITY_DEAD(Local_298[0 /*8*/], 0)){
func_242(6);
Local_434.f_9=2;
Local_434.f_1=3;
}elseif(ENTITY::IS_ENTITY_DEAD(Local_298[1 /*8*/], 0)){
func_242(6);
Local_434.f_9=3;
Local_434.f_1=3;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_298[0 /*8*/], PLAYER::PLAYER_PED_ID(), 1) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(Local_298[0 /*8*/], 0, 2)){
func_242(6);
Local_434.f_9=4;
Local_434.f_1=3;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_298[1 /*8*/], PLAYER::PLAYER_PED_ID(), 1) && WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(Local_298[1 /*8*/], 0, 2)){
func_242(6);
Local_434.f_9=5;
Local_434.f_1=3;
}elseif(func_235(&(Local_298[0 /*8*/]))){
func_242(6);
Local_434.f_9=6;
Local_434.f_1=3;
}elseif(func_235(&(Local_298[1 /*8*/]))){
func_242(6);
Local_434.f_9=7;
Local_434.f_1=3;
}elseif(func_234(Local_298[0 /*8*/])){
...
if(Local_434.f_1==1){
if(func_259()){
}elseif(Local_434.f_6){
Local_434.f_1=3;
}elseif(Local_434.f_4){
...
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_95, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
}
...
if(func_349(PLAYER::PLAYER_PED_ID()) !=iLocal_89){
WEAPON::GIVE_WEAPON_TO_PED(PLAYER::PLAYER_PED_ID(), iLocal_89, -1, 1, 1);
}
PED::FORCE_PED_MOTION_STATE(PLAYER::PLAYER_PED_ID(), joaat("MotionState_Idle"), 0, 1, 0);
return 1;
}}}
...
PED::FORCE_PED_MOTION_STATE(Local_298[1 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
}}}
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(Local_81.f_28[0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_81.f_28[0], 0f, 7f, 0f), 1f, 20000, 0.25f, 5, 1193033728);
func_405("Did Marnie regular exit");
}
PED::FORCE_PED_MOTION_STATE(Local_298[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 0);
}}}
...
void func_265(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
...
uVar7=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_278(iVar2, iVar6));
}}}
iVar6++;
}
...
WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_278(iVar2, iVar8));
func_275(uVar1, func_278(iVar2, iVar8));
}}
iVar8++;
}
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
...
}elseif(fLocal_302 > 50f){
Local_301.f_14="detector_level2_prop";
}else{
Local_301.f_14="detector_level1_prop";
}
ENTITY::PLAY_ENTITY_ANIM(Local_301.f_0, Local_301.f_14, "rcm_epsilonism4", 16f, 0, 0, 0, 0, 0);
}}}elseif(func_294()){
...
Var3={
func_101(iVar4, 2, uParam1->f_59, -1) 
};
...
Var3={
func_101(iVar4, 1, uParam1->f_62, -1) 
};
...
Local_434.f_9=7;
Local_434.f_1=3;
}elseif(!func_331(&uLocal_356, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
func_242(6);
Local_434.f_9=8;
Local_434.f_1=3;
}elseif(Local_434.f_6){
...
}}elseif(func_233(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_1, 1) > 120f){
if(CUTSCENE::HAS_CUTSCENE_LOADED()){
...
func_405("Player moved away - unloading midtro");
CUTSCENE::REMOVE_CUTSCENE();
}}}elseif(func_233(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_1, 1) < 100f){
if(!CUTSCENE::HAS_CUTSCENE_LOADED()){
...
if(iLocal_269==1){
func_325(&uLocal_94);
if(!func_331(&uLocal_304, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
iLocal_269=0;
AUDIO::STOP_SCRIPTED_CONVERSATION(0);
HUD::CLEAR_PRINTS();
}elseif(iLocal_277==0 && iLocal_268){
if(!func_285()){
iLocal_288=MISC::GET_GAME_TIMER();
iLocal_277=1;
}}elseif(iLocal_270==0){
...
if((MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_37, sLocal_91) || !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_291, 30f, 30f, 30f, 0, 1, 0)) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_37, 7, 0, 0, 0)){
...
iLocal_287=0;
}}elseif(iLocal_268==0 && !func_309(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, 9f, 1)){
...
iLocal_286=MISC::GET_GAME_TIMER();
iLocal_413++;
}}}elseif(bLocal_266 !=Local_301.f_1){
...
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, 6.2f, 6.2f, 2f, 0, 0, 1)){
if(iLocal_289==-1){
iLocal_289=MISC::GET_GAME_TIMER();
}elseif((MISC::GET_GAME_TIMER() - iLocal_289) >=1500){
if(func_285()){
func_283();
}
...
iLocal_267=1;
iLocal_268=1;
}}elseif(!func_309(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, (9f + 2f), 1)){
iLocal_267=0;
}}else{
if(!HUD::DOES_BLIP_EXIST(uLocal_94)){
uLocal_94=func_307(Local_82, 5, 0);
}
bLocal_266=Local_301.f_1;
if(func_331(&uLocal_304, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
iLocal_269=1;
...
}}elseif((!func_285() && (MISC::GET_GAME_TIMER() - iLocal_288) >=7500) && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
if(MISC::ARE_STRINGS_EQUAL(Local_293[iLocal_283 /*43*/].f_39, sLocal_91) || func_311(&uLocal_98, "EPS4AUD", Local_293[iLocal_283 /*43*/].f_39, 7, 0, 0, 0)){
iLocal_275=1;
}}}}}}
if(Local_434.f_1==3){
...
int func_307(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
iVar0=0;
...
bool func_309(int iParam0, struct<3> Param1, float fParam2, int iParam3){
...
Local_301.f_6=0;
iLocal_284=0;
}}elseif(iLocal_284 < MISC::GET_GAME_TIMER()){
if(fVar0 <=6.5f && bVar8){
AUDIO::STOP_SOUND(Local_301.f_3);
...
fLocal_302=94.9f;
}elseif(fLocal_302 <=-95f && fLocal_302 >=-99.8f){
fLocal_302=-94.9f;
}
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_293[iLocal_283 /*43*/].f_2, 6.2f, 6.2f, 2f, 0, 0, 1)){
fLocal_302=100f;
...
if(!ENTITY::IS_ENTITY_AT_COORD(*uParam0, Local_296[iVar0 /*6*/], 3f, 3f, 3f, 0, 1, 0)){
...
if(!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uParam0->f_4, 1f, 1f, 1f, 0, 1, 0) || iLocal_283 > 0){
if(!PED::IS_PED_IN_GROUP(*uParam0)){
TASK::CLEAR_PED_TASKS(*uParam0);
...
elseif(func_311(&uLocal_98, "EPS4AUD", "EPS4_MESSM", 7, 0, 0, 0)){
iLocal_419=MISC::GET_GAME_TIMER();
}}}
...
elseif(func_311(&uLocal_98, "EPS4AUD", "EPS4_PROMPTM", 7, 0, 0, 0)){
iLocal_421=MISC::GET_GAME_TIMER();
iLocal_420++;
}}}}
break;
...
iLocal_299=0;
iLocal_300=0;
}}elseif(func_311(&uLocal_98, "EPS4AUD", "EPS4_MKNOCK", 7, 0, 0, 0)){
iLocal_299=0;
iLocal_300=0;
}}}}}}


bool func_331(var uParam0, struct<2> Param1, float fParam2){
bool bVar0;
int iVar1;
int iVar2;
if(uParam0->f_46 < 3){}
...
STREAMING::REQUEST_MODEL(uLocal_90);
...
ENTITY::SET_ENTITY_COORDS(Local_298[1 /*8*/], 1829.8f, 4693.48f, uVar0, 1, 0, 0, 1);
}}}
...
PED::FORCE_PED_MOTION_STATE(Local_298[0 /*8*/], joaat("MotionState_Walk"), 0, 1, 1);
Local_298[0 /*8*/].f_7=1;
func_405("Done Marnie intro exit state");
}}}

int func_346(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_234(iParam0)){
...
iLocal_264=1;
}}elseif(func_350(Local_81.f_28[0])){
...
void func_352(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_354(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
int func_380(var uParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4){
if(iParam3 !=0){
*uParam0=iParam3;
...
Local_301.f_13=0;
Local_301.f_14="NO_RECENT_ANIM";
uLocal_95=GRAPHICS::REQUEST_SCALEFORM_MOVIE("digiscanner");
...
int func_390(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
if(iLocal_297 >=11){}
iVar0=iLocal_297;
iLocal_297++;
...
void func_398(struct<3> Param0, float fParam1){
int iVar0;
iVar0=(iLocal_294 - 1);
if(iVar0 < 0){}
Local_293[iVar0 /*43*/].f_32={
Param0 
};
...
iVar0=(iLocal_294 - 1);
if(iVar0 < 0){}
Local_293[iVar0 /*43*/].f_8={
Param0 
};
Local_293[iVar0 /*43*/].f_11={
Param1 
};
...
void func_401(int iParam0, struct<3> Param1, struct<3> Param2){
int iVar0;
if(iLocal_294 >=4){}
iVar0=iLocal_294;
iLocal_294++;
Local_293[iVar0 /*43*/]=iParam0;
Local_293[iVar0 /*43*/].f_2={
Param1 
};
Local_293[iVar0 /*43*/].f_5={
Param2 
};
...
var func__406(struct<3> Param0, float fParam1){
struct<3> Var0;
Var0={
...
int func_409(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_410(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(*uParam0, 1);
...
int func_410(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
int iVar0;
if(!func_170(iParam1)){
...
GRAPHICS::REMOVE_GRASS_CULL_SPHERE(uLocal_290);
...
}elseif(PED::IS_PED_IN_GROUP(Local_298[1 /*8*/])){
