...
int func_211(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7){
var uVar0;
...
func_264(uParam0, iLocal_53, Var0, fVar1);
...
void func_264(var uParam0, int iParam1, struct<3> Param2, float fParam3){
func_265(uParam0);
...
void func_266(var uParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4){
func_267(uParam0);
...
int func_269(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
int iVar0;
if(!func_36(iParam1)){
...
func_264(uParam0, iLocal_53, 558.09f, -1765.39f, 28.86f, 335.3252f);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*uParam0, 4);
...
uLocal_54=PED::CREATE_SYNCHRONIZED_SCENE(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_54, 1);
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_54, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
}
...
int func_291(int iParam0, int iParam1, struct<3> Param2, float fParam3){
int iVar0;
if(*iParam0==1){
...
int func_292(int iParam0, struct<3> Param1, float fParam2, var uParam3){
int iVar0;
struct<7> Var1;
iVar0=0;
...
int func_293(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
