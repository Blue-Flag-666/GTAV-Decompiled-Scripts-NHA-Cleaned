...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_45.f_0, 0);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_45.f_0, 0);
}
...
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_48.f_2, 0, 1);
}
if(bParam0){
func_7(&(Local_48.f_2));
}else{
...
func_26(13, floor(Global_113648.f_10196.f_3853));
}
...
Global_78341[1 /*14*/]={
func_101(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_101(iVar10, 14, uVar12[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_101(iVar10, 14, uVar15[iVar1], -1) 
};
func_68(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_84(14);
if(Global_78339==1){
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_93(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_93(iParam0));
if(iVar11 > iVar10){
...
func_179(&uVar1, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
void func_181(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21){
uParam0->f_4=iParam4;
*uParam0=sParam1;
uParam0->f_1={
Param2 
...
RECORDING::REPLAY_RECORD_BACK_FOR_TIME(5f, 0f, 3);
RECORDING::REPLAY_START_EVENT(4);
func_342(Local_56, Local_57, fLocal_58, -1530.614f, 4538.023f, 46.8171f, 318.992f, func_348(), 1, 1, 1, 0, 0);
...
MISC::CLEAR_AREA(Local_386, 200f, 1, 0, 0, 0);
iLocal_197=(CUTSCENE::GET_CUTSCENE_TOTAL_DURATION() - 300);
iLocal_198=1;
if(func_341(iVar0)){
ENTITY::SET_ENTITY_COORDS(iVar0, Local_386, 1, 0, 0, 1);
...
if(Local_43.f_1==1){
if(!func_341(uLocal_385)){
uLocal_385=PLAYER::GET_PLAYERS_LAST_VEHICLE();
if(!func_341(uLocal_385) && STREAMING::HAS_MODEL_LOADED(iLocal_377)){
uLocal_385=VEHICLE::CREATE_VEHICLE(iLocal_377, Local_386, fLocal_387, 1, 1, 0);
if(func_341(uLocal_385)){
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_385, 1);
}}}
if(func_340()){
if(iLocal_198){
...
PED::SET_PED_CONFIG_FLAG(Local_48.f_2, 185, 1);
...
TASK::TASK_PERFORM_SEQUENCE(Local_48.f_2, uVar1);
TASK::CLEAR_SEQUENCE_TASK(&uVar1);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_48.f_2, 1, 0);
...
func_375();
func_336(Local_48.f_2, -1539.342f, 4539.53f, 46.8468f, 0, 0, 1);
func_374(Local_48.f_2, 1);
Local_48.f_0=5;
Local_48.f_1=0;
func_11(&(Local_48.f_3));
...
var uVar0;
var uVar1;
uVar0=Global_2848282[iParam0 /*3*/][func_87(iParam1)];
...
int func_298(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
Var3={
func_306(Var3, -Var0.f_3.f_2) 
};
Var3={
func_306(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__306(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
return (shift_right(iParam0, 26) & 31 * func_324(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
int func_336(int iParam0, struct<3> Param1, int iParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_245(iParam0)){
...
void func_342(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
func_343(Param0, Param1, fParam2, Param3, fParam4, Param5, bParam6, bParam7, bParam8, bParam9, bParam10);
}


void func_343(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
void func_349(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
var uVar0;
uVar0=PLAYER::GET_PLAYER_INDEX();
...
void func_352(struct<3> Param0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5){
var uVar0;
int iVar1;
...
Local_46.f_0=OBJECT::CREATE_OBJECT_NO_OFFSET(iLocal_376, Local_388, 1, 1, 0);
if(ENTITY::DOES_ENTITY_EXIST(Local_46.f_0)){
ENTITY::SET_ENTITY_ROTATION(Local_46.f_0, Local_389, 2, 1);
...
int func_375(){
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
Local_48.f_2=PED::CREATE_PED(25, iLocal_370, Local_47.f_1[1 /*14*/].f_1, 0f, 1, 1);
}else{
Local_48.f_2=PED::CREATE_PED(25, iLocal_370, Local_47.f_1[0 /*14*/].f_1, 0f, 1, 1);
}
if(func_474(Local_48.f_2)){
iLocal_188=func_376(PLAYER::PLAYER_PED_ID(), Local_48.f_2, 0f);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_48.f_2, 1, 1);
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(Local_48.f_2, 0);
PED::SET_PED_CAN_BE_TARGETTED(Local_48.f_2, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_48.f_2, 1);
WEAPON::GIVE_WEAPON_TO_PED(Local_48.f_2, joaat("weapon_unarmed"), -1, 1, 1);
PED::SET_PED_MONEY(Local_48.f_2, 0);
...
PED::SET_PED_CONFIG_FLAG(Local_48.f_2, 185, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_48.f_2, 46, 1);
...
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_402, 1, 0, 0, 1);
...
Local_43.f_9=4;
Local_43.f_1=3;
}elseif(!func_474(Local_48.f_2)){
if(FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_48.f_2, 1), 4f) || iLocal_171){
...
Local_43.f_1=3;
func_11(&(Local_48.f_3));
}}elseif(FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_48.f_2, 1), 4f)){
...
if(!func_18() && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_392, 35f, 35f, 35f, 0, 1, 0)){
func_385();
func_241(&uLocal_199, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
if(iLocal_168==0){
if(!func_384(&uLocal_63, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
func_389("SAS1_C2", 7500, 0);
iLocal_168=1;
iLocal_172=MISC::GET_GAME_TIMER() + 30000;
}}elseif(MISC::GET_GAME_TIMER() > iLocal_172){
if(func_384(&uLocal_63, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
iLocal_168=0;
}}}}
if(Local_43.f_1==3){
...
HUD::CLEAR_PRINTS();
func_11(&(Local_48.f_3));
if(func_384(&uLocal_115, ENTITY::GET_ENTITY_COORDS(Local_48.f_2, 0))){
bLocal_180=false;
}else{
bLocal_180=true;
}
...
bool func_384(var uParam0, struct<2> Param1, float fParam2){
bool bVar0;
int iVar1;
int iVar2;
if(uParam0->f_46 < 3){}
...
void func_391(){
if(MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_48.f_2, 1), 1.5f, 1, 1)){
if(Local_47.f_352 < (Local_47.f_353 - 1)){
func_392();
func_407(807, 1, 0);
if(!func_18()){
...
}}}elseif(MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_48.f_2, 1), 5f, 1, 1)){
if(Local_47.f_352 < (Local_47.f_353 - 1)){
if(!func_18()){
func_241(&uLocal_199, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
ENTITY::SET_ENTITY_COORDS(Local_48.f_2, uParam0->f_1, 1, 0, 0, 1);
if(*uParam0==1){
func_405(Local_48.f_2, uParam0->f_5);
}
Local_48.f_4=(MISC::GET_GAME_TIMER() + iVar1);
Local_48.f_1=1;
}elseif(Local_48.f_1==1){
if(fVar0==-1f){
Local_48.f_0=0;
Local_48.f_1=0;
}elseif(MISC::GET_GAME_TIMER() > Local_48.f_4){
Local_48.f_0=2;
Local_48.f_1=0;
...
Local_48.f_4=0;
Local_48.f_1=1;
}elseif(fVar0==-1f || func_397(Local_48.f_2, PLAYER::PLAYER_PED_ID(), fVar0, 1)){
...
Local_48.f_0=4;
Local_48.f_1=0;
}}elseif(HUD::DOES_BLIP_EXIST(Local_48.f_3)){
iVar2=(HUD::GET_BLIP_ALPHA(Local_48.f_3) - 5);
if(iVar2 > 0){
HUD::SET_BLIP_ALPHA(Local_48.f_3, iVar2);
}else{
func_11(&(Local_48.f_3));
}}elseif(MISC::GET_GAME_TIMER() > Local_48.f_12){
Local_48.f_11=1;
}elseif(MISC::GET_GAME_TIMER() > Local_48.f_4){
...
HUD::TRIGGER_SONAR_BLIP(ENTITY::GET_ENTITY_COORDS(Local_48.f_2, 1), 30f, 6);
}
...
if(Local_47.f_352==(Local_47.f_353 - 1)){
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(Local_48.f_2, 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_48.f_2, 1);
ENTITY::SET_ENTITY_HEALTH(Local_48.f_2, 110, 0);
}
Local_48.f_1=1;
}elseif(Local_48.f_1==1){
...
Local_48.f_1=2;
}elseif(Local_47.f_352 >=(Local_47.f_353 - 1) && func_390(Local_48.f_2, uParam0->f_5, 1.5f, 1)){
Local_48.f_1=2;
}elseif((AUDIO::HAS_SOUND_FINISHED(Local_48.f_6) && AUDIO::HAS_SOUND_FINISHED(Local_48.f_6)) && AUDIO::HAS_SOUND_FINISHED(Local_48.f_7)){
if(Local_48.f_10==0){
AUDIO::PLAY_SOUND_FROM_ENTITY(Local_48.f_6, "RUNNING", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
}
else{
...
TASK::TASK_PERFORM_SEQUENCE(Local_48.f_2, uVar6);
func_385();
Local_48.f_1=1;
Local_48.f_9=0;
}elseif(Local_48.f_1==1){
...
iLocal_192=-1;
}elseif(MISC::GET_GAME_TIMER() > iLocal_191){
...
iLocal_191=-1;
}elseif(MISC::GET_GAME_TIMER() > iLocal_192){
if((!func_18() && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && !PED::IS_PED_STOPPED(PLAYER::PLAYER_PED_ID())){
...
void func_405(int iParam0, struct<2> Param1, var uParam2){
struct<3> Var0;
float fVar1;
float fVar2;
float fVar3;
...
iVar0=0;
while (iVar0 < iLocal_60){
Local_59[iVar0 /*16*/]=PED::CREATE_PED(25, iLocal_378, Local_59[iVar0 /*16*/].f_11, Local_59[iVar0 /*16*/].f_14, 1, 1);
if(func_474(Local_59[iVar0 /*16*/])){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_59[iVar0 /*16*/], 1);
...
PED::SET_PED_COMBAT_ATTRIBUTES(Local_59[iVar0 /*16*/], 46, 1);
...
func_449();
if(func_474(Local_45.f_0)){
PED::SET_PED_CONFIG_FLAG(Local_45.f_0, 185, 1);
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_45.f_0, 0);
}
uLocal_61=HUD::ADD_BLIP_FOR_RADIUS(Local_390, 75f);
HUD::SET_BLIP_COLOUR(uLocal_61, 5);
HUD::SET_BLIP_ALPHA(uLocal_61, 128);
...
MISC::CLEAR_AREA(Local_407, 100f, 1, 0, 0, 0);
iLocal_167=0;
iLocal_168=0;
iLocal_169=0;
iLocal_174=0;
...
Local_43.f_9=1;
Local_43.f_1=3;
}elseif(func_16(Local_45.f_0)){
func_254(6);
func_389("Hunnter dead", 7000, 1);
Local_43.f_9=2;
Local_43.f_1=3;
}elseif((func_437(Local_45.f_0, 0, 70f, 170f, 1, 0, 0, 0) || !func_390(Local_45.f_0, Local_397, 1.5f, 1)) || PED::IS_PED_RAGDOLL(Local_45.f_0)){
...
bVar0=func_384(&uLocal_63, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
...
if(!func_18()){
func_241(&uLocal_199, 4, Local_45.f_0, "HUNTER", 0, 1);
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_45.f_0, 25f, 25f, 25f, 0, 1, 0)){
...
elseif(func_224(&uLocal_199, "SAS1AUD", "SAS1_START1B", 7, 0, 0, 0)){
iLocal_175=1;
}}else{
iLocal_175=1;
}}}elseif(iLocal_167==0){
...
MISC::CLEAR_AREA(Local_406, 50f, 1, 0, 0, 0);
MISC::CLEAR_AREA(Local_407, 20f, 1, 0, 0, 0);
iVar0=PLAYER::GET_PLAYERS_LAST_VEHICLE();
...
ENTITY::SET_ENTITY_COORDS(iVar0, Local_383, 1, 0, 0, 1);
...
}}elseif(func_224(&uLocal_199, "SAS1AUD", sParam2, 7, 0, 0, 0)){
*iParam0=(MISC::GET_GAME_TIMER() + iParam1);
}}}
...
int func_429(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5){
var uVar0;
struct<3> Var1;
var uVar2;
int iVar3;
...
int func_442(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
...
TASK::TASK_PERFORM_SEQUENCE(Local_45.f_0, uVar0);
...
if(bParam0){
if(func_474(PLAYER::PLAYER_PED_ID()) && !func_363()){
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_393, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), uLocal_394);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
}
if(func_474(Local_44.f_28[0])){
Local_45.f_0=Local_44.f_28[0];
ENTITY::SET_ENTITY_COORDS(Local_45.f_0, Local_395, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(Local_45.f_0, fLocal_396);
}else{
Local_45.f_0=PED::CREATE_PED(26, iLocal_371, Local_395, fLocal_396, 1, 1);
...
Local_45.f_2=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_weapon_sniperrifle"), Local_398, Local_399, iVar0, 100, 0, 1, 0);
}
if(!OBJECT::DOES_PICKUP_EXIST(Local_45.f_3)){
if(Local_400.f_2 !=0f){
Local_45.f_3=OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_weapon_pumpshotgun"), Local_400, Local_401, iVar0, 48, 0, 1, 0);
}}}
...
func_361(500, 0);
PATHFIND::SET_PED_PATHS_IN_AREA(Local_408, Local_409, 0, 0);
...
if(func_452(Local_45.f_0, joaat("player"), iLocal_368)){
if(STREAMING::HAS_ANIM_DICT_LOADED(sLocal_379)){
TASK::TASK_PLAY_ANIM(Local_45.f_0, sLocal_379, "hunter_leadout", 1000f, -8f, -1, iLocal_382, 0, 0, 0, 0);
}}}}
...
uVar7=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_285(iVar2, iVar6));
}}}
iVar6++;
}
...
WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_285(iVar2, iVar8));
func_467(uVar1, func_285(iVar2, iVar8));
}}
iVar8++;
}
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
...
float func_470(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
Var0={
ENTITY::GET_ENTITY_COORDS(iParam0, 1) 
...
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_378, 1);
if(func_474(PLAYER::PLAYER_PED_ID())){
func_241(&uLocal_199, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}
if(func_510()){
...
void func_476(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_478(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
func_496(&uLocal_63);
func_495(&uLocal_63, -1241.771f, 4394.965f, 3.8679f);
func_495(&uLocal_63, -1240.532f, 4611.695f, 130.3852f);
func_495(&uLocal_63, -1221.613f, 4702.286f, 125.4371f);
func_495(&uLocal_63, -1461.12f, 4795.818f, 84.8864f);
func_495(&uLocal_63, -1545.03f, 4769.507f, 61.4836f);
func_495(&uLocal_63, -1649.403f, 4828.104f, 59.7308f);
func_495(&uLocal_63, -1828.723f, 4677.121f, 56.0479f);
func_495(&uLocal_63, -1721.592f, 4503.228f, 0.0447f);
func_495(&uLocal_63, -1640.807f, 4488.236f, 0.3443f);
func_495(&uLocal_63, -1561.473f, 4377.037f, 2.2095f);
func_495(&uLocal_63, -1359.169f, 4339.531f, 3.8651f);
func_494(&uLocal_63);
func_496(&uLocal_115);
func_495(&uLocal_115, -1541.932f, 4538.026f, 46.20551f);
func_495(&uLocal_115, -1530.173f, 4515.2f, 41.43694f);
func_495(&uLocal_115, -1507.497f, 4498.376f, 45.2857f);
func_495(&uLocal_115, -1489.46f, 4511.402f, 47.72325f);
func_495(&uLocal_115, -1507.927f, 4587.872f, 34.03341f);
func_495(&uLocal_115, -1535.494f, 4571.508f, 38.5085f);
func_495(&uLocal_115, -1543.281f, 4554.625f, 35.51556f);
func_495(&uLocal_115, -1539.657f, 4545.945f, 45.68447f);
func_494(&uLocal_115);
...
void func_497(struct<3> Param0, struct<3> Param1, float fParam2){
Local_391={
Param0 
};
Local_392={
...
void func_498(struct<3> Param0, float fParam1, float fParam2){
int iVar0;
if(iLocal_60 >=4){}
iVar0=iLocal_60;
Local_59[iVar0 /*16*/].f_1=0;
Local_59[iVar0 /*16*/].f_11={
Param0 
};
...
void func_499(struct<3> Param0, struct<3> Param1, float fParam2, float fParam3, int iParam4, int iParam5){
func_500(1, Param0, 0f, Param1, fParam2, fParam3, iParam4, iParam5);
}


void func_500(int iParam0, struct<3> Param1, float fParam2, struct<3> Param3, var uParam4, var uParam5, var uParam6, var uParam7){
int iVar0;
...
Local_47.f_1[iVar0 /*14*/].f_1={
Param1 
};
Local_47.f_1[iVar0 /*14*/].f_4=fParam2;
Local_47.f_1[iVar0 /*14*/].f_5={
Param3 
};
...
void func_501(struct<3> Param0, float fParam1){
Local_402={
Param0 
};
fLocal_403=fParam1;
...
void func_502(struct<3> Param0, struct<3> Param1){
Local_388={
Param0 
};
Local_389={
...
void func_504(struct<3> Param0, float fParam1){
Local_393={
Param0 
};
fLocal_394=fParam1;
...
case 2:
bVar2=true;
uParam0->f_28[0]=PED::CREATE_PED(25, iLocal_38, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
...
void func_507(var uParam0, int iParam1, struct<3> Param2, float fParam3){
func_337(uParam0);
...
PED::SET_PED_MODEL_IS_SUPPRESSED(iLocal_378, 0);
func_10(0);
func_8(0);
func_2(0);
func_460(&uLocal_385);
