...
iVar2=iVar5;
Var3={
func_198(Global_44465[iVar5 /*12*/].f_1) 
};
...
Var3={
func_198(Global_44465[iVar11 /*12*/].f_1) 
};
}}
if(!bParam4){
...
func_129();
return 0;
}}elseif(func_289(&Global_43639, uParam0->f_6, &Var2, &(Var2.f_4), iVar0, &(Var2.f_8), &cVar3, &cVar4, 0, 0, 1)){
if(uParam0->f_3==5 || MISC::IS_BIT_SET(uParam0->f_1, 12)){
func_144(1);
}
return 1;
...
func_129();
return 0;
}}elseif(func_288(&Global_43639, uParam0->f_6, &Var5, &(Var5.f_4), iVar0, 0, 0, 1)){
if(MISC::IS_BIT_SET(uParam0->f_1, 12)){
func_144(1);
}
if(MISC::IS_BIT_SET(uParam0->f_1, 13)){
