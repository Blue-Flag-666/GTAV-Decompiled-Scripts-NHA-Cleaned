...
ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(Local_303[iVar0 /*13*/], 0, iLocal_320);
...
if(!PED::IS_PED_IN_VEHICLE(Local_293.f_0, Local_317.f_0, 0)){
...
ENTITY::SET_ENTITY_COORDS(Local_317.f_0, -1246.956f, -89.9753f, 42.904f, 1, 0, 0, 1);
...
ENTITY::SET_ENTITY_COORDS(Local_316[4 /*6*/], -1273.736f, -75.3014f, 44.6289f, 1, 0, 0, 1);
...
ENTITY::DETACH_ENTITY(iLocal_323, 1, 1);
}}
func_4(&Local_293);
iLocal_252=0;
iLocal_260=0;
...
if(!func_32()){
if(func_517(PLAYER::PLAYER_PED_ID())){
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_323, 1) + Vector(0f, 1.5f, 0f), 1, 0, 0, 1);
}}
iLocal_260=1;
iLocal_69=2;
break;
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_328.f_1, Local_293.f_0, PED::GET_PED_BONE_INDEX(Local_293.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1, 0);
if(func_5(Local_317.f_0)){
if(func_6(Local_293.f_0)){
if(!PED::IS_PED_IN_VEHICLE(Local_293.f_0, Local_317.f_0, 0)){
TASK::TASK_ENTER_VEHICLE(Local_293.f_0, Local_317.f_0, -1, -1, 1073741824, 1, 0);
}}
}
...
func_12();
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 11f, 11f, 11f, 0, 1, 0)){
...
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 11f, 11f, 11f, 0, 1, 0)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_328.f_1, Local_293.f_0, PED::GET_PED_BONE_INDEX(Local_293.f_0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_322);
...
TASK::SET_SEQUENCE_TO_REPEAT(uLocal_322, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_322);
TASK::TASK_PERFORM_SEQUENCE(Local_293.f_0, uLocal_322);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_322);
...
iLocal_68=0;
}elseif((MISC::GET_GAME_TIMER() - iLocal_279) >=2500){
...
if((func_5(Local_317.f_0) && func_5(Local_316[5 /*6*/])) && func_517(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317.f_0, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_316[5 /*6*/], 0)){
if(func_14()){
func_15();
}
...
break;
case 3:
if(((func_5(Local_317.f_0) && func_265(Local_293.f_0, Local_317.f_0, 1) < 10f) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317.f_0, 0)) && !ENTITY::IS_ENTITY_UPSIDEDOWN(Local_317.f_0)){
...
if(func_6(Local_293.f_0)){
if(!func_263()){
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_293.f_0, Local_317.f_0, "NIGEL1DGOLF", 786468, 0, 12, -1, -1082130432, 0, 1073741824);
}else{
iLocal_261=1;
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_293.f_0, Local_317.f_0, "NIGEL1DGOLF2", 786468, 0, 12, -1, -1082130432, 0, 1073741824);
}
}
iLocal_68=4;
}}else{
...
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317.f_0, 1)){
iLocal_68=7;
}}
break;
case 5:
...
func_259();
if(func_5(Local_317.f_0)){
if(!PED::IS_PED_IN_VEHICLE(Local_293.f_0, Local_317.f_0, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317.f_0, 1)){
iLocal_68=7;
}}
break;
case 7:
...
int func_258(){
if(ENTITY::GET_ENTITY_SPEED(Local_317.f_0) < 0.15f && PED::IS_PED_IN_VEHICLE(Local_293.f_0, Local_317.f_0, 0)){
iLocal_276++;
if(iLocal_276 > 30){
TASK::VEHICLE_WAYPOINT_PLAYBACK_PAUSE(Local_317.f_0);
if(func_5(Local_317.f_0) && func_517(Local_293.f_0)){
VEHICLE::BRING_VEHICLE_TO_HALT(Local_317.f_0, 2f, 3, 0);
if(PED::IS_PED_IN_VEHICLE(Local_293.f_0, Local_317.f_0, 0)){
...
void func_259(){
if(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_293.f_0, 1), 20f, 1)){
...
int func_263(){
if(func_517(PLAYER::PLAYER_PED_ID())){
if(func_264(&uLocal_437, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1))){
return 1;
}}
return 0;
}
...
TASK::TASK_PERFORM_SEQUENCE(Local_303[iVar0 /*13*/], uLocal_321);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_321);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_303[iVar0 /*13*/], 25, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_303[iVar0 /*13*/], 1, 1);
PED::SET_PED_KEEP_TASK(Local_303[iVar0 /*13*/], 1);
...
if(func_5(Local_317.f_0)){
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317.f_0, 0)){
if(func_6(Local_293.f_0)){
if(!PED::IS_PED_IN_VEHICLE(Local_293.f_0, Local_317.f_0, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_321);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 500);
TASK::TASK_PAUSE(0, MISC::GET_RANDOM_INT_IN_RANGE(250, 500));
TASK::TASK_ENTER_VEHICLE(0, Local_317.f_0, -1, -1, 1073741824, 1, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_321);
TASK::TASK_PERFORM_SEQUENCE(Local_293.f_0, uLocal_321);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_321);
...
if(func_517(Local_298.f_0)){
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_298.f_0, 1, 1);
}
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_328.f_1, Local_293.f_0, PED::GET_PED_BONE_INDEX(Local_293.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1, 0);
if(func_517(Local_298.f_0)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_332.f_0, Local_298.f_0, PED::GET_PED_BONE_INDEX(Local_298.f_0, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}elseif(ENTITY::IS_ENTITY_ATTACHED(Local_328.f_1)){
ENTITY::DETACH_ENTITY(Local_328.f_1, 1, 1);
}
func_268(790, 0);
iLocal_255=1;
}}
...
ENTITY::DETACH_ENTITY(Local_331[iParam0 /*6*/], 1, 1);
}}
...
switch (iLocal_315){
case 0:
if(func_6(Local_293.f_0) && func_517(PLAYER::PLAYER_PED_ID())){
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_322);
TASK::TASK_PERFORM_SEQUENCE(iParam0, uLocal_322);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_322);
PED::SET_PED_KEEP_TASK(iParam0, 1);
}}}
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_306[iVar0 /*13*/], 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_306[iVar0 /*13*/], 0);
iVar0++;
}
iVar0=0;
while (iVar0 <=1){
func_308(&(Local_318[iVar0 /*6*/]), 0);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_318[iVar0 /*6*/].f_5, 1);
iVar0++;
}
iLocal_246=1;
}}else{
...
if(func_517(Local_293.f_0)){
if(PED::IS_PED_IN_VEHICLE(Local_293.f_0, Local_317.f_0, 0)){
if(ENTITY::IS_ENTITY_AT_ENTITY(Local_293.f_0, Local_306[iParam0 /*13*/], 62f, 62f, 62f, 0, 1, 0)){
if(func_6(Local_306[iParam0 /*13*/])){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_306[iParam0 /*13*/], Local_293.f_0, -1);
iLocal_309[iParam0]=1;
}
}
elseif(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_306[iParam0 /*13*/], 1), 15f, 1)){
...
}}elseif(func_275(Local_306[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || ENTITY::IS_ENTITY_AT_ENTITY(Local_293.f_0, Local_306[iParam0 /*13*/], 30f, 30f, 30f, 0, 1, 0)){
func_299(Local_306[iParam0 /*13*/], 0);
iLocal_309[iParam0]=3;
}}}
break;
case 1:
if(ENTITY::IS_ENTITY_AT_ENTITY(Local_293.f_0, Local_306[iParam0 /*13*/], 38f, 38f, 38f, 0, 1, 0)){
if(func_6(Local_306[iParam0 /*13*/])){
func_296(&uLocal_72, 8, Local_306[iParam0 /*13*/], "NIGEL1DAMBIENTGOLFER1", 0, 1);
if(func_265(PLAYER::PLAYER_PED_ID(), Local_306[iParam0 /*13*/], 1) < 45f){
...
PED::SET_PED_KEEP_TASK(Local_306[iParam0 /*13*/], 1);
iLocal_309[iParam0]=2;
}}
break;
case 2:
if(ENTITY::IS_ENTITY_AT_COORD(Local_306[iParam0 /*13*/], Local_306[iParam0 /*13*/].f_4, 2f, 2f, 2f, 0, 1, 0)){
func_299(Local_306[iParam0 /*13*/], 0);
iLocal_309[iParam0]=3;
}
break;
...
WEAPON::GIVE_WEAPON_TO_PED(Local_303[iVar0 /*13*/], joaat("weapon_pistol"), -1, 0, 1);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_303[iVar0 /*13*/], 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_303[iVar0 /*13*/], 1);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_303[iVar0 /*13*/], iLocal_320);
PED::SET_PED_DIES_WHEN_INJURED(Local_303[iVar0 /*13*/], 1);
PED::SET_PED_MODEL_IS_SUPPRESSED(Local_303[iVar0 /*13*/].f_8, 1);
iVar0++;
}
iLocal_243=1;
}}else{
...
int iVar0;
int iVar1;
if(func_517(PLAYER::PLAYER_PED_ID()) && func_517(Local_303[iParam0 /*13*/])){
...
attacking...");
func_267();
}}elseif(PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_303[iParam0 /*13*/])){
if(func_273()){
...
if(!func_181(PLAYER::PLAYER_PED_ID(), 12, 4)){
if(!func_317()){
if(func_277(Local_303[iParam0 /*13*/], 1126825984) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0)){
if(func_14()){
func_12();
}
func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
...
elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0)){
if(iLocal_247==0){
func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
...
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_321);
TASK::TASK_PERFORM_SEQUENCE(Local_303[iParam0 /*13*/], uLocal_321);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_321);
iLocal_285=MISC::GET_GAME_TIMER();
iLocal_247=1;
iLocal_307[iParam0]=1;
}}elseif(func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_1", 7, 1, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_321);
TASK::TASK_PLAY_ANIM(0, "rcmnigel1d", "thanks_male_03", 8f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_321);
...
}}}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 50f, 50f, 50f, 0, 1, 0)){
...
attacking");
func_267();
}}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0)){
...
}}elseif(func_277(Local_303[iParam0 /*13*/], 1126825984)){
func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
if(iLocal_254==0){
...
attacking...");
func_267();
}}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 9f, 9f, 9f, 0, 1, 0) && iLocal_249==1){
func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
...
}}elseif((MISC::GET_GAME_TIMER() - iLocal_285) >=8000){
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 4f, 4f, 4f, 0, 1, 0) || (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 8f, 8f, 8f, 0, 1, 0) && iLocal_249==1)){
func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
if(func_272(&uLocal_72, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_3", 7, 0, 0)){
if(func_6(Local_303[iParam0 /*13*/])){
TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_303[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), -1);
...
elseif(func_265(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 1) > 20f){
...
TASK::TASK_PERFORM_SEQUENCE(Local_303[iParam0 /*13*/], uLocal_321);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_321);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_303[iParam0 /*13*/], 25, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_303[iParam0 /*13*/], 1, 1);
PED::SET_PED_KEEP_TASK(Local_303[iParam0 /*13*/], 1);
...
if(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_303[iParam0 /*13*/], 1), 20f, 0) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0)){
if(func_14()){
func_12();
}
func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
...
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 7f, 7f, 5f, 0, 1, 0) || (func_315(PLAYER::PLAYER_PED_ID(), -1097.28f, 68.05f, 52.99f, 10f, 1) && iLocal_249==1)){
if(func_14()){
func_12();
}
func_296(&uLocal_72, 7, Local_303[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
...
if(func_517(Local_293.f_0)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_303[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0) && !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 11f, 11f, 11f, 0, 1, 0)){
if(func_6(Local_303[iParam0 /*13*/])){
...
break;
case 4:
if(func_265(Local_303[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1) > 120f && (PED::IS_PED_IN_ANY_VEHICLE(Local_293.f_0, 0) || func_517(Local_293.f_0))){
if(HUD::DOES_BLIP_EXIST(Local_303[iParam0 /*13*/].f_11)){
HUD::REMOVE_BLIP(&(Local_303[iParam0 /*13*/].f_11));
func_299(Local_303[iParam0 /*13*/], 1);
iLocal_307[iParam0]=6;
}}elseif(!func_314(Local_303[iParam0 /*13*/], joaat("script_task_perform_sequence"))){
TASK::OPEN_SEQUENCE_TASK(&uLocal_321);
TASK::TASK_PAUSE(0, MISC::GET_RANDOM_INT_IN_RANGE(5, 200));
TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
TASK::CLOSE_SEQUENCE_TASK(uLocal_321);
...
TASK::TASK_GO_TO_ENTITY(Local_303[iVar0 /*13*/], Local_293.f_0, 20000, 6f, 1073741824, 1073741824, 0);
}}else{
TASK::TASK_LOOK_AT_ENTITY(Local_303[iVar0 /*13*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
}
WEAPON::SET_CURRENT_PED_WEAPON(Local_303[iVar0 /*13*/], joaat("weapon_pistol"), 1);
PED::SET_PED_USING_ACTION_MODE(Local_303[iVar0 /*13*/], 1, -1, "DEFAULT_ACTION");
...
ENTITY::DETACH_ENTITY(Local_332.f_0, 1, 1);
}
TASK::TASK_SMART_FLEE_PED(Local_298.f_0, PLAYER::PLAYER_PED_ID(), 300f, -1, 1, 0);
...
iVar0=0;
while (iVar0 <=2){
if((!func_517(Local_303[iVar0 /*13*/]) || func_322(PLAYER::PLAYER_PED_ID(), Local_303[iVar0 /*13*/], 1)) || PED::IS_PED_RAGDOLL(Local_303[iVar0 /*13*/])){
...
if((!func_517(Local_293.f_0) || func_322(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 1)) || PED::IS_PED_RAGDOLL(Local_293.f_0)){
func_536("HAS_PLAYER_MUCKED_ABOUT():
Celeb ragdoll OR player bumped celeb with vehicle OR celeb isn't alive");
return 1;
}
if((!func_517(Local_298.f_0) || func_322(PLAYER::PLAYER_PED_ID(), Local_298.f_0, 1)) || PED::IS_PED_RAGDOLL(Local_298.f_0)){
func_536("HAS_PLAYER_MUCKED_ABOUT():
Celeb friend ragdoll OR player bumped friend with vehicle OR friend isn't alive");
return 1;
}
if(func_5(Local_317.f_0) && func_517(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_317.f_0, 0)){
func_536("HAS_PLAYER_MUCKED_ABOUT():
...
if(func_5(Local_316[4 /*6*/]) && func_517(PLAYER::PLAYER_PED_ID())){
if(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_316[4 /*6*/], 0)){
func_536("HAS_PLAYER_MUCKED_ABOUT():
...
if(func_5(Local_316[5 /*6*/]) && func_517(PLAYER::PLAYER_PED_ID())){
...
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_287, "COLLECT_IN_BAG", Local_328.f_1, "NIGEL_1D_SOUNDSET", 0, 0);
}else{
func_536("Golf club NOT attached to bag - correct?");
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_287, "COLLECT_OUT_BAG", Local_328.f_1, "NIGEL_1D_SOUNDSET", 0, 0);
}
...
if(func_264(&uLocal_333, ENTITY::GET_ENTITY_COORDS(iParam0, 1))){
return 1;
}
return 0;
}
...
iLocal_256=1;
}}}}}elseif(iLocal_68==7 || iLocal_67==6){
if(func_517(Local_328.f_1)){
...
if(iLocal_67 < 6){
if(func_517(Local_293.f_0)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 140f, 140f, 140f, 0, 1, 0) && !func_278(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 1126825984, 1, 250, 7)){
func_34(1);
}}}}}
...
if(ENTITY::DOES_ENTITY_EXIST(Local_293.f_0) && func_517(Local_328.f_1)){
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_323, Local_317.f_0, 0, 0.2f, -1.3f, 0.5f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}
...
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_328.f_1, iLocal_323, 0, 0.1f, 0f, -0.25f, -5f, 155f, 0f, 0, 0, 0, 0, 2, 1, 0);
}elseif(ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_328.f_1, Local_293.f_0)){
...
if((func_258() || VEHICLE::IS_VEHICLE_TYRE_BURST(Local_317.f_0, 0, 0)) || VEHICLE::IS_VEHICLE_TYRE_BURST(Local_317.f_0, 1, 0)){
...
void func_335(){
if(func_517(Local_293.f_0)){
if(!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_293.f_0, 20f, 20f, 20f, 0, 1, 0)){
...
if(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_317.f_0, PLAYER::PLAYER_PED_ID(), 1) && !WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(Local_317.f_0, 0, 2)){
func_370();
func_513("VEHICLE HEALTH IS ", ENTITY::GET_ENTITY_HEALTH(Local_317.f_0));
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_317.f_0);
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_317.f_0, PLAYER::PLAYER_PED_ID(), 1)){
func_513("VEHICLE HEALTH IS ", ENTITY::GET_ENTITY_HEALTH(Local_317.f_0));
ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_317.f_0);
}}else{
func_536("Celeb dead - returning true");
...
if(iLocal_261==0){
if(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_317.f_0)){
TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Local_293.f_0, Local_317.f_0, "NIGEL1DGOLF", 786468, 0, 8, -1, -1082130432, 0, 1073741824);
}}elseif(!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_317.f_0)){
iLocal_261=0;
}}}}}}
...
PED::SET_PED_CAN_BE_TARGETTED(Local_305[iVar0 /*13*/], 1);
iVar0++;
}
iVar0=0;
while (iVar0 <=5){
func_378(&(Local_331[iVar0 /*6*/]), 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_331[iVar0 /*6*/], Local_305[iVar0 /*13*/], PED::GET_PED_BONE_INDEX(Local_305[iVar0 /*13*/], 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1, 0);
iVar0++;
}
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_331[0 /*6*/], Local_305[0 /*13*/], PED::GET_PED_BONE_INDEX(Local_305[0 /*13*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_331[1 /*6*/], Local_305[1 /*13*/], PED::GET_PED_BONE_INDEX(Local_305[1 /*13*/], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_331[2 /*6*/], Local_305[2 /*13*/], PED::GET_PED_BONE_INDEX(Local_305[2 /*13*/], 28422), 0f, 0f, 0.05f, 0f, -10f, -90f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_331[3 /*6*/], Local_305[3 /*13*/], PED::GET_PED_BONE_INDEX(Local_305[3 /*13*/], 28422), -0.01f, 0f, 0f, 10f, 0f, -90f, 0, 0, 0, 0, 2, 1, 0);
iVar0=0;
while (iVar0 <=1){
...
case 0:
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_305[iParam0 /*13*/], 1), 50f, 0)){
func_270(iParam0);
...
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_305[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0)){
...
Local_291={
ENTITY::GET_ENTITY_COORDS(Local_305[iParam0 /*13*/], 1) 
};
...
PED::SET_PED_CAN_BE_TARGETTED(Local_305[iParam0 /*13*/], 1);
...
iLocal_308[iParam0]=1;
}}elseif(func_277(Local_305[iParam0 /*13*/], 1126825984)){
if(!func_317()){
if(!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
func_306(Local_305[iParam0 /*13*/], "GENERIC_SHOCKED_HIGH", 34);
}
...
func_374();
iLocal_308[iParam0]=1;
}}elseif(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_305[iParam0 /*13*/], 1), 50f, 1)){
func_299(Local_305[iParam0 /*13*/], 1);
func_375(iParam0);
if(!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED()){
func_306(Local_305[iParam0 /*13*/], "GENERIC_SHOCKED_HIGH", 34);
...
func_318();
iLocal_308[iParam0]=1;
}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(Local_305[iParam0 /*13*/]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_305[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1)){
...
if(ENTITY::IS_ENTITY_AT_COORD(Local_305[iVar0 /*13*/], Local_291, 20f, 20f, 20f, 0, 1, 0)){
PED::SET_PED_CAN_BE_TARGETTED(Local_305[iVar0 /*13*/], 1);
...
ENTITY::DETACH_ENTITY(Local_331[iVar0 /*6*/], 1, 1);
}}
iLocal_308[iVar0]=1;
}}}
iVar0++;
...
break;
case 1:
if(!CAM::DOES_CAM_EXIST(uLocal_241)){
uLocal_241=func_386();
}
if(!CAM::DOES_CAM_EXIST(uLocal_239)){
uLocal_239=CAM::CREATE_CAMERA_WITH_PARAMS(180543640, -1409.452f, 53.5135f, 78.0868f, -26.7543f, 0f, -85.6976f, 50f, 0, 2);
CAM::SET_CAM_SPLINE_DURATION(uLocal_239, 4500);
CAM::ADD_CAM_SPLINE_NODE_USING_CAMERA_FRAME(uLocal_239, uLocal_241, 1500, 3);
CAM::ADD_CAM_SPLINE_NODE(uLocal_239, -1382.719f, 55.216f, 58.0408f, -15.6873f, 0f, -88.6059f, 1500, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_239, -1409.452f, 53.5135f, 78.0868f, -26.7543f, 0f, -85.6976f, 1500, 3, 2);
}
...
break;
case 2:
if(!CAM::IS_CAM_ACTIVE(uLocal_241)){
if(!CAM::IS_CAM_ACTIVE(uLocal_239)){
CAM::SET_CAM_ACTIVE(uLocal_241, 1);
CAM::RENDER_SCRIPT_CAMS(1, 1, 3000, 1, 0, 0);
}}elseif(!CAM::IS_CAM_ACTIVE(uLocal_239)){
...
uLocal_240=CAM::CREATE_CAMERA_WITH_PARAMS(180543640, -1373.681f, 57.0584f, 54.9717f, -10.6657f, 0f, 91.5916f, 50f, 0, 2);
CAM::SET_CAM_SPLINE_DURATION(uLocal_240, 4500);
CAM::ADD_CAM_SPLINE_NODE_USING_CAMERA_FRAME(uLocal_240, uLocal_239, 1500, 3);
CAM::ADD_CAM_SPLINE_NODE(uLocal_240, -1382.719f, 55.216f, 58.0408f, -15.6873f, 0f, -88.6059f, 1500, 3, 2);
CAM::ADD_CAM_SPLINE_NODE(uLocal_240, -1373.681f, 57.0584f, 54.9717f, -10.6657f, 0f, 91.5916f, 1500, 3, 2);
}
...
if(CAM::IS_CAM_ACTIVE(uLocal_241)){
CAM::SET_CAM_ACTIVE(uLocal_241, 0);
}
if(CAM::IS_CAM_ACTIVE(uLocal_239)){
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_292[iVar0 /*13*/], 1);
iVar0++;
}
...
}elseif(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_292[iParam0 /*13*/], 1), 30f, 1)){
if(!HUD::IS_MESSAGE_BEING_DISPLAYED() || MISC::GET_PROFILE_SETTING(203)==0){
if(!func_14()){
if(iParam0==0){
func_296(&uLocal_72, 7, Local_292[iParam0 /*13*/], "CONCIERGE", 0, 1);
...
}}elseif(!HUD::DOES_BLIP_EXIST(iLocal_237)){
...
if(func_264(&uLocal_385, ENTITY::GET_ENTITY_COORDS(iParam0, 0))){
return 1;
}
return 0;
}
...
func_257();
func_384();
if(func_517(Local_293.f_0) && func_517(PLAYER::PLAYER_PED_ID())){
...
Var3={
func_443(Var3, -Var0.f_3.f_2) 
};
Var3={
func_443(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__443(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
return (shift_right(iParam0, 26) & 31 * func_461(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
PED::SET_PED_PROP_INDEX(Local_293.f_0, 0, 0, 0, false, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_293.f_0, 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_293.f_0, 0);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_293.f_0, 1);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_293.f_0, 1, 1);
func_487(Local_293.f_0, 0);
func_309(&Local_298, 0);
func_378(&Local_332, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_332.f_0, Local_298.f_0, PED::GET_PED_BONE_INDEX(Local_298.f_0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
TASK::TASK_PLAY_ANIM(Local_298.f_0, "rcmnigel1d", "idle_a", 8f, -8f, -1, 1, 0, 0, 0, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_298.f_0, 1);
PED::SET_PED_CAN_BE_TARGETTED(Local_298.f_0, 0);
if(func_517(Local_293.f_0)){
Local_328.f_3={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(Local_293.f_0, 1), 1067030938, 1069547520) 
};
}
iLocal_323=OBJECT::CREATE_OBJECT(joaat("prop_golf_bag_01"), Local_328.f_3, 1, 1, 0);
func_308(&Local_317, 0);
if(AUDIO::IS_AUDIO_SCENE_ACTIVE("NIGEL_1D_SCENE")){
if(func_5(Local_317.f_0)){
AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(Local_317.f_0, "NIGEL_1D_GOLF_CART_A", 0);
}}
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_317.f_0, 1, 1, 0);
ENTITY::SET_ENTITY_HEALTH(Local_317.f_0, 1200, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_323, Local_317.f_0, 0, 0.2f, -1.3f, 0.5f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(Local_317.f_5, 1);
Local_328.f_1=OBJECT::CREATE_OBJECT(joaat("prop_golf_wood_01"), Local_328.f_3, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_328.f_1, Local_293.f_0, PED::GET_PED_BONE_INDEX(Local_293.f_0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
...
Var4={
func_490(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
uLocal_324=PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
PED::SET_PED_NON_CREATION_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f);
uLocal_325=PED::ADD_SCENARIO_BLOCKING_AREA(-1379.33f, 45.13f, 50.68f, -1368.01f, 69.83f, 55.9f, 0, 1, 1, 1);
if(iLocal_326==-1){
...
break;
case 1:
if((!func_543(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1)){
return 0;
}
iLocal_49=2;
break;
...
case 38:
if(bParam1){
uLocal_65=PED::ADD_SCENARIO_BLOCKING_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", 0);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", 0);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", 0);
...
case 39:
if(bParam1){
uLocal_65=PED::ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
PED::SET_PED_NON_CREATION_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f);
...
case 41:
if(bParam1){
uLocal_65=PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
...
case 42:
if(bParam1){
uLocal_65=PED::ADD_SCENARIO_BLOCKING_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
...
iVar2=func_466(SCRIPT::GET_THIS_SCRIPT_NAME());
if(iVar2 > -1){
