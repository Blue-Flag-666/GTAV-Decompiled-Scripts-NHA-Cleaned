...
Local_2={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uScriptParam_8, 0f, 0f, 0f) 
};
...
}elseif(ENTITY::HAS_ENTITY_ANIM_FINISHED(uLocal_1, sLocal_6, sLocal_4, 3)){
TASK::TASK_PLAY_ANIM(uLocal_1, sLocal_6, sLocal_4, 1090519040, -1056964608, -1, 0, 0, 0, 0, 0);
}elseif(!iLocal_7){
...
void func_4(){
if(ENTITY::IS_ENTITY_DEAD(uLocal_1, 0)){
uLocal_1=PED::CREATE_PED(5, iLocal_5, Local_2.f_0, Local_2.f_1, Local_2.f_2, uLocal_3, 1, 1);
