...
PED::REMOVE_RELATIONSHIP_GROUP(uLocal_40);
...
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_199.f_0, 0)){
...
return 1;
}elseif(((func_149(2, Local_199.f_1, Local_199.f_4) && func_149(3, Local_197.f_1, Local_197.f_4)) && func_149(4, Local_198.f_1, Local_198.f_4)) && func_141(0)){
func_142();
func_147(33);
...
PED::ADD_RELATIONSHIP_GROUP("Enemies", &uLocal_40);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_45[0 /*11*/], uLocal_40);
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_45[1 /*11*/], uLocal_40);
...
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_46[iLocal_48 /*25*/].f_11 - Local_46[iLocal_48 /*25*/].f_14, Local_46[iLocal_48 /*25*/].f_11 + Local_46[iLocal_48 /*25*/].f_14, 1, 1);
}}
if(!bParam0){
func_134();
}else{
...
if(iLocal_48 !=-1){
if(!func_136(Local_46[iLocal_48 /*25*/].f_11) && !func_136(Local_46[iLocal_48 /*25*/].f_14)){
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_46[iLocal_48 /*25*/].f_11 - Local_46[iLocal_48 /*25*/].f_14, Local_46[iLocal_48 /*25*/].f_11 + Local_46[iLocal_48 /*25*/].f_14, 0, 1);
}}}
...
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_43, 1) 
};
iVar2=0;
while (iVar2 <=(iLocal_41 - 1)){
fVar5=MISC::GET_DISTANCE_BETWEEN_COORDS(Var1, Local_46[iVar2 /*25*/], 1);
...
var uVar1;
if(!bParam0){
uVar1=ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_43, "wheel_rf");
}else{
uVar1=ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iLocal_43, "wheel_lf");
}
Var0={
ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(iLocal_43, uVar1) 
};
Var0={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_43, Var0) 
};
if(!bParam0){
Var0={
...
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_199.f_0, 1);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_199.f_0, 1);
return 1;
}}elseif(func_153(&Local_199, Local_199.f_5, Local_199.f_1, Local_199.f_4, 1)){
func_36(Local_199.f_0, 0);
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_199.f_0, 1);
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_199.f_0, 1);
return 1;
...
PED::SET_PED_CONFIG_FLAG(Local_197.f_0, 170, 0);
PED::SET_PED_FLEE_ATTRIBUTES(Local_197.f_0, 65536, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_197.f_0, 50, 1);
return 1;
}}else{
return 1;
}}elseif(func_150(&Local_197, Local_197.f_5, Local_197.f_1, Local_197.f_4, 1, 0, 1, 1)){
if(func_37(Local_199.f_0)){
...
if(func_343(Local_198.f_0)){
PED::SET_PED_CONFIG_FLAG(Local_198.f_0, 170, 0);
PED::SET_PED_FLEE_ATTRIBUTES(Local_198.f_0, 65536, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(Local_198.f_0, 50, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_198.f_0, true);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_198.f_0, 1, 1);
return 1;
}}else{
return 1;
}}elseif(func_150(&Local_198, Local_198.f_5, Local_198.f_1, Local_198.f_4, 1, 0, 1, 1)){
if(func_37(Local_199.f_0)){
...
func_7(&(uParam0->f_4));
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!func_157(PLAYER::PLAYER_PED_ID(), *uParam0, 150f, 1) && !bLocal_52){
...
if(ENTITY::DOES_ENTITY_EXIST(Local_45[func_171(uParam0->f_10) /*11*/])){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_54, 1f, -1, 2f, 0, 1193033728);
}}
uParam0->f_1=MISC::GET_GAME_TIMER();
uParam0->f_6=23;
uParam0->f_5=1;
...
break;
case 7:
if(PED::IS_PED_IN_VEHICLE(*uParam0, iLocal_43, 1)){
...
func_163(uParam0);
uParam0->f_1=MISC::GET_GAME_TIMER();
}elseif(func_177(Local_45[func_171(uParam0->f_10) /*11*/], *uParam0, 1126825984, 1, 250, 7)){
func_176(uParam0, 0);
}else{
func_162(uParam0);
uParam0->f_1=MISC::GET_GAME_TIMER();
...
uParam0->f_5=1;
uParam0->f_6=16;
}}elseif((MISC::GET_GAME_TIMER() - iLocal_55) >=5000 && (MISC::GET_GAME_TIMER() - iLocal_55) <=5500){
if(PED::IS_PED_IN_ANY_VEHICLE(*uParam0, 0)){
...
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_43, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0)){
func_163(uParam0);
}else{
func_168(uParam0);
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, 10f, -2f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, 3f, 2f), 5f, 0, 1, 0) && PED::IS_PED_STOPPED(*uParam0)){
return 1;
}
return 0;
}
...
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_40, joaat("player"));
switch (uParam0->f_8){
case 4:
break;
case 10:
...
if(!PED::IS_PED_IN_VEHICLE(*uParam0, iLocal_43, 0)){
if(uParam0->f_10==0){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(1)), 1f, -1, 1048576000, 0, 1193033728);
uParam0->f_7=1;
}else{
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(0)), 1f, -1, 1048576000, 0, 1193033728);
uParam0->f_7=1;
}}}
break;
case 2:
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(0)), 1f, -1, 1048576000, 0, 1193033728);
uParam0->f_7=1;
}}elseif(!PED::IS_PED_IN_VEHICLE(*uParam0, iLocal_43, 0)){
if(uParam0->f_10==0){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(1)), 1f, -1, 1048576000, 0, 1193033728);
uParam0->f_7=1;
}else{
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_46[iLocal_48 /*25*/].f_19, 1f, 20000, -1f, 0, func_165(Local_46[iLocal_48 /*25*/].f_19, ENTITY::GET_ENTITY_COORDS(*uParam0, 1), 1));
}
if(func_37(iLocal_43)){
...
if(func_37(iLocal_43) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_43, 0) && !PED::IS_PED_IN_VEHICLE(*uParam0, iLocal_43, 0))){
...
uParam0->f_7=3;
}}}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_43, 1)){
func_176(uParam0, 0);
return;
}
break;
...
TASK::OPEN_SEQUENCE_TASK(&uVar0);
if(func_170(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_46[iLocal_48 /*25*/].f_19) > 1.5f){
...
TASK::CLEAR_SEQUENCE_TASK(&uVar0);
uParam0->f_9=2;
}elseif(func_191(Local_46[iLocal_48 /*25*/].f_19, *uParam0, 1f, 1f, 8f)){
func_190(uParam0);
return;
}
...
if(func_10(Local_46[iLocal_48 /*25*/].f_17) && !ENTITY::IS_ENTITY_ATTACHED(Local_46[iLocal_48 /*25*/].f_17)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_46[iLocal_48 /*25*/].f_17, *uParam0, PED::GET_PED_BONE_INDEX(*uParam0, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1, 0);
}}}
...
if(ENTITY::IS_ENTITY_AT_COORD(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, -5.5f, 0f), 0.9f, 0.9f, 2f, 0, 1, 0)){
if(!func_184(*uParam0, joaat("script_task_follow_nav_mesh_to_coord"))){
TASK::OPEN_SEQUENCE_TASK(&uVar1);
if(func_170(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), ENTITY::GET_ENTITY_COORDS(iLocal_43, 1)) > 3f){
...
var uVar0;
var uVar1;
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_40, joaat("player"));
func_169(uParam0);
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
if(!PED::IS_PED_IN_ANY_VEHICLE(*uParam0, 0)){
TASK::TASK_PUT_PED_DIRECTLY_INTO_MELEE(*uParam0, PLAYER::PLAYER_PED_ID(), 8f, -1f, 10f, 0);
...
return 1;
}}}}elseif(ENTITY::IS_ENTITY_A_PED(Local_42.f_18)){
if(func_10(Local_42.f_18)){
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_43, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_43, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0)){
func_197(uParam0);
}elseif(!func_184(*uParam0, joaat("script_task_go_to_entity")) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_43, 1) + Vector(2f, 0f, 0f), 9f, 0, 1, 0)){
TASK::CLEAR_PED_TASKS(*uParam0);
TASK::TASK_GO_TO_ENTITY(*uParam0, PLAYER::PLAYER_PED_ID(), -1, 4f, 1f, 1073741824, 0);
}}elseif(func_107(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(bParam1)), 5f, 1)){
iVar0=-1;
if(!bParam1){
iVar0=0;
}
...
if(!func_184(*uParam0, joaat("script_task_drive_by")) && PED::IS_PED_IN_VEHICLE(*uParam0, iLocal_43, 0)){
...
}}elseif(Local_46[iVar0 /*25*/].f_23 !=0){
...
Local_54={
ENTITY::GET_ENTITY_COORDS(Local_45[func_171(iParam1) /*11*/], 1) 
};
uParam0->f_1=MISC::GET_GAME_TIMER();
uParam0->f_8=uParam0->f_7;
uParam0->f_5=1;
...
func_176(uParam0, 0);
}}}elseif(Local_45[func_171(iParam1) /*11*/].f_6==22){
if(func_181(*uParam0, Local_45[func_171(iParam1) /*11*/], 140f, 0) && func_157(Local_45[func_171(iParam1) /*11*/], PLAYER::PLAYER_PED_ID(), 15f, 1)){
uParam0->f_5=1;
uParam0->f_6=21;
}}elseif(Local_45[func_171(iParam1) /*11*/].f_6==5 || Local_45[func_171(iParam1) /*11*/].f_6==7){
...
if(iParam1==0){
TASK::TASK_VEHICLE_MISSION_PED_TARGET(*uParam0, iLocal_43, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, 1);
uParam0->f_6=7;
...
iLocal_194=1;
}}elseif(!func_157(PLAYER::PLAYER_PED_ID(), Local_199.f_0, 120f, 1) && iLocal_194){
...
TASK::TASK_VEHICLE_DRIVE_TO_COORD(iVar2, PED::GET_VEHICLE_PED_IS_IN(iVar2, 0), Local_186, 20f, 0, 0, 34340901, 2f, 10f);
}
else{
...
if(TASK::GET_SCRIPT_TASK_STATUS(iVar2, joaat("script_task_vehicle_mission")) !=1 && TASK::GET_SCRIPT_TASK_STATUS(iVar2, joaat("script_task_vehicle_mission")) !=0){
TASK::TASK_VEHICLE_MISSION(iVar2, PED::GET_VEHICLE_PED_IS_IN(iVar2, 0), Local_199.f_0, 3, 20f, 786468, 2f, 0.5f, 1);
}
}}}else{
func_223(iVar2);
}}}
...
if(!func_230()){
if((ENTITY::DOES_ENTITY_EXIST(Local_199.f_0) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_199.f_0, 0)) && !ENTITY::IS_ENTITY_AT_COORD(Local_199.f_0, Local_186, 2f, 2f, 2f, 0, 1, 0)){
if((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_199.f_0, 0)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if(PED::IS_PED_IN_VEHICLE(iParam0, Local_199.f_0, 0) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(Local_199.f_0, -1, 0)==iParam0){
return 1;
}}}}
return 0;
}
...
MISC::SET_BIT(&(Local_73[iParam0 /*8*/].f_7), false);
}}}}else{
...
MISC::SET_BIT(&(Local_73[iParam0 /*8*/].f_7), true);
}}}
...
if(!MISC::IS_BIT_SET(Local_73[iParam0 /*8*/].f_7, bParam1)){
if(iLocal_375 !=-1){
if(!HUD::IS_MESSAGE_BEING_DISPLAYED()){
...
}}elseif(func_107(PLAYER::PLAYER_PED_ID(), Local_186, 240f, 1)){
if(iLocal_203){
func_6(&uLocal_202);
iLocal_203=0;
}}}
...
if(!func_157(PLAYER::PLAYER_PED_ID(), uLocal_201, fVar0, 1)){
iVar1++;
}}else{
iVar1++;
}
...
func_145(&uLocal_56, 0, 0);
if(CAM::DOES_CAM_EXIST(uLocal_184)){
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
CAM::DESTROY_CAM(uLocal_184, 0);
}}
