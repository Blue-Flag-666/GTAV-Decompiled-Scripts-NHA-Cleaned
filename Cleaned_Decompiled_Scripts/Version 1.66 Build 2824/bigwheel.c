...
CAM::ATTACH_CAM_TO_PED_BONE(Local_178.f_0, PLAYER::PLAYER_PED_ID(), 31086, 0f, -0.25f, 0f, 1);
}else{
...
struct<3> Var0;
Var0.f_0=(sin(fParam0) * Local_167.f_0);
...
ENTITY::SET_ENTITY_COORDS(iLocal_161, Local_166, 1, 0, 0, 1);
...
return ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_161, 0f, (15.3f * sin(fVar0)), (-15.3f * cos(fVar0)));
}
...
if(!CAM::DOES_CAM_EXIST(uLocal_177)){
uLocal_177=CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -1659.446f, -1120.833f, 12.9255f, -3.6667f, 0f, 56.0716f, 50.1098f, 1, 2);
CAM::SET_CAM_PARAMS(uLocal_177, -1659.446f, -1120.833f, 12.9255f, -3.6667f, 0f, 56.0716f, 50.1098f, 0, 1, 1, 2);
CAM::SET_CAM_ACTIVE(uLocal_177, 1);
CAM::SET_CAM_PARAMS(uLocal_177, -1659.11f, -1120.752f, 12.9489f, -5.5053f, 0f, 56.0716f, 50.1098f, 7000, 1, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_123(iVar10, 14, uVar12[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_123(iVar10, 14, uVar15[iVar1], -1) 
};
func_91(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_114(14);
if(Global_78339==1){
...
func_216(13, floor(Global_113648.f_10196.f_3853));
}
