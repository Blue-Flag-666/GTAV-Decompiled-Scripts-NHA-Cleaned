...
float func_196(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
Var0={
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8){
var uVar0;
if(!*uParam8==3){
if(func_183(2)){
if(!func_151()){
...
*uParam8=3;
return 1;
}}}elseif(((func_199(sParam3) && !*uParam8==1) && func_132(PLAYER::PLAYER_PED_ID())) && func_196(PLAYER::PLAYER_PED_ID(), Param1, 1) >=20f){
...
int func_212(struct<2> Param0, float fParam1, struct<2> Param2, Vector3 vParam3, float fParam4){
if(fParam4 < 0f){
fParam4=0f;
}
...
int func_255(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_256(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
int func_256(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_36(iParam1)){
