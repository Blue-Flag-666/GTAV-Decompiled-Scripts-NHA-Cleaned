...
PED::CLEAR_PED_PROP(uParam0, Global_78341[1 /*14*/].f_12, 1);
}else{
uVar6={
func_80(iVar0, 0) 
};
...
if(func_75(uParam0, iVar0, &iVar7, 0)){
...
iVar3=0;
while (iVar3 <=8){
if(!func_149(uParam0, 14, uVar6[iVar3])){
iVar4=0;
while (iVar4 <=19){
Global_78341[2 /*14*/]={
...
iVar7=0;
while (iVar7 <=8){
if(!func_149(uParam0, 14, uVar8[iVar7])){
return 0;
}
iVar7++;
}
...
int func_219(var uParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_207(uParam0)){
...
void func_220(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
var uVar0;
uVar0=PLAYER::GET_PLAYER_INDEX();
...
void func_236(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_238(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
