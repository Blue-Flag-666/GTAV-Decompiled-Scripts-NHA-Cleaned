...
if(MISC::IS_BIT_SET(uLocal_335, 3)){
CUTSCENE::REMOVE_CUTSCENE();
}
MISC::SET_BIT(&(Local_162[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), false);
}
...
if(NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT()){
if(iLocal_161==0){
MISC::CLEAR_BIT(&uLocal_335, false);
...
if(!MISC::IS_BIT_SET(Local_162[iLocal_161 /*3*/].f_2, 0)){
MISC::CLEAR_BIT(&uLocal_335, true);
}
if(func_4(iVar1, 0, 1)){
if(MISC::IS_BIT_SET(Local_162[iLocal_161 /*3*/].f_2, 1)){
MISC::SET_BIT(&uLocal_335, 12);
if(Local_85.f_2==-1){
if(Local_85.f_2 !=iLocal_161){
Local_85.f_2=iLocal_161;
}}}elseif(Local_85.f_2==iLocal_161){
Local_85.f_2=-1;
}}}
iLocal_161++;
if(iLocal_161==32){
if(MISC::IS_BIT_SET(uLocal_335, 1)){
MISC::SET_BIT(&(Local_85.f_1), false);
}
if(!MISC::IS_BIT_SET(uLocal_335, 12)){
if(Local_85.f_2 !=-1){
Local_85.f_2=-1;
}}
MISC::SET_BIT(&uLocal_335, false);
iLocal_161=0;
}}}
...
case 0:
if(!MISC::IS_BIT_SET(uLocal_335, 2)){
if(!MISC::IS_BIT_SET(uLocal_335, 5)){
if(!func_235()){
if(!func_234()){
if(!func_232()){
...
if(HUD::DOES_BLIP_EXIST(Global_1935132)){
if(!MISC::IS_BIT_SET(uLocal_335, 14)){
if(Local_85.f_2 !=-1){
...
if(MISC::IS_BIT_SET(uLocal_335, 8)){
MISC::CLEAR_BIT(&uLocal_335, 8);
}
if(func_198()){
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID())==0){
if((bLocal_333 && CUTSCENE::HAS_CUTSCENE_LOADED()) || !bLocal_333){
if(!MISC::IS_BIT_SET(Local_162[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1)){
MISC::SET_BIT(&(Local_162[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), true);
}
if(MISC::IS_BIT_SET(Local_162[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1)){
if(Local_85.f_2==NETWORK::PARTICIPANT_ID_TO_INT()){
func_12();
...
if(bLocal_334){
func_194();
uLocal_343=GRAPHICS::REQUEST_SCALEFORM_MOVIE("SECURITY_CAM");
}
Local_162[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1=1;
}
elseif(Local_85.f_2 !=-1){
if(!MISC::IS_BIT_SET(uLocal_335, 13)){
if(func_188(1, 1, 1, 1)){
...
if(!MISC::IS_BIT_SET(uLocal_335, 9)){
if(func_188(0, 1, 1, 1)){
if(!func_225()){
...
if(MISC::IS_BIT_SET(Local_162[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1)){
MISC::CLEAR_BIT(&(Local_162[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), true);
}
if(MISC::IS_BIT_SET(uLocal_335, 13)){
...
}elseif(func_184(&uLocal_338, 10, 0)){
...
break;
case 3:
if(!MISC::IS_BIT_SET(Local_162[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0)){
MISC::SET_BIT(&(Local_162[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), false);
}
break;
}
...
uVar0=Global_2805029[iParam0 /*3*/][func_85(iParam1)];
...
var uVar0;
var uVar1;
uVar0=Global_2848282[iParam0 /*3*/][func_85(iParam1)];
...
switch (iLocal_163){
case 0:
if(!MISC::IS_BIT_SET(uLocal_335, 18)){
if(!PED::IS_PED_INJURED(uLocal_164)){
uLocal_337=HUD::ADD_BLIP_FOR_ENTITY(uLocal_164);
HUD::SET_BLIP_AS_FRIENDLY(uLocal_337, 1);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_337, "FM_LEST_BLP");
func_136("FM_LEST_GTL", 0);
MISC::SET_BIT(&uLocal_335, 18);
}}
if(!MISC::IS_BIT_SET(uLocal_335, 20)){
...
uLocal_167=PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
TASK::TASK_SYNCHRONIZED_SCENE(uLocal_164, uLocal_167, "missfinale_c2leadinoutfin_c_int", "_LEADIN_ACTION_LESTER", 1000f, -8f, 5, 16, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uLocal_166, uLocal_167, "_LEADIN_ACTION_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, 8f, 4, 1148846080);
MISC::SET_BIT(&uLocal_335, 20);
}}}}
if(!MISC::IS_BIT_SET(uLocal_335, 3)){
CUTSCENE::REQUEST_CUTSCENE(sLocal_336, 8);
MISC::SET_BIT(&uLocal_335, 3);
}elseif(!MISC::IS_BIT_SET(uLocal_335, 10)){
...
if(MISC::IS_BIT_SET(uLocal_335, 10)){
iLocal_163++;
}}}
break;
case 1:
...
if(MISC::IS_BIT_SET(uLocal_335, 25)){
...
if(!MISC::IS_BIT_SET(uLocal_335, 11)){
...
if(!MISC::IS_BIT_SET(uLocal_335, 26)){
if(iLocal_163 > 2){
...
if(MISC::IS_BIT_SET(uLocal_335, 19)){
...
if(!func_184(&(Global_2802595[bParam0 /*2*/]), 3500, 1) || NETWORK::NETWORK_IS_PLAYER_FADING(bParam0)){
if(!func_96()){
if(CAM::IS_SCREEN_FADED_OUT()){
...
func_183(&(Global_2802595[bParam0 /*2*/]));
...
HUD::REMOVE_BLIP(&uLocal_337);
}
if(ENTITY::DOES_ENTITY_EXIST(uLocal_164)){
uVar0=uLocal_164;
...
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_343) && func_194()){
func_175();
func_174();
...
TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_165);
ENTITY::SET_ENTITY_COORDS(uLocal_165, 1275.256f, -1722.368f, 53.655f, 1, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(uLocal_165, 12.6638f);
PED::FORCE_PED_MOTION_STATE(uLocal_165, joaat("MotionState_Walk"), 0, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
WEAPON::SET_CURRENT_PED_WEAPON(uLocal_165, joaat("weapon_unarmed"), 1);
}
uLocal_344=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 0);
CAM::SET_CAM_ACTIVE(uLocal_344, 1);
CAM::SET_CAM_PARAMS(uLocal_344, 1276.409f, -1719.918f, 56.1054f, -29.932f, 0f, 137.9132f, 50f, 0, 1, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_343, "SET_DETAILS");
func_167("FM_LEST_CAM");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_343, "SET_LOCATION");
...
if(!MISC::IS_BIT_SET(uLocal_335, 17)){
...
case 1:
if(!PED::IS_PED_INJURED(uLocal_165)){
if(!MISC::IS_BIT_SET(uLocal_335, 21)){
if(func_184(&uLocal_345, 1000, 0)){
TASK::TASK_LOOK_AT_COORD(uLocal_165, 1276.409f, -1719.918f, 56.1054f, -1, 0, 2);
...
if(!PED::IS_PED_INJURED(uLocal_165)){
if(!func_235()){
PED::SET_PED_CONFIG_FLAG(uLocal_165, 104, 1);
MISC::SET_BIT(&uLocal_335, 22);
TASK::TASK_CLEAR_LOOK_AT(uLocal_165);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_165, 1273.576f, -1718.459f, 53.7715f, 1f, 20000, 1048576000, 0, 1193033728);
func_183(&uLocal_345);
func_7(&uLocal_345, 0, 0);
iLocal_342++;
}}
...
case 3:
if(!PED::IS_PED_INJURED(uLocal_165)){
if(func_184(&uLocal_345, 5000, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_165, 1275.138f, -1718.426f, 53.72994f, 1272.451f, -1719.627f, 55.45897f, 1.5625f, 0, 1, 0)){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
...
if(MISC::IS_BIT_SET(uLocal_335, 15)){
if(GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_343)){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_343, "SET_TIME");
...
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_343, 255, 255, 255, 255, 0);
}}
if(MISC::IS_BIT_SET(uLocal_335, 22)){
if(!PED::IS_PED_INJURED(uLocal_165)){
PED::SET_PED_CONFIG_FLAG(uLocal_165, 104, 1);
PED::SET_PED_RESET_FLAG(uLocal_165, 60, 1);
PED::SET_PED_RESET_FLAG(uLocal_165, 342, 1);
PED::SET_PED_RESET_FLAG(uLocal_165, 348, 1);
}}
if(MISC::IS_BIT_SET(uLocal_335, 23)){
if(func_143()){
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_164, 1);
ENTITY::SET_ENTITY_INVINCIBLE(iLocal_164, 1);
func_144(&uLocal_168, 8, iLocal_164, "Lester", 0, 1);
PED::SET_PED_PROP_INDEX(iLocal_164, 1, 0, 0, 0, 1);
}}}
if(!ENTITY::DOES_ENTITY_EXIST(uLocal_166)){
if(STREAMING::HAS_MODEL_LOADED(joaat("prop_wheelchair_01_s"))){
iLocal_166=OBJECT::CREATE_OBJECT(joaat("prop_wheelchair_01_s"), 1276.39f, -1712.845f, 54.372f, 0, 0, 0);
}}
...
if(!PED::IS_PED_INJURED(iLocal_164)){
uLocal_167=PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_164, uLocal_167, "missfinale_c2leadinoutfin_c_int", "_LEADIN_LOOP1_LESTER", 1000f, -8f, 5, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_166, uLocal_167, "_LEADIN_LOOP1_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, -8f, 4, 1148846080);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_167, 1);
bVar0=true;
}
if(!bVar0){
return 0;
...
int func_145(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
int iVar0;
if(!func_121(iParam1)){
...
void func_147(){
var uVar0;
if(CAM::DOES_CAM_EXIST(uLocal_344)){
CAM::SET_CAM_ACTIVE(uLocal_344, 0);
CAM::DESTROY_CAM(uLocal_344, 0);
}
...
GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_343);
...
iLocal_165=PED::CREATE_PED(4, uVar0, 1273.827f, -1717.873f, 53.7715f, 19.2225f, 0, 0);
...
if(MISC::IS_BIT_SET(uLocal_335, 24)){
...
void func_260(var uParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
func_245();
}
