...
if(Var0.f_0==17){
uLocal_57=PED::ADD_SCENARIO_BLOCKING_AREA(Var1 - Vector(40f, 40f, 40f), Var1 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
}elseif(Var0.f_0==18){
uLocal_57=PED::ADD_SCENARIO_BLOCKING_AREA(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
}
...
func_201(&Var0);
if(AUDIO::HAS_SOUND_FINISHED(uLocal_56)){
func_196(&Var0, Var1, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
}
if((((((!func_195() && func_194(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(uLocal_56)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", 0, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", 0, -1)){
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_56, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
}
if((iLocal_55==0 && func_194(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var1, Var0.f_15, Var0.f_15, Var0.f_15, 0, 0, 0)){
Var3={
...
func_172(Var0.f_0, &uLocal_58);
}
if(!func_2(&Var0)){
func_277(&Var0, 1);
}elseif(Var0.f_0==19){
AUDIO::STOP_SOUND(uLocal_56);
}
if(func_1(&Var0)){
func_277(&Var0, 0);
}}}}
...
var func__173(struct<3> Param0, int iParam1){
var uVar0;
...
int func_225(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5){
var uVar0;
struct<3> Var1;
var uVar2;
int iVar3;
...
int func_237(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
...
void func_250(var uParam0, struct<3> Param1, float fParam2){
func_251(uParam0, iLocal_53, Param1, fParam2, 26);
...
void func_251(var uParam0, int iParam1, struct<3> Param2, var uParam3, int iParam4){
func_252(uParam0);
...
void func_261(var uParam0, var uParam1, struct<3> Param2, float fParam3){
func_262(uParam0);
