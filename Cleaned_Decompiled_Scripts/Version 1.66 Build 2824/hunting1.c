...
uLocal_80=WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_sniperrifle"));
uLocal_81=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("component_at_scope_large"));
uLocal_82=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("component_at_ar_supp_02"));
Local_83={
...
func_16(13, floor(Global_113648.f_10196.f_3853));
}
...
Global_78341[1 /*14*/]={
func_91(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_91(iVar10, 14, uVar12[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_91(iVar10, 14, uVar15[iVar1], -1) 
};
func_58(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_74(14);
if(Global_78339==1){
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_83(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_83(iParam0));
if(iVar11 > iVar10){
...
func_169(&uVar1, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
WEAPON::SET_PED_AMMO_BY_TYPE(PLAYER::PLAYER_PED_ID(), joaat("AMMO_SNIPER"), uLocal_337);
}else{
...
}}}elseif(PED::IS_PED_GROUP_MEMBER(iLocal_348, func_230())){
TASK::CLEAR_PED_TASKS(iLocal_348);
...
var uVar0;
var uVar1;
uVar0=Global_2848282[iParam0 /*3*/][func_77(iParam1)];
...
int func_268(struct<3> Param0, char* sParam1, struct<3> Param2){
int iVar0;
int iVar1;
...
bool func_270(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_276(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
Var3={
func_284(Var3, -Var0.f_3.f_2) 
};
Var3={
func_284(Var3, Var1.f_3.f_2) 
};
*uParam2={
...
Vector3 func__284(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
return (shift_right(iParam0, 26) & 31 * func_303(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
...
if(iLocal_338 < 3){
if(!bLocal_294){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_365, Local_366, 20f, 0, 1, 0)){
func_327();
if(iLocal_301[17]){
...
uLocal_425[iVar3]=VEHICLE::CREATE_VEHICLE(iVar2[iVar3], Var0[iVar3 /*3*/], fVar1[iVar3], 1, 1, 0);
}
iVar3++;
}
if(((func_233(uLocal_425[0]) && func_233(uLocal_425[1])) && func_233(uLocal_425[2])) && func_233(uLocal_425[3])){
func_318();
}}
...
Local_421[iVar0 /*3*/]={
ENTITY::GET_ENTITY_COORDS(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, 1) 
};
iLocal_303[iVar0]=1;
...
iLocal_329=1;
}elseif(!ENTITY::IS_ENTITY_DEAD(Local_260[iVar0 /*54*/][2 /*17*/].f_6, 0)){
...
}}elseif(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_6, 1), 2f, 0)){
iLocal_277=0;
iLocal_281=1;
iLocal_330=0;
iLocal_330=0;
...
Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_14={
ENTITY::GET_ENTITY_COORDS(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, 1) 
};
Local_260[iVar0 /*54*/].f_52=4;
}
elseif(!Local_260[iVar0 /*54*/][iVar1 /*17*/].f_1){
iLocal_281=0;
}
iLocal_330++;
}}}
...
elseif(Local_260[iVar0 /*54*/][iVar1 /*17*/].f_4==1){
...
TASK::TASK_GO_TO_COORD_ANY_MEANS(Local_260[iVar0 /*54*/][iLocal_330 /*17*/].f_6, Local_421[iVar0 /*3*/], MISC::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
...
}elseif(ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iLocal_329 /*17*/].f_6, 0)){
...
case 6:
if(ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
if(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4==0 && ENTITY::IS_ENTITY_AT_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9 /*3*/], func_332(iParam0), 0, 0, 0)){
iVar1=0;
iVar1=0;
while (iVar1 < 3){
if(ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
...
TASK::TASK_SMART_FLEE_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_421[iParam0 /*3*/], 50f, -1, 0, 0);
}else{
TASK::TASK_SMART_FLEE_COORD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_14, 50f, -1, 0, 0);
}
PED::SET_PED_KEEP_TASK(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
...
TASK::TASK_GO_TO_COORD_ANY_MEANS(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_421[iParam0 /*3*/], MISC::GET_RANDOM_FLOAT_IN_RANGE(1f, 2.5f), 0, 0, 786603, -1082130432);
Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3=10;
}}elseif(func_331(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_260[iParam0 /*54*/][iParam1 /*17*/].f_14, 1) >=45f){
if(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_4==0){
...
if((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_365, Local_366, 20f, 0, 1, 0) && ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)) && iLocal_286) && iLocal_338 < 3){
...
if(!ENTITY::IS_ENTITY_DEAD(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 0)){
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
}}}else{
...
if(iParam1==1){
Var0={
Local_419[Local_260[iParam0 /*54*/][0 /*17*/].f_9 /*3*/] + Local_382 
};
Local_260[iParam0 /*54*/][iParam1 /*17*/].f_11={
Local_382 
};
}elseif(iParam1==2){
Var0={
Local_419[Local_260[iParam0 /*54*/][0 /*17*/].f_9 /*3*/] + Local_383 
};
Local_260[iParam0 /*54*/][iParam1 /*17*/].f_11={
Local_383 
};
}
Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6=PED::CREATE_PED(26, iLocal_341, Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 359.9f), 1, 1);
if(ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6)){
ENTITY::SET_ENTITY_HEALTH(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
Local_260[iParam0 /*54*/][iParam1 /*17*/].f_3=8;
}}}
...
Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6=PED::CREATE_PED(26, iLocal_341, Local_419[Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10 /*3*/], Local_260[iParam0 /*54*/][iParam1 /*17*/].f_5, 1, 1);
if(ENTITY::DOES_ENTITY_EXIST(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6)){
ENTITY::SET_ENTITY_HEALTH(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 100, 0);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_260[iParam0 /*54*/][iParam1 /*17*/].f_6, 1);
Local_260[iParam0 /*54*/][iParam1 /*17*/].f_9=Local_260[iParam0 /*54*/][iParam1 /*17*/].f_10;
...
if(!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), Local_367, 0, 0, 0)){
return 1;
}}
return 0;
}
...
func_370();
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_413, Local_414, 3.5f, 0, 1, 0) || iLocal_301[16]){
func_364();
func_357();
iLocal_254=15;
}
...
if(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_363, Local_364, 10f, 0, 1, 0)){
if(!bLocal_289){
...
Local_259[iVar0 /*29*/].f_28=VEHICLE::CREATE_VEHICLE(Local_259[iVar0 /*29*/].f_9, Local_259[iVar0 /*29*/].f_16, Local_259[iVar0 /*29*/].f_4, 1, 1, 0);
if(ENTITY::DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_28) && !ENTITY::IS_ENTITY_DEAD(Local_259[iVar0 /*29*/].f_28, 0)){
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_259[iVar0 /*29*/].f_28, 1);
VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(Local_259[iVar0 /*29*/].f_28, 1);
Local_259[iVar0 /*29*/].f_7=MISC::GET_RANDOM_INT_IN_RANGE(0, 5);
Local_259[iVar0 /*29*/].f_12=PED::CREATE_PED_INSIDE_VEHICLE(Local_259[iVar0 /*29*/].f_28, 26, Local_259[Local_259[iVar0 /*29*/].f_7 /*29*/].f_10, -1, 1, 1);
if(ENTITY::DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_12)){
Local_259[iVar0 /*29*/].f_11=OBJECT::CREATE_OBJECT(iLocal_345, Local_259[iVar0 /*29*/].f_16, 1, 1, 0);
if(ENTITY::DOES_ENTITY_EXIST(Local_259[iVar0 /*29*/].f_11)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_259[iVar0 /*29*/].f_11, Local_259[iVar0 /*29*/].f_12, PED::GET_PED_BONE_INDEX(Local_259[iVar0 /*29*/].f_12, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
ENTITY::SET_ENTITY_VISIBLE(Local_259[iVar0 /*29*/].f_11, 0, 0);
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_259[iVar0 /*29*/].f_12, 1, 1);
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(Local_259[iVar0 /*29*/].f_12, 1);
Local_259[iVar0 /*29*/].f_2=0;
Local_259[iVar0 /*29*/].f_1=0;
Local_259[iVar0 /*29*/].f_3=0;
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_259[iVar0 /*29*/].f_12, 1);
...
if(!ENTITY::IS_ENTITY_AT_COORD(Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_19, 10f, 10f, 10f, 0, 0, 0)){
...
elseif(!iLocal_282){
if(MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_28, 1), 5f, 1)){
iLocal_282=1;
}
}}else{
TASK::CLEAR_PED_TASKS(Local_259[iVar0 /*29*/].f_12);
VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(Local_259[iVar0 /*29*/].f_28, 0);
TASK::TASK_VEHICLE_DRIVE_WANDER(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, 8f, 786599);
PED::SET_PED_KEEP_TASK(Local_259[iVar0 /*29*/].f_12, 1);
Local_259[iVar0 /*29*/].f_13=15;
}}else{
Local_259[iVar0 /*29*/].f_13=15;
}
...
TASK::CLEAR_PED_TASKS(Local_259[iVar0 /*29*/].f_12);
Var1={
func_374(Local_259[iVar0 /*29*/].f_28) 
};
if(!func_270(Var1, 0f, 0f, 0f, 0)){
TASK::TASK_VEHICLE_PARK(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_28, Var1, ENTITY::GET_ENTITY_HEADING(Local_259[iVar0 /*29*/].f_28), 3, 270f, 1);
}elseif(func_355()){
...
break;
case 6:
if((func_233(Local_259[iVar0 /*29*/].f_28) && func_314(Local_259[iVar0 /*29*/].f_12)) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)){
...
break;
case 7:
if(func_314(Local_259[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)){
...
func_375(iVar0);
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)){
func_375(iVar0);
}}else{
Local_259[iVar0 /*29*/].f_13=15;
}
break;
case 8:
if((func_314(Local_259[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)) && func_383(Local_259[iVar0 /*29*/].f_28)){
Var2={
ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_12, 1) 
};
if(!PED::IS_PED_IN_ANY_VEHICLE(Local_259[iVar0 /*29*/].f_12, 0)){
if(!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(Var2, 3f, 1)){
Local_259[iVar0 /*29*/].f_25={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Local_259[iVar0 /*29*/].f_28, Local_259[iVar0 /*29*/].f_22) 
};
...
if(!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1) && !MISC::IS_BULLET_IN_AREA(Var2, 3f, 1)){
if(ENTITY::IS_ENTITY_AT_COORD(Local_259[iVar0 /*29*/].f_12, Local_259[iVar0 /*29*/].f_25, 1f, 1f, 1f, 0, 0, 1)){
TASK::CLEAR_PED_TASKS(Local_259[iVar0 /*29*/].f_12);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_259[iVar0 /*29*/].f_12, 1);
...
elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Local_259[iVar0 /*29*/].f_12, "ODDJOBS@HUNTER", "enter_call", 3) && !ENTITY::IS_ENTITY_VISIBLE(Local_259[iVar0 /*29*/].f_11)){
ENTITY::SET_ENTITY_VISIBLE(Local_259[iVar0 /*29*/].f_11, 1, 0);
}}else{
TASK::CLEAR_PED_TASKS(Local_259[iVar0 /*29*/].f_12);
func_375(iVar0);
}}else{
...
case 13:
if(!ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_259[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_28, 0), ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_12, 1), 0) > 100f){
Local_259[iVar0 /*29*/].f_13=15;
}}else{
Local_259[iVar0 /*29*/].f_13=15;
}
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_376, ENTITY::GET_ENTITY_COORDS(Local_259[iVar0 /*29*/].f_28, 1), 1) > 450f){
Local_259[iVar0 /*29*/].f_13=15;
}}
iVar0++;
}}
...
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_259[iParam0 /*29*/].f_12, 1);
if(func_383(Local_259[iParam0 /*29*/].f_28)){
...
TASK::TASK_SMART_FLEE_COORD(Local_259[iParam0 /*29*/].f_12, Local_358, 10000f, -1, 0, 0);
Local_259[iParam0 /*29*/].f_13=13;
}}
Local_259[iParam0 /*29*/].f_2=1;
PED::SET_PED_KEEP_TASK(Local_259[iParam0 /*29*/].f_12, 1);
}else{
...
iLocal_278=1;
}}elseif(MISC::GET_GAME_TIMER() > iLocal_318){
...
if(func_314(iLocal_348)){
Var1={
ENTITY::GET_ENTITY_COORDS(iLocal_348, 1) 
};
...
ENTITY::SET_ENTITY_CAN_BE_DAMAGED(Local_259[iParam0 /*29*/].f_28, 0);
}
...
Local_259[iParam0 /*29*/].f_22={
2.5f, 3f, 0f 
};
Local_259[iParam0 /*29*/].f_5=90f;
return 1;
}elseif(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_259[iParam0 /*29*/].f_28, 5, 0)){
Local_259[iParam0 /*29*/].f_22={
2.5f, -3f, 0f 
};
Local_259[iParam0 /*29*/].f_5=90f;
return 1;
}elseif(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_259[iParam0 /*29*/].f_28, 4, 0)){
Local_259[iParam0 /*29*/].f_22={
-2.5f, -3f, 0f 
};
Local_259[iParam0 /*29*/].f_5=-90f;
return 1;
}elseif(VEHICLE::IS_VEHICLE_TYRE_BURST(Local_259[iParam0 /*29*/].f_28, 0, 0)){
Local_259[iParam0 /*29*/].f_22={
-2.5f, 3f, 0f 
};
Local_259[iParam0 /*29*/].f_5=-90f;
...
iLocal_255=13;
MISC::CLEAR_AREA_OF_VEHICLES(Local_376, 50f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(Local_374, 50f, 0, 0, 0, 0, 0, 0, 0);
MISC::CLEAR_AREA_OF_VEHICLES(Local_375, 50f, 0, 0, 0, 0, 0, 0, 0);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
func_386();
func_360();
func_359();
...
void func_393(){
Local_259[0 /*29*/]={
func_394(joaat("habanero"), 1155.058f, 3533.135f, 33.9186f, 34.9236f, joaat("a_m_y_hippy_01"), Local_374) 
};
Local_259[1 /*29*/]={
func_394(joaat("dubsta"), 1655.803f, 3492.451f, 35.5714f, 105.5303f, joaat("a_m_m_salton_01"), Local_375) 
};
Local_259[2 /*29*/]={
func_394(joaat("patriot"), 1516.076f, 3376.604f, 36.6333f, 359.8644f, joaat("a_m_m_hillbilly_01"), Local_375) 
};
Local_259[3 /*29*/]={
func_394(joaat("rebel"), 1140.058f, 3533.135f, 33.9186f, 269f, joaat("a_m_m_salton_01"), Local_374) 
};
Local_259[4 /*29*/]={
func_394(joaat("sadler"), 1508.076f, 3372.604f, 36.6333f, 359.8644f, joaat("a_m_y_hippy_01"), Local_375) 
};
}
struct<29> func_394(int iParam0, struct<3> Param1, float fParam2, int iParam3, struct<3> Param4){
struct<29> Var0;
Var0.f_9=iParam0;
Var0.f_16={
Param1 
...
if(!bLocal_283){
if(!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), Local_384, 0, 1, 0) || INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) !=0){
if(!PED::IS_PED_FALLING(iLocal_348)){
bLocal_283=true;
}}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), Local_385, 0, 1, 0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==0){
...
int func_398(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
iVar0=0;
...
if(!iLocal_293){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_357, 50f, 50f, 50f, 0, 1, 0)){
func_401();
iLocal_293=1;
}}else{
PED::SET_SCENARIO_PED_DENSITY_MULTIPLIER_THIS_FRAME(0f, 0f);
...
if(!bLocal_283){
if(ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_357, 5f, 5f, 5f, 0, 1, 0) && func_400(1077936128, 1)){
VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_374, Local_375, 0, 1);
func_8(&iLocal_262);
func_391();
func_2();
func_357();
...
void func_401(){
PED::ADD_SCENARIO_BLOCKING_AREA(Local_401, Local_402, 0, 1, 1, 1);
...
OBJECT::SET_FORCE_OBJECT_THIS_FRAME(Local_359, fLocal_315);
OBJECT::SET_FORCE_OBJECT_THIS_FRAME(Local_360, fLocal_315);
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_361, Local_362, 7f, 1, 1, 0)){
if(iLocal_301[1]){
iLocal_290=0;
...
OBJECT::SET_FORCE_OBJECT_THIS_FRAME(Local_359, fLocal_315);
OBJECT::SET_FORCE_OBJECT_THIS_FRAME(Local_360, fLocal_315);
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_361, Local_362, 7f, 0, 1, 0)){
func_327();
func_410();
func_389();
if(!func_226() || MISC::GET_PROFILE_SETTING(203)==0){
...
if(!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && (ENTITY::IS_ENTITY_AT_COORD(iLocal_348, Local_368, 2f, 2f, 2f, 0, 1, 0) || iLocal_338 >=3)){
if(!bLocal_294){
if(iLocal_338 >=3){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_348, Local_368, 2f, 2f, 2f, 0, 1, 0)){
func_229(1);
}
iLocal_254=8;
}}else{
...
OBJECT::BREAK_OBJECT_FRAGMENT_CHILD(Local_258[iParam0 /*10*/], 1, 0);
}}}
...
Local_258[iVar0 /*10*/]=OBJECT::CREATE_OBJECT(iLocal_340, Local_258[iVar0 /*10*/].f_1, 1, 1, 0);
...
if(!ENTITY::IS_ENTITY_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), Local_384, 0, 1, 0)){
func_2();
func_320(1, 0);
func_325("HT_BKHTER");
}}else{
...
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), Local_385, 0, 1, 0)){
func_320(1, 0);
if(func_404("HT_BKHTER", 0, 0)){
HUD::CLEAR_PRINTS();
}
...
func_231(1);
MISC::CLEAR_AREA_OF_VEHICLES(Local_379, 2f, 0, 0, 0, 0, 0, 0, 0);
func_7();
iLocal_257=2;
}
break;
...
ENTITY::SET_ENTITY_COORDS(iLocal_426, 1806.732f, 3934.353f, 33.3275f, 1, 0, 0, 1);
...
void func_430(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
int iVar0;
iVar0=PLAYER::GET_PLAYER_INDEX();
...
void func_434(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
func_435(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}


void func_435(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
int iVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
int func_436(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
int func_437(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7){
float fVar0;
float fVar1;
float fVar2;
float fVar3;
...
uVar7=WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(func_263(iVar2, iVar6));
}}}
iVar6++;
}
...
WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_263(iVar2, iVar8));
func_442(uVar1, func_263(iVar2, iVar8));
}}
iVar8++;
}
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
...
}}elseif(func_314(iLocal_348) && func_314(PLAYER::PLAYER_PED_ID())){
...
PED::SET_PED_CONFIG_FLAG(iLocal_348, 169, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_348, 206, 1);
PED::SET_PED_CONFIG_FLAG(iLocal_348, 32, 0);
...
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_348, 1);
...
iLocal_274=1;
uLocal_337=WEAPON::GET_PED_AMMO_BY_TYPE(PLAYER::PLAYER_PED_ID(), joaat("AMMO_SNIPER"));
}}
...
void func_461(){
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() !=4){
if((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_397, Local_398, 16f, 0, 1, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_399, Local_400, 19f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_401, Local_402, 19f, 0, 1, 0)){
...
ENTITY::SET_ENTITY_COORDS(iLocal_348, Local_373, 1, 0, 0, 1);
...
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_348, Local_368, 1.5f, 1.5f, 1.5f, 0, 1, 0)){
TASK::CLEAR_PED_TASKS(iLocal_348);
...
ENTITY::SET_ENTITY_VISIBLE(iLocal_346, 0, 0);
}
func_360();
func_359();
func_8(&iLocal_263);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_348);
ENTITY::SET_ENTITY_COORDS(iLocal_348, Local_368, 1, 0, 0, 1);
...
if(func_415()){
iLocal_269=1;
}}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_361, Local_362, 7f, 0, 1, 0) && func_378()){
if(func_490()){
func_386();
...
func_495(0);
iLocal_299[0]=1;
}}elseif(func_334(&uLocal_89, cLocal_353, "HUNT1_DISH", "HUNT1_DISH_1", 7, 0, 0)){
iLocal_269=0;
func_495(0);
iLocal_299[0]=1;
}}elseif(!func_226()){
...
if(iLocal_333==-1){
iLocal_333=PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Local_395, Local_396, 0f, 0, 7);
}
func_386();
iLocal_301[9]=1;
func_229(0);
...
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_348);
ENTITY::SET_ENTITY_COORDS(iLocal_348, Local_369, 1, 0, 0, 1);
...
case 14:
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_348, joaat("script_task_follow_nav_mesh_to_coord"))==7){
if(ENTITY::IS_ENTITY_AT_COORD(iLocal_348, Local_369, 1.25f, 1.25f, 2.5f, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_363, Local_364, 10f, 0, 1, 0)){
if(func_490()){
...
elseif(iLocal_338==2 && !iLocal_299[1]){
...
iLocal_299[2]=1;
}elseif(iLocal_336 <=10 && func_377(&uLocal_89, cLocal_353, "HUNT1_TRY3", 7, 0, 0, 0)){
iLocal_299[2]=1;
}elseif(func_377(&uLocal_89, cLocal_353, "HUNT1_TYR4", 7, 0, 0, 0)){
iLocal_299[2]=1;
...
if(func_378()){
if(!func_226()){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_358, 1) > 10f){
...
break;
case 4:
if(TASK::GET_SCRIPT_TASK_STATUS(iLocal_348, joaat("script_task_follow_nav_mesh_to_coord"))==7 || (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_413, Local_414, 3.5f, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_348, Local_413, Local_414, 3.5f, 0, 1, 0))){
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
iLocal_255=18;
}
break;
...
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_348);
ENTITY::SET_ENTITY_COORDS(iLocal_348, Local_370, 1, 0, 0, 1);
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_413, Local_414, 3.5f, 0, 1, 0) || Var0.f_2 > 41f){
...
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(iLocal_348, 0);
iLocal_255=21;
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_348, joaat("script_task_turn_ped_to_face_entity")) !=1){
...
if(func_314(iLocal_348)){
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_348);
ENTITY::SET_ENTITY_COORDS(iLocal_348, Local_417, 1, 0, 0, 1);
...
TASK::CLEAR_PED_TASKS(iLocal_348);
TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(iLocal_348, 0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_351);
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_351);
TASK::TASK_PERFORM_SEQUENCE(iLocal_348, uLocal_351);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_351);
...
if(((ENTITY::IS_ENTITY_DEAD(iLocal_348, 0) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), 1)) || WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_348, 0, 2)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_348, 0), 10f)){
func_2();
iLocal_324=MISC::GET_GAME_TIMER() + 2400;
iLocal_280=1;
}}elseif(MISC::GET_GAME_TIMER() > iLocal_324){
...
iLocal_433=1;
}elseif(MISC::GET_GAME_TIMER() > iLocal_434){
if(func_378()){
...
iLocal_291=1;
}elseif(MISC::GET_GAME_TIMER() > iLocal_317){
if(!func_226()){
if(!iLocal_301[8]){
...
iLocal_297=1;
}}elseif(MISC::GET_GAME_TIMER() > iLocal_332){
...
iLocal_429=1;
}}elseif(MISC::GET_GAME_TIMER() > iLocal_430){
if(!func_226() && func_378()){
if(!iLocal_301[4]){
...
void func_480(){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_361, Local_362, 16f, 0, 1, 0)){
...
if(!iLocal_273){
uLocal_435=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_348, 1)){
if(!VEHICLE::ARE_ANY_VEHICLE_SEATS_FREE(uLocal_435)){
if(func_378()){
if(!func_226()){
...
}}elseif(!ENTITY::DOES_ENTITY_EXIST(iLocal_346)){
TASK::CLEAR_PED_TASKS(iLocal_348);
return 1;
}
return 0;
...
if(iLocal_269){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_348, Local_368, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !PED::IS_PED_HEADING_TOWARDS_POSITION(iLocal_348, Local_258[iLocal_335 /*10*/].f_1, 30f)){
...
break;
case 1:
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_348, Local_369, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_487(iLocal_348, fLocal_305, 30f)){
iLocal_328=1;
}
break;
case 2:
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_348, Local_372, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_487(iLocal_348, fLocal_313, 30f)){
iLocal_328=1;
}
break;
}
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_348, uVar0);
...
void func_497(){
if(!PED::IS_PED_INJURED(iLocal_348)){
if(((MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_348, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_348, 0) - Vector(2f, 2f, 2f), joaat("weapon_grenade"), 0) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_348, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_348, 0) - Vector(2f, 2f, 2f), joaat("weapon_stickybomb"), 0)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_348, 0) + Vector(2f, 2f, 2f), ENTITY::GET_ENTITY_COORDS(iLocal_348, 0) - Vector(2f, 2f, 2f), joaat("weapon_molotov"), 0)) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_348, 0), 10f)){
...
if(!bLocal_298){
if(PED::IS_PED_FALLING(iLocal_348)){
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_348, 0);
bLocal_298=true;
}}elseif(TASK::IS_PED_GETTING_UP(iLocal_348)){
ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_348, 1);
bLocal_298=false;
}}}
...
return 1;
}}elseif(((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) && PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_348, 30f)) && func_379(iLocal_348, PLAYER::PLAYER_PED_ID(), 1) <=2f){
return 1;
}}
return 0;
}
...
iLocal_346=OBJECT::CREATE_OBJECT(iLocal_342, ENTITY::GET_ENTITY_COORDS(iLocal_348, 1), 0, 0, 0);
}}elseif(!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(iLocal_346, iLocal_348)){
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_346, iLocal_348, PED::GET_PED_BONE_INDEX(iLocal_348, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
}}}


void func_501(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_503(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
void func_523(var uParam0, struct<3> Param1, float fParam2, int iParam3){
func_524(uParam0, iLocal_79, Param1, fParam2);
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
void func_524(var uParam0, int iParam1, struct<3> Param2, var uParam3){
func_525(uParam0);
...
int func_526(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_527(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
int func_527(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_160(iParam1)){
...
if(iLocal_293){
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_350, 0);
}
