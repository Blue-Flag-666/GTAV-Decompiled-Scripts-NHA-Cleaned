...
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(floor(Global_4542578));
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_4542299);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(floor(Global_4542578.f_1));
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_4542300);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(floor(Global_4542578.f_2));
func_8("CELL_BODYG");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_4542301);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(floor(Global_4542581));
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_4542302);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(floor(Global_4542581.f_1));
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_4542303);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(floor(Global_4542581.f_2));
}else{
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(0);
func_8("CELL_EXTBYOU");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_4542301);
