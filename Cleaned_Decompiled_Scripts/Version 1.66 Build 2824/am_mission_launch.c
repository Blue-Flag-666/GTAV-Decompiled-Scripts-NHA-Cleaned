...
if(((func_51(PLAYER::PLAYER_ID(), 1, 0) || func_48(PLAYER::PLAYER_ID())) || MISC::IS_BIT_SET(uLocal_93, 8)) || MISC::IS_BIT_SET(uLocal_93, 16)){
...
if(func_11(&(Local_85.f_12[0]), iVar1, Var2, uVar3, 1, 1, 1, 0, 1, 1, 0, 0, 0, 0)){
...
ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(NETWORK::NET_TO_PED(Local_85.f_9[0]), 1, 0);
ENTITY::SET_ENTITY_HEALTH(NETWORK::NET_TO_PED(Local_85.f_9[0]), round((200f * Global_262145.f_165)), 0);
Local_85.f_16=1;
}
}}}}}}
...
switch (iLocal_102){
case 0:
if(MISC::IS_BIT_SET(Local_85.f_4, iLocal_102)){
Var0={
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_20(PLAYER::PLAYER_ID()), Param0, 1) <=(fVar2 + fParam1)){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_20(iVar1), Param0, 1) <=(fVar2 + fParam1)){
...
bool func_25(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
if(MISC::IS_BIT_SET(uLocal_93, 1)){
Var2={
func_24(Local_85.f_5, bLocal_101) 
};
Var3={
ENTITY::GET_ENTITY_COORDS(uVar1, 0) 
};
fVar4=MISC::GET_DISTANCE_BETWEEN_COORDS(Var2, Var3, 1);
if(fVar4 < 300f){
MISC::CLEAR_BIT(&uLocal_93, true);
}}}}
iLocal_88++;
if(iLocal_88==Local_90.f_0){
if(MISC::IS_BIT_SET(uLocal_93, 1)){
MISC::SET_BIT(&(Local_85.f_4), bLocal_101);
}}}else{
return 1;
}}
return 0;
...
iLocal_87=0;
iLocal_100=0;
MISC::CLEAR_BIT(&uLocal_93, false);
...
bVar2=uVar3;
if(MISC::IS_BIT_SET(uLocal_93, 5)){
if(Local_90[iVar0 /*3*/].f_2 < 7){
MISC::CLEAR_BIT(&uLocal_93, 5);
}}
if(!MISC::IS_BIT_SET(Local_85.f_0, 0)){
if(MISC::IS_BIT_SET(Local_90[iVar0 /*3*/], 0)){
iLocal_100++;
}}elseif(MISC::IS_BIT_SET(Local_90[iVar0 /*3*/], 2)){
...
if(!MISC::IS_BIT_SET(Local_85.f_0, 4)){
if(MISC::IS_BIT_SET(Local_90[iVar0 /*3*/], 1)){
Local_85.f_8=uVar3;
...
if(!MISC::IS_BIT_SET(Local_85.f_0, 4)){
if(!MISC::IS_BIT_SET(Local_85.f_0, 18)){
if(MISC::IS_BIT_SET(Local_90[iVar0 /*3*/], 7)){
MISC::SET_BIT(&Local_85, 18);
}}}
if(MISC::IS_BIT_SET(uLocal_93, 9)){
if(MISC::IS_BIT_SET(Local_90[iVar0 /*3*/], 5)){
MISC::CLEAR_BIT(&uLocal_93, 9);
}}
if(!MISC::IS_BIT_SET(uLocal_93, 14)){
if(MISC::IS_BIT_SET(Local_90[iVar0 /*3*/], 6)){
MISC::SET_BIT(&uLocal_93, 14);
}}
if(!MISC::IS_BIT_SET(uLocal_93, 20)){
if(MISC::IS_BIT_SET(Local_90[iVar0 /*3*/], 8)){
...
if(func_40(Local_85.f_9[0])){
if(!MISC::IS_BIT_SET(Local_85.f_0, 4)){
if(MISC::IS_BIT_SET(uLocal_93, 15)){
if(!func_44(&uLocal_98)){
func_45(&uLocal_98, 0, 0);
}elseif(func_38(&uLocal_98, 2000, 0)){
MISC::SET_BIT(&Local_85, 16);
}}
}}}}
...
if(NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT()){
if(!MISC::IS_BIT_SET(Local_85.f_0, 7)){
if(MISC::IS_BIT_SET(Local_90[iParam0 /*3*/], 3)){
...
case 0:
if(MISC::IS_BIT_SET(Local_90[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/], 0)){
...
func_224(88, 1);
func_223();
}elseif(MISC::IS_BIT_SET(uLocal_93, 8)){
Local_90[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2=6;
}}elseif(func_213()){
Local_90[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2=5;
}else{
if(MISC::IS_BIT_SET(uLocal_93, 8)){
Local_90[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2=6;
}
if(MISC::IS_BIT_SET(Local_85.f_0, 15)){
func_200(12, 116);
...
if(!MISC::IS_BIT_SET(uLocal_93, 10)){
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Local_105.f_0, "FM_GDM_BLP");
...
if(!MISC::IS_BIT_SET(uLocal_93, 12)){
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Local_105.f_1, "FM_GDM_BLP");
MISC::SET_BIT(&uLocal_93, 12);
}}
if(!MISC::IS_BIT_SET(uLocal_93, 6)){
...
func_55();
MISC::CLEAR_BIT(&uLocal_93, 6);
}}elseif(MISC::IS_BIT_SET(uLocal_93, 6)){
func_55();
MISC::CLEAR_BIT(&uLocal_93, 6);
}
if(!MISC::IS_BIT_SET(Local_90[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/], 1)){
iVar1=NETWORK::NETWORK_GET_DESTROYER_OF_NETWORK_ID(Local_85.f_9[0], &uVar0);
if(iVar1==PLAYER::PLAYER_ID()){
MISC::SET_BIT(&(Local_90[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/]), true);
iVar2=func_184(func_186(PLAYER::PLAYER_ID(), 1), 1);
if(iVar2 > 100){
iVar2=100;
}
iVar3=iVar2 * 20;
iVar3=round((Global_262145.f_4239 * IntToFloat(iVar3)));
func_140(2, "XPT_KAIE", -1859646258, 2131309714, iVar3, 1, -1, 0);
if(Global_262145.f_2433 !=0f){
iVar4=round(Global_262145.f_2433);
}else{
iVar4=2000;
}
if(Global_262145.f_2429 !=0f){
iVar5=round(Global_262145.f_2429);
}else{
iVar5=8000;
}
if(iVar4 >=100){
...
if(!MISC::IS_BIT_SET(Local_90[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/], 7)){
...
if(((func_354(PLAYER::PLAYER_ID()) || (func_128() && func_127())) && !MISC::IS_BIT_SET(Global_2793046.f_4690, 31)) && !bParam4){
uVar1=func_126();
...
if(bVar3){
iVar6=round((func_166(*iParam0, 100) * (10f * Global_262145.f_4228)));
}
if(iVar2 > 4){
iVar2=4;
}
if(iVar2 >=2){
iVar7=round((func_166(*iParam0, 100) * (20f * Global_262145.f_4221)));
}
...
if(bVar2){
iVar5=round((func_166(*iParam1, 100) * (10f * Global_262145.f_4228)));
}
if(iVar1 > 4){
iVar1=4;
}
if(iVar1 >=1){
iVar6=round((func_166(*iParam1, 100) * (20f * Global_262145.f_4221)));
}
...
iVar0=round((func_166(*iParam0, 100) * 25f));
*iParam0=(*iParam0 + iVar0);
return *iParam0;
}
...
func_206(1);
func_210(Global_20364, "DISPLAY_VIEW", 1f, to_float(Global_20363), -1082130432, -1082130432, -1082130432);
}}}
...
if(Global_2694521){
if(iVar1==14){
func_207(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(Global_22788), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}}
Global_8822[iVar0]=1;
}}}
iVar1++;
...
func_207(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(Global_22793), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}elseif(iVar1==7){
if(Global_78558){
iVar4=0;
...
func_207(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(iVar4), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}else{
switch (Global_20383){
case 0:
iVar6=Global_44457;
...
func_207(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(iVar6), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}}elseif(iVar1==14){
func_207(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(Global_22788), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}elseif(iVar1==20){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_20364, "SET_DATA_SLOT");
...
func_207(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(iVar9), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}else{
func_207(Global_20364, "SET_DATA_SLOT", to_float(1), to_float(iVar0), to_float(Global_8260[iVar1 /*15*/].f_10), to_float(0), -1f, &(Global_8260[iVar1 /*15*/]), 0, 0, 0, 0);
}
Global_8822[iVar0]=1;
}}}
iVar1++;
...
int func_213(){
if(!MISC::IS_BIT_SET(uLocal_93, 17)){
func_215(12, 116, "", 1, 0, 1, 0);
MISC::SET_BIT(&uLocal_93, 17);
}elseif(!MISC::IS_BIT_SET(uLocal_93, 18)){
if(func_214(12, 116)){
...
var uVar0;
uVar0=Global_2849801[iParam0 /*3*/][func_160(iParam1)];
...
if(iVar1 !=-1){
Var0={
Global_794709.f_183637[Global_794709.f_159989[iVar1 /*13*/].f_10 /*6*/] 
};
}
...
int func_226(){
if(!MISC::IS_BIT_SET(uLocal_93, 4)){
if(!MISC::IS_BIT_SET(uLocal_93, 8) || (MISC::IS_BIT_SET(uLocal_93, 8) && func_38(&uLocal_96, 600000, 0))){
if(func_232(Local_85.f_5)){
MISC::SET_BIT(&uLocal_93, 4);
MISC::CLEAR_BIT(&uLocal_93, 8);
}}}elseif(!func_231()){
if(!MISC::IS_BIT_SET(uLocal_93, 19)){
if(func_230()){
...
int func_289(struct<6> Param0, struct<6> Param1){
struct<4> Var0;
struct<4> Var1;
int iVar2;
int iVar3;
...
if(!MISC::IS_BIT_SET(uLocal_93, 11)){
switch (iParam0){
case 0:
sLocal_277="FMA_KIL1";
...
void func_359(struct<2> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, int iParam13){
...
if(!MISC::IS_BIT_SET(Local_90[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/], 6)){
if(func_366(Local_85.f_5)){
MISC::SET_BIT(&(Local_90[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/]), 6);
}}
if(!MISC::IS_BIT_SET(Local_90[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/], 8)){
if(func_365()){
MISC::SET_BIT(&(Local_90[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/]), 8);
}}}
if(!MISC::IS_BIT_SET(uLocal_93, 13)){
if(NETWORK::NETWORK_DOES_ENTITY_EXIST_WITH_NETWORK_ID(Local_85.f_9[0])){
if(!func_40(Local_85.f_9[0])){
ENTITY::SET_ENTITY_IS_TARGET_PRIORITY(NETWORK::NET_TO_PED(Local_85.f_9[0]), 1, 0);
...
if(!func_40(Local_85.f_9[0])){
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(NETWORK::NET_TO_PED(Local_85.f_9[0]), 1)) < 40000f){
return 1;
}}}}
break;
}
...
func_353(11, 0);
func_200(12, 116);
MISC::CLEAR_BIT(&(Global_2672505.f_3561), false);
MISC::CLEAR_BIT(&(Global_2672505.f_3561), true);
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
...
MISC::SET_BIT(&(Global_2672505.f_3561), false);
MISC::CLEAR_BIT(&(Global_2672505.f_3561), true);
}
...
void func_397(var uParam0, struct<17> Param1, var uParam2, var uParam3, var uParam4, var uParam5){
if(!NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
func_383();
}
