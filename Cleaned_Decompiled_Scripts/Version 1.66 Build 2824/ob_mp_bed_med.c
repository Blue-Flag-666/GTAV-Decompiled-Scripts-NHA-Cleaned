...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_334, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) < 3f){
switch (iLocal_322){
case 0:
if(func_65()){
iLocal_322=1;
...
func_2();
if(MISC::IS_BIT_SET(uLocal_321, 0)){
func_1();
}
}
break;
case 2:
break;
}}elseif(MISC::GET_DISTANCE_BETWEEN_COORDS(Local_334, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 1) > 6f){
func_83();
}}else{
func_83();
}}}
...
void func_1(){
uLocal_328=NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(uLocal_327);
switch (iLocal_323){
case 0:
break;
case 1:
...
uLocal_327=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_338, Local_339, 2, 0, 1, 1065353216, 0, 1065353216);
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_327, sLocal_330, sLocal_332, 8f, -2f, 261, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uLocal_327);
iLocal_323=7;
}elseif(func_54(9)){
if((((func_50(Local_334, Var0) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==INTERIOR::GET_INTERIOR_AT_COORDS(Local_334)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_336, Local_337, 2f, 0, 1, 0)) && func_49()) && !func_46(PLAYER::PLAYER_ID())){
if(iLocal_329==-1){
...
if(func_44(1, 0, 1)){
if((((((func_50(Local_334, Var0) && Local_340.f_2 < (Local_334.f_2 + 1f)) && func_54(9)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())==INTERIOR::GET_INTERIOR_AT_COORDS(Local_334)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_336, Local_337, 2f, 0, 1, 0)) && func_49()) && !func_46(PLAYER::PLAYER_ID())){
...
Local_334={
PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_330, sLocal_331, Local_338, Local_339, 0, 2) 
};
Var1={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_330, sLocal_331, Local_338, Local_339, 0, 2) 
};
fLocal_335=Var1.f_2;
...
MISC::CLEAR_BIT(&uLocal_321, 0);
uLocal_327=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_338, Local_339, 2, 0, 0, 1065353216, 0, 1065353216);
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_327, sLocal_330, sLocal_331, 4f, -2f, 261, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uLocal_327);
if(CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==4){
iLocal_326=1;
}
...
MISC::CLEAR_BIT(&uLocal_321, 0);
uLocal_327=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_338, Local_339, 2, 0, 0, 1065353216, 0, 1065353216);
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_327, sLocal_330, sLocal_333, 2f, -2f, 261, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uLocal_327);
iLocal_323=8;
}
break;
...
MISC::CLEAR_BIT(&uLocal_321, 0);
uLocal_327=NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_338, Local_339, 2, 0, 0, 1065353216, 0, 1065353216);
NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_327, sLocal_330, sLocal_333, 1000f, -2f, 261, 0, 1148846080, 0);
NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uLocal_327);
iLocal_323=8;
}
break;
...
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(uVar0[iVar2], Local_336, Local_337, 2f, 0, 1, 0)){
return 0;
}}
iVar2++;
}}
...
int func_50(struct<3> Param0, float fParam1, var uParam2, var uParam3){
...
if(func_51(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Param0, fParam1, 0)){
return 1;
}}}}}
return 0;
}

int func_51(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3){
if(fParam2 < 0f){
fParam2=0f;
}
if(!bParam3){
