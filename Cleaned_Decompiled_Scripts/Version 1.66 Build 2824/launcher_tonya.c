...
MISC::CLEAR_AREA(Local_52, 5f, 1, 0, 0, 0);
while (true){
wait(0);
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
fVar0=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_52);
...
TASK::TASK_PERFORM_SEQUENCE(uParam0->f_28[0], uLocal_54);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_54);
}
}
elseif(*uParam0==59){
...
case 2:
if(func_196(&uLocal_223)){
if(func_190(&uLocal_223) > MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 15f)){
iLocal_226++;
switch (iLocal_226){
case 1:
if(*uParam0==58){
...
float func_215(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
Var0={
...
uLocal_53=PED::ADD_SCENARIO_BLOCKING_AREA(Local_52 - Vector(10f, 10f, 10f), Local_52 + Vector(10f, 10f, 10f), 0, 1, 1, 1);
iLocal_55=1;
