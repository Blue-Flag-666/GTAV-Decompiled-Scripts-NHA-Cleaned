...
TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, iLocal_53, iLocal_53, 1f, 0, 3f, 1082130432, 1, 0, joaat("FIRING_PATTERN_FULL_AUTO"));
...
Var1={
0f, 0f, (ENTITY::GET_ENTITY_HEADING(iLocal_53) * 3f) 
};
...
VEHICLE::SET_VEHICLE_WILL_FORCE_OTHER_VEHICLES_TO_STOP(iLocal_55, 1);
...
if(VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_53, iLocal_55, 2, 0, 0)){
if(!PED::IS_PED_INJURED(iLocal_53)){
...
elseif(PED::IS_PED_FACING_PED(iLocal_54, iLocal_53, 180f)){
Local_283={
-2.978f, -0.75f, 1f 
};
}
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_67);
TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_55, Local_283), iLocal_53, 0.75f, 0, 0.5f, 4f, 1, 0, 0, joaat("FIRING_PATTERN_FULL_AUTO"), 60000);
TASK::TASK_AIM_GUN_AT_ENTITY(0, iLocal_53, -1, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_67);
TASK::TASK_PERFORM_SEQUENCE(iLocal_52, uLocal_67);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_67);
...
TASK::CLEAR_PED_TASKS(iLocal_53);
iLocal_62=1;
}}elseif(!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_53, sLocal_250, "kneeling_arrest_get_up", 3)){
if(func_72(iLocal_52, iLocal_55)==2){
Local_283={
1.578f, -0.5f, 1f 
};
...
func_177();
}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_52, joaat("script_task_enter_vehicle"))==7){
TASK::CLEAR_PED_TASKS(iLocal_52);
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_67);
iLocal_254=1;
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_53, sLocal_251, "enter", 3)){
if(func_5()){
func_74(&uLocal_72, "REARRAU", "REARR_PRAND", 4, iLocal_246, 0, 0);
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_53, sLocal_251, "exit", 3)){}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_53, sLocal_251, sLocal_252, 3)){
...
TASK::CLEAR_SEQUENCE_TASK(&uLocal_67);
iLocal_254=1;
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_52, sLocal_250, "radio_chatter", 3)){
if(func_5()){
func_74(&uLocal_72, "REARRAU", "REARR_PRAD3", 4, iLocal_246, 0, 0);
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_52, sLocal_250, "radio_exit", 3)){
iLocal_255=0;
func_8();
}}
...
iLocal_241=6;
}}elseif(TASK::GET_SCRIPT_TASK_STATUS(iLocal_53, joaat("script_task_perform_sequence"))==7){
TASK::OPEN_SEQUENCE_TASK(&uLocal_67);
TASK::TASK_LOOK_AT_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_52, 0), 1000, 0, 2);
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_52, 0), 2f, -1, 3f, 0, 1193033728);
TASK::CLOSE_SEQUENCE_TASK(uLocal_67);
...
iLocal_241=4;
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_53, PLAYER::PLAYER_PED_ID(), 75f, 75f, 75f, 0, 1, 0)){
if(!func_89()){
TASK::CLEAR_PED_TASKS(iLocal_53);
TASK::OPEN_SEQUENCE_TASK(&uLocal_67);
...
PED::SET_PED_KEEP_TASK(iLocal_53, 1);
}elseif(!PED::IS_PED_IN_ANY_VEHICLE(iLocal_53, 0) && !PED::IS_PED_RAGDOLL(iLocal_53)){
TASK::CLEAR_PED_TASKS(iLocal_53);
TASK::TASK_COWER(iLocal_53, -1);
PED::SET_PED_KEEP_TASK(iLocal_53, 1);
}
...
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_53, 40f, 40f, 40f, 0, 1, 0)){
func_58();
wait(0);
...
if(PED::IS_PED_INJURED(iLocal_53)){
return 1;
}elseif(!MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_53, 31086, 0f, 0f, 0f), 2f, 1)){
return 1;
}}
...
Var0={
Var0 + PED::GET_PED_BONE_COORDS(iLocal_52, 31086, 0f, 0f, 0f) 
};
Var1={
Var1 + PED::GET_PED_BONE_COORDS(iLocal_52, 31086, 0f, 0f, 0f) 
};
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_53, uLocal_67);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_67);
PED::FORCE_PED_MOTION_STATE(iLocal_53, joaat("MotionState_Run"), 0, 0, 0);
PED::SET_PED_KEEP_TASK(iLocal_53, 1);
}
else{
TASK::CLEAR_PED_TASKS(iLocal_53);
...
if(bLocal_68){
if(iLocal_50 !=7){
if(vdist(ENTITY::GET_ENTITY_COORDS(iLocal_53, 1), Local_64) > 2.5f){
return 1;
}}else{
return 1;
}}else{
...
func_74(&uLocal_72, "REARRAU", "REARR_PRAND", 4, iLocal_246, 0, 0);
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_53, 10f, 10f, 10f, 0, 1, 0)){
func_74(&uLocal_72, "REARRAU", sLocal_260, 4, iLocal_246, 0, 0);
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_52, 10f, 10f, 10f, 0, 1, 0)){
func_74(&uLocal_72, "REARRAU", sLocal_260, 4, iLocal_246, 0, 0);
}else{
func_74(&uLocal_72, "REARRAU", sLocal_264, 4, iLocal_246, 0, 0);
}
...
int func_90(){
if(ENTITY::IS_ENTITY_AT_ENTITY(iLocal_53, iLocal_52, 3.5f, 3.5f, 3.5f, 0, 1, 0) || func_93()){
...
WEAPON::SET_CURRENT_PED_WEAPON(iLocal_52, joaat("weapon_pistol"), 1);
uLocal_58=OBJECT::CREATE_OBJECT(joaat("prop_ld_binbag_01"), Local_63.f_0, Local_63.f_1, (Local_63.f_2 + 100f), 1, 1, 0);
...
if(vmag2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_123()){
return 0;
}}
