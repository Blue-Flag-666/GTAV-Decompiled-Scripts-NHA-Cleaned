...
iLocal_59=MISC::IS_BIT_SET(Global_8254, 28);
if(iLocal_48 !=-1){
if(fVar0 < fLocal_46){
Var1={
Local_55 
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_24(iParam0));
if(iVar11 > iVar10){
...
int func_98(struct<3> Param0, float fParam1, float fParam2){
float fVar0;
float fVar1;
...
void func_99(struct<3> Param0, struct<3> Param1, struct<3> Param2, float fParam3, float fParam4){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
...
fVar7=(fVar4 / 2f);
Var8={
func_101(func_102(Var2, 0f, 0f, -1f)) 
};
Var9={
func_101(func_102(Var2, Var8)) 
};
*uParam1={
...
return Global_113648.f_10051.f_135[iVar0]==(round(pow(2f, to_float(iVar1 + 1))) - 1);
}
...
if(!func_113()){
uLocal_57=GRAPHICS::REQUEST_SCALEFORM_MOVIE("MIDSIZED_MESSAGE");
...
void func_116(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3, float fParam4){
Local_54[iParam0 /*8*/]={
Param1 
};
Local_54[iParam0 /*8*/].f_3={
