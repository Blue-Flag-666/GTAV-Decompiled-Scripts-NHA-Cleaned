...
int func_189(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7){
var uVar0;
...
float func_193(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
if(!ENTITY::IS_ENTITY_DEAD(iParam0, 0)){
Var0={
...
int func_217(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5){
var uVar0;
struct<3> Var1;
var uVar2;
int iVar3;
...
int func_229(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
...
iLocal_58=WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_sniperrifle"), 0, Local_57, 0, 1065353216, 0, 0, 1);
...
if(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_57, 1f, iLocal_54, 0)){
...
void func_242(var uParam0, struct<3> Param1, float fParam2, int iParam3){
func_243(uParam0, iLocal_53, Param1, fParam2);
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
...
void func_243(var uParam0, int iParam1, struct<3> Param2, var uParam3){
func_244(uParam0);
