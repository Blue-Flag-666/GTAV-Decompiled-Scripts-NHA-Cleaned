...
iLocal_105=-1;
iLocal_106=-1;
sLocal_107=PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2, 195, 1);
...
uLocal_112=GRAPHICS::REQUEST_SCALEFORM_MOVIE("instructional_buttons");
}}else{
...
if(CAM::IS_CAM_ACTIVE(uLocal_68)){
return 0;
}}
return 1;
}
...
Global_112696=0;
CAM::SET_CAM_ACTIVE(uLocal_68, 0);
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
...
iLocal_57=1;
iLocal_823=5;
}elseif(func_160(iLocal_89, 2500)){
iLocal_823=5;
}
break;
case 5:
...
iLocal_823=6;
}elseif(func_160(iLocal_89, 20000)){
if(iLocal_815 !=-1){
STREAMING::NEW_LOAD_SCENE_STOP();
iLocal_57=0;
func_106(iLocal_815);
...
if(bVar1){
if(((func_55()==0 && !MISC::IS_BIT_SET(Global_91469[iLocal_815 /*34*/].f_15, 8)) || (func_55()==1 && !MISC::IS_BIT_SET(Global_91469[iLocal_815 /*34*/].f_15, 9))) || (func_55()==2 && !MISC::IS_BIT_SET(Global_91469[iLocal_815 /*34*/].f_15, 10))){
bVar1=false;
}}
if(bVar1){
...
fVar1=MISC::GET_DISTANCE_BETWEEN_COORDS(Global_112686, Var0, 1);
if(fVar1 < 100f){
Var0={
func_82(Global_112686 - Var0) 
};
Var0={
(Global_112686 + (Var0.f_0 * IntToFloat((100 - round(fVar1))))), (Global_112686.f_1 + (Var0.f_1 * IntToFloat((100 - round(fVar1))))), Global_112686.f_2 
};
...
float fVar0;
int iVar1;
fVar0=(((func_119(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Global_112686) / 50f) * fLocal_73) * 2.4f);
...
void func_121(){
iLocal_103=(iLocal_103 + round((MISC::GET_FRAME_TIME() * 1000f)));
if(iLocal_103 > 5000){
fLocal_82=(fLocal_82 + fLocal_73);
iLocal_103=0;
}
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Local_833, 0) > 50f){
fLocal_82=(fLocal_82 + fLocal_73);
iLocal_103=0;
Local_833={
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_111, "SET_TAXI_PRICE");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_101);
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
fLocal_83=vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), Global_112686);
...
if(func_125(&Global_112679, ENTITY::GET_ENTITY_COORDS(Global_112679, 0), Local_829, uParam1, uParam2, &iLocal_88, iParam0, 1000)){
iLocal_820=3;
return 0;
}else{
return 0;
...
Var3={
HUD::GET_BLIP_COORDS(Global_32543[Global_97614[iVar4 /*17*/].f_9 /*23*/].f_19) 
};
if(uParam0->f_2==1f){
Var3.f_2=1f;
}
...
uVar1=ENTITY::GET_ENTITY_HEADING(Global_112679);
TASK::TASK_VEHICLE_PARK(Global_112680, Global_112679, Var0, uVar1, 3, 60f, 0);
}}}}
...
bLocal_65=true;
iLocal_822=2;
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_enter", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_idle", 3)){
if(PED::IS_PED_HEADTRACKING_PED(Global_112680, PLAYER::PLAYER_PED_ID())){
TASK::TASK_CLEAR_LOOK_AT(Global_112680);
}
TASK::TASK_PLAY_ANIM(Global_112680, &cLocal_824, "leanover_exit", 4f, -4f, -1, 0, 0, 0, 0, 0);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_exit", 3)){
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_813);
TASK::TASK_VEHICLE_DRIVE_TO_COORD_LONGRANGE(0, Global_112679, Global_112686, fVar1, iVar0, 45f);
TASK::TASK_VEHICLE_PARK(0, Global_112679, Global_112686, Global_112692, iLocal_110, 60f, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_813);
TASK::TASK_PERFORM_SEQUENCE(Global_112680, uLocal_813);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_813);
}}}}}}}
...
int func_172(){
if((ENTITY::IS_ENTITY_AT_COORD(Global_112679, Global_112686, 45f, 45f, 20f, 0, 1, 0) || iLocal_56) || iLocal_821==4){
iLocal_56=1;
...
TASK::OPEN_SEQUENCE_TASK(&uLocal_813);
TASK::TASK_PLAY_ANIM(0, &cLocal_824, "leanover_enter", 4f, -8f, -1, 0, 0, 0, 0, 0);
TASK::TASK_PLAY_ANIM(0, &cLocal_824, "leanover_idle", 4f, -8f, -1, 1, 0, 0, 0, 0);
TASK::CLOSE_SEQUENCE_TASK(uLocal_813);
TASK::TASK_PERFORM_SEQUENCE(Global_112680, uLocal_813);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_813);
return 1;
...
if(ENTITY::DOES_ENTITY_EXIST(Global_112679)){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
iLocal_109=OBJECT::CREATE_OBJECT(iLocal_108, ENTITY::GET_ENTITY_COORDS(Global_112679, 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_109, Global_112679, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(Global_112679, "Chassis"), Local_837, Local_838, 0, 0, 0, 0, 2, 1, 0);
...
uLocal_93=HUD::GET_NAMED_RENDERTARGET_RENDER_ID("taxi");
}}
return 0;
}
...
uLocal_111=GRAPHICS::REQUEST_SCALEFORM_MOVIE("taxi_display");
uLocal_112=GRAPHICS::REQUEST_SCALEFORM_MOVIE("instructional_buttons");
STREAMING::REQUEST_ANIM_DICT(&cLocal_824);
if(((STREAMING::HAS_MODEL_LOADED(iLocal_108) && GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_111)) && GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_112)) && STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_824)){
return 1;
}
return 0;
}
...
uLocal_68=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 0);
CAM::ATTACH_CAM_TO_ENTITY(uLocal_68, Global_112679, Local_835, 1);
func_182();
CAM::SET_CAM_CONTROLS_MINI_MAP_HEADING(uLocal_68, 1);
}}elseif(!bLocal_60 || bLocal_59){
if(!func_186() && !func_185(8, -1)){
if(!CAM::IS_CAM_ACTIVE(uLocal_68)){
func_181(4, 1, -1);
CAM::SET_CAM_CONTROLS_MINI_MAP_HEADING(uLocal_68, 1);
func_180();
CAM::SET_CAM_ACTIVE(uLocal_68, 1);
...
}}elseif(CAM::IS_CAM_ACTIVE(uLocal_68)){
CAM::SET_CAM_ACTIVE(uLocal_68, 0);
CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
...
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_111, "HIGHLIGHT_DESTINATION");
...
CAM::SET_CAM_FOV(uLocal_68, fLocal_74);
CAM::SET_CAM_NEAR_CLIP(uLocal_68, 0.01f);
CAM::SET_CAM_IS_INSIDE_VEHICLE(uLocal_68, 1);
...
uVar3=Var0.f_1;
Var4={
func_82(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_112679, Param2) - ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_112679, Local_835)) 
};
...
iVar0=0;
func_192();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_111, "CLEAR_TAXI_DISPLAY");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
iVar0=0;
while (iVar0 < iLocal_91){
if(!HUD::DOES_BLIP_EXIST(Local_819[iVar0 /*3*/])){
}elseif(func_127(Local_819[iVar0 /*3*/])==-1){
}elseif(func_131(HUD::GET_BLIP_COORDS(Local_819[iVar0 /*3*/]), 0f, 0f, 0f, 1056964608, 0)){
}else{
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_111, "ADD_TAXI_DESTINATION");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(HUD::GET_BLIP_SPRITE(Local_819[bVar0 /*3*/]));
HUD::GET_HUD_COLOUR(HUD::GET_BLIP_HUD_COLOUR(Local_819[bVar0 /*3*/]), &iVar1, &iVar2, &iVar3, &uVar4);
...
HUD::ADD_TEXT_COMPONENT_SUBSTRING_BLIP_NAME(Local_819[bVar0 /*3*/]);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}else{
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
...
if(HUD::GET_BLIP_INFO_ID_TYPE(Local_819[bVar0 /*3*/])==2){
if(!PED::IS_PED_INJURED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(Local_819[bVar0 /*3*/])))){
Var5={
ENTITY::GET_ENTITY_COORDS(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(Local_819[bVar0 /*3*/])), 1) 
};
}}elseif(HUD::GET_BLIP_INFO_ID_TYPE(Local_819[bVar0 /*3*/])==1){
if(VEHICLE::IS_VEHICLE_DRIVEABLE(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(Local_819[bVar0 /*3*/]), 0)){
Var5={
ENTITY::GET_ENTITY_COORDS(HUD::GET_BLIP_INFO_ID_ENTITY_INDEX(Local_819[bVar0 /*3*/]), 1) 
};
}}else{
Var5={
HUD::GET_BLIP_COORDS(Local_819[bVar0 /*3*/]) 
};
}
...
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL_HASH_KEY(Local_819[bVar0 /*3*/].f_1);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}}else{
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRTNM2");
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL_HASH_KEY(Local_819[bVar0 /*3*/].f_1);
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL_HASH_KEY(Local_819[bVar0 /*3*/].f_2);
GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
if(bLocal_60){
...
if(bLocal_60){
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_111, "SHOW_TAXI_DESTINATION");
GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_111, "HIGHLIGHT_DESTINATION");
...
iLocal_97=iParam1;
Local_834={
HUD::GET_BLIP_COORDS(Local_819[iParam1 /*3*/]) 
};
}}
...
var uVar2;
bVar0=false;
if(!HUD::DOES_BLIP_EXIST(Local_819[bLocal_92 /*3*/])){
...
Var1={
HUD::GET_BLIP_COORDS(Local_819[iLocal_97 /*3*/]) 
};
...
void func_212(){
if(iLocal_821 !=0){
HUD::SET_TEXT_RENDER_ID(uLocal_93);
GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(4);
GRAPHICS::SET_SCRIPT_GFX_DRAW_BEHIND_PAUSEMENU(1);
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Global_112679, 0)){
GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_111, fLocal_86, fLocal_87, fLocal_84, fLocal_85, 0, 0, 0, 255, 0);
}}}
...
void func_215(){
struct<3> Var0;
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_111, "SET_INPUT_EVENT");
...
if(HUD::DOES_BLIP_EXIST(Local_819[bLocal_92 /*3*/])){
Var0={
HUD::GET_BLIP_COORDS(Local_819[bLocal_92 /*3*/]) 
};
if(!func_216(Var0)){
HUD::LOCK_MINIMAP_POSITION(Var0.f_0, Var0.f_1);
}}}
...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_824, "leanover_idle", 3)){
