...
StringCopy(&Local_184, "CELL_249", 16);
StringCopy(&Local_187, "CELL_206", 16);
StringCopy(&Local_190, "CELL_212", 16);
StringCopy(&Local_193, "CELL_213", 16);
...
iLocal_220=1;
}}elseif(func_177(2, Global_20352) && !bLocal_203){
func_3();
}}
...
func_125();
if((iLocal_180==1 && uLocal_213[iLocal_209]==0) || ((iLocal_180==1 && uLocal_213[iLocal_209]==1) && !Global_262145.f_4707)){
if(iLocal_210==0 && bLocal_205){
func_124();
func_121(0, 32);
}elseif(iLocal_210==2 || (iLocal_210==1 && bLocal_205==0)){
func_120();
}}elseif(iLocal_210==0 && bLocal_205){
func_124();
func_121(0, 32);
}
...
func_142(1);
func_141(0);
}elseif(Global_262145.f_4705==0 && iLocal_206==0){
...
void func_85(struct<3> Param0, var uParam1){
int iVar0;
int iVar1;
iVar0=1;
iVar1=7;
...
int func_86(struct<3> Param0, int iParam1, float fParam2){
int iVar0;
struct<3> Var1[3];
struct<3> Var2[3];
int iVar3;
...
void func_105(struct<67> Param0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19){
struct<3> Var0;
int iVar1;
if(iParam19 < 0){
return;
...
iVar0=0;
while (iVar0 < 32){
Global_2684801.f_3894.f_1[iVar0 /*13*/]={
Var1 
};
iVar0++;
}
Global_2684801.f_3894.f_1[0 /*13*/]={
func_111(PLAYER::PLAYER_ID()) 
};
...
if((NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar2) && iVar2 !=PLAYER::PLAYER_ID()) && Global_2684801.f_3894 < iParam1){
Var1={
func_111(iVar2) 
};
if((iParam0 || NETWORK::NETWORK_IS_FRIEND(&Var1)) && iVar0 < 32){
if(iParam0 || func_122(iVar2)){
Global_2684801.f_3894.f_1[Global_2684801.f_3894 /*13*/]={
Var1 
};
...
if(MISC::IS_BIT_SET(Global_2684801.f_1.f_2809, 0)){
...
if(func_184(1)){
StringCopy(&Local_196, "PHINVQUITBBB", 24);
}else{
StringCopy(&Local_196, "PHINVQUITBB", 24);
}
bVar0=true;
}elseif(func_183(PLAYER::PLAYER_ID())){
StringCopy(&Local_196, "PHINVQUITB", 24);
bVar0=true;
}
if(func_180()){
StringCopy(&Local_196, "PHINVQUIT", 24);
bVar0=true;
}
if(bVar0){}
...
bVar1=true;
if((iLocal_180==1 && uLocal_213[iLocal_209]==0) && !Global_262145.f_4707){
if(bLocal_205){
...
bVar1=false;
}elseif((iLocal_180==1 && uLocal_213[iLocal_209]==3) && !func_198()){
GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("PIM_DMAGUT");
HUD::ADD_TEXT_COMPONENT_SUBSTRING_TIME((func_199(joaat("mpply_h4_cooldown")) - NETWORK::GET_CLOUD_TIME_AS_INT()) * 1000, 14);
bVar1=false;
}elseif(iLocal_180==2 && (uLocal_214[iLocal_209]==4 || uLocal_214[iLocal_209]==3)){
...
if(!MISC::IS_BIT_SET(Global_2793046.f_1839, 30)){
func_179("CH_QM_PHONEN", -1);
MISC::SET_BIT(&(Global_2793046.f_1839), 30);
}}elseif(uLocal_213[iLocal_209]==3 && !func_198()){
if(!MISC::IS_BIT_SET(Global_2793046.f_1839, 31)){
func_179("IH_QM_PHONEN", -1);
MISC::SET_BIT(&(Global_2793046.f_1839), 31);
}}elseif(uLocal_213[iLocal_209]==0 && !Global_262145.f_4707){
func_195(&cLocal_181);
}}
if(bVar1){
func_192(13, &Local_190, 1, "", 4, &Local_187, &uLocal_224);
}else{
func_192(1, "", 1, "", 4, &Local_187, &uLocal_224);
}}
...
if(iParam1==1){
func_208(Global_20364, "SET_SOFT_KEYS", to_float(iParam0), 0f, to_float(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
MISC::CLEAR_BIT(uParam4, iParam3);
func_194(iParam5, 0);
return;
}
if(Global_20371){
func_208(Global_20364, "SET_SOFT_KEYS", to_float(iParam0), 1f, to_float(iParam1), -1f, -1f, sParam2, 0, 0, 0, 0);
MISC::SET_BIT(uParam4, iParam3);
func_194(iParam5, 1);
return;
}
func_208(Global_20364, "SET_SOFT_KEYS", to_float(iParam0), 1f, to_float(iParam1), -1f, -1f, 0, 0, 0, 0, 0);
MISC::SET_BIT(uParam4, iParam3);
func_194(iParam5, 1);
}
...
uLocal_221=GRAPHICS::END_SCALEFORM_MOVIE_METHOD_RETURN_VALUE();
while (!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_221)){
wait(0);
}
iLocal_210=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_221);
iLocal_179=3;
Global_20383.f_1=8;
...
bLocal_203=false;
}}elseif(func_239(2, Global_20352, 0) && !bLocal_203){
Global_20361=1;
func_190();
}}
...
func_209(Global_20364, "SET_DATA_SLOT_EMPTY", to_float(13), -1082130432, -1082130432, -1082130432, -1082130432);
func_208(Global_20364, "SET_DATA_SLOT", to_float(13), to_float(0), to_float(12), -1f, -1f, &Local_184, 0, 0, 0, 0);
func_209(Global_20364, "DISPLAY_VIEW", to_float(13), -1082130432, -1082130432, -1082130432, -1082130432);
func_192(13, &Local_190, 1, "", 14, &Local_193, &uLocal_224);
}
...
void func_230(){
func_209(Global_20364, "SET_INPUT_EVENT", to_float(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_232(){
func_209(Global_20364, "SET_INPUT_EVENT", to_float(1), -1082130432, -1082130432, -1082130432, -1082130432);
AUDIO::PLAY_SOUND_FRONTEND(-1, "Menu_Navigate", &Global_20372, 1);
func_233();
}
...
iLocal_209=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_221);
switch (iLocal_180){
case 0:
iVar0=16;
break;
...
if(iParam0==0 && (Global_262145.f_4705==1 || iLocal_206==1)){
return 0;
}
return 1;
}
...
iLocal_208=GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(uLocal_221);
...
int func_263(){
if(func_265(935, &(Local_207.f_1), &(Local_207.f_2), &(Local_207.f_4), &(Global_2684801.f_1.f_2807))){
if(Local_207.f_4){
return 1;
}else{
if(Local_207.f_3 > 2){
...
iVar23=0;
while (iVar23 <=31){
Global_2684801.f_1.f_845[iVar23 /*57*/]={
Var12 
};
Global_2684801.f_1.f_845[iVar23 /*57*/].f_13={
Var13 
};
StringCopy(&(Global_2684801.f_1.f_845[iVar23 /*57*/].f_29), "", 16);
Global_2684801.f_1.f_845[iVar23 /*57*/].f_44=uVar16;
Global_2684801.f_1.f_845[iVar23 /*57*/].f_45=uVar17;
Global_2684801.f_1.f_845[iVar23 /*57*/].f_46=0;
Global_2684801.f_1.f_845[iVar23 /*57*/].f_47=uVar18;
Global_2684801.f_1.f_845[iVar23 /*57*/].f_50=uVar19;
Global_2684801.f_1.f_845[iVar23 /*57*/].f_55=uVar20;
Global_2684801.f_1.f_845[iVar23 /*57*/].f_48=0;
Global_2684801.f_1.f_845[iVar23 /*57*/].f_49=0;
Global_2684801.f_1.f_845[iVar23 /*57*/].f_54=0;
Global_2684801.f_1.f_845[iVar23 /*57*/].f_56=uVar20;
Global_2684801.f_1.f_845[iVar23 /*57*/].f_53=uVar22;
iVar24=0;
while (iVar24 <=1){
Global_2684801.f_1.f_845[iVar23 /*57*/].f_33[iVar24]=uVar14;
iVar24++;
}
iVar24=0;
while (iVar24 <=6){
Global_2684801.f_1.f_845[iVar23 /*57*/].f_36[iVar24]=uVar15;
iVar24++;
}
iVar23++;
}
iVar23=0;
while (iVar23 <=1){
Global_2684801.f_1.f_2670[iVar23 /*57*/]={
Var12 
};
Global_2684801.f_1.f_2670[iVar23 /*57*/].f_13={
Var13 
};
Global_2684801.f_1.f_2670[iVar23 /*57*/].f_44=uVar16;
Global_2684801.f_1.f_2670[iVar23 /*57*/].f_45=uVar17;
Global_2684801.f_1.f_2670[iVar23 /*57*/].f_47=uVar18;
Global_2684801.f_1.f_2670[iVar23 /*57*/].f_50=uVar19;
Global_2684801.f_1.f_2670[iVar23 /*57*/].f_55=uVar20;
Global_2684801.f_1.f_2670[iVar23 /*57*/].f_56=uVar20;
iVar24=0;
while (iVar24 <=1){
Global_2684801.f_1.f_2670[iVar23 /*57*/].f_33[iVar24]=uVar14;
iVar24++;
}
iVar24=0;
while (iVar24 <=6){
Global_2684801.f_1.f_2670[iVar23 /*57*/].f_36[iVar24]=uVar15;
iVar24++;
}
iVar23++;
}
...
iVar25=0;
while (iVar25 < 8){
Global_2684801.f_1.f_2813[iVar25]=0;
iVar25++;
}
Global_2684801.f_1.f_2825=iVar21;
