...
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Var0.f_189.f_55) < 5625f || ScriptParam_618.f_1){
...
func_266(uParam0[iParam3 /*94*/], PED::CREATE_PED(1, uParam0->f_1669, Var13, MISC::GET_HEADING_FROM_VECTOR_2D(uParam0->f_1658, uParam0->f_1658.f_1), 0, 0));
...
func_266(uParam0[iParam4 /*94*/], PED::CREATE_PED(1, uParam0->f_1668, Var1, MISC::GET_HEADING_FROM_VECTOR_2D(-uParam0->f_1658, -uParam0->f_1658.f_1), 0, 0));
...
Var2={
func_87((uParam0[iVar4 /*94*/])->f_37, &(uParam0->f_189), func_283(&(uParam0->f_247)), uParam0->f_247.f_10, uParam0->f_1658, func_92(&(uParam0->f_247)), func_91(&(uParam0->f_247)), func_90(&(uParam0->f_247)), &fVar5) 
};
...
func_269(uParam1, 14);
}elseif(Var6.f_2 < (uParam0->f_189.f_3[0 /*3*/].f_2 - 1f) && vdist2(uParam0->f_189.f_29, func_283(&(uParam0->f_247))) < (26.75f * 26.75f)){
func_103(uParam1, (1 - func_176(uParam1)));
func_269(uParam1, 14);
if(func_63(uParam1) !=iParam3 && uParam0->f_1657 !=1){
Global_113648.f_20023.f_10++;
...
Vector3 func__82(var uParam0, var uParam1, struct<3> Param2, var uParam3, float fParam4){
int iVar0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
Vector3 func__87(struct<3> Param0, var uParam1, struct<3> Param2, struct<3> Param3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, var uParam9, float fParam10){
struct<3> Var0;
int iVar1;
int iVar2;
iVar1=0;
...
Vector3 func__89(var uParam0, struct<3> Param1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9, var uParam10){
int iVar0;
int iVar1;
iVar0=0;
iVar1=0;
...
if(uParam0->f_31 !=4){
Var16={
func_87(uParam0->f_37, &(uParam1->f_189), func_283(&(uParam1->f_247)), uParam1->f_247.f_10, uParam1->f_1658, func_92(&(uParam1->f_247)), func_91(&(uParam1->f_247)), func_90(&(uParam1->f_247)), &fVar15) 
};
...
Vector3 func__116(bool bParam0, struct<3> Param1, struct<3> Param2){
if(bParam0){
return Param1;
}
return Param2;
...
Vector3 func__120(var uParam0, var uParam1, int iParam2, int iParam3, struct<3> Param4, bool bParam5, bool bParam6, bool bParam7, bool bParam8){
struct<3> Var0;
float fVar1;
float fVar2;
float fVar3;
...
if(uParam0->f_31 !=4){
Var0={
func_123(uParam0, &(uParam1->f_189), Var8, iParam2) 
};
}else{
iVar19=(1 - iParam3);
Var0={
func_121(uParam0, uParam1, &(uParam1->f_247.f_16), &((uParam1[iVar19 /*94*/])->f_37), iParam3) 
};
}
...
Var9={
func_122(Var6, Var7, fVar5) 
};
Var3={
Var9 - func_283(&(uParam1->f_247)) 
};
...
Vector3 func__122(struct<3> Param0, struct<3> Param1, float fParam2){
return FtoV((1f - fParam2)) * Param0 + Vector(fParam2, fParam2, fParam2) * Param1;
}


Vector3 func__123(var uParam0, var uParam1, struct<3> Param2, int iParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
int iVar3;
...
fVar6=func_124(0.4f, 1f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216));
...
Var9={
func_122(Var7, uParam1->f_3[iVar4 /*3*/] + Var2, fVar8) 
};
}else{
fVar8=(to_float(iParam3) / to_float(-128));
Var9={
func_122(Var7, uParam1->f_3[iVar3 /*3*/] + Var1, fVar8) 
};
}
Var0={
Var9 - Param2 
...
Var3={
func_85(uParam0, *(uParam1[iVar9 /*3*/])) 
};
Var4={
uParam0->f_37 + Var3 
};
...
*fParam8=MISC::GET_RATIO_OF_CLOSEST_POINT_ON_LINE(Var5, func_116(bParam6, *uParam5, *uParam4), func_116(bParam6, *uParam4, *uParam5), 0);
...
Var4={
func_85(uParam0, *(uParam2[iVar18 /*3*/])) 
};
Var27={
Var15 + Var4 
};
Var28={
func_122(*(uParam4[iVar3 /*3*/]), *(uParam4[iVar3 + 1 /*3*/]), fVar22) 
};
Var29={
Var28 - Var4 
};
...
func_164(uParam0);
func_172(uParam0, (to_float(iVar0) * MISC::GET_FRAME_TIME()));
}}
if(!func_171(*uParam2)){
uParam1->f_1583[iVar0 /*3*/]={
*uParam2 
...
iVar0=func_50(MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.2f, 6, iVar7);
}elseif(uParam2->f_4.f_20==1){
iVar7=MISC::GET_RANDOM_INT_IN_RANGE(1, 4);
iVar0=func_50(MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216) < 0.1f, 6, iVar7);
}elseif(uParam2->f_4.f_20==2){
iVar0=MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
}
Var5={
func_122(Var6, Var5, MISC::GET_RANDOM_FLOAT_IN_RANGE(0, 1065353216)) 
};
...
fVar0=*uParam1;
Var1={
func_183(to_float(*uParam2), to_float(uParam2->f_1), fVar0, &(uParam1->f_40), &(uParam1->f_43)) 
};
if(ENTITY::DOES_ENTITY_EXIST(uParam0->f_247)){
if(uParam0->f_1657 !=1 && !func_275(&(uParam0->f_247))){
func_274(&(uParam0->f_247));
...
Vector3 func__185(struct<3> Param0, struct<3> Param1){
struct<3> Var0;
Var0={
Param1 * FtoV(func_69(Param0, Param1)) 
};
return Var0;
}
...
int func_219(struct<2> Param0, Vector3 vParam1, struct<2> Param2, var uParam3, float fParam4){
if(fParam4 < 0f){
fParam4=0f;
}
...
if(((func_75(uParam0)==75 && ENTITY::DOES_ENTITY_EXIST(uParam1->f_247)) && ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(uParam1->f_247)) && vdist2(uParam0->f_37, func_283(&(uParam1->f_247))) < (0.88f * 0.88f)){
func_58(uParam0, 256);
...
TASK::TASK_GO_STRAIGHT_TO_COORD(func_265(uParam0), Var1, 2f, -1, 1193033728, 1056964608);
...
}elseif((ENTITY::IS_ENTITY_AT_COORD(uParam0->f_32, func_70(&(uParam0->f_4)), Var2, 0, 1, 0) || TASK::GET_SCRIPT_TASK_STATUS(func_265(uParam0), joaat("script_task_go_straight_to_coord"))==7) && !func_228(&(uParam0->f_4), 256)){
func_235(&(uParam0->f_4), 0);
func_217(&(uParam0->f_4), 4);
...
Var7={
func_283(uParam4) - func_283(uParam4) + uParam4->f_10 * Vector(fVar3, fVar3, fVar3) 
};
Var6={
func_283(uParam4) + Var7 
};
Var4={
Var1 - uParam0->f_37 
};
...
if(((!PED::IS_PED_INJURED(func_265(uParam0)) && !vdist2(uParam0->f_37, Var1) <=(0f * 0f)) && !func_228(&(uParam0->f_4), 4)) && !func_104(uParam0, 1024)){
...
*iParam1=round((Var0.f_0 * 128f));
*iParam2=round((Var0.f_1 * 128f));
}elseif(vdist2(uParam0->f_37, Var1) <=(0f * 0f) || TASK::GET_SCRIPT_TASK_STATUS(func_265(uParam0), joaat("script_task_go_straight_to_coord"))==7){
...
if(!bParam4){
ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_265(uParam0[iParam1 /*94*/]), PED::GET_PED_BONE_INDEX(func_265(uParam0[iParam1 /*94*/]), 28422), Local_164, Local_165, 0, 0, 0, 0, 2, 1, 0);
}
ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_265(uParam0[iParam2 /*94*/]), PED::GET_PED_BONE_INDEX(func_265(uParam0[iParam2 /*94*/]), 28422), Local_164, Local_165, 0, 0, 0, 0, 2, 1, 0);
}}}
...
Vector3 func__270(var uParam0, int iParam1, struct<3> Param2, struct<3> Param3, bool bParam4, int iParam5){
struct<3> Var0;
struct<3> Var1;
float fVar2;
float fVar3;
...
*uParam2={
*uParam2 - Var6 * FtoV(func_69(Var6, *uParam2)) * Vector(1.4f, 1.4f, 1.4f) 
};
}
Var13={
*uParam1 
...
*uParam2={
*uParam2 + func_280(*uParam2, fVar1) 
};
...
Vector3 func__280(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
struct<3> Var2;
Var0={
