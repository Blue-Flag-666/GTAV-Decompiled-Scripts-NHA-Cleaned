...
func_472(&uLocal_106, &(Local_79.f_41[0]));
func_458();
...
bLocal_110=true;
return 1;
}}elseif(VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_114, Local_97.f_4)){
bLocal_110=true;
return 1;
}}
return 0;
...
iLocal_120=0;
while (iLocal_120 <=7){
if(func_421(Local_117[iLocal_120 /*7*/].f_4) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/].f_4, 0)){
bVar2=true;
...
}}elseif(!Local_117[iLocal_120 /*7*/].f_6 && func_9(PLAYER::PLAYER_PED_ID(), Local_117[iLocal_120 /*7*/], 100f, 1)){
...
func_18();
}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_97.f_4, 1)){
func_18();
}}else{
func_18();
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_97.f_4, 0)){
...
if(AUDIO::REQUEST_SCRIPT_AUDIO_BANK("BARRY3C_IGNITION_FAIL", 0, -1) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_299)){
...
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_296, "IGNITION_FAIL", Local_97.f_4, "BARRY_03_SOUNDSET", 0, 0);
AUDIO::SET_VARIABLE_ON_SOUND(uLocal_296, "HOLD TIME", 1.5f);
...
iLocal_95=2;
iLocal_304=1;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, 0, 0) && !ENTITY::IS_ENTITY_IN_AIR(Local_97.f_4)){
Var0={
ENTITY::GET_ENTITY_COORDS(Local_97.f_4, 1) 
};
if(Var0.f_2 < 6.7f){
iLocal_94=12;
iLocal_95=0;
...
iLocal_301=1;
}}elseif(func_21(&uLocal_121, "BAR3CAU", sLocal_302[iLocal_303], 7, 0, 0, 0)){
iLocal_301=1;
}
break;
case 1:
...
if(func_4()){
iLocal_95=2;
}elseif(iLocal_307 && !func_421(iLocal_114)){
func_47(&iLocal_96);
HUD::CLEAR_PRINTS();
iLocal_94=10;
iLocal_95=0;
...
iLocal_94=11;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, 1, 0)){
iLocal_94=6;
}else{
iLocal_94=5;
}}else{
...
func_58(13, floor(Global_113648.f_10196.f_3853));
}
...
Global_78341[1 /*14*/]={
func_133(iVar0, iParam1, uVar6[iParam1], -1) 
};
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_125(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
uVar0=Global_2805029[iParam0 /*3*/][func_119(iParam1)];
...
func_205(&uVar1, Var0.f_3, Global_100718, iParam1, iParam2);
}}
...
void func_207(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21){
uParam0->f_4=iParam4;
*uParam0=sParam1;
uParam0->f_1={
Param2 
...
var uVar0;
var uVar1;
uVar0=Global_2848282[iParam0 /*3*/][func_119(iParam1)];
...
if(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0){
iLocal_95=2;
}elseif(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_114, 0)){
iLocal_95=2;
}elseif(func_2()){
if(ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, 1, 0)){
func_47(&iLocal_96);
...
iLocal_290=1;
}}}elseif(!ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[1 /*7*/][0 /*3*/], Local_305[1 /*7*/][1 /*3*/], fLocal_306[1], 0, 1, 0)){
iLocal_94=10;
iLocal_95=0;
}}else{
iLocal_95=2;
...
iLocal_95=2;
}elseif(ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 1, 1, 0)){
iLocal_95=2;
}elseif(iLocal_309){
if(!func_15()){
iLocal_309=0;
...
iLocal_286=1;
}}elseif(!iLocal_287 && (MISC::GET_GAME_TIMER() - iLocal_292) > 120000){
if(!func_344()){
if(func_343(&uLocal_121, 49, "BAR3CAU", "BAR3C_HC", 7, 0, 0, 1)){
iLocal_287=1;
}}}elseif(!iLocal_288 && (MISC::GET_GAME_TIMER() - iLocal_292) > 160000){
...
void func_346(struct<3> Param0, float fParam1, int iParam2, int iParam3){
struct<3> Var0;
var uVar1;
...
if(iParam2==1){
if(func_370(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
...
void func_347(int iParam0, struct<3> Param1, var uParam2, int iParam3, bool bParam4){
struct<60> Var0;
if(ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)){
...
func_366(iParam3, &Var0, Param1, uParam2, func_262(iParam0));
...
func_341(3);
func_341(4);
VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_97.f_4, 0);
VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_97.f_4, 0);
if(func_2()){
iLocal_95=0;
iLocal_94=5;
}else{
...
if(iLocal_295==4){
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_296, "IGNITION_FAIL", Local_97.f_4, "BARRY_03_SOUNDSET", 0, 0);
AUDIO::SET_VARIABLE_ON_SOUND(uLocal_296, "HOLD TIME", 3f);
iLocal_291=MISC::GET_GAME_TIMER() + 9100;
}
else{
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_296, "IGNITION_FAIL", Local_97.f_4, "BARRY_03_SOUNDSET", 0, 0);
AUDIO::SET_VARIABLE_ON_SOUND(uLocal_296, "HOLD TIME", (to_float((1200 + iLocal_295 * 250)) / 1000f));
...
iLocal_94=13;
return 1;
}elseif(iLocal_102 && iLocal_307==0){
...
Var4={
func_406(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
}elseif(iLocal_115==joaat("towtruck") || iLocal_115==joaat("towtruck2")){
...
void func_426(struct<3> Param0, float fParam1, bool bParam2){
if(func_421(PLAYER::PLAYER_PED_ID())){
if(bParam2){
...
iLocal_114=VEHICLE::CREATE_VEHICLE(iLocal_115, Param0, fParam1, 1, 1, 0);
...
VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(iLocal_114, 0);
VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(iLocal_114, 0);
...
void func_429(struct<3> Param0, float fParam1){
...
func_249(&uLocal_106);
func_6(&(Local_97.f_4));
Local_97.f_4=VEHICLE::CREATE_VEHICLE(Local_97.f_5, Param0, fParam1, 1, 1, 0);
...
uLocal_106=OBJECT::CREATE_OBJECT(iLocal_109, Param0 + Local_107, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_106, Local_97.f_4, 0, Local_107, Local_108, 0, 0, 0, 0, 2, 1, 0);
}
...
void func_438(struct<3> Param0, float fParam1, int iParam2, int iParam3){
if(func_457()){
...
fLocal_312=277.92f;
}elseif(iLocal_115==joaat("towtruck2")){
Local_311={
-463.5672f, -1712.284f, 17.6392f 
};
fLocal_312=272.29f;
}elseif((iLocal_115==joaat("cargobob") || iLocal_115==joaat("cargobob2")) || iLocal_115==joaat("cargobob3")){
Local_311={
...
}elseif(PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_97.f_4, 0)){
...
uLocal_80=func_471();
uLocal_113[0]=PED::ADD_SCENARIO_BLOCKING_AREA(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
uLocal_113[1]=PED::ADD_SCENARIO_BLOCKING_AREA(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
...
struct<7> func_470(struct<3> Param0, float fParam1){
struct<7> Var0;
Var0={
Param0 
};
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_113[0], 0);
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_113[1], 0);
