...
uLocal_262=PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
}
if(func_296(Local_81.f_28[0])){
PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_81.f_28[0], uLocal_262);
...
uLocal_87=PED::CREATE_SYNCHRONIZED_SCENE(Local_88, Local_89, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], uLocal_87, "rcmjosh1leadinout", "leadout_josh", 8f, -4f, 27, 0, 1000f, 16);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, uLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_81.f_28[0], 1, 0);
func_246("Done Josh leadout anim");
iLocal_94=1;
}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_87)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_87) > 0.29f){
if(!iLocal_95){
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_87) > 0.98f){
...
if((PED::IS_PED_INJURED(Local_81.f_28[0]) || FIRE::IS_ENTITY_ON_FIRE(Local_81.f_28[0])) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_81.f_28[0], 1), 5f)){
if(func_296(Local_81.f_28[0])){
ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(Local_81.f_28[0], -8f, 1);
TASK::CLEAR_PED_TASKS(Local_81.f_28[0]);
}
...
TASK::TASK_PERFORM_SEQUENCE(Local_81.f_28[0], uLocal_84);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_84);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_81.f_28[0], 0);
if(iLocal_96==0){
PED::FORCE_PED_MOTION_STATE(Local_81.f_28[0], joaat("MotionState_Walk"), 0, 0, 1);
}}
if(OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0)){
OBJECT::SET_STATE_OF_CLOSEST_DOOR_OF_TYPE(joaat("prop_lrggate_01c_l"), -1107.01f, 289.38f, 64.76f, 0, 0f, 0);
}
...
if(func_297(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85)){
uLocal_87=PED::CREATE_SYNCHRONIZED_SCENE(Local_88, Local_89, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], uLocal_87, "rcmjosh1leadinout", "leadout_josh", 1000f, -8f, 25, 0, 1000f, 16);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, uLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
func_246("Done Josh leadout anim on Josh exit state");
ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
PED::FORCE_PED_MOTION_STATE(Local_81.f_28[0], joaat("MotionState_Idle"), 0, 1, 1);
iLocal_94=1;
}}}
...
if(func_297(Local_81.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_85)){
uLocal_87=PED::CREATE_SYNCHRONIZED_SCENE(Local_88, Local_89, 2);
TASK::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], uLocal_87, "rcmjosh1leadinout", "leadout_josh", 8f, -8f, 25, 0, 1000f, 16);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, uLocal_87, "leadout_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
func_246("Done Josh leadout anim on non active cutscene");
ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_85);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_81.f_28[0], 0, 0);
iLocal_94=1;
}}
iLocal_83=2;
}
...
int func_248(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_296(iParam0)){
...
void func_249(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
int iVar0;
iVar0=PLAYER::GET_PLAYER_INDEX();
...
void func_253(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10){
var uVar0;
bool bVar1;
bool bVar2;
int iVar3;
...
int func_257(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3){
struct<3> Var0;
struct<3> Var1;
struct<3> Var2;
struct<3> Var3;
...
TASK::TASK_SYNCHRONIZED_SCENE(Local_81.f_28[0], uLocal_86, "rcmjosh1leadinout", "leadin_josh", 8f, -8f, 25, 0, 1148846080, 0);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_85, uLocal_86, "leadin_gate", "rcmjosh1leadinout", 8f, 1090519040, 0, 1148846080);
...
iLocal_83=2;
}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_86)){
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_86) > 0.15f){
if(!iLocal_91){
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_86) > 0.9f){
...
void func_280(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_282(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
func_302(uParam0, iLocal_79, Var0, fVar1);
...
void func_302(var uParam0, int iParam1, struct<3> Param2, float fParam3){
func_303(uParam0);
...
int func_304(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5){
if(func_305(uParam0, iParam1, Param2, fParam3, 1)){
if(ENTITY::DOES_ENTITY_EXIST(*uParam0)){
if(!ENTITY::IS_ENTITY_DEAD(*uParam0, 0)){
...
int func_305(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4){
int iVar0;
if(!func_153(iParam1)){
