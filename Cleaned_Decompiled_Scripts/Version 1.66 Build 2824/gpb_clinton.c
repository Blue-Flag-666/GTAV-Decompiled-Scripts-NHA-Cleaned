...
uLocal_208=PED::CREATE_PED(25, iLocal_36, Local_210, ScriptParam_332.f_17[0], 0, 1);
func_104();
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_208, Local_210, 1f, -1, 1f, 1024, ScriptParam_332.f_17[0]);
iLocal_216=6;
}
break;
case 6:
