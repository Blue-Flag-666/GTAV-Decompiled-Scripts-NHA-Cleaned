...
while (!GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(uLocal_49)){
wait(0);
}
...
iVar2=iVar5;
Var3={
func_32(Global_44465[iVar5 /*12*/].f_1) 
};
...
Var3={
func_32(Global_44465[iVar11 /*12*/].f_1) 
};
}}
if(!bParam4){
...
Var17={
func_32(Global_44465[iVar15 /*12*/]) 
};
Var18={
func_32(Global_44465[iVar15 /*12*/].f_1) 
};
if(Global_53765[iVar13 /*203*/].f_10[iVar3 /*48*/].f_1){
MemCopy(&Var18,{
Global_53765[iVar13 /*203*/].f_10[iVar3 /*48*/].f_2
}
, 16);
}
...
Var15={
func_32(Global_44465[iVar14 /*12*/]) 
};
GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0, "SET_DATA_SLOT");
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(8);
GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar3);
...
fVar1=func_71((to_float((MISC::GET_GAME_TIMER() - iLocal_18)) / fParam4), 0f, 1f);
if(fVar1 < 1f){
fVar2=fVar1;
if(bParam5){
fVar2=(fVar2 - 1f);
