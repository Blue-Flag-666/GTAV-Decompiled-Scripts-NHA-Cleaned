...
func_84(&(Global_2683864.f_781), 0, 0, Var6, &uVar4, Var6, 1, 0, &uVar4, &iVar5, iVar5, 0, uVar7);
func_76(0, 0);
...
void func_84(var uParam0, int iParam1, int iParam2, struct<3> Param3, var uParam4, struct<3> Param5, bool bParam6, bool bParam7, var uParam8, var uParam9, int iParam10, bool bParam11, var uParam12){
struct<3> Var0;
struct<3> Var1;
float fVar2;
bool bVar3;
...
fVar2=50f;
}elseif(func_130(Global_4718592.f_113724) || MISC::IS_BIT_SET(uParam12, 2)){
...
fVar2=42.6052f;
}}elseif(func_128(Global_4718592.f_113724) || MISC::IS_BIT_SET(uParam12, 1)){
Var0={
...
fVar2=50f;
}elseif(MISC::IS_BIT_SET(uParam12, 4) || func_127(Global_4718592.f_113724)){
Var0={
...
Var0={
OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_125(iVar6), func_124(iVar6), 3.5688f, 7.9792f, 4.1641f) 
};
Var1={
-21.6791f, 0f, (func_124(iVar6) + 40.237f) 
};
fVar2=70f;
}elseif(MISC::IS_BIT_SET(uParam12, 6) || func_123()){
...
fVar2=50f;
}elseif(MISC::IS_BIT_SET(uParam12, 8) || func_119(Global_4718592.f_113724)){}elseif(MISC::IS_BIT_SET(uParam12, 9) || (func_117() && func_116(249))){
Var0={
...
if(!func_115()){
iVar5=0;
}}elseif(MISC::IS_BIT_SET(uParam12, 10)){}elseif(func_114(Global_4718592.f_113724)){
Var0={
...
func_85(func_156(), ((MISC::IS_BIT_SET(uParam12, 0) || MISC::IS_BIT_SET(uParam12, 1)) || MISC::IS_BIT_SET(uParam12, 2)));
}
...
Var1={
func_103(Var1, -Var0[0 /*6*/].f_3.f_2) 
};
Var1={
func_103(Var1, Var0[1 /*6*/].f_3.f_2) 
};
*uParam2={
...
Vector3 func__103(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
...
void func_252(struct<3> Param0, var uParam1){
int iVar0;
int iVar1;
iVar0=1;
iVar1=7;
...
int func_253(struct<3> Param0, int iParam1, float fParam2){
int iVar0;
struct<3> Var1[3];
struct<3> Var2[3];
int iVar3;
...
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_152, "SET_INPUT_EVENT", to_float(205), -1082130432, -1082130432, -1082130432, -1082130432);
}
func_381(2, 206, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 206)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_152, "SET_INPUT_EVENT", to_float(206), -1082130432, -1082130432, -1082130432, -1082130432);
}
func_381(2, 188, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 188)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_152, "SET_INPUT_EVENT", to_float(188), -1082130432, -1082130432, -1082130432, -1082130432);
MISC::SET_BIT(&uLocal_131, 3);
}
func_381(2, 187, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 187)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_152, "SET_INPUT_EVENT", to_float(187), -1082130432, -1082130432, -1082130432, -1082130432);
MISC::SET_BIT(&uLocal_131, 3);
}
func_381(2, 189, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 189)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_152, "SET_INPUT_EVENT", to_float(189), -1082130432, -1082130432, -1082130432, -1082130432);
}
func_381(2, 190, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 190)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_152, "SET_INPUT_EVENT", to_float(190), -1082130432, -1082130432, -1082130432, -1082130432);
}
func_381(2, 201, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 201)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_152, "SET_INPUT_EVENT", to_float(201), -1082130432, -1082130432, -1082130432, -1082130432);
}
func_381(2, 202, 1);
...
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_152, "SET_INPUT_EVENT", to_float(203), -1082130432, -1082130432, -1082130432, -1082130432);
}
func_381(2, 204, 1);
if(PAD::IS_CONTROL_JUST_PRESSED(2, 204)){
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_152, "SET_INPUT_EVENT", to_float(204), -1082130432, -1082130432, -1082130432, -1082130432);
}
...
GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(uLocal_152, "SET_INPUT_EVENT", to_float(202), -1082130432, -1082130432, -1082130432, -1082130432);
func_326(4);
}
