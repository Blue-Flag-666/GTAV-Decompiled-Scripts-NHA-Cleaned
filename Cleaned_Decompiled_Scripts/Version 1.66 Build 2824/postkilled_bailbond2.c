...
if(vdist2(Var0, ENTITY::GET_ENTITY_COORDS(iLocal_79[iVar1], 0)) >=IntToFloat((iVar3 * iVar3)) && ENTITY::IS_ENTITY_OCCLUDED(iLocal_79[iVar1])){
...
}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_79[iVar1])){
func_6(&(iLocal_79[iVar1]), 1, 0, 1);
}
...
}}}elseif(ENTITY::DOES_ENTITY_EXIST(iLocal_79.f_5[iVar2])){
func_2(&(iLocal_79.f_5[iVar2]));
}
iVar1++;
if(iVar1==iLocal_79){
