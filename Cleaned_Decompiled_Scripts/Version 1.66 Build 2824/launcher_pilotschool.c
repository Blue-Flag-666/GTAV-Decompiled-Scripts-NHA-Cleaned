...
if(bVar3){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_53, ScriptParam_88.f_1[0 /*3*/], fLocal_77, fLocal_77, 2f, 0, 1, iLocal_67)){
bVar3=false;
}
...
elseif(!func_88(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_45(&iLocal_60);
...
if(func_88(uLocal_58, 2097152)){
if(!func_74(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_50)){
func_81(10);
}}
