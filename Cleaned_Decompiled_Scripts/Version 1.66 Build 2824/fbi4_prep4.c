...
iLocal_81=2;
}elseif(!func_93(PLAYER::PLAYER_PED_ID(), Local_195, 75f, 1)){
if(!iLocal_201){
func_22(&uLocal_192);
iLocal_201=1;
}
func_84(&uLocal_192, Local_196, 1, 1, "PRD_SHOP");
}elseif(func_93(PLAYER::PLAYER_PED_ID(), Local_196, 12f, 1)){
if(iLocal_201){
func_22(&uLocal_192);
iLocal_201=0;
}
func_84(&uLocal_192, Local_196, 1, 1, "PRD_BLIP");
...
void func_84(var uParam0, struct<3> Param1, int iParam2, bool bParam3, char* sParam4){
if(!HUD::DOES_BLIP_EXIST(*uParam0)){
*uParam0=func_85(Param1, 5, iParam2);
if(bParam3){
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(*uParam0, sParam4);
}}}

int func_85(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
iVar0=0;
...
bool func_93(int iParam0, struct<3> Param1, float fParam2, int iParam3){
...
int func_96(var uParam0, struct<3> Param1, var uParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_27(uParam0)){
...
if(!func_188() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
void func_193(struct<3> Param0, float fParam1, int iParam2){
int iVar0;
iVar0=0;
while (iVar0 < 68){
...
int func_203(struct<3> Param0, float fParam1){
return func_204(&(Global_107196.f_2890), Param0, fParam1, 0);
}

int func_204(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
int func_206(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_207(iParam0, uVar1[iVar3], 1) && func_98(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_202(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
...
void func_284(struct<3> Param0, float fParam1, int iParam2, int iParam3){
if(func_285()){
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(uVar1, 10, -1, 0, -1, func_300(iParam0));
if(iVar11 > iVar10){
...
bool func_359(var uParam0, struct<2> Param1, Vector3 vParam2){
bool bVar0;
int iVar1;
int iVar2;
if(uParam0->f_46 < 3){}
