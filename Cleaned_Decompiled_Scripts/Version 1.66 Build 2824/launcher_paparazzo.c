...
var func__175(struct<3> Param0, int iParam1){
var uVar0;
...
int func_221(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5){
var uVar0;
struct<3> Var1;
var uVar2;
int iVar3;
...
float func_225(struct<3> Param0, struct<3> Param1){
return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_233(int iParam0, struct<3> Param1, float fParam2, int iParam3){
struct<3> Var0;
struct<3> Var1;
float fVar2;
Var0={
...
void func_247(var uParam0, var uParam1, struct<3> Param2, float fParam3){
func_212(uParam0);
...
void func_250(var uParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4){
func_251(uParam0);
...
int func_253(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4){
int iVar0;
if(!func_36(iParam1)){
...
case 3:
if(func_132(uParam0->f_41[0])){
uLocal_54=PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(uParam0->f_41[0], 1), ENTITY::GET_ENTITY_ROTATION(uParam0->f_41[0], 2), 2);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[0], uLocal_54, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1148846080);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_54, 1);
if(func_132(uParam0->f_28[0])){
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_54, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
}
if(func_132(uParam0->f_41[1])){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[1], uLocal_54, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1148846080);
}
if(func_132(uParam0->f_41[2])){
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_41[2], uLocal_54, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1148846080);
}}
iVar5=0;
while (iVar5 <=(iVar0 - 1)){
...
uLocal_54=PED::CREATE_SYNCHRONIZED_SCENE(-71.283f, 301.557f, 106.711f, 0f, 0f, 4.659f, 2);
PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_54, 1);
TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], uLocal_54, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
