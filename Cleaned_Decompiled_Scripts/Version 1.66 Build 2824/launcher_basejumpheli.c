...
fLocal_57=vdist2(Local_55, ScriptParam_260.f_1[0 /*3*/]);
fLocal_57=fLocal_57;
Local_75={
Local_55 
};
...
elseif(!func_161(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_116(&iLocal_60);
...
if(func_161(uLocal_58, 2097152)){
if(!func_139(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_50)){
func_154(10);
}}
if(!SCRIPT::IS_THREAD_ACTIVE(uLocal_50)){
STATS::PLAYSTATS_ODDJOB_DONE(round((func_12(&uLocal_71) * 1000f)), iLocal_63, 0);
func_11(&uLocal_71);
...
void func_17(){
func_18(&uLocal_252, Local_247.f_0);
}
...
if(CAM::IS_CAM_ACTIVE(uLocal_252)){
CAM::SET_CAM_ACTIVE(uLocal_252, 0);
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
CAM::DESTROY_CAM(uLocal_252, 0);
}
func_2();
}
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247.f_0, 0)){
...
uVar7=func_112(func_113(iLocal_81)==joaat("maverick"), 0.45f, 0.3f);
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247.f_0, 0) && PED::IS_PED_IN_VEHICLE(Local_247.f_3, Local_247.f_0, 0)){
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(Local_247.f_3, Local_247.f_0, ENTITY::GET_ENTITY_COORDS(Local_247.f_0, 1) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_247.f_0) + Vector(500f, 0f, 0f), 4, VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(Local_247.f_0), 262144, 50f, 50f, 1);
}else{
TASK::TASK_SMART_FLEE_PED(Local_247.f_3, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
}
PED::SET_PED_KEEP_TASK(Local_247.f_3, 1);
PED::SET_PED_CONFIG_FLAG(Local_247.f_3, 251, 0);
PED::SET_PED_CONFIG_FLAG(Local_247.f_3, 255, 0);
Local_247.f_3=0;
}
...
fVar6=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_108(iLocal_81));
if(fVar6 < 11664f){
if(!iLocal_251){
...
if((STREAMING::HAS_MODEL_LOADED(func_107(iLocal_81)) && ENTITY::DOES_ENTITY_EXIST(Local_247.f_0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247.f_0, 0)){
Local_247.f_3=PED::CREATE_PED_INSIDE_VEHICLE(Local_247.f_0, 4, func_107(iLocal_81), -1, 1, 1);
...
PED::SET_PED_CONFIG_FLAG(Local_247.f_3, 251, 1);
PED::SET_PED_CONFIG_FLAG(Local_247.f_3, 255, 1);
}
VEHICLE::SET_VEHICLE_ENGINE_ON(Local_247.f_0, 1, 1, 0);
VEHICLE::SET_HELI_BLADES_SPEED(Local_247.f_0, uVar7);
}}else{
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Local_247.f_3, 1, 0);
if(!CAM::DOES_CAM_EXIST(uLocal_252) || !CAM::IS_CAM_RENDERING(uLocal_252)){
VEHICLE::SET_HELI_BLADES_SPEED(Local_247.f_0, uVar7);
}
if(!MISC::IS_BIT_SET(Local_247.f_169, 0)){
if(CAM::IS_SCREEN_FADED_IN()){
if(!PED::IS_PED_INJURED(Local_247.f_3) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_247.f_3, 1)) < 400f){
...
func_18(&uLocal_252, Local_247.f_0);
if((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_247.f_0, 1) && !PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())) && func_78(Local_247.f_3, Local_247.f_0)){
Var5={
ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Local_247.f_0, PED::GET_PED_BONE_COORDS(PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f)) 
};
...
if(!CAM::DOES_CAM_EXIST(uLocal_252)){
func_67(0, 0, 1);
func_60(1);
uLocal_252=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, func_59(iLocal_81), func_58(iLocal_81), func_57(iLocal_81), 0, 2);
CAM::SET_CAM_ACTIVE(uLocal_252, 1);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
CAM::SHAKE_CAM(uLocal_252, "HAND_SHAKE", 0.07f);
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247.f_0, 0)){
iVar0=TASK::GET_SCRIPT_TASK_STATUS(Local_247.f_3, joaat("script_task_vehicle_mission"));
if(iVar0 !=0 && iVar0 !=1){
PED::SET_PED_CONFIG_FLAG(Local_247.f_3, 134, 1);
func_25(&uVar1);
...
func_24(&uLocal_253);
while (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_247.f_0, 0) && func_55(&uLocal_253) < 2f){
wait(0);
}
func_11(&uLocal_253);
if(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_247.f_0, 0)){
bVar8=false;
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
if(CAM::DOES_CAM_EXIST(uLocal_252)){
CAM::DESTROY_CAM(uLocal_252, 0);
...
if(!ENTITY::IS_ENTITY_DEAD(Local_247.f_3, 0) && !ENTITY::IS_ENTITY_DEAD(Local_247.f_0, 0)){
TASK::OPEN_SEQUENCE_TASK(&uVar4);
TASK::TASK_STAND_STILL(0, 500);
TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, Local_247.f_0, ENTITY::GET_ENTITY_COORDS(Local_247.f_0, 1) + Vector(100f, 100f, 100f) * ENTITY::GET_ENTITY_FORWARD_VECTOR(Local_247.f_0) + Vector(500f, 0f, 0f), 4, VEHICLE::GET_VEHICLE_ESTIMATED_MAX_SPEED(Local_247.f_0), 262144, 50f, 50f, 1);
TASK::CLOSE_SEQUENCE_TASK(uVar4);
TASK::TASK_PERFORM_SEQUENCE(Local_247.f_3, uVar4);
...
if(!bVar8){
if((VEHICLE::IS_VEHICLE_DRIVEABLE(Local_247.f_0, 0) && vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_247.f_0, 1)) < 225f) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)){
...
void func_144(struct<3> Param0, float fParam1){
var uVar0;
bool bVar1;
fLocal_57=vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Param0);
...
if(iLocal_81==3){
Local_247.f_0=VEHICLE::CREATE_VEHICLE(joaat("frogger"), Param0, fParam1, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_247.f_0, 5);
}else{
Local_247.f_0=VEHICLE::CREATE_VEHICLE(joaat("maverick"), Param0, fParam1, 1, 1, 0);
VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(Local_247.f_0, 6);
}
iLocal_54=Local_247.f_0;
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_54, 1);
if(MISC::GET_GROUND_Z_FOR_3D_COORD(Param0, &uVar0, 0, 0)){
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(Local_247.f_0, 1084227584);
}
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_247.f_0, 1);
iLocal_249=1;
}else{
iLocal_249=0;
}}
...
fLocal_66=(to_float(func_163(iLocal_69)) + 5f);
if(iLocal_69 !=263){
if(!func_158(0, iLocal_63)){
bLocal_248=false;
func_56(iLocal_69);
...
int func_166(struct<3> Param0, int iParam1){
float fVar0;
float fVar1;
int iVar2;
int iVar3;
...
fVar1=vdist2(Param0, func_108(iVar3));
if(fVar0 > fVar1){
fVar0=fVar1;
iVar2=iVar3;
}}
