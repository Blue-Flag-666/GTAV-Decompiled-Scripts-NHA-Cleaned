...
iLocal_242=0;
if(ENTITY::IS_ENTITY_AT_COORD(Local_43.f_4, Local_53, 6f, 6f, 2f, 1, 1, 0)){
func_217(&iLocal_42);
iLocal_41=0;
iLocal_40=6;
}
...
iLocal_42=func_216(Local_53, 5, 1);
}}}elseif(iLocal_240 && !func_215()){
func_213(3);
iLocal_240=0;
}}elseif(!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_43.f_4, 0)){
HUD::CLEAR_PRINTS();
iLocal_241=0;
iLocal_240=1;
func_217(&iLocal_42);
...
iLocal_240=1;
func_217(&iLocal_42);
}elseif(ENTITY::IS_ENTITY_AT_COORD(Local_43.f_4, Local_53, 6f, 6f, 2f, 1, 1, 0)){
func_217(&iLocal_42);
iLocal_41=0;
iLocal_40=6;
}
...
bool func_210(int iParam0, struct<3> Param1, float fParam2, int iParam3){
...
int func_216(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
iVar0=0;
...
switch (iLocal_41){
case 0:
if(ENTITY::IS_ENTITY_AT_COORD(Local_43.f_4, Local_53, 10f, 10f, 2f, 0, 1, 0)){
func_217(&iLocal_42);
...
iLocal_41=2;
}elseif((iLocal_237 && func_212(5)) && (MISC::GET_PROFILE_SETTING(203)==0 || !func_215())){
func_213(5);
}}}else{
HUD::CLEAR_PRINTS();
iLocal_40=8;
...
iLocal_41=1;
iLocal_237=1;
}}elseif(func_221(&uLocal_63, 49, "BAR3AAU", "BAR3A_P1b", 9, 1, 0, 0, 0)){
iLocal_41=1;
iLocal_237=1;
}}}}
...
if(!func_215() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_43.f_4, 0)){
if(!iLocal_229){
iLocal_229=1;
...
iLocal_229=0;
iLocal_230++;
}}elseif(func_249(&uLocal_63, "BAR3AAU", Local_228[iLocal_230 /*2*/], 7, 0, 0, 0)){
iLocal_229=0;
iLocal_230++;
}}}}}}
...
if(PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_43.f_4) && ENTITY::IS_ENTITY_AT_COORD(Local_43.f_4, Local_53, 6f, 6f, 2f, 1, 1, 0)){
iLocal_243=0;
iLocal_41=2;
}
if(!iLocal_236){
...
var uVar0;
var uVar1;
uVar0=Global_2848282[iParam0 /*3*/][func_69(iParam1)];
...
int func_295(struct<3> Param0, char* sParam1, struct<3> Param2){
int iVar0;
int iVar1;
...
bool func_297(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_303(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
void func_341(struct<3> Param0, float fParam1, int iParam2, int iParam3){
struct<3> Var0;
var uVar1;
...
if(iParam2==1){
if(func_365(ENTITY::GET_ENTITY_COORDS(Global_104212.f_4, 1), iParam3, &Var0, &uVar1)){
Param0={
Var0 
};
fParam1=uVar1;
...
void func_342(int iParam0, struct<3> Param1, var uParam2, int iParam3, bool bParam4){
struct<60> Var0;
if(ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)){
...
func_361(iParam3, &Var0, Param1, uParam2, func_270(iParam0));
...
void func_361(int iParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4){
if(func_360(&(Global_77348.f_555[0 /*21*/]), iParam0)){
...
int func_365(struct<3> Param0, int iParam1, var uParam2, var uParam3){
int iVar0;
...
int func_366(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
float fVar1;
float fVar2;
int iVar3;
...
Local_56[iParam0 /*29*/].f_1=PED::CREATE_PED_INSIDE_VEHICLE(Local_56[iParam0 /*29*/], 6, iLocal_59, -1, 1, 1);
Local_56[iParam0 /*29*/].f_2=PED::CREATE_PED_INSIDE_VEHICLE(Local_56[iParam0 /*29*/], 6, iLocal_59, 0, 1, 1);
}}elseif(STREAMING::HAS_MODEL_LOADED(iLocal_58)){
Local_56[iParam0 /*29*/]=VEHICLE::CREATE_VEHICLE(iLocal_58, Local_56[iParam0 /*29*/].f_3, Local_56[iParam0 /*29*/].f_6, 1, 1, 0);
}}elseif(!ENTITY::IS_ENTITY_DEAD(Local_56[iParam0 /*29*/].f_1, 0)){
...
}elseif((func_391(Local_56[iParam0 /*29*/]) || func_378(Local_56[iParam0 /*29*/].f_1)) || func_378(Local_56[iParam0 /*29*/].f_2)){
func_376(iParam0, 0);
}elseif(PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0){
func_376(iParam0, 0);
}}else{
...
func_376(iParam0, 1);
}elseif((func_378(Local_56[iParam0 /*29*/].f_1) || func_378(Local_56[iParam0 /*29*/].f_2)) || func_391(Local_56[iParam0 /*29*/])){
func_376(iParam0, 0);
}
break;
case 3:
...
return 1;
}elseif(Local_56[iParam0 /*29*/].f_7[1 /*8*/].f_7 !=0f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_43.f_4, Local_56[iParam0 /*29*/].f_7[1 /*8*/][0 /*3*/], Local_56[iParam0 /*29*/].f_7[1 /*8*/][1 /*3*/], Local_56[iParam0 /*29*/].f_7[1 /*8*/].f_7, 0, 1, 0)){
return 1;
}
return 0;
}
...
Var4={
func_412(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
VEHICLE::SET_VEHICLE_CAN_LEAK_OIL(Local_43.f_4, 0);
VEHICLE::SET_VEHICLE_CAN_LEAK_PETROL(Local_43.f_4, 0);
if(!bLocal_46){
...
void func_448(struct<3> Param0, float fParam1, bool bParam2){
...
func_209(&uLocal_49);
func_206(&(Local_43.f_4));
Local_43.f_4=VEHICLE::CREATE_VEHICLE(Local_43.f_5, Param0, fParam1, 1, 1, 0);
...
VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_43.f_4, 1);
VEHICLE::ADD_VEHICLE_UPSIDEDOWN_CHECK(Local_43.f_4);
VEHICLE::SET_VEHICLE_EXTRA(Local_43.f_4, 1, 1);
VEHICLE::SET_VEHICLE_EXTRA(Local_43.f_4, 2, 1);
VEHICLE::SET_VEHICLE_EXTRA(Local_43.f_4, 3, 1);
uLocal_49=OBJECT::CREATE_OBJECT(iLocal_51, Param0, 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_49, Local_43.f_4, 0, Local_50, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1, 0);
ENTITY::SET_ENTITY_COLLISION(uLocal_49, 1, 0);
bLocal_46=true;
func_427(Local_43.f_4, 0);
...
void func_454(struct<3> Param0, float fParam1, int iParam2, int iParam3){
if(func_456()){
...
sLocal_253="DEFAULT";
func_458(49, 1, 0);
uLocal_54[0]=PED::ADD_SCENARIO_BLOCKING_AREA(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
uLocal_54[1]=PED::ADD_SCENARIO_BLOCKING_AREA(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
...
Local_56[1 /*29*/].f_7[0 /*8*/][0 /*3*/]={
1164.457f, -1363.839f, 33.51062f 
};
Local_56[1 /*29*/].f_7[0 /*8*/][1 /*3*/]={
1180.637f, -1359.837f, 39.11396f 
};
Local_56[1 /*29*/].f_7[0 /*8*/].f_7=15.5f;
Local_56[1 /*29*/].f_7[1 /*8*/][0 /*3*/]={
0f, 0f, 0f 
};
Local_56[1 /*29*/].f_7[1 /*8*/][1 /*3*/]={
0f, 0f, 0f 
};
...
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_54[0], 0);
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_54[1], 0);
MISC::SET_INSTANCE_PRIORITY_HINT(0);
