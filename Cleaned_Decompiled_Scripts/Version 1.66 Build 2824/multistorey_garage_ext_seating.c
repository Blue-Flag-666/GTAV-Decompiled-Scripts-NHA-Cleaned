...
if(func_70()){
func_67(&uLocal_112, -271.6364f, 289.377f, 103.994f, 63, "MSG_BLP_EL", 1065353216, 1, 0);
}else{
func_66(&uLocal_112);
}}
if(func_65()){
...
if((fVar1 >=0.35f && !Global_2766480) && !Global_2766483){
func_19(uParam0);
}}
...
func_4(uParam0);
}elseif(Global_2766480 || Global_2766483){
func_4(uParam0);
...
void func_67(var uParam0, struct<3> Param1, int iParam2, char* sParam3, int iParam4, int iParam5, bool bParam6){
if(!HUD::DOES_BLIP_EXIST(*uParam0)){
...
HUD::SET_BLIP_SCALE(*uParam0, iParam4);
...
bool func_70(){
return MISC::IS_BIT_SET(Global_1950108.f_11, 17);
}
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_83(PLAYER::PLAYER_ID()), Global_1950108.f_1029[161 /*3*/], 1) >=150f){
return 1;
}
if(func_75()){
return 1;
...
func_106(func_107(), fVar1) + Var0 
};
uParam1->f_16[iParam2 /*14*/].f_6.f_4={
func_106(func_105(), fVar1) + Var0 
};
...
Vector3 func__106(struct<3> Param0, float fParam1){
struct<3> Var0;
float fVar1;
float fVar2;
fVar1=sin(fParam1);
