...
if(func_231(Local_91.f_0)){
if(timera() > 5000){
if((MISC::GET_GAME_TIMER() > iLocal_292 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0)){
iLocal_85=2;
}}}elseif((MISC::GET_GAME_TIMER() > iLocal_292 + 25000 || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, 1, 0)){
iLocal_85=2;
}}
...
if(!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_293) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_294)){
if(func_245(400)){
bLocal_303=true;
}}
if(bLocal_303){
...
if(PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_293)==1f){
if(func_320(Local_91.f_0)){
...
TASK::TASK_SYNCHRONIZED_SCENE(Local_91.f_0, uLocal_294, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_294, 0);
CAM::SET_CAM_ACTIVE(uLocal_286, 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_286, uLocal_294, "Base_Jump_Spot_02_CAM", "rcmextreme4");
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_91.f_0, 0, 0);
CAM::DESTROY_CAM(uLocal_285, 0);
iLocal_301=1;
}}}}elseif(!iLocal_302){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_294) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_294) >=0.2f){
...
if(func_320(Local_91.f_0)){
uLocal_295=PED::CREATE_SYNCHRONIZED_SCENE(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
uLocal_287=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 1);
TASK::TASK_SYNCHRONIZED_SCENE(Local_91.f_0, uLocal_295, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_295, 1);
CAM::SET_CAM_ACTIVE(uLocal_287, 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_287, uLocal_295, "Fall_and_impact_CAM", "rcmextreme4");
AUDIO::PLAY_SYNCHRONIZED_AUDIO_EVENT(uLocal_295);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_91.f_0, 0, 0);
CAM::DESTROY_CAM(uLocal_286, 0);
iLocal_302=1;
}}}elseif(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_295) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_295) >=0.323f){
if(!iLocal_298){
...
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_295) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_295) >=0.44f){
uLocal_104=GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, 0);
GRAPHICS::SET_PARTICLE_FX_LOOPED_ALPHA(uLocal_104, 1f);
iLocal_304=1;
}}}
...
if(iVar0 !=7){
CAM::DESTROY_CAM(uLocal_287, 0);
uLocal_284=CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
CAM::SET_CAM_PARAMS(uLocal_284, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
...
if(bLocal_303){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_295)){
AUDIO::STOP_SYNCHRONIZED_AUDIO_EVENT(uLocal_295);
}
...
Var4={
ENTITY::GET_ENTITY_COORDS(Local_91.f_0, 1) 
};
if(Var4.f_2 > 155f){
fVar5=155f;
}else{
...
ENTITY::SET_ENTITY_COORDS(Local_91.f_0, 1657.046f, -17.4571f, fVar5, 1, 0, 0, 1);
}}
...
if(func_231(Local_91.f_0)){
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_295)){
PED::SET_SYNCHRONIZED_SCENE_PHASE(uLocal_295, 1f);
}
TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_91.f_0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_91.f_0, 0, 0);
ENTITY::SET_ENTITY_COORDS(Local_91.f_0, 1655.77f, -20.04f, 135.8f, 1, 0, 0, 1);
...
AUDIO::STOP_SOUND(uLocal_289);
if(CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY()){
CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION("Dom", 8, 2, 0, 0);
}
if(!func_269()){
if(func_263(1, 20f, 1)){
if((!iLocal_305 || MISC::GET_GAME_TIMER() > iLocal_306 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, 0, 1, 0)){
...
if(func_320(Local_91.f_0)){
ENTITY::FREEZE_ENTITY_POSITION(Local_91.f_0, 0);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_103) && !ENTITY::IS_ENTITY_DEAD(iLocal_103, 0)){
ENTITY::SET_ENTITY_VISIBLE(iLocal_103, 0, 0);
}
...
uLocal_288=PED::ADD_SCENARIO_BLOCKING_AREA(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
iLocal_85=1;
}}}
break;
case 1:
...
TASK::TASK_SYNCHRONIZED_SCENE(Local_91.f_0, uLocal_293, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_293, 1);
CAM::SET_CAM_ACTIVE(uLocal_285, 1);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_285, uLocal_293, "Base_Jump_Spot_CAM", "rcmextreme4");
CAM::RENDER_SCRIPT_CAMS(1, 0, 3000, 1, 0, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_91.f_0, 0, 0);
iLocal_90=1;
}
...
RECORDING::REPLAY_STOP_EVENT();
if(ENTITY::DOES_ENTITY_EXIST(iLocal_103) && !ENTITY::IS_ENTITY_DEAD(iLocal_103, 0)){
ENTITY::SET_ENTITY_VISIBLE(iLocal_103, 1, 0);
}
if(iLocal_87==0){
...
void func_250(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
var uVar0;
uVar0=PLAYER::GET_PLAYER_INDEX();
...
void func_253(struct<3> Param0, float fParam1){
int iVar0;
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
...
void func_254(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9){
...
PED::SET_PED_COMBAT_ATTRIBUTES(Local_80.f_28[0], 17, 1);
}
iLocal_290=0;
iLocal_305=1;
func_281("EXT4_01", 7500, 1);
uLocal_94=func_280(Local_91.f_0, 1, 1, 5);
settimera(0);
iLocal_85=1;
break;
case 1:
...
TASK::TASK_PERFORM_SEQUENCE(Local_91.f_0, uLocal_95);
}}}
...
if(AUDIO::HAS_SOUND_FINISHED(uLocal_289)){
...
if(AUDIO::HAS_SOUND_FINISHED(uLocal_289)){
AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_289, "DOM", Local_91.f_0, "EXTREME_04_SOUNDSET", 0, 0);
}}}}
...
MISC::CLEAR_AREA_OF_VEHICLES(Local_91.f_1, 20f, 0, 0, 0, 0, 0, 0, 0);
...
iLocal_100=OBJECT::CREATE_OBJECT(joaat("prop_box_wood01a"), 1666.282f, -11.20408f, 172.7773f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_100, 0.000637f, -0.000136f, 10.66059f, 2, 1);
}
if(!ENTITY::DOES_ENTITY_EXIST(iLocal_101)){
iLocal_101=OBJECT::CREATE_OBJECT(joaat("prop_box_wood01a"), 1667.076f, -12.07778f, 173.2611f, 1, 1, 0);
...
if(func_320(Local_91.f_0)){
PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(Local_91.f_0, 0);
...
void func_285(var uParam0, struct<3> Param1, float fParam2){
func_286(uParam0, iLocal_79, Param1, fParam2, 26);
...
void func_286(var uParam0, int iParam1, struct<3> Param2, var uParam3, int iParam4){
func_287(uParam0);
...
void func_293(struct<3> Param0, float fParam1, int iParam2, int iParam3){
if(func_338()){
...
CAM::SET_GAMEPLAY_HINT_CAMERA_BLEND_TO_FOLLOW_PED_MEDIUM_VIEW_MODE(1);
CAM::SET_GAMEPLAY_ENTITY_HINT(Local_91.f_0, 0f, 0f, 0f, 1, 30000, 2000, 2000, 0);
CAM::SET_GAMEPLAY_HINT_FOV(fVar0);
CAM::SET_GAMEPLAY_HINT_FOLLOW_DISTANCE_SCALAR(fVar1);
CAM::SET_GAMEPLAY_HINT_BASE_ORBIT_PITCH_OFFSET(fVar2);
CAM::SET_GAMEPLAY_HINT_CAMERA_RELATIVE_SIDE_OFFSET(fVar3);
...
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_91.f_0, 1), 1);
if(iLocal_89==0){
if(fVar0 > 160f){
iLocal_89=1;
}}elseif(fVar0 > 200f){
...
HUD::SET_BLIP_FLASHES(uLocal_94, 1);
}}elseif(HUD::DOES_BLIP_EXIST(uLocal_94)){
HUD::SET_BLIP_FLASHES(uLocal_94, 0);
}}
...
Var4={
func_304(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
iLocal_99=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_99, 90f, 0f, -63f, 2, 1);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_99, 1);
ENTITY::SET_ENTITY_VISIBLE(iLocal_99, 0, 0);
}
func_325(1);
if(!ENTITY::DOES_ENTITY_EXIST(Local_91.f_0)){
func_322(&Local_91, 52, Local_91.f_1, Local_91.f_4, "Ext4-Dom", 1);
ENTITY::FREEZE_ENTITY_POSITION(Local_91.f_0, 1);
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_91.f_0, 1);
WEAPON::REMOVE_ALL_PED_WEAPONS(Local_91.f_0, 1);
PED::SET_PED_COMPONENT_VARIATION(Local_91.f_0, 8, 2, 0, 0);
AUDIO::DISABLE_PED_PAIN_AUDIO(Local_91.f_0, 1);
PED::SET_PED_CONFIG_FLAG(Local_91.f_0, 137, 1);
PED::SET_PED_CONFIG_FLAG(Local_91.f_0, 118, 0);
PED::SET_PED_CONFIG_FLAG(Local_91.f_0, 208, 1);
