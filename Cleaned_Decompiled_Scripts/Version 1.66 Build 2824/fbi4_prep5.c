...
int func_39(var uParam0, struct<3> Param1, var uParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_27(uParam0)){
...
case 0:
if(func_95(iLocal_81, bLocal_28)){
func_108(&uLocal_197, Local_200, 1, 1, "PRE_BLIP");
if(HUD::DOES_BLIP_EXIST(uLocal_197)){
HUD::SET_BLIP_COLOUR(uLocal_197, 2);
HUD::SET_BLIP_ROUTE_COLOUR(uLocal_197, 2);
}
...
func_108(&uLocal_197, Local_200, 1, 1, "PRE_SHOP");
}elseif(func_105(PLAYER::PLAYER_PED_ID(), Local_200, 12f, 1)){
if(iLocal_195){
func_22(&uLocal_197);
iLocal_195=0;
}
...
bool func_105(int iParam0, struct<3> Param1, float fParam2, int iParam3){
...
void func_108(var uParam0, struct<3> Param1, int iParam2, bool bParam3, char* sParam4){
if(!HUD::DOES_BLIP_EXIST(*uParam0)){
*uParam0=func_109(Param1, 5, iParam2);
if(bParam3){
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(*uParam0, sParam4);
}}}

int func_109(struct<3> Param0, int iParam1, int iParam2){
int iVar0;
iVar0=0;
...
if(!func_190() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
bool func_204(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_205(struct<3> Param0, float fParam1){
return func_206(&(Global_107196.f_2890), Param0, fParam1, 0);
}

int func_206(var uParam0, struct<3> Param1, float fParam2, bool bParam3){
int iVar0;
struct<3> Var1;
bool bVar2;
var uVar3;
...
int func_208(int iParam0, struct<3> Param1, bool bParam2){
int iVar0;
var uVar1[3];
int iVar2;
int iVar3;
...
iVar3=0;
while (iVar3 <=(iVar2 - 1)){
if(func_209(iParam0, uVar1[iVar3], 1) && func_97(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0)){
if((!bParam2 || func_204(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f){
...
bool func_237(struct<3> Param0, int iParam1){
return func_238(Global_107196.f_2890.f_12.f_66, Param0, iParam1);
}

int func_238(int iParam0, struct<3> Param1, int iParam2){
struct<3> Var0;
struct<3> Var1;
if(iParam0==0){
return 0;
...
func_247(2);
}elseif(!func_105(PLAYER::PLAYER_PED_ID(), Local_200, 75f, 1)){
if(!bLocal_201){
HUD::CLEAR_PRINTS();
...
void func_294(struct<3> Param0, float fParam1, int iParam2, int iParam3){
if(func_295()){
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(uVar1, 10, -1, 0, -1, func_310(iParam0));
if(iVar11 > iVar10){
...
if(CAM::DOES_CAM_EXIST(uLocal_198)){
CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
CAM::DESTROY_CAM(uLocal_198, 0);
}}
