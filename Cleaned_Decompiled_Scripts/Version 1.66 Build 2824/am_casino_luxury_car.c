...
if(!func_95() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(uParam0, iParam1, iParam2)){
return 1;
}
return 0;
}
...
return 1;
}}elseif(func_118(func_255(iVar1), Param0, fParam1, iParam2, 1036831949)){
return 1;
...
if(!func_173(Var1)){
Var1={
func_168(Var1, &fVar2, iVar7, uParam2->f_9, *uParam2, iVar8, uParam2->f_11, uParam2->f_34, &bVar9, bVar10, 1, uParam2->f_51, uParam2->f_60) 
};
if(vmag(Var1) > 0f){
if(!func_167(Var1, 5f)){
...
elseif(func_199(Var1, 6f, 1f, 1f, 5f, iVar17, bVar18, iVar19, fVar20, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_117(Var1, fVar2, uParam2->f_34, 1, 1, 0, 0, 0, 0)){
iVar21=1;
}
}
...
return 1;
}}elseif(vdist(func_255(iVar1), Param0) < 1f){
return 1;
}}elseif(Global_2648605.f_261[iVar0]){
if(vdist(Global_2648605.f_131[iVar0 /*3*/], Param0) < fParam1){
return 1;
...
if(vmag(*uParam3) > 0f){
*uParam3={
func_168(*uParam3, fParam4, iParam7, uParam5->f_9, *uParam5, iParam6, uParam5->f_11, uParam5->f_34, &bParam11, 0, 0, uParam5->f_51, uParam5->f_60) 
};
if(!func_173(*uParam3)){
iVar0=999;
return;
...
Vector3 func__168(struct<3> Param0, var uParam1, int iParam2, bool bParam3, struct<3> Param4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10, bool bParam11, var uParam12){
struct<3> Var0;
var uVar1;
var uVar2;
var uVar3;
...
Vector3 func__184(struct<3> Param0, struct<3> Param1, struct<3> Param2, float fParam3, int iParam4, float fParam5, bool bParam6){
int iVar0;
struct<3> Var1;
switch (iParam4){
case 0:
...
bVar10=true;
}}elseif(func_199(Var3, 6f, 1f, 1f, 5f, iVar6, bVar7, iVar8, fVar9, uParam2->f_58, -1, 1, 0f, 0, 0, 0, 0) && !func_117(Var3, fVar4, uParam2->f_34, 1, 1, 0, 0, uParam2->f_58, 0)){
bVar10=true;
}
}
if(bVar10){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_201(PLAYER::PLAYER_ID()), Param0, 1) <=(fVar2 + fParam1)){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_201(iVar1), Param0, 1) <=(fVar2 + fParam1)){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_255(iVar1), Param0, 1) < fParam1){
return 1;
}}
}}}}}
iVar0++;
...
break;
}}elseif(func_229(Param0, &iVar2, &iVar3) || (func_206(Param0, &(iVar2[0])) && (VEHICLE::IS_THIS_MODEL_A_PLANE(iParam1) || VEHICLE::IS_THIS_MODEL_A_HELI(iParam1)))){
func_248();
iVar0=0;
while (iVar0 < iVar2){
if(iVar2[iVar0] > 1000){
...
iVar0=(iParam1 / 32);
iVar1=(iParam1 % 32);
return MISC::IS_BIT_SET(Local_87[iParam0 /*4*/].f_2[iVar0], iVar1);
}
...
uLocal_92=HUD::ADD_BLIP_FOR_ENTITY(func_16());
HUD::SET_BLIP_SPRITE(uLocal_92, func_299());
func_296(&uLocal_92, func_298());
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_92, func_295());
...
uVar1=NETWORK::NETWORK_GET_PLAYER_INDEX(iLocal_88[iVar0]);
...
iVar0=(iParam0 / 32);
iVar1=(iParam0 % 32);
return MISC::IS_BIT_SET(uLocal_89[iVar0], iVar1);
}
