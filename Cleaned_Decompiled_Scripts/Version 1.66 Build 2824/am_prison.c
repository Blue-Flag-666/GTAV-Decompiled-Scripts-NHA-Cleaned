...
func_5(&(Local_98.f_1));
}elseif(func_2(&(Local_98.f_1)) > 20f){
...
Local_98.f_4=PED::ADD_SCENARIO_BLOCKING_AREA(1413.703f, 2341.517f, -232.3945f, 2016.209f, 2998.893f, 161.0299f, 0, 1, 1, 1);
}
...
case 2:
if(Global_1836156 || func_23(3)){
PED::REMOVE_SCENARIO_BLOCKING_AREA(Local_98.f_4, 0);
}
return 1;
break;
}
