...
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_58[0], iLocal_48, PED::GET_PED_BONE_INDEX(iLocal_48, 28422), 0f, -0.01f, -0.02f, Local_66, 1, 1, 0, 0, 2, 1, 0);
...
Var2={
ENTITY::GET_ENTITY_COORDS(iLocal_48, 0) 
};
fVar4=7.5f;
Var5={
fVar4, fVar4, fVar4 
...
if(!ENTITY::IS_ENTITY_ON_SCREEN(iLocal_48) && vdist2(Var2, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)) > 2500f){
...
iLocal_56=1;
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, sLocal_62, sLocal_64, 3)){
...
Local_57={
ENTITY::GET_ENTITY_COORDS(iLocal_48, 0) - Vector(1f, 0f, 0f) 
};
iLocal_56=1;
}else{
iLocal_56=3;
...
func_75();
}}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_48, sLocal_62, sLocal_65, 3)){
