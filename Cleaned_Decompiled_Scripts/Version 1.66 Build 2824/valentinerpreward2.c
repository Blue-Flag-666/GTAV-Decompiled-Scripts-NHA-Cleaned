...
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_20, "05", PLAYER::PLAYER_PED_ID(), "DLC_GR_CS2_Sounds", 0, 0);
}}elseif(func_25(&uLocal_13, 4000, 0)){
...
iLocal_6=OBJECT::CREATE_OBJECT_NO_OFFSET(iVar0, 360.8759f, 5623.427f, 780.1747f, 0, 0, 1);
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iVar0);
ENTITY::FREEZE_ENTITY_POSITION(iLocal_6, 1);
...
Local_17={
ENTITY::GET_ENTITY_COORDS(iLocal_6, 0) 
};
iLocal_18=0;
}}else{
func_14();
...
AUDIO::PLAY_SOUND_FROM_ENTITY(iLocal_19, "07", iLocal_6, "DLC_GR_CS2_Sounds", 0, 0);
}
if(!iLocal_8){
if(func_25(&uLocal_9, 4500, 0)){
ENTITY::FREEZE_ENTITY_POSITION(iLocal_6, 0);
func_5(&uLocal_9, 0, 0);
func_24(&uLocal_9);
...
fVar4=(fVar4 * fVar3);
Var5={
func_8(Local_17, func_9(), fVar4) 
};
ENTITY::SET_ENTITY_COORDS(iLocal_6, Var5, 1, 0, 0, 1);
if(fVar4 >=1f){
iLocal_18++;
Local_17={
ENTITY::GET_ENTITY_COORDS(iLocal_6, 0) 
...
Vector3 func__8(struct<3> Param0, struct<3> Param1, float fParam2){
...
var func__12(var uParam0, bool bParam1, bool bParam2){
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1){
if(!bParam2){
...
struct<3> Var0;
Var0={
ENTITY::GET_ENTITY_ROTATION(iLocal_6, 2) 
};
Var0.f_0=0f;
Var0.f_1=0f;
Var0.f_2=(Var0.f_2 + 1f);
ENTITY::SET_ENTITY_ROTATION(iLocal_6, Var0, 2, 1);
}
...
int func_19(){
if(((((((func_23(22107, -1) && Global_2639783==7) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)) && func_22(PLAYER::PLAYER_PED_ID(), 426.433f, 5614.172f, 766.414f, 1f)) && Global_2684801.f_3076.f_178 >=1) && Global_2684801.f_3076.f_178 < 4) && func_21()) && func_20()){
return 1;
}
return 0;
}
...
bVar0=false;
if(!func_38(PLAYER::PLAYER_ID(), 1, 0) && !MISC::IS_BIT_SET(Global_1950108, 27)){
bVar0=true;
}
if(!bVar0 && !func_36()){
bVar0=true;
...
if(!bVar0){
if((((func_35(PLAYER::PLAYER_PED_ID()) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) && CAM::IS_SCREEN_FADED_IN()) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_34(PLAYER::PLAYER_ID())){
if(!func_32(PLAYER::PLAYER_ID()) && !MISC::IS_BIT_SET(Global_1950108, 27)){
bVar0=true;
}}}
if(bVar0){
Global_1950091=0;
...
}elseif((Global_1575060 && iParam0==PLAYER::PLAYER_ID()) && func_38(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7 !=-1;
}}
return 0;
}
...
switch (iParam0){
case 0:
return MISC::IS_BIT_SET(Global_1950108.f_2654[iVar0], uVar1);
break;
case 1:
return MISC::IS_BIT_SET(Global_1950108.f_2661[iVar0], uVar1);
break;
case 2:
return MISC::IS_BIT_SET(Global_1950108.f_2668[iVar0], uVar1);
break;
case 3:
return MISC::IS_BIT_SET(Global_1950108.f_3325[iVar0], uVar1);
break;
case 4:
return MISC::IS_BIT_SET(Global_1950108.f_3332[iVar0], uVar1);
break;
case 5:
return MISC::IS_BIT_SET(Global_1950108.f_3618[iVar0], uVar1);
break;
case 6:
return MISC::IS_BIT_SET(Global_1950108.f_3625[iVar0], uVar1);
break;
case 7:
return MISC::IS_BIT_SET(Global_1950108.f_3632[iVar0], uVar1);
break;
case 8:
return MISC::IS_BIT_SET(Global_1950108.f_3655[iVar0], uVar1);
break;
case 9:
return MISC::IS_BIT_SET(Global_1950108.f_3662[iVar0], uVar1);
break;
case 10:
return MISC::IS_BIT_SET(Global_1950108.f_3339[iVar0], uVar1);
break;
case 11:
return MISC::IS_BIT_SET(Global_1950108.f_3639[iVar0], uVar1);
break;
case 12:
return MISC::IS_BIT_SET(Global_1950108.f_3646[iVar0], uVar1);
break;
case 13:
return MISC::IS_BIT_SET(Global_1950108.f_3349[iVar0], uVar1);
break;
}
return 0;
}
...
if(!iLocal_75){
if((((((((func_38(PLAYER::PLAYER_ID(), 1, 1) && !Global_1935176) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) && !Global_4521801.f_910==1) && !func_58()) && func_54(PLAYER::PLAYER_PED_ID(), -1352.45f, 146.7562f, -99.6944f, 50f)) && func_22(PLAYER::PLAYER_PED_ID(), -1352.45f, 146.7562f, -99.6944f, 1f)) && !func_53()) && !Global_262145.f_26641){
if((func_52() || PAD::IS_CONTROL_JUST_PRESSED(0, 51)) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, 51)){
iLocal_75=1;
}}}elseif(((((!func_38(PLAYER::PLAYER_ID(), 1, 1) || Global_4521801.f_910==1) || func_58()) || !func_54(PLAYER::PLAYER_PED_ID(), -1352.45f, 146.7562f, -99.6944f, 50f)) || !func_22(PLAYER::PLAYER_PED_ID(), -1352.45f, 146.7562f, -99.6944f, 1f)) || Global_262145.f_26641){
if(!Global_1935176){
Global_1935176=1;
}elseif(!func_52()){
Global_1935176=0;
...
return func_55(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_HEADING(iParam0), Param1, fParam2);
}
...
Vector3 func__57(struct<3> Param0){
float fVar0;
float fVar1;
fVar0=vmag(Param0);
if(fVar0 !=0f){
...
struct<4> Var1;
struct<16> Var2;
if(Global_2766490 || ((func_38(PLAYER::PLAYER_ID(), 1, 1) && func_36()) && !iLocal_74)){
iLocal_74=1;
StringCopy(&Var0, "&#166;
", 16);
StringCopy(&Var1, "&#8249;
...
StringCopy(&Var2, func_65(PLAYER::PLAYER_ID()), 64);
if(func_89(&Var2, Var0) || func_89(&Var2, Var1)){
func_62(Var2);
}}}}
...
if(func_49(iParam0, 28) || (func_49(PLAYER::PLAYER_ID(), 28) && !func_68(iParam0))){
return sVar0;
}
...
iVar0=0;
while (iVar0 < 7){
if(Global_1894573[PLAYER::PLAYER_ID() /*608*/].f_10.f_11[iVar0] !=func_33()){
if(NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1894573[PLAYER::PLAYER_ID() /*608*/].f_10.f_11[iVar0])){
SCRIPT::SEND_TU_SCRIPT_EVEN(1, &Var1, 2, func_73(Global_1894573[PLAYER::PLAYER_ID() /*608*/].f_10.f_11[iVar0]));
}}
iVar0++;
}}


var func__73(bool bParam0){
var uVar0;
if(bParam0 !=-1){
...
if((!func_66() && NETWORK::NETWORK_CHECK_USER_CONTENT_PRIVILEGES(0, -1, 1)) || func_77()){
func_76(28);
}else{
func_75(28);
}}
...
if(((func_49(iVar0, 28) || func_49(PLAYER::PLAYER_ID(), 28)) || func_93(iVar0)) && !func_68(iVar0)){
...
var func__91(int iParam0, bool bParam1){
if(!bParam1){
...
break;
case 2:
if(NETSHOPPING::NET_GAMESERVER_BEGIN_SERVICE(uParam0, 1474183246, func_98(uParam0->f_2), -50712147, 0, 1)){
...
if(bParam0){
return MISC::IS_BIT_SET(func_18(9618, -1, 0), 0);
}
...
bool bVar0;
struct<101> Var1;
if(((iLocal_68 > 2 || !NETWORK::NETWORK_IS_GAME_IN_PROGRESS()) || !func_105()) || !func_248(PLAYER::PLAYER_ID())){
return;
}
...
if(func_35(PLAYER::PLAYER_PED_ID()) && func_244()){
...
}}elseif(func_154(&iLocal_72, iLocal_67)){
if(iLocal_72==2){
func_148(func_152());
iLocal_72=0;
if(iLocal_68==0){
...
int iVar35;
char* sVar36;
iVar10=func_204(ENTITY::GET_ENTITY_MODEL(iParam1));
...
if(VEHICLE::GET_NUM_MOD_KITS(iParam1) <=0 && func_203(ENTITY::GET_ENTITY_MODEL(iParam1))){
...
iVar12=func_197(ENTITY::GET_ENTITY_MODEL(iParam1));
iVar13=func_195(ENTITY::GET_ENTITY_MODEL(iParam1));
iVar14=func_191(ENTITY::GET_ENTITY_MODEL(iParam1));
iVar15=func_190(ENTITY::GET_ENTITY_MODEL(iParam1));
iVar16=func_189(iParam1);
if(bVar11){
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_0_v", "VEM_SPOILER", VEHICLE::GET_VEHICLE_MOD(iParam1, 0) + 1, 14, iVar12, -1, iParam1, 0)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_1_v", "VEM_BUMPER_F", VEHICLE::GET_VEHICLE_MOD(iParam1, 1) + 1, 34, iVar12, -1, iParam1, 1)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_2_v", "VEM_BUMPER_R", VEHICLE::GET_VEHICLE_MOD(iParam1, 2) + 11, 35, iVar12, -1, iParam1, 2)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_3_v", "VEM_SKIRT", VEHICLE::GET_VEHICLE_MOD(iParam1, 3) + 1, 13, iVar12, -1, iParam1, 3)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_4_v", "VEM_EXHAUST", VEHICLE::GET_VEHICLE_MOD(iParam1, 4) + 1, 6, iVar12, -1, iParam1, 4)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_5_v", "VEM_CHASSIS", VEHICLE::GET_VEHICLE_MOD(iParam1, 5) + 1, 4, iVar12, -1, iParam1, 5)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_6_v", "VEM_GRILL", VEHICLE::GET_VEHICLE_MOD(iParam1, 6) + 1, 8, iVar12, -1, iParam1, 6)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_7_v", "VEM_HOOD", VEHICLE::GET_VEHICLE_MOD(iParam1, 7) + 1, 9, iVar12, -1, iParam1, 7)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_8_v", "VEM_FENDER_L", VEHICLE::GET_VEHICLE_MOD(iParam1, 8) + 1, 36, iVar12, -1, iParam1, 8)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_9_v", "VEM_FENDER_R", VEHICLE::GET_VEHICLE_MOD(iParam1, 9) + 6, 37, iVar12, -1, iParam1, 9)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_10_v", "VEM_ROOF", VEHICLE::GET_VEHICLE_MOD(iParam1, 10) + 1, 12, iVar12, iVar16, iParam1, 10)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_11_v", "VEM_ENGINE", VEHICLE::GET_VEHICLE_MOD(iParam1, 11) + 1, 5, iVar12, -1, iParam1, 11)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_12_v", "VEM_BRAKE", VEHICLE::GET_VEHICLE_MOD(iParam1, 12) + 1, 2, iVar12, -1, iParam1, 12)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_13_v", "VEM_TRANS", VEHICLE::GET_VEHICLE_MOD(iParam1, 13) + 1, 16, iVar12, -1, iParam1, 13)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_15_v", "VEM_SUSPENSION", VEHICLE::GET_VEHICLE_MOD(iParam1, 15) + 1, 15, iVar12, -1, iParam1, 15)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_16_v", "VEM_ARMOUR", VEHICLE::GET_VEHICLE_MOD(iParam1, 16) + 1, 1, iVar12, -1, iParam1, 16)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_18_v", "VEM_TURBO", func_187(VEHICLE::IS_TOGGLE_MOD_ON(iParam1, 18)), 17, iVar12, -1, 0, 23)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_22_v", "VEM_HLIGHT", func_187(VEHICLE::IS_TOGGLE_MOD_ON(iParam1, 22)), 11, iVar12, -1, 0, 23)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_0_v", "VEM_SUPERMOD_0", VEHICLE::GET_VEHICLE_MOD(iParam1, 25) + 1, 41, iVar13, -1, iParam1, 25)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_1_v", "VEM_SUPERMOD_1", VEHICLE::GET_VEHICLE_MOD(iParam1, 26) + 1, 42, iVar13, -1, iParam1, 26)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_2_v", "VEM_SUPERMOD_2", VEHICLE::GET_VEHICLE_MOD(iParam1, 27) + 1, 43, iVar13, -1, iParam1, 27)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_3_v", "VEM_SUPERMOD_3", VEHICLE::GET_VEHICLE_MOD(iParam1, 28) + 1, 44, iVar13, -1, iParam1, 28)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_4_v", "VEM_SUPERMOD_4", VEHICLE::GET_VEHICLE_MOD(iParam1, 29) + 1, 45, iVar13, -1, iParam1, 29)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_5_v", "VEM_SUPERMOD_5", VEHICLE::GET_VEHICLE_MOD(iParam1, 30) + 1, 46, iVar13, -1, iParam1, 30)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_6_v", "VEM_SUPERMOD_6", VEHICLE::GET_VEHICLE_MOD(iParam1, 31) + 1, 47, iVar13, -1, iParam1, 31)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_7_v", "VEM_SUPERMOD_7", VEHICLE::GET_VEHICLE_MOD(iParam1, 32) + 1, 48, iVar13, -1, iParam1, 32)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_8_v", "VEM_SUPERMOD_8", VEHICLE::GET_VEHICLE_MOD(iParam1, 33) + 1, 49, iVar13, -1, iParam1, 33)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_9_v", "VEM_SUPERMOD_9", VEHICLE::GET_VEHICLE_MOD(iParam1, 34) + 1, 50, iVar13, -1, iParam1, 34)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_10_v", "VEM_SUPERMOD_10", VEHICLE::GET_VEHICLE_MOD(iParam1, 35) + 1, 51, iVar13, -1, iParam1, 35)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_11_v", "VEM_SUPERMOD_11", VEHICLE::GET_VEHICLE_MOD(iParam1, 36) + 1, 52, iVar13, -1, iParam1, 36)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_12_v", "VEM_SUPERMOD_12", VEHICLE::GET_VEHICLE_MOD(iParam1, 37) + 1, 53, iVar13, -1, iParam1, 37)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_13_v", "VEM_SUPERMOD_13", VEHICLE::GET_VEHICLE_MOD(iParam1, 38) + 1, 54, iVar13, -1, iParam1, 38)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_14_v", "VEM_SUPERMOD_14", VEHICLE::GET_VEHICLE_MOD(iParam1, 39) + 1, 55, iVar13, -1, iParam1, 39)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_15_v", "VEM_SUPERMOD_15", VEHICLE::GET_VEHICLE_MOD(iParam1, 40) + 1, 56, iVar13, -1, iParam1, 40)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_16_v", "VEM_SUPERMOD_16", VEHICLE::GET_VEHICLE_MOD(iParam1, 41) + 1, 57, iVar13, -1, iParam1, 41)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_17_v", "VEM_SUPERMOD_17", VEHICLE::GET_VEHICLE_MOD(iParam1, 42) + 1, 58, iVar13, -1, iParam1, 42)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_18_v", "VEM_SUPERMOD_18", VEHICLE::GET_VEHICLE_MOD(iParam1, 43) + 1, 59, iVar13, -1, iParam1, 43)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_19_v", "VEM_SUPERMOD_19", VEHICLE::GET_VEHICLE_MOD(iParam1, 44) + 1, 60, iVar13, -1, iParam1, 44)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_20_v", "VEM_SUPERMOD_20", VEHICLE::GET_VEHICLE_MOD(iParam1, 45) + 1, 61, iVar13, -1, iParam1, 45)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_21_v", "VEM_SUPERMOD_21", VEHICLE::GET_VEHICLE_MOD(iParam1, 46) + 1, 62, iVar13, -1, iParam1, 46)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_22_v", "VEM_SUPERMOD_22", VEHICLE::GET_VEHICLE_MOD(iParam1, 47) + 1, 63, iVar13, -1, iParam1, 47)){
return 0;
}
if(!func_188(iParam0, "PACKED_MP_VEH_MOD_IDX_S_23_v", "VEM_SUPERMOD_23", VEHICLE::GET_VEHICLE_MOD(iParam1, 48) + 1, 64, iVar14, -1, iParam1, 48)){
return 0;
}}
if(bVar11){
uVar17=func_186(VEHICLE::GET_VEHICLE_MOD_IDENTIFIER_HASH(iParam1, 14, VEHICLE::GET_VEHICLE_MOD(iParam1, 14)));
...
return 0;
}}elseif(!func_188(iParam0, "PACKED_MP_VEH_MOD_VAR_0_v", "VEM_CMOD_TYR", 1, 32, iVar12, -1, 0, 23)){
return 0;
}
...
return 0;
}}elseif(!func_188(iParam0, "PACKED_MP_VEH_MOD_VAR_1_v", "VEM_CMOD_TYR", 1, 32, iVar12, -1, 0, 23)){
return 0;
}}
...
break;
case 0:
if(func_177(ENTITY::GET_ENTITY_MODEL(iParam1)) || VEHICLE::IS_VEHICLE_MODEL(iParam1, joaat("oppressor2"))){
iVar29=255;
break;
}
break;
...
iVar30=func_175(VEHICLE::GET_VEHICLE_NEON_ENABLED(iParam1, 2), (VEHICLE::GET_VEHICLE_NEON_ENABLED(iParam1, 0) || VEHICLE::GET_VEHICLE_NEON_ENABLED(iParam1, 1)), VEHICLE::GET_VEHICLE_NEON_ENABLED(iParam1, 3));
if(bVar11){
...
if(!func_188(iParam0, "PACKED_MP_VEH_LIVERY_0_v", "VEM_LIVERY", VEHICLE::GET_VEHICLE_LIVERY(iParam1), 26, iVar12, func_170(ENTITY::GET_ENTITY_MODEL(iParam1)), 0, 23)){
return 0;
}}
if(VEHICLE::GET_VEHICLE_LIVERY2_COUNT(iParam1) > 1){
if(!func_188(iParam0, "PACKED_MP_VEH_LIVERY2_0_v", "VEM_LIVERY2", VEHICLE::GET_VEHICLE_LIVERY2(iParam1), 39, iVar14, func_170(ENTITY::GET_ENTITY_MODEL(iParam1)), 0, 23)){
return 0;
}}
if(bVar11){
...
if(iParam2 && bVar11){
if(!func_163(iParam0, "PACKED_NG_VEHICLE_INSURANCE_v", ENTITY::GET_ENTITY_MODEL(iParam1))){
return 0;
}}elseif(bVar11){
...
return func_205(78225582, -1224924353, MISC::GET_HASH_KEY(&cVar1), 478352891, 1, 0, 1, 4, MISC::GET_HASH_KEY(&cVar0), 3);
}
...
return func_205(78225582, -1224924353, MISC::GET_HASH_KEY(&cVar2), 478352891, 1, 0, 1, 4, MISC::GET_HASH_KEY(&cVar0), 3);
}
...
StringCopy(&cVar0, sParam1, 64);
StringIntConCat(&cVar0, iParam0, 64);
iVar1=func_182(VEHICLE::GET_VEHICLE_WHEEL_TYPE(iParam2));
if(!NETSHOPPING::NET_GAMESERVER_CATALOG_ITEM_KEY_IS_VALID(iVar1)){
return 1;
}
return func_205(78225582, -1224924353, iVar1, 478352891, 1, 0, 1, 4, MISC::GET_HASH_KEY(&cVar0), 3);
}
...
return func_205(78225582, -1224924353, iParam2, 478352891, 1, 0, 1, 4, MISC::GET_HASH_KEY(&cVar0), 3);
}
...
if(func_196(ENTITY::GET_ENTITY_MODEL(iParam0))){
if(uParam1->f_9[44]==2){
...
if((!func_218(4) && !bParam4) && !NETWORK::NETWORK_IS_ACTIVITY_SESSION()){
}
if(func_217(iVar0)){
...
if(func_215(uParam1->f_81) && NETWORK::NETWORK_IS_GAMER_IN_MY_SESSION(&(uParam1->f_81))){
...
if(Global_32163==0){
return MISC::IS_BIT_SET(func_18(func_221(iParam0), -1, 0), iParam1);
}}else{
...
iVar0=1;
if(MISC::IS_BIT_SET(uParam1->f_77, func_137(iVar0 + 1))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_137(iVar0 + 1));
}}elseif(uParam1->f_66==joaat("sandking") || uParam1->f_66==joaat("sandking2")){
iVar1=1;
if(MISC::IS_BIT_SET(uParam1->f_77, func_137(iVar1 + 1))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_137(iVar1 + 1));
}}elseif(uParam1->f_66==joaat("formula") || uParam1->f_66==joaat("formula2")){
iVar2=1;
while (iVar2 <=9){
if(MISC::IS_BIT_SET(uParam1->f_77, func_137(iVar2))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_137(iVar2));
}
iVar2++;
}}elseif(uParam1->f_66==joaat("openwheel1")){
iVar3=1;
while (iVar3 <=6){
if(MISC::IS_BIT_SET(uParam1->f_77, func_137(iVar3))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_137(iVar3));
}
iVar3++;
...
while (iVar4 <=11){
if(iVar4 !=9 && iVar4 !=10){
if(MISC::IS_BIT_SET(uParam1->f_77, func_137(iVar4))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_137(iVar4));
}}
iVar4++;
}}elseif(uParam1->f_66==joaat("surfer3")){
iVar5=1;
while (iVar5 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_137(iVar5))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_137(iVar5));
}
iVar5++;
}}elseif(uParam1->f_66==joaat("dinghy5")){
if(MISC::IS_BIT_SET(uParam1->f_77, func_137(4))){
}else{
...
iVar6=1;
while (iVar6 <=2){
if(MISC::IS_BIT_SET(uParam1->f_77, func_137(iVar6))){
}else{
MISC::SET_BIT(&(uParam1->f_77), func_137(iVar6));
}
iVar6++;
}}
...
if((MISC::IS_BIT_SET(uParam1->f_77, 15) || func_236(iParam0)) || (((uParam1->f_62==0 && uParam1->f_63==0) && uParam1->f_64==0) && uParam1->f_9[20] > 0)){
uParam1->f_62=0;
uParam1->f_63=0;
uParam1->f_64=0;
...
iVar7=0;
while (iVar7 <=11){
if(MISC::IS_BIT_SET(uParam1->f_77, func_137(iVar7 + 1))){
...
if(((func_228() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))){
...
var func__231(var uParam0, var uParam1){
int iVar0;
int iVar1;
int iVar2;
iVar0=uParam1;
...
if(iParam0 !=-1){
return MISC::IS_BIT_SET(Global_1981514[iParam0 /*60*/].f_57, func_250(iParam1, 1));
}
return 0;
}
...
if(bParam1){
return MISC::IS_BIT_SET(func_18(10871, -1, 0), func_250(iParam0, 1));
}
...
if(func_35(PLAYER::PLAYER_PED_ID())){
if(!iLocal_56){
if(((MISC::IS_BIT_SET(Global_1950108, 27) && MISC::IS_BIT_SET(Global_1950108.f_5, 20)) && Global_2644490.f_1==17) && func_259(1)){
iLocal_56=1;
...
void func_260(){
if(!func_268()){
if(func_267(PLAYER::PLAYER_PED_ID(), 353.7142f, 4877.06f, -59.14812f, 1) < 16f && !NETWORK::NETWORK_IS_ACTIVITY_SESSION()){
func_261(1);
}}}
...
}elseif(func_25(&uLocal_51, iParam0, 0)){
func_24(&uLocal_51);
return 1;
}}else{
func_24(&uLocal_51);
...
void func_277(){
if(!MISC::IS_BIT_SET(Global_1981350.f_5, 0) && !func_278()){
...
if(func_283(PLAYER::PLAYER_ID()) && iVar1==1){
return 1237;
}
...
if(NETWORK::NETWORK_IS_GAME_IN_PROGRESS()){
if(!func_294()){
if(func_38(PLAYER::PLAYER_ID(), 1, 0)){
...
void func_295(){
if((NETWORK::NETWORK_IS_ACTIVITY_SESSION() || !func_36()) || !func_38(PLAYER::PLAYER_ID(), 0, 1)){
return;
}
if(!func_309(PLAYER::PLAYER_ID(), 0) || !func_308(PLAYER::PLAYER_ID())){
return;
}
if(func_307()){
func_296();
...
}elseif(func_25(&uLocal_48, 10000, 0)){
AUDIO::RELEASE_SCRIPT_AUDIO_BANK();
iLocal_50=1;
}}}elseif(func_26(&uLocal_48)){
func_24(&uLocal_48);
iLocal_50=0;
}}
...
void func_311(){
if((func_316(PLAYER::PLAYER_ID()) && func_35(PLAYER::PLAYER_PED_ID())) && CAM::IS_SCREEN_FADED_IN()){
if(!iLocal_47){
if((func_52() && MISC::ARE_STRINGS_EQUAL(&(Global_23270.f_1), "SUB_SUPPLIES")) && !func_22(PLAYER::PLAYER_PED_ID(), func_315(), 1.5f)){
iLocal_47=1;
}}else{
if(func_312(PLAYER::PLAYER_PED_ID())){
Global_44199=1;
}
if((func_52() && MISC::ARE_STRINGS_EQUAL(&(Global_23270.f_1), "SUB_SUPPLIES")) && func_22(PLAYER::PLAYER_PED_ID(), func_315(), 1f)){
iLocal_47=0;
}}}elseif(iLocal_47){
iLocal_47=0;
}}
...
bVar0=false;
while (bVar0 < 26){
if(MISC::IS_BIT_SET(iLocal_31, bVar0)){
AUDIO::SET_RADIO_STATION_AS_FAVOURITE(func_327(bVar0), 0);
MISC::CLEAR_BIT(&iLocal_31, bVar0);
}
bVar0++;
}
iLocal_32=0;
...
bVar1=false;
while (bVar1 < 26){
if(!MISC::IS_BIT_SET(iLocal_32, bVar1)){
if(MISC::IS_BIT_SET(iVar0, bVar1)){
}
MISC::SET_BIT(&iLocal_32, bVar1);
AUDIO::SET_RADIO_STATION_AS_FAVOURITE(func_327(bVar1), 1);
}
if(MISC::IS_BIT_SET(iVar0, bVar1) && !MISC::IS_BIT_SET(iLocal_31, bVar1)){
...
func_334(32);
if(bParam3){
if(func_336() >=0 && MISC::IS_BIT_SET(Global_1586468[func_336() /*142*/].f_103, 0)){
func_334(33);
}}else{
func_147(33);
}
...
iLocal_29=DECORATOR::DECOR_GET_INT(Global_2793046.f_299, "PV_Slot");
}}}elseif(Global_2359296[func_129() /*5568*/].f_681.f_2 !=iLocal_29){
if(!func_26(&uLocal_27)){
func_13(&uLocal_27, 1, 0);
}elseif(func_25(&uLocal_27, 10000, 1)){
...
}elseif(((Global_1575060 || Global_2635559.f_2680) && iParam0==PLAYER::PLAYER_ID()) && func_38(iParam0, 1, 0)){
return Global_2657589[iParam0 /*466*/].f_321.f_7;
}}
return -1;
}
...
if(((func_36() && func_38(PLAYER::PLAYER_ID(), 0, 1)) && CAM::IS_SCREEN_FADED_IN()) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())){
...
if(((((((((!func_35(PLAYER::PLAYER_PED_ID()) || !func_38(PLAYER::PLAYER_ID(), 1, 1)) || NETWORK::NETWORK_IS_ACTIVITY_SESSION()) || NETWORK::NETWORK_IS_IN_MP_CUTSCENE()) || !func_36()) || func_32(PLAYER::PLAYER_ID())) || func_348(PLAYER::PLAYER_ID())) || func_34(PLAYER::PLAYER_ID())) || Global_2672505.f_3542) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())){
return;
}
...
if(!iLocal_22){
if((Global_1950108.f_513 !=-1 && MISC::ARE_STRINGS_EQUAL(&(Global_23270.f_1), "MP_MAN_VEH1")) && func_351()==9){
iLocal_22=1;
}}elseif(!func_52()){
if(func_350()){
PAD::DISABLE_CONTROL_ACTION(2, 51, 1);
PAD::DISABLE_CONTROL_ACTION(2, 52, 1);
}elseif(func_35(Global_2793046.f_299)){
if(!func_350()){
func_332(1, 0, 1, 0, 0, 0, 0);
}}else{
iLocal_22=0;
...
if(func_353(PLAYER::PLAYER_PED_ID(), 0)==-1){
...
var func__354(char* sParam0, var uParam1){
...
var uVar0;
int iVar1;
if((func_38(PLAYER::PLAYER_ID(), 1, 1) && func_362(PLAYER::PLAYER_ID())) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())){
uVar0=PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
if(func_35(uVar0) && func_353(PLAYER::PLAYER_PED_ID(), 0)==-1){
...
PAD::DISABLE_CONTROL_ACTION(2, 52, 1);
Global_44199=1;
if(CAM::IS_GAMEPLAY_CAM_RENDERING() && !func_360("CMOD_FTRIG")){
func_359("CMOD_FTRIG");
}}}}elseif(iLocal_21){
iLocal_21=0;
func_358(45, 1, 1);
...
var uVar0;
if(!iLocal_44){
NETWORK::NETWORK_GET_LOCAL_HANDLE(&Local_45, 13);
...
if(!NETWORK::NETWORK_ARE_HANDLES_THE_SAME(&uVar0, &Local_45)){
