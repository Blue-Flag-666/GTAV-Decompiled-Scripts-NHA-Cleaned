...
}elseif(func_10(&uLocal_65, 10000, 0)){
Local_238.f_0=3;
}}
if(func_9()){
Local_238.f_0=3;
...
Local_61={
ENTITY::GET_ENTITY_COORDS(NETWORK::NET_TO_VEH(Local_238.f_2), 1) 
};
...
Var1={
Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 
};
...
}}}}elseif(func_10(&(Local_238.f_51), 750, 0)){
...
if(!MISC::IS_BIT_SET(uLocal_237, Local_238.f_50)){
Var1={
Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(0f, 5f, 5f) 
};
Var1.f_2=Local_61.f_2;
Var2={
Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(0f, 5f, 5f) 
...
MISC::GET_GROUND_Z_FOR_3D_COORD(Var2 + Vector(10f, 0f, 0f), &(Var2.f_2), 0, 0);
Var2.f_2=(Var2.f_2 - 25f);
MISC::SHOOT_SINGLE_BULLET_BETWEEN_COORDS_IGNORE_ENTITY_NEW(Var1, Var2, iVar3, 1, joaat("weapon_airstrike_rocket"), NETWORK::NET_TO_PED(Local_238.f_2.f_3), 1, 0, -1f, iVar0, 1, 0, 0, 0, 0, 0, 0);
func_11(&(Local_238.f_51), 0, 0);
MISC::SET_BIT(&uLocal_237, Local_238.f_50);
}}elseif(func_10(&(Local_238.f_51), 500, 0)){
func_14(&(Local_238.f_51));
Local_238.f_50++;
}
break;
...
if(!MISC::IS_BIT_SET(uLocal_237, Local_238.f_50)){
Var1={
Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(0f, 5f, 10f) 
};
Var1.f_2=Local_61.f_2;
Var2={
Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(0f, 5f, 10f) 
...
if(!MISC::IS_BIT_SET(uLocal_237, Local_238.f_50)){
Var1={
Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(0f, 10f, 10f) 
};
Var1.f_2=Local_61.f_2;
Var2={
Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(0f, 10f, 10f) 
...
int iVar4;
if(func_42(Local_238.f_2)){
uVar0=NETWORK::NET_TO_VEH(Local_238.f_2);
Var2={
...
fLocal_62=MISC::GET_DISTANCE_BETWEEN_COORDS(Var2, Var1, 0);
}else{
iLocal_59=1;
}}else{
iLocal_59=1;
...
iLocal_56=1;
}}elseif(MISC::IS_BIT_SET(Global_44449, 10) || MISC::GET_COORDS_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(PLAYER::PLAYER_PED_ID(), joaat("weapon_flare"), 100f, &(Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2), 1)){
if(MISC::IS_BIT_SET(Global_44449, 10)){
Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) 
};
}elseif(func_95(Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2, 0f, 0f, 0f, 0)){
Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2={
Var0 
};
}
...
VEHICLE::SET_TASK_VEHICLE_GOTO_PLANE_MIN_HEIGHT_ABOVE_TERRAIN(NETWORK::NET_TO_VEH(Local_238.f_2), round(50f));
iLocal_55=1;
...
HUD::SET_BLIP_ROTATION(uLocal_47, ceil(ENTITY::GET_ENTITY_HEADING(uVar0)));
}
if(!iLocal_53){
if(!func_44(Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2)){
Var3={
...
if(!iLocal_235 && !MISC::IS_BIT_SET(Global_44449, 10)){
if(!Local_238.f_54){
if(!func_94(Local_238.f_2.f_3)){
if(!func_44(Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2)){
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_59(PLAYER::PLAYER_ID()), ENTITY::GET_ENTITY_COORDS(NETWORK::NET_TO_VEH(Local_238.f_2.f_3), 1), 0) <=250f){
...
}elseif(func_10(&uLocal_63, 7500, 0)){
Local_238.f_53=1;
}
Var1={
Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 - Vector(1000f, 25f, 25f) 
};
Var2={
Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector(1000f, 25f, 25f) 
};
...
Local_238.f_50=100;
Local_238.f_54=1;
if(!iLocal_236 && !MISC::IS_BIT_SET(Global_44449, 10)){
if(func_41()){
if(!func_38()){
...
uVar0=NETWORK::NET_TO_PED(Local_238.f_2.f_3);
...
if(func_94(Local_238.f_2.f_3)){
func_91(3);
}}elseif(func_94(Local_238.f_2.f_3)){
func_91(3);
}
break;
case 3:
...
}elseif(func_90(Local_238.f_2.f_1) && func_90(Local_238.f_2.f_3.f_1)){
...
TASK::TASK_PLANE_MISSION(0, NETWORK::NET_TO_VEH(Local_238.f_2), 0, 0, Local_60 + Vector((50f + 5f), 0f, 0f), 4, 60f, 15f, -1f, ceil((50f + 5f)), 20, 1);
TASK::TASK_PLANE_MISSION(0, NETWORK::NET_TO_VEH(Local_238.f_2), 0, 0, Local_238.f_2.f_14, 4, 60f, 25f, -1f, ceil((50f + 5f)), 20, 1);
...
ENTITY::FREEZE_ENTITY_POSITION(NETWORK::NET_TO_VEH(Local_238.f_2), 0);
...
ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(NETWORK::NET_TO_VEH(Local_238.f_2), 0);
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_78(PLAYER::PLAYER_ID()), Param0, 1) <=(fVar2 + fParam1)){
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(func_78(iVar1), Param0, 1) <=(fVar2 + fParam1)){
...
var func__87(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3){
return MISC::GET_HEADING_FROM_VECTOR_2D((Param2.f_0 - Param0.f_0), (Param2.f_1 - Param0.f_1));
}


Vector3 func__88(struct<3> Param0, float fParam1, float fParam2, float fParam3){
struct<3> Var0;
float fVar1;
Var0={
...
fVar1=(fParam3 / 2f);
Var0={
func_89(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(fParam1, fParam2)) 
};
...
TASK::TASK_PLANE_MISSION(0, NETWORK::NET_TO_VEH(Local_238.f_2), 0, 0, Local_240[NETWORK::PARTICIPANT_ID_TO_INT() /*5*/].f_2 + Vector((50f + 5f), 0f, 0f), 4, 60f, 15f, -1f, ceil((50f + 5f)), 20, 1);
TASK::TASK_PLANE_MISSION(0, NETWORK::NET_TO_VEH(Local_238.f_2), 0, 0, Local_238.f_2.f_14, 4, 60f, 25f, -1f, ceil((50f + 5f)), 20, 1);
