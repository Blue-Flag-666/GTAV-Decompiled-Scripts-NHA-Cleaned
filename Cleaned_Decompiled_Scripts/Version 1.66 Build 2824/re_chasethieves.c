...
uLocal_128=func_310(iLocal_78, 1, 0);
HUD::SET_BLIP_COLOUR(uLocal_128, 1);
}
func_309(1);
...
if(OBJECT::DOES_PICKUP_OBJECT_EXIST(uLocal_520)){
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), OBJECT::GET_PICKUP_COORDS(uLocal_520)) > 100f){
func_401();
}}elseif(bLocal_65==1){
func_2(2);
func_421();
}else{
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, uLocal_510, joaat("player"));
if(func_1(iLocal_78)){
...
func_4();
break;
}}elseif(FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(iLocal_83, 1), 20f)){
func_4();
}}}
...
iLocal_178=1;
if(func_1(iLocal_83)){
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_83, 17, 1);
...
switch (iLocal_152){
case 0:
if(!STREAMING::STREAMVOL_IS_VALID(uLocal_525)){
uLocal_525=STREAMING::STREAMVOL_CREATE_SPHERE(ENTITY::GET_ENTITY_COORDS(iLocal_83, 1), 200f, 12, 127);
}
...
func_217(0);
func_216();
if(((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1) && !func_215()) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_169)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_wallet_01"))){
if(iLocal_523==-1){
...
uLocal_127=OBJECT::CREATE_OBJECT(joaat("prop_ld_wallet_01"), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_127, PLAYER::PLAYER_PED_ID(), PED::GET_PED_BONE_INDEX(PLAYER::PLAYER_PED_ID(), 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
...
Var1={
ENTITY::GET_ENTITY_ROTATION(iLocal_83, 2) 
};
uLocal_150=PED::CREATE_SYNCHRONIZED_SCENE(Var0, Var1, 2);
PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uLocal_150, 0);
uLocal_151=CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", 0);
CAM::PLAY_SYNCHRONIZED_CAM_ANIM(uLocal_151, uLocal_150, sLocal_172, sLocal_169);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), uLocal_150, sLocal_169, sLocal_170, 1000f, -1000f, 1, 0, 1148846080, 0);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), 0, 0);
TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_83);
TASK::TASK_SYNCHRONIZED_SCENE(iLocal_83, uLocal_150, sLocal_169, sLocal_171, 1000f, -1000f, 1, 0, 1148846080, 0);
...
MISC::CLEAR_AREA(PED::GET_ANIM_INITIAL_OFFSET_POSITION(sLocal_169, sLocal_171, Var0, Var1, 0, 2), 2f, 1, 0, 0, 0);
CAM::SET_CAM_ACTIVE(uLocal_151, 1);
...
break;
case 2:
if(((iLocal_528==0 && CAM::GET_FOLLOW_PED_CAM_VIEW_MODE()==4) && PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_150)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_150) >=0.96f){
GRAPHICS::ANIMPOSTFX_PLAY("CamPushInNeutral", 0, 0);
AUDIO::PLAY_SOUND_FRONTEND(-1, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", 1);
iLocal_528=1;
}
if(((PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_150) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_150)==1f) || func_92()) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), -571081548)){
...
if((ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_127, PLAYER::PLAYER_PED_ID()) && iLocal_179==0) && func_96(&uLocal_180, "RECHAAU", sVar2, sVar3, 4, 0, 0)){
ENTITY::DETACH_ENTITY(uLocal_127, 0, 1);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_127, iLocal_83, PED::GET_PED_BONE_INDEX(iLocal_83, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
iLocal_179=1;
}}else{
if(iLocal_179==0 && func_96(&uLocal_180, "RECHAAU", sVar2, sVar3, 4, 0, 0)){
iLocal_179=1;
}
if(PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_150) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_150) > 0.9f){
func_88();
}}}
break;
case 3:
...
WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), iLocal_57, 0);
}}}}
...
func_90(iLocal_83, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PLAYER::PLAYER_PED_ID(), 0f, 2f, 1f), uLocal_132, 1, 1);
PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_83, 0, 0);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_83, uLocal_136);
...
int func_90(int iParam0, struct<3> Param1, var uParam2, bool bParam3, int iParam4){
bool bVar0;
float fVar1;
bVar0=false;
if(func_1(iParam0)){
...
void func_99(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10){
var uVar0;
uVar0=PLAYER::GET_PLAYER_INDEX();
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_149(iVar10, 14, uVar12[iVar1], -1) 
};
...
while (iVar1 <=8){
Global_78341[1 /*14*/]={
func_149(iVar10, 14, uVar15[iVar1], -1) 
};
func_121(iParam0, Global_78341[1 /*14*/].f_12, Global_78341[1 /*14*/].f_3, Global_78341[1 /*14*/].f_4);
func_144(14);
if(Global_78339==1){
...
iVar5=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 10, -1, 0, -1, func_111(iParam2));
if(iVar5 <=iVar4){
return -1;
}
...
if(iVar10 >=0){
iVar11=FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 10, -1, 0, -1, func_111(iParam0));
if(iVar11 > iVar10){
...
}}elseif(PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_83)){
...
void func_229(){
if(func_1(iLocal_83)){
func_237(uLocal_129, &uLocal_524);
func_235();
if(func_234(func_17()) < iLocal_149){
func_2(2);
func_421();
}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 20f, 20f, 20f, 0, 1, 0)){
func_230();
iLocal_58=6;
}elseif(iLocal_144==1){
...
func_2(2);
func_421();
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 30f, 30f, 20f, 0, 1, 0)){
iLocal_144=1;
}elseif(fLocal_146 > -1f){
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_60) > (fLocal_146 + 120f)){
func_2(2);
func_421();
}}}}
...
case 0:
if(!PED::IS_PED_RUNNING_MOBILE_PHONE_TASK(iLocal_83)){
if(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 30f, 30f, 30f, 0, 0, 0) && func_96(&uLocal_180, "RECHAAU", "RECHA_TK", "RECHA_TK_1", 4, 0, 0)){
iLocal_75++;
}}elseif(ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 40f, 40f, 40f, 0, 0, 0) && func_5(&uLocal_180, "RECHAAU", "RECHA_WT", 4, 0, 0, 0)){
iLocal_75++;
}
break;
case 1:
...
if(iLocal_64==1){
if((!func_215() && timera() > 8000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 12f, 12f, 5f, 0, 0, 0)){
TASK::OPEN_SEQUENCE_TASK(&uLocal_136);
...
void func_241(){
if(OBJECT::HAS_PICKUP_BEEN_COLLECTED(uLocal_520)){
PAD::SET_CONTROL_SHAKE(0, 200, 250);
bLocal_65=true;
fLocal_146=vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_60);
...
func_246();
uLocal_129=func_310(iLocal_83, 0, 0);
func_245(&uLocal_524);
iLocal_58=5;
}}else{
func_2(2);
...
func_243(2);
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_176) > 150f){
func_242();
}}}


void func_242(){
if(OBJECT::DOES_PICKUP_EXIST(uLocal_520)){
if(vdist(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), OBJECT::GET_PICKUP_COORDS(uLocal_520)) > 100f){
func_401();
}}elseif(bLocal_65){
func_2(2);
...
EVENT::REMOVE_ALL_SHOCKING_EVENTS(0);
TASK::OPEN_SEQUENCE_TASK(&uLocal_136);
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_83, Local_131, 1f, 1f, 2f, 0, 1, 0)){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_131, 1f, 20000, 0.25f, 0, 1193033728);
}
TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
TASK::CLOSE_SEQUENCE_TASK(uLocal_136);
TASK::TASK_PERFORM_SEQUENCE(iLocal_83, uLocal_136);
...
func_2(3);
func_421();
}}elseif((((bLocal_65==0 && OBJECT::DOES_PICKUP_EXIST(uLocal_520)) && func_1(iLocal_83)) && ENTITY::IS_ENTITY_AT_COORD(iLocal_83, OBJECT::GET_PICKUP_COORDS(uLocal_520), 15f, 15f, 2f, 0, 1, 0)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_83, sLocal_515, sLocal_516, 3)){
STREAMING::REQUEST_ANIM_DICT(sLocal_521);
Var0={
OBJECT::GET_PICKUP_COORDS(uLocal_520) - Vector(15f, 15f, 15f) 
};
Var1={
OBJECT::GET_PICKUP_COORDS(uLocal_520) + Vector(15f, 15f, 15f) 
};
if(STREAMING::HAS_ANIM_DICT_LOADED(sLocal_521) && !PED::IS_ANY_PED_SHOOTING_IN_AREA(Var0, Var1, 0, 1)){
iLocal_67=1;
if(!func_91(iLocal_83, joaat("script_task_perform_sequence"))){
TASK::OPEN_SEQUENCE_TASK(&uLocal_136);
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_83, OBJECT::GET_PICKUP_COORDS(uLocal_520), 1f, 1f, 2f, 0, 1, 0)){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, OBJECT::GET_PICKUP_COORDS(uLocal_520), 2f, 20000, 0.25f, 0, 1193033728);
}
TASK::TASK_TURN_PED_TO_FACE_COORD(0, OBJECT::GET_PICKUP_COORDS(uLocal_520), 0);
...
Local_176={
OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_78, 0), 1067030938, 1069547520) 
};
MISC::SET_BIT(&uLocal_163, 3);
MISC::SET_BIT(&uLocal_163, 4);
MISC::SET_BIT(&uLocal_163, true);
uLocal_520=OBJECT::CREATE_PICKUP(joaat("pickup_money_wallet"), Local_176, uLocal_163, iLocal_149, 1, iLocal_168);
func_246();
uLocal_130=func_295(uLocal_520);
...
func_255(uLocal_128, iLocal_78, fLocal_522, 1061158912, 0);
...
if(MISC::IS_BULLET_IN_AREA(Local_60, 50f, 0)){
func_223(0);
...
switch (iLocal_73){
case 0:
if(((iLocal_147==0 && !func_215()) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 40f, 40f, 40f, 0, 0, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_GET", 4, 0, 0, 0)){
iLocal_147=1;
}
...
break;
case 1:
if(((!func_215() && (MISC::GET_GAME_TIMER() - iLocal_74) > 1000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_PCA", 4, 0, 0, 0)){
iLocal_74=MISC::GET_GAME_TIMER();
iLocal_162=2;
iLocal_73++;
}
break;
case 2:
if(((!func_215() && (MISC::GET_GAME_TIMER() - iLocal_74) > 5000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_PCB", 4, 0, 0, 0)){
iLocal_74=MISC::GET_GAME_TIMER();
iLocal_162=3;
iLocal_73++;
}
break;
case 3:
if(((!func_215() && (MISC::GET_GAME_TIMER() - iLocal_74) > 6000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 20f, 20f, 20f, 0, 0, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_PCC", 4, 0, 0, 0)){
iLocal_74=MISC::GET_GAME_TIMER();
iLocal_162=4;
iLocal_73++;
}
break;
case 4:
if(((!func_215() && (MISC::GET_GAME_TIMER() - iLocal_74) > 6000) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_83, 15f, 15f, 15f, 0, 0, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_PCD", 4, 0, 0, 0)){
iLocal_162=5;
iLocal_73++;
}
break;
...
return 1;
}}elseif(((ENTITY::DOES_ENTITY_EXIST(iLocal_78) && ENTITY::IS_ENTITY_DEAD(iLocal_78, 0)) && ENTITY::IS_ENTITY_AT_COORD(iLocal_83, ENTITY::GET_ENTITY_COORDS(iLocal_78, 0), 20f, 20f, 10f, 0, 1, 0)) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_83, iLocal_78, 17)){
return 1;
}}}
return 0;
}
...
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_86, 1, 1, 0);
PED::FORCE_PED_MOTION_STATE(iLocal_78, joaat("MotionState_Sprint"), 0, 0, 0);
iLocal_59=1;
}else{
iLocal_59=3;
}
...
TASK::CLOSE_SEQUENCE_TASK(uLocal_136);
TASK::TASK_PERFORM_SEQUENCE(iLocal_79, uLocal_136);
TASK::CLEAR_SEQUENCE_TASK(&uLocal_136);
iLocal_59=2;
}}else{
iLocal_59=3;
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_86, 0)){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_86, Local_87, 30f, 30f, 5f, 0, 1, 0) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_79, 0)){
...
if(((((((iLocal_71 < 4 && (MISC::GET_GAME_TIMER() - iLocal_72) > 10000) && func_1(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && !func_215()) && !PED::IS_PED_INJURED(iLocal_78)) && func_254(PLAYER::PLAYER_PED_ID(), iLocal_78, 1) < 40f) && func_5(&uLocal_180, "RECHAAU", "RECHA_YELL", 4, 0, 0, 0)){
iLocal_71++;
iLocal_72=MISC::GET_GAME_TIMER();
}
break;
...
void func_257(){
if(((((((iLocal_141==1 && (MISC::GET_GAME_TIMER() - iLocal_76) > 8000) && !func_215()) && func_1(iLocal_78)) && func_1(iLocal_83)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_78, 20f, 20f, 20f, 0, 1, 0)) && !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_78, iLocal_83, 30f, 30f, 30f, 0, 1, 0)) && func_5(&uLocal_180, "RECHAAU", "RECHA_taunt", 4, 0, 0, 0)){
iLocal_76=MISC::GET_GAME_TIMER();
}}
...
iLocal_138=0;
while (iLocal_138 < 2){
Var0.f_0=(Var0.f_0 + to_float(iLocal_138));
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_90[iLocal_138], uLocal_510);
if(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)){
TASK::TASK_VEHICLE_MISSION(iLocal_90[iLocal_138], uLocal_89[iLocal_138], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iVar3, 40f, 786469, 5f, 10f, 1);
}
else{
TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_90[iLocal_138], uLocal_89[iLocal_138], PLAYER::PLAYER_PED_ID(), iVar3, 40f, 786469, 5f, 10f, 1);
}
WEAPON::GIVE_WEAPON_TO_PED(iLocal_90[iLocal_138], joaat("weapon_sawnoffshotgun"), 999999, 1, 1);
VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_89[iLocal_138], ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()));
iVar3=11;
WEAPON::GIVE_WEAPON_TO_PED(iLocal_91[iLocal_138], joaat("weapon_sawnoffshotgun"), 999999, 1, 1);
...
if(!PED::IS_PED_IN_VEHICLE(iLocal_78, iLocal_86, 0)){
return 1;
}}elseif(ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_78, PLAYER::PLAYER_PED_ID(), 1)){
return 1;
}
if(PED::IS_PED_BEING_JACKED(iLocal_78)){
return 1;
}
if((iLocal_59==1 && !PED::IS_PED_IN_VEHICLE(iLocal_78, iLocal_86, 1)) && !VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_78, iLocal_86, 0, 0, 0)){
return 1;
}}else{
return 1;
}
...
if((((func_1(iLocal_79) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_79, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_79, joaat("script_task_vehicle_mission"))==1) && !TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(iLocal_79)) && !PED::IS_PED_IN_COMBAT(iLocal_79, 0)){
TASK::TASK_DRIVE_BY(iLocal_79, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 30f, 60, 1, -753768974);
TASK::SET_DRIVE_TASK_CRUISE_SPEED(iLocal_79, 40f);
}
if((func_1(iLocal_80) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_80, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_80, joaat("script_task_perform_sequence"))==7){
TASK::TASK_DRIVE_BY(iLocal_80, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 100f, 60, 0, -753768974);
}
if((func_1(iLocal_81) && PED::IS_PED_IN_ANY_VEHICLE(iLocal_81, 0)) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_81, joaat("script_task_perform_sequence"))==7){
...
void func_268(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7){
...
void func_283(var uParam0, int iParam1, struct<3> Param2, int iParam3){
int iVar0;
int iVar1;
int iVar2;
int iVar3;
...
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_86, 0) && !func_263()){
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_131, 2f, 20000, 2f, 8192, 1193033728);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_79, uVar0);
...
TASK::TASK_PERFORM_SEQUENCE(iLocal_80, uVar1);
...
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_128, 1);
if(HUD::GET_BLIP_COLOUR(uLocal_128)==1){
}else{
HUD::SET_BLIP_AS_FRIENDLY(uLocal_128, 0);
HUD::SET_BLIP_COLOUR(uLocal_128, 1);
}}}else{
if(HUD::DOES_BLIP_EXIST(uLocal_128)){
HUD::SHOW_HEIGHT_ON_BLIP(uLocal_128, 0);
func_307(uLocal_128, &uLocal_140);
}
if(VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_86, 0)){
...
fVar2=100f;
if((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var0, Var1, fVar2, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_155, 20f, 20f, 20f, 0, 1, 0)) || MISC::IS_BULLET_IN_ANGLED_AREA(Var0, Var1, fVar2, 1)) || MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(Var0, Var1, fVar2, joaat("weapon_rpg"), 0)) || PED::IS_PED_INJURED(iLocal_78)){
return 1;
}}elseif(bLocal_153==3){
Var0={
...
fVar2=96.75f;
if((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Var0, Var1, fVar2, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_131, 20f, 20f, 20f, 0, 1, 0)) || MISC::IS_BULLET_IN_ANGLED_AREA(Var0, Var1, fVar2, 1)) || MISC::IS_PROJECTILE_TYPE_IN_ANGLED_AREA(Var0, Var1, fVar2, joaat("weapon_rpg"), 0)) || PED::IS_PED_INJURED(iLocal_78)){
return 1;
}}elseif(bLocal_153==4){
Var0={
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(vmag2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_330()){
return 0;
}}
...
void func_325(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21){
uParam0->f_4=iParam4;
*uParam0=sParam1;
uParam0->f_1={
Param2 
...
struct<3> Var1[2];
float fVar2[2];
MISC::CLEAR_AREA(Local_84, 20f, 1, 0, 0, 0);
iLocal_83=PED::CREATE_PED(26, iLocal_165, Local_84, fLocal_85, 1, 1);
PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_83, 1, 0);
...
PED::SET_PED_CONFIG_FLAG(iLocal_83, 285, 1);
AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_83, "S_M_Y_BusBoy_01_WHITE_MINI_01");
if(!func_89(Local_134)){
iLocal_133=VEHICLE::CREATE_VEHICLE(iLocal_167, Local_134, fLocal_135, 1, 1, 0);
...
ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_83, 1, 1);
PED::SET_PED_CAN_BE_TARGETTED(iLocal_83, 0);
PED::SET_PED_MONEY(iLocal_83, 0);
PED::SET_PED_LOD_MULTIPLIER(iLocal_83, 1.5f);
iLocal_78=PED::CREATE_PED(26, iLocal_164, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_83, Local_177), fLocal_82, 1, 1);
iLocal_86=VEHICLE::CREATE_VEHICLE(iLocal_166, Local_87, fLocal_88, 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_86, 1084227584);
VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_166, 1);
VEHICLE::SET_DISABLE_PRETEND_OCCUPANTS(iLocal_86, 1);
VEHICLE::SET_VEHICLE_DISABLE_TOWING(iLocal_86, 1);
VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_86, 1, 1, 0);
PED::ADD_RELATIONSHIP_GROUP("re_chasethieves badGuys", &uLocal_510);
PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_510, joaat("player"));
switch (bLocal_153){
case 1:
iLocal_79=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_86, 22, iLocal_164, -1, 1, 1);
...
case 2:
iLocal_79=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_86, 22, iLocal_164, -1, 1, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_79, joaat("weapon_sawnoffshotgun"), -1, 0, 1);
WEAPON::GIVE_WEAPON_TO_PED(iLocal_78, joaat("weapon_pistol"), -1, 0, 1);
func_336(iLocal_79);
func_336(iLocal_78);
break;
...
iLocal_80=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_86, 22, iLocal_164, 1, 1, 1);
iLocal_81=PED::CREATE_PED_INSIDE_VEHICLE(iLocal_86, 22, iLocal_164, 2, 1, 1);
...
Local_175={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_512, sLocal_514, Local_173, Local_174, 0, 2) 
};
...
Local_175={
PED::GET_ANIM_INITIAL_OFFSET_ROTATION(sLocal_512, sLocal_513, Local_173, Local_174, 0, 2) 
};
...
iLocal_138=0;
while (iLocal_138 <=1){
uVar0[iLocal_138]=VEHICLE::CREATE_VEHICLE(iLocal_166, Var1[iLocal_138 /*3*/], fVar2[iLocal_138], 1, 1, 0);
VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uVar0[iLocal_138], 1084227584);
iLocal_138++;
}}
if(bLocal_153==3){
uLocal_137=PED::ADD_SCENARIO_BLOCKING_AREA(1608.8f, 4824.81f, 0f, 1730.9f, 4856.1f, 51.1f, 0, 1, 1, 1);
MISC::CLEAR_AREA_OF_PEDS(1973.98f, 4817.32f, 41.53f, 10f, 0);
}
MISC::SET_BIT(&uLocal_159, 5);
MISC::SET_BIT(&uLocal_159, 4);
MISC::SET_BIT(&uLocal_159, false);
MISC::SET_BIT(&uLocal_159, true);
if(iLocal_511==0){
...
PED::SET_PED_RELATIONSHIP_GROUP_HASH(iParam0, uLocal_510);
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_56) < (75f * 75f)){
return 1;
}
if(vmag2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_330()){
return 0;
...
int func_359(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4){
bool bVar0;
struct<3> Var1;
int iVar2;
struct<3> Var3;
...
iVar3=(iVar3 - 1);
iVar0=round(func_365(to_float(iVar0 + 1), 0f, 12f));
}
while (iVar3 < 0){
iVar3 +=12;
iVar2=(iVar2 - 1);
...
if(MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_157, 1) < fVar0){
fVar0=MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_157, 1);
bLocal_153=4;
}
if(bLocal_153==1){
return Local_154;
...
void func_401(){
PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_137, 0);
...
PED::SET_PED_CAN_BE_TARGETTED(iLocal_83, 1);
