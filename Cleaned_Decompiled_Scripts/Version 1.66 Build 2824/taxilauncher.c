...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_240, "FP_HAIL_TAXI", 3)){
ENTITY::STOP_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), "FP_HAIL_TAXI", &cLocal_240, -2f);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_240, "FUCK_U", 3)){
ENTITY::STOP_ENTITY_ANIM(PLAYER::PLAYER_PED_ID(), "FUCK_U", &cLocal_240, -2f);
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_240, "FORGET_IT", 3)){
...
HUD::SET_BLIP_ROUTE(uLocal_63, 0);
...
}elseif(ENTITY::IS_ENTITY_PLAYING_ANIM(Global_112680, &cLocal_240, "Aknowledge_L", 3)){
...
func_33();
if(HUD::DOES_BLIP_EXIST(uLocal_63)){
HUD::SET_BLIP_FLASH_TIMER(uLocal_63, 10000);
}}else{
func_5();
}}else{
func_5();
...
if(func_39(Global_112679)){
if(!HUD::DOES_BLIP_EXIST(uLocal_63)){
uLocal_63=HUD::ADD_BLIP_FOR_ENTITY(Global_112679);
HUD::SET_BLIP_SPRITE(uLocal_63, 198);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_63, "TXM_BLIP");
HUD::SET_BLIP_FLASHES(uLocal_63, 1);
HUD::SET_BLIP_FLASH_TIMER(uLocal_63, 10000);
}}}
...
return 1;
}elseif(func_38(Var0, Local_243, 5f)){
Local_56.f_14={
Local_243 
};
return 1;
...
iLocal_244=0;
}elseif(iLocal_244 !=uVar13[iVar2]){
func_109(&iLocal_244, 0);
...
iLocal_61=0;
iLocal_52=2;
}}elseif(func_118(&uLocal_71, 131, "TAXISAU", sLocal_237, sLocal_237, "TX_2A", "TX_2A", 2, 1, 0, 0, 0)){
iLocal_52=1;
}}}}elseif(iLocal_52==1){
if(func_117()){
iLocal_52=0;
