...
uLocal_208=PED::CREATE_PED(25, iLocal_36, Local_210, ScriptParam_333.f_17[0], 0, 1);
func_106();
STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_36);
iLocal_209=1;
if(ENTITY::DOES_ENTITY_EXIST(uLocal_208) && func_105(uLocal_208)){
...
fVar12=func_99(PLAYER::PLAYER_PED_ID(), uLocal_208);
...
if(PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())){
if((((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_208) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_208)) && fVar12 < 25f) && func_91(PLAYER::PLAYER_PED_ID()) !=joaat("weapon_unarmed")) && func_88(uLocal_208, PLAYER::PLAYER_PED_ID(), 1126825984, 0)){
if(!func_92()){
func_94();
TASK::TASK_PLAY_ANIM(uLocal_208, &cLocal_234, &Local_203, 2f, -2f, -1, 0, 0, 0, 0, 0);
iLocal_216=24;
...
if(func_87(uLocal_208, PLAYER::PLAYER_PED_ID(), 1) < 25f){
if(!HUD::DOES_BLIP_EXIST(uLocal_214)){
func_83(&uLocal_214, &uLocal_208, 0);
...
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_208, Local_210, 1f, -1, 1f, 1024, ScriptParam_333.f_17[0]);
iLocal_216=6;
}
break;
case 6:
...
if(func_87(uLocal_208, PLAYER::PLAYER_PED_ID(), 1) < fVar9){
if(func_62()==1){
iLocal_216=8;
iLocal_269=0;
}}
...
func_56(Global_113593[iLocal_217], iLocal_223, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(uLocal_208, &Local_253, &Local_252));
}}
break;
case 9:
...
func_53(&uLocal_37, 3, uLocal_208, &Local_205, 0, 1);
func_52(&cVar2);
...
if(bLocal_266){
iVar35=1;
}elseif(func_37(&uLocal_37, &cLocal_227, &cVar3, 3, 0, 0, 0)){
iVar35=1;
}
if(iVar35==1){
iLocal_216=11;
...
if(((((((((((((iLocal_216==0 || iLocal_216==1) || iLocal_216==3) || iLocal_216==8) || iLocal_216==9) || iLocal_216==7) && func_87(uLocal_208, PLAYER::PLAYER_PED_ID(), 1) < 5f) && bLocal_265==1) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) && iVar6==0) && bLocal_268==1) && !Global_3) && func_7()) && bVar18){
if(iLocal_224==-1){
...
if((ENTITY::IS_ENTITY_OCCLUDED(uLocal_208) && func_87(uLocal_208, PLAYER::PLAYER_PED_ID(), 1) > 50f) && !BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()){
func_116(1);
}
wait(0);
}}
...
void func_8(){
func_9();
if(func_105(uLocal_208) && func_105(PLAYER::PLAYER_PED_ID())){
PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_208, 0);
...
void func_9(){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_277)){
ENTITY::DETACH_ENTITY(uLocal_277, 1, 1);
}}
...
void func_107(){
uLocal_277=OBJECT::CREATE_OBJECT(joaat("prop_cs_pamphlet_01"), ENTITY::GET_ENTITY_COORDS(uLocal_208, 1), 1, 1, 0);
ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_277, uLocal_208, PED::GET_PED_BONE_INDEX(uLocal_208, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0);
...
void func_120(){
if(ENTITY::DOES_ENTITY_EXIST(uLocal_277)){
OBJECT::DELETE_OBJECT(&uLocal_277);
}}
