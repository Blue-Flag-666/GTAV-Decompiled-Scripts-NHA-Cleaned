...
}elseif(bParam11 && Global_2694540==0){
...
if(((NETWORK::NETWORK_IS_IN_SPECTATOR_MODE()==0 && Global_1836587==0) && !MISC::IS_BIT_SET(Global_2672505.f_1685.f_756, 11)) && Global_1853910[PLAYER::PLAYER_ID() /*862*/] !=0){
return 0;
}}}
