...
fLocal_57=vdist2(Local_55, ScriptParam_261.f_1[0 /*3*/]);
fLocal_57=fLocal_57;
Local_75={
Local_55 
};
...
if(bVar2){
if(!ENTITY::IS_ENTITY_AT_COORD(iLocal_53, ScriptParam_261.f_1[0 /*3*/], fLocal_77, fLocal_77, 2f, 0, 1, iLocal_67)){
bVar2=false;
}
...
elseif(!func_134(uLocal_58, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()){
func_91(&iLocal_60);
...
if(func_134(uLocal_58, 2097152)){
if(!func_114(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_50)){
func_127(10);
}}
...
iVar0=start_new_script_with_args(&Local_51, &Local_83, 170, iLocal_61);
...
Var6={
func_71(cos(Var6.f_2), sin(Var6.f_2), MISC::TAN(Var6.f_0)) 
};
...
Var4={
ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - ENTITY::GET_ENTITY_COORDS(iLocal_255, 0) 
};
Var4.f_2=0f;
fVar7=vmag(Var4);
...
if(fVar7 > 0.8f){
Var4={
Var4 * FtoV((0.78f / fVar7)) 
};
Var5={
ENTITY::GET_ENTITY_COORDS(iLocal_255, 0) + Var4 
};
if(iLocal_82==12){
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Var5, 1f, 20000, 1048576000, 0, func_67(Var5, ENTITY::GET_ENTITY_COORDS(iLocal_255, 0)));
}else{
TASK::TASK_GO_STRAIGHT_TO_COORD(0, Var5, 1f, -1, func_67(Var5, ENTITY::GET_ENTITY_COORDS(iLocal_255, 0)), 1056964608);
}}elseif(fVar7 > 0.15f){
TASK::TASK_ACHIEVE_HEADING(0, func_67(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_255, 0)), 0);
}
...
func_25(&uLocal_251);
while ((func_12(&uLocal_251) < 6f && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), "pickup_object", "pickup_low", 3)){
PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, 1);
wait(0);
}
...
while ((func_12(&uLocal_251) < 6f && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(PLAYER::PLAYER_PED_ID(), "pickup_object", "pickup_low") < 0.22f){
PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, 1);
...
if(bParam0){
if(!func_35(func_36(iLocal_82)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), func_36(iLocal_82), 1f, -1, 1048576000, 0, 1193033728);
}
if(ENTITY::DOES_ENTITY_EXIST(iLocal_255)){
OBJECT::DELETE_OBJECT(&iLocal_255);
}
uVar2=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, func_34(iLocal_82), func_33(iLocal_82), func_32(iLocal_82), 1, 2);
uVar3=CAM::CREATE_CAMERA_WITH_PARAMS(26379945, func_31(iLocal_82), func_30(iLocal_82), func_29(iLocal_82), 0, 2);
...
CAM::SET_CAM_ACTIVE_WITH_INTERP(uVar3, uVar2, func_28(iLocal_82), 1, 1);
func_23(&uVar0);
while (func_12(&uVar0) < ((to_float(func_28(iLocal_82)) / 1000f) + 0.3f)){
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, 1);
}
wait(0);
...
func_51(0, 0, 1);
iLocal_255=OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("p_parachute_s"), func_50(iLocal_82), 1, 1, 0);
ENTITY::SET_ENTITY_ROTATION(iLocal_255, func_49(iLocal_82), 2, 1);
func_44(&Var0, &uVar1);
Var2={
0f, 0f, uVar1 
};
uVar3=PED::CREATE_SYNCHRONIZED_SCENE(Var0, Var2, 2);
ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_255, uVar3, "puton_parachute_bag", "oddjobs@basejump@ig_15", 1000f, -1000f, 1, 1148846080);
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
...
float func_67(struct<2> Param0, Vector3 vParam1, struct<2> Param2, Vector3 vParam3){
...
if(!func_35(Var0)){
uLocal_256=VEHICLE::CREATE_VEHICLE(joaat("bati"), Var0, func_119(iLocal_82), 1, 1, 0);
uLocal_256=uLocal_256;
}
break;
default:
break;
...
iLocal_63=0;
fLocal_66=(to_float(func_136(iLocal_69)) + 5f);
fLocal_77=1.1f;
...
fVar1=vdist2(Param0, func_48(iVar3));
if(fVar0 > fVar1){
fVar0=fVar1;
iVar2=iVar3;
}}
