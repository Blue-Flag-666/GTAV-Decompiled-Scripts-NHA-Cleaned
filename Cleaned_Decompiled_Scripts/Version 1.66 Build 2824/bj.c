...
func_560(&Var3, &uVar51, &iVar33, &iVar34, &iVar36, &iVar39, &iVar40, &uVar32, &iVar42, &iVar43, &iVar44, uVar85, &iVar80, uVar45, uVar46, bVar13, &uVar41, bVar111);
}
if(bVar77 < 0){
return;
}
if(MISC::IS_BIT_SET(Global_113648.f_18969.f_1, bVar77)){
fVar65=0.1f;
}
bVar13=bVar77;
func_559(0);
...
ENTITY::SET_ENTITY_AS_MISSION_ENTITY(ScriptParam_516.f_2, 1, 1);
...
Var57={
func_475(cos(Var57.f_2), sin(Var57.f_2), MISC::TAN(Var57.f_0)) 
};
if(func_474(bVar13)){
STREAMING::NEW_LOAD_SCENE_START(func_473(bVar13), Var57, 4000f, 0);
}
}
func_467(&Var3, bVar13, &uVar0, &uVar1, &iVar2, &uVar51, &iVar84);
}elseif(func_465(func_466(bVar13))){
Var62={
Vector(1.2f, 1.2f, 1.2f) * Vector(0f, -cos((-97.4239f + func_464(&Var3))), sin((-97.4239f + func_464(&Var3)))) 
};
Var61={
ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar33, 1.12046f, -0.317773f, 1.3385f) 
};
Var62={
func_463(Var62, 8.909f) 
};
if(func_474(bVar13)){
STREAMING::NEW_LOAD_SCENE_START(Var61 + Var62, Var62, 4000f, 0);
}}else{
Var57={
-10f, 0f, func_464(&Var3) 
};
Var57={
func_475(cos(Var57.f_2), sin(Var57.f_2), MISC::TAN(Var57.f_0)) 
};
...
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_473(bVar13), 0, 0, 0, 1);
ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), func_464(&Var3));
ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), 1);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 0);
}
iVar7=2;
}elseif(!CAM::IS_SCREEN_FADING_OUT() && (!func_462(&uVar23) || func_461(&uVar23) > 0.05f)){
...
break;
case 2:
if(func_459(&uVar0, &uVar16, &uVar51, bVar13, iVar84, ((bVar13 !=5 && bVar13 !=6) && bVar13 !=12))){
func_458(&uVar16);
func_435(&Var3, &uVar32, &iVar72, &iVar33, &iVar34, &iVar36, &uVar35, &uVar37, &iVar42, &iVar43, uVar1, iVar2, &uVar19, bVar13, &iVar81);
...
break;
case 3:
if(!func_462(&uVar16) && !bVar93){
func_434(0, 0, 1);
func_486(&uVar16);
}elseif((func_462(&uVar16) && func_461(&uVar16) > 0.2f) || bVar93){
...
if(!func_431(func_432(bVar13)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
PED::SET_PED_RESET_FLAG(PLAYER::PLAYER_PED_ID(), 177, 1);
if(PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID())){
PED::SET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID(), 0, 0);
}
ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), func_432(bVar13), 1, 0, 0, 1);
...
TASK::TASK_GO_STRAIGHT_TO_COORD(0, func_473(bVar13), 1f, -1, func_464(&Var3), 1056964608);
...
elseif(func_461(&uVar30) > 4f || (func_465(func_466(bVar13)) && func_461(&uVar30) > 0.5f)){
func_401(&uVar32, "OJBJAUD", func_416(&Var3), 8, 0, 0, 0);
bVar104=true;
}}
if(!CAM::IS_SCREEN_FADING_OUT() && !bVar93){
if(func_379(&Var3, bVar13, &iVar36, &uVar5, &uVar4, &uVar17, &uVar18, &uVar22, &uVar28, iVar84, &bVar94, &bVar106, bVar98)){
HUD::CLEAR_HELP(1);
bVar98=false;
if(func_378(&Var3)){
CAM::DO_SCREEN_FADE_OUT(800);
...
uVar45=HUD::ADD_BLIP_FOR_COORD(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iVar34, func_370(&Var3)));
HUD::SET_BLIP_COLOUR(uVar45, 5);
HUD::SHOW_HEIGHT_ON_BLIP(uVar45, 1);
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uVar45, "BJ_BLIP_TGT");
}else{
uVar45=HUD::ADD_BLIP_FOR_COORD(func_369(&Var3, 0));
HUD::SET_BLIP_COLOUR(uVar45, 5);
if(iVar72==1){
HUD::SET_BLIP_NAME_FROM_TEXT_FILE(uVar45, "BJ_BLIP_TGT");
}else{
...
if(iVar72 > 1){
uVar46=HUD::ADD_BLIP_FOR_COORD(func_369(&Var3, 1));
...
ENTITY::SET_ENTITY_COORDS(iVar34, func_369(&Var3, 0), 1, 0, 0, 1);
}}
if(MISC::IS_BIT_SET(Global_113648.f_18969.f_1, (func_366(&Var3) - 125))){
...
CAM::SET_CAM_ACTIVE(func_433(&uVar5, 0), 1);
}
else{
if(CAM::IS_SCRIPT_GLOBAL_SHAKING()){
CAM::STOP_SCRIPT_GLOBAL_SHAKING(0);
...
iVar7=12;
break;
}elseif((bVar97 || bVar96) || func_359(&Var3, bVar13, &bVar99)){
HUD::CLEAR_HELP(1);
HUD::CLEAR_PRINTS();
iVar7=10;
}else{
...
func_358(&uVar19);
func_348(&Var3, iVar34, iVar42, &iVar44, &uVar49, &uVar50, &iVar71, &iVar73, &iVar74, iVar72, &iVar75, &uVar45, &uVar46, &iVar70, &iVar14, &uVar66, &uVar67, &uVar68, &uVar95, 0, 1, fVar65);
func_347(&uVar52);
if(func_462(&uVar16)){
if(func_461(&uVar16) > 10f){
func_343(&uVar20, &iVar80);
}}else{
func_342(&uVar16, 0f);
}
...
if(HUD::IS_MESSAGE_BEING_DISPLAYED() || !func_462(&uVar31)){
func_371(&uVar31);
}
elseif(func_461(&uVar31) > 0.25f){
Var55={
func_341(bVar13) 
};
...
func_348(&Var3, iVar34, iVar42, &iVar44, &uVar49, &uVar50, &iVar71, &iVar73, &iVar74, iVar72, &iVar75, &uVar45, &uVar46, &iVar70, &iVar14, &uVar66, &uVar67, &uVar68, &uVar95, 0, 1, fVar65);
func_347(&uVar52);
if(func_465(func_466(bVar13)) && !ENTITY::IS_ENTITY_DEAD(iVar33, 0)){
...
if(func_332(&Var3, &uVar5, &uVar4, &uVar18, &Var56, &uVar60, Var61, Var62) || bVar98){
func_458(&uVar16);
HUD::CLEAR_HELP(1);
if(!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)){
if(ENTITY::DOES_ENTITY_EXIST(iVar33) && !ENTITY::IS_ENTITY_DEAD(iVar33, 0)){
ENTITY::SET_ENTITY_COORDS(iVar33, func_473(bVar13), 1, 0, 0, 1);
...
if(ENTITY::DOES_ENTITY_EXIST(iVar33)){
if(func_329(&uVar5, &uVar17, Var61, Var62, Var56, &uVar63, &uVar64)){
...
HUD::CLEAR_PRINTS();
iVar7=10;
}elseif(func_328(&uVar4, 3, 1000) && !Global_23131.f_135){
ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), 1);
PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 256);
CAM::DO_SCREEN_FADE_OUT(800);
while (CAM::IS_SCREEN_FADING_OUT()){
func_348(&Var3, iVar34, iVar43, &iVar44, &uVar49, &uVar50, &iVar71, &iVar73, &iVar74, iVar72, &iVar75, &uVar45, &uVar46, &iVar70, &iVar14, &uVar66, &uVar67, &uVar68, &uVar95, 0, 1, fVar65);
wait(0);
}
func_282(&Var3, &uVar51, &Var6, &uVar78, &iVar43, &iVar44, &iVar40, &iVar34, &uVar35, &iVar36, &iVar39, &uVar49, &uVar50, uVar45, uVar46, &iVar71, &iVar73, &iVar74, &iVar80, &iVar75, bVar13, &iVar8, &iVar14, &uVar21, &Var27, &uVar60, &uVar66, &uVar67, &uVar68, &uVar95, &bVar94, &bVar96, &bVar97, &bVar98, &bVar100, &iVar92, &uVar41);
bVar93=true;
iVar7=0;
}else{
func_279(&uVar26, &iVar44);
if(bVar98){
Var58={
func_369(&Var3, (iVar72 - 1)) 
};
...
func_358(&uVar19);
if(func_367(func_368(&Var3))){
if(!ENTITY::DOES_ENTITY_EXIST(iVar34) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_369(&Var3, 0), 0) <=200f){
iVar34=VEHICLE::CREATE_MISSION_TRAIN(6, func_369(&Var3, 0), 1, 0, 0);
if(!ENTITY::IS_ENTITY_DEAD(iVar34, 0)){
VEHICLE::SET_TRAIN_CRUISE_SPEED(iVar34, 7.5f);
}
}}elseif((ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, 0)) && !func_431(func_369(&Var3, 0))){
...
iVar8=func_348(&Var3, iVar34, iVar43, &iVar44, &uVar49, &uVar50, &iVar71, &iVar73, &iVar74, iVar72, &iVar75, &uVar45, &uVar46, &iVar70, &iVar14, &uVar66, &uVar67, &uVar68, &uVar95, 1, 1, fVar65);
if(iVar8==1 || iVar8 >=2){
...
if(!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())){
if(((((ENTITY::DOES_ENTITY_EXIST(iVar34) && !ENTITY::IS_ENTITY_DEAD(iVar34, 0)) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), 0)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iVar34, Var59, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), func_369(&Var3, iVar71), Var59, 0, 1, 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())){
bVar117=false;
...
if(((bVar96 || bVar97) || bVar99) || (func_462(&uVar21) && func_461(&uVar21) > 0.25f)){
if(func_462(&uVar21) && func_461(&uVar21) > 0.25f){
...
bVar83=false;
while (bVar83 < 13){
if(!MISC::IS_BIT_SET(Global_113648.f_18969.f_1, bVar83)){
...
}elseif(!CAM::IS_SCREEN_FADING_OUT() && (!func_77() || func_461(&uVar25) >=2f)){
...
if(func_462(&uVar18)){
if((iVar9==1 || func_461(&uVar18) >=60f) || ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())) || (!bVar108 && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)))){
if(!bVar113){
func_76(&(Var6.f_26));
bVar113=true;
}
...
if(func_461(&(uParam0->f_2)) * 1000f) > to_float(uParam0->f_1){
...
if(*iParam9){
if(PLAYER::IS_PLAYER_ONLINE()){
if(!func_263(uParam1, 28) && func_80(&uLocal_73)){
...
func_253(13, floor(Global_113648.f_10196.f_3853));
}
...
void func_265(struct<3> Param0, int iParam1, int iParam2, int iParam3, var uParam4, float fParam5){
int iVar0;
int iVar1;
bool bVar2;
int iVar3;
...
*uParam4=func_268(ceil(((100f * (15f - fVar15)) / 15f)) + 4, 0, 100);
*iParam3=1;
}else{
*iParam3=3;
}}
...
void func_269(struct<3> Param0, var uParam1, var uParam2, var uParam3){
float fVar0;
int iVar1;
if(!func_462(&uParam1)){
return;
}
fVar0=func_461(&uParam1);
if(fVar0 > 1.4f){
return;
}
...
uVar10=func_49(func_272(Var6.f_1, fVar8, 0.5f), Var6.f_1, fVar7);
...
float fVar0;
fVar0=((1f - cos(func_273((fParam2 * 3.141593f)))) * 0.5f);
...
func_310(iParam3, &Var0, Param1, uParam2, func_316(iParam0));
...
bool func_317(struct<3> Param0, struct<3> Param1, bool bParam2){
if(bParam2){
...
int func_329(var uParam0, var uParam1, struct<3> Param2, struct<3> Param3, struct<3> Param4, var uParam5, var uParam6){
struct<3> Var0;
switch (uParam0->f_3){
case 0:
...
Var0={
func_463(Param3, Param4.f_2) 
};
CAM::SET_CAM_PARAMS(func_433(uParam0, 0), Param2 + Var0, *uParam5, *uParam6, 300, 1, 1, 2);
CAM::SET_CAM_ACTIVE_WITH_INTERP(func_433(uParam0, 1), func_433(uParam0, 0), floor((1000f * (1.1f - 0f))), 2, 1);
uParam0->f_3=1;
}
break;
case 1:
...
var uVar2;
struct<3> Var3;
uVar1=func_433(uParam1, 0);
uVar2=func_433(uParam1, 1);
CAM::SET_CAM_NEAR_CLIP(uVar2, func_331());
Var3={
...
int func_332(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, struct<3> Param6, struct<3> Param7){
var uVar0;
struct<3> Var1;
struct<3> Var2;
...
GRAPHICS::DRAW_MARKER(6, Var9, 0f, 0f, 1f, 0f, 0f, 0f, 4f, 4f, 4f, 240, 200, 80, func_357(Var9, 170, 200), 0, 0, 2, 0, 0, 0, 0);
GRAPHICS::DRAW_MARKER(6, Var9, 0f, 0f, 1f, 0f, 0f, 0f, 9f, 9f, 9f, 240, 200, 80, func_357(Var9, 170, 200), 0, 0, 2, 0, 0, 0, 0);
GRAPHICS::DRAW_MARKER(6, Var9, 0f, 0f, 1f, 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_357(Var9, 170, 200), 0, 0, 2, 0, 0, 0, 0);
}
if(*iParam7 !=-1){
...
GRAPHICS::DRAW_MARKER(6, Var4, func_475(Var6), 0f, 0f, 0f, 14f, 14f, 14f, 240, 200, 80, func_357(Var4, 25, 200), 0, 0, 2, 0, 0, 0, 0);
if(*iParam7 !=*iParam6){
if(*iParam7 >=0){
GRAPHICS::DELETE_CHECKPOINT(*uParam4);
*uParam4=0;
...
*uParam4=GRAPHICS::CREATE_CHECKPOINT(17, Var4, Var5, 9f, uVar17, uVar18, uVar19, func_357(Var9, 25, ceil((200f * (to_float(113) / to_float(170))))), 0);
if(*iParam6 < (iParam9 - 2)){
*uParam5=GRAPHICS::CREATE_CHECKPOINT(17, Var5, func_369(uParam0, *iParam6 + 2), (9f * 0.5f), uVar17, uVar18, uVar19, func_357(Var9, 25, ceil((200f * (to_float(113) / to_float(170))))), 0);
}
*iParam7=*iParam6;
}
if(*iParam6 + 1==(iParam9 - 1)){
GRAPHICS::DRAW_MARKER(6, Var5, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 4f), (0.5f * 4f), (0.5f * 4f), 240, 200, 80, func_357(Var5, 170, 200), 0, 0, 2, 0, 0, 0, 0);
GRAPHICS::DRAW_MARKER(6, Var5, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 9f), (0.5f * 9f), (0.5f * 9f), 240, 200, 80, func_357(Var5, 170, 200), 0, 0, 2, 0, 0, 0, 0);
GRAPHICS::DRAW_MARKER(6, Var5, 0f, 0f, 1f, 0f, 0f, 0f, (0.5f * 14f), (0.5f * 14f), (0.5f * 14f), 240, 200, 80, func_357(Var5, 170, 200), 0, 0, 2, 0, 0, 0, 0);
}else{
GRAPHICS::DRAW_MARKER(6, Var5, func_475(Var3 - Var5), 0f, 0f, 0f, (0.5f * 14f), (0.5f * 14f), (0.5f * 14f), 240, 200, 80, func_357(Var5, 25, 200), 0, 0, 2, 0, 0, 0, 0);
}
if(*uParam4 !=0){
GRAPHICS::SET_CHECKPOINT_RGBA(*uParam4, uVar17, uVar18, uVar19, func_357(Var4, 25, ceil((200f * (to_float(113) / to_float(170))))));
}
if(*uParam5 !=0){
GRAPHICS::SET_CHECKPOINT_RGBA(*uParam5, uVar17, uVar18, uVar19, func_357(Var5, 25, ceil((200f * (to_float(113) / to_float(170))))));
}}
if(!bParam19){
return 0;
}
...
if(func_462(&uLocal_513)){
func_458(&uLocal_513);
}}elseif(func_462(&uLocal_513)){
if(func_353(&uLocal_513) > 0.5f){
func_458(&uLocal_513);
iLocal_511=1;
}}else{
func_486(&uLocal_513);
...
*uParam10=func_268(ceil(((100f * (15f - fVar12)) / 15f)) + 4, 0, 100);
return 1;
}else{
return 3;
}}elseif(func_351()){
...
if(fVar11 < (10f * 10f)){
bVar16=true;
}elseif(func_275(Var0, -Var6 / FtoV(sqrt(fVar11))) < 0.08f){
bVar16=true;
}
if(bVar16){
*uParam8++;
func_350(iParam13, 1);
func_223(func_428(), 1, floor((30f * fParam21)), 0, 0);
iLocal_512=0;
}
...
float func_349(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3){
...
void func_355(struct<3> Param0, var uParam1, var uParam2, var uParam3){
var uVar0;
var uVar1;
float fVar2;
float fVar3;
...
void func_356(struct<3> Param0, var uParam1, var uParam2){
float fVar0;
float fVar1;
struct<3> Var2;
...
int func_357(struct<3> Param0, int iParam1, int iParam2){
float fVar0;
int iVar1;
float fVar2;
float fVar3;
...
if(vdist2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_473(bParam1)) > 3600f){
*uParam2=1;
return 1;
}}
return 0;
...
void func_381(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5){
float fVar0;
int iVar1;
int iVar2;
int iVar3;
...
Var4={
func_384(Global_78814, Global_78816, iParam5) 
};
if(fVar6==-0.014f){
}
...
*uParam4={
Vector(1.2f, 1.2f, 1.2f) * Vector(0f, -cos((-97.4239f + func_464(uParam1))), sin((-97.4239f + func_464(uParam1)))) 
};
*uParam3={
...
var func__430(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3){
...
uVar2=func_483(uParam1);
if(!CAM::DOES_CAM_EXIST(func_433(uParam0, 0))){
func_482(uParam0, 0, CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var0, Var1, 1115815936, 0, 2), 1);
}else{
CAM::SET_CAM_COORD(func_433(uParam0, 0), Var0);
CAM::SET_CAM_ROT(func_433(uParam0, 0), Var1, 2);
}
CAM::SET_CAM_FOV(func_433(uParam0, 0), uVar2);
...
func_482(uParam0, 1, CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var0, Var1, 1115815936, 0, 2), 1);
}else{
...
return (shift_right(iParam0, 26) & 31 * func_526(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}
